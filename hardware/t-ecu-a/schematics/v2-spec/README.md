...
[RFC 0007 §5](../../../../docs/rfcs/0007-hardware-reference-designs.md).
...
`osr-dmi` and `osr-vigilance` are feature-gated behind `goa2-cab`
per RFC 0015 §10.2 and not included in the default image.
...
| HDMI | 1 | DMI output (only used under `goa2-cab`) |
