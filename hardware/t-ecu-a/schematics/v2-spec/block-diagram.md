...
```
 ...
 └───────────────────────────────────────────────────────────┘
      ...
      │ A + B  │ │ HVAC   │ │ DMI    │ │console │ │ + M.2  │
      │(redun) │ │ LIGHT  │ │ (goa2) │ │+ diag  │ │  5G    │
      └────────┘ └────────┘ └────────┘ └────────┘ └────────┘
           │
           ▼
      ┌────────┐
...
| HDMI header | `J3` | DMI output (populated only on `goa2-cab` build) |
...
- TCMS stops publishing rollup state → DMI goes blank (no-op
  under GoA 4), OCC supervisor sees "trainset silent" and
