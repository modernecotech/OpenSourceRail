...
3. Greedy loop: pick the grid cell with the highest uncovered
   ...
   inter-station spacing (1.2 km minimum in the centre for OSR light-metro
   planning, with a smaller value only when a deployment explicitly
   selects tram-like stop density).
...
~10 000–12 000 residents in the service area, with the spacing gate
removing any excess candidates that would make stations bunch up.
"""
