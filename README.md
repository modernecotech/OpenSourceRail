...
| **Software in the loop** | One PTP-synchronised deterministic run connects train, station and wayside controllers through T2G to depot services; real balise registry fixes feed odometry, TCMS trips and physical HABD warnings/trips feed movement, and simulator/OCC report fault, failover, history, analytics and work-order evidence. |
