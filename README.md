...
| Deterministic integrated testing | Pinned browser/adapter acceptance plus a [reproducible complete Samawah example](deployment/example-city/README.md): real ERPNext, FUXA, controller and Workbench, changed settings, procurement-to-replacement records, city isolation and outage recovery. |
