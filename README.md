...
| Station and civil product geometry | All seven controlled station archetypes now have [native FreeCAD and geometric IFC4.3 assemblies](docs/stations/README.md), covering all 45 station products. The native civil catalogue also includes turnout operating/detection hardware, depot maintenance/services and reusable bearing, expansion-joint, walkway/service and approach-transition interfaces. |
