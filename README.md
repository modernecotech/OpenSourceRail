...
| Civil BIM, GIS and field evidence | Generate OSR-ALN, GIS, IFC4.3, IDS/BCF, quantities, classifications and 4D construction review through the [Bonsai civil workflow](docs/civil/bonsai-ifc-workflow.md). City Studio also issues a revision-locked [survey/site evidence brief](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/field-evidence-brief.md) and empty receipt manifest without pretending field acceptance exists. |
...
SUMO, EnergyPlus and FDS applications, and whether to start the GUI. There are
