...
| **Software in the loop** | One PTP-synchronised deterministic run connects train, station and wayside controllers through T2G to depot services; TCMS trips and physical HABD warnings/trips feed back into movement, while simulator and OCC report fault, failover, history, analytics and work-order evidence. |
