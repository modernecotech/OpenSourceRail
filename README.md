...
| Deterministic integrated testing | Pinned browser/adapter acceptance plus a [reproducible complete Samawah example](deployment/example-city/README.md): real ERPNext, FUXA, controller and Workbench, changed settings, procurement-to-replacement records, city isolation and outage recovery; [function/setting coverage and gaps](deployment/example-city/coverage-register.md), commit-bound release gates, unmocked disposition and native business outcomes; [review follow-through](docs/operating/review-follow-through.md). |
