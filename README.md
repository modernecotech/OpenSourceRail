...
| Civil BIM, GIS and field evidence | Generate OSR-ALN, GIS, IFC4.3, IDS/BCF, quantities, classifications and 4D construction review through the [Bonsai civil workflow](docs/civil/bonsai-ifc-workflow.md). City Studio issues the [survey/site brief](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/field-evidence-brief.md); deterministic gates cover [control](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/control-processing-readiness.md), [ground](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/ground-model-readiness.md), [alignments](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/surveyed-alignment-readiness.md), [route fit](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/route-station-fit-readiness.md), and [drainage/foundations](cities/catalogue/west-asia/Iraq/Samawah/engineering/survey/drainage-ground-readiness.md), with authority acceptance kept separate. |
| Station and civil product geometry | All seven controlled station archetypes have [native FreeCAD and geometric IFC4.3 assemblies](docs/stations/README.md), covering all 45 station products. The 4,324 native station shapes provide installed/exploded states, coordinate-bearing train/track/optional-PSD/edge interfaces and maintenance/lifting zones; a [bidirectional register](design/component-catalogue/catalog/buildable-stations/station-product-reconciliation.md) rejects orphan IDs across BOM, traveler, drawing definition, FreeCAD and IFC. The civil catalogue also includes turnout operating/detection hardware, depot services and reusable bearing, expansion-joint, walkway/service and approach-transition interfaces. |
...
| Buildable modular trainset | The controlled [`LM3-FA-001` first-article baseline](design/component-catalogue/catalog/buildable-trainset/first-article-baseline.json) separates 101 product rows into 26 part→subassembly→car→trainset nodes, including explicit chassis/body/front, articulation, bogie/body connection and bogie-mounted drive units. Git includes [101 separate native FreeCAD parts and 26 tested assemblies](design/component-catalogue/models/cad/README.md), matching [split IFC4.3 part/assembly files](engineering/models/bim/reference/README.md), 523 geometric primitives, installed-coordinate/configuration-state evidence, nine timed methods, 20 tooling/mould families and shop travelers. The 46 locally made rows also have [round-trip-tested STEP, DXF and SVG references](design/component-catalogue/models/manufacturing-reference/README.md). The [model coverage register](engineering/models/model-coverage.md) separates envelopes, interface detail and release maturity. All 54 bought-in rows map to 39 manufacturer-sourced [off-the-shelf or vehicle-specific RFQ candidates](design/component-catalogue/catalog/buildable-trainset/cots-candidates.md), grouped under 25 supplier-family anchors, with local-equivalent routes retained. Its 67 unresolved rows remain [public work packages](design/component-catalogue/catalog/buildable-trainset/first-article-work-packages.md) routed through one [first-article execution pack](design/component-catalogue/catalog/buildable-trainset/first-article-execution-pack.md) and 12 honest evidence gates. |
