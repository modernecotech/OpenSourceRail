...
| Station engineering screens | The tracked [station systems report](engineering/analysis/stations/screening-summary.md) runs OpenSees canopy gravity/uplift, JuPedSim normal/degraded/egress and per-bay SWMM drainage across all seven variants. It publishes assumptions and unresolved deployment gates; EnergyPlus and FDS decks remain explicitly pending rather than presented as completed evidence. |
