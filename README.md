...
| **Software in the loop** | One PTP-synchronised deterministic run connects train, station and wayside controllers through T2G to depot services; signed TVM→AFC→settlement transactions and balise fixes execute beside movement feedback, fault, failover, history, analytics and work-order evidence. |
