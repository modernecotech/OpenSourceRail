...
| **Campaign-ready city catalogue** | Deterministic [government, municipality, funder, nonprofit and media outreach packages](marketing/README.md) turn every retained design into a concise brief, audience-specific email, image set and contact-research queue without guessing addresses or sending messages. |
