...
from osr_mech.depot import DepotArchetype, depot_footprint, depot_layout
from osr_mech.track.turnout import TurnoutTangent, turnout, turnout_footprint_mm
...
def test_turnout_reverse_speed_scales_with_tangent() -> None:
    ...
    from osr_mech.track.turnout import CATALOGUE
