...
def trainset(family: ConsistFamily = ConsistFamily.LIGHT_METRO_3CAR) -> Compound:
    ...
    # end-car envelope, so it does not add to consist length.
    ...
    # Every car repeats the RFC 0022 powered/trailer bogie pair.
    for i in range(car_count):
        ...
        bogie_builders = (motor_bogie, trailer_bogie)
