...
DEFAULT_CATALOG_DIR = REPO_ROOT / "mechanical-py/catalog/buildable-stations"
...
def station_variant(
    ...
    items: list[StationProductItem] = [
        ...
        _item(
            ...
            ("hardware/s-sbc/diy-assembly/README.md", "hardware/s-sbc/schematics/v2-spec/README.md"),
        ),
        _item(
            "STN-PAX-P020",
        ...
        items.extend(
            [
                ...
                _item(
                    ...
                    ("RFC 0012 §5", "hardware/w-sbc/diy-assembly/README.md", "osr-wayside-points"),
        ...
        items.extend(
            [
                ...
                _item(
                    ...
                    ("RFC 0014 §5", "standard-archetype/services.md", "hardware/s-sbc/diy-assembly/README.md"),
    ...
    assemblies = (
        ...
        StationAssemblyNode(
            ...
            ("hardware/configuration release", "accessibility walkdown", "station systems SAT"),
        ),
        StationAssemblyNode(
            "STN-ACC-SA600",
