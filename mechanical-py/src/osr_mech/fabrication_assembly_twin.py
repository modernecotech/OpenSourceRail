...
STATION_MANIFEST_PATH = (
    REPO_ROOT / "mechanical-py/catalog/buildable-stations/station-kit-manifest.json"
)
TRAINSET_MANIFEST_PATH = (
    REPO_ROOT / "mechanical-py/catalog/buildable-trainset/buildable-trainset-manifest.json"
)
...
def fabrication_streams() -> tuple[FabricationStream, ...]:
    ...
    common_track_refs = (
        ...
        "mechanical-py/src/osr_mech/track/panel.py",
    )
    ...
    station_refs = (
        "mechanical-py/catalog/buildable-stations/station-kit-manifest.json",
