# Station assembly traveler — `depot-terminal`
...
| `dwell_seconds` | 240 |
| `tpss_kva` | 2000 |
| `access_type` | ground-level-side-access |
| `turnout_count` | 1 |
| `turnout_tangent` | 1:9 |
| `turnout_total_length_m` | 27.0 |
| `turnout_switch_blade_length_m` | 7.8 |
| `turnout_sleeper_count` | 42 |
...
2. construct/place ground-level slab panels and the depressed guideway channel on the released sub-base.
...
| `STN-CHG-P020` | 2000 | kVA installed | `BID` | `buildable-after-utility-and-supplier-freeze` |
...
| `STN-PAX-P040` | 6 | lane/validator | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P050` | 4 | ea | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P060` | 2 | platform kit | `SOURCE` | `release-candidate` |
| `STN-PAX-P070` | 6 | lane plinth | `MAKE` | `release-candidate` |
...
- [ ] hardware/configuration release — inspector/signature/date: __________
...
## `STN-TRK-SA800` — terminal 1:9 turnout, point machine, detection, and stop-block assembly

Work cell: track/switch assembly and commissioning.

### BOM release

| Engineering ID | Qty | Unit | Route | Maturity |
|---|---:|---|---|---|
| `STN-TRK-P010` | 1 | turnout kit | `MAKE` | `buildable-after-controlled-drawing-release` |
| `STN-TRK-P020` | 1 | turnout kit | `BID` | `buildable-after-supplier-freeze` |
| `STN-TRK-P030` | 42 | sleeper position | `SOURCE` | `buildable-after-supplier-freeze` |
| `STN-TRK-P040` | 1 | ea | `BID` | `buildable-after-actuator-qualification` |
| `STN-TRK-P050` | 1 | turnout kit | `SOURCE` | `buildable-after-hardware-freeze` |
| `STN-TRK-P060` | 1 | turnout kit | `SOURCE` | `buildable-after-climate-and-supplier-freeze` |
| `STN-TRK-P070` | 2 | track-end kit | `SOURCE` | `buildable-after-site-geometry-freeze` |

### Work instructions

1. release the controlled turnout geometry, rail/blade drawings, supplier documents, site trackform, and drainage.
2. assemble switch rails, frog, check rails, sleepers, chairs, fasteners, stretcher bars, and mechanical lock in the shop fixture.
3. install actuator, hand-wind provision, detection channels, W-SBC interface, heating, cabinet, and labelled harness.
4. bench-prove blade throw, force, time, mechanical lock, normal/reverse detection, disagreement response, and manual operation.
5. install to the released site datum; align, stress, weld/bolt, drain, and survey the complete turnout and track ends.
6. execute route locking, detection, heating, stop-block, and integrated train-movement proof tests.

### Hold points

- [ ] controlled geometry/drawing release — inspector/signature/date: __________
- [ ] shop bench proof — inspector/signature/date: __________
- [ ] site geometry and route proof — inspector/signature/date: __________

## `STN-DEP-SA850` — co-located main-heavy depot civil, track, workshop, energy, and systems assembly

Work cell: depot construction and systems integration.

### BOM release

| Engineering ID | Qty | Unit | Route | Maturity |
|---|---:|---|---|---|
| `STN-DEP-P010` | 8000 | m2 site | `MAKE` | `buildable-after-site-design-release` |
| `STN-DEP-P020` | 400 | track-m | `MAKE` | `buildable-after-controlled-layout-release` |
| `STN-DEP-P030` | 2 | turnout assembly | `MAKE` | `buildable-after-turnout-design-and-site-freeze` |
| `STN-DEP-P040` | 4 | stall kit | `BID` | `buildable-after-supplier-and-energy-freeze` |
| `STN-DEP-P050` | 1 | energy-site kit | `BID` | `buildable-after-energy-site-and-supplier-freeze` |
| `STN-DEP-P060` | 1800 | m2 workshop | `BID` | `buildable-after-building-and-equipment-freeze` |
| `STN-DEP-P070` | 1 | depot services kit | `BID` | `buildable-after-services-and-supplier-freeze` |
...
- [ ] site/layout release — inspector/signature/date: __________
- [ ] track/building completion — inspector/signature/date: __________
- [ ] energy and workshop SAT — inspector/signature/date: __________
- [ ] operator depot handover — inspector/signature/date: __________
...
| `STN-TRK-SA800` | 1 | assembly | `RELEASED CHILD` | `traveler required` |
| `STN-DEP-SA850` | 1 | assembly | `RELEASED CHILD` | `traveler required` |
