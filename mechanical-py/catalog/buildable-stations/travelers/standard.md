# Station assembly traveler — `standard`
...
| `site_canopy_target_m2` | 1800.0 |
| `auxiliary_canopy_required_area_m2` | 1296.0 |
| `auxiliary_canopy_module_area_m2` | 187.0 |
| `auxiliary_canopy_module_count` | 7 |
| `auxiliary_canopy_installed_area_m2` | 1309.0 |
| `auxiliary_canopy_target_overbuild_m2` | 13.0 |
| `auxiliary_canopy_kwp` | 222.5 |
...
| `STN-CNP-P070` | 16 | column kit | `MAKE` | `buildable-after-site-structural-release` |
...
| `STN-CNP-P050` | 7 | 187 m2 module | `BID` | `buildable-after-supplier-and-structural-release` |
| `STN-CNP-P060` | 8 | shared frame | `MAKE` | `buildable-after-structural-calculation-and-drawing-release` |
| `STN-CNP-P080` | 1 | string group | `BID` | `buildable-after-electrical-and-supplier-freeze` |
| `STN-CNP-P090` | 7 | roof-bay kit | `SOURCE` | `buildable-after-site-and-supplier-freeze` |
...
| `STN-PAX-P040` | 4 | lane/validator | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P050` | 2 | ea | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P060` | 2 | platform kit | `SOURCE` | `release-candidate` |
| `STN-PAX-P070` | 4 | lane plinth | `MAKE` | `release-candidate` |
| `STN-PAX-P080` | 2 | TVM plinth | `MAKE` | `release-candidate` |
