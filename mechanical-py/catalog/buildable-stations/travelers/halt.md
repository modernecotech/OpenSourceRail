# Station assembly traveler — `halt`
...
| `platform_length_m` | 55.5 |
| `platform_l_units` | 0 |
| `at_grade_track_channel_count` | 1 |
| `at_grade_slab_panels` | 10 |
| `guideway_edge_modules` | 19 |
| `canopy_bays_per_platform` | 10 |
| `total_canopy_bays` | 10 |
| `platform_canopy_area_m2` | 252.0 |
| `site_canopy_target_m2` | 400.0 |
| `auxiliary_canopy_required_area_m2` | 148.0 |
| `auxiliary_canopy_module_area_m2` | 187.0 |
| `auxiliary_canopy_module_count` | 1 |
| `auxiliary_canopy_installed_area_m2` | 187.0 |
| `auxiliary_canopy_target_overbuild_m2` | 39.0 |
| `auxiliary_canopy_kwp` | 31.8 |
| `charging_power_kw` | 0 |
| `dwell_seconds` | 60 |
| `tpss_kva` | 0 |
...
|---|---:|---|---|---|
| `STN-CIV-P030` | 55.5 | m | `MAKE` | `release-candidate` |
| `STN-CNP-P020` | 11 | column kit | `MAKE` | `release-candidate` |
| `STN-CNP-P070` | 4 | column kit | `MAKE` | `buildable-after-site-structural-release` |
...
| `STN-CIV-P020` | 1 | platform kit | `MAKE` | `release-candidate` |
| `STN-CIV-P040` | 19 | edge module | `MAKE` | `release-candidate` |
| `STN-PLT-P010` | 55.5 | m | `SOURCE` | `release-candidate` |
...
| Engineering ID | Qty | Unit | Route | Maturity |
|---|---:|---|---|---|
| `STN-CNP-P010` | 10 | bay kit | `MAKE` | `release-candidate` |
| `STN-CNP-P030` | 10 | ea | `BID` | `buildable-after-supplier-freeze` |
| `STN-CNP-P040` | 1 | platform kit | `BID` | `buildable-after-supplier-freeze` |
| `STN-CNP-P050` | 1 | 187 m2 module | `BID` | `buildable-after-supplier-and-structural-release` |
| `STN-CNP-P060` | 2 | shared frame | `MAKE` | `buildable-after-structural-calculation-and-drawing-release` |
| `STN-CNP-P080` | 1 | string group | `BID` | `buildable-after-electrical-and-supplier-freeze` |
| `STN-CNP-P090` | 1 | roof-bay kit | `SOURCE` | `buildable-after-site-and-supplier-freeze` |
...
| `STN-MEP-P030` | 20 | luminaire point | `SOURCE` | `release-candidate` |
...
| `STN-PAX-P020` | 2 | display point | `SOURCE` | `release-candidate` |
| `STN-PAX-P030` | 1 | platform kit | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P040` | 2 | lane/validator | `BID` | `buildable-after-supplier-freeze` |
| `STN-PAX-P060` | 1 | platform kit | `SOURCE` | `release-candidate` |
| `STN-PAX-P070` | 2 | lane plinth | `MAKE` | `release-candidate` |
