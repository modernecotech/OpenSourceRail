...
| `LM3-EXT-P080` | `B6` | external-component | `BID` | 6 side kit | `LM3-SHELL-A200` | fire-rated composite exterior side sandwich-panel kit | EN 45545 evidence<br>panel dimensional report<br>insert pull-out<br>bond coupon and water test |
| `LM3-EXT-P090` | `B7` | external-component | `BID` | 3 car kit | `LM3-SHELL-A200` | fire-rated composite roof fairing and exterior skirt-panel kit | EN 45545 evidence<br>service-removal trial<br>fastener/insert proof<br>water and debris-ingress check |
