...
| 80 | install and integrate LM3-TRC-P060: station side-pin charging connector, actuator, shutter, and alignment target | final assembly and commissioning cell | 1.53 | `FIX-LM3-HV-SA510`<br>`GAUGE-LM3-TRC-P060`<br>`TORQUE-LM3-TRC-P060` | placement zone and joint controls accepted: under-seat HV bay, side-pin dock zone, and segregated cable route | operator |
