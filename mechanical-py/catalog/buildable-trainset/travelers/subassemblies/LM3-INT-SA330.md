...
| 20 | install and integrate LM3-EXT-P060: seats, grab rails, flooring, lighting, PIS, CCTV, intercom, signage kit | final assembly and commissioning cell | 1.35 | `FIX-LM3-INT-SA330`<br>`GAUGE-LM3-EXT-P060`<br>`TORQUE-LM3-EXT-P060` | placement zone and joint controls accepted: saloon interior, PRM aisle, ceiling, and service-panel zone | operator |
