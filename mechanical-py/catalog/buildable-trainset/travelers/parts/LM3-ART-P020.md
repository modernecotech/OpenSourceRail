# Shop traveler — LM3-ART-P020 — gangway, lower spherical pivot, upper links, bellows, turntable, and trainline kit
...
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-ART-P020`<br>`DOC-LM3-ART-SA800` | traveler rev and parent assembly match released manifest | cell lead |
...
| 30 | perform envelope, mounting, service-removal, and connector checks | incoming fit-check cell | 0.75 | `GAUGE-LM3-ART-P020-ENVELOPE`<br>`FIX-LM3-ART-SA800` | component fits without parent datum rework | operator |
| 40 | verify acceptance gate: motion-envelope proof | quality inspection | 0.25 | `QA-LM3-ART-P020` | motion-envelope proof | quality inspector |
| 50 | verify acceptance gate: fire evidence | quality inspection | 0.25 | `QA-LM3-ART-P020` | fire evidence | quality inspector |
| 60 | verify acceptance gate: water ingress/drain test | quality inspection | 0.25 | `LEAK-TEST-LM3-ART-P020` | water ingress/drain test | quality inspector |
| 70 | final item release to parent assembly | production control | 0.25 | `REL-LM3-ART-P020`<br>`KIT-LM3-ART-SA800` | item is released, tagged, and staged for parent assembly | cell lead |
