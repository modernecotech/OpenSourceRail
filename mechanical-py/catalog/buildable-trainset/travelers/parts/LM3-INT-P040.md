...
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-INT-FAB`<br>`GAUGE-LM3-INT-P040-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-INT-SA330`<br>`TORQUE-LM3-INT-P040` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: fire-material certificate | quality inspection | 0.25 | `QA-LM3-INT-P040` | fire-material certificate | quality inspector |
| 50 | verify acceptance gate: service-hatch removal | quality inspection | 0.25 | `QA-LM3-INT-P040` | service-hatch removal | quality inspector |
| 60 | verify acceptance gate: HV warning label check | quality inspection | 0.25 | `QA-LM3-INT-P040` | HV warning label check | quality inspector |
| 70 | verify acceptance gate: sharp-edge inspection | quality inspection | 0.25 | `QA-LM3-INT-P040` | sharp-edge inspection | quality inspector |
| 80 | final item release to parent assembly | production control | 0.25 | `REL-LM3-INT-P040`<br>`KIT-LM3-INT-SA330` | item is released, tagged, and staged for parent assembly | cell lead |
