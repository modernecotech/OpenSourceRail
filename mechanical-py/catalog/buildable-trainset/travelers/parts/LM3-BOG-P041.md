# Shop traveler — LM3-BOG-P041 — trailer-bogie certified wheelset, axlebox, suspension, brake, centre-pivot, yaw-link, and sensor kit
...
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BOG-P041`<br>`DOC-LM3-BOG-SA620` | traveler rev and parent assembly match released manifest | cell lead |
...
| 30 | perform envelope, mounting, service-removal, and connector checks | incoming fit-check cell | 0.75 | `GAUGE-LM3-BOG-P041-ENVELOPE`<br>`FIX-LM3-BOG-SA620` | component fits without parent datum rework | operator |
| 40 | verify acceptance gate: wheelset certificates | quality inspection | 0.25 | `QA-LM3-BOG-P041` | wheelset certificates | quality inspector |
| 50 | verify acceptance gate: bearing records | quality inspection | 0.25 | `QA-LM3-BOG-P041` | bearing records | quality inspector |
| 60 | verify acceptance gate: spring/damper certificates | quality inspection | 0.25 | `QA-LM3-BOG-P041` | spring/damper certificates | quality inspector |
| 70 | verify acceptance gate: brake test | quality inspection | 0.25 | `QA-LM3-BOG-P041` | brake test | quality inspector |
| 80 | verify acceptance gate: sensor test | quality inspection | 0.25 | `QA-LM3-BOG-P041` | sensor test | quality inspector |
| 90 | verify acceptance gate: ride-height report | quality inspection | 0.25 | `QA-LM3-BOG-P041` | ride-height report | quality inspector |
| 100 | final item release to parent assembly | production control | 0.25 | `REL-LM3-BOG-P041`<br>`KIT-LM3-BOG-SA620` | item is released, tagged, and staged for parent assembly | cell lead |
