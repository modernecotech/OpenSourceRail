...
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-CWL-FAB`<br>`GAUGE-LM3-CWL-P013-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-CWL-SA710`<br>`TORQUE-LM3-CWL-P013` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: mould release record | quality inspection | 0.25 | `QA-LM3-CWL-P013` | mould release record | quality inspector |
| 50 | verify acceptance gate: laminate coupon | quality inspection | 0.25 | `QA-LM3-CWL-P013` | laminate coupon | quality inspector |
| 60 | verify acceptance gate: insert pull-out | quality inspection | 0.25 | `QA-LM3-CWL-P013` | insert pull-out | quality inspector |
| 70 | verify acceptance gate: split-gap gauge | quality inspection | 0.25 | `GAUGE-LM3-CWL-P013` | split-gap gauge | quality inspector |
| 80 | final item release to parent assembly | production control | 0.25 | `REL-LM3-CWL-P013`<br>`KIT-LM3-CWL-SA710` | item is released, tagged, and staged for parent assembly | cell lead |
