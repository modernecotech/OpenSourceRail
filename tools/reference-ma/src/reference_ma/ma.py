...
def section_available_to(
    ...
    no maintenance override covers it, and its intrusion detector reports
    `Clear`."""
    ...
    intrusion = state.section_intrusions.get(section)
    return intrusion is not None and intrusion.state.value == "Clear"
