...
def _portal_apps(design_path: Path, scenario_path: Path) -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "native_command": f"python3 tools/automation/generate-qa-maintenance-data.py --design {_rel(design_path)} --scenario {_rel(scenario_path)}",
            "web_command": "python3 tools/automation/ops-core-server.py --port 8008",
