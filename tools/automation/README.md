...
| [`buildable-trainset.sh`](buildable-trainset.sh) | Generate the LM3 product tree, supplier/COTS registers, 18 factory drawing briefs, package readiness, first-article work packages and evidence status |
