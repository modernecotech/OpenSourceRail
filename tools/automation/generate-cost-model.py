...
TRAINSET_BUILD_COST_PATH = REPO_ROOT / "design/component-catalogue/catalog/buildable-trainset/trainset-build-cost.json"
FACTORY_PLAN_PATH = REPO_ROOT / "design/component-catalogue/catalog/buildable-trainset/factory-plan.json"
...
def render_cost_model() -> str:
    ...
    lines: list[str] = [
        ...
        "(../design/component-catalogue/catalog/buildable-trainset/trainset-build-cost.md) "
