#!/usr/bin/env bash
# Resynthesise and refresh every complete catalog city package in designs/.
#
# Usage:
...
#   scripts/regenerate-all.sh --from-scratch   # refetch OSM and resynthesise designs
#   scripts/regenerate-all.sh --resynthesise-corridors  # reroute from cached rasters
#
...
COMMAND=(
    "$PYTHON" "$REPO/scripts/generate-city-packages-fast.py"
