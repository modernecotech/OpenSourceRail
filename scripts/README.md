...
| [`generate-introduction-brochure.py`](generate-introduction-brochure.py) | Generate and drift-check the one-page public overview from the design catalogue and LM3 build-cost record |
