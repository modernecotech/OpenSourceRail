...
FINANCE_RUNNER = REPO_ROOT / "scripts/generate-city-finance.py"
...
PEDESTRIAN_RUNNER = REPO_ROOT / "engineering/benchmarks/jupedsim/station-corridor.py"
STATION_MANIFEST = REPO_ROOT / "mechanical-py/catalog/buildable-stations/station-kit-manifest.json"
