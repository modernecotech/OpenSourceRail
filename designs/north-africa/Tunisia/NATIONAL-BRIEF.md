...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this national OSR programme avoids **$3.10 B (87.2%) of external capital** and **$3.82 B of external interest**. Capital plus saved interest totals **$6.92 B over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the comparator external requirement is assumed debt-financed, and the comparator is an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.67 B | $2.21 B (83.0%) | $2.72 B | **$4.94 B** |
| **Default** | 2.00× | $3.56 B | $3.10 B (87.2%) | $3.82 B | **$6.92 B** |
| High | 3.00× | $5.34 B | $4.88 B (91.5%) | $6.00 B | **$10.88 B** |

At the default 2.00× case, the OSR programme reduces external capital from $3.56 B to $453.9 M, a saving of **$3.10 B (87.2%)**, plus **$3.82 B** of external interest over the financing life. Total programme CAPEX is 50.0% below the comparator. Replace both variables with scope-normalized bids before investment approval.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Tunis](Tunis/README.md) | 2,900,000 | 255 | $1.91 B | 23.1% | $441.0 M | $3.44 B | $3.00 B | $6.69 B | $1.47 B |
