...
|---|---|---|---|---|
| line-1 |  8.1 km | 6 | 26 | NW Mid ↔ S Outer |
| line-2 |  7.9 km | 5 | 25 | N Outer ↔ S Inner |
| line-3 |  2.2 km | 3 | 11 | SE Inner ↔ NW Inner |
| **Total** | **18.3 km** | **14 unique** | **62** | |
...
| Total fleet capacity | 14,880 AW2 pax (19,840 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 62 × 240 = **14,880 AW2 passengers** (19,840 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **2.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 22.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 344 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 16 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 2.8 MW / 18 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 45 kWh | 123 kWh | 73 kWh | 2.0 km / 11 kWh |
| line-2 | 5 | 44 kWh | 98 kWh | 50 kWh | 2.9 km / 16 kWh |
| line-3 | 3 | 12 kWh | 65 kWh | 52 kWh | 1.2 km / 7 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 62 | $560 k | $35 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 124 | $60 k | $7.4 M |
| High sensitivity check | 124 | $120 k | $15 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 2,750 kW @ $700/kW | $1.9 M |
| Grid interconnection / PPA tie-in | 2,750 kW @ $100/kW | $275 k |
| Annual generation proxy | 2.8 MW × 6.5 peak-sun-h/day × 365 d/yr | 6.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$2.2 M** |
...
| Depots | $8.0 M |
| Rolling stock | $35 M |
| Railway production plant | $7.4 M |
| Dedicated solar power plant | $2.2 M |
...
|---|---|---|
| Construction (years 1–10) | **$13 M / yr** | $42 |
| Steady-state, low capacity-use (year 11+) | **$1.1 M / yr** | $4 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$160 M cumulative** | $533 |
| Lifecycle envelope (yr 1–40, high scenario) | **$126 M cumulative** | $420 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$457 M cumulative** | $1,525 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.9 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $180 M | 4.5% | 40 y, 10 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $45 M | — | — | — |
| **Total** | **100%** | **$225 M** | | | **$11 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $8.1 M / yr = **$8.1 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($4.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (26.8 GWh / yr) | 8,495 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.1 GWh/yr + dedicated solar plant 2.8 MW / 6.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $33 k |
| Labour (226 FTE) | driverless roster: OCC/remote 49, station/platform 67, passenger service 38, fleet maintenance 30, infrastructure/energy 21, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $418 k |
| **OPEX subtotal** | | **$5.2 M / yr** |

_Annual service work: 8,495 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 3.3 M train-km / yr (6.7 M car-km / yr). On-site PV covers 21.1 GWh/yr and the dedicated solar plant adds 6.5 GWh/yr against 26.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 62 trainsets, 14 stations, 18.3 route-km, 3 lines, and 8,495 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 15.1 M |
| Annual paid trips / city resident | 163 | 261 | 50 |
| Farebox revenue | $14 M / yr | $23 M / yr | $4.4 M / yr |
| Station shop leases | $307 k / yr | $307 k / yr | $307 k / yr |
| Advertising boards | $430 k / yr | $430 k / yr | $430 k / yr |
| **Total revenue** | **$15 M / yr** | **$24 M / yr** | **$5.2 M / yr** |
| Revenue / OPEX recovery | 292% | 459% | 100% |
...
| Operating surplus applied to debt support | -$9.9 M / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.1 M / yr | $0 k / yr | **$11 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.9 M / yr | $19 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,904 m² of station shop/kiosk leases at $10/m²/month and 548 advertising boards at $77/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 11,142 trips/school day; 2.5 M access-events/yr | 17,827 trips/school day; 3.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $132 M | 59% of $225 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $212 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $21 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 25,071 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $2.2 M |
| **Reconciled project CAPEX** | **$225 M** |
| 15%–25% planning risk envelope | $259 M–$281 M |
| Annual OPEX | $5.2 M / yr |
| Low/high project NPV at 8% | $-99211 k / $-54351 k |
| Low/high project IRR | 1.4% / 5.0% |
| Low/high steady-state DSCR | 0.90 / 1.68 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 843.81 train-km; 4,698.66 kWh consumed; 5,310.99 kWh charged; 41 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 8,849.45 train-km; 49,277.06 kWh consumed; 50,622.72 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 90%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 87.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 89.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.1% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 89.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
