...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$248 M (88.3%) of external capital** and **$320 M of external interest**. Capital plus saved interest totals **$568 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 18.3 km |
| Revenue fleet | 35 × 2-car trainsets |
| Revenue fleet passenger capacity | 8,400 AW2 pax (11,200 AW3 crush) |
...
| Revenue fleet capacity | 8,400 AW2 pax (11,200 AW3 crush) |
| Total fleet capacity | 9,840 AW2 pax (13,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 35 × 240 = **8,400 AW2 passengers** (11,200 AW3 crush)
- **Total fleet passenger capacity:** 41 × 240 = **9,840 AW2 passengers** (13,120 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **4,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **4.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.8× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 336 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 21 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 48 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 8,495 train-km/day | One-way train journeys × route length |
| Annual service work | 3.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 73 MWh/day | 6.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 25 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 4.5 MW / 29 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 45 kWh | 90 kWh | 40 kWh | 3.1 km / 18 kWh |
| line-2 | 3 | 44 kWh | 69 kWh | 21 kWh | 4.4 km / 24 kWh |
| line-3 | 2 | 12 kWh | 49 kWh | 35 kWh | 2.2 km / 12 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (17.2 km @ $2.58 M/km) | $44 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 41 | $560 k | $23 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 82 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 82 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 4,475 kW @ $700/kW | $3.1 M |
| Grid interconnection / PPA tie-in | 4,475 kW @ $100/kW | $448 k |
| Annual generation proxy | 4.5 MW × 6.5 peak-sun-h/day × 365 d/yr | 10.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$3.6 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 18.3 km × $0.050 M/km | $913 k |
...
| Dedicated solar power plant | $3.6 M |
| Residual train-control wayside + charging microgrids | $2.0 M |
| EPC overhead (7%) | $10.0 M |
| **CAPEX total** | **$156 M** |
| Per-route-km | $8.5 M / km |
| Per-capita (city pop) | $520 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $60 M | 15% | $8.9 M | $51 M |
| Stations | $50 M | 20% | $10 M | $40 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $23 M | 35% | $8.0 M | $15 M |
| Dedicated solar plant | $3.6 M | 45% | $1.6 M | $2.0 M |
| Residual signalling / train control | $913 k | 50% | $457 k | $457 k |
| Charging microgrids | $1.1 M | 40% | $430 k | $645 k |
| EPC / project services | $10.0 M | 15% | $1.5 M | $8.5 M |
| **Total city CAPEX** | **$156 M** | **21.1%** | **$33 M** | **$123 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh waw`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.1%** | **$33 M** | **$3.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.9%** | **$123 M** | **$12 M / yr** |
| of which planned local bond issuance | 63.1% of total CAPEX | $98 M | $9.8 M / yr |
| **Total city programme** | **100.0%** | **$156 M** | **$16 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $211 M | $178 M (84.4%) | $230 M | **$407 M** |
| **Default** | 2.00× | $281 M | $248 M (88.3%) | $320 M | **$568 M** |
| High | 3.00× | $421 M | $388 M (92.2%) | $502 M | **$890 M** |

At the default 2.00× case, OSR's $33 M external requirement is 88.3% below the illustrative foreign-company requirement of $281 M; the associated lifetime external-interest saving is $320 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$19 M / yr** | $62 |
| Steady-state, low capacity-use (year 11+) | **$5.9 M / yr** | $20 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $57 |
| Lifecycle envelope (yr 1–40, low scenario) | **$365 M cumulative** | $1,216 |
| Lifecycle envelope (yr 1–40, high scenario) | **$187 M cumulative** | $624 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$698 M cumulative** | $2,326 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $17 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $33 M | 4.5% | 40 y, 10 y grace | $2.0 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $98 M | 15.0% | 40 y, 10 y grace | $15 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $25 M | — | — | — |
| **Total** | **100%** | **$156 M** | | | **$17 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.5 M / yr + local bonds $15 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $46 k |
| Traction energy (26.8 GWh / yr) | 8,495 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.6 GWh/yr + dedicated solar plant 4.5 MW / 10.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $54 k |
| Labour (189 FTE) | driverless roster: OCC/remote 41, station/platform 45, passenger service 38, fleet maintenance 24, infrastructure/energy 20, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $349 k |
| **OPEX subtotal** | | **$3.7 M / yr** |

_Annual service work: 8,495 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 3.3 M train-km / yr (6.7 M car-km / yr). On-site PV covers 17.6 GWh/yr and the dedicated solar plant adds 10.6 GWh/yr against 26.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 41 trainsets, 9 stations, 18.3 route-km, 3 lines, and 8,495 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 11.0 M |
| Annual paid trips / city resident | 163 | 261 | 37 |
| Farebox revenue | $14 M / yr | $23 M / yr | $3.2 M / yr |
| Station shop leases | $198 k / yr | $198 k / yr | $198 k / yr |
| Advertising boards | $286 k / yr | $286 k / yr | $286 k / yr |
| **Total revenue** | **$15 M / yr** | **$23 M / yr** | **$3.7 M / yr** |
| Revenue / OPEX recovery | 399% | 630% | 100% |
...
| Operating surplus applied to debt support | -$11 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.9 M / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $20 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,872 m² of station shop/kiosk leases at $10/m²/month and 364 advertising boards at $77/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$39 M / yr** | **$62 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 10,781 trips/school day; 2.4 M access-events/yr | 17,249 trips/school day; 3.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $123 M | 79% of $156 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $197 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $20 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 23,313 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $3.6 M |
| **Reconciled project CAPEX** | **$156 M** |
| Imported / external-capital requirement | $33 M (21.1%) |
| Local-content / local-funding requirement | $123 M (78.9%) |
| Default foreign-turnkey external-capital comparison | $281 M; OSR saves $248 M (88.3%) |
| Lifetime external interest and combined financing saving | $320 M interest; $568 M capital + interest |
| 15%–25% planning risk envelope | $179 M–$195 M |
| Annual OPEX | $3.7 M / yr |
| Low/high project NPV at 8% | $-46813 k / $-1953 k |
| Low/high project IRR | 4.1% / 7.9% |
| Low/high steady-state DSCR | 0.65 / 1.16 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 841.68 train-km; 4,686.85 kWh consumed; 4,984.10 kWh charged; 43 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 8,561.23 train-km; 47,672.61 kWh consumed; 48,449.81 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 73%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 62.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.1% | 99.5% / 60% | pass |
| ten-hour single charging-pad outage | 35.9% | 100.0% / 90% | pass |
...
|---|---|
| ![Waw energy and battery simulation dashboard](engineering/screenshots/waw-simulation-dashboard.png) | ![Waw simulator network visualizer](engineering/screenshots/waw-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 9 line platforms, 2 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Waw QGIS engineering layers](engineering/screenshots/waw-qgis-engineering-map.png) | ![Waw SUMO timetable validation](engineering/screenshots/waw-sumo-validation.png) |
