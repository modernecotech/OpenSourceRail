...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **39,366 – 65,610 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$6.0 M / yr** | $20 |
| Steady-state, high-ridership (year 11+) | **$3.6 M / yr** | $12 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$257 M cumulative** | $857 |
| Lifecycle envelope (yr 1–40, high scenario) | **$185 M cumulative** | $616 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$78 M cumulative** | $260 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 45,000 | 75,000 | 119,338 |
| Daily paid trips / population | 15% | 25% | 40% |
| Annual paid trips | 16.4 M | 27.4 M | 43.6 M |
| Farebox revenue | $3.6 M / yr | $6.0 M / yr | $9.6 M / yr |
| Station shop leases | $210 k / yr | $210 k / yr | $210 k / yr |
| Advertising boards | $298 k / yr | $298 k / yr | $298 k / yr |
| **Total revenue** | **$4.1 M / yr** | **$6.5 M / yr** | **$10 M / yr** |
| Revenue / OPEX + debt-service recovery | 41% | 65% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $6.0 M / yr | $3.6 M / yr | **$0 / yr** |
