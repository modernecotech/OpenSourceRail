...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$265 M (88.5%) of external capital** and **$342 M of external interest**. Capital plus saved interest totals **$607 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (17.2 km @ $3.0 M/km) | $52 M |
...
| Per-capita (city pop) | $554 / person |
...
| EPC / project services | $11 M | 15% | $1.6 M | $9.1 M |
| **Total city CAPEX** | **$166 M** | **20.7%** | **$35 M** | **$132 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.7%** | **$35 M** | **$3.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.3%** | **$132 M** | **$13 M / yr** |
| of which planned local bond issuance | 63.4% of total CAPEX | $105 M | $11 M / yr |
| **Total city programme** | **100.0%** | **$166 M** | **$17 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $225 M | $190 M (84.6%) | $245 M | **$436 M** |
| **Default** | 2.00× | $299 M | $265 M (88.5%) | $342 M | **$607 M** |
| High | 3.00× | $449 M | $415 M (92.3%) | $536 M | **$950 M** |

At the default 2.00× case, OSR's $35 M external requirement is 88.5% below the illustrative foreign-company requirement of $299 M; the associated lifetime external-interest saving is $342 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$20 M / yr** | $67 |
| Steady-state, low capacity-use (year 11+) | **$7.3 M / yr** | $24 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$418 M cumulative** | $1,394 |
| Lifecycle envelope (yr 1–40, high scenario) | **$200 M cumulative** | $667 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$746 M cumulative** | $2,485 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $18 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $35 M | 4.5% | 40 y, 10 y grace | $2.1 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $105 M | 15.0% | 40 y, 10 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $26 M | — | — | — |
| **Total** | **100%** | **$166 M** | | | **$18 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.6 M / yr + local bonds $16 M / yr = **$17 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 11.7 M |
| Annual paid trips / city resident | 163 | 261 | 39 |
| Farebox revenue | $14 M / yr | $23 M / yr | $3.4 M / yr |
| Station shop leases | $198 k / yr | $198 k / yr | $198 k / yr |
| Advertising boards | $286 k / yr | $286 k / yr | $286 k / yr |
| **Total revenue** | **$15 M / yr** | **$23 M / yr** | **$3.9 M / yr** |
| Revenue / OPEX recovery | 379% | 599% | 100% |
...
| Operating surplus applied to debt support | -$11 M / yr | -$18 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $7.3 M / yr | $0 k / yr | **$18 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $132 M | 79% of $166 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $211 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $21 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 24,969 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $163 M |
| Timetable-sized dedicated solar CAPEX | $3.6 M |
| **Reconciled project CAPEX** | **$166 M** |
| Imported / external-capital requirement | $35 M (20.7%) |
| Local-content / local-funding requirement | $132 M (79.3%) |
| Default foreign-turnkey external-capital comparison | $299 M; OSR saves $265 M (88.5%) |
| Lifetime external interest and combined financing saving | $342 M interest; $607 M capital + interest |
| 15%–25% planning risk envelope | $191 M–$208 M |
| Annual OPEX | $3.9 M / yr |
| Low/high project NPV at 8% | $-54716 k / $-9855 k |
| Low/high project IRR | 3.7% / 7.4% |
| Low/high steady-state DSCR | 0.60 / 1.07 |
