...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 82 | $60 k | $4.9 M |
| High sensitivity check | 82 | $120 k | $9.8 M |
...
| Per-capita (city pop) | $572 / person |
...
|---|---|---|
| Construction (years 1–10) | **$9.6 M / yr** | $32 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$96 M cumulative** | $320 |
| Lifecycle envelope (yr 1–40, high scenario) | **$96 M cumulative** | $320 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$349 M cumulative** | $1,163 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $137 M | 4.5% | 40 y, 10 y grace | $8.4 M / yr |
| Government equity (no debt service) | 20% | $34 M | — | — | — |
| **Total** | **100%** | **$172 M** | | | **$8.4 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $6.2 M / yr = **$6.2 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($3.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $102 M | 59% of $172 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $163 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $16 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 19,236 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $197 M–$215 M |
| Annual OPEX | $3.9 M / yr |
| Low/high project NPV at 8% | $-58248 k / $-13388 k |
| Low/high project IRR | 3.5% / 7.1% |
| Low/high steady-state DSCR | 1.29 / 2.32 |
