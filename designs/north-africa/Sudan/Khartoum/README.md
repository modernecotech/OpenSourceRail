...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **1,025.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 289 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 4,747 MWh/day | 183,158 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 4,458 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 1,025.4 MW / 5,127 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 1,025,445 kW @ $700/kW | $718 M |
| Grid interconnection / PPA tie-in | 1,025,445 kW @ $100/kW | $103 M |
| Annual generation proxy | 1,025.4 MW × 5.0 peak-sun-h/day × 365 d/yr | 1,871.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$820 M** |
...
| Dedicated solar power plant | $820 M |
...
|---|---|---|
| Construction (years 1–10) | **$270 M / yr** | $46 |
| Steady-state, low capacity-use (year 11+) | **$414 M / yr** | $71 |
| Steady-state, high capacity-use (year 11+) | **$377 M / yr** | $65 |
| Steady-state, operating-neutral revenue case | **$268 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$15.11 bn cumulative** | $2,592 |
| Lifecycle envelope (yr 1–40, high scenario) | **$14.00 bn cumulative** | $2,401 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.73 bn cumulative** | $1,841 |

_Population basis: 5,829,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $146 M / yr → $109 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $6.00 bn | 2.0% | 40 y, 10 y grace | $268 M / yr |
| Government equity (no debt service) | 20% | $1.50 bn | — | — | — |
| **Total** | **100%** | **$7.49 bn** | | | **$268 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $120 M / yr = **$120 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($150 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (1732.8 GWh / yr) | 183,158 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 105.5 GWh/yr + dedicated solar plant 1025.4 MW / 1871.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $12 M |
| Labour (1,609 FTE) | driverless roster: OCC/remote 248, station/platform 491, passenger service 120, fleet maintenance 383, infrastructure/energy 321, admin/training 46; no train drivers × country median × 12 × engineer-premium 1.4 | $3.0 M |
| **OPEX subtotal** | | **$213 M / yr** |

_Annual service work: 183,158 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 72.2 M train-km / yr (433.2 M car-km / yr). On-site PV covers 105.5 GWh/yr and the dedicated solar plant adds 1871.4 GWh/yr against 1732.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 168% |
| Annual paid trips | 210.2 M | 336.4 M | 707.9 M |
| Annual paid trips / city resident | 36 | 58 | 121 |
| Farebox revenue | $62 M / yr | $99 M / yr | $208 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| **Total revenue** | **$67 M / yr** | **$104 M / yr** | **$213 M / yr** |
| Revenue / OPEX recovery | 31% | 49% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $414 M / yr | $377 M / yr | **$268 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $414 M / yr | $377 M / yr | **$268 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $18 M / yr | $28 M / yr | 16 min/trip × $0.32/h value-of-time proxy |
...
| Station-area commerce turnover supported | $64 M / yr | $102 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $33 M / yr | $53 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$217 M / yr** | **$346 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 12 education anchors | 34,704 trips/school day; 7.6 M access-events/yr | 55,526 trips/school day; 12.2 M access-events/yr |
| Healthcare | 12 healthcare anchors | 43,632 trips/day; 15.9 M access-events/yr | 69,811 trips/day; 25.5 M access-events/yr |
| Commerce | 60 major/terminal/interchange nodes | 116,192 trips/trading day; 38.3 M access-events/yr | 185,907 trips/trading day; 61.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.72 bn | 50% of $7.49 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.96 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $596 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 705,380 job-years | retained CAPEX ÷ (4.0 × median annual income) |
