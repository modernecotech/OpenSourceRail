...
|---|---|---|
| Construction (years 1–10) | **$149 M / yr** | $26 |
| Steady-state, low-ridership (year 11+) | **$174 M / yr** | $30 |
| Steady-state, high-ridership (year 11+) | **$161 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$146 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.71 bn cumulative** | $1,151 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.34 bn cumulative** | $1,087 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.86 bn cumulative** | $1,006 |

_Population basis: 5,829,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $28 M / yr → $16 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.27 bn | 3.0% | 40 y, 10 y grace | $65 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $530 M | 15.0% | 40 y, 10 y grace | $81 M / yr |
| Government equity (no debt service) | 15% | $318 M | — | — | — |
| **Total** | **100%** | **$2.12 bn** | | | **$146 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $38 M / yr + bonds $79 M / yr = **$118 M / yr** total — plus the equity tranche amortised across construction ($32 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 231,877 | 386,462 | 583,452 |
| Daily paid trips / catchment | 18% | 30% | 45% |
| Daily paid trips / city population | 4% | 7% | 10% |
| Annual paid trips | 84.6 M | 141.1 M | 213.0 M |
| Farebox revenue | $19 M / yr | $31 M / yr | $47 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| **Total revenue** | **$24 M / yr** | **$36 M / yr** | **$52 M / yr** |
| Revenue / OPEX recovery | 46% | 70% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $174 M / yr | $161 M / yr | **$146 M / yr** |
