...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 362.7 km × €0.4 M/km | €145 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 362.7 km × €0.8 M/km | €289 M |
| EPC integration + project management (7%) | on subtotal | €264 M |
...
| Signalling + power | €434 M |
| EPC overhead (7%) | €264 M |
| **CAPEX total** | **€4.04 bn** |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.42 bn | 3.0% | 40 y, 10 y grace | €124 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €1.01 bn | 15.0% | 40 y, 10 y grace | €154 M / yr |
| Government equity (no debt service) | 15% | €606 M | — | — | — |
| **Total** | **100%** | **€4.04 bn** | | | **€277 M / yr** |
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €7.2 M |
...
| Operating shortfall (gov subsidy required) | €86 M / yr | €68 M / yr |
| **Total annual government burden** (debt service + OPEX shortfall) | **€363 M / yr** | **€345 M / yr** |
