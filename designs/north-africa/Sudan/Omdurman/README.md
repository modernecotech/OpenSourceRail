...
|---|---|---|
| Construction (years 1–10) | **$124 M / yr** | $44 |
| Steady-state, low-ridership (year 11+) | **$138 M / yr** | $49 |
| Steady-state, high-ridership (year 11+) | **$125 M / yr** | $45 |
| Steady-state, operating-neutral revenue case | **$121 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.37 bn cumulative** | $1,919 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.99 bn cumulative** | $1,782 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.87 bn cumulative** | $1,739 |

_Population basis: 2,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $17 M / yr → $4.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.06 bn | 3.0% | 40 y, 10 y grace | $54 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $440 M | 15.0% | 40 y, 10 y grace | $67 M / yr |
| Government equity (no debt service) | 15% | $264 M | — | — | — |
| **Total** | **100%** | **$1.76 bn** | | | **$121 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $32 M / yr + bonds $66 M / yr = **$98 M / yr** total — plus the equity tranche amortised across construction ($26 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 238,896 | 398,160 | 447,535 |
| Daily paid trips / catchment | 18% | 30% | 34% |
| Daily paid trips / city population | 9% | 14% | 16% |
| Annual paid trips | 87.2 M | 145.3 M | 163.4 M |
| Farebox revenue | $19 M / yr | $32 M / yr | $36 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$40 M / yr** |
| Revenue / OPEX recovery | 58% | 90% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $138 M / yr | $125 M / yr | **$121 M / yr** |
