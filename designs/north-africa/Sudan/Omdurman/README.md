...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **331,800 – 597,240 trips/day**
...
| Per-capita (city pop) | $1,324 / person |
...
|---|---|---|
| Construction (years 1–10) | **$74 M / yr** | $26 |
| Steady-state, low-ridership (year 11+) | **$151 M / yr** | $54 |
| Steady-state, high-ridership (year 11+) | **$122 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$83 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.26 bn cumulative** | $1,877 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.40 bn cumulative** | $1,573 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.22 bn cumulative** | $1,152 |

_Population basis: 2,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $68 M / yr → $39 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $1.48 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $1.85 bn | 2.0% | 40 y, 10 y grace | $83 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 15.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $371 M | — | — | — |
| **Total** | **100%** | **$3.71 bn** | | | **$83 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $37 M / yr + fallback bonds $0 k / yr = **$37 M / yr** total. The $1.48 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($37 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (961.7 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,542 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $2.8 M |
| **OPEX subtotal** | | **$107 M / yr** |

_Annual fleet utilisation: 306 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 60.1 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 331,800 | 597,240 | 964,458 |
| Daily paid trips / catchment | 25% | 45% | 73% |
| Daily paid trips / city population | 12% | 21% | 34% |
| Annual paid trips | 121.1 M | 218.0 M | 352.0 M |
| Farebox revenue | $36 M / yr | $64 M / yr | $103 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| **Total revenue** | **$39 M / yr** | **$68 M / yr** | **$107 M / yr** |
| Revenue / OPEX recovery | 37% | 63% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $151 M / yr | $122 M / yr | **$83 M / yr** |
