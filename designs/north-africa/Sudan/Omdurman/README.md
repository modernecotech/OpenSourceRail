...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.36 bn (87.0%) of external capital** and **$4.34 bn of external interest**. Capital plus saved interest totals **$7.70 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (236.9 km @ $2.58 M/km) | $612 M |
| Elevated (19.2 km @ $9.75 M/km) | $187 M |
...
| Per-capita (city pop) | $766 / person |
...
| **Total city CAPEX** | **$2.14 bn** | **23.3%** | **$501 M** | **$1.64 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.3%** | **$501 M** | **$50 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.7%** | **$1.64 bn** | **$164 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $1.32 bn | $132 M / yr |
| **Total city programme** | **100.0%** | **$2.14 bn** | **$214 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.90 bn | $2.39 bn (82.7%) | $3.09 bn | **$5.49 bn** |
| **Default** | 2.00× | $3.86 bn | $3.36 bn (87.0%) | $4.34 bn | **$7.70 bn** |
| High | 3.00× | $5.79 bn | $5.29 bn (91.4%) | $6.83 bn | **$12.12 bn** |

At the default 2.00× case, OSR's $501 M external requirement is 87.0% below the illustrative foreign-company requirement of $3.86 bn; the associated lifetime external-interest saving is $4.34 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$253 M / yr** | $90 |
| Steady-state, low capacity-use (year 11+) | **$222 M / yr** | $79 |
| Steady-state, high capacity-use (year 11+) | **$191 M / yr** | $68 |
| Steady-state, operating-neutral revenue case | **$231 M / yr** | $83 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.20 bn cumulative** | $3,285 |
| Lifecycle envelope (yr 1–40, high scenario) | **$8.25 bn cumulative** | $2,947 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.46 bn cumulative** | $3,378 |

_Population basis: 2,800,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.6 M / yr → $40 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $501 M | 4.5% | 40 y, 10 y grace | $31 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.32 bn | 15.0% | 40 y, 10 y grace | $200 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $329 M | — | — | — |
| **Total** | **100%** | **$2.14 bn** | | | **$231 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $23 M / yr + local bonds $197 M / yr = **$220 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($33 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 149.8 M |
| Annual paid trips / city resident | 64 | 102 | 54 |
| Farebox revenue | $53 M / yr | $84 M / yr | $44 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| **Total revenue** | **$57 M / yr** | **$88 M / yr** | **$48 M / yr** |
| Revenue / OPEX recovery | 118% | 183% | 100% |
...
| Operating surplus applied to debt support | -$8.6 M / yr | -$40 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $222 M / yr | $191 M / yr | **$231 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.6 M / yr | $40 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.64 bn | 77% of $2.14 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.63 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $263 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 311,351 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $501 M (23.3%) |
| Local-content / local-funding requirement | $1.64 bn (76.7%) |
| Default foreign-turnkey external-capital comparison | $3.86 bn; OSR saves $3.36 bn (87.0%) |
| Lifetime external interest and combined financing saving | $4.34 bn interest; $7.70 bn capital + interest |
| 15%–25% planning risk envelope | $2.47 bn–$2.68 bn |
| Annual OPEX | $48 M / yr |
| Low/high project NPV at 8% | $-1394095 k / $-1229605 k |
| Low/high project IRR | -8.8% / -2.7% |
