...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.61 bn (87.3%) of external capital** and **$4.66 bn of external interest**. Capital plus saved interest totals **$8.27 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $1.01 bn | 15% | $151 M | $857 M |
...
| EPC / project services | $135 M | 15% | $20 M | $115 M |
| **Total city CAPEX** | **$2.30 bn** | **22.8%** | **$524 M** | **$1.77 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.8%** | **$524 M** | **$52 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.2%** | **$1.77 bn** | **$177 M / yr** |
| of which planned local bond issuance | 61.8% of total CAPEX | $1.42 bn | $142 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $3.10 bn | $2.58 bn (83.1%) | $3.33 bn | **$5.91 bn** |
| **Default** | 2.00× | $4.13 bn | $3.61 bn (87.3%) | $4.66 bn | **$8.27 bn** |
| High | 3.00× | $6.20 bn | $5.68 bn (91.6%) | $7.33 bn | **$13.01 bn** |

At the default 2.00× case, OSR's $524 M external requirement is 87.3% below the illustrative foreign-company requirement of $4.13 bn; the associated lifetime external-interest saving is $4.66 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$272 M / yr** | $97 |
| Steady-state, low capacity-use (year 11+) | **$242 M / yr** | $87 |
| Steady-state, high capacity-use (year 11+) | **$211 M / yr** | $75 |
| Steady-state, operating-neutral revenue case | **$248 M / yr** | $89 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.99 bn cumulative** | $3,567 |
| Lifecycle envelope (yr 1–40, high scenario) | **$9.04 bn cumulative** | $3,229 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.16 bn cumulative** | $3,629 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $524 M | 4.5% | 40 y, 10 y grace | $32 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.42 bn | 15.0% | 40 y, 10 y grace | $216 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $355 M | — | — | — |
| **Total** | **100%** | **$2.30 bn** | | | **$248 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $24 M / yr + local bonds $213 M / yr = **$236 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($35 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $248 M / yr | $248 M / yr | **$248 M / yr** |
| Operating surplus applied to debt support | -$5.8 M / yr | -$37 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $242 M / yr | $211 M / yr | **$248 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.77 bn | 77% of $2.30 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.84 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $284 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 335,780 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $524 M (22.8%) |
| Local-content / local-funding requirement | $1.77 bn (77.2%) |
| Default foreign-turnkey external-capital comparison | $4.13 bn; OSR saves $3.61 bn (87.3%) |
| Lifetime external interest and combined financing saving | $4.66 bn interest; $8.27 bn capital + interest |
| 15%–25% planning risk envelope | $2.64 bn–$2.87 bn |
| Annual OPEX | $51 M / yr |
| Low/high project NPV at 8% | $-1510709 k / $-1346220 k |
| Low/high project IRR | -10.5% / -3.3% |
| Low/high steady-state DSCR | 0.02 / 0.15 |
