...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **95,125 – 171,225 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$13 M / yr** | $25 |
| Steady-state, low-ridership (year 11+) | **$20 M / yr** | $39 |
| Steady-state, high-ridership (year 11+) | **$14 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$14 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$717 M cumulative** | $1,434 |
| Lifecycle envelope (yr 1–40, high scenario) | **$547 M cumulative** | $1,094 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$547 M cumulative** | $1,094 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $251 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $314 M | 2.0% | 40 y, 10 y grace | $14 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 15.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $63 M | — | — | — |
| **Total** | **100%** | **$629 M** | | | **$14 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $6.3 M / yr + fallback bonds $0 k / yr = **$6.3 M / yr** total. The $251 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($6.3 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 95,125 | 171,225 | 148,046 |
| Daily paid trips / catchment | 25% | 45% | 39% |
| Daily paid trips / city population | 19% | 34% | 30% |
| Annual paid trips | 34.7 M | 62.5 M | 54.0 M |
| Farebox revenue | $10 M / yr | $18 M / yr | $16 M / yr |
| Station shop leases | $351 k / yr | $351 k / yr | $351 k / yr |
| Advertising boards | $503 k / yr | $503 k / yr | $503 k / yr |
| **Total revenue** | **$11 M / yr** | **$19 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 66% | 115% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $20 M / yr | $14 M / yr | **$14 M / yr** |
