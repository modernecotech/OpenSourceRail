...
|---|---|---|---|---|
| line-1 | 13.5 km | 9 | 23 | N Outer ↔ S Outer |
| line-2 | 11.0 km | 7 | 19 | S Mid ↔ NW Mid |
| line-3 |  8.8 km | 6 | 16 | S Mid ↔ NE Mid |
| **Total** | **33.3 km** | **22 unique** | **58** | |
...
| Total fleet capacity | 20,880 AW2 pax (27,840 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 51 × 360 = **18,360 AW2 passengers** (24,480 AW3 crush)
- **Total fleet passenger capacity:** 58 × 360 = **20,880 AW2 passengers** (27,840 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **34.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 218 MWh/day | 16,830 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 151 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 34.8 MW / 174 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 58 | $4.20 M | $244 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 174 | $100 k | $17 M |
| High sensitivity check | 174 | $200 k | $35 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 34,757 kW @ $700/kW | $24 M |
| Grid interconnection / PPA tie-in | 34,757 kW @ $100/kW | $3.5 M |
| Annual generation proxy | 34.8 MW × 5.0 peak-sun-h/day × 365 d/yr | 63.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$21 M / yr** | $42 |
| Steady-state, low capacity-use (year 11+) | **$17 M / yr** | $34 |
| Steady-state, high capacity-use (year 11+) | **$5.9 M / yr** | $12 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$718 M cumulative** | $1,435 |
| Lifecycle envelope (yr 1–40, high scenario) | **$385 M cumulative** | $769 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$831 M cumulative** | $1,662 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.8 M / yr → $15 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $464 M | 2.0% | 40 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $116 M | — | — | — |
| **Total** | **100%** | **$581 M** | | | **$21 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $9.3 M / yr = **$9.3 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($12 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (79.6 GWh / yr) | 16,830 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.5 GWh/yr + dedicated solar plant 34.8 MW / 63.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $417 k |
| Labour (311 FTE) | driverless roster: OCC/remote 49, station/platform 88, passenger service 44, fleet maintenance 40, infrastructure/energy 54, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $575 k |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 16,830 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.6 M train-km / yr (19.9 M car-km / yr). On-site PV covers 24.5 GWh/yr and the dedicated solar plant adds 63.4 GWh/yr against 79.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 50.2 M |
| Annual paid trips / city resident | 126 | 202 | 100 |
...
| **Total revenue** | **$19 M / yr** | **$31 M / yr** | **$16 M / yr** |
...
| Operating surplus applied to debt support | -$3.8 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $17 M / yr | $5.9 M / yr | **$21 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.8 M / yr | $15 M / yr | $0 / yr |
...
| Avoided road congestion | $7.6 M / yr | $12 M / yr | 95 M - 151 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.4 M / yr | $2.2 M / yr | 17.0–27.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.8 M / yr | $6.0 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $21 M / yr | $34 M / yr | 23% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 10,305 trips/school day; 2.3 M access-events/yr | 16,488 trips/school day; 3.6 M access-events/yr |
| Healthcare | 2 healthcare anchors | 13,007 trips/day; 4.7 M access-events/yr | 20,811 trips/day; 7.6 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 39,194 trips/trading day; 12.9 M access-events/yr | 62,711 trips/trading day; 20.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $308 M | 53% of $581 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $493 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $49 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 58,302 job-years | retained CAPEX ÷ (4.0 × median annual income) |
