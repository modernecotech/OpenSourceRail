...
|---|---|---|
| Construction (years 1–10) | **$32 M / yr** | $64 |
| Steady-state, low-ridership (year 11+) | **$36 M / yr** | $73 |
| Steady-state, high-ridership (year 11+) | **$32 M / yr** | $65 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.41 bn cumulative** | $2,821 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.29 bn cumulative** | $2,588 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.26 bn cumulative** | $2,525 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.9 M / yr → $1.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $274 M | 3.0% | 40 y, 10 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $114 M | 15.0% | 40 y, 10 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $68 M | — | — | — |
| **Total** | **100%** | **$456 M** | | | **$31 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $8.2 M / yr + bonds $17 M / yr = **$25 M / yr** total — plus the equity tranche amortised across construction ($6.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 72,450 | 120,750 | 133,970 |
| Daily paid trips / catchment | 18% | 30% | 33% |
| Daily paid trips / city population | 14% | 24% | 27% |
| Annual paid trips | 26.4 M | 44.1 M | 48.9 M |
| Farebox revenue | $5.8 M / yr | $9.7 M / yr | $11 M / yr |
| Station shop leases | $402 k / yr | $402 k / yr | $402 k / yr |
| Advertising boards | $572 k / yr | $572 k / yr | $572 k / yr |
| **Total revenue** | **$6.8 M / yr** | **$11 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 58% | 91% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $36 M / yr | $32 M / yr | **$31 M / yr** |
