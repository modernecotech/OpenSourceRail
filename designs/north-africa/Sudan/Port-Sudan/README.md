...
| Steady-state, high-ridership (year 11+) | **$12 M / yr** | $25 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$581 M cumulative** | $1,162 |
| Lifecycle envelope (yr 1–40, high scenario) | **$481 M cumulative** | $962 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$481 M cumulative** | $962 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.3 M / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $16 M / yr | $12 M / yr | **$12 M / yr** |
