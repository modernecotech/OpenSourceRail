...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $50 |
| Steady-state, low-ridership (year 11+) | **$32 M / yr** | $54 |
| Steady-state, high-ridership (year 11+) | **$29 M / yr** | $49 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.26 bn cumulative** | $2,106 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.18 bn cumulative** | $1,963 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.18 bn cumulative** | $1,963 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.9 M / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $106 M | 15.0% | 40 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$426 M** | | | **$29 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $7.7 M / yr + bonds $16 M / yr = **$24 M / yr** total — plus the equity tranche amortised across construction ($6.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Operating surplus after OPEX | $0 k / yr | $683 k / yr | $0 / yr |
