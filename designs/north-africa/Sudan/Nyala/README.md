...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **92,100 – 165,780 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$15 M / yr** | $25 |
| Steady-state, low-ridership (year 11+) | **$27 M / yr** | $44 |
| Steady-state, high-ridership (year 11+) | **$19 M / yr** | $31 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$949 M cumulative** | $1,582 |
| Lifecycle envelope (yr 1–40, high scenario) | **$712 M cumulative** | $1,187 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$657 M cumulative** | $1,095 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.7 M / yr → $1.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $302 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $378 M | 2.0% | 40 y, 10 y grace | $17 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 15.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $76 M | — | — | — |
| **Total** | **100%** | **$756 M** | | | **$17 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $7.6 M / yr + fallback bonds $0 k / yr = **$7.6 M / yr** total. The $302 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($7.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 92,100 | 165,780 | 182,978 |
| Daily paid trips / catchment | 25% | 45% | 50% |
| Daily paid trips / city population | 15% | 28% | 30% |
| Annual paid trips | 33.6 M | 60.5 M | 66.8 M |
| Farebox revenue | $9.9 M / yr | $18 M / yr | $20 M / yr |
| Station shop leases | $373 k / yr | $373 k / yr | $373 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$11 M / yr** | **$19 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 53% | 91% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $27 M / yr | $19 M / yr | **$17 M / yr** |
