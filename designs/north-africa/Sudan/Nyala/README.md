...
| Per-capita (city pop) | $587 / person |
...
|---|---|---|
| Construction (years 1–10) | **$25 M / yr** | $41 |
| Steady-state, low-ridership (year 11+) | **$26 M / yr** | $43 |
| Steady-state, high-ridership (year 11+) | **$24 M / yr** | $40 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.02 bn cumulative** | $1,697 |
| Lifecycle envelope (yr 1–40, high scenario) | **$974 M cumulative** | $1,623 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$974 M cumulative** | $1,623 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.5 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $211 M | 3.0% | 40 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $88 M | 15.0% | 40 y, 10 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $53 M | — | — | — |
| **Total** | **100%** | **$352 M** | | | **$24 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.3 M / yr + bonds $13 M / yr = **$20 M / yr** total — plus the equity tranche amortised across construction ($5.3 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 66,312 | 110,520 | 84,825 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 11% | 18% | 14% |
| Annual paid trips | 24.2 M | 40.3 M | 31.0 M |
| Farebox revenue | $5.3 M / yr | $8.9 M / yr | $6.8 M / yr |
| Station shop leases | $373 k / yr | $373 k / yr | $373 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$6.3 M / yr** | **$9.8 M / yr** | **$7.7 M / yr** |
| Revenue / OPEX recovery | 81% | 127% | 100% |
