...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **66,312 – 110,520 trips/day**
...
| Per-capita (city pop) | $537 / person |
...
|---|---|---|
| Construction (years 1–10) | **$23 M / yr** | $38 |
| Steady-state, low-ridership (year 11+) | **$23 M / yr** | $38 |
| Steady-state, high-ridership (year 11+) | **$22 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$919 M cumulative** | $1,532 |
| Lifecycle envelope (yr 1–40, high scenario) | **$891 M cumulative** | $1,486 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$891 M cumulative** | $1,486 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $930 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $193 M | 3.0% | 40 y, 10 y grace | $9.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $81 M | 15.0% | 40 y, 10 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $48 M | — | — | — |
| **Total** | **100%** | **$322 M** | | | **$22 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $5.8 M / yr + bonds $12 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($4.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 66,312 | 110,520 | 77,900 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 11% | 18% | 13% |
| Annual paid trips | 24.2 M | 40.3 M | 28.4 M |
| Farebox revenue | $5.3 M / yr | $8.9 M / yr | $6.3 M / yr |
| Station shop leases | $373 k / yr | $373 k / yr | $373 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$6.3 M / yr** | **$9.8 M / yr** | **$7.2 M / yr** |
| Revenue / OPEX recovery | 87% | 136% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $23 M / yr | $22 M / yr | **$22 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $2.6 M / yr | $0 / yr |
