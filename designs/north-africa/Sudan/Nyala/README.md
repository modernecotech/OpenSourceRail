...
|---|---|---|---|---|
| line-1 | 19.4 km | 11 | 31 | E Outer ↔ SW Outer |
| line-2 | 15.3 km | 10 | 26 | S Outer ↔ N Outer |
| line-3 | 11.9 km | 8 | 20 | SE Mid ↔ NW Outer |
| **Total** | **46.7 km** | **29 unique** | **77** | |
...
| **Total installed** | **29** | **15,000 kW** | **104,000 kWh** |
...
| PV daily yield proxy | 75 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 306 MWh/day | 23,586 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 231 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 53.1 MW / 265 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Bucket | Value |
|---|---|
| At-grade (37.3 km @ $3.0 M/km) | $112 M |
| Elevated (9.3 km @ $12.0 M/km) | $111 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 53,054 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 53,054 kW @ $100/kW | $5.3 M |
| Annual generation proxy | 53.1 MW × 5.0 peak-sun-h/day × 365 d/yr | 96.8 GWh/yr |
...
| Per-capita (city pop) | $1,330 / person |
...
| Steady-state, low capacity-use (year 11+) | **$30 M / yr** | $51 |
| Steady-state, high capacity-use (year 11+) | **$19 M / yr** | $32 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.20 bn cumulative** | $1,996 |
| Lifecycle envelope (yr 1–40, high scenario) | **$864 M cumulative** | $1,441 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.14 bn cumulative** | $1,904 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.8 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $9.3 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $638 M | 2.0% | 40 y, 10 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $160 M | — | — | — |
| **Total** | **100%** | **$798 M** | | | **$29 M / yr** |
...
| Traction energy (111.6 GWh / yr) | 23,586 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 53.1 MW / 96.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $637 k |
| Labour (349 FTE) | driverless roster: OCC/remote 57, station/platform 92, passenger service 44, fleet maintenance 55, infrastructure/energy 65, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $645 k |
| **OPEX subtotal** | | **$21 M / yr** |

_Annual service work: 23,586 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.3 M train-km / yr (27.9 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 96.8 GWh/yr against 111.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 69.3 M |
| Annual paid trips / city resident | 105 | 168 | 116 |
| Farebox revenue | $19 M / yr | $30 M / yr | $20 M / yr |
| Station shop leases | $373 k / yr | $373 k / yr | $373 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$19 M / yr** | **$31 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 91% | 144% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $30 M / yr | $29 M / yr | **$29 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$9.3 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $30 M / yr | $19 M / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $0 k / yr | $9.3 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,528 m² of station shop/kiosk leases at $10/m²/month and 716 advertising boards at $77/board/month, with occupancy derates applied._
...
| Commerce | 9 major/terminal/interchange nodes | 34,246 trips/trading day; 11.3 M access-events/yr | 54,793 trips/trading day; 18.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $427 M | 54% of $798 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $683 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $68 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 80,905 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
cargo run --release --bin osr-design -- --slug nyala \
    --sidecar .cache/osr-pipeline/rasters/nyala.grid.json \
    --out-dir designs/.../Nyala
...
python -m osr_scenario.network_readme \
    ...
    --scenario designs/.../nyala.toml \
    --out designs/.../README.md
```

`scripts/regenerate-nyala.sh` chains steps 3 + drift tests into a single command.
