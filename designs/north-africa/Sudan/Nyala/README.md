...
|---|---|---|
| Construction (years 1–10) | **$43 M / yr** | $72 |
| Steady-state, low-ridership (year 11+) | **$52 M / yr** | $86 |
| Steady-state, high-ridership (year 11+) | **$48 M / yr** | $80 |
| Steady-state, operating-neutral revenue case | **$42 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.99 bn cumulative** | $3,309 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.88 bn cumulative** | $3,131 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.70 bn cumulative** | $2,839 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.4 M / yr → $5.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $370 M | 3.0% | 40 y, 10 y grace | $19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $154 M | 15.0% | 40 y, 10 y grace | $23 M / yr |
| Government equity (no debt service) | 15% | $92 M | — | — | — |
| **Total** | **100%** | **$616 M** | | | **$42 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $23 M / yr = **$34 M / yr** total — plus the equity tranche amortised across construction ($9.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 66,312 | 110,520 | 183,298 |
| Daily paid trips / catchment | 18% | 30% | 50% |
| Daily paid trips / city population | 11% | 18% | 31% |
| Annual paid trips | 24.2 M | 40.3 M | 66.9 M |
| Farebox revenue | $5.3 M / yr | $8.9 M / yr | $15 M / yr |
| Station shop leases | $373 k / yr | $373 k / yr | $373 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$6.3 M / yr** | **$9.8 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 40% | 63% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $52 M / yr | $48 M / yr | **$42 M / yr** |
