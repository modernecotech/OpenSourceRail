...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$641 M (87.0%) of external capital** and **$829 M of external interest**. Capital plus saved interest totals **$1.47 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`el-obeid.corridor.geojson`](el-obeid.corridor.geojson).
...
| Anchor-weighted coverage | 69.7% |
| Route length (double track) | 47.2 km |
| Revenue fleet | 91 × 3-car trainsets |
| Revenue fleet passenger capacity | 32,760 AW2 pax (43,680 AW3 crush) |
...
| Revenue fleet capacity | 32,760 AW2 pax (43,680 AW3 crush) |
| Total fleet capacity | 36,720 AW2 pax (48,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 91 × 360 = **32,760 AW2 passengers** (43,680 AW3 crush)
- **Total fleet passenger capacity:** 102 × 360 = **36,720 AW2 passengers** (48,960 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 69.7%
- Catchment population: **≈ 348,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **42.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 494 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 44 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 62 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 21,970 train-km/day | One-way train journeys × route length |
| Annual service work | 8.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 285 MWh/day | 26.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 222 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 42.6 MW / 256 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 132 kWh | 200 kWh | 55 kWh | 5.7 km / 46 kWh |
| line-2 | 7 | 141 kWh | 204 kWh | 49 kWh | 5.4 km / 43 kWh |
| line-3 | 5 | 108 kWh | 163 kWh | 44 kWh | 3.5 km / 28 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 102 | $900 k | $92 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 306 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 306 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,613 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,613 kW @ $100/kW | $4.3 M |
| Annual generation proxy | 42.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 93.3 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 47.2 km × $0.050 M/km | $2.4 M |
...
| EPC integration + project management (7%) | on subtotal | $25 M |
...
| Residual train-control wayside + charging microgrids | $4.5 M |
| EPC overhead (7%) | $25 M |
| **CAPEX total** | **$410 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $168 M | 15% | $25 M | $143 M |
| Stations | $79 M | 20% | $16 M | $63 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $92 M | 35% | $32 M | $60 M |
| Dedicated solar plant | $34 M | 45% | $15 M | $19 M |
| Residual signalling / train control | $2.4 M | 50% | $1.2 M | $1.2 M |
| Charging microgrids | $2.1 M | 40% | $840 k | $1.3 M |
| EPC / project services | $25 M | 15% | $3.7 M | $21 M |
| **Total city CAPEX** | **$410 M** | **23.5%** | **$96 M** | **$314 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh el-obeid`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.5%** | **$96 M** | **$9.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.5%** | **$314 M** | **$31 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $251 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$410 M** | **$41 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $553 M | $457 M (82.6%) | $590 M | **$1.05 bn** |
| **Default** | 2.00× | $738 M | $641 M (87.0%) | $829 M | **$1.47 bn** |
| High | 3.00× | $1.11 bn | $1.01 bn (91.3%) | $1.30 bn | **$2.32 bn** |

At the default 2.00× case, OSR's $96 M external requirement is 87.0% below the illustrative foreign-company requirement of $738 M; the associated lifetime external-interest saving is $829 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$48 M / yr** | $96 |
| Steady-state, low capacity-use (year 11+) | **$32 M / yr** | $64 |
| Steady-state, high capacity-use (year 11+) | **$19 M / yr** | $38 |
| Steady-state, operating-neutral revenue case | **$44 M / yr** | $88 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.44 bn cumulative** | $2,877 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.05 bn cumulative** | $2,103 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.81 bn cumulative** | $3,612 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $12 M / yr → $25 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $96 M | 4.5% | 40 y, 10 y grace | $5.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $251 M | 15.0% | 40 y, 10 y grace | $38 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$410 M** | | | **$44 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.3 M / yr + local bonds $38 M / yr = **$42 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.3 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $118 k |
| Traction energy (103.9 GWh / yr) | 21,970 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.8 GWh/yr + dedicated solar plant 42.6 MW / 93.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $511 k |
| Labour (306 FTE) | driverless roster: OCC/remote 69, station/platform 65, passenger service 49, fleet maintenance 60, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $565 k |
| **OPEX subtotal** | | **$10.0 M / yr** |

_Annual service work: 21,970 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.7 M train-km / yr (26.0 M car-km / yr). On-site PV covers 22.8 GWh/yr and the dedicated solar plant adds 93.3 GWh/yr against 103.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 102 trainsets, 19 stations, 47.2 route-km, 3 lines, and 21,970 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 31.6 M |
| Annual paid trips / city resident | 147 | 235 | 63 |
| Farebox revenue | $22 M / yr | $34 M / yr | $9.3 M / yr |
| Station shop leases | $279 k / yr | $279 k / yr | $279 k / yr |
| Advertising boards | $418 k / yr | $418 k / yr | $418 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$10.0 M / yr** |
| Revenue / OPEX recovery | 223% | 352% | 100% |
...
| Operating surplus applied to debt support | -$12 M / yr | -$25 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $32 M / yr | $19 M / yr | **$44 M / yr** |
| Operating surplus after OPEX (before debt support) | $12 M / yr | $25 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,640 m² of station shop/kiosk leases at $10/m²/month and 532 advertising boards at $77/board/month, with occupancy derates applied._
...
| Avoided road congestion | $12 M / yr | $20 M / yr | 156 M - 249 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.2 M / yr | $3.6 M / yr | 28.0–44.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.2 M / yr | $10.0 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$61 M / yr** | **$98 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 11,651 trips/school day; 2.6 M access-events/yr | 18,642 trips/school day; 4.1 M access-events/yr |
| Healthcare | 0 healthcare anchors | 12,053 trips/day; 4.4 M access-events/yr | 19,284 trips/day; 7.0 M access-events/yr |
| Commerce | 8 major/terminal/interchange nodes | 41,022 trips/trading day; 13.5 M access-events/yr | 65,635 trips/trading day; 21.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $314 M | 77% of $410 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $502 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $50 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 59,398 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $376 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$410 M** |
| Imported / external-capital requirement | $96 M (23.5%) |
| Local-content / local-funding requirement | $314 M (76.5%) |
| Default foreign-turnkey external-capital comparison | $738 M; OSR saves $641 M (87.0%) |
| Lifetime external interest and combined financing saving | $829 M interest; $1.47 bn capital + interest |
| 15%–25% planning risk envelope | $471 M–$512 M |
| Annual OPEX | $10.0 M / yr |
| Low/high project NPV at 8% | $-211135 k / $-143843 k |
| Low/high project IRR | -0.5% / 3.3% |
| Low/high steady-state DSCR | 0.28 / 0.57 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,880.03 train-km; 15,162.11 kWh consumed; 14,034.76 kWh charged; 32 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,734.98 train-km; 175,287.06 kWh consumed; 176,770.22 kWh charged; 511 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 98.9% of scheduled train-km delivered; 24 SoC warnings; 1 energy-adapted off-peak departures, maximum 15 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 98.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 97.8% / 90% | pass |
| 50% charging-contact availability | 20.0% | 98.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 86.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 98.9% / 90% | pass |
...
|---|---|
| ![El-Obeid energy and battery simulation dashboard](engineering/screenshots/el-obeid-simulation-dashboard.png) | ![El-Obeid simulator network visualizer](engineering/screenshots/el-obeid-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![El-Obeid QGIS engineering layers](engineering/screenshots/el-obeid-qgis-engineering-map.png) | ![El-Obeid SUMO timetable validation](engineering/screenshots/el-obeid-sumo-validation.png) |
...
| [`el-obeid.toml`](el-obeid.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`el-obeid-network-map.png`](el-obeid-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`el-obeid.corridor.geojson`](el-obeid.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`el-obeid.stations.json`](el-obeid.stations.json) | Machine-readable station list |
| [`el-obeid.design-quality.yaml`](el-obeid.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug el-obeid

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh el-obeid
```
