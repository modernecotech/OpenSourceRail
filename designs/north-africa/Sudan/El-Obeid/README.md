...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **90,625 – 163,125 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$14 M / yr** | $28 |
| Steady-state, low-ridership (year 11+) | **$25 M / yr** | $49 |
| Steady-state, high-ridership (year 11+) | **$17 M / yr** | $34 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $31 |
| Lifecycle envelope (yr 1–40, low scenario) | **$878 M cumulative** | $1,756 |
| Lifecycle envelope (yr 1–40, high scenario) | **$645 M cumulative** | $1,291 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$610 M cumulative** | $1,220 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.9 M / yr → $1.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $280 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $351 M | 2.0% | 40 y, 10 y grace | $16 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 15.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $70 M | — | — | — |
| **Total** | **100%** | **$701 M** | | | **$16 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $7.0 M / yr + fallback bonds $0 k / yr = **$7.0 M / yr** total. The $280 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($7.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 90,625 | 163,125 | 174,144 |
| Daily paid trips / catchment | 25% | 45% | 48% |
| Daily paid trips / city population | 18% | 33% | 35% |
| Annual paid trips | 33.1 M | 59.5 M | 63.6 M |
| Farebox revenue | $9.7 M / yr | $17 M / yr | $19 M / yr |
| Station shop leases | $374 k / yr | $374 k / yr | $374 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$11 M / yr** | **$18 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 54% | 94% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $25 M / yr | $17 M / yr | **$16 M / yr** |
