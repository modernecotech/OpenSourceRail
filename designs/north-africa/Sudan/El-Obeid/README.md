...
|---|---|---|---|---|
| line-1 | 16.3 km | 10 | 42 | N Outer ↔ S Outer |
| line-2 | 17.5 km | 10 | 43 | NE Outer ↔ SW Outer |
| line-3 | 13.4 km | 8 | 35 | S Outer ↔ NE Outer |
| **Total** | **47.2 km** | **28 unique** | **120** | |
...
| Onboard battery adequacy | 31.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 39.5 MW / 237 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 132 kWh | 212 kWh | 67 kWh | 2.0 km / 16 kWh |
| line-2 | 10 | 141 kWh | 220 kWh | 66 kWh | 2.1 km / 17 kWh |
| line-3 | 8 | 108 kWh | 172 kWh | 52 kWh | 2.0 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,508 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,508 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 39.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 86.5 GWh/yr |
...
| Steady-state, high capacity-use (year 11+) | **$848 k / yr** | $2 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$693 M cumulative** | $1,386 |
| Lifecycle envelope (yr 1–40, high scenario) | **$306 M cumulative** | $612 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $2,038 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $401 M | 4.5% | 40 y, 10 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $100 M | — | — | — |
| **Total** | **100%** | **$501 M** | | | **$25 M / yr** |
...
| Traction energy (103.9 GWh / yr) | 21,970 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.7 GWh/yr + dedicated solar plant 39.5 MW / 86.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $474 k |
| Labour (349 FTE) | driverless roster: OCC/remote 77, station/platform 92, passenger service 49, fleet maintenance 65, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $645 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 21,970 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.7 M train-km / yr (26.0 M car-km / yr). On-site PV covers 28.7 GWh/yr and the dedicated solar plant adds 86.5 GWh/yr against 103.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 120 trainsets, 28 stations, 47.2 route-km, 3 lines, and 21,970 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 36.3 M |
| Annual paid trips / city resident | 147 | 235 | 73 |
| Farebox revenue | $22 M / yr | $34 M / yr | $11 M / yr |
| Station shop leases | $394 k / yr | $394 k / yr | $394 k / yr |
| Advertising boards | $584 k / yr | $584 k / yr | $584 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 193% | 304% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $14 M / yr | $848 k / yr | **$25 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $24 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,728 m² of station shop/kiosk leases at $10/m²/month and 744 advertising boards at $77/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $284 M | 57% of $501 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $455 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $45 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 53,858 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$501 M** |
| 15%–25% planning risk envelope | $576 M–$626 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-279590 k / $-212299 k |
| Low/high project IRR | -2.1% / 1.8% |
| Low/high steady-state DSCR | 0.44 / 0.97 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,884.62 train-km; 15,198.97 kWh consumed; 15,661.10 kWh charged; 30 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,738.60 train-km; 183,380.24 kWh consumed; 186,746.65 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 50.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 59.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.5% / 60% | pass |
| ten-hour single charging-pad outage | 38.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 28 line platforms, 3 interchange complexes, 9 civil segments, and 0 input findings |
