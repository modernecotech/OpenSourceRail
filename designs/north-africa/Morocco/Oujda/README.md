...
| Bucket | Value |
|---|---|
| At-grade (44.5 km @ €3.5 M/km) | €156 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.9 km × €0.015 M/km | €0.7 M |
...
| Steady-state, low-ridership (year 6+) | **€43 M / yr** | €72 |
| Steady-state, high-ridership (year 6+) | **€36 M / yr** | €61 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.05 bn cumulative** | €1,744 |
| Lifecycle envelope (yr 1–25, high scenario) | **€909 M cumulative** | €1,514 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€8.1 M / yr (low) → €1.2 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €337 M | 3.8% | 25 y, 5 y grace | €24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €141 M | 4.5% | 25 y, 5 y grace | €11 M / yr |
| Government equity (no debt service) | 15% | €84 M | — | — | — |
| **Total** | **100%** | **€562 M** | | | **€35 M / yr** |
...
| Farebox / OPEX recovery | 46% | 92% |
| Country policy-target recovery (diagnostic) | 60% | 60% |
| Operating shortfall (gov subsidy required) | €8.1 M / yr | €1.2 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€43 M / yr** | **€36 M / yr** |
