...
|---|---|---|---|---|
| line-1 | 19.6 km | 12 | 19 | SE Mid ↔ N Outer |
| line-2 | 13.4 km | 10 | 14 | SE Mid ↔ N Mid |
| line-3 | 13.9 km | 11 | 15 | E Mid ↔ W Outer |
| **Total** | **46.9 km** | **33 unique** | **48** | |
...
| Bucket | Value |
|---|---|
| At-grade (44.5 km @ $2.0 M/km) | $89 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.9 km × $0.015 M/km | $2.3 M |
...
| Per-capita (city pop) | $445 / person |
...
| Steady-state, low-ridership (year 6+) | **$17 M / yr** | $28 |
| Steady-state, high-ridership (year 6+) | **$17 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $28 |
| Lifecycle envelope (yr 1–25, low scenario) | **$420 M cumulative** | $700 |
| Lifecycle envelope (yr 1–25, high scenario) | **$420 M cumulative** | $700 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$420 M cumulative** | $700 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $160 M | 3.8% | 25 y, 5 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $67 M | 4.5% | 25 y, 5 y grace | $5.1 M / yr |
| Government equity (no debt service) | 15% | $40 M | — | — | — |
| **Total** | **100%** | **$267 M** | | | **$17 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $6.1 M / yr + bonds $3.0 M / yr = **$9.1 M / yr** total — plus the equity tranche amortised across construction ($8.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (293 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $2.0 M |
