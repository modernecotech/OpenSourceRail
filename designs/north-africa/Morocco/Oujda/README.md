...
|---|---|---|---|---|
| line-1 | 13.0 km | 9 | 31 | W Outer ↔ E Outer |
| line-2 | 12.8 km | 9 | 31 | N Outer ↔ S Outer |
| line-3 | 11.7 km | 8 | 29 | N Outer ↔ SW Outer |
| **Total** | **37.5 km** | **26 unique** | **91** | |
...
| Total fleet capacity | 32,760 AW2 pax (43,680 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 82 × 360 = **29,520 AW2 passengers** (39,360 AW3 crush)
- **Total fleet passenger capacity:** 91 × 360 = **32,760 AW2 passengers** (43,680 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **28.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 27.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 521 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 28.9 MW / 174 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 105 kWh | 172 kWh | 57 kWh | 2.0 km / 16 kWh |
| line-2 | 9 | 104 kWh | 163 kWh | 49 kWh | 2.0 km / 16 kWh |
| line-3 | 8 | 94 kWh | 147 kWh | 43 kWh | 2.4 km / 19 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 91 | $900 k | $82 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 273 | $60 k | $16 M |
| High sensitivity check | 273 | $120 k | $33 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 28,940 kW @ $700/kW | $20 M |
| Grid interconnection / PPA tie-in | 28,940 kW @ $100/kW | $2.9 M |
| Annual generation proxy | 28.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 63.4 GWh/yr |
...
| Per-capita (city pop) | $701 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$160 M cumulative** | $266 |
| Lifecycle envelope (yr 1–40, high scenario) | **$160 M cumulative** | $266 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$835 M cumulative** | $1,391 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $337 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $84 M | — | — | — |
| **Total** | **100%** | **$421 M** | | | **$19 M / yr** |
...
| Traction energy (82.5 GWh / yr) | 17,437 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 28.9 MW / 63.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $347 k |
| Labour (336 FTE) | driverless roster: OCC/remote 65, station/platform 112, passenger service 49, fleet maintenance 51, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 17,437 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.9 M train-km / yr (20.6 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 63.4 GWh/yr against 82.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 91 trainsets, 26 stations, 37.5 route-km, 3 lines, and 17,437 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 6.3 M |
...
| **Total revenue** | **$85 M / yr** | **$133 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 743% | 1165% | 100% |
...
_Commercial-revenue assumptions: 5,120 m² of station shop/kiosk leases at $33/m²/month and 952 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$94 M / yr** | **$150 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 8,870 trips/school day; 2.0 M access-events/yr | 14,191 trips/school day; 3.1 M access-events/yr |
| Healthcare | 3 healthcare anchors | 14,000 trips/day; 5.1 M access-events/yr | 22,400 trips/day; 8.2 M access-events/yr |
| Commerce | 22 major/terminal/interchange nodes | 49,988 trips/trading day; 16.5 M access-events/yr | 79,981 trips/trading day; 26.4 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 22,020 trips/activity day; 6.6 M access-events/yr | 35,231 trips/activity day; 10.6 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $240 M | 57% of $421 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 12,177 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $246 M / $627 M |
| Low/high project IRR | 13.2% / 19.5% |
| Low/high steady-state DSCR | 3.80 / 6.30 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,588.77 train-km; 12,812.84 kWh consumed; 13,326.24 kWh charged; 34 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,094.97 train-km; 145,929.62 kWh consumed; 148,716.74 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 68%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 61.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 57.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 68.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 99.7% / 60% | pass |
| ten-hour single charging-pad outage | 50.9% | 100.0% / 90% | pass |
