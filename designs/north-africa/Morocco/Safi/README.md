...
**Country:** MA · **Population:** 350,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$542 M (86.7%) of external capital** and **$666 M of external interest**. Capital plus saved interest totals **$1.21 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`safi.corridor.geojson`](safi.corridor.geojson).
...
| Anchor-weighted coverage | 72.5% |
| Route length (double track) | 39.3 km |
| Revenue fleet | 77 × 3-car trainsets |
| Revenue fleet passenger capacity | 27,720 AW2 pax (36,960 AW3 crush) |
...
| Revenue fleet capacity | 27,720 AW2 pax (36,960 AW3 crush) |
| Total fleet capacity | 30,960 AW2 pax (41,280 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 77 × 360 = **27,720 AW2 passengers** (36,960 AW3 crush)
- **Total fleet passenger capacity:** 86 × 360 = **30,960 AW2 passengers** (41,280 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 72.5%
- Catchment population: **≈ 253,750** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **38.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 468 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 38 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 54 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 18,254 train-km/day | One-way train journeys × route length |
| Annual service work | 7.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 237 MWh/day | 21.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 183 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 38.2 MW / 210 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 143 kWh | 229 kWh | 72 kWh | 10.0 km / 72 kWh |
| line-2 | 5 | 75 kWh | 122 kWh | 40 kWh | 3.5 km / 25 kWh |
| line-3 | 5 | 65 kWh | 110 kWh | 38 kWh | 2.3 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (38.1 km @ $2.58 M/km) | $99 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 86 | $900 k | $77 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 258 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 258 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,194 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,194 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 38.2 MW × 5.5 peak-sun-h/day × 365 d/yr | 76.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 39.3 km × $0.050 M/km | $2.0 M |
...
|---|---:|---:|---:|---:|
| Civil works | $114 M | 15% | $17 M | $97 M |
| Stations | $93 M | 20% | $19 M | $74 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $77 M | 35% | $27 M | $50 M |
| Dedicated solar plant | $31 M | 45% | $14 M | $17 M |
| Residual signalling / train control | $2.0 M | 50% | $981 k | $981 k |
| Charging microgrids | $1.9 M | 40% | $770 k | $1.2 M |
| EPC / project services | $21 M | 15% | $3.1 M | $18 M |
| **Total city CAPEX** | **$347 M** | **24.0%** | **$83 M** | **$264 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh safi`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$83 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$264 M** | **$53 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $211 M | $42 M / yr |
| **Total city programme** | **100.0%** | **$347 M** | **$69 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $469 M | $385 M (82.2%) | $474 M | **$859 M** |
| **Default** | 2.00× | $625 M | $542 M (86.7%) | $666 M | **$1.21 bn** |
| High | 3.00× | $937 M | $854 M (91.1%) | $1.05 bn | **$1.90 bn** |

At the default 2.00× case, OSR's $83 M external requirement is 86.7% below the illustrative foreign-company requirement of $625 M; the associated lifetime external-interest saving is $666 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$24 M / yr** | $68 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$119 M cumulative** | $340 |
| Lifecycle envelope (yr 1–40, high scenario) | **$119 M cumulative** | $340 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$709 M cumulative** | $2,026 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $83 M | 4.5% | 40 y, 5 y grace | $4.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $211 M | 4.5% | 40 y, 5 y grace | $12 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $53 M | — | — | — |
| **Total** | **100%** | **$347 M** | | | **$17 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.7 M / yr + local bonds $9.5 M / yr = **$13 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $3.1 M |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $4.3 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $98 k |
| Traction energy (86.3 GWh / yr) | 18,254 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.7 GWh/yr + dedicated solar plant 38.2 MW / 76.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $458 k |
| Labour (295 FTE) | driverless roster: OCC/remote 61, station/platform 77, passenger service 49, fleet maintenance 50, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$10.0 M / yr** |

_Annual service work: 18,254 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.2 M train-km / yr (21.6 M car-km / yr). On-site PV covers 19.7 GWh/yr and the dedicated solar plant adds 76.7 GWh/yr against 86.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 86 trainsets, 19 stations, 39.3 route-km, 3 lines, and 18,254 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 4% |
| Annual paid trips | 73.3 M | 117.3 M | 6.4 M |
| Annual paid trips / city resident | 209 | 335 | 18 |
| Farebox revenue | $80 M / yr | $128 M / yr | $7.0 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$83 M / yr** | **$131 M / yr** | **$10.0 M / yr** |
| Revenue / OPEX recovery | 834% | 1316% | 100% |
...
| Operating surplus after OPEX (before debt support) | $73 M / yr | $121 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,336 m² of station shop/kiosk leases at $33/m²/month and 636 advertising boards at $287/board/month, with occupancy derates applied._
...
| Avoided road congestion | $10 M / yr | $17 M / yr | 130 M - 207 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.9 M / yr | $3.0 M / yr | 23.3–37.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.2 M / yr | $8.3 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $35 M / yr | $56 M / yr | 23% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $16 M / yr | $25 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$91 M / yr** | **$146 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 13,042 trips/school day; 2.9 M access-events/yr | 20,867 trips/school day; 4.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $264 M | 76% of $347 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $422 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $84 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 13,406 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $317 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$347 M** |
| Imported / external-capital requirement | $83 M (24.0%) |
| Local-content / local-funding requirement | $264 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $625 M; OSR saves $542 M (86.7%) |
| Lifetime external interest and combined financing saving | $666 M interest; $1.21 bn capital + interest |
| 15%–25% planning risk envelope | $399 M–$434 M |
| Annual OPEX | $10.0 M / yr |
| Low/high project NPV at 8% | $303 M / $685 M |
| Low/high project IRR | 15.4% / 22.4% |
| Low/high steady-state DSCR | 4.34 / 7.19 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,634.59 train-km; 11,768.26 kWh consumed; 11,420.58 kWh charged; 34 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,888.87 train-km; 135,990.63 kWh consumed; 134,014.33 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 22%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 11 SoC warnings; 3 energy-adapted off-peak departures, maximum 14 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 22.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.7% / 60% | pass |
...
|---|---|
| ![Safi energy and battery simulation dashboard](engineering/screenshots/safi-simulation-dashboard.png) | ![Safi simulator network visualizer](engineering/screenshots/safi-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Safi QGIS engineering layers](engineering/screenshots/safi-qgis-engineering-map.png) | ![Safi SUMO timetable validation](engineering/screenshots/safi-sumo-validation.png) |
...
| [`safi.toml`](safi.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`safi-network-map.png`](safi-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`safi.corridor.geojson`](safi.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`safi.stations.json`](safi.stations.json) | Machine-readable station list |
| [`safi.design-quality.yaml`](safi.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
