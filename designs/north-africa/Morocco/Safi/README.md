...
|---|---|---|---|---|
| line-1 | 19.8 km | 13 | 49 | SE Outer ↔ NW Mid |
| line-2 | 10.4 km | 7 | 26 | N Mid ↔ SW Mid |
| line-3 |  9.1 km | 7 | 24 | NE Inner ↔ SW Mid |
| **Total** | **39.3 km** | **27 unique** | **99** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **35.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 49 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 67 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 35.4 MW / 195 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 143 kWh | 241 kWh | 84 kWh | 8.1 km / 58 kWh |
| line-2 | 7 | 75 kWh | 131 kWh | 49 kWh | 2.3 km / 16 kWh |
| line-3 | 7 | 65 kWh | 131 kWh | 59 kWh | 2.0 km / 14 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 297 | $60 k | $18 M |
| High sensitivity check | 297 | $120 k | $36 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 35,434 kW @ $700/kW | $25 M |
| Grid interconnection / PPA tie-in | 35,434 kW @ $100/kW | $3.5 M |
| Annual generation proxy | 35.4 MW × 5.5 peak-sun-h/day × 365 d/yr | 71.1 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh safi`.
...
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $58 |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$883 M cumulative** | $2,522 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $356 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $89 M | — | — | — |
| **Total** | **100%** | **$445 M** | | | **$20 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $16 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($18 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (86.3 GWh / yr) | 18,254 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.5 GWh/yr + dedicated solar plant 35.4 MW / 71.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $425 k |
| Labour (340 FTE) | driverless roster: OCC/remote 65, station/platform 112, passenger service 49, fleet maintenance 54, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 18,254 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.2 M train-km / yr (21.6 M car-km / yr). On-site PV covers 24.5 GWh/yr and the dedicated solar plant adds 71.1 GWh/yr against 86.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 99 trainsets, 27 stations, 39.3 route-km, 3 lines, and 18,254 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 20 |
...
| **Total revenue** | **$85 M / yr** | **$133 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 706% | 1107% | 100% |
...
_Commercial-revenue assumptions: 4,920 m² of station shop/kiosk leases at $33/m²/month and 920 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $35 M / yr | $55 M / yr | 23% of paid trips × $2.05 local spend proxy |
...
| Healthcare | 1 healthcare anchors | 13,107 trips/day; 4.8 M access-events/yr | 20,972 trips/day; 7.7 M access-events/yr |
| Commerce | 18 major/terminal/interchange nodes | 46,202 trips/trading day; 15.2 M access-events/yr | 73,924 trips/trading day; 24.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $252 M | 57% of $445 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 12,797 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$445 M** |
| 15%–25% planning risk envelope | $512 M–$556 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $220 M / $602 M |
| Low/high project IRR | 12.5% / 18.7% |
| Low/high steady-state DSCR | 3.56 / 5.92 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,601.10 train-km; 11,527.23 kWh consumed; 11,974.59 kWh charged; 32 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,898.21 train-km; 136,059.00 kWh consumed; 138,778.89 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 48.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 52.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
