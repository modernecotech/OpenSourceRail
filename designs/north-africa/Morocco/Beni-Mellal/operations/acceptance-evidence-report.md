...
| Item | Count / Status |
|---|---:|
| Assets in register | 199 |
| Manufacturing schedule rows | 781 |
| Manufacturing material/BOM rows | 12,074 |
| Manufacturing QA verification rows | 781 |
| Construction QA action rows | 735 |
| Maintenance handover schedule rows | 922 |
