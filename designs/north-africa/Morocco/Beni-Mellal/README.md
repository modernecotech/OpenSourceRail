...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$409 M (88.1%) of external capital** and **$503 M of external interest**. Capital plus saved interest totals **$913 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- **Total fleet passenger capacity:** 66 × 240 = **15,840 AW2 passengers** (21,120 AW3 crush, incl. service rotation + spare + reserve)
...
| Scheduled train journey-km | 14,050 train-km/day | One-way train journeys × route length |
| Annual service work | 5.5 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 121 MWh/day | 11.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 74 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 15.5 MW / 85 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 45 kWh | 98 kWh | 48 kWh | 4.4 km / 21 kWh |
| line-2 | 4 | 56 kWh | 106 kWh | 44 kWh | 7.0 km / 34 kWh |
| line-3 | 4 | 44 kWh | 90 kWh | 42 kWh | 6.1 km / 29 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 66 | $560 k | $37 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 132 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 132 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 15,491 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 15,491 kW @ $100/kW | $1.5 M |
| Annual generation proxy | 15.5 MW × 5.5 peak-sun-h/day × 365 d/yr | 31.1 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $3.0 M |
| EPC overhead (7%) | $16 M |
| **CAPEX total** | **$258 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $106 M | 15% | $16 M | $90 M |
| Stations | $76 M | 20% | $15 M | $61 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $37 M | 35% | $13 M | $24 M |
| Dedicated solar plant | $12 M | 45% | $5.6 M | $6.8 M |
| Residual signalling / train control | $1.5 M | 50% | $755 k | $755 k |
| Charging microgrids | $1.5 M | 40% | $610 k | $915 k |
| EPC / project services | $16 M | 15% | $2.4 M | $14 M |
| **Total city CAPEX** | **$258 M** | **21.4%** | **$55 M** | **$203 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh beni-mellal`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.4%** | **$55 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.6%** | **$203 M** | **$41 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $162 M | $32 M / yr |
| **Total city programme** | **100.0%** | **$258 M** | **$52 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $349 M | $293 M (84.1%) | $361 M | **$654 M** |
| **Default** | 2.00× | $465 M | $409 M (88.1%) | $503 M | **$913 M** |
| High | 3.00× | $697 M | $642 M (92.1%) | $789 M | **$1.43 bn** |

At the default 2.00× case, OSR's $55 M external requirement is 88.1% below the illustrative foreign-company requirement of $465 M; the associated lifetime external-interest saving is $503 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$18 M / yr** | $60 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $42 |
| Lifecycle envelope (yr 1–40, low scenario) | **$90 M cumulative** | $298 |
| Lifecycle envelope (yr 1–40, high scenario) | **$90 M cumulative** | $298 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$526 M cumulative** | $1,753 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $12 M / yr → $12 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $55 M | 4.5% | 40 y, 5 y grace | $3.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $162 M | 4.5% | 40 y, 5 y grace | $9.3 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $41 M | — | — | — |
| **Total** | **100%** | **$258 M** | | | **$12 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.5 M / yr + local bonds $7.3 M / yr = **$9.8 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (44.3 GWh / yr) | 14,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.3 GWh/yr + dedicated solar plant 15.5 MW / 31.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $186 k |
| Labour (242 FTE) | driverless roster: OCC/remote 53, station/platform 62, passenger service 38, fleet maintenance 39, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$7.2 M / yr** |

_Annual service work: 14,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.5 M train-km / yr (11.1 M car-km / yr). On-site PV covers 17.3 GWh/yr and the dedicated solar plant adds 31.1 GWh/yr against 44.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 66 trainsets, 14 stations, 30.2 route-km, 3 lines, and 14,050 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 4.4 M |
| Annual paid trips / city resident | 163 | 261 | 15 |
| Farebox revenue | $53 M / yr | $86 M / yr | $4.8 M / yr |
| Station shop leases | $920 k / yr | $920 k / yr | $920 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$56 M / yr** | **$88 M / yr** | **$7.2 M / yr** |
| Revenue / OPEX recovery | 775% | 1221% | 100% |
...
| Operating surplus applied to debt support | -$12 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$12 M / yr** |
| Operating surplus after OPEX (before debt support) | $49 M / yr | $81 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,656 m² of station shop/kiosk leases at $33/m²/month and 508 advertising boards at $287/board/month, with occupancy derates applied._
...
| Avoided CO2e | $957 k / yr | $1.5 M / yr | 12.0–19.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 12,588 trips/school day; 2.8 M access-events/yr | 20,142 trips/school day; 4.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $203 M | 79% of $258 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $325 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $65 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 10,309 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$258 M** |
| Imported / external-capital requirement | $55 M (21.4%) |
| Local-content / local-funding requirement | $203 M (78.6%) |
| Default foreign-turnkey external-capital comparison | $465 M; OSR saves $409 M (88.1%) |
| Lifetime external interest and combined financing saving | $503 M interest; $913 M capital + interest |
| 15%–25% planning risk envelope | $297 M–$323 M |
| Annual OPEX | $7.2 M / yr |
| Low/high project NPV at 8% | $180 M / $434 M |
| Low/high project IRR | 14.1% / 20.7% |
| Low/high steady-state DSCR | 3.90 / 6.47 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,267.09 train-km; 6,081.47 kWh consumed; 6,565.69 kWh charged; 38 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,211.92 train-km; 63,411.36 kWh consumed; 64,624.99 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 94.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 79.6% | 94.0% / 90% | pass |
| maximum planning climate/HVAC duty | 77.7% | 94.0% / 90% | pass |
| 50% charging-contact availability | 82.7% | 94.0% / 90% | pass |
| ten-hour all-site grid outage | 23.6% | 94.0% / 60% | pass |
| ten-hour single charging-pad outage | 82.7% | 94.0% / 90% | pass |
...
|---|---|
| ![Beni-Mellal energy and battery simulation dashboard](engineering/screenshots/beni-mellal-simulation-dashboard.png) | ![Beni-Mellal simulator network visualizer](engineering/screenshots/beni-mellal-network-visualizer.png) |
...
|---|---|
| ![Beni-Mellal QGIS engineering layers](engineering/screenshots/beni-mellal-qgis-engineering-map.png) | ![Beni-Mellal SUMO timetable validation](engineering/screenshots/beni-mellal-sumo-validation.png) |
...
scripts/regenerate-city.sh beni-mellal
```
