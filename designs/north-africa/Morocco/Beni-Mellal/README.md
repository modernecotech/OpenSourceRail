...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$383 M (87.9%) of external capital** and **$471 M of external interest**. Capital plus saved interest totals **$855 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| **Total city CAPEX** | **$242 M** | **21.9%** | **$53 M** | **$189 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.9%** | **$53 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.1%** | **$189 M** | **$38 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $152 M | $30 M / yr |
| **Total city programme** | **100.0%** | **$242 M** | **$48 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $327 M | $274 M (83.8%) | $337 M | **$612 M** |
| **Default** | 2.00× | $436 M | $383 M (87.9%) | $471 M | **$855 M** |
| High | 3.00× | $655 M | $602 M (91.9%) | $740 M | **$1.34 bn** |

At the default 2.00× case, OSR's $53 M external requirement is 87.9% below the illustrative foreign-company requirement of $436 M; the associated lifetime external-interest saving is $471 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$17 M / yr** | $56 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$84 M cumulative** | $280 |
| Lifecycle envelope (yr 1–40, high scenario) | **$84 M cumulative** | $280 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$494 M cumulative** | $1,647 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $53 M | 4.5% | 40 y, 5 y grace | $3.0 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $152 M | 4.5% | 40 y, 5 y grace | $8.7 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $38 M | — | — | — |
| **Total** | **100%** | **$242 M** | | | **$12 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.4 M / yr + local bonds $6.8 M / yr = **$9.2 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.6 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 4.1 M |
| Annual paid trips / city resident | 163 | 261 | 14 |
| Farebox revenue | $53 M / yr | $86 M / yr | $4.5 M / yr |
| Station shop leases | $920 k / yr | $920 k / yr | $920 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$56 M / yr** | **$88 M / yr** | **$6.9 M / yr** |
| Revenue / OPEX recovery | 809% | 1273% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $189 M | 78% of $242 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,629 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $230 M |
| Timetable-sized dedicated solar CAPEX | $12 M |
| **Reconciled project CAPEX** | **$242 M** |
| Imported / external-capital requirement | $53 M (21.9%) |
| Local-content / local-funding requirement | $189 M (78.1%) |
| Default foreign-turnkey external-capital comparison | $436 M; OSR saves $383 M (87.9%) |
| Lifetime external interest and combined financing saving | $471 M interest; $855 M capital + interest |
| 15%–25% planning risk envelope | $279 M–$303 M |
| Annual OPEX | $6.9 M / yr |
| Low/high project NPV at 8% | $195 M / $449 M |
| Low/high project IRR | 14.9% / 21.7% |
| Low/high steady-state DSCR | 4.18 / 6.91 |
