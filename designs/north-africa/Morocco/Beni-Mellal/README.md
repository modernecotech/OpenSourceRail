...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 45 | €2.0 M | €90 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 30.2 km × €0.015 M/km | €0.5 M |
...
| Per-capita (city pop) | €1,279 / person |
...
| Steady-state, low-ridership (year 6+) | **€31 M / yr** | €102 |
| Steady-state, high-ridership (year 6+) | **€27 M / yr** | €91 |
| Lifecycle envelope (yr 1–25, low scenario) | **€736 M cumulative** | €2,453 |
| Lifecycle envelope (yr 1–25, high scenario) | **€667 M cumulative** | €2,223 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€6.6 M / yr (low) → €3.2 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €230 M | 3.8% | 25 y, 5 y grace | €17 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €96 M | 4.5% | 25 y, 5 y grace | €7.4 M / yr |
| Government equity (no debt service) | 15% | €58 M | — | — | — |
| **Total** | **100%** | **€384 M** | | | **€24 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €8.8 M / yr + bonds €4.3 M / yr = **€13 M / yr** total — plus the equity tranche amortised across construction (€12 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (193 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.2 M |
...
| Farebox revenue | €3.4 M / yr | €6.9 M / yr |
| Farebox / OPEX recovery | 34% | 68% |
| Country policy-target recovery (diagnostic) | 60% | 60% |
| Operating shortfall (gov subsidy required) | €6.6 M / yr | €3.2 M / yr |
