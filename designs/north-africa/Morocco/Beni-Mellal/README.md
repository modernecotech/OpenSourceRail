...
|---|---|---|---|---|
| line-1 |  9.4 km | 6 | 29 | NE Mid ↔ SW Outer |
| line-2 | 11.7 km | 6 | 36 | SW Mid ↔ NE Outer |
| line-3 |  9.1 km | 6 | 28 | S Mid ↔ N Outer |
| **Total** | **30.2 km** | **18 unique** | **93** | |
...
| Onboard battery adequacy | 14.2× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 335 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 50 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 52 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 14.5 MW / 80 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 45 kWh | 114 kWh | 65 kWh | 2.1 km / 10 kWh |
| line-2 | 5 | 56 kWh | 118 kWh | 56 kWh | 5.3 km / 25 kWh |
| line-3 | 5 | 44 kWh | 98 kWh | 50 kWh | 5.1 km / 24 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 14,456 kW @ $700/kW | $10 M |
| Grid interconnection / PPA tie-in | 14,456 kW @ $100/kW | $1.4 M |
| Annual generation proxy | 14.5 MW × 5.5 peak-sun-h/day × 365 d/yr | 29.0 GWh/yr |
...
| Per-capita (city pop) | $982 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$112 M cumulative** | $373 |
| Lifecycle envelope (yr 1–40, high scenario) | **$112 M cumulative** | $373 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$584 M cumulative** | $1,947 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $236 M | 4.5% | 40 y, 5 y grace | $13 M / yr |
| Government equity (no debt service) | 20% | $59 M | — | — | — |
| **Total** | **100%** | **$295 M** | | | **$13 M / yr** |
...
| Traction energy (44.3 GWh / yr) | 14,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 19.1 GWh/yr + dedicated solar plant 14.5 MW / 29.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $173 k |
| Labour (270 FTE) | driverless roster: OCC/remote 65, station/platform 69, passenger service 38, fleet maintenance 47, infrastructure/energy 30, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.9 M |
| **OPEX subtotal** | | **$8.1 M / yr** |

_Annual service work: 14,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.5 M train-km / yr (11.1 M car-km / yr). On-site PV covers 19.1 GWh/yr and the dedicated solar plant adds 29.0 GWh/yr against 44.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 93 trainsets, 18 stations, 30.2 route-km, 3 lines, and 14,050 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 5.0 M |
| Annual paid trips / city resident | 163 | 261 | 17 |
| Farebox revenue | $53 M / yr | $86 M / yr | $5.5 M / yr |
| Station shop leases | $998 k / yr | $998 k / yr | $998 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$56 M / yr** | **$88 M / yr** | **$8.1 M / yr** |
| Revenue / OPEX recovery | 688% | 1082% | 100% |
...
_Commercial-revenue assumptions: 2,880 m² of station shop/kiosk leases at $33/m²/month and 560 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $22 M / yr | $35 M / yr | 22% of paid trips × $2.05 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $171 M | 58% of $295 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $273 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $55 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 8,668 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $339 M–$368 M |
| Annual OPEX | $8.1 M / yr |
| Low/high project NPV at 8% | $145 M / $399 M |
| Low/high project IRR | 12.5% / 18.7% |
| Low/high steady-state DSCR | 3.55 / 5.93 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,353.95 train-km; 6,498.40 kWh consumed; 7,043.38 kWh charged; 38 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,618.35 train-km; 70,161.95 kWh consumed; 72,092.20 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 82.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 66.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 82.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 82.9% | 100.0% / 90% | pass |
