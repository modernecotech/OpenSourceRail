...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 724 | $60 k | $43 M |
| High sensitivity check | 724 | $120 k | $87 M |
...
| Per-capita (city pop) | $1,163 / person |
...
| Steady-state, operating-neutral revenue case | **$64 M / yr** | $53 |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.77 bn cumulative** | $2,306 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $64 M / yr → $64 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.12 bn | 4.5% | 40 y, 5 y grace | $64 M / yr |
| Government equity (no debt service) | 20% | $279 M | — | — | — |
| **Total** | **100%** | **$1.40 bn** | | | **$64 M / yr** |
...
| Operating surplus applied to debt support | -$64 M / yr | -$64 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$64 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $788 M | 56% of $1.40 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.26 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $252 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 40,053 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.24 bn |
| Timetable-sized dedicated solar CAPEX | $153 M |
| **Reconciled project CAPEX** | **$1.40 bn** |
| 15%–25% planning risk envelope | $1.60 bn–$1.74 bn |
| Annual OPEX | $33 M / yr |
| Low/high project NPV at 8% | $-43867 k / $719 M |
| Low/high project IRR | 7.7% / 12.7% |
| Low/high steady-state DSCR | 2.11 / 3.62 |
