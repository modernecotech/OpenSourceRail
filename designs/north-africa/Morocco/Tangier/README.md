...
| Revenue fleet | 223 × 4-car trainsets |
| Revenue fleet passenger capacity | 107,040 AW2 pax (142,720 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 22.3 km | 13 | 51 | W Mid ↔ E Mid |
| line-2 | 24.2 km | 14 | 54 | W Mid ↔ NE Outer |
| line-3 | 20.5 km | 11 | 47 | SW Outer ↔ E Mid |
| line-4 | 29.9 km | 17 | 63 | SE Outer ↔ NW Outer |
| line-5 | 59.7 km | 38 | 32 | NW Outer ↔ NW Outer |
| **Total** | **156.6 km** | **93 unique** | **247** | |
...
| Revenue fleet capacity | 107,040 AW2 pax (142,720 AW3 crush) |
| Total fleet capacity | 118,560 AW2 pax (158,080 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 223 × 480 = **107,040 AW2 passengers** (142,720 AW3 crush)
- **Total fleet passenger capacity:** 247 × 480 = **118,560 AW2 passengers** (158,080 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 45 | 300 kW | 1500 kWh |
| Terminal | 7 | 300 kW | 1500 kWh |
| **Total installed** | **87** | **30,800 kW** | **169,000 kWh** |

Aggregate station-rail charging power: **130,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **177.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.1× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 618 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 371 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 169 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 849 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 177.5 MW / 976 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 169 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 214 kWh | 686 kWh | 451 kWh | 2.3 km / 22 kWh |
| line-2 | 14 | 232 kWh | 735 kWh | 480 kWh | 3.5 km / 34 kWh |
| line-3 | 11 | 197 kWh | 588 kWh | 371 kWh | 3.3 km / 32 kWh |
| line-4 | 14 | 287 kWh | 760 kWh | 444 kWh | 10.6 km / 102 kWh |
| line-5 | 35 | 573 kWh | 1,715 kWh | 1,085 kWh | 9.0 km / 87 kWh |
...
| Elevated (8.6 km @ $12.0 M/km) | $103 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$579 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 247 | $1.12 M | $277 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 988 | $60 k | $59 M |
| High sensitivity check | 988 | $120 k | $119 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 177,491 kW @ $700/kW | $124 M |
| Grid interconnection / PPA tie-in | 177,491 kW @ $100/kW | $18 M |
| Annual generation proxy | 177.5 MW × 5.5 peak-sun-h/day × 365 d/yr | 356.3 GWh/yr |
...
| EPC integration + project management (7%) | on subtotal | $104 M |
...
|---|---|---|
| Construction (years 1–5) | **$132 M / yr** | $110 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$80 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$660 M cumulative** | $550 |
| Lifecycle envelope (yr 1–40, high scenario) | **$660 M cumulative** | $550 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.44 bn cumulative** | $2,869 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.39 bn | 4.5% | 40 y, 5 y grace | $80 M / yr |
| Government equity (no debt service) | 20% | $347 M | — | — | — |
| **Total** | **100%** | **$1.74 bn** | | | **$80 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $62 M / yr = **$62 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($69 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (371.7 GWh / yr) | 58,928 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 61.8 GWh/yr + dedicated solar plant 177.5 MW / 356.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.1 M |
| Labour (941 FTE) | driverless roster: OCC/remote 142, station/platform 391, passenger service 92, fleet maintenance 152, infrastructure/energy 139, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $6.5 M |
| **OPEX subtotal** | | **$42 M / yr** |

_Annual service work: 58,928 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 23.2 M train-km / yr (92.9 M car-km / yr). On-site PV covers 61.8 GWh/yr and the dedicated solar plant adds 356.3 GWh/yr against 371.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 247 trainsets, 93 stations, 156.6 route-km, 5 lines, and 58,928 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 25.0 M |
| Annual paid trips / city resident | 122 | 196 | 21 |
| Farebox revenue | $160 M / yr | $257 M / yr | $27 M / yr |
| Station shop leases | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| Advertising boards | $9.1 M / yr | $9.1 M / yr | $9.1 M / yr |
| **Total revenue** | **$175 M / yr** | **$272 M / yr** | **$42 M / yr** |
| Revenue / OPEX recovery | 413% | 640% | 100% |
...
| Operating surplus after OPEX (before debt support) | $133 M / yr | $229 M / yr | $0 / yr |

_Commercial-revenue assumptions: 17,072 m² of station shop/kiosk leases at $33/m²/month and 3,116 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $62 M / yr | $100 M / yr | 21% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $32 M / yr | $51 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$211 M / yr** | **$338 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 18,623 trips/school day; 4.1 M access-events/yr | 29,796 trips/school day; 6.6 M access-events/yr |
| Healthcare | 3 healthcare anchors | 30,061 trips/day; 11.0 M access-events/yr | 48,098 trips/day; 17.6 M access-events/yr |
| Commerce | 42 major/terminal/interchange nodes | 83,333 trips/trading day; 27.5 M access-events/yr | 133,332 trips/trading day; 44.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $983 M | 57% of $1.74 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 49,930 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,185.81 train-km; 40,182.24 kWh consumed; 44,720.68 kWh charged; 31 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 59,115.19 train-km; 567,483.70 kWh consumed; 577,834.72 kWh charged; 825 depot services completed (7 active at cutoff); minimum SoC 81%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 76.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 78.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 81.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 93 line platforms, 7 interchange complexes, 27 civil segments, and 0 input findings |
