...
|---|---|---|
| Construction (years 1–5) | **$56 M / yr** | $62 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$278 M cumulative** | $308 |
| Lifecycle envelope (yr 1–40, high scenario) | **$278 M cumulative** | $308 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.45 bn cumulative** | $1,610 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $584 M | 4.5% | 40 y, 5 y grace | $33 M / yr |
| Government equity (no debt service) | 20% | $146 M | — | — | — |
| **Total** | **100%** | **$730 M** | | | **$33 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $410 M | 56% of $730 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $657 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $131 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 20,854 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $668 M |
| Timetable-sized dedicated solar CAPEX | $63 M |
| **Reconciled project CAPEX** | **$730 M** |
| 15%–25% planning risk envelope | $840 M–$913 M |
| Annual OPEX | $19 M / yr |
| Low/high project NPV at 8% | $-62148 k / $319 M |
| Low/high project IRR | 7.1% / 12.0% |
| Low/high steady-state DSCR | 1.96 / 3.40 |
