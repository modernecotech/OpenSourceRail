...
| Revenue fleet | 179 × 3-car trainsets |
| Revenue fleet passenger capacity | 64,440 AW2 pax (85,920 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 28.6 km | 18 | 70 | SE Outer ↔ NW Mid |
| line-2 | 25.9 km | 15 | 62 | NW Outer ↔ SE Mid |
| line-3 | 27.0 km | 16 | 67 | SE Outer ↔ N Outer |
| **Total** | **81.5 km** | **49 unique** | **199** | |
...
| Revenue fleet capacity | 64,440 AW2 pax (85,920 AW3 crush) |
| Total fleet capacity | 71,640 AW2 pax (95,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 179 × 360 = **64,440 AW2 passengers** (85,920 AW3 crush)
- **Total fleet passenger capacity:** 199 × 360 = **71,640 AW2 passengers** (95,520 AW3 crush, incl. service rotation + spare + reserve)
...
| Major | 12 | 300 kW | 500 kWh |
| Standard | 23 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **47** | **18,800 kW** | **63,000 kWh** |

Aggregate station-rail charging power: **23,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **72.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 499 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 378 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 72.5 MW / 435 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 63 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 17 | 230 kWh | 363 kWh | 110 kWh | 5.0 km / 40 kWh |
| line-2 | 14 | 209 kWh | 294 kWh | 65 kWh | 5.0 km / 41 kWh |
| line-3 | 16 | 218 kWh | 335 kWh | 95 kWh | 2.5 km / 20 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 199 | $900 k | $179 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 597 | $60 k | $36 M |
| High sensitivity check | 597 | $120 k | $72 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 72,507 kW @ $700/kW | $51 M |
| Grid interconnection / PPA tie-in | 72,507 kW @ $100/kW | $7.3 M |
| Annual generation proxy | 72.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 158.8 GWh/yr |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $5.0 M |
...
|---|---|---|
| Construction (years 1–5) | **$62 M / yr** | $69 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$312 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, high scenario) | **$312 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.63 bn cumulative** | $1,812 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $658 M | 4.5% | 40 y, 5 y grace | $38 M / yr |
| Government equity (no debt service) | 20% | $164 M | — | — | — |
| **Total** | **100%** | **$822 M** | | | **$38 M / yr** |
...
| Traction energy (179.2 GWh / yr) | 37,893 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 41.2 GWh/yr + dedicated solar plant 72.5 MW / 158.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $870 k |
| Labour (542 FTE) | driverless roster: OCC/remote 114, station/platform 173, passenger service 49, fleet maintenance 110, infrastructure/energy 75, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.7 M |
| **OPEX subtotal** | | **$22 M / yr** |

_Annual service work: 37,893 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.9 M train-km / yr (44.8 M car-km / yr). On-site PV covers 41.2 GWh/yr and the dedicated solar plant adds 158.8 GWh/yr against 179.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 199 trainsets, 49 stations, 81.5 route-km, 3 lines, and 37,893 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $80 M / yr | $128 M / yr | $15 M / yr |
| Station shop leases | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| Advertising boards | $4.1 M / yr | $4.1 M / yr | $4.1 M / yr |
| **Total revenue** | **$87 M / yr** | **$135 M / yr** | **$22 M / yr** |
| Revenue / OPEX recovery | 399% | 620% | 100% |
...
_Commercial-revenue assumptions: 7,360 m² of station shop/kiosk leases at $33/m²/month and 1,404 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $32 M / yr | $51 M / yr | 21% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $16 M / yr | $25 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$106 M / yr** | **$170 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 10,747 trips/school day; 2.4 M access-events/yr | 17,195 trips/school day; 3.8 M access-events/yr |
| Healthcare | 5 healthcare anchors | 14,689 trips/day; 5.4 M access-events/yr | 23,503 trips/day; 8.6 M access-events/yr |
| Commerce | 24 major/terminal/interchange nodes | 42,472 trips/trading day; 14.0 M access-events/yr | 67,955 trips/trading day; 22.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $463 M | 56% of $822 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $741 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $148 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 23,542 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $764 M |
| Timetable-sized dedicated solar CAPEX | $58 M |
| **Reconciled project CAPEX** | **$822 M** |
| 15%–25% planning risk envelope | $945 M–$1.03 bn |
| Annual OPEX | $22 M / yr |
| Low/high project NPV at 8% | $-140376 k / $241 M |
| Low/high project IRR | 6.1% / 10.8% |
| Low/high steady-state DSCR | 1.73 / 3.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,726.99 train-km; 21,992.38 kWh consumed; 22,670.06 kWh charged; 15 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 38,841.08 train-km; 313,240.62 kWh consumed; 318,957.37 kWh charged; 503 depot services completed (1 active at cutoff); minimum SoC 38%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 23.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 37.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.0% / 60% | pass |
| ten-hour single charging-pad outage | 37.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 49 line platforms, 3 interchange complexes, 23 civil segments, and 0 input findings |
