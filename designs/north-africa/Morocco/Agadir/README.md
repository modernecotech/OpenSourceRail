...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **58,500 – 87,750 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (81.0 km @ $1.2 M/km) | $97 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 82.6 km × $0.015 M/km | $1.2 M |
...
|---|---|---|
| Construction (years 1–5) | **$15 M / yr** | $17 |
...
| Lifecycle envelope (yr 1–25, low scenario) | **$77 M cumulative** | $85 |
| Lifecycle envelope (yr 1–25, high scenario) | **$77 M cumulative** | $85 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$77 M cumulative** | $85 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $144 M | 3.8% | 25 y, 5 y grace | $10 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $60 M | 4.5% | 25 y, 5 y grace | $4.6 M / yr |
| Government equity (no debt service) | 15% | $36 M | — | — | — |
| **Total** | **100%** | **$239 M** | | | **$15 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $5.5 M / yr + bonds $2.7 M / yr = **$8.1 M / yr** total — plus the equity tranche amortised across construction ($7.2 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 72,000 | 135,000 | 61,302 |
| Daily paid trips / population | 8% | 15% | 7% |
| Annual paid trips | 26.3 M | 49.3 M | 22.4 M |
| Farebox revenue | $22 M / yr | $40 M / yr | $18 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$27 M / yr** | **$46 M / yr** | **$24 M / yr** |
| Revenue / OPEX + debt-service recovery | 113% | 192% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Remaining steady-state gov gap | $0 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $3.2 M / yr | $22 M / yr | $0 / yr |
