...
| Bucket | Value |
|---|---|
| At-grade (81.0 km @ €3.5 M/km) | €284 M |
...
|---|---|---|
| Construction (years 1–5) | **€50 M / yr** | €55 |
| Steady-state, low-ridership (year 6+) | **€60 M / yr** | €67 |
| Steady-state, high-ridership (year 6+) | **€50 M / yr** | €56 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.45 bn cumulative** | €1,615 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.25 bn cumulative** | €1,385 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €1.6 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €464 M | 3.8% | 25 y, 5 y grace | €34 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €193 M | 4.5% | 25 y, 5 y grace | €15 M / yr |
| Government equity (no debt service) | 15% | €116 M | — | — | — |
| **Total** | **100%** | **€773 M** | | | **€48 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €18 M / yr + bonds €8.7 M / yr = **€26 M / yr** total — plus the equity tranche amortised across construction (€23 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (508 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.2 M |
...
| Farebox / OPEX recovery | 46% | 93% |
| Country policy-target recovery (diagnostic) | 60% | 60% |
| Operating shortfall (gov subsidy required) | €12 M / yr | €1.6 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€60 M / yr** | **€50 M / yr** |
