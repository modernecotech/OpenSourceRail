...
| Bucket | Value |
|---|---|
| At-grade (177.6 km @ €3.5 M/km) | €622 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 159 | €4.0 M | €636 M |
...
|---|---|---|
| Construction (years 1–5) | **€133 M / yr** | €111 |
| Steady-state, low-ridership (year 6+) | **€175 M / yr** | €146 |
| Steady-state, high-ridership (year 6+) | **€161 M / yr** | €134 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.17 bn cumulative** | €3,474 |
| Lifecycle envelope (yr 1–25, high scenario) | **€3.89 bn cumulative** | €3,245 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€45 M / yr (low) → €31 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.25 bn | 3.8% | 25 y, 5 y grace | €90 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €521 M | 4.5% | 25 y, 5 y grace | €40 M / yr |
| Government equity (no debt service) | 15% | €312 M | — | — | — |
| **Total** | **100%** | **€2.08 bn** | | | **€130 M / yr** |
...
| Labour (1,160 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €7.4 M |
...
| Operating shortfall (gov subsidy required) | €45 M / yr | €31 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€175 M / yr** | **€161 M / yr** |
