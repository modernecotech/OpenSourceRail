...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.60 bn (87.0%) of external capital** and **$3.19 bn of external interest**. Capital plus saved interest totals **$5.79 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (182.1 km @ $3.0 M/km) | $546 M |
...
| Per-capita (city pop) | $1,381 / person |
...
| EPC / project services | $96 M | 15% | $14 M | $82 M |
| **Total city CAPEX** | **$1.66 bn** | **23.4%** | **$387 M** | **$1.27 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$387 M** | **$77 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$1.27 bn** | **$254 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $1.02 bn | $203 M / yr |
| **Total city programme** | **100.0%** | **$1.66 bn** | **$331 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.24 bn | $1.85 bn (82.7%) | $2.27 bn | **$4.12 bn** |
| **Default** | 2.00× | $2.98 bn | $2.60 bn (87.0%) | $3.19 bn | **$5.79 bn** |
| High | 3.00× | $4.47 bn | $4.09 bn (91.3%) | $5.03 bn | **$9.11 bn** |

At the default 2.00× case, OSR's $387 M external requirement is 87.0% below the illustrative foreign-company requirement of $2.98 bn; the associated lifetime external-interest saving is $3.19 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$114 M / yr** | $95 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$570 M cumulative** | $475 |
| Lifecycle envelope (yr 1–40, high scenario) | **$570 M cumulative** | $475 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.38 bn cumulative** | $2,819 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $387 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.02 bn | 4.5% | 40 y, 5 y grace | $58 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $254 M | — | — | — |
| **Total** | **100%** | **$1.66 bn** | | | **$80 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $17 M / yr + local bonds $46 M / yr = **$63 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($51 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 29.8 M |
| Annual paid trips / city resident | 149 | 239 | 25 |
| Farebox revenue | $196 M / yr | $314 M / yr | $33 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.7 M / yr | $5.7 M / yr | $5.7 M / yr |
| **Total revenue** | **$205 M / yr** | **$323 M / yr** | **$42 M / yr** |
| Revenue / OPEX recovery | 490% | 770% | 100% |
...
| Operating surplus after OPEX (before debt support) | $163 M / yr | $281 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.27 bn | 77% of $1.66 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.03 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $406 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 64,527 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.47 bn |
| Timetable-sized dedicated solar CAPEX | $191 M |
| **Reconciled project CAPEX** | **$1.66 bn** |
| Imported / external-capital requirement | $387 M (23.4%) |
| Local-content / local-funding requirement | $1.27 bn (76.6%) |
| Default foreign-turnkey external-capital comparison | $2.98 bn; OSR saves $2.60 bn (87.0%) |
| Lifetime external interest and combined financing saving | $3.19 bn interest; $5.79 bn capital + interest |
| 15%–25% planning risk envelope | $1.91 bn–$2.07 bn |
| Annual OPEX | $42 M / yr |
| Low/high project NPV at 8% | $-27465 k / $905 M |
| Low/high project IRR | 7.8% / 12.9% |
| Low/high steady-state DSCR | 2.03 / 3.50 |
