...
| Revenue fleet | 300 × 4-car trainsets |
...
|---|---|---|---|---|
| line-1 | 29.2 km | 15 | 61 | W Inner ↔ SE Outer |
| line-2 | 27.2 km | 16 | 60 | NE Outer ↔ SW Inner |
| line-3 | 26.4 km | 14 | 58 | W Inner ↔ E Outer |
| line-4 | 27.2 km | 15 | 59 | S Outer ↔ N Mid |
| line-5 | 34.0 km | 16 | 69 | S Mid ↔ NW Outer |
| line-6 | 50.1 km | 28 | 27 | W Inner ↔ W Inner |
| **Total** | **194.1 km** | **104 unique** | **334** | |
...
| Total fleet capacity | 160,320 AW2 pax (213,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 300 × 480 = **144,000 AW2 passengers** (192,000 AW3 crush)
- **Total fleet passenger capacity:** 334 × 480 = **160,320 AW2 passengers** (213,760 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 47 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **90** | **31,700 kW** | **173,500 kWh** |

Aggregate station-rail charging power: **135,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **223.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 259 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 190 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,168 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 223.9 MW / 1,344 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 174 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 314 kWh | 637 kWh | 292 kWh | 11.0 km / 119 kWh |
| line-2 | 14 | 293 kWh | 735 kWh | 413 kWh | 8.2 km / 88 kWh |
| line-3 | 13 | 284 kWh | 686 kWh | 373 kWh | 5.9 km / 63 kWh |
| line-4 | 13 | 293 kWh | 686 kWh | 364 kWh | 8.0 km / 86 kWh |
| line-5 | 12 | 366 kWh | 662 kWh | 259 kWh | 12.9 km / 139 kWh |
| line-6 | 26 | 538 kWh | 1,274 kWh | 682 kWh | 5.9 km / 64 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 334 | $1.12 M | $374 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1336 | $60 k | $80 M |
| High sensitivity check | 1336 | $120 k | $160 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 223,942 kW @ $700/kW | $157 M |
| Grid interconnection / PPA tie-in | 223,942 kW @ $100/kW | $22 M |
| Annual generation proxy | 223.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 490.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$179 M** |
...
|---|---|---|
| Construction (years 1–5) | **$160 M / yr** | $133 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$96 M / yr** | $80 |
| Lifecycle envelope (yr 1–40, low scenario) | **$799 M cumulative** | $665 |
| Lifecycle envelope (yr 1–40, high scenario) | **$799 M cumulative** | $665 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.17 bn cumulative** | $3,474 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $96 M / yr → $96 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.68 bn | 4.5% | 40 y, 5 y grace | $96 M / yr |
| Government equity (no debt service) | 20% | $420 M | — | — | — |
| **Total** | **100%** | **$2.10 bn** | | | **$96 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $76 M / yr = **$76 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($84 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (495.9 GWh / yr) | 78,622 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 69.4 GWh/yr + dedicated solar plant 223.9 MW / 490.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.7 M |
| Labour (1,108 FTE) | driverless roster: OCC/remote 187, station/platform 412, passenger service 111, fleet maintenance 204, infrastructure/energy 167, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $7.6 M |
| **OPEX subtotal** | | **$52 M / yr** |

_Annual service work: 78,622 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 31.0 M train-km / yr (124.0 M car-km / yr). On-site PV covers 69.4 GWh/yr and the dedicated solar plant adds 490.4 GWh/yr against 495.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 334 trainsets, 104 stations, 194.1 route-km, 6 lines, and 78,622 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 33.1 M |
| Annual paid trips / city resident | 149 | 239 | 28 |
| Farebox revenue | $196 M / yr | $314 M / yr | $36 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.5 M / yr | $9.5 M / yr | $9.5 M / yr |
| **Total revenue** | **$212 M / yr** | **$329 M / yr** | **$52 M / yr** |
| Revenue / OPEX recovery | 408% | 635% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Gross repayable-debt service + residual OPEX subsidy | $96 M / yr | $96 M / yr | **$96 M / yr** |
| Operating surplus applied to debt support | -$96 M / yr | -$96 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$96 M / yr** |
| Operating surplus after OPEX (before debt support) | $160 M / yr | $277 M / yr | $0 / yr |

_Commercial-revenue assumptions: 17,648 m² of station shop/kiosk leases at $33/m²/month and 3,252 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $75 M / yr | $120 M / yr | 20% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $39 M / yr | $62 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$257 M / yr** | **$411 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 23,721 trips/school day; 5.2 M access-events/yr | 37,954 trips/school day; 8.3 M access-events/yr |
| Healthcare | 5 healthcare anchors | 34,751 trips/day; 12.7 M access-events/yr | 55,601 trips/day; 20.3 M access-events/yr |
| Commerce | 43 major/terminal/interchange nodes | 99,884 trips/trading day; 33.0 M access-events/yr | 159,815 trips/trading day; 52.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.19 bn | 56% of $2.10 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.90 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $379 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 60,242 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $179 M |
| **Reconciled project CAPEX** | **$2.10 bn** |
| 15%–25% planning risk envelope | $2.42 bn–$2.63 bn |
| Annual OPEX | $52 M / yr |
| Low/high project NPV at 8% | $-410899 k / $522 M |
| Low/high project IRR | 5.8% / 10.4% |
| Low/high steady-state DSCR | 1.66 / 2.88 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,776.16 train-km; 62,111.21 kWh consumed; 65,002.97 kWh charged; 35 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 79,560.22 train-km; 855,512.35 kWh consumed; 867,672.76 kWh charged; 993 depot services completed (9 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 60.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 71.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 87.2% / 60% | pass |
| ten-hour single charging-pad outage | 71.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 104 line platforms, 9 interchange complexes, 56 civil segments, and 0 input findings |
