...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.41 bn (86.7%) of external capital** and **$2.97 bn of external interest**. Capital plus saved interest totals **$5.38 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 194.1 km |
| Revenue fleet | 229 × 4-car trainsets |
| Revenue fleet passenger capacity | 109,920 AW2 pax (146,560 AW3 crush) |
...
| Revenue fleet capacity | 109,920 AW2 pax (146,560 AW3 crush) |
| Total fleet capacity | 122,400 AW2 pax (163,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 229 × 480 = **109,920 AW2 passengers** (146,560 AW3 crush)
...
- Anchor-weighted coverage: 59.3%
- Catchment population: **≈ 711,600** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **239.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 4.9× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 573 kWh usable margin across the worst powered-stop gap (line-5) |
| Lowest traversal charging margin | 119 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 111 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 78,622 train-km/day | One-way train journeys × route length |
| Annual service work | 31.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,359 MWh/day | 124.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,248 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 239.1 MW / 1,435 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 314 kWh | 514 kWh | 170 kWh | 12.6 km / 135 kWh |
| line-2 | 8 | 293 kWh | 514 kWh | 193 kWh | 8.2 km / 88 kWh |
| line-3 | 7 | 284 kWh | 453 kWh | 141 kWh | 6.9 km / 75 kWh |
| line-4 | 6 | 293 kWh | 441 kWh | 119 kWh | 10.7 km / 115 kWh |
| line-5 | 6 | 366 kWh | 527 kWh | 124 kWh | 13.7 km / 147 kWh |
| line-6 | 11 | 538 kWh | 808 kWh | 216 kWh | 10.9 km / 117 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (182.1 km @ $2.58 M/km) | $470 M |
| Elevated (12.0 km @ $9.75 M/km) | $117 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$624 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 239,122 kW @ $700/kW | $167 M |
| Grid interconnection / PPA tie-in | 239,122 kW @ $100/kW | $24 M |
| Annual generation proxy | 239.1 MW × 6.0 peak-sun-h/day × 365 d/yr | 523.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$191 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 194.1 km × $0.050 M/km | $9.7 M |
...
|---|---:|---:|---:|---:|
| Civil works | $624 M | 15% | $94 M | $530 M |
| Stations | $325 M | 20% | $65 M | $260 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $286 M | 35% | $100 M | $186 M |
| Dedicated solar plant | $191 M | 45% | $86 M | $105 M |
| Residual signalling / train control | $9.7 M | 50% | $4.9 M | $4.9 M |
| Charging microgrids | $16 M | 40% | $6.3 M | $9.4 M |
| EPC / project services | $89 M | 15% | $13 M | $75 M |
| **Total city CAPEX** | **$1.55 bn** | **24.0%** | **$371 M** | **$1.18 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh marrakech`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$371 M** | **$74 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$1.18 bn** | **$235 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $941 M | $188 M / yr |
| **Total city programme** | **100.0%** | **$1.55 bn** | **$309 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.09 bn | $1.72 bn (82.2%) | $2.11 bn | **$3.83 bn** |
| **Default** | 2.00× | $2.79 bn | $2.41 bn (86.7%) | $2.97 bn | **$5.38 bn** |
| High | 3.00× | $4.18 bn | $3.81 bn (91.1%) | $4.68 bn | **$8.49 bn** |

At the default 2.00× case, OSR's $371 M external requirement is 86.7% below the illustrative foreign-company requirement of $2.79 bn; the associated lifetime external-interest saving is $2.97 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$106 M / yr** | $88 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$75 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$530 M cumulative** | $442 |
| Lifecycle envelope (yr 1–40, high scenario) | **$530 M cumulative** | $442 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.16 bn cumulative** | $2,634 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $75 M / yr → $75 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $371 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $941 M | 4.5% | 40 y, 5 y grace | $54 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $235 M | — | — | — |
| **Total** | **100%** | **$1.55 bn** | | | **$75 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $17 M / yr + local bonds $42 M / yr = **$59 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($47 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (495.9 GWh / yr) | 78,622 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 40.5 GWh/yr + dedicated solar plant 239.1 MW / 523.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.9 M |
| Labour (864 FTE) | driverless roster: OCC/remote 150, station/platform 245, passenger service 111, fleet maintenance 180, infrastructure/energy 151, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $6.0 M |
| **OPEX subtotal** | | **$40 M / yr** |

_Annual service work: 78,622 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 31.0 M train-km / yr (124.0 M car-km / yr). On-site PV covers 40.5 GWh/yr and the dedicated solar plant adds 523.7 GWh/yr against 495.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 255 trainsets, 57 stations, 194.1 route-km, 6 lines, and 78,622 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 27.9 M |
| Annual paid trips / city resident | 149 | 239 | 23 |
| Farebox revenue | $196 M / yr | $314 M / yr | $31 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.7 M / yr | $5.7 M / yr | $5.7 M / yr |
| **Total revenue** | **$205 M / yr** | **$323 M / yr** | **$40 M / yr** |
| Revenue / OPEX recovery | 515% | 810% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Gross repayable-debt service + residual OPEX subsidy | $75 M / yr | $75 M / yr | **$75 M / yr** |
| Operating surplus applied to debt support | -$75 M / yr | -$75 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$75 M / yr** |
| Operating surplus after OPEX (before debt support) | $165 M / yr | $283 M / yr | $0 / yr |

_Commercial-revenue assumptions: 10,584 m² of station shop/kiosk leases at $33/m²/month and 1,940 advertising boards at $287/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $57 M / yr | $90 M / yr | 16 min/trip × $1.18/h value-of-time proxy |
...
| Station-area commerce turnover supported | $79 M / yr | $127 M / yr | 22% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $39 M / yr | $62 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$261 M / yr** | **$418 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 21,851 trips/school day; 4.8 M access-events/yr | 34,962 trips/school day; 7.7 M access-events/yr |
| Healthcare | 5 healthcare anchors | 38,056 trips/day; 13.9 M access-events/yr | 60,889 trips/day; 22.2 M access-events/yr |
| Commerce | 30 major/terminal/interchange nodes | 105,703 trips/trading day; 34.9 M access-events/yr | 169,125 trips/trading day; 55.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.18 bn | 76% of $1.55 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.88 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $376 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 59,775 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.36 bn |
| Timetable-sized dedicated solar CAPEX | $191 M |
| **Reconciled project CAPEX** | **$1.55 bn** |
| Imported / external-capital requirement | $371 M (24.0%) |
| Local-content / local-funding requirement | $1.18 bn (76.0%) |
| Default foreign-turnkey external-capital comparison | $2.79 bn; OSR saves $2.41 bn (86.7%) |
| Lifetime external interest and combined financing saving | $2.97 bn interest; $5.38 bn capital + interest |
| 15%–25% planning risk envelope | $1.78 bn–$1.93 bn |
| Annual OPEX | $40 M / yr |
| Low/high project NPV at 8% | $77 M / $1.01 bn |
| Low/high project IRR | 8.5% / 13.8% |
| Low/high steady-state DSCR | 2.20 / 3.77 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,970.92 train-km; 64,206.12 kWh consumed; 63,482.76 kWh charged; 48 depot services completed; minimum SoC 60%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 73,665.73 train-km; 792,137.99 kWh consumed; 798,296.17 kWh charged; 1,006 depot services completed (10 active at cutoff); minimum SoC 59%; 0 onboard emergencies; 0 invariant violations; 93.7% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 50.1% | 93.7% / 90% | pass |
| maximum planning climate/HVAC duty | 23.0% | 93.7% / 90% | pass |
| 50% charging-contact availability | 59.2% | 93.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 64.2% / 60% | pass |
| ten-hour single charging-pad outage | 51.5% | 93.7% / 90% | pass |
...
|---|---|
| ![Marrakech energy and battery simulation dashboard](engineering/screenshots/marrakech-simulation-dashboard.png) | ![Marrakech simulator network visualizer](engineering/screenshots/marrakech-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 57 line platforms, 8 interchange complexes, 54 civil segments, and 0 input findings |
...
|---|---|
| ![Marrakech QGIS engineering layers](engineering/screenshots/marrakech-qgis-engineering-map.png) | ![Marrakech SUMO timetable validation](engineering/screenshots/marrakech-sumo-validation.png) |
...
scripts/regenerate-city.sh marrakech
```
