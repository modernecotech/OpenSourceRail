...
| Item | Count / Status |
|---|---:|
| Assets in register | 272 |
| Manufacturing schedule rows | 1,083 |
| Manufacturing material/BOM rows | 16,841 |
| Manufacturing QA verification rows | 1,083 |
| Construction QA action rows | 1,017 |
| Maintenance handover schedule rows | 1,279 |
| Manufacturing rows with material refs | 1,083 / 1,083 |
| Manufacturing rows with verification refs | 1,083 / 1,083 |
| Manufacturing rows linked to QA actions | 1,083 / 1,083 |
