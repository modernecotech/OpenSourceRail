# Kenitra Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 356 |
| Manufacturing schedule rows | 1,356 |
| Manufacturing material/BOM rows | 20,290 |
| Manufacturing QA verification rows | 1,356 |
| Construction QA action rows | 1,258 |
| Maintenance handover schedule rows | 1,617 |
| Manufacturing rows with material refs | 1,356 / 1,356 |
| Manufacturing rows with verification refs | 1,356 / 1,356 |
| Manufacturing rows linked to QA actions | 1,356 / 1,356 |
