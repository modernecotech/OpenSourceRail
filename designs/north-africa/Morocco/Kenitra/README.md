...
| Bucket | Value |
|---|---|
| At-grade (59.7 km @ $1.2 M/km) | $72 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.0 km × $0.015 M/km | $901 k |
...
| Steady-state, low-ridership (year 6+) | **$1.2 M / yr** | $2 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$81 M cumulative** | $161 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $107 M | 3.8% | 25 y, 5 y grace | $7.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $45 M | 4.5% | 25 y, 5 y grace | $3.4 M / yr |
| Government equity (no debt service) | 15% | $27 M | — | — | — |
| **Total** | **100%** | **$178 M** | | | **$11 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $4.1 M / yr + bonds $2.0 M / yr = **$6.1 M / yr** total — plus the equity tranche amortised across construction ($5.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 40,000 | 75,000 | 43,931 |
| Daily paid trips / population | 8% | 15% | 9% |
| Annual paid trips | 14.6 M | 27.4 M | 16.0 M |
| Farebox revenue | $12 M / yr | $22 M / yr | $13 M / yr |
...
| Revenue / OPEX + debt-service recovery | 93% | 152% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Remaining steady-state gov gap | $1.2 M / yr | $0 k / yr | **$0 / yr** |
