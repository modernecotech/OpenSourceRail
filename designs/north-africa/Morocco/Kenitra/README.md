...
|---|---|---|---|---|
| line-1 | 17.7 km | 11 | 18 | W Outer ↔ E Mid |
| line-2 | 21.1 km | 13 | 21 | SE Mid ↔ W Outer |
| line-3 | 21.2 km | 11 | 21 | NE Outer ↔ SW Mid |
| **Total** | **60.0 km** | **35 unique** | **60** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **59,310 – 98,850 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (59.7 km @ $2.0 M/km) | $119 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.0 km × $0.015 M/km | $3.0 M |
...
|---|---|---|
| Construction (years 1–5) | **$17 M / yr** | $35 |
...
| Lifecycle envelope (yr 1–25, low scenario) | **$426 M cumulative** | $852 |
| Lifecycle envelope (yr 1–25, high scenario) | **$426 M cumulative** | $852 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$426 M cumulative** | $852 |
...
_During the 5-year grace period the operator pays interest only — multilateral $6.2 M / yr + bonds $3.0 M / yr = **$9.2 M / yr** total — plus the equity tranche amortised across construction ($8.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (372 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $2.6 M |
