...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$716 M (86.2%) of external capital** and **$881 M of external interest**. Capital plus saved interest totals **$1.60 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 66.2%
- Catchment population: **≈ 331,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **62.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 458 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 77 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 64 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 27,930 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 62.3 MW / 343 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 128 kWh | 220 kWh | 80 kWh | 3.0 km / 22 kWh |
| line-2 | 8 | 152 kWh | 261 kWh | 94 kWh | 4.6 km / 33 kWh |
| line-3 | 6 | 152 kWh | 245 kWh | 77 kWh | 11.4 km / 82 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (59.8 km @ $2.58 M/km) | $154 M |
| Elevated (0.3 km @ $9.75 M/km) | $2.9 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 62,346 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 62,346 kW @ $100/kW | $6.2 M |
| Annual generation proxy | 62.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 125.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$50 M** |
...
| Dedicated solar power plant | $50 M |
...
|---|---:|---:|---:|---:|
| Civil works | $157 M | 15% | $24 M | $134 M |
| Stations | $97 M | 20% | $19 M | $78 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $117 M | 35% | $41 M | $76 M |
| Dedicated solar plant | $50 M | 45% | $22 M | $27 M |
...
| **Total city CAPEX** | **$462 M** | **24.9%** | **$115 M** | **$347 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kenitra`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.9%** | **$115 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.1%** | **$347 M** | **$69 M / yr** |
| of which planned local bond issuance | 60.1% of total CAPEX | $277 M | $55 M / yr |
| **Total city programme** | **100.0%** | **$462 M** | **$92 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $623 M | $508 M (81.6%) | $625 M | **$1.13 bn** |
| **Default** | 2.00× | $831 M | $716 M (86.2%) | $881 M | **$1.60 bn** |
| High | 3.00× | $1.25 bn | $1.13 bn (90.8%) | $1.39 bn | **$2.52 bn** |

At the default 2.00× case, OSR's $115 M external requirement is 86.2% below the illustrative foreign-company requirement of $831 M; the associated lifetime external-interest saving is $881 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$32 M / yr** | $63 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$158 M cumulative** | $315 |
| Lifecycle envelope (yr 1–40, high scenario) | **$158 M cumulative** | $315 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$944 M cumulative** | $1,888 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $115 M | 4.5% | 40 y, 5 y grace | $6.6 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $277 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$462 M** | | | **$22 M / yr** |
...
| Traction energy (132.1 GWh / yr) | 27,930 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.3 GWh/yr + dedicated solar plant 62.3 MW / 125.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $748 k |
| Labour (370 FTE) | driverless roster: OCC/remote 81, station/platform 91, passenger service 49, fleet maintenance 76, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 27,930 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.0 M train-km / yr (33.0 M car-km / yr). On-site PV covers 23.3 GWh/yr and the dedicated solar plant adds 125.2 GWh/yr against 132.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 130 trainsets, 24 stations, 60.1 route-km, 3 lines, and 27,930 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 9.1 M |
| Annual paid trips / city resident | 147 | 235 | 18 |
| Farebox revenue | $80 M / yr | $128 M / yr | $10.0 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$84 M / yr** | **$132 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 625% | 984% | 100% |
...
_Commercial-revenue assumptions: 3,744 m² of station shop/kiosk leases at $33/m²/month and 724 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$99 M / yr** | **$158 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 12,103 trips/school day; 2.7 M access-events/yr | 19,365 trips/school day; 4.3 M access-events/yr |
| Healthcare | 3 healthcare anchors | 15,217 trips/day; 5.6 M access-events/yr | 24,347 trips/day; 8.9 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 44,445 trips/trading day; 14.7 M access-events/yr | 71,112 trips/trading day; 23.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $347 M | 75% of $462 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $555 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $111 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,621 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $412 M |
| Timetable-sized dedicated solar CAPEX | $50 M |
| **Reconciled project CAPEX** | **$462 M** |
| Imported / external-capital requirement | $115 M (24.9%) |
| Local-content / local-funding requirement | $347 M (75.1%) |
| Default foreign-turnkey external-capital comparison | $831 M; OSR saves $716 M (86.2%) |
| Lifetime external interest and combined financing saving | $881 M interest; $1.60 bn capital + interest |
| 15%–25% planning risk envelope | $531 M–$577 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $188 M / $570 M |
| Low/high project IRR | 11.8% / 17.9% |
| Low/high steady-state DSCR | 3.12 / 5.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,240.70 train-km; 16,131.90 kWh consumed; 15,541.85 kWh charged; 26 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,447.92 train-km; 197,611.02 kWh consumed; 195,995.94 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 32%; 0 onboard emergencies; 0 invariant violations; 98.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 22.3% | 98.1% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 97.9% / 90% | pass |
| 50% charging-contact availability | 32.2% | 98.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 88.5% / 60% | pass |
| ten-hour single charging-pad outage | 31.3% | 98.3% / 90% | pass |
...
|---|---|
| ![Kenitra energy and battery simulation dashboard](engineering/screenshots/kenitra-simulation-dashboard.png) | ![Kenitra simulator network visualizer](engineering/screenshots/kenitra-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
...
|---|---|
| ![Kenitra QGIS engineering layers](engineering/screenshots/kenitra-qgis-engineering-map.png) | ![Kenitra SUMO timetable validation](engineering/screenshots/kenitra-sumo-validation.png) |
...
scripts/regenerate-city.sh kenitra
```
