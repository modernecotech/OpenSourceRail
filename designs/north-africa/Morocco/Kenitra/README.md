...
|---|---|---|---|---|
| line-1 | 17.7 km | 11 | 46 | E Mid ↔ W Outer |
| line-2 | 21.2 km | 12 | 52 | SE Mid ↔ W Outer |
| line-3 | 21.2 km | 12 | 56 | SW Mid ↔ NE Outer |
| **Total** | **60.1 km** | **35 unique** | **154** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **58.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 492 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 58.6 MW / 322 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| line-2 | 12 | 152 kWh | 253 kWh | 86 kWh | 3.0 km / 22 kWh |
| line-3 | 11 | 152 kWh | 278 kWh | 110 kWh | 6.6 km / 48 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (58.5 km @ $3.0 M/km) | $176 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 58,551 kW @ $700/kW | $41 M |
| Grid interconnection / PPA tie-in | 58,551 kW @ $100/kW | $5.9 M |
| Annual generation proxy | 58.6 MW × 5.5 peak-sun-h/day × 365 d/yr | 117.5 GWh/yr |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$231 M cumulative** | $463 |
| Lifecycle envelope (yr 1–40, high scenario) | **$231 M cumulative** | $463 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.21 bn cumulative** | $2,415 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $487 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $122 M | — | — | — |
| **Total** | **100%** | **$609 M** | | | **$28 M / yr** |
...
| Traction energy (132.1 GWh / yr) | 27,930 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.9 GWh/yr + dedicated solar plant 58.6 MW / 117.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $703 k |
| Labour (430 FTE) | driverless roster: OCC/remote 94, station/platform 127, passenger service 49, fleet maintenance 83, infrastructure/energy 56, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.0 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 27,930 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.0 M train-km / yr (33.0 M car-km / yr). On-site PV covers 29.9 GWh/yr and the dedicated solar plant adds 117.5 GWh/yr against 132.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 154 trainsets, 35 stations, 60.1 route-km, 3 lines, and 27,930 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Revenue / OPEX recovery | 518% | 811% | 100% |
...
_Commercial-revenue assumptions: 5,288 m² of station shop/kiosk leases at $33/m²/month and 1,016 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$97 M / yr** | **$156 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 5 education anchors | 12,752 trips/school day; 2.8 M access-events/yr | 20,402 trips/school day; 4.5 M access-events/yr |
| Healthcare | 3 healthcare anchors | 14,254 trips/day; 5.2 M access-events/yr | 22,806 trips/day; 8.3 M access-events/yr |
| Commerce | 17 major/terminal/interchange nodes | 42,386 trips/trading day; 14.0 M access-events/yr | 67,817 trips/trading day; 22.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $341 M | 56% of $609 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,319 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $562 M |
| Timetable-sized dedicated solar CAPEX | $47 M |
| **Reconciled project CAPEX** | **$609 M** |
| 15%–25% planning risk envelope | $700 M–$761 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $58 M / $439 M |
| Low/high project IRR | 9.0% / 14.3% |
| Low/high steady-state DSCR | 2.46 / 4.18 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,229.86 train-km; 16,053.96 kWh consumed; 17,367.50 kWh charged; 24 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,754.74 train-km; 207,021.03 kWh consumed; 211,041.32 kWh charged; 497 depot services completed (6 active at cutoff); minimum SoC 76%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 71.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 53.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 76.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.4% / 60% | pass |
| ten-hour single charging-pad outage | 67.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 2 interchange complexes, 11 civil segments, and 0 input findings |
