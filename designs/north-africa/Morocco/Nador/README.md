...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$422 M (87.8%) of external capital** and **$518 M of external interest**. Capital plus saved interest totals **$940 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (33.0 km @ $2.58 M/km) | $85 M |
...
| EPC / project services | $16 M | 15% | $2.5 M | $14 M |
| **Total city CAPEX** | **$267 M** | **21.9%** | **$58 M** | **$208 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.9%** | **$58 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.1%** | **$208 M** | **$42 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $167 M | $33 M / yr |
| **Total city programme** | **100.0%** | **$267 M** | **$53 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $360 M | $302 M (83.8%) | $371 M | **$673 M** |
| **Default** | 2.00× | $480 M | $422 M (87.8%) | $518 M | **$940 M** |
| High | 3.00× | $720 M | $662 M (91.9%) | $814 M | **$1.48 bn** |

At the default 2.00× case, OSR's $58 M external requirement is 87.8% below the illustrative foreign-company requirement of $480 M; the associated lifetime external-interest saving is $518 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$18 M / yr** | $74 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$92 M cumulative** | $369 |
| Lifecycle envelope (yr 1–40, high scenario) | **$92 M cumulative** | $369 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$543 M cumulative** | $2,173 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $58 M | 4.5% | 40 y, 5 y grace | $3.3 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $167 M | 4.5% | 40 y, 5 y grace | $9.5 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $42 M | — | — | — |
| **Total** | **100%** | **$267 M** | | | **$13 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.6 M / yr + local bonds $7.5 M / yr = **$10 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips / city resident | 196 | 313 | 18 |
| Farebox revenue | $53 M / yr | $86 M / yr | $5.0 M / yr |
| Station shop leases | $970 k / yr | $970 k / yr | $970 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$56 M / yr** | **$88 M / yr** | **$7.5 M / yr** |
| Revenue / OPEX recovery | 744% | 1170% | 100% |
...
| Operating surplus after OPEX (before debt support) | $48 M / yr | $81 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $208 M | 78% of $267 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $333 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $67 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 10,587 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $252 M |
| Timetable-sized dedicated solar CAPEX | $15 M |
| **Reconciled project CAPEX** | **$267 M** |
| Imported / external-capital requirement | $58 M (21.9%) |
| Local-content / local-funding requirement | $208 M (78.1%) |
| Default foreign-turnkey external-capital comparison | $480 M; OSR saves $422 M (87.8%) |
| Lifetime external interest and combined financing saving | $518 M interest; $940 M capital + interest |
| 15%–25% planning risk envelope | $307 M–$333 M |
| Annual OPEX | $7.5 M / yr |
| Low/high project NPV at 8% | $171 M / $426 M |
| Low/high project IRR | 13.7% / 20.2% |
| Low/high steady-state DSCR | 3.76 / 6.25 |
