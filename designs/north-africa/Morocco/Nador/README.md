...
|---|---|---|---|---|
| line-1 | 10.0 km | 6 | 30 | E Inner ↔ W Outer |
| line-2 | 15.4 km | 8 | 43 | NW Outer ↔ SE Mid |
| line-3 |  9.0 km | 7 | 29 | SE Outer ↔ N Inner |
| **Total** | **34.3 km** | **21 unique** | **102** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **16.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 332 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 16.5 MW / 91 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 48 kWh | 114 kWh | 62 kWh | 2.7 km / 13 kWh |
| line-2 | 7 | 74 kWh | 139 kWh | 58 kWh | 5.8 km / 28 kWh |
| line-3 | 7 | 43 kWh | 131 kWh | 83 kWh | 2.0 km / 10 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 16,548 kW @ $700/kW | $12 M |
| Grid interconnection / PPA tie-in | 16,548 kW @ $100/kW | $1.7 M |
| Annual generation proxy | 16.5 MW × 5.5 peak-sun-h/day × 365 d/yr | 33.2 GWh/yr |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$655 M cumulative** | $2,621 |
...
| Traction energy (50.4 GWh / yr) | 15,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 16.5 MW / 33.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $199 k |
| Labour (292 FTE) | driverless roster: OCC/remote 69, station/platform 78, passenger service 38, fleet maintenance 52, infrastructure/energy 34, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$9.0 M / yr** |

_Annual service work: 15,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (12.6 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 33.2 GWh/yr against 50.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 102 trainsets, 21 stations, 34.3 route-km, 3 lines, and 15,971 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 196 | 313 | 22 |
| Farebox revenue | $53 M / yr | $86 M / yr | $6.0 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$56 M / yr** | **$89 M / yr** | **$9.0 M / yr** |
| Revenue / OPEX recovery | 624% | 979% | 100% |
...
| Operating surplus after OPEX (before debt support) | $47 M / yr | $79 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,288 m² of station shop/kiosk leases at $33/m²/month and 640 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $22 M / yr | $34 M / yr | 22% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $11 M / yr | $17 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$58 M / yr** | **$92 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $191 M | 58% of $330 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,726 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$330 M** |
| 15%–25% planning risk envelope | $380 M–$413 M |
| Annual OPEX | $9.0 M / yr |
| Low/high project NPV at 8% | $112 M / $367 M |
| Low/high project IRR | 11.2% / 17.1% |
| Low/high steady-state DSCR | 3.13 / 5.25 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,494.77 train-km; 7,174.27 kWh consumed; 7,829.33 kWh charged; 35 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,593.02 train-km; 79,639.30 kWh consumed; 81,793.39 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
