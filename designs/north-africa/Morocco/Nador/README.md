...
| Bucket | Value |
|---|---|
| At-grade (33.0 km @ €3.5 M/km) | €115 M |
...
|---|---|---|
| Construction (years 1–5) | **€24 M / yr** | €95 |
| Steady-state, low-ridership (year 6+) | **€31 M / yr** | €122 |
| Steady-state, high-ridership (year 6+) | **€28 M / yr** | €111 |
| Lifecycle envelope (yr 1–25, low scenario) | **€730 M cumulative** | €2,921 |
| Lifecycle envelope (yr 1–25, high scenario) | **€673 M cumulative** | €2,692 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€7.3 M / yr (low) → €4.4 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €223 M | 3.8% | 25 y, 5 y grace | €16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €93 M | 4.5% | 25 y, 5 y grace | €7.2 M / yr |
| Government equity (no debt service) | 15% | €56 M | — | — | — |
| **Total** | **100%** | **€372 M** | | | **€23 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €8.5 M / yr + bonds €4.2 M / yr = **€13 M / yr** total — plus the equity tranche amortised across construction (€11 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (218 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.4 M |
...
| Operating shortfall (gov subsidy required) | €7.3 M / yr | €4.4 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€31 M / yr** | **€28 M / yr** |
