...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$289 M (88.2%) of external capital** and **$355 M of external interest**. Capital plus saved interest totals **$644 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`khouribga.corridor.geojson`](khouribga.corridor.geojson).
...
| Anchor-weighted coverage | 82.0% |
| Route length (double track) | 18.8 km |
| Revenue fleet | 40 × 2-car trainsets |
| Revenue fleet passenger capacity | 9,600 AW2 pax (12,800 AW3 crush) |
...
| Revenue fleet capacity | 9,600 AW2 pax (12,800 AW3 crush) |
| Total fleet capacity | 11,040 AW2 pax (14,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 40 × 240 = **9,600 AW2 passengers** (12,800 AW3 crush)
- **Total fleet passenger capacity:** 46 × 240 = **11,040 AW2 passengers** (14,720 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 82.0%
- Catchment population: **≈ 205,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **5.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 16.9× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 339 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 41 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 48 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 8,729 train-km/day | One-way train journeys × route length |
| Annual service work | 3.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 75 MWh/day | 6.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 27 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 5.3 MW / 32 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 48 kWh | 98 kWh | 45 kWh | 4.0 km / 21 kWh |
| line-2 | 4 | 31 kWh | 82 kWh | 48 kWh | 2.0 km / 11 kWh |
| line-3 | 3 | 22 kWh | 65 kWh | 41 kWh | 2.1 km / 11 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (17.6 km @ $2.58 M/km) | $45 M |
| Elevated (1.2 km @ $9.75 M/km) | $11 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 46 | $560 k | $26 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 92 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 92 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 5,255 kW @ $700/kW | $3.7 M |
| Grid interconnection / PPA tie-in | 5,255 kW @ $100/kW | $525 k |
| Annual generation proxy | 5.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 11.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$4.2 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 18.8 km × $0.050 M/km | $939 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $1.3 M |
...
| Dedicated solar power plant | $4.2 M |
| Residual train-control wayside + charging microgrids | $2.3 M |
| EPC overhead (7%) | $12 M |
| **CAPEX total** | **$182 M** |
| Per-route-km | $9.7 M / km |
| Per-capita (city pop) | $727 / person |
...
| Stations | $68 M | 20% | $14 M | $55 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $26 M | 35% | $9.0 M | $17 M |
| Dedicated solar plant | $4.2 M | 45% | $1.9 M | $2.3 M |
| Residual signalling / train control | $939 k | 50% | $469 k | $469 k |
| Charging microgrids | $1.3 M | 40% | $530 k | $795 k |
| EPC / project services | $12 M | 15% | $1.7 M | $9.9 M |
| **Total city CAPEX** | **$182 M** | **21.2%** | **$39 M** | **$143 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh khouribga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$39 M** | **$7.7 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$143 M** | **$29 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $115 M | $23 M / yr |
| **Total city programme** | **100.0%** | **$182 M** | **$36 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $245 M | $207 M (84.3%) | $254 M | **$461 M** |
| **Default** | 2.00× | $327 M | $289 M (88.2%) | $355 M | **$644 M** |
| High | 3.00× | $491 M | $452 M (92.1%) | $556 M | **$1.01 bn** |

At the default 2.00× case, OSR's $39 M external requirement is 88.2% below the illustrative foreign-company requirement of $327 M; the associated lifetime external-interest saving is $355 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$13 M / yr** | $50 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$8.8 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$63 M cumulative** | $252 |
| Lifecycle envelope (yr 1–40, high scenario) | **$63 M cumulative** | $252 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$370 M cumulative** | $1,480 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $39 M | 4.5% | 40 y, 5 y grace | $2.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $115 M | 4.5% | 40 y, 5 y grace | $6.6 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $29 M | — | — | — |
| **Total** | **100%** | **$182 M** | | | **$8.8 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.7 M / yr + local bonds $5.2 M / yr = **$6.9 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.7 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (27.5 GWh / yr) | 8,729 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.5 GWh/yr + dedicated solar plant 5.3 MW / 11.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $63 k |
| Labour (202 FTE) | driverless roster: OCC/remote 41, station/platform 55, passenger service 38, fleet maintenance 26, infrastructure/energy 21, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$5.3 M / yr** |

_Annual service work: 8,729 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 3.4 M train-km / yr (6.9 M car-km / yr). On-site PV covers 17.5 GWh/yr and the dedicated solar plant adds 11.5 GWh/yr against 27.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 46 trainsets, 11 stations, 18.8 route-km, 3 lines, and 8,729 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 3% |
| Annual paid trips | 48.9 M | 78.2 M | 2.9 M |
| Annual paid trips / city resident | 196 | 313 | 12 |
| Farebox revenue | $53 M / yr | $86 M / yr | $3.1 M / yr |
| Station shop leases | $823 k / yr | $823 k / yr | $823 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$56 M / yr** | **$88 M / yr** | **$5.3 M / yr** |
| Revenue / OPEX recovery | 1051% | 1657% | 100% |
...
| Operating surplus after OPEX (before debt support) | $50 M / yr | $82 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,376 m² of station shop/kiosk leases at $33/m²/month and 452 advertising boards at $287/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $25 M / yr | $39 M / yr | 25% of paid trips × $2.05 local spend proxy |
...
| Commerce | 9 major/terminal/interchange nodes | 32,932 trips/trading day; 10.9 M access-events/yr | 52,691 trips/trading day; 17.4 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,549 trips/activity day; 4.4 M access-events/yr | 23,278 trips/activity day; 7.0 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $143 M | 79% of $182 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $229 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $46 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 7,277 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $178 M |
| Timetable-sized dedicated solar CAPEX | $4.2 M |
| **Reconciled project CAPEX** | **$182 M** |
| Imported / external-capital requirement | $39 M (21.2%) |
| Local-content / local-funding requirement | $143 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $327 M; OSR saves $289 M (88.2%) |
| Lifetime external interest and combined financing saving | $355 M interest; $644 M capital + interest |
| 15%–25% planning risk envelope | $209 M–$227 M |
| Annual OPEX | $5.3 M / yr |
| Low/high project NPV at 8% | $254 M / $508 M |
| Low/high project IRR | 18.9% / 26.7% |
| Low/high steady-state DSCR | 5.73 / 9.39 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 870.89 train-km; 4,681.52 kWh consumed; 5,155.53 kWh charged; 41 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 8,890.24 train-km; 47,789.84 kWh consumed; 48,753.69 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 84.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 84.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 86.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 47.5% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 68.8% | 100.0% / 90% | pass |
...
|---|---|
| ![Khouribga energy and battery simulation dashboard](engineering/screenshots/khouribga-simulation-dashboard.png) | ![Khouribga simulator network visualizer](engineering/screenshots/khouribga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 11 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Khouribga QGIS engineering layers](engineering/screenshots/khouribga-qgis-engineering-map.png) | ![Khouribga SUMO timetable validation](engineering/screenshots/khouribga-sumo-validation.png) |
...
| [`khouribga.toml`](khouribga.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`khouribga-network-map.png`](khouribga-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`khouribga.corridor.geojson`](khouribga.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`khouribga.stations.json`](khouribga.stations.json) | Machine-readable station list |
| [`khouribga.design-quality.yaml`](khouribga.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug khouribga

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh khouribga
```
