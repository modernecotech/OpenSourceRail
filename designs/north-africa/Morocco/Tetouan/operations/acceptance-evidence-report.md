...
| Manufacturing schedule rows | 1,203 |
| Manufacturing material/BOM rows | 17,852 |
| Manufacturing QA verification rows | 1,203 |
| Construction QA action rows | 1,114 |
| Maintenance handover schedule rows | 1,436 |
| Manufacturing rows with material refs | 1,203 / 1,203 |
| Manufacturing rows with verification refs | 1,203 / 1,203 |
| Manufacturing rows linked to QA actions | 1,203 / 1,203 |
