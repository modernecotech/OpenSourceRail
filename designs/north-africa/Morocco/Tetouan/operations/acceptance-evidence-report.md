# Tetouan Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 14,795 |
| Manufacturing QA verification rows | 936 |
| Construction QA action rows | 885 |
| Maintenance handover schedule rows | 1,101 |
