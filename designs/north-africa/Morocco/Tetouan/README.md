...
| Revenue fleet | 121 × 3-car trainsets |
| Revenue fleet passenger capacity | 43,560 AW2 pax (58,080 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 18.6 km | 11 | 47 | W Mid ↔ NE Outer |
| line-2 | 23.2 km | 14 | 57 | NE Outer ↔ SW Outer |
| line-3 | 12.3 km | 7 | 31 | W Outer ↔ SE Inner |
| **Total** | **54.1 km** | **32 unique** | **135** | |
...
| Revenue fleet capacity | 43,560 AW2 pax (58,080 AW3 crush) |
| Total fleet capacity | 48,600 AW2 pax (64,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 121 × 360 = **43,560 AW2 passengers** (58,080 AW3 crush)
- **Total fleet passenger capacity:** 135 × 360 = **48,600 AW2 passengers** (64,800 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **52.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 17.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 508 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 54 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 77 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 52.0 MW / 286 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 134 kWh | 233 kWh | 86 kWh | 2.4 km / 18 kWh |
| line-2 | 13 | 167 kWh | 282 kWh | 98 kWh | 4.4 km / 32 kWh |
| line-3 | 7 | 88 kWh | 151 kWh | 54 kWh | 2.8 km / 20 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 135 | $900 k | $122 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 405 | $60 k | $24 M |
| High sensitivity check | 405 | $120 k | $49 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 52,012 kW @ $700/kW | $36 M |
| Grid interconnection / PPA tie-in | 52,012 kW @ $100/kW | $5.2 M |
| Annual generation proxy | 52.0 MW × 5.5 peak-sun-h/day × 365 d/yr | 104.4 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $6.0 M |
| EPC overhead (7%) | $38 M |
| **CAPEX total** | **$615 M** |
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $93 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$234 M cumulative** | $467 |
| Lifecycle envelope (yr 1–40, high scenario) | **$234 M cumulative** | $467 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.22 bn cumulative** | $2,440 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $492 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $123 M | — | — | — |
| **Total** | **100%** | **$615 M** | | | **$28 M / yr** |
...
| Traction energy (118.9 GWh / yr) | 25,135 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.1 GWh/yr + dedicated solar plant 52.0 MW / 104.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $624 k |
| Labour (396 FTE) | driverless roster: OCC/remote 86, station/platform 115, passenger service 49, fleet maintenance 74, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 25,135 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.9 M train-km / yr (29.7 M car-km / yr). On-site PV covers 28.1 GWh/yr and the dedicated solar plant adds 104.4 GWh/yr against 118.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 135 trainsets, 32 stations, 54.1 route-km, 3 lines, and 25,135 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $80 M / yr | $128 M / yr | $12 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| **Total revenue** | **$85 M / yr** | **$133 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 528% | 829% | 100% |
...
_Commercial-revenue assumptions: 4,976 m² of station shop/kiosk leases at $33/m²/month and 956 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$96 M / yr** | **$154 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 5 healthcare anchors | 16,740 trips/day; 6.1 M access-events/yr | 26,784 trips/day; 9.8 M access-events/yr |
| Commerce | 18 major/terminal/interchange nodes | 44,005 trips/trading day; 14.5 M access-events/yr | 70,408 trips/trading day; 23.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $350 M | 57% of $615 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,805 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$615 M** |
| 15%–25% planning risk envelope | $707 M–$769 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $54 M / $435 M |
| Low/high project IRR | 8.9% / 14.2% |
| Low/high steady-state DSCR | 2.44 / 4.14 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,063.65 train-km; 14,857.34 kWh consumed; 15,941.67 kWh charged; 28 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,946.52 train-km; 186,803.48 kWh consumed; 190,776.85 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 71%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 64.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 57.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 70.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.6% / 60% | pass |
| ten-hour single charging-pad outage | 66.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 32 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
