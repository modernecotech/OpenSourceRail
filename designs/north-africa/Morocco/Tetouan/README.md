...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$827 M (87.3%) of external capital** and **$1.02 bn of external interest**. Capital plus saved interest totals **$1.84 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 103 × 3-car trainsets |
| Revenue fleet passenger capacity | 37,080 AW2 pax (49,440 AW3 crush) |
...
| Revenue fleet capacity | 37,080 AW2 pax (49,440 AW3 crush) |
| Total fleet capacity | 41,400 AW2 pax (55,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 103 × 360 = **37,080 AW2 passengers** (49,440 AW3 crush)
- **Total fleet passenger capacity:** 115 × 360 = **41,400 AW2 passengers** (55,200 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **56.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 494 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 50 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 57 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 25,135 train-km/day | One-way train journeys × route length |
| Annual service work | 9.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 326 MWh/day | 29.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 269 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 56.2 MW / 309 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 134 kWh | 229 kWh | 82 kWh | 3.6 km / 26 kWh |
| line-2 | 8 | 167 kWh | 261 kWh | 77 kWh | 6.4 km / 46 kWh |
| line-3 | 4 | 88 kWh | 147 kWh | 50 kWh | 5.8 km / 41 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (46.0 km @ $3.0 M/km) | $138 M |
| Elevated (8.0 km @ $12.0 M/km) | $96 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$239 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 115 | $900 k | $104 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 345 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 345 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 56,152 kW @ $700/kW | $39 M |
| Grid interconnection / PPA tie-in | 56,152 kW @ $100/kW | $5.6 M |
| Annual generation proxy | 56.2 MW × 5.5 peak-sun-h/day × 365 d/yr | 112.7 GWh/yr |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tetouan`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.8%** | **$120 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.2%** | **$406 M** | **$81 M / yr** |
| of which planned local bond issuance | 61.7% of total CAPEX | $325 M | $65 M / yr |
| **Total city programme** | **100.0%** | **$526 M** | **$105 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $710 M | $590 M (83.1%) | $726 M | **$1.32 bn** |
| **Default** | 2.00× | $947 M | $827 M (87.3%) | $1.02 bn | **$1.84 bn** |
| High | 3.00× | $1.42 bn | $1.30 bn (91.5%) | $1.60 bn | **$2.90 bn** |

At the default 2.00× case, OSR's $120 M external requirement is 87.3% below the illustrative foreign-company requirement of $947 M; the associated lifetime external-interest saving is $1.02 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $73 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$181 M cumulative** | $363 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $363 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $2,146 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $120 M | 4.5% | 40 y, 5 y grace | $6.9 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $325 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $81 M | — | — | — |
| **Total** | **100%** | **$526 M** | | | **$25 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.4 M / yr + local bonds $15 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($16 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (118.9 GWh / yr) | 25,135 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.9 GWh/yr + dedicated solar plant 56.2 MW / 112.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $674 k |
| Labour (334 FTE) | driverless roster: OCC/remote 73, station/platform 77, passenger service 49, fleet maintenance 68, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 25,135 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.9 M train-km / yr (29.7 M car-km / yr). On-site PV covers 20.9 GWh/yr and the dedicated solar plant adds 112.7 GWh/yr against 118.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 115 trainsets, 19 stations, 54.1 route-km, 3 lines, and 25,135 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.1 M |
| Annual paid trips / city resident | 147 | 235 | 20 |
| Farebox revenue | $80 M / yr | $128 M / yr | $11 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$83 M / yr** | **$131 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 591% | 933% | 100% |
...
| Operating surplus after OPEX (before debt support) | $69 M / yr | $117 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,336 m² of station shop/kiosk leases at $33/m²/month and 640 advertising boards at $287/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $23 M / yr | 179 M - 286 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.6 M / yr | $4.1 M / yr | 32.1–51.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.1 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $34 M / yr | $54 M / yr | 23% of paid trips × $2.05 local spend proxy |
| Entertainment / community activity supported | $16 M / yr | $25 M / yr | 11% of paid trips × $2.05 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$97 M / yr** | **$155 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 15,267 trips/school day; 3.4 M access-events/yr | 24,427 trips/school day; 5.4 M access-events/yr |
| Healthcare | 2 healthcare anchors | 14,865 trips/day; 5.4 M access-events/yr | 23,784 trips/day; 8.7 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 45,462 trips/trading day; 15.0 M access-events/yr | 72,740 trips/trading day; 24.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $406 M | 77% of $526 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $650 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $130 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 20,632 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$526 M** |
| Imported / external-capital requirement | $120 M (22.8%) |
| Local-content / local-funding requirement | $406 M (77.2%) |
| Default foreign-turnkey external-capital comparison | $947 M; OSR saves $827 M (87.3%) |
| Lifetime external interest and combined financing saving | $1.02 bn interest; $1.84 bn capital + interest |
| 15%–25% planning risk envelope | $605 M–$658 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $128 M / $510 M |
| Low/high project IRR | 10.3% / 16.1% |
| Low/high steady-state DSCR | 2.71 / 4.60 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,044.31 train-km; 14,717.94 kWh consumed; 14,099.22 kWh charged; 29 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 24,144.84 train-km; 173,830.16 kWh consumed; 176,755.15 kWh charged; 475 depot services completed (6 active at cutoff); minimum SoC 24%; 0 onboard emergencies; 0 invariant violations; 96.1% of scheduled train-km delivered; 4 SoC warnings |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 96.1% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 95.3% / 90% | pass |
| 50% charging-contact availability | 23.7% | 96.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 84.4% / 60% | pass |
...
|---|---|
| ![Tetouan energy and battery simulation dashboard](engineering/screenshots/tetouan-simulation-dashboard.png) | ![Tetouan simulator network visualizer](engineering/screenshots/tetouan-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Tetouan QGIS engineering layers](engineering/screenshots/tetouan-qgis-engineering-map.png) | ![Tetouan SUMO timetable validation](engineering/screenshots/tetouan-sumo-validation.png) |
...
scripts/regenerate-city.sh tetouan
```
