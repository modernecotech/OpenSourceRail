...
| Revenue fleet passenger capacity | 76,320 AW2 pax (101,760 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 22.3 km | 14 | 52 | NE Mid ↔ SW Outer |
| line-2 | 20.3 km | 15 | 50 | W Mid ↔ SE Mid |
| line-3 | 19.8 km | 13 | 46 | E Outer ↔ NW Inner |
| line-4 | 52.0 km | 34 | 29 | NW Inner ↔ W Mid |
| **Total** | **114.4 km** | **76 unique** | **177** | |
...
| Revenue fleet capacity | 76,320 AW2 pax (101,760 AW3 crush) |
| Total fleet capacity | 84,960 AW2 pax (113,280 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 159 × 480 = **76,320 AW2 passengers** (101,760 AW3 crush)
- **Total fleet passenger capacity:** 177 × 480 = **84,960 AW2 passengers** (113,280 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 33 | 300 kW | 1500 kWh |
| Major | 4 | 300 kW | 1500 kWh |
| Standard | 32 | 300 kW | 1500 kWh |
| Terminal | 5 | 300 kW | 1500 kWh |
| **Total installed** | **75** | **27,200 kW** | **151,000 kWh** |

Aggregate station-rail charging power: **112,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **117.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 15.0× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 672 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 428 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 150 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 561 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 117.3 MW / 645 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 151 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 215 kWh | 760 kWh | 524 kWh | 2.5 km / 24 kWh |
| line-2 | 15 | 195 kWh | 784 kWh | 569 kWh | 2.0 km / 19 kWh |
| line-3 | 12 | 190 kWh | 637 kWh | 428 kWh | 5.0 km / 48 kWh |
| line-4 | 34 | 499 kWh | 1,666 kWh | 1,117 kWh | 2.3 km / 22 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 177 | $1.12 M | $198 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 708 | $60 k | $42 M |
| High sensitivity check | 708 | $120 k | $85 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 117,295 kW @ $700/kW | $82 M |
| Grid interconnection / PPA tie-in | 117,295 kW @ $100/kW | $12 M |
| Annual generation proxy | 117.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 235.5 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$113 M / yr** | $87 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$68 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$565 M cumulative** | $435 |
| Lifecycle envelope (yr 1–40, high scenario) | **$565 M cumulative** | $435 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.95 bn cumulative** | $2,268 |

_Population basis: 1,300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $68 M / yr → $68 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.19 bn | 4.5% | 40 y, 5 y grace | $68 M / yr |
| Government equity (no debt service) | 20% | $297 M | — | — | — |
| **Total** | **100%** | **$1.49 bn** | | | **$68 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $54 M / yr = **$54 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($59 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (259.4 GWh / yr) | 41,121 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 54.6 GWh/yr + dedicated solar plant 117.3 MW / 235.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.4 M |
| Labour (790 FTE) | driverless roster: OCC/remote 106, station/platform 376, passenger service 72, fleet maintenance 108, infrastructure/energy 105, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $5.4 M |
| **OPEX subtotal** | | **$36 M / yr** |

_Annual service work: 41,121 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 16.2 M train-km / yr (64.8 M car-km / yr). On-site PV covers 54.6 GWh/yr and the dedicated solar plant adds 235.5 GWh/yr against 259.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 177 trainsets, 76 stations, 114.4 route-km, 4 lines, and 41,121 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (624,960 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the CAPEX funding stack, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 8% |
| Annual paid trips | 114.1 M | 182.5 M | 19.2 M |
| Annual paid trips / city resident | 88 | 140 | 15 |
| Farebox revenue | $125 M / yr | $200 M / yr | $21 M / yr |
| Station shop leases | $5.8 M / yr | $5.8 M / yr | $5.8 M / yr |
| Advertising boards | $8.8 M / yr | $8.8 M / yr | $8.8 M / yr |
| **Total revenue** | **$139 M / yr** | **$214 M / yr** | **$36 M / yr** |
| Revenue / OPEX recovery | 391% | 601% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Gross repayable-debt service + residual OPEX subsidy | $68 M / yr | $68 M / yr | **$68 M / yr** |
| Operating surplus applied to debt support | -$68 M / yr | -$68 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$68 M / yr** |
| Operating surplus after OPEX (before debt support) | $104 M / yr | $178 M / yr | $0 / yr |

_Commercial-revenue assumptions: 16,864 m² of station shop/kiosk leases at $33/m²/month and 3,000 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$167 M / yr** | **$268 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 8 education anchors | 21,208 trips/school day; 4.7 M access-events/yr | 33,933 trips/school day; 7.5 M access-events/yr |
| Healthcare | 4 healthcare anchors | 22,136 trips/day; 8.1 M access-events/yr | 35,417 trips/day; 12.9 M access-events/yr |
| Commerce | 43 major/terminal/interchange nodes | 68,561 trips/trading day; 22.6 M access-events/yr | 109,697 trips/trading day; 36.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $855 M | 57% of $1.49 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.37 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $274 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 43,432 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.39 bn |
| Timetable-sized dedicated solar CAPEX | $94 M |
| **Reconciled project CAPEX** | **$1.49 bn** |
| 15%–25% planning risk envelope | $1.71 bn–$1.86 bn |
| Annual OPEX | $36 M / yr |
| Low/high project NPV at 8% | $-364832 k / $229 M |
| Low/high project IRR | 5.2% / 9.5% |
| Low/high steady-state DSCR | 1.52 / 2.62 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,912.05 train-km; 27,954.75 kWh consumed; 31,953.16 kWh charged; 25 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 40,667.94 train-km; 390,398.90 kWh consumed; 398,039.99 kWh charged; 663 depot services completed (6 active at cutoff); minimum SoC 90%; 0 onboard emergencies; 0 invariant violations; 98.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 88.3% | 98.9% / 90% | pass |
| maximum planning climate/HVAC duty | 89.0% | 98.9% / 90% | pass |
| 50% charging-contact availability | 89.7% | 98.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.6% / 60% | pass |
| ten-hour single charging-pad outage | 89.7% | 98.9% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 4 corridors, 76 line platforms, 10 interchange complexes, 27 civil segments, and 0 input findings |
