...
| Bucket | Value |
|---|---|
| At-grade (102.4 km @ €3.5 M/km) | €358 M |
| Elevated (9.6 km @ €18 M/km) | €174 M |
| Elevated-interchange premium (8 sites @ €20 M) | €160 M |
| **Civil subtotal** | **€692 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 94 | €4.0 M | €376 M |
...
|---|---|---|
| Construction (years 1–5) | **€88 M / yr** | €68 |
| Steady-state, low-ridership (year 6+) | **€108 M / yr** | €83 |
| Steady-state, high-ridership (year 6+) | **€93 M / yr** | €72 |
| Lifecycle envelope (yr 1–25, low scenario) | **€2.60 bn cumulative** | €2,004 |
| Lifecycle envelope (yr 1–25, high scenario) | **€2.31 bn cumulative** | €1,774 |

_Population basis: 1,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€22 M / yr (low) → €7.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €824 M | 3.8% | 25 y, 5 y grace | €60 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €343 M | 4.5% | 25 y, 5 y grace | €26 M / yr |
| Government equity (no debt service) | 15% | €206 M | — | — | — |
| **Total** | **100%** | **€1.37 bn** | | | **€86 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €31 M / yr + bonds €15 M / yr = **€47 M / yr** total — plus the equity tranche amortised across construction (€41 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (687 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €4.4 M |
...
| Operating shortfall (gov subsidy required) | €22 M / yr | €7.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€108 M / yr** | **€93 M / yr** |
