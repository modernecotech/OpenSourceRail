...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 512 | $60 k | $31 M |
| High sensitivity check | 512 | $120 k | $61 M |
...
| Per-capita (city pop) | $881 / person |
...
| Steady-state, operating-neutral revenue case | **$52 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$435 M cumulative** | $335 |
| Lifecycle envelope (yr 1–40, high scenario) | **$435 M cumulative** | $335 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.27 bn cumulative** | $1,748 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $916 M | 4.5% | 40 y, 5 y grace | $52 M / yr |
| Government equity (no debt service) | 20% | $229 M | — | — | — |
| **Total** | **100%** | **$1.15 bn** | | | **$52 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $41 M / yr = **$41 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($46 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $656 M | 57% of $1.15 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.05 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $210 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 33,327 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.15 bn** |
| 15%–25% planning risk envelope | $1.32 bn–$1.43 bn |
| Annual OPEX | $27 M / yr |
| Low/high project NPV at 8% | $-75833 k / $518 M |
| Low/high project IRR | 7.3% / 12.1% |
| Low/high steady-state DSCR | 2.02 / 3.44 |
