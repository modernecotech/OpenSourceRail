...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.6%** | **$162 M** | **$32 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.4%** | **$201 M** | **$40 M / yr** |
| of which planned local bond issuance | 44.3% of total CAPEX | $161 M | $32 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$23 M / yr** | $32 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$113 M cumulative** | $161 |
| Lifecycle envelope (yr 1–40, high scenario) | **$113 M cumulative** | $161 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$760 M cumulative** | $1,086 |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $201 M | 55% of $363 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $322 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $64 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 10,223 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $162 M (44.6%) |
| Local-content / local-funding requirement | $201 M (55.4%) |
| 15%–25% planning risk envelope | $418 M–$454 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $286 M / $667 M |
| Low/high project IRR | 14.8% / 21.6% |
| Low/high steady-state DSCR | 3.92 / 6.52 |
