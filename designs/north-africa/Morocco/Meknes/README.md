...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 267 | $60 k | $16 M |
| High sensitivity check | 267 | $120 k | $32 M |
...
|---|---|---|
| Construction (years 1–5) | **$29 M / yr** | $41 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$145 M cumulative** | $206 |
| Lifecycle envelope (yr 1–40, high scenario) | **$145 M cumulative** | $206 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$754 M cumulative** | $1,078 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $304 M | 4.5% | 40 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $76 M | — | — | — |
| **Total** | **100%** | **$380 M** | | | **$17 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $214 M | 56% of $380 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 10,865 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $350 M |
...
| Low/high project IRR | 14.2% / 20.9% |
| Low/high steady-state DSCR | 4.16 / 6.92 |
