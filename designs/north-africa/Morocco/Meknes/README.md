...
|---|---|---|---|---|
| line-1 | 15.7 km | 9 | 40 | NE Outer ↔ SW Outer |
| line-2 | 12.2 km | 8 | 32 | N Outer ↔ S Mid |
| line-3 | 11.4 km | 9 | 29 | S Outer ↔ NW Mid |
| **Total** | **39.4 km** | **26 unique** | **101** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **35.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 31.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 73 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 69 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 168 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 35.2 MW / 194 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 113 kWh | 200 kWh | 76 kWh | 2.4 km / 17 kWh |
| line-2 | 8 | 88 kWh | 172 kWh | 75 kWh | 2.1 km / 15 kWh |
| line-3 | 9 | 82 kWh | 163 kWh | 73 kWh | 2.0 km / 15 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 303 | $60 k | $18 M |
| High sensitivity check | 303 | $120 k | $36 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 35,219 kW @ $700/kW | $25 M |
| Grid interconnection / PPA tie-in | 35,219 kW @ $100/kW | $3.5 M |
| Annual generation proxy | 35.2 MW × 5.5 peak-sun-h/day × 365 d/yr | 70.7 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh meknes`.
...
|---|---|---|
| Construction (years 1–5) | **$35 M / yr** | $50 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$175 M cumulative** | $250 |
| Lifecycle envelope (yr 1–40, high scenario) | **$175 M cumulative** | $250 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$912 M cumulative** | $1,303 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $368 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $92 M | — | — | — |
| **Total** | **100%** | **$460 M** | | | **$21 M / yr** |
...
| Traction energy (86.6 GWh / yr) | 18,302 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.1 GWh/yr + dedicated solar plant 35.2 MW / 70.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $423 k |
| Labour (347 FTE) | driverless roster: OCC/remote 69, station/platform 114, passenger service 49, fleet maintenance 55, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.4 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 18,302 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.2 M train-km / yr (21.6 M car-km / yr). On-site PV covers 25.1 GWh/yr and the dedicated solar plant adds 70.7 GWh/yr against 86.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 101 trainsets, 26 stations, 39.4 route-km, 3 lines, and 18,302 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 7.2 M |
| Annual paid trips / city resident | 105 | 168 | 10 |
| Farebox revenue | $80 M / yr | $128 M / yr | $7.9 M / yr |
...
| Revenue / OPEX recovery | 686% | 1076% | 100% |
...
| Operating surplus after OPEX (before debt support) | $72 M / yr | $120 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,960 m² of station shop/kiosk leases at $33/m²/month and 924 advertising boards at $287/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$90 M / yr** | **$143 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 5 education anchors | 13,744 trips/school day; 3.0 M access-events/yr | 21,991 trips/school day; 4.8 M access-events/yr |
| Healthcare | 4 healthcare anchors | 15,605 trips/day; 5.7 M access-events/yr | 24,968 trips/day; 9.1 M access-events/yr |
| Commerce | 15 major/terminal/interchange nodes | 44,309 trips/trading day; 14.6 M access-events/yr | 70,895 trips/trading day; 23.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $260 M | 57% of $460 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 13,235 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $206 M / $588 M |
| Low/high project IRR | 12.1% / 18.2% |
| Low/high steady-state DSCR | 3.43 / 5.71 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,627.59 train-km; 11,717.92 kWh consumed; 12,693.98 kWh charged; 32 depot services completed; minimum SoC 91%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,971.11 train-km; 136,583.66 kWh consumed; 139,686.23 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 74%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 69.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 63.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 74.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 46.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 6 civil segments, and 0 input findings |
