...
**Country:** MA · **Population:** 700,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$535 M (86.6%) of external capital** and **$658 M of external interest**. Capital plus saved interest totals **$1.19 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`meknes.corridor.geojson`](meknes.corridor.geojson).
...
| Route length (double track) | 39.4 km |
...
| Total fleet capacity | 32,040 AW2 pax (42,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 79 × 360 = **28,440 AW2 passengers** (37,920 AW3 crush)
- **Total fleet passenger capacity:** 89 × 360 = **32,040 AW2 passengers** (42,720 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 58.0%
- Catchment population: **≈ 406,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **38.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 16.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 506 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 18,302 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 38.3 MW / 211 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 113 kWh | 196 kWh | 71 kWh | 4.7 km / 34 kWh |
| line-2 | 5 | 88 kWh | 143 kWh | 46 kWh | 3.7 km / 27 kWh |
| line-3 | 6 | 82 kWh | 147 kWh | 57 kWh | 3.0 km / 22 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (38.2 km @ $2.58 M/km) | $99 M |
| Elevated (1.2 km @ $9.75 M/km) | $12 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$115 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 89 | $900 k | $80 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 267 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 267 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,324 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,324 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 38.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 76.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 39.4 km × $0.050 M/km | $2.0 M |
...
|---|---:|---:|---:|---:|
| Civil works | $115 M | 15% | $17 M | $98 M |
| Stations | $86 M | 20% | $17 M | $68 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $80 M | 35% | $28 M | $52 M |
| Dedicated solar plant | $31 M | 45% | $14 M | $17 M |
| Residual signalling / train control | $2.0 M | 50% | $984 k | $984 k |
| Charging microgrids | $1.9 M | 40% | $770 k | $1.2 M |
| EPC / project services | $20 M | 15% | $3.1 M | $17 M |
| **Total city CAPEX** | **$343 M** | **24.2%** | **$83 M** | **$260 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh meknes`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$83 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$260 M** | **$52 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $208 M | $42 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $463 M | $381 M (82.1%) | $468 M | **$848 M** |
| **Default** | 2.00× | $618 M | $535 M (86.6%) | $658 M | **$1.19 bn** |
| High | 3.00× | $927 M | $844 M (91.1%) | $1.04 bn | **$1.88 bn** |

At the default 2.00× case, OSR's $83 M external requirement is 86.6% below the illustrative foreign-company requirement of $618 M; the associated lifetime external-interest saving is $658 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$24 M / yr** | $34 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$118 M cumulative** | $168 |
| Lifecycle envelope (yr 1–40, high scenario) | **$118 M cumulative** | $168 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$701 M cumulative** | $1,002 |
...
| Traction energy (86.6 GWh / yr) | 18,302 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.7 GWh/yr + dedicated solar plant 38.3 MW / 76.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $460 k |
| Labour (287 FTE) | driverless roster: OCC/remote 61, station/platform 69, passenger service 49, fleet maintenance 51, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$9.9 M / yr** |

_Annual service work: 18,302 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.2 M train-km / yr (21.6 M car-km / yr). On-site PV covers 19.7 GWh/yr and the dedicated solar plant adds 76.9 GWh/yr against 86.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 89 trainsets, 17 stations, 39.4 route-km, 3 lines, and 18,302 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 6.6 M |
| Annual paid trips / city resident | 105 | 168 | 9 |
| Farebox revenue | $80 M / yr | $128 M / yr | $7.2 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| **Total revenue** | **$83 M / yr** | **$131 M / yr** | **$9.9 M / yr** |
| Revenue / OPEX recovery | 837% | 1322% | 100% |
...
_Commercial-revenue assumptions: 2,936 m² of station shop/kiosk leases at $33/m²/month and 568 advertising boards at $287/board/month, with occupancy derates applied._
...
| Avoided CO2e | $1.9 M / yr | $3.0 M / yr | 23.4–37.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $260 M | 76% of $343 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $417 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $83 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 13,230 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $313 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$343 M** |
| Imported / external-capital requirement | $83 M (24.2%) |
| Local-content / local-funding requirement | $260 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $618 M; OSR saves $535 M (86.6%) |
| Lifetime external interest and combined financing saving | $658 M interest; $1.19 bn capital + interest |
| 15%–25% planning risk envelope | $395 M–$429 M |
| Annual OPEX | $9.9 M / yr |
| Low/high project NPV at 8% | $304 M / $686 M |
| Low/high project IRR | 15.5% / 22.5% |
| Low/high steady-state DSCR | 4.37 / 7.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,651.69 train-km; 11,891.36 kWh consumed; 11,737.45 kWh charged; 35 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,538.08 train-km; 133,464.79 kWh consumed; 136,085.39 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 29%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 1 SoC warnings; 2 energy-adapted off-peak departures, maximum 12 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 24.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 28.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.9% / 60% | pass |
| ten-hour single charging-pad outage | 28.5% | 100.0% / 90% | pass |
...
|---|---|
| ![Meknes energy and battery simulation dashboard](engineering/screenshots/meknes-simulation-dashboard.png) | ![Meknes simulator network visualizer](engineering/screenshots/meknes-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 6 civil segments, and 0 input findings |
...
|---|---|
| ![Meknes QGIS engineering layers](engineering/screenshots/meknes-qgis-engineering-map.png) | ![Meknes SUMO timetable validation](engineering/screenshots/meknes-sumo-validation.png) |
...
| [`meknes.toml`](meknes.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`meknes-network-map.png`](meknes-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`meknes.corridor.geojson`](meknes.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`meknes.stations.json`](meknes.stations.json) | Machine-readable station list |
| [`meknes.design-quality.yaml`](meknes.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug meknes
