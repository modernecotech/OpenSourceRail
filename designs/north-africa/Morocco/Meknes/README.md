...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$568 M (86.9%) of external capital** and **$698 M of external interest**. Capital plus saved interest totals **$1.27 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (38.2 km @ $3.0 M/km) | $115 M |
...
| EPC / project services | $22 M | 15% | $3.3 M | $18 M |
| **Total city CAPEX** | **$363 M** | **23.7%** | **$86 M** | **$277 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$86 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$277 M** | **$55 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $222 M | $44 M / yr |
| **Total city programme** | **100.0%** | **$363 M** | **$73 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $490 M | $404 M (82.5%) | $497 M | **$901 M** |
| **Default** | 2.00× | $654 M | $568 M (86.9%) | $698 M | **$1.27 bn** |
| High | 3.00× | $981 M | $895 M (91.2%) | $1.10 bn | **$1.99 bn** |

At the default 2.00× case, OSR's $86 M external requirement is 86.9% below the illustrative foreign-company requirement of $654 M; the associated lifetime external-interest saving is $698 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$125 M cumulative** | $178 |
| Lifecycle envelope (yr 1–40, high scenario) | **$125 M cumulative** | $178 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$742 M cumulative** | $1,059 |
...
| Annual paid trips / city resident | 105 | 168 | 10 |
| Farebox revenue | $80 M / yr | $128 M / yr | $7.6 M / yr |
...
| Revenue / OPEX recovery | 806% | 1274% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $277 M | 76% of $363 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $444 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $89 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 14,088 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$363 M** |
| Imported / external-capital requirement | $86 M (23.7%) |
| Local-content / local-funding requirement | $277 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $654 M; OSR saves $568 M (86.9%) |
| Lifetime external interest and combined financing saving | $698 M interest; $1.27 bn capital + interest |
| 15%–25% planning risk envelope | $418 M–$454 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $286 M / $667 M |
| Low/high project IRR | 14.8% / 21.6% |
| Low/high steady-state DSCR | 4.12 / 6.85 |
