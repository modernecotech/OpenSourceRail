...
|---|---|---|---|---|
| line-1 | 21.0 km | 14 | 54 | N Outer ↔ S Outer |
| line-2 | 13.3 km | 9 | 32 | NW Outer ↔ S Outer |
| line-3 | 11.6 km | 8 | 29 | NE Mid ↔ SE Mid |
| **Total** | **45.9 km** | **31 unique** | **115** | |
...
| Onboard battery adequacy | 30.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 32.8 MW / 213 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 175 kWh | 302 kWh | 109 kWh | 2.1 km / 17 kWh |
| line-2 | 9 | 111 kWh | 163 kWh | 41 kWh | 2.0 km / 17 kWh |
| line-3 | 8 | 97 kWh | 147 kWh | 40 kWh | 2.0 km / 17 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 32,830 kW @ $700/kW | $23 M |
| Grid interconnection / PPA tie-in | 32,830 kW @ $100/kW | $3.3 M |
| Annual generation proxy | 32.8 MW × 6.5 peak-sun-h/day × 365 d/yr | 77.9 GWh/yr |
...
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$224 M cumulative** | $249 |
| Lifecycle envelope (yr 1–40, high scenario) | **$224 M cumulative** | $249 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$991 M cumulative** | $1,102 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $396 M | 4.5% | 40 y, 7 y grace | $23 M / yr |
...
| Traction energy (100.9 GWh / yr) | 21,340 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 33.2 GWh/yr + dedicated solar plant 32.8 MW / 77.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $394 k |
| Labour (357 FTE) | driverless roster: OCC/remote 73, station/platform 106, passenger service 49, fleet maintenance 63, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 21,340 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.2 M car-km / yr). On-site PV covers 33.2 GWh/yr and the dedicated solar plant adds 77.9 GWh/yr against 100.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 115 trainsets, 31 stations, 45.9 route-km, 3 lines, and 21,340 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 21.6 M |
| Annual paid trips / city resident | 81 | 130 | 24 |
| Farebox revenue | $34 M / yr | $55 M / yr | $10 M / yr |
| Station shop leases | $669 k / yr | $669 k / yr | $669 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 303% | 476% | 100% |
...
| Operating surplus after OPEX (before debt support) | $24 M / yr | $45 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,528 m² of station shop/kiosk leases at $14/m²/month and 884 advertising boards at $122/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$65 M / yr** | **$105 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 10,319 trips/school day; 2.3 M access-events/yr | 16,510 trips/school day; 3.6 M access-events/yr |
| Healthcare | 10 healthcare anchors | 20,934 trips/day; 7.6 M access-events/yr | 33,494 trips/day; 12.2 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 43,027 trips/trading day; 14.2 M access-events/yr | 68,844 trips/trading day; 22.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $283 M | 57% of $495 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 33,633 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $569 M–$619 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-206074 k / $-68149 k |
| Low/high project IRR | 2.5% / 6.5% |
| Low/high steady-state DSCR | 1.04 / 1.92 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,803.06 train-km; 15,057.43 kWh consumed; 15,829.38 kWh charged; 30 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,057.31 train-km; 184,201.80 kWh consumed; 187,560.01 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 70%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 63.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 63.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 69.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.7% / 60% | pass |
| ten-hour single charging-pad outage | 65.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 1 interchange complexes, 17 civil segments, and 0 input findings |
