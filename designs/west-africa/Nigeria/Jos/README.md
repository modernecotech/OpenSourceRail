...
| Steady-state, low-ridership (year 8+) | **$64 M / yr** | $71 |
| Steady-state, high-ridership (year 8+) | **$61 M / yr** | $67 |
| Steady-state, operating-neutral revenue case | **$54 M / yr** | $60 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.87 bn cumulative** | $2,079 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.79 bn cumulative** | $1,989 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.64 bn cumulative** | $1,823 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $10 M / yr → $6.5 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $415 M | 4.5% | 30 y, 7 y grace | $29 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $173 M | 13.5% | 30 y, 7 y grace | $25 M / yr |
| Government equity (no debt service) | 15% | $104 M | — | — | — |
| **Total** | **100%** | **$692 M** | | | **$54 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 41,634 | 69,390 | 120,228 |
| Daily paid trips / catchment | 18% | 30% | 52% |
| Daily paid trips / city population | 5% | 8% | 13% |
| Annual paid trips | 15.2 M | 25.3 M | 43.9 M |
...
| **Total revenue** | **$7.9 M / yr** | **$11 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 44% | 64% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $64 M / yr | $61 M / yr | **$54 M / yr** |
