...
|---|---|---|
| Construction (years 1–7) | **$28 M / yr** | $31 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $23 |
| Lifecycle envelope (yr 1–40, low scenario) | **$198 M cumulative** | $220 |
| Lifecycle envelope (yr 1–40, high scenario) | **$198 M cumulative** | $220 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$876 M cumulative** | $973 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $350 M | 4.5% | 40 y, 7 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $87 M | — | — | — |
| **Total** | **100%** | **$437 M** | | | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $249 M | 57% of $437 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 29,623 job-years | retained CAPEX ÷ (4.0 × median annual income) |
