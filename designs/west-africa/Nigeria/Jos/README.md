...
| Bucket | Value |
|---|---|
| At-grade (50.0 km @ €3.5 M/km) | €175 M |
| Elevated (3.4 km @ €18 M/km) | €60 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.9 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–7) | **€51 M / yr** | €57 |
| Steady-state, low-ridership (year 8+) | **€60 M / yr** | €66 |
| Steady-state, high-ridership (year 8+) | **€55 M / yr** | €61 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.73 bn cumulative** | €1,920 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.63 bn cumulative** | €1,807 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€11 M / yr (low) → €6.7 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €372 M | 4.5% | 30 y, 7 y grace | €26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €155 M | 13.5% | 30 y, 7 y grace | €22 M / yr |
| Government equity (no debt service) | 15% | €93 M | — | — | — |
| **Total** | **100%** | **€621 M** | | | **€48 M / yr** |
...
| Labour (335 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €906 k |
...
| Operating shortfall (gov subsidy required) | €11 M / yr | €6.7 M / yr |
