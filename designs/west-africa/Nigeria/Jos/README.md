...
|---|---|---|---|---|
| line-1 | 22.5 km | 18 | 23 | N Outer ↔ S Outer |
| line-2 | 18.5 km | 13 | 18 | SE Outer ↔ NW Outer |
| line-3 | 12.9 km | 9 | 14 | E Outer ↔ N Mid |
| **Total** | **53.9 km** | **40 unique** | **55** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **23,130 – 34,695 trips/day**
...
| PV daily yield proxy | 101 MWh/day | 5 peak-sun-hour planning proxy before local derates |
...
| Bucket | Value |
|---|---|
| At-grade (50.0 km @ $1.2 M/km) | $60 M |
| Elevated (3.4 km @ $5.5 M/km) | $18 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.9 km × $0.015 M/km | $808 k |
...
| Per-capita (city pop) | $212 / person |
...
| Steady-state, low-ridership (year 8+) | **$8.4 M / yr** | $9 |
| Steady-state, high-ridership (year 8+) | **$372 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$304 M cumulative** | $337 |
| Lifecycle envelope (yr 1–30, high scenario) | **$119 M cumulative** | $132 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$110 M cumulative** | $122 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $115 M | 4.5% | 30 y, 7 y grace | $8.1 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $5.2 M / yr + bonds $6.5 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($4.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (335 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $985 k |
...
|---|---|---|---|
| Daily paid trips | 72,000 | 135,000 | 137,913 |
| Daily paid trips / population | 8% | 15% | 15% |
| Annual paid trips | 26.3 M | 49.3 M | 50.3 M |
| Farebox revenue | $9.2 M / yr | $17 M / yr | $18 M / yr |
| Station shop leases | $995 k / yr | $995 k / yr | $995 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$12 M / yr** | **$20 M / yr** | **$20 M / yr** |
| Revenue / OPEX + debt-service recovery | 58% | 98% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $8.4 M / yr | $372 k / yr | **$0 / yr** |
