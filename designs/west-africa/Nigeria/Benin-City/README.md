...
| Revenue fleet | 161 × 4-car trainsets |
| Revenue fleet passenger capacity | 77,280 AW2 pax (103,040 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 30.5 km | 16 | 41 | N Outer ↔ S Outer |
| line-2 | 30.0 km | 17 | 41 | NE Outer ↔ SW Outer |
| line-3 | 26.1 km | 14 | 36 | NW Mid ↔ SE Outer |
| line-4 | 45.7 km | 30 | 61 | W Inner ↔ W Inner |
| **Total** | **132.3 km** | **76 unique** | **179** | |
...
| Revenue fleet capacity | 77,280 AW2 pax (103,040 AW3 crush) |
| Total fleet capacity | 85,920 AW2 pax (114,560 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 161 × 480 = **77,280 AW2 passengers** (103,040 AW3 crush)
- **Total fleet passenger capacity:** 179 × 480 = **85,920 AW2 passengers** (114,560 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **224.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 1,154 MWh/day | 66,805 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 976 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 224.6 MW / 1,123 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 224,571 kW @ $700/kW | $157 M |
| Grid interconnection / PPA tie-in | 224,571 kW @ $100/kW | $22 M |
| Annual generation proxy | 224.6 MW × 5.0 peak-sun-h/day × 365 d/yr | 409.8 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 132.3 km × $0.050 M/km | $6.6 M |
...
|---|---|---|
| Construction (years 1–7) | **$113 M / yr** | $63 |
| Steady-state, low capacity-use (year 8+) | **$94 M / yr** | $52 |
| Steady-state, high capacity-use (year 8+) | **$62 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$85 M / yr** | $47 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.88 bn cumulative** | $2,157 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.85 bn cumulative** | $1,582 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.59 bn cumulative** | $1,993 |

_Population basis: 1,800,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.0 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $22 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.03 bn | 2.0% | 40 y, 7 y grace | $85 M / yr |
| Government equity (no debt service) | 20% | $508 M | — | — | — |
| **Total** | **100%** | **$2.54 bn** | | | **$85 M / yr** |
...
| Traction energy (421.4 GWh / yr) | 66,805 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 65.0 GWh/yr + dedicated solar plant 224.6 MW / 409.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.7 M |
| Labour (855 FTE) | driverless roster: OCC/remote 110, station/platform 357, passenger service 71, fleet maintenance 142, infrastructure/energy 137, admin/training 38; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$67 M / yr** |

_Annual service work: 66,805 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 26.3 M train-km / yr (105.3 M car-km / yr). On-site PV covers 65.0 GWh/yr and the dedicated solar plant adds 409.8 GWh/yr against 421.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 59% |
| Annual paid trips | 112.1 M | 179.4 M | 131.3 M |
| Annual paid trips / city resident | 62 | 100 | 73 |
| Farebox revenue | $52 M / yr | $84 M / yr | $61 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$58 M / yr** | **$90 M / yr** | **$67 M / yr** |
| Revenue / OPEX recovery | 87% | 133% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $94 M / yr | $85 M / yr | **$85 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$22 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $94 M / yr | $62 M / yr | **$85 M / yr** |
| Operating surplus after OPEX (before debt support) | $0 k / yr | $22 M / yr | $0 / yr |
...
| Station-area commerce turnover supported | $39 M / yr | $62 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $18 M / yr | $29 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$126 M / yr** | **$201 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 13,139 trips/school day; 2.9 M access-events/yr | 21,022 trips/school day; 4.6 M access-events/yr |
| Healthcare | 14 healthcare anchors | 27,695 trips/day; 10.1 M access-events/yr | 44,312 trips/day; 16.2 M access-events/yr |
| Commerce | 50 major/terminal/interchange nodes | 70,373 trips/trading day; 23.2 M access-events/yr | 112,597 trips/trading day; 37.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.34 bn | 53% of $2.54 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 159,931 job-years | retained CAPEX ÷ (4.0 × median annual income) |
