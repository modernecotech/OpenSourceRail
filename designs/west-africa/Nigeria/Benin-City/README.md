...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 111 | $5.60 M | $622 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 444 | $100 k | $44 M |
| High sensitivity check | 444 | $200 k | $89 M |
...
| Per-capita (city pop) | $1,069 / person |
...
|---|---|---|
| Construction (years 1–7) | **$158 M / yr** | $88 |
| Steady-state, low-ridership (year 8+) | **$175 M / yr** | $97 |
| Steady-state, high-ridership (year 8+) | **$163 M / yr** | $90 |
| Steady-state, operating-neutral revenue case | **$150 M / yr** | $83 |
| Lifecycle envelope (yr 1–30, low scenario) | **$5.13 bn cumulative** | $2,852 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.85 bn cumulative** | $2,696 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.56 bn cumulative** | $2,534 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $25 M / yr → $13 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.15 bn | 4.5% | 30 y, 7 y grace | $82 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $481 M | 13.5% | 30 y, 7 y grace | $69 M / yr |
| Government equity (no debt service) | 15% | $288 M | — | — | — |
| **Total** | **100%** | **$1.92 bn** | | | **$150 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $52 M / yr + bonds $65 M / yr = **$117 M / yr** total — plus the equity tranche amortised across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 143,532 | 239,220 | 338,340 |
| Daily paid trips / catchment | 18% | 30% | 42% |
| Daily paid trips / city population | 8% | 13% | 19% |
| Annual paid trips | 52.4 M | 87.3 M | 123.5 M |
| Farebox revenue | $18 M / yr | $31 M / yr | $43 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$24 M / yr** | **$37 M / yr** | **$49 M / yr** |
| Revenue / OPEX recovery | 49% | 74% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $175 M / yr | $163 M / yr | **$150 M / yr** |
