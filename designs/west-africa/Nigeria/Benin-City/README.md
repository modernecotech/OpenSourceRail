...
| Bucket | Value |
|---|---|
| At-grade (114.6 km @ €3.5 M/km) | €401 M |
| Elevated (16.8 km @ €18 M/km) | €302 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 111 | €4.0 M | €444 M |
...
|---|---|---|
| Construction (years 1–7) | **€145 M / yr** | €80 |
| Steady-state, low-ridership (year 8+) | **€172 M / yr** | €96 |
| Steady-state, high-ridership (year 8+) | **€163 M / yr** | €91 |
| Lifecycle envelope (yr 1–30, low scenario) | **€4.97 bn cumulative** | €2,761 |
| Lifecycle envelope (yr 1–30, high scenario) | **€4.77 bn cumulative** | €2,648 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€35 M / yr (low) → €26 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.06 bn | 4.5% | 30 y, 7 y grace | €75 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €440 M | 13.5% | 30 y, 7 y grace | €63 M / yr |
| Government equity (no debt service) | 15% | €264 M | — | — | — |
| **Total** | **100%** | **€1.76 bn** | | | **€137 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €48 M / yr + bonds €59 M / yr = **€107 M / yr** total — plus the equity tranche amortised across construction (€38 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (806 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €2.2 M |
...
| Operating shortfall (gov subsidy required) | €35 M / yr | €26 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€172 M / yr** | **€163 M / yr** |
