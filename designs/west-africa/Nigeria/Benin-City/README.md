...
|---|---|---|
| Construction (years 1–7) | **$110 M / yr** | $61 |
| Steady-state, low-ridership (year 8+) | **$109 M / yr** | $61 |
| Steady-state, high-ridership (year 8+) | **$104 M / yr** | $58 |
| Steady-state, operating-neutral revenue case | **$104 M / yr** | $58 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.28 bn cumulative** | $1,823 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.17 bn cumulative** | $1,762 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.17 bn cumulative** | $1,762 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.8 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $802 M | 4.5% | 30 y, 7 y grace | $57 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $334 M | 13.5% | 30 y, 7 y grace | $48 M / yr |
| Government equity (no debt service) | 15% | $201 M | — | — | — |
| **Total** | **100%** | **$1.34 bn** | | | **$104 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $36 M / yr + bonds $45 M / yr = **$81 M / yr** total — plus the equity tranche amortised across construction ($29 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 143,532 | 239,220 | 180,798 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 8% | 13% | 10% |
| Annual paid trips | 52.4 M | 87.3 M | 66.0 M |
| Farebox revenue | $18 M / yr | $31 M / yr | $23 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$24 M / yr** | **$37 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 84% | 126% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $109 M / yr | $104 M / yr | **$104 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $7.5 M / yr | $0 / yr |
