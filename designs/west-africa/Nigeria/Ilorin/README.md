...
| Revenue fleet | 130 × 3-car trainsets |
| Revenue fleet passenger capacity | 46,800 AW2 pax (62,400 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 20.9 km | 14 | 54 | SW Mid ↔ E Outer |
| line-2 | 21.7 km | 11 | 54 | W Mid ↔ NE Outer |
| line-3 | 14.2 km | 8 | 36 | NW Mid ↔ SW Outer |
| **Total** | **56.8 km** | **33 unique** | **144** | |
...
| Revenue fleet capacity | 46,800 AW2 pax (62,400 AW3 crush) |
| Total fleet capacity | 51,840 AW2 pax (69,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 130 × 360 = **46,800 AW2 passengers** (62,400 AW3 crush)
- **Total fleet passenger capacity:** 144 × 360 = **51,840 AW2 passengers** (69,120 AW3 crush, incl. service rotation + spare + reserve)
...
| Major | 8 | 300 kW | 500 kWh |
| Standard | 15 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **32** | **14,300 kW** | **55,500 kWh** |

Aggregate station-rail charging power: **16,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **65.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 501 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 54 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 69 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 274 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 65.6 MW / 315 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 56 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 156 kWh | 294 kWh | 122 kWh | 2.5 km / 19 kWh |
| line-2 | 10 | 162 kWh | 253 kWh | 75 kWh | 5.2 km / 39 kWh |
| line-3 | 8 | 107 kWh | 172 kWh | 54 kWh | 2.2 km / 16 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 144 | $900 k | $130 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 432 | $60 k | $26 M |
| High sensitivity check | 432 | $120 k | $52 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 65,576 kW @ $700/kW | $46 M |
| Grid interconnection / PPA tie-in | 65,576 kW @ $100/kW | $6.6 M |
| Annual generation proxy | 65.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 114.9 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $6.3 M |
| EPC overhead (7%) | $37 M |
| **CAPEX total** | **$611 M** |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ilorin`.
...
|---|---|---|
| Construction (years 1–7) | **$39 M / yr** | $39 |
| Steady-state, low capacity-use (year 8+) | **$7.1 M / yr** | $7 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $29 |
| Lifecycle envelope (yr 1–40, low scenario) | **$509 M cumulative** | $509 |
| Lifecycle envelope (yr 1–40, high scenario) | **$276 M cumulative** | $276 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.22 bn cumulative** | $1,223 |

_Population basis: 1,000,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $29 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $489 M | 4.5% | 40 y, 7 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $122 M | — | — | — |
| **Total** | **100%** | **$611 M** | | | **$29 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $22 M / yr = **$22 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($17 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (125.0 GWh / yr) | 26,416 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.1 GWh/yr + dedicated solar plant 65.6 MW / 114.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $787 k |
| Labour (406 FTE) | driverless roster: OCC/remote 90, station/platform 115, passenger service 49, fleet maintenance 78, infrastructure/energy 53, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 26,416 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.4 M train-km / yr (31.2 M car-km / yr). On-site PV covers 25.1 GWh/yr and the dedicated solar plant adds 114.9 GWh/yr against 125.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 144 trainsets, 33 stations, 56.8 route-km, 3 lines, and 26,416 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 27.0 M |
| Annual paid trips / city resident | 73 | 117 | 27 |
| Farebox revenue | $34 M / yr | $55 M / yr | $13 M / yr |
| Station shop leases | $727 k / yr | $727 k / yr | $727 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 249% | 391% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $29 M / yr | $29 M / yr | **$29 M / yr** |
| Operating surplus applied to debt support | -$22 M / yr | -$29 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $7.1 M / yr | $0 k / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $42 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,920 m² of station shop/kiosk leases at $14/m²/month and 952 advertising boards at $122/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$70 M / yr** | **$112 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 11,651 trips/school day; 2.6 M access-events/yr | 18,642 trips/school day; 4.1 M access-events/yr |
| Healthcare | 9 healthcare anchors | 18,381 trips/day; 6.7 M access-events/yr | 29,409 trips/day; 10.7 M access-events/yr |
| Commerce | 17 major/terminal/interchange nodes | 43,007 trips/trading day; 14.2 M access-events/yr | 68,811 trips/trading day; 22.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $342 M | 56% of $611 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 40,754 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $558 M |
| Timetable-sized dedicated solar CAPEX | $52 M |
| **Reconciled project CAPEX** | **$611 M** |
| 15%–25% planning risk envelope | $702 M–$763 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-308863 k / $-170938 k |
| Low/high project IRR | 0.8% / 4.7% |
| Low/high steady-state DSCR | 0.75 / 1.47 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,138.24 train-km; 16,010.94 kWh consumed; 16,927.00 kWh charged; 26 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,251.81 train-km; 204,059.03 kWh consumed; 208,178.05 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 56%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 46.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 56.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.2% / 60% | pass |
| ten-hour single charging-pad outage | 56.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 33 line platforms, 2 interchange complexes, 67 civil segments, and 0 input findings |
