...
**Country:** NG · **Population:** 1,000,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$783 M (86.5%) of external capital** and **$981 M of external interest**. Capital plus saved interest totals **$1.76 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`ilorin.corridor.geojson`](ilorin.corridor.geojson).
...
| Anchor-weighted coverage | 54.9% |
| Route length (double track) | 56.8 km |
| Revenue fleet | 111 × 3-car trainsets |
| Revenue fleet passenger capacity | 39,960 AW2 pax (53,280 AW3 crush) |
...
| Revenue fleet capacity | 39,960 AW2 pax (53,280 AW3 crush) |
| Total fleet capacity | 44,640 AW2 pax (59,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 111 × 360 = **39,960 AW2 passengers** (53,280 AW3 crush)
- **Total fleet passenger capacity:** 124 × 360 = **44,640 AW2 passengers** (59,520 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 54.9%
- Catchment population: **≈ 549,000** (within ~800 m walk of a station)
...
| Standard | 13 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **25** | **12,200 kW** | **52,000 kWh** |

Aggregate station-rail charging power: **12,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **68.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 498 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 54 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 59 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 26,416 train-km/day | One-way train journeys × route length |
| Annual service work | 10.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 342 MWh/day | 31.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 284 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 68.0 MW / 326 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 156 kWh | 245 kWh | 73 kWh | 3.0 km / 23 kWh |
| line-2 | 9 | 162 kWh | 261 kWh | 83 kWh | 5.7 km / 42 kWh |
| line-3 | 6 | 107 kWh | 172 kWh | 54 kWh | 4.1 km / 31 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (52.9 km @ $2.58 M/km) | $137 M |
| Elevated (3.9 km @ $9.75 M/km) | $38 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 124 | $900 k | $112 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 372 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 372 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 67,991 kW @ $700/kW | $48 M |
| Grid interconnection / PPA tie-in | 67,991 kW @ $100/kW | $6.8 M |
| Annual generation proxy | 68.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 119.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.8 km × $0.050 M/km | $2.8 M |
...
| Per-capita (city pop) | $503 / person |
...
| Stations | $110 M | 20% | $22 M | $88 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $112 M | 35% | $39 M | $73 M |
| Dedicated solar plant | $54 M | 45% | $24 M | $30 M |
| Residual signalling / train control | $2.8 M | 50% | $1.4 M | $1.4 M |
| Charging microgrids | $2.7 M | 40% | $1.1 M | $1.6 M |
| EPC / project services | $29 M | 15% | $4.4 M | $25 M |
| **Total city CAPEX** | **$503 M** | **24.3%** | **$122 M** | **$381 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ilorin`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$122 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$381 M** | **$54 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $304 M | $43 M / yr |
| **Total city programme** | **100.0%** | **$503 M** | **$72 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $678 M | $556 M (82.0%) | $697 M | **$1.25 bn** |
| **Default** | 2.00× | $905 M | $783 M (86.5%) | $981 M | **$1.76 bn** |
| High | 3.00× | $1.36 bn | $1.23 bn (91.0%) | $1.55 bn | **$2.78 bn** |

At the default 2.00× case, OSR's $122 M external requirement is 86.5% below the illustrative foreign-company requirement of $905 M; the associated lifetime external-interest saving is $981 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$57 M / yr** | $57 |
| Steady-state, low capacity-use (year 8+) | **$26 M / yr** | $26 |
| Steady-state, high capacity-use (year 8+) | **$5.2 M / yr** | $5 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.25 bn cumulative** | $1,251 |
| Lifecycle envelope (yr 1–40, high scenario) | **$573 M cumulative** | $573 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.02 bn cumulative** | $2,016 |

_Population basis: 1,000,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $23 M / yr → $44 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $122 M | 4.5% | 40 y, 7 y grace | $7.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $304 M | 13.5% | 40 y, 7 y grace | $42 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $76 M | — | — | — |
| **Total** | **100%** | **$503 M** | | | **$49 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.5 M / yr + local bonds $41 M / yr = **$47 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $142 k |
| Traction energy (125.0 GWh / yr) | 26,416 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.4 GWh/yr + dedicated solar plant 68.0 MW / 119.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $816 k |
| Labour (361 FTE) | driverless roster: OCC/remote 77, station/platform 91, passenger service 49, fleet maintenance 72, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 26,416 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.4 M train-km / yr (31.2 M car-km / yr). On-site PV covers 21.4 GWh/yr and the dedicated solar plant adds 119.1 GWh/yr against 125.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 124 trainsets, 26 stations, 56.8 route-km, 3 lines, and 26,416 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 23.6 M |
| Annual paid trips / city resident | 73 | 117 | 24 |
| Farebox revenue | $34 M / yr | $55 M / yr | $11 M / yr |
| Station shop leases | $558 k / yr | $558 k / yr | $558 k / yr |
| Advertising boards | $925 k / yr | $925 k / yr | $925 k / yr |
| **Total revenue** | **$36 M / yr** | **$56 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 285% | 449% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $49 M / yr | $49 M / yr | **$49 M / yr** |
| Operating surplus applied to debt support | -$23 M / yr | -$44 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $26 M / yr | $5.2 M / yr | **$49 M / yr** |
| Operating surplus after OPEX (before debt support) | $23 M / yr | $44 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,776 m² of station shop/kiosk leases at $14/m²/month and 740 advertising boards at $122/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $9.9 M / yr | $16 M / yr | 16 min/trip × $0.50/h value-of-time proxy |
| Avoided road congestion | $15 M / yr | $24 M / yr | 187 M - 300 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.7 M / yr | $4.3 M / yr | 33.7–54.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.5 M / yr | $12 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $23 M / yr | $37 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $12 M / yr | $19 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$70 M / yr** | **$111 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 9,391 trips/school day; 2.1 M access-events/yr | 15,026 trips/school day; 3.3 M access-events/yr |
| Healthcare | 6 healthcare anchors | 18,381 trips/day; 6.7 M access-events/yr | 29,409 trips/day; 10.7 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 41,876 trips/trading day; 13.8 M access-events/yr | 67,001 trips/trading day; 22.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $381 M | 76% of $503 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $609 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $87 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 45,300 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $448 M |
| Timetable-sized dedicated solar CAPEX | $54 M |
| **Reconciled project CAPEX** | **$503 M** |
| Imported / external-capital requirement | $122 M (24.3%) |
| Local-content / local-funding requirement | $381 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $905 M; OSR saves $783 M (86.5%) |
| Lifetime external interest and combined financing saving | $981 M interest; $1.76 bn capital + interest |
| 15%–25% planning risk envelope | $578 M–$628 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-218000 k / $-80075 k |
| Low/high project IRR | 2.2% / 6.2% |
| Low/high steady-state DSCR | 0.47 / 0.89 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,161.58 train-km; 16,185.76 kWh consumed; 16,094.87 kWh charged; 27 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,963.31 train-km; 201,899.08 kWh consumed; 204,667.28 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 26%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 1 SoC warnings |
...
| 50% charging-contact availability | 26.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 88.3% / 60% | pass |
| ten-hour single charging-pad outage | 24.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Ilorin energy and battery simulation dashboard](engineering/screenshots/ilorin-simulation-dashboard.png) | ![Ilorin simulator network visualizer](engineering/screenshots/ilorin-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 2 interchange complexes, 67 civil segments, and 0 input findings |
...
|---|---|
| ![Ilorin QGIS engineering layers](engineering/screenshots/ilorin-qgis-engineering-map.png) | ![Ilorin SUMO timetable validation](engineering/screenshots/ilorin-sumo-validation.png) |
...
| [`ilorin.toml`](ilorin.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`ilorin-network-map.png`](ilorin-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`ilorin.corridor.geojson`](ilorin.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`ilorin.stations.json`](ilorin.stations.json) | Machine-readable station list |
| [`ilorin.design-quality.yaml`](ilorin.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
