...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 372 | $60 k | $22 M |
| High sensitivity check | 372 | $120 k | $45 M |
...
| Per-capita (city pop) | $559 / person |
...
|---|---|---|
| Construction (years 1–7) | **$36 M / yr** | $36 |
| Steady-state, low capacity-use (year 8+) | **$3.7 M / yr** | $4 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$375 M cumulative** | $375 |
| Lifecycle envelope (yr 1–40, high scenario) | **$253 M cumulative** | $253 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.12 bn cumulative** | $1,120 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $447 M | 4.5% | 40 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $112 M | — | — | — |
| **Total** | **100%** | **$559 M** | | | **$26 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $20 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.7 M / yr | $0 k / yr | **$26 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $313 M | 56% of $559 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $501 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $72 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 37,307 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$559 M** |
| 15%–25% planning risk envelope | $643 M–$699 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-264357 k / $-126432 k |
| Low/high project IRR | 1.5% / 5.4% |
| Low/high steady-state DSCR | 0.86 / 1.64 |
