# Ilorin Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 335 |
| Manufacturing schedule rows | 1,270 |
| Manufacturing material/BOM rows | 18,982 |
| Manufacturing QA verification rows | 1,270 |
| Construction QA action rows | 1,179 |
| Maintenance handover schedule rows | 1,516 |
| Manufacturing rows with material refs | 1,270 / 1,270 |
| Manufacturing rows with verification refs | 1,270 / 1,270 |
| Manufacturing rows linked to QA actions | 1,270 / 1,270 |
