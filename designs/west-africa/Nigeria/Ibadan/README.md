...
| Revenue fleet | 257 × 6-car trainsets |
| Revenue fleet passenger capacity | 185,040 AW2 pax (246,720 AW3 crush) |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 24 planned-maintenance spares and 5 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 26.9 km | 16 | 70 | N Outer ↔ S Mid |
| line-2 | 24.1 km | 14 | 63 | NW Mid ↔ SE Mid |
| line-3 | 20.4 km | 14 | 57 | E Mid ↔ W Mid |
| line-4 | 29.7 km | 17 | 73 | E Mid ↔ W Outer |
| line-5 | 34.2 km | 24 | 23 | W Inner ↔ W Inner |
| **Total** | **135.3 km** | **85 unique** | **286** | |
...
| Revenue fleet capacity | 185,040 AW2 pax (246,720 AW3 crush) |
| Total fleet capacity | 205,920 AW2 pax (274,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 257 × 720 = **185,040 AW2 passengers** (246,720 AW3 crush)
- **Total fleet passenger capacity:** 286 × 720 = **205,920 AW2 passengers** (274,560 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 36 | 300 kW | 2000 kWh |
| Major | 1 | 300 kW | 2000 kWh |
| Standard | 37 | 300 kW | 2000 kWh |
| Terminal | 7 | 300 kW | 2000 kWh |
| **Total installed** | **82** | **29,300 kW** | **202,000 kWh** |

Aggregate station-rail charging power: **164,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **307.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.2× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 906 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 523 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 141 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 307.7 MW / 1,477 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 202 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 402 kWh | 1,111 kWh | 668 kWh | 2.1 km / 31 kWh |
| line-2 | 14 | 361 kWh | 980 kWh | 583 kWh | 2.1 km / 31 kWh |
| line-3 | 14 | 306 kWh | 980 kWh | 643 kWh | 2.3 km / 34 kWh |
| line-4 | 14 | 445 kWh | 1,013 kWh | 523 kWh | 11.6 km / 174 kWh |
| line-5 | 24 | 512 kWh | 1,568 kWh | 1,005 kWh | 2.3 km / 34 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (121.4 km @ $3.0 M/km) | $364 M |
| Elevated (13.9 km @ $12.0 M/km) | $166 M |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 286 | $1.68 M | $480 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1716 | $60 k | $103 M |
| High sensitivity check | 1716 | $120 k | $206 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 307,673 kW @ $700/kW | $215 M |
| Grid interconnection / PPA tie-in | 307,673 kW @ $100/kW | $31 M |
| Annual generation proxy | 307.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 539.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$246 M** |
...
| Dedicated solar power plant | $246 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ibadan`.
...
|---|---|---|
| Construction (years 1–7) | **$138 M / yr** | $35 |
| Steady-state, low capacity-use (year 8+) | **$40 M / yr** | $10 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$101 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.29 bn cumulative** | $588 |
| Lifecycle envelope (yr 1–40, high scenario) | **$967 M cumulative** | $248 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.28 bn cumulative** | $1,099 |

_Population basis: 3,900,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $60 M / yr → $101 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.71 bn | 4.5% | 40 y, 7 y grace | $101 M / yr |
| Government equity (no debt service) | 20% | $428 M | — | — | — |
| **Total** | **100%** | **$2.14 bn** | | | **$101 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $77 M / yr = **$77 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($61 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (520.1 GWh / yr) | 54,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 51.3 GWh/yr + dedicated solar plant 307.7 MW / 539.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.7 M |
| Labour (1,001 FTE) | driverless roster: OCC/remote 162, station/platform 409, passenger service 124, fleet maintenance 159, infrastructure/energy 122, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $2.9 M |
| **OPEX subtotal** | | **$49 M / yr** |

_Annual service work: 54,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 21.7 M train-km / yr (130.0 M car-km / yr). On-site PV covers 51.3 GWh/yr and the dedicated solar plant adds 539.0 GWh/yr against 520.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 286 trainsets, 85 stations, 135.3 route-km, 5 lines, and 54,971 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (1,205,280 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the CAPEX funding stack, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 21% |
| Annual paid trips | 220.0 M | 351.9 M | 90.6 M |
| Annual paid trips / city resident | 56 | 90 | 23 |
| Farebox revenue | $103 M / yr | $164 M / yr | $42 M / yr |
| Station shop leases | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| Advertising boards | $4.1 M / yr | $4.1 M / yr | $4.1 M / yr |
| **Total revenue** | **$109 M / yr** | **$171 M / yr** | **$49 M / yr** |
| Revenue / OPEX recovery | 223% | 349% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $101 M / yr | $101 M / yr | **$101 M / yr** |
| Operating surplus applied to debt support | -$60 M / yr | -$101 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $40 M / yr | $0 k / yr | **$101 M / yr** |
| Operating surplus after OPEX (before debt support) | $60 M / yr | $122 M / yr | $0 / yr |

_Commercial-revenue assumptions: 18,176 m² of station shop/kiosk leases at $14/m²/month and 3,252 advertising boards at $122/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 31,079 trips/school day; 6.8 M access-events/yr | 49,726 trips/school day; 10.9 M access-events/yr |
| Healthcare | 19 healthcare anchors | 70,509 trips/day; 25.7 M access-events/yr | 112,814 trips/day; 41.2 M access-events/yr |
| Commerce | 45 major/terminal/interchange nodes | 129,922 trips/trading day; 42.9 M access-events/yr | 207,875 trips/trading day; 68.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.17 bn | 55% of $2.14 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 138,925 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.89 bn |
| Timetable-sized dedicated solar CAPEX | $246 M |
| **Reconciled project CAPEX** | **$2.14 bn** |
| 15%–25% planning risk envelope | $2.46 bn–$2.67 bn |
| Annual OPEX | $49 M / yr |
| Low/high project NPV at 8% | $-1185547 k / $-771772 k |
| Low/high project IRR | -0.4% / 3.5% |
| Low/high steady-state DSCR | 0.60 / 1.21 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,117.13 train-km; 61,657.39 kWh consumed; 67,841.04 kWh charged; 32 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 55,974.64 train-km; 838,266.88 kWh consumed; 855,423.23 kWh charged; 827 depot services completed (7 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 72.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 70.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 77.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 89.9% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 85 line platforms, 8 interchange complexes, 157 civil segments, and 0 input findings |
