...
**Country:** NG · **Population:** 3,900,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.58 bn (85.8%) of external capital** and **$3.24 bn of external interest**. Capital plus saved interest totals **$5.82 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`ibadan.corridor.geojson`](ibadan.corridor.geojson).
...
| Anchor-weighted coverage | 38.5% |
| Route length (double track) | 135.3 km |
| Revenue fleet | 200 × 6-car trainsets |
| Revenue fleet passenger capacity | 144,000 AW2 pax (192,000 AW3 crush) |
...
| Revenue fleet capacity | 144,000 AW2 pax (192,000 AW3 crush) |
| Total fleet capacity | 159,840 AW2 pax (213,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 200 × 720 = **144,000 AW2 passengers** (192,000 AW3 crush)
- **Total fleet passenger capacity:** 222 × 720 = **159,840 AW2 passengers** (213,120 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 38.5%
- Catchment population: **≈ 1,501,500** (within ~800 m walk of a station)
...
| Interchange | 19 | 300 kW | 2000 kWh |
| Major | 1 | 300 kW | 2000 kWh |
| Standard | 25 | 300 kW | 2000 kWh |
| Terminal | 7 | 300 kW | 2000 kWh |
| **Total installed** | **53** | **20,600 kW** | **144,000 kWh** |

Aggregate station-rail charging power: **106,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **317.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 4.7× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 849 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 221 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 99 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,092 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 54,971 train-km/day | One-way train journeys × route length |
| Annual service work | 21.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,425 MWh/day | 130.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,326 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 317.7 MW / 1,525 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 144 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 402 kWh | 849 kWh | 407 kWh | 4.6 km / 69 kWh |
| line-2 | 12 | 361 kWh | 849 kWh | 452 kWh | 3.0 km / 45 kWh |
| line-3 | 9 | 306 kWh | 653 kWh | 317 kWh | 3.2 km / 48 kWh |
| line-4 | 8 | 445 kWh | 817 kWh | 327 kWh | 15.4 km / 231 kWh |
| line-5 | 12 | 512 kWh | 784 kWh | 221 kWh | 4.0 km / 60 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (120.3 km @ $3.0 M/km) | $361 M |
| Elevated (15.0 km @ $12.0 M/km) | $180 M |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 222 | $1.68 M | $373 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 1332 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 1332 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 317,678 kW @ $700/kW | $222 M |
| Grid interconnection / PPA tie-in | 317,678 kW @ $100/kW | $32 M |
| Annual generation proxy | 317.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 556.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$254 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 135.3 km × $0.050 M/km | $6.8 M |
...
| EPC integration + project management (7%) | on subtotal | $93 M |
...
|---|---:|---:|---:|---:|
| Civil works | $581 M | 15% | $87 M | $494 M |
| Stations | $333 M | 20% | $67 M | $266 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $373 M | 35% | $131 M | $242 M |
| Dedicated solar plant | $254 M | 45% | $114 M | $140 M |
| Residual signalling / train control | $6.8 M | 50% | $3.4 M | $3.4 M |
| Charging microgrids | $24 M | 40% | $9.5 M | $14 M |
| EPC / project services | $93 M | 15% | $14 M | $79 M |
| **Total city CAPEX** | **$1.67 bn** | **25.6%** | **$427 M** | **$1.24 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ibadan`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.6%** | **$427 M** | **$61 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.4%** | **$1.24 bn** | **$178 M / yr** |
| of which planned local bond issuance | 59.6% of total CAPEX | $996 M | $142 M / yr |
| **Total city programme** | **100.0%** | **$1.67 bn** | **$239 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.26 bn | $1.83 bn (81.1%) | $2.29 bn | **$4.12 bn** |
| **Default** | 2.00× | $3.01 bn | $2.58 bn (85.8%) | $3.24 bn | **$5.82 bn** |
| High | 3.00× | $4.52 bn | $4.09 bn (90.5%) | $5.12 bn | **$9.21 bn** |

At the default 2.00× case, OSR's $427 M external requirement is 85.8% below the illustrative foreign-company requirement of $3.01 bn; the associated lifetime external-interest saving is $3.24 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$189 M / yr** | $49 |
| Steady-state, low capacity-use (year 8+) | **$95 M / yr** | $24 |
| Steady-state, high capacity-use (year 8+) | **$33 M / yr** | $8 |
| Steady-state, operating-neutral revenue case | **$162 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.45 bn cumulative** | $1,141 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.42 bn cumulative** | $620 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.66 bn cumulative** | $1,707 |

_Population basis: 3,900,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $67 M / yr → $129 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $427 M | 4.5% | 40 y, 7 y grace | $25 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $996 M | 13.5% | 40 y, 7 y grace | $137 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $249 M | — | — | — |
| **Total** | **100%** | **$1.67 bn** | | | **$162 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $134 M / yr = **$154 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($36 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $338 k |
| Traction energy (520.1 GWh / yr) | 54,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 36.1 GWh/yr + dedicated solar plant 317.7 MW / 556.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.8 M |
| Labour (776 FTE) | driverless roster: OCC/remote 130, station/platform 246, passenger service 124, fleet maintenance 139, infrastructure/energy 112, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$40 M / yr** |

_Annual service work: 54,971 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 21.7 M train-km / yr (130.0 M car-km / yr). On-site PV covers 36.1 GWh/yr and the dedicated solar plant adds 556.6 GWh/yr against 520.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 222 trainsets, 55 stations, 135.3 route-km, 5 lines, and 54,971 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 220.0 M | 351.9 M | 76.6 M |
| Annual paid trips / city resident | 56 | 90 | 20 |
| Farebox revenue | $103 M / yr | $164 M / yr | $36 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$107 M / yr** | **$168 M / yr** | **$40 M / yr** |
| Revenue / OPEX recovery | 268% | 423% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $162 M / yr | $162 M / yr | **$162 M / yr** |
| Operating surplus applied to debt support | -$67 M / yr | -$129 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $95 M / yr | $33 M / yr | **$162 M / yr** |
| Operating surplus after OPEX (before debt support) | $67 M / yr | $129 M / yr | $0 / yr |

_Commercial-revenue assumptions: 10,776 m² of station shop/kiosk leases at $14/m²/month and 1,968 advertising boards at $122/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $30 M / yr | $47 M / yr | 16 min/trip × $0.50/h value-of-time proxy |
...
| Station-area commerce turnover supported | $70 M / yr | $113 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $35 M / yr | $56 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$241 M / yr** | **$386 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 27,531 trips/school day; 6.1 M access-events/yr | 44,050 trips/school day; 9.7 M access-events/yr |
| Healthcare | 10 healthcare anchors | 62,801 trips/day; 22.9 M access-events/yr | 100,482 trips/day; 36.7 M access-events/yr |
| Commerce | 28 major/terminal/interchange nodes | 128,636 trips/trading day; 42.4 M access-events/yr | 205,818 trips/trading day; 67.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.24 bn | 74% of $1.67 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.99 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $285 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 148,202 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.42 bn |
| Timetable-sized dedicated solar CAPEX | $254 M |
| **Reconciled project CAPEX** | **$1.67 bn** |
| Imported / external-capital requirement | $427 M (25.6%) |
| Local-content / local-funding requirement | $1.24 bn (74.4%) |
| Default foreign-turnkey external-capital comparison | $3.01 bn; OSR saves $2.58 bn (85.8%) |
| Lifetime external interest and combined financing saving | $3.24 bn interest; $5.82 bn capital + interest |
| 15%–25% planning risk envelope | $1.92 bn–$2.09 bn |
| Annual OPEX | $40 M / yr |
| Low/high project NPV at 8% | $-794270 k / $-380495 k |
| Low/high project IRR | 1.4% / 5.4% |
| Low/high steady-state DSCR | 0.41 / 0.79 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,349.07 train-km; 65,130.95 kWh consumed; 68,502.08 kWh charged; 42 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 54,762.07 train-km; 820,107.31 kWh consumed; 830,148.45 kWh charged; 825 depot services completed (10 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 99.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 68.5% | 99.6% / 90% | pass |
| maximum planning climate/HVAC duty | 68.1% | 99.6% / 90% | pass |
| 50% charging-contact availability | 74.8% | 99.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.8% / 60% | pass |
| ten-hour single charging-pad outage | 74.8% | 99.6% / 90% | pass |
...
|---|---|
| ![Ibadan energy and battery simulation dashboard](engineering/screenshots/ibadan-simulation-dashboard.png) | ![Ibadan simulator network visualizer](engineering/screenshots/ibadan-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 55 line platforms, 9 interchange complexes, 159 civil segments, and 0 input findings |
...
|---|---|
| ![Ibadan QGIS engineering layers](engineering/screenshots/ibadan-qgis-engineering-map.png) | ![Ibadan SUMO timetable validation](engineering/screenshots/ibadan-sumo-validation.png) |
...
| [`ibadan.toml`](ibadan.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`ibadan-network-map.png`](ibadan-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`ibadan.corridor.geojson`](ibadan.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`ibadan.stations.json`](ibadan.stations.json) | Machine-readable station list |
| [`ibadan.design-quality.yaml`](ibadan.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
