...
|---|---|---|---|---|
| line-1 | 12.4 km | 7 | 32 | E Outer ↔ W Outer |
| line-2 |  8.1 km | 5 | 23 | NW Mid ↔ E Mid |
| line-3 | 11.5 km | 8 | 30 | SW Outer ↔ NE Mid |
| **Total** | **31.9 km** | **20 unique** | **85** | |
...
| Total fleet capacity | 30,600 AW2 pax (40,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 76 × 360 = **27,360 AW2 passengers** (36,480 AW3 crush)
- **Total fleet passenger capacity:** 85 × 360 = **30,600 AW2 passengers** (40,800 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **34.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 20.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 514 kWh usable margin across the worst powered-stop gap (line-3) |
...
| On-site PV shortfall before solar plant | 143 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 34.2 MW / 164 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 93 kWh | 159 kWh | 57 kWh | 2.4 km / 18 kWh |
| line-2 | 5 | 60 kWh | 110 kWh | 44 kWh | 2.3 km / 18 kWh |
| line-3 | 7 | 86 kWh | 151 kWh | 56 kWh | 3.5 km / 26 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 85 | $900 k | $76 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 255 | $60 k | $15 M |
| High sensitivity check | 255 | $120 k | $31 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 34,157 kW @ $700/kW | $24 M |
| Grid interconnection / PPA tie-in | 34,157 kW @ $100/kW | $3.4 M |
| Annual generation proxy | 34.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 59.8 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$23 M / yr** | $26 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $19 |
| Lifecycle envelope (yr 1–40, low scenario) | **$162 M cumulative** | $180 |
| Lifecycle envelope (yr 1–40, high scenario) | **$162 M cumulative** | $180 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$716 M cumulative** | $796 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $286 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $71 M | — | — | — |
| **Total** | **100%** | **$357 M** | | | **$17 M / yr** |
...
| Traction energy (70.3 GWh / yr) | 14,853 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 18.2 GWh/yr + dedicated solar plant 34.2 MW / 59.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $410 k |
| Labour (285 FTE) | driverless roster: OCC/remote 61, station/platform 76, passenger service 49, fleet maintenance 46, infrastructure/energy 32, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $838 k |
| **OPEX subtotal** | | **$8.6 M / yr** |

_Annual service work: 14,853 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (17.6 M car-km / yr). On-site PV covers 18.2 GWh/yr and the dedicated solar plant adds 59.8 GWh/yr against 70.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 85 trainsets, 20 stations, 31.9 route-km, 3 lines, and 14,853 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 81 | 130 | 18 |
| Farebox revenue | $34 M / yr | $55 M / yr | $7.4 M / yr |
| Station shop leases | $475 k / yr | $475 k / yr | $475 k / yr |
| Advertising boards | $780 k / yr | $780 k / yr | $780 k / yr |
| **Total revenue** | **$35 M / yr** | **$56 M / yr** | **$8.6 M / yr** |
| Revenue / OPEX recovery | 410% | 648% | 100% |
...
_Commercial-revenue assumptions: 3,216 m² of station shop/kiosk leases at $14/m²/month and 624 advertising boards at $122/board/month, with occupancy derates applied._
...
| Commerce | 11 major/terminal/interchange nodes | 46,604 trips/trading day; 15.4 M access-events/yr | 74,567 trips/trading day; 24.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $201 M | 56% of $357 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,889 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$357 M** |
| 15%–25% planning risk envelope | $411 M–$447 M |
| Annual OPEX | $8.6 M / yr |
| Low/high project NPV at 8% | $-85673 k / $52 M |
| Low/high project IRR | 5.2% / 9.4% |
| Low/high steady-state DSCR | 1.60 / 2.82 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,393.95 train-km; 10,437.79 kWh consumed; 10,911.84 kWh charged; 35 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,432.42 train-km; 115,556.74 kWh consumed; 118,116.11 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 51.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 45.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 60.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.3% / 60% | pass |
| ten-hour single charging-pad outage | 37.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
