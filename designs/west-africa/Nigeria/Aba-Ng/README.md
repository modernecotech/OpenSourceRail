...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **35,730 – 53,595 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (31.2 km @ $1.2 M/km) | $37 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 34.0 km × $0.015 M/km | $510 k |
...
|---|---|---|
| Construction (years 1–7) | **$11 M / yr** | $13 |
| Steady-state, low-ridership (year 8+) | **$3.5 M / yr** | $4 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$160 M cumulative** | $178 |
| Lifecycle envelope (yr 1–30, high scenario) | **$80 M cumulative** | $89 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$80 M cumulative** | $89 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $84 M | 4.5% | 30 y, 7 y grace | $5.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $35 M | 13.5% | 30 y, 7 y grace | $5.0 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$139 M** | | | **$11 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.8 M / yr + bonds $4.7 M / yr = **$8.5 M / yr** total — plus the equity tranche amortised across construction ($3.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 72,000 | 135,000 | 99,202 |
| Daily paid trips / population | 8% | 15% | 11% |
| Annual paid trips | 26.3 M | 49.3 M | 36.2 M |
| Farebox revenue | $9.2 M / yr | $17 M / yr | $13 M / yr |
...
| Revenue / OPEX + debt-service recovery | 76% | 131% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $3.5 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $4.6 M / yr | $0 / yr |
