...
|---|---|---|
| Construction (years 1–7) | **$42 M / yr** | $46 |
| Steady-state, low-ridership (year 8+) | **$42 M / yr** | $47 |
| Steady-state, high-ridership (year 8+) | **$40 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $44 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.26 bn cumulative** | $1,405 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.20 bn cumulative** | $1,335 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.20 bn cumulative** | $1,335 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $304 M | 4.5% | 30 y, 7 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $127 M | 13.5% | 30 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 15% | $76 M | — | — | — |
| **Total** | **100%** | **$507 M** | | | **$40 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $14 M / yr + bonds $17 M / yr = **$31 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 64,314 | 107,190 | 85,468 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 7% | 12% | 9% |
| Annual paid trips | 23.5 M | 39.1 M | 31.2 M |
| Farebox revenue | $8.2 M / yr | $14 M / yr | $11 M / yr |
| Station shop leases | $757 k / yr | $757 k / yr | $757 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$10 M / yr** | **$16 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 79% | 122% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $42 M / yr | $40 M / yr | **$40 M / yr** |
