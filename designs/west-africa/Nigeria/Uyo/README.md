...
|---|---|---|---|---|
| line-1 | 16.2 km | 10 | 41 | SW Mid ↔ E Outer |
| line-2 |  9.5 km | 6 | 26 | NW Mid ↔ SE Inner |
| line-3 |  8.4 km | 6 | 21 | NE Inner ↔ SW Mid |
| **Total** | **34.0 km** | **22 unique** | **88** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **36.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 31.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 36.1 MW / 173 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 121 kWh | 220 kWh | 87 kWh | 2.3 km / 17 kWh |
| line-2 | 6 | 71 kWh | 131 kWh | 53 kWh | 2.3 km / 17 kWh |
| line-3 | 6 | 63 kWh | 114 kWh | 45 kWh | 2.0 km / 15 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 36,137 kW @ $700/kW | $25 M |
| Grid interconnection / PPA tie-in | 36,137 kW @ $100/kW | $3.6 M |
| Annual generation proxy | 36.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 63.3 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $31 |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$772 M cumulative** | $965 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $308 M | 4.5% | 40 y, 7 y grace | $18 M / yr |
...
| Traction energy (74.9 GWh / yr) | 15,823 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.8 GWh/yr + dedicated solar plant 36.1 MW / 63.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $434 k |
| Labour (292 FTE) | driverless roster: OCC/remote 61, station/platform 79, passenger service 49, fleet maintenance 48, infrastructure/energy 34, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $858 k |
| **OPEX subtotal** | | **$9.2 M / yr** |

_Annual service work: 15,823 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.2 M train-km / yr (18.7 M car-km / yr). On-site PV covers 19.8 GWh/yr and the dedicated solar plant adds 63.3 GWh/yr against 74.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 88 trainsets, 22 stations, 34.0 route-km, 3 lines, and 15,823 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $34 M / yr | $55 M / yr | $7.9 M / yr |
| Station shop leases | $487 k / yr | $487 k / yr | $487 k / yr |
| Advertising boards | $810 k / yr | $810 k / yr | $810 k / yr |
| **Total revenue** | **$36 M / yr** | **$56 M / yr** | **$9.2 M / yr** |
...
_Commercial-revenue assumptions: 3,296 m² of station shop/kiosk leases at $14/m²/month and 648 advertising boards at $122/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $217 M | 56% of $385 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,859 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-109986 k / $28 M |
| Low/high project IRR | 4.6% / 8.7% |
| Low/high steady-state DSCR | 1.45 / 2.59 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,440.12 train-km; 10,783.53 kWh consumed; 11,578.81 kWh charged; 35 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,417.68 train-km; 122,934.27 kWh consumed; 125,524.66 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 71%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 56.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 71.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.7% / 60% | pass |
| ten-hour single charging-pad outage | 47.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 2 interchange complexes, 13 civil segments, and 0 input findings |
