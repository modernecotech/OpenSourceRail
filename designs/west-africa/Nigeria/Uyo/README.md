...
| Steady-state, low capacity-use (year 8+) | **$2.9 M / yr** | $4 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $23 |
| Lifecycle envelope (yr 1–40, low scenario) | **$269 M cumulative** | $337 |
| Lifecycle envelope (yr 1–40, high scenario) | **$174 M cumulative** | $217 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$788 M cumulative** | $985 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $446 M | 2.0% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $112 M | — | — | — |
| **Total** | **100%** | **$558 M** | | | **$19 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $8.9 M / yr = **$8.9 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Labour (324 FTE) | driverless roster: OCC/remote 49, station/platform 104, passenger service 44, fleet maintenance 38, infrastructure/energy 53, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $953 k |
...
| Annual paid trips | 63.1 M | 100.9 M | 29.4 M |
| Annual paid trips / city resident | 79 | 126 | 37 |
| Farebox revenue | $29 M / yr | $47 M / yr | $14 M / yr |
...
| Revenue / OPEX recovery | 202% | 316% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.9 M / yr | $0 k / yr | **$19 M / yr** |
...
| Avoided road congestion | $7.1 M / yr | $11 M / yr | 88 M - 141 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.3 M / yr | $2.0 M / yr | 15.9–25.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.5 M / yr | $5.6 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $23 M / yr | $37 M / yr | 25% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 13,133 trips/school day; 2.9 M access-events/yr | 21,012 trips/school day; 4.6 M access-events/yr |
| Healthcare | 0 healthcare anchors | 10,368 trips/day; 3.8 M access-events/yr | 16,589 trips/day; 6.1 M access-events/yr |
| Commerce | 20 major/terminal/interchange nodes | 42,768 trips/trading day; 14.1 M access-events/yr | 68,429 trips/trading day; 22.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $296 M | 53% of $558 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 35,186 job-years | retained CAPEX ÷ (4.0 × median annual income) |
