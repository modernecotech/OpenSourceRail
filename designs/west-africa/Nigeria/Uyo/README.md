...
| Bucket | Value |
|---|---|
| At-grade (29.9 km @ €3.5 M/km) | €105 M |
| Elevated (0.5 km @ €18 M/km) | €9.6 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 36 | €3.0 M | €108 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 31.1 km × €0.015 M/km | €0.5 M |
...
| Steady-state, low-ridership (year 8+) | **€36 M / yr** | €45 |
| Steady-state, high-ridership (year 8+) | **€32 M / yr** | €40 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.05 bn cumulative** | €1,311 |
| Lifecycle envelope (yr 1–30, high scenario) | **€959 M cumulative** | €1,199 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€5.8 M / yr (low) → €1.9 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €232 M | 4.5% | 30 y, 7 y grace | €16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €96 M | 13.5% | 30 y, 7 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €58 M | — | — | — |
| **Total** | **100%** | **€386 M** | | | **€30 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €10 M / yr + bonds €13 M / yr = **€23 M / yr** total — plus the equity tranche amortised across construction (€8.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (199 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €538 k |
...
| Farebox revenue | €3.9 M / yr | €7.8 M / yr |
| Farebox / OPEX recovery | 40% | 81% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €5.8 M / yr | €1.9 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€36 M / yr** | **€32 M / yr** |
