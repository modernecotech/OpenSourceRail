...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 148 | $5.60 M | $829 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 592 | $100 k | $59 M |
| High sensitivity check | 592 | $200 k | $118 M |
...
| Per-capita (city pop) | $1,455 / person |
...
|---|---|---|
| Construction (years 1–7) | **$179 M / yr** | $120 |
| Steady-state, low-ridership (year 8+) | **$215 M / yr** | $143 |
| Steady-state, high-ridership (year 8+) | **$208 M / yr** | $139 |
| Steady-state, operating-neutral revenue case | **$170 M / yr** | $114 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.20 bn cumulative** | $4,134 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.05 bn cumulative** | $4,030 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.18 bn cumulative** | $3,451 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $45 M / yr → $38 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.31 bn | 4.5% | 30 y, 7 y grace | $93 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $546 M | 13.5% | 30 y, 7 y grace | $78 M / yr |
| Government equity (no debt service) | 15% | $327 M | — | — | — |
| **Total** | **100%** | **$2.18 bn** | | | **$170 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $59 M / yr + bonds $74 M / yr = **$133 M / yr** total — plus the equity tranche amortised across construction ($47 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 79,650 | 132,750 | 428,506 |
| Daily paid trips / catchment | 18% | 30% | 97% |
| Daily paid trips / city population | 5% | 9% | 29% |
| Annual paid trips | 29.1 M | 48.5 M | 156.4 M |
| Farebox revenue | $10 M / yr | $17 M / yr | $55 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$15 M / yr** | **$21 M / yr** | **$59 M / yr** |
| Revenue / OPEX recovery | 25% | 36% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $215 M / yr | $208 M / yr | **$170 M / yr** |
