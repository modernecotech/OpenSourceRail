...
|---|---|---|
| Construction (years 1–7) | **$89 M / yr** | $60 |
| Steady-state, low-ridership (year 8+) | **$97 M / yr** | $65 |
| Steady-state, high-ridership (year 8+) | **$90 M / yr** | $60 |
| Steady-state, operating-neutral revenue case | **$85 M / yr** | $57 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.85 bn cumulative** | $1,901 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.70 bn cumulative** | $1,797 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.58 bn cumulative** | $1,719 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $5.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $652 M | 4.5% | 30 y, 7 y grace | $46 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $272 M | 13.5% | 30 y, 7 y grace | $39 M / yr |
| Government equity (no debt service) | 15% | $163 M | — | — | — |
| **Total** | **100%** | **$1.09 bn** | | | **$85 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $29 M / yr + bonds $37 M / yr = **$66 M / yr** total — plus the equity tranche amortised across construction ($23 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 79,650 | 132,750 | 172,504 |
| Daily paid trips / catchment | 18% | 30% | 39% |
| Daily paid trips / city population | 5% | 9% | 12% |
| Annual paid trips | 29.1 M | 48.5 M | 63.0 M |
| Farebox revenue | $10 M / yr | $17 M / yr | $22 M / yr |
...
| Revenue / OPEX recovery | 55% | 81% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $97 M / yr | $90 M / yr | **$85 M / yr** |
