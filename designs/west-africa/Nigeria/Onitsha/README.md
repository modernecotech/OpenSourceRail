...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **79,650 – 132,750 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (163.7 km @ $2.0 M/km) | $327 M |
| Elevated (19.0 km @ $9.0 M/km) | $171 M |
| Elevated-interchange premium (6 sites @ $4.50 M) | $27 M |
| **Civil subtotal** | **$525 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 148 | $1.07 M | $158 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 183.7 km × $0.015 M/km | $9.1 M |
...
|---|---|---|
| Construction (years 1–7) | **$75 M / yr** | $50 |
| Steady-state, low-ridership (year 8+) | **$80 M / yr** | $53 |
| Steady-state, high-ridership (year 8+) | **$73 M / yr** | $49 |
| Steady-state, operating-neutral revenue case | **$71 M / yr** | $47 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.36 bn cumulative** | $1,574 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.21 bn cumulative** | $1,470 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.16 bn cumulative** | $1,442 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.6 M / yr → $1.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $547 M | 4.5% | 30 y, 7 y grace | $39 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $228 M | 13.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $137 M | — | — | — |
| **Total** | **100%** | **$912 M** | | | **$71 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $25 M / yr + bonds $31 M / yr = **$55 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 79,650 | 132,750 | 146,879 |
| Daily paid trips / catchment | 18% | 30% | 33% |
| Daily paid trips / city population | 5% | 9% | 10% |
| Annual paid trips | 29.1 M | 48.5 M | 53.6 M |
| Farebox revenue | $10 M / yr | $17 M / yr | $19 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$15 M / yr** | **$21 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 63% | 92% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $80 M / yr | $73 M / yr | **$71 M / yr** |
