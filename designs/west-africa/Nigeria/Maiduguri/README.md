...
|---|---|---|---|---|
| line-1 | 26.7 km | 19 | 63 | NW Mid ↔ SE Mid |
| line-2 | 25.4 km | 17 | 59 | W Mid ↔ E Mid |
| line-3 | 27.9 km | 17 | 62 | N Mid ↔ SW Mid |
| line-4 | 26.3 km | 14 | 56 | NW Inner ↔ SE Outer |
| line-5 | 62.0 km | 33 | 31 | W Mid ↔ W Mid |
| **Total** | **168.4 km** | **100 unique** | **271** | |
...
| Interchange | 28 | 300 kW | 1500 kWh |
| Major | 19 | 300 kW | 1500 kWh |
| Standard | 36 | 300 kW | 1500 kWh |
| Terminal | 7 | 300 kW | 1500 kWh |
| **Total installed** | **91** | **32,000 kW** | **175,000 kWh** |

Aggregate station-rail charging power: **136,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **158.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.5× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 590 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 266 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 208 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 896 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 158.4 MW / 1,030 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 175 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 297 kWh | 980 kWh | 653 kWh | 3.2 km / 36 kWh |
| line-2 | 17 | 283 kWh | 882 kWh | 571 kWh | 2.0 km / 23 kWh |
| line-3 | 16 | 311 kWh | 858 kWh | 515 kWh | 5.5 km / 61 kWh |
| line-4 | 11 | 293 kWh | 588 kWh | 266 kWh | 11.7 km / 130 kWh |
| line-5 | 28 | 691 kWh | 1,372 kWh | 612 kWh | 6.8 km / 76 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1084 | $60 k | $65 M |
| High sensitivity check | 1084 | $120 k | $130 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 158,441 kW @ $700/kW | $111 M |
| Grid interconnection / PPA tie-in | 158,441 kW @ $100/kW | $16 M |
| Annual generation proxy | 158.4 MW × 6.5 peak-sun-h/day × 365 d/yr | 375.9 GWh/yr |
...
| Per-capita (city pop) | $1,713 / person |
...
|---|---|---|
| Construction (years 1–7) | **$133 M / yr** | $111 |
| Steady-state, low capacity-use (year 8+) | **$67 M / yr** | $55 |
| Steady-state, high capacity-use (year 8+) | **$26 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$97 M / yr** | $81 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.13 bn cumulative** | $2,605 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.77 bn cumulative** | $1,476 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.12 bn cumulative** | $3,431 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $30 M / yr → $71 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.64 bn | 4.5% | 40 y, 7 y grace | $97 M / yr |
| Government equity (no debt service) | 20% | $411 M | — | — | — |
| **Total** | **100%** | **$2.06 bn** | | | **$97 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $74 M / yr = **$74 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($59 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (402.8 GWh / yr) | 63,862 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 75.9 GWh/yr + dedicated solar plant 158.4 MW / 375.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.9 M |
| Labour (1,007 FTE) | driverless roster: OCC/remote 154, station/platform 421, passenger service 92, fleet maintenance 166, infrastructure/energy 149, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $3.0 M |
| **OPEX subtotal** | | **$45 M / yr** |

_Annual service work: 63,862 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 25.2 M train-km / yr (100.7 M car-km / yr). On-site PV covers 75.9 GWh/yr and the dedicated solar plant adds 375.9 GWh/yr against 402.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 271 trainsets, 100 stations, 168.4 route-km, 5 lines, and 63,862 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 82.3 M |
| Annual paid trips / city resident | 122 | 196 | 69 |
| Farebox revenue | $68 M / yr | $109 M / yr | $38 M / yr |
| Station shop leases | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| Advertising boards | $4.2 M / yr | $4.2 M / yr | $4.2 M / yr |
| **Total revenue** | **$75 M / yr** | **$116 M / yr** | **$45 M / yr** |
| Revenue / OPEX recovery | 166% | 257% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $97 M / yr | $97 M / yr | **$97 M / yr** |
| Operating surplus applied to debt support | -$30 M / yr | -$71 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $67 M / yr | $26 M / yr | **$97 M / yr** |
| Operating surplus after OPEX (before debt support) | $30 M / yr | $71 M / yr | $0 / yr |

_Commercial-revenue assumptions: 18,536 m² of station shop/kiosk leases at $14/m²/month and 3,372 advertising boards at $122/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 20,203 trips/school day; 4.4 M access-events/yr | 32,324 trips/school day; 7.1 M access-events/yr |
| Healthcare | 15 healthcare anchors | 36,158 trips/day; 13.2 M access-events/yr | 57,853 trips/day; 21.1 M access-events/yr |
| Commerce | 55 major/terminal/interchange nodes | 87,483 trips/trading day; 28.9 M access-events/yr | 139,973 trips/trading day; 46.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.19 bn | 58% of $2.06 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.90 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $272 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 141,422 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.06 bn** |
| 15%–25% planning risk envelope | $2.36 bn–$2.57 bn |
| Annual OPEX | $45 M / yr |
| Low/high project NPV at 8% | $-1327288 k / $-1051437 k |
| Low/high project IRR | -3.3% / 0.7% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,435.08 train-km; 49,389.62 kWh consumed; 53,712.55 kWh charged; 25 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 64,198.71 train-km; 714,924.59 kWh consumed; 725,872.23 kWh charged; 833 depot services completed (4 active at cutoff); minimum SoC 73%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.3% / 60% | pass |
| ten-hour single charging-pad outage | 72.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 100 line platforms, 9 interchange complexes, 58 civil segments, and 0 input findings |
