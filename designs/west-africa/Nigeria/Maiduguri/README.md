...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 145 | $5.60 M | $812 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 580 | $100 k | $58 M |
| High sensitivity check | 580 | $200 k | $116 M |
...
|---|---|---|
| Construction (years 1–7) | **$198 M / yr** | $165 |
| Steady-state, low-ridership (year 8+) | **$235 M / yr** | $196 |
| Steady-state, high-ridership (year 8+) | **$229 M / yr** | $191 |
| Steady-state, operating-neutral revenue case | **$188 M / yr** | $157 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.80 bn cumulative** | $5,666 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.65 bn cumulative** | $5,545 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.70 bn cumulative** | $4,754 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $48 M / yr → $41 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.44 bn | 4.5% | 30 y, 7 y grace | $102 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $601 M | 13.5% | 30 y, 7 y grace | $86 M / yr |
| Government equity (no debt service) | 15% | $361 M | — | — | — |
| **Total** | **100%** | **$2.41 bn** | | | **$188 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $65 M / yr + bonds $81 M / yr = **$146 M / yr** total — plus the equity tranche amortised across construction ($52 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 74,303 | 123,839 | 446,700 |
| Daily paid trips / catchment | 18% | 30% | 108% |
| Daily paid trips / city population | 6% | 10% | 37% |
| Annual paid trips | 27.1 M | 45.2 M | 163.0 M |
| Farebox revenue | $9.5 M / yr | $16 M / yr | $57 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$15 M / yr** | **$21 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 24% | 34% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $235 M / yr | $229 M / yr | **$188 M / yr** |
