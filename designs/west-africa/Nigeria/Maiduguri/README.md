...
| Steady-state, low-ridership (year 8+) | **$149 M / yr** | $124 |
| Steady-state, high-ridership (year 8+) | **$143 M / yr** | $119 |
| Steady-state, operating-neutral revenue case | **$128 M / yr** | $107 |
| Lifecycle envelope (yr 1–30, low scenario) | **$4.38 bn cumulative** | $3,649 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.23 bn cumulative** | $3,528 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.89 bn cumulative** | $3,241 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $21 M / yr → $15 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $984 M | 4.5% | 30 y, 7 y grace | $70 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $410 M | 13.5% | 30 y, 7 y grace | $59 M / yr |
| Government equity (no debt service) | 15% | $246 M | — | — | — |
| **Total** | **100%** | **$1.64 bn** | | | **$128 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $44 M / yr + bonds $55 M / yr = **$100 M / yr** total — plus the equity tranche amortised across construction ($35 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 74,303 | 123,839 | 240,902 |
| Daily paid trips / catchment | 18% | 30% | 58% |
| Daily paid trips / city population | 6% | 10% | 20% |
| Annual paid trips | 27.1 M | 45.2 M | 87.9 M |
| Farebox revenue | $9.5 M / yr | $16 M / yr | $31 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$15 M / yr** | **$21 M / yr** | **$36 M / yr** |
| Revenue / OPEX recovery | 42% | 59% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $149 M / yr | $143 M / yr | **$128 M / yr** |
