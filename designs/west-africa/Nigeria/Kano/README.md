...
|---|---:|---:|---:|---:|
| Civil works | $1.86 bn | 35% | $650 M | $1.21 bn |
| Stations | $726 M | 40% | $291 M | $436 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $1.15 bn | 55% | $634 M | $519 M |
| Dedicated solar plant | $625 M | 70% | $437 M | $187 M |
| Residual signalling / train control | $22 M | 80% | $17 M | $4.3 M |
| Charging microgrids | $55 M | 55% | $30 M | $25 M |
| EPC / project services | $267 M | 45% | $120 M | $147 M |
| **Total city CAPEX** | **$4.71 bn** | **46.3%** | **$2.18 bn** | **$2.53 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **46.3%** | **$2.18 bn** | **$312 M / yr** |
| **Local capital for domestic procurement / payroll** | **53.7%** | **$2.53 bn** | **$361 M / yr** |
| of which planned local bond issuance | 42.9% of total CAPEX | $2.02 bn | $289 M / yr |
...
|---|---|---|
| Construction (years 1–7) | **$444 M / yr** | $106 |
| Steady-state, low capacity-use (year 8+) | **$317 M / yr** | $75 |
| Steady-state, high capacity-use (year 8+) | **$201 M / yr** | $48 |
| Steady-state, operating-neutral revenue case | **$406 M / yr** | $97 |
| Lifecycle envelope (yr 1–40, low scenario) | **$13.56 bn cumulative** | $3,229 |
| Lifecycle envelope (yr 1–40, high scenario) | **$9.72 bn cumulative** | $2,315 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$16.49 bn cumulative** | $3,926 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 46% | $2.18 bn | 4.5% | 40 y, 7 y grace | $128 M / yr |
| Local-currency sovereign / project bonds for local content | 43% | $2.02 bn | 13.5% | 40 y, 7 y grace | $277 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $506 M | — | — | — |
| **Total** | **100%** | **$4.71 bn** | | | **$406 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $98 M / yr + local bonds $273 M / yr = **$371 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($72 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $406 M / yr | $406 M / yr | **$406 M / yr** |
| Operating surplus applied to debt support | -$89 M / yr | -$205 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $317 M / yr | $201 M / yr | **$406 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.53 bn | 54% of $4.71 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.05 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $578 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 301,097 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $2.18 bn (46.3%) |
| Local-content / local-funding requirement | $2.53 bn (53.7%) |
...
| Low/high steady-state DSCR | 0.22 / 0.51 |
