# Port Harcourt Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 957 |
| Manufacturing schedule rows | 3,262 |
| Manufacturing material/BOM rows | 43,678 |
| Manufacturing QA verification rows | 3,262 |
| Construction QA action rows | 2,933 |
| Maintenance handover schedule rows | 3,992 |
| Manufacturing rows with material refs | 3,262 / 3,262 |
| Manufacturing rows with verification refs | 3,262 / 3,262 |
| Manufacturing rows linked to QA actions | 3,262 / 3,262 |
