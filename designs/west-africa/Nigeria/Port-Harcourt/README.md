...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 160 | $5.60 M | $896 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 640 | $100 k | $64 M |
| High sensitivity check | 640 | $200 k | $128 M |
...
|---|---|---|
| Construction (years 1–7) | **$190 M / yr** | $63 |
| Steady-state, low-ridership (year 8+) | **$217 M / yr** | $72 |
| Steady-state, high-ridership (year 8+) | **$203 M / yr** | $68 |
| Steady-state, operating-neutral revenue case | **$181 M / yr** | $60 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.31 bn cumulative** | $2,104 |
| Lifecycle envelope (yr 1–30, high scenario) | **$5.99 bn cumulative** | $1,996 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.48 bn cumulative** | $1,828 |

_Population basis: 3,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $36 M / yr → $22 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.39 bn | 4.5% | 30 y, 7 y grace | $98 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $578 M | 13.5% | 30 y, 7 y grace | $83 M / yr |
| Government equity (no debt service) | 15% | $347 M | — | — | — |
| **Total** | **100%** | **$2.31 bn** | | | **$181 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $62 M / yr + bonds $78 M / yr = **$140 M / yr** total — plus the equity tranche amortised across construction ($50 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 165,240 | 275,400 | 447,194 |
| Daily paid trips / catchment | 18% | 30% | 49% |
| Daily paid trips / city population | 6% | 9% | 15% |
| Annual paid trips | 60.3 M | 100.5 M | 163.2 M |
| Farebox revenue | $21 M / yr | $35 M / yr | $57 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| **Total revenue** | **$27 M / yr** | **$41 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 43% | 65% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $217 M / yr | $203 M / yr | **$181 M / yr** |
