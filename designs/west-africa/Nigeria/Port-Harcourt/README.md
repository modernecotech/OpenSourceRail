...
|---|---|---|
| Construction (years 1–7) | **$121 M / yr** | $40 |
| Steady-state, low-ridership (year 8+) | **$122 M / yr** | $41 |
| Steady-state, high-ridership (year 8+) | **$115 M / yr** | $38 |
| Steady-state, operating-neutral revenue case | **$115 M / yr** | $38 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.64 bn cumulative** | $1,214 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.48 bn cumulative** | $1,160 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.48 bn cumulative** | $1,160 |

_Population basis: 3,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.0 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $880 M | 4.5% | 30 y, 7 y grace | $62 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $367 M | 13.5% | 30 y, 7 y grace | $52 M / yr |
| Government equity (no debt service) | 15% | $220 M | — | — | — |
| **Total** | **100%** | **$1.47 bn** | | | **$115 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $40 M / yr + bonds $50 M / yr = **$89 M / yr** total — plus the equity tranche amortised across construction ($31 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 165,240 | 275,400 | 220,106 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 6% | 9% | 7% |
| Annual paid trips | 60.3 M | 100.5 M | 80.3 M |
| Farebox revenue | $21 M / yr | $35 M / yr | $28 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| **Total revenue** | **$27 M / yr** | **$41 M / yr** | **$34 M / yr** |
| Revenue / OPEX recovery | 79% | 121% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $122 M / yr | $115 M / yr | **$115 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $7.1 M / yr | $0 / yr |
