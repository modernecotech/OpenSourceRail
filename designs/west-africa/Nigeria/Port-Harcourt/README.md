...
| Bucket | Value |
|---|---|
| At-grade (189.1 km @ €3.5 M/km) | €662 M |
| Elevated (8.8 km @ €18 M/km) | €159 M |
| Elevated-interchange premium (6 sites @ €20 M) | €120 M |
| **Civil subtotal** | **€941 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 160 | €4.0 M | €640 M |
...
|---|---|---|
| Construction (years 1–7) | **€166 M / yr** | €55 |
| Steady-state, low-ridership (year 8+) | **€196 M / yr** | €65 |
| Steady-state, high-ridership (year 8+) | **€182 M / yr** | €61 |
| Lifecycle envelope (yr 1–30, low scenario) | **€5.68 bn cumulative** | €1,892 |
| Lifecycle envelope (yr 1–30, high scenario) | **€5.34 bn cumulative** | €1,779 |

_Population basis: 3,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€39 M / yr (low) → €24 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.21 bn | 4.5% | 30 y, 7 y grace | €86 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €505 M | 13.5% | 30 y, 7 y grace | €72 M / yr |
| Government equity (no debt service) | 15% | €303 M | — | — | — |
| **Total** | **100%** | **€2.02 bn** | | | **€158 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €55 M / yr + bonds €68 M / yr = **€123 M / yr** total — plus the equity tranche amortised across construction (€43 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (1,205 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.3 M |
...
|---|---|---|
| Annual paid trips | 54.8 M | 109.5 M |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€196 M / yr** | **€182 M / yr** |
