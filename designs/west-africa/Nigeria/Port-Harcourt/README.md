...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **91,800 – 137,700 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (189.1 km @ $0.85 M/km) | $161 M |
| Elevated (8.8 km @ $4.0 M/km) | $35 M |
...
|---|---|---|---|
| `standard` | 48 | $300 k | $14 M |
| `major` | 28 | $600 k | $17 M |
| `terminal` | 5 | $500 k | $2.5 M |
| `depot-terminal` | 1 | $650 k | $650 k |
| `interchange-elevated` | 13 | $1.20 M | $16 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 198.9 km × $0.015 M/km | $3.0 M |
...
| Per-capita (city pop) | $166 / person |
...
|---|---|---|
| Construction (years 1–7) | **$41 M / yr** | $14 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $6 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$706 M cumulative** | $235 |
| Lifecycle envelope (yr 1–30, high scenario) | **$286 M cumulative** | $95 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$286 M cumulative** | $95 |

_Population basis: 3,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $298 M | 4.5% | 30 y, 7 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $124 M | 13.5% | 30 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$497 M** | | | **$39 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $17 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 240,000 | 450,000 | 382,978 |
| Daily paid trips / population | 8% | 15% | 13% |
| Annual paid trips | 87.6 M | 164.2 M | 139.8 M |
| Farebox revenue | $31 M / yr | $57 M / yr | $49 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| **Total revenue** | **$36 M / yr** | **$63 M / yr** | **$55 M / yr** |
| Revenue / OPEX + debt-service recovery | 67% | 116% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $18 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $8.6 M / yr | $0 / yr |
