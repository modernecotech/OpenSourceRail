...
|---|---|---|
| Construction (years 1–10) | **$124 M / yr** | $49 |
| Steady-state, low-ridership (year 11+) | **$160 M / yr** | $63 |
| Steady-state, high-ridership (year 11+) | **$151 M / yr** | $60 |
| Steady-state, operating-neutral revenue case | **$133 M / yr** | $52 |
| Lifecycle envelope (yr 1–35, low scenario) | **$5.23 bn cumulative** | $2,066 |
| Lifecycle envelope (yr 1–35, high scenario) | **$5.00 bn cumulative** | $1,976 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$4.55 bn cumulative** | $1,799 |

_Population basis: 2,531,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $27 M / yr → $18 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.31 bn | 3.0% | 35 y, 10 y grace | $75 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $544 M | 9.5% | 35 y, 10 y grace | $58 M / yr |
| Government equity (no debt service) | 15% | $327 M | — | — | — |
| **Total** | **100%** | **$2.18 bn** | | | **$133 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $39 M / yr + bonds $52 M / yr = **$91 M / yr** total — plus the equity tranche amortised across construction ($33 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 170,386 | 283,978 | 506,858 |
| Daily paid trips / catchment | 18% | 30% | 54% |
| Daily paid trips / city population | 7% | 11% | 20% |
| Annual paid trips | 62.2 M | 103.7 M | 185.0 M |
| Farebox revenue | $14 M / yr | $23 M / yr | $41 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$20 M / yr** | **$29 M / yr** | **$47 M / yr** |
| Revenue / OPEX recovery | 43% | 62% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $160 M / yr | $151 M / yr | **$133 M / yr** |
