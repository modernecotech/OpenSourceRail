...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.70 bn (86.9%) of external capital** and **$3.49 bn of external interest**. Capital plus saved interest totals **$6.19 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 60.5% |
| Route length (double track) | 221.6 km |
| Revenue fleet | 243 × 4-car trainsets |
| Revenue fleet passenger capacity | 116,640 AW2 pax (155,520 AW3 crush) |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 22 planned-maintenance spares and 6 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
| Revenue fleet capacity | 116,640 AW2 pax (155,520 AW3 crush) |
| Total fleet capacity | 130,080 AW2 pax (173,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 243 × 480 = **116,640 AW2 passengers** (155,520 AW3 crush)
- **Total fleet passenger capacity:** 271 × 480 = **130,080 AW2 passengers** (173,440 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 60.5%
- Catchment population: **≈ 1,531,255** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **237.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 4.6× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 562 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 142 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 175 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 87,812 train-km/day | One-way train journeys × route length |
| Annual service work | 34.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,517 MWh/day | 138.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,343 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 237.5 MW / 1,544 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 427 kWh | 662 kWh | 192 kWh | 14.2 km / 158 kWh |
| line-2 | 10 | 270 kWh | 539 kWh | 242 kWh | 3.1 km / 34 kWh |
| line-3 | 11 | 317 kWh | 588 kWh | 239 kWh | 6.6 km / 74 kWh |
| line-4 | 11 | 364 kWh | 588 kWh | 188 kWh | 7.3 km / 82 kWh |
| line-5 | 10 | 361 kWh | 539 kWh | 142 kWh | 6.4 km / 71 kWh |
| line-6 | 22 | 729 kWh | 1,078 kWh | 276 kWh | 6.8 km / 76 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (210.7 km @ $2.58 M/km) | $544 M |
| Elevated (10.9 km @ $9.75 M/km) | $106 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 271 | $1.12 M | $304 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 1084 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 1084 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 237,526 kW @ $700/kW | $166 M |
| Grid interconnection / PPA tie-in | 237,526 kW @ $100/kW | $24 M |
| Annual generation proxy | 237.5 MW × 6.5 peak-sun-h/day × 365 d/yr | 563.5 GWh/yr |
...
| Per-capita (city pop) | $682 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $691 M | 15% | $104 M | $588 M |
| Stations | $398 M | 20% | $80 M | $318 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $304 M | 35% | $106 M | $197 M |
| Dedicated solar plant | $190 M | 45% | $86 M | $105 M |
| Residual signalling / train control | $11 M | 50% | $5.5 M | $5.5 M |
| Charging microgrids | $24 M | 40% | $9.6 M | $14 M |
| EPC / project services | $100 M | 15% | $15 M | $85 M |
| **Total city CAPEX** | **$1.73 bn** | **23.6%** | **$407 M** | **$1.32 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ouagadougou`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$407 M** | **$41 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$1.32 bn** | **$132 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $1.06 bn | $106 M / yr |
| **Total city programme** | **100.0%** | **$1.73 bn** | **$173 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.33 bn | $1.92 bn (82.5%) | $2.48 bn | **$4.41 bn** |
| **Default** | 2.00× | $3.11 bn | $2.70 bn (86.9%) | $3.49 bn | **$6.19 bn** |
| High | 3.00× | $4.66 bn | $4.25 bn (91.3%) | $5.49 bn | **$9.75 bn** |

At the default 2.00× case, OSR's $407 M external requirement is 86.9% below the illustrative foreign-company requirement of $3.11 bn; the associated lifetime external-interest saving is $3.49 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$145 M / yr** | $57 |
| Steady-state, low capacity-use (year 11+) | **$116 M / yr** | $46 |
| Steady-state, high capacity-use (year 11+) | **$84 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$132 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.92 bn cumulative** | $1,944 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.97 bn cumulative** | $1,570 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.42 bn cumulative** | $2,141 |

_Population basis: 2,531,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $17 M / yr → $48 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $407 M | 4.5% | 40 y, 10 y grace | $25 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.06 bn | 9.5% | 40 y, 10 y grace | $107 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $264 M | — | — | — |
| **Total** | **100%** | **$1.73 bn** | | | **$132 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $18 M / yr + local bonds $100 M / yr = **$119 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($26 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (553.8 GWh / yr) | 87,812 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 63.8 GWh/yr + dedicated solar plant 237.5 MW / 563.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.9 M |
| Labour (969 FTE) | driverless roster: OCC/remote 158, station/platform 301, passenger service 111, fleet maintenance 197, infrastructure/energy 175, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$39 M / yr** |

_Annual service work: 87,812 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 34.6 M train-km / yr (138.5 M car-km / yr). On-site PV covers 63.8 GWh/yr and the dedicated solar plant adds 563.5 GWh/yr against 553.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 271 trainsets, 77 stations, 221.6 route-km, 6 lines, and 87,812 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 122.7 M |
| Annual paid trips / city resident | 71 | 113 | 48 |
| Farebox revenue | $53 M / yr | $84 M / yr | $36 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$56 M / yr** | **$87 M / yr** | **$39 M / yr** |
| Revenue / OPEX recovery | 142% | 223% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $132 M / yr | $132 M / yr | **$132 M / yr** |
| Operating surplus applied to debt support | -$17 M / yr | -$48 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $116 M / yr | $84 M / yr | **$132 M / yr** |
| Operating surplus after OPEX (before debt support) | $17 M / yr | $48 M / yr | $0 / yr |

_Commercial-revenue assumptions: 13,048 m² of station shop/kiosk leases at $10/m²/month and 2,436 advertising boards at $77/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $55 M / yr | $89 M / yr | 21% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 10 education anchors | 32,900 trips/school day; 7.2 M access-events/yr | 52,639 trips/school day; 11.6 M access-events/yr |
| Healthcare | 10 healthcare anchors | 39,774 trips/day; 14.5 M access-events/yr | 63,639 trips/day; 23.2 M access-events/yr |
| Commerce | 34 major/terminal/interchange nodes | 101,333 trips/trading day; 33.4 M access-events/yr | 162,132 trips/trading day; 53.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.32 bn | 76% of $1.73 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.11 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $211 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 249,802 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.73 bn** |
| Imported / external-capital requirement | $407 M (23.6%) |
| Local-content / local-funding requirement | $1.32 bn (76.4%) |
| Default foreign-turnkey external-capital comparison | $3.11 bn; OSR saves $2.70 bn (86.9%) |
| Lifetime external interest and combined financing saving | $3.49 bn interest; $6.19 bn capital + interest |
| 15%–25% planning risk envelope | $1.99 bn–$2.16 bn |
| Annual OPEX | $39 M / yr |
| Low/high project NPV at 8% | $-1071774 k / $-907284 k |
| Low/high project IRR | -5.5% / -0.9% |
| Low/high steady-state DSCR | 0.13 / 0.36 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,414.85 train-km; 71,436.62 kWh consumed; 72,680.85 kWh charged; 39 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 84,132.57 train-km; 936,911.24 kWh consumed; 945,106.90 kWh charged; 978 depot services completed (9 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 95.8% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 42.1% | 95.8% / 90% | pass |
| maximum planning climate/HVAC duty | 23.8% | 95.8% / 90% | pass |
| 50% charging-contact availability | 52.7% | 95.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 74.7% / 60% | pass |
| ten-hour single charging-pad outage | 52.7% | 95.8% / 90% | pass |
...
|---|---|
| ![Ouagadougou energy and battery simulation dashboard](engineering/screenshots/ouagadougou-simulation-dashboard.png) | ![Ouagadougou simulator network visualizer](engineering/screenshots/ouagadougou-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 77 line platforms, 9 interchange complexes, 26 civil segments, and 0 input findings |
...
|---|---|
| ![Ouagadougou QGIS engineering layers](engineering/screenshots/ouagadougou-qgis-engineering-map.png) | ![Ouagadougou SUMO timetable validation](engineering/screenshots/ouagadougou-sumo-validation.png) |
