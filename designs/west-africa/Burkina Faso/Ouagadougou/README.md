...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **236,648 – 425,967 trips/day**
...
| Per-capita (city pop) | $1,657 / person |
...
|---|---|---|
| Construction (years 1–10) | **$84 M / yr** | $33 |
| Steady-state, low-ridership (year 11+) | **$179 M / yr** | $71 |
| Steady-state, high-ridership (year 11+) | **$158 M / yr** | $63 |
| Steady-state, operating-neutral revenue case | **$94 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.20 bn cumulative** | $2,450 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.59 bn cumulative** | $2,210 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.65 bn cumulative** | $1,441 |

_Population basis: 2,531,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $85 M / yr → $65 M / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $2.10 bn | 2.0% | 40 y, 10 y grace | $94 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 9.5% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $419 M | — | — | — |
| **Total** | **100%** | **$4.19 bn** | | | **$94 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $42 M / yr + fallback bonds $0 k / yr = **$42 M / yr** total. The $1.68 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($42 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (996.2 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
...
|---|---|---|---|
| Daily paid trips | 236,648 | 425,967 | 1,031,665 |
| Daily paid trips / catchment | 25% | 45% | 109% |
| Daily paid trips / city population | 9% | 17% | 41% |
| Annual paid trips | 86.4 M | 155.5 M | 376.6 M |
| Farebox revenue | $25 M / yr | $46 M / yr | $110 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$32 M / yr** | **$52 M / yr** | **$117 M / yr** |
| Revenue / OPEX recovery | 27% | 45% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $179 M / yr | $158 M / yr | **$94 M / yr** |
