...
| Bucket | Value |
|---|---|
| At-grade (247.7 km @ $2.0 M/km) | $495 M |
| Elevated (15.5 km @ $9.0 M/km) | $139 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 263.9 km × $0.015 M/km | $13 M |
...
|---|---|---|
| Construction (years 1–10) | **$76 M / yr** | $30 |
| Steady-state, low-ridership (year 11+) | **$93 M / yr** | $37 |
| Steady-state, high-ridership (year 11+) | **$84 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$82 M / yr** | $32 |
| Lifecycle envelope (yr 1–35, low scenario) | **$3.09 bn cumulative** | $1,222 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.87 bn cumulative** | $1,132 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.81 bn cumulative** | $1,110 |

_Population basis: 2,531,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $11 M / yr → $2.3 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $806 M | 3.0% | 35 y, 10 y grace | $46 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $336 M | 9.5% | 35 y, 10 y grace | $36 M / yr |
| Government equity (no debt service) | 15% | $201 M | — | — | — |
| **Total** | **100%** | **$1.34 bn** | | | **$82 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $24 M / yr + bonds $32 M / yr = **$56 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 170,386 | 283,978 | 312,587 |
| Daily paid trips / catchment | 18% | 30% | 33% |
| Daily paid trips / city population | 7% | 11% | 12% |
| Annual paid trips | 62.2 M | 103.7 M | 114.1 M |
| Farebox revenue | $14 M / yr | $23 M / yr | $25 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$20 M / yr** | **$29 M / yr** | **$32 M / yr** |
| Revenue / OPEX recovery | 64% | 93% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $93 M / yr | $84 M / yr | **$82 M / yr** |
