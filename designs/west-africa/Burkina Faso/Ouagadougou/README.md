...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.90 bn (87.2%) of external capital** and **$3.74 bn of external interest**. Capital plus saved interest totals **$6.64 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $803 M | 15% | $121 M | $683 M |
...
| **Total city CAPEX** | **$1.85 bn** | **23.0%** | **$425 M** | **$1.42 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.0%** | **$425 M** | **$43 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.0%** | **$1.42 bn** | **$142 M / yr** |
| of which planned local bond issuance | 61.6% of total CAPEX | $1.14 bn | $114 M / yr |
| **Total city programme** | **100.0%** | **$1.85 bn** | **$185 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.49 bn | $2.07 bn (82.9%) | $2.67 bn | **$4.74 bn** |
| **Default** | 2.00× | $3.32 bn | $2.90 bn (87.2%) | $3.74 bn | **$6.64 bn** |
| High | 3.00× | $4.98 bn | $4.56 bn (91.5%) | $5.89 bn | **$10.45 bn** |

At the default 2.00× case, OSR's $425 M external requirement is 87.2% below the illustrative foreign-company requirement of $3.32 bn; the associated lifetime external-interest saving is $3.74 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$156 M / yr** | $61 |
| Steady-state, low capacity-use (year 11+) | **$127 M / yr** | $50 |
| Steady-state, high capacity-use (year 11+) | **$96 M / yr** | $38 |
| Steady-state, operating-neutral revenue case | **$142 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.38 bn cumulative** | $2,124 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.43 bn cumulative** | $1,750 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.81 bn cumulative** | $2,294 |

_Population basis: 2,531,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $14 M / yr → $46 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $425 M | 4.5% | 40 y, 10 y grace | $26 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.14 bn | 9.5% | 40 y, 10 y grace | $116 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $284 M | — | — | — |
| **Total** | **100%** | **$1.85 bn** | | | **$142 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $108 M / yr = **$127 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($28 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 130.3 M |
| Annual paid trips / city resident | 71 | 113 | 51 |
| Farebox revenue | $53 M / yr | $84 M / yr | $38 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$56 M / yr** | **$87 M / yr** | **$42 M / yr** |
| Revenue / OPEX recovery | 135% | 211% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $142 M / yr | $142 M / yr | **$142 M / yr** |
| Operating surplus applied to debt support | -$14 M / yr | -$46 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $127 M / yr | $96 M / yr | **$142 M / yr** |
| Operating surplus after OPEX (before debt support) | $14 M / yr | $46 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.42 bn | 77% of $1.85 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.27 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $227 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 269,129 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.66 bn |
| Timetable-sized dedicated solar CAPEX | $190 M |
| **Reconciled project CAPEX** | **$1.85 bn** |
| Imported / external-capital requirement | $425 M (23.0%) |
| Local-content / local-funding requirement | $1.42 bn (77.0%) |
| Default foreign-turnkey external-capital comparison | $3.32 bn; OSR saves $2.90 bn (87.2%) |
| Lifetime external interest and combined financing saving | $3.74 bn interest; $6.64 bn capital + interest |
| 15%–25% planning risk envelope | $2.12 bn–$2.31 bn |
| Annual OPEX | $42 M / yr |
| Low/high project NPV at 8% | $-1164034 k / $-999544 k |
| Low/high project IRR | -6.4% / -1.4% |
