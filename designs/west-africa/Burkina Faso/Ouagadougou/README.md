...
|---|---|---|
| Construction (years 1–10) | **$107 M / yr** | $42 |
| Steady-state, low capacity-use (year 11+) | **$80 M / yr** | $32 |
| Steady-state, high capacity-use (year 11+) | **$48 M / yr** | $19 |
| Steady-state, operating-neutral revenue case | **$94 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.47 bn cumulative** | $1,369 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.52 bn cumulative** | $995 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.90 bn cumulative** | $1,539 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.53 bn | 4.5% | 40 y, 10 y grace | $94 M / yr |
| Government equity (no debt service) | 20% | $383 M | — | — | — |
| **Total** | **100%** | **$1.92 bn** | | | **$94 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $80 M / yr | $48 M / yr | **$94 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.08 bn | 57% of $1.92 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.73 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $173 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 205,152 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.92 bn** |
| 15%–25% planning risk envelope | $2.20 bn–$2.39 bn |
| Annual OPEX | $42 M / yr |
| Low/high project NPV at 8% | $-1210731 k / $-1046242 k |
| Low/high project IRR | -6.5% / -1.6% |
| Low/high steady-state DSCR | 0.15 / 0.49 |
