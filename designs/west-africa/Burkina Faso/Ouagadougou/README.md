...
| Revenue fleet | 341 × 4-car trainsets |
| Revenue fleet passenger capacity | 163,680 AW2 pax (218,240 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 38.4 km | 22 | 82 | SW Mid ↔ NE Outer |
| line-2 | 24.2 km | 13 | 53 | E Mid ↔ W Mid |
| line-3 | 28.5 km | 16 | 62 | S Outer ↔ NE Mid |
| line-4 | 32.7 km | 20 | 73 | NW Outer ↔ SE Mid |
| line-5 | 32.4 km | 21 | 72 | S Mid ↔ N Outer |
| line-6 | 65.4 km | 41 | 36 | W Mid ↔ W Mid |
| **Total** | **221.6 km** | **133 unique** | **378** | |
...
| Revenue fleet capacity | 163,680 AW2 pax (218,240 AW3 crush) |
| Total fleet capacity | 181,440 AW2 pax (241,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 341 × 480 = **163,680 AW2 passengers** (218,240 AW3 crush)
- **Total fleet passenger capacity:** 378 × 480 = **181,440 AW2 passengers** (241,920 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 62 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **125** | **42,200 kW** | **226,000 kWh** |

Aggregate station-rail charging power: **187,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **219.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.0× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 576 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 389 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 274 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,243 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 219.9 MW / 1,430 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 427 kWh | 1,004 kWh | 535 kWh | 12.9 km / 144 kWh |
| line-2 | 13 | 270 kWh | 686 kWh | 389 kWh | 2.1 km / 24 kWh |
| line-3 | 15 | 317 kWh | 784 kWh | 435 kWh | 5.9 km / 65 kWh |
| line-4 | 19 | 364 kWh | 980 kWh | 580 kWh | 5.0 km / 56 kWh |
| line-5 | 19 | 361 kWh | 980 kWh | 583 kWh | 6.4 km / 71 kWh |
| line-6 | 40 | 729 kWh | 1,960 kWh | 1,158 kWh | 5.0 km / 56 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (207.4 km @ $3.0 M/km) | $622 M |
| Elevated (14.2 km @ $12.0 M/km) | $170 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 378 | $1.12 M | $423 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1512 | $60 k | $91 M |
| High sensitivity check | 1512 | $120 k | $181 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 219,931 kW @ $700/kW | $154 M |
| Grid interconnection / PPA tie-in | 219,931 kW @ $100/kW | $22 M |
| Annual generation proxy | 219.9 MW × 6.5 peak-sun-h/day × 365 d/yr | 521.8 GWh/yr |
| **Dedicated solar plant subtotal** | | **$176 M** |
...
| Dedicated solar power plant | $176 M |
...
|---|---|---|
| Construction (years 1–10) | **$140 M / yr** | $55 |
| Steady-state, low capacity-use (year 11+) | **$119 M / yr** | $47 |
| Steady-state, high capacity-use (year 11+) | **$87 M / yr** | $34 |
| Steady-state, operating-neutral revenue case | **$123 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.96 bn cumulative** | $1,961 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.02 bn cumulative** | $1,587 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.08 bn cumulative** | $2,008 |

_Population basis: 2,531,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.0 M / yr → $36 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.00 bn | 4.5% | 40 y, 10 y grace | $123 M / yr |
| Government equity (no debt service) | 20% | $500 M | — | — | — |
| **Total** | **100%** | **$2.50 bn** | | | **$123 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $90 M / yr = **$90 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($50 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (553.8 GWh / yr) | 87,812 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 100.1 GWh/yr + dedicated solar plant 219.9 MW / 521.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.6 M |
| Labour (1,326 FTE) | driverless roster: OCC/remote 207, station/platform 557, passenger service 111, fleet maintenance 229, infrastructure/energy 195, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$55 M / yr** |

_Annual service work: 87,812 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 34.6 M train-km / yr (138.5 M car-km / yr). On-site PV covers 100.1 GWh/yr and the dedicated solar plant adds 521.8 GWh/yr against 553.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 378 trainsets, 133 stations, 221.6 route-km, 6 lines, and 87,812 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 165.6 M |
| Annual paid trips / city resident | 71 | 113 | 65 |
| Farebox revenue | $53 M / yr | $84 M / yr | $49 M / yr |
| Station shop leases | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| Advertising boards | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| **Total revenue** | **$59 M / yr** | **$90 M / yr** | **$55 M / yr** |
| Revenue / OPEX recovery | 107% | 165% | 100% |
...
| Operating surplus applied to debt support | -$4.0 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $119 M / yr | $87 M / yr | **$123 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.0 M / yr | $36 M / yr | $0 / yr |

_Commercial-revenue assumptions: 24,520 m² of station shop/kiosk leases at $10/m²/month and 4,468 advertising boards at $77/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 16 education anchors | 33,784 trips/school day; 7.4 M access-events/yr | 54,054 trips/school day; 11.9 M access-events/yr |
| Healthcare | 14 healthcare anchors | 39,087 trips/day; 14.3 M access-events/yr | 62,539 trips/day; 22.8 M access-events/yr |
| Commerce | 63 major/terminal/interchange nodes | 102,989 trips/trading day; 34.0 M access-events/yr | 164,783 trips/trading day; 54.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.42 bn | 57% of $2.50 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 269,172 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.32 bn |
| Timetable-sized dedicated solar CAPEX | $176 M |
| **Reconciled project CAPEX** | **$2.50 bn** |
| 15%–25% planning risk envelope | $2.87 bn–$3.12 bn |
| Annual OPEX | $55 M / yr |
| Low/high project NPV at 8% | $-1656498 k / $-1492009 k |
| Low/high project IRR | -12.0% / -3.9% |
| Low/high steady-state DSCR | 0.03 / 0.29 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,807.11 train-km; 64,668.68 kWh consumed; 69,999.57 kWh charged; 26 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 88,566.00 train-km; 986,281.72 kWh consumed; 1,001,164.16 kWh charged; 1,011 depot services completed (4 active at cutoff); minimum SoC 74%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 70.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 73.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.2% / 60% | pass |
| ten-hour single charging-pad outage | 73.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 133 line platforms, 12 interchange complexes, 30 civil segments, and 0 input findings |
