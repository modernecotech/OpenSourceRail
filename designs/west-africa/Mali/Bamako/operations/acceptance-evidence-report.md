# Bamako Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,021 |
| Manufacturing schedule rows | 3,563 |
| Manufacturing material/BOM rows | 48,714 |
| Manufacturing QA verification rows | 3,563 |
| Construction QA action rows | 3,215 |
| Maintenance handover schedule rows | 4,339 |
| Manufacturing rows with material refs | 3,563 / 3,563 |
| Manufacturing rows with verification refs | 3,563 / 3,563 |
| Manufacturing rows linked to QA actions | 3,563 / 3,563 |
...
|---|---:|
| `project_kit` | 7,296 |
| `rolling_stock_bom` | 38,940 |
| `rolling_stock_cots_fitout` | 2,478 |
...
| `qa-11-bogie-wheelset` | 354 |
| `qa-12-traction-brake-battery` | 354 |
| `qa-13-passenger-systems` | 354 |
| `qa-15-first-article-trainset` | 354 |
| `qa-20-survey-geotech` | 117 |
| `qa-21-earthworks-drainage` | 117 |
| `qa-22-trackform-rail` | 245 |
| `qa-24-stations-depots-plant` | 248 |
| `qa-25-power-energy` | 231 |
| `qa-26-wayside-comms-safety` | 480 |
