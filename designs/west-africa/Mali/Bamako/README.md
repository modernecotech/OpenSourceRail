...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.38 bn (88.1%) of external capital** and **$4.36 bn of external interest**. Capital plus saved interest totals **$7.74 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (130.9 km @ $2.58 M/km) | $338 M |
| Elevated (81.6 km @ $9.75 M/km) | $795 M |
| Elevated-interchange premium (5 sites @ $4.50 M) | $22 M |
| **Civil subtotal** | **$1.16 bn** |
...
|---|---:|---:|---:|---:|
| Civil works | $1.16 bn | 15% | $173 M | $983 M |
...
| EPC / project services | $128 M | 15% | $19 M | $108 M |
| **Total city CAPEX** | **$2.13 bn** | **21.5%** | **$458 M** | **$1.67 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.5%** | **$458 M** | **$46 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.5%** | **$1.67 bn** | **$167 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $1.34 bn | $134 M / yr |
| **Total city programme** | **100.0%** | **$2.13 bn** | **$213 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.88 bn | $2.42 bn (84.1%) | $3.12 bn | **$5.54 bn** |
| **Default** | 2.00× | $3.84 bn | $3.38 bn (88.1%) | $4.36 bn | **$7.74 bn** |
| High | 3.00× | $5.75 bn | $5.29 bn (92.0%) | $6.84 bn | **$12.13 bn** |

At the default 2.00× case, OSR's $458 M external requirement is 88.1% below the illustrative foreign-company requirement of $3.84 bn; the associated lifetime external-interest saving is $4.36 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$181 M / yr** | $62 |
| Steady-state, low capacity-use (year 11+) | **$155 M / yr** | $53 |
| Steady-state, high capacity-use (year 11+) | **$124 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$164 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.46 bn cumulative** | $2,207 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.52 bn cumulative** | $1,884 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.74 bn cumulative** | $2,300 |

_Population basis: 2,929,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.1 M / yr → $41 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $458 M | 4.5% | 40 y, 10 y grace | $28 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $1.34 bn | 9.5% | 40 y, 10 y grace | $136 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $335 M | — | — | — |
| **Total** | **100%** | **$2.13 bn** | | | **$164 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $21 M / yr + local bonds $127 M / yr = **$148 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($33 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 148.3 M |
| Annual paid trips / city resident | 61 | 98 | 51 |
| Farebox revenue | $53 M / yr | $84 M / yr | $43 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| **Total revenue** | **$56 M / yr** | **$87 M / yr** | **$46 M / yr** |
| Revenue / OPEX recovery | 120% | 187% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $164 M / yr | $164 M / yr | **$164 M / yr** |
| Operating surplus applied to debt support | -$9.1 M / yr | -$41 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $155 M / yr | $124 M / yr | **$164 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.1 M / yr | $41 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.67 bn | 79% of $2.13 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.68 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $268 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 316,817 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.13 bn** |
| Imported / external-capital requirement | $458 M (21.5%) |
| Local-content / local-funding requirement | $1.67 bn (78.5%) |
| Default foreign-turnkey external-capital comparison | $3.84 bn; OSR saves $3.38 bn (88.1%) |
| Lifetime external interest and combined financing saving | $4.36 bn interest; $7.74 bn capital + interest |
| 15%–25% planning risk envelope | $2.45 bn–$2.66 bn |
| Annual OPEX | $46 M / yr |
| Low/high project NPV at 8% | $-1382282 k / $-1217793 k |
| Low/high project IRR | -8.6% / -2.6% |
| Low/high steady-state DSCR | 0.06 / 0.25 |
