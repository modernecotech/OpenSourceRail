...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **224,068 – 403,323 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$92 M / yr** | $31 |
| Steady-state, low-ridership (year 11+) | **$197 M / yr** | $67 |
| Steady-state, high-ridership (year 11+) | **$178 M / yr** | $61 |
| Steady-state, operating-neutral revenue case | **$102 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.84 bn cumulative** | $2,334 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.26 bn cumulative** | $2,138 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.98 bn cumulative** | $1,360 |

_Population basis: 2,929,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $95 M / yr → $76 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $1.83 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $2.29 bn | 2.0% | 40 y, 10 y grace | $102 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 9.5% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $458 M | — | — | — |
| **Total** | **100%** | **$4.58 bn** | | | **$102 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $46 M / yr + fallback bonds $0 k / yr = **$46 M / yr** total. The $1.83 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($46 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (974.2 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,556 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $2.9 M |
| **OPEX subtotal** | | **$124 M / yr** |

_Annual fleet utilisation: 310 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 60.9 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 224,068 | 403,323 | 1,112,615 |
| Daily paid trips / catchment | 25% | 45% | 124% |
| Daily paid trips / city population | 8% | 14% | 38% |
| Annual paid trips | 81.8 M | 147.2 M | 406.1 M |
| Farebox revenue | $24 M / yr | $43 M / yr | $119 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$29 M / yr** | **$48 M / yr** | **$124 M / yr** |
| Revenue / OPEX recovery | 23% | 39% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $197 M / yr | $178 M / yr | **$102 M / yr** |
