...
| Bucket | Value |
|---|---|
| At-grade (40.7 km @ $0.85 M/km) | $35 M |
| Elevated (1.5 km @ $4.0 M/km) | $5.8 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 45 | $800 k | $36 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 42.5 km × $0.015 M/km | $638 k |
...
|---|---|---|
| Construction (years 1–7) | **$7.8 M / yr** | $19 |
| Steady-state, low-ridership (year 8+) | **$5.4 M / yr** | $14 |
| Steady-state, high-ridership (year 8+) | **$1.7 M / yr** | $4 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$179 M cumulative** | $446 |
| Lifecycle envelope (yr 1–30, high scenario) | **$94 M cumulative** | $235 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$54 M cumulative** | $136 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $71 M | 3.8% | 30 y, 7 y grace | $4.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $30 M | 8.5% | 30 y, 7 y grace | $3.0 M / yr |
| Government equity (no debt service) | 15% | $18 M | — | — | — |
| **Total** | **100%** | **$119 M** | | | **$7.7 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.7 M / yr + bonds $2.5 M / yr = **$5.2 M / yr** total — plus the equity tranche amortised across construction ($2.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (267 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $807 k |
...
|---|---|---|---|
| Daily paid trips | 32,000 | 60,000 | 73,099 |
| Daily paid trips / population | 8% | 15% | 18% |
| Annual paid trips | 11.7 M | 21.9 M | 26.7 M |
| Farebox revenue | $4.2 M / yr | $7.9 M / yr | $9.6 M / yr |
| Station shop leases | $644 k / yr | $644 k / yr | $644 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$5.9 M / yr** | **$9.6 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 52% | 85% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $5.4 M / yr | $1.7 M / yr | **$0 / yr** |
