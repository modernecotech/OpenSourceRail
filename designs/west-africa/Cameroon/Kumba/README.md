...
|---|---|---|
| Construction (years 1–7) | **$24 M / yr** | $60 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$169 M cumulative** | $422 |
| Lifecycle envelope (yr 1–40, high scenario) | **$169 M cumulative** | $422 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$748 M cumulative** | $1,870 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $299 M | 4.5% | 40 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $75 M | — | — | — |
| **Total** | **100%** | **$374 M** | | | **$18 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $207 M | 55% of $374 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $330 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $47 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 23,902 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-94593 k / $47 M |
| Low/high project IRR | 5.0% / 9.3% |
