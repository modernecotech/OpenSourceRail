...
|---|---|---|---|---|
| line-1 | 20.2 km | 12 | 52 | S Mid ↔ NE Outer |
| line-2 | 12.8 km | 9 | 31 | SW Outer ↔ E Inner |
| line-3 |  9.5 km | 7 | 25 | S Mid ↔ W Inner |
| **Total** | **42.5 km** | **28 unique** | **108** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **47.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 490 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 47.0 MW / 226 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 151 kWh | 253 kWh | 87 kWh | 6.6 km / 50 kWh |
| line-2 | 9 | 96 kWh | 163 kWh | 58 kWh | 2.0 km / 15 kWh |
| line-3 | 7 | 71 kWh | 131 kWh | 53 kWh | 2.2 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (40.8 km @ $3.0 M/km) | $122 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 47,048 kW @ $700/kW | $33 M |
| Grid interconnection / PPA tie-in | 47,048 kW @ $100/kW | $4.7 M |
| Annual generation proxy | 47.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 82.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$32 M / yr** | $79 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$221 M cumulative** | $551 |
| Lifecycle envelope (yr 1–40, high scenario) | **$221 M cumulative** | $551 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$977 M cumulative** | $2,444 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $390 M | 4.5% | 40 y, 7 y grace | $23 M / yr |
| Government equity (no debt service) | 20% | $98 M | — | — | — |
| **Total** | **100%** | **$488 M** | | | **$23 M / yr** |
...
| Traction energy (93.6 GWh / yr) | 19,782 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.9 GWh/yr + dedicated solar plant 47.0 MW / 82.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $565 k |
| Labour (358 FTE) | driverless roster: OCC/remote 73, station/platform 114, passenger service 49, fleet maintenance 59, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 19,782 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.4 M car-km / yr). On-site PV covers 21.9 GWh/yr and the dedicated solar plant adds 82.4 GWh/yr against 93.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 108 trainsets, 28 stations, 42.5 route-km, 3 lines, and 19,782 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 20.2 M |
| Annual paid trips / city resident | 183 | 293 | 50 |
| Farebox revenue | $35 M / yr | $56 M / yr | $9.7 M / yr |
| Station shop leases | $748 k / yr | $748 k / yr | $748 k / yr |
...
_Commercial-revenue assumptions: 4,920 m² of station shop/kiosk leases at $14/m²/month and 924 advertising boards at $126/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 16,713 trips/school day; 3.7 M access-events/yr | 26,741 trips/school day; 5.9 M access-events/yr |
| Healthcare | 3 healthcare anchors | 17,115 trips/day; 6.2 M access-events/yr | 27,384 trips/day; 10.0 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 44,194 trips/trading day; 14.6 M access-events/yr | 70,710 trips/trading day; 23.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $274 M | 56% of $488 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 31,770 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,710.33 train-km; 12,806.83 kWh consumed; 13,389.49 kWh charged; 31 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,470.94 train-km; 153,284.77 kWh consumed; 156,165.99 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 55.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 63.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.2% / 60% | pass |
| ten-hour single charging-pad outage | 34.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 28 line platforms, 2 interchange complexes, 21 civil segments, and 0 input findings |
