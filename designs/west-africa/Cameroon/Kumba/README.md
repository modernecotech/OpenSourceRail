...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$521 M (86.1%) of external capital** and **$653 M of external interest**. Capital plus saved interest totals **$1.17 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Total fleet capacity | 32,400 AW2 pax (43,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 81 × 360 = **29,160 AW2 passengers** (38,880 AW3 crush)
- **Total fleet passenger capacity:** 90 × 360 = **32,400 AW2 passengers** (43,200 AW3 crush, incl. service rotation + spare + reserve)
...
| Scheduled train journey-km | 19,782 train-km/day | One-way train journeys × route length |
| Annual service work | 7.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 256 MWh/day | 23.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 214 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 51.2 MW / 246 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 151 kWh | 225 kWh | 58 kWh | 11.2 km / 84 kWh |
| line-2 | 5 | 96 kWh | 143 kWh | 37 kWh | 3.8 km / 29 kWh |
| line-3 | 4 | 71 kWh | 114 kWh | 36 kWh | 3.5 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (42.1 km @ $2.58 M/km) | $109 M |
| Elevated (0.4 km @ $9.75 M/km) | $4.0 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 90 | $900 k | $81 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 270 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 270 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 51,188 kW @ $700/kW | $36 M |
| Grid interconnection / PPA tie-in | 51,188 kW @ $100/kW | $5.1 M |
| Annual generation proxy | 51.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 89.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 42.5 km × $0.050 M/km | $2.1 M |
...
| Residual train-control wayside + charging microgrids | $3.7 M |
| EPC overhead (7%) | $19 M |
| **CAPEX total** | **$336 M** |
...
| Stations | $71 M | 20% | $14 M | $56 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $81 M | 35% | $28 M | $53 M |
...
| **Total city CAPEX** | **$336 M** | **25.1%** | **$84 M** | **$252 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kumba`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.1%** | **$84 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.9%** | **$252 M** | **$36 M / yr** |
| of which planned local bond issuance | 59.9% of total CAPEX | $202 M | $29 M / yr |
| **Total city programme** | **100.0%** | **$336 M** | **$48 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $454 M | $370 M (81.4%) | $464 M | **$833 M** |
| **Default** | 2.00× | $606 M | $521 M (86.1%) | $653 M | **$1.17 bn** |
| High | 3.00× | $908 M | $824 M (90.7%) | $1.03 bn | **$1.86 bn** |

At the default 2.00× case, OSR's $84 M external requirement is 86.1% below the illustrative foreign-company requirement of $606 M; the associated lifetime external-interest saving is $653 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$28 M / yr** | $70 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$197 M cumulative** | $492 |
| Lifecycle envelope (yr 1–40, high scenario) | **$197 M cumulative** | $492 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$967 M cumulative** | $2,418 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $84 M | 4.5% | 40 y, 7 y grace | $5.0 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $202 M | 8.5% | 40 y, 7 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $50 M | — | — | — |
| **Total** | **100%** | **$336 M** | | | **$23 M / yr** |
...
| Traction energy (93.6 GWh / yr) | 19,782 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 51.2 MW / 89.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $614 k |
| Labour (293 FTE) | driverless roster: OCC/remote 65, station/platform 68, passenger service 49, fleet maintenance 53, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $886 k |
| **OPEX subtotal** | | **$8.7 M / yr** |

_Annual service work: 19,782 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.4 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 89.7 GWh/yr against 93.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 90 trainsets, 15 stations, 42.5 route-km, 3 lines, and 19,782 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 15.7 M |
| Annual paid trips / city resident | 183 | 293 | 39 |
| Farebox revenue | $35 M / yr | $56 M / yr | $7.6 M / yr |
| Station shop leases | $432 k / yr | $432 k / yr | $432 k / yr |
| Advertising boards | $694 k / yr | $694 k / yr | $694 k / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$8.7 M / yr** |
| Revenue / OPEX recovery | 419% | 662% | 100% |
...
_Commercial-revenue assumptions: 2,840 m² of station shop/kiosk leases at $14/m²/month and 540 advertising boards at $126/board/month, with occupancy derates applied._
...
| Avoided CO2e | $2.0 M / yr | $3.2 M / yr | 25.2–40.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 18,883 trips/school day; 4.2 M access-events/yr | 30,212 trips/school day; 6.6 M access-events/yr |
| Healthcare | 3 healthcare anchors | 18,381 trips/day; 6.7 M access-events/yr | 29,409 trips/day; 10.7 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 49,015 trips/trading day; 16.2 M access-events/yr | 78,424 trips/trading day; 25.9 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 21,695 trips/activity day; 6.5 M access-events/yr | 34,712 trips/activity day; 10.4 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $252 M | 75% of $336 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 29,172 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $296 M |
| Timetable-sized dedicated solar CAPEX | $41 M |
| **Reconciled project CAPEX** | **$336 M** |
| Imported / external-capital requirement | $84 M (25.1%) |
| Local-content / local-funding requirement | $252 M (74.9%) |
| Default foreign-turnkey external-capital comparison | $606 M; OSR saves $521 M (86.1%) |
| Lifetime external interest and combined financing saving | $653 M interest; $1.17 bn capital + interest |
| 15%–25% planning risk envelope | $387 M–$421 M |
| Annual OPEX | $8.7 M / yr |
| Low/high project NPV at 8% | $-64531 k / $77 M |
| Low/high project IRR | 5.8% / 10.2% |
| Low/high steady-state DSCR | 1.18 / 2.09 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,742.70 train-km; 13,049.17 kWh consumed; 10,814.40 kWh charged; 35 depot services completed; minimum SoC 64%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,298.15 train-km; 144,502.72 kWh consumed; 137,255.01 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.6% of scheduled train-km delivered; 84 SoC warnings; 8 energy-adapted off-peak departures, maximum 14 min headway |
...
| 50% charging-contact availability | 20.0% | 97.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 77.8% / 60% | pass |
...
|---|---|
| ![Kumba energy and battery simulation dashboard](engineering/screenshots/kumba-simulation-dashboard.png) | ![Kumba simulator network visualizer](engineering/screenshots/kumba-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 2 interchange complexes, 19 civil segments, and 0 input findings |
...
|---|---|
| ![Kumba QGIS engineering layers](engineering/screenshots/kumba-qgis-engineering-map.png) | ![Kumba SUMO timetable validation](engineering/screenshots/kumba-sumo-validation.png) |
...
scripts/regenerate-city.sh kumba
```
