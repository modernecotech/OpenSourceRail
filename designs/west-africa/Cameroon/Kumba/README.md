...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$554 M (86.4%) of external capital** and **$694 M of external interest**. Capital plus saved interest totals **$1.25 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (42.1 km @ $3.0 M/km) | $126 M |
| Elevated (0.4 km @ $12.0 M/km) | $5.0 M |
...
|---|---:|---:|---:|---:|
| Civil works | $131 M | 15% | $20 M | $112 M |
...
| **Total city CAPEX** | **$356 M** | **24.5%** | **$87 M** | **$269 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.5%** | **$87 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.5%** | **$269 M** | **$38 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $215 M | $31 M / yr |
| **Total city programme** | **100.0%** | **$356 M** | **$51 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $481 M | $394 M (81.8%) | $493 M | **$887 M** |
| **Default** | 2.00× | $641 M | $554 M (86.4%) | $694 M | **$1.25 bn** |
| High | 3.00× | $962 M | $874 M (90.9%) | $1.10 bn | **$1.97 bn** |

At the default 2.00× case, OSR's $87 M external requirement is 86.4% below the illustrative foreign-company requirement of $641 M; the associated lifetime external-interest saving is $694 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$30 M / yr** | $75 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$209 M cumulative** | $523 |
| Lifecycle envelope (yr 1–40, high scenario) | **$209 M cumulative** | $523 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.03 bn cumulative** | $2,564 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $87 M | 4.5% | 40 y, 7 y grace | $5.1 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $215 M | 8.5% | 40 y, 7 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $54 M | — | — | — |
| **Total** | **100%** | **$356 M** | | | **$25 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 16.5 M |
| Annual paid trips / city resident | 183 | 293 | 41 |
| Farebox revenue | $35 M / yr | $56 M / yr | $7.9 M / yr |
| Station shop leases | $432 k / yr | $432 k / yr | $432 k / yr |
| Advertising boards | $694 k / yr | $694 k / yr | $694 k / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$9.0 M / yr** |
| Revenue / OPEX recovery | 402% | 635% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $269 M | 75% of $356 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $430 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $61 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 31,115 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $87 M (24.5%) |
| Local-content / local-funding requirement | $269 M (75.5%) |
| Default foreign-turnkey external-capital comparison | $641 M; OSR saves $554 M (86.4%) |
| Lifetime external interest and combined financing saving | $694 M interest; $1.25 bn capital + interest |
| 15%–25% planning risk envelope | $410 M–$445 M |
| Annual OPEX | $9.0 M / yr |
| Low/high project NPV at 8% | $-81700 k / $60 M |
| Low/high project IRR | 5.3% / 9.6% |
| Low/high steady-state DSCR | 1.10 / 1.96 |
