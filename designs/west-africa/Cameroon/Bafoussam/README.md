...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **28,260 – 42,390 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (71.7 km @ $0.85 M/km) | $61 M |
| Elevated (0.2 km @ $4.0 M/km) | $613 k |
| **Civil subtotal** | **$62 M** |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $6.3 M |
...
| Steady-state, low-ridership (year 8+) | **$8.1 M / yr** | $13 |
| Steady-state, high-ridership (year 8+) | **$2.5 M / yr** | $4 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$260 M cumulative** | $433 |
| Lifecycle envelope (yr 1–30, high scenario) | **$133 M cumulative** | $221 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$74 M cumulative** | $124 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $97 M | 3.8% | 30 y, 7 y grace | $6.4 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $41 M | 8.5% | 30 y, 7 y grace | $4.1 M / yr |
| Government equity (no debt service) | 15% | $24 M | — | — | — |
| **Total** | **100%** | **$162 M** | | | **$10 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.7 M / yr + bonds $3.4 M / yr = **$7.1 M / yr** total — plus the equity tranche amortised across construction ($3.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 109,367 |
| Daily paid trips / population | 8% | 15% | 18% |
| Annual paid trips | 17.5 M | 32.9 M | 39.9 M |
...
| Revenue / OPEX + debt-service recovery | 49% | 84% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $8.1 M / yr | $2.5 M / yr | **$0 / yr** |
