...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$900 M (86.1%) of external capital** and **$1.13 bn of external interest**. Capital plus saved interest totals **$2.03 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`bafoussam.corridor.geojson`](bafoussam.corridor.geojson).
...
| Anchor-weighted coverage | 47.1% |
| Route length (double track) | 73.5 km |
| Revenue fleet | 142 × 3-car trainsets |
| Revenue fleet passenger capacity | 51,120 AW2 pax (68,160 AW3 crush) |
...
| Revenue fleet capacity | 51,120 AW2 pax (68,160 AW3 crush) |
| Total fleet capacity | 56,880 AW2 pax (75,840 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 142 × 360 = **51,120 AW2 passengers** (68,160 AW3 crush)
- **Total fleet passenger capacity:** 158 × 360 = **56,880 AW2 passengers** (75,840 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 47.1%
- Catchment population: **≈ 282,600** (within ~800 m walk of a station)
...
| **Total installed** | **23** | **11,600 kW** | **51,000 kWh** |

Aggregate station-rail charging power: **11,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **92.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 443 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 72 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 56 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 34,183 train-km/day | One-way train journeys × route length |
| Annual service work | 13.5 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 443 MWh/day | 40.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 387 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 92.8 MW / 445 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 51 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 172 kWh | 261 kWh | 72 kWh | 7.9 km / 59 kWh |
| line-2 | 8 | 180 kWh | 294 kWh | 96 kWh | 7.0 km / 53 kWh |
| line-3 | 7 | 198 kWh | 314 kWh | 97 kWh | 12.9 km / 97 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (72.9 km @ $3.0 M/km) | $219 M |
| Elevated (0.6 km @ $12.0 M/km) | $7.2 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 158 | $900 k | $142 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 474 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 474 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 92,798 kW @ $700/kW | $65 M |
| Grid interconnection / PPA tie-in | 92,798 kW @ $100/kW | $9.3 M |
| Annual generation proxy | 92.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 162.6 GWh/yr |
...
| Per-capita (city pop) | $967 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $226 M | 15% | $34 M | $192 M |
...
| Residual signalling / train control | $3.7 M | 50% | $1.8 M | $1.8 M |
| Charging microgrids | $2.5 M | 40% | $980 k | $1.5 M |
| EPC / project services | $33 M | 15% | $5.0 M | $28 M |
| **Total city CAPEX** | **$580 M** | **25.0%** | **$145 M** | **$435 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bafoussam`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.0%** | **$145 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.0%** | **$435 M** | **$62 M / yr** |
| of which planned local bond issuance | 60.0% of total CAPEX | $348 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$580 M** | **$83 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $784 M | $639 M (81.5%) | $801 M | **$1.44 bn** |
| **Default** | 2.00× | $1.04 bn | $900 M (86.1%) | $1.13 bn | **$2.03 bn** |
| High | 3.00× | $1.57 bn | $1.42 bn (90.7%) | $1.78 bn | **$3.21 bn** |

At the default 2.00× case, OSR's $145 M external requirement is 86.1% below the illustrative foreign-company requirement of $1.04 bn; the associated lifetime external-interest saving is $1.13 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$49 M / yr** | $81 |
| Steady-state, low capacity-use (year 8+) | **$18 M / yr** | $31 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$949 M cumulative** | $1,582 |
| Lifecycle envelope (yr 1–40, high scenario) | **$340 M cumulative** | $567 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.67 bn cumulative** | $2,782 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $40 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $145 M | 4.5% | 40 y, 7 y grace | $8.5 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $348 M | 8.5% | 40 y, 7 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $87 M | — | — | — |
| **Total** | **100%** | **$580 M** | | | **$40 M / yr** |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $184 k |
| Traction energy (161.7 GWh / yr) | 34,183 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 92.8 MW / 162.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (405 FTE) | driverless roster: OCC/remote 94, station/platform 86, passenger service 49, fleet maintenance 93, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 34,183 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.5 M train-km / yr (40.4 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 162.6 GWh/yr against 161.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 158 trainsets, 27 stations, 73.5 route-km, 3 lines, and 34,183 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 27.9 M |
| Annual paid trips / city resident | 122 | 196 | 46 |
| Farebox revenue | $35 M / yr | $56 M / yr | $13 M / yr |
| Station shop leases | $495 k / yr | $495 k / yr | $495 k / yr |
| Advertising boards | $843 k / yr | $843 k / yr | $843 k / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 248% | 392% | 100% |
...
| Operating surplus applied to debt support | -$22 M / yr | -$40 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $0 k / yr | **$40 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $43 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,256 m² of station shop/kiosk leases at $14/m²/month and 656 advertising boards at $126/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $10 M / yr | $16 M / yr | 16 min/trip × $0.52/h value-of-time proxy |
| Avoided road congestion | $19 M / yr | $31 M / yr | 243 M - 388 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.5 M / yr | $5.6 M / yr | 43.7–69.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $9.7 M / yr | $16 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$76 M / yr** | **$122 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 10,007 trips/school day; 2.2 M access-events/yr | 16,012 trips/school day; 3.5 M access-events/yr |
| Healthcare | 3 healthcare anchors | 16,655 trips/day; 6.1 M access-events/yr | 26,648 trips/day; 9.7 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 39,953 trips/trading day; 13.2 M access-events/yr | 63,924 trips/trading day; 21.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $435 M | 75% of $580 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $697 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $100 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 50,401 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $506 M |
| Timetable-sized dedicated solar CAPEX | $74 M |
| **Reconciled project CAPEX** | **$580 M** |
| Imported / external-capital requirement | $145 M (25.0%) |
| Local-content / local-funding requirement | $435 M (75.0%) |
| Default foreign-turnkey external-capital comparison | $1.04 bn; OSR saves $900 M (86.1%) |
| Lifetime external interest and combined financing saving | $1.13 bn interest; $2.03 bn capital + interest |
| 15%–25% planning risk envelope | $668 M–$726 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-285120 k / $-143254 k |
| Low/high project IRR | 1.1% / 5.1% |
| Low/high steady-state DSCR | 0.54 / 1.07 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,614.96 train-km; 19,580.62 kWh consumed; 16,333.11 kWh charged; 22 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 33,970.45 train-km; 254,367.91 kWh consumed; 232,137.05 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.4% of scheduled train-km delivered; 146 SoC warnings; 15 energy-adapted off-peak departures, maximum 14 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 92.7% / 90% | pass |
| 50% charging-contact availability | 20.0% | 99.4% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 77.1% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 98.7% / 90% | pass |
...
|---|---|
| ![Bafoussam energy and battery simulation dashboard](engineering/screenshots/bafoussam-simulation-dashboard.png) | ![Bafoussam simulator network visualizer](engineering/screenshots/bafoussam-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 34 civil segments, and 0 input findings |
...
|---|---|
| ![Bafoussam QGIS engineering layers](engineering/screenshots/bafoussam-qgis-engineering-map.png) | ![Bafoussam SUMO timetable validation](engineering/screenshots/bafoussam-sumo-validation.png) |
...
| [`bafoussam.toml`](bafoussam.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`bafoussam-network-map.png`](bafoussam-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`bafoussam.corridor.geojson`](bafoussam.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`bafoussam.stations.json`](bafoussam.stations.json) | Machine-readable station list |
| [`bafoussam.design-quality.yaml`](bafoussam.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug bafoussam

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh bafoussam
```
