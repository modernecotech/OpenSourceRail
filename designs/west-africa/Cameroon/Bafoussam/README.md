...
| Revenue fleet | 170 × 3-car trainsets |
| Revenue fleet passenger capacity | 61,200 AW2 pax (81,600 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 23.0 km | 13 | 59 | N Mid ↔ S Outer |
| line-2 | 24.0 km | 13 | 60 | NW Outer ↔ E Mid |
| line-3 | 26.4 km | 13 | 70 | E Mid ↔ SW Outer |
| **Total** | **73.5 km** | **39 unique** | **189** | |
...
| Revenue fleet capacity | 61,200 AW2 pax (81,600 AW3 crush) |
| Total fleet capacity | 68,040 AW2 pax (90,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 170 × 360 = **61,200 AW2 passengers** (81,600 AW3 crush)
- **Total fleet passenger capacity:** 189 × 360 = **68,040 AW2 passengers** (90,720 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **89.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 462 kWh usable margin across the worst powered-stop gap (line-3) |
...
| On-site PV shortfall before solar plant | 374 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 89.7 MW / 431 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 172 kWh | 270 kWh | 80 kWh | 7.3 km / 55 kWh |
| line-2 | 11 | 180 kWh | 270 kWh | 71 kWh | 8.0 km / 60 kWh |
| line-3 | 10 | 198 kWh | 327 kWh | 109 kWh | 10.4 km / 78 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 189 | $900 k | $170 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 567 | $60 k | $34 M |
| High sensitivity check | 567 | $120 k | $68 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 89,693 kW @ $700/kW | $63 M |
| Grid interconnection / PPA tie-in | 89,693 kW @ $100/kW | $9.0 M |
| Annual generation proxy | 89.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 157.1 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bafoussam`.
...
|---|---|---|
| Construction (years 1–7) | **$44 M / yr** | $74 |
| Steady-state, low capacity-use (year 8+) | **$12 M / yr** | $20 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $53 |
| Lifecycle envelope (yr 1–40, low scenario) | **$697 M cumulative** | $1,161 |
| Lifecycle envelope (yr 1–40, high scenario) | **$309 M cumulative** | $515 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.37 bn cumulative** | $2,280 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $20 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $546 M | 4.5% | 40 y, 7 y grace | $32 M / yr |
| Government equity (no debt service) | 20% | $137 M | — | — | — |
| **Total** | **100%** | **$683 M** | | | **$32 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $25 M / yr = **$25 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (161.7 GWh / yr) | 34,183 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.1 GWh/yr + dedicated solar plant 89.7 MW / 157.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (467 FTE) | driverless roster: OCC/remote 110, station/platform 119, passenger service 49, fleet maintenance 102, infrastructure/energy 66, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$17 M / yr** |

_Annual service work: 34,183 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.5 M train-km / yr (40.4 M car-km / yr). On-site PV covers 25.1 GWh/yr and the dedicated solar plant adds 157.1 GWh/yr against 161.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 189 trainsets, 39 stations, 73.5 route-km, 3 lines, and 34,183 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 30.9 M |
| Annual paid trips / city resident | 122 | 196 | 52 |
| Farebox revenue | $35 M / yr | $56 M / yr | $15 M / yr |
| Station shop leases | $678 k / yr | $678 k / yr | $678 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 222% | 349% | 100% |
...
| Operating surplus applied to debt support | -$20 M / yr | -$32 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $0 k / yr | **$32 M / yr** |
| Operating surplus after OPEX (before debt support) | $20 M / yr | $41 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,456 m² of station shop/kiosk leases at $14/m²/month and 892 advertising boards at $126/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $21 M / yr | $34 M / yr | 19% of paid trips × $1.50 local spend proxy |
...
| Commerce | 12 major/terminal/interchange nodes | 38,631 trips/trading day; 12.7 M access-events/yr | 61,809 trips/trading day; 20.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $375 M | 55% of $683 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $600 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $86 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 43,424 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $611 M |
| Timetable-sized dedicated solar CAPEX | $72 M |
| **Reconciled project CAPEX** | **$683 M** |
| 15%–25% planning risk envelope | $785 M–$854 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-371345 k / $-229479 k |
| Low/high project IRR | -0.1% / 3.9% |
| Low/high steady-state DSCR | 0.63 / 1.29 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,577.78 train-km; 19,302.18 kWh consumed; 18,622.84 kWh charged; 20 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 35,081.24 train-km; 262,685.39 kWh consumed; 263,218.40 kWh charged; 496 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 76 SoC warnings |
...
| ten-hour all-site grid outage | 20.0% | 87.6% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 1 interchange complexes, 34 civil segments, and 0 input findings |
