...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **15,150 – 22,725 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (9.5 km @ $1.2 M/km) | $11 M |
| Elevated (0.0 km @ $5.5 M/km) | $266 k |
| **Civil subtotal** | **$12 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 9.6 km × $0.015 M/km | $145 k |
...
| Per-capita (city pop) | $151 / person |
...
|---|---|---|
| Construction (years 1–7) | **$2.5 M / yr** | $10 |
| Steady-state, low-ridership (year 8+) | **$385 k / yr** | $2 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$26 M cumulative** | $105 |
| Lifecycle envelope (yr 1–30, high scenario) | **$17 M cumulative** | $69 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$17 M cumulative** | $69 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $23 M | 3.8% | 30 y, 7 y grace | $1.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $9.5 M | 8.5% | 30 y, 7 y grace | $950 k / yr |
| Government equity (no debt service) | 15% | $5.7 M | — | — | — |
| **Total** | **100%** | **$38 M** | | | **$2.4 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $864 k / yr + bonds $805 k / yr = **$1.7 M / yr** total — plus the equity tranche amortised across construction ($812 k / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $519 k |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $7 k |
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 22,930 |
| Daily paid trips / population | 8% | 15% | 9% |
| Annual paid trips | 7.3 M | 13.7 M | 8.4 M |
| Farebox revenue | $2.6 M / yr | $4.9 M / yr | $3.0 M / yr |
| Station shop leases | $180 k / yr | $180 k / yr | $180 k / yr |
| Advertising boards | $293 k / yr | $293 k / yr | $293 k / yr |
| **Total revenue** | **$3.1 M / yr** | **$5.4 M / yr** | **$3.5 M / yr** |
| Revenue / OPEX + debt-service recovery | 89% | 155% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $385 k / yr | $0 k / yr | **$0 / yr** |
