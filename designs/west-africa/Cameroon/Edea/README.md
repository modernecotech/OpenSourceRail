...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$116 M (87.9%) of external capital** and **$145 M of external interest**. Capital plus saved interest totals **$261 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 18 × 2-car trainsets |
| Revenue fleet passenger capacity | 4,320 AW2 pax (5,760 AW3 crush) |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 1 planned-maintenance spares and 1 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
| Revenue fleet capacity | 4,320 AW2 pax (5,760 AW3 crush) |
| Total fleet capacity | 4,800 AW2 pax (6,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 18 × 240 = **4,320 AW2 passengers** (5,760 AW3 crush)
- **Total fleet passenger capacity:** 20 × 240 = **4,800 AW2 passengers** (6,400 AW3 crush, incl. service rotation + spare + reserve)
...
- **Daily theoretical capacity from timetable:** 465 scheduled one-way train journeys/day × 240 AW2 pax = **111,600 passenger-trips/day**
- **Practical daily service capacity** (80% load factor): ≈ **89,280 passenger-trips/day**
- **Planning annual paid-trip scenario** (capacity-led): ≈ **16.3 – 26.1 M paid trips/year** at 50%–80% practical capacity utilisation
...
Aggregate station-rail charging power: **2,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **2.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 21.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 343 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 53 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 4,469 train-km/day | One-way train journeys × route length |
| Annual service work | 1.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 39 MWh/day | 3.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 9 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 2.1 MW / 10 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 48 kWh | 106 kWh | 53 kWh | 3.4 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (9.5 km @ $2.58 M/km) | $25 M |
| Elevated (0.1 km @ $9.75 M/km) | $747 k |
| **Civil subtotal** | **$25 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 20 | $560 k | $11 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 40 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 40 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 2,120 kW @ $700/kW | $1.5 M |
| Grid interconnection / PPA tie-in | 2,120 kW @ $100/kW | $212 k |
| Annual generation proxy | 2.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 3.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$1.7 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 9.6 km × $0.050 M/km | $480 k |
...
| EPC integration + project management (7%) | on subtotal | $4.7 M |
...
| Dedicated solar power plant | $1.7 M |
| Residual train-control wayside + charging microgrids | $1.1 M |
| EPC overhead (7%) | $4.7 M |
| **CAPEX total** | **$73 M** |
| Per-route-km | $7.6 M / km |
| Per-capita (city pop) | $292 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $25 M | 15% | $3.8 M | $22 M |
| Stations | $21 M | 20% | $4.2 M | $17 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $11 M | 35% | $3.9 M | $7.3 M |
| Dedicated solar plant | $1.7 M | 45% | $763 k | $933 k |
| Residual signalling / train control | $480 k | 50% | $240 k | $240 k |
| Charging microgrids | $650 k | 40% | $260 k | $390 k |
| EPC / project services | $4.7 M | 15% | $700 k | $4.0 M |
| **Total city CAPEX** | **$73 M** | **21.7%** | **$16 M** | **$57 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh edea`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.7%** | **$16 M** | **$2.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.3%** | **$57 M** | **$8.2 M / yr** |
| of which planned local bond issuance | 62.6% of total CAPEX | $46 M | $6.5 M / yr |
| **Total city programme** | **100.0%** | **$73 M** | **$10 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $99 M | $83 M (83.9%) | $104 M | **$187 M** |
| **Default** | 2.00× | $132 M | $116 M (87.9%) | $145 M | **$261 M** |
| High | 3.00× | $197 M | $181 M (91.9%) | $227 M | **$409 M** |

At the default 2.00× case, OSR's $16 M external requirement is 87.9% below the illustrative foreign-company requirement of $132 M; the associated lifetime external-interest saving is $145 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$6.2 M / yr** | $25 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$5.1 M / yr** | $20 |
| Lifecycle envelope (yr 1–40, low scenario) | **$44 M cumulative** | $175 |
| Lifecycle envelope (yr 1–40, high scenario) | **$44 M cumulative** | $175 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$212 M cumulative** | $848 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $5.1 M / yr → $5.1 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $16 M | 4.5% | 40 y, 7 y grace | $934 k / yr |
| Local-currency sovereign / project bonds for local content | 63% | $46 M | 8.5% | 40 y, 7 y grace | $4.2 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $11 M | — | — | — |
| **Total** | **100%** | **$73 M** | | | **$5.1 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $715 k / yr + local bonds $3.9 M / yr = **$4.6 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($1.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (14.1 GWh / yr) | 4,469 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 10.9 GWh/yr + dedicated solar plant 2.1 MW / 3.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $25 k |
| Labour (100 FTE) | driverless roster: OCC/remote 25, station/platform 21, passenger service 13, fleet maintenance 12, infrastructure/energy 12, admin/training 17; no train drivers × country median × 12 × engineer-premium 1.4 | $302 k |
| **OPEX subtotal** | | **$1.9 M / yr** |

_Annual service work: 4,469 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 1.8 M train-km / yr (3.5 M car-km / yr). On-site PV covers 10.9 GWh/yr and the dedicated solar plant adds 3.7 GWh/yr against 14.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 20 trainsets, 5 stations, 9.6 route-km, 1 lines, and 4,469 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (89,280 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the external/local CAPEX funding sources, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 10% |
| Annual paid trips | 16.3 M | 26.1 M | 3.3 M |
| Annual paid trips / city resident | 65 | 104 | 13 |
| Farebox revenue | $7.8 M / yr | $13 M / yr | $1.6 M / yr |
| Station shop leases | $119 k / yr | $119 k / yr | $119 k / yr |
| Advertising boards | $200 k / yr | $200 k / yr | $200 k / yr |
| **Total revenue** | **$8.1 M / yr** | **$13 M / yr** | **$1.9 M / yr** |
| Revenue / OPEX recovery | 431% | 680% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gross repayable-debt service + residual OPEX subsidy | $5.1 M / yr | $5.1 M / yr | **$5.1 M / yr** |
| Operating surplus applied to debt support | -$5.1 M / yr | -$5.1 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$5.1 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.3 M / yr | $11 M / yr | $0 / yr |

_Commercial-revenue assumptions: 784 m² of station shop/kiosk leases at $14/m²/month and 156 advertising boards at $126/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $2.3 M / yr | $3.6 M / yr | 16 min/trip × $0.52/h value-of-time proxy |
| Avoided road congestion | $1.7 M / yr | $2.7 M / yr | 21 M - 34 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $304 k / yr | $487 k / yr | 3.8–6.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $845 k / yr | $1.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $6.0 M / yr | $9.5 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $2.6 M / yr | $4.2 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$14 M / yr** | **$22 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 0 education anchors | 1,786 trips/school day; 0.4 M access-events/yr | 2,857 trips/school day; 0.6 M access-events/yr |
| Healthcare | 0 healthcare anchors | 2,678 trips/day; 1.0 M access-events/yr | 4,285 trips/day; 1.6 M access-events/yr |
| Commerce | 4 major/terminal/interchange nodes | 10,892 trips/trading day; 3.6 M access-events/yr | 17,427 trips/trading day; 5.8 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 4,821 trips/activity day; 1.4 M access-events/yr | 7,714 trips/activity day; 2.3 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $57 M | 78% of $73 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $91 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $13 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 6,619 job-years | retained CAPEX ÷ (4.0 × median annual income) |
| Annual paid-trip capacity used in revenue model | 16.3 M - 26.1 M trips/yr | 50%-80% of practical service capacity |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $71 M |
| Timetable-sized dedicated solar CAPEX | $1.7 M |
| **Reconciled project CAPEX** | **$73 M** |
| Imported / external-capital requirement | $16 M (21.7%) |
| Local-content / local-funding requirement | $57 M (78.3%) |
| Default foreign-turnkey external-capital comparison | $132 M; OSR saves $116 M (87.9%) |
| Lifetime external interest and combined financing saving | $145 M interest; $261 M capital + interest |
| 15%–25% planning risk envelope | $84 M–$91 M |
| Annual OPEX | $1.9 M / yr |
| Low/high project NPV at 8% | $-12342 k / $19 M |
| Low/high project IRR | 6.1% / 10.5% |
| Low/high steady-state DSCR | 1.22 / 2.14 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 432.63 train-km; 2,159.86 kWh consumed; 2,329.92 kWh charged; 13 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 4,566.22 train-km; 22,796.54 kWh consumed; 23,225.19 kWh charged; 164 depot services completed (2 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 86.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 82.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 45.9% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 81.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Edea energy and battery simulation dashboard](engineering/screenshots/edea-simulation-dashboard.png) | ![Edea simulator network visualizer](engineering/screenshots/edea-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 1 corridors, 5 line platforms, 0 interchange complexes, 3 civil segments, and 0 input findings |
...
|---|---|
| ![Edea QGIS engineering layers](engineering/screenshots/edea-qgis-engineering-map.png) | ![Edea SUMO timetable validation](engineering/screenshots/edea-sumo-validation.png) |
