...
| Bucket | Value |
|---|---|
| At-grade (9.5 km @ €3.5 M/km) | €33 M |
| Elevated (0.0 km @ €18 M/km) | €0.9 M |
| **Civil subtotal** | **€34 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 14 | €2.0 M | €28 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 9.6 km × €0.015 M/km | €0.1 M |
...
| EPC integration + project management (7%) | on subtotal | €7.9 M |
...
|---|---|---|
| Construction (years 1–7) | **€7.9 M / yr** | €31 |
| Steady-state, low-ridership (year 8+) | **€9.5 M / yr** | €38 |
| Steady-state, high-ridership (year 8+) | **€8.2 M / yr** | €33 |
| Lifecycle envelope (yr 1–30, low scenario) | **€273 M cumulative** | €1,091 |
| Lifecycle envelope (yr 1–30, high scenario) | **€244 M cumulative** | €975 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€1.7 M / yr (low) → €427 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €72 M | 3.8% | 30 y, 7 y grace | €4.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €30 M | 8.5% | 30 y, 7 y grace | €3.0 M / yr |
| Government equity (no debt service) | 15% | €18 M | — | — | — |
| **Total** | **100%** | **€120 M** | | | **€7.8 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €2.7 M / yr + bonds €2.6 M / yr = **€5.3 M / yr** total — plus the equity tranche amortised across construction (€2.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (70 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €195 k |
...
| Operating shortfall (gov subsidy required) | €1.7 M / yr | €427 k / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€9.5 M / yr** | **€8.2 M / yr** |
