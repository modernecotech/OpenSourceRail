...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 189 | $60 k | $11 M |
| High sensitivity check | 189 | $120 k | $23 M |
...
|---|---|---|
| Construction (years 1–7) | **$19 M / yr** | $55 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$14 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$135 M cumulative** | $385 |
| Lifecycle envelope (yr 1–40, high scenario) | **$135 M cumulative** | $385 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$597 M cumulative** | $1,705 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $238 M | 4.5% | 40 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 20% | $60 M | — | — | — |
| **Total** | **100%** | **$298 M** | | | **$14 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $11 M / yr = **$11 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $168 M | 56% of $298 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $268 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $38 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 19,396 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $272 M |
| Timetable-sized dedicated solar CAPEX | $26 M |
| **Reconciled project CAPEX** | **$298 M** |
| 15%–25% planning risk envelope | $343 M–$372 M |
| Annual OPEX | $7.1 M / yr |
| Low/high project NPV at 8% | $-26539 k / $115 M |
| Low/high project IRR | 7.0% / 11.5% |
| Low/high steady-state DSCR | 2.07 / 3.58 |
