...
|---|---|---|---|---|
| line-1 |  9.4 km | 7 | 25 | W Mid ↔ SE Mid |
| line-2 | 10.3 km | 7 | 26 | NW Mid ↔ NE Outer |
| line-3 |  9.6 km | 6 | 26 | S Outer ↔ NW Mid |
| **Total** | **29.4 km** | **20 unique** | **77** | |
...
| Total fleet capacity | 27,720 AW2 pax (36,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 68 × 360 = **24,480 AW2 passengers** (32,640 AW3 crush)
- **Total fleet passenger capacity:** 77 × 360 = **27,720 AW2 passengers** (36,960 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **30.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 32.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 30.1 MW / 144 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 70 kWh | 131 kWh | 53 kWh | 2.0 km / 15 kWh |
| line-2 | 7 | 77 kWh | 139 kWh | 54 kWh | 2.2 km / 17 kWh |
| line-3 | 6 | 72 kWh | 131 kWh | 51 kWh | 2.1 km / 16 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 77 | $900 k | $69 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 231 | $60 k | $14 M |
| High sensitivity check | 231 | $120 k | $28 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 30,076 kW @ $700/kW | $21 M |
| Grid interconnection / PPA tie-in | 30,076 kW @ $100/kW | $3.0 M |
| Annual generation proxy | 30.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 52.7 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $62 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$153 M cumulative** | $437 |
| Lifecycle envelope (yr 1–40, high scenario) | **$153 M cumulative** | $437 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$678 M cumulative** | $1,937 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $271 M | 4.5% | 40 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $68 M | — | — | — |
| **Total** | **100%** | **$338 M** | | | **$16 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $12 M / yr = **$12 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (64.6 GWh / yr) | 13,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 18.7 GWh/yr + dedicated solar plant 30.1 MW / 52.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $361 k |
| Labour (277 FTE) | driverless roster: OCC/remote 57, station/platform 77, passenger service 49, fleet maintenance 42, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $838 k |
| **OPEX subtotal** | | **$8.2 M / yr** |

_Annual service work: 13,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.4 M train-km / yr (16.1 M car-km / yr). On-site PV covers 18.7 GWh/yr and the dedicated solar plant adds 52.7 GWh/yr against 64.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 77 trainsets, 20 stations, 29.4 route-km, 3 lines, and 13,649 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 41 |
| Farebox revenue | $35 M / yr | $56 M / yr | $6.9 M / yr |
| Station shop leases | $499 k / yr | $499 k / yr | $499 k / yr |
| Advertising boards | $817 k / yr | $817 k / yr | $817 k / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$8.2 M / yr** |
| Revenue / OPEX recovery | 446% | 704% | 100% |
...
_Commercial-revenue assumptions: 3,280 m² of station shop/kiosk leases at $14/m²/month and 636 advertising boards at $126/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $191 M | 56% of $338 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 22,080 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$338 M** |
| 15%–25% planning risk envelope | $389 M–$423 M |
| Annual OPEX | $8.2 M / yr |
| Low/high project NPV at 8% | $-61404 k / $80 M |
| Low/high project IRR | 6.0% / 10.3% |
| Low/high steady-state DSCR | 1.78 / 3.11 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,303.44 train-km; 9,760.06 kWh consumed; 10,408.81 kWh charged; 36 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,192.63 train-km; 106,273.28 kWh consumed; 108,654.12 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 79%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 74.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 60.3% | 100.0% / 90% | pass |
