...
| Bucket | Value |
|---|---|
| At-grade (53.8 km @ €3.5 M/km) | €188 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 54.1 km × €0.015 M/km | €0.8 M |
...
| Steady-state, low-ridership (year 8+) | **€43 M / yr** | €71 |
| Steady-state, high-ridership (year 8+) | **€40 M / yr** | €66 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.22 bn cumulative** | €2,028 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.15 bn cumulative** | €1,912 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€10 M / yr (low) → €7.4 M / yr (high)._
...
| Labour (337 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €938 k |
...
| Operating shortfall (gov subsidy required) | €10 M / yr | €7.4 M / yr |
