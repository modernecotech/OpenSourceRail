...
|---|---|---|---|---|
| line-1 | 19.9 km | 11 | 52 | E Outer ↔ W Mid |
| line-2 | 17.2 km | 11 | 45 | SE Mid ↔ W Mid |
| line-3 | 15.4 km | 9 | 39 | NW Outer ↔ SW Inner |
| **Total** | **52.5 km** | **31 unique** | **136** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **60.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Dedicated solar plant | 60.1 MW / 288 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 149 kWh | 253 kWh | 89 kWh | 5.0 km / 37 kWh |
| line-2 | 11 | 129 kWh | 233 kWh | 91 kWh | 2.0 km / 15 kWh |
| line-3 | 9 | 115 kWh | 192 kWh | 65 kWh | 2.5 km / 18 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 60,064 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 60,064 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 60.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 105.2 GWh/yr |
...
| Per-capita (city pop) | $843 / person |
...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $54 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$229 M cumulative** | $381 |
| Lifecycle envelope (yr 1–40, high scenario) | **$229 M cumulative** | $381 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $405 M | 4.5% | 40 y, 7 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $101 M | — | — | — |
| **Total** | **100%** | **$506 M** | | | **$24 M / yr** |
...
| Traction energy (115.5 GWh / yr) | 24,418 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.0 GWh/yr + dedicated solar plant 60.1 MW / 105.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $721 k |
| Labour (377 FTE) | driverless roster: OCC/remote 86, station/platform 99, passenger service 49, fleet maintenance 73, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 24,418 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.6 M train-km / yr (28.9 M car-km / yr). On-site PV covers 24.0 GWh/yr and the dedicated solar plant adds 105.2 GWh/yr against 115.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 136 trainsets, 31 stations, 52.5 route-km, 3 lines, and 24,418 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 22.5 M |
| Annual paid trips / city resident | 122 | 196 | 38 |
| Farebox revenue | $35 M / yr | $56 M / yr | $11 M / yr |
| Station shop leases | $588 k / yr | $588 k / yr | $588 k / yr |
| Advertising boards | $997 k / yr | $997 k / yr | $997 k / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 297% | 467% | 100% |
...
_Commercial-revenue assumptions: 3,864 m² of station shop/kiosk leases at $14/m²/month and 776 advertising boards at $126/board/month, with occupancy derates applied._
...
| Commerce | 11 major/terminal/interchange nodes | 39,625 trips/trading day; 13.1 M access-events/yr | 63,400 trips/trading day; 20.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $279 M | 55% of $506 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $447 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $64 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 32,340 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $458 M |
| Timetable-sized dedicated solar CAPEX | $48 M |
| **Reconciled project CAPEX** | **$506 M** |
| 15%–25% planning risk envelope | $582 M–$633 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-212528 k / $-70662 k |
| Low/high project IRR | 2.5% / 6.5% |
| Low/high steady-state DSCR | 1.03 / 1.91 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,021.84 train-km; 15,139.41 kWh consumed; 15,954.67 kWh charged; 27 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,226.12 train-km; 188,891.11 kWh consumed; 192,874.56 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 47%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 35.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 47.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.7% / 60% | pass |
| ten-hour single charging-pad outage | 22.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
