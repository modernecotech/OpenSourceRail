...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$666 M (86.3%) of external capital** and **$835 M of external interest**. Capital plus saved interest totals **$1.50 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (52.4 km @ $3.0 M/km) | $157 M |
...
| **Total city CAPEX** | **$429 M** | **24.7%** | **$106 M** | **$323 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$106 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$323 M** | **$46 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $258 M | $37 M / yr |
| **Total city programme** | **100.0%** | **$429 M** | **$61 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $579 M | $473 M (81.7%) | $593 M | **$1.07 bn** |
| **Default** | 2.00× | $772 M | $666 M (86.3%) | $835 M | **$1.50 bn** |
| High | 3.00× | $1.16 bn | $1.05 bn (90.9%) | $1.32 bn | **$2.37 bn** |

At the default 2.00× case, OSR's $106 M external requirement is 86.3% below the illustrative foreign-company requirement of $772 M; the associated lifetime external-interest saving is $835 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$4.2 M / yr** | $7 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $50 |
| Lifecycle envelope (yr 1–40, low scenario) | **$392 M cumulative** | $653 |
| Lifecycle envelope (yr 1–40, high scenario) | **$252 M cumulative** | $420 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.23 bn cumulative** | $2,058 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $26 M / yr → $30 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $106 M | 4.5% | 40 y, 7 y grace | $6.2 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $258 M | 8.5% | 40 y, 7 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $65 M | — | — | — |
| **Total** | **100%** | **$429 M** | | | **$30 M / yr** |
...
| Annual paid trips / city resident | 122 | 196 | 34 |
| Farebox revenue | $35 M / yr | $56 M / yr | $9.7 M / yr |
...
| Revenue / OPEX recovery | 335% | 530% | 100% |
...
| Operating surplus applied to debt support | -$26 M / yr | -$30 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $4.2 M / yr | $0 k / yr | **$30 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $323 M | 75% of $429 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $517 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $74 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 37,389 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$429 M** |
| Imported / external-capital requirement | $106 M (24.7%) |
| Local-content / local-funding requirement | $323 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $772 M; OSR saves $666 M (86.3%) |
| Lifetime external interest and combined financing saving | $835 M interest; $1.50 bn capital + interest |
| 15%–25% planning risk envelope | $493 M–$536 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-147402 k / $-5536 k |
| Low/high project IRR | 3.7% / 7.9% |
| Low/high steady-state DSCR | 0.86 / 1.57 |
