...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $48 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$204 M cumulative** | $339 |
| Lifecycle envelope (yr 1–40, high scenario) | **$204 M cumulative** | $339 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$902 M cumulative** | $1,503 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $360 M | 4.5% | 40 y, 7 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $90 M | — | — | — |
| **Total** | **100%** | **$450 M** | | | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $248 M | 55% of $450 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 28,734 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-163303 k / $-21437 k |
| Low/high project IRR | 3.4% / 7.5% |
| Low/high steady-state DSCR | 1.21 / 2.20 |
