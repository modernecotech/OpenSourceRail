...
|---|---:|---:|---:|---:|
| Civil works | $159 M | 35% | $56 M | $103 M |
...
| **Total city CAPEX** | **$429 M** | **45.8%** | **$196 M** | **$233 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **45.8%** | **$196 M** | **$28 M / yr** |
| **Local capital for domestic procurement / payroll** | **54.2%** | **$233 M** | **$33 M / yr** |
| of which planned local bond issuance | 43.4% of total CAPEX | $186 M | $27 M / yr |
...
|---|---|---|
| Construction (years 1–7) | **$31 M / yr** | $52 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$317 M cumulative** | $528 |
| Lifecycle envelope (yr 1–40, high scenario) | **$219 M cumulative** | $365 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $1,932 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 46% | $196 M | 4.5% | 40 y, 7 y grace | $12 M / yr |
| Local-currency sovereign / project bonds for local content | 43% | $186 M | 8.5% | 40 y, 7 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $47 M | — | — | — |
| **Total** | **100%** | **$429 M** | | | **$28 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $8.8 M / yr + local bonds $16 M / yr = **$25 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $233 M | 54% of $429 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,910 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $196 M (45.8%) |
| Local-content / local-funding requirement | $233 M (54.2%) |
