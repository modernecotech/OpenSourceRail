...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **35,220 – 52,830 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (53.8 km @ $1.2 M/km) | $65 M |
| **Civil subtotal** | **$65 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 54.1 km × $0.015 M/km | $811 k |
...
|---|---|---|
| Construction (years 1–7) | **$10 M / yr** | $17 |
| Steady-state, low-ridership (year 8+) | **$7.0 M / yr** | $12 |
| Steady-state, high-ridership (year 8+) | **$1.5 M / yr** | $3 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$234 M cumulative** | $390 |
| Lifecycle envelope (yr 1–30, high scenario) | **$107 M cumulative** | $179 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$72 M cumulative** | $121 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $95 M | 3.8% | 30 y, 7 y grace | $6.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $39 M | 8.5% | 30 y, 7 y grace | $4.0 M / yr |
| Government equity (no debt service) | 15% | $24 M | — | — | — |
| **Total** | **100%** | **$158 M** | | | **$10 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.6 M / yr + bonds $3.4 M / yr = **$6.9 M / yr** total — plus the equity tranche amortised across construction ($3.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 101,530 |
| Daily paid trips / population | 8% | 15% | 17% |
| Annual paid trips | 17.5 M | 32.9 M | 37.1 M |
| Farebox revenue | $6.3 M / yr | $12 M / yr | $13 M / yr |
...
| Revenue / OPEX + debt-service recovery | 53% | 90% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $7.0 M / yr | $1.5 M / yr | **$0 / yr** |
