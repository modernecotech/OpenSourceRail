...
| Bucket | Value |
|---|---|
| At-grade (53.8 km @ $2.0 M/km) | $108 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 54.1 km × $0.015 M/km | $2.7 M |
...
| Steady-state, high-ridership (year 8+) | **$15 M / yr** | $26 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $26 |
| Lifecycle envelope (yr 1–30, low scenario) | **$465 M cumulative** | $775 |
| Lifecycle envelope (yr 1–30, high scenario) | **$465 M cumulative** | $775 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$465 M cumulative** | $775 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $143 M | 3.8% | 30 y, 7 y grace | $9.5 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $5.5 M / yr + bonds $5.1 M / yr = **$11 M / yr** total — plus the equity tranche amortised across construction ($5.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating surplus after OPEX | $3.7 M / yr | $9.3 M / yr | $0 / yr |
