...
|---|---|---|---|---|
| line-1 | 17.3 km | 10 | 18 | SE Mid ↔ W Mid |
| line-2 | 20.4 km | 12 | 20 | W Mid ↔ E Outer |
| line-3 | 16.3 km | 9 | 17 | E Inner ↔ NW Outer |
| **Total** | **54.1 km** | **31 unique** | **55** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **63,396 – 105,660 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$39 M / yr** | $65 |
| Steady-state, low-ridership (year 8+) | **$45 M / yr** | $75 |
| Steady-state, high-ridership (year 8+) | **$39 M / yr** | $65 |
| Steady-state, operating-neutral revenue case | **$38 M / yr** | $64 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.30 bn cumulative** | $2,170 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.17 bn cumulative** | $1,957 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.16 bn cumulative** | $1,928 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.3 M / yr → $775 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $357 M | 3.8% | 30 y, 7 y grace | $24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $149 M | 8.5% | 30 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 15% | $89 M | — | — | — |
| **Total** | **100%** | **$594 M** | | | **$38 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $14 M / yr + bonds $13 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 63,396 | 105,660 | 111,556 |
| Daily paid trips / catchment | 18% | 30% | 32% |
| Daily paid trips / city population | 11% | 18% | 19% |
| Annual paid trips | 23.1 M | 38.6 M | 40.7 M |
| Farebox revenue | $8.3 M / yr | $14 M / yr | $15 M / yr |
| Station shop leases | $597 k / yr | $597 k / yr | $597 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$9.9 M / yr** | **$15 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 61% | 95% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $45 M / yr | $39 M / yr | **$38 M / yr** |
