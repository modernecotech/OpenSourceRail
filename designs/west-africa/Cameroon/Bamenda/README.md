...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$627 M (86.0%) of external capital** and **$786 M of external interest**. Capital plus saved interest totals **$1.41 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---|---|---|---|
| line-1 | 19.9 km | 8 | 42 | E Outer ↔ W Mid |
| line-2 | 17.2 km | 8 | 37 | SE Mid ↔ W Mid |
| line-3 | 15.4 km | 6 | 32 | NW Outer ↔ SW Inner |
| **Total** | **52.5 km** | **22 unique** | **111** | |
...
- Anchor-weighted coverage: 53.6%
- Catchment population: **≈ 321,600** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 488 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 45 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 24,418 train-km/day | One-way train journeys × route length |
| Annual service work | 9.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 316 MWh/day | 28.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 264 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 63.2 MW / 303 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 149 kWh | 229 kWh | 65 kWh | 7.0 km / 52 kWh |
| line-2 | 8 | 129 kWh | 196 kWh | 54 kWh | 3.0 km / 22 kWh |
| line-3 | 6 | 115 kWh | 172 kWh | 45 kWh | 5.0 km / 38 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (52.4 km @ $2.58 M/km) | $135 M |
| Elevated (0.1 km @ $9.75 M/km) | $1.3 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 63,169 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 63,169 kW @ $100/kW | $6.3 M |
| Annual generation proxy | 63.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 110.7 GWh/yr |
...
|---|---:|---:|---:|---:|
| Civil works | $137 M | 15% | $20 M | $116 M |
...
| **Total city CAPEX** | **$405 M** | **25.2%** | **$102 M** | **$303 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bamenda`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.2%** | **$102 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.8%** | **$303 M** | **$43 M / yr** |
| of which planned local bond issuance | 59.8% of total CAPEX | $242 M | $35 M / yr |
| **Total city programme** | **100.0%** | **$405 M** | **$58 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $547 M | $445 M (81.3%) | $558 M | **$1.00 bn** |
| **Default** | 2.00× | $729 M | $627 M (86.0%) | $786 M | **$1.41 bn** |
| High | 3.00× | $1.09 bn | $992 M (90.6%) | $1.24 bn | **$2.24 bn** |

At the default 2.00× case, OSR's $102 M external requirement is 86.0% below the illustrative foreign-company requirement of $729 M; the associated lifetime external-interest saving is $786 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$34 M / yr** | $56 |
| Steady-state, low capacity-use (year 8+) | **$2.1 M / yr** | $4 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $47 |
| Lifecycle envelope (yr 1–40, low scenario) | **$307 M cumulative** | $512 |
| Lifecycle envelope (yr 1–40, high scenario) | **$237 M cumulative** | $395 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $1,941 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $26 M / yr → $28 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $102 M | 4.5% | 40 y, 7 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $242 M | 8.5% | 40 y, 7 y grace | $22 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$405 M** | | | **$28 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.6 M / yr + local bonds $21 M / yr = **$25 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (115.5 GWh / yr) | 24,418 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.3 GWh/yr + dedicated solar plant 63.2 MW / 110.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $758 k |
| Labour (331 FTE) | driverless roster: OCC/remote 73, station/platform 76, passenger service 49, fleet maintenance 66, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 24,418 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.6 M train-km / yr (28.9 M car-km / yr). On-site PV covers 19.3 GWh/yr and the dedicated solar plant adds 110.7 GWh/yr against 115.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 111 trainsets, 22 stations, 52.5 route-km, 3 lines, and 24,418 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $35 M / yr | $56 M / yr | $9.2 M / yr |
| Station shop leases | $450 k / yr | $450 k / yr | $450 k / yr |
| Advertising boards | $761 k / yr | $761 k / yr | $761 k / yr |
| **Total revenue** | **$36 M / yr** | **$58 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 349% | 552% | 100% |
...
| Operating surplus applied to debt support | -$26 M / yr | -$28 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.1 M / yr | $0 k / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $26 M / yr | $47 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,960 m² of station shop/kiosk leases at $14/m²/month and 592 advertising boards at $126/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $303 M | 75% of $405 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $485 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $69 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 35,063 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $355 M |
| Timetable-sized dedicated solar CAPEX | $51 M |
| **Reconciled project CAPEX** | **$405 M** |
| Imported / external-capital requirement | $102 M (25.2%) |
| Local-content / local-funding requirement | $303 M (74.8%) |
| Default foreign-turnkey external-capital comparison | $729 M; OSR saves $627 M (86.0%) |
| Lifetime external interest and combined financing saving | $786 M interest; $1.41 bn capital + interest |
| 15%–25% planning risk envelope | $466 M–$507 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-126855 k / $15 M |
| Low/high project IRR | 4.2% / 8.4% |
| Low/high steady-state DSCR | 0.92 / 1.68 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,065.83 train-km; 15,468.78 kWh consumed; 14,671.17 kWh charged; 30 depot services completed; minimum SoC 69%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 24,528.79 train-km; 183,669.45 kWh consumed; 182,591.38 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 74 SoC warnings; 9 energy-adapted off-peak departures, maximum 13 min headway |
...
| ten-hour single charging-pad outage | 20.0% | 99.6% / 90% | pass |
...
|---|---|
| ![Bamenda energy and battery simulation dashboard](engineering/screenshots/bamenda-simulation-dashboard.png) | ![Bamenda simulator network visualizer](engineering/screenshots/bamenda-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Bamenda QGIS engineering layers](engineering/screenshots/bamenda-qgis-engineering-map.png) | ![Bamenda SUMO timetable validation](engineering/screenshots/bamenda-sumo-validation.png) |
...
scripts/regenerate-city.sh bamenda
```
