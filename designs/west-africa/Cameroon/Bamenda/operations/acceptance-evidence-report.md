...
| Manufacturing schedule rows | 941 |
| Manufacturing material/BOM rows | 14,454 |
| Manufacturing QA verification rows | 941 |
| Construction QA action rows | 881 |
| Maintenance handover schedule rows | 1,113 |
| Manufacturing rows with material refs | 941 / 941 |
| Manufacturing rows with verification refs | 941 / 941 |
| Manufacturing rows linked to QA actions | 941 / 941 |
