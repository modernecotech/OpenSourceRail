...
|---|---|---|
| Construction (years 1–7) | **$140 M / yr** | $36 |
| Steady-state, low-ridership (year 8+) | **$144 M / yr** | $37 |
| Steady-state, high-ridership (year 8+) | **$139 M / yr** | $36 |
| Steady-state, operating-neutral revenue case | **$139 M / yr** | $36 |
| Lifecycle envelope (yr 1–30, low scenario) | **$4.30 bn cumulative** | $1,103 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.17 bn cumulative** | $1,070 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.17 bn cumulative** | $1,070 |

_Population basis: 3,900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.6 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.29 bn | 3.8% | 30 y, 7 y grace | $85 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $536 M | 8.5% | 30 y, 7 y grace | $54 M / yr |
| Government equity (no debt service) | 15% | $322 M | — | — | — |
| **Total** | **100%** | **$2.14 bn** | | | **$139 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $49 M / yr + bonds $46 M / yr = **$94 M / yr** total — plus the equity tranche amortised across construction ($46 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 259,740 | 432,900 | 302,335 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 7% | 11% | 8% |
| Annual paid trips | 94.8 M | 158.0 M | 110.4 M |
| Farebox revenue | $34 M / yr | $57 M / yr | $40 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $5.8 M / yr | $5.8 M / yr | $5.8 M / yr |
| **Total revenue** | **$44 M / yr** | **$66 M / yr** | **$49 M / yr** |
| Revenue / OPEX recovery | 89% | 135% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $144 M / yr | $139 M / yr | **$139 M / yr** |
