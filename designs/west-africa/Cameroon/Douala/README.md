...
| Bucket | Value |
|---|---|
| At-grade (193.3 km @ €3.5 M/km) | €676 M |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 184 | €6.0 M | €1.10 bn |
...
|---|---|---|
| Construction (years 1–7) | **€204 M / yr** | €52 |
| Steady-state, low-ridership (year 8+) | **€265 M / yr** | €68 |
| Steady-state, high-ridership (year 8+) | **€245 M / yr** | €63 |
| Lifecycle envelope (yr 1–30, low scenario) | **€7.51 bn cumulative** | €1,927 |
| Lifecycle envelope (yr 1–30, high scenario) | **€7.06 bn cumulative** | €1,811 |

_Population basis: 3,900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€64 M / yr (low) → €44 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.87 bn | 3.8% | 30 y, 7 y grace | €123 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €778 M | 8.5% | 30 y, 7 y grace | €78 M / yr |
| Government equity (no debt service) | 15% | €467 M | — | — | — |
| **Total** | **100%** | **€3.11 bn** | | | **€201 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €71 M / yr + bonds €66 M / yr = **€137 M / yr** total — plus the equity tranche amortised across construction (€67 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (1,380 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.8 M |
...
| Operating shortfall (gov subsidy required) | €64 M / yr | €44 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€265 M / yr** | **€245 M / yr** |
