...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$443 M (87.3%) of external capital** and **$556 M of external interest**. Capital plus saved interest totals **$999 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`ngaoundere.corridor.geojson`](ngaoundere.corridor.geojson).
...
- Anchor-weighted coverage: 84.8%
- Catchment population: **≈ 296,800** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 19.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 512 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 19 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 13,661 train-km/day | One-way train journeys × route length |
| Annual service work | 5.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 177 MWh/day | 16.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 117 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 20.7 MW / 135 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 108 kWh | 159 kWh | 41 kWh | 3.0 km / 25 kWh |
| line-2 | 4 | 72 kWh | 98 kWh | 19 kWh | 3.0 km / 25 kWh |
| line-3 | 4 | 66 kWh | 98 kWh | 26 kWh | 3.3 km / 28 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (26.8 km @ $2.58 M/km) | $69 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 20,743 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 20,743 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 20.7 MW × 6.5 peak-sun-h/day × 365 d/yr | 49.2 GWh/yr |
...
| Per-capita (city pop) | $806 / person |
...
| **Total city CAPEX** | **$282 M** | **22.9%** | **$65 M** | **$218 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ngaoundere`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.9%** | **$65 M** | **$9.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.1%** | **$218 M** | **$31 M / yr** |
| of which planned local bond issuance | 61.7% of total CAPEX | $174 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$282 M** | **$40 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $381 M | $316 M (83.0%) | $397 M | **$713 M** |
| **Default** | 2.00× | $508 M | $443 M (87.3%) | $556 M | **$999 M** |
| High | 3.00× | $762 M | $697 M (91.5%) | $874 M | **$1.57 bn** |

At the default 2.00× case, OSR's $65 M external requirement is 87.3% below the illustrative foreign-company requirement of $508 M; the associated lifetime external-interest saving is $556 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$167 M cumulative** | $478 |
| Lifecycle envelope (yr 1–40, high scenario) | **$167 M cumulative** | $478 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$816 M cumulative** | $2,333 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $65 M | 4.5% | 40 y, 7 y grace | $3.8 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $174 M | 8.5% | 40 y, 7 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $44 M | — | — | — |
| **Total** | **100%** | **$282 M** | | | **$20 M / yr** |
...
| Traction energy (64.6 GWh / yr) | 13,661 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.8 GWh/yr + dedicated solar plant 20.7 MW / 49.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $249 k |
| Labour (255 FTE) | driverless roster: OCC/remote 53, station/platform 65, passenger service 49, fleet maintenance 38, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $771 k |
| **OPEX subtotal** | | **$7.1 M / yr** |

_Annual service work: 13,661 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.4 M train-km / yr (16.2 M car-km / yr). On-site PV covers 21.8 GWh/yr and the dedicated solar plant adds 49.2 GWh/yr against 64.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 64 trainsets, 15 stations, 29.4 route-km, 3 lines, and 13,661 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 12.6 M |
| Annual paid trips / city resident | 209 | 335 | 36 |
| Farebox revenue | $35 M / yr | $56 M / yr | $6.0 M / yr |
| Station shop leases | $425 k / yr | $425 k / yr | $425 k / yr |
| Advertising boards | $689 k / yr | $689 k / yr | $689 k / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$7.1 M / yr** |
| Revenue / OPEX recovery | 508% | 804% | 100% |
...
_Commercial-revenue assumptions: 2,792 m² of station shop/kiosk leases at $14/m²/month and 536 advertising boards at $126/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$60 M / yr** | **$96 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 5 education anchors | 23,532 trips/school day; 5.2 M access-events/yr | 37,651 trips/school day; 8.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $218 M | 77% of $282 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,185 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$282 M** |
| Imported / external-capital requirement | $65 M (22.9%) |
| Local-content / local-funding requirement | $218 M (77.1%) |
| Default foreign-turnkey external-capital comparison | $508 M; OSR saves $443 M (87.3%) |
| Lifetime external interest and combined financing saving | $556 M interest; $999 M capital + interest |
| 15%–25% planning risk envelope | $325 M–$353 M |
| Annual OPEX | $7.1 M / yr |
| Low/high project NPV at 8% | $-13975 k / $128 M |
| Low/high project IRR | 7.5% / 12.1% |
| Low/high steady-state DSCR | 1.48 / 2.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,317.06 train-km; 10,998.71 kWh consumed; 10,298.86 kWh charged; 37 depot services completed; minimum SoC 71%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,156.09 train-km; 118,218.25 kWh consumed; 119,789.27 kWh charged; 484 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 26 SoC warnings; 11 energy-adapted off-peak departures, maximum 12 min headway |
...
| ten-hour all-site grid outage | 20.0% | 90.2% / 60% | pass |
...
|---|---|
| ![Ngaoundere energy and battery simulation dashboard](engineering/screenshots/ngaoundere-simulation-dashboard.png) | ![Ngaoundere simulator network visualizer](engineering/screenshots/ngaoundere-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 1 interchange complexes, 55 civil segments, and 0 input findings |
...
|---|---|
| ![Ngaoundere QGIS engineering layers](engineering/screenshots/ngaoundere-qgis-engineering-map.png) | ![Ngaoundere SUMO timetable validation](engineering/screenshots/ngaoundere-sumo-validation.png) |
...
| [`ngaoundere.toml`](ngaoundere.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`ngaoundere-network-map.png`](ngaoundere-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`ngaoundere.corridor.geojson`](ngaoundere.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`ngaoundere.stations.json`](ngaoundere.stations.json) | Machine-readable station list |
| [`ngaoundere.design-quality.yaml`](ngaoundere.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug ngaoundere
