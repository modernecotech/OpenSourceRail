...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$473 M (87.5%) of external capital** and **$593 M of external interest**. Capital plus saved interest totals **$1.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (26.8 km @ $3.0 M/km) | $80 M |
...
| Per-capita (city pop) | $858 / person |
...
| **Total city CAPEX** | **$300 M** | **22.4%** | **$67 M** | **$233 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.4%** | **$67 M** | **$9.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.6%** | **$233 M** | **$33 M / yr** |
| of which planned local bond issuance | 62.1% of total CAPEX | $186 M | $27 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $405 M | $338 M (83.4%) | $424 M | **$762 M** |
| **Default** | 2.00× | $541 M | $473 M (87.5%) | $593 M | **$1.07 bn** |
| High | 3.00× | $811 M | $744 M (91.7%) | $932 M | **$1.68 bn** |

At the default 2.00× case, OSR's $67 M external requirement is 87.5% below the illustrative foreign-company requirement of $541 M; the associated lifetime external-interest saving is $593 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$26 M / yr** | $73 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$179 M cumulative** | $511 |
| Lifecycle envelope (yr 1–40, high scenario) | **$179 M cumulative** | $511 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$870 M cumulative** | $2,486 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $67 M | 4.5% | 40 y, 7 y grace | $4.0 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $186 M | 8.5% | 40 y, 7 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $47 M | — | — | — |
| **Total** | **100%** | **$300 M** | | | **$21 M / yr** |
...
| Annual paid trips / city resident | 209 | 335 | 38 |
| Farebox revenue | $35 M / yr | $56 M / yr | $6.4 M / yr |
| Station shop leases | $425 k / yr | $425 k / yr | $425 k / yr |
| Advertising boards | $689 k / yr | $689 k / yr | $689 k / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$7.5 M / yr** |
| Revenue / OPEX recovery | 485% | 767% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $233 M | 78% of $300 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,971 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $284 M |
| Timetable-sized dedicated solar CAPEX | $17 M |
| **Reconciled project CAPEX** | **$300 M** |
| Imported / external-capital requirement | $67 M (22.4%) |
| Local-content / local-funding requirement | $233 M (77.6%) |
| Default foreign-turnkey external-capital comparison | $541 M; OSR saves $473 M (87.5%) |
| Lifetime external interest and combined financing saving | $593 M interest; $1.07 bn capital + interest |
| 15%–25% planning risk envelope | $345 M–$375 M |
| Annual OPEX | $7.5 M / yr |
| Low/high project NPV at 8% | $-29759 k / $112 M |
| Low/high project IRR | 6.9% / 11.4% |
| Low/high steady-state DSCR | 1.38 / 2.38 |
