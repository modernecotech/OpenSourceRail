...
|---|---|---|---|---|
| line-1 | 12.9 km | 8 | 34 | N Outer ↔ S Outer |
| line-2 |  8.6 km | 7 | 24 | NW Outer ↔ SE Outer |
| line-3 |  7.8 km | 6 | 21 | W Outer ↔ NE Mid |
| **Total** | **29.4 km** | **21 unique** | **79** | |
...
| Onboard battery adequacy | 29.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 521 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 18.7 MW / 121 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 108 kWh | 180 kWh | 61 kWh | 2.2 km / 19 kWh |
| line-2 | 7 | 72 kWh | 131 kWh | 51 kWh | 2.0 km / 17 kWh |
| line-3 | 6 | 66 kWh | 114 kWh | 42 kWh | 2.0 km / 17 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 18,673 kW @ $700/kW | $13 M |
| Grid interconnection / PPA tie-in | 18,673 kW @ $100/kW | $1.9 M |
| Annual generation proxy | 18.7 MW × 6.5 peak-sun-h/day × 365 d/yr | 44.3 GWh/yr |
...
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$166 M cumulative** | $475 |
| Lifecycle envelope (yr 1–40, high scenario) | **$166 M cumulative** | $475 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$736 M cumulative** | $2,103 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $294 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $74 M | — | — | — |
| **Total** | **100%** | **$368 M** | | | **$17 M / yr** |
...
| Traction energy (64.6 GWh / yr) | 13,661 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 18.7 MW / 44.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $224 k |
| Labour (292 FTE) | driverless roster: OCC/remote 57, station/platform 92, passenger service 49, fleet maintenance 42, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $883 k |
| **OPEX subtotal** | | **$8.8 M / yr** |

_Annual service work: 13,661 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.4 M train-km / yr (16.2 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 44.3 GWh/yr against 64.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 79 trainsets, 21 stations, 29.4 route-km, 3 lines, and 13,661 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 43 |
| Farebox revenue | $35 M / yr | $56 M / yr | $7.3 M / yr |
| Station shop leases | $605 k / yr | $605 k / yr | $605 k / yr |
| Advertising boards | $961 k / yr | $961 k / yr | $961 k / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 416% | 655% | 100% |
...
_Commercial-revenue assumptions: 3,976 m² of station shop/kiosk leases at $14/m²/month and 748 advertising boards at $126/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 8 education anchors | 25,391 trips/school day; 5.6 M access-events/yr | 40,626 trips/school day; 8.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $211 M | 57% of $368 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 24,448 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$368 M** |
| 15%–25% planning risk envelope | $423 M–$459 M |
| Annual OPEX | $8.8 M / yr |
| Low/high project NPV at 8% | $-85765 k / $56 M |
| Low/high project IRR | 5.3% / 9.5% |
| Low/high steady-state DSCR | 1.62 / 2.84 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,286.02 train-km; 10,739.60 kWh consumed; 11,390.73 kWh charged; 36 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,195.59 train-km; 118,548.14 kWh consumed; 120,943.12 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 65%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 57.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 60.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 64.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 34.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 1 interchange complexes, 55 civil segments, and 0 input findings |
