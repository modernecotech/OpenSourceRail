...
| Steady-state, low-ridership (year 8+) | **$50 M / yr** | $101 |
| Steady-state, high-ridership (year 8+) | **$45 M / yr** | $89 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $87 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.47 bn cumulative** | $2,932 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.33 bn cumulative** | $2,665 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.30 bn cumulative** | $2,605 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.1 M / yr → $1.3 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $402 M | 3.8% | 30 y, 7 y grace | $26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $167 M | 8.5% | 30 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $100 M | — | — | — |
| **Total** | **100%** | **$669 M** | | | **$43 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 66,240 | 110,400 | 120,381 |
| Daily paid trips / catchment | 18% | 30% | 33% |
| Daily paid trips / city population | 13% | 22% | 24% |
| Annual paid trips | 24.2 M | 40.3 M | 43.9 M |
| Farebox revenue | $8.7 M / yr | $15 M / yr | $16 M / yr |
...
| Revenue / OPEX recovery | 59% | 93% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $50 M / yr | $45 M / yr | **$43 M / yr** |
