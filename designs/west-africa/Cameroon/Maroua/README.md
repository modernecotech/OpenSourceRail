...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **36,800 – 55,200 trips/day**
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 52.5 km × $0.015 M/km | $788 k |
...
| Steady-state, low-ridership (year 8+) | **$7.7 M / yr** | $15 |
| Steady-state, high-ridership (year 8+) | **$3.1 M / yr** | $6 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$249 M cumulative** | $498 |
| Lifecycle envelope (yr 1–30, high scenario) | **$143 M cumulative** | $287 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$71 M cumulative** | $143 |
...
| **Total** | **100%** | **$156 M** | | | **$10 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.5 M / yr + bonds $3.3 M / yr = **$6.9 M / yr** total — plus the equity tranche amortised across construction ($3.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
