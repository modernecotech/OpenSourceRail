...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 219 | $60 k | $13 M |
| High sensitivity check | 219 | $120 k | $26 M |
...
|---|---|---|
| Construction (years 1–7) | **$23 M / yr** | $39 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$164 M cumulative** | $273 |
| Lifecycle envelope (yr 1–40, high scenario) | **$164 M cumulative** | $273 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$726 M cumulative** | $1,210 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $290 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $73 M | — | — | — |
| **Total** | **100%** | **$363 M** | | | **$17 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $210 M | 58% of $363 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 24,311 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $417 M–$453 M |
| Annual OPEX | $8.6 M / yr |
| Low/high project NPV at 8% | $-84121 k / $58 M |
| Low/high project IRR | 5.3% / 9.6% |
| Low/high steady-state DSCR | 1.62 / 2.86 |
