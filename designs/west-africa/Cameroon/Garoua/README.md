...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **40,500 – 67,500 trips/day**
...
| Steady-state, low-ridership (year 8+) | **$53 M / yr** | $88 |
| Steady-state, high-ridership (year 8+) | **$49 M / yr** | $82 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $72 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.51 bn cumulative** | $2,524 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.43 bn cumulative** | $2,388 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.29 bn cumulative** | $2,157 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.6 M / yr → $6.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $399 M | 3.8% | 30 y, 7 y grace | $26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $166 M | 8.5% | 30 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $100 M | — | — | — |
| **Total** | **100%** | **$665 M** | | | **$43 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 40,500 | 67,500 | 113,408 |
| Daily paid trips / catchment | 18% | 30% | 50% |
| Daily paid trips / city population | 7% | 11% | 19% |
| Annual paid trips | 14.8 M | 24.6 M | 41.4 M |
...
| **Total revenue** | **$7.1 M / yr** | **$11 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 43% | 64% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $53 M / yr | $49 M / yr | **$43 M / yr** |
