...
|---|---|---|---|---|
| line-1 | 14.2 km | 10 | 35 | SW Outer ↔ NE Outer |
| line-2 | 10.9 km | 7 | 29 | S Mid ↔ N Outer |
| line-3 |  7.8 km | 5 | 23 | W Outer ↔ N Mid |
| **Total** | **33.0 km** | **22 unique** | **87** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **22.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 30.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 522 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 125 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 22.2 MW / 144 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 119 kWh | 188 kWh | 57 kWh | 2.1 km / 18 kWh |
| line-2 | 7 | 91 kWh | 151 kWh | 51 kWh | 2.1 km / 18 kWh |
| line-3 | 5 | 65 kWh | 110 kWh | 39 kWh | 2.0 km / 17 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 261 | $60 k | $16 M |
| High sensitivity check | 261 | $120 k | $31 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 22,165 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 22,165 kW @ $100/kW | $2.2 M |
| Annual generation proxy | 22.2 MW × 6.5 peak-sun-h/day × 365 d/yr | 52.6 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$26 M / yr** | $44 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$184 M cumulative** | $307 |
| Lifecycle envelope (yr 1–40, high scenario) | **$184 M cumulative** | $307 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$816 M cumulative** | $1,360 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $326 M | 4.5% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $81 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$19 M / yr** |
...
| Traction energy (72.5 GWh / yr) | 15,334 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.8 GWh/yr + dedicated solar plant 22.2 MW / 52.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $266 k |
| Labour (296 FTE) | driverless roster: OCC/remote 61, station/platform 84, passenger service 49, fleet maintenance 47, infrastructure/energy 34, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $895 k |
| **OPEX subtotal** | | **$9.7 M / yr** |

_Annual service work: 15,334 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.0 M train-km / yr (18.1 M car-km / yr). On-site PV covers 26.8 GWh/yr and the dedicated solar plant adds 52.6 GWh/yr against 72.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 87 trainsets, 22 stations, 33.0 route-km, 3 lines, and 15,334 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 17.3 M |
| Annual paid trips / city resident | 122 | 196 | 29 |
| Farebox revenue | $35 M / yr | $56 M / yr | $8.3 M / yr |
| Station shop leases | $536 k / yr | $536 k / yr | $536 k / yr |
| Advertising boards | $879 k / yr | $879 k / yr | $879 k / yr |
| **Total revenue** | **$37 M / yr** | **$58 M / yr** | **$9.7 M / yr** |
| Revenue / OPEX recovery | 377% | 595% | 100% |
...
_Commercial-revenue assumptions: 3,528 m² of station shop/kiosk leases at $14/m²/month and 684 advertising boards at $126/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 6 education anchors | 15,267 trips/school day; 3.4 M access-events/yr | 24,427 trips/school day; 5.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $236 M | 58% of $407 M CAPEX using bucket local-content shares |
...
| 15%–25% planning risk envelope | $468 M–$509 M |
| Annual OPEX | $9.7 M / yr |
| Low/high project NPV at 8% | $-122182 k / $20 M |
| Low/high project IRR | 4.4% / 8.5% |
| Low/high steady-state DSCR | 1.41 / 2.51 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,415.15 train-km; 11,817.98 kWh consumed; 12,269.96 kWh charged; 35 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,922.16 train-km; 132,966.53 kWh consumed; 135,553.78 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 59%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| 50% charging-contact availability | 59.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.9% / 60% | pass |
| ten-hour single charging-pad outage | 51.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 36 civil segments, and 0 input findings |
