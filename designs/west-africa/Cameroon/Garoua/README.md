...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$551 M (87.8%) of external capital** and **$691 M of external interest**. Capital plus saved interest totals **$1.24 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 66.4% |
| Route length (double track) | 33.0 km |
| Revenue fleet | 65 × 3-car trainsets |
| Revenue fleet passenger capacity | 23,400 AW2 pax (31,200 AW3 crush) |
...
| Revenue fleet capacity | 23,400 AW2 pax (31,200 AW3 crush) |
| Total fleet capacity | 26,280 AW2 pax (35,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 65 × 360 = **23,400 AW2 passengers** (31,200 AW3 crush)
- **Total fleet passenger capacity:** 73 × 360 = **26,280 AW2 passengers** (35,040 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 66.4%
- Catchment population: **≈ 398,400** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **24.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 26 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 15,334 train-km/day | One-way train journeys × route length |
| Annual service work | 6.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 199 MWh/day | 18.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 141 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 24.9 MW / 162 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 119 kWh | 176 kWh | 45 kWh | 3.5 km / 29 kWh |
| line-2 | 4 | 91 kWh | 131 kWh | 30 kWh | 6.1 km / 51 kWh |
| line-3 | 4 | 65 kWh | 98 kWh | 26 kWh | 3.0 km / 25 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (25.3 km @ $3.0 M/km) | $76 M |
| Elevated (7.6 km @ $12.0 M/km) | $92 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 73 | $900 k | $66 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 219 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 219 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 24,925 kW @ $700/kW | $17 M |
| Grid interconnection / PPA tie-in | 24,925 kW @ $100/kW | $2.5 M |
| Annual generation proxy | 24.9 MW × 6.5 peak-sun-h/day × 365 d/yr | 59.1 GWh/yr |
...
| Rolling stock | $66 M | 35% | $23 M | $43 M |
| Dedicated solar plant | $20 M | 45% | $9.0 M | $11 M |
| Residual signalling / train control | $1.6 M | 50% | $824 k | $824 k |
| Charging microgrids | $1.6 M | 40% | $620 k | $930 k |
| EPC / project services | $21 M | 15% | $3.2 M | $18 M |
| **Total city CAPEX** | **$349 M** | **21.9%** | **$76 M** | **$272 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh garoua`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.9%** | **$76 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.1%** | **$272 M** | **$39 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $218 M | $31 M / yr |
| **Total city programme** | **100.0%** | **$349 M** | **$50 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $470 M | $394 M (83.8%) | $494 M | **$888 M** |
| **Default** | 2.00× | $627 M | $551 M (87.8%) | $691 M | **$1.24 bn** |
| High | 3.00× | $941 M | $865 M (91.9%) | $1.08 bn | **$1.95 bn** |

At the default 2.00× case, OSR's $76 M external requirement is 87.8% below the illustrative foreign-company requirement of $627 M; the associated lifetime external-interest saving is $691 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$30 M / yr** | $50 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$208 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, high scenario) | **$208 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,685 |
...
| Traction energy (72.5 GWh / yr) | 15,334 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.1 GWh/yr + dedicated solar plant 24.9 MW / 59.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $299 k |
| Labour (260 FTE) | driverless roster: OCC/remote 57, station/platform 59, passenger service 49, fleet maintenance 43, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $786 k |
| **OPEX subtotal** | | **$8.6 M / yr** |

_Annual service work: 15,334 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.0 M train-km / yr (18.1 M car-km / yr). On-site PV covers 21.1 GWh/yr and the dedicated solar plant adds 59.1 GWh/yr against 72.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 73 trainsets, 14 stations, 33.0 route-km, 3 lines, and 15,334 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 15.8 M |
| Annual paid trips / city resident | 122 | 196 | 26 |
| Farebox revenue | $35 M / yr | $56 M / yr | $7.6 M / yr |
| Station shop leases | $371 k / yr | $371 k / yr | $371 k / yr |
| Advertising boards | $612 k / yr | $612 k / yr | $612 k / yr |
| **Total revenue** | **$36 M / yr** | **$57 M / yr** | **$8.6 M / yr** |
| Revenue / OPEX recovery | 423% | 669% | 100% |
...
_Commercial-revenue assumptions: 2,440 m² of station shop/kiosk leases at $14/m²/month and 476 advertising boards at $126/board/month, with occupancy derates applied._
...
| Avoided road congestion | $8.7 M / yr | $14 M / yr | 109 M - 174 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.6 M / yr | $2.5 M / yr | 19.6–31.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $4.4 M / yr | $7.0 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| Commerce | 10 major/terminal/interchange nodes | 47,207 trips/trading day; 15.6 M access-events/yr | 75,531 trips/trading day; 24.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $272 M | 78% of $349 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $436 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $62 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 31,507 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$349 M** |
| Imported / external-capital requirement | $76 M (21.9%) |
| Local-content / local-funding requirement | $272 M (78.1%) |
| Default foreign-turnkey external-capital comparison | $627 M; OSR saves $551 M (87.8%) |
| Lifetime external interest and combined financing saving | $691 M interest; $1.24 bn capital + interest |
| 15%–25% planning risk envelope | $401 M–$436 M |
| Annual OPEX | $8.6 M / yr |
| Low/high project NPV at 8% | $-73664 k / $68 M |
| Low/high project IRR | 5.6% / 9.9% |
| Low/high steady-state DSCR | 1.13 / 2.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,409.46 train-km; 11,770.26 kWh consumed; 10,802.37 kWh charged; 37 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,274.52 train-km; 127,558.52 kWh consumed; 128,591.59 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.6% of scheduled train-km delivered; 44 SoC warnings; 6 energy-adapted off-peak departures, maximum 15 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 98.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 99.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 87.8% / 60% | pass |
...
|---|---|
| ![Garoua energy and battery simulation dashboard](engineering/screenshots/garoua-simulation-dashboard.png) | ![Garoua simulator network visualizer](engineering/screenshots/garoua-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 36 civil segments, and 0 input findings |
...
|---|---|
| ![Garoua QGIS engineering layers](engineering/screenshots/garoua-qgis-engineering-map.png) | ![Garoua SUMO timetable validation](engineering/screenshots/garoua-sumo-validation.png) |
