...
| Steady-state, low-ridership (year 8+) | **$28 M / yr** | $47 |
| Steady-state, high-ridership (year 8+) | **$26 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $44 |
| Lifecycle envelope (yr 1–30, low scenario) | **$830 M cumulative** | $1,383 |
| Lifecycle envelope (yr 1–30, high scenario) | **$787 M cumulative** | $1,312 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$787 M cumulative** | $1,312 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.9 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $243 M | 3.8% | 30 y, 7 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $101 M | 8.5% | 30 y, 7 y grace | $10 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$405 M** | | | **$26 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $9.2 M / yr + bonds $8.6 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($8.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 40,500 | 67,500 | 54,661 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 7% | 11% | 9% |
| Annual paid trips | 14.8 M | 24.6 M | 20.0 M |
| Farebox revenue | $5.3 M / yr | $8.9 M / yr | $7.2 M / yr |
| Station shop leases | $669 k / yr | $669 k / yr | $669 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$7.1 M / yr** | **$11 M / yr** | **$9.0 M / yr** |
| Revenue / OPEX recovery | 79% | 119% | 100% |
