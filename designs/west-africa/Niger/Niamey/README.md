...
|---|---|---|---|---|
| line-1 | 30.9 km | 17 | 42 | SE Outer ↔ NW Outer |
| line-2 | 24.7 km | 15 | 35 | N Outer ↔ SE Outer |
| line-3 | 28.7 km | 17 | 39 | SW Outer ↔ E Mid |
| line-4 | 61.6 km | 31 | 81 | NW Outer ↔ NW Outer |
| **Total** | **146.0 km** | **79 unique** | **197** | |
...
| Total fleet capacity | 94,560 AW2 pax (126,080 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 177 × 480 = **84,960 AW2 passengers** (113,280 AW3 crush)
- **Total fleet passenger capacity:** 197 × 480 = **94,560 AW2 passengers** (126,080 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **251.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Average one-way line energy | 584 kWh | 36.5 km average line length |
...
| Scheduled traction demand | 1,274 MWh/day | 73,715 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,095 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 251.8 MW / 1,259 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 197 | $5.60 M | $1.10 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 788 | $100 k | $79 M |
| High sensitivity check | 788 | $200 k | $158 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 251,803 kW @ $700/kW | $176 M |
| Grid interconnection / PPA tie-in | 251,803 kW @ $100/kW | $25 M |
| Annual generation proxy | 251.8 MW × 5.0 peak-sun-h/day × 365 d/yr | 459.5 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 146.0 km × $0.050 M/km | $7.3 M |
...
| Per-capita (city pop) | $1,784 / person |
...
|---|---|---|
| Construction (years 1–10) | **$90 M / yr** | $64 |
| Steady-state, low capacity-use (year 11+) | **$125 M / yr** | $89 |
| Steady-state, high capacity-use (year 11+) | **$108 M / yr** | $77 |
| Steady-state, operating-neutral revenue case | **$90 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.66 bn cumulative** | $3,311 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.15 bn cumulative** | $2,948 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.60 bn cumulative** | $2,555 |

_Population basis: 1,407,635 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $35 M / yr → $18 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.01 bn | 2.0% | 40 y, 10 y grace | $90 M / yr |
| Government equity (no debt service) | 20% | $502 M | — | — | — |
| **Total** | **100%** | **$2.51 bn** | | | **$90 M / yr** |
...
| Traction energy (464.9 GWh / yr) | 73,715 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 65.3 GWh/yr + dedicated solar plant 251.8 MW / 459.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.0 M |
| Labour (852 FTE) | driverless roster: OCC/remote 118, station/platform 322, passenger service 71, fleet maintenance 156, infrastructure/energy 147, admin/training 38; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$68 M / yr** |

_Annual service work: 73,715 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 29.1 M train-km / yr (116.2 M car-km / yr). On-site PV covers 65.3 GWh/yr and the dedicated solar plant adds 459.5 GWh/yr against 464.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 112% |
| Annual paid trips | 112.1 M | 179.4 M | 252.2 M |
| Annual paid trips / city resident | 80 | 127 | 179 |
| Farebox revenue | $28 M / yr | $45 M / yr | $64 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$32 M / yr** | **$49 M / yr** | **$68 M / yr** |
| Revenue / OPEX recovery | 47% | 73% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $125 M / yr | $108 M / yr | **$90 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $125 M / yr | $108 M / yr | **$90 M / yr** |
| Operating surplus after OPEX (before debt support) | $0 k / yr | $0 k / yr | $0 / yr |

_Commercial-revenue assumptions: 14,832 m² of station shop/kiosk leases at $10/m²/month and 2,720 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $8.2 M / yr | $13 M / yr | 16 min/trip × $0.27/h value-of-time proxy |
...
| Station-area commerce turnover supported | $39 M / yr | $63 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $18 M / yr | $29 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$120 M / yr** | **$192 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 13 education anchors | 23,638 trips/school day; 5.2 M access-events/yr | 37,821 trips/school day; 8.3 M access-events/yr |
| Healthcare | 3 healthcare anchors | 20,469 trips/day; 7.5 M access-events/yr | 32,751 trips/day; 12.0 M access-events/yr |
| Commerce | 56 major/terminal/interchange nodes | 72,017 trips/trading day; 23.8 M access-events/yr | 115,227 trips/trading day; 38.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.30 bn | 52% of $2.51 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.08 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $208 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 285,718 job-years | retained CAPEX ÷ (4.0 × median annual income) |
