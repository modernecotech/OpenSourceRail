...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 120 | $5.60 M | $672 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 480 | $100 k | $48 M |
| High sensitivity check | 480 | $200 k | $96 M |
...
| Per-capita (city pop) | $1,290 / person |
...
|---|---|---|
| Construction (years 1–10) | **$101 M / yr** | $72 |
| Steady-state, low-ridership (year 11+) | **$146 M / yr** | $104 |
| Steady-state, high-ridership (year 11+) | **$141 M / yr** | $100 |
| Steady-state, operating-neutral revenue case | **$109 M / yr** | $77 |
| Lifecycle envelope (yr 1–35, low scenario) | **$4.65 bn cumulative** | $3,304 |
| Lifecycle envelope (yr 1–35, high scenario) | **$4.54 bn cumulative** | $3,224 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$3.73 bn cumulative** | $2,648 |

_Population basis: 1,407,635 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $37 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.09 bn | 3.0% | 35 y, 10 y grace | $63 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $454 M | 9.0% | 35 y, 10 y grace | $46 M / yr |
| Government equity (no debt service) | 15% | $272 M | — | — | — |
| **Total** | **100%** | **$1.82 bn** | | | **$109 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $33 M / yr + bonds $41 M / yr = **$74 M / yr** total — plus the equity tranche amortised across construction ($27 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 97,295 | 162,159 | 629,909 |
| Daily paid trips / catchment | 18% | 30% | 117% |
| Daily paid trips / city population | 7% | 12% | 45% |
| Annual paid trips | 35.5 M | 59.2 M | 229.9 M |
| Farebox revenue | $6.7 M / yr | $11 M / yr | $44 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$10 M / yr** | **$15 M / yr** | **$47 M / yr** |
| Revenue / OPEX recovery | 22% | 31% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $146 M / yr | $141 M / yr | **$109 M / yr** |
