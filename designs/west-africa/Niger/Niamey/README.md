...
|---|---|---|
| Construction (years 1–10) | **$66 M / yr** | $47 |
| Steady-state, low-ridership (year 11+) | **$86 M / yr** | $61 |
| Steady-state, high-ridership (year 11+) | **$82 M / yr** | $58 |
| Steady-state, operating-neutral revenue case | **$71 M / yr** | $50 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.81 bn cumulative** | $1,994 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.69 bn cumulative** | $1,914 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.43 bn cumulative** | $1,725 |

_Population basis: 1,407,635 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $15 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $710 M | 3.0% | 35 y, 10 y grace | $41 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $296 M | 9.0% | 35 y, 10 y grace | $30 M / yr |
| Government equity (no debt service) | 15% | $177 M | — | — | — |
| **Total** | **100%** | **$1.18 bn** | | | **$71 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $21 M / yr + bonds $27 M / yr = **$48 M / yr** total — plus the equity tranche amortised across construction ($18 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 97,295 | 162,159 | 316,169 |
| Daily paid trips / catchment | 18% | 30% | 58% |
| Daily paid trips / city population | 7% | 12% | 22% |
| Annual paid trips | 35.5 M | 59.2 M | 115.4 M |
| Farebox revenue | $6.7 M / yr | $11 M / yr | $22 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$10 M / yr** | **$15 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 41% | 58% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $86 M / yr | $82 M / yr | **$71 M / yr** |
