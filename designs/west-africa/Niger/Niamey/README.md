...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **97,295 – 162,159 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (139.0 km @ $2.0 M/km) | $278 M |
| Elevated (6.4 km @ $9.0 M/km) | $58 M |
...
| `major` | 39 | $1.60 M | $62 M |
| `terminal` | 5 | $1.40 M | $7.0 M |
| `depot-terminal` | 1 | $2.0 M | $2.0 M |
| `interchange-elevated` | 11 | $3.50 M | $38 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 146.0 km × $0.015 M/km | $7.3 M |
...
| Per-capita (city pop) | $518 / person |
...
|---|---|---|
| Construction (years 1–10) | **$40 M / yr** | $29 |
| Steady-state, low-ridership (year 11+) | **$50 M / yr** | $36 |
| Steady-state, high-ridership (year 11+) | **$46 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$44 M / yr** | $31 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.66 bn cumulative** | $1,182 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.55 bn cumulative** | $1,102 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.50 bn cumulative** | $1,063 |

_Population basis: 1,407,635 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.7 M / yr → $2.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $437 M | 3.0% | 35 y, 10 y grace | $25 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $182 M | 9.0% | 35 y, 10 y grace | $19 M / yr |
| Government equity (no debt service) | 15% | $109 M | — | — | — |
| **Total** | **100%** | **$729 M** | | | **$44 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $16 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 97,295 | 162,159 | 193,845 |
| Daily paid trips / catchment | 18% | 30% | 36% |
| Daily paid trips / city population | 7% | 12% | 14% |
| Annual paid trips | 35.5 M | 59.2 M | 70.8 M |
| Farebox revenue | $6.7 M / yr | $11 M / yr | $13 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$10 M / yr** | **$15 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 61% | 87% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $50 M / yr | $46 M / yr | **$44 M / yr** |
