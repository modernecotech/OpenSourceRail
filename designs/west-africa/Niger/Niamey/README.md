...
| Revenue fleet | 241 × 4-car trainsets |
| Revenue fleet passenger capacity | 115,680 AW2 pax (154,240 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 27.3 km | 17 | 61 | SE Outer ↔ NW Mid |
| line-2 | 18.9 km | 12 | 45 | NW Mid ↔ E Mid |
| line-3 | 16.8 km | 10 | 39 | NE Mid ↔ SW Mid |
| line-4 | 21.7 km | 14 | 50 | W Mid ↔ SE Outer |
| line-5 | 19.5 km | 12 | 45 | NW Outer ↔ S Mid |
| line-6 | 53.5 km | 32 | 29 | NW Mid ↔ W Mid |
| **Total** | **157.6 km** | **97 unique** | **269** | |
...
| Revenue fleet capacity | 115,680 AW2 pax (154,240 AW3 crush) |
| Total fleet capacity | 129,120 AW2 pax (172,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 241 × 480 = **115,680 AW2 passengers** (154,240 AW3 crush)
- **Total fleet passenger capacity:** 269 × 480 = **129,120 AW2 passengers** (172,160 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **148.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.9× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 664 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 334 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 212 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 840 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 148.5 MW / 966 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 303 kWh | 858 kWh | 524 kWh | 5.0 km / 56 kWh |
| line-2 | 12 | 211 kWh | 637 kWh | 405 kWh | 2.1 km / 24 kWh |
| line-3 | 10 | 187 kWh | 539 kWh | 334 kWh | 2.2 km / 25 kWh |
| line-4 | 13 | 241 kWh | 686 kWh | 421 kWh | 4.2 km / 47 kWh |
| line-5 | 11 | 217 kWh | 588 kWh | 349 kWh | 5.0 km / 56 kWh |
| line-6 | 31 | 596 kWh | 1,519 kWh | 863 kWh | 4.5 km / 50 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 269 | $1.12 M | $301 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1076 | $60 k | $65 M |
| High sensitivity check | 1076 | $120 k | $129 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 148,539 kW @ $700/kW | $104 M |
| Grid interconnection / PPA tie-in | 148,539 kW @ $100/kW | $15 M |
| Annual generation proxy | 148.5 MW × 6.5 peak-sun-h/day × 365 d/yr | 352.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$119 M** |
...
| Dedicated solar power plant | $119 M |
...
|---|---|---|
| Construction (years 1–10) | **$106 M / yr** | $75 |
| Steady-state, low capacity-use (year 11+) | **$84 M / yr** | $60 |
| Steady-state, high capacity-use (year 11+) | **$57 M / yr** | $40 |
| Steady-state, operating-neutral revenue case | **$93 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.58 bn cumulative** | $2,542 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.76 bn cumulative** | $1,961 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.85 bn cumulative** | $2,735 |

_Population basis: 1,407,635 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.1 M / yr → $36 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.51 bn | 4.5% | 40 y, 10 y grace | $93 M / yr |
| Government equity (no debt service) | 20% | $379 M | — | — | — |
| **Total** | **100%** | **$1.89 bn** | | | **$93 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $68 M / yr = **$68 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($38 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (383.8 GWh / yr) | 60,849 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 77.3 GWh/yr + dedicated solar plant 148.5 MW / 352.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.8 M |
| Labour (1,022 FTE) | driverless roster: OCC/remote 158, station/platform 424, passenger service 111, fleet maintenance 161, infrastructure/energy 141, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$41 M / yr** |

_Annual service work: 60,849 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 24.0 M train-km / yr (95.9 M car-km / yr). On-site PV covers 77.3 GWh/yr and the dedicated solar plant adds 352.4 GWh/yr against 383.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 269 trainsets, 97 stations, 157.6 route-km, 6 lines, and 60,849 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 143.4 M |
| Annual paid trips / city resident | 127 | 204 | 102 |
| Farebox revenue | $45 M / yr | $73 M / yr | $36 M / yr |
| Station shop leases | $2.0 M / yr | $2.0 M / yr | $2.0 M / yr |
| Advertising boards | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| **Total revenue** | **$50 M / yr** | **$77 M / yr** | **$41 M / yr** |
| Revenue / OPEX recovery | 122% | 189% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $93 M / yr | $93 M / yr | **$93 M / yr** |
| Operating surplus applied to debt support | -$9.1 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $84 M / yr | $57 M / yr | **$93 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.1 M / yr | $36 M / yr | $0 / yr |

_Commercial-revenue assumptions: 18,808 m² of station shop/kiosk leases at $10/m²/month and 3,420 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 27 education anchors | 46,158 trips/school day; 10.2 M access-events/yr | 73,852 trips/school day; 16.2 M access-events/yr |
| Healthcare | 10 healthcare anchors | 37,101 trips/day; 13.5 M access-events/yr | 59,361 trips/day; 21.7 M access-events/yr |
| Commerce | 51 major/terminal/interchange nodes | 105,675 trips/trading day; 34.9 M access-events/yr | 169,080 trips/trading day; 55.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.09 bn | 57% of $1.89 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.74 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $174 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 237,964 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $119 M |
| **Reconciled project CAPEX** | **$1.89 bn** |
| 15%–25% planning risk envelope | $2.18 bn–$2.37 bn |
| Annual OPEX | $41 M / yr |
| Low/high project NPV at 8% | $-1223189 k / $-1081130 k |
| Low/high project IRR | -8.2% / -2.6% |
| Low/high steady-state DSCR | 0.10 / 0.39 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,553.13 train-km; 50,704.15 kWh consumed; 55,954.28 kWh charged; 42 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 61,321.37 train-km; 682,882.00 kWh consumed; 694,236.32 kWh charged; 986 depot services completed (9 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| 50% charging-contact availability | 88.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.7% / 60% | pass |
| ten-hour single charging-pad outage | 86.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 97 line platforms, 13 interchange complexes, 48 civil segments, and 0 input findings |
