...
| Steady-state, low-ridership (year 11+) | **$48 M / yr** | $24 |
| Steady-state, high-ridership (year 11+) | **$48 M / yr** | $24 |
| Steady-state, operating-neutral revenue case | **$48 M / yr** | $24 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.65 bn cumulative** | $819 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.64 bn cumulative** | $817 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.64 bn cumulative** | $817 |

_Population basis: 2,010,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $217 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $462 M | 3.0% | 35 y, 10 y grace | $27 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $193 M | 10.0% | 35 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $116 M | — | — | — |
| **Total** | **100%** | **$771 M** | | | **$48 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $14 M / yr + bonds $19 M / yr = **$33 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 145,443 | 224,640 | 147,732 |
| Daily paid trips / catchment | 18% | 28% | 18% |
| Daily paid trips / city population | 7% | 11% | 7% |
| Annual paid trips | 53.1 M | 82.0 M | 53.9 M |
| Farebox revenue | $14 M / yr | $21 M / yr | $14 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$17 M / yr** | **$24 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 99% | 143% | 100% |
