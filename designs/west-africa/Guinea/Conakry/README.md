...
| Steady-state, high-ridership (year 11+) | **$33 M / yr** | $17 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $17 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.71 bn cumulative** | $850 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.30 bn cumulative** | $648 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.30 bn cumulative** | $648 |

_Population basis: 2,010,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $0 k / yr._
...
Planning ridership bracket = 25-45% of catchment × 365 service-days at the operating-neutral fare, capped by practical service capacity (460,800 trips/day). The operating-neutral column solves annual paid trips so **farebox + station-shop leases + advertising = steady-state OPEX**. Post-grace repayable-debt service remains a capital-funding obligation in the government commitment table above.
...
| Gov repayable-debt service + residual OPEX subsidy | $47 M / yr | $33 M / yr | **$33 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $6.9 M / yr | $0 / yr |
