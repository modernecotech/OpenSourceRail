...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 93.2 km × €0.4 M/km | €37 M |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €619 M | 3.0% | 35 y, 10 y grace | €36 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €258 M | 10.0% | 35 y, 10 y grace | €28 M / yr |
| Government equity (no debt service) | 15% | €155 M | — | — | — |
| **Total** | **100%** | **€1.03 bn** | | | **€64 M / yr** |
...
| Operating shortfall (gov subsidy required) | €17 M / yr | €10 M / yr |
| **Total annual government burden** (debt service + OPEX shortfall) | **€81 M / yr** | **€74 M / yr** |
