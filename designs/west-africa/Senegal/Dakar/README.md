...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **377,933 – 629,889 trips/day**
...
| Steady-state, low-ridership (year 8+) | **$17 M / yr** | $4 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$895 M cumulative** | $222 |
| Lifecycle envelope (yr 1–30, high scenario) | **$511 M cumulative** | $127 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$511 M cumulative** | $127 |

_Population basis: 4,030,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 604,500 | 1,007,500 | 735,216 |
| Daily paid trips / population | 15% | 25% | 18% |
| Annual paid trips | 220.6 M | 367.7 M | 268.4 M |
| Farebox revenue | $77 M / yr | $129 M / yr | $94 M / yr |
| Station shop leases | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| Advertising boards | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| **Total revenue** | **$85 M / yr** | **$136 M / yr** | **$101 M / yr** |
| Revenue / OPEX + debt-service recovery | 84% | 134% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $17 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $35 M / yr | $0 / yr |
