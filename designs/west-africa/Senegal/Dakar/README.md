...
| Residual train-control wayside + power | €166 M |
...
|---|---|---|
| Construction (years 1–7) | **€179 M / yr** | €44 |
| Steady-state, low-ridership (year 8+) | **€228 M / yr** | €57 |
| Steady-state, high-ridership (year 8+) | **€208 M / yr** | €52 |
| Lifecycle envelope (yr 1–30, low scenario) | **€6.49 bn cumulative** | €1,611 |
| Lifecycle envelope (yr 1–30, high scenario) | **€6.04 bn cumulative** | €1,499 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.64 bn | 3.8% | 30 y, 7 y grace | €108 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €682 M | 8.5% | 30 y, 7 y grace | €68 M / yr |
| Government equity (no debt service) | 15% | €409 M | — | — | — |
| **Total** | **100%** | **€2.73 bn** | | | **€176 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €62 M / yr + bonds €58 M / yr = **€120 M / yr** total — plus the equity tranche amortised across construction (€58 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€228 M / yr** | **€208 M / yr** |
