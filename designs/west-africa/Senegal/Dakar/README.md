...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1980 | $60 k | $119 M |
| High sensitivity check | 1980 | $120 k | $238 M |
...
| Depots | $8.0 M |
| Rolling stock | $554 M |
| Railway production plant | $119 M |
...
|---|---|---|
| Construction (years 1–7) | **$156 M / yr** | $39 |
| Steady-state, low capacity-use (year 8+) | **$39 M / yr** | $10 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$114 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.38 bn cumulative** | $590 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.10 bn cumulative** | $272 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.85 bn cumulative** | $1,204 |

_Population basis: 4,030,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $75 M / yr → $114 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.94 bn | 4.5% | 40 y, 7 y grace | $114 M / yr |
| Government equity (no debt service) | 20% | $485 M | — | — | — |
| **Total** | **100%** | **$2.42 bn** | | | **$114 M / yr** |
...
| Operating surplus applied to debt support | -$75 M / yr | -$114 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $39 M / yr | $0 k / yr | **$114 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.32 bn | 55% of $2.42 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.12 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $303 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 157,656 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $56 M / yr |
| Low/high project NPV at 8% | $-1297927 k / $-792202 k |
| Low/high project IRR | 0.1% / 4.0% |
| Low/high steady-state DSCR | 0.66 / 1.32 |
