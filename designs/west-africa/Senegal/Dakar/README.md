...
| Revenue fleet | 406 × 6-car trainsets |
| Revenue fleet passenger capacity | 292,320 AW2 pax (389,760 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 40.3 km | 24 | 102 | E Outer ↔ W Outer |
| line-2 | 30.3 km | 21 | 82 | W Outer ↔ E Mid |
| line-3 | 31.3 km | 20 | 82 | W Mid ↔ NE Outer |
| line-4 | 26.4 km | 18 | 72 | NE Mid ↔ SW Mid |
| line-5 | 28.3 km | 14 | 69 | E Outer ↔ SW Mid |
| line-6 | 65.6 km | 46 | 43 | W Mid ↔ W Mid |
| **Total** | **222.2 km** | **143 unique** | **450** | |
...
| Revenue fleet capacity | 292,320 AW2 pax (389,760 AW3 crush) |
| Total fleet capacity | 324,000 AW2 pax (432,000 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 406 × 720 = **292,320 AW2 passengers** (389,760 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **350.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.3× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 933 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 330 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 300 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,983 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 350.8 MW / 2,280 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 22 | 674 kWh | 1,535 kWh | 794 kWh | 8.8 km / 147 kWh |
| line-2 | 21 | 505 kWh | 1,437 kWh | 881 kWh | 2.0 km / 34 kWh |
| line-3 | 19 | 523 kWh | 1,307 kWh | 731 kWh | 4.7 km / 78 kWh |
| line-4 | 18 | 441 kWh | 1,241 kWh | 756 kWh | 2.0 km / 34 kWh |
| line-5 | 12 | 472 kWh | 849 kWh | 330 kWh | 8.3 km / 139 kWh |
| line-6 | 46 | 1,096 kWh | 3,005 kWh | 1,800 kWh | 2.8 km / 46 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (205.4 km @ $3.0 M/km) | $616 M |
| Elevated (16.8 km @ $12.0 M/km) | $202 M |
| Elevated-interchange premium (14 sites @ $4.50 M) | $63 M |
| **Civil subtotal** | **$881 M** |
...
|---|---|---|---|
| `halt` | 5 | $600 k | $3.0 M |
| `standard` | 63 | $2.50 M | $158 M |
| `major` | 9 | $4.50 M | $40 M |
| `terminal` | 9 | $4.50 M | $40 M |
| `depot-terminal` | 1 | $5.0 M | $5.0 M |
| `interchange-elevated` | 56 | $12.0 M | $672 M |
| **Stations subtotal** | | | **$918 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 350,822 kW @ $700/kW | $246 M |
| Grid interconnection / PPA tie-in | 350,822 kW @ $100/kW | $35 M |
| Annual generation proxy | 350.8 MW × 6.5 peak-sun-h/day × 365 d/yr | 832.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$281 M** |
...
| Dedicated solar power plant | $281 M |
...
|---|---|---|
| Construction (years 1–7) | **$211 M / yr** | $52 |
| Steady-state, low capacity-use (year 8+) | **$93 M / yr** | $23 |
| Steady-state, high capacity-use (year 8+) | **$18 M / yr** | $4 |
| Steady-state, operating-neutral revenue case | **$154 M / yr** | $38 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.55 bn cumulative** | $1,129 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.07 bn cumulative** | $513 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.56 bn cumulative** | $1,627 |

_Population basis: 4,030,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $61 M / yr → $136 M / yr._
...
| Traction energy (833.1 GWh / yr) | 88,062 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 109.4 GWh/yr + dedicated solar plant 350.8 MW / 832.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.2 M |
| Labour (1,533 FTE) | driverless roster: OCC/remote 239, station/platform 666, passenger service 151, fleet maintenance 251, infrastructure/energy 199, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $4.5 M |
| **OPEX subtotal** | | **$76 M / yr** |

_Annual service work: 88,062 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 34.7 M train-km / yr (208.3 M car-km / yr). On-site PV covers 109.4 GWh/yr and the dedicated solar plant adds 832.3 GWh/yr against 833.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 450 trainsets, 143 stations, 222.2 route-km, 6 lines, and 88,062 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 268.8 M | 430.2 M | 138.4 M |
| Annual paid trips / city resident | 67 | 107 | 34 |
| Farebox revenue | $125 M / yr | $201 M / yr | $65 M / yr |
| Station shop leases | $4.4 M / yr | $4.4 M / yr | $4.4 M / yr |
| Advertising boards | $6.7 M / yr | $6.7 M / yr | $6.7 M / yr |
| **Total revenue** | **$137 M / yr** | **$212 M / yr** | **$76 M / yr** |
| Revenue / OPEX recovery | 180% | 280% | 100% |
...
| Operating surplus applied to debt support | -$61 M / yr | -$136 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $93 M / yr | $18 M / yr | **$154 M / yr** |
| Operating surplus after OPEX (before debt support) | $61 M / yr | $136 M / yr | $0 / yr |

_Commercial-revenue assumptions: 29,728 m² of station shop/kiosk leases at $14/m²/month and 5,324 advertising boards at $122/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $87 M / yr | $139 M / yr | 22% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $43 M / yr | $68 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$296 M / yr** | **$473 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 21 education anchors | 55,564 trips/school day; 12.2 M access-events/yr | 88,903 trips/school day; 19.6 M access-events/yr |
| Healthcare | 8 healthcare anchors | 51,927 trips/day; 19.0 M access-events/yr | 83,084 trips/day; 30.3 M access-events/yr |
| Commerce | 75 major/terminal/interchange nodes | 158,412 trips/trading day; 52.3 M access-events/yr | 253,459 trips/trading day; 83.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.81 bn | 55% of $3.27 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.90 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $414 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 215,693 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.99 bn |
| Timetable-sized dedicated solar CAPEX | $281 M |
| **Reconciled project CAPEX** | **$3.27 bn** |
| 15%–25% planning risk envelope | $3.77 bn–$4.09 bn |
| Annual OPEX | $76 M / yr |
| Low/high project NPV at 8% | $-2026439 k / $-1520713 k |
| Low/high project IRR | -2.3% / 1.7% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,674.40 train-km; 94,774.20 kWh consumed; 103,742.51 kWh charged; 25 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 88,944.48 train-km; 1,485,557.35 kWh consumed; 1,514,249.62 kWh charged; 1,026 depot services completed (3 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 73.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 78.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.1% / 60% | pass |
| ten-hour single charging-pad outage | 76.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 143 line platforms, 14 interchange complexes, 45 civil segments, and 0 input findings |
