...
| Bucket | Value |
|---|---|
| At-grade (223.5 km @ $1.2 M/km) | $268 M |
| Elevated (10.4 km @ $5.5 M/km) | $57 M |
| Elevated-interchange premium (9 sites @ $2.5 M) | $22 M |
| **Civil subtotal** | **$348 M** |
...
|---|---|---|
| Construction (years 1–7) | **$74 M / yr** | $24 |
| Steady-state, low-ridership (year 8+) | **$58 M / yr** | $19 |
| Steady-state, high-ridership (year 8+) | **$30 M / yr** | $10 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.84 bn cumulative** | $605 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.21 bn cumulative** | $399 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$515 M cumulative** | $170 |

_Population basis: 3,037,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $516 M | 3.8% | 30 y, 7 y grace | $34 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $215 M | 16.5% | 30 y, 7 y grace | $37 M / yr |
| Government equity (no debt service) | 15% | $129 M | — | — | — |
| **Total** | **100%** | **$860 M** | | | **$71 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $20 M / yr + bonds $35 M / yr = **$55 M / yr** total — plus the equity tranche amortised across construction ($18 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 242,960 | 455,550 | 693,082 |
| Daily paid trips / population | 8% | 15% | 23% |
| Annual paid trips | 88.7 M | 166.3 M | 253.0 M |
| Farebox revenue | $31 M / yr | $58 M / yr | $89 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.9 M / yr | $4.9 M / yr | $4.9 M / yr |
| **Total revenue** | **$39 M / yr** | **$66 M / yr** | **$97 M / yr** |
| Revenue / OPEX + debt-service recovery | 40% | 69% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $58 M / yr | $30 M / yr | **$0 / yr** |
