...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$4.35 bn (85.0%) of external capital** and **$5.45 bn of external interest**. Capital plus saved interest totals **$9.80 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (263.0 km @ $2.58 M/km) | $680 M |
| Elevated (16.5 km @ $9.75 M/km) | $161 M |
| Elevated-interchange premium (13 sites @ $4.50 M) | $58 M |
| **Civil subtotal** | **$899 M** |
...
| Per-capita (city pop) | $936 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $899 M | 15% | $135 M | $764 M |
...
| EPC / project services | $151 M | 15% | $23 M | $129 M |
| **Total city CAPEX** | **$2.84 bn** | **27.0%** | **$767 M** | **$2.08 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **27.0%** | **$767 M** | **$110 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.0%** | **$2.08 bn** | **$297 M / yr** |
| of which planned local bond issuance | 58.4% of total CAPEX | $1.66 bn | $237 M / yr |
| **Total city programme** | **100.0%** | **$2.84 bn** | **$406 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $3.84 bn | $3.07 bn (80.0%) | $3.85 bn | **$6.92 bn** |
| **Default** | 2.00× | $5.12 bn | $4.35 bn (85.0%) | $5.45 bn | **$9.80 bn** |
| High | 3.00× | $7.68 bn | $6.91 bn (90.0%) | $8.66 bn | **$15.57 bn** |

At the default 2.00× case, OSR's $767 M external requirement is 85.0% below the illustrative foreign-company requirement of $5.12 bn; the associated lifetime external-interest saving is $5.45 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$368 M / yr** | $121 |
| Steady-state, low capacity-use (year 8+) | **$212 M / yr** | $70 |
| Steady-state, high capacity-use (year 8+) | **$110 M / yr** | $36 |
| Steady-state, operating-neutral revenue case | **$321 M / yr** | $106 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.58 bn cumulative** | $3,156 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.20 bn cumulative** | $2,040 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$13.16 bn cumulative** | $4,335 |

_Population basis: 3,037,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $109 M / yr → $211 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 27% | $767 M | 4.5% | 40 y, 7 y grace | $45 M / yr |
| Local-currency sovereign / project bonds for local content | 58% | $1.66 bn | 16.5% | 40 y, 7 y grace | $276 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $415 M | — | — | — |
| **Total** | **100%** | **$2.84 bn** | | | **$321 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $34 M / yr + local bonds $274 M / yr = **$309 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($59 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 366.6 M | 586.6 M | 134.1 M |
| Annual paid trips / city resident | 121 | 193 | 44 |
| Farebox revenue | $171 M / yr | $274 M / yr | $63 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$177 M / yr** | **$280 M / yr** | **$69 M / yr** |
| Revenue / OPEX recovery | 258% | 407% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gross repayable-debt service + residual OPEX subsidy | $321 M / yr | $321 M / yr | **$321 M / yr** |
| Operating surplus applied to debt support | -$109 M / yr | -$211 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $212 M / yr | $110 M / yr | **$321 M / yr** |
| Operating surplus after OPEX (before debt support) | $109 M / yr | $211 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.08 bn | 73% of $2.84 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.32 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $475 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 247,180 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.31 bn |
| Timetable-sized dedicated solar CAPEX | $532 M |
| **Reconciled project CAPEX** | **$2.84 bn** |
| Imported / external-capital requirement | $767 M (27.0%) |
| Local-content / local-funding requirement | $2.08 bn (73.0%) |
| Default foreign-turnkey external-capital comparison | $5.12 bn; OSR saves $4.35 bn (85.0%) |
| Lifetime external interest and combined financing saving | $5.45 bn interest; $9.80 bn capital + interest |
| 15%–25% planning risk envelope | $3.27 bn–$3.55 bn |
| Annual OPEX | $69 M / yr |
| Low/high project NPV at 8% | $-1385478 k / $-695853 k |
