...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 192 | $8.40 M | $1.61 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1152 | $100 k | $115 M |
| High sensitivity check | 1152 | $200 k | $230 M |
...
| Stations | $564 M |
| Depots | $30 M |
| Rolling stock | $1.61 bn |
| Railway production plant | $115 M |
...
|---|---|---|
| Construction (years 1–7) | **$295 M / yr** | $97 |
| Steady-state, low-ridership (year 8+) | **$349 M / yr** | $115 |
| Steady-state, high-ridership (year 8+) | **$334 M / yr** | $110 |
| Steady-state, operating-neutral revenue case | **$283 M / yr** | $93 |
| Lifecycle envelope (yr 1–30, low scenario) | **$10.10 bn cumulative** | $3,324 |
| Lifecycle envelope (yr 1–30, high scenario) | **$9.73 bn cumulative** | $3,205 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$8.57 bn cumulative** | $2,823 |

_Population basis: 3,037,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $66 M / yr → $50 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $2.07 bn | 3.8% | 30 y, 7 y grace | $136 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $862 M | 16.5% | 30 y, 7 y grace | $147 M / yr |
| Government equity (no debt service) | 15% | $517 M | — | — | — |
| **Total** | **100%** | **$3.45 bn** | | | **$283 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $79 M / yr + bonds $142 M / yr = **$221 M / yr** total — plus the equity tranche amortised across construction ($74 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 184,771 | 307,951 | 702,905 |
| Daily paid trips / catchment | 18% | 30% | 68% |
| Daily paid trips / city population | 6% | 10% | 23% |
| Annual paid trips | 67.4 M | 112.4 M | 256.6 M |
| Farebox revenue | $24 M / yr | $39 M / yr | $90 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.9 M / yr | $4.9 M / yr | $4.9 M / yr |
| **Total revenue** | **$32 M / yr** | **$47 M / yr** | **$98 M / yr** |
| Revenue / OPEX recovery | 32% | 48% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $349 M / yr | $334 M / yr | **$283 M / yr** |
