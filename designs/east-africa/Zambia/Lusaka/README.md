...
|---|---|---|
| Construction (years 1–7) | **$130 M / yr** | $43 |
| Steady-state, low-ridership (year 8+) | **$131 M / yr** | $43 |
| Steady-state, high-ridership (year 8+) | **$125 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$125 M / yr** | $41 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.93 bn cumulative** | $1,295 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.79 bn cumulative** | $1,247 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.79 bn cumulative** | $1,247 |

_Population basis: 3,037,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.4 M / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $381 M | 16.5% | 30 y, 7 y grace | $65 M / yr |
| Government equity (no debt service) | 15% | $228 M | — | — | — |
| **Total** | **100%** | **$1.52 bn** | | | **$125 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $35 M / yr + bonds $63 M / yr = **$98 M / yr** total — plus the equity tranche amortised across construction ($33 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 184,771 | 307,951 | 234,906 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 6% | 10% | 8% |
| Annual paid trips | 67.4 M | 112.4 M | 85.7 M |
...
| **Total revenue** | **$32 M / yr** | **$47 M / yr** | **$38 M / yr** |
| Revenue / OPEX recovery | 83% | 125% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $131 M / yr | $125 M / yr | **$125 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $9.3 M / yr | $0 / yr |
