...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **256,626 – 461,927 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$113 M / yr** | $37 |
| Steady-state, low-ridership (year 8+) | **$184 M / yr** | $61 |
| Steady-state, high-ridership (year 8+) | **$150 M / yr** | $49 |
| Steady-state, operating-neutral revenue case | **$97 M / yr** | $32 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.88 bn cumulative** | $2,264 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.72 bn cumulative** | $1,884 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.98 bn cumulative** | $1,311 |

_Population basis: 3,037,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $88 M / yr → $53 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $1.86 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $2.32 bn | 2.0% | 40 y, 7 y grace | $97 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 16.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $464 M | — | — | — |
| **Total** | **100%** | **$4.64 bn** | | | **$97 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $46 M / yr + fallback bonds $0 k / yr = **$46 M / yr** total. The $1.86 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($66 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (1338.8 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,426 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $4.2 M |
| **OPEX subtotal** | | **$140 M / yr** |

_Annual fleet utilisation: 284 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 55.8 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 256,626 | 461,927 | 771,781 |
| Daily paid trips / catchment | 25% | 45% | 75% |
| Daily paid trips / city population | 8% | 15% | 25% |
| Annual paid trips | 93.7 M | 168.6 M | 281.7 M |
| Farebox revenue | $44 M / yr | $79 M / yr | $131 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.9 M / yr | $4.9 M / yr | $4.9 M / yr |
| **Total revenue** | **$52 M / yr** | **$87 M / yr** | **$140 M / yr** |
| Revenue / OPEX recovery | 37% | 62% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov repayable-debt service + residual OPEX subsidy | $184 M / yr | $150 M / yr | **$97 M / yr** |
