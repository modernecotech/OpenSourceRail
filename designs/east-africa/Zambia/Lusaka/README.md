...
|---|---|---|
| Construction (years 1–7) | **$165 M / yr** | $54 |
| Steady-state, low-ridership (year 8+) | **$172 M / yr** | $57 |
| Steady-state, high-ridership (year 8+) | **$158 M / yr** | $52 |
| Steady-state, operating-neutral revenue case | **$158 M / yr** | $52 |
| Lifecycle envelope (yr 1–30, low scenario) | **$5.11 bn cumulative** | $1,684 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.79 bn cumulative** | $1,578 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.79 bn cumulative** | $1,578 |

_Population basis: 3,037,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.16 bn | 3.8% | 30 y, 7 y grace | $76 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $482 M | 16.5% | 30 y, 7 y grace | $82 M / yr |
| Government equity (no debt service) | 15% | $289 M | — | — | — |
| **Total** | **100%** | **$1.93 bn** | | | **$158 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $44 M / yr + bonds $79 M / yr = **$123 M / yr** total — plus the equity tranche amortised across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
