...
| Bucket | Value |
|---|---|
| At-grade (70.7 km @ $0.85 M/km) | $60 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 72.7 km × $0.015 M/km | $1.1 M |
...
| Per-capita (city pop) | $252 / person |
...
|---|---|---|
| Construction (years 1–7) | **$12 M / yr** | $17 |
| Steady-state, low-ridership (year 8+) | **$8.3 M / yr** | $12 |
| Steady-state, high-ridership (year 8+) | **$2.4 M / yr** | $3 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$275 M cumulative** | $393 |
| Lifecycle envelope (yr 1–30, high scenario) | **$140 M cumulative** | $199 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$84 M cumulative** | $120 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $106 M | 3.8% | 30 y, 7 y grace | $7.0 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $44 M | 9.5% | 30 y, 7 y grace | $4.8 M / yr |
| Government equity (no debt service) | 15% | $26 M | — | — | — |
| **Total** | **100%** | **$176 M** | | | **$12 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.0 M / yr + bonds $4.2 M / yr = **$8.2 M / yr** total — plus the equity tranche amortised across construction ($3.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,000 | 105,000 | 125,103 |
| Daily paid trips / population | 8% | 15% | 18% |
| Annual paid trips | 20.4 M | 38.3 M | 45.7 M |
| Farebox revenue | $6.7 M / yr | $13 M / yr | $15 M / yr |
| Station shop leases | $837 k / yr | $837 k / yr | $837 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$9.0 M / yr** | **$15 M / yr** | **$17 M / yr** |
| Revenue / OPEX + debt-service recovery | 52% | 86% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $8.3 M / yr | $2.4 M / yr | **$0 / yr** |
