...
|---|---|---|
| Construction (years 1–7) | **$55 M / yr** | $78 |
| Steady-state, low-ridership (year 8+) | **$68 M / yr** | $97 |
| Steady-state, high-ridership (year 8+) | **$64 M / yr** | $91 |
| Steady-state, operating-neutral revenue case | **$54 M / yr** | $77 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.94 bn cumulative** | $2,772 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.86 bn cumulative** | $2,651 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.62 bn cumulative** | $2,314 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $10 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $483 M | 3.8% | 30 y, 7 y grace | $32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $201 M | 9.5% | 30 y, 7 y grace | $22 M / yr |
| Government equity (no debt service) | 15% | $121 M | — | — | — |
| **Total** | **100%** | **$806 M** | | | **$54 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $18 M / yr + bonds $19 M / yr = **$38 M / yr** total — plus the equity tranche amortised across construction ($17 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 45,864 | 76,440 | 161,675 |
| Daily paid trips / catchment | 18% | 30% | 63% |
| Daily paid trips / city population | 7% | 11% | 23% |
| Annual paid trips | 16.7 M | 27.9 M | 59.0 M |
| Farebox revenue | $5.5 M / yr | $9.2 M / yr | $19 M / yr |
| Station shop leases | $837 k / yr | $837 k / yr | $837 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$7.7 M / yr** | **$11 M / yr** | **$22 M / yr** |
| Revenue / OPEX recovery | 36% | 53% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $68 M / yr | $64 M / yr | **$54 M / yr** |
