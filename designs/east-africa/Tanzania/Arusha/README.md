...
| Per-capita (city pop) | $1,454 / person |
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $35 |
| Steady-state, low-ridership (year 8+) | **$38 M / yr** | $54 |
| Steady-state, high-ridership (year 8+) | **$30 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.42 bn cumulative** | $2,031 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.15 bn cumulative** | $1,645 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$873 M cumulative** | $1,247 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $17 M / yr → $8.5 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $407 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $509 M | 2.0% | 40 y, 7 y grace | $21 M / yr |
...
_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $10 M / yr + fallback bonds $0 k / yr = **$10 M / yr** total. The $407 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($15 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 63,700 | 114,660 | 167,284 |
| Daily paid trips / catchment | 25% | 45% | 66% |
| Daily paid trips / city population | 9% | 16% | 24% |
| Annual paid trips | 23.3 M | 41.9 M | 61.1 M |
| Farebox revenue | $10 M / yr | $18 M / yr | $27 M / yr |
...
| Gov repayable-debt service + residual OPEX subsidy | $38 M / yr | $30 M / yr | **$21 M / yr** |
