...
|---|---|---|---|---|
| line-1 | 18.7 km | 14 | 45 | NW Mid ↔ SE Mid |
| line-2 | 20.0 km | 13 | 50 | SW Mid ↔ E Outer |
| line-3 | 25.1 km | 12 | 64 | S Mid ↔ NW Outer |
| **Total** | **63.9 km** | **39 unique** | **159** | |
...
| Total fleet capacity | 57,240 AW2 pax (76,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 143 × 360 = **51,480 AW2 passengers** (68,640 AW3 crush)
- **Total fleet passenger capacity:** 159 × 360 = **57,240 AW2 passengers** (76,320 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **50.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 101 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 50.3 MW / 327 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 156 kWh | 245 kWh | 73 kWh | 2.0 km / 17 kWh |
| line-2 | 12 | 167 kWh | 253 kWh | 69 kWh | 4.0 km / 34 kWh |
| line-3 | 10 | 210 kWh | 290 kWh | 59 kWh | 9.1 km / 76 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 159 | $900 k | $143 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 477 | $60 k | $29 M |
| High sensitivity check | 477 | $120 k | $57 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 50,289 kW @ $700/kW | $35 M |
| Grid interconnection / PPA tie-in | 50,289 kW @ $100/kW | $5.0 M |
| Annual generation proxy | 50.3 MW × 6.5 peak-sun-h/day × 365 d/yr | 119.3 GWh/yr |
...
| Steady-state, low capacity-use (year 8+) | **$12 M / yr** | $17 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$678 M cumulative** | $969 |
| Lifecycle envelope (yr 1–40, high scenario) | **$293 M cumulative** | $419 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.30 bn cumulative** | $1,855 |

_Population basis: 700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $19 M / yr → $30 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $519 M | 4.5% | 40 y, 7 y grace | $30 M / yr |
| Government equity (no debt service) | 20% | $130 M | — | — | — |
| **Total** | **100%** | **$648 M** | | | **$30 M / yr** |
...
| Traction energy (140.5 GWh / yr) | 29,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 36.8 GWh/yr + dedicated solar plant 50.3 MW / 119.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $603 k |
| Labour (444 FTE) | driverless roster: OCC/remote 94, station/platform 133, passenger service 49, fleet maintenance 87, infrastructure/energy 60, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 29,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.7 M train-km / yr (35.1 M car-km / yr). On-site PV covers 36.8 GWh/yr and the dedicated solar plant adds 119.3 GWh/yr against 140.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 159 trainsets, 39 stations, 63.9 route-km, 3 lines, and 29,706 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 105 | 168 | 44 |
| Farebox revenue | $32 M / yr | $52 M / yr | $13 M / yr |
| Station shop leases | $779 k / yr | $779 k / yr | $779 k / yr |
...
| Operating surplus applied to debt support | -$19 M / yr | -$30 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $0 k / yr | **$30 M / yr** |
| Operating surplus after OPEX (before debt support) | $19 M / yr | $38 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,592 m² of station shop/kiosk leases at $13/m²/month and 1,080 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 10,994 trips/school day; 2.4 M access-events/yr | 17,590 trips/school day; 3.9 M access-events/yr |
| Healthcare | 6 healthcare anchors | 16,655 trips/day; 6.1 M access-events/yr | 26,648 trips/day; 9.7 M access-events/yr |
| Commerce | 17 major/terminal/interchange nodes | 41,335 trips/trading day; 13.6 M access-events/yr | 66,136 trips/trading day; 21.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $367 M | 57% of $648 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $587 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $84 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 46,315 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $608 M |
| Timetable-sized dedicated solar CAPEX | $40 M |
| **Reconciled project CAPEX** | **$648 M** |
| 15%–25% planning risk envelope | $746 M–$810 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-355894 k / $-225850 k |
| Low/high project IRR | -0.2% / 3.7% |
| Low/high steady-state DSCR | 0.62 / 1.25 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,325.97 train-km; 19,424.27 kWh consumed; 19,209.74 kWh charged; 23 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 30,383.98 train-km; 253,742.17 kWh consumed; 250,639.15 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 176 SoC warnings; 6 energy-adapted off-peak departures, maximum 14 min headway |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 1 interchange complexes, 31 civil segments, and 0 input findings |
