...
| Steady-state, low-ridership (year 8+) | **$24 M / yr** | $49 |
| Steady-state, high-ridership (year 8+) | **$24 M / yr** | $48 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $48 |
| Lifecycle envelope (yr 1–30, low scenario) | **$733 M cumulative** | $1,467 |
| Lifecycle envelope (yr 1–30, high scenario) | **$730 M cumulative** | $1,460 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$730 M cumulative** | $1,460 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $140 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $91 M | 9.5% | 30 y, 7 y grace | $9.8 M / yr |
| Government equity (no debt service) | 15% | $54 M | — | — | — |
| **Total** | **100%** | **$363 M** | | | **$24 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.3 M / yr + bonds $8.6 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($7.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
