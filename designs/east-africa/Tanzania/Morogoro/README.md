...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$832 M (86.8%) of external capital** and **$1.04 bn of external interest**. Capital plus saved interest totals **$1.88 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Elevated (6.9 km @ $9.75 M/km) | $67 M |
...
|---|---:|---:|---:|---:|
| Civil works | $201 M | 15% | $30 M | $171 M |
...
| **Total city CAPEX** | **$533 M** | **23.7%** | **$126 M** | **$406 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$126 M** | **$18 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$406 M** | **$58 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $325 M | $46 M / yr |
| **Total city programme** | **100.0%** | **$533 M** | **$76 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $719 M | $593 M (82.5%) | $743 M | **$1.34 bn** |
| **Default** | 2.00× | $959 M | $832 M (86.8%) | $1.04 bn | **$1.88 bn** |
| High | 3.00× | $1.44 bn | $1.31 bn (91.2%) | $1.64 bn | **$2.96 bn** |

At the default 2.00× case, OSR's $126 M external requirement is 86.8% below the illustrative foreign-company requirement of $959 M; the associated lifetime external-interest saving is $1.04 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$48 M / yr** | $96 |
| Steady-state, low capacity-use (year 8+) | **$19 M / yr** | $38 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $80 |
| Lifecycle envelope (yr 1–40, low scenario) | **$966 M cumulative** | $1,932 |
| Lifecycle envelope (yr 1–40, high scenario) | **$337 M cumulative** | $674 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.65 bn cumulative** | $3,309 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $126 M | 4.5% | 40 y, 7 y grace | $7.4 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $325 M | 9.5% | 40 y, 7 y grace | $33 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $81 M | — | — | — |
| **Total** | **100%** | **$533 M** | | | **$40 M / yr** |
...
| Revenue / OPEX recovery | 261% | 410% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $19 M / yr | $0 k / yr | **$40 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $406 M | 76% of $533 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 51,320 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $480 M |
| Timetable-sized dedicated solar CAPEX | $53 M |
| **Reconciled project CAPEX** | **$533 M** |
| Imported / external-capital requirement | $126 M (23.7%) |
| Local-content / local-funding requirement | $406 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $959 M; OSR saves $832 M (86.8%) |
| Lifetime external interest and combined financing saving | $1.04 bn interest; $1.88 bn capital + interest |
| 15%–25% planning risk envelope | $612 M–$666 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-255817 k / $-125774 k |
