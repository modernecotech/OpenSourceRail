...
| Steady-state, low-ridership (year 8+) | **$33 M / yr** | $65 |
| Steady-state, high-ridership (year 8+) | **$31 M / yr** | $61 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $61 |
| Lifecycle envelope (yr 1–30, low scenario) | **$969 M cumulative** | $1,938 |
| Lifecycle envelope (yr 1–30, high scenario) | **$924 M cumulative** | $1,849 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$924 M cumulative** | $1,849 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.9 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $276 M | 3.8% | 30 y, 7 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $115 M | 9.5% | 30 y, 7 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$460 M** | | | **$31 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $11 M / yr = **$21 M / yr** total — plus the equity tranche amortised across construction ($9.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 54,630 | 91,050 | 70,789 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 11% | 18% | 14% |
| Annual paid trips | 19.9 M | 33.2 M | 25.8 M |
| Farebox revenue | $6.6 M / yr | $11 M / yr | $8.5 M / yr |
| Station shop leases | $649 k / yr | $649 k / yr | $649 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$8.3 M / yr** | **$13 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 81% | 124% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $33 M / yr | $31 M / yr | **$31 M / yr** |
