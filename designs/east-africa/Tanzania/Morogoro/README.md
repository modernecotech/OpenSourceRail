...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$895 M (87.2%) of external capital** and **$1.12 bn of external interest**. Capital plus saved interest totals **$2.02 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 55.1 km |
...
- Anchor-weighted coverage: 61.0%
- Catchment population: **≈ 305,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **66.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 487 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 57 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 25,600 train-km/day | One-way train journeys × route length |
| Annual service work | 10.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 332 MWh/day | 30.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 276 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 66.1 MW / 318 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 165 kWh | 261 kWh | 80 kWh | 7.0 km / 53 kWh |
| line-2 | 7 | 121 kWh | 200 kWh | 67 kWh | 5.0 km / 37 kWh |
| line-3 | 8 | 126 kWh | 196 kWh | 57 kWh | 3.6 km / 27 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 66,146 kW @ $700/kW | $46 M |
| Grid interconnection / PPA tie-in | 66,146 kW @ $100/kW | $6.6 M |
| Annual generation proxy | 66.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 115.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 55.1 km × $0.050 M/km | $2.8 M |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh morogoro`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$132 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$439 M** | **$63 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $351 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$571 M** | **$82 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $770 M | $639 M (82.9%) | $800 M | **$1.44 bn** |
| **Default** | 2.00× | $1.03 bn | $895 M (87.2%) | $1.12 bn | **$2.02 bn** |
| High | 3.00× | $1.54 bn | $1.41 bn (91.4%) | $1.77 bn | **$3.17 bn** |

At the default 2.00× case, OSR's $132 M external requirement is 87.2% below the illustrative foreign-company requirement of $1.03 bn; the associated lifetime external-interest saving is $1.12 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, high capacity-use (year 8+) | **$3.3 M / yr** | $7 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $86 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.11 bn cumulative** | $2,223 |
| Lifecycle envelope (yr 1–40, high scenario) | **$473 M cumulative** | $945 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.78 bn cumulative** | $3,554 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $20 M / yr → $40 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $132 M | 4.5% | 40 y, 7 y grace | $7.7 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $351 M | 9.5% | 40 y, 7 y grace | $35 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $88 M | — | — | — |
| **Total** | **100%** | **$571 M** | | | **$43 M / yr** |
...
| Traction energy (121.1 GWh / yr) | 25,600 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 66.1 MW / 115.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $794 k |
| Labour (367 FTE) | driverless roster: OCC/remote 77, station/platform 101, passenger service 49, fleet maintenance 70, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 25,600 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.1 M train-km / yr (30.3 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 115.9 GWh/yr against 121.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 120 trainsets, 24 stations, 55.1 route-km, 3 lines, and 25,600 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 27.5 M |
...
| Advertising boards | $971 k / yr | $971 k / yr | $971 k / yr |
| **Total revenue** | **$34 M / yr** | **$53 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 247% | 389% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $43 M / yr | $43 M / yr | **$43 M / yr** |
| Operating surplus applied to debt support | -$20 M / yr | -$40 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $3.3 M / yr | **$43 M / yr** |
| Operating surplus after OPEX (before debt support) | $20 M / yr | $40 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,384 m² of station shop/kiosk leases at $13/m²/month and 824 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $15 M / yr | $23 M / yr | 182 M - 291 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.6 M / yr | $4.2 M / yr | 32.7–52.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 14,711 trips/school day; 3.2 M access-events/yr | 23,537 trips/school day; 5.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $439 M | 77% of $571 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 55,408 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $518 M |
| Timetable-sized dedicated solar CAPEX | $53 M |
| **Reconciled project CAPEX** | **$571 M** |
| Imported / external-capital requirement | $132 M (23.1%) |
| Local-content / local-funding requirement | $439 M (76.9%) |
| Default foreign-turnkey external-capital comparison | $1.03 bn; OSR saves $895 M (87.2%) |
| Lifetime external interest and combined financing saving | $1.12 bn interest; $2.02 bn capital + interest |
| 15%–25% planning risk envelope | $656 M–$713 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-288931 k / $-158887 k |
| Low/high project IRR | 0.8% / 4.7% |
| Low/high steady-state DSCR | 0.47 / 0.92 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,114.24 train-km; 15,831.24 kWh consumed; 14,999.11 kWh charged; 28 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,852.39 train-km; 193,580.43 kWh consumed; 191,404.81 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 16 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 99.1% / 90% | pass |
...
|---|---|
| ![Morogoro energy and battery simulation dashboard](engineering/screenshots/morogoro-simulation-dashboard.png) | ![Morogoro simulator network visualizer](engineering/screenshots/morogoro-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 2 interchange complexes, 36 civil segments, and 0 input findings |
...
|---|---|
| ![Morogoro QGIS engineering layers](engineering/screenshots/morogoro-qgis-engineering-map.png) | ![Morogoro SUMO timetable validation](engineering/screenshots/morogoro-sumo-validation.png) |
...
scripts/regenerate-city.sh morogoro
```
