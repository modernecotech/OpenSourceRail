...
| Revenue fleet | 123 × 3-car trainsets |
| Revenue fleet passenger capacity | 44,280 AW2 pax (59,040 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 22.1 km | 13 | 53 | E Outer ↔ NW Mid |
| line-2 | 16.2 km | 11 | 38 | SW Outer ↔ NE Mid |
| line-3 | 16.8 km | 9 | 46 | S Outer ↔ NW Mid |
| **Total** | **55.1 km** | **33 unique** | **137** | |
...
| Revenue fleet capacity | 44,280 AW2 pax (59,040 AW3 crush) |
| Total fleet capacity | 49,320 AW2 pax (65,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 123 × 360 = **44,280 AW2 passengers** (59,040 AW3 crush)
- **Total fleet passenger capacity:** 137 × 360 = **49,320 AW2 passengers** (65,760 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 14.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 503 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 63 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 165 kWh | 261 kWh | 80 kWh | 5.0 km / 37 kWh |
| line-2 | 11 | 121 kWh | 196 kWh | 63 kWh | 2.0 km / 15 kWh |
| line-3 | 9 | 126 kWh | 220 kWh | 82 kWh | 2.4 km / 18 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (48.2 km @ $3.0 M/km) | $145 M |
| Elevated (6.8 km @ $12.0 M/km) | $82 M |
...
| `interchange-elevated` | 9 | $12.0 M | $108 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 137 | $900 k | $123 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 411 | $60 k | $25 M |
| High sensitivity check | 411 | $120 k | $49 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 63,041 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 63,041 kW @ $100/kW | $6.3 M |
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $87 |
| Steady-state, low capacity-use (year 8+) | **$13 M / yr** | $26 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$725 M cumulative** | $1,450 |
| Lifecycle envelope (yr 1–40, high scenario) | **$304 M cumulative** | $609 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $2,698 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $19 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $539 M | 4.5% | 40 y, 7 y grace | $32 M / yr |
| Government equity (no debt service) | 20% | $135 M | — | — | — |
| **Total** | **100%** | **$673 M** | | | **$32 M / yr** |
...
| Traction energy (121.1 GWh / yr) | 25,600 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.1 GWh/yr + dedicated solar plant 63.0 MW / 110.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $756 k |
| Labour (424 FTE) | driverless roster: OCC/remote 86, station/platform 141, passenger service 49, fleet maintenance 75, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 25,600 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.1 M train-km / yr (30.3 M car-km / yr). On-site PV covers 25.1 GWh/yr and the dedicated solar plant adds 110.4 GWh/yr against 121.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 137 trainsets, 33 stations, 55.1 route-km, 3 lines, and 25,600 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 30.4 M |
| Annual paid trips / city resident | 147 | 235 | 61 |
| Farebox revenue | $32 M / yr | $52 M / yr | $13 M / yr |
| Station shop leases | $858 k / yr | $858 k / yr | $858 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$34 M / yr** | **$54 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 221% | 346% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $32 M / yr | $32 M / yr | **$32 M / yr** |
| Operating surplus applied to debt support | -$19 M / yr | -$32 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $13 M / yr | $0 k / yr | **$32 M / yr** |
| Operating surplus after OPEX (before debt support) | $19 M / yr | $38 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,152 m² of station shop/kiosk leases at $13/m²/month and 1,140 advertising boards at $115/board/month, with occupancy derates applied._
...
| Commerce | 18 major/terminal/interchange nodes | 43,646 trips/trading day; 14.4 M access-events/yr | 69,833 trips/trading day; 23.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $382 M | 57% of $673 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $612 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $87 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 48,265 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$673 M** |
| 15%–25% planning risk envelope | $775 M–$842 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-373933 k / $-243889 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,104.35 train-km; 15,757.17 kWh consumed; 16,610.96 kWh charged; 27 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,434.83 train-km; 197,941.72 kWh consumed; 201,924.38 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 63%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 55.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 63.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.5% / 60% | pass |
| ten-hour single charging-pad outage | 49.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 33 line platforms, 2 interchange complexes, 34 civil segments, and 0 input findings |
