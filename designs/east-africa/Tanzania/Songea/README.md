...
| Bucket | Value |
|---|---|
| At-grade (11.4 km @ €3.5 M/km) | €40 M |
| **Civil subtotal** | **€40 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 16 | €2.0 M | €32 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 11.4 km × €0.015 M/km | €0.2 M |
...
| Steady-state, low-ridership (year 8+) | **€11 M / yr** | €42 |
| Steady-state, high-ridership (year 8+) | **€9.4 M / yr** | €38 |
| Lifecycle envelope (yr 1–30, low scenario) | **€303 M cumulative** | €1,213 |
| Lifecycle envelope (yr 1–30, high scenario) | **€277 M cumulative** | €1,107 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€2.0 M / yr (low) → €873 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €77 M | 3.8% | 30 y, 7 y grace | €5.1 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €32 M | 9.5% | 30 y, 7 y grace | €3.5 M / yr |
| Government equity (no debt service) | 15% | €19 M | — | — | — |
| **Total** | **100%** | **€128 M** | | | **€8.5 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €2.9 M / yr + bonds €3.0 M / yr = **€5.9 M / yr** total — plus the equity tranche amortised across construction (€2.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (80 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €204 k |
...
| Operating shortfall (gov subsidy required) | €2.0 M / yr | €873 k / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€11 M / yr** | **€9.4 M / yr** |
