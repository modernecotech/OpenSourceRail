...
| Revenue fleet passenger capacity | 5,520 AW2 pax (7,360 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 11.4 km | 7 | 26 | E Mid ↔ W Outer |
| **Total** | **11.4 km** | **7 unique** | **26** | |
...
| Revenue fleet capacity | 5,520 AW2 pax (7,360 AW3 crush) |
| Total fleet capacity | 6,240 AW2 pax (8,320 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 23 × 240 = **5,520 AW2 passengers** (7,360 AW3 crush)
- **Total fleet passenger capacity:** 26 × 240 = **6,240 AW2 passengers** (8,320 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **3.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 35 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 50 MWh/day | 5,781 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 15 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 3.4 MW / 17 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 26 | $2.80 M | $73 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 52 | $100 k | $5.2 M |
| High sensitivity check | 52 | $200 k | $10 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 3,438 kW @ $700/kW | $2.4 M |
| Grid interconnection / PPA tie-in | 3,438 kW @ $100/kW | $344 k |
| Annual generation proxy | 3.4 MW × 5.0 peak-sun-h/day × 365 d/yr | 6.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$2.8 M** |
...
| Depots | $14 M |
| Rolling stock | $73 M |
| Railway production plant | $5.2 M |
| Dedicated solar power plant | $2.8 M |
| Residual train-control wayside + charging microgrids | $3.8 M |
| EPC overhead (7%) | $11 M |
| **CAPEX total** | **$170 M** |
| Per-route-km | $15 M / km |
| Per-capita (city pop) | $680 / person |
...
|---|---|---|
| Construction (years 1–7) | **$7.6 M / yr** | $30 |
| Steady-state, low capacity-use (year 8+) | **$3.9 M / yr** | $16 |
| Steady-state, high capacity-use (year 8+) | **$225 k / yr** | $1 |
| Steady-state, operating-neutral revenue case | **$5.7 M / yr** | $23 |
| Lifecycle envelope (yr 1–40, low scenario) | **$183 M cumulative** | $730 |
| Lifecycle envelope (yr 1–40, high scenario) | **$60 M cumulative** | $242 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$240 M cumulative** | $960 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $1.7 M / yr → $5.4 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $136 M | 2.0% | 40 y, 7 y grace | $5.7 M / yr |
| Government equity (no debt service) | 20% | $34 M | — | — | — |
| **Total** | **100%** | **$170 M** | | | **$5.7 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $2.7 M / yr = **$2.7 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($4.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (18.2 GWh / yr) | 5,781 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 12.8 GWh/yr + dedicated solar plant 3.4 MW / 6.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $41 k |
| Labour (117 FTE) | driverless roster: OCC/remote 25, station/platform 26, passenger service 12, fleet maintenance 16, infrastructure/energy 18, admin/training 20; no train drivers × country median × 12 × engineer-premium 1.4 | $324 k |
| **OPEX subtotal** | | **$4.8 M / yr** |

_Annual service work: 5,781 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.3 M train-km / yr (4.6 M car-km / yr). On-site PV covers 12.8 GWh/yr and the dedicated solar plant adds 6.3 GWh/yr against 18.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 14.0 M | 22.4 M | 10.1 M |
| Annual paid trips / city resident | 56 | 90 | 40 |
| Farebox revenue | $6.2 M / yr | $9.9 M / yr | $4.4 M / yr |
| Station shop leases | $138 k / yr | $138 k / yr | $138 k / yr |
| Advertising boards | $231 k / yr | $231 k / yr | $231 k / yr |
| **Total revenue** | **$6.5 M / yr** | **$10 M / yr** | **$4.8 M / yr** |
| Revenue / OPEX recovery | 136% | 213% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $5.7 M / yr | $5.7 M / yr | **$5.7 M / yr** |
| Operating surplus applied to debt support | -$1.7 M / yr | -$5.4 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.9 M / yr | $225 k / yr | **$5.7 M / yr** |
| Operating surplus after OPEX (before debt support) | $1.7 M / yr | $5.4 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $1.8 M / yr | $2.8 M / yr | 16 min/trip × $0.48/h value-of-time proxy |
| Avoided road congestion | $1.7 M / yr | $2.8 M / yr | 22 M - 35 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $311 k / yr | $497 k / yr | 3.9–6.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $863 k / yr | $1.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $4.9 M / yr | $7.9 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $2.2 M / yr | $3.6 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$12 M / yr** | **$19 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 0 healthcare anchors | 2,304 trips/day; 0.8 M access-events/yr | 3,686 trips/day; 1.3 M access-events/yr |
| Commerce | 5 major/terminal/interchange nodes | 9,024 trips/trading day; 3.0 M access-events/yr | 14,438 trips/trading day; 4.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $91 M | 54% of $170 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $146 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $21 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 11,546 job-years | retained CAPEX ÷ (4.0 × median annual income) |
