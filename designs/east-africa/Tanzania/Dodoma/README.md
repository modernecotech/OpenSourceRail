...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **81,000 – 145,800 trips/day**
...
| Per-capita (city pop) | $1,174 / person |
...
|---|---|---|
| Construction (years 1–7) | **$23 M / yr** | $29 |
| Steady-state, low-ridership (year 8+) | **$31 M / yr** | $39 |
| Steady-state, high-ridership (year 8+) | **$21 M / yr** | $26 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $24 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.20 bn cumulative** | $1,498 |
| Lifecycle envelope (yr 1–40, high scenario) | **$855 M cumulative** | $1,069 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$805 M cumulative** | $1,007 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $1.5 M / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $469 M | 2.0% | 40 y, 7 y grace | $20 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 9.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $94 M | — | — | — |
| **Total** | **100%** | **$939 M** | | | **$20 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $9.4 M / yr + fallback bonds $0 k / yr = **$9.4 M / yr** total. The $376 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (191.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (410 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$27 M / yr** |

_Annual fleet utilisation: 95 revenue trainsets × 20.5 h/day × 365 d/yr × 30 km/h commercial × 75% revenue factor = 16.0 M train-km / yr (~168 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 81,000 | 145,800 | 155,146 |
| Daily paid trips / catchment | 25% | 45% | 48% |
| Daily paid trips / city population | 10% | 18% | 19% |
| Annual paid trips | 29.6 M | 53.2 M | 56.6 M |
...
| **Total revenue** | **$15 M / yr** | **$25 M / yr** | **$27 M / yr** |
| Revenue / OPEX recovery | 56% | 94% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov repayable-debt service + residual OPEX subsidy | $31 M / yr | $21 M / yr | **$20 M / yr** |
