...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 66.3 km × $0.015 M/km | $3.3 M |
...
| Steady-state, low-ridership (year 8+) | **$25 M / yr** | $32 |
| Steady-state, high-ridership (year 8+) | **$25 M / yr** | $32 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $32 |
| Lifecycle envelope (yr 1–30, low scenario) | **$764 M cumulative** | $955 |
| Lifecycle envelope (yr 1–30, high scenario) | **$760 M cumulative** | $950 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$760 M cumulative** | $950 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $194 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $227 M | 3.8% | 30 y, 7 y grace | $15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $94 M | 9.5% | 30 y, 7 y grace | $10 M / yr |
| Government equity (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$378 M** | | | **$25 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.6 M / yr + bonds $9.0 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($8.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
