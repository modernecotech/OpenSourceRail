...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$685 M (86.9%) of external capital** and **$858 M of external interest**. Capital plus saved interest totals **$1.54 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 52.2 km |
...
- Anchor-weighted coverage: 58.1%
- Catchment population: **≈ 464,799** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **43.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 481 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 39 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 24,262 train-km/day | One-way train journeys × route length |
| Annual service work | 9.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 314 MWh/day | 28.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 243 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 43.0 MW / 279 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 138 kWh | 196 kWh | 45 kWh | 3.5 km / 29 kWh |
| line-2 | 7 | 147 kWh | 200 kWh | 39 kWh | 6.9 km / 58 kWh |
| line-3 | 6 | 151 kWh | 220 kWh | 54 kWh | 7.0 km / 59 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (50.4 km @ $3.0 M/km) | $151 M |
| Elevated (1.7 km @ $12.0 M/km) | $21 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,982 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,982 kW @ $100/kW | $4.3 M |
| Annual generation proxy | 43.0 MW × 6.5 peak-sun-h/day × 365 d/yr | 102.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 52.2 km × $0.050 M/km | $2.6 M |
...
|---|---:|---:|---:|---:|
| Civil works | $172 M | 15% | $26 M | $146 M |
...
| **Total city CAPEX** | **$438 M** | **23.6%** | **$103 M** | **$335 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh dodoma`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$103 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$335 M** | **$48 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $268 M | $38 M / yr |
| **Total city programme** | **100.0%** | **$438 M** | **$63 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $591 M | $488 M (82.6%) | $611 M | **$1.10 bn** |
| **Default** | 2.00× | $788 M | $685 M (86.9%) | $858 M | **$1.54 bn** |
| High | 3.00× | $1.18 bn | $1.08 bn (91.3%) | $1.35 bn | **$2.43 bn** |

At the default 2.00× case, OSR's $103 M external requirement is 86.9% below the illustrative foreign-company requirement of $788 M; the associated lifetime external-interest saving is $858 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$10 M / yr** | $13 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$619 M cumulative** | $773 |
| Lifecycle envelope (yr 1–40, high scenario) | **$277 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.36 bn cumulative** | $1,700 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $103 M | 4.5% | 40 y, 7 y grace | $6.1 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $268 M | 9.5% | 40 y, 7 y grace | $27 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$438 M** | | | **$33 M / yr** |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $130 k |
| Traction energy (114.8 GWh / yr) | 24,262 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 43.0 MW / 102.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $516 k |
| Labour (340 FTE) | driverless roster: OCC/remote 73, station/platform 85, passenger service 49, fleet maintenance 66, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $942 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 24,262 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.6 M train-km / yr (28.7 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 102.0 GWh/yr against 114.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 113 trainsets, 22 stations, 52.2 route-km, 3 lines, and 24,262 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 22.2 M |
| Annual paid trips / city resident | 92 | 147 | 28 |
| Farebox revenue | $32 M / yr | $52 M / yr | $9.8 M / yr |
| Station shop leases | $484 k / yr | $484 k / yr | $484 k / yr |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $10 M / yr | $0 k / yr | **$33 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $42 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,472 m² of station shop/kiosk leases at $13/m²/month and 672 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $22 M / yr | 172 M - 276 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.5 M / yr | $4.0 M / yr | 31.0–49.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $335 M | 76% of $438 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 42,239 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$438 M** |
| Imported / external-capital requirement | $103 M (23.6%) |
| Local-content / local-funding requirement | $335 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $788 M; OSR saves $685 M (86.9%) |
| Lifetime external interest and combined financing saving | $858 M interest; $1.54 bn capital + interest |
| 15%–25% planning risk envelope | $503 M–$547 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-174493 k / $-44449 k |
| Low/high project IRR | 2.8% / 6.9% |
| Low/high steady-state DSCR | 0.68 / 1.27 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,030.12 train-km; 16,953.41 kWh consumed; 15,359.24 kWh charged; 30 depot services completed; minimum SoC 71%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,717.53 train-km; 198,067.72 kWh consumed; 190,968.66 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.8% of scheduled train-km delivered; 115 SoC warnings; 15 energy-adapted off-peak departures, maximum 15 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 96.2% / 90% | pass |
| 50% charging-contact availability | 20.0% | 97.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 85.0% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 97.4% / 90% | pass |
...
|---|---|
| ![Dodoma energy and battery simulation dashboard](engineering/screenshots/dodoma-simulation-dashboard.png) | ![Dodoma simulator network visualizer](engineering/screenshots/dodoma-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 22 civil segments, and 0 input findings |
...
|---|---|
| ![Dodoma QGIS engineering layers](engineering/screenshots/dodoma-qgis-engineering-map.png) | ![Dodoma SUMO timetable validation](engineering/screenshots/dodoma-sumo-validation.png) |
...
scripts/regenerate-city.sh dodoma
```
