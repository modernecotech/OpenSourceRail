...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **58,320 – 97,200 trips/day**
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 66 | $4.20 M | $277 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 198 | $100 k | $20 M |
| High sensitivity check | 198 | $200 k | $40 M |
...
|---|---|---|
| Construction (years 1–7) | **$51 M / yr** | $63 |
| Steady-state, low-ridership (year 8+) | **$61 M / yr** | $76 |
| Steady-state, high-ridership (year 8+) | **$56 M / yr** | $70 |
| Steady-state, operating-neutral revenue case | **$50 M / yr** | $62 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.76 bn cumulative** | $2,196 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.65 bn cumulative** | $2,062 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.50 bn cumulative** | $1,875 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $11 M / yr → $6.5 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $448 M | 3.8% | 30 y, 7 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $187 M | 9.5% | 30 y, 7 y grace | $20 M / yr |
| Government equity (no debt service) | 15% | $112 M | — | — | — |
| **Total** | **100%** | **$746 M** | | | **$50 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 58,320 | 97,200 | 151,071 |
| Daily paid trips / catchment | 18% | 30% | 47% |
| Daily paid trips / city population | 7% | 12% | 19% |
| Annual paid trips | 21.3 M | 35.5 M | 55.1 M |
...
| **Total revenue** | **$8.9 M / yr** | **$14 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 44% | 68% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $61 M / yr | $56 M / yr | **$50 M / yr** |
