...
| Per-capita (city pop) | $574 / person |
...
|---|---|---|
| Construction (years 1–7) | **$30 M / yr** | $37 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $27 |
| Lifecycle envelope (yr 1–40, low scenario) | **$208 M cumulative** | $260 |
| Lifecycle envelope (yr 1–40, high scenario) | **$208 M cumulative** | $260 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$920 M cumulative** | $1,150 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $368 M | 4.5% | 40 y, 7 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $92 M | — | — | — |
| **Total** | **100%** | **$459 M** | | | **$22 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $259 M | 56% of $459 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 32,695 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-190680 k / $-60637 k |
| Low/high project IRR | 2.6% / 6.5% |
| Low/high steady-state DSCR | 1.04 / 1.94 |
