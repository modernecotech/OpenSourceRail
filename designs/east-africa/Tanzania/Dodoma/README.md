...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$641 M (86.6%) of external capital** and **$803 M of external interest**. Capital plus saved interest totals **$1.44 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (50.4 km @ $2.58 M/km) | $130 M |
| Elevated (1.7 km @ $9.75 M/km) | $17 M |
...
| **Total city CAPEX** | **$411 M** | **24.1%** | **$99 M** | **$312 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$99 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$312 M** | **$45 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $250 M | $36 M / yr |
| **Total city programme** | **100.0%** | **$411 M** | **$59 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $555 M | $456 M (82.1%) | $571 M | **$1.03 bn** |
| **Default** | 2.00× | $740 M | $641 M (86.6%) | $803 M | **$1.44 bn** |
| High | 3.00× | $1.11 bn | $1.01 bn (91.1%) | $1.27 bn | **$2.28 bn** |

At the default 2.00× case, OSR's $99 M external requirement is 86.6% below the illustrative foreign-company requirement of $740 M; the associated lifetime external-interest saving is $803 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$37 M / yr** | $46 |
| Steady-state, low capacity-use (year 8+) | **$7.8 M / yr** | $10 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $38 |
| Lifecycle envelope (yr 1–40, low scenario) | **$517 M cumulative** | $646 |
| Lifecycle envelope (yr 1–40, high scenario) | **$260 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.28 bn cumulative** | $1,594 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $99 M | 4.5% | 40 y, 7 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $250 M | 9.5% | 40 y, 7 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $62 M | — | — | — |
| **Total** | **100%** | **$411 M** | | | **$31 M / yr** |
...
| Annual paid trips / city resident | 92 | 147 | 26 |
...
| Revenue / OPEX recovery | 317% | 501% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $7.8 M / yr | $0 k / yr | **$31 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $312 M | 76% of $411 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 39,380 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Local-content / local-funding requirement | $312 M (75.9%) |
| Default foreign-turnkey external-capital comparison | $740 M; OSR saves $641 M (86.6%) |
| Lifetime external interest and combined financing saving | $803 M interest; $1.44 bn capital + interest |
| 15%–25% planning risk envelope | $473 M–$514 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-151330 k / $-21287 k |
| Low/high project IRR | 3.3% / 7.5% |
| Low/high steady-state DSCR | 0.75 / 1.38 |
