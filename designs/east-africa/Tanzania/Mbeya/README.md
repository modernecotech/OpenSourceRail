...
|---|---|---|---|---|
| line-1 | 19.8 km | 12 | 50 | E Outer ↔ SW Mid |
| line-2 | 22.6 km | 14 | 56 | E Outer ↔ W Outer |
| line-3 | 10.6 km | 8 | 27 | NW Mid ↔ S Mid |
| **Total** | **53.0 km** | **34 unique** | **133** | |
...
| **Total installed** | **33** | **14,600 kW** | **56,000 kWh** |

Aggregate station-rail charging power: **16,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **39.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 15.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 505 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 50 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 95 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 225 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 39.7 MW / 258 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 165 kWh | 253 kWh | 71 kWh | 2.2 km / 18 kWh |
| line-2 | 13 | 189 kWh | 282 kWh | 74 kWh | 4.2 km / 35 kWh |
| line-3 | 8 | 89 kWh | 147 kWh | 50 kWh | 2.0 km / 17 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 399 | $60 k | $24 M |
| High sensitivity check | 399 | $120 k | $48 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,741 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,741 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 39.7 MW × 6.5 peak-sun-h/day × 365 d/yr | 94.3 GWh/yr |
...
| Per-capita (city pop) | $1,011 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mbeya`.
...
| Steady-state, low capacity-use (year 8+) | **$5.1 M / yr** | $9 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $47 |
| Lifecycle envelope (yr 1–40, low scenario) | **$421 M cumulative** | $765 |
| Lifecycle envelope (yr 1–40, high scenario) | **$251 M cumulative** | $457 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $2,024 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $26 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $445 M | 4.5% | 40 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $111 M | — | — | — |
| **Total** | **100%** | **$556 M** | | | **$26 M / yr** |
...
| Traction energy (116.6 GWh / yr) | 24,654 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 34.6 GWh/yr + dedicated solar plant 39.7 MW / 94.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $477 k |
| Labour (414 FTE) | driverless roster: OCC/remote 81, station/platform 139, passenger service 49, fleet maintenance 73, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 24,654 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.7 M train-km / yr (29.2 M car-km / yr). On-site PV covers 34.6 GWh/yr and the dedicated solar plant adds 94.3 GWh/yr against 116.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 133 trainsets, 34 stations, 53.0 route-km, 3 lines, and 24,654 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 25.6 M |
| Annual paid trips / city resident | 133 | 213 | 47 |
| Farebox revenue | $32 M / yr | $52 M / yr | $11 M / yr |
| Station shop leases | $802 k / yr | $802 k / yr | $802 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$34 M / yr** | **$54 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 257% | 402% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $26 M / yr | $26 M / yr | **$26 M / yr** |
| Operating surplus applied to debt support | -$21 M / yr | -$26 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.1 M / yr | $0 k / yr | **$26 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $40 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,752 m² of station shop/kiosk leases at $13/m²/month and 1,080 advertising boards at $115/board/month, with occupancy derates applied._
...
| Commerce | 18 major/terminal/interchange nodes | 43,307 trips/trading day; 14.3 M access-events/yr | 69,292 trips/trading day; 22.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $315 M | 57% of $556 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 39,787 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $524 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$556 M** |
| 15%–25% planning risk envelope | $639 M–$695 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-272381 k / $-142338 k |
| Low/high project IRR | 1.1% / 5.0% |
| Low/high steady-state DSCR | 0.80 / 1.54 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,005.10 train-km; 16,744.65 kWh consumed; 17,291.81 kWh charged; 27 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,434.13 train-km; 212,401.74 kWh consumed; 216,182.88 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 36.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 63.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.4% / 60% | pass |
| ten-hour single charging-pad outage | 42.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 34 line platforms, 2 interchange complexes, 14 civil segments, and 0 input findings |
