...
**Country:** TZ · **Population:** 550,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$621 M (86.5%) of external capital** and **$778 M of external interest**. Capital plus saved interest totals **$1.40 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`mbeya.corridor.geojson`](mbeya.corridor.geojson).
...
| Route length (double track) | 53.0 km |
...
- **Revenue fleet simultaneous capacity:** 100 × 360 = **36,000 AW2 passengers** (48,000 AW3 crush)
- **Total fleet passenger capacity:** 112 × 360 = **40,320 AW2 passengers** (53,760 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 63.0%
- Catchment population: **≈ 346,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **43.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 486 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 25 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 24,654 train-km/day | One-way train journeys × route length |
| Annual service work | 9.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 320 MWh/day | 29.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 248 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 43.9 MW / 285 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 165 kWh | 229 kWh | 47 kWh | 3.7 km / 31 kWh |
| line-2 | 8 | 189 kWh | 261 kWh | 54 kWh | 6.4 km / 54 kWh |
| line-3 | 5 | 89 kWh | 122 kWh | 25 kWh | 4.6 km / 38 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (52.8 km @ $2.58 M/km) | $136 M |
| Elevated (0.2 km @ $9.75 M/km) | $2.2 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 112 | $900 k | $101 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 43,881 kW @ $700/kW | $31 M |
| Grid interconnection / PPA tie-in | 43,881 kW @ $100/kW | $4.4 M |
| Annual generation proxy | 43.9 MW × 6.5 peak-sun-h/day × 365 d/yr | 104.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.0 km × $0.050 M/km | $2.7 M |
...
| Residual train-control wayside + charging microgrids | $4.9 M |
| EPC overhead (7%) | $24 M |
| **CAPEX total** | **$399 M** |
| Per-route-km | $7.5 M / km |
| Per-capita (city pop) | $725 / person |
...
| Rolling stock | $101 M | 35% | $35 M | $66 M |
| Dedicated solar plant | $35 M | 45% | $16 M | $19 M |
| Residual signalling / train control | $2.7 M | 50% | $1.3 M | $1.3 M |
| Charging microgrids | $2.2 M | 40% | $900 k | $1.4 M |
| EPC / project services | $24 M | 15% | $3.6 M | $20 M |
| **Total city CAPEX** | **$399 M** | **24.4%** | **$97 M** | **$302 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mbeya`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.4%** | **$97 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.6%** | **$302 M** | **$43 M / yr** |
| of which planned local bond issuance | 60.5% of total CAPEX | $241 M | $34 M / yr |
| **Total city programme** | **100.0%** | **$399 M** | **$57 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $538 M | $441 M (81.9%) | $553 M | **$994 M** |
| **Default** | 2.00× | $718 M | $621 M (86.5%) | $778 M | **$1.40 bn** |
| High | 3.00× | $1.08 bn | $979 M (91.0%) | $1.23 bn | **$2.21 bn** |

At the default 2.00× case, OSR's $97 M external requirement is 86.5% below the illustrative foreign-company requirement of $718 M; the associated lifetime external-interest saving is $778 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$36 M / yr** | $65 |
| Steady-state, low capacity-use (year 8+) | **$6.6 M / yr** | $12 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$471 M cumulative** | $856 |
| Lifecycle envelope (yr 1–40, high scenario) | **$251 M cumulative** | $457 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.24 bn cumulative** | $2,247 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $23 M / yr → $30 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $97 M | 4.5% | 40 y, 7 y grace | $5.7 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $241 M | 9.5% | 40 y, 7 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $60 M | — | — | — |
| **Total** | **100%** | **$399 M** | | | **$30 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.4 M / yr + local bonds $23 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $4.0 M |
...
| Traction energy (116.6 GWh / yr) | 24,654 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 43.9 MW / 104.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $527 k |
| Labour (336 FTE) | driverless roster: OCC/remote 73, station/platform 81, passenger service 49, fleet maintenance 66, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $931 k |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 24,654 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.7 M train-km / yr (29.2 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 104.1 GWh/yr against 116.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 112 trainsets, 21 stations, 53.0 route-km, 3 lines, and 24,654 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 20.6 M |
| Annual paid trips / city resident | 133 | 213 | 38 |
| Farebox revenue | $32 M / yr | $52 M / yr | $9.1 M / yr |
| Station shop leases | $465 k / yr | $465 k / yr | $465 k / yr |
| Advertising boards | $763 k / yr | $763 k / yr | $763 k / yr |
| **Total revenue** | **$33 M / yr** | **$53 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 325% | 513% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $30 M / yr | $30 M / yr | **$30 M / yr** |
| Operating surplus applied to debt support | -$23 M / yr | -$30 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.6 M / yr | $0 k / yr | **$30 M / yr** |
| Operating surplus after OPEX (before debt support) | $23 M / yr | $43 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,336 m² of station shop/kiosk leases at $13/m²/month and 648 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $22 M / yr | 175 M - 280 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.5 M / yr | $4.0 M / yr | 31.5–50.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $302 M | 76% of $399 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $483 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $69 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 38,077 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $364 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$399 M** |
| Imported / external-capital requirement | $97 M (24.4%) |
| Local-content / local-funding requirement | $302 M (75.6%) |
| Default foreign-turnkey external-capital comparison | $718 M; OSR saves $621 M (86.5%) |
| Lifetime external interest and combined financing saving | $778 M interest; $1.40 bn capital + interest |
| 15%–25% planning risk envelope | $459 M–$498 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-140806 k / $-10763 k |
| Low/high project IRR | 3.6% / 7.7% |
| Low/high steady-state DSCR | 0.78 / 1.43 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,017.76 train-km; 16,850.17 kWh consumed; 14,790.10 kWh charged; 29 depot services completed; minimum SoC 68%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,768.72 train-km; 198,495.40 kWh consumed; 192,384.70 kWh charged; 481 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 96.4% of scheduled train-km delivered; 148 SoC warnings; 14 energy-adapted off-peak departures, maximum 19 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 96.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 95.1% / 90% | pass |
| 50% charging-contact availability | 20.0% | 96.4% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.1% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.8% / 90% | pass |
...
|---|---|
| ![Mbeya energy and battery simulation dashboard](engineering/screenshots/mbeya-simulation-dashboard.png) | ![Mbeya simulator network visualizer](engineering/screenshots/mbeya-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Mbeya QGIS engineering layers](engineering/screenshots/mbeya-qgis-engineering-map.png) | ![Mbeya SUMO timetable validation](engineering/screenshots/mbeya-sumo-validation.png) |
...
| [`mbeya.toml`](mbeya.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`mbeya-network-map.png`](mbeya-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`mbeya.corridor.geojson`](mbeya.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`mbeya.stations.json`](mbeya.stations.json) | Machine-readable station list |
| [`mbeya.design-quality.yaml`](mbeya.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
