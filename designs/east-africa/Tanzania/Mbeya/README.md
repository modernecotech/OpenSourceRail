...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$660 M (86.8%) of external capital** and **$828 M of external interest**. Capital plus saved interest totals **$1.49 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (52.8 km @ $3.0 M/km) | $158 M |
| Elevated (0.2 km @ $12.0 M/km) | $2.7 M |
...
| Per-capita (city pop) | $769 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $161 M | 15% | $24 M | $137 M |
...
| EPC / project services | $25 M | 15% | $3.8 M | $22 M |
| **Total city CAPEX** | **$423 M** | **23.8%** | **$101 M** | **$322 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.8%** | **$101 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.2%** | **$322 M** | **$46 M / yr** |
| of which planned local bond issuance | 60.9% of total CAPEX | $258 M | $37 M / yr |
| **Total city programme** | **100.0%** | **$423 M** | **$60 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $571 M | $470 M (82.3%) | $589 M | **$1.06 bn** |
| **Default** | 2.00× | $761 M | $660 M (86.8%) | $828 M | **$1.49 bn** |
| High | 3.00× | $1.14 bn | $1.04 bn (91.2%) | $1.30 bn | **$2.35 bn** |

At the default 2.00× case, OSR's $101 M external requirement is 86.8% below the illustrative foreign-company requirement of $761 M; the associated lifetime external-interest saving is $828 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$38 M / yr** | $69 |
| Steady-state, low capacity-use (year 8+) | **$8.9 M / yr** | $16 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$563 M cumulative** | $1,023 |
| Lifecycle envelope (yr 1–40, high scenario) | **$267 M cumulative** | $486 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.31 bn cumulative** | $2,387 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $23 M / yr → $32 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $101 M | 4.5% | 40 y, 7 y grace | $5.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $258 M | 9.5% | 40 y, 7 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$423 M** | | | **$32 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.5 M / yr + local bonds $24 M / yr = **$29 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 21.7 M |
| Annual paid trips / city resident | 133 | 213 | 39 |
| Farebox revenue | $32 M / yr | $52 M / yr | $9.5 M / yr |
...
| Revenue / OPEX recovery | 311% | 491% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $32 M / yr | $32 M / yr | **$32 M / yr** |
| Operating surplus applied to debt support | -$23 M / yr | -$32 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $8.9 M / yr | $0 k / yr | **$32 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $322 M | 76% of $423 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $515 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $74 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 40,658 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $388 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$423 M** |
| Imported / external-capital requirement | $101 M (23.8%) |
| Local-content / local-funding requirement | $322 M (76.2%) |
| Default foreign-turnkey external-capital comparison | $761 M; OSR saves $660 M (86.8%) |
| Lifetime external interest and combined financing saving | $828 M interest; $1.49 bn capital + interest |
| 15%–25% planning risk envelope | $486 M–$528 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-161713 k / $-31669 k |
| Low/high project IRR | 3.1% / 7.2% |
| Low/high steady-state DSCR | 0.72 / 1.33 |
