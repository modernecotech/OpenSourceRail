...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $52 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $38 |
| Lifecycle envelope (yr 1–40, low scenario) | **$201 M cumulative** | $365 |
| Lifecycle envelope (yr 1–40, high scenario) | **$201 M cumulative** | $365 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$890 M cumulative** | $1,618 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $355 M | 4.5% | 40 y, 7 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $89 M | — | — | — |
| **Total** | **100%** | **$444 M** | | | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $249 M | 56% of $444 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 31,478 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-177757 k / $-47713 k |
| Low/high project IRR | 2.8% / 6.8% |
| Low/high steady-state DSCR | 1.09 / 2.02 |
