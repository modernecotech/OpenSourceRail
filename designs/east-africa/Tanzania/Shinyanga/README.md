...
| Bucket | Value |
|---|---|
| At-grade (35.3 km @ €3.5 M/km) | €124 M |
| Elevated (1.1 km @ €18 M/km) | €19 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 36.8 km × €0.015 M/km | €0.5 M |
...
| Per-capita (city pop) | €1,472 / person |
...
| Steady-state, low-ridership (year 8+) | **€33 M / yr** | €131 |
| Steady-state, high-ridership (year 8+) | **€32 M / yr** | €126 |
| Lifecycle envelope (yr 1–30, low scenario) | **€929 M cumulative** | €3,714 |
| Lifecycle envelope (yr 1–30, high scenario) | **€902 M cumulative** | €3,608 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€8.2 M / yr (low) → €7.1 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €221 M | 3.8% | 30 y, 7 y grace | €15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €92 M | 9.5% | 30 y, 7 y grace | €10.0 M / yr |
| Government equity (no debt service) | 15% | €55 M | — | — | — |
| **Total** | **100%** | **€368 M** | | | **€25 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €8.4 M / yr + bonds €8.7 M / yr = **€17 M / yr** total — plus the equity tranche amortised across construction (€7.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (233 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €594 k |
...
| Farebox / OPEX recovery | 12% | 25% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €8.2 M / yr | €7.1 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€33 M / yr** | **€32 M / yr** |
