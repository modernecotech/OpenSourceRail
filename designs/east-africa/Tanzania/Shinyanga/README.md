...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 152 | $60 k | $9.1 M |
| High sensitivity check | 152 | $120 k | $18 M |
...
| Depots | $8.0 M |
| Rolling stock | $43 M |
| Railway production plant | $9.1 M |
...
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$125 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$125 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$555 M cumulative** | $2,221 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $222 M | 4.5% | 40 y, 7 y grace | $13 M / yr |
| Government equity (no debt service) | 20% | $55 M | — | — | — |
| **Total** | **100%** | **$277 M** | | | **$13 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $10.0 M / yr = **$10.0 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($7.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $162 M | 58% of $277 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $259 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $37 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 20,415 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $264 M |
| Timetable-sized dedicated solar CAPEX | $13 M |
| **Reconciled project CAPEX** | **$277 M** |
| 15%–25% planning risk envelope | $319 M–$347 M |
| Annual OPEX | $6.5 M / yr |
| Low/high project NPV at 8% | $-99688 k / $-12992 k |
| Low/high project IRR | 3.5% / 7.5% |
| Low/high steady-state DSCR | 1.22 / 2.21 |
