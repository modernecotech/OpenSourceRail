...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$424 M (88.1%) of external capital** and **$531 M of external interest**. Capital plus saved interest totals **$955 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 68 × 2-car trainsets |
| Revenue fleet passenger capacity | 16,320 AW2 pax (21,760 AW3 crush) |
...
| Revenue fleet capacity | 16,320 AW2 pax (21,760 AW3 crush) |
| Total fleet capacity | 18,240 AW2 pax (24,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 68 × 240 = **16,320 AW2 passengers** (21,760 AW3 crush)
- **Total fleet passenger capacity:** 76 × 240 = **18,240 AW2 passengers** (24,320 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **16.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.2× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 321 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 29 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 56 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 17,104 train-km/day | One-way train journeys × route length |
| Annual service work | 6.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 148 MWh/day | 13.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 92 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 16.3 MW / 106 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 89 kWh | 131 kWh | 33 kWh | 7.0 km / 39 kWh |
| line-2 | 4 | 53 kWh | 90 kWh | 31 kWh | 5.2 km / 29 kWh |
| line-3 | 4 | 63 kWh | 98 kWh | 29 kWh | 5.9 km / 33 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (35.5 km @ $3.0 M/km) | $107 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 76 | $560 k | $43 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 152 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 152 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 16,256 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 16,256 kW @ $100/kW | $1.6 M |
| Annual generation proxy | 16.3 MW × 6.5 peak-sun-h/day × 365 d/yr | 38.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$13 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $122 M | 15% | $18 M | $104 M |
| Stations | $62 M | 20% | $12 M | $50 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $43 M | 35% | $15 M | $28 M |
| Dedicated solar plant | $13 M | 45% | $5.9 M | $7.2 M |
| Residual signalling / train control | $1.8 M | 50% | $920 k | $920 k |
| Charging microgrids | $1.4 M | 40% | $580 k | $870 k |
| EPC / project services | $17 M | 15% | $2.5 M | $14 M |
| **Total city CAPEX** | **$267 M** | **21.5%** | **$57 M** | **$210 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh shinyanga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.5%** | **$57 M** | **$8.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.5%** | **$210 M** | **$30 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $168 M | $24 M / yr |
| **Total city programme** | **100.0%** | **$267 M** | **$38 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $361 M | $304 M (84.1%) | $381 M | **$684 M** |
| **Default** | 2.00× | $481 M | $424 M (88.1%) | $531 M | **$955 M** |
| High | 3.00× | $722 M | $665 M (92.0%) | $833 M | **$1.50 bn** |

At the default 2.00× case, OSR's $57 M external requirement is 88.1% below the illustrative foreign-company requirement of $481 M; the associated lifetime external-interest saving is $531 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $98 |
| Steady-state, low capacity-use (year 8+) | **$4.3 M / yr** | $17 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $81 |
| Lifecycle envelope (yr 1–40, low scenario) | **$315 M cumulative** | $1,258 |
| Lifecycle envelope (yr 1–40, high scenario) | **$172 M cumulative** | $687 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$838 M cumulative** | $3,351 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $16 M / yr → $20 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $57 M | 4.5% | 40 y, 7 y grace | $3.4 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $168 M | 9.5% | 40 y, 7 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $42 M | — | — | — |
| **Total** | **100%** | **$267 M** | | | **$20 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.6 M / yr + local bonds $16 M / yr = **$19 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (53.9 GWh / yr) | 17,104 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.4 GWh/yr + dedicated solar plant 16.3 MW / 38.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $195 k |
| Labour (255 FTE) | driverless roster: OCC/remote 57, station/platform 60, passenger service 38, fleet maintenance 46, infrastructure/energy 33, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $707 k |
| **OPEX subtotal** | | **$6.5 M / yr** |

_Annual service work: 17,104 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.7 M train-km / yr (13.5 M car-km / yr). On-site PV covers 20.4 GWh/yr and the dedicated solar plant adds 38.6 GWh/yr against 53.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 76 trainsets, 14 stations, 36.8 route-km, 3 lines, and 17,104 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 12.9 M |
| Annual paid trips / city resident | 196 | 313 | 51 |
| Farebox revenue | $22 M / yr | $34 M / yr | $5.7 M / yr |
| Station shop leases | $332 k / yr | $332 k / yr | $332 k / yr |
| Advertising boards | $547 k / yr | $547 k / yr | $547 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$6.5 M / yr** |
| Revenue / OPEX recovery | 343% | 540% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $20 M / yr | $20 M / yr | **$20 M / yr** |
| Operating surplus applied to debt support | -$16 M / yr | -$20 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $4.3 M / yr | $0 k / yr | **$20 M / yr** |
| Operating surplus after OPEX (before debt support) | $16 M / yr | $29 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,384 m² of station shop/kiosk leases at $13/m²/month and 464 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $6.5 M / yr | $10 M / yr | 81 M - 130 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.2 M / yr | $1.9 M / yr | 14.6–23.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.2 M / yr | $5.2 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$42 M / yr** | **$66 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 9 major/terminal/interchange nodes | 30,467 trips/trading day; 10.1 M access-events/yr | 48,747 trips/trading day; 16.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $210 M | 79% of $267 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $336 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $48 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 26,516 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $13 M |
| **Reconciled project CAPEX** | **$267 M** |
| Imported / external-capital requirement | $57 M (21.5%) |
| Local-content / local-funding requirement | $210 M (78.5%) |
| Default foreign-turnkey external-capital comparison | $481 M; OSR saves $424 M (88.1%) |
| Lifetime external interest and combined financing saving | $531 M interest; $955 M capital + interest |
| 15%–25% planning risk envelope | $308 M–$334 M |
| Annual OPEX | $6.5 M / yr |
| Low/high project NPV at 8% | $-92430 k / $-5734 k |
| Low/high project IRR | 3.7% / 7.8% |
| Low/high steady-state DSCR | 0.79 / 1.43 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,521.17 train-km; 8,470.57 kWh consumed; 8,454.12 kWh charged; 37 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,354.77 train-km; 91,070.62 kWh consumed; 92,251.16 kWh charged; 485 depot services completed (6 active at cutoff); minimum SoC 55%; 0 onboard emergencies; 0 invariant violations; 95.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 52.7% | 95.6% / 90% | pass |
| maximum planning climate/HVAC duty | 33.5% | 95.6% / 90% | pass |
| 50% charging-contact availability | 54.9% | 95.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.3% / 60% | pass |
| ten-hour single charging-pad outage | 20.5% | 95.2% / 90% | pass |
...
|---|---|
| ![Shinyanga energy and battery simulation dashboard](engineering/screenshots/shinyanga-simulation-dashboard.png) | ![Shinyanga simulator network visualizer](engineering/screenshots/shinyanga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 17 civil segments, and 0 input findings |
...
|---|---|
| ![Shinyanga QGIS engineering layers](engineering/screenshots/shinyanga-qgis-engineering-map.png) | ![Shinyanga SUMO timetable validation](engineering/screenshots/shinyanga-sumo-validation.png) |
