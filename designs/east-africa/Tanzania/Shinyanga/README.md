...
| Revenue fleet | 99 × 2-car trainsets |
...
|---|---|---|---|---|
| line-1 | 15.9 km | 8 | 46 | NE Outer ↔ S Inner |
| line-2 |  9.6 km | 7 | 30 | NW Mid ↔ S Inner |
| line-3 | 11.3 km | 6 | 35 | SE Inner ↔ S Mid |
| **Total** | **36.8 km** | **21 unique** | **111** | |
...
- **Revenue fleet simultaneous capacity:** 99 × 240 = **23,760 AW2 passengers** (31,680 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **14.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 311 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 14.5 MW / 94 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 89 kWh | 139 kWh | 41 kWh | 8.8 km / 49 kWh |
| line-2 | 7 | 53 kWh | 131 kWh | 72 kWh | 2.2 km / 13 kWh |
| line-3 | 5 | 63 kWh | 110 kWh | 41 kWh | 4.8 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (34.4 km @ $3.0 M/km) | $103 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 14,531 kW @ $700/kW | $10 M |
| Grid interconnection / PPA tie-in | 14,531 kW @ $100/kW | $1.5 M |
| Annual generation proxy | 14.5 MW × 6.5 peak-sun-h/day × 365 d/yr | 34.5 GWh/yr |
...
| Steady-state, low capacity-use (year 8+) | **$2.4 M / yr** | $10 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$240 M cumulative** | $960 |
| Lifecycle envelope (yr 1–40, high scenario) | **$161 M cumulative** | $644 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$714 M cumulative** | $2,855 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $285 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
...
| Traction energy (53.9 GWh / yr) | 17,104 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 24.0 GWh/yr + dedicated solar plant 14.5 MW / 34.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $174 k |
| Labour (317 FTE) | driverless roster: OCC/remote 73, station/platform 93, passenger service 38, fleet maintenance 56, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $879 k |
| **OPEX subtotal** | | **$8.5 M / yr** |

_Annual service work: 17,104 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.7 M train-km / yr (13.5 M car-km / yr). On-site PV covers 24.0 GWh/yr and the dedicated solar plant adds 34.5 GWh/yr against 53.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 111 trainsets, 21 stations, 36.8 route-km, 3 lines, and 17,104 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Station shop leases | $520 k / yr | $520 k / yr | $520 k / yr |
| Advertising boards | $825 k / yr | $825 k / yr | $825 k / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$8.5 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.4 M / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $14 M / yr | $27 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,728 m² of station shop/kiosk leases at $13/m²/month and 700 advertising boards at $115/board/month, with occupancy derates applied._
...
| Commerce | 13 major/terminal/interchange nodes | 30,132 trips/trading day; 9.9 M access-events/yr | 48,211 trips/trading day; 15.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $208 M | 58% of $356 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,227 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $410 M–$446 M |
| Annual OPEX | $8.5 M / yr |
| Low/high project NPV at 8% | $-168615 k / $-81919 k |
| Low/high project IRR | 1.5% / 5.3% |
| Low/high steady-state DSCR | 0.86 / 1.63 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,568.76 train-km; 8,735.50 kWh consumed; 9,018.31 kWh charged; 35 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,553.05 train-km; 97,742.44 kWh consumed; 99,960.70 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 66%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 58.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 56.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 65.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 55.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 2 interchange complexes, 19 civil segments, and 0 input findings |
