...
| Revenue fleet | 275 × 4-car trainsets |
| Revenue fleet passenger capacity | 132,000 AW2 pax (176,000 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 25.6 km | 19 | 61 | S Mid ↔ N Mid |
| line-2 | 23.0 km | 16 | 53 | W Mid ↔ E Mid |
| line-3 | 18.3 km | 11 | 41 | SW Mid ↔ NW Mid |
| line-4 | 26.0 km | 16 | 59 | NE Outer ↔ W Mid |
| line-5 | 29.9 km | 16 | 62 | NW Mid ↔ SE Outer |
| line-6 | 53.2 km | 35 | 29 | N Mid ↔ N Mid |
| **Total** | **175.9 km** | **113 unique** | **305** | |
...
| Revenue fleet capacity | 132,000 AW2 pax (176,000 AW3 crush) |
| Total fleet capacity | 146,400 AW2 pax (195,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 275 × 480 = **132,000 AW2 passengers** (176,000 AW3 crush)
- **Total fleet passenger capacity:** 305 × 480 = **146,400 AW2 passengers** (195,200 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 43 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **104** | **35,900 kW** | **194,500 kWh** |

Aggregate station-rail charging power: **156,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **246.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 333 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 172 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 246.2 MW / 1,182 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 255 kWh | 980 kWh | 699 kWh | 2.4 km / 24 kWh |
| line-2 | 15 | 229 kWh | 784 kWh | 532 kWh | 3.8 km / 38 kWh |
| line-3 | 10 | 183 kWh | 539 kWh | 338 kWh | 5.0 km / 50 kWh |
| line-4 | 15 | 259 kWh | 784 kWh | 499 kWh | 5.7 km / 57 kWh |
| line-5 | 12 | 298 kWh | 662 kWh | 333 kWh | 13.0 km / 130 kWh |
| line-6 | 33 | 531 kWh | 1,617 kWh | 1,033 kWh | 4.7 km / 47 kWh |
...
| `interchange-elevated` | 48 | $12.0 M | $576 M |
| **Stations subtotal** | | | **$748 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 305 | $1.12 M | $342 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1220 | $60 k | $73 M |
| High sensitivity check | 1220 | $120 k | $146 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 246,152 kW @ $700/kW | $172 M |
| Grid interconnection / PPA tie-in | 246,152 kW @ $100/kW | $25 M |
| Annual generation proxy | 246.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 431.3 GWh/yr |
...
| Per-capita (city pop) | $2,000 / person |
...
|---|---|---|
| Construction (years 1–7) | **$142 M / yr** | $129 |
| Steady-state, low capacity-use (year 8+) | **$65 M / yr** | $59 |
| Steady-state, high capacity-use (year 8+) | **$17 M / yr** | $16 |
| Steady-state, operating-neutral revenue case | **$103 M / yr** | $94 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.13 bn cumulative** | $2,846 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.57 bn cumulative** | $1,427 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.41 bn cumulative** | $4,005 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.76 bn | 4.5% | 40 y, 7 y grace | $103 M / yr |
| Government equity (no debt service) | 20% | $440 M | — | — | — |
| **Total** | **100%** | **$2.20 bn** | | | **$103 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $79 M / yr = **$79 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($63 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (437.9 GWh / yr) | 69,429 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 62.9 GWh/yr + dedicated solar plant 246.2 MW / 431.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.0 M |
| Labour (1,194 FTE) | driverless roster: OCC/remote 175, station/platform 540, passenger service 111, fleet maintenance 183, infrastructure/energy 158, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.3 M |
| **OPEX subtotal** | | **$49 M / yr** |

_Annual service work: 69,429 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.4 M train-km / yr (109.5 M car-km / yr). On-site PV covers 62.9 GWh/yr and the dedicated solar plant adds 431.3 GWh/yr against 437.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 305 trainsets, 113 stations, 175.9 route-km, 6 lines, and 69,429 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 91.4 M |
| Annual paid trips / city resident | 163 | 261 | 83 |
| Farebox revenue | $79 M / yr | $126 M / yr | $40 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.1 M / yr | $5.1 M / yr | $5.1 M / yr |
| **Total revenue** | **$87 M / yr** | **$135 M / yr** | **$49 M / yr** |
| Revenue / OPEX recovery | 179% | 277% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $103 M / yr | $103 M / yr | **$103 M / yr** |
| Operating surplus applied to debt support | -$39 M / yr | -$86 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $65 M / yr | $17 M / yr | **$103 M / yr** |
| Operating surplus after OPEX (before debt support) | $39 M / yr | $86 M / yr | $0 / yr |

_Commercial-revenue assumptions: 24,048 m² of station shop/kiosk leases at $13/m²/month and 4,292 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 9 education anchors | 30,248 trips/school day; 6.7 M access-events/yr | 48,397 trips/school day; 10.6 M access-events/yr |
| Healthcare | 14 healthcare anchors | 42,295 trips/day; 15.4 M access-events/yr | 67,672 trips/day; 24.7 M access-events/yr |
| Commerce | 61 major/terminal/interchange nodes | 106,399 trips/trading day; 35.1 M access-events/yr | 170,239 trips/trading day; 56.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.24 bn | 56% of $2.20 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 156,322 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $49 M / yr |
| Low/high project NPV at 8% | $-1376569 k / $-1058685 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,997.37 train-km; 49,896.81 kWh consumed; 54,833.70 kWh charged; 37 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 69,890.76 train-km; 697,832.67 kWh consumed; 709,194.08 kWh charged; 997 depot services completed (9 active at cutoff); minimum SoC 80%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 113 line platforms, 8 interchange complexes, 66 civil segments, and 0 input findings |
