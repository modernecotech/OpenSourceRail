...
|---|---|---|
| Construction (years 1–7) | **$63 M / yr** | $57 |
| Steady-state, low-ridership (year 8+) | **$69 M / yr** | $63 |
| Steady-state, high-ridership (year 8+) | **$62 M / yr** | $56 |
| Steady-state, operating-neutral revenue case | **$61 M / yr** | $56 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.03 bn cumulative** | $1,844 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.86 bn cumulative** | $1,693 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.85 bn cumulative** | $1,682 |

_Population basis: 1,100,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.7 M / yr → $541 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $552 M | 3.8% | 30 y, 7 y grace | $36 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $230 M | 9.5% | 30 y, 7 y grace | $25 M / yr |
| Government equity (no debt service) | 15% | $138 M | — | — | — |
| **Total** | **100%** | **$920 M** | | | **$61 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $21 M / yr + bonds $22 M / yr = **$43 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 89,496 | 149,160 | 153,651 |
| Daily paid trips / catchment | 18% | 30% | 31% |
| Daily paid trips / city population | 8% | 14% | 14% |
| Annual paid trips | 32.7 M | 54.4 M | 56.1 M |
| Farebox revenue | $11 M / yr | $18 M / yr | $19 M / yr |
| Station shop leases | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| Advertising boards | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| **Total revenue** | **$15 M / yr** | **$22 M / yr** | **$22 M / yr** |
| Revenue / OPEX recovery | 66% | 98% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $69 M / yr | $62 M / yr | **$61 M / yr** |
