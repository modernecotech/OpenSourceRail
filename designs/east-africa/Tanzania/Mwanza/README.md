...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.35 bn (86.5%) of external capital** and **$2.94 bn of external interest**. Capital plus saved interest totals **$5.29 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (165.5 km @ $2.58 M/km) | $428 M |
| Elevated (10.4 km @ $9.75 M/km) | $102 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$565 M** |
...
| Per-capita (city pop) | $1,370 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $565 M | 15% | $85 M | $480 M |
...
| **Total city CAPEX** | **$1.51 bn** | **24.2%** | **$365 M** | **$1.14 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$365 M** | **$52 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$1.14 bn** | **$163 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $914 M | $131 M / yr |
| **Total city programme** | **100.0%** | **$1.51 bn** | **$215 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.03 bn | $1.67 bn (82.1%) | $2.09 bn | **$3.76 bn** |
| **Default** | 2.00× | $2.71 bn | $2.35 bn (86.5%) | $2.94 bn | **$5.29 bn** |
| High | 3.00× | $4.07 bn | $3.70 bn (91.0%) | $4.64 bn | **$8.35 bn** |

At the default 2.00× case, OSR's $365 M external requirement is 86.5% below the illustrative foreign-company requirement of $2.71 bn; the associated lifetime external-interest saving is $2.94 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$136 M / yr** | $124 |
| Steady-state, low capacity-use (year 8+) | **$64 M / yr** | $58 |
| Steady-state, high capacity-use (year 8+) | **$17 M / yr** | $15 |
| Steady-state, operating-neutral revenue case | **$113 M / yr** | $103 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.07 bn cumulative** | $2,790 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.51 bn cumulative** | $1,371 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.67 bn cumulative** | $4,249 |

_Population basis: 1,100,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $49 M / yr → $96 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $365 M | 4.5% | 40 y, 7 y grace | $21 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $914 M | 9.5% | 40 y, 7 y grace | $91 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $228 M | — | — | — |
| **Total** | **100%** | **$1.51 bn** | | | **$113 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $16 M / yr + local bonds $87 M / yr = **$103 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($33 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 68.7 M |
| Annual paid trips / city resident | 163 | 261 | 62 |
| Farebox revenue | $79 M / yr | $126 M / yr | $30 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| **Total revenue** | **$83 M / yr** | **$130 M / yr** | **$35 M / yr** |
| Revenue / OPEX recovery | 241% | 378% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $113 M / yr | $113 M / yr | **$113 M / yr** |
| Operating surplus applied to debt support | -$49 M / yr | -$96 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $64 M / yr | $17 M / yr | **$113 M / yr** |
| Operating surplus after OPEX (before debt support) | $49 M / yr | $96 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.14 bn | 76% of $1.51 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 144,199 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.51 bn** |
| Imported / external-capital requirement | $365 M (24.2%) |
| Local-content / local-funding requirement | $1.14 bn (75.8%) |
| Default foreign-turnkey external-capital comparison | $2.71 bn; OSR saves $2.35 bn (86.5%) |
| Lifetime external interest and combined financing saving | $2.94 bn interest; $5.29 bn capital + interest |
| 15%–25% planning risk envelope | $1.73 bn–$1.88 bn |
| Annual OPEX | $35 M / yr |
| Low/high project NPV at 8% | $-794231 k / $-476346 k |
| Low/high project IRR | 0.3% / 4.1% |
| Low/high steady-state DSCR | 0.43 / 0.85 |
