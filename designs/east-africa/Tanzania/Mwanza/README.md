...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **89,496 – 149,160 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (154.1 km @ $2.0 M/km) | $308 M |
| Elevated (6.8 km @ $9.0 M/km) | $61 M |
| Elevated-interchange premium (6 sites @ $4.50 M) | $27 M |
| **Civil subtotal** | **$396 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 161.6 km × $0.015 M/km | $8.0 M |
...
|---|---|---|
| Construction (years 1–7) | **$51 M / yr** | $47 |
| Steady-state, low-ridership (year 8+) | **$55 M / yr** | $50 |
| Steady-state, high-ridership (year 8+) | **$50 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$50 M / yr** | $46 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.63 bn cumulative** | $1,478 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.52 bn cumulative** | $1,381 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.52 bn cumulative** | $1,381 |

_Population basis: 1,100,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $453 M | 3.8% | 30 y, 7 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $189 M | 9.5% | 30 y, 7 y grace | $20 M / yr |
| Government equity (no debt service) | 15% | $113 M | — | — | — |
| **Total** | **100%** | **$756 M** | | | **$50 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $18 M / yr = **$35 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 89,496 | 149,160 | 128,056 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 8% | 14% | 12% |
| Annual paid trips | 32.7 M | 54.4 M | 46.7 M |
...
| **Total revenue** | **$15 M / yr** | **$22 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 76% | 113% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $55 M / yr | $50 M / yr | **$50 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $2.5 M / yr | $0 / yr |
