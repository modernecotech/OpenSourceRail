...
| Manufacturing material/BOM rows | 16,841 |
| Manufacturing QA verification rows | 1,142 |
| Construction QA action rows | 1,057 |
| Maintenance handover schedule rows | 1,365 |
