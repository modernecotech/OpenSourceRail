...
**Country:** TZ · **Population:** 400,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$654 M (86.3%) of external capital** and **$820 M of external interest**. Capital plus saved interest totals **$1.47 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`tanga.corridor.geojson`](tanga.corridor.geojson).
...
| Anchor-weighted coverage | 52.2% |
| Route length (double track) | 50.1 km |
...
| Total fleet capacity | 38,880 AW2 pax (51,840 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 97 × 360 = **34,920 AW2 passengers** (46,560 AW3 crush)
- **Total fleet passenger capacity:** 108 × 360 = **38,880 AW2 passengers** (51,840 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 52.2%
- Catchment population: **≈ 208,800** (within ~800 m walk of a station)
...
| **Total installed** | **20** | **10,700 kW** | **49,500 kWh** |

Aggregate station-rail charging power: **10,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **60.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 502 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 46 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 51 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 23,287 train-km/day | One-way train journeys × route length |
| Annual service work | 9.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 302 MWh/day | 27.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 250 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 60.0 MW / 288 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 160 kWh | 257 kWh | 81 kWh | 4.2 km / 31 kWh |
| line-2 | 7 | 114 kWh | 172 kWh | 46 kWh | 5.1 km / 38 kWh |
| line-3 | 6 | 101 kWh | 172 kWh | 60 kWh | 3.0 km / 23 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (48.7 km @ $2.58 M/km) | $126 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 108 | $900 k | $97 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 324 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 324 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 60,002 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 60,002 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 60.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 105.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 50.1 km × $0.050 M/km | $2.5 M |
...
| Residual train-control wayside + charging microgrids | $4.7 M |
| EPC overhead (7%) | $24 M |
| **CAPEX total** | **$421 M** |
| Per-route-km | $8.4 M / km |
| Per-capita (city pop) | $1,052 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $144 M | 15% | $22 M | $123 M |
| Stations | $94 M | 20% | $19 M | $76 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $97 M | 35% | $34 M | $63 M |
| Dedicated solar plant | $48 M | 45% | $22 M | $26 M |
| Residual signalling / train control | $2.5 M | 50% | $1.3 M | $1.3 M |
| Charging microgrids | $2.2 M | 40% | $880 k | $1.3 M |
| EPC / project services | $24 M | 15% | $3.7 M | $21 M |
| **Total city CAPEX** | **$421 M** | **24.7%** | **$104 M** | **$317 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tanga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$104 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$317 M** | **$45 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $254 M | $36 M / yr |
| **Total city programme** | **100.0%** | **$421 M** | **$60 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $568 M | $464 M (81.7%) | $582 M | **$1.05 bn** |
| **Default** | 2.00× | $758 M | $654 M (86.3%) | $820 M | **$1.47 bn** |
| High | 3.00× | $1.14 bn | $1.03 bn (90.9%) | $1.29 bn | **$2.33 bn** |

At the default 2.00× case, OSR's $104 M external requirement is 86.3% below the illustrative foreign-company requirement of $758 M; the associated lifetime external-interest saving is $820 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$38 M / yr** | $95 |
| Steady-state, low capacity-use (year 8+) | **$8.6 M / yr** | $21 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$547 M cumulative** | $1,368 |
| Lifecycle envelope (yr 1–40, high scenario) | **$265 M cumulative** | $662 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.30 bn cumulative** | $3,258 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $23 M / yr → $31 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $104 M | 4.5% | 40 y, 7 y grace | $6.1 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $254 M | 9.5% | 40 y, 7 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$421 M** | | | **$31 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.7 M / yr + local bonds $24 M / yr = **$29 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (110.2 GWh / yr) | 23,287 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 18.7 GWh/yr + dedicated solar plant 60.0 MW / 105.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $720 k |
| Labour (331 FTE) | driverless roster: OCC/remote 73, station/platform 81, passenger service 49, fleet maintenance 63, infrastructure/energy 44, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $918 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 23,287 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.2 M train-km / yr (27.5 M car-km / yr). On-site PV covers 18.7 GWh/yr and the dedicated solar plant adds 105.1 GWh/yr against 110.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 108 trainsets, 20 stations, 50.1 route-km, 3 lines, and 23,287 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 21.3 M |
| Annual paid trips / city resident | 183 | 293 | 53 |
| Farebox revenue | $32 M / yr | $52 M / yr | $9.4 M / yr |
| Station shop leases | $469 k / yr | $469 k / yr | $469 k / yr |
| Advertising boards | $763 k / yr | $763 k / yr | $763 k / yr |
| **Total revenue** | **$33 M / yr** | **$53 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 316% | 499% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $31 M / yr | $31 M / yr | **$31 M / yr** |
| Operating surplus applied to debt support | -$23 M / yr | -$31 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $8.6 M / yr | $0 k / yr | **$31 M / yr** |
| Operating surplus after OPEX (before debt support) | $23 M / yr | $42 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,368 m² of station shop/kiosk leases at $13/m²/month and 648 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $21 M / yr | 165 M - 264 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.4 M / yr | $3.8 M / yr | 29.8–47.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 11,373 trips/school day; 2.5 M access-events/yr | 18,197 trips/school day; 4.0 M access-events/yr |
| Healthcare | 1 healthcare anchors | 13,351 trips/day; 4.9 M access-events/yr | 21,361 trips/day; 7.8 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 43,742 trips/trading day; 14.4 M access-events/yr | 69,987 trips/trading day; 23.1 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 21,633 trips/activity day; 6.5 M access-events/yr | 34,613 trips/activity day; 10.4 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $317 M | 75% of $421 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $507 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $72 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 40,028 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $373 M |
| Timetable-sized dedicated solar CAPEX | $48 M |
| **Reconciled project CAPEX** | **$421 M** |
| Imported / external-capital requirement | $104 M (24.7%) |
| Local-content / local-funding requirement | $317 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $758 M; OSR saves $654 M (86.3%) |
| Lifetime external interest and combined financing saving | $820 M interest; $1.47 bn capital + interest |
| 15%–25% planning risk envelope | $484 M–$526 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-159175 k / $-29132 k |
| Low/high project IRR | 3.2% / 7.3% |
| Low/high steady-state DSCR | 0.73 / 1.34 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,958.40 train-km; 14,664.33 kWh consumed; 13,706.62 kWh charged; 31 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,060.62 train-km; 172,675.81 kWh consumed; 173,723.44 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.0% of scheduled train-km delivered; 9 SoC warnings; 2 energy-adapted off-peak departures, maximum 12 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 98.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 97.3% / 90% | pass |
| 50% charging-contact availability | 20.0% | 99.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 85.7% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 98.4% / 90% | pass |
...
|---|---|
| ![Tanga energy and battery simulation dashboard](engineering/screenshots/tanga-simulation-dashboard.png) | ![Tanga simulator network visualizer](engineering/screenshots/tanga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 2 interchange complexes, 16 civil segments, and 0 input findings |
...
|---|---|
| ![Tanga QGIS engineering layers](engineering/screenshots/tanga-qgis-engineering-map.png) | ![Tanga SUMO timetable validation](engineering/screenshots/tanga-sumo-validation.png) |
...
| [`tanga.toml`](tanga.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`tanga-network-map.png`](tanga-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`tanga.corridor.geojson`](tanga.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`tanga.stations.json`](tanga.stations.json) | Machine-readable station list |
| [`tanga.design-quality.yaml`](tanga.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
