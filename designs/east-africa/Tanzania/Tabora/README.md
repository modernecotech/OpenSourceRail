...
| Bucket | Value |
|---|---|
| At-grade (15.3 km @ €3.5 M/km) | €53 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 26 | €2.0 M | €52 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 17.6 km × €0.015 M/km | €0.3 M |
...
|---|---|---|
| Construction (years 1–7) | **€19 M / yr** | €63 |
| Steady-state, low-ridership (year 8+) | **€24 M / yr** | €79 |
| Steady-state, high-ridership (year 8+) | **€22 M / yr** | €74 |
| Lifecycle envelope (yr 1–30, low scenario) | **€676 M cumulative** | €2,254 |
| Lifecycle envelope (yr 1–30, high scenario) | **€644 M cumulative** | €2,148 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€5.1 M / yr (low) → €3.7 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €70 M | 9.5% | 30 y, 7 y grace | €7.6 M / yr |
| Government equity (no debt service) | 15% | €42 M | — | — | — |
| **Total** | **100%** | **€278 M** | | | **€19 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €6.3 M / yr + bonds €6.6 M / yr = **€13 M / yr** total — plus the equity tranche amortised across construction (€6.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (118 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €301 k |
...
| Operating shortfall (gov subsidy required) | €5.1 M / yr | €3.7 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€24 M / yr** | **€22 M / yr** |
