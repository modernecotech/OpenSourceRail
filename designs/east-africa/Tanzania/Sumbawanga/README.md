...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **8,725 – 13,087 trips/day**
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 11 | €2.0 M | €22 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 6.5 km × €0.015 M/km | €0.1 M |
...
|---|---|---|
| Construction (years 1–7) | **€6.5 M / yr** | €26 |
| Steady-state, low-ridership (year 8+) | **€7.6 M / yr** | €30 |
| Steady-state, high-ridership (year 8+) | **€6.4 M / yr** | €26 |
| Lifecycle envelope (yr 1–30, low scenario) | **€219 M cumulative** | €877 |
| Lifecycle envelope (yr 1–30, high scenario) | **€193 M cumulative** | €771 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€1.2 M / yr (low) → €8 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €57 M | 3.8% | 30 y, 7 y grace | €3.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €24 M | 9.5% | 30 y, 7 y grace | €2.6 M / yr |
| Government equity (no debt service) | 15% | €14 M | — | — | — |
| **Total** | **100%** | **€96 M** | | | **€6.4 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €2.2 M / yr + bonds €2.3 M / yr = **€4.5 M / yr** total — plus the equity tranche amortised across construction (€2.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | €880 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | €1.3 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | €5 k |
| Traction energy (8.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (51 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €130 k |
...
| Farebox / OPEX recovery | 50% | 100% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €1.2 M / yr | €8 k / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€7.6 M / yr** | **€6.4 M / yr** |
