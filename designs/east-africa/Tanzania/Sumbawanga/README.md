...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **15,705 – 26,175 trips/day**
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 11 | $2.80 M | $31 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 22 | $100 k | $2.2 M |
| High sensitivity check | 22 | $200 k | $4.4 M |
...
|---|---|---|
| Construction (years 1–7) | **$6.7 M / yr** | $27 |
| Steady-state, low-ridership (year 8+) | **$6.9 M / yr** | $28 |
| Steady-state, high-ridership (year 8+) | **$6.6 M / yr** | $26 |
| Steady-state, operating-neutral revenue case | **$6.6 M / yr** | $26 |
| Lifecycle envelope (yr 1–30, low scenario) | **$206 M cumulative** | $823 |
| Lifecycle envelope (yr 1–30, high scenario) | **$199 M cumulative** | $796 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$199 M cumulative** | $796 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $291 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $59 M | 3.8% | 30 y, 7 y grace | $3.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $25 M | 9.5% | 30 y, 7 y grace | $2.7 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$99 M** | | | **$6.6 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.3 M / yr + bonds $2.4 M / yr = **$4.6 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 15,705 | 26,175 | 18,117 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 6% | 10% | 7% |
| Annual paid trips | 5.7 M | 9.6 M | 6.6 M |
| Farebox revenue | $1.9 M / yr | $3.2 M / yr | $2.2 M / yr |
| Station shop leases | $127 k / yr | $127 k / yr | $127 k / yr |
| Advertising boards | $207 k / yr | $207 k / yr | $207 k / yr |
| **Total revenue** | **$2.2 M / yr** | **$3.5 M / yr** | **$2.5 M / yr** |
| Revenue / OPEX recovery | 88% | 139% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $6.9 M / yr | $6.6 M / yr | **$6.6 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $971 k / yr | $0 / yr |
