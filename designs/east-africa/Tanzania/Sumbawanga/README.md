...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$217 M (88.0%) of external capital** and **$272 M of external interest**. Capital plus saved interest totals **$490 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 77.2% |
| Route length (double track) | 15.7 km |
| Revenue fleet | 34 × 2-car trainsets |
| Revenue fleet passenger capacity | 8,160 AW2 pax (10,880 AW3 crush) |
...
| Revenue fleet capacity | 8,160 AW2 pax (10,880 AW3 crush) |
| Total fleet capacity | 9,600 AW2 pax (12,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 34 × 240 = **8,160 AW2 passengers** (10,880 AW3 crush)
- **Total fleet passenger capacity:** 40 × 240 = **9,600 AW2 passengers** (12,800 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 77.2%
- Catchment population: **≈ 193,000** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **5,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **2.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 30 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 50 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 7,285 train-km/day | One-way train journeys × route length |
| Annual service work | 2.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 63 MWh/day | 5.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 13 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 2.3 MW / 15 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 37 kWh | 90 kWh | 49 kWh | 2.5 km / 14 kWh |
| line-2 | 3 | 32 kWh | 65 kWh | 30 kWh | 3.4 km / 19 kWh |
| line-3 | 3 | 18 kWh | 65 kWh | 45 kWh | 1.6 km / 9 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (15.5 km @ $2.58 M/km) | $40 M |
| Elevated (0.2 km @ $9.75 M/km) | $1.6 M |
| **Civil subtotal** | **$42 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 40 | $560 k | $22 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 80 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 80 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 2,280 kW @ $700/kW | $1.6 M |
| Grid interconnection / PPA tie-in | 2,280 kW @ $100/kW | $228 k |
| Annual generation proxy | 2.3 MW × 6.5 peak-sun-h/day × 365 d/yr | 5.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$1.8 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 15.7 km × $0.050 M/km | $783 k |
...
|---|---:|---:|---:|---:|
| Civil works | $42 M | 15% | $6.2 M | $35 M |
| Stations | $52 M | 20% | $10 M | $42 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $22 M | 35% | $7.8 M | $15 M |
| Dedicated solar plant | $1.8 M | 45% | $821 k | $1.0 M |
| Residual signalling / train control | $783 k | 50% | $392 k | $392 k |
| Charging microgrids | $1.1 M | 40% | $460 k | $690 k |
| EPC / project services | $8.9 M | 15% | $1.3 M | $7.5 M |
| **Total city CAPEX** | **$137 M** | **21.6%** | **$30 M** | **$108 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sumbawanga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.6%** | **$30 M** | **$4.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.4%** | **$108 M** | **$15 M / yr** |
| of which planned local bond issuance | 62.7% of total CAPEX | $86 M | $12 M / yr |
| **Total city programme** | **100.0%** | **$137 M** | **$20 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $185 M | $156 M (84.0%) | $195 M | **$351 M** |
| **Default** | 2.00× | $247 M | $217 M (88.0%) | $272 M | **$490 M** |
| High | 3.00× | $370 M | $341 M (92.0%) | $427 M | **$768 M** |

At the default 2.00× case, OSR's $30 M external requirement is 88.0% below the illustrative foreign-company requirement of $247 M; the associated lifetime external-interest saving is $272 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$13 M / yr** | $50 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$88 M cumulative** | $352 |
| Lifecycle envelope (yr 1–40, high scenario) | **$88 M cumulative** | $352 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$429 M cumulative** | $1,718 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $30 M | 4.5% | 40 y, 7 y grace | $1.7 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $86 M | 9.5% | 40 y, 7 y grace | $8.6 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $22 M | — | — | — |
| **Total** | **100%** | **$137 M** | | | **$10 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.3 M / yr + local bonds $8.2 M / yr = **$9.5 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $896 k |
...
| Traction energy (23.0 GWh / yr) | 7,285 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 18.3 GWh/yr + dedicated solar plant 2.3 MW / 5.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $27 k |
| Labour (191 FTE) | driverless roster: OCC/remote 41, station/platform 51, passenger service 38, fleet maintenance 22, infrastructure/energy 18, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $529 k |
| **OPEX subtotal** | | **$3.5 M / yr** |

_Annual service work: 7,285 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.9 M train-km / yr (5.7 M car-km / yr). On-site PV covers 18.3 GWh/yr and the dedicated solar plant adds 5.4 GWh/yr against 23.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 40 trainsets, 10 stations, 15.7 route-km, 3 lines, and 7,285 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 6.2 M |
| Annual paid trips / city resident | 196 | 313 | 25 |
| Farebox revenue | $22 M / yr | $34 M / yr | $2.7 M / yr |
| Station shop leases | $300 k / yr | $300 k / yr | $300 k / yr |
| Advertising boards | $485 k / yr | $485 k / yr | $485 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$3.5 M / yr** |
| Revenue / OPEX recovery | 631% | 996% | 100% |
...
| Operating surplus after OPEX (before debt support) | $19 M / yr | $32 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,152 m² of station shop/kiosk leases at $13/m²/month and 412 advertising boards at $115/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $19 M / yr | $31 M / yr | 26% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $8.4 M / yr | $13 M / yr | 12% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$42 M / yr** | **$67 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 4 healthcare anchors | 13,660 trips/day; 5.0 M access-events/yr | 21,856 trips/day; 8.0 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 35,489 trips/trading day; 11.7 M access-events/yr | 56,782 trips/trading day; 18.7 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 15,401 trips/activity day; 4.6 M access-events/yr | 24,641 trips/activity day; 7.4 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $108 M | 78% of $137 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $172 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $25 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 13,581 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $135 M |
| Timetable-sized dedicated solar CAPEX | $1.8 M |
| **Reconciled project CAPEX** | **$137 M** |
| Imported / external-capital requirement | $30 M (21.6%) |
| Local-content / local-funding requirement | $108 M (78.4%) |
| Default foreign-turnkey external-capital comparison | $247 M; OSR saves $217 M (88.0%) |
| Lifetime external interest and combined financing saving | $272 M interest; $490 M capital + interest |
| 15%–25% planning risk envelope | $158 M–$171 M |
| Annual OPEX | $3.5 M / yr |
| Low/high project NPV at 8% | $24 M / $111 M |
| Low/high project IRR | 9.7% / 14.6% |
| Low/high steady-state DSCR | 1.81 / 3.06 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 748.84 train-km; 4,169.82 kWh consumed; 4,651.16 kWh charged; 43 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 7,569.77 train-km; 42,151.58 kWh consumed; 42,995.19 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 88.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 88.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 89.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 73.2% | 100.0% / 90% | pass |
...
|---|---|
| ![Sumbawanga energy and battery simulation dashboard](engineering/screenshots/sumbawanga-simulation-dashboard.png) | ![Sumbawanga simulator network visualizer](engineering/screenshots/sumbawanga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 10 line platforms, 1 interchange complexes, 14 civil segments, and 0 input findings |
...
|---|---|
| ![Sumbawanga QGIS engineering layers](engineering/screenshots/sumbawanga-qgis-engineering-map.png) | ![Sumbawanga SUMO timetable validation](engineering/screenshots/sumbawanga-sumo-validation.png) |
