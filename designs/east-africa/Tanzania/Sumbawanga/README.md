...
| Revenue fleet passenger capacity | 11,760 AW2 pax (15,680 AW3 crush) |
...
|---|---|---|---|---|
| line-1 |  6.6 km | 5 | 23 | E Mid ↔ NW Outer |
| line-2 |  5.7 km | 4 | 19 | S Outer ↔ NE Mid |
| line-3 |  3.3 km | 4 | 14 | N Mid ↔ S Mid |
| **Total** | **15.7 km** | **13 unique** | **56** | |
...
| Revenue fleet capacity | 11,760 AW2 pax (15,680 AW3 crush) |
| Total fleet capacity | 13,440 AW2 pax (17,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 49 × 240 = **11,760 AW2 passengers** (15,680 AW3 crush)
- **Total fleet passenger capacity:** 56 × 240 = **13,440 AW2 passengers** (17,920 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **1.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 26.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 346 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 1.2 MW / 8 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 37 kWh | 106 kWh | 65 kWh | 2.5 km / 14 kWh |
| line-2 | 4 | 32 kWh | 82 kWh | 46 kWh | 2.4 km / 13 kWh |
| line-3 | 4 | 18 kWh | 82 kWh | 62 kWh | 1.3 km / 7 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 56 | $560 k | $31 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 112 | $60 k | $6.7 M |
| High sensitivity check | 112 | $120 k | $13 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 1,245 kW @ $700/kW | $872 k |
| Grid interconnection / PPA tie-in | 1,245 kW @ $100/kW | $125 k |
| Annual generation proxy | 1.2 MW × 6.5 peak-sun-h/day × 365 d/yr | 3.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$996 k** |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$373 M cumulative** | $1,493 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $149 M | 4.5% | 40 y, 7 y grace | $8.8 M / yr |
| Government equity (no debt service) | 20% | $37 M | — | — | — |
| **Total** | **100%** | **$186 M** | | | **$8.8 M / yr** |
...
| Traction energy (23.0 GWh / yr) | 7,285 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.4 GWh/yr + dedicated solar plant 1.2 MW / 3.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $15 k |
| Labour (229 FTE) | driverless roster: OCC/remote 49, station/platform 75, passenger service 38, fleet maintenance 27, infrastructure/energy 19, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $635 k |
| **OPEX subtotal** | | **$4.6 M / yr** |

_Annual service work: 7,285 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.9 M train-km / yr (5.7 M car-km / yr). On-site PV covers 20.4 GWh/yr and the dedicated solar plant adds 3.0 GWh/yr against 23.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 56 trainsets, 13 stations, 15.7 route-km, 3 lines, and 7,285 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 196 | 313 | 32 |
| Farebox revenue | $22 M / yr | $34 M / yr | $3.5 M / yr |
| Station shop leases | $440 k / yr | $440 k / yr | $440 k / yr |
| Advertising boards | $683 k / yr | $683 k / yr | $683 k / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$4.6 M / yr** |
| Revenue / OPEX recovery | 492% | 772% | 100% |
...
_Commercial-revenue assumptions: 3,160 m² of station shop/kiosk leases at $13/m²/month and 580 advertising boards at $115/board/month, with occupancy derates applied._
...
| Commerce | 13 major/terminal/interchange nodes | 35,489 trips/trading day; 11.7 M access-events/yr | 56,782 trips/trading day; 18.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $109 M | 59% of $186 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $175 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $25 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 13,778 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $185 M |
| Timetable-sized dedicated solar CAPEX | $996 k |
| **Reconciled project CAPEX** | **$186 M** |
| 15%–25% planning risk envelope | $214 M–$233 M |
| Annual OPEX | $4.6 M / yr |
| Low/high project NPV at 8% | $-17506 k / $69 M |
| Low/high project IRR | 7.0% / 11.4% |
| Low/high steady-state DSCR | 2.06 / 3.53 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 740.87 train-km; 4,125.45 kWh consumed; 4,707.67 kWh charged; 41 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 7,596.16 train-km; 42,298.24 kWh consumed; 43,517.61 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 90%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 89.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 89.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 90.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 53.1% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 89.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 13 line platforms, 1 interchange complexes, 14 civil segments, and 0 input findings |
