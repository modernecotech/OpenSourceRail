...
| Manufacturing schedule rows | 498 |
| Manufacturing material/BOM rows | 7,396 |
| Manufacturing QA verification rows | 498 |
| Construction QA action rows | 464 |
| Maintenance handover schedule rows | 588 |
| Manufacturing rows with material refs | 498 / 498 |
| Manufacturing rows with verification refs | 498 / 498 |
| Manufacturing rows linked to QA actions | 498 / 498 |
...
|---|---:|
| `project_kit` | 844 |
| `rolling_stock_bom` | 6,160 |
| `rolling_stock_cots_fitout` | 392 |
