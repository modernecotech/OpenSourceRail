# Moshi Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 251 |
| Manufacturing schedule rows | 959 |
| Manufacturing material/BOM rows | 14,447 |
| Manufacturing QA verification rows | 959 |
| Construction QA action rows | 893 |
| Maintenance handover schedule rows | 1,140 |
| Manufacturing rows with material refs | 959 / 959 |
| Manufacturing rows with verification refs | 959 / 959 |
| Manufacturing rows linked to QA actions | 959 / 959 |
...
- Operations bundle: [`moshi-operations.json.gz`](moshi-operations.json.gz)
- Evidence matrix CSV: [`moshi-acceptance-evidence-matrix.csv`](moshi-acceptance-evidence-matrix.csv)
- Manufacturing schedule CSV: [`moshi-manufacturing-schedule.csv`](moshi-manufacturing-schedule.csv)
- Manufacturing materials CSV: [`moshi-manufacturing-materials.csv`](moshi-manufacturing-materials.csv)
- Manufacturing verification CSV: [`moshi-manufacturing-verification.csv`](moshi-manufacturing-verification.csv)
- QA register CSV: [`moshi-qa-register.csv`](moshi-qa-register.csv)
- Maintenance schedule CSV: [`moshi-maintenance-schedule.csv`](moshi-maintenance-schedule.csv)
