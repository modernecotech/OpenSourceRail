...
| Bucket | Value |
|---|---|
| At-grade (28.9 km @ $0.85 M/km) | $25 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 35.7 km × $0.015 M/km | $536 k |
...
| Steady-state, low-ridership (year 8+) | **$7.0 M / yr** | $23 |
| Steady-state, high-ridership (year 8+) | **$4.5 M / yr** | $15 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$218 M cumulative** | $725 |
| Lifecycle envelope (yr 1–30, high scenario) | **$159 M cumulative** | $532 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$57 M cumulative** | $190 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $72 M | 3.8% | 30 y, 7 y grace | $4.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $30 M | 9.5% | 30 y, 7 y grace | $3.2 M / yr |
| Government equity (no debt service) | 15% | $18 M | — | — | — |
| **Total** | **100%** | **$120 M** | | | **$8.0 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.7 M / yr + bonds $2.8 M / yr = **$5.6 M / yr** total — plus the equity tranche amortised across construction ($2.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 81,989 |
| Daily paid trips / population | 8% | 15% | 27% |
| Annual paid trips | 8.8 M | 16.4 M | 29.9 M |
| Farebox revenue | $2.9 M / yr | $5.4 M / yr | $9.9 M / yr |
| Station shop leases | $554 k / yr | $554 k / yr | $554 k / yr |
| Advertising boards | $881 k / yr | $881 k / yr | $881 k / yr |
| **Total revenue** | **$4.3 M / yr** | **$6.9 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 38% | 61% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $7.0 M / yr | $4.5 M / yr | **$0 / yr** |
