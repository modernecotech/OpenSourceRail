...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **41,202 – 68,670 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$26 M / yr** | $85 |
| Steady-state, low-ridership (year 8+) | **$27 M / yr** | $89 |
| Steady-state, high-ridership (year 8+) | **$25 M / yr** | $84 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $84 |
| Lifecycle envelope (yr 1–30, low scenario) | **$792 M cumulative** | $2,641 |
| Lifecycle envelope (yr 1–30, high scenario) | **$755 M cumulative** | $2,516 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$755 M cumulative** | $2,516 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.6 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $225 M | 3.8% | 30 y, 7 y grace | $15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $94 M | 9.5% | 30 y, 7 y grace | $10 M / yr |
| Government equity (no debt service) | 15% | $56 M | — | — | — |
| **Total** | **100%** | **$376 M** | | | **$25 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.6 M / yr + bonds $8.9 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($8.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (226 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $626 k |
...
|---|---|---|---|
| Daily paid trips | 41,202 | 68,670 | 54,753 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 14% | 23% | 18% |
| Annual paid trips | 15.0 M | 25.1 M | 20.0 M |
| Farebox revenue | $5.0 M / yr | $8.3 M / yr | $6.6 M / yr |
| Station shop leases | $554 k / yr | $554 k / yr | $554 k / yr |
| Advertising boards | $881 k / yr | $881 k / yr | $881 k / yr |
| **Total revenue** | **$6.4 M / yr** | **$9.7 M / yr** | **$8.0 M / yr** |
| Revenue / OPEX recovery | 80% | 121% | 100% |
