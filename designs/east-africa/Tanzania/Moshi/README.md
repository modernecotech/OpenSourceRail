...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$472 M (88.0%) of external capital** and **$591 M of external interest**. Capital plus saved interest totals **$1.06 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 36.1 km |
...
| Total fleet capacity | 17,520 AW2 pax (23,360 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 73 × 240 = **17,520 AW2 passengers** (23,360 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 76.1%
- Catchment population: **≈ 228,300** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **24.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 20 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 16,778 train-km/day | One-way train journeys × route length |
| Annual service work | 6.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 145 MWh/day | 13.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 102 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 24.5 MW / 118 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 76 kWh | 139 kWh | 55 kWh | 4.9 km / 24 kWh |
| line-2 | 5 | 55 kWh | 98 kWh | 37 kWh | 3.1 km / 15 kWh |
| line-3 | 3 | 49 kWh | 74 kWh | 20 kWh | 6.3 km / 32 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (31.6 km @ $2.58 M/km) | $82 M |
| Elevated (4.5 km @ $9.75 M/km) | $44 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 73 | $560 k | $41 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 146 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 146 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 24,495 kW @ $700/kW | $17 M |
| Grid interconnection / PPA tie-in | 24,495 kW @ $100/kW | $2.4 M |
| Annual generation proxy | 24.5 MW × 4.8 peak-sun-h/day × 365 d/yr | 42.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 36.1 km × $0.050 M/km | $1.8 M |
...
| Rolling stock | $41 M | 35% | $14 M | $27 M |
| Dedicated solar plant | $20 M | 45% | $8.8 M | $11 M |
| Residual signalling / train control | $1.8 M | 50% | $902 k | $902 k |
| Charging microgrids | $1.6 M | 40% | $650 k | $975 k |
| EPC / project services | $18 M | 15% | $2.7 M | $15 M |
| **Total city CAPEX** | **$298 M** | **21.6%** | **$64 M** | **$233 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh moshi`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.6%** | **$64 M** | **$9.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.4%** | **$233 M** | **$33 M / yr** |
| of which planned local bond issuance | 62.7% of total CAPEX | $187 M | $27 M / yr |
| **Total city programme** | **100.0%** | **$298 M** | **$43 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $402 M | $338 M (84.0%) | $423 M | **$761 M** |
| **Default** | 2.00× | $536 M | $472 M (88.0%) | $591 M | **$1.06 bn** |
| High | 3.00× | $804 M | $740 M (92.0%) | $927 M | **$1.67 bn** |

At the default 2.00× case, OSR's $64 M external requirement is 88.0% below the illustrative foreign-company requirement of $536 M; the associated lifetime external-interest saving is $591 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$27 M / yr** | $91 |
| Steady-state, low capacity-use (year 8+) | **$7.0 M / yr** | $23 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $75 |
| Lifecycle envelope (yr 1–40, low scenario) | **$422 M cumulative** | $1,407 |
| Lifecycle envelope (yr 1–40, high scenario) | **$191 M cumulative** | $637 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$932 M cumulative** | $3,107 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $15 M / yr → $22 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $64 M | 4.5% | 40 y, 7 y grace | $3.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $187 M | 9.5% | 40 y, 7 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $47 M | — | — | — |
| **Total** | **100%** | **$298 M** | | | **$22 M / yr** |
...
| Traction energy (52.9 GWh / yr) | 16,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 24.5 MW / 42.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $294 k |
| Labour (256 FTE) | driverless roster: OCC/remote 57, station/platform 63, passenger service 38, fleet maintenance 44, infrastructure/energy 33, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $710 k |
| **OPEX subtotal** | | **$7.0 M / yr** |

_Annual service work: 16,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.6 M train-km / yr (13.2 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 42.9 GWh/yr against 52.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 73 trainsets, 14 stations, 36.1 route-km, 3 lines, and 16,778 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 13.8 M |
| Annual paid trips / city resident | 163 | 261 | 46 |
| Farebox revenue | $22 M / yr | $34 M / yr | $6.1 M / yr |
| Station shop leases | $379 k / yr | $379 k / yr | $379 k / yr |
| Advertising boards | $613 k / yr | $613 k / yr | $613 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$7.0 M / yr** |
| Revenue / OPEX recovery | 319% | 503% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $22 M / yr | $22 M / yr | **$22 M / yr** |
| Operating surplus applied to debt support | -$15 M / yr | -$22 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $7.0 M / yr | $0 k / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $15 M / yr | $28 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,720 m² of station shop/kiosk leases at $13/m²/month and 520 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $6.4 M / yr | $10 M / yr | 79 M - 127 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.1 M / yr | $1.8 M / yr | 14.3–22.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.2 M / yr | $5.1 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 7,987 trips/school day; 1.8 M access-events/yr | 12,778 trips/school day; 2.8 M access-events/yr |
| Healthcare | 4 healthcare anchors | 12,126 trips/day; 4.4 M access-events/yr | 19,401 trips/day; 7.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $233 M | 78% of $298 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $373 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $53 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 29,463 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $20 M |
| **Reconciled project CAPEX** | **$298 M** |
| Imported / external-capital requirement | $64 M (21.6%) |
| Local-content / local-funding requirement | $233 M (78.4%) |
| Default foreign-turnkey external-capital comparison | $536 M; OSR saves $472 M (88.0%) |
| Lifetime external interest and combined financing saving | $591 M interest; $1.06 bn capital + interest |
| 15%–25% planning risk envelope | $342 M–$372 M |
| Annual OPEX | $7.0 M / yr |
| Low/high project NPV at 8% | $-117664 k / $-30968 k |
| Low/high project IRR | 2.9% / 6.9% |
| Low/high steady-state DSCR | 0.69 / 1.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,514.93 train-km; 7,563.19 kWh consumed; 7,788.90 kWh charged; 37 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,117.86 train-km; 80,467.61 kWh consumed; 81,838.51 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 96.1% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 41.9% | 96.1% / 90% | pass |
| maximum planning climate/HVAC duty | 40.2% | 96.1% / 90% | pass |
| 50% charging-contact availability | 52.5% | 96.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.0% / 60% | pass |
| ten-hour single charging-pad outage | 52.5% | 96.1% / 90% | pass |
...
|---|---|
| ![Moshi energy and battery simulation dashboard](engineering/screenshots/moshi-simulation-dashboard.png) | ![Moshi simulator network visualizer](engineering/screenshots/moshi-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
...
|---|---|
| ![Moshi QGIS engineering layers](engineering/screenshots/moshi-qgis-engineering-map.png) | ![Moshi SUMO timetable validation](engineering/screenshots/moshi-sumo-validation.png) |
