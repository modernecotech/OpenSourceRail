...
|---|---|---|---|---|
| line-1 | 15.3 km | 9 | 45 | E Outer ↔ SW Mid |
| line-2 | 11.1 km | 8 | 35 | NW Outer ↔ S Mid |
| line-3 |  9.8 km | 7 | 30 | NW Mid ↔ E Mid |
| **Total** | **36.1 km** | **24 unique** | **110** | |
...
| Total fleet capacity | 26,400 AW2 pax (35,200 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 110 × 240 = **26,400 AW2 passengers** (35,200 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 29.7× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-1) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 76 kWh | 172 kWh | 88 kWh | 2.4 km / 12 kWh |
| line-2 | 8 | 55 kWh | 147 kWh | 86 kWh | 2.0 km / 10 kWh |
| line-3 | 7 | 49 kWh | 131 kWh | 77 kWh | 2.0 km / 10 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 110 | $560 k | $62 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 220 | $60 k | $13 M |
| High sensitivity check | 220 | $120 k | $26 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 21,045 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 21,045 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 21.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 36.9 GWh/yr |
...
| Steady-state, low capacity-use (year 8+) | **$5.6 M / yr** | $19 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$369 M cumulative** | $1,230 |
| Lifecycle envelope (yr 1–40, high scenario) | **$185 M cumulative** | $616 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$819 M cumulative** | $2,729 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $14 M / yr → $19 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $327 M | 4.5% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $82 M | — | — | — |
| **Total** | **100%** | **$409 M** | | | **$19 M / yr** |
...
| Traction energy (52.9 GWh / yr) | 16,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.8 GWh/yr + dedicated solar plant 21.0 MW / 36.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $253 k |
| Labour (324 FTE) | driverless roster: OCC/remote 73, station/platform 100, passenger service 38, fleet maintenance 56, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $898 k |
| **OPEX subtotal** | | **$9.4 M / yr** |

_Annual service work: 16,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.6 M train-km / yr (13.2 M car-km / yr). On-site PV covers 20.8 GWh/yr and the dedicated solar plant adds 36.9 GWh/yr against 52.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 110 trainsets, 24 stations, 36.1 route-km, 3 lines, and 16,778 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 17.9 M |
| Annual paid trips / city resident | 163 | 261 | 60 |
...
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$9.4 M / yr** |
| Revenue / OPEX recovery | 244% | 381% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $19 M / yr | $19 M / yr | **$19 M / yr** |
| Operating surplus applied to debt support | -$14 M / yr | -$19 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.6 M / yr | $0 k / yr | **$19 M / yr** |
...
| Healthcare | 3 healthcare anchors | 10,144 trips/day; 3.7 M access-events/yr | 16,231 trips/day; 5.9 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 29,630 trips/trading day; 9.8 M access-events/yr | 47,408 trips/trading day; 15.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $238 M | 58% of $409 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $381 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $54 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 30,073 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-212459 k / $-125763 k |
| Low/high project IRR | 0.5% / 4.3% |
| Low/high steady-state DSCR | 0.71 / 1.38 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,533.49 train-km; 7,655.79 kWh consumed; 8,553.71 kWh charged; 35 depot services completed; minimum SoC 92%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,412.75 train-km; 86,931.36 kWh consumed; 89,311.02 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 92%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 91.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 87.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 91.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 21.2% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 88.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
