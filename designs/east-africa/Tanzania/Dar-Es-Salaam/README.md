...
| Revenue fleet | 814 × 6-car trainsets |
| Revenue fleet passenger capacity | 586,080 AW2 pax (781,440 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 55.0 km | 29 | 130 | S Outer ↔ N Mid |
| line-2 | 59.0 km | 31 | 138 | SE Mid ↔ NW Outer |
| line-3 | 49.0 km | 23 | 113 | W Inner ↔ SE Outer |
| line-4 | 48.0 km | 25 | 113 | N Mid ↔ S Mid |
| line-5 | 35.9 km | 20 | 89 | S Mid ↔ NE Inner |
| line-6 | 39.5 km | 18 | 95 | NW Outer ↔ S Inner |
| line-7 | 34.2 km | 17 | 81 | NE Inner ↔ W Mid |
| line-8 | 37.4 km | 19 | 89 | NE Inner ↔ SW Mid |
| line-9 | 85.6 km | 52 | 53 | W Mid ↔ W Mid |
| **Total** | **443.7 km** | **234 unique** | **901** | |
...
| Revenue fleet capacity | 586,080 AW2 pax (781,440 AW3 crush) |
| Total fleet capacity | 648,720 AW2 pax (864,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 814 × 720 = **586,080 AW2 passengers** (781,440 AW3 crush)
- **Total fleet passenger capacity:** 901 × 720 = **648,720 AW2 passengers** (864,960 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 108 | 300 kW | 2000 kWh |
| Terminal | 15 | 300 kW | 2000 kWh |
| **Total installed** | **194** | **62,900 kW** | **426,000 kWh** |

Aggregate station-rail charging power: **388,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **1,085.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 3.5× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 771 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 351 kWh | line-7 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 302 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 4,530 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 1,085.4 MW / 5,210 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 426 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 24 | 823 kWh | 1,633 kWh | 728 kWh | 14.5 km / 217 kWh |
| line-2 | 25 | 883 kWh | 1,731 kWh | 760 kWh | 15.9 km / 237 kWh |
| line-3 | 18 | 734 kWh | 1,241 kWh | 433 kWh | 18.9 km / 283 kWh |
| line-4 | 20 | 719 kWh | 1,372 kWh | 581 kWh | 12.8 km / 192 kWh |
| line-5 | 18 | 538 kWh | 1,241 kWh | 650 kWh | 9.0 km / 135 kWh |
| line-6 | 12 | 592 kWh | 1,013 kWh | 361 kWh | 20.6 km / 309 kWh |
| line-7 | 13 | 513 kWh | 915 kWh | 351 kWh | 10.0 km / 150 kWh |
| line-8 | 15 | 560 kWh | 1,045 kWh | 429 kWh | 13.8 km / 206 kWh |
| line-9 | 49 | 1,283 kWh | 3,201 kWh | 1,791 kWh | 5.7 km / 85 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (398.9 km @ $3.0 M/km) | $1.20 bn |
| Elevated (44.8 km @ $12.0 M/km) | $538 M |
| Elevated-interchange premium (17 sites @ $4.50 M) | $76 M |
| **Civil subtotal** | **$1.81 bn** |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 901 | $1.68 M | $1.51 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 5406 | $60 k | $324 M |
| High sensitivity check | 5406 | $120 k | $649 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 1,085,356 kW @ $700/kW | $760 M |
| Grid interconnection / PPA tie-in | 1,085,356 kW @ $100/kW | $109 M |
| Annual generation proxy | 1,085.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 1,901.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$868 M** |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $84 M |
| EPC integration + project management (7%) | on subtotal | $341 M |
...
| Railway production plant | $324 M |
| Dedicated solar power plant | $868 M |
| Residual train-control wayside + charging microgrids | $106 M |
| EPC overhead (7%) | $341 M |
| **CAPEX total** | **$6.09 bn** |
...
|---|---|---|
| Construction (years 1–7) | **$393 M / yr** | $53 |
| Steady-state, low capacity-use (year 8+) | **$231 M / yr** | $31 |
| Steady-state, high capacity-use (year 8+) | **$121 M / yr** | $16 |
| Steady-state, operating-neutral revenue case | **$286 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$10.36 bn cumulative** | $1,399 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.74 bn cumulative** | $910 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$12.19 bn cumulative** | $1,647 |

_Population basis: 7,404,689 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $56 M / yr → $165 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $4.87 bn | 4.5% | 40 y, 7 y grace | $286 M / yr |
| Government equity (no debt service) | 20% | $1.22 bn | — | — | — |
| **Total** | **100%** | **$6.09 bn** | | | **$286 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $219 M / yr = **$219 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($174 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (1763.7 GWh / yr) | 186,424 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 110.2 GWh/yr + dedicated solar plant 1085.4 MW / 1901.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $13 M |
| Labour (2,470 FTE) | driverless roster: OCC/remote 458, station/platform 857, passenger service 231, fleet maintenance 516, infrastructure/energy 375, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $6.8 M |
| **OPEX subtotal** | | **$140 M / yr** |

_Annual service work: 186,424 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 73.5 M train-km / yr (440.9 M car-km / yr). On-site PV covers 110.2 GWh/yr and the dedicated solar plant adds 1901.5 GWh/yr against 1763.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 901 trainsets, 234 stations, 443.7 route-km, 9 lines, and 186,424 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 289.3 M |
| Annual paid trips / city resident | 56 | 90 | 39 |
| Farebox revenue | $183 M / yr | $293 M / yr | $127 M / yr |
| Station shop leases | $5.0 M / yr | $5.0 M / yr | $5.0 M / yr |
| Advertising boards | $7.9 M / yr | $7.9 M / yr | $7.9 M / yr |
| **Total revenue** | **$196 M / yr** | **$305 M / yr** | **$140 M / yr** |
| Revenue / OPEX recovery | 140% | 218% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $286 M / yr | $286 M / yr | **$286 M / yr** |
| Operating surplus applied to debt support | -$56 M / yr | -$165 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $231 M / yr | $121 M / yr | **$286 M / yr** |
| Operating surplus after OPEX (before debt support) | $56 M / yr | $165 M / yr | $0 / yr |

_Commercial-revenue assumptions: 36,032 m² of station shop/kiosk leases at $13/m²/month and 6,696 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 24 education anchors | 71,644 trips/school day; 15.8 M access-events/yr | 114,630 trips/school day; 25.2 M access-events/yr |
| Healthcare | 22 healthcare anchors | 86,915 trips/day; 31.7 M access-events/yr | 139,064 trips/day; 50.8 M access-events/yr |
| Commerce | 86 major/terminal/interchange nodes | 226,059 trips/trading day; 74.6 M access-events/yr | 361,694 trips/trading day; 119.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.27 bn | 54% of $6.09 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.23 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $746 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 412,339 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $5.22 bn |
| Timetable-sized dedicated solar CAPEX | $868 M |
| **Reconciled project CAPEX** | **$6.09 bn** |
| 15%–25% planning risk envelope | $7.00 bn–$7.61 bn |
| Annual OPEX | $140 M / yr |
| Low/high project NPV at 8% | $-4154771 k / $-3417857 k |
| Low/high project IRR | -5.2% / -0.5% |
| Low/high steady-state DSCR | 0.19 / 0.58 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 11,145.42 train-km; 166,911.87 kWh consumed; 167,647.98 kWh charged; 22 depot services completed; minimum SoC 67%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 187,716.67 train-km; 2,811,211.93 kWh consumed; 2,852,725.43 kWh charged; 1,581 depot services completed (1 active at cutoff); minimum SoC 51%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 41.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 51.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 84.5% / 60% | pass |
| ten-hour single charging-pad outage | 51.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 234 line platforms, 19 interchange complexes, 299 civil segments, and 0 input findings |
