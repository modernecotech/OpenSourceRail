...
|---|---|---|
| Construction (years 1–7) | **$170 M / yr** | $23 |
| Steady-state, low-ridership (year 8+) | **$177 M / yr** | $24 |
| Steady-state, high-ridership (year 8+) | **$167 M / yr** | $23 |
| Steady-state, operating-neutral revenue case | **$167 M / yr** | $23 |
| Lifecycle envelope (yr 1–30, low scenario) | **$5.27 bn cumulative** | $712 |
| Lifecycle envelope (yr 1–30, high scenario) | **$5.04 bn cumulative** | $680 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.04 bn cumulative** | $680 |

_Population basis: 7,404,689 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $10 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.50 bn | 3.8% | 30 y, 7 y grace | $99 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $627 M | 9.5% | 30 y, 7 y grace | $68 M / yr |
| Government equity (no debt service) | 15% | $376 M | — | — | — |
| **Total** | **100%** | **$2.51 bn** | | | **$167 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $57 M / yr + bonds $60 M / yr = **$117 M / yr** total — plus the equity tranche amortised across construction ($54 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 366,532 | 610,886 | 451,879 |
| Daily paid trips / catchment | 18% | 30% | 22% |
| Daily paid trips / city population | 5% | 8% | 6% |
| Annual paid trips | 133.8 M | 223.0 M | 164.9 M |
| Farebox revenue | $44 M / yr | $74 M / yr | $54 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| **Total revenue** | **$53 M / yr** | **$82 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 84% | 130% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $177 M / yr | $167 M / yr | **$167 M / yr** |
