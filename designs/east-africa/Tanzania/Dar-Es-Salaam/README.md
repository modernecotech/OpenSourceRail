...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **509,072 – 916,330 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$181 M / yr** | $24 |
| Steady-state, low-ridership (year 8+) | **$291 M / yr** | $39 |
| Steady-state, high-ridership (year 8+) | **$226 M / yr** | $30 |
| Steady-state, operating-neutral revenue case | **$155 M / yr** | $21 |
| Lifecycle envelope (yr 1–40, low scenario) | **$10.88 bn cumulative** | $1,469 |
| Lifecycle envelope (yr 1–40, high scenario) | **$8.72 bn cumulative** | $1,177 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.40 bn cumulative** | $864 |

_Population basis: 7,404,689 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $136 M / yr → $70 M / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $3.73 bn | 2.0% | 40 y, 7 y grace | $155 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 9.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $746 M | — | — | — |
| **Total** | **100%** | **$7.46 bn** | | | **$155 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $75 M / yr + fallback bonds $0 k / yr = **$75 M / yr** total. The $2.98 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($107 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (2196.7 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (2,371 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $6.6 M |
| **OPEX subtotal** | | **$226 M / yr** |

_Annual fleet utilisation: 466 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 91.5 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 509,072 | 916,330 | 1,354,548 |
| Daily paid trips / catchment | 25% | 45% | 67% |
| Daily paid trips / city population | 7% | 12% | 18% |
| Annual paid trips | 185.8 M | 334.5 M | 494.4 M |
| Farebox revenue | $82 M / yr | $147 M / yr | $218 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| **Total revenue** | **$90 M / yr** | **$156 M / yr** | **$226 M / yr** |
| Revenue / OPEX recovery | 40% | 69% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov repayable-debt service + residual OPEX subsidy | $291 M / yr | $226 M / yr | **$155 M / yr** |
