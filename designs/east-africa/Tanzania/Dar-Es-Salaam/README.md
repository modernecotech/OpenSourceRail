...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **203,628 – 305,443 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (358.1 km @ $0.85 M/km) | $304 M |
| Elevated (31.9 km @ $4.0 M/km) | $128 M |
| Elevated-interchange premium (11 sites @ $2.0 M) | $22 M |
| **Civil subtotal** | **$454 M** |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 314 | $1.60 M | $503 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 393.1 km × $0.015 M/km | $5.9 M |
...
| Per-capita (city pop) | $158 / person |
...
|---|---|---|
| Construction (years 1–7) | **$79 M / yr** | $11 |
| Steady-state, low-ridership (year 8+) | **$36 M / yr** | $5 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.39 bn cumulative** | $187 |
| Lifecycle envelope (yr 1–30, high scenario) | **$555 M cumulative** | $75 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$555 M cumulative** | $75 |

_Population basis: 7,404,689 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $700 M | 3.8% | 30 y, 7 y grace | $46 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $292 M | 9.5% | 30 y, 7 y grace | $32 M / yr |
| Government equity (no debt service) | 15% | $175 M | — | — | — |
| **Total** | **100%** | **$1.17 bn** | | | **$78 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $27 M / yr + bonds $28 M / yr = **$54 M / yr** total — plus the equity tranche amortised across construction ($25 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 592,375 | 1,110,703 | 891,926 |
| Daily paid trips / population | 8% | 15% | 12% |
| Annual paid trips | 216.2 M | 405.4 M | 325.6 M |
| Farebox revenue | $71 M / yr | $134 M / yr | $107 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| **Total revenue** | **$80 M / yr** | **$142 M / yr** | **$116 M / yr** |
| Revenue / OPEX + debt-service recovery | 69% | 123% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $36 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $26 M / yr | $0 / yr |
