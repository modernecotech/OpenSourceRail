...
| Per-capita (city pop) | $407 / person |
...
|---|---|---|
| Construction (years 1–7) | **$205 M / yr** | $28 |
| Steady-state, low-ridership (year 8+) | **$221 M / yr** | $30 |
| Steady-state, high-ridership (year 8+) | **$201 M / yr** | $27 |
| Steady-state, operating-neutral revenue case | **$201 M / yr** | $27 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.51 bn cumulative** | $880 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.06 bn cumulative** | $818 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$6.06 bn cumulative** | $818 |

_Population basis: 7,404,689 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $20 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.81 bn | 3.8% | 30 y, 7 y grace | $119 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $754 M | 9.5% | 30 y, 7 y grace | $82 M / yr |
| Government equity (no debt service) | 15% | $452 M | — | — | — |
| **Total** | **100%** | **$3.01 bn** | | | **$201 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $69 M / yr + bonds $72 M / yr = **$140 M / yr** total — plus the equity tranche amortised across construction ($65 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 366,532 | 610,886 | 530,784 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 5% | 8% | 7% |
| Annual paid trips | 133.8 M | 223.0 M | 193.7 M |
| Farebox revenue | $44 M / yr | $74 M / yr | $64 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| **Total revenue** | **$53 M / yr** | **$82 M / yr** | **$72 M / yr** |
| Revenue / OPEX recovery | 73% | 113% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $221 M / yr | $201 M / yr | **$201 M / yr** |
