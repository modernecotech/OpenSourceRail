...
| Revenue fleet | 76 × 2-car trainsets |
| Revenue fleet passenger capacity | 18,240 AW2 pax (24,320 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 11.3 km | 8 | 35 | NE Outer ↔ SW Outer |
| line-2 |  9.7 km | 7 | 30 | S Outer ↔ W Outer |
| line-3 |  6.0 km | 5 | 20 | NW Mid ↔ E Mid |
| **Total** | **27.1 km** | **20 unique** | **85** | |
...
| Revenue fleet capacity | 18,240 AW2 pax (24,320 AW3 crush) |
| Total fleet capacity | 20,400 AW2 pax (27,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 76 × 240 = **18,240 AW2 passengers** (24,320 AW3 crush)
- **Total fleet passenger capacity:** 85 × 240 = **20,400 AW2 passengers** (27,200 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **6.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 31.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 6.9 MW / 45 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 63 kWh | 155 kWh | 86 kWh | 2.0 km / 11 kWh |
| line-2 | 7 | 54 kWh | 131 kWh | 71 kWh | 2.1 km / 12 kWh |
| line-3 | 5 | 34 kWh | 98 kWh | 61 kWh | 2.0 km / 11 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (24.6 km @ $3.0 M/km) | $74 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 85 | $560 k | $48 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 170 | $60 k | $10 M |
| High sensitivity check | 170 | $120 k | $20 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 6,941 kW @ $700/kW | $4.9 M |
| Grid interconnection / PPA tie-in | 6,941 kW @ $100/kW | $694 k |
| Annual generation proxy | 6.9 MW × 6.5 peak-sun-h/day × 365 d/yr | 16.5 GWh/yr |
...
| Per-capita (city pop) | $1,268 / person |
...
|---|---|---|
| Construction (years 1–7) | **$20 M / yr** | $82 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$143 M cumulative** | $573 |
| Lifecycle envelope (yr 1–40, high scenario) | **$143 M cumulative** | $573 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$635 M cumulative** | $2,541 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $254 M | 4.5% | 40 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 20% | $63 M | — | — | — |
| **Total** | **100%** | **$317 M** | | | **$15 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $11 M / yr = **$11 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (39.7 GWh / yr) | 12,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 25.4 GWh/yr + dedicated solar plant 6.9 MW / 16.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $83 k |
| Labour (282 FTE) | driverless roster: OCC/remote 61, station/platform 90, passenger service 38, fleet maintenance 43, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $782 k |
| **OPEX subtotal** | | **$7.4 M / yr** |

_Annual service work: 12,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.0 M train-km / yr (9.9 M car-km / yr). On-site PV covers 25.4 GWh/yr and the dedicated solar plant adds 16.5 GWh/yr against 39.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 85 trainsets, 20 stations, 27.1 route-km, 3 lines, and 12,591 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $22 M / yr | $34 M / yr | $6.0 M / yr |
| Station shop leases | $544 k / yr | $544 k / yr | $544 k / yr |
| Advertising boards | $862 k / yr | $862 k / yr | $862 k / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$7.4 M / yr** |
| Revenue / OPEX recovery | 308% | 482% | 100% |
...
_Commercial-revenue assumptions: 3,904 m² of station shop/kiosk leases at $13/m²/month and 732 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 8,069 trips/school day; 1.8 M access-events/yr | 12,910 trips/school day; 2.8 M access-events/yr |
| Healthcare | 4 healthcare anchors | 10,848 trips/day; 4.0 M access-events/yr | 17,356 trips/day; 6.3 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 30,567 trips/trading day; 10.1 M access-events/yr | 48,908 trips/trading day; 16.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $186 M | 59% of $317 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $298 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $43 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 23,545 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $312 M |
| Timetable-sized dedicated solar CAPEX | $5.6 M |
| **Reconciled project CAPEX** | **$317 M** |
| 15%–25% planning risk envelope | $365 M–$396 M |
| Annual OPEX | $7.4 M / yr |
| Low/high project NPV at 8% | $-131843 k / $-45147 k |
| Low/high project IRR | 2.6% / 6.4% |
| Low/high steady-state DSCR | 1.04 / 1.90 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,198.65 train-km; 6,674.51 kWh consumed; 7,423.99 kWh charged; 37 depot services completed; minimum SoC 91%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,090.05 train-km; 72,890.29 kWh consumed; 74,707.81 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 91%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 90.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 89.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 91.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 52.8% | 100.0% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 28 civil segments, and 0 input findings |
