...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$360 M (88.3%) of external capital** and **$451 M of external interest**. Capital plus saved interest totals **$810 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`iringa.corridor.geojson`](iringa.corridor.geojson).
...
| Route length (double track) | 27.1 km |
...
| Total fleet capacity | 13,920 AW2 pax (18,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 51 × 240 = **12,240 AW2 passengers** (16,320 AW3 crush)
- **Total fleet passenger capacity:** 58 × 240 = **13,920 AW2 passengers** (18,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 73.2%
- Catchment population: **≈ 183,000** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **7,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **9.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 18.9× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 341 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 28 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 58 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 12,591 train-km/day | One-way train journeys × route length |
| Annual service work | 5.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 109 MWh/day | 9.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 51 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 9.0 MW / 59 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 63 kWh | 123 kWh | 53 kWh | 3.0 km / 17 kWh |
| line-2 | 5 | 54 kWh | 98 kWh | 38 kWh | 2.6 km / 15 kWh |
| line-3 | 3 | 34 kWh | 65 kWh | 28 kWh | 3.4 km / 19 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (25.7 km @ $3.0 M/km) | $77 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 58 | $560 k | $32 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 116 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 116 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 9,011 kW @ $700/kW | $6.3 M |
| Grid interconnection / PPA tie-in | 9,011 kW @ $100/kW | $901 k |
| Annual generation proxy | 9.0 MW × 6.5 peak-sun-h/day × 365 d/yr | 21.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$7.2 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 27.1 km × $0.050 M/km | $1.4 M |
...
| Dedicated solar power plant | $7.2 M |
...
|---|---:|---:|---:|---:|
| Civil works | $93 M | 15% | $14 M | $79 M |
| Stations | $68 M | 20% | $14 M | $54 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $32 M | 35% | $11 M | $21 M |
| Dedicated solar plant | $7.2 M | 45% | $3.2 M | $4.0 M |
| Residual signalling / train control | $1.4 M | 50% | $677 k | $677 k |
| Charging microgrids | $1.6 M | 40% | $620 k | $930 k |
| EPC / project services | $14 M | 15% | $2.1 M | $12 M |
| **Total city CAPEX** | **$226 M** | **21.1%** | **$48 M** | **$179 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh iringa`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.1%** | **$48 M** | **$6.8 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.9%** | **$179 M** | **$26 M / yr** |
| of which planned local bond issuance | 63.1% of total CAPEX | $143 M | $20 M / yr |
| **Total city programme** | **100.0%** | **$226 M** | **$32 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $305 M | $258 M (84.4%) | $323 M | **$581 M** |
| **Default** | 2.00× | $407 M | $360 M (88.3%) | $451 M | **$810 M** |
| High | 3.00× | $611 M | $563 M (92.2%) | $706 M | **$1.27 bn** |

At the default 2.00× case, OSR's $48 M external requirement is 88.3% below the illustrative foreign-company requirement of $407 M; the associated lifetime external-interest saving is $451 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $83 |
| Steady-state, low capacity-use (year 8+) | **$105 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$149 M cumulative** | $597 |
| Lifecycle envelope (yr 1–40, high scenario) | **$146 M cumulative** | $583 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$710 M cumulative** | $2,838 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $48 M | 4.5% | 40 y, 7 y grace | $2.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $143 M | 9.5% | 40 y, 7 y grace | $14 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $36 M | — | — | — |
| **Total** | **100%** | **$226 M** | | | **$17 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.1 M / yr + local bonds $14 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $68 k |
| Traction energy (39.7 GWh / yr) | 12,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.1 GWh/yr + dedicated solar plant 9.0 MW / 21.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $108 k |
| Labour (234 FTE) | driverless roster: OCC/remote 49, station/platform 65, passenger service 38, fleet maintenance 34, infrastructure/energy 27, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $649 k |
| **OPEX subtotal** | | **$5.5 M / yr** |

_Annual service work: 12,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.0 M train-km / yr (9.9 M car-km / yr). On-site PV covers 21.1 GWh/yr and the dedicated solar plant adds 21.4 GWh/yr against 39.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 58 trainsets, 14 stations, 27.1 route-km, 3 lines, and 12,591 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 10.3 M |
| Annual paid trips / city resident | 196 | 313 | 41 |
| Farebox revenue | $22 M / yr | $34 M / yr | $4.5 M / yr |
| Station shop leases | $377 k / yr | $377 k / yr | $377 k / yr |
| Advertising boards | $608 k / yr | $608 k / yr | $608 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$5.5 M / yr** |
| Revenue / OPEX recovery | 408% | 642% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $105 k / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $17 M / yr | $30 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,704 m² of station shop/kiosk leases at $13/m²/month and 516 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $4.8 M / yr | $7.6 M / yr | 60 M - 95 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $858 k / yr | $1.4 M / yr | 10.7–17.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $2.4 M / yr | $3.8 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $18 M / yr | $28 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $7.9 M / yr | $13 M / yr | 11% of paid trips × $1.50 local spend proxy |
...
| Healthcare | 2 healthcare anchors | 10,081 trips/day; 3.7 M access-events/yr | 16,129 trips/day; 5.9 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 32,476 trips/trading day; 10.7 M access-events/yr | 51,961 trips/trading day; 17.1 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,396 trips/activity day; 4.3 M access-events/yr | 23,034 trips/activity day; 6.9 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $179 M | 79% of $226 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $286 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $41 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 22,549 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $219 M |
| Timetable-sized dedicated solar CAPEX | $7.2 M |
| **Reconciled project CAPEX** | **$226 M** |
| Imported / external-capital requirement | $48 M (21.1%) |
| Local-content / local-funding requirement | $179 M (78.9%) |
| Default foreign-turnkey external-capital comparison | $407 M; OSR saves $360 M (88.3%) |
| Lifetime external interest and combined financing saving | $451 M interest; $810 M capital + interest |
| 15%–25% planning risk envelope | $260 M–$283 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $-54182 k / $33 M |
| Low/high project IRR | 5.2% / 9.4% |
| Low/high steady-state DSCR | 0.99 / 1.75 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,234.07 train-km; 6,871.83 kWh consumed; 7,196.10 kWh charged; 39 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,049.23 train-km; 72,663.53 kWh consumed; 73,816.20 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 70%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 64.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 62.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 70.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 47.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Iringa energy and battery simulation dashboard](engineering/screenshots/iringa-simulation-dashboard.png) | ![Iringa simulator network visualizer](engineering/screenshots/iringa-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 26 civil segments, and 0 input findings |
...
|---|---|
| ![Iringa QGIS engineering layers](engineering/screenshots/iringa-qgis-engineering-map.png) | ![Iringa SUMO timetable validation](engineering/screenshots/iringa-sumo-validation.png) |
...
| [`iringa.toml`](iringa.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`iringa-network-map.png`](iringa-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`iringa.corridor.geojson`](iringa.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`iringa.stations.json`](iringa.stations.json) | Machine-readable station list |
| [`iringa.design-quality.yaml`](iringa.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
