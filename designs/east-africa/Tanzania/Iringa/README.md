...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 116 | $60 k | $7.0 M |
| High sensitivity check | 116 | $120 k | $14 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh iringa`.
...
|---|---|---|
| Construction (years 1–7) | **$15 M / yr** | $60 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$106 M cumulative** | $423 |
| Lifecycle envelope (yr 1–40, high scenario) | **$106 M cumulative** | $423 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$468 M cumulative** | $1,872 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $187 M | 4.5% | 40 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $47 M | — | — | — |
| **Total** | **100%** | **$234 M** | | | **$11 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $8.4 M / yr = **$8.4 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $137 M | 59% of $234 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $220 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $31 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 17,345 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $226 M |
| Timetable-sized dedicated solar CAPEX | $7.2 M |
| **Reconciled project CAPEX** | **$234 M** |
| 15%–25% planning risk envelope | $269 M–$292 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $-59721 k / $27 M |
| Low/high project IRR | 5.0% / 9.1% |
| Low/high steady-state DSCR | 1.55 / 2.72 |
