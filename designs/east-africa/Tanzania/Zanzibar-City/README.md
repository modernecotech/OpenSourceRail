...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 402 | $60 k | $24 M |
| High sensitivity check | 402 | $120 k | $48 M |
...
| Per-capita (city pop) | $1,315 / person |
...
|---|---|---|
| Construction (years 1–7) | **$42 M / yr** | $85 |
| Steady-state, low capacity-use (year 8+) | **$12 M / yr** | $24 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$694 M cumulative** | $1,389 |
| Lifecycle envelope (yr 1–40, high scenario) | **$297 M cumulative** | $594 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.32 bn cumulative** | $2,633 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $19 M / yr → $31 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $526 M | 4.5% | 40 y, 7 y grace | $31 M / yr |
| Government equity (no debt service) | 20% | $131 M | — | — | — |
| **Total** | **100%** | **$657 M** | | | **$31 M / yr** |
...
| Operating surplus applied to debt support | -$19 M / yr | -$31 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $0 k / yr | **$31 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $371 M | 56% of $657 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $593 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $85 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 46,806 job-years | retained CAPEX ÷ (4.0 × median annual income) |
