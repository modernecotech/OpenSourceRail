...
|---|---|---|---|---|
| line-1 | 19.1 km | 13 | 45 | N Outer ↔ S Mid |
| line-2 | 21.0 km | 12 | 56 | NW Outer ↔ E Mid |
| line-3 | 21.7 km | 12 | 54 | SE Outer ↔ NE Inner |
| **Total** | **61.9 km** | **37 unique** | **155** | |
...
| Interchange | 13 | 300 kW | 500 kWh |
| Major | 2 | 300 kW | 500 kWh |
| Standard | 13 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **34** | **14,900 kW** | **56,500 kWh** |

Aggregate station-rail charging power: **17,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **72.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 72 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 72.2 MW / 346 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 143 kWh | 229 kWh | 71 kWh | 2.0 km / 15 kWh |
| line-2 | 11 | 157 kWh | 270 kWh | 96 kWh | 5.0 km / 38 kWh |
| line-3 | 10 | 163 kWh | 253 kWh | 74 kWh | 8.1 km / 61 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 72,171 kW @ $700/kW | $51 M |
| Grid interconnection / PPA tie-in | 72,171 kW @ $100/kW | $7.2 M |
| Annual generation proxy | 72.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 126.4 GWh/yr |
...
| Per-capita (city pop) | $1,504 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh zanzibar-city`.
...
|---|---|---|
| Construction (years 1–7) | **$49 M / yr** | $97 |
| Steady-state, low capacity-use (year 8+) | **$18 M / yr** | $36 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$930 M cumulative** | $1,860 |
| Lifecycle envelope (yr 1–40, high scenario) | **$340 M cumulative** | $680 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.51 bn cumulative** | $3,013 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $17 M / yr → $35 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $602 M | 4.5% | 40 y, 7 y grace | $35 M / yr |
| Government equity (no debt service) | 20% | $150 M | — | — | — |
| **Total** | **100%** | **$752 M** | | | **$35 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $27 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($21 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $9.5 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $155 k |
| Traction energy (136.1 GWh / yr) | 28,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 72.2 MW / 126.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $866 k |
| Labour (477 FTE) | driverless roster: OCC/remote 94, station/platform 170, passenger service 49, fleet maintenance 85, infrastructure/energy 58, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$17 M / yr** |

_Annual service work: 28,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.3 M train-km / yr (34.0 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 126.4 GWh/yr against 136.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 155 trainsets, 37 stations, 61.9 route-km, 3 lines, and 28,762 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 33.6 M |
| Annual paid trips / city resident | 147 | 235 | 67 |
...
| **Total revenue** | **$35 M / yr** | **$54 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 200% | 311% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $35 M / yr | $35 M / yr | **$35 M / yr** |
| Operating surplus applied to debt support | -$17 M / yr | -$35 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $0 k / yr | **$35 M / yr** |
| Operating surplus after OPEX (before debt support) | $17 M / yr | $37 M / yr | $0 / yr |

_Commercial-revenue assumptions: 7,432 m² of station shop/kiosk leases at $13/m²/month and 1,352 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 2 education anchors | 9,922 trips/school day; 2.2 M access-events/yr | 15,875 trips/school day; 3.5 M access-events/yr |
| Healthcare | 11 healthcare anchors | 20,123 trips/day; 7.3 M access-events/yr | 32,197 trips/day; 11.8 M access-events/yr |
| Commerce | 21 major/terminal/interchange nodes | 44,112 trips/trading day; 14.6 M access-events/yr | 70,579 trips/trading day; 23.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $425 M | 57% of $752 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $680 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $97 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 53,680 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$752 M** |
| 15%–25% planning risk envelope | $865 M–$940 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-442048 k / $-312004 k |
| Low/high project IRR | -1.3% / 2.6% |
| Low/high steady-state DSCR | 0.49 / 1.04 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,287.51 train-km; 17,128.70 kWh consumed; 17,652.99 kWh charged; 25 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 29,649.08 train-km; 222,009.79 kWh consumed; 225,859.25 kWh charged; 498 depot services completed (6 active at cutoff); minimum SoC 28%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 1 SoC warnings |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 28.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.2% / 60% | pass |
| ten-hour single charging-pad outage | 28.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 37 line platforms, 3 interchange complexes, 63 civil segments, and 0 input findings |
