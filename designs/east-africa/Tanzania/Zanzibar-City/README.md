...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$926 M (86.8%) of external capital** and **$1.16 bn of external interest**. Capital plus saved interest totals **$2.09 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`zanzibar-city.corridor.geojson`](zanzibar-city.corridor.geojson).
...
| Lines | 3 |
| Unique stations | 22 |
| Interchange-class stations | 4 |
| Multi-line transfer reachability | 100% (line-pairs sharing ≥ 1 station) |
| Anchor-weighted coverage | 71.7% |
| Route length (double track) | 61.9 km |
| Revenue fleet | 120 × 3-car trainsets |
| Revenue fleet passenger capacity | 43,200 AW2 pax (57,600 AW3 crush) |
...
| Revenue fleet capacity | 43,200 AW2 pax (57,600 AW3 crush) |
| Total fleet capacity | 48,240 AW2 pax (64,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 120 × 360 = **43,200 AW2 passengers** (57,600 AW3 crush)
- **Total fleet passenger capacity:** 134 × 360 = **48,240 AW2 passengers** (64,320 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 71.7%
- Catchment population: **≈ 358,500** (within ~800 m walk of a station)
...
| Interchange | 8 | 300 kW | 500 kWh |
| Major | 1 | 300 kW | 500 kWh |
| Standard | 6 | 300 kW | 500 kWh |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **76.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 71 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 28,762 train-km/day | One-way train journeys × route length |
| Annual service work | 11.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 373 MWh/day | 34.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 320 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 76.7 MW / 368 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 143 kWh | 229 kWh | 71 kWh | 6.0 km / 45 kWh |
| line-2 | 7 | 157 kWh | 257 kWh | 84 kWh | 6.8 km / 51 kWh |
| line-3 | 7 | 163 kWh | 257 kWh | 78 kWh | 7.0 km / 53 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (56.1 km @ $2.58 M/km) | $145 M |
| Elevated (5.7 km @ $9.75 M/km) | $56 M |
| Elevated-interchange premium (4 sites @ $4.50 M) | $18 M |
| **Civil subtotal** | **$219 M** |
...
| `interchange-elevated` | 8 | $12.0 M | $96 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 134 | $900 k | $121 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 402 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 402 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 76,656 kW @ $700/kW | $54 M |
| Grid interconnection / PPA tie-in | 76,656 kW @ $100/kW | $7.7 M |
| Annual generation proxy | 76.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 134.3 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 61.9 km × $0.050 M/km | $3.1 M |
...
| Per-capita (city pop) | $1,185 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $219 M | 15% | $33 M | $186 M |
| Stations | $144 M | 20% | $29 M | $115 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $121 M | 35% | $42 M | $78 M |
| Dedicated solar plant | $61 M | 45% | $28 M | $34 M |
| Residual signalling / train control | $3.1 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $2.5 M | 40% | $980 k | $1.5 M |
| EPC / project services | $35 M | 15% | $5.2 M | $30 M |
| **Total city CAPEX** | **$593 M** | **23.8%** | **$141 M** | **$452 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh zanzibar-city`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.8%** | **$141 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.2%** | **$452 M** | **$65 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $361 M | $52 M / yr |
| **Total city programme** | **100.0%** | **$593 M** | **$85 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $800 M | $659 M (82.4%) | $826 M | **$1.49 bn** |
| **Default** | 2.00× | $1.07 bn | $926 M (86.8%) | $1.16 bn | **$2.09 bn** |
| High | 3.00× | $1.60 bn | $1.46 bn (91.2%) | $1.83 bn | **$3.29 bn** |

At the default 2.00× case, OSR's $141 M external requirement is 86.8% below the illustrative foreign-company requirement of $1.07 bn; the associated lifetime external-interest saving is $1.16 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$54 M / yr** | $107 |
| Steady-state, low capacity-use (year 8+) | **$25 M / yr** | $50 |
| Steady-state, high capacity-use (year 8+) | **$5.5 M / yr** | $11 |
| Steady-state, operating-neutral revenue case | **$44 M / yr** | $89 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.19 bn cumulative** | $2,390 |
| Lifecycle envelope (yr 1–40, high scenario) | **$556 M cumulative** | $1,112 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.84 bn cumulative** | $3,682 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $20 M / yr → $39 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $141 M | 4.5% | 40 y, 7 y grace | $8.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $361 M | 9.5% | 40 y, 7 y grace | $36 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $90 M | — | — | — |
| **Total** | **100%** | **$593 M** | | | **$44 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.3 M / yr + local bonds $34 M / yr = **$41 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $155 k |
| Traction energy (136.1 GWh / yr) | 28,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.3 GWh/yr + dedicated solar plant 76.7 MW / 134.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $920 k |
| Labour (390 FTE) | driverless roster: OCC/remote 81, station/platform 109, passenger service 49, fleet maintenance 78, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 28,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.3 M train-km / yr (34.0 M car-km / yr). On-site PV covers 19.3 GWh/yr and the dedicated solar plant adds 134.3 GWh/yr against 136.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 134 trainsets, 22 stations, 61.9 route-km, 3 lines, and 28,762 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 28.8 M |
| Annual paid trips / city resident | 147 | 235 | 58 |
| Farebox revenue | $32 M / yr | $52 M / yr | $13 M / yr |
| Station shop leases | $668 k / yr | $668 k / yr | $668 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$34 M / yr** | **$53 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 236% | 371% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $44 M / yr | $44 M / yr | **$44 M / yr** |
| Operating surplus applied to debt support | -$20 M / yr | -$39 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $25 M / yr | $5.5 M / yr | **$44 M / yr** |
| Operating surplus after OPEX (before debt support) | $20 M / yr | $39 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,792 m² of station shop/kiosk leases at $13/m²/month and 876 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $26 M / yr | 204 M - 327 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.7 M / yr | 36.8–58.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.2 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $25 M / yr | $41 M / yr | 23% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 9,240 trips/school day; 2.0 M access-events/yr | 14,785 trips/school day; 3.3 M access-events/yr |
| Healthcare | 7 healthcare anchors | 18,615 trips/day; 6.8 M access-events/yr | 29,784 trips/day; 10.9 M access-events/yr |
| Commerce | 15 major/terminal/interchange nodes | 46,522 trips/trading day; 15.4 M access-events/yr | 74,435 trips/trading day; 24.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $452 M | 76% of $593 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $723 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $103 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 57,019 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $531 M |
| Timetable-sized dedicated solar CAPEX | $61 M |
| **Reconciled project CAPEX** | **$593 M** |
| Imported / external-capital requirement | $141 M (23.8%) |
| Local-content / local-funding requirement | $452 M (76.2%) |
| Default foreign-turnkey external-capital comparison | $1.07 bn; OSR saves $926 M (86.8%) |
| Lifetime external interest and combined financing saving | $1.16 bn interest; $2.09 bn capital + interest |
| 15%–25% planning risk envelope | $682 M–$741 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-309330 k / $-179287 k |
| Low/high project IRR | 0.4% / 4.3% |
| Low/high steady-state DSCR | 0.44 / 0.88 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,262.31 train-km; 16,939.94 kWh consumed; 15,460.73 kWh charged; 26 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,105.98 train-km; 202,967.24 kWh consumed; 199,217.62 kWh charged; 467 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.2% of scheduled train-km delivered; 95 SoC warnings; 10 energy-adapted off-peak departures, maximum 14 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 94.2% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.8% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.7% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.1% / 90% | pass |
...
|---|---|
| ![Zanzibar-City energy and battery simulation dashboard](engineering/screenshots/zanzibar-city-simulation-dashboard.png) | ![Zanzibar-City simulator network visualizer](engineering/screenshots/zanzibar-city-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 4 interchange complexes, 69 civil segments, and 0 input findings |
...
|---|---|
| ![Zanzibar-City QGIS engineering layers](engineering/screenshots/zanzibar-city-qgis-engineering-map.png) | ![Zanzibar-City SUMO timetable validation](engineering/screenshots/zanzibar-city-sumo-validation.png) |
...
| [`zanzibar-city.toml`](zanzibar-city.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`zanzibar-city-network-map.png`](zanzibar-city-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`zanzibar-city.corridor.geojson`](zanzibar-city.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`zanzibar-city.stations.json`](zanzibar-city.stations.json) | Machine-readable station list |
| [`zanzibar-city.design-quality.yaml`](zanzibar-city.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug zanzibar-city
