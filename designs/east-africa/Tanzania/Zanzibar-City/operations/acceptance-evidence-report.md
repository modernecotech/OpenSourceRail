# Zanzibar City Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 367 |
| Manufacturing schedule rows | 1,380 |
| Manufacturing material/BOM rows | 20,491 |
| Manufacturing QA verification rows | 1,380 |
| Construction QA action rows | 1,280 |
| Maintenance handover schedule rows | 1,650 |
| Manufacturing rows with material refs | 1,380 / 1,380 |
| Manufacturing rows with verification refs | 1,380 / 1,380 |
| Manufacturing rows linked to QA actions | 1,380 / 1,380 |
