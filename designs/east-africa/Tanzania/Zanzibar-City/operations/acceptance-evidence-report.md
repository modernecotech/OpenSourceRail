...
| Manufacturing schedule rows | 1,087 |
| Manufacturing material/BOM rows | 17,223 |
| Manufacturing QA verification rows | 1,087 |
| Construction QA action rows | 1,031 |
| Maintenance handover schedule rows | 1,282 |
| Manufacturing rows with material refs | 1,087 / 1,087 |
| Manufacturing rows with verification refs | 1,087 / 1,087 |
| Manufacturing rows linked to QA actions | 1,087 / 1,087 |
