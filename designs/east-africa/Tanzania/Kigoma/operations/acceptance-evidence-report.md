# Kigoma Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 14,158 |
| Manufacturing QA verification rows | 936 |
| Construction QA action rows | 873 |
| Maintenance handover schedule rows | 1,111 |
