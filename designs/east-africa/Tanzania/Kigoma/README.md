...
| Steady-state, low-ridership (year 8+) | **$32 M / yr** | $108 |
| Steady-state, high-ridership (year 8+) | **$29 M / yr** | $97 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $94 |
| Lifecycle envelope (yr 1–30, low scenario) | **$944 M cumulative** | $3,148 |
| Lifecycle envelope (yr 1–30, high scenario) | **$868 M cumulative** | $2,892 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$846 M cumulative** | $2,819 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.3 M / yr → $947 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $252 M | 3.8% | 30 y, 7 y grace | $17 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $105 M | 9.5% | 30 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$421 M** | | | **$28 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $9.6 M / yr + bonds $10.0 M / yr = **$20 M / yr** total — plus the equity tranche amortised across construction ($9.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 41,580 | 69,300 | 77,165 |
| Daily paid trips / catchment | 18% | 30% | 33% |
| Daily paid trips / city population | 14% | 23% | 26% |
| Annual paid trips | 15.2 M | 25.3 M | 28.2 M |
| Farebox revenue | $5.0 M / yr | $8.3 M / yr | $9.3 M / yr |
| Station shop leases | $602 k / yr | $602 k / yr | $602 k / yr |
| Advertising boards | $961 k / yr | $961 k / yr | $961 k / yr |
| **Total revenue** | **$6.6 M / yr** | **$9.9 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 61% | 91% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $32 M / yr | $29 M / yr | **$28 M / yr** |
