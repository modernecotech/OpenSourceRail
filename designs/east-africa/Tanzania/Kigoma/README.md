...
| Revenue fleet | 97 × 2-car trainsets |
| Revenue fleet passenger capacity | 23,280 AW2 pax (31,040 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 12.3 km | 9 | 38 | SW Outer ↔ E Mid |
| line-2 | 14.7 km | 9 | 43 | SE Outer ↔ N Outer |
| line-3 |  8.9 km | 5 | 27 | N Mid ↔ S Mid |
| **Total** | **35.9 km** | **23 unique** | **108** | |
...
| Revenue fleet capacity | 23,280 AW2 pax (31,040 AW3 crush) |
| Total fleet capacity | 25,920 AW2 pax (34,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 97 × 240 = **23,280 AW2 passengers** (31,040 AW3 crush)
- **Total fleet passenger capacity:** 108 × 240 = **25,920 AW2 passengers** (34,560 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **21.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 30.6× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 49 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 89 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 21.2 MW / 102 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 62 kWh | 163 kWh | 96 kWh | 2.0 km / 10 kWh |
| line-2 | 9 | 74 kWh | 172 kWh | 91 kWh | 2.4 km / 12 kWh |
| line-3 | 5 | 44 kWh | 98 kWh | 49 kWh | 2.3 km / 12 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (34.6 km @ $3.0 M/km) | $104 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 108 | $560 k | $60 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 216 | $60 k | $13 M |
| High sensitivity check | 216 | $120 k | $26 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 21,241 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 21,241 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 21.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 37.2 GWh/yr |
...
| Per-capita (city pop) | $1,229 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$264 M cumulative** | $880 |
| Lifecycle envelope (yr 1–40, high scenario) | **$167 M cumulative** | $555 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$738 M cumulative** | $2,461 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $14 M / yr → $17 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $295 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $74 M | — | — | — |
| **Total** | **100%** | **$369 M** | | | **$17 M / yr** |
...
| Traction energy (52.7 GWh / yr) | 16,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 21.2 MW / 37.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $255 k |
| Labour (325 FTE) | driverless roster: OCC/remote 73, station/platform 102, passenger service 38, fleet maintenance 55, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $901 k |
| **OPEX subtotal** | | **$8.7 M / yr** |

_Annual service work: 16,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.6 M train-km / yr (13.2 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 37.2 GWh/yr against 52.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 108 trainsets, 23 stations, 35.9 route-km, 3 lines, and 16,706 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 163 | 261 | 54 |
| Farebox revenue | $22 M / yr | $34 M / yr | $7.1 M / yr |
| Station shop leases | $598 k / yr | $598 k / yr | $598 k / yr |
| Advertising boards | $947 k / yr | $947 k / yr | $947 k / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$8.7 M / yr** |
| Revenue / OPEX recovery | 266% | 414% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $17 M / yr | $17 M / yr | **$17 M / yr** |
| Operating surplus applied to debt support | -$14 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.0 M / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $14 M / yr | $27 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,288 m² of station shop/kiosk leases at $13/m²/month and 804 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 1 education anchors | 6,046 trips/school day; 1.3 M access-events/yr | 9,673 trips/school day; 2.1 M access-events/yr |
| Healthcare | 3 healthcare anchors | 9,642 trips/day; 3.5 M access-events/yr | 15,428 trips/day; 5.6 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 29,986 trips/trading day; 9.9 M access-events/yr | 47,978 trips/trading day; 15.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $213 M | 58% of $369 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,880 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-177626 k / $-90930 k |
| Low/high project IRR | 1.3% / 5.1% |
| Low/high steady-state DSCR | 0.83 / 1.57 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,532.18 train-km; 7,649.27 kWh consumed; 8,396.71 kWh charged; 35 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,340.64 train-km; 86,571.49 kWh consumed; 88,893.79 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 67.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 86.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 86.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 2 interchange complexes, 11 civil segments, and 0 input findings |
