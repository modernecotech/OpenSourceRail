...
| Lifecycle envelope (yr 1–40, low scenario) | **$127 M cumulative** | $424 |
| Lifecycle envelope (yr 1–40, high scenario) | **$127 M cumulative** | $424 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$563 M cumulative** | $1,877 |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $162 M | 57% of $281 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 20,414 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $263 M |
...
| Low/high project NPV at 8% | $-102102 k / $-15406 k |
| Low/high project IRR | 3.4% / 7.4% |
| Low/high steady-state DSCR | 1.21 / 2.18 |
