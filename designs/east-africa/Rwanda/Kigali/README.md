...
Aggregate station-rail charging power: **29,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 460 kWh battery covers running.
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 139 | €3.0 M | €417 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 170.6 km × €0.1 M/km | €17 M |
...
|---|---|---|
| Construction (years 1–7) | **€107 M / yr** | €89 |
| Steady-state, low-ridership (year 8+) | **€146 M / yr** | €121 |
| Steady-state, high-ridership (year 8+) | **€141 M / yr** | €117 |
| Lifecycle envelope (yr 1–30, low scenario) | **€4.11 bn cumulative** | €3,400 |
| Lifecycle envelope (yr 1–30, high scenario) | **€4.01 bn cumulative** | €3,316 |

_Population basis: 1,208,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€37 M / yr (low) → €33 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.06 bn | 3.0% | 30 y, 7 y grace | €65 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €442 M | 8.5% | 30 y, 7 y grace | €44 M / yr |
| Government equity (no debt service) | 15% | €265 M | — | — | — |
| **Total** | **100%** | **€1.77 bn** | | | **€109 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €32 M / yr + bonds €38 M / yr = **€69 M / yr** total — plus the equity tranche amortised across construction (€38 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €850 k |
...
| Operating shortfall (gov subsidy required) | €37 M / yr | €33 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€146 M / yr** | **€141 M / yr** |
