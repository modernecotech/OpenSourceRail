...
| Total fleet capacity | 108,960 AW2 pax (145,280 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 205 × 480 = **98,400 AW2 passengers** (131,200 AW3 crush)
- **Total fleet passenger capacity:** 227 × 480 = **108,960 AW2 passengers** (145,280 AW3 crush, incl. spare + reserve)
...
| PV daily yield proxy | 186 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,489 MWh/day | 86,145 scheduled train-km/day × 108% depot/deadhead factor |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 299,593 kW @ $700/kW | $210 M |
| Grid interconnection / PPA tie-in | 299,593 kW @ $100/kW | $30 M |
| Annual generation proxy | 299.6 MW × 5.0 peak-sun-h/day × 365 d/yr | 546.8 GWh/yr |
...
| Per-capita (city pop) | $2,356 / person |
...
|---|---|---|
| Construction (years 1–7) | **$127 M / yr** | $105 |
| Steady-state, low capacity-use (year 8+) | **$129 M / yr** | $107 |
| Steady-state, high capacity-use (year 8+) | **$106 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$95 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.15 bn cumulative** | $4,267 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.38 bn cumulative** | $3,630 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.02 bn cumulative** | $3,327 |

_Population basis: 1,208,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $34 M / yr → $11 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.28 bn | 2.0% | 40 y, 7 y grace | $95 M / yr |
| Government equity (no debt service) | 20% | $569 M | — | — | — |
| **Total** | **100%** | **$2.85 bn** | | | **$95 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $46 M / yr = **$46 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($81 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (543.3 GWh / yr) | 86,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 67.9 GWh/yr + dedicated solar plant 299.6 MW / 546.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.6 M |
| Labour (913 FTE) | driverless roster: OCC/remote 130, station/platform 327, passenger service 71, fleet maintenance 182, infrastructure/energy 165, admin/training 38; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$77 M / yr** |

_Annual service work: 86,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 34.0 M train-km / yr (135.8 M car-km / yr). On-site PV covers 67.9 GWh/yr and the dedicated solar plant adds 546.8 GWh/yr against 543.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 94% |
| Annual paid trips | 112.1 M | 179.4 M | 211.3 M |
| Annual paid trips / city resident | 93 | 149 | 175 |
| Farebox revenue | $39 M / yr | $62 M / yr | $73 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$43 M / yr** | **$66 M / yr** | **$77 M / yr** |
| Revenue / OPEX recovery | 56% | 86% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $129 M / yr | $106 M / yr | **$95 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $129 M / yr | $106 M / yr | **$95 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $11 M / yr | $18 M / yr | 16 min/trip × $0.38/h value-of-time proxy |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 14,500 trips/school day; 3.2 M access-events/yr | 23,200 trips/school day; 5.1 M access-events/yr |
| Healthcare | 23 healthcare anchors | 38,216 trips/day; 13.9 M access-events/yr | 61,145 trips/day; 22.3 M access-events/yr |
| Commerce | 52 major/terminal/interchange nodes | 68,885 trips/trading day; 22.7 M access-events/yr | 110,216 trips/trading day; 36.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.47 bn | 52% of $2.85 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.35 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $336 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 235,761 job-years | retained CAPEX ÷ (4.0 × median annual income) |
