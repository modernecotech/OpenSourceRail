...
|---|---|---|
| Construction (years 1–7) | **$62 M / yr** | $51 |
| Steady-state, low-ridership (year 8+) | **$75 M / yr** | $62 |
| Steady-state, high-ridership (year 8+) | **$70 M / yr** | $58 |
| Steady-state, operating-neutral revenue case | **$63 M / yr** | $52 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.16 bn cumulative** | $1,788 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.05 bn cumulative** | $1,699 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.87 bn cumulative** | $1,550 |

_Population basis: 1,208,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $13 M / yr → $7.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $610 M | 3.0% | 30 y, 7 y grace | $37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $254 M | 8.5% | 30 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 15% | $153 M | — | — | — |
| **Total** | **100%** | **$1.02 bn** | | | **$63 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $18 M / yr + bonds $22 M / yr = **$40 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 74,581 | 124,303 | 206,462 |
| Daily paid trips / catchment | 18% | 30% | 50% |
| Daily paid trips / city population | 6% | 10% | 17% |
| Annual paid trips | 27.2 M | 45.4 M | 75.4 M |
| Farebox revenue | $7.1 M / yr | $12 M / yr | $20 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$11 M / yr** | **$16 M / yr** | **$24 M / yr** |
| Revenue / OPEX recovery | 47% | 67% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $75 M / yr | $70 M / yr | **$63 M / yr** |
