...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 139 | $5.60 M | $778 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 556 | $100 k | $56 M |
| High sensitivity check | 556 | $200 k | $111 M |
...
|---|---|---|
| Construction (years 1–7) | **$124 M / yr** | $103 |
| Steady-state, low-ridership (year 8+) | **$169 M / yr** | $140 |
| Steady-state, high-ridership (year 8+) | **$164 M / yr** | $136 |
| Steady-state, operating-neutral revenue case | **$126 M / yr** | $104 |
| Lifecycle envelope (yr 1–30, low scenario) | **$4.75 bn cumulative** | $3,932 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.64 bn cumulative** | $3,842 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.76 bn cumulative** | $3,111 |

_Population basis: 1,208,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $43 M / yr → $38 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.22 bn | 3.0% | 30 y, 7 y grace | $74 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $510 M | 8.5% | 30 y, 7 y grace | $51 M / yr |
| Government equity (no debt service) | 15% | $306 M | — | — | — |
| **Total** | **100%** | **$2.04 bn** | | | **$126 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $37 M / yr + bonds $43 M / yr = **$80 M / yr** total — plus the equity tranche amortised across construction ($44 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 74,581 | 124,303 | 529,211 |
| Daily paid trips / catchment | 18% | 30% | 128% |
| Daily paid trips / city population | 6% | 10% | 44% |
| Annual paid trips | 27.2 M | 45.4 M | 193.2 M |
| Farebox revenue | $7.1 M / yr | $12 M / yr | $50 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$11 M / yr** | **$16 M / yr** | **$54 M / yr** |
| Revenue / OPEX recovery | 21% | 29% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $169 M / yr | $164 M / yr | **$126 M / yr** |
