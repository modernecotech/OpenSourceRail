...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.72 bn (86.9%) of external capital** and **$3.41 bn of external interest**. Capital plus saved interest totals **$6.13 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (167.2 km @ $2.58 M/km) | $432 M |
| Elevated (16.1 km @ $9.75 M/km) | $157 M |
| Elevated-interchange premium (12 sites @ $4.50 M) | $54 M |
| **Civil subtotal** | **$643 M** |
...
| Per-capita (city pop) | $1,439 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $643 M | 15% | $96 M | $546 M |
...
| EPC / project services | $100 M | 15% | $15 M | $85 M |
| **Total city CAPEX** | **$1.74 bn** | **23.6%** | **$410 M** | **$1.33 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$410 M** | **$59 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$1.33 bn** | **$190 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $1.06 bn | $152 M / yr |
| **Total city programme** | **100.0%** | **$1.74 bn** | **$248 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.35 bn | $1.94 bn (82.5%) | $2.43 bn | **$4.37 bn** |
| **Default** | 2.00× | $3.13 bn | $2.72 bn (86.9%) | $3.41 bn | **$6.13 bn** |
| High | 3.00× | $4.70 bn | $4.29 bn (91.3%) | $5.37 bn | **$9.66 bn** |

At the default 2.00× case, OSR's $410 M external requirement is 86.9% below the illustrative foreign-company requirement of $3.13 bn; the associated lifetime external-interest saving is $3.41 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$147 M / yr** | $122 |
| Steady-state, low capacity-use (year 8+) | **$93 M / yr** | $77 |
| Steady-state, high capacity-use (year 8+) | **$56 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$121 M / yr** | $100 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.10 bn cumulative** | $3,395 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.87 bn cumulative** | $2,376 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.02 bn cumulative** | $4,157 |

_Population basis: 1,208,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $28 M / yr → $65 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $410 M | 4.5% | 40 y, 7 y grace | $24 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.06 bn | 8.5% | 40 y, 7 y grace | $97 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $266 M | — | — | — |
| **Total** | **100%** | **$1.74 bn** | | | **$121 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $18 M / yr + local bonds $90 M / yr = **$109 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($38 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 98.8 M |
| Annual paid trips / city resident | 148 | 237 | 82 |
| Farebox revenue | $62 M / yr | $99 M / yr | $34 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$67 M / yr** | **$104 M / yr** | **$39 M / yr** |
| Revenue / OPEX recovery | 172% | 268% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $121 M / yr | $121 M / yr | **$121 M / yr** |
| Operating surplus applied to debt support | -$28 M / yr | -$65 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $93 M / yr | $56 M / yr | **$121 M / yr** |
| Operating surplus after OPEX (before debt support) | $28 M / yr | $65 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.33 bn | 76% of $1.74 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.13 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $304 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 212,998 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.53 bn |
| Timetable-sized dedicated solar CAPEX | $214 M |
| **Reconciled project CAPEX** | **$1.74 bn** |
| Imported / external-capital requirement | $410 M (23.6%) |
| Local-content / local-funding requirement | $1.33 bn (76.4%) |
| Default foreign-turnkey external-capital comparison | $3.13 bn; OSR saves $2.72 bn (86.9%) |
| Lifetime external interest and combined financing saving | $3.41 bn interest; $6.13 bn capital + interest |
| 15%–25% planning risk envelope | $2.00 bn–$2.17 bn |
| Annual OPEX | $39 M / yr |
| Low/high project NPV at 8% | $-1105994 k / $-855540 k |
| Low/high project IRR | -2.9% / 1.1% |
| Low/high steady-state DSCR | 0.23 / 0.54 |
