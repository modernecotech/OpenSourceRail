...
| Per-capita (city pop) | $1,082 / person |
...
| Steady-state, low-ridership (year 8+) | **$98 M / yr** | $81 |
| Steady-state, high-ridership (year 8+) | **$94 M / yr** | $78 |
| Steady-state, operating-neutral revenue case | **$81 M / yr** | $67 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.82 bn cumulative** | $2,334 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.71 bn cumulative** | $2,244 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.41 bn cumulative** | $1,993 |

_Population basis: 1,208,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $18 M / yr → $13 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $784 M | 3.0% | 30 y, 7 y grace | $48 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $327 M | 8.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $196 M | — | — | — |
| **Total** | **100%** | **$1.31 bn** | | | **$81 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $24 M / yr + bonds $28 M / yr = **$51 M / yr** total — plus the equity tranche amortised across construction ($28 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 74,581 | 124,303 | 263,638 |
| Daily paid trips / catchment | 18% | 30% | 64% |
| Daily paid trips / city population | 6% | 10% | 22% |
| Annual paid trips | 27.2 M | 45.4 M | 96.2 M |
| Farebox revenue | $7.1 M / yr | $12 M / yr | $25 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$11 M / yr** | **$16 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 39% | 55% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $98 M / yr | $94 M / yr | **$81 M / yr** |
