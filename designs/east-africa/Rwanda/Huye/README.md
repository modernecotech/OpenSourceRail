...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$462 M (87.2%) of external capital** and **$579 M of external interest**. Capital plus saved interest totals **$1.04 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (44.1 km @ $2.58 M/km) | $114 M |
| Elevated (0.6 km @ $9.75 M/km) | $5.5 M |
...
| Per-capita (city pop) | $1,177 / person |
...
| **Total city CAPEX** | **$294 M** | **23.0%** | **$68 M** | **$227 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.0%** | **$68 M** | **$9.7 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.0%** | **$227 M** | **$32 M / yr** |
| of which planned local bond issuance | 61.6% of total CAPEX | $181 M | $26 M / yr |
| **Total city programme** | **100.0%** | **$294 M** | **$42 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $397 M | $330 M (83.0%) | $413 M | **$743 M** |
| **Default** | 2.00× | $530 M | $462 M (87.2%) | $579 M | **$1.04 bn** |
| High | 3.00× | $795 M | $727 M (91.5%) | $911 M | **$1.64 bn** |

At the default 2.00× case, OSR's $68 M external requirement is 87.2% below the illustrative foreign-company requirement of $530 M; the associated lifetime external-interest saving is $579 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$9.9 M / yr** | $40 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $82 |
| Lifecycle envelope (yr 1–40, low scenario) | **$501 M cumulative** | $2,004 |
| Lifecycle envelope (yr 1–40, high scenario) | **$175 M cumulative** | $698 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$851 M cumulative** | $3,405 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $21 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $68 M | 4.5% | 40 y, 7 y grace | $4.0 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $181 M | 8.5% | 40 y, 7 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $45 M | — | — | — |
| **Total** | **100%** | **$294 M** | | | **$21 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.0 M / yr + local bonds $15 M / yr = **$18 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 18.3 M |
| Annual paid trips / city resident | 196 | 313 | 73 |
| Farebox revenue | $17 M / yr | $27 M / yr | $6.3 M / yr |
| Station shop leases | $286 k / yr | $286 k / yr | $286 k / yr |
| Advertising boards | $472 k / yr | $472 k / yr | $472 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$7.1 M / yr** |
| Revenue / OPEX recovery | 250% | 393% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $21 M / yr | $21 M / yr | **$21 M / yr** |
| Operating surplus applied to debt support | -$11 M / yr | -$21 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.9 M / yr | $0 k / yr | **$21 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $21 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $227 M | 77% of $294 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $363 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $52 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 36,318 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $268 M |
| Timetable-sized dedicated solar CAPEX | $26 M |
| **Reconciled project CAPEX** | **$294 M** |
| Imported / external-capital requirement | $68 M (23.0%) |
| Local-content / local-funding requirement | $227 M (77.0%) |
| Default foreign-turnkey external-capital comparison | $530 M; OSR saves $462 M (87.2%) |
| Lifetime external interest and combined financing saving | $579 M interest; $1.04 bn capital + interest |
| 15%–25% planning risk envelope | $338 M–$368 M |
| Annual OPEX | $7.1 M / yr |
| Low/high project NPV at 8% | $-147589 k / $-79283 k |
| Low/high project IRR | 0.9% / 4.8% |
| Low/high steady-state DSCR | 0.52 / 1.01 |
