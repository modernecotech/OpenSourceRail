...
**Country:** RW · **Population:** 250,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$497 M (87.5%) of external capital** and **$623 M of external interest**. Capital plus saved interest totals **$1.12 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`huye.corridor.geojson`](huye.corridor.geojson).
...
| Anchor-weighted coverage | 67.7% |
| Route length (double track) | 44.6 km |
| Revenue fleet | 83 × 2-car trainsets |
| Revenue fleet passenger capacity | 19,920 AW2 pax (26,560 AW3 crush) |
...
| Revenue fleet capacity | 19,920 AW2 pax (26,560 AW3 crush) |
| Total fleet capacity | 22,080 AW2 pax (29,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 83 × 240 = **19,920 AW2 passengers** (26,560 AW3 crush)
- **Total fleet passenger capacity:** 92 × 240 = **22,080 AW2 passengers** (29,440 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 67.7%
- Catchment population: **≈ 169,250** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **32.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 315 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 20,762 train-km/day | One-way train journeys × route length |
| Annual service work | 8.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 179 MWh/day | 16.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 137 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 32.7 MW / 157 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 79 kWh | 131 kWh | 44 kWh | 9.0 km / 45 kWh |
| line-2 | 4 | 70 kWh | 114 kWh | 37 kWh | 7.0 km / 35 kWh |
| line-3 | 5 | 74 kWh | 122 kWh | 41 kWh | 7.0 km / 35 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (44.1 km @ $3.0 M/km) | $132 M |
| Elevated (0.6 km @ $12.0 M/km) | $6.8 M |
| **Civil subtotal** | **$139 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 92 | $560 k | $52 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 184 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 184 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 32,743 kW @ $700/kW | $23 M |
| Grid interconnection / PPA tie-in | 32,743 kW @ $100/kW | $3.3 M |
| Annual generation proxy | 32.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 57.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 44.6 km × $0.050 M/km | $2.2 M |
...
| Per-capita (city pop) | $1,261 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $139 M | 15% | $21 M | $118 M |
| Stations | $68 M | 20% | $14 M | $54 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $52 M | 35% | $18 M | $33 M |
| Dedicated solar plant | $26 M | 45% | $12 M | $14 M |
| Residual signalling / train control | $2.2 M | 50% | $1.1 M | $1.1 M |
| Charging microgrids | $1.6 M | 40% | $620 k | $930 k |
| EPC / project services | $19 M | 15% | $2.8 M | $16 M |
| **Total city CAPEX** | **$315 M** | **22.5%** | **$71 M** | **$244 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh huye`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.5%** | **$71 M** | **$10 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.5%** | **$244 M** | **$35 M / yr** |
| of which planned local bond issuance | 62.0% of total CAPEX | $196 M | $28 M / yr |
| **Total city programme** | **100.0%** | **$315 M** | **$45 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $426 M | $355 M (83.4%) | $445 M | **$800 M** |
| **Default** | 2.00× | $568 M | $497 M (87.5%) | $623 M | **$1.12 bn** |
| High | 3.00× | $851 M | $780 M (91.7%) | $978 M | **$1.76 bn** |

At the default 2.00× case, OSR's $71 M external requirement is 87.5% below the illustrative foreign-company requirement of $568 M; the associated lifetime external-interest saving is $623 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$27 M / yr** | $107 |
| Steady-state, low capacity-use (year 8+) | **$12 M / yr** | $47 |
| Steady-state, high capacity-use (year 8+) | **$1.6 M / yr** | $6 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $88 |
| Lifecycle envelope (yr 1–40, low scenario) | **$576 M cumulative** | $2,304 |
| Lifecycle envelope (yr 1–40, high scenario) | **$241 M cumulative** | $962 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$913 M cumulative** | $3,653 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $71 M | 4.5% | 40 y, 7 y grace | $4.2 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $196 M | 8.5% | 40 y, 7 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $49 M | — | — | — |
| **Total** | **100%** | **$315 M** | | | **$22 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.2 M / yr + local bonds $17 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (65.5 GWh / yr) | 20,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 32.7 MW / 57.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $393 k |
| Labour (284 FTE) | driverless roster: OCC/remote 65, station/platform 66, passenger service 38, fleet maintenance 55, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $620 k |
| **OPEX subtotal** | | **$7.5 M / yr** |

_Annual service work: 20,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.2 M train-km / yr (16.4 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 57.4 GWh/yr against 65.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 92 trainsets, 17 stations, 44.6 route-km, 3 lines, and 20,762 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 19.4 M |
| Annual paid trips / city resident | 196 | 313 | 78 |
| Farebox revenue | $17 M / yr | $27 M / yr | $6.7 M / yr |
| Station shop leases | $286 k / yr | $286 k / yr | $286 k / yr |
| Advertising boards | $472 k / yr | $472 k / yr | $472 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$7.5 M / yr** |
| Revenue / OPEX recovery | 237% | 372% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $1.6 M / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $10 M / yr | $20 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,600 m² of station shop/kiosk leases at $10/m²/month and 508 advertising boards at $91/board/month, with occupancy derates applied._
...
| Avoided road congestion | $7.8 M / yr | $13 M / yr | 98 M - 157 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.4 M / yr | $2.3 M / yr | 17.7–28.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.9 M / yr | $6.3 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 8,973 trips/school day; 2.0 M access-events/yr | 14,356 trips/school day; 3.2 M access-events/yr |
| Healthcare | 5 healthcare anchors | 15,066 trips/day; 5.5 M access-events/yr | 24,106 trips/day; 8.8 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 29,699 trips/trading day; 9.8 M access-events/yr | 47,518 trips/trading day; 15.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $244 M | 78% of $315 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $391 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $56 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 39,177 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $289 M |
| Timetable-sized dedicated solar CAPEX | $26 M |
| **Reconciled project CAPEX** | **$315 M** |
| Imported / external-capital requirement | $71 M (22.5%) |
| Local-content / local-funding requirement | $244 M (77.5%) |
| Default foreign-turnkey external-capital comparison | $568 M; OSR saves $497 M (87.5%) |
| Lifetime external interest and combined financing saving | $623 M interest; $1.12 bn capital + interest |
| 15%–25% planning risk envelope | $363 M–$394 M |
| Annual OPEX | $7.5 M / yr |
| Low/high project NPV at 8% | $-165839 k / $-97533 k |
| Low/high project IRR | 0.3% / 4.2% |
| Low/high steady-state DSCR | 0.46 / 0.93 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,848.44 train-km; 9,228.24 kWh consumed; 9,076.99 kWh charged; 34 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,529.13 train-km; 102,490.58 kWh consumed; 103,826.26 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 98.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 54.7% | 98.9% / 90% | pass |
| maximum planning climate/HVAC duty | 30.8% | 98.9% / 90% | pass |
| 50% charging-contact availability | 60.4% | 98.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.0% / 60% | pass |
| ten-hour single charging-pad outage | 55.8% | 98.9% / 90% | pass |
...
|---|---|
| ![Huye energy and battery simulation dashboard](engineering/screenshots/huye-simulation-dashboard.png) | ![Huye simulator network visualizer](engineering/screenshots/huye-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
...
|---|---|
| ![Huye QGIS engineering layers](engineering/screenshots/huye-qgis-engineering-map.png) | ![Huye SUMO timetable validation](engineering/screenshots/huye-sumo-validation.png) |
...
| [`huye.toml`](huye.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`huye-network-map.png`](huye-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`huye.corridor.geojson`](huye.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`huye.stations.json`](huye.stations.json) | Machine-readable station list |
| [`huye.design-quality.yaml`](huye.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
