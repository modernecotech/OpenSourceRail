...
| Revenue fleet | 117 × 2-car trainsets |
...
| Spare + cold-reserve | 13 × 2-car trainsets |
| Peak headway | 3 min |
...
|---|---|---|---|---|
| line-1 | 15.9 km | 8 | 47 | SW Mid ↔ NE Outer |
| line-2 | 14.0 km | 8 | 40 | SE Outer ↔ W Mid |
| line-3 | 14.8 km | 8 | 43 | N Outer ↔ W Mid |
| **Total** | **44.6 km** | **24 unique** | **130** | |
...
| Total fleet capacity | 31,200 AW2 pax (41,600 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 117 × 240 = **28,080 AW2 passengers** (37,440 AW3 crush)
- **Total fleet passenger capacity:** 130 × 240 = **31,200 AW2 passengers** (41,600 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **10,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **30.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| On-site PV shortfall before solar plant | 128 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 30.7 MW / 147 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 79 kWh | 159 kWh | 72 kWh | 7.3 km / 37 kWh |
| line-2 | 7 | 70 kWh | 131 kWh | 54 kWh | 5.1 km / 26 kWh |
| line-3 | 6 | 74 kWh | 131 kWh | 50 kWh | 8.0 km / 40 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (42.9 km @ $3.0 M/km) | $129 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 130 | $560 k | $73 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 260 | $60 k | $16 M |
| High sensitivity check | 260 | $120 k | $31 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 30,673 kW @ $700/kW | $21 M |
| Grid interconnection / PPA tie-in | 30,673 kW @ $100/kW | $3.1 M |
| Annual generation proxy | 30.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 53.7 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh huye`.
...
| Steady-state, low capacity-use (year 8+) | **$11 M / yr** | $44 |
| Steady-state, high capacity-use (year 8+) | **$716 k / yr** | $3 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $78 |
| Lifecycle envelope (yr 1–40, low scenario) | **$546 M cumulative** | $2,184 |
| Lifecycle envelope (yr 1–40, high scenario) | **$210 M cumulative** | $842 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$828 M cumulative** | $3,311 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.5 M / yr → $19 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $331 M | 4.5% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $83 M | — | — | — |
| **Total** | **100%** | **$413 M** | | | **$19 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $15 M / yr = **$15 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (65.5 GWh / yr) | 20,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 18.7 GWh/yr + dedicated solar plant 30.7 MW / 53.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $368 k |
| Labour (347 FTE) | driverless roster: OCC/remote 81, station/platform 98, passenger service 38, fleet maintenance 67, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $758 k |
| **OPEX subtotal** | | **$9.6 M / yr** |

_Annual service work: 20,762 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.2 M train-km / yr (16.4 M car-km / yr). On-site PV covers 18.7 GWh/yr and the dedicated solar plant adds 53.7 GWh/yr against 65.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 130 trainsets, 24 stations, 44.6 route-km, 3 lines, and 20,762 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 196 | 313 | 97 |
| Farebox revenue | $17 M / yr | $27 M / yr | $8.4 M / yr |
| Station shop leases | $445 k / yr | $445 k / yr | $445 k / yr |
| Advertising boards | $709 k / yr | $709 k / yr | $709 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$9.6 M / yr** |
| Revenue / OPEX recovery | 189% | 296% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $19 M / yr | $19 M / yr | **$19 M / yr** |
| Operating surplus applied to debt support | -$8.5 M / yr | -$19 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $716 k / yr | **$19 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.5 M / yr | $19 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,048 m² of station shop/kiosk leases at $10/m²/month and 764 advertising boards at $91/board/month, with occupancy derates applied._
...
| Healthcare | 5 healthcare anchors | 14,285 trips/day; 5.2 M access-events/yr | 22,856 trips/day; 8.3 M access-events/yr |
| Commerce | 15 major/terminal/interchange nodes | 30,216 trips/trading day; 10.0 M access-events/yr | 48,345 trips/trading day; 16.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $237 M | 57% of $413 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 38,020 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $389 M |
| Timetable-sized dedicated solar CAPEX | $25 M |
| **Reconciled project CAPEX** | **$413 M** |
| 15%–25% planning risk envelope | $475 M–$517 M |
| Annual OPEX | $9.6 M / yr |
| Low/high project NPV at 8% | $-250025 k / $-181719 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,844.72 train-km; 9,209.63 kWh consumed; 9,432.59 kWh charged; 33 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,153.39 train-km; 105,606.67 kWh consumed; 108,025.77 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 66%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| ten-hour all-site grid outage | 20.0% | 97.5% / 60% | pass |
| ten-hour single charging-pad outage | 66.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 2 interchange complexes, 18 civil segments, and 0 input findings |
