...
| Revenue fleet | 121 × 2-car trainsets |
| Revenue fleet passenger capacity | 29,040 AW2 pax (38,720 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 14 × 2-car trainsets |
| Peak headway | 3 min |
...
|---|---|---|---|---|
| line-1 | 15.3 km | 12 | 47 | W Outer ↔ NE Mid |
| line-2 | 15.9 km | 10 | 46 | S Outer ↔ NW Mid |
| line-3 | 14.9 km | 9 | 42 | NW Mid ↔ E Outer |
| **Total** | **46.1 km** | **31 unique** | **135** | |
...
| Revenue fleet capacity | 29,040 AW2 pax (38,720 AW3 crush) |
...
- **Revenue fleet simultaneous capacity:** 121 × 240 = **29,040 AW2 passengers** (38,720 AW3 crush)
- **Total fleet passenger capacity:** 135 × 240 = **32,400 AW2 passengers** (43,200 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **14,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **29.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 65 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 64 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 29.0 MW / 139 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 77 kWh | 212 kWh | 128 kWh | 2.0 km / 10 kWh |
| line-2 | 9 | 79 kWh | 172 kWh | 84 kWh | 5.0 km / 25 kWh |
| line-3 | 8 | 75 kWh | 147 kWh | 65 kWh | 4.5 km / 22 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 135 | $560 k | $76 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 270 | $60 k | $16 M |
| High sensitivity check | 270 | $120 k | $32 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 29,002 kW @ $700/kW | $20 M |
| Grid interconnection / PPA tie-in | 29,002 kW @ $100/kW | $2.9 M |
| Annual generation proxy | 29.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 50.8 GWh/yr |
...
| Per-capita (city pop) | $1,687 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh rubavu`.
...
| Steady-state, low capacity-use (year 8+) | **$11 M / yr** | $45 |
| Steady-state, high capacity-use (year 8+) | **$1.1 M / yr** | $4 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$563 M cumulative** | $2,250 |
| Lifecycle envelope (yr 1–40, high scenario) | **$227 M cumulative** | $908 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$845 M cumulative** | $3,379 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.6 M / yr → $19 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $337 M | 4.5% | 40 y, 7 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $84 M | — | — | — |
| **Total** | **100%** | **$422 M** | | | **$20 M / yr** |
...
| Traction energy (67.7 GWh / yr) | 21,455 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 23.5 GWh/yr + dedicated solar plant 29.0 MW / 50.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $348 k |
| Labour (375 FTE) | driverless roster: OCC/remote 86, station/platform 116, passenger service 38, fleet maintenance 69, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $819 k |
| **OPEX subtotal** | | **$9.8 M / yr** |

_Annual service work: 21,455 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.5 M train-km / yr (16.9 M car-km / yr). On-site PV covers 23.5 GWh/yr and the dedicated solar plant adds 50.8 GWh/yr against 67.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 135 trainsets, 31 stations, 46.1 route-km, 3 lines, and 21,455 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Advertising boards | $876 k / yr | $876 k / yr | $876 k / yr |
| **Total revenue** | **$18 M / yr** | **$29 M / yr** | **$9.8 M / yr** |
| Revenue / OPEX recovery | 187% | 291% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $20 M / yr | $20 M / yr | **$20 M / yr** |
| Operating surplus applied to debt support | -$8.6 M / yr | -$19 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $1.1 M / yr | **$20 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.6 M / yr | $19 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,952 m² of station shop/kiosk leases at $10/m²/month and 944 advertising boards at $91/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 7,526 trips/school day; 1.7 M access-events/yr | 12,042 trips/school day; 2.6 M access-events/yr |
| Healthcare | 10 healthcare anchors | 13,660 trips/day; 5.0 M access-events/yr | 21,856 trips/day; 8.0 M access-events/yr |
| Commerce | 20 major/terminal/interchange nodes | 30,499 trips/trading day; 10.1 M access-events/yr | 48,799 trips/trading day; 16.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $242 M | 57% of $422 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 38,724 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-256237 k / $-187931 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,859.13 train-km; 9,281.50 kWh consumed; 10,238.89 kWh charged; 30 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,213.28 train-km; 110,897.52 kWh consumed; 113,775.48 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 77.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 89.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 89.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 1 interchange complexes, 39 civil segments, and 0 input findings |
