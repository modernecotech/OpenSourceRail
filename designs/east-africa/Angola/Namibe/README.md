...
| Bucket | Value |
|---|---|
| At-grade (39.5 km @ $0.85 M/km) | $34 M |
| Elevated (0.4 km @ $4.0 M/km) | $1.5 M |
| **Civil subtotal** | **$35 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 55 | $534 k | $29 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 40.2 km × $0.015 M/km | $604 k |
...
|---|---|---|
| Construction (years 1–5) | **$8.8 M / yr** | $29 |
| Steady-state, low-ridership (year 6+) | **$5.0 M / yr** | $17 |
| Steady-state, high-ridership (year 6+) | **$1.4 M / yr** | $5 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$145 M cumulative** | $483 |
| Lifecycle envelope (yr 1–25, high scenario) | **$71 M cumulative** | $237 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$44 M cumulative** | $147 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $62 M | 4.5% | 25 y, 5 y grace | $4.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $26 M | 11.5% | 25 y, 5 y grace | $3.3 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$103 M** | | | **$8.1 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $2.8 M / yr + bonds $3.0 M / yr = **$5.7 M / yr** total — plus the equity tranche amortised across construction ($3.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 52,755 |
| Daily paid trips / population | 8% | 15% | 18% |
| Annual paid trips | 8.8 M | 16.4 M | 19.3 M |
| Farebox revenue | $4.2 M / yr | $7.9 M / yr | $9.2 M / yr |
| Station shop leases | $865 k / yr | $865 k / yr | $865 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$6.5 M / yr** | **$10 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 56% | 88% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $5.0 M / yr | $1.4 M / yr | **$0 / yr** |
