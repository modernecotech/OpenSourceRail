...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 55 | $2.80 M | $154 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 110 | $100 k | $11 M |
| High sensitivity check | 110 | $200 k | $22 M |
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $132 |
| Steady-state, low-ridership (year 6+) | **$41 M / yr** | $135 |
| Steady-state, high-ridership (year 6+) | **$37 M / yr** | $122 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $121 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.01 bn cumulative** | $3,360 |
| Lifecycle envelope (yr 1–25, high scenario) | **$931 M cumulative** | $3,105 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$922 M cumulative** | $3,072 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.3 M / yr → $487 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $277 M | 4.5% | 25 y, 5 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $115 M | 11.5% | 25 y, 5 y grace | $15 M / yr |
| Government equity (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$461 M** | | | **$36 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $13 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 32,832 | 54,720 | 57,502 |
| Daily paid trips / catchment | 18% | 30% | 32% |
| Daily paid trips / city population | 11% | 18% | 19% |
| Annual paid trips | 12.0 M | 20.0 M | 21.0 M |
| Farebox revenue | $5.8 M / yr | $9.6 M / yr | $10 M / yr |
| Station shop leases | $865 k / yr | $865 k / yr | $865 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$8.0 M / yr** | **$12 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 65% | 96% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $41 M / yr | $37 M / yr | **$36 M / yr** |
