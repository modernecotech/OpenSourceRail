...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$271 M (87.4%) of external capital** and **$333 M of external interest**. Capital plus saved interest totals **$604 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 30 × 3-car trainsets |
| Revenue fleet passenger capacity | 10,800 AW2 pax (14,400 AW3 crush) |
...
| Revenue fleet capacity | 10,800 AW2 pax (14,400 AW3 crush) |
| Total fleet capacity | 12,240 AW2 pax (16,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 30 × 360 = **10,800 AW2 passengers** (14,400 AW3 crush)
- **Total fleet passenger capacity:** 34 × 360 = **12,240 AW2 passengers** (16,320 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 56.9%
- Catchment population: **≈ 284,500** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **4,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **13.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 18.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 510 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 26 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 6,997 train-km/day | One-way train journeys × route length |
| Annual service work | 2.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 91 MWh/day | 8.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 57 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 13.6 MW / 65 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 69 kWh | 118 kWh | 42 kWh | 3.0 km / 23 kWh |
| line-2 | 3 | 43 kWh | 74 kWh | 26 kWh | 4.0 km / 30 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (13.8 km @ $3.0 M/km) | $41 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 34 | $900 k | $31 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 102 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 102 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 13,560 kW @ $700/kW | $9.5 M |
| Grid interconnection / PPA tie-in | 13,560 kW @ $100/kW | $1.4 M |
| Annual generation proxy | 13.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 23.8 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 15.0 km × $0.050 M/km | $752 k |
...
| Residual train-control wayside + charging microgrids | $1.8 M |
| EPC overhead (7%) | $11 M |
| **CAPEX total** | **$172 M** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $345 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $61 M | 15% | $9.2 M | $52 M |
| Stations | $50 M | 20% | $9.9 M | $40 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $31 M | 35% | $11 M | $20 M |
| Dedicated solar plant | $11 M | 45% | $4.9 M | $6.0 M |
| Residual signalling / train control | $752 k | 50% | $376 k | $376 k |
| Charging microgrids | $1.0 M | 40% | $400 k | $600 k |
| EPC / project services | $11 M | 15% | $1.6 M | $9.0 M |
| **Total city CAPEX** | **$172 M** | **22.6%** | **$39 M** | **$133 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh malanje`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.6%** | **$39 M** | **$7.8 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.4%** | **$133 M** | **$27 M / yr** |
| of which planned local bond issuance | 61.9% of total CAPEX | $107 M | $21 M / yr |
| **Total city programme** | **100.0%** | **$172 M** | **$34 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $233 M | $194 M (83.2%) | $238 M | **$432 M** |
| **Default** | 2.00× | $310 M | $271 M (87.4%) | $333 M | **$604 M** |
| High | 3.00× | $465 M | $426 M (91.6%) | $524 M | **$950 M** |

At the default 2.00× case, OSR's $39 M external requirement is 87.4% below the illustrative foreign-company requirement of $310 M; the associated lifetime external-interest saving is $333 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$19 M / yr** | $39 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$97 M cumulative** | $193 |
| Lifecycle envelope (yr 1–40, high scenario) | **$97 M cumulative** | $193 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$614 M cumulative** | $1,228 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $15 M / yr → $15 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $39 M | 4.5% | 40 y, 5 y grace | $2.2 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $107 M | 11.5% | 40 y, 5 y grace | $13 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $27 M | — | — | — |
| **Total** | **100%** | **$172 M** | | | **$15 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.8 M / yr + local bonds $12 M / yr = **$14 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (33.1 GWh / yr) | 6,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 12.4 GWh/yr + dedicated solar plant 13.6 MW / 23.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $163 k |
| Labour (163 FTE) | driverless roster: OCC/remote 33, station/platform 41, passenger service 33, fleet maintenance 20, infrastructure/energy 17, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $657 k |
| **OPEX subtotal** | | **$4.5 M / yr** |

_Annual service work: 6,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.8 M train-km / yr (8.3 M car-km / yr). On-site PV covers 12.4 GWh/yr and the dedicated solar plant adds 23.8 GWh/yr against 33.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 34 trainsets, 8 stations, 15.0 route-km, 2 lines, and 6,997 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 5.5 M |
| Annual paid trips / city resident | 98 | 156 | 11 |
| Farebox revenue | $31 M / yr | $50 M / yr | $3.5 M / yr |
| Station shop leases | $352 k / yr | $352 k / yr | $352 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$32 M / yr** | **$51 M / yr** | **$4.5 M / yr** |
| Revenue / OPEX recovery | 723% | 1145% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $15 M / yr | $15 M / yr | **$15 M / yr** |
| Operating surplus applied to debt support | -$15 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$15 M / yr** |
| Operating surplus after OPEX (before debt support) | $28 M / yr | $47 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,736 m² of station shop/kiosk leases at $19/m²/month and 328 advertising boards at $168/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $9.0 M / yr | $14 M / yr | 16 min/trip × $0.69/h value-of-time proxy |
...
| Station-area commerce turnover supported | $18 M / yr | $30 M / yr | 25% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $8.1 M / yr | $13 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$43 M / yr** | **$70 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 12,588 trips/school day; 2.8 M access-events/yr | 20,142 trips/school day; 4.4 M access-events/yr |
| Healthcare | 0 healthcare anchors | 8,035 trips/day; 2.9 M access-events/yr | 12,856 trips/day; 4.7 M access-events/yr |
| Commerce | 7 major/terminal/interchange nodes | 33,731 trips/trading day; 11.1 M access-events/yr | 53,970 trips/trading day; 17.8 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,815 trips/activity day; 4.4 M access-events/yr | 23,704 trips/activity day; 7.1 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $133 M | 77% of $172 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $213 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $43 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 11,569 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $161 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$172 M** |
| Imported / external-capital requirement | $39 M (22.6%) |
| Local-content / local-funding requirement | $133 M (77.4%) |
| Default foreign-turnkey external-capital comparison | $310 M; OSR saves $271 M (87.4%) |
| Lifetime external interest and combined financing saving | $333 M interest; $604 M capital + interest |
| 15%–25% planning risk envelope | $198 M–$215 M |
| Annual OPEX | $4.5 M / yr |
| Low/high project NPV at 8% | $83 M / $231 M |
| Low/high project IRR | 12.4% / 18.6% |
| Low/high steady-state DSCR | 1.88 / 3.15 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 691.68 train-km; 5,179.24 kWh consumed; 5,347.52 kWh charged; 27 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 7,209.45 train-km; 53,983.79 kWh consumed; 54,970.27 kWh charged; 329 depot services completed (4 active at cutoff); minimum SoC 66%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 58.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 52.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 66.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.1% / 60% | pass |
| ten-hour single charging-pad outage | 25.3% | 100.0% / 90% | pass |
...
|---|---|
| ![Malanje energy and battery simulation dashboard](engineering/screenshots/malanje-simulation-dashboard.png) | ![Malanje simulator network visualizer](engineering/screenshots/malanje-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 8 line platforms, 1 interchange complexes, 6 civil segments, and 0 input findings |
...
|---|---|
| ![Malanje QGIS engineering layers](engineering/screenshots/malanje-qgis-engineering-map.png) | ![Malanje SUMO timetable validation](engineering/screenshots/malanje-sumo-validation.png) |
...
scripts/regenerate-city.sh malanje
```
