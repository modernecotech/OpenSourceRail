...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$256 M (87.2%) of external capital** and **$315 M of external interest**. Capital plus saved interest totals **$571 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (13.8 km @ $2.58 M/km) | $36 M |
| Elevated (1.3 km @ $9.75 M/km) | $12 M |
...
| EPC integration + project management (7%) | on subtotal | $10.0 M |
...
| EPC overhead (7%) | $10.0 M |
| **CAPEX total** | **$163 M** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $326 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $52 M | 15% | $7.9 M | $45 M |
...
| EPC / project services | $10.0 M | 15% | $1.5 M | $8.5 M |
| **Total city CAPEX** | **$163 M** | **23.1%** | **$38 M** | **$125 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$38 M** | **$7.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$125 M** | **$25 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $100 M | $20 M / yr |
| **Total city programme** | **100.0%** | **$163 M** | **$33 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $220 M | $183 M (82.9%) | $224 M | **$407 M** |
| **Default** | 2.00× | $294 M | $256 M (87.2%) | $315 M | **$571 M** |
| High | 3.00× | $440 M | $403 M (91.5%) | $495 M | **$898 M** |

At the default 2.00× case, OSR's $38 M external requirement is 87.2% below the illustrative foreign-company requirement of $294 M; the associated lifetime external-interest saving is $315 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$18 M / yr** | $37 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$14 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$91 M cumulative** | $183 |
| Lifecycle envelope (yr 1–40, high scenario) | **$91 M cumulative** | $183 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$580 M cumulative** | $1,160 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $38 M | 4.5% | 40 y, 5 y grace | $2.2 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $100 M | 11.5% | 40 y, 5 y grace | $12 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $25 M | — | — | — |
| **Total** | **100%** | **$163 M** | | | **$14 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.7 M / yr + local bonds $12 M / yr = **$13 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 5.3 M |
| Annual paid trips / city resident | 98 | 156 | 11 |
| Farebox revenue | $31 M / yr | $50 M / yr | $3.4 M / yr |
| Station shop leases | $352 k / yr | $352 k / yr | $352 k / yr |
| Advertising boards | $562 k / yr | $562 k / yr | $562 k / yr |
| **Total revenue** | **$32 M / yr** | **$51 M / yr** | **$4.3 M / yr** |
| Revenue / OPEX recovery | 752% | 1191% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $125 M | 77% of $163 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $201 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $40 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 10,891 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $152 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$163 M** |
| Imported / external-capital requirement | $38 M (23.1%) |
| Local-content / local-funding requirement | $125 M (76.9%) |
| Default foreign-turnkey external-capital comparison | $294 M; OSR saves $256 M (87.2%) |
| Lifetime external interest and combined financing saving | $315 M interest; $571 M capital + interest |
| 15%–25% planning risk envelope | $188 M–$204 M |
| Annual OPEX | $4.3 M / yr |
| Low/high project NPV at 8% | $91 M / $240 M |
| Low/high project IRR | 13.0% / 19.4% |
| Low/high steady-state DSCR | 2.00 / 3.34 |
