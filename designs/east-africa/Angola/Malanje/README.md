...
|---|---|---|---|---|
| line-1 |  9.3 km | 6 | 26 | W Outer ↔ E Outer |
| line-2 |  5.8 km | 5 | 17 | SE Mid ↔ NW Mid |
| **Total** | **15.0 km** | **11 unique** | **43** | |
...
| Total fleet capacity | 15,480 AW2 pax (20,640 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 38 × 360 = **13,680 AW2 passengers** (18,240 AW3 crush)
- **Total fleet passenger capacity:** 43 × 360 = **15,480 AW2 passengers** (20,640 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 30.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 522 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 12.5 MW / 60 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 69 kWh | 139 kWh | 63 kWh | 2.4 km / 18 kWh |
| line-2 | 5 | 43 kWh | 98 kWh | 50 kWh | 1.8 km / 14 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (13.2 km @ $3.0 M/km) | $40 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 43 | $900 k | $39 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 129 | $60 k | $7.7 M |
| High sensitivity check | 129 | $120 k | $15 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 12,525 kW @ $700/kW | $8.8 M |
| Grid interconnection / PPA tie-in | 12,525 kW @ $100/kW | $1.3 M |
| Annual generation proxy | 12.5 MW × 4.8 peak-sun-h/day × 365 d/yr | 21.9 GWh/yr |
...
| Depots | $8.0 M |
| Rolling stock | $39 M |
| Railway production plant | $7.7 M |
...
|---|---|---|
| Construction (years 1–5) | **$17 M / yr** | $33 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$10.0 M / yr** | $20 |
| Lifecycle envelope (yr 1–40, low scenario) | **$83 M cumulative** | $165 |
| Lifecycle envelope (yr 1–40, high scenario) | **$83 M cumulative** | $165 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$431 M cumulative** | $862 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $10.0 M / yr → $10.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $174 M | 4.5% | 40 y, 5 y grace | $10.0 M / yr |
| Government equity (no debt service) | 20% | $43 M | — | — | — |
| **Total** | **100%** | **$217 M** | | | **$10.0 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $7.8 M / yr = **$7.8 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.7 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (33.1 GWh / yr) | 6,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 14.0 GWh/yr + dedicated solar plant 12.5 MW / 21.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $150 k |
| Labour (183 FTE) | driverless roster: OCC/remote 37, station/platform 53, passenger service 33, fleet maintenance 23, infrastructure/energy 18, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $738 k |
| **OPEX subtotal** | | **$5.4 M / yr** |

_Annual service work: 6,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.8 M train-km / yr (8.3 M car-km / yr). On-site PV covers 14.0 GWh/yr and the dedicated solar plant adds 21.9 GWh/yr against 33.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 43 trainsets, 11 stations, 15.0 route-km, 2 lines, and 6,997 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 98 | 156 | 13 |
| Farebox revenue | $31 M / yr | $50 M / yr | $4.2 M / yr |
| Station shop leases | $459 k / yr | $459 k / yr | $459 k / yr |
| Advertising boards | $727 k / yr | $727 k / yr | $727 k / yr |
| **Total revenue** | **$32 M / yr** | **$51 M / yr** | **$5.4 M / yr** |
| Revenue / OPEX recovery | 604% | 953% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $10.0 M / yr | $10.0 M / yr | **$10.0 M / yr** |
| Operating surplus applied to debt support | -$10.0 M / yr | -$10.0 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$10.0 M / yr** |
| Operating surplus after OPEX (before debt support) | $27 M / yr | $46 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,264 m² of station shop/kiosk leases at $19/m²/month and 424 advertising boards at $168/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $125 M | 58% of $217 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 10,857 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$217 M** |
| 15%–25% planning risk envelope | $250 M–$272 M |
| Annual OPEX | $5.4 M / yr |
| Low/high project NPV at 8% | $41 M / $190 M |
| Low/high project IRR | 9.9% / 15.4% |
| Low/high steady-state DSCR | 2.72 / 4.61 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 685.61 train-km; 5,133.76 kWh consumed; 5,581.11 kWh charged; 26 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 7,284.84 train-km; 54,548.32 kWh consumed; 55,820.96 kWh charged; 325 depot services completed (4 active at cutoff); minimum SoC 82%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 77.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 62.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 82.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 48.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 11 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
