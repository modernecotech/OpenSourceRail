...
| Bucket | Value |
|---|---|
| At-grade (20.7 km @ €3.5 M/km) | €72 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 22.4 km × €0.015 M/km | €0.3 M |
...
| Steady-state, low-ridership (year 6+) | **€29 M / yr** | €117 |
| Steady-state, high-ridership (year 6+) | **€28 M / yr** | €110 |
| Lifecycle envelope (yr 1–25, low scenario) | **€714 M cumulative** | €2,857 |
| Lifecycle envelope (yr 1–25, high scenario) | **€681 M cumulative** | €2,723 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€5.7 M / yr (low) → €4.0 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €180 M | 4.5% | 25 y, 5 y grace | €14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €75 M | 11.5% | 25 y, 5 y grace | €9.7 M / yr |
| Government equity (no debt service) | 15% | €45 M | — | — | — |
| **Total** | **100%** | **€301 M** | | | **€24 M / yr** |
...
| Labour (146 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €542 k |
...
| Operating shortfall (gov subsidy required) | €5.7 M / yr | €4.0 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€29 M / yr** | **€28 M / yr** |
