...
|---|---|---|
| Construction (years 1–5) | **$21 M / yr** | $83 |
| Steady-state, low capacity-use (year 6+) | **$3.1 M / yr** | $12 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$213 M cumulative** | $854 |
| Lifecycle envelope (yr 1–40, high scenario) | **$104 M cumulative** | $416 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$521 M cumulative** | $2,083 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.8 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $297 M | 2.0% | 40 y, 5 y grace | $12 M / yr |
| Government equity (no debt service) | 20% | $74 M | — | — | — |
| **Total** | **100%** | **$372 M** | | | **$12 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $5.9 M / yr = **$5.9 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($15 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Labour (215 FTE) | driverless roster: OCC/remote 41, station/platform 55, passenger service 24, fleet maintenance 31, infrastructure/energy 36, admin/training 28; no train drivers × country median × 12 × engineer-premium 1.4 | $867 k |
...
| Annual paid trips | 28.0 M | 44.9 M | 14.3 M |
| Annual paid trips / city resident | 112 | 179 | 57 |
| Farebox revenue | $18 M / yr | $29 M / yr | $9.2 M / yr |
| Station shop leases | $466 k / yr | $466 k / yr | $466 k / yr |
| Advertising boards | $761 k / yr | $761 k / yr | $761 k / yr |
| **Total revenue** | **$19 M / yr** | **$30 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 184% | 288% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $12 M / yr | $12 M / yr | **$12 M / yr** |
| Operating surplus applied to debt support | -$8.8 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.1 M / yr | $0 k / yr | **$12 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $5.2 M / yr | $8.3 M / yr | 16 min/trip × $0.69/h value-of-time proxy |
| Avoided road congestion | $3.4 M / yr | $5.4 M / yr | 42 M - 68 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $610 k / yr | $977 k / yr | 7.6–12.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$25 M / yr** | **$39 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 8 major/terminal/interchange nodes | 16,896 trips/trading day; 5.6 M access-events/yr | 27,034 trips/trading day; 8.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $202 M | 54% of $372 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $323 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $65 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,549 job-years | retained CAPEX ÷ (4.0 × median annual income) |
