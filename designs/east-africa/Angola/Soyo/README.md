...
| **Total city CAPEX** | **$315 M** | **41.6%** | **$131 M** | **$184 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **41.6%** | **$131 M** | **$26 M / yr** |
| **Local capital for domestic procurement / payroll** | **58.4%** | **$184 M** | **$37 M / yr** |
| of which planned local bond issuance | 46.7% of total CAPEX | $147 M | $29 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$30 M / yr** | $121 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $99 |
| Lifecycle envelope (yr 1–40, low scenario) | **$151 M cumulative** | $603 |
| Lifecycle envelope (yr 1–40, high scenario) | **$151 M cumulative** | $603 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $4,072 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 42% | $131 M | 4.5% | 40 y, 5 y grace | $7.5 M / yr |
| Local-currency sovereign / project bonds for local content | 47% | $147 M | 11.5% | 40 y, 5 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 12% | $37 M | — | — | — |
| **Total** | **100%** | **$315 M** | | | **$25 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.9 M / yr + local bonds $17 M / yr = **$23 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $184 M | 58% of $315 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $294 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $59 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 15,950 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $131 M (41.6%) |
| Local-content / local-funding requirement | $184 M (58.4%) |
...
| Low/high steady-state DSCR | 1.03 / 1.79 |
