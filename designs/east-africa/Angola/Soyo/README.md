...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$501 M (88.4%) of external capital** and **$616 M of external interest**. Capital plus saved interest totals **$1.12 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 81.2%
- Catchment population: **≈ 203,000** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 13.5× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 333 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 13,679 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 75 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 47 kWh | 98 kWh | 47 kWh | 3.0 km / 15 kWh |
| line-2 | 4 | 43 kWh | 82 kWh | 35 kWh | 3.5 km / 17 kWh |
| line-3 | 5 | 57 kWh | 118 kWh | 55 kWh | 5.3 km / 27 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 18,081 kW @ $700/kW | $13 M |
| Grid interconnection / PPA tie-in | 18,081 kW @ $100/kW | $1.8 M |
...
| Per-capita (city pop) | $1,258 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $129 M | 15% | $19 M | $110 M |
...
| Residual signalling / train control | $1.5 M | 50% | $735 k | $735 k |
| Charging microgrids | $1.7 M | 40% | $680 k | $1.0 M |
| EPC / project services | $20 M | 15% | $2.9 M | $17 M |
| **Total city CAPEX** | **$315 M** | **20.8%** | **$66 M** | **$249 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh soyo`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.8%** | **$66 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.2%** | **$249 M** | **$50 M / yr** |
| of which planned local bond issuance | 63.3% of total CAPEX | $199 M | $40 M / yr |
| **Total city programme** | **100.0%** | **$315 M** | **$63 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $425 M | $359 M (84.6%) | $441 M | **$801 M** |
| **Default** | 2.00× | $566 M | $501 M (88.4%) | $616 M | **$1.12 bn** |
| High | 3.00× | $849 M | $784 M (92.3%) | $964 M | **$1.75 bn** |

At the default 2.00× case, OSR's $66 M external requirement is 88.4% below the illustrative foreign-company requirement of $566 M; the associated lifetime external-interest saving is $616 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $143 |
| Steady-state, low capacity-use (year 6+) | **$1.6 M / yr** | $7 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $109 |
| Lifecycle envelope (yr 1–40, low scenario) | **$236 M cumulative** | $946 |
| Lifecycle envelope (yr 1–40, high scenario) | **$179 M cumulative** | $716 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.13 bn cumulative** | $4,522 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $26 M / yr → $27 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $66 M | 4.5% | 40 y, 5 y grace | $3.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $199 M | 11.5% | 40 y, 5 y grace | $23 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $50 M | — | — | — |
| **Total** | **100%** | **$315 M** | | | **$27 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.9 M / yr + local bonds $23 M / yr = **$26 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($10.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (43.1 GWh / yr) | 13,679 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 18.1 MW / 31.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $217 k |
| Labour (253 FTE) | driverless roster: OCC/remote 49, station/platform 79, passenger service 38, fleet maintenance 37, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$7.6 M / yr** |

_Annual service work: 13,679 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.4 M train-km / yr (10.8 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 31.7 GWh/yr against 43.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 63 trainsets, 14 stations, 29.4 route-km, 3 lines, and 13,679 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 9.0 M |
| Annual paid trips / city resident | 196 | 313 | 36 |
| Farebox revenue | $31 M / yr | $50 M / yr | $5.7 M / yr |
| Station shop leases | $715 k / yr | $715 k / yr | $715 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$33 M / yr** | **$52 M / yr** | **$7.6 M / yr** |
| Revenue / OPEX recovery | 438% | 686% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $27 M / yr | $27 M / yr | **$27 M / yr** |
| Operating surplus applied to debt support | -$26 M / yr | -$27 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.6 M / yr | $0 k / yr | **$27 M / yr** |
| Operating surplus after OPEX (before debt support) | $26 M / yr | $44 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,528 m² of station shop/kiosk leases at $19/m²/month and 644 advertising boards at $168/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$44 M / yr** | **$71 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $249 M | 79% of $315 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $398 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $80 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 21,614 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $300 M |
| Timetable-sized dedicated solar CAPEX | $14 M |
| **Reconciled project CAPEX** | **$315 M** |
| Imported / external-capital requirement | $66 M (20.8%) |
| Local-content / local-funding requirement | $249 M (79.2%) |
| Default foreign-turnkey external-capital comparison | $566 M; OSR saves $501 M (88.4%) |
| Lifetime external interest and combined financing saving | $616 M interest; $1.12 bn capital + interest |
| 15%–25% planning risk envelope | $362 M–$393 M |
| Annual OPEX | $7.6 M / yr |
| Low/high project NPV at 8% | $-48583 k / $100 M |
| Low/high project IRR | 6.3% / 11.0% |
| Low/high steady-state DSCR | 0.94 / 1.63 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,295.04 train-km; 6,465.39 kWh consumed; 6,966.71 kWh charged; 38 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,565.28 train-km; 67,723.78 kWh consumed; 69,007.32 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 99.2% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 84.6% | 99.2% / 90% | pass |
| maximum planning climate/HVAC duty | 74.3% | 99.2% / 90% | pass |
| 50% charging-contact availability | 86.4% | 99.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.9% / 60% | pass |
| ten-hour single charging-pad outage | 79.9% | 99.2% / 90% | pass |
...
|---|---|
| ![Soyo energy and battery simulation dashboard](engineering/screenshots/soyo-simulation-dashboard.png) | ![Soyo simulator network visualizer](engineering/screenshots/soyo-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 3 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Soyo QGIS engineering layers](engineering/screenshots/soyo-qgis-engineering-map.png) | ![Soyo SUMO timetable validation](engineering/screenshots/soyo-sumo-validation.png) |
