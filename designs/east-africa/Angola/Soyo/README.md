...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$469 M (88.2%) of external capital** and **$577 M of external interest**. Capital plus saved interest totals **$1.05 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| EPC / project services | $18 M | 15% | $2.8 M | $16 M |
| **Total city CAPEX** | **$295 M** | **21.2%** | **$63 M** | **$233 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$63 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$233 M** | **$47 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $186 M | $37 M / yr |
| **Total city programme** | **100.0%** | **$295 M** | **$59 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $399 M | $336 M (84.3%) | $413 M | **$749 M** |
| **Default** | 2.00× | $532 M | $469 M (88.2%) | $577 M | **$1.05 bn** |
| High | 3.00× | $798 M | $735 M (92.1%) | $904 M | **$1.64 bn** |

At the default 2.00× case, OSR's $63 M external requirement is 88.2% below the illustrative foreign-company requirement of $532 M; the associated lifetime external-interest saving is $577 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$34 M / yr** | $134 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $102 |
| Lifecycle envelope (yr 1–40, low scenario) | **$168 M cumulative** | $671 |
| Lifecycle envelope (yr 1–40, high scenario) | **$168 M cumulative** | $671 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $4,239 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $63 M | 4.5% | 40 y, 5 y grace | $3.6 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $186 M | 11.5% | 40 y, 5 y grace | $22 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $47 M | — | — | — |
| **Total** | **100%** | **$295 M** | | | **$25 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.8 M / yr + local bonds $21 M / yr = **$24 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips / city resident | 196 | 313 | 34 |
| Farebox revenue | $31 M / yr | $50 M / yr | $5.4 M / yr |
| Station shop leases | $715 k / yr | $715 k / yr | $715 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$33 M / yr** | **$52 M / yr** | **$7.2 M / yr** |
| Revenue / OPEX recovery | 460% | 720% | 100% |
...
| Operating surplus after OPEX (before debt support) | $26 M / yr | $45 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $233 M | 79% of $295 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $372 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $74 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 20,201 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $281 M |
| Timetable-sized dedicated solar CAPEX | $14 M |
| **Reconciled project CAPEX** | **$295 M** |
| Imported / external-capital requirement | $63 M (21.2%) |
| Local-content / local-funding requirement | $233 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $532 M; OSR saves $469 M (88.2%) |
| Lifetime external interest and combined financing saving | $577 M interest; $1.05 bn capital + interest |
| 15%–25% planning risk envelope | $340 M–$369 M |
| Annual OPEX | $7.2 M / yr |
| Low/high project NPV at 8% | $-30452 k / $118 M |
| Low/high project IRR | 6.9% / 11.7% |
| Low/high steady-state DSCR | 1.02 / 1.75 |
