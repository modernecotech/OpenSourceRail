...
|---|---|---|---|---|
| line-1 | 15.8 km | 9 | 40 | NW Mid ↔ E Mid |
| line-2 | 24.0 km | 12 | 60 | SW Mid ↔ NE Outer |
| line-3 | 13.9 km | 10 | 34 | W Mid ↔ SE Mid |
| **Total** | **53.8 km** | **31 unique** | **134** | |
...
| Onboard battery adequacy | 8.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 475 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 41.6 MW / 270 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 132 kWh | 192 kWh | 47 kWh | 2.3 km / 19 kWh |
| line-2 | 11 | 201 kWh | 278 kWh | 57 kWh | 7.8 km / 65 kWh |
| line-3 | 10 | 116 kWh | 180 kWh | 52 kWh | 2.0 km / 17 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 41,567 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 41,567 kW @ $100/kW | $4.2 M |
| Annual generation proxy | 41.6 MW × 6.5 peak-sun-h/day × 365 d/yr | 98.6 GWh/yr |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$195 M cumulative** | $279 |
| Lifecycle envelope (yr 1–40, high scenario) | **$195 M cumulative** | $279 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $1,458 |
...
| Traction energy (118.3 GWh / yr) | 24,999 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 32.5 GWh/yr + dedicated solar plant 41.6 MW / 98.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $499 k |
| Labour (390 FTE) | driverless roster: OCC/remote 81, station/platform 115, passenger service 49, fleet maintenance 74, infrastructure/energy 50, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 24,999 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.9 M train-km / yr (29.6 M car-km / yr). On-site PV covers 32.5 GWh/yr and the dedicated solar plant adds 98.6 GWh/yr against 118.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 134 trainsets, 31 stations, 53.8 route-km, 3 lines, and 24,999 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 105 | 168 | 24 |
...
_Commercial-revenue assumptions: 4,648 m² of station shop/kiosk leases at $19/m²/month and 896 advertising boards at $168/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 6 education anchors | 14,234 trips/school day; 3.1 M access-events/yr | 22,774 trips/school day; 5.0 M access-events/yr |
| Healthcare | 6 healthcare anchors | 16,874 trips/day; 6.2 M access-events/yr | 26,998 trips/day; 9.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $289 M | 56% of $514 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,125 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-122106 k / $101 M |
| Low/high project IRR | 5.3% / 9.9% |
| Low/high steady-state DSCR | 1.54 / 2.74 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,044.25 train-km; 17,071.54 kWh consumed; 16,765.35 kWh charged; 28 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,265.78 train-km; 210,995.24 kWh consumed; 213,268.78 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 54%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 43.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 53.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.5% / 60% | pass |
| ten-hour single charging-pad outage | 22.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 1 interchange complexes, 18 civil segments, and 0 input findings |
