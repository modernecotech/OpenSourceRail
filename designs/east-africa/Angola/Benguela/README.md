...
|---|---|---|---|---|
| line-1 | 21.3 km | 11 | 54 | NE Outer ↔ S Inner |
| line-2 | 16.8 km | 11 | 43 | NE Mid ↔ W Outer |
| line-3 | 12.3 km | 8 | 34 | NW Inner ↔ SE Mid |
| **Total** | **50.5 km** | **30 unique** | **131** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **38.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 57 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 87 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 38.4 MW / 249 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 178 kWh | 253 kWh | 57 kWh | 6.8 km / 57 kWh |
| line-2 | 11 | 140 kWh | 233 kWh | 78 kWh | 2.0 km / 17 kWh |
| line-3 | 8 | 103 kWh | 172 kWh | 58 kWh | 2.0 km / 17 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,383 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,383 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 38.4 MW × 6.5 peak-sun-h/day × 365 d/yr | 91.1 GWh/yr |
...
| Per-capita (city pop) | $852 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$194 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, high scenario) | **$194 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,689 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $409 M | 4.5% | 40 y, 5 y grace | $23 M / yr |
| Government equity (no debt service) | 20% | $102 M | — | — | — |
| **Total** | **100%** | **$511 M** | | | **$23 M / yr** |
...
| Traction energy (111.0 GWh / yr) | 23,460 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 31.8 GWh/yr + dedicated solar plant 38.4 MW / 91.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $461 k |
| Labour (371 FTE) | driverless roster: OCC/remote 81, station/platform 101, passenger service 49, fleet maintenance 71, infrastructure/energy 48, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 23,460 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.2 M train-km / yr (27.7 M car-km / yr). On-site PV covers 31.8 GWh/yr and the dedicated solar plant adds 91.1 GWh/yr against 111.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 131 trainsets, 30 stations, 50.5 route-km, 3 lines, and 23,460 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Revenue / OPEX recovery | 383% | 603% | 100% |
...
_Commercial-revenue assumptions: 4,192 m² of station shop/kiosk leases at $19/m²/month and 824 advertising boards at $168/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $289 M | 57% of $511 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $462 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $92 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 25,068 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-119716 k / $104 M |
| Low/high project IRR | 5.4% / 10.0% |
| Low/high steady-state DSCR | 1.55 / 2.76 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,932.13 train-km; 16,135.27 kWh consumed; 16,166.71 kWh charged; 28 depot services completed; minimum SoC 77%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,726.38 train-km; 198,140.01 kWh consumed; 199,396.77 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| 50% charging-contact availability | 52.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.1% / 60% | pass |
| ten-hour single charging-pad outage | 47.6% | 100.0% / 90% | pass |
