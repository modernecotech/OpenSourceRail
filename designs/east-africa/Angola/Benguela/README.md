...
| Per-capita (city pop) | $734 / person |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$873 M cumulative** | $1,456 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $352 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $88 M | — | — | — |
| **Total** | **100%** | **$440 M** | | | **$20 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $248 M | 56% of $440 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,534 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-55260 k / $168 M |
| Low/high project IRR | 6.6% / 11.6% |
| Low/high steady-state DSCR | 1.85 / 3.25 |
