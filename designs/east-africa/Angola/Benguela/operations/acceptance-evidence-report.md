...
| Manufacturing schedule rows | 1,155 |
| Manufacturing material/BOM rows | 17,266 |
| Manufacturing QA verification rows | 1,155 |
| Construction QA action rows | 1,072 |
| Maintenance handover schedule rows | 1,377 |
| Manufacturing rows with material refs | 1,155 / 1,155 |
| Manufacturing rows with verification refs | 1,155 / 1,155 |
| Manufacturing rows linked to QA actions | 1,155 / 1,155 |
