...
|---|---|---|---|---|
| line-1 | 23.7 km | 13 | 61 | W Outer ↔ E Outer |
| line-2 | 12.9 km | 9 | 31 | E Mid ↔ SW Mid |
| line-3 | 15.9 km | 10 | 40 | N Mid ↔ S Outer |
| **Total** | **52.4 km** | **32 unique** | **132** | |
...
| Total fleet capacity | 47,520 AW2 pax (63,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 119 × 360 = **42,840 AW2 passengers** (57,120 AW3 crush)
- **Total fleet passenger capacity:** 132 × 360 = **47,520 AW2 passengers** (63,360 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **40.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 89 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 40.1 MW / 261 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 198 kWh | 302 kWh | 85 kWh | 5.5 km / 46 kWh |
| line-2 | 9 | 108 kWh | 163 kWh | 45 kWh | 2.3 km / 19 kWh |
| line-3 | 9 | 133 kWh | 192 kWh | 46 kWh | 4.1 km / 35 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 132 | $900 k | $119 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 396 | $60 k | $24 M |
| High sensitivity check | 396 | $120 k | $48 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 40,138 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 40,138 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 40.1 MW × 6.5 peak-sun-h/day × 365 d/yr | 95.2 GWh/yr |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$196 M cumulative** | $245 |
| Lifecycle envelope (yr 1–40, high scenario) | **$196 M cumulative** | $245 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $1,279 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $413 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $103 M | — | — | — |
| **Total** | **100%** | **$516 M** | | | **$24 M / yr** |
...
| Traction energy (115.3 GWh / yr) | 24,376 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 32.5 GWh/yr + dedicated solar plant 40.1 MW / 95.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $482 k |
| Labour (383 FTE) | driverless roster: OCC/remote 81, station/platform 110, passenger service 49, fleet maintenance 72, infrastructure/energy 50, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 24,376 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.6 M train-km / yr (28.8 M car-km / yr). On-site PV covers 32.5 GWh/yr and the dedicated solar plant adds 95.2 GWh/yr against 115.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 132 trainsets, 32 stations, 52.4 route-km, 3 lines, and 24,376 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Station shop leases | $915 k / yr | $915 k / yr | $915 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$49 M / yr** | **$78 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 380% | 597% | 100% |
...
| Operating surplus after OPEX (before debt support) | $36 M / yr | $65 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,512 m² of station shop/kiosk leases at $19/m²/month and 880 advertising boards at $168/board/month, with occupancy derates applied._
...
| Commerce | 16 major/terminal/interchange nodes | 42,687 trips/trading day; 14.1 M access-events/yr | 68,299 trips/trading day; 22.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $291 M | 56% of $516 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,290 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-123477 k / $100 M |
| Low/high project IRR | 5.3% / 9.9% |
| Low/high steady-state DSCR | 1.54 / 2.73 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,005.87 train-km; 16,751.10 kWh consumed; 16,941.48 kWh charged; 28 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,163.52 train-km; 210,141.84 kWh consumed; 213,614.68 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 35%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 23.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 35.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 32 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
