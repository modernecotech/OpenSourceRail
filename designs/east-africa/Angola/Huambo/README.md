...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **57,520 – 86,280 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (50.6 km @ €3.5 M/km) | €177 M |
| Elevated (2.0 km @ €18 M/km) | €37 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 52.9 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–5) | **€46 M / yr** | €58 |
| Steady-state, low-ridership (year 6+) | **€51 M / yr** | €64 |
| Steady-state, high-ridership (year 6+) | **€46 M / yr** | €58 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.26 bn cumulative** | €1,577 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.15 bn cumulative** | €1,442 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€9.0 M / yr (low) → €3.7 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €324 M | 4.5% | 25 y, 5 y grace | €25 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €135 M | 11.5% | 25 y, 5 y grace | €18 M / yr |
| Government equity (no debt service) | 15% | €81 M | — | — | — |
| **Total** | **100%** | **€540 M** | | | **€42 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €16 M / yr = **€30 M / yr** total — plus the equity tranche amortised across construction (€16 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (329 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.2 M |
...
| Farebox revenue | €5.4 M / yr | €11 M / yr |
| Farebox / OPEX recovery | 37% | 75% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €9.0 M / yr | €3.7 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€51 M / yr** | **€46 M / yr** |
