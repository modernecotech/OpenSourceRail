...
| Per-capita (city pop) | $573 / person |
...
|---|---|---|
| Construction (years 1–5) | **$35 M / yr** | $44 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$174 M cumulative** | $218 |
| Lifecycle envelope (yr 1–40, high scenario) | **$174 M cumulative** | $218 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$909 M cumulative** | $1,137 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $367 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $92 M | — | — | — |
| **Total** | **100%** | **$458 M** | | | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $259 M | 56% of $458 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 22,447 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $424 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$458 M** |
| 15%–25% planning risk envelope | $527 M–$573 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-70724 k / $153 M |
| Low/high project IRR | 6.3% / 11.1% |
| Low/high steady-state DSCR | 1.77 / 3.11 |
