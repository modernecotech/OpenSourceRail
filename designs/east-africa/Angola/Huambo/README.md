...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$638 M (86.6%) of external capital** and **$785 M of external interest**. Capital plus saved interest totals **$1.42 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 52.4 km |
...
- Anchor-weighted coverage: 71.4%
- Catchment population: **≈ 571,200** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **43.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 482 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 29 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 70 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 24,376 train-km/day | One-way train journeys × route length |
| Annual service work | 9.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 316 MWh/day | 28.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 246 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 43.6 MW / 283 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 198 kWh | 261 kWh | 44 kWh | 7.0 km / 58 kWh |
| line-2 | 6 | 108 kWh | 147 kWh | 29 kWh | 3.0 km / 25 kWh |
| line-3 | 6 | 133 kWh | 196 kWh | 50 kWh | 6.8 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (50.3 km @ $2.58 M/km) | $130 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 43,588 kW @ $700/kW | $31 M |
| Grid interconnection / PPA tie-in | 43,588 kW @ $100/kW | $4.4 M |
| Annual generation proxy | 43.6 MW × 6.5 peak-sun-h/day × 365 d/yr | 103.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 52.4 km × $0.050 M/km | $2.6 M |
...
| **Total city CAPEX** | **$409 M** | **24.1%** | **$99 M** | **$311 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh huambo`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$99 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$311 M** | **$62 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $249 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$409 M** | **$82 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $553 M | $454 M (82.2%) | $558 M | **$1.01 bn** |
| **Default** | 2.00× | $737 M | $638 M (86.6%) | $785 M | **$1.42 bn** |
| High | 3.00× | $1.11 bn | $1.01 bn (91.1%) | $1.24 bn | **$2.24 bn** |

At the default 2.00× case, OSR's $99 M external requirement is 86.6% below the illustrative foreign-company requirement of $737 M; the associated lifetime external-interest saving is $785 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$45 M / yr** | $57 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$227 M cumulative** | $284 |
| Lifecycle envelope (yr 1–40, high scenario) | **$227 M cumulative** | $284 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.45 bn cumulative** | $1,810 |

_Population basis: 800,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $35 M / yr → $35 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $99 M | 4.5% | 40 y, 5 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $249 M | 11.5% | 40 y, 5 y grace | $29 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $62 M | — | — | — |
| **Total** | **100%** | **$409 M** | | | **$35 M / yr** |
...
| Traction energy (115.3 GWh / yr) | 24,376 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.4 GWh/yr + dedicated solar plant 43.6 MW / 103.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $523 k |
| Labour (335 FTE) | driverless roster: OCC/remote 73, station/platform 80, passenger service 49, fleet maintenance 66, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 24,376 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.6 M train-km / yr (28.8 M car-km / yr). On-site PV covers 25.4 GWh/yr and the dedicated solar plant adds 103.4 GWh/yr against 115.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 112 trainsets, 21 stations, 52.4 route-km, 3 lines, and 24,376 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 14.3 M |
| Annual paid trips / city resident | 92 | 147 | 18 |
| Farebox revenue | $47 M / yr | $75 M / yr | $9.2 M / yr |
| Station shop leases | $663 k / yr | $663 k / yr | $663 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$49 M / yr** | **$77 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 446% | 703% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $35 M / yr | $35 M / yr | **$35 M / yr** |
| Operating surplus applied to debt support | -$35 M / yr | -$35 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$35 M / yr** |
| Operating surplus after OPEX (before debt support) | $38 M / yr | $66 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,272 m² of station shop/kiosk leases at $19/m²/month and 636 advertising boards at $168/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $22 M / yr | 173 M - 277 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.5 M / yr | $4.0 M / yr | 31.1–49.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.9 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$73 M / yr** | **$116 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 14,234 trips/school day; 3.1 M access-events/yr | 22,774 trips/school day; 5.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $311 M | 76% of $409 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $497 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $99 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 26,978 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $374 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$409 M** |
| Imported / external-capital requirement | $99 M (24.1%) |
| Local-content / local-funding requirement | $311 M (75.9%) |
| Default foreign-turnkey external-capital comparison | $737 M; OSR saves $638 M (86.6%) |
| Lifetime external interest and combined financing saving | $785 M interest; $1.42 bn capital + interest |
| 15%–25% planning risk envelope | $471 M–$512 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-27421 k / $196 M |
| Low/high project IRR | 7.3% / 12.4% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,995.33 train-km; 16,662.83 kWh consumed; 15,567.51 kWh charged; 31 depot services completed; minimum SoC 77%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,313.21 train-km; 194,689.20 kWh consumed; 192,201.48 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.6% of scheduled train-km delivered; 20 SoC warnings; 2 energy-adapted off-peak departures, maximum 12 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 94.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 82.0% / 60% | pass |
...
|---|---|
| ![Huambo energy and battery simulation dashboard](engineering/screenshots/huambo-simulation-dashboard.png) | ![Huambo simulator network visualizer](engineering/screenshots/huambo-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
...
|---|---|
| ![Huambo QGIS engineering layers](engineering/screenshots/huambo-qgis-engineering-map.png) | ![Huambo SUMO timetable validation](engineering/screenshots/huambo-sumo-validation.png) |
...
scripts/regenerate-city.sh huambo
```
