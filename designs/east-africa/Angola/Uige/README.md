...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$152 M (86.3%) of external capital** and **$187 M of external interest**. Capital plus saved interest totals **$340 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (12.0 km @ $2.58 M/km) | $31 M |
| **Civil subtotal** | **$31 M** |
...
| EPC integration + project management (7%) | on subtotal | $5.9 M |
...
| EPC overhead (7%) | $5.9 M |
| **CAPEX total** | **$98 M** |
| Per-route-km | $8.2 M / km |
| Per-capita (city pop) | $245 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $31 M | 15% | $4.7 M | $26 M |
...
| EPC / project services | $5.9 M | 15% | $884 k | $5.0 M |
| **Total city CAPEX** | **$98 M** | **24.6%** | **$24 M** | **$74 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$24 M** | **$4.8 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$74 M** | **$15 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $59 M | $12 M / yr |
| **Total city programme** | **100.0%** | **$98 M** | **$20 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $132 M | $108 M (81.8%) | $133 M | **$241 M** |
| **Default** | 2.00× | $176 M | $152 M (86.3%) | $187 M | **$340 M** |
| High | 3.00× | $265 M | $241 M (90.9%) | $296 M | **$536 M** |

At the default 2.00× case, OSR's $24 M external requirement is 86.3% below the illustrative foreign-company requirement of $176 M; the associated lifetime external-interest saving is $187 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$11 M / yr** | $27 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$8.3 M / yr** | $21 |
| Lifecycle envelope (yr 1–40, low scenario) | **$54 M cumulative** | $136 |
| Lifecycle envelope (yr 1–40, high scenario) | **$54 M cumulative** | $136 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$346 M cumulative** | $865 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.3 M / yr → $8.3 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $24 M | 4.5% | 40 y, 5 y grace | $1.4 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $59 M | 11.5% | 40 y, 5 y grace | $7.0 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$98 M** | | | **$8.3 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.1 M / yr + local bonds $6.8 M / yr = **$7.9 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 24.4 M | 39.1 M | 3.7 M |
| Annual paid trips / city resident | 61 | 98 | 9 |
| Farebox revenue | $16 M / yr | $25 M / yr | $2.4 M / yr |
| Station shop leases | $122 k / yr | $122 k / yr | $122 k / yr |
| Advertising boards | $226 k / yr | $226 k / yr | $226 k / yr |
| **Total revenue** | **$16 M / yr** | **$25 M / yr** | **$2.7 M / yr** |
| Revenue / OPEX recovery | 586% | 930% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $8.3 M / yr | $8.3 M / yr | **$8.3 M / yr** |
| Operating surplus applied to debt support | -$8.3 M / yr | -$8.3 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$8.3 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $74 M | 75% of $98 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $118 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $24 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 6,417 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $90 M |
| Timetable-sized dedicated solar CAPEX | $7.9 M |
| **Reconciled project CAPEX** | **$98 M** |
| Imported / external-capital requirement | $24 M (24.6%) |
| Local-content / local-funding requirement | $74 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $176 M; OSR saves $152 M (86.3%) |
| Lifetime external interest and combined financing saving | $187 M interest; $340 M capital + interest |
| 15%–25% planning risk envelope | $113 M–$123 M |
| Annual OPEX | $2.7 M / yr |
| Low/high project NPV at 8% | $27 M / $101 M |
| Low/high project IRR | 10.6% / 16.5% |
| Low/high steady-state DSCR | 1.59 / 2.72 |
