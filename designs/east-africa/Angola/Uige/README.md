...
|---|---|---|---|---|
| line-1 | 12.0 km | 7 | 31 | W Outer ↔ SE Outer |
| **Total** | **12.0 km** | **7 unique** | **31** | |
...
| Total fleet capacity | 11,160 AW2 pax (14,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 28 × 360 = **10,080 AW2 passengers** (13,440 AW3 crush)
- **Total fleet passenger capacity:** 31 × 360 = **11,160 AW2 passengers** (14,880 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **9.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 32.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 60 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 40 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 9.5 MW / 46 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 90 kWh | 159 kWh | 60 kWh | 2.2 km / 17 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 31 | $900 k | $28 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 93 | $60 k | $5.6 M |
| High sensitivity check | 93 | $120 k | $11 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 9,542 kW @ $700/kW | $6.7 M |
| Grid interconnection / PPA tie-in | 9,542 kW @ $100/kW | $954 k |
| Annual generation proxy | 9.5 MW × 4.8 peak-sun-h/day × 365 d/yr | 16.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$7.6 M** |
...
| Depots | $8.0 M |
| Rolling stock | $28 M |
| Railway production plant | $5.6 M |
| Dedicated solar power plant | $7.6 M |
| Residual train-control wayside + charging microgrids | $1.5 M |
| EPC overhead (7%) | $7.1 M |
| **CAPEX total** | **$116 M** |
| Per-route-km | $9.6 M / km |
| Per-capita (city pop) | $289 / person |
...
|---|---|---|
| Construction (years 1–5) | **$8.8 M / yr** | $22 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$5.3 M / yr** | $13 |
| Lifecycle envelope (yr 1–40, low scenario) | **$44 M cumulative** | $110 |
| Lifecycle envelope (yr 1–40, high scenario) | **$44 M cumulative** | $110 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$230 M cumulative** | $574 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $5.3 M / yr → $5.3 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $93 M | 4.5% | 40 y, 5 y grace | $5.3 M / yr |
| Government equity (no debt service) | 20% | $23 M | — | — | — |
| **Total** | **100%** | **$116 M** | | | **$5.3 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $4.2 M / yr = **$4.2 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($4.6 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (26.5 GWh / yr) | 5,592 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 11.9 GWh/yr + dedicated solar plant 9.5 MW / 16.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $115 k |
| Labour (116 FTE) | driverless roster: OCC/remote 29, station/platform 21, passenger service 17, fleet maintenance 17, infrastructure/energy 15, admin/training 17; no train drivers × country median × 12 × engineer-premium 1.4 | $468 k |
| **OPEX subtotal** | | **$3.0 M / yr** |

_Annual service work: 5,592 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.2 M train-km / yr (6.6 M car-km / yr). On-site PV covers 11.9 GWh/yr and the dedicated solar plant adds 16.7 GWh/yr against 26.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 31 trainsets, 7 stations, 12.0 route-km, 1 lines, and 5,592 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 24.4 M | 39.1 M | 4.2 M |
| Annual paid trips / city resident | 61 | 98 | 10 |
| Farebox revenue | $16 M / yr | $25 M / yr | $2.7 M / yr |
| Station shop leases | $136 k / yr | $136 k / yr | $136 k / yr |
| Advertising boards | $254 k / yr | $254 k / yr | $254 k / yr |
| **Total revenue** | **$16 M / yr** | **$25 M / yr** | **$3.0 M / yr** |
| Revenue / OPEX recovery | 526% | 833% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $5.3 M / yr | $5.3 M / yr | **$5.3 M / yr** |
| Operating surplus applied to debt support | -$5.3 M / yr | -$5.3 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$5.3 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $22 M / yr | $0 / yr |

_Commercial-revenue assumptions: 672 m² of station shop/kiosk leases at $19/m²/month and 148 advertising boards at $168/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $7.0 M / yr | $11 M / yr | 19% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $3.9 M / yr | $6.2 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$21 M / yr** | **$33 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 5,089 trips/school day; 1.1 M access-events/yr | 8,142 trips/school day; 1.8 M access-events/yr |
| Healthcare | 0 healthcare anchors | 4,018 trips/day; 1.5 M access-events/yr | 6,428 trips/day; 2.3 M access-events/yr |
| Commerce | 2 major/terminal/interchange nodes | 12,722 trips/trading day; 4.2 M access-events/yr | 20,356 trips/trading day; 6.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $65 M | 56% of $116 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $104 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $21 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,631 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $108 M |
| Timetable-sized dedicated solar CAPEX | $7.6 M |
| **Reconciled project CAPEX** | **$116 M** |
| 15%–25% planning risk envelope | $133 M–$145 M |
| Annual OPEX | $3.0 M / yr |
| Low/high project NPV at 8% | $11 M / $85 M |
| Low/high project IRR | 8.9% / 14.4% |
| Low/high steady-state DSCR | 2.45 / 4.22 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 517.55 train-km; 3,875.36 kWh consumed; 3,948.76 kWh charged; 12 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 5,806.95 train-km; 43,481.92 kWh consumed; 44,330.25 kWh charged; 164 depot services completed (2 active at cutoff); minimum SoC 66%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 58.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 53.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 66.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.3% / 60% | pass |
| ten-hour single charging-pad outage | 46.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 1 corridors, 7 line platforms, 0 interchange complexes, 1 civil segments, and 0 input findings |
