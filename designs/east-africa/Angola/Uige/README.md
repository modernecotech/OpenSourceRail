...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$161 M (86.6%) of external capital** and **$198 M of external interest**. Capital plus saved interest totals **$359 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 12.0 km |
| Revenue fleet | 24 × 3-car trainsets |
| Revenue fleet passenger capacity | 8,640 AW2 pax (11,520 AW3 crush) |
...
| Revenue fleet capacity | 8,640 AW2 pax (11,520 AW3 crush) |
| Total fleet capacity | 9,720 AW2 pax (12,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 24 × 360 = **8,640 AW2 passengers** (11,520 AW3 crush)
- **Total fleet passenger capacity:** 27 × 360 = **9,720 AW2 passengers** (12,960 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 47.0%
- Catchment population: **≈ 188,000** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **3,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **9.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 23.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 517 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 56 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 5,592 train-km/day | One-way train journeys × route length |
| Annual service work | 2.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 72 MWh/day | 6.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 41 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 9.9 MW / 47 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 90 kWh | 155 kWh | 56 kWh | 3.0 km / 23 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (12.0 km @ $3.0 M/km) | $36 M |
| **Civil subtotal** | **$36 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 27 | $900 k | $24 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 81 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 81 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 9,887 kW @ $700/kW | $6.9 M |
| Grid interconnection / PPA tie-in | 9,887 kW @ $100/kW | $989 k |
| Annual generation proxy | 9.9 MW × 4.8 peak-sun-h/day × 365 d/yr | 17.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$7.9 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 12.0 km × $0.050 M/km | $601 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $750 k |
| EPC integration + project management (7%) | on subtotal | $6.2 M |
...
| Dedicated solar power plant | $7.9 M |
| Residual train-control wayside + charging microgrids | $1.4 M |
| EPC overhead (7%) | $6.2 M |
| **CAPEX total** | **$103 M** |
| Per-route-km | $8.6 M / km |
| Per-capita (city pop) | $258 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $36 M | 15% | $5.4 M | $31 M |
| Stations | $20 M | 20% | $3.9 M | $16 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $24 M | 35% | $8.5 M | $16 M |
| Dedicated solar plant | $7.9 M | 45% | $3.6 M | $4.4 M |
| Residual signalling / train control | $601 k | 50% | $301 k | $301 k |
| Charging microgrids | $750 k | 40% | $300 k | $450 k |
| EPC / project services | $6.2 M | 15% | $937 k | $5.3 M |
| **Total city CAPEX** | **$103 M** | **24.1%** | **$25 M** | **$78 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh uige`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$25 M** | **$5.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$78 M** | **$16 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $63 M | $13 M / yr |
| **Total city programme** | **100.0%** | **$103 M** | **$21 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $140 M | $115 M (82.1%) | $141 M | **$256 M** |
| **Default** | 2.00× | $186 M | $161 M (86.6%) | $198 M | **$359 M** |
| High | 3.00× | $279 M | $254 M (91.1%) | $313 M | **$567 M** |

At the default 2.00× case, OSR's $25 M external requirement is 86.6% below the illustrative foreign-company requirement of $186 M; the associated lifetime external-interest saving is $198 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$11 M / yr** | $29 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$8.8 M / yr** | $22 |
| Lifecycle envelope (yr 1–40, low scenario) | **$57 M cumulative** | $143 |
| Lifecycle envelope (yr 1–40, high scenario) | **$57 M cumulative** | $143 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$366 M cumulative** | $914 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.8 M / yr → $8.8 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $25 M | 4.5% | 40 y, 5 y grace | $1.4 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $63 M | 11.5% | 40 y, 5 y grace | $7.4 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $16 M | — | — | — |
| **Total** | **100%** | **$103 M** | | | **$8.8 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.1 M / yr + local bonds $7.2 M / yr = **$8.3 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $972 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $1.3 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $30 k |
| Traction energy (26.5 GWh / yr) | 5,592 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 11.4 GWh/yr + dedicated solar plant 9.9 MW / 17.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $119 k |
| Labour (108 FTE) | driverless roster: OCC/remote 25, station/platform 19, passenger service 17, fleet maintenance 16, infrastructure/energy 14, admin/training 17; no train drivers × country median × 12 × engineer-premium 1.4 | $435 k |
| **OPEX subtotal** | | **$2.8 M / yr** |

_Annual service work: 5,592 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.2 M train-km / yr (6.6 M car-km / yr). On-site PV covers 11.4 GWh/yr and the dedicated solar plant adds 17.3 GWh/yr against 26.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 27 trainsets, 6 stations, 12.0 route-km, 1 lines, and 5,592 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 24.4 M | 39.1 M | 3.9 M |
| Annual paid trips / city resident | 61 | 98 | 10 |
| Farebox revenue | $16 M / yr | $25 M / yr | $2.5 M / yr |
| Station shop leases | $122 k / yr | $122 k / yr | $122 k / yr |
| Advertising boards | $226 k / yr | $226 k / yr | $226 k / yr |
| **Total revenue** | **$16 M / yr** | **$25 M / yr** | **$2.8 M / yr** |
| Revenue / OPEX recovery | 565% | 897% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $8.8 M / yr | $8.8 M / yr | **$8.8 M / yr** |
| Operating surplus applied to debt support | -$8.8 M / yr | -$8.8 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$8.8 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $23 M / yr | $0 / yr |

_Commercial-revenue assumptions: 600 m² of station shop/kiosk leases at $19/m²/month and 132 advertising boards at $168/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $4.5 M / yr | $7.2 M / yr | 16 min/trip × $0.69/h value-of-time proxy |
| Avoided road congestion | $3.2 M / yr | $5.1 M / yr | 40 M - 63 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $570 k / yr | $912 k / yr | 7.1–11.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $1.6 M / yr | $2.5 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $7.4 M / yr | $12 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $3.9 M / yr | $6.2 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$21 M / yr** | **$34 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 6,294 trips/school day; 1.4 M access-events/yr | 10,071 trips/school day; 2.2 M access-events/yr |
| Healthcare | 0 healthcare anchors | 4,018 trips/day; 1.5 M access-events/yr | 6,428 trips/day; 2.3 M access-events/yr |
| Commerce | 2 major/terminal/interchange nodes | 13,526 trips/trading day; 4.5 M access-events/yr | 21,641 trips/trading day; 7.1 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 7,098 trips/activity day; 2.1 M access-events/yr | 11,356 trips/activity day; 3.4 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $78 M | 76% of $103 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $126 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $25 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 6,811 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $95 M |
| Timetable-sized dedicated solar CAPEX | $7.9 M |
| **Reconciled project CAPEX** | **$103 M** |
| Imported / external-capital requirement | $25 M (24.1%) |
| Local-content / local-funding requirement | $78 M (75.9%) |
| Default foreign-turnkey external-capital comparison | $186 M; OSR saves $161 M (86.6%) |
| Lifetime external interest and combined financing saving | $198 M interest; $359 M capital + interest |
| 15%–25% planning risk envelope | $119 M–$129 M |
| Annual OPEX | $2.8 M / yr |
| Low/high project NPV at 8% | $22 M / $96 M |
| Low/high project IRR | 10.1% / 15.8% |
| Low/high steady-state DSCR | 1.49 / 2.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 519.99 train-km; 3,893.63 kWh consumed; 3,950.23 kWh charged; 12 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 5,808.77 train-km; 43,495.52 kWh consumed; 44,191.39 kWh charged; 164 depot services completed (2 active at cutoff); minimum SoC 56%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 45.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 43.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 55.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.1% / 60% | pass |
...
|---|---|
| ![Uige energy and battery simulation dashboard](engineering/screenshots/uige-simulation-dashboard.png) | ![Uige simulator network visualizer](engineering/screenshots/uige-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 1 corridors, 6 line platforms, 0 interchange complexes, 1 civil segments, and 0 input findings |
...
|---|---|
| ![Uige QGIS engineering layers](engineering/screenshots/uige-qgis-engineering-map.png) | ![Uige SUMO timetable validation](engineering/screenshots/uige-sumo-validation.png) |
