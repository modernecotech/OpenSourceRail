...
|---|---|---|---|---|
| line-1 | 13.0 km | 8 | 23 | W Outer ↔ SE Outer |
| **Total** | **13.0 km** | **8 unique** | **23** | |
...
| Total fleet capacity | 8,280 AW2 pax (11,040 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 20 × 360 = **7,200 AW2 passengers** (9,600 AW3 crush)
- **Total fleet passenger capacity:** 23 × 360 = **8,280 AW2 passengers** (11,040 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **10.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 38 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 85 MWh/day | 6,551 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 47 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 10.8 MW / 54 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Bucket | Value |
|---|---|
| At-grade (12.8 km @ $3.0 M/km) | $39 M |
| **Civil subtotal** | **$39 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 23 | $4.20 M | $97 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 69 | $100 k | $6.9 M |
| High sensitivity check | 69 | $200 k | $14 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 10,787 kW @ $700/kW | $7.6 M |
| Grid interconnection / PPA tie-in | 10,787 kW @ $100/kW | $1.1 M |
| Annual generation proxy | 10.8 MW × 5.0 peak-sun-h/day × 365 d/yr | 19.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$8.6 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 13.0 km × $0.050 M/km | $642 k |
...
| Depots | $14 M |
| Rolling stock | $97 M |
| Railway production plant | $6.9 M |
| Dedicated solar power plant | $8.6 M |
| Residual train-control wayside + charging microgrids | $4.2 M |
| EPC overhead (7%) | $13 M |
| **CAPEX total** | **$213 M** |
| Per-route-km | $16 M / km |
| Per-capita (city pop) | $532 / person |
...
|---|---|---|
| Construction (years 1–5) | **$12 M / yr** | $30 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$6.8 M / yr** | $17 |
| Lifecycle envelope (yr 1–40, low scenario) | **$60 M cumulative** | $149 |
| Lifecycle envelope (yr 1–40, high scenario) | **$60 M cumulative** | $149 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$298 M cumulative** | $745 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $170 M | 2.0% | 40 y, 5 y grace | $6.8 M / yr |
| Government equity (no debt service) | 20% | $43 M | — | — | — |
| **Total** | **100%** | **$213 M** | | | **$6.8 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $3.4 M / yr = **$3.4 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.5 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (31.0 GWh / yr) | 6,551 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 13.9 GWh/yr + dedicated solar plant 10.8 MW / 19.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $129 k |
| Labour (125 FTE) | driverless roster: OCC/remote 25, station/platform 29, passenger service 15, fleet maintenance 16, infrastructure/energy 20, admin/training 20; no train drivers × country median × 12 × engineer-premium 1.4 | $504 k |
| **OPEX subtotal** | | **$6.2 M / yr** |

_Annual service work: 6,551 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.6 M train-km / yr (7.7 M car-km / yr). On-site PV covers 13.9 GWh/yr and the dedicated solar plant adds 19.7 GWh/yr against 31.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 21.0 M | 33.6 M | 8.7 M |
| Annual paid trips / city resident | 53 | 84 | 22 |
| Farebox revenue | $13 M / yr | $22 M / yr | $5.6 M / yr |
| Station shop leases | $229 k / yr | $229 k / yr | $229 k / yr |
| Advertising boards | $384 k / yr | $384 k / yr | $384 k / yr |
| **Total revenue** | **$14 M / yr** | **$22 M / yr** | **$6.2 M / yr** |
| Revenue / OPEX recovery | 227% | 358% | 100% |
...
| Operating surplus after OPEX (before debt support) | $7.9 M / yr | $16 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $3.9 M / yr | $6.2 M / yr | 16 min/trip × $0.69/h value-of-time proxy |
| Avoided road congestion | $3.0 M / yr | $4.7 M / yr | 37 M - 59 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $531 k / yr | $850 k / yr | 6.6–10.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $1.5 M / yr | $2.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $7.1 M / yr | $11 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $3.3 M / yr | $5.3 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$19 M / yr** | **$31 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 3,859 trips/school day; 0.8 M access-events/yr | 6,175 trips/school day; 1.4 M access-events/yr |
| Healthcare | 1 healthcare anchors | 4,666 trips/day; 1.7 M access-events/yr | 7,465 trips/day; 2.7 M access-events/yr |
| Commerce | 5 major/terminal/interchange nodes | 12,996 trips/trading day; 4.3 M access-events/yr | 20,794 trips/trading day; 6.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $112 M | 53% of $213 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $179 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $36 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 9,728 job-years | retained CAPEX ÷ (4.0 × median annual income) |
