...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 81 | $60 k | $4.9 M |
| High sensitivity check | 81 | $120 k | $9.7 M |
...
| EPC integration + project management (7%) | on subtotal | $6.6 M |
...
|---|---|---|
| Construction (years 1–5) | **$8.3 M / yr** | $21 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$5.0 M / yr** | $12 |
| Lifecycle envelope (yr 1–40, low scenario) | **$41 M cumulative** | $103 |
| Lifecycle envelope (yr 1–40, high scenario) | **$41 M cumulative** | $103 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$215 M cumulative** | $538 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $87 M | 4.5% | 40 y, 5 y grace | $5.0 M / yr |
| Government equity (no debt service) | 20% | $22 M | — | — | — |
| **Total** | **100%** | **$109 M** | | | **$5.0 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $3.9 M / yr = **$3.9 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($4.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $61 M | 56% of $109 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $98 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $20 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,294 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $101 M |
| Timetable-sized dedicated solar CAPEX | $7.9 M |
| **Reconciled project CAPEX** | **$109 M** |
| 15%–25% planning risk envelope | $125 M–$136 M |
| Annual OPEX | $2.8 M / yr |
| Low/high project NPV at 8% | $18 M / $92 M |
| Low/high project IRR | 9.6% / 15.2% |
| Low/high steady-state DSCR | 2.65 / 4.53 |
