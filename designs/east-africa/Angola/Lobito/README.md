...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$466 M (86.6%) of external capital** and **$573 M of external interest**. Capital plus saved interest totals **$1.04 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`lobito.corridor.geojson`](lobito.corridor.geojson).
...
| Revenue fleet | 74 × 3-car trainsets |
| Revenue fleet passenger capacity | 26,640 AW2 pax (35,520 AW3 crush) |
...
| Revenue fleet capacity | 26,640 AW2 pax (35,520 AW3 crush) |
| Total fleet capacity | 29,880 AW2 pax (39,840 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 74 × 360 = **26,640 AW2 passengers** (35,520 AW3 crush)
- **Total fleet passenger capacity:** 83 × 360 = **29,880 AW2 passengers** (39,840 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 71.5%
- Catchment population: **≈ 357,500** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 10.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 487 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 23 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 60 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 17,696 train-km/day | One-way train journeys × route length |
| Annual service work | 7.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 229 MWh/day | 20.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 170 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 30.0 MW / 195 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 153 kWh | 229 kWh | 61 kWh | 6.3 km / 53 kWh |
| line-2 | 4 | 97 kWh | 131 kWh | 24 kWh | 5.6 km / 47 kWh |
| line-3 | 4 | 68 kWh | 98 kWh | 23 kWh | 3.1 km / 26 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (37.8 km @ $2.58 M/km) | $98 M |
| Elevated (0.3 km @ $9.75 M/km) | $3.0 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 83 | $900 k | $75 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 249 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 249 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 29,996 kW @ $700/kW | $21 M |
| Grid interconnection / PPA tie-in | 29,996 kW @ $100/kW | $3.0 M |
| Annual generation proxy | 30.0 MW × 6.5 peak-sun-h/day × 365 d/yr | 71.2 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $3.6 M |
| EPC overhead (7%) | $18 M |
| **CAPEX total** | **$299 M** |
| Per-route-km | $7.9 M / km |
| Per-capita (city pop) | $599 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $101 M | 15% | $15 M | $85 M |
| Stations | $70 M | 20% | $14 M | $56 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $75 M | 35% | $26 M | $49 M |
| Dedicated solar plant | $24 M | 45% | $11 M | $13 M |
| Residual signalling / train control | $1.9 M | 50% | $951 k | $951 k |
| Charging microgrids | $1.6 M | 40% | $660 k | $990 k |
| EPC / project services | $18 M | 15% | $2.7 M | $15 M |
| **Total city CAPEX** | **$299 M** | **24.2%** | **$72 M** | **$227 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lobito`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$72 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$227 M** | **$45 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $181 M | $36 M / yr |
| **Total city programme** | **100.0%** | **$299 M** | **$60 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $404 M | $332 M (82.1%) | $408 M | **$739 M** |
| **Default** | 2.00× | $539 M | $466 M (86.6%) | $573 M | **$1.04 bn** |
| High | 3.00× | $808 M | $736 M (91.0%) | $904 M | **$1.64 bn** |

At the default 2.00× case, OSR's $72 M external requirement is 86.6% below the illustrative foreign-company requirement of $539 M; the associated lifetime external-interest saving is $573 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$33 M / yr** | $66 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $51 |
| Lifecycle envelope (yr 1–40, low scenario) | **$166 M cumulative** | $332 |
| Lifecycle envelope (yr 1–40, high scenario) | **$166 M cumulative** | $332 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $2,116 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $72 M | 4.5% | 40 y, 5 y grace | $4.1 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $181 M | 11.5% | 40 y, 5 y grace | $21 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $45 M | — | — | — |
| **Total** | **100%** | **$299 M** | | | **$25 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.3 M / yr + local bonds $21 M / yr = **$24 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (83.7 GWh / yr) | 17,696 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.8 GWh/yr + dedicated solar plant 30.0 MW / 71.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $360 k |
| Labour (282 FTE) | driverless roster: OCC/remote 61, station/platform 67, passenger service 49, fleet maintenance 49, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$8.2 M / yr** |

_Annual service work: 17,696 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.0 M train-km / yr (20.9 M car-km / yr). On-site PV covers 21.8 GWh/yr and the dedicated solar plant adds 71.2 GWh/yr against 83.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 83 trainsets, 15 stations, 38.1 route-km, 3 lines, and 17,696 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.4 M |
| Annual paid trips / city resident | 147 | 235 | 21 |
| Farebox revenue | $47 M / yr | $75 M / yr | $6.7 M / yr |
| Station shop leases | $563 k / yr | $563 k / yr | $563 k / yr |
| Advertising boards | $912 k / yr | $912 k / yr | $912 k / yr |
| **Total revenue** | **$48 M / yr** | **$77 M / yr** | **$8.2 M / yr** |
| Revenue / OPEX recovery | 593% | 938% | 100% |
...
| Operating surplus after OPEX (before debt support) | $40 M / yr | $68 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,776 m² of station shop/kiosk leases at $19/m²/month and 532 advertising boards at $168/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 1 education anchors | 9,843 trips/school day; 2.2 M access-events/yr | 15,749 trips/school day; 3.5 M access-events/yr |
| Healthcare | 4 healthcare anchors | 17,677 trips/day; 6.5 M access-events/yr | 28,284 trips/day; 10.3 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 47,609 trips/trading day; 15.7 M access-events/yr | 76,174 trips/trading day; 25.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $227 M | 76% of $299 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $363 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $73 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,692 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $275 M |
| Timetable-sized dedicated solar CAPEX | $24 M |
| **Reconciled project CAPEX** | **$299 M** |
| Imported / external-capital requirement | $72 M (24.2%) |
| Local-content / local-funding requirement | $227 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $539 M; OSR saves $466 M (86.6%) |
| Lifetime external interest and combined financing saving | $573 M interest; $1.04 bn capital + interest |
| 15%–25% planning risk envelope | $344 M–$374 M |
| Annual OPEX | $8.2 M / yr |
| Low/high project NPV at 8% | $80 M / $304 M |
| Low/high project IRR | 10.6% / 16.4% |
| Low/high steady-state DSCR | 1.58 / 2.68 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,537.91 train-km; 12,842.95 kWh consumed; 11,764.97 kWh charged; 35 depot services completed; minimum SoC 70%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,765.55 train-km; 140,008.90 kWh consumed; 139,300.84 kWh charged; 482 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.7% of scheduled train-km delivered; 10 SoC warnings; 4 energy-adapted off-peak departures, maximum 14 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 94.8% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 94.6% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 85.0% / 60% | pass |
...
|---|---|
| ![Lobito energy and battery simulation dashboard](engineering/screenshots/lobito-simulation-dashboard.png) | ![Lobito simulator network visualizer](engineering/screenshots/lobito-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Lobito QGIS engineering layers](engineering/screenshots/lobito-qgis-engineering-map.png) | ![Lobito SUMO timetable validation](engineering/screenshots/lobito-sumo-validation.png) |
...
| [`lobito.toml`](lobito.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`lobito-network-map.png`](lobito-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`lobito.corridor.geojson`](lobito.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`lobito.stations.json`](lobito.stations.json) | Machine-readable station list |
| [`lobito.design-quality.yaml`](lobito.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug lobito
