...
|---|---|---|---|---|
| line-1 | 18.3 km | 11 | 47 | S Outer ↔ NE Outer |
| line-2 | 11.6 km | 9 | 29 | SW Inner ↔ E Mid |
| line-3 |  8.1 km | 6 | 21 | SE Inner ↔ NW Inner |
| **Total** | **38.1 km** | **26 unique** | **97** | |
...
| Onboard battery adequacy | 26.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 519 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 40 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 81 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 148 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 26.2 MW / 170 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 153 kWh | 241 kWh | 73 kWh | 2.5 km / 21 kWh |
| line-2 | 9 | 97 kWh | 163 kWh | 56 kWh | 2.0 km / 17 kWh |
| line-3 | 6 | 68 kWh | 114 kWh | 40 kWh | 2.0 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (36.5 km @ $3.0 M/km) | $110 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 291 | $60 k | $17 M |
| High sensitivity check | 291 | $120 k | $35 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 26,201 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 26,201 kW @ $100/kW | $2.6 M |
| Annual generation proxy | 26.2 MW × 6.5 peak-sun-h/day × 365 d/yr | 62.2 GWh/yr |
...
| Per-capita (city pop) | $857 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lobito`.
...
| Lifecycle envelope (yr 1–40, low scenario) | **$163 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, high scenario) | **$163 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$850 M cumulative** | $1,700 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $343 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $86 M | — | — | — |
| **Total** | **100%** | **$428 M** | | | **$20 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $15 M / yr = **$15 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($17 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (83.7 GWh / yr) | 17,696 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.7 GWh/yr + dedicated solar plant 26.2 MW / 62.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $314 k |
| Labour (342 FTE) | driverless roster: OCC/remote 65, station/platform 116, passenger service 49, fleet maintenance 53, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 17,696 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.0 M train-km / yr (20.9 M car-km / yr). On-site PV covers 29.7 GWh/yr and the dedicated solar plant adds 62.2 GWh/yr against 83.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 97 trainsets, 26 stations, 38.1 route-km, 3 lines, and 17,696 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $47 M / yr | $75 M / yr | $8.1 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$50 M / yr** | **$78 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 463% | 726% | 100% |
...
| Operating surplus after OPEX (before debt support) | $39 M / yr | $67 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,088 m² of station shop/kiosk leases at $19/m²/month and 944 advertising boards at $168/board/month, with occupancy derates applied._
...
| Commerce | 20 major/terminal/interchange nodes | 48,366 trips/trading day; 16.0 M access-events/yr | 77,385 trips/trading day; 25.5 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 21,479 trips/activity day; 6.4 M access-events/yr | 34,366 trips/activity day; 10.3 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $244 M | 57% of $428 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,213 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $407 M |
| Timetable-sized dedicated solar CAPEX | $21 M |
| **Reconciled project CAPEX** | **$428 M** |
| 15%–25% planning risk envelope | $493 M–$535 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-33798 k / $190 M |
| Low/high project IRR | 7.2% / 12.1% |
| Low/high steady-state DSCR | 1.98 / 3.41 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,562.32 train-km; 13,046.98 kWh consumed; 13,734.06 kWh charged; 33 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,334.01 train-km; 153,108.24 kWh consumed; 155,949.15 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 69%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 62.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 61.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 68.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 99.9% / 60% | pass |
| ten-hour single charging-pad outage | 44.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 2 interchange complexes, 14 civil segments, and 0 input findings |
