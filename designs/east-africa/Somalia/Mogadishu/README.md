...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.67 bn (87.1%) of external capital** and **$2.16 bn of external interest**. Capital plus saved interest totals **$3.82 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 120.7 km |
| Revenue fleet | 134 × 4-car trainsets |
| Revenue fleet passenger capacity | 64,320 AW2 pax (85,760 AW3 crush) |
...
| Revenue fleet capacity | 64,320 AW2 pax (85,760 AW3 crush) |
| Total fleet capacity | 71,520 AW2 pax (95,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 134 × 480 = **64,320 AW2 passengers** (85,760 AW3 crush)
- **Total fleet passenger capacity:** 149 × 480 = **71,520 AW2 passengers** (95,360 AW3 crush, incl. service rotation + spare + reserve)
- **Peak frequency:** 20 trains/hour/direction (3-min headway)
- **Peak capacity per line per direction:** 480 × 20 = **9,600 pphpd**
- **Network peak throughput (all lines, both directions):** 4 lines × 2 directions × 9,600 = **76,800 passengers/hour**
- **Scheduled one-way train journeys:** **1,628/day**
- **Daily theoretical capacity from timetable:** 1,628 scheduled one-way train journeys/day × 480 AW2 pax = **781,200 passenger-trips/day**
- **Practical daily service capacity** (80% load factor): ≈ **624,960 passenger-trips/day**
- **Planning annual paid-trip scenario** (capacity-led): ≈ **114.1 – 182.5 M paid trips/year** at 50%–80% practical capacity utilisation

## Catchment

- City population: **2,610,000**
- Anchor-weighted coverage: 56.1%
- Catchment population: **≈ 1,464,210** (within ~800 m walk of a station)
...
| Interchange | 18 | 300 kW | 1500 kWh |
| Major | 1 | 300 kW | 1500 kWh |
| Standard | 19 | 300 kW | 1500 kWh |
| Terminal | 5 | 300 kW | 1500 kWh |
| **Total installed** | **44** | **17,900 kW** | **104,500 kWh** |

Aggregate station-rail charging power: **66,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **133.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 585 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 140 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 107 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,628 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 46,358 train-km/day | One-way train journeys × route length |
| Annual service work | 18.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 801 MWh/day | 73.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 694 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 133.0 MW / 798 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 104 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 399 kWh | 662 kWh | 223 kWh | 12.5 km / 135 kWh |
| line-2 | 11 | 268 kWh | 588 kWh | 294 kWh | 3.5 km / 38 kWh |
| line-3 | 8 | 179 kWh | 441 kWh | 244 kWh | 3.0 km / 33 kWh |
| line-4 | 13 | 452 kWh | 637 kWh | 140 kWh | 10.0 km / 108 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (112.0 km @ $2.58 M/km) | $290 M |
| Elevated (8.7 km @ $9.75 M/km) | $84 M |
| Elevated-interchange premium (6 sites @ $4.50 M) | $27 M |
| **Civil subtotal** | **$401 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 149 | $1.12 M | $167 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 596 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 596 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 132,954 kW @ $700/kW | $93 M |
| Grid interconnection / PPA tie-in | 132,954 kW @ $100/kW | $13 M |
| Annual generation proxy | 133.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 291.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$106 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 120.7 km × $0.050 M/km | $6.0 M |
...
| Dedicated solar power plant | $106 M |
...
|---|---:|---:|---:|---:|
| Civil works | $401 M | 15% | $60 M | $341 M |
| Stations | $298 M | 20% | $60 M | $238 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $167 M | 35% | $58 M | $108 M |
| Dedicated solar plant | $106 M | 45% | $48 M | $58 M |
| Residual signalling / train control | $6.0 M | 50% | $3.0 M | $3.0 M |
| Charging microgrids | $15 M | 40% | $6.0 M | $9.0 M |
| EPC / project services | $63 M | 15% | $9.4 M | $53 M |
| **Total city CAPEX** | **$1.06 bn** | **23.2%** | **$246 M** | **$817 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mogadishu`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.2%** | **$246 M** | **$25 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.8%** | **$817 M** | **$82 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $654 M | $65 M / yr |
| **Total city programme** | **100.0%** | **$1.06 bn** | **$106 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.44 bn | $1.19 bn (82.8%) | $1.54 bn | **$2.73 bn** |
| **Default** | 2.00× | $1.91 bn | $1.67 bn (87.1%) | $2.16 bn | **$3.82 bn** |
| High | 3.00× | $2.87 bn | $2.63 bn (91.4%) | $3.39 bn | **$6.02 bn** |

At the default 2.00× case, OSR's $246 M external requirement is 87.1% below the illustrative foreign-company requirement of $1.91 bn; the associated lifetime external-interest saving is $2.16 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$126 M / yr** | $48 |
| Steady-state, low capacity-use (year 11+) | **$107 M / yr** | $41 |
| Steady-state, high capacity-use (year 11+) | **$90 M / yr** | $34 |
| Steady-state, operating-neutral revenue case | **$115 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.47 bn cumulative** | $1,713 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.95 bn cumulative** | $1,514 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.70 bn cumulative** | $1,800 |

_Population basis: 2,610,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.5 M / yr → $25 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $246 M | 4.5% | 40 y, 10 y grace | $15 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $654 M | 15.0% | 40 y, 10 y grace | $100 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $163 M | — | — | — |
| **Total** | **100%** | **$1.06 bn** | | | **$115 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $11 M / yr + local bonds $98 M / yr = **$109 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($16 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $302 k |
| Traction energy (292.4 GWh / yr) | 46,358 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 39.2 GWh/yr + dedicated solar plant 133.0 MW / 291.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.6 M |
| Labour (614 FTE) | driverless roster: OCC/remote 94, station/platform 219, passenger service 72, fleet maintenance 106, infrastructure/energy 100, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $980 k |
| **OPEX subtotal** | | **$24 M / yr** |

_Annual service work: 46,358 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 18.3 M train-km / yr (73.1 M car-km / yr). On-site PV covers 39.2 GWh/yr and the dedicated solar plant adds 291.2 GWh/yr against 292.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 149 trainsets, 48 stations, 120.7 route-km, 4 lines, and 46,358 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (624,960 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the external/local CAPEX funding sources, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 37% |
| Annual paid trips | 114.1 M | 182.5 M | 84.3 M |
| Annual paid trips / city resident | 44 | 70 | 32 |
| Farebox revenue | $29 M / yr | $46 M / yr | $21 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$24 M / yr** |
| Revenue / OPEX recovery | 132% | 205% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Gross repayable-debt service + residual OPEX subsidy | $115 M / yr | $115 M / yr | **$115 M / yr** |
| Operating surplus applied to debt support | -$7.5 M / yr | -$25 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $107 M / yr | $90 M / yr | **$115 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.5 M / yr | $25 M / yr | $0 / yr |

_Commercial-revenue assumptions: 9,592 m² of station shop/kiosk leases at $10/m²/month and 1,736 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $8.3 M / yr | $13 M / yr | 16 min/trip × $0.27/h value-of-time proxy |
| Avoided road congestion | $33 M / yr | $53 M / yr | 411 M - 657 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $5.9 M / yr | $9.5 M / yr | 73.9–118.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $16 M / yr | $26 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $37 M / yr | $59 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $18 M / yr | $29 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$118 M / yr** | **$189 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 18,124 trips/school day; 4.0 M access-events/yr | 28,998 trips/school day; 6.4 M access-events/yr |
| Healthcare | 5 healthcare anchors | 24,217 trips/day; 8.8 M access-events/yr | 38,748 trips/day; 14.1 M access-events/yr |
| Commerce | 25 major/terminal/interchange nodes | 67,086 trips/trading day; 22.1 M access-events/yr | 107,337 trips/trading day; 35.4 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 33,123 trips/activity day; 9.9 M access-events/yr | 52,997 trips/activity day; 15.9 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $817 M | 77% of $1.06 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.31 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $131 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 179,257 job-years | retained CAPEX ÷ (4.0 × median annual income) |
| Annual paid-trip capacity used in revenue model | 114.1 M - 182.5 M trips/yr | 50%-80% of practical service capacity |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $957 M |
| Timetable-sized dedicated solar CAPEX | $106 M |
| **Reconciled project CAPEX** | **$1.06 bn** |
| Imported / external-capital requirement | $246 M (23.2%) |
| Local-content / local-funding requirement | $817 M (76.8%) |
| Default foreign-turnkey external-capital comparison | $1.91 bn; OSR saves $1.67 bn (87.1%) |
| Lifetime external interest and combined financing saving | $2.16 bn interest; $3.82 bn capital + interest |
| 15%–25% planning risk envelope | $1.22 bn–$1.33 bn |
| Annual OPEX | $24 M / yr |
| Low/high project NPV at 8% | $-674497 k / $-584096 k |
| Low/high project IRR | -6.7% / -1.7% |
| Low/high steady-state DSCR | 0.07 / 0.22 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,605.39 train-km; 38,769.07 kWh consumed; 40,297.55 kWh charged; 32 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 46,369.47 train-km; 498,614.59 kWh consumed; 502,406.04 kWh charged; 661 depot services completed (6 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 63.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 58.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 71.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 79.8% / 60% | pass |
| ten-hour single charging-pad outage | 69.6% | 100.0% / 90% | pass |
...
|---|---|
| ![Mogadishu energy and battery simulation dashboard](engineering/screenshots/mogadishu-simulation-dashboard.png) | ![Mogadishu simulator network visualizer](engineering/screenshots/mogadishu-network-visualizer.png) |
...
|---|---|
| SUMO | 16/16 screening services arrived; 0 input findings; status `completed` |
| QGIS/GDAL | GeoPackage generated with 4 corridors, 48 line platforms, 6 interchange complexes, 115 civil segments, and 0 input findings |
...
|---|---|
| ![Mogadishu QGIS engineering layers](engineering/screenshots/mogadishu-qgis-engineering-map.png) | ![Mogadishu SUMO timetable validation](engineering/screenshots/mogadishu-sumo-validation.png) |
