...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **259,042 – 466,276 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$41 M / yr** | $16 |
| Steady-state, low-ridership (year 11+) | **$77 M / yr** | $29 |
| Steady-state, high-ridership (year 11+) | **$58 M / yr** | $22 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $18 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.71 bn cumulative** | $1,040 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.14 bn cumulative** | $819 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.80 bn cumulative** | $689 |

_Population basis: 2,610,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $31 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $827 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $1.03 bn | 2.0% | 40 y, 10 y grace | $46 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 15.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $207 M | — | — | — |
| **Total** | **100%** | **$2.07 bn** | | | **$46 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $21 M / yr + fallback bonds $0 k / yr = **$21 M / yr** total. The $827 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($21 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
