...
|---|---|---|
| Construction (years 1–10) | **$76 M / yr** | $29 |
| Steady-state, low-ridership (year 11+) | **$81 M / yr** | $31 |
| Steady-state, high-ridership (year 11+) | **$74 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$74 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.18 bn cumulative** | $1,217 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.96 bn cumulative** | $1,135 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.96 bn cumulative** | $1,135 |

_Population basis: 2,610,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $643 M | 3.0% | 40 y, 10 y grace | $33 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $268 M | 15.0% | 40 y, 10 y grace | $41 M / yr |
| Government equity (no debt service) | 15% | $161 M | — | — | — |
| **Total** | **100%** | **$1.07 bn** | | | **$74 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $19 M / yr + bonds $40 M / yr = **$59 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,510 | 299,520 | 288,582 |
| Daily paid trips / catchment | 18% | 29% | 28% |
| Daily paid trips / city population | 7% | 11% | 11% |
| Annual paid trips | 68.1 M | 109.3 M | 105.3 M |
| Farebox revenue | $13 M / yr | $21 M / yr | $20 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$16 M / yr** | **$24 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 69% | 103% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov commitment | $81 M / yr | $74 M / yr | **$74 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $759 k / yr | $0 / yr |
