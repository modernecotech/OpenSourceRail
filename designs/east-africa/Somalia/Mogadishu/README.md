...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 106 | $5.60 M | $594 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 424 | $100 k | $42 M |
| High sensitivity check | 424 | $200 k | $85 M |
...
|---|---|---|
| Construction (years 1–10) | **$115 M / yr** | $44 |
| Steady-state, low-ridership (year 11+) | **$138 M / yr** | $53 |
| Steady-state, high-ridership (year 11+) | **$130 M / yr** | $50 |
| Steady-state, operating-neutral revenue case | **$112 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.30 bn cumulative** | $2,030 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.06 bn cumulative** | $1,940 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.51 bn cumulative** | $1,728 |

_Population basis: 2,610,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $26 M / yr → $18 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $979 M | 3.0% | 40 y, 10 y grace | $50 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $408 M | 15.0% | 40 y, 10 y grace | $62 M / yr |
| Government equity (no debt service) | 15% | $245 M | — | — | — |
| **Total** | **100%** | **$1.63 bn** | | | **$112 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $29 M / yr + bonds $61 M / yr = **$91 M / yr** total — plus the equity tranche amortised across construction ($24 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,510 | 299,520 | 565,719 |
| Daily paid trips / catchment | 18% | 29% | 55% |
| Daily paid trips / city population | 7% | 11% | 22% |
| Annual paid trips | 68.1 M | 109.3 M | 206.5 M |
| Farebox revenue | $13 M / yr | $21 M / yr | $39 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$16 M / yr** | **$24 M / yr** | **$42 M / yr** |
| Revenue / OPEX recovery | 38% | 56% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Gov debt service + residual OPEX subsidy | $138 M / yr | $130 M / yr | **$112 M / yr** |
