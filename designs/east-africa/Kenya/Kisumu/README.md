...
|---|---|---|---|---|
| line-1 | 17.1 km | 11 | 45 | SW Mid ↔ N Mid |
| line-2 | 23.6 km | 13 | 59 | SE Outer ↔ W Mid |
| line-3 | 12.7 km | 10 | 32 | NW Mid ↔ NE Mid |
| **Total** | **53.5 km** | **34 unique** | **136** | |
...
| Onboard battery adequacy | 9.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 480 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 75 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 60.7 MW / 292 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 128 kWh | 233 kWh | 92 kWh | 2.0 km / 15 kWh |
| line-2 | 11 | 177 kWh | 278 kWh | 83 kWh | 8.0 km / 60 kWh |
| line-3 | 10 | 95 kWh | 180 kWh | 75 kWh | 2.0 km / 15 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 60,743 kW @ $700/kW | $43 M |
| Grid interconnection / PPA tie-in | 60,743 kW @ $100/kW | $6.1 M |
| Annual generation proxy | 60.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 106.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$38 M / yr** | $63 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$266 M cumulative** | $443 |
| Lifecycle envelope (yr 1–40, high scenario) | **$266 M cumulative** | $443 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.18 bn cumulative** | $1,961 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $470 M | 4.5% | 40 y, 7 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $117 M | — | — | — |
| **Total** | **100%** | **$587 M** | | | **$28 M / yr** |
...
| Traction energy (117.6 GWh / yr) | 24,859 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.1 GWh/yr + dedicated solar plant 60.7 MW / 106.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $729 k |
| Labour (417 FTE) | driverless roster: OCC/remote 86, station/platform 136, passenger service 49, fleet maintenance 74, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 24,859 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.8 M train-km / yr (29.4 M car-km / yr). On-site PV covers 25.1 GWh/yr and the dedicated solar plant adds 106.4 GWh/yr against 117.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 136 trainsets, 34 stations, 53.5 route-km, 3 lines, and 24,859 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 122 | 196 | 31 |
...
| **Total revenue** | **$48 M / yr** | **$75 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 333% | 520% | 100% |
...
_Commercial-revenue assumptions: 5,680 m² of station shop/kiosk leases at $18/m²/month and 1,068 advertising boards at $161/board/month, with occupancy derates applied._
...
| Commerce | 19 major/terminal/interchange nodes | 43,928 trips/trading day; 14.5 M access-events/yr | 70,284 trips/trading day; 23.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $329 M | 56% of $587 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $527 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $75 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 29,833 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $539 M |
| Timetable-sized dedicated solar CAPEX | $49 M |
| **Reconciled project CAPEX** | **$587 M** |
| 15%–25% planning risk envelope | $676 M–$734 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-212198 k / $-30925 k |
| Low/high project IRR | 3.5% / 7.4% |
| Low/high steady-state DSCR | 1.21 / 2.19 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,024.92 train-km; 15,162.44 kWh consumed; 15,990.64 kWh charged; 27 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,652.23 train-km; 192,081.84 kWh consumed; 195,051.61 kWh charged; 498 depot services completed (6 active at cutoff); minimum SoC 29%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 1 SoC warnings |
...
| 50% charging-contact availability | 29.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.4% / 60% | pass |
| ten-hour single charging-pad outage | 29.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 34 line platforms, 2 interchange complexes, 15 civil segments, and 0 input findings |
