...
| Steady-state, low-ridership (year 8+) | **$43 M / yr** | $72 |
| Steady-state, high-ridership (year 8+) | **$40 M / yr** | $66 |
| Steady-state, operating-neutral revenue case | **$39 M / yr** | $64 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.28 bn cumulative** | $2,128 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.19 bn cumulative** | $1,985 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.17 bn cumulative** | $1,949 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.7 M / yr → $940 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $314 M | 4.5% | 30 y, 7 y grace | $22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $131 M | 11.5% | 30 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $78 M | — | — | — |
| **Total** | **100%** | **$523 M** | | | **$39 M / yr** |
