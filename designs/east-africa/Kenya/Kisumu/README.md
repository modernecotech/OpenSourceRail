...
| Steady-state, low-ridership (year 8+) | **$35 M / yr** | $58 |
| Steady-state, high-ridership (year 8+) | **$32 M / yr** | $53 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $53 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.03 bn cumulative** | $1,721 |
| Lifecycle envelope (yr 1–30, high scenario) | **$964 M cumulative** | $1,607 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$964 M cumulative** | $1,607 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.0 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $259 M | 4.5% | 30 y, 7 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $108 M | 11.5% | 30 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $65 M | — | — | — |
| **Total** | **100%** | **$431 M** | | | **$32 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $12 M / yr = **$24 M / yr** total — plus the equity tranche amortised across construction ($9.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 33,372 | 55,620 | 51,009 |
| Daily paid trips / catchment | 18% | 30% | 28% |
| Daily paid trips / city population | 6% | 9% | 9% |
| Annual paid trips | 12.2 M | 20.3 M | 18.6 M |
| Farebox revenue | $5.6 M / yr | $9.3 M / yr | $8.6 M / yr |
