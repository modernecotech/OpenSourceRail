...
|---|---|---|
| Construction (years 1–7) | **$14 M / yr** | $24 |
| Steady-state, low-ridership (year 8+) | **$9.5 M / yr** | $16 |
| Steady-state, high-ridership (year 8+) | **$2.5 M / yr** | $4 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$319 M cumulative** | $532 |
| Lifecycle envelope (yr 1–30, high scenario) | **$157 M cumulative** | $261 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$100 M cumulative** | $166 |
...
| **Total** | **100%** | **$185 M** | | | **$14 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.0 M / yr + bonds $5.3 M / yr = **$10 M / yr** total — plus the equity tranche amortised across construction ($4.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
