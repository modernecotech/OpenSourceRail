...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.04 bn (86.7%) of external capital** and **$1.30 bn of external interest**. Capital plus saved interest totals **$2.34 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 62.5%
- Catchment population: **≈ 218,750** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **95.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 466 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 86 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 35,094 train-km/day | One-way train journeys × route length |
| Annual service work | 13.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 455 MWh/day | 41.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 398 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 95.3 MW / 457 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 217 kWh | 327 kWh | 88 kWh | 9.9 km / 74 kWh |
| line-2 | 8 | 160 kWh | 261 kWh | 86 kWh | 4.2 km / 32 kWh |
| line-3 | 8 | 188 kWh | 294 kWh | 87 kWh | 7.0 km / 52 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (69.4 km @ $3.0 M/km) | $208 M |
| Elevated (6.1 km @ $12.0 M/km) | $73 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$285 M** |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 483 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 483 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 95,282 kW @ $700/kW | $67 M |
| Grid interconnection / PPA tie-in | 95,282 kW @ $100/kW | $9.5 M |
| Annual generation proxy | 95.3 MW × 4.8 peak-sun-h/day × 365 d/yr | 166.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 75.5 km × $0.050 M/km | $3.8 M |
...
| Per-capita (city pop) | $1,900 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $285 M | 15% | $43 M | $243 M |
| Stations | $105 M | 20% | $21 M | $84 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $145 M | 35% | $51 M | $94 M |
| Dedicated solar plant | $76 M | 45% | $34 M | $42 M |
...
| **Total city CAPEX** | **$665 M** | **24.0%** | **$160 M** | **$505 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh thika`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$160 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$505 M** | **$72 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $404 M | $58 M / yr |
| **Total city programme** | **100.0%** | **$665 M** | **$95 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $898 M | $738 M (82.2%) | $925 M | **$1.66 bn** |
| **Default** | 2.00× | $1.20 bn | $1.04 bn (86.7%) | $1.30 bn | **$2.34 bn** |
| High | 3.00× | $1.80 bn | $1.64 bn (91.1%) | $2.05 bn | **$3.69 bn** |

At the default 2.00× case, OSR's $160 M external requirement is 86.7% below the illustrative foreign-company requirement of $1.20 bn; the associated lifetime external-interest saving is $1.30 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$68 M / yr** | $195 |
| Steady-state, low capacity-use (year 8+) | **$27 M / yr** | $77 |
| Steady-state, high capacity-use (year 8+) | **$107 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$57 M / yr** | $163 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.37 bn cumulative** | $3,916 |
| Lifecycle envelope (yr 1–40, high scenario) | **$480 M cumulative** | $1,372 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.36 bn cumulative** | $6,753 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $30 M / yr → $57 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $160 M | 4.5% | 40 y, 7 y grace | $9.4 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $404 M | 11.5% | 40 y, 7 y grace | $48 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $101 M | — | — | — |
| **Total** | **100%** | **$665 M** | | | **$57 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $7.2 M / yr + local bonds $46 M / yr = **$54 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($14 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (166.0 GWh / yr) | 35,094 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.8 GWh/yr + dedicated solar plant 95.3 MW / 166.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (414 FTE) | driverless roster: OCC/remote 98, station/platform 88, passenger service 49, fleet maintenance 95, infrastructure/energy 63, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$17 M / yr** |

_Annual service work: 35,094 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.8 M train-km / yr (41.5 M car-km / yr). On-site PV covers 20.8 GWh/yr and the dedicated solar plant adds 166.9 GWh/yr against 166.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 161 trainsets, 28 stations, 75.5 route-km, 3 lines, and 35,094 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $45 M / yr | $72 M / yr | $15 M / yr |
| Station shop leases | $675 k / yr | $675 k / yr | $675 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$47 M / yr** | **$74 M / yr** | **$17 M / yr** |
...
| Operating surplus applied to debt support | -$30 M / yr | -$57 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $27 M / yr | $107 k / yr | **$57 M / yr** |
| Operating surplus after OPEX (before debt support) | $30 M / yr | $57 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,472 m² of station shop/kiosk leases at $18/m²/month and 696 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $20 M / yr | $32 M / yr | 249 M - 399 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.6 M / yr | $5.7 M / yr | 44.8–71.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 11,980 trips/school day; 2.6 M access-events/yr | 19,168 trips/school day; 4.2 M access-events/yr |
| Healthcare | 2 healthcare anchors | 15,121 trips/day; 5.5 M access-events/yr | 24,193 trips/day; 8.8 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 39,674 trips/trading day; 13.1 M access-events/yr | 63,478 trips/trading day; 20.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $505 M | 76% of $665 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $808 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $115 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 45,762 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $589 M |
| Timetable-sized dedicated solar CAPEX | $76 M |
| **Reconciled project CAPEX** | **$665 M** |
| Imported / external-capital requirement | $160 M (24.0%) |
| Local-content / local-funding requirement | $505 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $1.20 bn; OSR saves $1.04 bn (86.7%) |
| Lifetime external interest and combined financing saving | $1.30 bn interest; $2.34 bn capital + interest |
| 15%–25% planning risk envelope | $765 M–$831 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-292372 k / $-111099 k |
| Low/high project IRR | 2.1% / 6.1% |
| Low/high steady-state DSCR | 0.53 / 1.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,670.23 train-km; 19,994.39 kWh consumed; 17,417.53 kWh charged; 21 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 34,425.48 train-km; 257,774.86 kWh consumed; 234,664.00 kWh charged; 490 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 98.1% of scheduled train-km delivered; 237 SoC warnings; 21 energy-adapted off-peak departures, maximum 16 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 97.2% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 92.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 98.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 77.9% / 60% | pass |
...
|---|---|
| ![Thika energy and battery simulation dashboard](engineering/screenshots/thika-simulation-dashboard.png) | ![Thika simulator network visualizer](engineering/screenshots/thika-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 28 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
...
|---|---|
| ![Thika QGIS engineering layers](engineering/screenshots/thika-qgis-engineering-map.png) | ![Thika SUMO timetable validation](engineering/screenshots/thika-sumo-validation.png) |
