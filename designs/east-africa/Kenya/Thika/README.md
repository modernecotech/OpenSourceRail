...
| Per-capita (city pop) | $1,988 / person |
...
|---|---|---|
| Construction (years 1–7) | **$45 M / yr** | $128 |
| Steady-state, low capacity-use (year 8+) | **$2.6 M / yr** | $7 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $93 |
| Lifecycle envelope (yr 1–40, low scenario) | **$401 M cumulative** | $1,145 |
| Lifecycle envelope (yr 1–40, high scenario) | **$315 M cumulative** | $899 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.39 bn cumulative** | $3,982 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $30 M / yr → $33 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $557 M | 4.5% | 40 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 20% | $139 M | — | — | — |
| **Total** | **100%** | **$696 M** | | | **$33 M / yr** |
...
| Operating surplus applied to debt support | -$30 M / yr | -$33 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.6 M / yr | $0 k / yr | **$33 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $388 M | 56% of $696 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $620 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $89 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 35,108 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $620 M |
| Timetable-sized dedicated solar CAPEX | $76 M |
| **Reconciled project CAPEX** | **$696 M** |
| 15%–25% planning risk envelope | $800 M–$870 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-315435 k / $-134162 k |
| Low/high project IRR | 1.9% / 5.8% |
| Low/high steady-state DSCR | 0.92 / 1.75 |
