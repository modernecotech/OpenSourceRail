...
| Bucket | Value |
|---|---|
| At-grade (69.3 km @ $0.85 M/km) | $59 M |
| Elevated (5.9 km @ $4.0 M/km) | $23 M |
...
|---|---|---|
| Construction (years 1–7) | **$15 M / yr** | $42 |
| Steady-state, low-ridership (year 8+) | **$14 M / yr** | $39 |
| Steady-state, high-ridership (year 8+) | **$9.5 M / yr** | $27 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$416 M cumulative** | $1,189 |
| Lifecycle envelope (yr 1–30, high scenario) | **$322 M cumulative** | $919 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$104 M cumulative** | $296 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $48 M | 11.5% | 30 y, 7 y grace | $6.0 M / yr |
| Government equity (no debt service) | 15% | $29 M | — | — | — |
| **Total** | **100%** | **$192 M** | | | **$14 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.2 M / yr + bonds $5.5 M / yr = **$11 M / yr** total — plus the equity tranche amortised across construction ($4.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
