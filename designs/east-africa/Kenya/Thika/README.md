...
| Per-capita (city pop) | $1,576 / person |
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $122 |
| Steady-state, low-ridership (year 8+) | **$45 M / yr** | $128 |
| Steady-state, high-ridership (year 8+) | **$41 M / yr** | $116 |
| Steady-state, operating-neutral revenue case | **$41 M / yr** | $116 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.33 bn cumulative** | $3,799 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.23 bn cumulative** | $3,523 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.23 bn cumulative** | $3,523 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.2 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $331 M | 4.5% | 30 y, 7 y grace | $23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $138 M | 11.5% | 30 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $83 M | — | — | — |
| **Total** | **100%** | **$551 M** | | | **$41 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $15 M / yr + bonds $16 M / yr = **$31 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 39,438 | 65,730 | 64,475 |
| Daily paid trips / catchment | 18% | 30% | 29% |
| Daily paid trips / city population | 11% | 19% | 18% |
| Annual paid trips | 14.4 M | 24.0 M | 23.5 M |
| Farebox revenue | $6.6 M / yr | $11 M / yr | $11 M / yr |
...
| Remaining steady-state gov commitment | $45 M / yr | $41 M / yr | **$41 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $211 k / yr | $0 / yr |
