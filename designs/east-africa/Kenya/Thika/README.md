...
| Bucket | Value |
|---|---|
| At-grade (69.3 km @ $1.2 M/km) | $83 M |
| Elevated (5.9 km @ $5.5 M/km) | $32 M |
...
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $51 |
| Steady-state, high-ridership (year 8+) | **$14 M / yr** | $39 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$535 M cumulative** | $1,528 |
| Lifecycle envelope (yr 1–30, high scenario) | **$440 M cumulative** | $1,258 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$128 M cumulative** | $365 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $280 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $142 M | 4.5% | 30 y, 7 y grace | $10 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $59 M | 11.5% | 30 y, 7 y grace | $7.4 M / yr |
| Government equity (no debt service) | 15% | $35 M | — | — | — |
| **Total** | **100%** | **$236 M** | | | **$17 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.4 M / yr + bonds $6.8 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($5.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,000 | 52,500 | 133,443 |
| Daily paid trips / population | 8% | 15% | 38% |
| Annual paid trips | 10.2 M | 19.2 M | 48.7 M |
| Farebox revenue | $4.7 M / yr | $8.8 M / yr | $22 M / yr |
| Station shop leases | $852 k / yr | $852 k / yr | $852 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$7.0 M / yr** | **$11 M / yr** | **$25 M / yr** |
| Revenue / OPEX + debt-service recovery | 28% | 45% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov gap | $18 M / yr | $14 M / yr | **$0 / yr** |
