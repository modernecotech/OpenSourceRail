...
|---|---|---|---|---|
| line-1 | 29.0 km | 15 | 46 | NE Outer ↔ SW Mid |
| line-2 | 21.3 km | 11 | 35 | W Mid ↔ E Mid |
| line-3 | 25.2 km | 12 | 40 | SW Outer ↔ NE Outer |
| **Total** | **75.5 km** | **38 unique** | **121** | |
...
| Total fleet capacity | 43,560 AW2 pax (58,080 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 108 × 360 = **38,880 AW2 passengers** (51,840 AW3 crush)
- **Total fleet passenger capacity:** 121 × 360 = **43,560 AW2 passengers** (58,080 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **94.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 494 MWh/day | 38,145 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 409 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 94.2 MW / 471 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Bucket | Value |
|---|---|
| At-grade (69.3 km @ $3.0 M/km) | $208 M |
| Elevated (5.9 km @ $12.0 M/km) | $70 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 121 | $4.20 M | $508 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 363 | $100 k | $36 M |
| High sensitivity check | 363 | $200 k | $73 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 94,153 kW @ $700/kW | $66 M |
| Grid interconnection / PPA tie-in | 94,153 kW @ $100/kW | $9.4 M |
| Annual generation proxy | 94.2 MW × 5.0 peak-sun-h/day × 365 d/yr | 171.8 GWh/yr |
...
| Per-capita (city pop) | $3,274 / person |
...
|---|---|---|
| Construction (years 1–7) | **$51 M / yr** | $146 |
| Steady-state, low capacity-use (year 8+) | **$29 M / yr** | $84 |
| Steady-state, high capacity-use (year 8+) | **$6.1 M / yr** | $18 |
| Steady-state, operating-neutral revenue case | **$38 M / yr** | $109 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.33 bn cumulative** | $3,790 |
| Lifecycle envelope (yr 1–40, high scenario) | **$560 M cumulative** | $1,601 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.62 bn cumulative** | $4,625 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.9 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $917 M | 2.0% | 40 y, 7 y grace | $38 M / yr |
| Government equity (no debt service) | 20% | $229 M | — | — | — |
| **Total** | **100%** | **$1.15 bn** | | | **$38 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $18 M / yr = **$18 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($33 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (180.4 GWh / yr) | 38,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 31.0 GWh/yr + dedicated solar plant 94.2 MW / 171.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (442 FTE) | driverless roster: OCC/remote 77, station/platform 111, passenger service 44, fleet maintenance 87, infrastructure/energy 87, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$32 M / yr** |

_Annual service work: 38,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 15.0 M train-km / yr (45.1 M car-km / yr). On-site PV covers 31.0 GWh/yr and the dedicated solar plant adds 171.8 GWh/yr against 180.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 48.6 M |
| Annual paid trips / city resident | 180 | 288 | 139 |
| Farebox revenue | $39 M / yr | $62 M / yr | $30 M / yr |
| Station shop leases | $852 k / yr | $852 k / yr | $852 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$41 M / yr** | **$64 M / yr** | **$32 M / yr** |
| Revenue / OPEX recovery | 128% | 200% | 100% |
...
| Operating surplus applied to debt support | -$8.9 M / yr | -$32 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $29 M / yr | $6.1 M / yr | **$38 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.9 M / yr | $32 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $11 M / yr | $18 M / yr | 16 min/trip × $0.66/h value-of-time proxy |
| Avoided road congestion | $17 M / yr | $27 M / yr | 214 M - 343 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.1 M / yr | $4.9 M / yr | 38.6–61.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.6 M / yr | $14 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 11,219 trips/school day; 2.5 M access-events/yr | 17,950 trips/school day; 3.9 M access-events/yr |
| Healthcare | 4 healthcare anchors | 14,834 trips/day; 5.4 M access-events/yr | 23,735 trips/day; 8.7 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 32,900 trips/trading day; 10.9 M access-events/yr | 52,640 trips/trading day; 17.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $601 M | 52% of $1.15 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $962 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $137 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 54,472 job-years | retained CAPEX ÷ (4.0 × median annual income) |
