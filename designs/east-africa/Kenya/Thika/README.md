...
|---|---|---|
| Construction (years 1–7) | **$65 M / yr** | $186 |
| Steady-state, low-ridership (year 8+) | **$77 M / yr** | $219 |
| Steady-state, high-ridership (year 8+) | **$72 M / yr** | $206 |
| Steady-state, operating-neutral revenue case | **$62 M / yr** | $178 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.22 bn cumulative** | $6,332 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.11 bn cumulative** | $6,041 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.89 bn cumulative** | $5,394 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $9.9 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $507 M | 4.5% | 30 y, 7 y grace | $36 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $211 M | 11.5% | 30 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 15% | $127 M | — | — | — |
| **Total** | **100%** | **$844 M** | | | **$62 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $23 M / yr + bonds $24 M / yr = **$47 M / yr** total — plus the equity tranche amortised across construction ($18 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 39,438 | 65,730 | 124,409 |
| Daily paid trips / catchment | 18% | 30% | 57% |
| Daily paid trips / city population | 11% | 19% | 36% |
| Annual paid trips | 14.4 M | 24.0 M | 45.4 M |
| Farebox revenue | $6.6 M / yr | $11 M / yr | $21 M / yr |
| Station shop leases | $852 k / yr | $852 k / yr | $852 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$8.9 M / yr** | **$13 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 39% | 58% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $77 M / yr | $72 M / yr | **$62 M / yr** |
