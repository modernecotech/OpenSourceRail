...
|---|---|---|---|---|
| line-1 | 29.0 km | 15 | 74 | SW Outer ↔ NE Outer |
| line-2 | 21.3 km | 12 | 52 | E Mid ↔ W Mid |
| line-3 | 25.2 km | 14 | 63 | SW Outer ↔ NE Outer |
| **Total** | **75.5 km** | **41 unique** | **189** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **91.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 481 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 78 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 74 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 380 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 91.1 MW / 437 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 217 kWh | 347 kWh | 108 kWh | 7.9 km / 59 kWh |
| line-2 | 12 | 160 kWh | 253 kWh | 78 kWh | 3.4 km / 26 kWh |
| line-3 | 12 | 188 kWh | 294 kWh | 87 kWh | 5.0 km / 38 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 91,142 kW @ $700/kW | $64 M |
| Grid interconnection / PPA tie-in | 91,142 kW @ $100/kW | $9.1 M |
| Annual generation proxy | 91.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 159.7 GWh/yr |
...
| Per-capita (city pop) | $2,174 / person |
...
|---|---|---|
| Construction (years 1–7) | **$49 M / yr** | $140 |
| Steady-state, low capacity-use (year 8+) | **$6.9 M / yr** | $20 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $102 |
| Lifecycle envelope (yr 1–40, low scenario) | **$573 M cumulative** | $1,638 |
| Lifecycle envelope (yr 1–40, high scenario) | **$344 M cumulative** | $983 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.52 bn cumulative** | $4,355 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $29 M / yr → $36 M / yr._
...
| Traction energy (166.0 GWh / yr) | 35,094 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.2 GWh/yr + dedicated solar plant 91.1 MW / 159.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (466 FTE) | driverless roster: OCC/remote 110, station/platform 115, passenger service 49, fleet maintenance 103, infrastructure/energy 68, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$19 M / yr** |

_Annual service work: 35,094 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.8 M train-km / yr (41.5 M car-km / yr). On-site PV covers 27.2 GWh/yr and the dedicated solar plant adds 159.7 GWh/yr against 166.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 189 trainsets, 41 stations, 75.5 route-km, 3 lines, and 35,094 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 75 |
| Farebox revenue | $45 M / yr | $72 M / yr | $16 M / yr |
| Station shop leases | $869 k / yr | $869 k / yr | $869 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$47 M / yr** | **$74 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 256% | 401% | 100% |
...
| Operating surplus applied to debt support | -$29 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.9 M / yr | $0 k / yr | **$36 M / yr** |
| Operating surplus after OPEX (before debt support) | $29 M / yr | $56 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,472 m² of station shop/kiosk leases at $18/m²/month and 912 advertising boards at $161/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $424 M | 56% of $761 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 38,431 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $688 M |
| Timetable-sized dedicated solar CAPEX | $73 M |
| **Reconciled project CAPEX** | **$761 M** |
| 15%–25% planning risk envelope | $875 M–$951 M |
| Annual OPEX | $19 M / yr |
| Low/high project NPV at 8% | $-372416 k / $-191143 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,614.16 train-km; 19,574.62 kWh consumed; 19,892.58 kWh charged; 19 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 36,028.92 train-km; 269,781.50 kWh consumed; 273,640.70 kWh charged; 501 depot services completed (3 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 24 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |
...
| 50% charging-contact availability | 21.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 41 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
