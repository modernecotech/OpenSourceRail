...
| Manufacturing schedule rows | 1,317 |
| Manufacturing material/BOM rows | 20,744 |
| Manufacturing QA verification rows | 1,317 |
| Construction QA action rows | 1,243 |
| Maintenance handover schedule rows | 1,553 |
| Manufacturing rows with material refs | 1,317 / 1,317 |
| Manufacturing rows with verification refs | 1,317 / 1,317 |
| Manufacturing rows linked to QA actions | 1,317 / 1,317 |
