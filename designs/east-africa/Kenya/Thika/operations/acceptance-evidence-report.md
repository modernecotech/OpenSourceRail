# Thika Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 422 |
| Manufacturing schedule rows | 1,634 |
| Manufacturing material/BOM rows | 24,761 |
| Manufacturing QA verification rows | 1,634 |
| Construction QA action rows | 1,522 |
| Maintenance handover schedule rows | 1,945 |
| Manufacturing rows with material refs | 1,634 / 1,634 |
| Manufacturing rows with verification refs | 1,634 / 1,634 |
| Manufacturing rows linked to QA actions | 1,634 / 1,634 |
