...
|---|---|---|---|---|
| line-1 | 27.0 km | 15 | 26 | SE Outer ↔ NW Outer |
| line-2 | 16.1 km | 11 | 17 | NE Mid ↔ S Mid |
| line-3 | 22.0 km | 13 | 21 | NW Outer ↔ SE Mid |
| **Total** | **65.1 km** | **39 unique** | **64** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **23,150 – 34,725 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (63.7 km @ $0.85 M/km) | $54 M |
| Elevated (1.2 km @ $4.0 M/km) | $5.0 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 65.1 km × $0.015 M/km | $977 k |
...
|---|---|---|
| Construction (years 1–7) | **$13 M / yr** | $25 |
| Steady-state, low-ridership (year 8+) | **$7.8 M / yr** | $16 |
| Steady-state, high-ridership (year 8+) | **$1.9 M / yr** | $4 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$268 M cumulative** | $537 |
| Lifecycle envelope (yr 1–30, high scenario) | **$133 M cumulative** | $267 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$89 M cumulative** | $177 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $98 M | 4.5% | 30 y, 7 y grace | $7.0 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $41 M | 11.5% | 30 y, 7 y grace | $5.1 M / yr |
| Government equity (no debt service) | 15% | $25 M | — | — | — |
| **Total** | **100%** | **$164 M** | | | **$12 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.4 M / yr + bonds $4.7 M / yr = **$9.2 M / yr** total — plus the equity tranche amortised across construction ($3.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (403 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.6 M |
...
|---|---|---|---|
| Daily paid trips | 40,000 | 75,000 | 86,558 |
