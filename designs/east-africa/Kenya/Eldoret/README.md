...
|---|---|---|
| Construction (years 1–7) | **$58 M / yr** | $116 |
| Steady-state, low-ridership (year 8+) | **$66 M / yr** | $131 |
| Steady-state, high-ridership (year 8+) | **$61 M / yr** | $122 |
| Steady-state, operating-neutral revenue case | **$55 M / yr** | $111 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.92 bn cumulative** | $3,835 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.81 bn cumulative** | $3,621 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.68 bn cumulative** | $3,361 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $10 M / yr → $5.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $451 M | 4.5% | 30 y, 7 y grace | $32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $188 M | 11.5% | 30 y, 7 y grace | $24 M / yr |
| Government equity (no debt service) | 15% | $113 M | — | — | — |
| **Total** | **100%** | **$752 M** | | | **$55 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $20 M / yr + bonds $22 M / yr = **$42 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 41,670 | 69,450 | 103,036 |
| Daily paid trips / catchment | 18% | 30% | 45% |
| Daily paid trips / city population | 8% | 14% | 21% |
| Annual paid trips | 15.2 M | 25.3 M | 37.6 M |
| Farebox revenue | $7.0 M / yr | $12 M / yr | $17 M / yr |
...
| Revenue / OPEX recovery | 49% | 72% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $66 M / yr | $61 M / yr | **$55 M / yr** |
