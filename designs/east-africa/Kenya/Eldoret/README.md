...
|---|---|---|---|---|
| line-1 | 22.6 km | 11 | 58 | SE Mid ↔ NW Outer |
| line-2 | 14.3 km | 9 | 38 | E Mid ↔ SW Mid |
| line-3 | 22.1 km | 12 | 58 | NW Outer ↔ SE Mid |
| **Total** | **59.0 km** | **32 unique** | **154** | |
...
| Onboard battery adequacy | 6.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 456 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 54 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 83 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 48.2 MW / 313 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 189 kWh | 261 kWh | 54 kWh | 8.8 km / 74 kWh |
| line-2 | 9 | 120 kWh | 192 kWh | 60 kWh | 2.4 km / 20 kWh |
| line-3 | 9 | 185 kWh | 257 kWh | 54 kWh | 10.0 km / 84 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 48,167 kW @ $700/kW | $34 M |
| Grid interconnection / PPA tie-in | 48,167 kW @ $100/kW | $4.8 M |
| Annual generation proxy | 48.2 MW × 6.5 peak-sun-h/day × 365 d/yr | 114.3 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$38 M / yr** | $75 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$263 M cumulative** | $527 |
| Lifecycle envelope (yr 1–40, high scenario) | **$263 M cumulative** | $527 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.17 bn cumulative** | $2,333 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $466 M | 4.5% | 40 y, 7 y grace | $27 M / yr |
...
| Traction energy (129.7 GWh / yr) | 27,427 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.4 GWh/yr + dedicated solar plant 48.2 MW / 114.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $578 k |
| Labour (410 FTE) | driverless roster: OCC/remote 94, station/platform 109, passenger service 49, fleet maintenance 83, infrastructure/energy 54, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 27,427 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.8 M train-km / yr (32.4 M car-km / yr). On-site PV covers 30.4 GWh/yr and the dedicated solar plant adds 114.3 GWh/yr against 129.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 154 trainsets, 32 stations, 59.0 route-km, 3 lines, and 27,427 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Station shop leases | $864 k / yr | $864 k / yr | $864 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$47 M / yr** | **$74 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 324% | 509% | 100% |
...
_Commercial-revenue assumptions: 4,448 m² of station shop/kiosk leases at $18/m²/month and 864 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 7 education anchors | 18,160 trips/school day; 4.0 M access-events/yr | 29,055 trips/school day; 6.4 M access-events/yr |
| Healthcare | 3 healthcare anchors | 15,428 trips/day; 5.6 M access-events/yr | 24,684 trips/day; 9.0 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 40,710 trips/trading day; 13.4 M access-events/yr | 65,135 trips/trading day; 21.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $328 M | 56% of $582 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $524 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $75 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 29,672 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-213703 k / $-32430 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,209.41 train-km; 18,450.76 kWh consumed; 16,827.72 kWh charged; 25 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,926.88 train-km; 233,223.15 kWh consumed; 226,143.77 kWh charged; 482 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 253 SoC warnings; 20 energy-adapted off-peak departures, maximum 14 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 98.3% / 90% | pass |
