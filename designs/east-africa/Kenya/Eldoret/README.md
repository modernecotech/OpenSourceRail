...
| Per-capita (city pop) | $1,084 / person |
...
|---|---|---|
| Construction (years 1–7) | **$35 M / yr** | $70 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$245 M cumulative** | $490 |
| Lifecycle envelope (yr 1–40, high scenario) | **$245 M cumulative** | $490 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.09 bn cumulative** | $2,171 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $434 M | 4.5% | 40 y, 7 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $108 M | — | — | — |
| **Total** | **100%** | **$542 M** | | | **$25 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $302 M | 56% of $542 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 27,329 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-183848 k / $-2575 k |
| Low/high project IRR | 3.8% / 8.0% |
| Low/high steady-state DSCR | 1.28 / 2.34 |
