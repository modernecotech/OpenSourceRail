...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **57,875 – 104,175 trips/day**
...
| Steady-state, low-ridership (year 8+) | **$31 M / yr** | $62 |
| Steady-state, high-ridership (year 8+) | **$21 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.18 bn cumulative** | $2,370 |
| Lifecycle envelope (yr 1–40, high scenario) | **$843 M cumulative** | $1,686 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$814 M cumulative** | $1,628 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $11 M / yr → $866 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $380 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $475 M | 2.0% | 40 y, 7 y grace | $20 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 11.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $95 M | — | — | — |
| **Total** | **100%** | **$949 M** | | | **$20 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $9.5 M / yr + fallback bonds $0 k / yr = **$9.5 M / yr** total. The $380 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($14 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 57,875 | 104,175 | 108,045 |
| Daily paid trips / catchment | 25% | 45% | 47% |
| Daily paid trips / city population | 12% | 21% | 22% |
| Annual paid trips | 21.1 M | 38.0 M | 39.4 M |
...
| **Total revenue** | **$16 M / yr** | **$26 M / yr** | **$27 M / yr** |
| Revenue / OPEX recovery | 59% | 97% | 100% |
