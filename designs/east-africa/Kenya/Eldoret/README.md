...
| Anchor-weighted coverage | 78.7% |
| Route length (double track) | 59.0 km |
...
- Anchor-weighted coverage: 78.7%
- Catchment population: **≈ 393,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **51.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 446 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 32 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 64 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 27,427 train-km/day | One-way train journeys × route length |
| Annual service work | 10.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 355 MWh/day | 32.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 292 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 51.6 MW / 336 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 189 kWh | 270 kWh | 62 kWh | 10.2 km / 86 kWh |
| line-2 | 5 | 120 kWh | 163 kWh | 32 kWh | 6.7 km / 56 kWh |
| line-3 | 6 | 185 kWh | 245 kWh | 42 kWh | 11.2 km / 94 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 51,617 kW @ $700/kW | $36 M |
| Grid interconnection / PPA tie-in | 51,617 kW @ $100/kW | $5.2 M |
| Annual generation proxy | 51.6 MW × 6.5 peak-sun-h/day × 365 d/yr | 122.5 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.0 km × $0.050 M/km | $2.9 M |
...
| Residual signalling / train control | $2.9 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $1.9 M | 40% | $770 k | $1.2 M |
| EPC / project services | $31 M | 15% | $4.6 M | $26 M |
| **Total city CAPEX** | **$510 M** | **24.5%** | **$125 M** | **$386 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh eldoret`.
...
| of which planned local bond issuance | 60.4% of total CAPEX | $308 M | $44 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $689 M | $564 M (81.9%) | $707 M | **$1.27 bn** |
| **Default** | 2.00× | $919 M | $794 M (86.4%) | $995 M | **$1.79 bn** |
| High | 3.00× | $1.38 bn | $1.25 bn (90.9%) | $1.57 bn | **$2.82 bn** |

At the default 2.00× case, OSR's $125 M external requirement is 86.4% below the illustrative foreign-company requirement of $919 M; the associated lifetime external-interest saving is $995 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$52 M / yr** | $104 |
| Steady-state, low capacity-use (year 8+) | **$11 M / yr** | $22 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$44 M / yr** | $88 |
| Lifecycle envelope (yr 1–40, low scenario) | **$734 M cumulative** | $1,468 |
| Lifecycle envelope (yr 1–40, high scenario) | **$365 M cumulative** | $730 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.81 bn cumulative** | $3,621 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $33 M / yr → $44 M / yr._
...
| Traction energy (129.7 GWh / yr) | 27,427 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.3 GWh/yr + dedicated solar plant 51.6 MW / 122.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $619 k |
| Labour (373 FTE) | driverless roster: OCC/remote 98, station/platform 70, passenger service 49, fleet maintenance 85, infrastructure/energy 50, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 27,427 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.8 M train-km / yr (32.4 M car-km / yr). On-site PV covers 23.3 GWh/yr and the dedicated solar plant adds 122.5 GWh/yr against 129.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 163 trainsets, 20 stations, 59.0 route-km, 3 lines, and 27,427 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $45 M / yr | $72 M / yr | $12 M / yr |
| Station shop leases | $550 k / yr | $550 k / yr | $550 k / yr |
| Advertising boards | $920 k / yr | $920 k / yr | $920 k / yr |
| **Total revenue** | **$46 M / yr** | **$73 M / yr** | **$14 M / yr** |
...
| Operating surplus applied to debt support | -$33 M / yr | -$44 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $0 k / yr | **$44 M / yr** |
| Operating surplus after OPEX (before debt support) | $33 M / yr | $60 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,832 m² of station shop/kiosk leases at $18/m²/month and 560 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $25 M / yr | 195 M - 311 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.8 M / yr | $4.5 M / yr | 35.0–56.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $386 M | 76% of $510 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 34,928 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $469 M |
...
| Lifetime external interest and combined financing saving | $995 M interest; $1.79 bn capital + interest |
| 15%–25% planning risk envelope | $587 M–$638 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-160498 k / $21 M |
| Low/high project IRR | 4.2% / 8.4% |
| Low/high steady-state DSCR | 0.74 / 1.36 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,221.88 train-km; 18,554.83 kWh consumed; 14,104.96 kWh charged; 28 depot services completed; minimum SoC 61%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,833.77 train-km; 215,744.36 kWh consumed; 182,236.25 kWh charged; 484 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.2% of scheduled train-km delivered; 407 SoC warnings; 46 energy-adapted off-peak departures, maximum 25 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 91.8% / 90% | pass |
...
| ten-hour single charging-pad outage | 20.0% | 93.3% / 90% | pass |
...
|---|---|
| ![Eldoret energy and battery simulation dashboard](engineering/screenshots/eldoret-simulation-dashboard.png) | ![Eldoret simulator network visualizer](engineering/screenshots/eldoret-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
...
|---|---|
| ![Eldoret QGIS engineering layers](engineering/screenshots/eldoret-qgis-engineering-map.png) | ![Eldoret SUMO timetable validation](engineering/screenshots/eldoret-sumo-validation.png) |
