...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 114 | $60 k | $6.8 M |
| High sensitivity check | 114 | $120 k | $14 M |
...
|---|---|---|
| Construction (years 1–7) | **$15 M / yr** | $51 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$107 M cumulative** | $358 |
| Lifecycle envelope (yr 1–40, high scenario) | **$107 M cumulative** | $358 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$476 M cumulative** | $1,587 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $190 M | 4.5% | 40 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $48 M | — | — | — |
| **Total** | **100%** | **$238 M** | | | **$11 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $8.6 M / yr = **$8.6 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $140 M | 59% of $238 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $224 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $32 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 12,686 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $231 M |
| Timetable-sized dedicated solar CAPEX | $6.5 M |
| **Reconciled project CAPEX** | **$238 M** |
| 15%–25% planning risk envelope | $273 M–$297 M |
| Annual OPEX | $5.8 M / yr |
| Low/high project NPV at 8% | $-5711 k / $115 M |
| Low/high project IRR | 7.7% / 12.3% |
| Low/high steady-state DSCR | 2.28 / 3.89 |
