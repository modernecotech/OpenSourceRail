...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$343 M (88.2%) of external capital** and **$430 M of external interest**. Capital plus saved interest totals **$774 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (24.0 km @ $2.58 M/km) | $62 M |
...
| Per-capita (city pop) | $721 / person |
...
| **Total city CAPEX** | **$216 M** | **21.3%** | **$46 M** | **$170 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.3%** | **$46 M** | **$6.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.7%** | **$170 M** | **$24 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $136 M | $19 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $292 M | $246 M (84.2%) | $308 M | **$554 M** |
| **Default** | 2.00× | $389 M | $343 M (88.2%) | $430 M | **$774 M** |
| High | 3.00× | $584 M | $538 M (92.1%) | $675 M | **$1.21 bn** |

At the default 2.00× case, OSR's $46 M external requirement is 88.2% below the illustrative foreign-company requirement of $389 M; the associated lifetime external-interest saving is $430 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$23 M / yr** | $75 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$158 M cumulative** | $527 |
| Lifecycle envelope (yr 1–40, high scenario) | **$158 M cumulative** | $527 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$779 M cumulative** | $2,597 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $46 M | 4.5% | 40 y, 7 y grace | $2.7 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $136 M | 11.5% | 40 y, 7 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $34 M | — | — | — |
| **Total** | **100%** | **$216 M** | | | **$19 M / yr** |
...
| Farebox revenue | $30 M / yr | $48 M / yr | $4.3 M / yr |
...
| Revenue / OPEX recovery | 564% | 889% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $170 M | 79% of $216 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $272 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $39 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 15,423 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $210 M |
| Timetable-sized dedicated solar CAPEX | $6.5 M |
| **Reconciled project CAPEX** | **$216 M** |
| Imported / external-capital requirement | $46 M (21.3%) |
| Local-content / local-funding requirement | $170 M (78.7%) |
| Default foreign-turnkey external-capital comparison | $389 M; OSR saves $343 M (88.2%) |
| Lifetime external interest and combined financing saving | $430 M interest; $774 M capital + interest |
| 15%–25% planning risk envelope | $249 M–$270 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $12 M / $133 M |
| Low/high project IRR | 8.6% / 13.3% |
| Low/high steady-state DSCR | 1.37 / 2.32 |
