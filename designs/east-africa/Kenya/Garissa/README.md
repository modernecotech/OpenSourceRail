...
| Bucket | Value |
|---|---|
| At-grade (27.2 km @ €3.5 M/km) | €95 M |
...
|---|---|---|
| Construction (years 1–7) | **€26 M / yr** | €87 |
| Steady-state, low-ridership (year 8+) | **€32 M / yr** | €106 |
| Steady-state, high-ridership (year 8+) | **€30 M / yr** | €99 |
| Lifecycle envelope (yr 1–30, low scenario) | **€912 M cumulative** | €3,039 |
| Lifecycle envelope (yr 1–30, high scenario) | **€867 M cumulative** | €2,891 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€6.7 M / yr (low) → €4.7 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €204 M | 4.5% | 30 y, 7 y grace | €14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €85 M | 11.5% | 30 y, 7 y grace | €11 M / yr |
| Government equity (no debt service) | 15% | €51 M | — | — | — |
| **Total** | **100%** | **€339 M** | | | **€25 M / yr** |
...
| Labour (185 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €658 k |
...
| Operating shortfall (gov subsidy required) | €6.7 M / yr | €4.7 M / yr |
