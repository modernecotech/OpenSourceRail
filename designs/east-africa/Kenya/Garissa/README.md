...
|---|---|---|---|---|
| line-1 |  8.2 km | 5 | 26 | S Mid ↔ NW Mid |
| line-2 | 12.4 km | 8 | 37 | SE Outer ↔ NE Outer |
| line-3 |  4.7 km | 4 | 17 | NW Inner ↔ SW Mid |
| **Total** | **25.4 km** | **17 unique** | **80** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **6.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 29.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 38 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 6.7 MW / 44 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 46 kWh | 98 kWh | 47 kWh | 2.2 km / 12 kWh |
| line-2 | 8 | 69 kWh | 155 kWh | 79 kWh | 2.1 km / 12 kWh |
| line-3 | 4 | 26 kWh | 82 kWh | 53 kWh | 1.8 km / 10 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 6,749 kW @ $700/kW | $4.7 M |
| Grid interconnection / PPA tie-in | 6,749 kW @ $100/kW | $675 k |
| Annual generation proxy | 6.7 MW × 6.5 peak-sun-h/day × 365 d/yr | 16.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$5.4 M** |
...
| Dedicated solar power plant | $5.4 M |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$120 M cumulative** | $402 |
| Lifecycle envelope (yr 1–40, high scenario) | **$120 M cumulative** | $402 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$534 M cumulative** | $1,780 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $213 M | 4.5% | 40 y, 7 y grace | $13 M / yr |
...
| Traction energy (37.2 GWh / yr) | 11,788 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 23.3 GWh/yr + dedicated solar plant 6.7 MW / 16.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $81 k |
| Labour (252 FTE) | driverless roster: OCC/remote 57, station/platform 69, passenger service 38, fleet maintenance 40, infrastructure/energy 27, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $974 k |
| **OPEX subtotal** | | **$6.6 M / yr** |

_Annual service work: 11,788 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.6 M train-km / yr (9.3 M car-km / yr). On-site PV covers 23.3 GWh/yr and the dedicated solar plant adds 16.0 GWh/yr against 37.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 80 trainsets, 17 stations, 25.4 route-km, 3 lines, and 11,788 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $30 M / yr | $48 M / yr | $5.1 M / yr |
| Station shop leases | $570 k / yr | $570 k / yr | $570 k / yr |
| Advertising boards | $933 k / yr | $933 k / yr | $933 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$6.6 M / yr** |
| Revenue / OPEX recovery | 474% | 745% | 100% |
...
| Healthcare | 2 healthcare anchors | 10,535 trips/day; 3.8 M access-events/yr | 16,856 trips/day; 6.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $156 M | 59% of $267 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 14,135 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $5.4 M |
| **Reconciled project CAPEX** | **$267 M** |
| 15%–25% planning risk envelope | $307 M–$333 M |
| Annual OPEX | $6.6 M / yr |
| Low/high project NPV at 8% | $-31372 k / $89 M |
| Low/high project IRR | 6.7% / 11.1% |
| Low/high steady-state DSCR | 1.98 / 3.42 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,135.32 train-km; 6,321.92 kWh consumed; 6,944.20 kWh charged; 38 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 12,261.67 train-km; 68,277.73 kWh consumed; 70,003.71 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 90%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 82.1% | 100.0% / 90% | pass |
