...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$366 M (88.4%) of external capital** and **$459 M of external interest**. Capital plus saved interest totals **$826 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 69.8% |
| Route length (double track) | 25.4 km |
| Revenue fleet | 50 × 2-car trainsets |
| Revenue fleet passenger capacity | 12,000 AW2 pax (16,000 AW3 crush) |
...
| Revenue fleet capacity | 12,000 AW2 pax (16,000 AW3 crush) |
| Total fleet capacity | 13,680 AW2 pax (18,240 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 50 × 240 = **12,000 AW2 passengers** (16,000 AW3 crush)
- **Total fleet passenger capacity:** 57 × 240 = **13,680 AW2 passengers** (18,240 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 69.8%
- Catchment population: **≈ 209,400** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **8.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 328 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 36 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 11,788 train-km/day | One-way train journeys × route length |
| Annual service work | 4.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 102 MWh/day | 9.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 46 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 8.1 MW / 53 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 46 kWh | 98 kWh | 47 kWh | 2.1 km / 12 kWh |
| line-2 | 5 | 69 kWh | 118 kWh | 42 kWh | 5.7 km / 32 kWh |
| line-3 | 3 | 26 kWh | 65 kWh | 36 kWh | 3.3 km / 18 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (24.0 km @ $3.0 M/km) | $72 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 57 | $560 k | $32 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 114 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 114 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 8,129 kW @ $700/kW | $5.7 M |
| Grid interconnection / PPA tie-in | 8,129 kW @ $100/kW | $813 k |
| Annual generation proxy | 8.1 MW × 6.5 peak-sun-h/day × 365 d/yr | 19.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$6.5 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 25.4 km × $0.050 M/km | $1.3 M |
...
| Dedicated solar power plant | $6.5 M |
| Residual train-control wayside + charging microgrids | $2.8 M |
| EPC overhead (7%) | $15 M |
| **CAPEX total** | **$230 M** |
| Per-route-km | $9.1 M / km |
| Per-capita (city pop) | $768 / person |
...
| Stations | $74 M | 20% | $15 M | $59 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $32 M | 35% | $11 M | $21 M |
| Dedicated solar plant | $6.5 M | 45% | $2.9 M | $3.6 M |
| Residual signalling / train control | $1.3 M | 50% | $634 k | $634 k |
| Charging microgrids | $1.5 M | 40% | $610 k | $915 k |
| EPC / project services | $15 M | 15% | $2.2 M | $12 M |
| **Total city CAPEX** | **$230 M** | **20.9%** | **$48 M** | **$182 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh garissa`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.9%** | **$48 M** | **$6.9 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.1%** | **$182 M** | **$26 M / yr** |
| of which planned local bond issuance | 63.3% of total CAPEX | $146 M | $21 M / yr |
| **Total city programme** | **100.0%** | **$230 M** | **$33 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $311 M | $263 M (84.5%) | $329 M | **$592 M** |
| **Default** | 2.00× | $415 M | $366 M (88.4%) | $459 M | **$826 M** |
| High | 3.00× | $622 M | $574 M (92.3%) | $719 M | **$1.29 bn** |

At the default 2.00× case, OSR's $48 M external requirement is 88.4% below the illustrative foreign-company requirement of $415 M; the associated lifetime external-interest saving is $459 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$24 M / yr** | $80 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$169 M cumulative** | $563 |
| Lifecycle envelope (yr 1–40, high scenario) | **$169 M cumulative** | $563 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$831 M cumulative** | $2,770 |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $63 k |
| Traction energy (37.2 GWh / yr) | 11,788 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.4 GWh/yr + dedicated solar plant 8.1 MW / 19.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $98 k |
| Labour (226 FTE) | driverless roster: OCC/remote 49, station/platform 59, passenger service 38, fleet maintenance 33, infrastructure/energy 26, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $873 k |
| **OPEX subtotal** | | **$5.8 M / yr** |

_Annual service work: 11,788 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.6 M train-km / yr (9.3 M car-km / yr). On-site PV covers 20.4 GWh/yr and the dedicated solar plant adds 19.3 GWh/yr against 37.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 57 trainsets, 13 stations, 25.4 route-km, 3 lines, and 11,788 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 7.4 M |
| Annual paid trips / city resident | 163 | 261 | 25 |
| Farebox revenue | $30 M / yr | $48 M / yr | $4.5 M / yr |
| Station shop leases | $490 k / yr | $490 k / yr | $490 k / yr |
| Advertising boards | $795 k / yr | $795 k / yr | $795 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$5.8 M / yr** |
| Revenue / OPEX recovery | 539% | 849% | 100% |
...
_Commercial-revenue assumptions: 2,520 m² of station shop/kiosk leases at $18/m²/month and 484 advertising boards at $161/board/month, with occupancy derates applied._
...
| Healthcare | 2 healthcare anchors | 11,249 trips/day; 4.1 M access-events/yr | 17,999 trips/day; 6.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $182 M | 79% of $230 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $291 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $42 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 16,501 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $224 M |
| Timetable-sized dedicated solar CAPEX | $6.5 M |
| **Reconciled project CAPEX** | **$230 M** |
| Imported / external-capital requirement | $48 M (20.9%) |
| Local-content / local-funding requirement | $182 M (79.1%) |
| Default foreign-turnkey external-capital comparison | $415 M; OSR saves $366 M (88.4%) |
| Lifetime external interest and combined financing saving | $459 M interest; $826 M capital + interest |
| 15%–25% planning risk envelope | $265 M–$288 M |
| Annual OPEX | $5.8 M / yr |
| Low/high project NPV at 8% | $-267 k / $121 M |
| Low/high project IRR | 8.0% / 12.6% |
| Low/high steady-state DSCR | 1.27 / 2.17 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,111.52 train-km; 6,189.43 kWh consumed; 6,570.67 kWh charged; 39 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 11,513.22 train-km; 64,110.51 kWh consumed; 65,251.32 kWh charged; 483 depot services completed (6 active at cutoff); minimum SoC 82%; 0 onboard emergencies; 0 invariant violations; 97.7% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 78.9% | 97.7% / 90% | pass |
| maximum planning climate/HVAC duty | 79.4% | 97.7% / 90% | pass |
| 50% charging-contact availability | 82.1% | 97.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.6% / 60% | pass |
| ten-hour single charging-pad outage | 63.1% | 97.7% / 90% | pass |
...
|---|---|
| ![Garissa energy and battery simulation dashboard](engineering/screenshots/garissa-simulation-dashboard.png) | ![Garissa simulator network visualizer](engineering/screenshots/garissa-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 13 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Garissa QGIS engineering layers](engineering/screenshots/garissa-qgis-engineering-map.png) | ![Garissa SUMO timetable validation](engineering/screenshots/garissa-sumo-validation.png) |
...
scripts/regenerate-city.sh garissa
```
