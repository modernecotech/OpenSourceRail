...
|---|---|---|---|---|
| line-1 |  7.1 km | 5 | 24 | SE Outer ↔ W Mid |
| line-2 |  6.3 km | 5 | 21 | NW Mid ↔ SW Mid |
| line-3 | 10.9 km | 7 | 32 | N Outer ↔ SE Mid |
| **Total** | **24.3 km** | **17 unique** | **77** | |
...
| Dedicated solar plant | 12.4 MW / 60 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 35 kWh | 98 kWh | 59 kWh | 2.2 km / 11 kWh |
| line-2 | 5 | 31 kWh | 98 kWh | 64 kWh | 2.0 km / 10 kWh |
| line-3 | 6 | 54 kWh | 123 kWh | 63 kWh | 5.0 km / 25 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (23.7 km @ $3.0 M/km) | $71 M |
| Elevated (0.6 km @ $12.0 M/km) | $6.9 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 12,444 kW @ $700/kW | $8.7 M |
| Grid interconnection / PPA tie-in | 12,444 kW @ $100/kW | $1.2 M |
| Annual generation proxy | 12.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 21.8 GWh/yr |
| **Dedicated solar plant subtotal** | | **$10.0 M** |
...
| Dedicated solar power plant | $10.0 M |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$121 M cumulative** | $404 |
| Lifecycle envelope (yr 1–40, high scenario) | **$121 M cumulative** | $404 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$537 M cumulative** | $1,788 |
...
| Traction energy (35.6 GWh / yr) | 11,290 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.6 GWh/yr + dedicated solar plant 12.4 MW / 21.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $149 k |
| Labour (256 FTE) | driverless roster: OCC/remote 57, station/platform 76, passenger service 38, fleet maintenance 38, infrastructure/energy 26, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $989 k |
| **OPEX subtotal** | | **$6.6 M / yr** |

_Annual service work: 11,290 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.5 M train-km / yr (8.9 M car-km / yr). On-site PV covers 16.6 GWh/yr and the dedicated solar plant adds 21.8 GWh/yr against 35.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 77 trainsets, 17 stations, 24.3 route-km, 3 lines, and 11,290 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$6.6 M / yr** |
| Revenue / OPEX recovery | 477% | 748% | 100% |
...
_Commercial-revenue assumptions: 3,312 m² of station shop/kiosk leases at $18/m²/month and 624 advertising boards at $161/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $155 M | 58% of $268 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $248 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $35 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 14,056 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $258 M |
| Timetable-sized dedicated solar CAPEX | $10.0 M |
| **Reconciled project CAPEX** | **$268 M** |
| 15%–25% planning risk envelope | $308 M–$335 M |
| Annual OPEX | $6.6 M / yr |
| Low/high project NPV at 8% | $-31202 k / $90 M |
| Low/high project IRR | 6.7% / 11.1% |
| Low/high steady-state DSCR | 1.99 / 3.42 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,105.21 train-km; 5,517.66 kWh consumed; 6,134.51 kWh charged; 38 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 11,752.66 train-km; 58,673.99 kWh consumed; 60,303.10 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 86.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 75.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 87.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.1% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 87.9% | 100.0% / 90% | pass |
