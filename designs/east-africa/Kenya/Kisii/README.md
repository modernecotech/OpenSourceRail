...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **36,180 – 60,300 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $97 |
| Steady-state, low-ridership (year 8+) | **$30 M / yr** | $100 |
| Steady-state, high-ridership (year 8+) | **$28 M / yr** | $93 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $93 |
| Lifecycle envelope (yr 1–30, low scenario) | **$898 M cumulative** | $2,992 |
| Lifecycle envelope (yr 1–30, high scenario) | **$845 M cumulative** | $2,818 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$845 M cumulative** | $2,818 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.3 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $227 M | 4.5% | 30 y, 7 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $95 M | 11.5% | 30 y, 7 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$378 M** | | | **$28 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $11 M / yr = **$21 M / yr** total — plus the equity tranche amortised across construction ($8.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating surplus after OPEX | $0 k / yr | $1.8 M / yr | $0 / yr |
