...
| Per-capita (city pop) | $750 / person |
...
|---|---|---|
| Construction (years 1–7) | **$15 M / yr** | $48 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$102 M cumulative** | $339 |
| Lifecycle envelope (yr 1–40, high scenario) | **$102 M cumulative** | $339 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$451 M cumulative** | $1,502 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $180 M | 4.5% | 40 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $45 M | — | — | — |
| **Total** | **100%** | **$225 M** | | | **$11 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $8.1 M / yr = **$8.1 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $131 M | 58% of $225 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 11,891 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $214 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$225 M** |
| 15%–25% planning risk envelope | $259 M–$281 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $5.6 M / $126 M |
| Low/high project IRR | 8.3% / 12.9% |
| Low/high steady-state DSCR | 2.43 / 4.14 |
