...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$324 M (87.9%) of external capital** and **$407 M of external interest**. Capital plus saved interest totals **$731 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 89.8% |
| Route length (double track) | 24.3 km |
...
| Total fleet capacity | 12,480 AW2 pax (16,640 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 52 × 240 = **12,480 AW2 passengers** (16,640 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **13.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 328 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 11,290 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 13.8 MW / 66 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 35 kWh | 82 kWh | 43 kWh | 3.0 km / 15 kWh |
| line-2 | 4 | 31 kWh | 82 kWh | 47 kWh | 3.0 km / 15 kWh |
| line-3 | 4 | 54 kWh | 98 kWh | 38 kWh | 6.3 km / 32 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (23.0 km @ $2.58 M/km) | $60 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 52 | $560 k | $29 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 104 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 104 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 13,824 kW @ $700/kW | $9.7 M |
| Grid interconnection / PPA tie-in | 13,824 kW @ $100/kW | $1.4 M |
| Annual generation proxy | 13.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 24.2 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 24.3 km × $0.050 M/km | $1.2 M |
...
| Per-capita (city pop) | $684 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $76 M | 15% | $11 M | $65 M |
| Stations | $66 M | 20% | $13 M | $52 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $29 M | 35% | $10 M | $19 M |
| Dedicated solar plant | $11 M | 45% | $5.0 M | $6.1 M |
| Residual signalling / train control | $1.2 M | 50% | $607 k | $607 k |
| Charging microgrids | $1.4 M | 40% | $560 k | $840 k |
| EPC / project services | $13 M | 15% | $1.9 M | $11 M |
| **Total city CAPEX** | **$205 M** | **21.8%** | **$45 M** | **$160 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kisii`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.8%** | **$45 M** | **$6.4 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.2%** | **$160 M** | **$23 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $128 M | $18 M / yr |
| **Total city programme** | **100.0%** | **$205 M** | **$29 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $277 M | $232 M (83.8%) | $291 M | **$523 M** |
| **Default** | 2.00× | $369 M | $324 M (87.9%) | $407 M | **$731 M** |
| High | 3.00× | $554 M | $509 M (91.9%) | $638 M | **$1.15 bn** |

At the default 2.00× case, OSR's $45 M external requirement is 87.9% below the illustrative foreign-company requirement of $369 M; the associated lifetime external-interest saving is $407 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $71 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$149 M cumulative** | $498 |
| Lifecycle envelope (yr 1–40, high scenario) | **$149 M cumulative** | $498 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$737 M cumulative** | $2,456 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $45 M | 4.5% | 40 y, 7 y grace | $2.6 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $128 M | 11.5% | 40 y, 7 y grace | $15 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $32 M | — | — | — |
| **Total** | **100%** | **$205 M** | | | **$18 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.0 M / yr + local bonds $15 M / yr = **$17 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (35.6 GWh / yr) | 11,290 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 14.5 GWh/yr + dedicated solar plant 13.8 MW / 24.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $166 k |
| Labour (214 FTE) | driverless roster: OCC/remote 45, station/platform 55, passenger service 38, fleet maintenance 31, infrastructure/energy 24, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $827 k |
| **OPEX subtotal** | | **$5.2 M / yr** |

_Annual service work: 11,290 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.5 M train-km / yr (8.9 M car-km / yr). On-site PV covers 14.5 GWh/yr and the dedicated solar plant adds 24.2 GWh/yr against 35.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 52 trainsets, 12 stations, 24.3 route-km, 3 lines, and 11,290 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 6.5 M |
| Annual paid trips / city resident | 163 | 261 | 22 |
| Farebox revenue | $30 M / yr | $48 M / yr | $4.0 M / yr |
| Station shop leases | $465 k / yr | $465 k / yr | $465 k / yr |
| Advertising boards | $755 k / yr | $755 k / yr | $755 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$5.2 M / yr** |
| Revenue / OPEX recovery | 599% | 944% | 100% |
...
| Operating surplus after OPEX (before debt support) | $26 M / yr | $44 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,392 m² of station shop/kiosk leases at $18/m²/month and 460 advertising boards at $161/board/month, with occupancy derates applied._
...
| Entertainment / community activity supported | $8.0 M / yr | $13 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$43 M / yr** | **$68 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 6,803 trips/school day; 1.5 M access-events/yr | 10,885 trips/school day; 2.4 M access-events/yr |
| Healthcare | 4 healthcare anchors | 12,535 trips/day; 4.6 M access-events/yr | 20,056 trips/day; 7.3 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 33,145 trips/trading day; 10.9 M access-events/yr | 53,032 trips/trading day; 17.5 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,620 trips/activity day; 4.4 M access-events/yr | 23,391 trips/activity day; 7.0 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $160 M | 78% of $205 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $257 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $37 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 14,523 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $194 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$205 M** |
| Imported / external-capital requirement | $45 M (21.8%) |
| Local-content / local-funding requirement | $160 M (78.2%) |
| Default foreign-turnkey external-capital comparison | $369 M; OSR saves $324 M (87.9%) |
| Lifetime external interest and combined financing saving | $407 M interest; $731 M capital + interest |
| 15%–25% planning risk envelope | $236 M–$256 M |
| Annual OPEX | $5.2 M / yr |
| Low/high project NPV at 8% | $22 M / $143 M |
| Low/high project IRR | 9.1% / 13.9% |
| Low/high steady-state DSCR | 1.46 / 2.47 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,073.85 train-km; 5,361.14 kWh consumed; 5,863.27 kWh charged; 41 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 11,000.29 train-km; 54,918.27 kWh consumed; 55,974.20 kWh charged; 484 depot services completed (6 active at cutoff); minimum SoC 84%; 0 onboard emergencies; 0 invariant violations; 97.4% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.1% | 97.4% / 90% | pass |
| maximum planning climate/HVAC duty | 80.6% | 97.4% / 90% | pass |
| 50% charging-contact availability | 84.0% | 97.4% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.4% / 60% | pass |
| ten-hour single charging-pad outage | 71.7% | 97.4% / 90% | pass |
...
|---|---|
| ![Kisii energy and battery simulation dashboard](engineering/screenshots/kisii-simulation-dashboard.png) | ![Kisii simulator network visualizer](engineering/screenshots/kisii-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 12 line platforms, 1 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Kisii QGIS engineering layers](engineering/screenshots/kisii-qgis-engineering-map.png) | ![Kisii SUMO timetable validation](engineering/screenshots/kisii-sumo-validation.png) |
