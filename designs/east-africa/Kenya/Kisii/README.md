...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 29.6 km × $0.015 M/km | $443 k |
...
| EPC integration + project management (7%) | on subtotal | $5.6 M |
...
| EPC overhead (7%) | $5.6 M |
| **CAPEX total** | **$86 M** |
| Per-route-km | $2.9 M / km |
| Per-capita (city pop) | $287 / person |
...
|---|---|---|
| Construction (years 1–7) | **$6.7 M / yr** | $22 |
| Steady-state, low-ridership (year 8+) | **$3.5 M / yr** | $12 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$127 M cumulative** | $423 |
| Lifecycle envelope (yr 1–30, high scenario) | **$47 M cumulative** | $155 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$47 M cumulative** | $155 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $52 M | 4.5% | 30 y, 7 y grace | $3.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $22 M | 11.5% | 30 y, 7 y grace | $2.7 M / yr |
| Government equity (no debt service) | 15% | $13 M | — | — | — |
| **Total** | **100%** | **$86 M** | | | **$6.4 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.3 M / yr + bonds $2.5 M / yr = **$4.8 M / yr** total — plus the equity tranche amortised across construction ($1.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 44,836 |
| Daily paid trips / population | 8% | 15% | 15% |
| Annual paid trips | 8.8 M | 16.4 M | 16.4 M |
| Farebox revenue | $4.0 M / yr | $7.6 M / yr | $7.5 M / yr |
| Station shop leases | $595 k / yr | $595 k / yr | $595 k / yr |
| Advertising boards | $966 k / yr | $966 k / yr | $966 k / yr |
| **Total revenue** | **$5.6 M / yr** | **$9.1 M / yr** | **$9.1 M / yr** |
| Revenue / OPEX + debt-service recovery | 62% | 100% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov gap | $3.5 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $27 k / yr | $0 / yr |
