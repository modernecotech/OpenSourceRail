...
|---|---|---|---|---|
| line-1 |  7.1 km | 5 | 17 | SE Outer ↔ NW Inner |
| line-2 | 11.3 km | 6 | 26 | S Inner ↔ N Outer |
| line-3 | 11.1 km | 6 | 26 | W Outer ↔ NW Inner |
| **Total** | **29.6 km** | **17 unique** | **69** | |
...
| Scheduled traction demand | 129 MWh/day | 14,923 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 71 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 16.3 MW / 82 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 16,316 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 16,316 kW @ $100/kW | $1.6 M |
| Annual generation proxy | 16.3 MW × 5.0 peak-sun-h/day × 365 d/yr | 29.8 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 29.6 km × $0.050 M/km | $1.5 M |
...
| Steady-state, low capacity-use (year 8+) | **$1.9 M / yr** | $6 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $53 |
| Lifecycle envelope (yr 1–40, low scenario) | **$210 M cumulative** | $699 |
| Lifecycle envelope (yr 1–40, high scenario) | **$148 M cumulative** | $494 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$670 M cumulative** | $2,235 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $380 M | 2.0% | 40 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $95 M | — | — | — |
| **Total** | **100%** | **$475 M** | | | **$16 M / yr** |
...
| Traction energy (47.1 GWh / yr) | 14,923 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.2 GWh/yr + dedicated solar plant 16.3 MW / 29.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $196 k |
| Labour (286 FTE) | driverless roster: OCC/remote 53, station/platform 71, passenger service 35, fleet maintenance 41, infrastructure/energy 50, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 14,923 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.8 M car-km / yr). On-site PV covers 21.2 GWh/yr and the dedicated solar plant adds 29.8 GWh/yr against 47.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 42.0 M | 67.3 M | 19.3 M |
| Annual paid trips / city resident | 140 | 224 | 64 |
| Farebox revenue | $26 M / yr | $41 M / yr | $12 M / yr |
| Station shop leases | $595 k / yr | $595 k / yr | $595 k / yr |
| Advertising boards | $966 k / yr | $966 k / yr | $966 k / yr |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.9 M / yr | $0 k / yr | **$16 M / yr** |
| Operating surplus after OPEX (before debt support) | $14 M / yr | $29 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,064 m² of station shop/kiosk leases at $18/m²/month and 588 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $4.5 M / yr | $7.2 M / yr | 56 M - 90 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $807 k / yr | $1.3 M / yr | 10.1–16.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 5,645 trips/school day; 1.2 M access-events/yr | 9,032 trips/school day; 2.0 M access-events/yr |
| Healthcare | 6 healthcare anchors | 11,750 trips/day; 4.3 M access-events/yr | 18,801 trips/day; 6.9 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 26,259 trips/trading day; 8.7 M access-events/yr | 42,014 trips/trading day; 13.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $256 M | 54% of $475 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,171 job-years | retained CAPEX ÷ (4.0 × median annual income) |
