...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **36,180 – 60,300 trips/day**
...
| Steady-state, low-ridership (year 8+) | **$7.3 M / yr** | $24 |
| Steady-state, high-ridership (year 8+) | **$2.3 M / yr** | $8 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$257 M cumulative** | $858 |
| Lifecycle envelope (yr 1–30, high scenario) | **$142 M cumulative** | $472 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$90 M cumulative** | $299 |
