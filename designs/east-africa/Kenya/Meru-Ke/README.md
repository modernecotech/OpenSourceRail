...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$414 M (88.4%) of external capital** and **$519 M of external interest**. Capital plus saved interest totals **$933 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`meru-ke.corridor.geojson`](meru-ke.corridor.geojson).
...
| Anchor-weighted coverage | 78.5% |
| Route length (double track) | 28.0 km |
...
- Anchor-weighted coverage: 78.5%
- Catchment population: **≈ 196,250** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **17.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.2× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 331 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 13,008 train-km/day | One-way train journeys × route length |
| Annual service work | 5.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 112 MWh/day | 10.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 74 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 17.7 MW / 85 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 68 kWh | 118 kWh | 44 kWh | 5.9 km / 29 kWh |
| line-2 | 3 | 26 kWh | 65 kWh | 37 kWh | 2.6 km / 13 kWh |
| line-3 | 4 | 46 kWh | 90 kWh | 39 kWh | 4.6 km / 23 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (22.7 km @ $3.0 M/km) | $68 M |
| Elevated (5.2 km @ $12.0 M/km) | $63 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 17,726 kW @ $700/kW | $12 M |
| Grid interconnection / PPA tie-in | 17,726 kW @ $100/kW | $1.8 M |
| Annual generation proxy | 17.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 31.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 28.0 km × $0.050 M/km | $1.4 M |
...
| Residual signalling / train control | $1.4 M | 50% | $699 k | $699 k |
| Charging microgrids | $1.3 M | 40% | $510 k | $765 k |
| EPC / project services | $16 M | 15% | $2.4 M | $14 M |
| **Total city CAPEX** | **$260 M** | **20.8%** | **$54 M** | **$206 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh meru-ke`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.8%** | **$54 M** | **$7.7 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.2%** | **$206 M** | **$29 M / yr** |
| of which planned local bond issuance | 63.3% of total CAPEX | $165 M | $24 M / yr |
| **Total city programme** | **100.0%** | **$260 M** | **$37 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $351 M | $297 M (84.6%) | $372 M | **$669 M** |
| **Default** | 2.00× | $468 M | $414 M (88.4%) | $519 M | **$933 M** |
| High | 3.00× | $702 M | $648 M (92.3%) | $812 M | **$1.46 bn** |

At the default 2.00× case, OSR's $54 M external requirement is 88.4% below the illustrative foreign-company requirement of $468 M; the associated lifetime external-interest saving is $519 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$27 M / yr** | $109 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $91 |
| Lifecycle envelope (yr 1–40, low scenario) | **$191 M cumulative** | $763 |
| Lifecycle envelope (yr 1–40, high scenario) | **$191 M cumulative** | $763 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$939 M cumulative** | $3,754 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $54 M | 4.5% | 40 y, 7 y grace | $3.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $165 M | 11.5% | 40 y, 7 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $41 M | — | — | — |
| **Total** | **100%** | **$260 M** | | | **$23 M / yr** |
...
| Traction energy (41.0 GWh / yr) | 13,008 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 14.0 GWh/yr + dedicated solar plant 17.7 MW / 31.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $213 k |
| Labour (214 FTE) | driverless roster: OCC/remote 49, station/platform 43, passenger service 38, fleet maintenance 36, infrastructure/energy 27, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $827 k |
| **OPEX subtotal** | | **$6.3 M / yr** |

_Annual service work: 13,008 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.1 M train-km / yr (10.3 M car-km / yr). On-site PV covers 14.0 GWh/yr and the dedicated solar plant adds 31.1 GWh/yr against 41.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 61 trainsets, 11 stations, 28.0 route-km, 3 lines, and 13,008 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 8.8 M |
| Annual paid trips / city resident | 196 | 313 | 35 |
| Farebox revenue | $30 M / yr | $48 M / yr | $5.4 M / yr |
| Station shop leases | $340 k / yr | $340 k / yr | $340 k / yr |
| Advertising boards | $585 k / yr | $585 k / yr | $585 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX recovery | 488% | 772% | 100% |
...
_Commercial-revenue assumptions: 1,752 m² of station shop/kiosk leases at $18/m²/month and 356 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $4.9 M / yr | $7.9 M / yr | 62 M - 99 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $887 k / yr | $1.4 M / yr | 11.1–17.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $2.5 M / yr | $3.9 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 10,178 trips/school day; 2.2 M access-events/yr | 16,285 trips/school day; 3.6 M access-events/yr |
| Healthcare | 1 healthcare anchors | 9,910 trips/day; 3.6 M access-events/yr | 15,856 trips/day; 5.8 M access-events/yr |
| Commerce | 7 major/terminal/interchange nodes | 30,375 trips/trading day; 10.0 M access-events/yr | 48,601 trips/trading day; 16.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $206 M | 79% of $260 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $329 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $47 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 18,648 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $54 M (20.8%) |
| Local-content / local-funding requirement | $206 M (79.2%) |
| Default foreign-turnkey external-capital comparison | $468 M; OSR saves $414 M (88.4%) |
| Lifetime external interest and combined financing saving | $519 M interest; $933 M capital + interest |
| 15%–25% planning risk envelope | $299 M–$325 M |
| Annual OPEX | $6.3 M / yr |
| Low/high project NPV at 8% | $-28350 k / $92 M |
| Low/high project IRR | 6.8% / 11.3% |
| Low/high steady-state DSCR | 1.08 / 1.88 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,172.48 train-km; 5,853.54 kWh consumed; 6,140.80 kWh charged; 39 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 12,241.48 train-km; 61,115.00 kWh consumed; 62,279.75 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 79%; 0 onboard emergencies; 0 invariant violations; 94.1% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 76.2% | 94.1% / 90% | pass |
| maximum planning climate/HVAC duty | 68.4% | 94.1% / 90% | pass |
| 50% charging-contact availability | 79.0% | 94.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.3% / 60% | pass |
| ten-hour single charging-pad outage | 56.0% | 94.1% / 90% | pass |
...
|---|---|
| ![Meru-Ke energy and battery simulation dashboard](engineering/screenshots/meru-ke-simulation-dashboard.png) | ![Meru-Ke simulator network visualizer](engineering/screenshots/meru-ke-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 11 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Meru-Ke QGIS engineering layers](engineering/screenshots/meru-ke-qgis-engineering-map.png) | ![Meru-Ke SUMO timetable validation](engineering/screenshots/meru-ke-sumo-validation.png) |
...
| [`meru-ke.toml`](meru-ke.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`meru-ke-network-map.png`](meru-ke-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`meru-ke.corridor.geojson`](meru-ke.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`meru-ke.stations.json`](meru-ke.stations.json) | Machine-readable station list |
| [`meru-ke.design-quality.yaml`](meru-ke.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug meru-ke
