...
| Revenue fleet | 77 × 2-car trainsets |
| Revenue fleet passenger capacity | 18,480 AW2 pax (24,640 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 13.6 km | 8 | 39 | S Outer ↔ N Outer |
| line-2 |  5.2 km | 5 | 19 | NE Inner ↔ NW Mid |
| line-3 |  9.2 km | 6 | 28 | E Inner ↔ SW Outer |
| **Total** | **28.0 km** | **19 unique** | **86** | |
...
| Revenue fleet capacity | 18,480 AW2 pax (24,640 AW3 crush) |
| Total fleet capacity | 20,640 AW2 pax (27,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 77 × 240 = **18,480 AW2 passengers** (24,640 AW3 crush)
- **Total fleet passenger capacity:** 86 × 240 = **20,640 AW2 passengers** (27,520 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 12.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 330 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 47 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 15.7 MW / 75 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 68 kWh | 139 kWh | 64 kWh | 5.0 km / 25 kWh |
| line-2 | 5 | 26 kWh | 98 kWh | 70 kWh | 2.0 km / 10 kWh |
| line-3 | 5 | 46 kWh | 98 kWh | 47 kWh | 6.0 km / 30 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 86 | $560 k | $48 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 172 | $60 k | $10 M |
| High sensitivity check | 172 | $120 k | $21 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 15,656 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 15,656 kW @ $100/kW | $1.6 M |
| Annual generation proxy | 15.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 27.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $89 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$156 M cumulative** | $624 |
| Lifecycle envelope (yr 1–40, high scenario) | **$156 M cumulative** | $624 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$692 M cumulative** | $2,766 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $276 M | 4.5% | 40 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $69 M | — | — | — |
| **Total** | **100%** | **$345 M** | | | **$16 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $12 M / yr = **$12 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (41.0 GWh / yr) | 13,008 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.2 GWh/yr + dedicated solar plant 15.7 MW / 27.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $188 k |
| Labour (276 FTE) | driverless roster: OCC/remote 61, station/platform 84, passenger service 38, fleet maintenance 43, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$8.2 M / yr** |

_Annual service work: 13,008 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.1 M train-km / yr (10.3 M car-km / yr). On-site PV covers 17.2 GWh/yr and the dedicated solar plant adds 27.4 GWh/yr against 41.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 86 trainsets, 19 stations, 28.0 route-km, 3 lines, and 13,008 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $30 M / yr | $48 M / yr | $6.4 M / yr |
| Station shop leases | $695 k / yr | $695 k / yr | $695 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$8.2 M / yr** |
| Revenue / OPEX recovery | 386% | 604% | 100% |
...
_Commercial-revenue assumptions: 3,576 m² of station shop/kiosk leases at $18/m²/month and 672 advertising boards at $161/board/month, with occupancy derates applied._
...
| Commerce | 12 major/terminal/interchange nodes | 30,308 trips/trading day; 10.0 M access-events/yr | 48,493 trips/trading day; 16.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $203 M | 59% of $345 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $324 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $46 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 18,349 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $397 M–$432 M |
| Annual OPEX | $8.2 M / yr |
| Low/high project NPV at 8% | $-98644 k / $22 M |
| Low/high project IRR | 4.6% / 8.7% |
| Low/high steady-state DSCR | 1.45 / 2.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,240.64 train-km; 6,193.78 kWh consumed; 6,698.90 kWh charged; 38 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,524.98 train-km; 67,522.15 kWh consumed; 69,304.58 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 82.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 74.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 86.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 73.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
