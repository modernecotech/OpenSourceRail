...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$376 M (88.1%) of external capital** and **$472 M of external interest**. Capital plus saved interest totals **$848 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (22.7 km @ $2.58 M/km) | $59 M |
| Elevated (5.2 km @ $9.75 M/km) | $51 M |
...
| Per-capita (city pop) | $949 / person |
...
| **Total city CAPEX** | **$237 M** | **21.4%** | **$51 M** | **$187 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.4%** | **$51 M** | **$7.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.6%** | **$187 M** | **$27 M / yr** |
| of which planned local bond issuance | 62.9% of total CAPEX | $149 M | $21 M / yr |
| **Total city programme** | **100.0%** | **$237 M** | **$34 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $320 M | $270 M (84.2%) | $338 M | **$608 M** |
| **Default** | 2.00× | $427 M | $376 M (88.1%) | $472 M | **$848 M** |
| High | 3.00× | $641 M | $590 M (92.1%) | $740 M | **$1.33 bn** |

At the default 2.00× case, OSR's $51 M external requirement is 88.1% below the illustrative foreign-company requirement of $427 M; the associated lifetime external-interest saving is $472 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $99 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $83 |
| Lifecycle envelope (yr 1–40, low scenario) | **$173 M cumulative** | $694 |
| Lifecycle envelope (yr 1–40, high scenario) | **$173 M cumulative** | $694 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$854 M cumulative** | $3,417 |
...
| Local-currency sovereign / project bonds for local content | 63% | $149 M | 11.5% | 40 y, 7 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $37 M | — | — | — |
| **Total** | **100%** | **$237 M** | | | **$21 M / yr** |
...
| Annual paid trips / city resident | 196 | 313 | 33 |
| Farebox revenue | $30 M / yr | $48 M / yr | $5.0 M / yr |
| Station shop leases | $340 k / yr | $340 k / yr | $340 k / yr |
| Advertising boards | $585 k / yr | $585 k / yr | $585 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$5.9 M / yr** |
| Revenue / OPEX recovery | 523% | 827% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $187 M | 79% of $237 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $299 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $43 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 16,899 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $223 M |
| Timetable-sized dedicated solar CAPEX | $14 M |
| **Reconciled project CAPEX** | **$237 M** |
| Imported / external-capital requirement | $51 M (21.4%) |
| Local-content / local-funding requirement | $187 M (78.6%) |
| Default foreign-turnkey external-capital comparison | $427 M; OSR saves $376 M (88.1%) |
| Lifetime external interest and combined financing saving | $472 M interest; $848 M capital + interest |
| 15%–25% planning risk envelope | $273 M–$297 M |
| Annual OPEX | $5.9 M / yr |
| Low/high project NPV at 8% | $-8601 k / $112 M |
| Low/high project IRR | 7.6% / 12.2% |
| Low/high steady-state DSCR | 1.21 / 2.08 |
