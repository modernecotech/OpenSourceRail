...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$704 M (86.9%) of external capital** and **$882 M of external interest**. Capital plus saved interest totals **$1.59 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (53.0 km @ $3.0 M/km) | $159 M |
...
|---|---:|---:|---:|---:|
| Civil works | $178 M | 15% | $27 M | $152 M |
...
| **Total city CAPEX** | **$450 M** | **23.6%** | **$106 M** | **$344 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$106 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$344 M** | **$49 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $275 M | $39 M / yr |
| **Total city programme** | **100.0%** | **$450 M** | **$64 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $608 M | $501 M (82.5%) | $628 M | **$1.13 bn** |
| **Default** | 2.00× | $810 M | $704 M (86.9%) | $882 M | **$1.59 bn** |
| High | 3.00× | $1.22 bn | $1.11 bn (91.3%) | $1.39 bn | **$2.50 bn** |

At the default 2.00× case, OSR's $106 M external requirement is 86.9% below the illustrative foreign-company requirement of $810 M; the associated lifetime external-interest saving is $882 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$3.9 M / yr** | $6 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$39 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$452 M cumulative** | $645 |
| Lifecycle envelope (yr 1–40, high scenario) | **$324 M cumulative** | $462 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.60 bn cumulative** | $2,290 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $106 M | 4.5% | 40 y, 7 y grace | $6.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $275 M | 11.5% | 40 y, 7 y grace | $33 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$450 M** | | | **$39 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.8 M / yr + local bonds $32 M / yr = **$36 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips / city resident | 105 | 168 | 23 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.9 M / yr | $0 k / yr | **$39 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $344 M | 76% of $450 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $550 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $79 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 31,144 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $413 M |
| Timetable-sized dedicated solar CAPEX | $37 M |
| **Reconciled project CAPEX** | **$450 M** |
| Imported / external-capital requirement | $106 M (23.6%) |
| Local-content / local-funding requirement | $344 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $810 M; OSR saves $704 M (86.9%) |
| Lifetime external interest and combined financing saving | $882 M interest; $1.59 bn capital + interest |
| 15%–25% planning risk envelope | $518 M–$563 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-100341 k / $81 M |
| Low/high project IRR | 5.4% / 9.7% |
| Low/high steady-state DSCR | 0.90 / 1.60 |
