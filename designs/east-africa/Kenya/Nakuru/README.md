...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.6 km × $0.015 M/km | $3.0 M |
...
|---|---|---|
| Construction (years 1–7) | **$27 M / yr** | $38 |
| Steady-state, low-ridership (year 8+) | **$26 M / yr** | $37 |
| Steady-state, high-ridership (year 8+) | **$26 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $37 |
| Lifecycle envelope (yr 1–30, low scenario) | **$775 M cumulative** | $1,107 |
| Lifecycle envelope (yr 1–30, high scenario) | **$775 M cumulative** | $1,107 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$775 M cumulative** | $1,107 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $208 M | 4.5% | 30 y, 7 y grace | $15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $87 M | 11.5% | 30 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $52 M | — | — | — |
| **Total** | **100%** | **$347 M** | | | **$26 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $9.4 M / yr + bonds $10.0 M / yr = **$19 M / yr** total — plus the equity tranche amortised across construction ($7.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating surplus after OPEX | $3.8 M / yr | $10 M / yr | $0 / yr |
