...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$660 M (86.6%) of external capital** and **$827 M of external interest**. Capital plus saved interest totals **$1.49 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 54.3 km |
...
| Total fleet capacity | 41,760 AW2 pax (55,680 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 104 × 360 = **37,440 AW2 passengers** (49,920 AW3 crush)
- **Total fleet passenger capacity:** 116 × 360 = **41,760 AW2 passengers** (55,680 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 46.8%
- Catchment population: **≈ 327,600** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **46.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 466 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 28 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 66 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 25,232 train-km/day | One-way train journeys × route length |
| Annual service work | 9.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 327 MWh/day | 29.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 261 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 46.2 MW / 301 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 123 kWh | 163 kWh | 28 kWh | 5.7 km / 48 kWh |
| line-2 | 7 | 178 kWh | 257 kWh | 61 kWh | 8.8 km / 74 kWh |
| line-3 | 6 | 152 kWh | 220 kWh | 54 kWh | 6.9 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (53.0 km @ $2.58 M/km) | $137 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 116 | $900 k | $104 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 348 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 348 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 46,240 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 46,240 kW @ $100/kW | $4.6 M |
| Annual generation proxy | 46.2 MW × 6.5 peak-sun-h/day × 365 d/yr | 109.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 54.3 km × $0.050 M/km | $2.7 M |
...
| Stations | $91 M | 20% | $18 M | $72 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $104 M | 35% | $37 M | $68 M |
...
| **Total city CAPEX** | **$424 M** | **24.2%** | **$102 M** | **$321 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh nakuru`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$102 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$321 M** | **$46 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $257 M | $37 M / yr |
| **Total city programme** | **100.0%** | **$424 M** | **$61 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $572 M | $469 M (82.1%) | $589 M | **$1.06 bn** |
| **Default** | 2.00× | $762 M | $660 M (86.6%) | $827 M | **$1.49 bn** |
| High | 3.00× | $1.14 bn | $1.04 bn (91.1%) | $1.31 bn | **$2.35 bn** |

At the default 2.00× case, OSR's $102 M external requirement is 86.6% below the illustrative foreign-company requirement of $762 M; the associated lifetime external-interest saving is $827 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $62 |
| Steady-state, low capacity-use (year 8+) | **$1.0 M / yr** | $1 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$337 M cumulative** | $481 |
| Lifecycle envelope (yr 1–40, high scenario) | **$303 M cumulative** | $433 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.50 bn cumulative** | $2,149 |

_Population basis: 700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $35 M / yr → $36 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $102 M | 4.5% | 40 y, 7 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $257 M | 11.5% | 40 y, 7 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$424 M** | | | **$36 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.6 M / yr + local bonds $30 M / yr = **$34 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (119.4 GWh / yr) | 25,232 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.0 GWh/yr + dedicated solar plant 46.2 MW / 109.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $555 k |
| Labour (331 FTE) | driverless roster: OCC/remote 73, station/platform 74, passenger service 49, fleet maintenance 68, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 25,232 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.9 M train-km / yr (29.8 M car-km / yr). On-site PV covers 24.0 GWh/yr and the dedicated solar plant adds 109.7 GWh/yr against 119.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 116 trainsets, 19 stations, 54.3 route-km, 3 lines, and 25,232 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 15.6 M |
| Annual paid trips / city resident | 105 | 168 | 22 |
| Farebox revenue | $45 M / yr | $72 M / yr | $9.6 M / yr |
| Station shop leases | $611 k / yr | $611 k / yr | $611 k / yr |
| Advertising boards | $998 k / yr | $998 k / yr | $998 k / yr |
| **Total revenue** | **$47 M / yr** | **$74 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 416% | 658% | 100% |
...
| Operating surplus applied to debt support | -$35 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.0 M / yr | $0 k / yr | **$36 M / yr** |
| Operating surplus after OPEX (before debt support) | $35 M / yr | $62 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,144 m² of station shop/kiosk leases at $18/m²/month and 608 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $13 M / yr | $21 M / yr | 16 min/trip × $0.66/h value-of-time proxy |
| Avoided road congestion | $14 M / yr | $23 M / yr | 179 M - 287 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.6 M / yr | $4.1 M / yr | 32.2–51.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.2 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 9,704 trips/school day; 2.1 M access-events/yr | 15,526 trips/school day; 3.4 M access-events/yr |
| Healthcare | 1 healthcare anchors | 13,351 trips/day; 4.9 M access-events/yr | 21,361 trips/day; 7.8 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 44,352 trips/trading day; 14.6 M access-events/yr | 70,964 trips/trading day; 23.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $321 M | 76% of $424 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $514 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $73 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 29,098 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $387 M |
| Timetable-sized dedicated solar CAPEX | $37 M |
| **Reconciled project CAPEX** | **$424 M** |
| Imported / external-capital requirement | $102 M (24.2%) |
| Local-content / local-funding requirement | $321 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $762 M; OSR saves $660 M (86.6%) |
| Lifetime external interest and combined financing saving | $827 M interest; $1.49 bn capital + interest |
| 15%–25% planning risk envelope | $487 M–$529 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-77245 k / $104 M |
| Low/high project IRR | 5.9% / 10.3% |
| Low/high steady-state DSCR | 0.97 / 1.71 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,048.93 train-km; 17,110.46 kWh consumed; 14,146.33 kWh charged; 29 depot services completed; minimum SoC 67%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,408.47 train-km; 195,486.79 kWh consumed; 183,949.12 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 92.8% of scheduled train-km delivered; 25 SoC warnings; 5 energy-adapted off-peak departures, maximum 14 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 92.3% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.0% / 90% | pass |
| 50% charging-contact availability | 20.0% | 92.8% / 90% | pass |
...
|---|---|
| ![Nakuru energy and battery simulation dashboard](engineering/screenshots/nakuru-simulation-dashboard.png) | ![Nakuru simulator network visualizer](engineering/screenshots/nakuru-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![Nakuru QGIS engineering layers](engineering/screenshots/nakuru-qgis-engineering-map.png) | ![Nakuru SUMO timetable validation](engineering/screenshots/nakuru-sumo-validation.png) |
