...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.6 km × €0.015 M/km | €0.9 M |
...
| Steady-state, high-ridership (year 8+) | **€52 M / yr** | €74 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.62 bn cumulative** | €2,315 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.52 bn cumulative** | €2,167 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €7.1 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €364 M | 4.5% | 30 y, 7 y grace | €26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €151 M | 11.5% | 30 y, 7 y grace | €19 M / yr |
| Government equity (no debt service) | 15% | €91 M | — | — | — |
| **Total** | **100%** | **€606 M** | | | **€45 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €16 M / yr + bonds €17 M / yr = **€34 M / yr** total — plus the equity tranche amortised across construction (€13 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (370 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.3 M |
...
| Farebox revenue | €4.5 M / yr | €9.0 M / yr |
| Farebox / OPEX recovery | 28% | 56% |
| Country policy-target recovery (diagnostic) | 50% | 50% |
| Operating shortfall (gov subsidy required) | €12 M / yr | €7.1 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€56 M / yr** | **€52 M / yr** |
