...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **32,410 – 48,615 trips/day**
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.6 km × $0.015 M/km | $894 k |
...
| Steady-state, low-ridership (year 8+) | **$4.3 M / yr** | $6 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$181 M cumulative** | $259 |
| Lifecycle envelope (yr 1–30, high scenario) | **$83 M cumulative** | $118 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$83 M cumulative** | $118 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $92 M | 4.5% | 30 y, 7 y grace | $6.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $38 M | 11.5% | 30 y, 7 y grace | $4.8 M / yr |
| Government equity (no debt service) | 15% | $23 M | — | — | — |
| **Total** | **100%** | **$153 M** | | | **$11 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.1 M / yr + bonds $4.4 M / yr = **$8.5 M / yr** total — plus the equity tranche amortised across construction ($3.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
