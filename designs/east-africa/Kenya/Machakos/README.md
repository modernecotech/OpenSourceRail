...
|---|---|---|---|---|
| line-1 | 12.2 km | 6 | 17 | S Mid ↔ N Outer |
| line-2 |  7.7 km | 5 | 12 | W Mid ↔ N Inner |
| line-3 |  6.7 km | 5 | 11 | W Mid ↔ SE Mid |
| **Total** | **26.5 km** | **16 unique** | **40** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **22,710 – 34,065 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (25.2 km @ $1.2 M/km) | $30 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 40 | $534 k | $21 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 26.5 km × $0.015 M/km | $398 k |
...
| EPC integration + project management (7%) | on subtotal | $6.5 M |
...
|---|---|---|
| Construction (years 1–7) | **$7.6 M / yr** | $25 |
| Steady-state, low-ridership (year 8+) | **$4.6 M / yr** | $15 |
| Steady-state, high-ridership (year 8+) | **$1.0 M / yr** | $3 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$158 M cumulative** | $528 |
| Lifecycle envelope (yr 1–30, high scenario) | **$77 M cumulative** | $257 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$53 M cumulative** | $178 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $59 M | 4.5% | 30 y, 7 y grace | $4.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $25 M | 11.5% | 30 y, 7 y grace | $3.1 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$99 M** | | | **$7.3 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.7 M / yr + bonds $2.8 M / yr = **$5.5 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $854 k |
...
| Traction energy (33.6 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (171 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $661 k |
| **OPEX subtotal** | | **$2.9 M / yr** |

_Annual fleet utilisation: 34 revenue trainsets × 20.5 h/day × 365 d/yr × 22 km/h commercial × 75% revenue factor = 4.2 M train-km / yr (~123 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 51,136 |
| Daily paid trips / population | 8% | 15% | 17% |
| Annual paid trips | 8.8 M | 16.4 M | 18.7 M |
| Farebox revenue | $4.0 M / yr | $7.6 M / yr | $8.6 M / yr |
| Station shop leases | $606 k / yr | $606 k / yr | $606 k / yr |
| Advertising boards | $972 k / yr | $972 k / yr | $972 k / yr |
| **Total revenue** | **$5.6 M / yr** | **$9.1 M / yr** | **$10 M / yr** |
| Revenue / OPEX + debt-service recovery | 55% | 90% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov gap | $4.6 M / yr | $1.0 M / yr | **$0 / yr** |
