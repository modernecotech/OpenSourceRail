...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$374 M (88.1%) of external capital** and **$469 M of external interest**. Capital plus saved interest totals **$842 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 76.2% |
| Route length (double track) | 28.9 km |
| Revenue fleet | 56 × 2-car trainsets |
| Revenue fleet passenger capacity | 13,440 AW2 pax (17,920 AW3 crush) |
...
| Revenue fleet capacity | 13,440 AW2 pax (17,920 AW3 crush) |
| Total fleet capacity | 15,120 AW2 pax (20,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 56 × 240 = **13,440 AW2 passengers** (17,920 AW3 crush)
- **Total fleet passenger capacity:** 63 × 240 = **15,120 AW2 passengers** (20,160 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 76.2%
- Catchment population: **≈ 228,600** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **10.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled train journey-km | 13,430 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 58 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 10.3 MW / 67 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 68 kWh | 118 kWh | 44 kWh | 6.5 km / 36 kWh |
| line-2 | 4 | 43 kWh | 82 kWh | 35 kWh | 3.0 km / 17 kWh |
| line-3 | 5 | 50 kWh | 98 kWh | 43 kWh | 2.5 km / 14 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (27.6 km @ $2.58 M/km) | $71 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 63 | $560 k | $35 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 126 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 126 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 10,295 kW @ $700/kW | $7.2 M |
| Grid interconnection / PPA tie-in | 10,295 kW @ $100/kW | $1.0 M |
| Annual generation proxy | 10.3 MW × 6.5 peak-sun-h/day × 365 d/yr | 24.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$8.2 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $88 M | 15% | $13 M | $75 M |
| Stations | $78 M | 20% | $16 M | $62 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $35 M | 35% | $12 M | $23 M |
| Dedicated solar plant | $8.2 M | 45% | $3.7 M | $4.5 M |
| Residual signalling / train control | $1.4 M | 50% | $722 k | $722 k |
| Charging microgrids | $1.6 M | 40% | $650 k | $975 k |
| EPC / project services | $15 M | 15% | $2.2 M | $13 M |
| **Total city CAPEX** | **$236 M** | **21.4%** | **$51 M** | **$185 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh machakos`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.4%** | **$51 M** | **$7.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.6%** | **$185 M** | **$26 M / yr** |
| of which planned local bond issuance | 62.9% of total CAPEX | $148 M | $21 M / yr |
| **Total city programme** | **100.0%** | **$236 M** | **$34 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $318 M | $268 M (84.1%) | $336 M | **$603 M** |
| **Default** | 2.00× | $424 M | $374 M (88.1%) | $469 M | **$842 M** |
| High | 3.00× | $637 M | $586 M (92.1%) | $735 M | **$1.32 bn** |

At the default 2.00× case, OSR's $51 M external requirement is 88.1% below the illustrative foreign-company requirement of $424 M; the associated lifetime external-interest saving is $469 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $82 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$172 M cumulative** | $574 |
| Lifecycle envelope (yr 1–40, high scenario) | **$172 M cumulative** | $574 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$848 M cumulative** | $2,828 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $51 M | 4.5% | 40 y, 7 y grace | $3.0 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $148 M | 11.5% | 40 y, 7 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $37 M | — | — | — |
| **Total** | **100%** | **$236 M** | | | **$20 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.3 M / yr + local bonds $17 M / yr = **$19 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (42.4 GWh / yr) | 13,430 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.1 GWh/yr + dedicated solar plant 10.3 MW / 24.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $124 k |
| Labour (236 FTE) | driverless roster: OCC/remote 49, station/platform 63, passenger service 38, fleet maintenance 37, infrastructure/energy 28, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $912 k |
| **OPEX subtotal** | | **$6.0 M / yr** |

_Annual service work: 13,430 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.3 M train-km / yr (10.6 M car-km / yr). On-site PV covers 21.1 GWh/yr and the dedicated solar plant adds 24.4 GWh/yr against 42.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 63 trainsets, 14 stations, 28.9 route-km, 3 lines, and 13,430 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $30 M / yr | $48 M / yr | $4.6 M / yr |
| Station shop leases | $529 k / yr | $529 k / yr | $529 k / yr |
| Advertising boards | $854 k / yr | $854 k / yr | $854 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$6.0 M / yr** |
| Revenue / OPEX recovery | 522% | 822% | 100% |
...
| Operating surplus after OPEX (before debt support) | $25 M / yr | $43 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,720 m² of station shop/kiosk leases at $18/m²/month and 520 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 2 education anchors | 7,767 trips/school day; 1.7 M access-events/yr | 12,428 trips/school day; 2.7 M access-events/yr |
| Healthcare | 0 healthcare anchors | 8,035 trips/day; 2.9 M access-events/yr | 12,856 trips/day; 4.7 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 31,471 trips/trading day; 10.4 M access-events/yr | 50,354 trips/trading day; 16.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $185 M | 79% of $236 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $296 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $42 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 16,780 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $228 M |
| Timetable-sized dedicated solar CAPEX | $8.2 M |
| **Reconciled project CAPEX** | **$236 M** |
| Imported / external-capital requirement | $51 M (21.4%) |
| Local-content / local-funding requirement | $185 M (78.6%) |
| Default foreign-turnkey external-capital comparison | $424 M; OSR saves $374 M (88.1%) |
| Lifetime external interest and combined financing saving | $469 M interest; $842 M capital + interest |
| 15%–25% planning risk envelope | $271 M–$295 M |
| Annual OPEX | $6.0 M / yr |
| Low/high project NPV at 8% | $-4979 k / $116 M |
| Low/high project IRR | 7.8% / 12.3% |
| Low/high steady-state DSCR | 1.24 / 2.12 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,259.92 train-km; 7,015.74 kWh consumed; 7,369.97 kWh charged; 39 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,130.23 train-km; 73,114.61 kWh consumed; 74,330.49 kWh charged; 483 depot services completed (6 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 97.8% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 74.2% | 97.8% / 90% | pass |
| maximum planning climate/HVAC duty | 69.2% | 97.8% / 90% | pass |
| 50% charging-contact availability | 78.3% | 97.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.6% / 60% | pass |
| ten-hour single charging-pad outage | 78.3% | 97.8% / 90% | pass |
...
|---|---|
| ![Machakos energy and battery simulation dashboard](engineering/screenshots/machakos-simulation-dashboard.png) | ![Machakos simulator network visualizer](engineering/screenshots/machakos-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Machakos QGIS engineering layers](engineering/screenshots/machakos-qgis-engineering-map.png) | ![Machakos SUMO timetable validation](engineering/screenshots/machakos-sumo-validation.png) |
