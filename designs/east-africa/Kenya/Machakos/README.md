...
| Per-capita (city pop) | $628 / person |
...
| Steady-state, low-ridership (year 8+) | **$14 M / yr** | $46 |
| Steady-state, high-ridership (year 8+) | **$14 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$14 M / yr** | $46 |
| Lifecycle envelope (yr 1–30, low scenario) | **$421 M cumulative** | $1,403 |
| Lifecycle envelope (yr 1–30, high scenario) | **$421 M cumulative** | $1,403 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$421 M cumulative** | $1,403 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $113 M | 4.5% | 30 y, 7 y grace | $8.0 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $5.1 M / yr + bonds $5.4 M / yr = **$10 M / yr** total — plus the equity tranche amortised across construction ($4.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
