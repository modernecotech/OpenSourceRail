...
|---|---|---|
| Construction (years 1–7) | **$17 M / yr** | $56 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$117 M cumulative** | $391 |
| Lifecycle envelope (yr 1–40, high scenario) | **$117 M cumulative** | $391 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$519 M cumulative** | $1,730 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $207 M | 4.5% | 40 y, 7 y grace | $12 M / yr |
| Government equity (no debt service) | 20% | $52 M | — | — | — |
| **Total** | **100%** | **$259 M** | | | **$12 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $9.3 M / yr = **$9.3 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($7.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $152 M | 59% of $259 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 13,803 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $251 M |
| Timetable-sized dedicated solar CAPEX | $8.2 M |
| **Reconciled project CAPEX** | **$259 M** |
| 15%–25% planning risk envelope | $298 M–$324 M |
| Annual OPEX | $6.3 M / yr |
| Low/high project NPV at 8% | $-24353 k / $96 M |
