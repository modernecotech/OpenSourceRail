...
| Steady-state, low-ridership (year 8+) | **$19 M / yr** | $62 |
| Steady-state, high-ridership (year 8+) | **$19 M / yr** | $62 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $62 |
| Lifecycle envelope (yr 1–30, low scenario) | **$563 M cumulative** | $1,878 |
| Lifecycle envelope (yr 1–30, high scenario) | **$563 M cumulative** | $1,878 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$563 M cumulative** | $1,878 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $151 M | 4.5% | 30 y, 7 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $63 M | 11.5% | 30 y, 7 y grace | $7.9 M / yr |
| Government equity (no debt service) | 15% | $38 M | — | — | — |
| **Total** | **100%** | **$252 M** | | | **$19 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.8 M / yr + bonds $7.2 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($5.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
