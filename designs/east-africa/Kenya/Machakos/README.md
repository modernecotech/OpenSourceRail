...
| Bucket | Value |
|---|---|
| At-grade (25.2 km @ €3.5 M/km) | €88 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 40 | €2.0 M | €80 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 26.5 km × €0.015 M/km | €0.4 M |
...
| Steady-state, high-ridership (year 8+) | **€28 M / yr** | €94 |
| Lifecycle envelope (yr 1–30, low scenario) | **€866 M cumulative** | €2,886 |
| Lifecycle envelope (yr 1–30, high scenario) | **€821 M cumulative** | €2,738 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€6.2 M / yr (low) → €4.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €194 M | 4.5% | 30 y, 7 y grace | €14 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral €8.7 M / yr + bonds €9.3 M / yr = **€18 M / yr** total — plus the equity tranche amortised across construction (€6.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (171 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €608 k |
...
| Operating shortfall (gov subsidy required) | €6.2 M / yr | €4.3 M / yr |
