...
| Steady-state, low capacity-use (year 8+) | **$49 k / yr** | $0 |
...
| Lifecycle envelope (yr 1–40, high scenario) | **$139 M cumulative** | $463 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $356 M | 2.0% | 40 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 20% | $89 M | — | — | — |
| **Total** | **100%** | **$445 M** | | | **$15 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $7.1 M / yr = **$7.1 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Labour (279 FTE) | driverless roster: OCC/remote 53, station/platform 71, passenger service 35, fleet maintenance 37, infrastructure/energy 47, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
...
| Annual paid trips | 42.0 M | 67.3 M | 17.9 M |
| Annual paid trips / city resident | 140 | 224 | 60 |
...
| Revenue / OPEX recovery | 218% | 341% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $49 k / yr | $0 k / yr | **$15 M / yr** |
...
| Healthcare | 1 healthcare anchors | 7,656 trips/day; 2.8 M access-events/yr | 12,250 trips/day; 4.5 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 27,504 trips/trading day; 9.1 M access-events/yr | 44,006 trips/trading day; 14.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $241 M | 54% of $445 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $385 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $55 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 21,793 job-years | retained CAPEX ÷ (4.0 × median annual income) |
