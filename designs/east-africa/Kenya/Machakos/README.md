...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$399 M (88.3%) of external capital** and **$500 M of external interest**. Capital plus saved interest totals **$900 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $837 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $103 M | 15% | $15 M | $87 M |
...
| **Total city CAPEX** | **$251 M** | **21.0%** | **$53 M** | **$198 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.0%** | **$53 M** | **$7.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.0%** | **$198 M** | **$28 M / yr** |
| of which planned local bond issuance | 63.2% of total CAPEX | $159 M | $23 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $339 M | $286 M (84.4%) | $359 M | **$645 M** |
| **Default** | 2.00× | $452 M | $399 M (88.3%) | $500 M | **$900 M** |
| High | 3.00× | $678 M | $625 M (92.2%) | $784 M | **$1.41 bn** |

At the default 2.00× case, OSR's $53 M external requirement is 88.3% below the illustrative foreign-company requirement of $452 M; the associated lifetime external-interest saving is $500 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$184 M cumulative** | $613 |
| Lifecycle envelope (yr 1–40, high scenario) | **$184 M cumulative** | $613 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$905 M cumulative** | $3,018 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $53 M | 4.5% | 40 y, 7 y grace | $3.1 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $159 M | 11.5% | 40 y, 7 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $40 M | — | — | — |
| **Total** | **100%** | **$251 M** | | | **$22 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.4 M / yr + local bonds $18 M / yr = **$21 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Farebox revenue | $30 M / yr | $48 M / yr | $4.9 M / yr |
| Station shop leases | $529 k / yr | $529 k / yr | $529 k / yr |
| Advertising boards | $854 k / yr | $854 k / yr | $854 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX recovery | 498% | 784% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $198 M | 79% of $251 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $317 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $45 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 17,963 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $243 M |
| Timetable-sized dedicated solar CAPEX | $8.2 M |
| **Reconciled project CAPEX** | **$251 M** |
| Imported / external-capital requirement | $53 M (21.0%) |
| Local-content / local-funding requirement | $198 M (79.0%) |
| Default foreign-turnkey external-capital comparison | $452 M; OSR saves $399 M (88.3%) |
| Lifetime external interest and combined financing saving | $500 M interest; $900 M capital + interest |
| 15%–25% planning risk envelope | $289 M–$314 M |
| Annual OPEX | $6.3 M / yr |
| Low/high project NPV at 8% | $-18336 k / $103 M |
| Low/high project IRR | 7.2% / 11.7% |
| Low/high steady-state DSCR | 1.15 / 1.97 |
