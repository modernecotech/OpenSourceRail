...
|---|---|---|---|---|
| line-1 | 12.2 km | 8 | 36 | N Outer ↔ S Mid |
| line-2 |  7.6 km | 5 | 25 | SE Mid ↔ W Outer |
| line-3 |  9.1 km | 6 | 28 | N Mid ↔ W Mid |
| **Total** | **28.9 km** | **19 unique** | **89** | |
...
Aggregate station-rail charging power: **9,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **8.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.9× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 332 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 8.9 MW / 58 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 68 kWh | 139 kWh | 64 kWh | 5.0 km / 28 kWh |
| line-2 | 5 | 43 kWh | 98 kWh | 51 kWh | 2.4 km / 13 kWh |
| line-3 | 6 | 50 kWh | 114 kWh | 59 kWh | 2.1 km / 12 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 8,915 kW @ $700/kW | $6.2 M |
| Grid interconnection / PPA tie-in | 8,915 kW @ $100/kW | $891 k |
| Annual generation proxy | 8.9 MW × 6.5 peak-sun-h/day × 365 d/yr | 21.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$7.1 M** |
...
| Dedicated solar power plant | $7.1 M |
...
|---|---|---|
| Construction (years 1–7) | **$20 M / yr** | $67 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$141 M cumulative** | $469 |
| Lifecycle envelope (yr 1–40, high scenario) | **$141 M cumulative** | $469 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$624 M cumulative** | $2,080 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $249 M | 4.5% | 40 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 20% | $62 M | — | — | — |
| **Total** | **100%** | **$312 M** | | | **$15 M / yr** |
...
| Traction energy (42.4 GWh / yr) | 13,430 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 24.0 GWh/yr + dedicated solar plant 8.9 MW / 21.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $107 k |
| Labour (273 FTE) | driverless roster: OCC/remote 61, station/platform 78, passenger service 38, fleet maintenance 45, infrastructure/energy 30, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$7.6 M / yr** |

_Annual service work: 13,430 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.3 M train-km / yr (10.6 M car-km / yr). On-site PV covers 24.0 GWh/yr and the dedicated solar plant adds 21.2 GWh/yr against 42.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 89 trainsets, 19 stations, 28.9 route-km, 3 lines, and 13,430 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $30 M / yr | $48 M / yr | $5.9 M / yr |
| Station shop leases | $647 k / yr | $647 k / yr | $647 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$7.6 M / yr** |
| Revenue / OPEX recovery | 415% | 650% | 100% |
...
_Commercial-revenue assumptions: 3,328 m² of station shop/kiosk leases at $18/m²/month and 636 advertising boards at $161/board/month, with occupancy derates applied._
...
| Healthcare | 1 healthcare anchors | 8,785 trips/day; 3.2 M access-events/yr | 14,056 trips/day; 5.1 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 29,568 trips/trading day; 9.8 M access-events/yr | 47,309 trips/trading day; 15.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $183 M | 59% of $312 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 16,555 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $7.1 M |
| **Reconciled project CAPEX** | **$312 M** |
| 15%–25% planning risk envelope | $358 M–$389 M |
| Annual OPEX | $7.6 M / yr |
| Low/high project NPV at 8% | $-70273 k / $51 M |
| Low/high project IRR | 5.4% / 9.6% |
| Low/high steady-state DSCR | 1.64 / 2.87 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,287.05 train-km; 7,166.80 kWh consumed; 7,737.99 kWh charged; 38 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,968.96 train-km; 77,784.60 kWh consumed; 79,648.12 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 79.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 2 interchange complexes, 6 civil segments, and 0 input findings |
