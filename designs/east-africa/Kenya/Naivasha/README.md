...
|---|---|---|
| Construction (years 1–7) | **$20 M / yr** | $79 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$137 M cumulative** | $550 |
| Lifecycle envelope (yr 1–40, high scenario) | **$137 M cumulative** | $550 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$609 M cumulative** | $2,437 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $243 M | 4.5% | 40 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 20% | $61 M | — | — | — |
| **Total** | **100%** | **$304 M** | | | **$14 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $11 M / yr = **$11 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $178 M | 58% of $304 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $284 M | retained CAPEX × 1.6 local supplier / wage multiplier |
...
| 15%–25% planning risk envelope | $350 M–$380 M |
| Annual OPEX | $7.4 M / yr |
| Low/high project NPV at 8% | $-65538 k / $55 M |
| Low/high project IRR | 5.5% / 9.8% |
| Low/high steady-state DSCR | 1.67 / 2.93 |
