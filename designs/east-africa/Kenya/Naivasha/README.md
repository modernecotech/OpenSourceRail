...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$466 M (88.1%) of external capital** and **$585 M of external interest**. Capital plus saved interest totals **$1.05 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 81.9%
- Catchment population: **≈ 204,750** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 7.8× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 314 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 18,128 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 101 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 17.8 MW / 116 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 79 kWh | 114 kWh | 28 kWh | 8.3 km / 46 kWh |
| line-2 | 4 | 56 kWh | 90 kWh | 29 kWh | 6.8 km / 38 kWh |
| line-3 | 5 | 83 kWh | 131 kWh | 40 kWh | 4.4 km / 24 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (37.9 km @ $3.0 M/km) | $114 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 17,820 kW @ $700/kW | $12 M |
| Grid interconnection / PPA tie-in | 17,820 kW @ $100/kW | $1.8 M |
| Annual generation proxy | 17.8 MW × 6.5 peak-sun-h/day × 365 d/yr | 42.3 GWh/yr |
...
| Per-capita (city pop) | $1,176 / person |
...
| Residual signalling / train control | $1.9 M | 50% | $975 k | $975 k |
| Charging microgrids | $1.5 M | 40% | $610 k | $915 k |
| EPC / project services | $18 M | 15% | $2.7 M | $16 M |
| **Total city CAPEX** | **$294 M** | **21.4%** | **$63 M** | **$231 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh naivasha`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.4%** | **$63 M** | **$9.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.6%** | **$231 M** | **$33 M / yr** |
| of which planned local bond issuance | 62.9% of total CAPEX | $185 M | $26 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $397 M | $334 M (84.2%) | $419 M | **$753 M** |
| **Default** | 2.00× | $529 M | $466 M (88.1%) | $585 M | **$1.05 bn** |
| High | 3.00× | $794 M | $731 M (92.1%) | $916 M | **$1.65 bn** |

At the default 2.00× case, OSR's $63 M external requirement is 88.1% below the illustrative foreign-company requirement of $529 M; the associated lifetime external-interest saving is $585 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$31 M / yr** | $123 |
| Steady-state, low capacity-use (year 8+) | **$1.6 M / yr** | $7 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $102 |
| Lifecycle envelope (yr 1–40, low scenario) | **$269 M cumulative** | $1,077 |
| Lifecycle envelope (yr 1–40, high scenario) | **$215 M cumulative** | $860 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $4,234 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $63 M | 4.5% | 40 y, 7 y grace | $3.7 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $185 M | 11.5% | 40 y, 7 y grace | $22 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $46 M | — | — | — |
| **Total** | **100%** | **$294 M** | | | **$26 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.8 M / yr + local bonds $21 M / yr = **$24 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (57.2 GWh / yr) | 18,128 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.4 GWh/yr + dedicated solar plant 17.8 MW / 42.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $214 k |
| Labour (259 FTE) | driverless roster: OCC/remote 57, station/platform 60, passenger service 38, fleet maintenance 48, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$7.4 M / yr** |

_Annual service work: 18,128 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.3 M car-km / yr). On-site PV covers 20.4 GWh/yr and the dedicated solar plant adds 42.3 GWh/yr against 57.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 79 trainsets, 14 stations, 39.0 route-km, 3 lines, and 18,128 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 9.9 M |
| Annual paid trips / city resident | 196 | 313 | 40 |
| Farebox revenue | $30 M / yr | $48 M / yr | $6.1 M / yr |
| Station shop leases | $491 k / yr | $491 k / yr | $491 k / yr |
| Advertising boards | $801 k / yr | $801 k / yr | $801 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$7.4 M / yr** |
| Revenue / OPEX recovery | 425% | 670% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.6 M / yr | $0 k / yr | **$26 M / yr** |
| Operating surplus after OPEX (before debt support) | $24 M / yr | $42 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,528 m² of station shop/kiosk leases at $18/m²/month and 488 advertising boards at $161/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $231 M | 79% of $294 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 20,943 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $63 M (21.4%) |
| Local-content / local-funding requirement | $231 M (78.6%) |
| Default foreign-turnkey external-capital comparison | $529 M; OSR saves $466 M (88.1%) |
| Lifetime external interest and combined financing saving | $585 M interest; $1.05 bn capital + interest |
| 15%–25% planning risk envelope | $338 M–$368 M |
| Annual OPEX | $7.4 M / yr |
| Low/high project NPV at 8% | $-57994 k / $63 M |
| Low/high project IRR | 5.8% / 10.1% |
| Low/high steady-state DSCR | 0.94 / 1.64 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,567.92 train-km; 8,730.87 kWh consumed; 8,647.18 kWh charged; 37 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,967.34 train-km; 94,481.72 kWh consumed; 95,566.66 kWh charged; 479 depot services completed (6 active at cutoff); minimum SoC 52%; 0 onboard emergencies; 0 invariant violations; 93.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 41.3% | 93.6% / 90% | pass |
| maximum planning climate/HVAC duty | 27.5% | 93.6% / 90% | pass |
| 50% charging-contact availability | 52.0% | 93.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 88.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.1% | 93.1% / 90% | pass |
...
|---|---|
| ![Naivasha energy and battery simulation dashboard](engineering/screenshots/naivasha-simulation-dashboard.png) | ![Naivasha simulator network visualizer](engineering/screenshots/naivasha-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 14 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![Naivasha QGIS engineering layers](engineering/screenshots/naivasha-qgis-engineering-map.png) | ![Naivasha SUMO timetable validation](engineering/screenshots/naivasha-sumo-validation.png) |
...
scripts/regenerate-city.sh naivasha
```
