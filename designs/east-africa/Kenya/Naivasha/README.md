...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **21,475 – 32,212 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (31.7 km @ $0.85 M/km) | $27 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 33.0 km × $0.015 M/km | $494 k |
...
| Steady-state, low-ridership (year 8+) | **$4.8 M / yr** | $19 |
| Steady-state, high-ridership (year 8+) | **$1.9 M / yr** | $7 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$161 M cumulative** | $644 |
| Lifecycle envelope (yr 1–30, high scenario) | **$93 M cumulative** | $374 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$50 M cumulative** | $201 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $56 M | 4.5% | 30 y, 7 y grace | $3.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $23 M | 11.5% | 30 y, 7 y grace | $2.9 M / yr |
| Government equity (no debt service) | 15% | $14 M | — | — | — |
| **Total** | **100%** | **$93 M** | | | **$6.9 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.5 M / yr + bonds $2.7 M / yr = **$5.2 M / yr** total — plus the equity tranche amortised across construction ($2.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
