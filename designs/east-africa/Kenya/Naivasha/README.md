...
| Revenue fleet | 102 × 2-car trainsets |
...
|---|---|---|---|---|
| line-1 | 14.2 km | 8 | 41 | NW Outer ↔ S Outer |
| line-2 | 10.0 km | 6 | 30 | S Outer ↔ NE Inner |
| line-3 | 14.9 km | 8 | 42 | SE Outer ↔ NW Outer |
| **Total** | **39.0 km** | **22 unique** | **113** | |
...
- **Revenue fleet simultaneous capacity:** 102 × 240 = **24,480 AW2 passengers** (32,640 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **15.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Dedicated solar plant | 15.1 MW / 98 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 79 kWh | 147 kWh | 60 kWh | 3.2 km / 18 kWh |
| line-2 | 6 | 56 kWh | 114 kWh | 53 kWh | 2.4 km / 14 kWh |
| line-3 | 7 | 83 kWh | 139 kWh | 48 kWh | 4.0 km / 22 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 15,060 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 15,060 kW @ $100/kW | $1.5 M |
| Annual generation proxy | 15.1 MW × 6.5 peak-sun-h/day × 365 d/yr | 35.7 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$23 M / yr** | $90 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$158 M cumulative** | $631 |
| Lifecycle envelope (yr 1–40, high scenario) | **$158 M cumulative** | $631 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$699 M cumulative** | $2,795 |
...
| Traction energy (57.2 GWh / yr) | 18,128 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 15.1 MW / 35.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $181 k |
| Labour (304 FTE) | driverless roster: OCC/remote 73, station/platform 76, passenger service 38, fleet maintenance 58, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$8.7 M / yr** |

_Annual service work: 18,128 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.3 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 35.7 GWh/yr against 57.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 113 trainsets, 22 stations, 39.0 route-km, 3 lines, and 18,128 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 11.5 M |
| Annual paid trips / city resident | 196 | 313 | 46 |
| Farebox revenue | $30 M / yr | $48 M / yr | $7.0 M / yr |
| Station shop leases | $603 k / yr | $603 k / yr | $603 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$8.7 M / yr** |
| Revenue / OPEX recovery | 365% | 573% | 100% |
...
_Commercial-revenue assumptions: 3,104 m² of station shop/kiosk leases at $18/m²/month and 616 advertising boards at $161/board/month, with occupancy derates applied._
...
| Commerce | 9 major/terminal/interchange nodes | 27,180 trips/trading day; 9.0 M access-events/yr | 43,487 trips/trading day; 14.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $203 M | 58% of $349 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 18,355 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $337 M |
...
| Low/high project NPV at 8% | $-105434 k / $15 M |
| Low/high project IRR | 4.3% / 8.5% |
| Low/high steady-state DSCR | 1.40 / 2.50 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,671.51 train-km; 9,307.64 kWh consumed; 9,688.46 kWh charged; 34 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,820.34 train-km; 104,799.18 kWh consumed; 107,116.11 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 69%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 62.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 62.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 68.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 68.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
