...
| Bucket | Value |
|---|---|
| At-grade (31.7 km @ €3.5 M/km) | €111 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 33.0 km × €0.015 M/km | €0.5 M |
...
| Per-capita (city pop) | €1,476 / person |
...
|---|---|---|
| Construction (years 1–7) | **€28 M / yr** | €114 |
| Steady-state, low-ridership (year 8+) | **€35 M / yr** | €140 |
| Steady-state, high-ridership (year 8+) | **€33 M / yr** | €134 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.00 bn cumulative** | €4,019 |
| Lifecycle envelope (yr 1–30, high scenario) | **€968 M cumulative** | €3,871 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€7.8 M / yr (low) → €6.2 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €221 M | 4.5% | 30 y, 7 y grace | €16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €92 M | 11.5% | 30 y, 7 y grace | €12 M / yr |
| Government equity (no debt service) | 15% | €55 M | — | — | — |
| **Total** | **100%** | **€369 M** | | | **€27 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €10.0 M / yr + bonds €11 M / yr = **€21 M / yr** total — plus the equity tranche amortised across construction (€7.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (210 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €747 k |
...
| Operating shortfall (gov subsidy required) | €7.8 M / yr | €6.2 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€35 M / yr** | **€33 M / yr** |
