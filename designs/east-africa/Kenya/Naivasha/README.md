...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$434 M (87.9%) of external capital** and **$544 M of external interest**. Capital plus saved interest totals **$978 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (37.9 km @ $2.58 M/km) | $98 M |
...
| Per-capita (city pop) | $1,098 / person |
...
| **Total city CAPEX** | **$274 M** | **21.8%** | **$60 M** | **$215 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.8%** | **$60 M** | **$8.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.2%** | **$215 M** | **$31 M / yr** |
| of which planned local bond issuance | 62.6% of total CAPEX | $172 M | $25 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $370 M | $311 M (83.8%) | $389 M | **$700 M** |
| **Default** | 2.00× | $494 M | $434 M (87.9%) | $544 M | **$978 M** |
| High | 3.00× | $741 M | $681 M (91.9%) | $854 M | **$1.53 bn** |

At the default 2.00× case, OSR's $60 M external requirement is 87.9% below the illustrative foreign-company requirement of $494 M; the associated lifetime external-interest saving is $544 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $114 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $95 |
| Lifecycle envelope (yr 1–40, low scenario) | **$200 M cumulative** | $800 |
| Lifecycle envelope (yr 1–40, high scenario) | **$200 M cumulative** | $800 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$986 M cumulative** | $3,944 |
...
| Local-currency sovereign / project bonds for local content | 63% | $172 M | 11.5% | 40 y, 7 y grace | $20 M / yr |
...
| Annual paid trips | 48.9 M | 78.2 M | 9.3 M |
| Annual paid trips / city resident | 196 | 313 | 37 |
| Farebox revenue | $30 M / yr | $48 M / yr | $5.7 M / yr |
| Station shop leases | $491 k / yr | $491 k / yr | $491 k / yr |
| Advertising boards | $801 k / yr | $801 k / yr | $801 k / yr |
| **Total revenue** | **$31 M / yr** | **$49 M / yr** | **$7.0 M / yr** |
| Revenue / OPEX recovery | 447% | 705% | 100% |
...
| Construction-phase local economic activity | $343 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $49 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 19,436 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $60 M (21.8%) |
| Local-content / local-funding requirement | $215 M (78.2%) |
| Default foreign-turnkey external-capital comparison | $494 M; OSR saves $434 M (87.9%) |
| Lifetime external interest and combined financing saving | $544 M interest; $978 M capital + interest |
| 15%–25% planning risk envelope | $316 M–$343 M |
| Annual OPEX | $7.0 M / yr |
| Low/high project NPV at 8% | $-40977 k / $80 M |
| Low/high project IRR | 6.3% / 10.7% |
| Low/high steady-state DSCR | 1.02 / 1.77 |
