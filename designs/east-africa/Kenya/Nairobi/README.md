...
|---|---:|---:|---:|---:|
| Civil works | $1.85 bn | 35% | $649 M | $1.21 bn |
| Stations | $722 M | 40% | $289 M | $433 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $1.33 bn | 55% | $730 M | $597 M |
| Dedicated solar plant | $1.01 bn | 70% | $706 M | $303 M |
| Residual signalling / train control | $25 M | 80% | $20 M | $5.1 M |
| Charging microgrids | $54 M | 55% | $30 M | $24 M |
| EPC / project services | $279 M | 45% | $126 M | $154 M |
| **Total city CAPEX** | **$5.28 bn** | **48.4%** | **$2.55 bn** | **$2.73 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **48.4%** | **$2.55 bn** | **$365 M / yr** |
| **Local capital for domestic procurement / payroll** | **51.6%** | **$2.73 bn** | **$389 M / yr** |
| of which planned local bond issuance | 41.3% of total CAPEX | $2.18 bn | $312 M / yr |
...
|---|---|---|
| Construction (years 1–7) | **$444 M / yr** | $78 |
| Steady-state, low capacity-use (year 8+) | **$271 M / yr** | $47 |
| Steady-state, high capacity-use (year 8+) | **$118 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$408 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$12.04 bn cumulative** | $2,112 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.99 bn cumulative** | $1,227 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$16.56 bn cumulative** | $2,906 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 48% | $2.55 bn | 4.5% | 40 y, 7 y grace | $150 M / yr |
| Local-currency sovereign / project bonds for local content | 41% | $2.18 bn | 11.5% | 40 y, 7 y grace | $258 M / yr |
| Local government equity / other domestic funding (no debt service) | 10% | $545 M | — | — | — |
| **Total** | **100%** | **$5.28 bn** | | | **$408 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $115 M / yr + local bonds $251 M / yr = **$366 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($78 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $408 M / yr | $408 M / yr | **$408 M / yr** |
| Operating surplus applied to debt support | -$137 M / yr | -$290 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $271 M / yr | $118 M / yr | **$408 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.73 bn | 52% of $5.28 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 246,925 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $2.55 bn (48.4%) |
| Local-content / local-funding requirement | $2.73 bn (51.6%) |
...
| Low/high steady-state DSCR | 0.34 / 0.71 |
