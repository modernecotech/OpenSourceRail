...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 4740 | $60 k | $284 M |
| High sensitivity check | 4740 | $120 k | $569 M |
...
| EPC integration + project management (7%) | on subtotal | $299 M |
...
|---|---|---|
| Construction (years 1–7) | **$360 M / yr** | $63 |
| Steady-state, low capacity-use (year 8+) | **$125 M / yr** | $22 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$262 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.66 bn cumulative** | $1,168 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.52 bn cumulative** | $443 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$11.18 bn cumulative** | $1,962 |

_Population basis: 5,700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $137 M / yr → $262 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $4.47 bn | 4.5% | 40 y, 7 y grace | $262 M / yr |
| Government equity (no debt service) | 20% | $1.12 bn | — | — | — |
| **Total** | **100%** | **$5.58 bn** | | | **$262 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $201 M / yr = **$201 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($160 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $262 M / yr | $262 M / yr | **$262 M / yr** |
| Operating surplus applied to debt support | -$137 M / yr | -$262 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $125 M / yr | $0 k / yr | **$262 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.95 bn | 53% of $5.58 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.72 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $674 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 267,238 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $4.57 bn |
| Timetable-sized dedicated solar CAPEX | $1.01 bn |
| **Reconciled project CAPEX** | **$5.58 bn** |
| 15%–25% planning risk envelope | $6.42 bn–$6.98 bn |
| Annual OPEX | $129 M / yr |
| Low/high project NPV at 8% | $-3230773 k / $-2203559 k |
| Low/high project IRR | -1.0% / 2.9% |
| Low/high steady-state DSCR | 0.52 / 1.11 |
