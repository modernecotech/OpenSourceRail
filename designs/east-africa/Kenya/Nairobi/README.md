...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **609,900 – 1,097,820 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$214 M / yr** | $38 |
| Steady-state, low-ridership (year 8+) | **$306 M / yr** | $54 |
| Steady-state, high-ridership (year 8+) | **$197 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$184 M / yr** | $32 |
| Lifecycle envelope (yr 1–40, low scenario) | **$11.59 bn cumulative** | $2,034 |
| Lifecycle envelope (yr 1–40, high scenario) | **$7.99 bn cumulative** | $1,402 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.57 bn cumulative** | $1,327 |

_Population basis: 5,700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $122 M / yr → $13 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $3.53 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $4.41 bn | 2.0% | 40 y, 7 y grace | $184 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 11.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $882 M | — | — | — |
| **Total** | **100%** | **$8.82 bn** | | | **$184 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $88 M / yr + fallback bonds $0 k / yr = **$88 M / yr** total. The $3.53 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($126 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (2654.0 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (2,869 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $11 M |
| **OPEX subtotal** | | **$272 M / yr** |

_Annual fleet utilisation: 563 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 110.6 M train-km / yr (~196 k km / trainset / yr)._
...
Planning ridership bracket = 25-45% of catchment × 365 service-days at the operating-neutral fare, capped by practical service capacity (1,843,200 trips/day). The operating-neutral column solves annual paid trips so **farebox + station-shop leases + advertising = steady-state OPEX**. Post-grace repayable-debt service remains a capital-funding obligation in the government commitment table above.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Daily paid trips | 609,900 | 1,097,820 | 1,155,017 |
| Daily paid trips / catchment | 25% | 45% | 47% |
| Daily paid trips / city population | 11% | 19% | 20% |
| Annual paid trips | 222.6 M | 400.7 M | 421.6 M |
| Farebox revenue | $137 M / yr | $246 M / yr | $259 M / yr |
| Station shop leases | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| Advertising boards | $8.5 M / yr | $8.5 M / yr | $8.5 M / yr |
| **Total revenue** | **$150 M / yr** | **$260 M / yr** | **$272 M / yr** |
| Revenue / OPEX recovery | 55% | 95% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov repayable-debt service + residual OPEX subsidy | $306 M / yr | $197 M / yr | **$184 M / yr** |
