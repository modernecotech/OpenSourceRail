...
| Residual train-control wayside + power | €386 M |
...
|---|---|---|
| Construction (years 1–7) | **€450 M / yr** | €79 |
| Steady-state, low-ridership (year 8+) | **€550 M / yr** | €97 |
| Steady-state, high-ridership (year 8+) | **€514 M / yr** | €90 |
| Lifecycle envelope (yr 1–30, low scenario) | **€15.81 bn cumulative** | €2,773 |
| Lifecycle envelope (yr 1–30, high scenario) | **€14.96 bn cumulative** | €2,625 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €3.50 bn | 4.5% | 30 y, 7 y grace | €247 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €1.46 bn | 11.5% | 30 y, 7 y grace | €183 M / yr |
| Government equity (no debt service) | 15% | €875 M | — | — | — |
| **Total** | **100%** | **€5.83 bn** | | | **€430 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €157 M / yr + bonds €168 M / yr = **€325 M / yr** total — plus the equity tranche amortised across construction (€125 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€550 M / yr** | **€514 M / yr** |
