...
| Revenue fleet | 910 × 6-car trainsets |
| Revenue fleet passenger capacity | 655,200 AW2 pax (873,600 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 96 × 6-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 87 planned-maintenance spares and 9 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 57.9 km | 30 | 136 | NE Outer ↔ SW Mid |
| line-2 | 54.5 km | 29 | 131 | E Outer ↔ W Mid |
| line-3 | 52.2 km | 26 | 122 | N Mid ↔ SE Outer |
| line-4 | 32.5 km | 18 | 83 | E Mid ↔ W Mid |
| line-5 | 46.1 km | 23 | 107 | NE Mid ↔ SW Outer |
| line-6 | 59.9 km | 29 | 136 | SE Outer ↔ NW Outer |
| line-7 | 53.9 km | 28 | 126 | NW Outer ↔ SE Mid |
| line-8 | 43.6 km | 21 | 103 | SW Mid ↔ N Mid |
| line-9 | 105.1 km | 61 | 62 | W Mid ↔ W Mid |
| **Total** | **505.8 km** | **265 unique** | **1006** | |
...
| Revenue fleet capacity | 655,200 AW2 pax (873,600 AW3 crush) |
| Total fleet capacity | 724,320 AW2 pax (965,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 910 × 720 = **655,200 AW2 passengers** (873,600 AW3 crush)
- **Total fleet passenger capacity:** 1006 × 720 = **724,320 AW2 passengers** (965,760 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **219** | **70,400 kW** | **476,000 kWh** |

Aggregate station-rail charging power: **438,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **1,227.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 482 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 338 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 5,125 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 1,227.8 MW / 5,893 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 476 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 24 | 867 kWh | 1,633 kWh | 680 kWh | 16.1 km / 241 kWh |
| line-2 | 26 | 816 kWh | 1,764 kWh | 866 kWh | 12.0 km / 180 kWh |
| line-3 | 21 | 782 kWh | 1,437 kWh | 577 kWh | 15.3 km / 229 kWh |
| line-4 | 18 | 487 kWh | 1,241 kWh | 705 kWh | 2.0 km / 30 kWh |
| line-5 | 18 | 690 kWh | 1,241 kWh | 482 kWh | 14.0 km / 209 kWh |
| line-6 | 21 | 898 kWh | 1,470 kWh | 483 kWh | 15.7 km / 235 kWh |
| line-7 | 22 | 808 kWh | 1,503 kWh | 614 kWh | 18.2 km / 273 kWh |
| line-8 | 18 | 653 kWh | 1,241 kWh | 523 kWh | 11.2 km / 168 kWh |
| line-9 | 51 | 1,574 kWh | 3,332 kWh | 1,601 kWh | 8.4 km / 125 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (474.3 km @ $3.0 M/km) | $1.42 bn |
| Elevated (31.5 km @ $12.0 M/km) | $378 M |
| Elevated-interchange premium (22 sites @ $4.50 M) | $99 M |
| **Civil subtotal** | **$1.90 bn** |
...
|---|---|---|---|
| `halt` | 46 | $600 k | $28 M |
| `standard` | 130 | $2.50 M | $325 M |
| `major` | 6 | $4.50 M | $27 M |
| `terminal` | 15 | $4.50 M | $68 M |
| `depot-terminal` | 1 | $5.0 M | $5.0 M |
| `interchange` | 2 | $8.0 M | $16 M |
| `interchange-elevated` | 65 | $12.0 M | $780 M |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 1006 | $1.68 M | $1.69 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 6036 | $60 k | $362 M |
| High sensitivity check | 6036 | $120 k | $724 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 1,227,796 kW @ $700/kW | $859 M |
| Grid interconnection / PPA tie-in | 1,227,796 kW @ $100/kW | $123 M |
| Annual generation proxy | 1,227.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 2,151.1 GWh/yr |
| **Dedicated solar plant subtotal** | | **$982 M** |
...
| EPC integration + project management (7%) | on subtotal | $373 M |
...
| Stations | $1.25 bn |
| Depots | $8.0 M |
| Rolling stock | $1.69 bn |
| Railway production plant | $362 M |
| Dedicated solar power plant | $982 M |
| Residual train-control wayside + charging microgrids | $120 M |
| EPC overhead (7%) | $373 M |
| **CAPEX total** | **$6.68 bn** |
| Per-route-km | $13 M / km |
| Per-capita (city pop) | $1,172 / person |
...
|---|---|---|
| Construction (years 1–7) | **$432 M / yr** | $76 |
| Steady-state, low capacity-use (year 8+) | **$197 M / yr** | $35 |
| Steady-state, high capacity-use (year 8+) | **$44 M / yr** | $8 |
| Steady-state, operating-neutral revenue case | **$314 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.51 bn cumulative** | $1,669 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.47 bn cumulative** | $783 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$13.39 bn cumulative** | $2,348 |

_Population basis: 5,700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $117 M / yr → $270 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $5.35 bn | 4.5% | 40 y, 7 y grace | $314 M / yr |
| Government equity (no debt service) | 20% | $1.34 bn | — | — | — |
| **Total** | **100%** | **$6.68 bn** | | | **$314 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $241 M / yr = **$241 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($191 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (1993.9 GWh / yr) | 210,750 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 123.3 GWh/yr + dedicated solar plant 1227.8 MW / 2151.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $15 M |
| Labour (2,720 FTE) | driverless roster: OCC/remote 507, station/platform 944, passenger service 231, fleet maintenance 579, infrastructure/energy 426, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $11 M |
| **OPEX subtotal** | | **$157 M / yr** |

_Annual service work: 210,750 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 83.1 M train-km / yr (498.5 M car-km / yr). On-site PV covers 123.3 GWh/yr and the dedicated solar plant adds 2151.1 GWh/yr against 1993.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 1006 trainsets, 265 stations, 505.8 route-km, 9 lines, and 210,750 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 224.1 M |
| Annual paid trips / city resident | 73 | 117 | 39 |
| Farebox revenue | $255 M / yr | $408 M / yr | $137 M / yr |
| Station shop leases | $7.7 M / yr | $7.7 M / yr | $7.7 M / yr |
| Advertising boards | $12 M / yr | $12 M / yr | $12 M / yr |
| **Total revenue** | **$275 M / yr** | **$428 M / yr** | **$157 M / yr** |
| Revenue / OPEX recovery | 175% | 272% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gross repayable-debt service + residual OPEX subsidy | $314 M / yr | $314 M / yr | **$314 M / yr** |
| Operating surplus applied to debt support | -$117 M / yr | -$270 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $197 M / yr | $44 M / yr | **$314 M / yr** |
| Operating surplus after OPEX (before debt support) | $117 M / yr | $270 M / yr | $0 / yr |

_Commercial-revenue assumptions: 39,560 m² of station shop/kiosk leases at $18/m²/month and 7,380 advertising boards at $161/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $122 M / yr | $195 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$462 M / yr** | **$740 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 29 education anchors | 71,182 trips/school day; 15.7 M access-events/yr | 113,891 trips/school day; 25.1 M access-events/yr |
| Healthcare | 34 healthcare anchors | 91,688 trips/day; 33.5 M access-events/yr | 146,701 trips/day; 53.5 M access-events/yr |
| Commerce | 89 major/terminal/interchange nodes | 222,273 trips/trading day; 73.4 M access-events/yr | 355,637 trips/trading day; 117.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.57 bn | 53% of $6.68 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.71 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $816 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 323,196 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $5.70 bn |
| Timetable-sized dedicated solar CAPEX | $982 M |
| **Reconciled project CAPEX** | **$6.68 bn** |
| 15%–25% planning risk envelope | $7.69 bn–$8.35 bn |
| Annual OPEX | $157 M / yr |
| Low/high project NPV at 8% | $-4181952 k / $-3154739 k |
| Low/high project IRR | -2.5% / 1.5% |
| Low/high steady-state DSCR | 0.37 / 0.86 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 11,764.60 train-km; 176,184.63 kWh consumed; 178,783.92 kWh charged; 10 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 213,578.20 train-km; 3,198,511.08 kWh consumed; 3,257,692.50 kWh charged; 1,588 depot services completed; minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 50.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 42.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 60.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.9% / 60% | pass |
| ten-hour single charging-pad outage | 60.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 265 line platforms, 23 interchange complexes, 151 civil segments, and 0 input findings |
