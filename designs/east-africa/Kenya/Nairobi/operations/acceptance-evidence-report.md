...
| Item | Count / Status |
|---|---:|
| Assets in register | 2,459 |
| Manufacturing schedule rows | 9,152 |
| Manufacturing material/BOM rows | 133,922 |
| Manufacturing QA verification rows | 9,152 |
| Construction QA action rows | 8,436 |
| Maintenance handover schedule rows | 11,024 |
| Manufacturing rows with material refs | 9,152 / 9,152 |
| Manufacturing rows with verification refs | 9,152 / 9,152 |
| Manufacturing rows linked to QA actions | 9,152 / 9,152 |
...
|---|---:|
| `project_kit` | 16,220 |
| `rolling_stock_bom` | 110,660 |
| `rolling_stock_cots_fitout` | 7,042 |
...
| `qa-10-carbody-structure` | 2,012 |
| `qa-11-bogie-wheelset` | 1,006 |
| `qa-12-traction-brake-battery` | 1,006 |
| `qa-13-passenger-systems` | 1,006 |
| `qa-15-first-article-trainset` | 1,006 |
| `qa-20-survey-geotech` | 256 |
| `qa-21-earthworks-drainage` | 256 |
| `qa-22-trackform-rail` | 590 |
| `qa-24-stations-depots-plant` | 532 |
| `qa-25-power-energy` | 439 |
| `qa-26-wayside-comms-safety` | 1,042 |
