...
| Bucket | Value |
|---|---|
| At-grade (40.5 km @ €3.5 M/km) | €142 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 58 | €2.0 M | €116 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 42.4 km × €0.015 M/km | €0.6 M |
...
| Per-capita (city pop) | €1,466 / person |
...
|---|---|---|
| Construction (years 1–7) | **€34 M / yr** | €113 |
| Steady-state, low-ridership (year 8+) | **€42 M / yr** | €139 |
| Steady-state, high-ridership (year 8+) | **€40 M / yr** | €133 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.20 bn cumulative** | €3,997 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.15 bn cumulative** | €3,849 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€9.4 M / yr (low) → €7.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €264 M | 4.5% | 30 y, 7 y grace | €19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €110 M | 11.5% | 30 y, 7 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €66 M | — | — | — |
| **Total** | **100%** | **€440 M** | | | **€32 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €12 M / yr + bonds €13 M / yr = **€25 M / yr** total — plus the equity tranche amortised across construction (€9.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (266 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €946 k |
...
| Operating shortfall (gov subsidy required) | €9.4 M / yr | €7.5 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€42 M / yr** | **€40 M / yr** |
