...
| Revenue fleet | 112 × 2-car trainsets |
| Revenue fleet passenger capacity | 26,880 AW2 pax (35,840 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 13.6 km | 8 | 40 | W Mid ↔ SE Mid |
| line-2 | 15.4 km | 9 | 45 | NE Outer ↔ W Mid |
| line-3 | 13.1 km | 9 | 40 | NW Mid ↔ S Outer |
| **Total** | **42.2 km** | **26 unique** | **125** | |
...
| Revenue fleet capacity | 26,880 AW2 pax (35,840 AW3 crush) |
| Total fleet capacity | 30,000 AW2 pax (40,000 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 112 × 240 = **26,880 AW2 passengers** (35,840 AW3 crush)
- **Total fleet passenger capacity:** 125 × 240 = **30,000 AW2 passengers** (40,000 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 24.9× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 346 kWh usable margin across the worst powered-stop gap (line-2) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 68 kWh | 147 kWh | 72 kWh | 2.4 km / 12 kWh |
| line-2 | 9 | 77 kWh | 172 kWh | 87 kWh | 2.9 km / 14 kWh |
| line-3 | 9 | 66 kWh | 163 kWh | 91 kWh | 2.2 km / 11 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 125 | $560 k | $70 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 250 | $60 k | $15 M |
| High sensitivity check | 250 | $120 k | $30 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 26,209 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 26,209 kW @ $100/kW | $2.6 M |
...
| Per-capita (city pop) | $1,403 / person |
...
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$190 M cumulative** | $634 |
| Lifecycle envelope (yr 1–40, high scenario) | **$190 M cumulative** | $634 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$843 M cumulative** | $2,809 |
...
| Traction energy (61.8 GWh / yr) | 19,606 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.9 GWh/yr + dedicated solar plant 26.2 MW / 45.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $315 k |
| Labour (343 FTE) | driverless roster: OCC/remote 77, station/platform 102, passenger service 38, fleet maintenance 64, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 19,606 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.7 M train-km / yr (15.5 M car-km / yr). On-site PV covers 21.9 GWh/yr and the dedicated solar plant adds 45.9 GWh/yr against 61.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 125 trainsets, 26 stations, 42.2 route-km, 3 lines, and 19,606 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 13.1 M |
| Annual paid trips / city resident | 163 | 261 | 44 |
...
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 315% | 491% | 100% |
...
_Commercial-revenue assumptions: 4,336 m² of station shop/kiosk leases at $18/m²/month and 828 advertising boards at $161/board/month, with occupancy derates applied._
...
| Healthcare | 1 healthcare anchors | 8,738 trips/day; 3.2 M access-events/yr | 13,981 trips/day; 5.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $243 M | 58% of $421 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,984 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-165436 k / $-44587 k |
| Low/high project IRR | 2.9% / 6.8% |
| Low/high steady-state DSCR | 1.11 / 2.02 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,755.79 train-km; 8,765.65 kWh consumed; 9,645.79 kWh charged; 33 depot services completed; minimum SoC 92%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,330.15 train-km; 101,496.52 kWh consumed; 104,188.86 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 87.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 82.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 89.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 82.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 16 civil segments, and 0 input findings |
