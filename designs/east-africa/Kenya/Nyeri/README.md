...
| Revenue fleet | 98 × 2-car trainsets |
...
|---|---|---|---|---|
| line-1 | 10.4 km | 7 | 32 | E Mid ↔ W Mid |
| line-2 | 15.1 km | 9 | 43 | NE Outer ↔ S Outer |
| line-3 | 11.2 km | 7 | 34 | SW Outer ↔ N Mid |
| **Total** | **36.7 km** | **23 unique** | **109** | |
...
| Total fleet capacity | 26,160 AW2 pax (34,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 98 × 240 = **23,520 AW2 passengers** (31,360 AW3 crush)
- **Total fleet passenger capacity:** 109 × 240 = **26,160 AW2 passengers** (34,880 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **11,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **22.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 15.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 337 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 69 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 93 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 22.3 MW / 107 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 52 kWh | 131 kWh | 74 kWh | 2.3 km / 12 kWh |
| line-2 | 8 | 75 kWh | 155 kWh | 72 kWh | 4.7 km / 23 kWh |
| line-3 | 7 | 56 kWh | 131 kWh | 69 kWh | 2.5 km / 13 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 109 | $560 k | $61 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 218 | $60 k | $13 M |
| High sensitivity check | 218 | $120 k | $26 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 22,311 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 22,311 kW @ $100/kW | $2.2 M |
| Annual generation proxy | 22.3 MW × 4.8 peak-sun-h/day × 365 d/yr | 39.1 GWh/yr |
...
| Per-capita (city pop) | $1,848 / person |
...
|---|---|---|
| Construction (years 1–7) | **$30 M / yr** | $119 |
| Steady-state, low capacity-use (year 8+) | **$622 k / yr** | $2 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $87 |
| Lifecycle envelope (yr 1–40, low scenario) | **$229 M cumulative** | $918 |
| Lifecycle envelope (yr 1–40, high scenario) | **$209 M cumulative** | $836 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$926 M cumulative** | $3,702 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $22 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $370 M | 4.5% | 40 y, 7 y grace | $22 M / yr |
...
| Traction energy (53.8 GWh / yr) | 17,056 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 19.8 GWh/yr + dedicated solar plant 22.3 MW / 39.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $268 k |
| Labour (317 FTE) | driverless roster: OCC/remote 73, station/platform 93, passenger service 38, fleet maintenance 56, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 17,056 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.7 M train-km / yr (13.4 M car-km / yr). On-site PV covers 19.8 GWh/yr and the dedicated solar plant adds 39.1 GWh/yr against 53.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 109 trainsets, 23 stations, 36.7 route-km, 3 lines, and 17,056 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $30 M / yr | $48 M / yr | $8.9 M / yr |
| Station shop leases | $717 k / yr | $717 k / yr | $717 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 296% | 463% | 100% |
...
| Operating surplus applied to debt support | -$21 M / yr | -$22 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $622 k / yr | $0 k / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $39 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,688 m² of station shop/kiosk leases at $18/m²/month and 708 advertising boards at $161/board/month, with occupancy derates applied._
...
| Healthcare | 5 healthcare anchors | 13,149 trips/day; 4.8 M access-events/yr | 21,038 trips/day; 7.7 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 28,764 trips/trading day; 9.5 M access-events/yr | 46,022 trips/trading day; 15.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $274 M | 59% of $462 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $438 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $63 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 24,796 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $531 M–$578 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-201985 k / $-81136 k |
| Low/high project IRR | 2.2% / 6.0% |
| Low/high steady-state DSCR | 0.97 / 1.80 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,572.87 train-km; 7,852.42 kWh consumed; 8,573.32 kWh charged; 35 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,708.75 train-km; 88,409.37 kWh consumed; 90,747.29 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 86.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 76.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 88.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
