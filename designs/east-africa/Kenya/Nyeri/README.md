...
| Per-capita (city pop) | $2,246 / person |
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $173 |
| Steady-state, low-ridership (year 8+) | **$49 M / yr** | $195 |
| Steady-state, high-ridership (year 8+) | **$46 M / yr** | $182 |
| Steady-state, operating-neutral revenue case | **$41 M / yr** | $166 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.42 bn cumulative** | $5,696 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.35 bn cumulative** | $5,408 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.26 bn cumulative** | $5,022 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.3 M / yr → $4.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $337 M | 4.5% | 30 y, 7 y grace | $24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $140 M | 11.5% | 30 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 15% | $84 M | — | — | — |
| **Total** | **100%** | **$562 M** | | | **$41 M / yr** |
