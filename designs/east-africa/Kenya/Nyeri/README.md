...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$670 M (88.9%) of external capital** and **$840 M of external interest**. Capital plus saved interest totals **$1.51 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Onboard battery adequacy | 12.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 330 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 41 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 17,056 train-km/day | One-way train journeys × route length |
| Annual service work | 6.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 147 MWh/day | 13.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 102 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 24.4 MW / 117 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 52 kWh | 98 kWh | 41 kWh | 3.0 km / 15 kWh |
| line-2 | 6 | 75 kWh | 139 kWh | 56 kWh | 6.0 km / 30 kWh |
| line-3 | 5 | 56 kWh | 110 kWh | 49 kWh | 4.3 km / 22 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (23.2 km @ $3.0 M/km) | $70 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 24,381 kW @ $700/kW | $17 M |
| Grid interconnection / PPA tie-in | 24,381 kW @ $100/kW | $2.4 M |
| Annual generation proxy | 24.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 42.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 36.7 km × $0.050 M/km | $1.8 M |
...
| Per-capita (city pop) | $1,674 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $231 M | 15% | $35 M | $197 M |
...
| Residual signalling / train control | $1.8 M | 50% | $917 k | $917 k |
| Charging microgrids | $1.8 M | 40% | $700 k | $1.1 M |
| EPC / project services | $26 M | 15% | $3.9 M | $22 M |
| **Total city CAPEX** | **$419 M** | **19.9%** | **$83 M** | **$335 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh nyeri`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **19.9%** | **$83 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **80.1%** | **$335 M** | **$48 M / yr** |
| of which planned local bond issuance | 64.1% of total CAPEX | $268 M | $38 M / yr |
| **Total city programme** | **100.0%** | **$419 M** | **$60 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $565 M | $482 M (85.2%) | $604 M | **$1.09 bn** |
| **Default** | 2.00× | $753 M | $670 M (88.9%) | $840 M | **$1.51 bn** |
| High | 3.00× | $1.13 bn | $1.05 bn (92.6%) | $1.31 bn | **$2.36 bn** |

At the default 2.00× case, OSR's $83 M external requirement is 88.9% below the illustrative foreign-company requirement of $753 M; the associated lifetime external-interest saving is $840 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$44 M / yr** | $177 |
| Steady-state, low capacity-use (year 8+) | **$15 M / yr** | $58 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$37 M / yr** | $146 |
| Lifecycle envelope (yr 1–40, low scenario) | **$791 M cumulative** | $3,163 |
| Lifecycle envelope (yr 1–40, high scenario) | **$309 M cumulative** | $1,237 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.52 bn cumulative** | $6,069 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $37 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 20% | $83 M | 4.5% | 40 y, 7 y grace | $4.9 M / yr |
| Local-currency sovereign / project bonds for local content | 64% | $268 M | 11.5% | 40 y, 7 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $67 M | — | — | — |
| **Total** | **100%** | **$419 M** | | | **$37 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.8 M / yr + local bonds $31 M / yr = **$35 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (53.8 GWh / yr) | 17,056 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.6 GWh/yr + dedicated solar plant 24.4 MW / 42.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $293 k |
| Labour (282 FTE) | driverless roster: OCC/remote 57, station/platform 86, passenger service 38, fleet maintenance 46, infrastructure/energy 34, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$9.7 M / yr** |

_Annual service work: 17,056 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.7 M train-km / yr (13.4 M car-km / yr). On-site PV covers 16.6 GWh/yr and the dedicated solar plant adds 42.7 GWh/yr against 53.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 76 trainsets, 16 stations, 36.7 route-km, 3 lines, and 17,056 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 13.0 M |
| Annual paid trips / city resident | 196 | 313 | 52 |
| Farebox revenue | $30 M / yr | $48 M / yr | $8.0 M / yr |
| Station shop leases | $682 k / yr | $682 k / yr | $682 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$9.7 M / yr** |
| Revenue / OPEX recovery | 327% | 512% | 100% |
...
| Operating surplus applied to debt support | -$22 M / yr | -$37 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $15 M / yr | $0 k / yr | **$37 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $40 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,512 m² of station shop/kiosk leases at $18/m²/month and 648 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $6.5 M / yr | $10 M / yr | 81 M - 129 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.2 M / yr | $1.9 M / yr | 14.5–23.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$45 M / yr** | **$73 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 13 major/terminal/interchange nodes | 32,852 trips/trading day; 10.8 M access-events/yr | 52,564 trips/trading day; 17.3 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,522 trips/activity day; 4.4 M access-events/yr | 23,235 trips/activity day; 7.0 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $335 M | 80% of $419 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $536 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $77 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 30,358 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $83 M (19.9%) |
| Local-content / local-funding requirement | $335 M (80.1%) |
| Default foreign-turnkey external-capital comparison | $753 M; OSR saves $670 M (88.9%) |
| Lifetime external interest and combined financing saving | $840 M interest; $1.51 bn capital + interest |
| 15%–25% planning risk envelope | $481 M–$523 M |
| Annual OPEX | $9.7 M / yr |
| Low/high project NPV at 8% | $-163411 k / $-42563 k |
| Low/high project IRR | 3.0% / 6.9% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,546.88 train-km; 7,722.72 kWh consumed; 8,134.75 kWh charged; 36 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,419.57 train-km; 81,973.77 kWh consumed; 83,505.14 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 74%; 0 onboard emergencies; 0 invariant violations; 96.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 68.9% | 96.3% / 90% | pass |
| maximum planning climate/HVAC duty | 58.6% | 96.3% / 90% | pass |
| 50% charging-contact availability | 74.1% | 96.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.5% / 60% | pass |
| ten-hour single charging-pad outage | 27.5% | 96.3% / 90% | pass |
...
|---|---|
| ![Nyeri energy and battery simulation dashboard](engineering/screenshots/nyeri-simulation-dashboard.png) | ![Nyeri simulator network visualizer](engineering/screenshots/nyeri-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 16 line platforms, 3 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Nyeri QGIS engineering layers](engineering/screenshots/nyeri-qgis-engineering-map.png) | ![Nyeri SUMO timetable validation](engineering/screenshots/nyeri-sumo-validation.png) |
...
scripts/regenerate-city.sh nyeri
```
