...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **38,937 – 70,087 trips/day**
...
| Per-capita (city pop) | $2,670 / person |
...
|---|---|---|
| Construction (years 1–7) | **$16 M / yr** | $65 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$804 M cumulative** | $3,216 |
| Lifecycle envelope (yr 1–40, high scenario) | **$574 M cumulative** | $2,296 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$573 M cumulative** | $2,290 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.0 M / yr → $40 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $267 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $334 M | 2.0% | 40 y, 7 y grace | $14 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 11.5% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $67 M | — | — | — |
| **Total** | **100%** | **$667 M** | | | **$14 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $6.7 M / yr + fallback bonds $0 k / yr = **$6.7 M / yr** total. The $267 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($9.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (73.1 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (232 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $896 k |
| **OPEX subtotal** | | **$18 M / yr** |

_Annual fleet utilisation: 74 revenue trainsets × 20.5 h/day × 365 d/yr × 22 km/h commercial × 75% revenue factor = 9.1 M train-km / yr (~123 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 38,937 | 70,087 | 70,267 |
| Daily paid trips / catchment | 25% | 45% | 45% |
| Daily paid trips / city population | 16% | 28% | 28% |
| Annual paid trips | 14.2 M | 25.6 M | 25.6 M |
...
| Revenue / OPEX recovery | 60% | 100% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov repayable-debt service + residual OPEX subsidy | $21 M / yr | $14 M / yr | **$14 M / yr** |
