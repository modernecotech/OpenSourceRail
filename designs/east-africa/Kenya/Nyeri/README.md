...
| Lifecycle envelope (yr 1–40, low scenario) | **$194 M cumulative** | $774 |
| Lifecycle envelope (yr 1–40, high scenario) | **$194 M cumulative** | $774 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$858 M cumulative** | $3,431 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $343 M | 4.5% | 40 y, 7 y grace | $20 M / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $255 M | 60% of $428 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,130 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-170669 k / $-49821 k |
| Low/high project IRR | 2.9% / 6.7% |
| Low/high steady-state DSCR | 1.09 / 1.99 |
