...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $132 |
| Steady-state, low-ridership (year 8+) | **$34 M / yr** | $137 |
| Steady-state, high-ridership (year 8+) | **$31 M / yr** | $126 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $126 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.02 bn cumulative** | $4,067 |
| Lifecycle envelope (yr 1–30, high scenario) | **$955 M cumulative** | $3,818 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$955 M cumulative** | $3,818 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $256 M | 4.5% | 30 y, 7 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $107 M | 11.5% | 30 y, 7 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$427 M** | | | **$31 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $12 M / yr = **$24 M / yr** total — plus the equity tranche amortised across construction ($9.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,035 | 46,725 | 44,139 |
| Daily paid trips / catchment | 18% | 30% | 28% |
| Daily paid trips / city population | 11% | 19% | 18% |
| Annual paid trips | 10.2 M | 17.1 M | 16.1 M |
| Farebox revenue | $4.7 M / yr | $7.8 M / yr | $7.4 M / yr |
| Station shop leases | $712 k / yr | $712 k / yr | $712 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$6.6 M / yr** | **$9.7 M / yr** | **$9.3 M / yr** |
| Revenue / OPEX recovery | 71% | 105% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov commitment | $34 M / yr | $31 M / yr | **$31 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $434 k / yr | $0 / yr |
