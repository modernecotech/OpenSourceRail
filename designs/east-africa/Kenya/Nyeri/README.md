...
| Bucket | Value |
|---|---|
| At-grade (22.0 km @ $0.85 M/km) | $19 M |
...
|---|---|---|
| Construction (years 1–7) | **$11 M / yr** | $45 |
| Steady-state, low-ridership (year 8+) | **$9.5 M / yr** | $38 |
| Steady-state, high-ridership (year 8+) | **$6.5 M / yr** | $26 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$295 M cumulative** | $1,182 |
| Lifecycle envelope (yr 1–30, high scenario) | **$228 M cumulative** | $911 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$78 M cumulative** | $312 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $87 M | 4.5% | 30 y, 7 y grace | $6.1 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $3.9 M / yr + bonds $4.1 M / yr = **$8.0 M / yr** total — plus the equity tranche amortised across construction ($3.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
