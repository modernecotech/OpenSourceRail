...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$599 M (88.6%) of external capital** and **$751 M of external interest**. Capital plus saved interest totals **$1.35 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (23.2 km @ $2.58 M/km) | $60 M |
| Elevated (13.5 km @ $9.75 M/km) | $131 M |
...
|---|---:|---:|---:|---:|
| Civil works | $191 M | 15% | $29 M | $163 M |
...
| **Total city CAPEX** | **$376 M** | **20.5%** | **$77 M** | **$299 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.5%** | **$77 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.5%** | **$299 M** | **$43 M / yr** |
| of which planned local bond issuance | 63.6% of total CAPEX | $239 M | $34 M / yr |
| **Total city programme** | **100.0%** | **$376 M** | **$54 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $507 M | $430 M (84.8%) | $539 M | **$970 M** |
| **Default** | 2.00× | $676 M | $599 M (88.6%) | $751 M | **$1.35 bn** |
| High | 3.00× | $1.01 bn | $938 M (92.4%) | $1.18 bn | **$2.11 bn** |

At the default 2.00× case, OSR's $77 M external requirement is 88.6% below the illustrative foreign-company requirement of $676 M; the associated lifetime external-interest saving is $751 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$10.0 M / yr** | $40 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $131 |
| Lifecycle envelope (yr 1–40, low scenario) | **$606 M cumulative** | $2,422 |
| Lifecycle envelope (yr 1–40, high scenario) | **$276 M cumulative** | $1,106 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.36 bn cumulative** | $5,434 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $23 M / yr → $33 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 20% | $77 M | 4.5% | 40 y, 7 y grace | $4.5 M / yr |
| Local-currency sovereign / project bonds for local content | 64% | $239 M | 11.5% | 40 y, 7 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $60 M | — | — | — |
| **Total** | **100%** | **$376 M** | | | **$33 M / yr** |
...
| Annual paid trips / city resident | 196 | 313 | 47 |
| Farebox revenue | $30 M / yr | $48 M / yr | $7.2 M / yr |
| Station shop leases | $682 k / yr | $682 k / yr | $682 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$8.9 M / yr** |
| Revenue / OPEX recovery | 356% | 558% | 100% |
...
| Operating surplus applied to debt support | -$23 M / yr | -$33 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $10.0 M / yr | $0 k / yr | **$33 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $299 M | 80% of $376 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $478 M | retained CAPEX × 1.6 local supplier / wage multiplier |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $356 M |
| Timetable-sized dedicated solar CAPEX | $20 M |
| **Reconciled project CAPEX** | **$376 M** |
| Imported / external-capital requirement | $77 M (20.5%) |
| Local-content / local-funding requirement | $299 M (79.5%) |
| Default foreign-turnkey external-capital comparison | $676 M; OSR saves $599 M (88.6%) |
| Lifetime external interest and combined financing saving | $751 M interest; $1.35 bn capital + interest |
| 15%–25% planning risk envelope | $432 M–$470 M |
| Annual OPEX | $8.9 M / yr |
| Low/high project NPV at 8% | $-126208 k / $-5359 k |
| Low/high project IRR | 3.9% / 7.9% |
| Low/high steady-state DSCR | 0.70 / 1.24 |
