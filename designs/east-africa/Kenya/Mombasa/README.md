...
|---|---|---|
| Construction (years 1–7) | **$90 M / yr** | $67 |
| Steady-state, low-ridership (year 8+) | **$86 M / yr** | $64 |
| Steady-state, high-ridership (year 8+) | **$86 M / yr** | $64 |
| Steady-state, operating-neutral revenue case | **$86 M / yr** | $64 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.62 bn cumulative** | $1,942 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.62 bn cumulative** | $1,940 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.62 bn cumulative** | $1,940 |

_Population basis: 1,350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $91 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $703 M | 4.5% | 30 y, 7 y grace | $50 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $293 M | 11.5% | 30 y, 7 y grace | $37 M / yr |
| Government equity (no debt service) | 15% | $176 M | — | — | — |
| **Total** | **100%** | **$1.17 bn** | | | **$86 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $32 M / yr + bonds $34 M / yr = **$65 M / yr** total — plus the equity tranche amortised across construction ($25 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 126,603 | 211,005 | 127,146 |
| Daily paid trips / catchment | 18% | 30% | 18% |
| Daily paid trips / city population | 9% | 16% | 9% |
| Annual paid trips | 46.2 M | 77.0 M | 46.4 M |
| Farebox revenue | $21 M / yr | $35 M / yr | $21 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.1 M / yr | $5.1 M / yr | $5.1 M / yr |
| **Total revenue** | **$30 M / yr** | **$44 M / yr** | **$30 M / yr** |
| Revenue / OPEX recovery | 100% | 148% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov commitment | $86 M / yr | $86 M / yr | **$86 M / yr** |
