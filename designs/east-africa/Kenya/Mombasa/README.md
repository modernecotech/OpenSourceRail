...
| Revenue fleet | 149 × 4-car trainsets |
...
|---|---|---|---|---|
| line-1 | 32.6 km | 16 | 27 | S Mid ↔ NE Outer |
| line-2 | 24.5 km | 13 | 21 | NW Outer ↔ E Mid |
| line-3 | 22.2 km | 11 | 19 | W Mid ↔ NE Mid |
| line-4 | 30.5 km | 13 | 26 | N Mid ↔ SW Outer |
| line-5 | 20.6 km | 10 | 18 | E Inner ↔ SW Outer |
| line-6 | 70.4 km | 32 | 56 | NW Mid ↔ NW Mid |
| **Total** | **200.8 km** | **94 unique** | **167** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **70,335 – 105,502 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (191.2 km @ $0.85 M/km) | $163 M |
| Elevated (9.0 km @ $4.0 M/km) | $36 M |
...
|---|---|---|---|
| `halt` | 4 | $120 k | $480 k |
| `standard` | 36 | $300 k | $11 M |
| `major` | 28 | $600 k | $17 M |
| `terminal` | 9 | $500 k | $4.5 M |
| `depot-terminal` | 1 | $650 k | $650 k |
| `interchange-elevated` | 17 | $1.20 M | $20 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 167 | $1.07 M | $178 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 200.8 km × $0.015 M/km | $3.0 M |
...
| Per-capita (city pop) | $384 / person |
...
|---|---|---|
| Construction (years 1–7) | **$40 M / yr** | $30 |
| Steady-state, low-ridership (year 8+) | **$29 M / yr** | $22 |
| Steady-state, high-ridership (year 8+) | **$14 M / yr** | $10 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$956 M cumulative** | $708 |
| Lifecycle envelope (yr 1–30, high scenario) | **$591 M cumulative** | $438 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$280 M cumulative** | $207 |

_Population basis: 1,350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $311 M | 4.5% | 30 y, 7 y grace | $22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $130 M | 11.5% | 30 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $78 M | — | — | — |
| **Total** | **100%** | **$518 M** | | | **$38 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $14 M / yr + bonds $15 M / yr = **$29 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Traction energy (468.3 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
...
|---|---|---|---|
| Daily paid trips | 108,000 | 202,500 | 283,065 |
| Daily paid trips / population | 8% | 15% | 21% |
| Annual paid trips | 39.4 M | 73.9 M | 103.3 M |
| Farebox revenue | $18 M / yr | $34 M / yr | $48 M / yr |
| Station shop leases | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| Advertising boards | $5.1 M / yr | $5.1 M / yr | $5.1 M / yr |
| **Total revenue** | **$26 M / yr** | **$42 M / yr** | **$56 M / yr** |
| Revenue / OPEX + debt-service recovery | 47% | 76% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov gap | $29 M / yr | $14 M / yr | **$0 / yr** |
