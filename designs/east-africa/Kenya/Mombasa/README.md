...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 760 | $60 k | $46 M |
| High sensitivity check | 760 | $120 k | $91 M |
...
|---|---|---|
| Construction (years 1–7) | **$103 M / yr** | $77 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$75 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$723 M cumulative** | $536 |
| Lifecycle envelope (yr 1–40, high scenario) | **$723 M cumulative** | $536 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.21 bn cumulative** | $2,374 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.28 bn | 4.5% | 40 y, 7 y grace | $75 M / yr |
| Government equity (no debt service) | 20% | $320 M | — | — | — |
| **Total** | **100%** | **$1.60 bn** | | | **$75 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $905 M | 57% of $1.60 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.45 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $207 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 81,951 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $36 M / yr |
| Low/high project NPV at 8% | $-650514 k / $-207402 k |
| Low/high project IRR | 2.7% / 6.6% |
| Low/high steady-state DSCR | 1.07 / 1.95 |
