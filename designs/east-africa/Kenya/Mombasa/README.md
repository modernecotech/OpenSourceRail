...
| Bucket | Value |
|---|---|
| At-grade (191.2 km @ €3.5 M/km) | €669 M |
| Elevated (9.0 km @ €18 M/km) | €161 M |
| Elevated-interchange premium (7 sites @ €20 M) | €140 M |
| **Civil subtotal** | **€970 M** |
...
|---|---|---|
| Construction (years 1–7) | **€163 M / yr** | €121 |
| Steady-state, low-ridership (year 8+) | **€203 M / yr** | €151 |
| Steady-state, high-ridership (year 8+) | **€195 M / yr** | €144 |
| Lifecycle envelope (yr 1–30, low scenario) | **€5.81 bn cumulative** | €4,306 |
| Lifecycle envelope (yr 1–30, high scenario) | **€5.61 bn cumulative** | €4,158 |

_Population basis: 1,350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€48 M / yr (low) → €39 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.26 bn | 4.5% | 30 y, 7 y grace | €89 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €527 M | 11.5% | 30 y, 7 y grace | €66 M / yr |
| Government equity (no debt service) | 15% | €316 M | — | — | — |
| **Total** | **100%** | **€2.11 bn** | | | **€155 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €57 M / yr + bonds €61 M / yr = **€118 M / yr** total — plus the equity tranche amortised across construction (€45 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (1,217 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €4.3 M |
...
|---|---|---|
| Annual paid trips | 24.6 M | 49.3 M |
| Farebox revenue | €8.7 M / yr | €17 M / yr |
| Farebox / OPEX recovery | 15% | 31% |
| Country policy-target recovery (diagnostic) | 50% | 50% |
| Operating shortfall (gov subsidy required) | €48 M / yr | €39 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€203 M / yr** | **€195 M / yr** |
