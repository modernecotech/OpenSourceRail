...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **126,603 – 211,005 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (191.2 km @ $2.0 M/km) | $382 M |
| Elevated (9.0 km @ $9.0 M/km) | $81 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$495 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 200.8 km × $0.015 M/km | $10 M |
...
|---|---|---|
| Construction (years 1–7) | **$75 M / yr** | $55 |
| Steady-state, low-ridership (year 8+) | **$71 M / yr** | $53 |
| Steady-state, high-ridership (year 8+) | **$71 M / yr** | $53 |
| Steady-state, operating-neutral revenue case | **$71 M / yr** | $53 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.16 bn cumulative** | $1,601 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.16 bn cumulative** | $1,601 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.16 bn cumulative** | $1,601 |

_Population basis: 1,350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $580 M | 4.5% | 30 y, 7 y grace | $41 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $242 M | 11.5% | 30 y, 7 y grace | $30 M / yr |
| Government equity (no debt service) | 15% | $145 M | — | — | — |
| **Total** | **100%** | **$967 M** | | | **$71 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $26 M / yr + bonds $28 M / yr = **$54 M / yr** total — plus the equity tranche amortised across construction ($21 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 126,603 | 211,005 | 104,366 |
| Daily paid trips / catchment | 18% | 30% | 15% |
| Daily paid trips / city population | 9% | 16% | 8% |
| Annual paid trips | 46.2 M | 77.0 M | 38.1 M |
...
| **Total revenue** | **$30 M / yr** | **$44 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 114% | 169% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov commitment | $71 M / yr | $71 M / yr | **$71 M / yr** |
| Operating surplus after OPEX | $3.7 M / yr | $18 M / yr | $0 / yr |
