...
| Bucket | Value |
|---|---|
| At-grade (25.7 km @ €3.5 M/km) | €90 M |
| Elevated (3.6 km @ €18 M/km) | €64 M |
...
| Steady-state, low-ridership (year 8+) | **€35 M / yr** | €116 |
| Steady-state, high-ridership (year 8+) | **€33 M / yr** | €109 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.00 bn cumulative** | €3,338 |
| Lifecycle envelope (yr 1–30, high scenario) | **€957 M cumulative** | €3,190 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€7.3 M / yr (low) → €5.4 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €224 M | 4.5% | 30 y, 7 y grace | €16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €93 M | 11.5% | 30 y, 7 y grace | €12 M / yr |
| Government equity (no debt service) | 15% | €56 M | — | — | — |
| **Total** | **100%** | **€373 M** | | | **€27 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €10 M / yr + bonds €11 M / yr = **€21 M / yr** total — plus the equity tranche amortised across construction (€8.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating shortfall (gov subsidy required) | €7.3 M / yr | €5.4 M / yr |
