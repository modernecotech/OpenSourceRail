...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 168 | $60 k | $10 M |
| High sensitivity check | 168 | $120 k | $20 M |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $72 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$151 M cumulative** | $503 |
| Lifecycle envelope (yr 1–40, high scenario) | **$151 M cumulative** | $503 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$669 M cumulative** | $2,229 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $267 M | 4.5% | 40 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $67 M | — | — | — |
| **Total** | **100%** | **$334 M** | | | **$16 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $12 M / yr = **$12 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $193 M | 58% of $334 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $309 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $44 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 17,502 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-91388 k / $29 M |
| Low/high project IRR | 4.8% / 8.9% |
| Low/high steady-state DSCR | 1.49 / 2.64 |
