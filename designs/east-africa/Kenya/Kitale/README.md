...
| Revenue fleet | 105 × 2-car trainsets |
...
|---|---|---|---|---|
| line-1 | 14.6 km | 7 | 43 | W Inner ↔ SE Outer |
| line-2 | 13.9 km | 8 | 40 | SW Outer ↔ NE Mid |
| line-3 | 11.3 km | 6 | 34 | SE Inner ↔ N Outer |
| **Total** | **39.9 km** | **21 unique** | **117** | |
...
| Total fleet capacity | 28,080 AW2 pax (37,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 105 × 240 = **25,200 AW2 passengers** (33,600 AW3 crush)
- **Total fleet passenger capacity:** 117 × 240 = **28,080 AW2 passengers** (37,440 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **26.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 321 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 26.4 MW / 127 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 73 kWh | 139 kWh | 58 kWh | 7.9 km / 39 kWh |
| line-2 | 7 | 69 kWh | 131 kWh | 54 kWh | 5.0 km / 25 kWh |
| line-3 | 6 | 56 kWh | 114 kWh | 52 kWh | 3.4 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (36.6 km @ $3.0 M/km) | $110 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 117 | $560 k | $66 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 234 | $60 k | $14 M |
| High sensitivity check | 234 | $120 k | $28 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 26,416 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 26,416 kW @ $100/kW | $2.6 M |
| Annual generation proxy | 26.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 46.3 GWh/yr |
...
| Per-capita (city pop) | $1,331 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$180 M cumulative** | $602 |
| Lifecycle envelope (yr 1–40, high scenario) | **$180 M cumulative** | $602 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$800 M cumulative** | $2,666 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $319 M | 4.5% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $80 M | — | — | — |
| **Total** | **100%** | **$399 M** | | | **$19 M / yr** |
...
| Traction energy (58.5 GWh / yr) | 18,539 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 18.2 GWh/yr + dedicated solar plant 26.4 MW / 46.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $317 k |
| Labour (318 FTE) | driverless roster: OCC/remote 77, station/platform 84, passenger service 38, fleet maintenance 60, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$9.7 M / yr** |

_Annual service work: 18,539 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.3 M train-km / yr (14.6 M car-km / yr). On-site PV covers 18.2 GWh/yr and the dedicated solar plant adds 46.3 GWh/yr against 58.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 117 trainsets, 21 stations, 39.9 route-km, 3 lines, and 18,539 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 12.8 M |
| Annual paid trips / city resident | 163 | 261 | 43 |
| Farebox revenue | $30 M / yr | $48 M / yr | $7.9 M / yr |
| Station shop leases | $687 k / yr | $687 k / yr | $687 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$9.7 M / yr** |
| Revenue / OPEX recovery | 329% | 515% | 100% |
...
_Commercial-revenue assumptions: 3,536 m² of station shop/kiosk leases at $18/m²/month and 676 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 10,178 trips/school day; 2.2 M access-events/yr | 16,285 trips/school day; 3.6 M access-events/yr |
| Healthcare | 1 healthcare anchors | 8,973 trips/day; 3.3 M access-events/yr | 14,356 trips/day; 5.2 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 29,462 trips/trading day; 9.7 M access-events/yr | 47,140 trips/trading day; 15.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $231 M | 58% of $399 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 20,929 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $459 M–$499 M |
| Annual OPEX | $9.7 M / yr |
| Low/high project NPV at 8% | $-148362 k / $-27514 k |
| Low/high project IRR | 3.3% / 7.3% |
| Low/high steady-state DSCR | 1.18 / 2.14 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,677.46 train-km; 8,374.58 kWh consumed; 8,812.34 kWh charged; 34 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,652.21 train-km; 93,119.76 kWh consumed; 95,339.46 kWh charged; 503 depot services completed (6 active at cutoff); minimum SoC 85%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 81.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 84.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.7% / 60% | pass |
| ten-hour single charging-pad outage | 74.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
