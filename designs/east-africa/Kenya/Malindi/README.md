...
| Bucket | Value |
|---|---|
| At-grade (27.9 km @ €3.5 M/km) | €98 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 44 | €2.0 M | €88 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 29.4 km × €0.015 M/km | €0.4 M |
...
|---|---|---|
| Construction (years 1–7) | **€25 M / yr** | €84 |
| Steady-state, low-ridership (year 8+) | **€30 M / yr** | €101 |
| Steady-state, high-ridership (year 8+) | **€28 M / yr** | €95 |
| Lifecycle envelope (yr 1–30, low scenario) | **€876 M cumulative** | €2,919 |
| Lifecycle envelope (yr 1–30, high scenario) | **€831 M cumulative** | €2,771 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€6.4 M / yr (low) → €4.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €195 M | 4.5% | 30 y, 7 y grace | €14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €81 M | 11.5% | 30 y, 7 y grace | €10 M / yr |
| Government equity (no debt service) | 15% | €49 M | — | — | — |
| **Total** | **100%** | **€325 M** | | | **€24 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €8.8 M / yr + bonds €9.4 M / yr = **€18 M / yr** total — plus the equity tranche amortised across construction (€7.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (188 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €668 k |
...
| Operating shortfall (gov subsidy required) | €6.4 M / yr | €4.5 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€30 M / yr** | **€28 M / yr** |
