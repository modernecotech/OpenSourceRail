...
| Steady-state, low-ridership (year 8+) | **$19 M / yr** | $63 |
| Steady-state, high-ridership (year 8+) | **$19 M / yr** | $63 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $63 |
| Lifecycle envelope (yr 1–30, low scenario) | **$570 M cumulative** | $1,899 |
| Lifecycle envelope (yr 1–30, high scenario) | **$570 M cumulative** | $1,899 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$570 M cumulative** | $1,899 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $153 M | 4.5% | 30 y, 7 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $64 M | 11.5% | 30 y, 7 y grace | $8.0 M / yr |
| Government equity (no debt service) | 15% | $38 M | — | — | — |
| **Total** | **100%** | **$255 M** | | | **$19 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.9 M / yr + bonds $7.3 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($5.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
