...
|---|---|---|---|---|
| line-1 | 10.1 km | 7 | 15 | SE Outer ↔ NW Outer |
| line-2 | 10.3 km | 7 | 15 | N Outer ↔ S Outer |
| line-3 |  9.0 km | 6 | 14 | N Outer ↔ SE Mid |
| **Total** | **29.4 km** | **20 unique** | **44** | |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 44 | $2.80 M | $123 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 88 | $100 k | $8.8 M |
| High sensitivity check | 88 | $200 k | $18 M |
...
| Steady-state, low-ridership (year 8+) | **$28 M / yr** | $94 |
| Steady-state, high-ridership (year 8+) | **$27 M / yr** | $91 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $91 |
| Lifecycle envelope (yr 1–30, low scenario) | **$852 M cumulative** | $2,839 |
| Lifecycle envelope (yr 1–30, high scenario) | **$829 M cumulative** | $2,765 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$829 M cumulative** | $2,765 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $978 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $223 M | 4.5% | 30 y, 7 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $93 M | 11.5% | 30 y, 7 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $56 M | — | — | — |
| **Total** | **100%** | **$371 M** | | | **$27 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $11 M / yr = **$21 M / yr** total — plus the equity tranche amortised across construction ($7.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 42,660 | 71,100 | 48,484 |
| Daily paid trips / catchment | 18% | 30% | 20% |
| Daily paid trips / city population | 14% | 24% | 16% |
| Annual paid trips | 15.6 M | 26.0 M | 17.7 M |
| Farebox revenue | $7.2 M / yr | $12 M / yr | $8.1 M / yr |
| Station shop leases | $634 k / yr | $634 k / yr | $634 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$8.8 M / yr** | **$14 M / yr** | **$9.8 M / yr** |
| Revenue / OPEX recovery | 90% | 139% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $28 M / yr | $27 M / yr | **$27 M / yr** |
