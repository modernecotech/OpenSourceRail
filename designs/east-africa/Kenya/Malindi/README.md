...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$435 M (88.2%) of external capital** and **$545 M of external interest**. Capital plus saved interest totals **$980 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (27.1 km @ $3.0 M/km) | $81 M |
...
| **Total city CAPEX** | **$274 M** | **21.2%** | **$58 M** | **$216 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$58 M** | **$8.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$216 M** | **$31 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $173 M | $25 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $370 M | $312 M (84.3%) | $391 M | **$702 M** |
| **Default** | 2.00× | $493 M | $435 M (88.2%) | $545 M | **$980 M** |
| High | 3.00× | $740 M | $681 M (92.1%) | $854 M | **$1.54 bn** |

At the default 2.00× case, OSR's $58 M external requirement is 88.2% below the illustrative foreign-company requirement of $493 M; the associated lifetime external-interest saving is $545 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $95 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$200 M cumulative** | $668 |
| Lifecycle envelope (yr 1–40, high scenario) | **$200 M cumulative** | $668 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$987 M cumulative** | $3,289 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $58 M | 4.5% | 40 y, 7 y grace | $3.4 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $173 M | 11.5% | 40 y, 7 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $43 M | — | — | — |
| **Total** | **100%** | **$274 M** | | | **$24 M / yr** |
...
| Annual paid trips | 48.9 M | 78.2 M | 8.4 M |
| Annual paid trips / city resident | 163 | 261 | 28 |
| Farebox revenue | $30 M / yr | $48 M / yr | $5.2 M / yr |
| Station shop leases | $597 k / yr | $597 k / yr | $597 k / yr |
| Advertising boards | $939 k / yr | $939 k / yr | $939 k / yr |
| **Total revenue** | **$32 M / yr** | **$50 M / yr** | **$6.7 M / yr** |
| Revenue / OPEX recovery | 469% | 737% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $216 M | 79% of $274 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,546 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $58 M (21.2%) |
| Local-content / local-funding requirement | $216 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $493 M; OSR saves $435 M (88.2%) |
| Lifetime external interest and combined financing saving | $545 M interest; $980 M capital + interest |
| 15%–25% planning risk envelope | $315 M–$342 M |
| Annual OPEX | $6.7 M / yr |
| Low/high project NPV at 8% | $-37122 k / $84 M |
| Low/high project IRR | 6.5% / 10.9% |
| Low/high steady-state DSCR | 1.04 / 1.80 |
