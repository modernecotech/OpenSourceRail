...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$256 M (88.4%) of external capital** and **$330 M of external interest**. Capital plus saved interest totals **$586 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (13.6 km @ $3.0 M/km) | $41 M |
...
| Per-capita (city pop) | $643 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $62 M | 15% | $9.3 M | $52 M |
...
| EPC / project services | $10 M | 15% | $1.5 M | $8.7 M |
| **Total city CAPEX** | **$161 M** | **20.8%** | **$33 M** | **$127 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.8%** | **$33 M** | **$3.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.2%** | **$127 M** | **$13 M / yr** |
| of which planned local bond issuance | 63.3% of total CAPEX | $102 M | $10 M / yr |
| **Total city programme** | **100.0%** | **$161 M** | **$16 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $217 M | $183 M (84.6%) | $237 M | **$420 M** |
| **Default** | 2.00× | $289 M | $256 M (88.4%) | $330 M | **$586 M** |
| High | 3.00× | $434 M | $400 M (92.3%) | $517 M | **$918 M** |

At the default 2.00× case, OSR's $33 M external requirement is 88.4% below the illustrative foreign-company requirement of $289 M; the associated lifetime external-interest saving is $330 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$18 M / yr** | $71 |
| Steady-state, low capacity-use (year 11+) | **$8.0 M / yr** | $32 |
| Steady-state, high capacity-use (year 11+) | **$1.2 M / yr** | $5 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$417 M cumulative** | $1,668 |
| Lifecycle envelope (yr 1–40, high scenario) | **$214 M cumulative** | $855 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$661 M cumulative** | $2,644 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.1 M / yr → $15 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $33 M | 4.5% | 40 y, 10 y grace | $2.1 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $102 M | 13.5% | 40 y, 10 y grace | $14 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $25 M | — | — | — |
| **Total** | **100%** | **$161 M** | | | **$16 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.5 M / yr + local bonds $14 M / yr = **$15 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $2.5 M |
...
| Annual paid trips | 32.6 M | 52.1 M | 9.1 M |
| Annual paid trips / city resident | 130 | 209 | 36 |
| Farebox revenue | $11 M / yr | $18 M / yr | $3.2 M / yr |
| Station shop leases | $220 k / yr | $220 k / yr | $220 k / yr |
| Advertising boards | $342 k / yr | $342 k / yr | $342 k / yr |
| **Total revenue** | **$12 M / yr** | **$19 M / yr** | **$3.7 M / yr** |
| Revenue / OPEX recovery | 319% | 501% | 100% |
...
| Operating surplus applied to debt support | -$8.1 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $8.0 M / yr | $1.2 M / yr | **$16 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.1 M / yr | $15 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $127 M | 79% of $161 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $204 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $20 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 20,386 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $156 M |
| Timetable-sized dedicated solar CAPEX | $5.0 M |
| **Reconciled project CAPEX** | **$161 M** |
| Imported / external-capital requirement | $33 M (20.8%) |
| Local-content / local-funding requirement | $127 M (79.2%) |
| Default foreign-turnkey external-capital comparison | $289 M; OSR saves $256 M (88.4%) |
| Lifetime external interest and combined financing saving | $330 M interest; $586 M capital + interest |
| 15%–25% planning risk envelope | $185 M–$201 M |
| Annual OPEX | $3.7 M / yr |
| Low/high project NPV at 8% | $-65386 k / $-30041 k |
| Low/high project IRR | 2.2% / 5.8% |
| Low/high steady-state DSCR | 0.51 / 0.93 |
