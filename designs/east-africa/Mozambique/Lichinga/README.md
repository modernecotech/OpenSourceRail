...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$240 M (88.2%) of external capital** and **$310 M of external interest**. Capital plus saved interest totals **$551 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`lichinga.corridor.geojson`](lichinga.corridor.geojson).
...
| Anchor-weighted coverage | 80.4% |
| Route length (double track) | 14.9 km |
| Revenue fleet | 30 × 2-car trainsets |
| Revenue fleet passenger capacity | 7,200 AW2 pax (9,600 AW3 crush) |
...
| Revenue fleet capacity | 7,200 AW2 pax (9,600 AW3 crush) |
| Total fleet capacity | 8,160 AW2 pax (10,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 30 × 240 = **7,200 AW2 passengers** (9,600 AW3 crush)
- **Total fleet passenger capacity:** 34 × 240 = **8,160 AW2 passengers** (10,880 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **8** | **7,100 kW** | **43,500 kWh** |

Aggregate station-rail charging power: **4,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **6.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 19.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 341 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 31 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 34 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 930 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 6,947 train-km/day | One-way train journeys × route length |
| Annual service work | 2.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 60 MWh/day | 5.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 26 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 6.2 MW / 30 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 44 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 44 kWh | 106 kWh | 58 kWh | 3.0 km / 15 kWh |
| line-2 | 3 | 31 kWh | 65 kWh | 31 kWh | 3.7 km / 19 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (13.6 km @ $2.58 M/km) | $35 M |
| Elevated (1.4 km @ $9.75 M/km) | $13 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 34 | $560 k | $19 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 68 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 68 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 6,215 kW @ $700/kW | $4.4 M |
| Grid interconnection / PPA tie-in | 6,215 kW @ $100/kW | $621 k |
| Annual generation proxy | 6.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 10.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$5.0 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 14.9 km × $0.050 M/km | $747 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $1.0 M |
...
| Dedicated solar power plant | $5.0 M |
| Residual train-control wayside + charging microgrids | $1.7 M |
| EPC overhead (7%) | $9.6 M |
| **CAPEX total** | **$151 M** |
| Per-route-km | $10 M / km |
| Per-capita (city pop) | $605 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $53 M | 15% | $7.9 M | $45 M |
| Stations | $55 M | 20% | $11 M | $44 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $19 M | 35% | $6.7 M | $12 M |
| Dedicated solar plant | $5.0 M | 45% | $2.2 M | $2.7 M |
| Residual signalling / train control | $747 k | 50% | $373 k | $373 k |
| Charging microgrids | $1.0 M | 40% | $400 k | $600 k |
| EPC / project services | $9.6 M | 15% | $1.4 M | $8.1 M |
| **Total city CAPEX** | **$151 M** | **21.2%** | **$32 M** | **$119 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lichinga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$32 M** | **$3.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$119 M** | **$12 M / yr** |
| of which planned local bond issuance | 63.1% of total CAPEX | $95 M | $9.5 M / yr |
| **Total city programme** | **100.0%** | **$151 M** | **$15 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $204 M | $172 M (84.3%) | $222 M | **$395 M** |
| **Default** | 2.00× | $272 M | $240 M (88.2%) | $310 M | **$551 M** |
| High | 3.00× | $409 M | $376 M (92.2%) | $486 M | **$863 M** |

At the default 2.00× case, OSR's $32 M external requirement is 88.2% below the illustrative foreign-company requirement of $272 M; the associated lifetime external-interest saving is $310 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$17 M / yr** | $67 |
| Steady-state, low capacity-use (year 11+) | **$6.8 M / yr** | $27 |
| Steady-state, high capacity-use (year 11+) | **$53 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$372 M cumulative** | $1,488 |
| Lifecycle envelope (yr 1–40, high scenario) | **$169 M cumulative** | $675 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$621 M cumulative** | $2,485 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.3 M / yr → $15 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $32 M | 4.5% | 40 y, 10 y grace | $2.0 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $95 M | 13.5% | 40 y, 10 y grace | $13 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $24 M | — | — | — |
| **Total** | **100%** | **$151 M** | | | **$15 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.4 M / yr + local bonds $13 M / yr = **$14 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $762 k |
...
| Traction energy (21.9 GWh / yr) | 6,947 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 12.4 GWh/yr + dedicated solar plant 6.2 MW / 10.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $75 k |
| Labour (162 FTE) | driverless roster: OCC/remote 33, station/platform 47, passenger service 26, fleet maintenance 20, infrastructure/energy 17, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $354 k |
| **OPEX subtotal** | | **$3.5 M / yr** |

_Annual service work: 6,947 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 2.7 M train-km / yr (5.5 M car-km / yr). On-site PV covers 12.4 GWh/yr and the dedicated solar plant adds 10.9 GWh/yr against 21.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 34 trainsets, 8 stations, 14.9 route-km, 2 lines, and 6,947 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 32.6 M | 52.1 M | 8.6 M |
| Annual paid trips / city resident | 130 | 209 | 34 |
| Farebox revenue | $11 M / yr | $18 M / yr | $3.0 M / yr |
| Station shop leases | $220 k / yr | $220 k / yr | $220 k / yr |
| Advertising boards | $342 k / yr | $342 k / yr | $342 k / yr |
| **Total revenue** | **$12 M / yr** | **$19 M / yr** | **$3.5 M / yr** |
| Revenue / OPEX recovery | 334% | 525% | 100% |
...
| Operating surplus applied to debt support | -$8.3 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.8 M / yr | $53 k / yr | **$15 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.3 M / yr | $15 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,000 m² of station shop/kiosk leases at $10/m²/month and 368 advertising boards at $91/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $3.3 M / yr | $5.2 M / yr | 16 min/trip × $0.38/h value-of-time proxy |
...
| **Annual quantified benefit / activity proxy** | **$27 M / yr** | **$43 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 0 healthcare anchors | 5,357 trips/day; 2.0 M access-events/yr | 8,571 trips/day; 3.1 M access-events/yr |
| Commerce | 8 major/terminal/interchange nodes | 23,659 trips/trading day; 7.8 M access-events/yr | 37,855 trips/trading day; 12.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $119 M | 79% of $151 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $191 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $19 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 19,111 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $146 M |
| Timetable-sized dedicated solar CAPEX | $5.0 M |
| **Reconciled project CAPEX** | **$151 M** |
| Imported / external-capital requirement | $32 M (21.2%) |
| Local-content / local-funding requirement | $119 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $272 M; OSR saves $240 M (88.2%) |
| Lifetime external interest and combined financing saving | $310 M interest; $551 M capital + interest |
| 15%–25% planning risk envelope | $174 M–$189 M |
| Annual OPEX | $3.5 M / yr |
| Low/high project NPV at 8% | $-58193 k / $-22848 k |
| Low/high project IRR | 2.6% / 6.3% |
| Low/high steady-state DSCR | 0.55 / 1.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 688.76 train-km; 3,438.60 kWh consumed; 3,772.86 kWh charged; 27 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 7,109.71 train-km; 35,494.78 kWh consumed; 36,225.69 kWh charged; 323 depot services completed (4 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 86.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 87.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 87.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Lichinga energy and battery simulation dashboard](engineering/screenshots/lichinga-simulation-dashboard.png) | ![Lichinga simulator network visualizer](engineering/screenshots/lichinga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 8 line platforms, 2 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Lichinga QGIS engineering layers](engineering/screenshots/lichinga-qgis-engineering-map.png) | ![Lichinga SUMO timetable validation](engineering/screenshots/lichinga-sumo-validation.png) |
...
| [`lichinga.toml`](lichinga.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`lichinga-network-map.png`](lichinga-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`lichinga.corridor.geojson`](lichinga.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`lichinga.stations.json`](lichinga.stations.json) | Machine-readable station list |
| [`lichinga.design-quality.yaml`](lichinga.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug lichinga

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh lichinga
```
