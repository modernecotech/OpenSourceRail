...
| Bucket | Value |
|---|---|
| At-grade (27.6 km @ $2.0 M/km) | $55 M |
...
|---|---|---|
| Construction (years 1–10) | **$12 M / yr** | $49 |
| Steady-state, low-ridership (year 11+) | **$13 M / yr** | $53 |
| Steady-state, high-ridership (year 11+) | **$13 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $51 |
| Lifecycle envelope (yr 1–35, low scenario) | **$453 M cumulative** | $1,812 |
| Lifecycle envelope (yr 1–35, high scenario) | **$443 M cumulative** | $1,772 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$443 M cumulative** | $1,772 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $403 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $110 M | 3.0% | 35 y, 10 y grace | $6.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $46 M | 13.5% | 35 y, 10 y grace | $6.5 M / yr |
| Government equity (no debt service) | 15% | $28 M | — | — | — |
| **Total** | **100%** | **$184 M** | | | **$13 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.3 M / yr + bonds $6.2 M / yr = **$9.5 M / yr** total — plus the equity tranche amortised across construction ($2.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,350 | 47,250 | 32,601 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 11% | 19% | 13% |
| Annual paid trips | 10.3 M | 17.2 M | 11.9 M |
| Farebox revenue | $2.7 M / yr | $4.5 M / yr | $3.1 M / yr |
| Station shop leases | $412 k / yr | $412 k / yr | $412 k / yr |
| Advertising boards | $657 k / yr | $657 k / yr | $657 k / yr |
| **Total revenue** | **$3.8 M / yr** | **$5.6 M / yr** | **$4.2 M / yr** |
