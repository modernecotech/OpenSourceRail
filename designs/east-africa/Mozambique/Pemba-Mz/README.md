...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **39,375 – 70,875 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$9.9 M / yr** | $39 |
| Steady-state, low-ridership (year 11+) | **$18 M / yr** | $72 |
| Steady-state, high-ridership (year 11+) | **$14 M / yr** | $56 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$642 M cumulative** | $2,566 |
| Lifecycle envelope (yr 1–40, high scenario) | **$522 M cumulative** | $2,088 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$429 M cumulative** | $1,717 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.1 M / yr → $3.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $197 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $247 M | 2.0% | 40 y, 10 y grace | $11 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 13.5% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $49 M | — | — | — |
| **Total** | **100%** | **$493 M** | | | **$11 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $4.9 M / yr + fallback bonds $0 k / yr = **$4.9 M / yr** total. The $197 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($4.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (61.2 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (193 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $422 k |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual fleet utilisation: 62 revenue trainsets × 20.5 h/day × 365 d/yr × 22 km/h commercial × 75% revenue factor = 7.7 M train-km / yr (~123 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 39,375 | 70,875 | 95,323 |
| Daily paid trips / catchment | 25% | 45% | 61% |
| Daily paid trips / city population | 16% | 28% | 38% |
| Annual paid trips | 14.4 M | 25.9 M | 34.8 M |
| Farebox revenue | $5.0 M / yr | $9.0 M / yr | $12 M / yr |
...
| Revenue / OPEX recovery | 46% | 76% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $18 M / yr | $14 M / yr | **$11 M / yr** |
