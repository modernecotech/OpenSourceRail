...
|---|---|---|
| Construction (years 1–10) | **$27 M / yr** | $109 |
| Steady-state, low-ridership (year 11+) | **$35 M / yr** | $139 |
| Steady-state, high-ridership (year 11+) | **$33 M / yr** | $132 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $113 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.14 bn cumulative** | $4,555 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.09 bn cumulative** | $4,376 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$980 M cumulative** | $3,921 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.3 M / yr → $4.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $244 M | 3.0% | 35 y, 10 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $102 M | 13.5% | 35 y, 10 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$28 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 28,350 | 47,250 | 95,232 |
| Daily paid trips / catchment | 18% | 30% | 60% |
| Daily paid trips / city population | 11% | 19% | 38% |
| Annual paid trips | 10.3 M | 17.2 M | 34.8 M |
| Farebox revenue | $2.7 M / yr | $4.5 M / yr | $9.0 M / yr |
...
| Revenue / OPEX recovery | 37% | 55% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $35 M / yr | $33 M / yr | **$28 M / yr** |
