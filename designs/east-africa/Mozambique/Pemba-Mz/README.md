...
|---|---|---|---|---|
| line-1 | 14.0 km | 9 | 41 | W Outer ↔ E Outer |
| line-2 |  7.8 km | 5 | 25 | S Outer ↔ NE Mid |
| line-3 | 10.6 km | 6 | 31 | N Inner ↔ SE Outer |
| **Total** | **32.4 km** | **20 unique** | **97** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **18.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 20.8× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 343 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 18.9 MW / 91 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 70 kWh | 172 kWh | 95 kWh | 2.3 km / 12 kWh |
| line-2 | 5 | 39 kWh | 98 kWh | 55 kWh | 2.0 km / 10 kWh |
| line-3 | 6 | 53 kWh | 114 kWh | 56 kWh | 3.5 km / 17 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 18,895 kW @ $700/kW | $13 M |
| Grid interconnection / PPA tie-in | 18,895 kW @ $100/kW | $1.9 M |
| Annual generation proxy | 18.9 MW × 4.8 peak-sun-h/day × 365 d/yr | 33.1 GWh/yr |
...
| Steady-state, low capacity-use (year 11+) | **$6.2 M / yr** | $25 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$375 M cumulative** | $1,499 |
| Lifecycle envelope (yr 1–40, high scenario) | **$188 M cumulative** | $753 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$683 M cumulative** | $2,734 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $10 M / yr → $17 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $269 M | 4.5% | 40 y, 10 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $67 M | — | — | — |
| **Total** | **100%** | **$336 M** | | | **$17 M / yr** |
...
| Traction energy (47.5 GWh / yr) | 15,073 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 18.7 GWh/yr + dedicated solar plant 18.9 MW / 33.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $227 k |
| Labour (292 FTE) | driverless roster: OCC/remote 65, station/platform 86, passenger service 38, fleet maintenance 49, infrastructure/energy 33, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $638 k |
| **OPEX subtotal** | | **$7.7 M / yr** |

_Annual service work: 15,073 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.9 M car-km / yr). On-site PV covers 18.7 GWh/yr and the dedicated solar plant adds 33.1 GWh/yr against 47.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 97 trainsets, 20 stations, 32.4 route-km, 3 lines, and 15,073 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 19.2 M |
| Annual paid trips / city resident | 196 | 313 | 77 |
| Farebox revenue | $17 M / yr | $27 M / yr | $6.7 M / yr |
| Station shop leases | $409 k / yr | $409 k / yr | $409 k / yr |
| Advertising boards | $653 k / yr | $653 k / yr | $653 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$7.7 M / yr** |
...
| Operating surplus applied to debt support | -$10 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.2 M / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $10 M / yr | $20 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,720 m² of station shop/kiosk leases at $10/m²/month and 704 advertising boards at $91/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $194 M | 58% of $336 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 31,163 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $321 M |
| Timetable-sized dedicated solar CAPEX | $15 M |
| **Reconciled project CAPEX** | **$336 M** |
| 15%–25% planning risk envelope | $386 M–$420 M |
| Annual OPEX | $7.7 M / yr |
| Low/high project NPV at 8% | $-171871 k / $-118853 k |
| Low/high project IRR | -0.4% / 3.2% |
| Low/high steady-state DSCR | 0.62 / 1.24 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,407.07 train-km; 7,024.69 kWh consumed; 7,783.21 kWh charged; 36 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,597.07 train-km; 77,867.03 kWh consumed; 79,971.86 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 19 civil segments, and 0 input findings |
