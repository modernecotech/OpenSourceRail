...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$462 M (88.1%) of external capital** and **$596 M of external interest**. Capital plus saved interest totals **$1.06 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 32.4 km |
...
| Total fleet capacity | 16,560 AW2 pax (22,080 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 69 × 240 = **16,560 AW2 passengers** (22,080 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 63.6%
- Catchment population: **≈ 159,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **21.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.2× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 333 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 32 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 15,073 train-km/day | One-way train journeys × route length |
| Annual service work | 5.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 130 MWh/day | 11.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 88 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 21.0 MW / 101 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 70 kWh | 139 kWh | 62 kWh | 3.0 km / 15 kWh |
| line-2 | 4 | 39 kWh | 82 kWh | 39 kWh | 3.0 km / 15 kWh |
| line-3 | 4 | 53 kWh | 90 kWh | 32 kWh | 5.5 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (30.2 km @ $3.0 M/km) | $91 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 69 | $560 k | $39 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 138 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 138 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 20,965 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 20,965 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 21.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 36.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 32.4 km × $0.050 M/km | $1.6 M |
...
| Per-capita (city pop) | $1,164 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $126 M | 15% | $19 M | $107 M |
| Stations | $81 M | 20% | $16 M | $64 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $39 M | 35% | $14 M | $25 M |
| Dedicated solar plant | $17 M | 45% | $7.5 M | $9.2 M |
| Residual signalling / train control | $1.6 M | 50% | $810 k | $810 k |
| Charging microgrids | $1.6 M | 40% | $650 k | $975 k |
| EPC / project services | $18 M | 15% | $2.7 M | $15 M |
| **Total city CAPEX** | **$291 M** | **21.4%** | **$62 M** | **$229 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh pemba-mz`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.4%** | **$62 M** | **$6.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.6%** | **$229 M** | **$23 M / yr** |
| of which planned local bond issuance | 62.9% of total CAPEX | $183 M | $18 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $393 M | $331 M (84.2%) | $427 M | **$758 M** |
| **Default** | 2.00× | $524 M | $462 M (88.1%) | $596 M | **$1.06 bn** |
| High | 3.00× | $786 M | $724 M (92.1%) | $935 M | **$1.66 bn** |

At the default 2.00× case, OSR's $62 M external requirement is 88.1% below the illustrative foreign-company requirement of $524 M; the associated lifetime external-interest saving is $596 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$32 M / yr** | $128 |
| Steady-state, low capacity-use (year 11+) | **$18 M / yr** | $72 |
| Steady-state, high capacity-use (year 11+) | **$7.9 M / yr** | $32 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $116 |
| Lifecycle envelope (yr 1–40, low scenario) | **$862 M cumulative** | $3,449 |
| Lifecycle envelope (yr 1–40, high scenario) | **$557 M cumulative** | $2,229 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.19 bn cumulative** | $4,775 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $62 M | 4.5% | 40 y, 10 y grace | $3.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $183 M | 13.5% | 40 y, 10 y grace | $25 M / yr |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $81 k |
| Traction energy (47.5 GWh / yr) | 15,073 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 21.0 MW / 36.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $252 k |
| Labour (250 FTE) | driverless roster: OCC/remote 53, station/platform 66, passenger service 38, fleet maintenance 41, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $546 k |
| **OPEX subtotal** | | **$6.7 M / yr** |

_Annual service work: 15,073 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.9 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 36.7 GWh/yr against 47.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 69 trainsets, 15 stations, 32.4 route-km, 3 lines, and 15,073 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 196 | 313 | 68 |
| Farebox revenue | $17 M / yr | $27 M / yr | $5.9 M / yr |
| Station shop leases | $314 k / yr | $314 k / yr | $314 k / yr |
| Advertising boards | $505 k / yr | $505 k / yr | $505 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$6.7 M / yr** |
| Revenue / OPEX recovery | 265% | 416% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $7.9 M / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $21 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,856 m² of station shop/kiosk leases at $10/m²/month and 544 advertising boards at $91/board/month, with occupancy derates applied._
...
| Avoided road congestion | $5.7 M / yr | $9.1 M / yr | 71 M - 114 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.0 M / yr | $1.6 M / yr | 12.8–20.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $2.9 M / yr | $4.6 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| Healthcare | 1 healthcare anchors | 9,285 trips/day; 3.4 M access-events/yr | 14,856 trips/day; 5.4 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 31,739 trips/trading day; 10.5 M access-events/yr | 50,782 trips/trading day; 16.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $229 M | 79% of $291 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 36,668 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $274 M |
| Timetable-sized dedicated solar CAPEX | $17 M |
| **Reconciled project CAPEX** | **$291 M** |
| Imported / external-capital requirement | $62 M (21.4%) |
| Local-content / local-funding requirement | $229 M (78.6%) |
| Default foreign-turnkey external-capital comparison | $524 M; OSR saves $462 M (88.1%) |
| Lifetime external interest and combined financing saving | $596 M interest; $1.06 bn capital + interest |
| 15%–25% planning risk envelope | $335 M–$364 M |
| Annual OPEX | $6.7 M / yr |
| Low/high project NPV at 8% | $-137652 k / $-84635 k |
| Low/high project IRR | 0.7% / 4.3% |
| Low/high steady-state DSCR | 0.38 / 0.73 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,452.96 train-km; 7,253.81 kWh consumed; 7,441.88 kWh charged; 39 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,684.68 train-km; 78,304.73 kWh consumed; 79,605.24 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 50.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 45.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 59.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.8% / 60% | pass |
| ten-hour single charging-pad outage | 51.6% | 100.0% / 90% | pass |
...
|---|---|
| ![Pemba-Mz energy and battery simulation dashboard](engineering/screenshots/pemba-mz-simulation-dashboard.png) | ![Pemba-Mz simulator network visualizer](engineering/screenshots/pemba-mz-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 2 interchange complexes, 20 civil segments, and 0 input findings |
...
|---|---|
| ![Pemba-Mz QGIS engineering layers](engineering/screenshots/pemba-mz-qgis-engineering-map.png) | ![Pemba-Mz SUMO timetable validation](engineering/screenshots/pemba-mz-sumo-validation.png) |
