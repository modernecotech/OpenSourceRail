...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$431 M (87.9%) of external capital** and **$556 M of external interest**. Capital plus saved interest totals **$987 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (30.2 km @ $2.58 M/km) | $78 M |
| Elevated (2.2 km @ $9.75 M/km) | $21 M |
...
| Per-capita (city pop) | $1,089 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $108 M | 15% | $16 M | $92 M |
...
| **Total city CAPEX** | **$272 M** | **21.8%** | **$59 M** | **$213 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.8%** | **$59 M** | **$5.9 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.2%** | **$213 M** | **$21 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $170 M | $17 M / yr |
| **Total city programme** | **100.0%** | **$272 M** | **$27 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $368 M | $308 M (83.8%) | $398 M | **$706 M** |
| **Default** | 2.00× | $490 M | $431 M (87.9%) | $556 M | **$987 M** |
| High | 3.00× | $735 M | $676 M (91.9%) | $873 M | **$1.55 bn** |

At the default 2.00× case, OSR's $59 M external requirement is 87.9% below the illustrative foreign-company requirement of $490 M; the associated lifetime external-interest saving is $556 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $120 |
| Steady-state, low capacity-use (year 11+) | **$16 M / yr** | $63 |
| Steady-state, high capacity-use (year 11+) | **$5.6 M / yr** | $22 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $109 |
| Lifecycle envelope (yr 1–40, low scenario) | **$772 M cumulative** | $3,089 |
| Lifecycle envelope (yr 1–40, high scenario) | **$467 M cumulative** | $1,869 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $4,457 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $22 M / yr._
...
| Local-currency sovereign / project bonds for local content | 63% | $170 M | 13.5% | 40 y, 10 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $43 M | — | — | — |
| **Total** | **100%** | **$272 M** | | | **$27 M / yr** |
...
| Annual paid trips | 48.9 M | 78.2 M | 16.0 M |
| Annual paid trips / city resident | 196 | 313 | 64 |
| Farebox revenue | $17 M / yr | $27 M / yr | $5.5 M / yr |
| Station shop leases | $314 k / yr | $314 k / yr | $314 k / yr |
| Advertising boards | $505 k / yr | $505 k / yr | $505 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$6.4 M / yr** |
| Revenue / OPEX recovery | 279% | 439% | 100% |
...
| Operating surplus applied to debt support | -$11 M / yr | -$22 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $5.6 M / yr | **$27 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $22 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $213 M | 78% of $272 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $341 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $34 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 34,120 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$272 M** |
| Imported / external-capital requirement | $59 M (21.8%) |
| Local-content / local-funding requirement | $213 M (78.2%) |
| Default foreign-turnkey external-capital comparison | $490 M; OSR saves $431 M (87.9%) |
| Lifetime external interest and combined financing saving | $556 M interest; $987 M capital + interest |
| 15%–25% planning risk envelope | $313 M–$340 M |
| Annual OPEX | $6.4 M / yr |
| Low/high project NPV at 8% | $-123279 k / $-70262 k |
| Low/high project IRR | 1.2% / 4.8% |
| Low/high steady-state DSCR | 0.42 / 0.79 |
