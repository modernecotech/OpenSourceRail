...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **67,112 – 120,802 trips/day**
...
| Per-capita (city pop) | $2,029 / person |
...
| Steady-state, low-ridership (year 11+) | **$25 M / yr** | $72 |
| Steady-state, high-ridership (year 11+) | **$19 M / yr** | $53 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$901 M cumulative** | $2,574 |
...
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $284 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $355 M | 2.0% | 40 y, 10 y grace | $16 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 13.5% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $71 M | — | — | — |
| **Total** | **100%** | **$710 M** | | | **$16 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $7.1 M / yr + fallback bonds $0 k / yr = **$7.1 M / yr** total. The $284 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($7.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 67,112 | 120,802 | 141,740 |
| Daily paid trips / catchment | 25% | 45% | 53% |
| Daily paid trips / city population | 19% | 35% | 40% |
| Annual paid trips | 24.5 M | 44.1 M | 51.7 M |
| Farebox revenue | $8.5 M / yr | $15 M / yr | $18 M / yr |
