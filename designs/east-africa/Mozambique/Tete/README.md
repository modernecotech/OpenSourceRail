...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 243 | $60 k | $15 M |
| High sensitivity check | 243 | $120 k | $29 M |
...
| Per-capita (city pop) | $1,243 / person |
...
|---|---|---|
| Construction (years 1–10) | **$24 M / yr** | $70 |
| Steady-state, low capacity-use (year 11+) | **$5.2 M / yr** | $15 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$398 M cumulative** | $1,138 |
| Lifecycle envelope (yr 1–40, high scenario) | **$244 M cumulative** | $696 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$885 M cumulative** | $2,528 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $16 M / yr → $21 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $348 M | 4.5% | 40 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $87 M | — | — | — |
| **Total** | **100%** | **$435 M** | | | **$21 M / yr** |
...
| Operating surplus applied to debt support | -$16 M / yr | -$21 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.2 M / yr | $0 k / yr | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $254 M | 58% of $435 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 40,724 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-207373 k / $-127847 k |
| Low/high project IRR | 0.6% / 4.2% |
