...
| Bucket | Value |
|---|---|
| At-grade (24.4 km @ $0.85 M/km) | $21 M |
| Elevated (13.6 km @ $4.0 M/km) | $54 M |
...
|---|---|---|
| Construction (years 1–10) | **$9.8 M / yr** | $28 |
| Steady-state, low-ridership (year 11+) | **$11 M / yr** | $30 |
| Steady-state, high-ridership (year 11+) | **$8.2 M / yr** | $23 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$361 M cumulative** | $1,032 |
| Lifecycle envelope (yr 1–35, high scenario) | **$303 M cumulative** | $866 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$98 M cumulative** | $281 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $237 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $88 M | 3.0% | 35 y, 10 y grace | $5.1 M / yr |
