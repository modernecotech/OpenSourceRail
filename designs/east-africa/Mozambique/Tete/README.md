...
|---|---|---|---|---|
| line-1 | 14.5 km | 9 | 38 | NW Outer ↔ S Outer |
| line-2 | 12.6 km | 8 | 34 | SE Outer ↔ NW Mid |
| line-3 | 10.8 km | 6 | 29 | W Inner ↔ NE Outer |
| **Total** | **37.9 km** | **23 unique** | **101** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **27.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 494 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 24 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 73 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 155 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 27.4 MW / 178 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 121 kWh | 200 kWh | 67 kWh | 2.0 km / 17 kWh |
| line-2 | 8 | 105 kWh | 172 kWh | 56 kWh | 2.1 km / 18 kWh |
| line-3 | 5 | 90 kWh | 122 kWh | 24 kWh | 5.5 km / 46 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (24.2 km @ $3.0 M/km) | $73 M |
| Elevated (13.6 km @ $12.0 M/km) | $164 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 27,378 kW @ $700/kW | $19 M |
| Grid interconnection / PPA tie-in | 27,378 kW @ $100/kW | $2.7 M |
| Annual generation proxy | 27.4 MW × 6.5 peak-sun-h/day × 365 d/yr | 65.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$22 M** |
...
| Dedicated solar power plant | $22 M |
...
|---|---|---|
| Construction (years 1–10) | **$29 M / yr** | $83 |
| Steady-state, low capacity-use (year 11+) | **$11 M / yr** | $30 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$607 M cumulative** | $1,735 |
| Lifecycle envelope (yr 1–40, high scenario) | **$289 M cumulative** | $826 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.05 bn cumulative** | $2,998 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $15 M / yr → $25 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $413 M | 4.5% | 40 y, 10 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $103 M | — | — | — |
| **Total** | **100%** | **$516 M** | | | **$25 M / yr** |
...
| Traction energy (83.3 GWh / yr) | 17,608 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.8 GWh/yr + dedicated solar plant 27.4 MW / 65.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $329 k |
| Labour (321 FTE) | driverless roster: OCC/remote 69, station/platform 91, passenger service 49, fleet maintenance 54, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $701 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 17,608 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.9 M train-km / yr (20.8 M car-km / yr). On-site PV covers 26.8 GWh/yr and the dedicated solar plant adds 65.0 GWh/yr against 83.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 101 trainsets, 23 stations, 37.9 route-km, 3 lines, and 17,608 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 30.8 M |
| Annual paid trips / city resident | 209 | 335 | 88 |
| Farebox revenue | $25 M / yr | $41 M / yr | $11 M / yr |
| Station shop leases | $396 k / yr | $396 k / yr | $396 k / yr |
| Advertising boards | $646 k / yr | $646 k / yr | $646 k / yr |
| **Total revenue** | **$26 M / yr** | **$42 M / yr** | **$12 M / yr** |
...
| Operating surplus applied to debt support | -$15 M / yr | -$25 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $0 k / yr | **$25 M / yr** |
| Operating surplus after OPEX (before debt support) | $15 M / yr | $30 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,608 m² of station shop/kiosk leases at $10/m²/month and 696 advertising boards at $91/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $301 M | 58% of $516 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 48,308 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $494 M |
| Timetable-sized dedicated solar CAPEX | $22 M |
| **Reconciled project CAPEX** | **$516 M** |
| 15%–25% planning risk envelope | $593 M–$645 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-269433 k / $-189907 k |
| Low/high project IRR | -0.8% / 3.0% |
| Low/high steady-state DSCR | 0.58 / 1.18 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,591.31 train-km; 13,289.01 kWh consumed; 13,328.80 kWh charged; 33 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,250.37 train-km; 152,409.85 kWh consumed; 154,295.47 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 27 SoC warnings; 2 energy-adapted off-peak departures, maximum 12 min headway |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 2 interchange complexes, 12 civil segments, and 0 input findings |
