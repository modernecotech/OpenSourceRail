...
|---|---|---|---|---|
| line-1 | 20.0 km | 11 | 52 | E Outer ↔ SW Outer |
| line-2 | 14.2 km | 9 | 36 | E Outer ↔ W Mid |
| **Total** | **34.1 km** | **20 unique** | **88** | |
...
| Total fleet capacity | 31,680 AW2 pax (42,240 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 79 × 360 = **28,440 AW2 passengers** (37,920 AW3 crush)
- **Total fleet passenger capacity:** 88 × 360 = **31,680 AW2 passengers** (42,240 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **37.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 502 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 55 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 157 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 37.7 MW / 181 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 149 kWh | 253 kWh | 89 kWh | 5.0 km / 38 kWh |
| line-2 | 8 | 106 kWh | 172 kWh | 55 kWh | 5.0 km / 37 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 88 | $900 k | $79 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 264 | $60 k | $16 M |
| High sensitivity check | 264 | $120 k | $32 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 37,676 kW @ $700/kW | $26 M |
| Grid interconnection / PPA tie-in | 37,676 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 37.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 66.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$30 M** |
...
| Dedicated solar power plant | $30 M |
...
|---|---|---|
| Construction (years 1–10) | **$21 M / yr** | $52 |
| Steady-state, low capacity-use (year 11+) | **$9.3 M / yr** | $23 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$490 M cumulative** | $1,225 |
| Lifecycle envelope (yr 1–40, high scenario) | **$210 M cumulative** | $525 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$762 M cumulative** | $1,906 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.1 M / yr → $18 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $300 M | 4.5% | 40 y, 10 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $75 M | — | — | — |
| **Total** | **100%** | **$375 M** | | | **$18 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $13 M / yr = **$13 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($7.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (75.1 GWh / yr) | 15,875 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 17.7 GWh/yr + dedicated solar plant 37.7 MW / 66.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $452 k |
| Labour (266 FTE) | driverless roster: OCC/remote 57, station/platform 75, passenger service 33, fleet maintenance 48, infrastructure/energy 34, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $581 k |
| **OPEX subtotal** | | **$8.8 M / yr** |

_Annual service work: 15,875 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (18.8 M car-km / yr). On-site PV covers 17.7 GWh/yr and the dedicated solar plant adds 66.0 GWh/yr against 75.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 88 trainsets, 20 stations, 34.1 route-km, 2 lines, and 15,875 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 22.7 M |
| Annual paid trips / city resident | 122 | 196 | 57 |
| Farebox revenue | $17 M / yr | $27 M / yr | $7.9 M / yr |
| Station shop leases | $340 k / yr | $340 k / yr | $340 k / yr |
| Advertising boards | $549 k / yr | $549 k / yr | $549 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 204% | 320% | 100% |
...
| Operating surplus applied to debt support | -$9.1 M / yr | -$18 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.3 M / yr | $0 k / yr | **$18 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.1 M / yr | $19 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,096 m² of station shop/kiosk leases at $10/m²/month and 592 advertising boards at $91/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $15 M / yr | $24 M / yr | 21% of paid trips × $1.50 local spend proxy |
...
| Commerce | 9 major/terminal/interchange nodes | 27,755 trips/trading day; 9.2 M access-events/yr | 44,408 trips/trading day; 14.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $210 M | 56% of $375 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $337 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $34 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 33,712 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $30 M |
| **Reconciled project CAPEX** | **$375 M** |
| 15%–25% planning risk envelope | $431 M–$469 M |
| Annual OPEX | $8.8 M / yr |
| Low/high project NPV at 8% | $-204270 k / $-151253 k |
| Low/high project IRR | -1.5% / 2.3% |
| Low/high steady-state DSCR | 0.49 / 1.05 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,325.89 train-km; 9,928.19 kWh consumed; 10,128.81 kWh charged; 19 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,403.77 train-km; 122,830.15 kWh consumed; 125,239.16 kWh charged; 329 depot services completed (4 active at cutoff); minimum SoC 43%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 30.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 22.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 43.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.4% / 60% | pass |
| ten-hour single charging-pad outage | 23.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 20 line platforms, 2 interchange complexes, 19 civil segments, and 0 input findings |
