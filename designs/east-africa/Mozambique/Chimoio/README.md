...
**Country:** MZ · **Population:** 400,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$482 M (86.5%) of external capital** and **$623 M of external interest**. Capital plus saved interest totals **$1.10 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`chimoio.corridor.geojson`](chimoio.corridor.geojson).
...
| Anchor-weighted coverage | 55.7% |
| Route length (double track) | 34.1 km |
...
| Total fleet capacity | 29,520 AW2 pax (39,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 73 × 360 = **26,280 AW2 passengers** (35,040 AW3 crush)
- **Total fleet passenger capacity:** 82 × 360 = **29,520 AW2 passengers** (39,360 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 55.7%
- Catchment population: **≈ 222,800** (within ~800 m walk of a station)
...
| **Total installed** | **10** | **7,700 kW** | **44,500 kWh** |

Aggregate station-rail charging power: **5,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **40.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 488 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 47 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 37 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 930 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 15,875 train-km/day | One-way train journeys × route length |
| Annual service work | 6.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 206 MWh/day | 18.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 169 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 40.4 MW / 194 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 149 kWh | 220 kWh | 56 kWh | 7.0 km / 52 kWh |
| line-2 | 4 | 106 kWh | 163 kWh | 47 kWh | 7.0 km / 52 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (32.6 km @ $3.0 M/km) | $98 M |
| Elevated (1.5 km @ $12.0 M/km) | $18 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$121 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 82 | $900 k | $74 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 246 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 246 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 40,436 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 40,436 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 40.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 70.8 GWh/yr |
| **Dedicated solar plant subtotal** | | **$32 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 34.1 km × $0.050 M/km | $1.7 M |
...
| Dedicated solar power plant | $32 M |
| Residual train-control wayside + charging microgrids | $2.9 M |
| EPC overhead (7%) | $18 M |
| **CAPEX total** | **$310 M** |
| Per-route-km | $9.1 M / km |
| Per-capita (city pop) | $774 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $121 M | 15% | $18 M | $103 M |
| Stations | $54 M | 20% | $11 M | $43 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $74 M | 35% | $26 M | $48 M |
| Dedicated solar plant | $32 M | 45% | $15 M | $18 M |
| Residual signalling / train control | $1.7 M | 50% | $853 k | $853 k |
| Charging microgrids | $1.2 M | 40% | $480 k | $720 k |
| EPC / project services | $18 M | 15% | $2.7 M | $15 M |
| **Total city CAPEX** | **$310 M** | **24.3%** | **$75 M** | **$234 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh chimoio`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$75 M** | **$7.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$234 M** | **$23 M / yr** |
| of which planned local bond issuance | 60.5% of total CAPEX | $188 M | $19 M / yr |
| **Total city programme** | **100.0%** | **$310 M** | **$31 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $418 M | $343 M (82.0%) | $443 M | **$786 M** |
| **Default** | 2.00× | $557 M | $482 M (86.5%) | $623 M | **$1.10 bn** |
| High | 3.00× | $836 M | $761 M (91.0%) | $983 M | **$1.74 bn** |

At the default 2.00× case, OSR's $75 M external requirement is 86.5% below the illustrative foreign-company requirement of $557 M; the associated lifetime external-interest saving is $623 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$33 M / yr** | $83 |
| Steady-state, low capacity-use (year 11+) | **$21 M / yr** | $52 |
| Steady-state, high capacity-use (year 11+) | **$11 M / yr** | $26 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $76 |
| Lifecycle envelope (yr 1–40, low scenario) | **$956 M cumulative** | $2,389 |
| Lifecycle envelope (yr 1–40, high scenario) | **$651 M cumulative** | $1,627 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.25 bn cumulative** | $3,123 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.8 M / yr → $20 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $75 M | 4.5% | 40 y, 10 y grace | $4.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $188 M | 13.5% | 40 y, 10 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $47 M | — | — | — |
| **Total** | **100%** | **$310 M** | | | **$31 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.4 M / yr + local bonds $25 M / yr = **$29 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $3.6 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $85 k |
| Traction energy (75.1 GWh / yr) | 15,875 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 13.5 GWh/yr + dedicated solar plant 40.4 MW / 70.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $485 k |
| Labour (231 FTE) | driverless roster: OCC/remote 57, station/platform 45, passenger service 33, fleet maintenance 46, infrastructure/energy 31, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $505 k |
| **OPEX subtotal** | | **$7.7 M / yr** |

_Annual service work: 15,875 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (18.8 M car-km / yr). On-site PV covers 13.5 GWh/yr and the dedicated solar plant adds 70.8 GWh/yr against 75.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 82 trainsets, 12 stations, 34.1 route-km, 2 lines, and 15,875 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 20.7 M |
| Annual paid trips / city resident | 122 | 196 | 52 |
| Farebox revenue | $17 M / yr | $27 M / yr | $7.2 M / yr |
| Station shop leases | $194 k / yr | $194 k / yr | $194 k / yr |
| Advertising boards | $323 k / yr | $323 k / yr | $323 k / yr |
| **Total revenue** | **$17 M / yr** | **$28 M / yr** | **$7.7 M / yr** |
| Revenue / OPEX recovery | 227% | 360% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $31 M / yr | $31 M / yr | **$31 M / yr** |
| Operating surplus applied to debt support | -$9.8 M / yr | -$20 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $21 M / yr | $11 M / yr | **$31 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.8 M / yr | $20 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,768 m² of station shop/kiosk leases at $10/m²/month and 348 advertising boards at $91/board/month, with occupancy derates applied._
...
| Avoided road congestion | $9.0 M / yr | $14 M / yr | 113 M - 180 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.6 M / yr | $2.6 M / yr | 20.3–32.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $4.5 M / yr | $7.2 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $16 M / yr | $25 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $7.8 M / yr | $12 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$43 M / yr** | **$69 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 1 healthcare anchors | 10,848 trips/day; 4.0 M access-events/yr | 17,356 trips/day; 6.3 M access-events/yr |
| Commerce | 6 major/terminal/interchange nodes | 28,458 trips/trading day; 9.4 M access-events/yr | 45,533 trips/trading day; 15.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $234 M | 76% of $310 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $375 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $38 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 37,561 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $277 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$310 M** |
| Imported / external-capital requirement | $75 M (24.3%) |
| Local-content / local-funding requirement | $234 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $557 M; OSR saves $482 M (86.5%) |
| Lifetime external interest and combined financing saving | $623 M interest; $1.10 bn capital + interest |
| 15%–25% planning risk envelope | $356 M–$387 M |
| Annual OPEX | $7.7 M / yr |
| Low/high project NPV at 8% | $-156768 k / $-103751 k |
| Low/high project IRR | -0.3% / 3.6% |
| Low/high steady-state DSCR | 0.32 / 0.65 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,352.83 train-km; 10,129.86 kWh consumed; 8,073.13 kWh charged; 21 depot services completed; minimum SoC 70%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,145.41 train-km; 113,407.53 kWh consumed; 107,681.79 kWh charged; 332 depot services completed (4 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.4% of scheduled train-km delivered; 33 SoC warnings; 11 energy-adapted off-peak departures, maximum 16 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 95.4% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.6% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.4% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 78.9% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.7% / 90% | pass |
...
|---|---|
| ![Chimoio energy and battery simulation dashboard](engineering/screenshots/chimoio-simulation-dashboard.png) | ![Chimoio simulator network visualizer](engineering/screenshots/chimoio-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 12 line platforms, 2 interchange complexes, 19 civil segments, and 0 input findings |
...
|---|---|
| ![Chimoio QGIS engineering layers](engineering/screenshots/chimoio-qgis-engineering-map.png) | ![Chimoio SUMO timetable validation](engineering/screenshots/chimoio-sumo-validation.png) |
...
| [`chimoio.toml`](chimoio.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`chimoio-network-map.png`](chimoio-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`chimoio.corridor.geojson`](chimoio.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`chimoio.stations.json`](chimoio.stations.json) | Machine-readable station list |
| [`chimoio.design-quality.yaml`](chimoio.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug chimoio

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh chimoio
```
