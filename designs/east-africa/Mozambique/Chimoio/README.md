...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$452 M (86.2%) of external capital** and **$584 M of external interest**. Capital plus saved interest totals **$1.04 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (32.6 km @ $2.58 M/km) | $84 M |
| Elevated (1.5 km @ $9.75 M/km) | $15 M |
...
| Per-capita (city pop) | $729 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $104 M | 15% | $16 M | $88 M |
...
| EPC / project services | $17 M | 15% | $2.5 M | $14 M |
| **Total city CAPEX** | **$291 M** | **24.9%** | **$73 M** | **$219 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.9%** | **$73 M** | **$7.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.1%** | **$219 M** | **$22 M / yr** |
| of which planned local bond issuance | 60.1% of total CAPEX | $175 M | $18 M / yr |
| **Total city programme** | **100.0%** | **$291 M** | **$29 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $393 M | $321 M (81.6%) | $415 M | **$735 M** |
| **Default** | 2.00× | $525 M | $452 M (86.2%) | $584 M | **$1.04 bn** |
| High | 3.00× | $787 M | $714 M (90.8%) | $923 M | **$1.64 bn** |

At the default 2.00× case, OSR's $73 M external requirement is 86.2% below the illustrative foreign-company requirement of $525 M; the associated lifetime external-interest saving is $584 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$31 M / yr** | $78 |
| Steady-state, low capacity-use (year 11+) | **$19 M / yr** | $46 |
| Steady-state, high capacity-use (year 11+) | **$8.3 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$868 M cumulative** | $2,170 |
| Lifecycle envelope (yr 1–40, high scenario) | **$563 M cumulative** | $1,408 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.17 bn cumulative** | $2,930 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $10 M / yr → $20 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $73 M | 4.5% | 40 y, 10 y grace | $4.5 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $175 M | 13.5% | 40 y, 10 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $44 M | — | — | — |
| **Total** | **100%** | **$291 M** | | | **$29 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.3 M / yr + local bonds $24 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 19.7 M |
| Annual paid trips / city resident | 122 | 196 | 49 |
| Farebox revenue | $17 M / yr | $27 M / yr | $6.8 M / yr |
| Station shop leases | $194 k / yr | $194 k / yr | $194 k / yr |
| Advertising boards | $323 k / yr | $323 k / yr | $323 k / yr |
| **Total revenue** | **$17 M / yr** | **$28 M / yr** | **$7.3 M / yr** |
| Revenue / OPEX recovery | 238% | 377% | 100% |
...
| Operating surplus applied to debt support | -$10 M / yr | -$20 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $19 M / yr | $8.3 M / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $10 M / yr | $20 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $219 M | 75% of $291 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $350 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $35 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 35,079 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $259 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$291 M** |
| Imported / external-capital requirement | $73 M (24.9%) |
| Local-content / local-funding requirement | $219 M (75.1%) |
| Default foreign-turnkey external-capital comparison | $525 M; OSR saves $452 M (86.2%) |
| Lifetime external interest and combined financing saving | $584 M interest; $1.04 bn capital + interest |
| 15%–25% planning risk envelope | $335 M–$364 M |
| Annual OPEX | $7.3 M / yr |
| Low/high project NPV at 8% | $-142765 k / $-89748 k |
| Low/high project IRR | 0.2% / 4.0% |
| Low/high steady-state DSCR | 0.35 / 0.71 |
