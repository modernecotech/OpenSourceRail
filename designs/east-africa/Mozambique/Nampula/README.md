...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **95,904 – 112,320 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (49.1 km @ $2.0 M/km) | $98 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.7 km × $0.015 M/km | $2.6 M |
...
|---|---|---|
| Construction (years 1–10) | **$18 M / yr** | $22 |
| Steady-state, low-ridership (year 11+) | **$18 M / yr** | $23 |
| Steady-state, high-ridership (year 11+) | **$18 M / yr** | $23 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $23 |
| Lifecycle envelope (yr 1–35, low scenario) | **$632 M cumulative** | $790 |
| Lifecycle envelope (yr 1–35, high scenario) | **$632 M cumulative** | $790 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$632 M cumulative** | $790 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $157 M | 3.0% | 35 y, 10 y grace | $9.0 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $66 M | 13.5% | 35 y, 10 y grace | $9.2 M / yr |
| Government equity (no debt service) | 15% | $39 M | — | — | — |
| **Total** | **100%** | **$262 M** | | | **$18 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $4.7 M / yr + bonds $8.9 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($3.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 95,904 | 112,320 | 53,529 |
| Daily paid trips / catchment | 18% | 21% | 10% |
| Daily paid trips / city population | 12% | 14% | 7% |
| Annual paid trips | 35.0 M | 41.0 M | 19.5 M |
| Farebox revenue | $9.1 M / yr | $11 M / yr | $5.1 M / yr |
| Station shop leases | $461 k / yr | $461 k / yr | $461 k / yr |
| Advertising boards | $769 k / yr | $769 k / yr | $769 k / yr |
| **Total revenue** | **$10 M / yr** | **$12 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX recovery | 164% | 188% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $18 M / yr | $18 M / yr | **$18 M / yr** |
| Operating surplus after OPEX | $4.0 M / yr | $5.6 M / yr | $0 / yr |
