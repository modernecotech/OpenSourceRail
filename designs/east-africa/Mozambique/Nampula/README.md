...
| Bucket | Value |
|---|---|
| At-grade (49.1 km @ €3.5 M/km) | €172 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.7 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–10) | **€38 M / yr** | €47 |
| Steady-state, low-ridership (year 11+) | **€51 M / yr** | €64 |
| Steady-state, high-ridership (year 11+) | **€48 M / yr** | €60 |
| Lifecycle envelope (yr 1–35, low scenario) | **€1.66 bn cumulative** | €2,069 |
| Lifecycle envelope (yr 1–35, high scenario) | **€1.58 bn cumulative** | €1,978 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€11 M / yr (low) → €8.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €341 M | 3.0% | 35 y, 10 y grace | €20 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €142 M | 13.5% | 35 y, 10 y grace | €20 M / yr |
| Government equity (no debt service) | 15% | €85 M | — | — | — |
| **Total** | **100%** | **€568 M** | | | **€40 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €10 M / yr + bonds €19 M / yr = **€29 M / yr** total — plus the equity tranche amortised across construction (€8.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (322 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €647 k |
...
| Farebox / OPEX recovery | 20% | 41% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €11 M / yr | €8.5 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€51 M / yr** | **€48 M / yr** |
