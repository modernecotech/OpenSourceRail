...
|---|---|---|---|---|
| line-1 | 17.0 km | 11 | 17 | W Outer ↔ SE Mid |
| line-2 | 22.4 km | 13 | 23 | SE Outer ↔ NW Outer |
| line-3 | 12.3 km | 6 | 14 | NE Mid ↔ SE Outer |
| **Total** | **51.7 km** | **30 unique** | **54** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **53,280 – 79,920 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (49.1 km @ $0.85 M/km) | $42 M |
| Elevated (2.2 km @ $4.0 M/km) | $8.8 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.7 km × $0.015 M/km | $776 k |
...
| Per-capita (city pop) | $175 / person |
...
|---|---|---|
| Construction (years 1–10) | **$9.3 M / yr** | $12 |
| Steady-state, low-ridership (year 11+) | **$6.5 M / yr** | $8 |
| Steady-state, high-ridership (year 11+) | **$1.2 M / yr** | $2 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$257 M cumulative** | $321 |
| Lifecycle envelope (yr 1–35, high scenario) | **$124 M cumulative** | $155 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$93 M cumulative** | $117 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $84 M | 3.0% | 35 y, 10 y grace | $4.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $35 M | 13.5% | 35 y, 10 y grace | $4.9 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$140 M** | | | **$9.8 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.5 M / yr + bonds $4.7 M / yr = **$7.2 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (322 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $703 k |
...
|---|---|---|---|
| Daily paid trips | 64,000 | 120,000 | 132,833 |
| Daily paid trips / population | 8% | 15% | 17% |
| Annual paid trips | 23.4 M | 43.8 M | 48.5 M |
| Farebox revenue | $6.1 M / yr | $11 M / yr | $13 M / yr |
| Station shop leases | $461 k / yr | $461 k / yr | $461 k / yr |
| Advertising boards | $769 k / yr | $769 k / yr | $769 k / yr |
| **Total revenue** | **$7.3 M / yr** | **$13 M / yr** | **$14 M / yr** |
| Revenue / OPEX + debt-service recovery | 53% | 91% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $6.5 M / yr | $1.2 M / yr | **$0 / yr** |
