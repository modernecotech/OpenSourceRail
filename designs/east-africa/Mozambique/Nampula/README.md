...
|---|---|---|
| Construction (years 1–10) | **$41 M / yr** | $52 |
| Steady-state, low-ridership (year 11+) | **$49 M / yr** | $62 |
| Steady-state, high-ridership (year 11+) | **$43 M / yr** | $54 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $54 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.65 bn cumulative** | $2,061 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.50 bn cumulative** | $1,872 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.50 bn cumulative** | $1,872 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.0 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $373 M | 3.0% | 35 y, 10 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $155 M | 13.5% | 35 y, 10 y grace | $22 M / yr |
| Government equity (no debt service) | 15% | $93 M | — | — | — |
| **Total** | **100%** | **$621 M** | | | **$43 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $21 M / yr = **$32 M / yr** total — plus the equity tranche amortised across construction ($9.3 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 95,904 | 159,840 | 159,535 |
| Daily paid trips / catchment | 18% | 30% | 30% |
| Daily paid trips / city population | 12% | 20% | 20% |
| Annual paid trips | 35.0 M | 58.3 M | 58.2 M |
| Farebox revenue | $9.1 M / yr | $15 M / yr | $15 M / yr |
| Station shop leases | $461 k / yr | $461 k / yr | $461 k / yr |
| Advertising boards | $769 k / yr | $769 k / yr | $769 k / yr |
| **Total revenue** | **$10 M / yr** | **$16 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 63% | 100% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $49 M / yr | $43 M / yr | **$43 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $29 k / yr | $0 / yr |
