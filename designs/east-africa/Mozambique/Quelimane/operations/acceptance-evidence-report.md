# Quelimane Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 244 |
| Manufacturing material/BOM rows | 3,492 |
| Manufacturing QA verification rows | 244 |
| Construction QA action rows | 226 |
| Maintenance handover schedule rows | 289 |
| Manufacturing rows with material refs | 244 / 244 |
| Manufacturing rows with verification refs | 244 / 244 |
| Manufacturing rows linked to QA actions | 244 / 244 |
...
|---|---:|
| `project_kit` | 450 |
| `rolling_stock_bom` | 2,860 |
| `rolling_stock_cots_fitout` | 182 |
...
| `qa-10-carbody-structure` | 52 |
| `qa-11-bogie-wheelset` | 26 |
| `qa-12-traction-brake-battery` | 26 |
| `qa-13-passenger-systems` | 26 |
| `qa-15-first-article-trainset` | 26 |
