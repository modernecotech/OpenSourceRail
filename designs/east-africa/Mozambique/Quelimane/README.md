...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$140 M (86.6%) of external capital** and **$181 M of external interest**. Capital plus saved interest totals **$321 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 20 × 3-car trainsets |
...
| Spare + cold-reserve | 3 × 3-car trainsets |
| Peak headway | 3 min |
...
| Total fleet capacity | 8,280 AW2 pax (11,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 20 × 360 = **7,200 AW2 passengers** (9,600 AW3 crush)
- **Total fleet passenger capacity:** 23 × 360 = **8,280 AW2 passengers** (11,040 AW3 crush, incl. service rotation + spare + reserve)
- **Peak frequency:** 20 trains/hour/direction (3-min headway)
- **Peak capacity per line per direction:** 360 × 20 = **7,200 pphpd**
- **Network peak throughput (all lines, both directions):** 1 lines × 2 directions × 7,200 = **14,400 passengers/hour**
- **Scheduled one-way train journeys:** **465/day**
- **Daily theoretical capacity from timetable:** 465 scheduled one-way train journeys/day × 360 AW2 pax = **167,400 passenger-trips/day**
- **Practical daily service capacity** (80% load factor): ≈ **133,920 passenger-trips/day**
- **Planning annual paid-trip scenario** (capacity-led): ≈ **24.4 – 39.1 M paid trips/year** at 50%–80% practical capacity utilisation
...
| Standard | 1 | 300 kW | 500 kWh |
| Terminal | 1 | 300 kW | 500 kWh |
| **Total installed** | **5** | **6,200 kW** | **42,000 kWh** |

Aggregate station-rail charging power: **2,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **7.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 23.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 517 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 46 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 30 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 465 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 4,774 train-km/day | One-way train journeys × route length |
| Annual service work | 1.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 62 MWh/day | 5.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 32 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 7.7 MW / 37 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 77 kWh | 131 kWh | 46 kWh | 3.1 km / 23 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (10.2 km @ $2.58 M/km) | $26 M |
| Elevated (0.1 km @ $9.75 M/km) | $1.0 M |
| **Civil subtotal** | **$27 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 23 | $900 k | $21 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 69 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 69 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 7,693 kW @ $700/kW | $5.4 M |
| Grid interconnection / PPA tie-in | 7,693 kW @ $100/kW | $769 k |
| Annual generation proxy | 7.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 13.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$6.2 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 10.3 km × $0.050 M/km | $513 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $650 k |
| EPC integration + project management (7%) | on subtotal | $5.5 M |
...
| Dedicated solar power plant | $6.2 M |
| Residual train-control wayside + charging microgrids | $1.2 M |
| EPC overhead (7%) | $5.5 M |
| **CAPEX total** | **$90 M** |
| Per-route-km | $8.7 M / km |
| Per-capita (city pop) | $256 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $27 M | 15% | $4.1 M | $23 M |
| Stations | $21 M | 20% | $4.2 M | $17 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $21 M | 35% | $7.2 M | $13 M |
| Dedicated solar plant | $6.2 M | 45% | $2.8 M | $3.4 M |
| Residual signalling / train control | $513 k | 50% | $257 k | $257 k |
| Charging microgrids | $650 k | 40% | $260 k | $390 k |
| EPC / project services | $5.5 M | 15% | $820 k | $4.6 M |
| **Total city CAPEX** | **$90 M** | **24.1%** | **$22 M** | **$68 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh quelimane`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$22 M** | **$2.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$68 M** | **$6.8 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $54 M | $5.4 M / yr |
| **Total city programme** | **100.0%** | **$90 M** | **$9.0 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $121 M | $100 M (82.1%) | $129 M | **$228 M** |
| **Default** | 2.00× | $162 M | $140 M (86.6%) | $181 M | **$321 M** |
| High | 3.00× | $242 M | $221 M (91.1%) | $285 M | **$506 M** |

At the default 2.00× case, OSR's $22 M external requirement is 86.6% below the illustrative foreign-company requirement of $162 M; the associated lifetime external-interest saving is $181 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$9.7 M / yr** | $28 |
| Steady-state, low capacity-use (year 11+) | **$2.5 M / yr** | $7 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$8.9 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$171 M cumulative** | $487 |
| Lifecycle envelope (yr 1–40, high scenario) | **$97 M cumulative** | $277 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$363 M cumulative** | $1,036 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.4 M / yr → $8.9 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $22 M | 4.5% | 40 y, 10 y grace | $1.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $54 M | 13.5% | 40 y, 10 y grace | $7.5 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $14 M | — | — | — |
| **Total** | **100%** | **$90 M** | | | **$8.9 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $974 k / yr + local bonds $7.4 M / yr = **$8.3 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($1.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $828 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $1.1 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $26 k |
| Traction energy (22.6 GWh / yr) | 4,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 10.9 GWh/yr + dedicated solar plant 7.7 MW / 13.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $92 k |
| Labour (107 FTE) | driverless roster: OCC/remote 25, station/platform 21, passenger service 17, fleet maintenance 14, infrastructure/energy 13, admin/training 17; no train drivers × country median × 12 × engineer-premium 1.4 | $234 k |
| **OPEX subtotal** | | **$2.3 M / yr** |

_Annual service work: 4,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 1.9 M train-km / yr (5.6 M car-km / yr). On-site PV covers 10.9 GWh/yr and the dedicated solar plant adds 13.5 GWh/yr against 22.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 23 trainsets, 5 stations, 10.3 route-km, 1 lines, and 4,774 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (133,920 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the external/local CAPEX funding sources, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 12% |
| Annual paid trips | 24.4 M | 39.1 M | 6.0 M |
| Annual paid trips / city resident | 70 | 112 | 17 |
| Farebox revenue | $8.5 M / yr | $14 M / yr | $2.1 M / yr |
| Station shop leases | $86 k / yr | $86 k / yr | $86 k / yr |
| Advertising boards | $145 k / yr | $145 k / yr | $145 k / yr |
| **Total revenue** | **$8.7 M / yr** | **$14 M / yr** | **$2.3 M / yr** |
| Revenue / OPEX recovery | 378% | 598% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $8.9 M / yr | $8.9 M / yr | **$8.9 M / yr** |
| Operating surplus applied to debt support | -$6.4 M / yr | -$8.9 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.5 M / yr | $0 k / yr | **$8.9 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.4 M / yr | $11 M / yr | $0 / yr |

_Commercial-revenue assumptions: 784 m² of station shop/kiosk leases at $10/m²/month and 156 advertising boards at $91/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $2.4 M / yr | $3.9 M / yr | 16 min/trip × $0.38/h value-of-time proxy |
| Avoided road congestion | $2.7 M / yr | $4.4 M / yr | 34 M - 54 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $489 k / yr | $783 k / yr | 6.1–9.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $1.4 M / yr | $2.2 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $8.9 M / yr | $14 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $4.0 M / yr | $6.3 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$20 M / yr** | **$32 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 4,486 trips/school day; 1.0 M access-events/yr | 7,178 trips/school day; 1.6 M access-events/yr |
| Healthcare | 0 healthcare anchors | 4,018 trips/day; 1.5 M access-events/yr | 6,428 trips/day; 2.3 M access-events/yr |
| Commerce | 4 major/terminal/interchange nodes | 16,338 trips/trading day; 5.4 M access-events/yr | 26,141 trips/trading day; 8.6 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 7,232 trips/activity day; 2.2 M access-events/yr | 11,571 trips/activity day; 3.5 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $68 M | 76% of $90 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $109 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $11 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 10,917 job-years | retained CAPEX ÷ (4.0 × median annual income) |
| Annual paid-trip capacity used in revenue model | 24.4 M - 39.1 M trips/yr | 50%-80% of practical service capacity |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $84 M |
| Timetable-sized dedicated solar CAPEX | $6.2 M |
| **Reconciled project CAPEX** | **$90 M** |
| Imported / external-capital requirement | $22 M (24.1%) |
| Local-content / local-funding requirement | $68 M (75.9%) |
| Default foreign-turnkey external-capital comparison | $162 M; OSR saves $140 M (86.6%) |
| Lifetime external interest and combined financing saving | $181 M interest; $321 M capital + interest |
| 15%–25% planning risk envelope | $103 M–$112 M |
| Annual OPEX | $2.3 M / yr |
| Low/high project NPV at 8% | $-26870 k / $-361 k |
| Low/high project IRR | 4.2% / 8.0% |
| Low/high steady-state DSCR | 0.72 / 1.30 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 460.96 train-km; 3,451.66 kWh consumed; 3,480.82 kWh charged; 12 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 4,967.30 train-km; 37,194.69 kWh consumed; 37,791.49 kWh charged; 162 depot services completed (2 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 42.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 21.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 53.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.2% / 60% | pass |
...
|---|---|
| ![Quelimane energy and battery simulation dashboard](engineering/screenshots/quelimane-simulation-dashboard.png) | ![Quelimane simulator network visualizer](engineering/screenshots/quelimane-network-visualizer.png) |
...
|---|---|
| SUMO | 4/4 screening services arrived; 0 input findings; status `completed` |
| QGIS/GDAL | GeoPackage generated with 1 corridors, 5 line platforms, 0 interchange complexes, 9 civil segments, and 0 input findings |
...
|---|---|
| ![Quelimane QGIS engineering layers](engineering/screenshots/quelimane-qgis-engineering-map.png) | ![Quelimane SUMO timetable validation](engineering/screenshots/quelimane-sumo-validation.png) |
...
scripts/regenerate-city.sh quelimane
```
