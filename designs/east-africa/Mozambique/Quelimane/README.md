...
| Revenue fleet | 23 × 3-car trainsets |
| Revenue fleet passenger capacity | 8,280 AW2 pax (11,040 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 10.3 km | 7 | 26 | NE Outer ↔ W Outer |
| **Total** | **10.3 km** | **7 unique** | **26** | |
...
| Revenue fleet capacity | 8,280 AW2 pax (11,040 AW3 crush) |
| Total fleet capacity | 9,360 AW2 pax (12,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 23 × 360 = **8,280 AW2 passengers** (11,040 AW3 crush)
- **Total fleet passenger capacity:** 26 × 360 = **9,360 AW2 passengers** (12,480 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **3,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **7.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 31.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 523 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 54 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 29 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 7.0 MW / 34 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 77 kWh | 139 kWh | 54 kWh | 2.3 km / 17 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 26 | $900 k | $23 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 78 | $60 k | $4.7 M |
| High sensitivity check | 78 | $120 k | $9.4 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 7,003 kW @ $700/kW | $4.9 M |
| Grid interconnection / PPA tie-in | 7,003 kW @ $100/kW | $700 k |
| Annual generation proxy | 7.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 12.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$5.6 M** |
...
| EPC integration + project management (7%) | on subtotal | $6.8 M |
...
| Depots | $8.0 M |
| Rolling stock | $23 M |
| Railway production plant | $4.7 M |
| Dedicated solar power plant | $5.6 M |
| Residual train-control wayside + charging microgrids | $1.4 M |
| EPC overhead (7%) | $6.8 M |
| **CAPEX total** | **$110 M** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $313 / person |
...
|---|---|---|
| Construction (years 1–10) | **$6.1 M / yr** | $18 |
| Steady-state, low capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$5.4 M / yr** | $15 |
| Lifecycle envelope (yr 1–40, low scenario) | **$61 M cumulative** | $175 |
| Lifecycle envelope (yr 1–40, high scenario) | **$61 M cumulative** | $175 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$223 M cumulative** | $637 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $88 M | 4.5% | 40 y, 10 y grace | $5.4 M / yr |
| Government equity (no debt service) | 20% | $22 M | — | — | — |
| **Total** | **100%** | **$110 M** | | | **$5.4 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $3.9 M / yr = **$3.9 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($2.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $936 k |
...
| Traction energy (22.6 GWh / yr) | 4,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 11.9 GWh/yr + dedicated solar plant 7.0 MW / 12.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $84 k |
| Labour (115 FTE) | driverless roster: OCC/remote 25, station/platform 27, passenger service 17, fleet maintenance 15, infrastructure/energy 14, admin/training 17; no train drivers × country median × 12 × engineer-premium 1.4 | $251 k |
| **OPEX subtotal** | | **$2.7 M / yr** |

_Annual service work: 4,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 1.9 M train-km / yr (5.6 M car-km / yr). On-site PV covers 11.9 GWh/yr and the dedicated solar plant adds 12.3 GWh/yr against 22.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 26 trainsets, 7 stations, 10.3 route-km, 1 lines, and 4,774 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 24.4 M | 39.1 M | 6.8 M |
| Annual paid trips / city resident | 70 | 112 | 19 |
| Farebox revenue | $8.5 M / yr | $14 M / yr | $2.3 M / yr |
| Station shop leases | $116 k / yr | $116 k / yr | $116 k / yr |
| Advertising boards | $193 k / yr | $193 k / yr | $193 k / yr |
| **Total revenue** | **$8.8 M / yr** | **$14 M / yr** | **$2.7 M / yr** |
| Revenue / OPEX recovery | 331% | 523% | 100% |
...
| Operating surplus after OPEX (before debt support) | $6.1 M / yr | $11 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,056 m² of station shop/kiosk leases at $10/m²/month and 208 advertising boards at $91/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $8.6 M / yr | $14 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $3.9 M / yr | $6.2 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$20 M / yr** | **$31 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 0 education anchors | 2,678 trips/school day; 0.6 M access-events/yr | 4,285 trips/school day; 0.9 M access-events/yr |
| Healthcare | 1 healthcare anchors | 5,424 trips/day; 2.0 M access-events/yr | 8,678 trips/day; 3.2 M access-events/yr |
| Commerce | 5 major/terminal/interchange nodes | 15,736 trips/trading day; 5.2 M access-events/yr | 25,177 trips/trading day; 8.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $62 M | 57% of $110 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $99 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $9.9 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 9,965 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $104 M |
| Timetable-sized dedicated solar CAPEX | $5.6 M |
| **Reconciled project CAPEX** | **$110 M** |
| 15%–25% planning risk envelope | $126 M–$137 M |
| Annual OPEX | $2.7 M / yr |
| Low/high project NPV at 8% | $-41571 k / $-15063 k |
| Low/high project IRR | 2.7% / 6.4% |
| Low/high steady-state DSCR | 1.14 / 2.08 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 453.62 train-km; 3,396.66 kWh consumed; 3,597.62 kWh charged; 12 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 4,962.40 train-km; 37,158.03 kWh consumed; 37,899.27 kWh charged; 162 depot services completed (2 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 80.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 67.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 83.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 53.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 1 corridors, 7 line platforms, 0 interchange complexes, 9 civil segments, and 0 input findings |
