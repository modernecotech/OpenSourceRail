...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **35,245 – 58,743 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (52.2 km @ $2.0 M/km) | $104 M |
...
|---|---|---|
| Construction (years 1–10) | **$19 M / yr** | $35 |
| Steady-state, low-ridership (year 11+) | **$21 M / yr** | $39 |
| Steady-state, high-ridership (year 11+) | **$20 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $37 |
| Lifecycle envelope (yr 1–35, low scenario) | **$710 M cumulative** | $1,328 |
| Lifecycle envelope (yr 1–35, high scenario) | **$678 M cumulative** | $1,268 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$678 M cumulative** | $1,268 |

_Population basis: 535,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.3 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $169 M | 3.0% | 35 y, 10 y grace | $9.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $70 M | 13.5% | 35 y, 10 y grace | $9.9 M / yr |
| Government equity (no debt service) | 15% | $42 M | — | — | — |
| **Total** | **100%** | **$281 M** | | | **$20 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $5.1 M / yr + bonds $9.5 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($4.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
