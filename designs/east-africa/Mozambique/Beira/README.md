...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$580 M (86.3%) of external capital** and **$750 M of external interest**. Capital plus saved interest totals **$1.33 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Total fleet capacity | 34,560 AW2 pax (46,080 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 86 × 360 = **30,960 AW2 passengers** (41,280 AW3 crush)
- **Total fleet passenger capacity:** 96 × 360 = **34,560 AW2 passengers** (46,080 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 34.0%
- Catchment population: **≈ 181,900** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **53.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 500 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 20,843 train-km/day | One-way train journeys × route length |
| Annual service work | 8.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 270 MWh/day | 24.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 222 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 53.1 MW / 255 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 131 kWh | 204 kWh | 60 kWh | 3.7 km / 28 kWh |
| line-2 | 6 | 91 kWh | 147 kWh | 47 kWh | 3.0 km / 23 kWh |
| line-3 | 5 | 113 kWh | 184 kWh | 59 kWh | 5.4 km / 40 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (43.4 km @ $2.58 M/km) | $112 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 96 | $900 k | $86 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 53,101 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 53,101 kW @ $100/kW | $5.3 M |
| Annual generation proxy | 53.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 93.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$42 M** |
...
| Per-capita (city pop) | $698 / person |
...
| Rolling stock | $86 M | 35% | $30 M | $56 M |
| Dedicated solar plant | $42 M | 45% | $19 M | $23 M |
| Residual signalling / train control | $2.2 M | 50% | $1.1 M | $1.1 M |
| Charging microgrids | $2.0 M | 40% | $800 k | $1.2 M |
| EPC / project services | $22 M | 15% | $3.2 M | $18 M |
| **Total city CAPEX** | **$374 M** | **24.7%** | **$92 M** | **$281 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$92 M** | **$9.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$281 M** | **$28 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $225 M | $23 M / yr |
| **Total city programme** | **100.0%** | **$374 M** | **$37 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $504 M | $412 M (81.7%) | $533 M | **$945 M** |
| **Default** | 2.00× | $673 M | $580 M (86.3%) | $750 M | **$1.33 bn** |
| High | 3.00× | $1.01 bn | $917 M (90.9%) | $1.18 bn | **$2.10 bn** |

At the default 2.00× case, OSR's $92 M external requirement is 86.3% below the illustrative foreign-company requirement of $673 M; the associated lifetime external-interest saving is $750 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$40 M / yr** | $75 |
| Steady-state, low capacity-use (year 11+) | **$20 M / yr** | $37 |
| Steady-state, high capacity-use (year 11+) | **$4.5 M / yr** | $8 |
| Steady-state, operating-neutral revenue case | **$37 M / yr** | $69 |
| Lifecycle envelope (yr 1–40, low scenario) | **$994 M cumulative** | $1,858 |
| Lifecycle envelope (yr 1–40, high scenario) | **$537 M cumulative** | $1,003 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.50 bn cumulative** | $2,812 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $92 M | 4.5% | 40 y, 10 y grace | $5.7 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $225 M | 13.5% | 40 y, 10 y grace | $31 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $56 M | — | — | — |
| **Total** | **100%** | **$374 M** | | | **$37 M / yr** |
...
| Traction energy (98.6 GWh / yr) | 20,843 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 17.7 GWh/yr + dedicated solar plant 53.1 MW / 93.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $637 k |
| Labour (299 FTE) | driverless roster: OCC/remote 65, station/platform 67, passenger service 49, fleet maintenance 57, infrastructure/energy 40, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $653 k |
| **OPEX subtotal** | | **$9.2 M / yr** |

_Annual service work: 20,843 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.2 M train-km / yr (24.6 M car-km / yr). On-site PV covers 17.7 GWh/yr and the dedicated solar plant adds 93.0 GWh/yr against 98.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 96 trainsets, 18 stations, 44.8 route-km, 3 lines, and 20,843 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 137 | 219 | 45 |
| Farebox revenue | $25 M / yr | $41 M / yr | $8.4 M / yr |
| Station shop leases | $310 k / yr | $310 k / yr | $310 k / yr |
| Advertising boards | $516 k / yr | $516 k / yr | $516 k / yr |
| **Total revenue** | **$26 M / yr** | **$41 M / yr** | **$9.2 M / yr** |
| Revenue / OPEX recovery | 284% | 449% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $20 M / yr | $4.5 M / yr | **$37 M / yr** |
...
| **Annual quantified benefit / activity proxy** | **$63 M / yr** | **$101 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $281 M | 75% of $374 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $450 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $45 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 45,108 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $331 M |
| Timetable-sized dedicated solar CAPEX | $42 M |
| **Reconciled project CAPEX** | **$374 M** |
| Imported / external-capital requirement | $92 M (24.7%) |
| Local-content / local-funding requirement | $281 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $673 M; OSR saves $580 M (86.3%) |
| Lifetime external interest and combined financing saving | $750 M interest; $1.33 bn capital + interest |
| 15%–25% planning risk envelope | $430 M–$467 M |
| Annual OPEX | $9.2 M / yr |
| Low/high project NPV at 8% | $-162034 k / $-82508 k |
| Low/high project IRR | 1.6% / 5.3% |
| Low/high steady-state DSCR | 0.46 / 0.88 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,827.07 train-km; 13,680.91 kWh consumed; 12,597.83 kWh charged; 33 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,819.32 train-km; 155,893.33 kWh consumed; 157,216.33 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.9% of scheduled train-km delivered; 75 SoC warnings; 7 energy-adapted off-peak departures, maximum 15 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 99.7% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 97.6% / 90% | pass |
| 50% charging-contact availability | 20.0% | 99.9% / 90% | pass |
...
|---|---|
| ![Beira energy and battery simulation dashboard](engineering/screenshots/beira-simulation-dashboard.png) | ![Beira simulator network visualizer](engineering/screenshots/beira-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 18 line platforms, 1 interchange complexes, 19 civil segments, and 0 input findings |
...
|---|---|
| ![Beira QGIS engineering layers](engineering/screenshots/beira-qgis-engineering-map.png) | ![Beira SUMO timetable validation](engineering/screenshots/beira-sumo-validation.png) |
...
scripts/regenerate-city.sh beira
```
