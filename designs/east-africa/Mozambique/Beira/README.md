...
| Per-capita (city pop) | $1,260 / person |
...
|---|---|---|
| Construction (years 1–10) | **$45 M / yr** | $84 |
| Steady-state, low-ridership (year 11+) | **$59 M / yr** | $110 |
| Steady-state, high-ridership (year 11+) | **$57 M / yr** | $106 |
| Steady-state, operating-neutral revenue case | **$47 M / yr** | $88 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.92 bn cumulative** | $3,596 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.87 bn cumulative** | $3,492 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.62 bn cumulative** | $3,037 |

_Population basis: 535,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $9.7 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $405 M | 3.0% | 35 y, 10 y grace | $23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $169 M | 13.5% | 35 y, 10 y grace | $24 M / yr |
| Government equity (no debt service) | 15% | $101 M | — | — | — |
| **Total** | **100%** | **$674 M** | | | **$47 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $23 M / yr = **$35 M / yr** total — plus the equity tranche amortised across construction ($10 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 35,245 | 58,743 | 161,388 |
| Daily paid trips / catchment | 18% | 30% | 82% |
| Daily paid trips / city population | 7% | 11% | 30% |
| Annual paid trips | 12.9 M | 21.4 M | 58.9 M |
| Farebox revenue | $3.3 M / yr | $5.6 M / yr | $15 M / yr |
| Station shop leases | $762 k / yr | $762 k / yr | $762 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$5.3 M / yr** | **$7.5 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 31% | 44% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $59 M / yr | $57 M / yr | **$47 M / yr** |
