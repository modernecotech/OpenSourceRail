...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **19,530 – 32,550 trips/day**
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 17.9 km × $0.015 M/km | $886 k |
...
| Steady-state, low-ridership (year 11+) | **$7.9 M / yr** | $32 |
| Steady-state, high-ridership (year 11+) | **$7.8 M / yr** | $31 |
| Steady-state, operating-neutral revenue case | **$7.8 M / yr** | $31 |
| Lifecycle envelope (yr 1–35, low scenario) | **$271 M cumulative** | $1,085 |
| Lifecycle envelope (yr 1–35, high scenario) | **$268 M cumulative** | $1,072 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$268 M cumulative** | $1,072 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $128 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $67 M | 3.0% | 35 y, 10 y grace | $3.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $28 M | 13.5% | 35 y, 10 y grace | $3.9 M / yr |
| Government equity (no debt service) | 15% | $17 M | — | — | — |
| **Total** | **100%** | **$111 M** | | | **$7.8 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.0 M / yr + bonds $3.8 M / yr = **$5.8 M / yr** total — plus the equity tranche amortised across construction ($1.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 19,530 | 32,550 | 20,878 |
| Daily paid trips / catchment | 18% | 30% | 19% |
| Daily paid trips / city population | 8% | 13% | 8% |
| Annual paid trips | 7.1 M | 11.9 M | 7.6 M |
| Farebox revenue | $1.9 M / yr | $3.1 M / yr | $2.0 M / yr |
| Station shop leases | $212 k / yr | $212 k / yr | $212 k / yr |
| Advertising boards | $349 k / yr | $349 k / yr | $349 k / yr |
| **Total revenue** | **$2.4 M / yr** | **$3.6 M / yr** | **$2.5 M / yr** |
| Revenue / OPEX recovery | 95% | 144% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $7.9 M / yr | $7.8 M / yr | **$7.8 M / yr** |
