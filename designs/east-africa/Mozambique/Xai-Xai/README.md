...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **27,125 – 48,825 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$5.9 M / yr** | $23 |
| Steady-state, low-ridership (year 11+) | **$10 M / yr** | $42 |
| Steady-state, high-ridership (year 11+) | **$7.7 M / yr** | $31 |
| Steady-state, operating-neutral revenue case | **$6.5 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$371 M cumulative** | $1,484 |
| Lifecycle envelope (yr 1–40, high scenario) | **$289 M cumulative** | $1,154 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$254 M cumulative** | $1,018 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.9 M / yr → $1.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $117 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $146 M | 2.0% | 40 y, 10 y grace | $6.5 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 13.5% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $29 M | — | — | — |
| **Total** | **100%** | **$293 M** | | | **$6.5 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $2.9 M / yr + fallback bonds $0 k / yr = **$2.9 M / yr** total. The $117 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($2.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (37.5 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (119 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $260 k |
| **OPEX subtotal** | | **$7.9 M / yr** |

_Annual fleet utilisation: 38 revenue trainsets × 20.5 h/day × 365 d/yr × 22 km/h commercial × 75% revenue factor = 4.7 M train-km / yr (~123 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 27,125 | 48,825 | 57,828 |
| Daily paid trips / catchment | 25% | 45% | 53% |
| Daily paid trips / city population | 11% | 20% | 23% |
| Annual paid trips | 9.9 M | 17.8 M | 21.1 M |
| Farebox revenue | $3.4 M / yr | $6.2 M / yr | $7.3 M / yr |
| Station shop leases | $212 k / yr | $212 k / yr | $212 k / yr |
| Advertising boards | $349 k / yr | $349 k / yr | $349 k / yr |
| **Total revenue** | **$4.0 M / yr** | **$6.7 M / yr** | **$7.9 M / yr** |
| Revenue / OPEX recovery | 51% | 86% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $10 M / yr | $7.7 M / yr | **$6.5 M / yr** |
