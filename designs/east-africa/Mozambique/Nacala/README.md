...
| Per-capita (city pop) | $1,152 / person |
...
|---|---|---|
| Construction (years 1–10) | **$23 M / yr** | $77 |
| Steady-state, low-ridership (year 11+) | **$26 M / yr** | $87 |
| Steady-state, high-ridership (year 11+) | **$24 M / yr** | $80 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $80 |
| Lifecycle envelope (yr 1–35, low scenario) | **$884 M cumulative** | $2,948 |
| Lifecycle envelope (yr 1–35, high scenario) | **$833 M cumulative** | $2,775 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$833 M cumulative** | $2,775 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $207 M | 3.0% | 35 y, 10 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $86 M | 13.5% | 35 y, 10 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $52 M | — | — | — |
| **Total** | **100%** | **$345 M** | | | **$24 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.2 M / yr + bonds $12 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($5.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 43,200 | 72,000 | 65,046 |
| Daily paid trips / catchment | 18% | 30% | 27% |
| Daily paid trips / city population | 14% | 24% | 22% |
| Annual paid trips | 15.8 M | 26.3 M | 23.7 M |
| Farebox revenue | $4.1 M / yr | $6.8 M / yr | $6.2 M / yr |
| Station shop leases | $470 k / yr | $470 k / yr | $470 k / yr |
| Advertising boards | $757 k / yr | $757 k / yr | $757 k / yr |
| **Total revenue** | **$5.3 M / yr** | **$8.1 M / yr** | **$7.4 M / yr** |
| Revenue / OPEX recovery | 72% | 109% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $26 M / yr | $24 M / yr | **$24 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $660 k / yr | $0 / yr |
