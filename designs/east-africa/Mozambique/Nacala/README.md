...
| Revenue fleet | 104 × 2-car trainsets |
| Revenue fleet passenger capacity | 24,960 AW2 pax (33,280 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 14.5 km | 9 | 42 | S Mid ↔ NE Outer |
| line-2 | 12.1 km | 8 | 37 | SE Mid ↔ W Outer |
| line-3 | 12.4 km | 8 | 37 | NE Mid ↔ S Outer |
| **Total** | **39.0 km** | **25 unique** | **116** | |
...
| Revenue fleet capacity | 24,960 AW2 pax (33,280 AW3 crush) |
| Total fleet capacity | 27,840 AW2 pax (37,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 104 × 240 = **24,960 AW2 passengers** (33,280 AW3 crush)
- **Total fleet passenger capacity:** 116 × 240 = **27,840 AW2 passengers** (37,120 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **12,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **23.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 29.6× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 23.5 MW / 113 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 72 kWh | 172 kWh | 92 kWh | 2.4 km / 12 kWh |
| line-2 | 8 | 60 kWh | 147 kWh | 80 kWh | 2.4 km / 12 kWh |
| line-3 | 8 | 62 kWh | 147 kWh | 79 kWh | 2.4 km / 12 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (37.1 km @ $3.0 M/km) | $111 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 116 | $560 k | $65 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 232 | $60 k | $14 M |
| High sensitivity check | 232 | $120 k | $28 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 23,479 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 23,479 kW @ $100/kW | $2.3 M |
| Annual generation proxy | 23.5 MW × 4.8 peak-sun-h/day × 365 d/yr | 41.1 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$22 M / yr** | $75 |
| Steady-state, low capacity-use (year 11+) | **$11 M / yr** | $36 |
| Steady-state, high capacity-use (year 11+) | **$510 k / yr** | $2 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$545 M cumulative** | $1,816 |
| Lifecycle envelope (yr 1–40, high scenario) | **$240 M cumulative** | $800 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$815 M cumulative** | $2,718 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.0 M / yr → $19 M / yr._
...
| Traction energy (57.1 GWh / yr) | 18,120 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.4 GWh/yr + dedicated solar plant 23.5 MW / 41.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $282 k |
| Labour (330 FTE) | driverless roster: OCC/remote 73, station/platform 100, passenger service 38, fleet maintenance 59, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $721 k |
| **OPEX subtotal** | | **$9.2 M / yr** |

_Annual service work: 18,120 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.3 M car-km / yr). On-site PV covers 21.4 GWh/yr and the dedicated solar plant adds 41.1 GWh/yr against 57.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 116 trainsets, 25 stations, 39.0 route-km, 3 lines, and 18,120 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 22.9 M |
| Annual paid trips / city resident | 163 | 261 | 76 |
| Farebox revenue | $17 M / yr | $27 M / yr | $7.9 M / yr |
| Station shop leases | $476 k / yr | $476 k / yr | $476 k / yr |
| Advertising boards | $765 k / yr | $765 k / yr | $765 k / yr |
| **Total revenue** | **$18 M / yr** | **$28 M / yr** | **$9.2 M / yr** |
...
| Operating surplus applied to debt support | -$9.0 M / yr | -$19 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $510 k / yr | **$20 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.0 M / yr | $19 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,336 m² of station shop/kiosk leases at $10/m²/month and 824 advertising boards at $91/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $232 M | 58% of $401 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $371 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $37 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 37,177 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $382 M |
| Timetable-sized dedicated solar CAPEX | $19 M |
| **Reconciled project CAPEX** | **$401 M** |
| 15%–25% planning risk envelope | $461 M–$501 M |
| Annual OPEX | $9.2 M / yr |
| Low/high project NPV at 8% | $-222047 k / $-169030 k |
| Low/high project IRR | -1.9% / 1.9% |
| Low/high steady-state DSCR | 0.46 / 0.97 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,643.43 train-km; 8,204.67 kWh consumed; 9,146.18 kWh charged; 33 depot services completed; minimum SoC 92%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,800.64 train-km; 93,860.42 kWh consumed; 96,356.44 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 91%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 89.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 91.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 91.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 2 interchange complexes, 10 civil segments, and 0 input findings |
