...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 162 | $60 k | $9.7 M |
| High sensitivity check | 162 | $120 k | $19 M |
...
| Depots | $8.0 M |
| Rolling stock | $45 M |
| Railway production plant | $9.7 M |
...
| Steady-state, low capacity-use (year 11+) | **$5.8 M / yr** | $19 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$360 M cumulative** | $1,201 |
| Lifecycle envelope (yr 1–40, high scenario) | **$185 M cumulative** | $618 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$673 M cumulative** | $2,243 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $265 M | 4.5% | 40 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $66 M | — | — | — |
| **Total** | **100%** | **$331 M** | | | **$16 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.8 M / yr | $0 k / yr | **$16 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $191 M | 58% of $331 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 30,683 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-167682 k / $-114665 k |
