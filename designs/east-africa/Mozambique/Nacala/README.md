...
| Bucket | Value |
|---|---|
| At-grade (37.1 km @ $0.85 M/km) | $31 M |
| Elevated (1.8 km @ $4.0 M/km) | $7.0 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 54 | $534 k | $29 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 39.0 km × $0.015 M/km | $585 k |
...
|---|---|---|
| Construction (years 1–10) | **$7.4 M / yr** | $25 |
| Steady-state, low-ridership (year 11+) | **$7.3 M / yr** | $24 |
| Steady-state, high-ridership (year 11+) | **$5.3 M / yr** | $18 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$256 M cumulative** | $853 |
| Lifecycle envelope (yr 1–35, high scenario) | **$206 M cumulative** | $687 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$74 M cumulative** | $246 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $66 M | 3.0% | 35 y, 10 y grace | $3.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $28 M | 13.5% | 35 y, 10 y grace | $3.9 M / yr |
| Government equity (no debt service) | 15% | $17 M | — | — | — |
| **Total** | **100%** | **$111 M** | | | **$7.7 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.0 M / yr + bonds $3.7 M / yr = **$5.7 M / yr** total — plus the equity tranche amortised across construction ($1.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 100,791 |
| Daily paid trips / population | 8% | 15% | 34% |
| Annual paid trips | 8.8 M | 16.4 M | 36.8 M |
| Farebox revenue | $2.3 M / yr | $4.3 M / yr | $9.6 M / yr |
| Station shop leases | $470 k / yr | $470 k / yr | $470 k / yr |
| Advertising boards | $757 k / yr | $757 k / yr | $757 k / yr |
| **Total revenue** | **$3.5 M / yr** | **$5.5 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 32% | 51% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $7.3 M / yr | $5.3 M / yr | **$0 / yr** |
