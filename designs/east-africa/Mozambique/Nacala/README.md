...
| Bucket | Value |
|---|---|
| At-grade (37.1 km @ $1.2 M/km) | $44 M |
| Elevated (1.8 km @ $5.5 M/km) | $9.6 M |
...
| Steady-state, low-ridership (year 11+) | **$9.5 M / yr** | $32 |
| Steady-state, high-ridership (year 11+) | **$7.5 M / yr** | $25 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$329 M cumulative** | $1,097 |
| Lifecycle envelope (yr 1–35, high scenario) | **$279 M cumulative** | $931 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$91 M cumulative** | $303 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $51 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $82 M | 3.0% | 35 y, 10 y grace | $4.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $34 M | 13.5% | 35 y, 10 y grace | $4.8 M / yr |
| Government equity (no debt service) | 15% | $20 M | — | — | — |
| **Total** | **100%** | **$136 M** | | | **$9.5 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.4 M / yr + bonds $4.6 M / yr = **$7.0 M / yr** total — plus the equity tranche amortised across construction ($2.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
