...
| Revenue fleet | 270 × 4-car trainsets |
| Revenue fleet passenger capacity | 129,600 AW2 pax (172,800 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 24.3 km | 15 | 56 | SW Mid ↔ NE Outer |
| line-2 | 21.7 km | 13 | 50 | SE Mid ↔ N Mid |
| line-3 | 21.9 km | 14 | 51 | NE Outer ↔ SW Mid |
| line-4 | 27.5 km | 16 | 60 | SE Mid ↔ NW Outer |
| line-5 | 21.9 km | 14 | 51 | E Mid ↔ W Mid |
| line-6 | 57.0 km | 38 | 32 | NW Mid ↔ W Mid |
| **Total** | **174.4 km** | **110 unique** | **300** | |
...
| Revenue fleet capacity | 129,600 AW2 pax (172,800 AW3 crush) |
| Total fleet capacity | 144,000 AW2 pax (192,000 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 270 × 480 = **129,600 AW2 passengers** (172,800 AW3 crush)
- **Total fleet passenger capacity:** 300 × 480 = **144,000 AW2 passengers** (192,000 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 43 | 300 kW | 1500 kWh |
| Major | 4 | 300 kW | 1500 kWh |
| Standard | 50 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **107** | **36,800 kW** | **199,000 kWh** |

Aggregate station-rail charging power: **160,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **238.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.4× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 657 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 448 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 177 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 996 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 238.6 MW / 1,145 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 199 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 243 kWh | 784 kWh | 517 kWh | 2.1 km / 21 kWh |
| line-2 | 13 | 216 kWh | 686 kWh | 448 kWh | 2.5 km / 24 kWh |
| line-3 | 14 | 219 kWh | 735 kWh | 494 kWh | 2.0 km / 20 kWh |
| line-4 | 14 | 275 kWh | 760 kWh | 457 kWh | 6.3 km / 63 kWh |
| line-5 | 14 | 219 kWh | 735 kWh | 494 kWh | 2.0 km / 20 kWh |
| line-6 | 37 | 570 kWh | 1,813 kWh | 1,186 kWh | 5.7 km / 57 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 300 | $1.12 M | $336 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1200 | $60 k | $72 M |
| High sensitivity check | 1200 | $120 k | $144 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 238,562 kW @ $700/kW | $167 M |
| Grid interconnection / PPA tie-in | 238,562 kW @ $100/kW | $24 M |
| Annual generation proxy | 238.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 418.0 GWh/yr |
...
| Per-capita (city pop) | $1,424 / person |
...
|---|---|---|
| Construction (years 1–10) | **$122 M / yr** | $80 |
| Steady-state, low capacity-use (year 11+) | **$86 M / yr** | $56 |
| Steady-state, high capacity-use (year 11+) | **$49 M / yr** | $32 |
| Steady-state, operating-neutral revenue case | **$107 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.80 bn cumulative** | $2,484 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.68 bn cumulative** | $1,753 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.43 bn cumulative** | $2,896 |

_Population basis: 1,530,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $58 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.74 bn | 4.5% | 40 y, 10 y grace | $107 M / yr |
| Government equity (no debt service) | 20% | $436 M | — | — | — |
| **Total** | **100%** | **$2.18 bn** | | | **$107 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $78 M / yr = **$78 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($44 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (427.9 GWh / yr) | 67,846 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 64.5 GWh/yr + dedicated solar plant 238.6 MW / 418.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.9 M |
| Labour (1,157 FTE) | driverless roster: OCC/remote 171, station/platform 512, passenger service 111, fleet maintenance 180, infrastructure/energy 156, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$47 M / yr** |

_Annual service work: 67,846 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 26.7 M train-km / yr (107.0 M car-km / yr). On-site PV covers 64.5 GWh/yr and the dedicated solar plant adds 418.0 GWh/yr against 427.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 300 trainsets, 110 stations, 174.4 route-km, 6 lines, and 67,846 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 118.6 M |
| Annual paid trips / city resident | 117 | 187 | 78 |
| Farebox revenue | $62 M / yr | $99 M / yr | $41 M / yr |
| Station shop leases | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$68 M / yr** | **$106 M / yr** | **$47 M / yr** |
| Revenue / OPEX recovery | 144% | 223% | 100% |
...
| Operating surplus applied to debt support | -$21 M / yr | -$58 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $86 M / yr | $49 M / yr | **$107 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $58 M / yr | $0 / yr |

_Commercial-revenue assumptions: 22,640 m² of station shop/kiosk leases at $10/m²/month and 4,072 advertising boards at $91/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $58 M / yr | $92 M / yr | 21% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 24,815 trips/school day; 5.5 M access-events/yr | 39,705 trips/school day; 8.7 M access-events/yr |
| Healthcare | 5 healthcare anchors | 34,493 trips/day; 12.6 M access-events/yr | 55,188 trips/day; 20.1 M access-events/yr |
| Commerce | 57 major/terminal/interchange nodes | 105,283 trips/trading day; 34.7 M access-events/yr | 168,454 trips/trading day; 55.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.23 bn | 56% of $2.18 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.97 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $197 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 197,170 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.18 bn** |
| 15%–25% planning risk envelope | $2.51 bn–$2.72 bn |
| Annual OPEX | $47 M / yr |
| Low/high project NPV at 8% | $-1352464 k / $-1158067 k |
| Low/high project IRR | -5.5% / -1.1% |
| Low/high steady-state DSCR | 0.20 / 0.54 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,827.54 train-km; 48,201.13 kWh consumed; 54,116.57 kWh charged; 46 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 68,337.10 train-km; 682,320.28 kWh consumed; 694,867.64 kWh charged; 991 depot services completed (11 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 86.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.9% / 60% | pass |
| ten-hour single charging-pad outage | 88.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 110 line platforms, 12 interchange complexes, 62 civil segments, and 0 input findings |
