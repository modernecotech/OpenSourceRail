...
|---|---|---|
| Construction (years 1–10) | **$150 M / yr** | $98 |
| Steady-state, low-ridership (year 11+) | **$195 M / yr** | $127 |
| Steady-state, high-ridership (year 11+) | **$183 M / yr** | $119 |
| Steady-state, operating-neutral revenue case | **$157 M / yr** | $103 |
| Lifecycle envelope (yr 1–35, low scenario) | **$6.38 bn cumulative** | $4,167 |
| Lifecycle envelope (yr 1–35, high scenario) | **$6.07 bn cumulative** | $3,965 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$5.43 bn cumulative** | $3,547 |

_Population basis: 1,530,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $38 M / yr → $26 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.35 bn | 3.0% | 35 y, 10 y grace | $78 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $563 M | 13.5% | 35 y, 10 y grace | $79 M / yr |
| Government equity (no debt service) | 15% | $338 M | — | — | — |
| **Total** | **100%** | **$2.25 bn** | | | **$157 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $41 M / yr + bonds $76 M / yr = **$117 M / yr** total — plus the equity tranche amortised across construction ($34 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 195,809 | 326,349 | 596,199 |
| Daily paid trips / catchment | 18% | 30% | 55% |
| Daily paid trips / city population | 13% | 21% | 39% |
| Annual paid trips | 71.5 M | 119.1 M | 217.6 M |
| Farebox revenue | $19 M / yr | $31 M / yr | $57 M / yr |
| Station shop leases | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| Advertising boards | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$60 M / yr** |
| Revenue / OPEX recovery | 37% | 58% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $195 M / yr | $183 M / yr | **$157 M / yr** |
