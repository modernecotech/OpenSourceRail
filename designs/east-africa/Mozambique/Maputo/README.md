...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 856 | $60 k | $51 M |
| High sensitivity check | 856 | $120 k | $103 M |
...
| Per-capita (city pop) | $1,071 / person |
...
|---|---|---|
| Construction (years 1–10) | **$92 M / yr** | $60 |
| Steady-state, low capacity-use (year 11+) | **$50 M / yr** | $33 |
| Steady-state, high capacity-use (year 11+) | **$13 M / yr** | $9 |
| Steady-state, operating-neutral revenue case | **$80 M / yr** | $53 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.43 bn cumulative** | $1,587 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.31 bn cumulative** | $856 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.33 bn cumulative** | $2,177 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.31 bn | 4.5% | 40 y, 10 y grace | $80 M / yr |
| Government equity (no debt service) | 20% | $328 M | — | — | — |
| **Total** | **100%** | **$1.64 bn** | | | **$80 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $59 M / yr = **$59 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($33 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $50 M / yr | $13 M / yr | **$80 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $916 M | 56% of $1.64 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.46 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $146 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 146,735 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $1.88 bn–$2.05 bn |
| Annual OPEX | $35 M / yr |
| Low/high project NPV at 8% | $-942291 k / $-747895 k |
| Low/high project IRR | -2.8% / 1.1% |
