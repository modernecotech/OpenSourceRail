...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **333.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 172 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,623 MWh/day | 93,896 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,451 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 333.6 MW / 1,668 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 333,621 kW @ $700/kW | $234 M |
| Grid interconnection / PPA tie-in | 333,621 kW @ $100/kW | $33 M |
| Annual generation proxy | 333.6 MW × 5.0 peak-sun-h/day × 365 d/yr | 608.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$267 M** |
...
| Dedicated solar power plant | $267 M |
...
|---|---|---|
| Construction (years 1–10) | **$113 M / yr** | $74 |
| Steady-state, low capacity-use (year 11+) | **$135 M / yr** | $89 |
| Steady-state, high capacity-use (year 11+) | **$101 M / yr** | $66 |
| Steady-state, operating-neutral revenue case | **$112 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.19 bn cumulative** | $3,394 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.14 bn cumulative** | $2,709 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.49 bn cumulative** | $2,933 |

_Population basis: 1,530,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $24 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.51 bn | 2.0% | 40 y, 10 y grace | $112 M / yr |
| Government equity (no debt service) | 20% | $627 M | — | — | — |
| **Total** | **100%** | **$3.13 bn** | | | **$112 M / yr** |
...
| Traction energy (592.2 GWh / yr) | 93,896 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 62.8 GWh/yr + dedicated solar plant 333.6 MW / 608.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.0 M |
| Labour (1,008 FTE) | driverless roster: OCC/remote 150, station/platform 308, passenger service 107, fleet maintenance 199, infrastructure/energy 190, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $2.2 M |
| **OPEX subtotal** | | **$86 M / yr** |

_Annual service work: 93,896 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 37.0 M train-km / yr (148.1 M car-km / yr). On-site PV covers 62.8 GWh/yr and the dedicated solar plant adds 608.9 GWh/yr against 592.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 168.2 M | 269.1 M | 236.0 M |
| Annual paid trips / city resident | 110 | 176 | 154 |
| Farebox revenue | $58 M / yr | $93 M / yr | $82 M / yr |
| Station shop leases | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| Advertising boards | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| **Total revenue** | **$62 M / yr** | **$97 M / yr** | **$86 M / yr** |
| Revenue / OPEX recovery | 73% | 113% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $135 M / yr | $112 M / yr | **$112 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $135 M / yr | $101 M / yr | **$112 M / yr** |
...
| Station-area commerce turnover supported | $51 M / yr | $82 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $27 M / yr | $43 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$176 M / yr** | **$282 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 5 education anchors | 27,319 trips/school day; 6.0 M access-events/yr | 43,710 trips/school day; 9.6 M access-events/yr |
| Healthcare | 0 healthcare anchors | 27,648 trips/day; 10.1 M access-events/yr | 44,237 trips/day; 16.1 M access-events/yr |
| Commerce | 34 major/terminal/interchange nodes | 93,790 trips/trading day; 31.0 M access-events/yr | 150,063 trips/trading day; 49.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.62 bn | 52% of $3.13 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.59 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $259 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 259,693 job-years | retained CAPEX ÷ (4.0 × median annual income) |
