...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **320,292 – 533,820 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (240.6 km @ $2.0 M/km) | $481 M |
| Elevated (20.8 km @ $9.0 M/km) | $187 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 266.7 km × $0.015 M/km | $13 M |
...
|---|---|---|
| Construction (years 1–7) | **$100 M / yr** | $24 |
| Steady-state, low-ridership (year 8+) | **$48 M / yr** | $12 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.80 bn cumulative** | $439 |
| Lifecycle envelope (yr 1–30, high scenario) | **$701 M cumulative** | $171 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$701 M cumulative** | $171 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $918 M | 3.8% | 30 y, 7 y grace | $61 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $382 M | 8.5% | 30 y, 7 y grace | $38 M / yr |
| Government equity (no debt service) | 15% | $229 M | — | — | — |
| **Total** | **100%** | **$1.53 bn** | | | **$99 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $35 M / yr + bonds $33 M / yr = **$67 M / yr** total — plus the equity tranche amortised across construction ($33 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
