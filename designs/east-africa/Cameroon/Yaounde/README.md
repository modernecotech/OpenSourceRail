...
Aggregate station-rail charging power: **51,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh battery covers running.
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 219 | €4.5 M | €986 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 266.7 km × €0.1 M/km | €26 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 266.7 km × €0.8 M/km | €209 M |
...
|---|---|---|
| Construction (years 1–7) | **€222 M / yr** | €54 |
| Steady-state, low-ridership (year 8+) | **€283 M / yr** | €69 |
| Steady-state, high-ridership (year 8+) | **€262 M / yr** | €64 |
| Lifecycle envelope (yr 1–30, low scenario) | **€8.06 bn cumulative** | €1,966 |
| Lifecycle envelope (yr 1–30, high scenario) | **€7.58 bn cumulative** | €1,850 |

_Population basis: 4,100,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€64 M / yr (low) → €43 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.03 bn | 3.8% | 30 y, 7 y grace | €134 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €848 M | 8.5% | 30 y, 7 y grace | €85 M / yr |
| Government equity (no debt service) | 15% | €509 M | — | — | — |
| **Total** | **100%** | **€3.39 bn** | | | **€219 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €77 M / yr + bonds €72 M / yr = **€149 M / yr** total — plus the equity tranche amortised across construction (€73 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating shortfall (gov subsidy required) | €64 M / yr | €43 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€283 M / yr** | **€262 M / yr** |
