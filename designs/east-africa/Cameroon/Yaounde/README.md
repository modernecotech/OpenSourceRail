...
|---|---|---|
| Construction (years 1–7) | **$117 M / yr** | $29 |
| Steady-state, low-ridership (year 8+) | **$116 M / yr** | $28 |
| Steady-state, high-ridership (year 8+) | **$116 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$116 M / yr** | $28 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.48 bn cumulative** | $848 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.48 bn cumulative** | $848 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.48 bn cumulative** | $848 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.07 bn | 3.8% | 30 y, 7 y grace | $71 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $447 M | 8.5% | 30 y, 7 y grace | $45 M / yr |
| Government equity (no debt service) | 15% | $268 M | — | — | — |
| **Total** | **100%** | **$1.79 bn** | | | **$116 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $41 M / yr + bonds $38 M / yr = **$79 M / yr** total — plus the equity tranche amortised across construction ($38 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
