...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$528 M (87.8%) of external capital** and **$662 M of external interest**. Capital plus saved interest totals **$1.19 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $144 M | 15% | $22 M | $122 M |
...
| **Total city CAPEX** | **$334 M** | **21.9%** | **$73 M** | **$261 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.9%** | **$73 M** | **$10 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.1%** | **$261 M** | **$37 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $209 M | $30 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $451 M | $378 M (83.8%) | $473 M | **$851 M** |
| **Default** | 2.00× | $601 M | $528 M (87.8%) | $662 M | **$1.19 bn** |
| High | 3.00× | $902 M | $828 M (91.9%) | $1.04 bn | **$1.87 bn** |

At the default 2.00× case, OSR's $73 M external requirement is 87.8% below the illustrative foreign-company requirement of $601 M; the associated lifetime external-interest saving is $662 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$40 M / yr** | $133 |
| Steady-state, low capacity-use (year 8+) | **$22 M / yr** | $73 |
| Steady-state, high capacity-use (year 8+) | **$11 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $113 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.00 bn cumulative** | $3,337 |
| Lifecycle envelope (yr 1–40, high scenario) | **$627 M cumulative** | $2,090 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.40 bn cumulative** | $4,660 |
...
| Local-currency sovereign / project bonds for local content | 62% | $209 M | 14.0% | 40 y, 7 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $52 M | — | — | — |
| **Total** | **100%** | **$334 M** | | | **$34 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $22 M / yr | $11 M / yr | **$34 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $261 M | 78% of $334 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 37,460 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $73 M (21.9%) |
| Local-content / local-funding requirement | $261 M (78.1%) |
| Default foreign-turnkey external-capital comparison | $601 M; OSR saves $528 M (87.8%) |
| Lifetime external interest and combined financing saving | $662 M interest; $1.19 bn capital + interest |
...
| Low/high steady-state DSCR | 0.35 / 0.69 |
