...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $73 |
| Steady-state, low-ridership (year 8+) | **$24 M / yr** | $79 |
| Steady-state, high-ridership (year 8+) | **$22 M / yr** | $73 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $70 |
| Lifecycle envelope (yr 1–30, low scenario) | **$695 M cumulative** | $2,316 |
| Lifecycle envelope (yr 1–30, high scenario) | **$658 M cumulative** | $2,195 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$636 M cumulative** | $2,119 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.6 M / yr → $990 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $165 M | 3.8% | 30 y, 7 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $69 M | 14.0% | 30 y, 7 y grace | $10 M / yr |
| Government equity (no debt service) | 15% | $41 M | — | — | — |
| **Total** | **100%** | **$275 M** | | | **$21 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.3 M / yr + bonds $9.6 M / yr = **$16 M / yr** total — plus the equity tranche amortised across construction ($5.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 22,356 | 37,260 | 46,610 |
| Daily paid trips / catchment | 18% | 30% | 38% |
| Daily paid trips / city population | 7% | 12% | 16% |
| Annual paid trips | 8.2 M | 13.6 M | 17.0 M |
| Farebox revenue | $2.4 M / yr | $3.9 M / yr | $4.9 M / yr |
| Station shop leases | $521 k / yr | $521 k / yr | $521 k / yr |
| Advertising boards | $861 k / yr | $861 k / yr | $861 k / yr |
| **Total revenue** | **$3.7 M / yr** | **$5.3 M / yr** | **$6.3 M / yr** |
