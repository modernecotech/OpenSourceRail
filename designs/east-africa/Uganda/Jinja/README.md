...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 174 | $60 k | $10 M |
| High sensitivity check | 174 | $120 k | $21 M |
...
| Steady-state, low capacity-use (year 8+) | **$4.2 M / yr** | $14 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$294 M cumulative** | $981 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $4.2 M / yr | $0 k / yr | **$16 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $199 M | 58% of $345 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 28,626 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-175868 k / $-99681 k |
| Low/high project IRR | 0.7% / 4.5% |
| Low/high steady-state DSCR | 0.74 / 1.44 |
