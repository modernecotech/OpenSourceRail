...
| Revenue fleet | 113 × 2-car trainsets |
| Revenue fleet passenger capacity | 27,120 AW2 pax (36,160 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 15.8 km | 11 | 47 | NE Outer ↔ SW Mid |
| line-2 | 12.3 km | 9 | 38 | S Mid ↔ NW Mid |
| line-3 | 14.0 km | 7 | 41 | SW Outer ↔ NE Inner |
| **Total** | **42.1 km** | **27 unique** | **126** | |
...
| Revenue fleet capacity | 27,120 AW2 pax (36,160 AW3 crush) |
...
- **Revenue fleet simultaneous capacity:** 113 × 240 = **27,120 AW2 passengers** (36,160 AW3 crush)
- **Total fleet passenger capacity:** 126 × 240 = **30,240 AW2 passengers** (40,320 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 12.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 330 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 26.1 MW / 125 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 79 kWh | 204 kWh | 118 kWh | 2.1 km / 10 kWh |
| line-2 | 9 | 61 kWh | 163 kWh | 96 kWh | 2.2 km / 11 kWh |
| line-3 | 6 | 70 kWh | 131 kWh | 54 kWh | 6.0 km / 30 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 126 | $560 k | $71 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 26,114 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 26,114 kW @ $100/kW | $2.6 M |
| Annual generation proxy | 26.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 45.8 GWh/yr |
...
| Per-capita (city pop) | $1,411 / person |
...
| Steady-state, low capacity-use (year 8+) | **$9.3 M / yr** | $31 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$499 M cumulative** | $1,664 |
| Lifecycle envelope (yr 1–40, high scenario) | **$191 M cumulative** | $638 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$848 M cumulative** | $2,825 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $20 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $339 M | 4.5% | 40 y, 7 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $85 M | — | — | — |
| **Total** | **100%** | **$423 M** | | | **$20 M / yr** |
...
| Traction energy (61.7 GWh / yr) | 19,560 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.9 GWh/yr + dedicated solar plant 26.1 MW / 45.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $313 k |
| Labour (352 FTE) | driverless roster: OCC/remote 81, station/platform 107, passenger service 38, fleet maintenance 64, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $857 k |
| **OPEX subtotal** | | **$9.8 M / yr** |

_Annual service work: 19,560 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.7 M train-km / yr (15.4 M car-km / yr). On-site PV covers 21.9 GWh/yr and the dedicated solar plant adds 45.8 GWh/yr against 61.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 126 trainsets, 27 stations, 42.1 route-km, 3 lines, and 19,560 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 21.6 M |
| Annual paid trips / city resident | 163 | 261 | 72 |
| Farebox revenue | $19 M / yr | $30 M / yr | $8.3 M / yr |
| Station shop leases | $563 k / yr | $563 k / yr | $563 k / yr |
| Advertising boards | $903 k / yr | $903 k / yr | $903 k / yr |
| **Total revenue** | **$20 M / yr** | **$32 M / yr** | **$9.8 M / yr** |
| Revenue / OPEX recovery | 208% | 323% | 100% |
...
| Operating surplus applied to debt support | -$11 M / yr | -$20 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.3 M / yr | $0 k / yr | **$20 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $22 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,600 m² of station shop/kiosk leases at $12/m²/month and 872 advertising boards at $102/board/month, with occupancy derates applied._
...
| Healthcare | 8 healthcare anchors | 13,660 trips/day; 5.0 M access-events/yr | 21,856 trips/day; 8.0 M access-events/yr |
| Commerce | 15 major/terminal/interchange nodes | 29,239 trips/trading day; 9.6 M access-events/yr | 46,783 trips/trading day; 15.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $244 M | 58% of $423 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 35,047 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-243800 k / $-167612 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,737.79 train-km; 8,675.73 kWh consumed; 9,444.36 kWh charged; 32 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,272.47 train-km; 101,208.30 kWh consumed; 103,897.85 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 56.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 46.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 64.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 64.1% | 100.0% / 90% | pass |
