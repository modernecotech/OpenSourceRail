...
|---|---|---|
| Construction (years 1–7) | **$42 M / yr** | $139 |
| Steady-state, low-ridership (year 8+) | **$50 M / yr** | $167 |
| Steady-state, high-ridership (year 8+) | **$48 M / yr** | $161 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $134 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.44 bn cumulative** | $4,804 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.40 bn cumulative** | $4,683 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.22 bn cumulative** | $4,054 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.8 M / yr → $8.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $316 M | 3.8% | 30 y, 7 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $132 M | 14.0% | 30 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 15% | $79 M | — | — | — |
| **Total** | **100%** | **$526 M** | | | **$40 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $18 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 22,356 | 37,260 | 114,773 |
| Daily paid trips / catchment | 18% | 30% | 92% |
| Daily paid trips / city population | 7% | 12% | 38% |
| Annual paid trips | 8.2 M | 13.6 M | 41.9 M |
| Farebox revenue | $2.4 M / yr | $3.9 M / yr | $12 M / yr |
| Station shop leases | $521 k / yr | $521 k / yr | $521 k / yr |
| Advertising boards | $861 k / yr | $861 k / yr | $861 k / yr |
| **Total revenue** | **$3.7 M / yr** | **$5.3 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 28% | 39% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $50 M / yr | $48 M / yr | **$40 M / yr** |
