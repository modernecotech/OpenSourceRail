...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **22,356 – 37,260 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (43.8 km @ $2.0 M/km) | $88 M |
| Elevated (1.5 km @ $9.0 M/km) | $14 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 45.5 km × $0.015 M/km | $2.3 M |
...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $60 |
| Steady-state, low-ridership (year 8+) | **$19 M / yr** | $64 |
| Steady-state, high-ridership (year 8+) | **$18 M / yr** | $58 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $58 |
| Lifecycle envelope (yr 1–30, low scenario) | **$566 M cumulative** | $1,887 |
| Lifecycle envelope (yr 1–30, high scenario) | **$530 M cumulative** | $1,766 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$527 M cumulative** | $1,758 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.7 M / yr → $113 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $57 M | 14.0% | 30 y, 7 y grace | $8.4 M / yr |
| Government equity (no debt service) | 15% | $34 M | — | — | — |
| **Total** | **100%** | **$228 M** | | | **$17 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.2 M / yr + bonds $8.0 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($4.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 22,356 | 37,260 | 38,328 |
| Daily paid trips / catchment | 18% | 30% | 31% |
| Daily paid trips / city population | 7% | 12% | 13% |
| Annual paid trips | 8.2 M | 13.6 M | 14.0 M |
| Farebox revenue | $2.4 M / yr | $3.9 M / yr | $4.1 M / yr |
| Station shop leases | $521 k / yr | $521 k / yr | $521 k / yr |
| Advertising boards | $861 k / yr | $861 k / yr | $861 k / yr |
| **Total revenue** | **$3.7 M / yr** | **$5.3 M / yr** | **$5.4 M / yr** |
| Revenue / OPEX recovery | 69% | 98% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $19 M / yr | $18 M / yr | **$17 M / yr** |
