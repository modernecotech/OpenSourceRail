...
|---|---|---|
| Construction (years 1–7) | **$15 M / yr** | $44 |
| Steady-state, low-ridership (year 8+) | **$16 M / yr** | $45 |
| Steady-state, high-ridership (year 8+) | **$13 M / yr** | $37 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$468 M cumulative** | $1,337 |
| Lifecycle envelope (yr 1–30, high scenario) | **$408 M cumulative** | $1,167 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$108 M cumulative** | $309 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $781 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $117 M | 3.8% | 30 y, 7 y grace | $7.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $49 M | 14.0% | 30 y, 7 y grace | $7.2 M / yr |
| Government equity (no debt service) | 15% | $29 M | — | — | — |
| **Total** | **100%** | **$195 M** | | | **$15 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.4 M / yr + bonds $6.8 M / yr = **$11 M / yr** total — plus the equity tranche amortised across construction ($4.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,000 | 52,500 | 175,924 |
| Daily paid trips / population | 8% | 15% | 50% |
| Annual paid trips | 10.2 M | 19.2 M | 64.2 M |
| Farebox revenue | $3.0 M / yr | $5.6 M / yr | $19 M / yr |
| Station shop leases | $660 k / yr | $660 k / yr | $660 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$4.7 M / yr** | **$7.3 M / yr** | **$20 M / yr** |
