...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 63.7 km × €0.015 M/km | €1.0 M |
...
| Per-capita (city pop) | €1,793 / person |
...
|---|---|---|
| Construction (years 1–7) | **€50 M / yr** | €142 |
| Steady-state, low-ridership (year 8+) | **€63 M / yr** | €179 |
| Steady-state, high-ridership (year 8+) | **€61 M / yr** | €175 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.79 bn cumulative** | €5,113 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.76 bn cumulative** | €5,020 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€15 M / yr (low) → €13 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €157 M | 14.0% | 30 y, 7 y grace | €23 M / yr |
| Government equity (no debt service) | 15% | €94 M | — | — | — |
| **Total** | **100%** | **€627 M** | | | **€48 M / yr** |
...
| Labour (394 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €883 k |
