...
|---|---|---|---|---|
| line-1 | 20.5 km | 13 | 20 | E Mid ↔ W Outer |
| line-2 | 15.2 km | 10 | 16 | NE Mid ↔ SW Mid |
| line-3 | 28.0 km | 13 | 27 | NW Outer ↔ SE Outer |
| **Total** | **63.7 km** | **36 unique** | **63** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **31,752 – 52,920 trips/day**
...
| Per-capita (city pop) | $2,075 / person |
...
|---|---|---|
| Construction (years 1–7) | **$58 M / yr** | $164 |
| Steady-state, low-ridership (year 8+) | **$70 M / yr** | $199 |
| Steady-state, high-ridership (year 8+) | **$67 M / yr** | $193 |
| Steady-state, operating-neutral revenue case | **$55 M / yr** | $159 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.00 bn cumulative** | $5,728 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.95 bn cumulative** | $5,581 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.68 bn cumulative** | $4,798 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $436 M | 3.8% | 30 y, 7 y grace | $29 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $182 M | 14.0% | 30 y, 7 y grace | $27 M / yr |
| Government equity (no debt service) | 15% | $109 M | — | — | — |
| **Total** | **100%** | **$726 M** | | | **$55 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $25 M / yr = **$42 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 31,752 | 52,920 | 165,477 |
| Daily paid trips / catchment | 18% | 30% | 94% |
| Daily paid trips / city population | 9% | 15% | 47% |
| Annual paid trips | 11.6 M | 19.3 M | 60.4 M |
| Farebox revenue | $3.4 M / yr | $5.6 M / yr | $18 M / yr |
| Station shop leases | $660 k / yr | $660 k / yr | $660 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$5.1 M / yr** | **$7.3 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 26% | 38% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $70 M / yr | $67 M / yr | **$55 M / yr** |
