...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **17,640 – 26,460 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (62.5 km @ $0.85 M/km) | $53 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 63.7 km × $0.015 M/km | $956 k |
...
| Per-capita (city pop) | $455 / person |
...
| Steady-state, low-ridership (year 8+) | **$12 M / yr** | $35 |
| Steady-state, high-ridership (year 8+) | **$9.7 M / yr** | $28 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$370 M cumulative** | $1,059 |
| Lifecycle envelope (yr 1–30, high scenario) | **$311 M cumulative** | $888 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$88 M cumulative** | $252 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $115 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $95 M | 3.8% | 30 y, 7 y grace | $6.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $40 M | 14.0% | 30 y, 7 y grace | $5.9 M / yr |
| Government equity (no debt service) | 15% | $24 M | — | — | — |
| **Total** | **100%** | **$159 M** | | | **$12 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.6 M / yr + bonds $5.6 M / yr = **$9.2 M / yr** total — plus the equity tranche amortised across construction ($3.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
