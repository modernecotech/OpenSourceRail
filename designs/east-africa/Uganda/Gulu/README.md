...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$682 M (85.5%) of external capital** and **$855 M of external interest**. Capital plus saved interest totals **$1.54 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (59.8 km @ $2.58 M/km) | $155 M |
| Elevated (0.2 km @ $9.75 M/km) | $2.4 M |
...
| Per-capita (city pop) | $1,266 / person |
...
| Charging microgrids | $3.1 M | 40% | $1.2 M | $1.9 M |
| EPC / project services | $25 M | 15% | $3.7 M | $21 M |
| **Total city CAPEX** | **$443 M** | **26.1%** | **$116 M** | **$328 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.1%** | **$116 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.9%** | **$328 M** | **$47 M / yr** |
| of which planned local bond issuance | 59.1% of total CAPEX | $262 M | $37 M / yr |
| **Total city programme** | **100.0%** | **$443 M** | **$63 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $598 M | $483 M (80.7%) | $605 M | **$1.09 bn** |
| **Default** | 2.00× | $798 M | $682 M (85.5%) | $855 M | **$1.54 bn** |
| High | 3.00× | $1.20 bn | $1.08 bn (90.3%) | $1.36 bn | **$2.44 bn** |

At the default 2.00× case, OSR's $116 M external requirement is 85.5% below the illustrative foreign-company requirement of $798 M; the associated lifetime external-interest saving is $855 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, low capacity-use (year 8+) | **$26 M / yr** | $75 |
| Steady-state, high capacity-use (year 8+) | **$9.3 M / yr** | $27 |
| Steady-state, operating-neutral revenue case | **$44 M / yr** | $126 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.23 bn cumulative** | $3,507 |
| Lifecycle envelope (yr 1–40, high scenario) | **$666 M cumulative** | $1,903 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.81 bn cumulative** | $5,173 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $116 M | 4.5% | 40 y, 7 y grace | $6.8 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $262 M | 14.0% | 40 y, 7 y grace | $37 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $66 M | — | — | — |
| **Total** | **100%** | **$443 M** | | | **$44 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 27.6 M |
| Annual paid trips / city resident | 209 | 335 | 79 |
...
| **Total revenue** | **$29 M / yr** | **$46 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 255% | 403% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $26 M / yr | $9.3 M / yr | **$44 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $328 M | 74% of $443 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 47,087 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$443 M** |
| Imported / external-capital requirement | $116 M (26.1%) |
| Local-content / local-funding requirement | $328 M (73.9%) |
| Default foreign-turnkey external-capital comparison | $798 M; OSR saves $682 M (85.5%) |
| Lifetime external interest and combined financing saving | $855 M interest; $1.54 bn capital + interest |
| 15%–25% planning risk envelope | $510 M–$554 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-211018 k / $-96738 k |
| Low/high project IRR | 1.4% / 5.5% |
| Low/high steady-state DSCR | 0.40 / 0.79 |
