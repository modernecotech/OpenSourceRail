...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 142 | $60 k | $8.5 M |
| High sensitivity check | 142 | $120 k | $17 M |
...
| Depots | $8.0 M |
| Rolling stock | $40 M |
| Railway production plant | $8.5 M |
...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $61 |
| Steady-state, low capacity-use (year 8+) | **$222 k / yr** | $1 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$135 M cumulative** | $451 |
| Lifecycle envelope (yr 1–40, high scenario) | **$128 M cumulative** | $427 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$567 M cumulative** | $1,890 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $227 M | 4.5% | 40 y, 7 y grace | $13 M / yr |
| Government equity (no debt service) | 20% | $57 M | — | — | — |
| **Total** | **100%** | **$283 M** | | | **$13 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $10 M / yr = **$10 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $222 k / yr | $0 k / yr | **$13 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $165 M | 58% of $283 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $264 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $38 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 23,689 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $326 M–$354 M |
| Annual OPEX | $6.4 M / yr |
| Low/high project NPV at 8% | $-122695 k / $-46508 k |
| Low/high project IRR | 2.2% / 6.2% |
| Low/high steady-state DSCR | 0.98 / 1.84 |
