...
| Revenue fleet | 92 × 2-car trainsets |
| Revenue fleet passenger capacity | 22,080 AW2 pax (29,440 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 14.5 km | 10 | 43 | S Outer ↔ N Mid |
| line-2 | 14.4 km | 8 | 41 | NE Outer ↔ S Mid |
| line-3 |  5.2 km | 4 | 18 | E Inner ↔ NW Mid |
| **Total** | **34.1 km** | **22 unique** | **102** | |
...
| Revenue fleet capacity | 22,080 AW2 pax (29,440 AW3 crush) |
| Total fleet capacity | 24,480 AW2 pax (32,640 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 92 × 240 = **22,080 AW2 passengers** (29,440 AW3 crush)
- **Total fleet passenger capacity:** 102 × 240 = **24,480 AW2 passengers** (32,640 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **10,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **20.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 51 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 20.2 MW / 97 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 72 kWh | 188 kWh | 108 kWh | 2.0 km / 10 kWh |
| line-2 | 7 | 72 kWh | 131 kWh | 51 kWh | 5.0 km / 25 kWh |
| line-3 | 4 | 26 kWh | 82 kWh | 53 kWh | 2.0 km / 10 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (27.7 km @ $3.0 M/km) | $83 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 102 | $560 k | $57 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 204 | $60 k | $12 M |
| High sensitivity check | 204 | $120 k | $24 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 20,216 kW @ $700/kW | $14 M |
| Grid interconnection / PPA tie-in | 20,216 kW @ $100/kW | $2.0 M |
| Annual generation proxy | 20.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 35.4 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mbale`.
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $85 |
| Steady-state, low capacity-use (year 8+) | **$7.3 M / yr** | $24 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$420 M cumulative** | $1,401 |
| Lifecycle envelope (yr 1–40, high scenario) | **$178 M cumulative** | $593 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$788 M cumulative** | $2,626 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $315 M | 4.5% | 40 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $79 M | — | — | — |
| **Total** | **100%** | **$393 M** | | | **$18 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $14 M / yr = **$14 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (50.1 GWh / yr) | 15,877 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 19.3 GWh/yr + dedicated solar plant 20.2 MW / 35.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $243 k |
| Labour (299 FTE) | driverless roster: OCC/remote 69, station/platform 85, passenger service 38, fleet maintenance 52, infrastructure/energy 34, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $728 k |
| **OPEX subtotal** | | **$8.9 M / yr** |

_Annual service work: 15,877 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (12.5 M car-km / yr). On-site PV covers 19.3 GWh/yr and the dedicated solar plant adds 35.4 GWh/yr against 50.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 102 trainsets, 22 stations, 34.1 route-km, 3 lines, and 15,877 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 20.1 M |
| Annual paid trips / city resident | 163 | 261 | 67 |
| Farebox revenue | $19 M / yr | $30 M / yr | $7.8 M / yr |
| Station shop leases | $443 k / yr | $443 k / yr | $443 k / yr |
| Advertising boards | $721 k / yr | $721 k / yr | $721 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$8.9 M / yr** |
| Revenue / OPEX recovery | 225% | 352% | 100% |
...
_Commercial-revenue assumptions: 3,616 m² of station shop/kiosk leases at $12/m²/month and 696 advertising boards at $102/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 5 education anchors | 10,178 trips/school day; 2.2 M access-events/yr | 16,285 trips/school day; 3.6 M access-events/yr |
| Healthcare | 7 healthcare anchors | 13,285 trips/day; 4.8 M access-events/yr | 21,256 trips/day; 7.8 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 29,736 trips/trading day; 9.8 M access-events/yr | 47,578 trips/trading day; 15.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $231 M | 59% of $393 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $369 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $53 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 33,138 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $452 M–$492 M |
| Annual OPEX | $8.9 M / yr |
| Low/high project NPV at 8% | $-217751 k / $-141564 k |
| Low/high project IRR | -0.3% / 3.5% |
| Low/high steady-state DSCR | 0.60 / 1.22 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,449.59 train-km; 7,236.95 kWh consumed; 7,902.36 kWh charged; 35 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,476.57 train-km; 82,257.73 kWh consumed; 84,432.21 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 77%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 62.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 77.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 77.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 3 interchange complexes, 27 civil segments, and 0 input findings |
