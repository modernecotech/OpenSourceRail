...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$434 M (88.1%) of external capital** and **$545 M of external interest**. Capital plus saved interest totals **$979 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`mbale.corridor.geojson`](mbale.corridor.geojson).
...
| Total fleet capacity | 17,040 AW2 pax (22,720 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 71 × 240 = **17,040 AW2 passengers** (22,720 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 84.7%
- Catchment population: **≈ 254,100** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **6,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **23.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.7× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 329 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 35 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 41 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 15,877 train-km/day | One-way train journeys × route length |
| Annual service work | 6.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 137 MWh/day | 12.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 96 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 23.0 MW / 110 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 72 kWh | 139 kWh | 59 kWh | 4.5 km / 23 kWh |
| line-2 | 4 | 72 kWh | 114 kWh | 35 kWh | 6.2 km / 31 kWh |
| line-3 | 3 | 26 kWh | 65 kWh | 37 kWh | 2.7 km / 13 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (30.1 km @ $3.0 M/km) | $90 M |
| Elevated (4.1 km @ $12.0 M/km) | $49 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 71 | $560 k | $40 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 142 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 142 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 22,976 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 22,976 kW @ $100/kW | $2.3 M |
| Annual generation proxy | 23.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 40.3 GWh/yr |
...
| Per-capita (city pop) | $913 / person |
...
| Stations | $49 M | 20% | $9.8 M | $39 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $40 M | 35% | $14 M | $26 M |
| Dedicated solar plant | $18 M | 45% | $8.3 M | $10 M |
| Residual signalling / train control | $1.7 M | 50% | $854 k | $854 k |
| Charging microgrids | $1.4 M | 40% | $580 k | $870 k |
| EPC / project services | $17 M | 15% | $2.5 M | $14 M |
| **Total city CAPEX** | **$274 M** | **21.5%** | **$59 M** | **$215 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mbale`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.5%** | **$59 M** | **$8.4 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.5%** | **$215 M** | **$31 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $172 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$274 M** | **$39 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $370 M | $311 M (84.1%) | $390 M | **$701 M** |
| **Default** | 2.00× | $493 M | $434 M (88.1%) | $545 M | **$979 M** |
| High | 3.00× | $740 M | $681 M (92.1%) | $854 M | **$1.53 bn** |

At the default 2.00× case, OSR's $59 M external requirement is 88.1% below the illustrative foreign-company requirement of $493 M; the associated lifetime external-interest saving is $545 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $110 |
| Steady-state, low capacity-use (year 8+) | **$15 M / yr** | $49 |
| Steady-state, high capacity-use (year 8+) | **$3.5 M / yr** | $12 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $93 |
| Lifecycle envelope (yr 1–40, low scenario) | **$719 M cumulative** | $2,396 |
| Lifecycle envelope (yr 1–40, high scenario) | **$345 M cumulative** | $1,148 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.15 bn cumulative** | $3,835 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $13 M / yr → $24 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $59 M | 4.5% | 40 y, 7 y grace | $3.5 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $172 M | 14.0% | 40 y, 7 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $43 M | — | — | — |
| **Total** | **100%** | **$274 M** | | | **$28 M / yr** |
...
| Traction energy (50.1 GWh / yr) | 15,877 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 15.1 GWh/yr + dedicated solar plant 23.0 MW / 40.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $276 k |
| Labour (231 FTE) | driverless roster: OCC/remote 53, station/platform 45, passenger service 38, fleet maintenance 43, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $563 k |
| **OPEX subtotal** | | **$6.4 M / yr** |

_Annual service work: 15,877 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (12.5 M car-km / yr). On-site PV covers 15.1 GWh/yr and the dedicated solar plant adds 40.3 GWh/yr against 50.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 71 trainsets, 13 stations, 34.1 route-km, 3 lines, and 15,877 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 15.0 M |
| Annual paid trips / city resident | 163 | 261 | 50 |
| Farebox revenue | $19 M / yr | $30 M / yr | $5.8 M / yr |
| Station shop leases | $225 k / yr | $225 k / yr | $225 k / yr |
| Advertising boards | $393 k / yr | $393 k / yr | $393 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$6.4 M / yr** |
| Revenue / OPEX recovery | 303% | 480% | 100% |
...
| Operating surplus applied to debt support | -$13 M / yr | -$24 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $15 M / yr | $3.5 M / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $24 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,840 m² of station shop/kiosk leases at $12/m²/month and 380 advertising boards at $102/board/month, with occupancy derates applied._
...
| Avoided road congestion | $6.0 M / yr | $9.6 M / yr | 75 M - 120 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.1 M / yr | $1.7 M / yr | 13.5–21.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 10,178 trips/school day; 2.2 M access-events/yr | 16,285 trips/school day; 3.6 M access-events/yr |
| Healthcare | 4 healthcare anchors | 13,035 trips/day; 4.8 M access-events/yr | 20,856 trips/day; 7.6 M access-events/yr |
| Commerce | 8 major/terminal/interchange nodes | 30,080 trips/trading day; 9.9 M access-events/yr | 48,129 trips/trading day; 15.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $215 M | 79% of $274 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $344 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $49 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 30,928 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $256 M |
| Timetable-sized dedicated solar CAPEX | $18 M |
| **Reconciled project CAPEX** | **$274 M** |
| Imported / external-capital requirement | $59 M (21.5%) |
| Local-content / local-funding requirement | $215 M (78.5%) |
| Default foreign-turnkey external-capital comparison | $493 M; OSR saves $434 M (88.1%) |
| Lifetime external interest and combined financing saving | $545 M interest; $979 M capital + interest |
| 15%–25% planning risk envelope | $315 M–$343 M |
| Annual OPEX | $6.4 M / yr |
| Low/high project NPV at 8% | $-115914 k / $-39727 k |
| Low/high project IRR | 2.4% / 6.4% |
| Low/high steady-state DSCR | 0.47 / 0.88 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,404.96 train-km; 7,014.21 kWh consumed; 7,292.29 kWh charged; 37 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,342.07 train-km; 76,594.55 kWh consumed; 77,882.44 kWh charged; 500 depot services completed (6 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 96.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 69.6% | 96.6% / 90% | pass |
| maximum planning climate/HVAC duty | 65.9% | 96.6% / 90% | pass |
| 50% charging-contact availability | 74.7% | 96.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.1% / 60% | pass |
| ten-hour single charging-pad outage | 73.0% | 96.6% / 90% | pass |
...
|---|---|
| ![Mbale energy and battery simulation dashboard](engineering/screenshots/mbale-simulation-dashboard.png) | ![Mbale simulator network visualizer](engineering/screenshots/mbale-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 13 line platforms, 1 interchange complexes, 24 civil segments, and 0 input findings |
...
|---|---|
| ![Mbale QGIS engineering layers](engineering/screenshots/mbale-qgis-engineering-map.png) | ![Mbale SUMO timetable validation](engineering/screenshots/mbale-sumo-validation.png) |
...
| [`mbale.toml`](mbale.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`mbale-network-map.png`](mbale-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`mbale.corridor.geojson`](mbale.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`mbale.stations.json`](mbale.stations.json) | Machine-readable station list |
| [`mbale.design-quality.yaml`](mbale.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug mbale
