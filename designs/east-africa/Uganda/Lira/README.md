...
| Per-capita (city pop) | $1,422 / person |
...
| Steady-state, low capacity-use (year 8+) | **$5.0 M / yr** | $20 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$326 M cumulative** | $1,303 |
| Lifecycle envelope (yr 1–40, high scenario) | **$161 M cumulative** | $643 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$712 M cumulative** | $2,849 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $12 M / yr → $17 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $284 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $71 M | — | — | — |
| **Total** | **100%** | **$356 M** | | | **$17 M / yr** |
...
| Operating surplus applied to debt support | -$12 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.0 M / yr | $0 k / yr | **$17 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $205 M | 58% of $356 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 29,412 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-185790 k / $-109603 k |
| Low/high project IRR | 0.4% / 4.3% |
| Low/high steady-state DSCR | 0.70 / 1.38 |
