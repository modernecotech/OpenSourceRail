...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$506 M (87.5%) of external capital** and **$634 M of external interest**. Capital plus saved interest totals **$1.14 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $1,284 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $131 M | 15% | $20 M | $111 M |
...
| **Total city CAPEX** | **$321 M** | **22.6%** | **$72 M** | **$249 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.6%** | **$72 M** | **$10 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.4%** | **$249 M** | **$36 M / yr** |
| of which planned local bond issuance | 61.9% of total CAPEX | $199 M | $28 M / yr |
| **Total city programme** | **100.0%** | **$321 M** | **$46 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $433 M | $361 M (83.3%) | $453 M | **$814 M** |
| **Default** | 2.00× | $578 M | $506 M (87.5%) | $634 M | **$1.14 bn** |
| High | 3.00× | $867 M | $795 M (91.6%) | $996 M | **$1.79 bn** |

At the default 2.00× case, OSR's $72 M external requirement is 87.5% below the illustrative foreign-company requirement of $578 M; the associated lifetime external-interest saving is $634 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$38 M / yr** | $153 |
| Steady-state, low capacity-use (year 8+) | **$20 M / yr** | $81 |
| Steady-state, high capacity-use (year 8+) | **$9.0 M / yr** | $36 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $130 |
| Lifecycle envelope (yr 1–40, low scenario) | **$939 M cumulative** | $3,755 |
| Lifecycle envelope (yr 1–40, high scenario) | **$564 M cumulative** | $2,258 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.34 bn cumulative** | $5,357 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $72 M | 4.5% | 40 y, 7 y grace | $4.3 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $199 M | 14.0% | 40 y, 7 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $50 M | — | — | — |
| **Total** | **100%** | **$321 M** | | | **$32 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.3 M / yr + local bonds $28 M / yr = **$31 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 17.5 M |
| Annual paid trips / city resident | 196 | 313 | 70 |
| Farebox revenue | $19 M / yr | $30 M / yr | $6.8 M / yr |
| Station shop leases | $343 k / yr | $343 k / yr | $343 k / yr |
| Advertising boards | $559 k / yr | $559 k / yr | $559 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$7.7 M / yr** |
| Revenue / OPEX recovery | 258% | 406% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $20 M / yr | $9.0 M / yr | **$32 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $249 M | 77% of $321 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 35,722 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $295 M |
| Timetable-sized dedicated solar CAPEX | $26 M |
| **Reconciled project CAPEX** | **$321 M** |
| Imported / external-capital requirement | $72 M (22.6%) |
| Local-content / local-funding requirement | $249 M (77.4%) |
| Default foreign-turnkey external-capital comparison | $578 M; OSR saves $506 M (87.5%) |
| Lifetime external interest and combined financing saving | $634 M interest; $1.14 bn capital + interest |
| 15%–25% planning risk envelope | $369 M–$401 M |
| Annual OPEX | $7.7 M / yr |
| Low/high project NPV at 8% | $-157288 k / $-81101 k |
| Low/high project IRR | 1.1% / 5.0% |
