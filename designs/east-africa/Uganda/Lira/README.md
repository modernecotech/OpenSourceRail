...
| Revenue fleet | 115 × 2-car trainsets |
| Revenue fleet passenger capacity | 27,600 AW2 pax (36,800 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 14.7 km | 8 | 41 | W Mid ↔ NE Outer |
| line-2 | 14.9 km | 9 | 42 | E Outer ↔ W Mid |
| line-3 | 15.7 km | 9 | 45 | W Outer ↔ S Outer |
| **Total** | **45.3 km** | **26 unique** | **128** | |
...
| Revenue fleet capacity | 27,600 AW2 pax (36,800 AW3 crush) |
| Total fleet capacity | 30,720 AW2 pax (40,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 115 × 240 = **27,600 AW2 passengers** (36,800 AW3 crush)
- **Total fleet passenger capacity:** 128 × 240 = **30,720 AW2 passengers** (40,960 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **11,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **30.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.5× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 329 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 50 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 126 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 30.3 MW / 145 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 73 kWh | 131 kWh | 50 kWh | 6.2 km / 31 kWh |
| line-2 | 8 | 74 kWh | 147 kWh | 65 kWh | 5.6 km / 28 kWh |
| line-3 | 8 | 78 kWh | 155 kWh | 69 kWh | 5.5 km / 27 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 128 | $560 k | $72 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 256 | $60 k | $15 M |
| High sensitivity check | 256 | $120 k | $31 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 30,305 kW @ $700/kW | $21 M |
| Grid interconnection / PPA tie-in | 30,305 kW @ $100/kW | $3.0 M |
| Annual generation proxy | 30.3 MW × 4.8 peak-sun-h/day × 365 d/yr | 53.1 GWh/yr |
...
| Per-capita (city pop) | $1,647 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lira`.
...
|---|---|---|
| Construction (years 1–7) | **$27 M / yr** | $106 |
| Steady-state, low capacity-use (year 8+) | **$8.8 M / yr** | $35 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $77 |
| Lifecycle envelope (yr 1–40, low scenario) | **$476 M cumulative** | $1,902 |
| Lifecycle envelope (yr 1–40, high scenario) | **$186 M cumulative** | $744 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$825 M cumulative** | $3,298 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $11 M / yr → $19 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $329 M | 4.5% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $82 M | — | — | — |
| **Total** | **100%** | **$412 M** | | | **$19 M / yr** |
...
| Traction energy (66.5 GWh / yr) | 21,085 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 30.3 MW / 53.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $364 k |
| Labour (343 FTE) | driverless roster: OCC/remote 81, station/platform 93, passenger service 38, fleet maintenance 67, infrastructure/energy 43, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $836 k |
| **OPEX subtotal** | | **$9.6 M / yr** |

_Annual service work: 21,085 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.3 M train-km / yr (16.6 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 53.1 GWh/yr against 66.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 128 trainsets, 26 stations, 45.3 route-km, 3 lines, and 21,085 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 21.5 M |
| Annual paid trips / city resident | 196 | 313 | 86 |
| Farebox revenue | $19 M / yr | $30 M / yr | $8.3 M / yr |
| Station shop leases | $478 k / yr | $478 k / yr | $478 k / yr |
| Advertising boards | $783 k / yr | $783 k / yr | $783 k / yr |
| **Total revenue** | **$20 M / yr** | **$32 M / yr** | **$9.6 M / yr** |
| Revenue / OPEX recovery | 210% | 329% | 100% |
...
| Operating surplus applied to debt support | -$11 M / yr | -$19 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $8.8 M / yr | $0 k / yr | **$19 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $22 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,904 m² of station shop/kiosk leases at $12/m²/month and 756 advertising boards at $102/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $16 M / yr | $25 M / yr | 22% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 7,165 trips/school day; 1.6 M access-events/yr | 11,464 trips/school day; 2.5 M access-events/yr |
| Healthcare | 7 healthcare anchors | 12,957 trips/day; 4.7 M access-events/yr | 20,731 trips/day; 7.6 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 28,999 trips/trading day; 9.6 M access-events/yr | 46,398 trips/trading day; 15.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $236 M | 57% of $412 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 33,956 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $473 M–$515 M |
| Annual OPEX | $9.6 M / yr |
| Low/high project NPV at 8% | $-235145 k / $-158958 k |
| Low/high project IRR | -0.8% / 3.1% |
| Low/high steady-state DSCR | 0.55 / 1.13 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,887.23 train-km; 9,421.83 kWh consumed; 9,929.65 kWh charged; 33 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,835.33 train-km; 109,011.05 kWh consumed; 111,617.49 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 83.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 73.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 86.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 74.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
