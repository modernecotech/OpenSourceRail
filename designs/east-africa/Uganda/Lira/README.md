...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$543 M (87.7%) of external capital** and **$681 M of external interest**. Capital plus saved interest totals **$1.22 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`lira.corridor.geojson`](lira.corridor.geojson).
...
| Route length (double track) | 45.3 km |
...
- Anchor-weighted coverage: 64.5%
- Catchment population: **≈ 161,250** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **33.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 325 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 41 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 44 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 21,085 train-km/day | One-way train journeys × route length |
| Annual service work | 8.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 182 MWh/day | 16.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 138 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 33.1 MW / 159 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 73 kWh | 122 kWh | 42 kWh | 6.5 km / 33 kWh |
| line-2 | 5 | 74 kWh | 122 kWh | 41 kWh | 6.9 km / 35 kWh |
| line-3 | 5 | 78 kWh | 131 kWh | 44 kWh | 5.7 km / 28 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 33,065 kW @ $700/kW | $23 M |
| Grid interconnection / PPA tie-in | 33,065 kW @ $100/kW | $3.3 M |
| Annual generation proxy | 33.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 57.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 45.3 km × $0.050 M/km | $2.3 M |
...
| Per-capita (city pop) | $1,375 / person |
...
| Dedicated solar plant | $26 M | 45% | $12 M | $15 M |
...
| **Total city CAPEX** | **$344 M** | **22.1%** | **$76 M** | **$268 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lira`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.1%** | **$76 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.9%** | **$268 M** | **$38 M / yr** |
| of which planned local bond issuance | 62.3% of total CAPEX | $214 M | $31 M / yr |
| **Total city programme** | **100.0%** | **$344 M** | **$49 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $464 M | $388 M (83.6%) | $487 M | **$875 M** |
| **Default** | 2.00× | $619 M | $543 M (87.7%) | $681 M | **$1.22 bn** |
| High | 3.00× | $928 M | $852 M (91.8%) | $1.07 bn | **$1.92 bn** |

At the default 2.00× case, OSR's $76 M external requirement is 87.7% below the illustrative foreign-company requirement of $619 M; the associated lifetime external-interest saving is $681 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$41 M / yr** | $164 |
| Steady-state, low capacity-use (year 8+) | **$23 M / yr** | $93 |
| Steady-state, high capacity-use (year 8+) | **$12 M / yr** | $47 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $139 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.05 bn cumulative** | $4,206 |
| Lifecycle envelope (yr 1–40, high scenario) | **$677 M cumulative** | $2,709 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.44 bn cumulative** | $5,752 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $76 M | 4.5% | 40 y, 7 y grace | $4.5 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $214 M | 14.0% | 40 y, 7 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $54 M | — | — | — |
| **Total** | **100%** | **$344 M** | | | **$35 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.4 M / yr + local bonds $30 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (66.5 GWh / yr) | 21,085 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.1 GWh/yr + dedicated solar plant 33.1 MW / 57.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $397 k |
| Labour (286 FTE) | driverless roster: OCC/remote 65, station/platform 66, passenger service 38, fleet maintenance 56, infrastructure/energy 40, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $697 k |
| **OPEX subtotal** | | **$8.1 M / yr** |

_Annual service work: 21,085 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.3 M train-km / yr (16.6 M car-km / yr). On-site PV covers 16.1 GWh/yr and the dedicated solar plant adds 57.9 GWh/yr against 66.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 92 trainsets, 16 stations, 45.3 route-km, 3 lines, and 21,085 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 18.6 M |
| Annual paid trips / city resident | 196 | 313 | 74 |
| Farebox revenue | $19 M / yr | $30 M / yr | $7.2 M / yr |
| Station shop leases | $343 k / yr | $343 k / yr | $343 k / yr |
| Advertising boards | $559 k / yr | $559 k / yr | $559 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$8.1 M / yr** |
| Revenue / OPEX recovery | 245% | 385% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $12 M / yr | **$35 M / yr** |
| Operating surplus after OPEX (before debt support) | $12 M / yr | $23 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,800 m² of station shop/kiosk leases at $12/m²/month and 540 advertising boards at $102/board/month, with occupancy derates applied._
...
| Avoided road congestion | $8.0 M / yr | $13 M / yr | 100 M - 159 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.4 M / yr | $2.3 M / yr | 17.9–28.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $4.0 M / yr | $6.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $17 M / yr | $26 M / yr | 23% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 6,562 trips/school day; 1.4 M access-events/yr | 10,499 trips/school day; 2.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $268 M | 78% of $344 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $429 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $61 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 38,492 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$344 M** |
| Imported / external-capital requirement | $76 M (22.1%) |
| Local-content / local-funding requirement | $268 M (77.9%) |
| Default foreign-turnkey external-capital comparison | $619 M; OSR saves $543 M (87.7%) |
| Lifetime external interest and combined financing saving | $681 M interest; $1.22 bn capital + interest |
| 15%–25% planning risk envelope | $395 M–$430 M |
| Annual OPEX | $8.1 M / yr |
| Low/high project NPV at 8% | $-177004 k / $-100817 k |
| Low/high project IRR | 0.6% / 4.5% |
| Low/high steady-state DSCR | 0.34 / 0.66 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,766.28 train-km; 8,818.06 kWh consumed; 9,450.68 kWh charged; 34 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,259.09 train-km; 96,150.10 kWh consumed; 97,872.21 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 77%; 0 onboard emergencies; 0 invariant violations; 91.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 73.1% | 91.3% / 90% | pass |
| maximum planning climate/HVAC duty | 54.6% | 91.3% / 90% | pass |
| 50% charging-contact availability | 77.4% | 91.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 89.3% / 60% | pass |
| ten-hour single charging-pad outage | 51.7% | 91.3% / 90% | pass |
...
|---|---|
| ![Lira energy and battery simulation dashboard](engineering/screenshots/lira-simulation-dashboard.png) | ![Lira simulator network visualizer](engineering/screenshots/lira-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 16 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
...
|---|---|
| ![Lira QGIS engineering layers](engineering/screenshots/lira-qgis-engineering-map.png) | ![Lira SUMO timetable validation](engineering/screenshots/lira-sumo-validation.png) |
...
| [`lira.toml`](lira.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`lira-network-map.png`](lira-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`lira.corridor.geojson`](lira.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`lira.stations.json`](lira.stations.json) | Machine-readable station list |
| [`lira.design-quality.yaml`](lira.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug lira
