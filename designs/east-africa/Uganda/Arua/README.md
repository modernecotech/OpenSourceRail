...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **19,375 – 29,062 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (35.6 km @ $0.85 M/km) | $30 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 37.0 km × $0.015 M/km | $555 k |
...
| Steady-state, low-ridership (year 8+) | **$7.3 M / yr** | $29 |
| Steady-state, high-ridership (year 8+) | **$5.4 M / yr** | $22 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$224 M cumulative** | $896 |
| Lifecycle envelope (yr 1–30, high scenario) | **$181 M cumulative** | $726 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$56 M cumulative** | $225 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $61 M | 3.8% | 30 y, 7 y grace | $4.0 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $2.3 M / yr + bonds $3.5 M / yr = **$5.9 M / yr** total — plus the equity tranche amortised across construction ($2.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 88,945 |
| Daily paid trips / population | 8% | 15% | 36% |
| Annual paid trips | 7.3 M | 13.7 M | 32.5 M |
| Farebox revenue | $2.1 M / yr | $4.0 M / yr | $9.4 M / yr |
| Station shop leases | $475 k / yr | $475 k / yr | $475 k / yr |
| Advertising boards | $770 k / yr | $770 k / yr | $770 k / yr |
| **Total revenue** | **$3.4 M / yr** | **$5.2 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 32% | 49% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $7.3 M / yr | $5.4 M / yr | **$0 / yr** |
