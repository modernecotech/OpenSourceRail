...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $82 |
| Steady-state, low capacity-use (year 8+) | **$2.3 M / yr** | $9 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$220 M cumulative** | $880 |
| Lifecycle envelope (yr 1–40, high scenario) | **$144 M cumulative** | $575 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$637 M cumulative** | $2,548 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.3 M / yr | $0 k / yr | **$15 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $184 M | 58% of $318 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $295 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $42 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 26,454 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$318 M** |
| 15%–25% planning risk envelope | $366 M–$398 M |
| Annual OPEX | $7.2 M / yr |
| Low/high project NPV at 8% | $-151642 k / $-75455 k |
| Low/high project IRR | 1.4% / 5.2% |
| Low/high steady-state DSCR | 0.85 / 1.60 |
