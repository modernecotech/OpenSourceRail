...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **48,437 – 87,187 trips/day**
...
| Per-capita (city pop) | $2,229 / person |
...
| Steady-state, high-ridership (year 8+) | **$13 M / yr** | $53 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$713 M cumulative** | $2,852 |
| Lifecycle envelope (yr 1–40, high scenario) | **$533 M cumulative** | $2,130 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$478 M cumulative** | $1,912 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.1 M / yr → $1.6 M / yr._
...
|---|---|---|---|
| Daily paid trips | 48,437 | 87,187 | 98,871 |
| Daily paid trips / catchment | 25% | 45% | 51% |
| Daily paid trips / city population | 19% | 35% | 40% |
| Annual paid trips | 17.7 M | 31.8 M | 36.1 M |
| Farebox revenue | $6.8 M / yr | $12 M / yr | $14 M / yr |
...
| Gov repayable-debt service + residual OPEX subsidy | $19 M / yr | $13 M / yr | **$12 M / yr** |
