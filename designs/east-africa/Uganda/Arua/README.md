...
| Bucket | Value |
|---|---|
| At-grade (35.6 km @ €3.5 M/km) | €125 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 37.0 km × €0.015 M/km | €0.6 M |
...
| Steady-state, low-ridership (year 8+) | **€40 M / yr** | €158 |
| Steady-state, high-ridership (year 8+) | **€39 M / yr** | €154 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.13 bn cumulative** | €4,533 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.11 bn cumulative** | €4,440 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€8.9 M / yr (low) → €7.9 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €100 M | 14.0% | 30 y, 7 y grace | €15 M / yr |
| Government equity (no debt service) | 15% | €60 M | — | — | — |
| **Total** | **100%** | **€402 M** | | | **€31 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €9.2 M / yr + bonds €14 M / yr = **€23 M / yr** total — plus the equity tranche amortised across construction (€8.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (234 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €524 k |
...
| Operating shortfall (gov subsidy required) | €8.9 M / yr | €7.9 M / yr |
