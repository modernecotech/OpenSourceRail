...
|---|---|---|---|---|
| line-1 |  8.4 km | 6 | 20 | SE Mid ↔ N Mid |
| line-2 | 15.1 km | 9 | 34 | W Outer ↔ E Outer |
| line-3 | 13.4 km | 8 | 30 | S Outer ↔ NW Mid |
| **Total** | **37.0 km** | **23 unique** | **84** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **21.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 161 MWh/day | 18,672 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 93 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 21.3 MW / 107 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 21,349 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 21,349 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 21.3 MW × 5.0 peak-sun-h/day × 365 d/yr | 39.0 GWh/yr |
...
| Per-capita (city pop) | $2,298 / person |
...
|---|---|---|
| Construction (years 1–7) | **$26 M / yr** | $102 |
| Steady-state, low capacity-use (year 8+) | **$17 M / yr** | $69 |
| Steady-state, high capacity-use (year 8+) | **$7.6 M / yr** | $30 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $77 |
| Lifecycle envelope (yr 1–40, low scenario) | **$751 M cumulative** | $3,006 |
| Lifecycle envelope (yr 1–40, high scenario) | **$429 M cumulative** | $1,718 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$811 M cumulative** | $3,245 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $1.8 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $460 M | 2.0% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $115 M | — | — | — |
| **Total** | **100%** | **$574 M** | | | **$19 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $9.2 M / yr = **$9.2 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (58.9 GWh / yr) | 18,672 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 25.0 GWh/yr + dedicated solar plant 21.3 MW / 39.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $256 k |
| Labour (329 FTE) | driverless roster: OCC/remote 61, station/platform 90, passenger service 35, fleet maintenance 50, infrastructure/energy 57, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $801 k |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 18,672 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.4 M train-km / yr (14.7 M car-km / yr). On-site PV covers 25.0 GWh/yr and the dedicated solar plant adds 39.0 GWh/yr against 58.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 42.0 M | 67.3 M | 37.3 M |
| Annual paid trips / city resident | 168 | 269 | 149 |
| Farebox revenue | $16 M / yr | $26 M / yr | $14 M / yr |
| Station shop leases | $475 k / yr | $475 k / yr | $475 k / yr |
| Advertising boards | $770 k / yr | $770 k / yr | $770 k / yr |
| **Total revenue** | **$18 M / yr** | **$27 M / yr** | **$16 M / yr** |
...
| Operating surplus applied to debt support | -$1.8 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $17 M / yr | $7.6 M / yr | **$19 M / yr** |
| Operating surplus after OPEX (before debt support) | $1.8 M / yr | $12 M / yr | $0 / yr |
...
| Avoided CO2e | $1.0 M / yr | $1.6 M / yr | 12.6–20.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 6,072 trips/school day; 1.3 M access-events/yr | 9,715 trips/school day; 2.1 M access-events/yr |
| Healthcare | 8 healthcare anchors | 11,466 trips/day; 4.2 M access-events/yr | 18,345 trips/day; 6.7 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 25,795 trips/trading day; 8.5 M access-events/yr | 41,272 trips/trading day; 13.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $309 M | 54% of $574 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $494 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $71 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 44,384 job-years | retained CAPEX ÷ (4.0 × median annual income) |
