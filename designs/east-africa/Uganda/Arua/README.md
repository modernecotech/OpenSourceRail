...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$456 M (87.7%) of external capital** and **$571 M of external interest**. Capital plus saved interest totals **$1.03 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (36.5 km @ $2.58 M/km) | $94 M |
...
| **Total city CAPEX** | **$289 M** | **22.2%** | **$64 M** | **$225 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.2%** | **$64 M** | **$9.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.8%** | **$225 M** | **$32 M / yr** |
| of which planned local bond issuance | 62.2% of total CAPEX | $180 M | $26 M / yr |
| **Total city programme** | **100.0%** | **$289 M** | **$41 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $390 M | $326 M (83.5%) | $408 M | **$734 M** |
| **Default** | 2.00× | $520 M | $456 M (87.7%) | $571 M | **$1.03 bn** |
| High | 3.00× | $780 M | $716 M (91.8%) | $897 M | **$1.61 bn** |

At the default 2.00× case, OSR's $64 M external requirement is 87.7% below the illustrative foreign-company requirement of $520 M; the associated lifetime external-interest saving is $571 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$34 M / yr** | $138 |
| Steady-state, low capacity-use (year 8+) | **$16 M / yr** | $65 |
| Steady-state, high capacity-use (year 8+) | **$4.9 M / yr** | $20 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $117 |
| Lifecycle envelope (yr 1–40, low scenario) | **$778 M cumulative** | $3,113 |
| Lifecycle envelope (yr 1–40, high scenario) | **$404 M cumulative** | $1,616 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.21 bn cumulative** | $4,829 |
...
| Annual paid trips | 48.9 M | 78.2 M | 15.3 M |
| Annual paid trips / city resident | 196 | 313 | 61 |
| Farebox revenue | $19 M / yr | $30 M / yr | $5.9 M / yr |
| Station shop leases | $367 k / yr | $367 k / yr | $367 k / yr |
| Advertising boards | $592 k / yr | $592 k / yr | $592 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$6.9 M / yr** |
| Revenue / OPEX recovery | 290% | 455% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $4.9 M / yr | **$29 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $225 M | 78% of $289 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $359 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $51 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 32,278 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $269 M |
| Timetable-sized dedicated solar CAPEX | $20 M |
| **Reconciled project CAPEX** | **$289 M** |
| Imported / external-capital requirement | $64 M (22.2%) |
| Local-content / local-funding requirement | $225 M (77.8%) |
| Default foreign-turnkey external-capital comparison | $520 M; OSR saves $456 M (87.7%) |
| Lifetime external interest and combined financing saving | $571 M interest; $1.03 bn capital + interest |
| 15%–25% planning risk envelope | $332 M–$361 M |
| Annual OPEX | $6.9 M / yr |
| Low/high project NPV at 8% | $-127503 k / $-51316 k |
| Low/high project IRR | 2.1% / 6.0% |
| Low/high steady-state DSCR | 0.44 / 0.83 |
