...
| Per-capita (city pop) | $1,806 / person |
...
|---|---|---|
| Construction (years 1–7) | **$36 M / yr** | $143 |
| Steady-state, low-ridership (year 8+) | **$41 M / yr** | $164 |
| Steady-state, high-ridership (year 8+) | **$39 M / yr** | $154 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $138 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.19 bn cumulative** | $4,778 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.14 bn cumulative** | $4,552 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.04 bn cumulative** | $4,174 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.6 M / yr → $4.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $271 M | 3.8% | 30 y, 7 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $113 M | 14.0% | 30 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $68 M | — | — | — |
| **Total** | **100%** | **$451 M** | | | **$34 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $16 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($9.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 34,875 | 58,125 | 96,911 |
| Daily paid trips / catchment | 18% | 30% | 50% |
| Daily paid trips / city population | 14% | 23% | 39% |
| Annual paid trips | 12.7 M | 21.2 M | 35.4 M |
...
| **Total revenue** | **$4.9 M / yr** | **$7.4 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 43% | 64% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $41 M / yr | $39 M / yr | **$34 M / yr** |
