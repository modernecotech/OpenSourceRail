...
| Revenue fleet | 101 × 2-car trainsets |
| Revenue fleet passenger capacity | 24,240 AW2 pax (32,320 AW3 crush) |
...
|---|---|---|---|---|
| line-1 |  9.9 km | 7 | 31 | NW Mid ↔ SE Mid |
| line-2 | 15.0 km | 10 | 45 | E Outer ↔ W Outer |
| line-3 | 12.8 km | 7 | 37 | NE Outer ↔ S Mid |
| **Total** | **37.7 km** | **24 unique** | **113** | |
...
| Revenue fleet capacity | 24,240 AW2 pax (32,320 AW3 crush) |
| Total fleet capacity | 27,120 AW2 pax (36,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 101 × 240 = **24,240 AW2 passengers** (32,320 AW3 crush)
- **Total fleet passenger capacity:** 113 × 240 = **27,120 AW2 passengers** (36,160 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 14.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 335 kWh usable margin across the worst powered-stop gap (line-3) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 49 kWh | 131 kWh | 76 kWh | 2.2 km / 11 kWh |
| line-2 | 10 | 75 kWh | 188 kWh | 105 kWh | 2.0 km / 10 kWh |
| line-3 | 6 | 64 kWh | 114 kWh | 44 kWh | 5.0 km / 25 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 113 | $560 k | $63 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 226 | $60 k | $14 M |
| High sensitivity check | 226 | $120 k | $27 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 22,978 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 22,978 kW @ $100/kW | $2.3 M |
...
| Per-capita (city pop) | $1,458 / person |
...
|---|---|---|
| Construction (years 1–7) | **$24 M / yr** | $94 |
| Steady-state, low capacity-use (year 8+) | **$5.6 M / yr** | $22 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $69 |
| Lifecycle envelope (yr 1–40, low scenario) | **$348 M cumulative** | $1,394 |
| Lifecycle envelope (yr 1–40, high scenario) | **$165 M cumulative** | $659 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$730 M cumulative** | $2,921 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $292 M | 4.5% | 40 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $73 M | — | — | — |
| **Total** | **100%** | **$365 M** | | | **$17 M / yr** |
...
| Traction energy (55.3 GWh / yr) | 17,545 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 23.0 MW / 40.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $276 k |
| Labour (313 FTE) | driverless roster: OCC/remote 73, station/platform 87, passenger service 38, fleet maintenance 57, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $762 k |
| **OPEX subtotal** | | **$8.5 M / yr** |

_Annual service work: 17,545 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.9 M train-km / yr (13.8 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 40.3 GWh/yr against 55.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 113 trainsets, 24 stations, 37.7 route-km, 3 lines, and 17,545 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 19.0 M |
| Annual paid trips / city resident | 196 | 313 | 76 |
| Farebox revenue | $19 M / yr | $30 M / yr | $7.3 M / yr |
| Station shop leases | $445 k / yr | $445 k / yr | $445 k / yr |
| Advertising boards | $733 k / yr | $733 k / yr | $733 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$8.5 M / yr** |
| Revenue / OPEX recovery | 236% | 369% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.6 M / yr | $0 k / yr | **$17 M / yr** |
| Operating surplus after OPEX (before debt support) | $12 M / yr | $23 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,632 m² of station shop/kiosk leases at $12/m²/month and 708 advertising boards at $102/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 5 education anchors | 9,163 trips/school day; 2.0 M access-events/yr | 14,661 trips/school day; 3.2 M access-events/yr |
| Healthcare | 10 healthcare anchors | 13,956 trips/day; 5.1 M access-events/yr | 22,329 trips/day; 8.2 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 28,458 trips/trading day; 9.4 M access-events/yr | 45,533 trips/trading day; 15.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $210 M | 58% of $365 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 30,168 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $346 M |
| Timetable-sized dedicated solar CAPEX | $18 M |
| **Reconciled project CAPEX** | **$365 M** |
| 15%–25% planning risk envelope | $419 M–$456 M |
| Annual OPEX | $8.5 M / yr |
| Low/high project NPV at 8% | $-193444 k / $-117257 k |
| Low/high project IRR | 0.2% / 4.1% |
| Low/high steady-state DSCR | 0.68 / 1.34 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,602.02 train-km; 7,997.94 kWh consumed; 8,795.94 kWh charged; 34 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,207.72 train-km; 90,900.31 kWh consumed; 93,327.24 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.3% | 100.0% / 90% | pass |
...
| ten-hour single charging-pad outage | 87.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
