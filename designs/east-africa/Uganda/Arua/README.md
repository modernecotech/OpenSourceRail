...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$488 M (87.9%) of external capital** and **$611 M of external interest**. Capital plus saved interest totals **$1.10 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 78.9%
- Catchment population: **≈ 197,250** (within ~800 m walk of a station)
...
| Lowest traversal charging margin | 44 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 17,545 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 25.4 MW / 122 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 49 kWh | 98 kWh | 44 kWh | 3.0 km / 15 kWh |
| line-2 | 5 | 75 kWh | 131 kWh | 48 kWh | 6.4 km / 32 kWh |
| line-3 | 6 | 64 kWh | 114 kWh | 44 kWh | 4.2 km / 21 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (36.5 km @ $3.0 M/km) | $109 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 154 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 154 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 25,393 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 25,393 kW @ $100/kW | $2.5 M |
| Annual generation proxy | 25.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 44.5 GWh/yr |
...
| Dedicated solar plant | $20 M | 45% | $9.1 M | $11 M |
| Residual signalling / train control | $1.9 M | 50% | $943 k | $943 k |
| Charging microgrids | $1.8 M | 40% | $730 k | $1.1 M |
| EPC / project services | $19 M | 15% | $2.8 M | $16 M |
| **Total city CAPEX** | **$308 M** | **21.8%** | **$67 M** | **$241 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh arua`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.8%** | **$67 M** | **$9.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.2%** | **$241 M** | **$34 M / yr** |
| of which planned local bond issuance | 62.6% of total CAPEX | $193 M | $28 M / yr |
| **Total city programme** | **100.0%** | **$308 M** | **$44 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $416 M | $349 M (83.9%) | $437 M | **$786 M** |
| **Default** | 2.00× | $555 M | $488 M (87.9%) | $611 M | **$1.10 bn** |
| High | 3.00× | $832 M | $765 M (91.9%) | $959 M | **$1.72 bn** |

At the default 2.00× case, OSR's $67 M external requirement is 87.9% below the illustrative foreign-company requirement of $555 M; the associated lifetime external-interest saving is $611 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$37 M / yr** | $148 |
| Steady-state, low capacity-use (year 8+) | **$19 M / yr** | $75 |
| Steady-state, high capacity-use (year 8+) | **$7.3 M / yr** | $29 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $125 |
| Lifecycle envelope (yr 1–40, low scenario) | **$874 M cumulative** | $3,497 |
| Lifecycle envelope (yr 1–40, high scenario) | **$500 M cumulative** | $2,000 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.29 bn cumulative** | $5,166 |
...
| Local-currency sovereign / project bonds for local content | 63% | $193 M | 14.0% | 40 y, 7 y grace | $27 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $48 M | — | — | — |
| **Total** | **100%** | **$308 M** | | | **$31 M / yr** |
...
| Traction energy (55.3 GWh / yr) | 17,545 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.6 GWh/yr + dedicated solar plant 25.4 MW / 44.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $305 k |
| Labour (267 FTE) | driverless roster: OCC/remote 57, station/platform 69, passenger service 38, fleet maintenance 47, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $650 k |
| **OPEX subtotal** | | **$7.2 M / yr** |

_Annual service work: 17,545 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.9 M train-km / yr (13.8 M car-km / yr). On-site PV covers 16.6 GWh/yr and the dedicated solar plant adds 44.5 GWh/yr against 55.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 77 trainsets, 16 stations, 37.7 route-km, 3 lines, and 17,545 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 16.2 M |
| Annual paid trips / city resident | 196 | 313 | 65 |
| Farebox revenue | $19 M / yr | $30 M / yr | $6.3 M / yr |
| Station shop leases | $367 k / yr | $367 k / yr | $367 k / yr |
| Advertising boards | $592 k / yr | $592 k / yr | $592 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$7.2 M / yr** |
| Revenue / OPEX recovery | 275% | 432% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $19 M / yr | $7.3 M / yr | **$31 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $24 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,992 m² of station shop/kiosk leases at $12/m²/month and 572 advertising boards at $102/board/month, with occupancy derates applied._
...
| Avoided road congestion | $6.6 M / yr | $11 M / yr | 83 M - 133 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.2 M / yr | $1.9 M / yr | 14.9–23.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 9,807 trips/school day; 2.2 M access-events/yr | 15,691 trips/school day; 3.5 M access-events/yr |
| Healthcare | 6 healthcare anchors | 13,227 trips/day; 4.8 M access-events/yr | 21,163 trips/day; 7.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $241 M | 78% of $308 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 34,636 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $288 M |
| Timetable-sized dedicated solar CAPEX | $20 M |
| **Reconciled project CAPEX** | **$308 M** |
| Imported / external-capital requirement | $67 M (21.8%) |
| Local-content / local-funding requirement | $241 M (78.2%) |
| Default foreign-turnkey external-capital comparison | $555 M; OSR saves $488 M (87.9%) |
| Lifetime external interest and combined financing saving | $611 M interest; $1.10 bn capital + interest |
| 15%–25% planning risk envelope | $354 M–$385 M |
| Annual OPEX | $7.2 M / yr |
| Low/high project NPV at 8% | $-144289 k / $-68101 k |
| Low/high project IRR | 1.6% / 5.5% |
| Low/high steady-state DSCR | 0.40 / 0.77 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,562.03 train-km; 7,798.37 kWh consumed; 8,254.38 kWh charged; 37 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,851.38 train-km; 84,129.59 kWh consumed; 85,704.62 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 79%; 0 onboard emergencies; 0 invariant violations; 96.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 75.2% | 96.0% / 90% | pass |
| maximum planning climate/HVAC duty | 60.7% | 96.0% / 90% | pass |
| 50% charging-contact availability | 79.2% | 96.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.8% / 60% | pass |
| ten-hour single charging-pad outage | 37.2% | 96.0% / 90% | pass |
...
|---|---|
| ![Arua energy and battery simulation dashboard](engineering/screenshots/arua-simulation-dashboard.png) | ![Arua simulator network visualizer](engineering/screenshots/arua-network-visualizer.png) |
...
|---|---|
| ![Arua QGIS engineering layers](engineering/screenshots/arua-qgis-engineering-map.png) | ![Arua SUMO timetable validation](engineering/screenshots/arua-sumo-validation.png) |
...
scripts/regenerate-city.sh arua
```
