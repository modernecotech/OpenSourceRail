...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$163 M (88.7%) of external capital** and **$205 M of external interest**. Capital plus saved interest totals **$368 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| EPC integration + project management (7%) | on subtotal | $6.7 M |
...
| EPC overhead (7%) | $6.7 M |
| **CAPEX total** | **$102 M** |
| Per-route-km | $13 M / km |
| Per-capita (city pop) | $512 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $39 M | 15% | $5.8 M | $33 M |
...
| EPC / project services | $6.7 M | 15% | $1.0 M | $5.7 M |
| **Total city CAPEX** | **$102 M** | **20.4%** | **$21 M** | **$82 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.4%** | **$21 M** | **$3.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.6%** | **$82 M** | **$12 M / yr** |
| of which planned local bond issuance | 63.7% of total CAPEX | $65 M | $9.3 M / yr |
| **Total city programme** | **100.0%** | **$102 M** | **$15 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $138 M | $117 M (84.9%) | $147 M | **$264 M** |
| **Default** | 2.00× | $184 M | $163 M (88.7%) | $205 M | **$368 M** |
| High | 3.00× | $276 M | $256 M (92.5%) | $320 M | **$576 M** |

At the default 2.00× case, OSR's $21 M external requirement is 88.7% below the illustrative foreign-company requirement of $184 M; the associated lifetime external-interest saving is $205 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$12 M / yr** | $62 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$10 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$87 M cumulative** | $434 |
| Lifecycle envelope (yr 1–40, high scenario) | **$87 M cumulative** | $434 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$433 M cumulative** | $2,163 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $10 M / yr → $10 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 20% | $21 M | 4.5% | 40 y, 7 y grace | $1.2 M / yr |
| Local-currency sovereign / project bonds for local content | 64% | $65 M | 14.0% | 40 y, 7 y grace | $9.3 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $16 M | — | — | — |
| **Total** | **100%** | **$102 M** | | | **$10 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $938 k / yr + local bonds $9.1 M / yr = **$10 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 32.6 M | 52.1 M | 5.3 M |
| Annual paid trips / city resident | 163 | 261 | 27 |
| Farebox revenue | $13 M / yr | $20 M / yr | $2.1 M / yr |
| Station shop leases | $157 k / yr | $157 k / yr | $157 k / yr |
| Advertising boards | $257 k / yr | $257 k / yr | $257 k / yr |
| **Total revenue** | **$13 M / yr** | **$21 M / yr** | **$2.5 M / yr** |
| Revenue / OPEX recovery | 524% | 829% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gross repayable-debt service + residual OPEX subsidy | $10 M / yr | $10 M / yr | **$10 M / yr** |
| Operating surplus applied to debt support | -$10 M / yr | -$10 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$10 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $82 M | 80% of $102 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $130 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $19 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 11,715 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $102 M |
| Timetable-sized dedicated solar CAPEX | $103 k |
| **Reconciled project CAPEX** | **$102 M** |
| Imported / external-capital requirement | $21 M (20.4%) |
| Local-content / local-funding requirement | $82 M (79.6%) |
| Default foreign-turnkey external-capital comparison | $184 M; OSR saves $163 M (88.7%) |
| Lifetime external interest and combined financing saving | $205 M interest; $368 M capital + interest |
| 15%–25% planning risk envelope | $118 M–$128 M |
| Annual OPEX | $2.5 M / yr |
| Low/high project NPV at 8% | $-5387 k / $45 M |
| Low/high project IRR | 7.4% / 12.0% |
| Low/high steady-state DSCR | 1.01 / 1.73 |
