...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$154 M (88.5%) of external capital** and **$193 M of external interest**. Capital plus saved interest totals **$347 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`soroti.corridor.geojson`](soroti.corridor.geojson).
...
| Anchor-weighted coverage | 69.0% |
| Route length (double track) | 7.9 km |
| Revenue fleet | 19 × 2-car trainsets |
| Revenue fleet passenger capacity | 4,560 AW2 pax (6,080 AW3 crush) |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 2 planned-maintenance spares and 2 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
| Revenue fleet capacity | 4,560 AW2 pax (6,080 AW3 crush) |
| Total fleet capacity | 5,520 AW2 pax (7,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 19 × 240 = **4,560 AW2 passengers** (6,080 AW3 crush)
- **Total fleet passenger capacity:** 23 × 240 = **5,520 AW2 passengers** (7,360 AW3 crush, incl. service rotation + spare + reserve)
...
- **Scheduled one-way train journeys:** **930/day**
- **Daily theoretical capacity from timetable:** 930 scheduled one-way train journeys/day × 240 AW2 pax = **223,200 passenger-trips/day**
- **Practical daily service capacity** (80% load factor): ≈ **178,560 passenger-trips/day**
- **Planning annual paid-trip scenario** (capacity-led): ≈ **32.6 – 52.1 M paid trips/year** at 50%–80% practical capacity utilisation

## Catchment

- City population: **200,000**
- Anchor-weighted coverage: 69.0%
- Catchment population: **≈ 138,000** (within ~800 m walk of a station)
...
| Interchange | 1 | 300 kW | 500 kWh |
| Major | 1 | 300 kW | 500 kWh |
| Terminal | 3 | 300 kW | 500 kWh |
| **Total installed** | **6** | **6,500 kW** | **42,500 kWh** |

Aggregate station-rail charging power: **3,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **0.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 32.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 349 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 37 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 31 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 930 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 3,673 train-km/day | One-way train journeys × route length |
| Annual service work | 1.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 32 MWh/day | 2.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 0.1 MW / 1 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 42 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 29 kWh | 90 kWh | 58 kWh | 2.3 km / 11 kWh |
| line-2 | 2 | 11 kWh | 49 kWh | 37 kWh | 2.1 km / 11 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (6.8 km @ $2.58 M/km) | $17 M |
| Elevated (1.1 km @ $9.75 M/km) | $11 M |
...
| `interchange-elevated` | 1 | $12.0 M | $12 M |
| **Stations subtotal** | | | **$35 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 23 | $560 k | $13 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 46 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 46 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 129 kW @ $700/kW | $90 k |
| Grid interconnection / PPA tie-in | 129 kW @ $100/kW | $13 k |
| Annual generation proxy | 0.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 0.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$103 k** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 7.9 km × $0.050 M/km | $395 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $775 k |
| EPC integration + project management (7%) | on subtotal | $6.3 M |
...
| Dedicated solar power plant | $103 k |
| Residual train-control wayside + charging microgrids | $1.2 M |
| EPC overhead (7%) | $6.3 M |
| **CAPEX total** | **$97 M** |
| Per-route-km | $12 M / km |
| Per-capita (city pop) | $483 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $33 M | 15% | $5.0 M | $28 M |
| Stations | $35 M | 20% | $7.0 M | $28 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $13 M | 35% | $4.5 M | $8.4 M |
| Dedicated solar plant | $103 k | 45% | $46 k | $57 k |
| Residual signalling / train control | $395 k | 50% | $197 k | $197 k |
| Charging microgrids | $775 k | 40% | $310 k | $465 k |
| EPC / project services | $6.3 M | 15% | $947 k | $5.4 M |
| **Total city CAPEX** | **$97 M** | **20.7%** | **$20 M** | **$77 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh soroti`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.7%** | **$20 M** | **$2.9 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.3%** | **$77 M** | **$11 M / yr** |
| of which planned local bond issuance | 63.5% of total CAPEX | $61 M | $8.8 M / yr |
| **Total city programme** | **100.0%** | **$97 M** | **$14 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $130 M | $110 M (84.7%) | $138 M | **$249 M** |
| **Default** | 2.00× | $174 M | $154 M (88.5%) | $193 M | **$347 M** |
| High | 3.00× | $261 M | $241 M (92.3%) | $302 M | **$543 M** |

At the default 2.00× case, OSR's $20 M external requirement is 88.5% below the illustrative foreign-company requirement of $174 M; the associated lifetime external-interest saving is $193 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$12 M / yr** | $58 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$9.9 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$82 M cumulative** | $408 |
| Lifecycle envelope (yr 1–40, high scenario) | **$82 M cumulative** | $408 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$407 M cumulative** | $2,037 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.9 M / yr → $9.9 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $20 M | 4.5% | 40 y, 7 y grace | $1.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $61 M | 14.0% | 40 y, 7 y grace | $8.7 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $15 M | — | — | — |
| **Total** | **100%** | **$97 M** | | | **$9.9 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $899 k / yr + local bonds $8.6 M / yr = **$9.5 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($2.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $515 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $1.5 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $20 k |
| Traction energy (11.6 GWh / yr) | 3,673 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 11.4 GWh/yr + dedicated solar plant 0.1 MW / 0.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2 k |
| Labour (129 FTE) | driverless roster: OCC/remote 29, station/platform 31, passenger service 26, fleet maintenance 12, infrastructure/energy 12, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $314 k |
| **OPEX subtotal** | | **$2.4 M / yr** |

_Annual service work: 3,673 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 1.4 M train-km / yr (2.9 M car-km / yr). On-site PV covers 11.4 GWh/yr and the dedicated solar plant adds 0.2 GWh/yr against 11.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 23 trainsets, 6 stations, 7.9 route-km, 2 lines, and 3,673 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (178,560 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the external/local CAPEX funding sources, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 8% |
| Annual paid trips | 32.6 M | 52.1 M | 5.1 M |
| Annual paid trips / city resident | 163 | 261 | 25 |
| Farebox revenue | $13 M / yr | $20 M / yr | $2.0 M / yr |
| Station shop leases | $157 k / yr | $157 k / yr | $157 k / yr |
| Advertising boards | $257 k / yr | $257 k / yr | $257 k / yr |
| **Total revenue** | **$13 M / yr** | **$21 M / yr** | **$2.4 M / yr** |
| Revenue / OPEX recovery | 548% | 867% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gross repayable-debt service + residual OPEX subsidy | $9.9 M / yr | $9.9 M / yr | **$9.9 M / yr** |
| Operating surplus applied to debt support | -$9.9 M / yr | -$9.9 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$9.9 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $18 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,280 m² of station shop/kiosk leases at $12/m²/month and 248 advertising boards at $102/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $3.6 M / yr | $5.8 M / yr | 16 min/trip × $0.42/h value-of-time proxy |
| Avoided road congestion | $3.1 M / yr | $5.0 M / yr | 39 M - 63 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $563 k / yr | $901 k / yr | 7.0–11.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $1.6 M / yr | $2.5 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $13 M / yr | $21 M / yr | 26% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $5.6 M / yr | $9.0 M / yr | 12% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 0 education anchors | 3,571 trips/school day; 0.8 M access-events/yr | 5,714 trips/school day; 1.3 M access-events/yr |
| Healthcare | 3 healthcare anchors | 9,857 trips/day; 3.6 M access-events/yr | 15,770 trips/day; 5.8 M access-events/yr |
| Commerce | 6 major/terminal/interchange nodes | 23,659 trips/trading day; 7.8 M access-events/yr | 37,855 trips/trading day; 12.5 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 10,267 trips/activity day; 3.1 M access-events/yr | 16,428 trips/activity day; 4.9 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $77 M | 79% of $97 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $123 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $18 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 11,010 job-years | retained CAPEX ÷ (4.0 × median annual income) |
| Annual paid-trip capacity used in revenue model | 32.6 M - 52.1 M trips/yr | 50%-80% of practical service capacity |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $97 M |
| Timetable-sized dedicated solar CAPEX | $103 k |
| **Reconciled project CAPEX** | **$97 M** |
| Imported / external-capital requirement | $20 M (20.7%) |
| Local-content / local-funding requirement | $77 M (79.3%) |
| Default foreign-turnkey external-capital comparison | $174 M; OSR saves $154 M (88.5%) |
| Lifetime external interest and combined financing saving | $193 M interest; $347 M capital + interest |
| 15%–25% planning risk envelope | $111 M–$121 M |
| Annual OPEX | $2.4 M / yr |
| Low/high project NPV at 8% | $-369 k / $50 M |
| Low/high project IRR | 8.0% / 12.6% |
| Low/high steady-state DSCR | 1.08 / 1.84 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 381.20 train-km; 1,903.12 kWh consumed; 2,214.72 kWh charged; 29 depot services completed; minimum SoC 91%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 3,834.50 train-km; 19,143.42 kWh consumed; 19,643.35 kWh charged; 324 depot services completed (4 active at cutoff); minimum SoC 91%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 90.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 90.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 91.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 66.2% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 87.7% | 100.0% / 90% | pass |
...
|---|---|
| ![Soroti energy and battery simulation dashboard](engineering/screenshots/soroti-simulation-dashboard.png) | ![Soroti simulator network visualizer](engineering/screenshots/soroti-network-visualizer.png) |
...
|---|---|
| SUMO | 8/8 screening services arrived; 0 input findings; status `completed` |
| QGIS/GDAL | GeoPackage generated with 2 corridors, 6 line platforms, 1 interchange complexes, 4 civil segments, and 0 input findings |
| pandapower/pvlib | Solver passed; grid-only max transformer loading 69.6%; coordinated-daylight max 76.6%; 0 open screening findings |
...
|---|---|
| ![Soroti QGIS engineering layers](engineering/screenshots/soroti-qgis-engineering-map.png) | ![Soroti SUMO timetable validation](engineering/screenshots/soroti-sumo-validation.png) |
...
| [`soroti.toml`](soroti.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`soroti-network-map.png`](soroti-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`soroti.corridor.geojson`](soroti.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`soroti.stations.json`](soroti.stations.json) | Machine-readable station list |
| [`soroti.design-quality.yaml`](soroti.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
