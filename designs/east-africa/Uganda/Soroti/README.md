...
| Revenue fleet passenger capacity | 6,480 AW2 pax (8,640 AW3 crush) |
...
|---|---|---|---|---|
| line-1 |  5.8 km | 5 | 20 | N Outer ↔ W Mid |
| line-2 |  2.1 km | 3 | 11 | SW Mid ↔ E Mid |
| **Total** | **7.9 km** | **8 unique** | **31** | |
...
| Revenue fleet capacity | 6,480 AW2 pax (8,640 AW3 crush) |
| Total fleet capacity | 7,440 AW2 pax (9,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 27 × 240 = **6,480 AW2 passengers** (8,640 AW3 crush)
- **Total fleet passenger capacity:** 31 × 240 = **7,440 AW2 passengers** (9,920 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 36.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 350 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 54 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 0 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 0.0 MW / 0 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 29 kWh | 106 kWh | 75 kWh | 2.0 km / 10 kWh |
| line-2 | 3 | 11 kWh | 65 kWh | 54 kWh | 1.7 km / 8 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 31 | $560 k | $17 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 62 | $60 k | $3.7 M |
| High sensitivity check | 62 | $120 k | $7.4 M |
...
| **Dedicated solar plant subtotal** | | **$0 k** |
...
| EPC integration + project management (7%) | on subtotal | $8.3 M |
...
| Depots | $8.0 M |
| Rolling stock | $17 M |
| Railway production plant | $3.7 M |
| Dedicated solar power plant | $0 k |
| Residual train-control wayside + charging microgrids | $1.4 M |
| EPC overhead (7%) | $8.3 M |
| **CAPEX total** | **$127 M** |
| Per-route-km | $16 M / km |
| Per-capita (city pop) | $634 / person |
...
|---|---|---|
| Construction (years 1–7) | **$8.2 M / yr** | $41 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$6.0 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$57 M cumulative** | $287 |
| Lifecycle envelope (yr 1–40, high scenario) | **$57 M cumulative** | $287 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$254 M cumulative** | $1,270 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.0 M / yr → $6.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $101 M | 4.5% | 40 y, 7 y grace | $6.0 M / yr |
| Government equity (no debt service) | 20% | $25 M | — | — | — |
| **Total** | **100%** | **$127 M** | | | **$6.0 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $4.6 M / yr = **$4.6 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($3.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $694 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $1.9 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $20 k |
| Traction energy (11.6 GWh / yr) | 3,673 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 12.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $0 k |
| Labour (146 FTE) | driverless roster: OCC/remote 33, station/platform 41, passenger service 26, fleet maintenance 15, infrastructure/energy 12, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $356 k |
| **OPEX subtotal** | | **$3.0 M / yr** |

_Annual service work: 3,673 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 1.4 M train-km / yr (2.9 M car-km / yr). On-site PV covers 12.4 GWh/yr and the dedicated solar plant adds 0.0 GWh/yr against 11.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 31 trainsets, 8 stations, 7.9 route-km, 2 lines, and 3,673 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 32.6 M | 52.1 M | 6.3 M |
| Annual paid trips / city resident | 163 | 261 | 32 |
| Farebox revenue | $13 M / yr | $20 M / yr | $2.4 M / yr |
| Station shop leases | $213 k / yr | $213 k / yr | $213 k / yr |
| Advertising boards | $340 k / yr | $340 k / yr | $340 k / yr |
| **Total revenue** | **$13 M / yr** | **$21 M / yr** | **$3.0 M / yr** |
| Revenue / OPEX recovery | 440% | 693% | 100% |
...
| Operating surplus applied to debt support | -$6.0 M / yr | -$6.0 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$6.0 M / yr** |
| Operating surplus after OPEX (before debt support) | $10 M / yr | $18 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,736 m² of station shop/kiosk leases at $12/m²/month and 328 advertising boards at $102/board/month, with occupancy derates applied._
...
| Healthcare | 5 healthcare anchors | 10,044 trips/day; 3.7 M access-events/yr | 16,070 trips/day; 5.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $75 M | 59% of $127 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $120 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $17 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 10,811 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $127 M |
| Timetable-sized dedicated solar CAPEX | $0 k |
| **Reconciled project CAPEX** | **$127 M** |
| 15%–25% planning risk envelope | $146 M–$159 M |
| Annual OPEX | $3.0 M / yr |
| Low/high project NPV at 8% | $-26043 k / $25 M |
| Low/high project IRR | 5.7% / 9.9% |
| Low/high steady-state DSCR | 1.71 / 2.97 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 375.32 train-km; 1,873.76 kWh consumed; 2,297.37 kWh charged; 28 depot services completed; minimum SoC 92%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 3,831.50 train-km; 19,128.28 kWh consumed; 19,807.62 kWh charged; 325 depot services completed (4 active at cutoff); minimum SoC 92%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 90.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 91.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 91.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 76.9% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 90.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 8 line platforms, 1 interchange complexes, 4 civil segments, and 0 input findings |
