...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$438 M (88.0%) of external capital** and **$550 M of external interest**. Capital plus saved interest totals **$988 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 32.1 km |
...
- Anchor-weighted coverage: 55.8%
- Catchment population: **≈ 139,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **19.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 19.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 341 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 36 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 14,907 train-km/day | One-way train journeys × route length |
| Annual service work | 5.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 129 MWh/day | 11.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 83 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 19.9 MW / 96 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 51 kWh | 114 kWh | 59 kWh | 2.1 km / 10 kWh |
| line-2 | 4 | 49 kWh | 90 kWh | 36 kWh | 3.6 km / 18 kWh |
| line-3 | 6 | 60 kWh | 123 kWh | 56 kWh | 3.7 km / 19 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 19,932 kW @ $700/kW | $14 M |
| Grid interconnection / PPA tie-in | 19,932 kW @ $100/kW | $2.0 M |
| Annual generation proxy | 19.9 MW × 4.8 peak-sun-h/day × 365 d/yr | 34.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 32.1 km × $0.050 M/km | $1.6 M |
...
| Per-capita (city pop) | $1,108 / person |
...
| Dedicated solar plant | $16 M | 45% | $7.2 M | $8.8 M |
| Residual signalling / train control | $1.6 M | 50% | $801 k | $801 k |
| Charging microgrids | $1.8 M | 40% | $730 k | $1.1 M |
| EPC / project services | $17 M | 15% | $2.6 M | $15 M |
| **Total city CAPEX** | **$277 M** | **21.7%** | **$60 M** | **$217 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh masaka`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.7%** | **$60 M** | **$8.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.3%** | **$217 M** | **$31 M / yr** |
| of which planned local bond issuance | 62.7% of total CAPEX | $174 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$277 M** | **$40 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $374 M | $314 M (83.9%) | $393 M | **$707 M** |
| **Default** | 2.00× | $498 M | $438 M (88.0%) | $550 M | **$988 M** |
| High | 3.00× | $748 M | $688 M (92.0%) | $862 M | **$1.55 bn** |

At the default 2.00× case, OSR's $60 M external requirement is 88.0% below the illustrative foreign-company requirement of $498 M; the associated lifetime external-interest saving is $550 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $133 |
| Steady-state, low capacity-use (year 8+) | **$15 M / yr** | $59 |
| Steady-state, high capacity-use (year 8+) | **$3.5 M / yr** | $14 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $113 |
| Lifecycle envelope (yr 1–40, low scenario) | **$722 M cumulative** | $2,887 |
| Lifecycle envelope (yr 1–40, high scenario) | **$348 M cumulative** | $1,390 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $4,644 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $13 M / yr → $25 M / yr._
...
| Local-currency sovereign / project bonds for local content | 63% | $174 M | 14.0% | 40 y, 7 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $43 M | — | — | — |
| **Total** | **100%** | **$277 M** | | | **$28 M / yr** |
...
| Traction energy (47.0 GWh / yr) | 14,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.6 GWh/yr + dedicated solar plant 19.9 MW / 34.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $239 k |
| Labour (251 FTE) | driverless roster: OCC/remote 53, station/platform 67, passenger service 38, fleet maintenance 41, infrastructure/energy 31, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $611 k |
| **OPEX subtotal** | | **$6.5 M / yr** |

_Annual service work: 14,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.8 M car-km / yr). On-site PV covers 16.6 GWh/yr and the dedicated solar plant adds 34.9 GWh/yr against 47.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 69 trainsets, 16 stations, 32.1 route-km, 3 lines, and 14,907 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 14.5 M |
| Annual paid trips / city resident | 196 | 313 | 58 |
| Farebox revenue | $19 M / yr | $30 M / yr | $5.6 M / yr |
| Station shop leases | $351 k / yr | $351 k / yr | $351 k / yr |
| Advertising boards | $571 k / yr | $571 k / yr | $571 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$6.5 M / yr** |
| Revenue / OPEX recovery | 304% | 479% | 100% |
...
| Operating surplus applied to debt support | -$13 M / yr | -$25 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $15 M / yr | $3.5 M / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $25 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,864 m² of station shop/kiosk leases at $12/m²/month and 552 advertising boards at $102/board/month, with occupancy derates applied._
...
| Avoided road congestion | $5.6 M / yr | $9.0 M / yr | 71 M - 113 M vehicle-km/yr avoided × $0.08/vehicle-km |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $217 M | 78% of $277 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $347 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $50 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 31,161 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$277 M** |
| Imported / external-capital requirement | $60 M (21.7%) |
| Local-content / local-funding requirement | $217 M (78.3%) |
| Default foreign-turnkey external-capital comparison | $498 M; OSR saves $438 M (88.0%) |
| Lifetime external interest and combined financing saving | $550 M interest; $988 M capital + interest |
| 15%–25% planning risk envelope | $318 M–$346 M |
| Annual OPEX | $6.5 M / yr |
| Low/high project NPV at 8% | $-116524 k / $-40337 k |
| Low/high project IRR | 2.5% / 6.4% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,409.26 train-km; 7,035.62 kWh consumed; 7,518.09 kWh charged; 37 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,125.23 train-km; 75,511.65 kWh consumed; 76,908.51 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 57.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 77.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 99.9% / 60% | pass |
| ten-hour single charging-pad outage | 77.6% | 100.0% / 90% | pass |
...
|---|---|
| ![Masaka energy and battery simulation dashboard](engineering/screenshots/masaka-simulation-dashboard.png) | ![Masaka simulator network visualizer](engineering/screenshots/masaka-network-visualizer.png) |
...
|---|---|
| ![Masaka QGIS engineering layers](engineering/screenshots/masaka-qgis-engineering-map.png) | ![Masaka SUMO timetable validation](engineering/screenshots/masaka-sumo-validation.png) |
