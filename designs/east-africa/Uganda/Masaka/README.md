...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$411 M (87.7%) of external capital** and **$515 M of external interest**. Capital plus saved interest totals **$927 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (30.9 km @ $2.58 M/km) | $80 M |
...
| **Total city CAPEX** | **$260 M** | **22.1%** | **$58 M** | **$203 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.1%** | **$58 M** | **$8.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.9%** | **$203 M** | **$29 M / yr** |
| of which planned local bond issuance | 62.3% of total CAPEX | $162 M | $23 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $352 M | $294 M (83.6%) | $369 M | **$663 M** |
| **Default** | 2.00× | $469 M | $411 M (87.7%) | $515 M | **$927 M** |
| High | 3.00× | $703 M | $646 M (91.8%) | $809 M | **$1.45 bn** |

At the default 2.00× case, OSR's $58 M external requirement is 87.7% below the illustrative foreign-company requirement of $469 M; the associated lifetime external-interest saving is $515 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$31 M / yr** | $124 |
| Steady-state, low capacity-use (year 8+) | **$13 M / yr** | $51 |
| Steady-state, high capacity-use (year 8+) | **$1.4 M / yr** | $6 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $106 |
| Lifecycle envelope (yr 1–40, low scenario) | **$640 M cumulative** | $2,559 |
| Lifecycle envelope (yr 1–40, high scenario) | **$266 M cumulative** | $1,062 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.09 bn cumulative** | $4,357 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $58 M | 4.5% | 40 y, 7 y grace | $3.4 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $162 M | 14.0% | 40 y, 7 y grace | $23 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $41 M | — | — | — |
| **Total** | **100%** | **$260 M** | | | **$26 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.6 M / yr + local bonds $23 M / yr = **$25 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 13.7 M |
| Annual paid trips / city resident | 196 | 313 | 55 |
| Farebox revenue | $19 M / yr | $30 M / yr | $5.3 M / yr |
| Station shop leases | $351 k / yr | $351 k / yr | $351 k / yr |
| Advertising boards | $571 k / yr | $571 k / yr | $571 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$6.2 M / yr** |
| Revenue / OPEX recovery | 319% | 502% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $13 M / yr | $1.4 M / yr | **$26 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $203 M | 78% of $260 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 29,148 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $58 M (22.1%) |
| Local-content / local-funding requirement | $203 M (77.9%) |
| Default foreign-turnkey external-capital comparison | $469 M; OSR saves $411 M (87.7%) |
| Lifetime external interest and combined financing saving | $515 M interest; $927 M capital + interest |
| 15%–25% planning risk envelope | $299 M–$326 M |
| Annual OPEX | $6.2 M / yr |
| Low/high project NPV at 8% | $-102195 k / $-26008 k |
