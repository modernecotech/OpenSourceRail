...
|---|---|---|---|---|
| line-1 | 10.1 km | 7 | 31 | NE Mid ↔ W Mid |
| line-2 |  9.8 km | 7 | 30 | S Mid ↔ E Mid |
| line-3 | 12.1 km | 8 | 36 | SE Mid ↔ NW Outer |
| **Total** | **32.1 km** | **22 unique** | **97** | |
...
| Total fleet capacity | 23,280 AW2 pax (31,040 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 97 × 240 = **23,280 AW2 passengers** (31,040 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **18.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 16.3× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 338 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 18.2 MW / 87 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 51 kWh | 131 kWh | 75 kWh | 2.1 km / 10 kWh |
| line-2 | 7 | 49 kWh | 131 kWh | 77 kWh | 2.0 km / 10 kWh |
| line-3 | 7 | 60 kWh | 139 kWh | 72 kWh | 4.4 km / 22 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 97 | $560 k | $54 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 194 | $60 k | $12 M |
| High sensitivity check | 194 | $120 k | $23 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 18,207 kW @ $700/kW | $13 M |
| Grid interconnection / PPA tie-in | 18,207 kW @ $100/kW | $1.8 M |
| Annual generation proxy | 18.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 31.9 GWh/yr |
...
| Per-capita (city pop) | $1,367 / person |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $88 |
| Steady-state, low capacity-use (year 8+) | **$3.8 M / yr** | $15 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$280 M cumulative** | $1,122 |
| Lifecycle envelope (yr 1–40, high scenario) | **$155 M cumulative** | $618 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$685 M cumulative** | $2,738 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $12 M / yr → $16 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $273 M | 4.5% | 40 y, 7 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $68 M | — | — | — |
| **Total** | **100%** | **$342 M** | | | **$16 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $12 M / yr = **$12 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (47.0 GWh / yr) | 14,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 19.3 GWh/yr + dedicated solar plant 18.2 MW / 31.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $218 k |
| Labour (299 FTE) | driverless roster: OCC/remote 65, station/platform 93, passenger service 38, fleet maintenance 49, infrastructure/energy 33, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $728 k |
| **OPEX subtotal** | | **$7.9 M / yr** |

_Annual service work: 14,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.8 M car-km / yr). On-site PV covers 19.3 GWh/yr and the dedicated solar plant adds 31.9 GWh/yr against 47.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 97 trainsets, 22 stations, 32.1 route-km, 3 lines, and 14,907 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 17.2 M |
| Annual paid trips / city resident | 196 | 313 | 69 |
| Farebox revenue | $19 M / yr | $30 M / yr | $6.7 M / yr |
| Station shop leases | $488 k / yr | $488 k / yr | $488 k / yr |
| Advertising boards | $779 k / yr | $779 k / yr | $779 k / yr |
| **Total revenue** | **$20 M / yr** | **$32 M / yr** | **$7.9 M / yr** |
| Revenue / OPEX recovery | 255% | 398% | 100% |
...
| Operating surplus applied to debt support | -$12 M / yr | -$16 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.8 M / yr | $0 k / yr | **$16 M / yr** |
| Operating surplus after OPEX (before debt support) | $12 M / yr | $24 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,984 m² of station shop/kiosk leases at $12/m²/month and 752 advertising boards at $102/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $198 M | 58% of $342 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 28,419 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$342 M** |
| 15%–25% planning risk envelope | $393 M–$427 M |
| Annual OPEX | $7.9 M / yr |
| Low/high project NPV at 8% | $-171944 k / $-95757 k |
| Low/high project IRR | 0.9% / 4.7% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,402.01 train-km; 6,999.40 kWh consumed; 7,704.47 kWh charged; 36 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,490.64 train-km; 77,335.51 kWh consumed; 79,399.78 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 81.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 8 civil segments, and 0 input findings |
