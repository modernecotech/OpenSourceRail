...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **14,025 – 21,037 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (30.9 km @ $0.85 M/km) | $26 M |
| Elevated (1.0 km @ $4.0 M/km) | $4.2 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 32.0 km × $0.015 M/km | $481 k |
...
|---|---|---|
| Construction (years 1–7) | **$7.2 M / yr** | $29 |
| Steady-state, low-ridership (year 8+) | **$6.4 M / yr** | $25 |
| Steady-state, high-ridership (year 8+) | **$4.5 M / yr** | $18 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$197 M cumulative** | $786 |
| Lifecycle envelope (yr 1–30, high scenario) | **$154 M cumulative** | $616 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$50 M cumulative** | $202 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $23 M | 14.0% | 30 y, 7 y grace | $3.4 M / yr |
| Government equity (no debt service) | 15% | $14 M | — | — | — |
| **Total** | **100%** | **$91 M** | | | **$7.0 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.1 M / yr + bonds $3.2 M / yr = **$5.3 M / yr** total — plus the equity tranche amortised across construction ($2.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 80,007 |
| Daily paid trips / population | 8% | 15% | 32% |
| Annual paid trips | 7.3 M | 13.7 M | 29.2 M |
| Farebox revenue | $2.1 M / yr | $4.0 M / yr | $8.5 M / yr |
| Station shop leases | $417 k / yr | $417 k / yr | $417 k / yr |
| Advertising boards | $679 k / yr | $679 k / yr | $679 k / yr |
| **Total revenue** | **$3.2 M / yr** | **$5.1 M / yr** | **$9.6 M / yr** |
| Revenue / OPEX + debt-service recovery | 34% | 53% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $6.4 M / yr | $4.5 M / yr | **$0 / yr** |
