...
| Bucket | Value |
|---|---|
| At-grade (30.9 km @ €3.5 M/km) | €108 M |
| Elevated (1.0 km @ €18 M/km) | €19 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 32.0 km × €0.015 M/km | €0.5 M |
...
| Per-capita (city pop) | €1,443 / person |
...
| Steady-state, low-ridership (year 8+) | **€35 M / yr** | €142 |
| Steady-state, high-ridership (year 8+) | **€34 M / yr** | €138 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.02 bn cumulative** | €4,060 |
| Lifecycle envelope (yr 1–30, high scenario) | **€992 M cumulative** | €3,967 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€7.9 M / yr (low) → €6.9 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €90 M | 14.0% | 30 y, 7 y grace | €13 M / yr |
| Government equity (no debt service) | 15% | €54 M | — | — | — |
| **Total** | **100%** | **€361 M** | | | **€28 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €8.2 M / yr + bonds €13 M / yr = **€21 M / yr** total — plus the equity tranche amortised across construction (€7.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (204 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €457 k |
...
| Operating shortfall (gov subsidy required) | €7.9 M / yr | €6.9 M / yr |
