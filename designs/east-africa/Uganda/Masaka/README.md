...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $74 |
| Steady-state, low capacity-use (year 8+) | **$119 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$133 M cumulative** | $532 |
| Lifecycle envelope (yr 1–40, high scenario) | **$129 M cumulative** | $517 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$572 M cumulative** | $2,289 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $229 M | 4.5% | 40 y, 7 y grace | $13 M / yr |
| Government equity (no debt service) | 20% | $57 M | — | — | — |
| **Total** | **100%** | **$286 M** | | | **$13 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $10 M / yr = **$10 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $119 k / yr | $0 k / yr | **$13 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $166 M | 58% of $286 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,830 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-123113 k / $-46926 k |
