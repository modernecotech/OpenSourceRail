# Kampala Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,061 |
| Manufacturing schedule rows | 3,707 |
| Manufacturing material/BOM rows | 51,016 |
| Manufacturing QA verification rows | 3,707 |
| Construction QA action rows | 3,359 |
| Maintenance handover schedule rows | 4,515 |
...
|---|---:|
| `project_kit` | 7,492 |
| `rolling_stock_bom` | 40,920 |
| `rolling_stock_cots_fitout` | 2,604 |
...
| `qa-11-bogie-wheelset` | 372 |
| `qa-12-traction-brake-battery` | 372 |
| `qa-13-passenger-systems` | 372 |
| `qa-15-first-article-trainset` | 372 |
...
| `qa-26-wayside-comms-safety` | 496 |
