...
| Stations | $378 M | 40% | $151 M | $227 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $307 M | 55% | $169 M | $138 M |
| Dedicated solar plant | $270 M | 70% | $189 M | $81 M |
| Residual signalling / train control | $11 M | 80% | $8.9 M | $2.2 M |
| Charging microgrids | $20 M | 55% | $11 M | $9.1 M |
| EPC / project services | $110 M | 45% | $49 M | $60 M |
| **Total city CAPEX** | **$1.95 bn** | **45.0%** | **$878 M** | **$1.07 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **45.0%** | **$878 M** | **$125 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.0%** | **$1.07 bn** | **$153 M / yr** |
| of which planned local bond issuance | 44.0% of total CAPEX | $858 M | $123 M / yr |
...
|---|---|---|
| Construction (years 1–7) | **$190 M / yr** | $101 |
| Steady-state, low capacity-use (year 8+) | **$144 M / yr** | $77 |
| Steady-state, high capacity-use (year 8+) | **$102 M / yr** | $55 |
| Steady-state, operating-neutral revenue case | **$173 M / yr** | $92 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.08 bn cumulative** | $3,243 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.71 bn cumulative** | $2,511 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.05 bn cumulative** | $3,760 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $878 M | 4.5% | 40 y, 7 y grace | $52 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $858 M | 14.0% | 40 y, 7 y grace | $122 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $214 M | — | — | — |
| **Total** | **100%** | **$1.95 bn** | | | **$173 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $39 M / yr + local bonds $120 M / yr = **$160 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($31 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $144 M / yr | $102 M / yr | **$173 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.07 bn | 55% of $1.95 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.72 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $245 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 154,065 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $878 M (45.0%) |
| Local-content / local-funding requirement | $1.07 bn (55.0%) |
