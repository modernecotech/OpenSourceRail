...
|---|---|---|
| Construction (years 1–7) | **$185 M / yr** | $99 |
| Steady-state, low-ridership (year 8+) | **$228 M / yr** | $121 |
| Steady-state, high-ridership (year 8+) | **$222 M / yr** | $118 |
| Steady-state, operating-neutral revenue case | **$178 M / yr** | $95 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.53 bn cumulative** | $3,483 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.40 bn cumulative** | $3,413 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.40 bn cumulative** | $2,880 |

_Population basis: 1,875,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $49 M / yr → $43 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.40 bn | 3.8% | 30 y, 7 y grace | $92 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $584 M | 14.0% | 30 y, 7 y grace | $86 M / yr |
| Government equity (no debt service) | 15% | $350 M | — | — | — |
| **Total** | **100%** | **$2.34 bn** | | | **$178 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $53 M / yr + bonds $82 M / yr = **$135 M / yr** total — plus the equity tranche amortised across construction ($50 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
