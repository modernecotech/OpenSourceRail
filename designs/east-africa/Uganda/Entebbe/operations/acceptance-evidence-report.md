# Entebbe Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 15,679 |
| Manufacturing QA verification rows | 1,048 |
| Construction QA action rows | 974 |
| Maintenance handover schedule rows | 1,250 |
