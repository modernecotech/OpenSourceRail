...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **31,320 – 52,200 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$19 M / yr** | $75 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $73 |
| Steady-state, high-ridership (year 8+) | **$16 M / yr** | $62 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$549 M cumulative** | $2,197 |
| Lifecycle envelope (yr 1–30, high scenario) | **$488 M cumulative** | $1,954 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$132 M cumulative** | $526 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $48 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $59 M | 14.0% | 30 y, 7 y grace | $8.7 M / yr |
| Government equity (no debt service) | 15% | $36 M | — | — | — |
| **Total** | **100%** | **$237 M** | | | **$18 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.4 M / yr + bonds $8.3 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($5.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 37,500 | 62,500 | 209,123 |
| Daily paid trips / population | 15% | 25% | 84% |
| Annual paid trips | 13.7 M | 22.8 M | 76.3 M |
| Farebox revenue | $4.0 M / yr | $6.6 M / yr | $22 M / yr |
| Station shop leases | $582 k / yr | $582 k / yr | $582 k / yr |
| Advertising boards | $936 k / yr | $936 k / yr | $936 k / yr |
| **Total revenue** | **$5.5 M / yr** | **$8.1 M / yr** | **$24 M / yr** |
| Revenue / OPEX + debt-service recovery | 23% | 34% | 100% |
