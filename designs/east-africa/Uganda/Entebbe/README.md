...
| Steady-state, low-ridership (year 8+) | **$33 M / yr** | $130 |
| Steady-state, high-ridership (year 8+) | **$30 M / yr** | $121 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $117 |
| Lifecycle envelope (yr 1–30, low scenario) | **$960 M cumulative** | $3,840 |
| Lifecycle envelope (yr 1–30, high scenario) | **$909 M cumulative** | $3,636 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$882 M cumulative** | $3,527 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.4 M / yr → $1.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $229 M | 3.8% | 30 y, 7 y grace | $15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $95 M | 14.0% | 30 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$381 M** | | | **$29 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.7 M / yr + bonds $13 M / yr = **$22 M / yr** total — plus the equity tranche amortised across construction ($8.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 31,320 | 52,200 | 63,428 |
| Daily paid trips / catchment | 18% | 30% | 36% |
| Daily paid trips / city population | 13% | 21% | 25% |
| Annual paid trips | 11.4 M | 19.1 M | 23.2 M |
| Farebox revenue | $3.3 M / yr | $5.5 M / yr | $6.7 M / yr |
| Station shop leases | $582 k / yr | $582 k / yr | $582 k / yr |
| Advertising boards | $936 k / yr | $936 k / yr | $936 k / yr |
| **Total revenue** | **$4.8 M / yr** | **$7.0 M / yr** | **$8.2 M / yr** |
