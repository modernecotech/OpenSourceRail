...
| Per-capita (city pop) | $1,153 / person |
...
| Steady-state, high-ridership (year 8+) | **$22 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $88 |
| Lifecycle envelope (yr 1–30, low scenario) | **$704 M cumulative** | $2,818 |
| Lifecycle envelope (yr 1–30, high scenario) | **$666 M cumulative** | $2,665 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$666 M cumulative** | $2,665 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $173 M | 3.8% | 30 y, 7 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $72 M | 14.0% | 30 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $43 M | — | — | — |
| **Total** | **100%** | **$288 M** | | | **$22 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.6 M / yr + bonds $10 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($6.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating surplus after OPEX | $0 k / yr | $553 k / yr | $0 / yr |
