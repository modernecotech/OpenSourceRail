...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 59 | $534 k | $31 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 43.2 km × $0.015 M/km | $648 k |
...
| Lifecycle envelope (yr 1–30, low scenario) | **$355 M cumulative** | $1,421 |
| Lifecycle envelope (yr 1–30, high scenario) | **$313 M cumulative** | $1,251 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$83 M cumulative** | $333 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $352 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $90 M | 3.8% | 30 y, 7 y grace | $5.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $38 M | 14.0% | 30 y, 7 y grace | $5.5 M / yr |
| Government equity (no debt service) | 15% | $23 M | — | — | — |
| **Total** | **100%** | **$150 M** | | | **$11 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.4 M / yr + bonds $5.3 M / yr = **$8.7 M / yr** total — plus the equity tranche amortised across construction ($3.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (271 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $660 k |
