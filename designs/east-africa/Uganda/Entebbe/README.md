...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 43.2 km × $0.015 M/km | $2.2 M |
...
| Per-capita (city pop) | $1,123 / person |
...
| Steady-state, low-ridership (year 8+) | **$23 M / yr** | $92 |
| Steady-state, high-ridership (year 8+) | **$21 M / yr** | $86 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $86 |
| Lifecycle envelope (yr 1–30, low scenario) | **$684 M cumulative** | $2,735 |
| Lifecycle envelope (yr 1–30, high scenario) | **$649 M cumulative** | $2,596 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$649 M cumulative** | $2,596 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.5 M / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 31,320 | 52,200 | 45,640 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 13% | 21% | 18% |
| Annual paid trips | 11.4 M | 19.1 M | 16.7 M |
| Farebox revenue | $3.3 M / yr | $5.5 M / yr | $4.8 M / yr |
| Station shop leases | $582 k / yr | $582 k / yr | $582 k / yr |
| Advertising boards | $936 k / yr | $936 k / yr | $936 k / yr |
| **Total revenue** | **$4.8 M / yr** | **$7.0 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX recovery | 76% | 111% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $23 M / yr | $21 M / yr | **$21 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $694 k / yr | $0 / yr |
