...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **41,900 – 75,420 trips/day**
...
| Per-capita (city pop) | $2,730 / person |
...
|---|---|---|
| Construction (years 1–7) | **$13 M / yr** | $66 |
| Steady-state, low-ridership (year 8+) | **$19 M / yr** | $96 |
| Steady-state, high-ridership (year 8+) | **$14 M / yr** | $72 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $57 |
| Lifecycle envelope (yr 1–40, low scenario) | **$727 M cumulative** | $3,634 |
| Lifecycle envelope (yr 1–40, high scenario) | **$571 M cumulative** | $2,853 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$468 M cumulative** | $2,342 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.8 M / yr → $3.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $218 M | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $273 M | 2.0% | 40 y, 7 y grace | $11 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 14.0% | 40 y, 7 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $55 M | — | — | — |
| **Total** | **100%** | **$546 M** | | | **$11 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — concessional loan $5.5 M / yr + fallback bonds $0 k / yr = **$5.5 M / yr** total. The $218 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($7.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 41,900 | 75,420 | 97,364 |
| Daily paid trips / catchment | 25% | 45% | 58% |
| Daily paid trips / city population | 21% | 38% | 49% |
| Annual paid trips | 15.3 M | 27.5 M | 35.5 M |
| Farebox revenue | $5.9 M / yr | $11 M / yr | $14 M / yr |
| Station shop leases | $458 k / yr | $458 k / yr | $458 k / yr |
| Advertising boards | $737 k / yr | $737 k / yr | $737 k / yr |
| **Total revenue** | **$7.1 M / yr** | **$12 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 48% | 79% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov repayable-debt service + residual OPEX subsidy | $19 M / yr | $14 M / yr | **$11 M / yr** |
