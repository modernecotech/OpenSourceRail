...
|---|---|---|
| Construction (years 1–7) | **$24 M / yr** | $122 |
| Steady-state, low-ridership (year 8+) | **$26 M / yr** | $130 |
| Steady-state, high-ridership (year 8+) | **$24 M / yr** | $119 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $118 |
| Lifecycle envelope (yr 1–30, low scenario) | **$768 M cumulative** | $3,838 |
| Lifecycle envelope (yr 1–30, high scenario) | **$719 M cumulative** | $3,593 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$714 M cumulative** | $3,569 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.3 M / yr → $212 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $185 M | 3.8% | 30 y, 7 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $77 M | 14.0% | 30 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $46 M | — | — | — |
| **Total** | **100%** | **$309 M** | | | **$24 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $7.0 M / yr + bonds $11 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($6.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| **Total revenue** | **$4.4 M / yr** | **$6.5 M / yr** | **$6.7 M / yr** |
