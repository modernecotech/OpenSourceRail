...
|---|---|---|---|---|
| line-1 | 12.2 km | 8 | 28 | NW Outer ↔ SE Mid |
| line-2 |  9.2 km | 6 | 21 | NE Inner ↔ SW Mid |
| line-3 | 14.9 km | 7 | 34 | W Mid ↔ E Outer |
| **Total** | **36.3 km** | **21 unique** | **83** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **21.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 158 MWh/day | 18,332 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 93 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 21.4 MW / 107 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 21,364 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 21,364 kW @ $100/kW | $2.1 M |
| Annual generation proxy | 21.4 MW × 5.0 peak-sun-h/day × 365 d/yr | 39.0 GWh/yr |
...
| Per-capita (city pop) | $2,816 / person |
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $125 |
| Steady-state, low capacity-use (year 8+) | **$17 M / yr** | $84 |
| Steady-state, high capacity-use (year 8+) | **$7.0 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $94 |
| Lifecycle envelope (yr 1–40, low scenario) | **$728 M cumulative** | $3,641 |
| Lifecycle envelope (yr 1–40, high scenario) | **$406 M cumulative** | $2,032 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$795 M cumulative** | $3,977 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $2.0 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $451 M | 2.0% | 40 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $113 M | — | — | — |
| **Total** | **100%** | **$563 M** | | | **$19 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $9.0 M / yr = **$9.0 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (57.8 GWh / yr) | 18,332 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 23.9 GWh/yr + dedicated solar plant 21.4 MW / 39.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $256 k |
| Labour (322 FTE) | driverless roster: OCC/remote 61, station/platform 86, passenger service 35, fleet maintenance 49, infrastructure/energy 55, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $784 k |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 18,332 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.2 M train-km / yr (14.5 M car-km / yr). On-site PV covers 23.9 GWh/yr and the dedicated solar plant adds 39.0 GWh/yr against 57.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 42.0 M | 67.3 M | 36.8 M |
| Annual paid trips / city resident | 210 | 336 | 184 |
...
| Revenue / OPEX recovery | 113% | 176% | 100% |
...
| Operating surplus applied to debt support | -$2.0 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $17 M / yr | $7.0 M / yr | **$19 M / yr** |
| Operating surplus after OPEX (before debt support) | $2.0 M / yr | $12 M / yr | $0 / yr |
...
| Avoided road congestion | $5.5 M / yr | $8.8 M / yr | 69 M - 110 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $989 k / yr | $1.6 M / yr | 12.4–19.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $2.7 M / yr | $4.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 5,497 trips/school day; 1.2 M access-events/yr | 8,795 trips/school day; 1.9 M access-events/yr |
| Healthcare | 6 healthcare anchors | 11,059 trips/day; 4.0 M access-events/yr | 17,695 trips/day; 6.5 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 26,496 trips/trading day; 8.7 M access-events/yr | 42,394 trips/trading day; 14.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $303 M | 54% of $563 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 43,472 job-years | retained CAPEX ÷ (4.0 × median annual income) |
