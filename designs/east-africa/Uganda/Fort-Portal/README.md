...
| Per-capita (city pop) | $1,148 / person |
...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $91 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $92 |
| Steady-state, high-ridership (year 8+) | **$18 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $88 |
| Lifecycle envelope (yr 1–30, low scenario) | **$550 M cumulative** | $2,752 |
| Lifecycle envelope (yr 1–30, high scenario) | **$531 M cumulative** | $2,653 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$531 M cumulative** | $2,653 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $859 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $138 M | 3.8% | 30 y, 7 y grace | $9.1 M / yr |
...
|---|---|---|---|
| Daily paid trips | 30,168 | 50,280 | 38,288 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 15% | 25% | 19% |
| Annual paid trips | 11.0 M | 18.4 M | 14.0 M |
| Farebox revenue | $3.2 M / yr | $5.3 M / yr | $4.1 M / yr |
| Station shop leases | $458 k / yr | $458 k / yr | $458 k / yr |
| Advertising boards | $737 k / yr | $737 k / yr | $737 k / yr |
| **Total revenue** | **$4.4 M / yr** | **$6.5 M / yr** | **$5.2 M / yr** |
| Revenue / OPEX recovery | 84% | 124% | 100% |
