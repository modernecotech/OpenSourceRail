...
|---|---|---|---|---|
| line-1 | 12.2 km | 9 | 38 | SE Mid ↔ NW Outer |
| line-2 |  9.2 km | 6 | 28 | NE Inner ↔ SW Mid |
| line-3 | 14.9 km | 9 | 42 | E Outer ↔ W Mid |
| **Total** | **36.3 km** | **24 unique** | **108** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **21.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 335 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 21.6 MW / 104 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 61 kWh | 163 kWh | 96 kWh | 2.3 km / 12 kWh |
| line-2 | 6 | 46 kWh | 114 kWh | 64 kWh | 2.4 km / 12 kWh |
| line-3 | 8 | 74 kWh | 155 kWh | 73 kWh | 5.0 km / 25 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 21,590 kW @ $700/kW | $15 M |
| Grid interconnection / PPA tie-in | 21,590 kW @ $100/kW | $2.2 M |
| Annual generation proxy | 21.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 37.8 GWh/yr |
...
| Per-capita (city pop) | $1,921 / person |
...
|---|---|---|
| Construction (years 1–7) | **$25 M / yr** | $124 |
| Steady-state, low capacity-use (year 8+) | **$6.7 M / yr** | $34 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $90 |
| Lifecycle envelope (yr 1–40, low scenario) | **$395 M cumulative** | $1,975 |
| Lifecycle envelope (yr 1–40, high scenario) | **$174 M cumulative** | $869 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$770 M cumulative** | $3,848 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $307 M | 4.5% | 40 y, 7 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $77 M | — | — | — |
| **Total** | **100%** | **$384 M** | | | **$18 M / yr** |
...
| Traction energy (53.2 GWh / yr) | 16,874 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 21.6 MW / 37.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $259 k |
| Labour (318 FTE) | driverless roster: OCC/remote 73, station/platform 95, passenger service 38, fleet maintenance 55, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $775 k |
| **OPEX subtotal** | | **$8.8 M / yr** |

_Annual service work: 16,874 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.7 M train-km / yr (13.3 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 37.8 GWh/yr against 53.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 108 trainsets, 24 stations, 36.3 route-km, 3 lines, and 16,874 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 19.5 M |
| Annual paid trips / city resident | 244 | 391 | 98 |
| Farebox revenue | $19 M / yr | $30 M / yr | $7.5 M / yr |
| Station shop leases | $499 k / yr | $499 k / yr | $499 k / yr |
| Advertising boards | $803 k / yr | $803 k / yr | $803 k / yr |
| **Total revenue** | **$20 M / yr** | **$32 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 228% | 357% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.7 M / yr | $0 k / yr | **$18 M / yr** |
| Operating surplus after OPEX (before debt support) | $11 M / yr | $23 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,072 m² of station shop/kiosk leases at $12/m²/month and 776 advertising boards at $102/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 8,973 trips/school day; 2.0 M access-events/yr | 14,356 trips/school day; 3.2 M access-events/yr |
| Healthcare | 5 healthcare anchors | 11,551 trips/day; 4.2 M access-events/yr | 18,481 trips/day; 6.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $223 M | 58% of $384 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $357 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $51 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 32,039 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $442 M–$480 M |
| Annual OPEX | $8.8 M / yr |
| Low/high project NPV at 8% | $-209544 k / $-133357 k |
| Low/high project IRR | -0.1% / 3.7% |
| Low/high steady-state DSCR | 0.63 / 1.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,545.72 train-km; 7,716.86 kWh consumed; 8,483.64 kWh charged; 35 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,513.82 train-km; 87,435.97 kWh consumed; 89,737.59 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 76.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 2 interchange complexes, 10 civil segments, and 0 input findings |
