...
|---|---|---|
| Construction (years 1–7) | **$20 M / yr** | $100 |
| Steady-state, low capacity-use (year 8+) | **$1.7 M / yr** | $9 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$197 M cumulative** | $985 |
| Lifecycle envelope (yr 1–40, high scenario) | **$140 M cumulative** | $699 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$619 M cumulative** | $3,097 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $13 M / yr → $15 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $247 M | 4.5% | 40 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 20% | $62 M | — | — | — |
| **Total** | **100%** | **$309 M** | | | **$15 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $11 M / yr = **$11 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.8 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Operating surplus applied to debt support | -$13 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.7 M / yr | $0 k / yr | **$15 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $179 M | 58% of $309 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,725 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$309 M** |
| 15%–25% planning risk envelope | $356 M–$387 M |
| Annual OPEX | $7.0 M / yr |
| Low/high project NPV at 8% | $-144056 k / $-67868 k |
