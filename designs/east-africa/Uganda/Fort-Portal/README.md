...
| Bucket | Value |
|---|---|
| At-grade (35.0 km @ $1.2 M/km) | $42 M |
| Elevated (1.2 km @ $5.5 M/km) | $6.7 M |
...
|---|---|---|
| Construction (years 1–7) | **$9.7 M / yr** | $48 |
| Steady-state, low-ridership (year 8+) | **$9.7 M / yr** | $49 |
| Steady-state, high-ridership (year 8+) | **$8.2 M / yr** | $41 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$291 M cumulative** | $1,457 |
| Lifecycle envelope (yr 1–30, high scenario) | **$257 M cumulative** | $1,287 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$68 M cumulative** | $338 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $411 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $73 M | 3.8% | 30 y, 7 y grace | $4.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $30 M | 14.0% | 30 y, 7 y grace | $4.5 M / yr |
| Government equity (no debt service) | 15% | $18 M | — | — | — |
| **Total** | **100%** | **$122 M** | | | **$9.3 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.8 M / yr + bonds $4.3 M / yr = **$7.0 M / yr** total — plus the equity tranche amortised across construction ($2.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
