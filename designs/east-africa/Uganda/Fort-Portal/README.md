...
| Bucket | Value |
|---|---|
| At-grade (35.0 km @ $0.85 M/km) | $30 M |
| Elevated (1.2 km @ $4.0 M/km) | $4.9 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 36.3 km × $0.015 M/km | $545 k |
...
|---|---|---|
| Construction (years 1–7) | **$7.9 M / yr** | $40 |
| Steady-state, low-ridership (year 8+) | **$7.6 M / yr** | $38 |
| Steady-state, high-ridership (year 8+) | **$6.1 M / yr** | $31 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$231 M cumulative** | $1,153 |
| Lifecycle envelope (yr 1–30, high scenario) | **$196 M cumulative** | $982 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$55 M cumulative** | $277 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $60 M | 3.8% | 30 y, 7 y grace | $3.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $25 M | 14.0% | 30 y, 7 y grace | $3.7 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$100 M** | | | **$7.6 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $2.3 M / yr + bonds $3.5 M / yr = **$5.8 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
