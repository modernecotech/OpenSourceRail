...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $92 |
| Steady-state, low-ridership (year 8+) | **$19 M / yr** | $94 |
| Steady-state, high-ridership (year 8+) | **$18 M / yr** | $89 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $89 |
| Lifecycle envelope (yr 1–30, low scenario) | **$561 M cumulative** | $2,805 |
| Lifecycle envelope (yr 1–30, high scenario) | **$540 M cumulative** | $2,698 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$540 M cumulative** | $2,698 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $932 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $140 M | 3.8% | 30 y, 7 y grace | $9.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $58 M | 14.0% | 30 y, 7 y grace | $8.6 M / yr |
| Government equity (no debt service) | 15% | $35 M | — | — | — |
| **Total** | **100%** | **$233 M** | | | **$18 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.3 M / yr + bonds $8.2 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($5.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| **Total revenue** | **$4.4 M / yr** | **$6.5 M / yr** | **$5.3 M / yr** |
