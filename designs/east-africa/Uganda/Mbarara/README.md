...
| Bucket | Value |
|---|---|
| At-grade (56.0 km @ $0.85 M/km) | $48 M |
| Elevated (2.4 km @ $4.0 M/km) | $9.6 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 58.7 km × $0.015 M/km | $880 k |
...
|---|---|---|
| Construction (years 1–7) | **$12 M / yr** | $25 |
| Steady-state, low-ridership (year 8+) | **$10 M / yr** | $21 |
| Steady-state, high-ridership (year 8+) | **$6.8 M / yr** | $14 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$327 M cumulative** | $655 |
| Lifecycle envelope (yr 1–30, high scenario) | **$242 M cumulative** | $484 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$87 M cumulative** | $173 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $94 M | 3.8% | 30 y, 7 y grace | $6.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $39 M | 14.0% | 30 y, 7 y grace | $5.8 M / yr |
| Government equity (no debt service) | 15% | $23 M | — | — | — |
| **Total** | **100%** | **$156 M** | | | **$12 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.6 M / yr + bonds $5.5 M / yr = **$9.0 M / yr** total — plus the equity tranche amortised across construction ($3.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
