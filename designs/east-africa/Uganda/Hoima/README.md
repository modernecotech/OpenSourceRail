...
|---|---|---|
| Construction (years 1–7) | **$16 M / yr** | $82 |
| Steady-state, low-ridership (year 8+) | **$16 M / yr** | $81 |
| Steady-state, high-ridership (year 8+) | **$16 M / yr** | $79 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $79 |
| Lifecycle envelope (yr 1–30, low scenario) | **$487 M cumulative** | $2,433 |
| Lifecycle envelope (yr 1–30, high scenario) | **$476 M cumulative** | $2,381 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$476 M cumulative** | $2,381 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $447 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $124 M | 3.8% | 30 y, 7 y grace | $8.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $52 M | 14.0% | 30 y, 7 y grace | $7.6 M / yr |
| Government equity (no debt service) | 15% | $31 M | — | — | — |
| **Total** | **100%** | **$206 M** | | | **$16 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.7 M / yr + bonds $7.2 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($4.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| **Total revenue** | **$4.2 M / yr** | **$6.4 M / yr** | **$4.7 M / yr** |
