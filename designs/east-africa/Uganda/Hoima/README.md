...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 31.3 km × $0.015 M/km | $1.5 M |
...
|---|---|---|
| Construction (years 1–7) | **$16 M / yr** | $80 |
| Steady-state, low-ridership (year 8+) | **$16 M / yr** | $79 |
| Steady-state, high-ridership (year 8+) | **$15 M / yr** | $77 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $77 |
| Lifecycle envelope (yr 1–30, low scenario) | **$475 M cumulative** | $2,373 |
| Lifecycle envelope (yr 1–30, high scenario) | **$466 M cumulative** | $2,331 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$466 M cumulative** | $2,331 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $365 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $50 M | 14.0% | 30 y, 7 y grace | $7.4 M / yr |
| Government equity (no debt service) | 15% | $30 M | — | — | — |
| **Total** | **100%** | **$202 M** | | | **$15 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.6 M / yr + bonds $7.1 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($4.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 30,204 | 50,340 | 33,655 |
| Daily paid trips / catchment | 18% | 30% | 20% |
| Daily paid trips / city population | 15% | 25% | 17% |
| Annual paid trips | 11.0 M | 18.4 M | 12.3 M |
| Farebox revenue | $3.2 M / yr | $5.3 M / yr | $3.6 M / yr |
| Station shop leases | $399 k / yr | $399 k / yr | $399 k / yr |
| Advertising boards | $646 k / yr | $646 k / yr | $646 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.4 M / yr** | **$4.6 M / yr** |
