...
| Bucket | Value |
|---|---|
| At-grade (29.4 km @ $2.0 M/km) | $59 M |
...
|---|---|---|
| Construction (years 1–7) | **$13 M / yr** | $67 |
| Steady-state, low-ridership (year 8+) | **$13 M / yr** | $65 |
| Steady-state, high-ridership (year 8+) | **$13 M / yr** | $65 |
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $65 |
| Lifecycle envelope (yr 1–30, low scenario) | **$393 M cumulative** | $1,967 |
| Lifecycle envelope (yr 1–30, high scenario) | **$393 M cumulative** | $1,967 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$393 M cumulative** | $1,967 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $43 M | 14.0% | 30 y, 7 y grace | $6.3 M / yr |
| Government equity (no debt service) | 15% | $26 M | — | — | — |
| **Total** | **100%** | **$170 M** | | | **$13 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.9 M / yr + bonds $6.0 M / yr = **$9.8 M / yr** total — plus the equity tranche amortised across construction ($3.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
