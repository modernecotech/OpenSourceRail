...
| Bucket | Value |
|---|---|
| At-grade (29.4 km @ €3.5 M/km) | €103 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 31.3 km × €0.015 M/km | €0.5 M |
...
| Per-capita (city pop) | €1,789 / person |
...
|---|---|---|
| Construction (years 1–7) | **€28 M / yr** | €142 |
| Steady-state, low-ridership (year 8+) | **€35 M / yr** | €177 |
| Steady-state, high-ridership (year 8+) | **€35 M / yr** | €173 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.01 bn cumulative** | €5,053 |
| Lifecycle envelope (yr 1–30, high scenario) | **€992 M cumulative** | €4,960 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€8.0 M / yr (low) → €7.2 M / yr (high)._
...
| Labour (200 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €448 k |
...
| Operating shortfall (gov subsidy required) | €8.0 M / yr | €7.2 M / yr |
