...
| Revenue fleet passenger capacity | 19,200 AW2 pax (25,600 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 11.3 km | 6 | 35 | S Inner ↔ NW Outer |
| line-2 | 10.7 km | 6 | 31 | SE Outer ↔ NW Inner |
| line-3 |  7.1 km | 5 | 24 | SW Inner ↔ E Mid |
| **Total** | **29.1 km** | **17 unique** | **90** | |
...
| Revenue fleet capacity | 19,200 AW2 pax (25,600 AW3 crush) |
...
- **Revenue fleet simultaneous capacity:** 80 × 240 = **19,200 AW2 passengers** (25,600 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **17.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.7× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 332 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 73 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 17.4 MW / 84 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 56 kWh | 118 kWh | 56 kWh | 5.7 km / 28 kWh |
| line-2 | 5 | 53 kWh | 98 kWh | 39 kWh | 5.0 km / 25 kWh |
| line-3 | 5 | 36 kWh | 98 kWh | 59 kWh | 2.0 km / 10 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 17,446 kW @ $700/kW | $12 M |
| Grid interconnection / PPA tie-in | 17,446 kW @ $100/kW | $1.7 M |
| Annual generation proxy | 17.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 30.6 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$17 M / yr** | $85 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$12 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$119 M cumulative** | $597 |
| Lifecycle envelope (yr 1–40, high scenario) | **$119 M cumulative** | $597 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$529 M cumulative** | $2,647 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $211 M | 4.5% | 40 y, 7 y grace | $12 M / yr |
| Government equity (no debt service) | 20% | $53 M | — | — | — |
| **Total** | **100%** | **$264 M** | | | **$12 M / yr** |
...
| Traction energy (42.7 GWh / yr) | 13,539 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.1 GWh/yr + dedicated solar plant 17.4 MW / 30.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $209 k |
| Labour (261 FTE) | driverless roster: OCC/remote 61, station/platform 67, passenger service 38, fleet maintenance 45, infrastructure/energy 29, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $636 k |
| **OPEX subtotal** | | **$6.3 M / yr** |

_Annual service work: 13,539 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.3 M train-km / yr (10.7 M car-km / yr). On-site PV covers 16.1 GWh/yr and the dedicated solar plant adds 30.6 GWh/yr against 42.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 90 trainsets, 17 stations, 29.1 route-km, 3 lines, and 13,539 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 14.1 M |
| Annual paid trips / city resident | 244 | 391 | 71 |
| Farebox revenue | $19 M / yr | $30 M / yr | $5.5 M / yr |
| Station shop leases | $326 k / yr | $326 k / yr | $326 k / yr |
| Advertising boards | $538 k / yr | $538 k / yr | $538 k / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX recovery | 312% | 492% | 100% |
...
_Commercial-revenue assumptions: 2,664 m² of station shop/kiosk leases at $12/m²/month and 520 advertising boards at $102/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $151 M | 57% of $264 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $242 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $35 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 21,759 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $250 M |
...
| Low/high project NPV at 8% | $-106355 k / $-30168 k |
| Low/high project IRR | 2.8% / 6.8% |
| Low/high steady-state DSCR | 1.08 / 1.99 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,312.87 train-km; 6,554.41 kWh consumed; 7,000.42 kWh charged; 38 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,088.59 train-km; 70,336.09 kWh consumed; 72,154.43 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 81%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 78.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 60.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 81.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 34.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 33 civil segments, and 0 input findings |
