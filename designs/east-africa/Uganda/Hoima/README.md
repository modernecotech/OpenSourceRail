...
| Per-capita (city pop) | $1,327 / person |
...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $105 |
| Steady-state, low-ridership (year 8+) | **$22 M / yr** | $109 |
| Steady-state, high-ridership (year 8+) | **$20 M / yr** | $101 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $101 |
| Lifecycle envelope (yr 1–30, low scenario) | **$649 M cumulative** | $3,246 |
| Lifecycle envelope (yr 1–30, high scenario) | **$613 M cumulative** | $3,067 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$613 M cumulative** | $3,067 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.6 M / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $66 M | 14.0% | 30 y, 7 y grace | $9.8 M / yr |
| Government equity (no debt service) | 15% | $40 M | — | — | — |
| **Total** | **100%** | **$265 M** | | | **$20 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.0 M / yr + bonds $9.3 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating surplus after OPEX | $0 k / yr | $576 k / yr | $0 / yr |
