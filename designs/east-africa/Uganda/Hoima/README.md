...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.0%** | **$93 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **57.0%** | **$123 M** | **$18 M / yr** |
| of which planned local bond issuance | 45.6% of total CAPEX | $99 M | $14 M / yr |
...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $107 |
| Steady-state, low capacity-use (year 8+) | **$5.1 M / yr** | $26 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $97 |
| Lifecycle envelope (yr 1–40, low scenario) | **$319 M cumulative** | $1,597 |
| Lifecycle envelope (yr 1–40, high scenario) | **$150 M cumulative** | $752 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$792 M cumulative** | $3,960 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 43% | $93 M | 4.5% | 40 y, 7 y grace | $5.5 M / yr |
| Local-currency sovereign / project bonds for local content | 46% | $99 M | 14.0% | 40 y, 7 y grace | $14 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $25 M | — | — | — |
| **Total** | **100%** | **$216 M** | | | **$19 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.2 M / yr + local bonds $14 M / yr = **$18 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.1 M / yr | $0 k / yr | **$19 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $123 M | 57% of $216 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,700 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $93 M (43.0%) |
| Local-content / local-funding requirement | $123 M (57.0%) |
...
| Low/high steady-state DSCR | 0.74 / 1.32 |
