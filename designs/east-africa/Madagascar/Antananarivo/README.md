...
|---|---|---|
| Construction (years 1–10) | **$171 M / yr** | $56 |
| Steady-state, low-ridership (year 11+) | **$224 M / yr** | $73 |
| Steady-state, high-ridership (year 11+) | **$214 M / yr** | $70 |
| Steady-state, operating-neutral revenue case | **$182 M / yr** | $59 |
| Lifecycle envelope (yr 1–35, low scenario) | **$7.32 bn cumulative** | $2,394 |
| Lifecycle envelope (yr 1–35, high scenario) | **$7.07 bn cumulative** | $2,312 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$6.26 bn cumulative** | $2,047 |

_Population basis: 3,058,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $42 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.70 bn | 3.0% | 35 y, 10 y grace | $98 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $709 M | 11.0% | 35 y, 10 y grace | $84 M / yr |
| Government equity (no debt service) | 15% | $425 M | — | — | — |
| **Total** | **100%** | **$2.83 bn** | | | **$182 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $51 M / yr + bonds $78 M / yr = **$129 M / yr** total — plus the equity tranche amortised across construction ($43 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 231,184 | 385,308 | 878,029 |
| Daily paid trips / catchment | 18% | 30% | 68% |
| Daily paid trips / city population | 8% | 13% | 29% |
| Annual paid trips | 84.4 M | 140.6 M | 320.5 M |
| Farebox revenue | $15 M / yr | $25 M / yr | $58 M / yr |
| Station shop leases | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$21 M / yr** | **$32 M / yr** | **$64 M / yr** |
| Revenue / OPEX recovery | 34% | 49% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $224 M / yr | $214 M / yr | **$182 M / yr** |
