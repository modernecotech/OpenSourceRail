...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.24 bn (85.1%) of external capital** and **$6.76 bn of external interest**. Capital plus saved interest totals **$12.00 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (284.9 km @ $2.58 M/km) | $736 M |
| Elevated (39.7 km @ $9.75 M/km) | $387 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 3024 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 3024 | $120 k | $0 |
...
|---|---:|---:|---:|---:|
| Civil works | $1.17 bn | 15% | $175 M | $993 M |
| Stations | $522 M | 20% | $104 M | $417 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $847 M | 35% | $296 M | $550 M |
| Dedicated solar plant | $636 M | 45% | $286 M | $350 M |
| Residual signalling / train control | $16 M | 50% | $8.1 M | $8.1 M |
| Charging microgrids | $38 M | 40% | $15 M | $23 M |
| EPC / project services | $182 M | 15% | $27 M | $155 M |
| **Total city CAPEX** | **$3.42 bn** | **26.8%** | **$915 M** | **$2.50 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh antananarivo`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.8%** | **$915 M** | **$91 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.2%** | **$2.50 bn** | **$250 M / yr** |
| of which planned local bond issuance | 58.6% of total CAPEX | $2.00 bn | $200 M / yr |
| **Total city programme** | **100.0%** | **$3.42 bn** | **$342 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $4.61 bn | $3.70 bn (80.2%) | $4.78 bn | **$8.47 bn** |
| **Default** | 2.00× | $6.15 bn | $5.24 bn (85.1%) | $6.76 bn | **$12.00 bn** |
| High | 3.00× | $9.22 bn | $8.31 bn (90.1%) | $10.73 bn | **$19.04 bn** |

At the default 2.00× case, OSR's $915 M external requirement is 85.1% below the illustrative foreign-company requirement of $6.15 bn; the associated lifetime external-interest saving is $6.76 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$311 M / yr** | $102 |
| Steady-state, low capacity-use (year 11+) | **$263 M / yr** | $86 |
| Steady-state, high capacity-use (year 11+) | **$203 M / yr** | $66 |
| Steady-state, operating-neutral revenue case | **$286 M / yr** | $94 |
| Lifecycle envelope (yr 1–40, low scenario) | **$10.99 bn cumulative** | $3,595 |
| Lifecycle envelope (yr 1–40, high scenario) | **$9.20 bn cumulative** | $3,008 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$11.70 bn cumulative** | $3,828 |

_Population basis: 3,058,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $24 M / yr → $84 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 27% | $915 M | 4.5% | 40 y, 10 y grace | $56 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.00 bn | 11.0% | 40 y, 10 y grace | $230 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $500 M | — | — | — |
| **Total** | **100%** | **$3.42 bn** | | | **$286 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $41 M / yr + local bonds $220 M / yr = **$261 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($50 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 316.9 M |
| Annual paid trips / city resident | 136 | 217 | 104 |
| Farebox revenue | $100 M / yr | $160 M / yr | $76 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| **Total revenue** | **$104 M / yr** | **$164 M / yr** | **$81 M / yr** |
| Revenue / OPEX recovery | 129% | 204% | 100% |
...
| Operating surplus applied to debt support | -$24 M / yr | -$84 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $263 M / yr | $203 M / yr | **$286 M / yr** |
| Operating surplus after OPEX (before debt support) | $24 M / yr | $84 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.50 bn | 73% of $3.42 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.00 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $400 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 579,127 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$3.42 bn** |
| Imported / external-capital requirement | $915 M (26.8%) |
| Local-content / local-funding requirement | $2.50 bn (73.2%) |
| Default foreign-turnkey external-capital comparison | $6.15 bn; OSR saves $5.24 bn (85.1%) |
| Lifetime external interest and combined financing saving | $6.76 bn interest; $12.00 bn capital + interest |
| 15%–25% planning risk envelope | $3.93 bn–$4.27 bn |
| Annual OPEX | $81 M / yr |
| Low/high project NPV at 8% | $-2169109 k / $-1857123 k |
| Low/high project IRR | -6.8% / -1.5% |
| Low/high steady-state DSCR | 0.08 / 0.29 |
