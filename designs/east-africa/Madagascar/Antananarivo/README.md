...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **321,090 – 577,962 trips/day**
...
| Per-capita (city pop) | $2,192 / person |
...
|---|---|---|
| Construction (years 1–10) | **$134 M / yr** | $44 |
| Steady-state, low-ridership (year 11+) | **$313 M / yr** | $102 |
| Steady-state, high-ridership (year 11+) | **$290 M / yr** | $95 |
| Steady-state, operating-neutral revenue case | **$150 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$10.73 bn cumulative** | $3,509 |
| Lifecycle envelope (yr 1–40, high scenario) | **$10.05 bn cumulative** | $3,288 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.83 bn cumulative** | $1,906 |

_Population basis: 3,058,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $163 M / yr → $141 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $2.68 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $3.35 bn | 2.0% | 40 y, 10 y grace | $150 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 11.0% | 40 y, 10 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $670 M | — | — | — |
| **Total** | **100%** | **$6.70 bn** | | | **$150 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — concessional loan $67 M / yr + fallback bonds $0 k / yr = **$67 M / yr** total. The $2.68 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($67 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 321,090 | 577,962 | 2,185,745 |
| Daily paid trips / catchment | 25% | 45% | 170% |
| Daily paid trips / city population | 10% | 19% | 71% |
| Annual paid trips | 117.2 M | 211.0 M | 797.8 M |
| Farebox revenue | $28 M / yr | $51 M / yr | $191 M / yr |
| Station shop leases | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$34 M / yr** | **$57 M / yr** | **$198 M / yr** |
| Revenue / OPEX recovery | 17% | 29% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $313 M / yr | $290 M / yr | **$150 M / yr** |
