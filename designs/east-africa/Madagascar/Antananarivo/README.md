...
|---|---|---|
| Construction (years 1–10) | **$269 M / yr** | $88 |
| Steady-state, low capacity-use (year 11+) | **$398 M / yr** | $130 |
| Steady-state, high capacity-use (year 11+) | **$356 M / yr** | $116 |
| Steady-state, operating-neutral revenue case | **$267 M / yr** | $87 |
| Lifecycle envelope (yr 1–40, low scenario) | **$14.63 bn cumulative** | $4,786 |
| Lifecycle envelope (yr 1–40, high scenario) | **$13.36 bn cumulative** | $4,370 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.68 bn cumulative** | $3,493 |

_Population basis: 3,058,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $132 M / yr → $89 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $5.97 bn | 2.0% | 40 y, 10 y grace | $267 M / yr |
| Government equity (no debt service) | 20% | $1.49 bn | — | — | — |
| **Total** | **100%** | **$7.46 bn** | | | **$267 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $119 M / yr = **$119 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($149 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (1,732 FTE) | driverless roster: OCC/remote 244, station/platform 576, passenger service 167, fleet maintenance 360, infrastructure/energy 323, admin/training 62; no train drivers × country median × 12 × engineer-premium 1.4 | $2.6 M |
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 143% |
| Annual paid trips | 294.3 M | 470.9 M | 843.3 M |
| Annual paid trips / city resident | 96 | 154 | 276 |
| Farebox revenue | $71 M / yr | $113 M / yr | $202 M / yr |
| Station shop leases | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$77 M / yr** | **$119 M / yr** | **$209 M / yr** |
| Revenue / OPEX recovery | 37% | 57% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $398 M / yr | $356 M / yr | **$267 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $398 M / yr | $356 M / yr | **$267 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $20 M / yr | $33 M / yr | 16 min/trip × $0.26/h value-of-time proxy |
...
| Station-area commerce turnover supported | $94 M / yr | $151 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $47 M / yr | $75 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$304 M / yr** | **$486 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 12 education anchors | 45,829 trips/school day; 10.1 M access-events/yr | 73,326 trips/school day; 16.1 M access-events/yr |
| Healthcare | 6 healthcare anchors | 53,662 trips/day; 19.6 M access-events/yr | 85,860 trips/day; 31.3 M access-events/yr |
| Commerce | 78 major/terminal/interchange nodes | 171,910 trips/trading day; 56.7 M access-events/yr | 275,056 trips/trading day; 90.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.75 bn | 50% of $7.46 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $6.01 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $601 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 868,779 job-years | retained CAPEX ÷ (4.0 × median annual income) |
