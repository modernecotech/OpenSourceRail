...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 338.9 km × €0.1 M/km | €34 M |
...
|---|---|---|
| Construction (years 1–10) | **€253 M / yr** | €83 |
| Steady-state, low-ridership (year 11+) | **€362 M / yr** | €118 |
| Steady-state, high-ridership (year 11+) | **€354 M / yr** | €116 |
| Lifecycle envelope (yr 1–35, low scenario) | **€11.59 bn cumulative** | €3,789 |
| Lifecycle envelope (yr 1–35, high scenario) | **€11.40 bn cumulative** | €3,726 |

_Population basis: 3,058,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€94 M / yr (low) → €86 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.51 bn | 3.0% | 35 y, 10 y grace | €144 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €1.05 bn | 11.0% | 35 y, 10 y grace | €124 M / yr |
| Government equity (no debt service) | 15% | €628 M | — | — | — |
| **Total** | **100%** | **€4.19 bn** | | | **€269 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €75 M / yr + bonds €115 M / yr = **€191 M / yr** total — plus the equity tranche amortised across construction (€63 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €1.7 M |
...
| Operating shortfall (gov subsidy required) | €94 M / yr | €86 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€362 M / yr** | **€354 M / yr** |
