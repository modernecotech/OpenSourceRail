...
| Total fleet capacity | 47,880 AW2 pax (63,840 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 120 × 360 = **43,200 AW2 passengers** (57,600 AW3 crush)
- **Total fleet passenger capacity:** 133 × 360 = **47,880 AW2 passengers** (63,840 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **60.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled train journey-km | 29,348 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 314 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 60.3 MW / 362 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 204 kWh | 294 kWh | 70 kWh | 7.0 km / 56 kWh |
| line-2 | 8 | 177 kWh | 261 kWh | 67 kWh | 7.0 km / 57 kWh |
| line-3 | 4 | 128 kWh | 180 kWh | 38 kWh | 6.4 km / 52 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 133 | $900 k | $120 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 399 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 399 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 60,251 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 60,251 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 60.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 132.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 63.1 km × $0.050 M/km | $3.2 M |
...
| Per-capita (city pop) | $956 / person |
...
| Rolling stock | $120 M | 35% | $42 M | $78 M |
| Dedicated solar plant | $48 M | 45% | $22 M | $27 M |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hail`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.5%** | **$117 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.5%** | **$361 M** | **$72 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $289 M | $58 M / yr |
| **Total city programme** | **100.0%** | **$478 M** | **$96 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $645 M | $528 M (81.8%) | $649 M | **$1.18 bn** |
| **Default** | 2.00× | $860 M | $743 M (86.4%) | $913 M | **$1.66 bn** |
| High | 3.00× | $1.29 bn | $1.17 bn (90.9%) | $1.44 bn | **$2.62 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 86.4% below the illustrative foreign-company requirement of $860 M; the associated lifetime external-interest saving is $913 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$33 M / yr** | $65 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$163 M cumulative** | $327 |
| Lifecycle envelope (yr 1–40, high scenario) | **$163 M cumulative** | $327 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$977 M cumulative** | $1,953 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $117 M | 4.5% | 40 y, 5 y grace | $6.7 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $289 M | 4.5% | 40 y, 5 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $72 M | — | — | — |
| **Total** | **100%** | **$478 M** | | | **$23 M / yr** |
...
| Traction energy (138.8 GWh / yr) | 29,348 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.1 GWh/yr + dedicated solar plant 60.3 MW / 132.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $723 k |
| Labour (361 FTE) | driverless roster: OCC/remote 81, station/platform 77, passenger service 49, fleet maintenance 79, infrastructure/energy 54, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $10 M |
| **OPEX subtotal** | | **$22 M / yr** |

_Annual service work: 29,348 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.6 M train-km / yr (34.7 M car-km / yr). On-site PV covers 24.1 GWh/yr and the dedicated solar plant adds 132.0 GWh/yr against 138.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 133 trainsets, 23 stations, 63.1 route-km, 3 lines, and 29,348 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$343 M / yr** | **$543 M / yr** | **$22 M / yr** |
| Revenue / OPEX recovery | 1595% | 2523% | 100% |
...
_Commercial-revenue assumptions: 3,184 m² of station shop/kiosk leases at $90/m²/month and 632 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided CO2e | $3.0 M / yr | $4.8 M / yr | 37.5–60.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.3 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $131 M / yr | $210 M / yr | 21% of paid trips × $8.50 local spend proxy |
...
| Healthcare | 4 healthcare anchors | 19,552 trips/day; 7.1 M access-events/yr | 31,284 trips/day; 11.4 M access-events/yr |
...
| Construction employment supported | 4,420 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $430 M |
...
| Lifetime external interest and combined financing saving | $913 M interest; $1.66 bn capital + interest |
| 15%–25% planning risk envelope | $549 M–$597 M |
| Annual OPEX | $22 M / yr |
| Low/high project NPV at 8% | $2.17 bn / $3.75 bn |
| Low/high project IRR | 34.3% / 45.2% |
| Low/high steady-state DSCR | 13.84 / 22.43 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,313.09 train-km; 18,654.53 kWh consumed; 15,272.94 kWh charged; 26 depot services completed; minimum SoC 63%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,475.34 train-km; 229,639.53 kWh consumed; 209,900.09 kWh charged; 470 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.0% of scheduled train-km delivered; 377 SoC warnings; 41 energy-adapted off-peak departures, maximum 16 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 92.5% / 90% | pass |
| 50% charging-contact availability | 20.0% | 97.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.1% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 96.0% / 90% | pass |
...
|---|---|
| ![Hail energy and battery simulation dashboard](engineering/screenshots/hail-simulation-dashboard.png) | ![Hail simulator network visualizer](engineering/screenshots/hail-network-visualizer.png) |
...
|---|---|
| ![Hail QGIS engineering layers](engineering/screenshots/hail-qgis-engineering-map.png) | ![Hail SUMO timetable validation](engineering/screenshots/hail-sumo-validation.png) |
