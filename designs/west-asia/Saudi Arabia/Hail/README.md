...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $81 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$203 M cumulative** | $406 |
| Lifecycle envelope (yr 1–40, high scenario) | **$203 M cumulative** | $406 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $2,119 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $427 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $107 M | — | — | — |
| **Total** | **100%** | **$534 M** | | | **$24 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $299 M | 56% of $534 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 3,661 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$534 M** |
| 15%–25% planning risk envelope | $614 M–$668 M |
| Annual OPEX | $22 M / yr |
| Low/high project NPV at 8% | $2.12 bn / $3.70 bn |
| Low/high project IRR | 32.0% / 42.5% |
| Low/high steady-state DSCR | 13.12 / 21.27 |
