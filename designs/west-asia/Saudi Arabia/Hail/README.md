...
|---|---|---|---|---|
| line-1 | 25.3 km | 15 | 62 | S Outer ↔ N Outer |
| line-2 | 21.9 km | 13 | 53 | SW Outer ↔ NE Mid |
| line-3 | 15.9 km | 9 | 40 | N Outer ↔ SE Mid |
| **Total** | **63.1 km** | **37 unique** | **155** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **55.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 19.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 512 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Dedicated solar plant | 55.1 MW / 330 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 204 kWh | 323 kWh | 98 kWh | 2.5 km / 20 kWh |
| line-2 | 12 | 177 kWh | 253 kWh | 59 kWh | 3.5 km / 28 kWh |
| line-3 | 9 | 128 kWh | 192 kWh | 51 kWh | 2.0 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 55,076 kW @ $700/kW | $39 M |
| Grid interconnection / PPA tie-in | 55,076 kW @ $100/kW | $5.5 M |
| Annual generation proxy | 55.1 MW × 6.0 peak-sun-h/day × 365 d/yr | 120.6 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$45 M / yr** | $91 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$227 M cumulative** | $455 |
| Lifecycle envelope (yr 1–40, high scenario) | **$227 M cumulative** | $455 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.19 bn cumulative** | $2,375 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $479 M | 4.5% | 40 y, 5 y grace | $27 M / yr |
| Government equity (no debt service) | 20% | $120 M | — | — | — |
| **Total** | **100%** | **$599 M** | | | **$27 M / yr** |
...
| Traction energy (138.8 GWh / yr) | 29,348 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 33.9 GWh/yr + dedicated solar plant 55.1 MW / 120.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $661 k |
| Labour (417 FTE) | driverless roster: OCC/remote 94, station/platform 109, passenger service 49, fleet maintenance 86, infrastructure/energy 58, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $12 M |
| **OPEX subtotal** | | **$25 M / yr** |

_Annual service work: 29,348 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.6 M train-km / yr (34.7 M car-km / yr). On-site PV covers 33.9 GWh/yr and the dedicated solar plant adds 120.6 GWh/yr against 138.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 155 trainsets, 37 stations, 63.1 route-km, 3 lines, and 29,348 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$347 M / yr** | **$547 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 1379% | 2171% | 100% |
...
_Commercial-revenue assumptions: 4,384 m² of station shop/kiosk leases at $90/m²/month and 888 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $121 M / yr | $194 M / yr | 19% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$311 M / yr** | **$497 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 12 major/terminal/interchange nodes | 38,982 trips/trading day; 12.9 M access-events/yr | 62,371 trips/trading day; 20.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $336 M | 56% of $599 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $537 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $107 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,116 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $555 M |
| Timetable-sized dedicated solar CAPEX | $44 M |
| **Reconciled project CAPEX** | **$599 M** |
| 15%–25% planning risk envelope | $688 M–$748 M |
| Annual OPEX | $25 M / yr |
| Low/high project NPV at 8% | $2.08 bn / $3.66 bn |
| Low/high project IRR | 29.8% / 39.9% |
| Low/high steady-state DSCR | 11.75 / 19.02 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,304.99 train-km; 18,589.09 kWh consumed; 19,081.88 kWh charged; 24 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 30,230.54 train-km; 243,799.84 kWh consumed; 248,212.43 kWh charged; 495 depot services completed (5 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 48.9% | 100.0% / 90% | pass |
