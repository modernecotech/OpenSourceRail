...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$794 M (86.7%) of external capital** and **$976 M of external interest**. Capital plus saved interest totals **$1.77 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $1,017 / person |
...
| **Total city CAPEX** | **$509 M** | **23.9%** | **$122 M** | **$387 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.9%** | **$122 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.1%** | **$387 M** | **$77 M / yr** |
| of which planned local bond issuance | 60.9% of total CAPEX | $309 M | $62 M / yr |
| **Total city programme** | **100.0%** | **$509 M** | **$102 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $687 M | $565 M (82.3%) | $694 M | **$1.26 bn** |
| **Default** | 2.00× | $915 M | $794 M (86.7%) | $976 M | **$1.77 bn** |
| High | 3.00× | $1.37 bn | $1.25 bn (91.1%) | $1.54 bn | **$2.79 bn** |

At the default 2.00× case, OSR's $122 M external requirement is 86.7% below the illustrative foreign-company requirement of $915 M; the associated lifetime external-interest saving is $976 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$35 M / yr** | $70 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$174 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, high scenario) | **$174 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.04 bn cumulative** | $2,077 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $122 M | 4.5% | 40 y, 5 y grace | $7.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $309 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $77 M | — | — | — |
| **Total** | **100%** | **$509 M** | | | **$25 M / yr** |
...
| Revenue / OPEX recovery | 1554% | 2457% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $387 M | 76% of $509 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,740 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$509 M** |
| Imported / external-capital requirement | $122 M (23.9%) |
| Local-content / local-funding requirement | $387 M (76.1%) |
| Default foreign-turnkey external-capital comparison | $915 M; OSR saves $794 M (86.7%) |
| Lifetime external interest and combined financing saving | $976 M interest; $1.77 bn capital + interest |
| 15%–25% planning risk envelope | $585 M–$636 M |
| Annual OPEX | $22 M / yr |
| Low/high project NPV at 8% | $2.14 bn / $3.72 bn |
| Low/high project IRR | 33.0% / 43.7% |
| Low/high steady-state DSCR | 13.00 / 21.08 |
