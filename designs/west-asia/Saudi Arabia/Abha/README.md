...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 378 | $60 k | $23 M |
| High sensitivity check | 378 | $120 k | $45 M |
...
| Per-capita (city pop) | $1,059 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh abha`.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $80 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$181 M cumulative** | $402 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $402 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$945 M cumulative** | $2,100 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $381 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $95 M | — | — | — |
| **Total** | **100%** | **$476 M** | | | **$22 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $17 M / yr = **$17 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($19 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $266 M | 56% of $476 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $425 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $85 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 3,257 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$476 M** |
| 15%–25% planning risk envelope | $548 M–$596 M |
| Annual OPEX | $20 M / yr |
| Low/high project NPV at 8% | $2.16 bn / $3.75 bn |
| Low/high project IRR | 34.3% / 45.2% |
| Low/high steady-state DSCR | 14.69 / 23.83 |
