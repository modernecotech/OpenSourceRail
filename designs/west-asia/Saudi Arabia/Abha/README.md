...
**Country:** SA · **Population:** 450,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$658 M (86.2%) of external capital** and **$809 M of external interest**. Capital plus saved interest totals **$1.47 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`abha.corridor.geojson`](abha.corridor.geojson).
...
| Anchor-weighted coverage | 29.3% |
| Route length (double track) | 59.1 km |
...
| Total fleet capacity | 45,360 AW2 pax (60,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 113 × 360 = **40,680 AW2 passengers** (54,240 AW3 crush)
- **Total fleet passenger capacity:** 126 × 360 = **45,360 AW2 passengers** (60,480 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 29.3%
- Catchment population: **≈ 131,850** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **53.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 490 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 66 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 66 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 27,474 train-km/day | One-way train journeys × route length |
| Annual service work | 10.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 356 MWh/day | 32.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 290 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 53.7 MW / 333 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 151 kWh | 257 kWh | 92 kWh | 7.0 km / 50 kWh |
| line-2 | 8 | 168 kWh | 261 kWh | 76 kWh | 6.3 km / 45 kWh |
| line-3 | 5 | 107 kWh | 184 kWh | 66 kWh | 4.7 km / 34 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (58.0 km @ $2.58 M/km) | $150 M |
| Elevated (1.1 km @ $9.75 M/km) | $10 M |
| **Civil subtotal** | **$160 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 126 | $900 k | $113 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 378 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 378 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 53,740 kW @ $700/kW | $38 M |
| Grid interconnection / PPA tie-in | 53,740 kW @ $100/kW | $5.4 M |
| Annual generation proxy | 53.7 MW × 6.2 peak-sun-h/day × 365 d/yr | 121.6 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.1 km × $0.050 M/km | $3.0 M |
...
|---|---:|---:|---:|---:|
| Civil works | $160 M | 15% | $24 M | $136 M |
| Stations | $69 M | 20% | $14 M | $55 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $113 M | 35% | $40 M | $74 M |
| Dedicated solar plant | $43 M | 45% | $19 M | $24 M |
| Residual signalling / train control | $3.0 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $2.1 M | 40% | $860 k | $1.3 M |
| EPC / project services | $25 M | 15% | $3.7 M | $21 M |
| **Total city CAPEX** | **$424 M** | **24.8%** | **$105 M** | **$319 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh abha`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.8%** | **$105 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.2%** | **$319 M** | **$64 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $255 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$424 M** | **$85 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $572 M | $467 M (81.7%) | $574 M | **$1.04 bn** |
| **Default** | 2.00× | $763 M | $658 M (86.2%) | $809 M | **$1.47 bn** |
| High | 3.00× | $1.14 bn | $1.04 bn (90.8%) | $1.28 bn | **$2.32 bn** |

At the default 2.00× case, OSR's $105 M external requirement is 86.2% below the illustrative foreign-company requirement of $763 M; the associated lifetime external-interest saving is $809 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$29 M / yr** | $64 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$145 M cumulative** | $322 |
| Lifecycle envelope (yr 1–40, high scenario) | **$145 M cumulative** | $322 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$866 M cumulative** | $1,925 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $105 M | 4.5% | 40 y, 5 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $255 M | 4.5% | 40 y, 5 y grace | $15 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$424 M** | | | **$21 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.7 M / yr + local bonds $11 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (130.0 GWh / yr) | 27,474 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.2 GWh/yr + dedicated solar plant 53.7 MW / 121.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $645 k |
| Labour (337 FTE) | driverless roster: OCC/remote 81, station/platform 62, passenger service 49, fleet maintenance 74, infrastructure/energy 50, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $9.6 M |
| **OPEX subtotal** | | **$20 M / yr** |

_Annual service work: 27,474 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.8 M train-km / yr (32.5 M car-km / yr). On-site PV covers 24.2 GWh/yr and the dedicated solar plant adds 121.6 GWh/yr against 130.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 126 trainsets, 21 stations, 59.1 route-km, 3 lines, and 27,474 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 2.4 M |
| Annual paid trips / city resident | 163 | 261 | 5 |
| Farebox revenue | $332 M / yr | $532 M / yr | $11 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $6.3 M / yr | $6.3 M / yr | $6.3 M / yr |
| **Total revenue** | **$341 M / yr** | **$540 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 1731% | 2743% | 100% |
...
| Operating surplus after OPEX (before debt support) | $321 M / yr | $521 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,480 m² of station shop/kiosk leases at $90/m²/month and 516 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $25 M / yr | 195 M - 312 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.8 M / yr | $4.5 M / yr | 35.1–56.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.8 M / yr | $12 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $128 M / yr | $204 M / yr | 20% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$316 M / yr** | **$505 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 9 major/terminal/interchange nodes | 41,180 trips/trading day; 13.6 M access-events/yr | 65,889 trips/trading day; 21.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $319 M | 75% of $424 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $510 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $102 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 3,907 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $381 M |
| Timetable-sized dedicated solar CAPEX | $43 M |
| **Reconciled project CAPEX** | **$424 M** |
| Imported / external-capital requirement | $105 M (24.8%) |
| Local-content / local-funding requirement | $319 M (75.2%) |
| Default foreign-turnkey external-capital comparison | $763 M; OSR saves $658 M (86.2%) |
| Lifetime external interest and combined financing saving | $809 M interest; $1.47 bn capital + interest |
| 15%–25% planning risk envelope | $487 M–$530 M |
| Annual OPEX | $20 M / yr |
| Low/high project NPV at 8% | $2.21 bn / $3.79 bn |
| Low/high project IRR | 36.8% / 48.2% |
| Low/high steady-state DSCR | 15.58 / 25.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,211.01 train-km; 15,918.09 kWh consumed; 15,046.62 kWh charged; 28 depot services completed; minimum SoC 77%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,175.32 train-km; 188,448.56 kWh consumed; 190,057.40 kWh charged; 505 depot services completed (6 active at cutoff); minimum SoC 40%; 0 onboard emergencies; 0 invariant violations; 95.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 26.5% | 95.3% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 95.1% / 90% | pass |
| 50% charging-contact availability | 40.2% | 95.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 85.9% / 60% | pass |
| ten-hour single charging-pad outage | 35.5% | 95.3% / 90% | pass |
...
|---|---|
| ![Abha energy and battery simulation dashboard](engineering/screenshots/abha-simulation-dashboard.png) | ![Abha simulator network visualizer](engineering/screenshots/abha-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 0 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Abha QGIS engineering layers](engineering/screenshots/abha-qgis-engineering-map.png) | ![Abha SUMO timetable validation](engineering/screenshots/abha-sumo-validation.png) |
...
| [`abha.toml`](abha.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`abha-network-map.png`](abha-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`abha.corridor.geojson`](abha.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`abha.stations.json`](abha.stations.json) | Machine-readable station list |
| [`abha.design-quality.yaml`](abha.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
