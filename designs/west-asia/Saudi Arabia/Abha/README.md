...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$705 M (86.6%) of external capital** and **$866 M of external interest**. Capital plus saved interest totals **$1.57 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (58.0 km @ $3.0 M/km) | $174 M |
...
| Per-capita (city pop) | $1,005 / person |
...
| **Total city CAPEX** | **$452 M** | **24.2%** | **$109 M** | **$343 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$109 M** | **$22 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$343 M** | **$69 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $274 M | $55 M / yr |
| **Total city programme** | **100.0%** | **$452 M** | **$90 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $610 M | $501 M (82.1%) | $616 M | **$1.12 bn** |
| **Default** | 2.00× | $814 M | $705 M (86.6%) | $866 M | **$1.57 bn** |
| High | 3.00× | $1.22 bn | $1.11 bn (91.1%) | $1.37 bn | **$2.48 bn** |

At the default 2.00× case, OSR's $109 M external requirement is 86.6% below the illustrative foreign-company requirement of $814 M; the associated lifetime external-interest saving is $866 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$31 M / yr** | $69 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$155 M cumulative** | $344 |
| Lifecycle envelope (yr 1–40, high scenario) | **$155 M cumulative** | $344 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$924 M cumulative** | $2,053 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $109 M | 4.5% | 40 y, 5 y grace | $6.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $274 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$452 M** | | | **$22 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.9 M / yr + local bonds $12 M / yr = **$17 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 2.6 M |
| Annual paid trips / city resident | 163 | 261 | 6 |
...
| Revenue / OPEX recovery | 1686% | 2671% | 100% |
...
| Operating surplus after OPEX (before debt support) | $321 M / yr | $520 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $343 M | 76% of $452 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,203 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$452 M** |
| Imported / external-capital requirement | $109 M (24.2%) |
| Local-content / local-funding requirement | $343 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $814 M; OSR saves $705 M (86.6%) |
| Lifetime external interest and combined financing saving | $866 M interest; $1.57 bn capital + interest |
| 15%–25% planning risk envelope | $520 M–$565 M |
| Annual OPEX | $20 M / yr |
| Low/high project NPV at 8% | $2.18 bn / $3.77 bn |
| Low/high project IRR | 35.4% / 46.5% |
| Low/high steady-state DSCR | 14.60 / 23.68 |
