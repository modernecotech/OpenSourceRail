...
| Revenue fleet | 135 × 3-car trainsets |
| Revenue fleet passenger capacity | 48,600 AW2 pax (64,800 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 20.9 km | 13 | 53 | E Outer ↔ W Mid |
| line-2 | 23.3 km | 14 | 57 | SE Outer ↔ W Outer |
| line-3 | 14.8 km | 8 | 40 | E Outer ↔ NW Mid |
| **Total** | **59.1 km** | **35 unique** | **150** | |
...
| Revenue fleet capacity | 48,600 AW2 pax (64,800 AW3 crush) |
| Total fleet capacity | 54,000 AW2 pax (72,000 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 135 × 360 = **48,600 AW2 passengers** (64,800 AW3 crush)
- **Total fleet passenger capacity:** 150 × 360 = **54,000 AW2 passengers** (72,000 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **48.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 16.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 508 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 79 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 92 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 48.9 MW / 303 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 151 kWh | 274 kWh | 108 kWh | 2.0 km / 15 kWh |
| line-2 | 13 | 168 kWh | 282 kWh | 97 kWh | 4.4 km / 32 kWh |
| line-3 | 8 | 107 kWh | 196 kWh | 79 kWh | 2.8 km / 20 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 150 | $900 k | $135 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 450 | $60 k | $27 M |
| High sensitivity check | 450 | $120 k | $54 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 48,910 kW @ $700/kW | $34 M |
| Grid interconnection / PPA tie-in | 48,910 kW @ $100/kW | $4.9 M |
| Annual generation proxy | 48.9 MW × 6.2 peak-sun-h/day × 365 d/yr | 110.7 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $92 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$207 M cumulative** | $459 |
| Lifecycle envelope (yr 1–40, high scenario) | **$207 M cumulative** | $459 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.08 bn cumulative** | $2,396 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $435 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $109 M | — | — | — |
| **Total** | **100%** | **$544 M** | | | **$25 M / yr** |
...
| Traction energy (130.0 GWh / yr) | 27,474 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 33.7 GWh/yr + dedicated solar plant 48.9 MW / 110.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $587 k |
| Labour (392 FTE) | driverless roster: OCC/remote 90, station/platform 95, passenger service 49, fleet maintenance 82, infrastructure/energy 55, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $11 M |
| **OPEX subtotal** | | **$23 M / yr** |

_Annual service work: 27,474 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.8 M train-km / yr (32.5 M car-km / yr). On-site PV covers 33.7 GWh/yr and the dedicated solar plant adds 110.7 GWh/yr against 130.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 150 trainsets, 35 stations, 59.1 route-km, 3 lines, and 27,474 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$345 M / yr** | **$545 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 1477% | 2330% | 100% |
...
_Commercial-revenue assumptions: 3,744 m² of station shop/kiosk leases at $90/m²/month and 780 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $120 M / yr | $192 M / yr | 19% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$308 M / yr** | **$493 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 11 major/terminal/interchange nodes | 38,770 trips/trading day; 12.8 M access-events/yr | 62,032 trips/trading day; 20.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $304 M | 56% of $544 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $487 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $97 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 3,728 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $504 M |
| Timetable-sized dedicated solar CAPEX | $39 M |
| **Reconciled project CAPEX** | **$544 M** |
| 15%–25% planning risk envelope | $625 M–$679 M |
| Annual OPEX | $23 M / yr |
| Low/high project NPV at 8% | $2.12 bn / $3.70 bn |
| Low/high project IRR | 31.7% / 42.1% |
| Low/high steady-state DSCR | 12.93 / 20.94 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,191.05 train-km; 15,774.56 kWh consumed; 17,023.81 kWh charged; 25 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,321.52 train-km; 203,902.27 kWh consumed; 208,346.91 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 52.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 71.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.5% / 60% | pass |
| ten-hour single charging-pad outage | 65.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 0 interchange complexes, 10 civil segments, and 0 input findings |
