...
| Item | Count / Status |
|---|---:|
| Assets in register | 374 |
| Manufacturing schedule rows | 1,422 |
| Manufacturing material/BOM rows | 21,233 |
| Manufacturing QA verification rows | 1,422 |
| Construction QA action rows | 1,318 |
| Maintenance handover schedule rows | 1,697 |
| Manufacturing rows with material refs | 1,422 / 1,422 |
| Manufacturing rows with verification refs | 1,422 / 1,422 |
| Manufacturing rows linked to QA actions | 1,422 / 1,422 |
