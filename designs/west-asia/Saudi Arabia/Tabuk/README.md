...
| Steady-state, low-ridership (year 6+) | **$27 M / yr** | $42 |
| Steady-state, high-ridership (year 6+) | **$27 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $42 |
| Lifecycle envelope (yr 1–25, low scenario) | **$688 M cumulative** | $1,059 |
| Lifecycle envelope (yr 1–25, high scenario) | **$688 M cumulative** | $1,059 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$688 M cumulative** | $1,059 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $263 M | 3.8% | 25 y, 5 y grace | $19 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $10.0 M / yr + bonds $4.9 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
