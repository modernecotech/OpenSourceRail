...
| Bucket | Value |
|---|---|
| At-grade (56.6 km @ $1.2 M/km) | $68 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 62.9 km × $0.015 M/km | $944 k |
...
|---|---|---|
| Construction (years 1–5) | **$15 M / yr** | $23 |
...
| Lifecycle envelope (yr 1–25, low scenario) | **$74 M cumulative** | $113 |
| Lifecycle envelope (yr 1–25, high scenario) | **$74 M cumulative** | $113 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$74 M cumulative** | $113 |

_Population basis: 650,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $138 M | 3.8% | 25 y, 5 y grace | $10.0 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $5.2 M / yr + bonds $2.6 M / yr = **$7.8 M / yr** total — plus the equity tranche amortised across construction ($6.9 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 52,000 | 97,500 | 4,023 |
| Daily paid trips / population | 8% | 15% | 1% |
| Annual paid trips | 19.0 M | 35.6 M | 1.5 M |
| Farebox revenue | $65 M / yr | $121 M / yr | $5.0 M / yr |
| Station shop leases | $7.6 M / yr | $7.6 M / yr | $7.6 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$90 M / yr** | **$147 M / yr** | **$31 M / yr** |
| Revenue / OPEX + debt-service recovery | 294% | 479% | 100% |
| Country farebox-only policy target (diagnostic) | 85% | 85% | 85% |
| Remaining steady-state gov gap | $0 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $60 M / yr | $116 M / yr | $0 / yr |
