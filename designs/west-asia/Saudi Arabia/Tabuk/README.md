...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$890 M (87.1%) of external capital** and **$1.09 bn of external interest**. Capital plus saved interest totals **$1.98 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $245 M | 15% | $37 M | $209 M |
...
| **Total city CAPEX** | **$567 M** | **23.1%** | **$131 M** | **$436 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$131 M** | **$26 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$436 M** | **$87 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $349 M | $70 M / yr |
| **Total city programme** | **100.0%** | **$567 M** | **$113 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $766 M | $634 M (82.9%) | $780 M | **$1.41 bn** |
| **Default** | 2.00× | $1.02 bn | $890 M (87.1%) | $1.09 bn | **$1.98 bn** |
| High | 3.00× | $1.53 bn | $1.40 bn (91.4%) | $1.72 bn | **$3.12 bn** |

At the default 2.00× case, OSR's $131 M external requirement is 87.1% below the illustrative foreign-company requirement of $1.02 bn; the associated lifetime external-interest saving is $1.09 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$39 M / yr** | $60 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $42 |
| Lifecycle envelope (yr 1–40, low scenario) | **$195 M cumulative** | $300 |
| Lifecycle envelope (yr 1–40, high scenario) | **$195 M cumulative** | $300 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $1,780 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $131 M | 4.5% | 40 y, 5 y grace | $7.5 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $349 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $87 M | — | — | — |
| **Total** | **100%** | **$567 M** | | | **$27 M / yr** |
...
| **Total revenue** | **$344 M / yr** | **$544 M / yr** | **$24 M / yr** |
| Revenue / OPEX recovery | 1465% | 2313% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $436 M | 77% of $567 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 5,342 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $520 M |
| Timetable-sized dedicated solar CAPEX | $47 M |
| **Reconciled project CAPEX** | **$567 M** |
| Imported / external-capital requirement | $131 M (23.1%) |
| Local-content / local-funding requirement | $436 M (76.9%) |
| Default foreign-turnkey external-capital comparison | $1.02 bn; OSR saves $890 M (87.1%) |
| Lifetime external interest and combined financing saving | $1.09 bn interest; $1.98 bn capital + interest |
| 15%–25% planning risk envelope | $652 M–$709 M |
| Annual OPEX | $24 M / yr |
| Low/high project NPV at 8% | $2.09 bn / $3.67 bn |
| Low/high project IRR | 30.8% / 41.1% |
| Low/high steady-state DSCR | 11.67 / 18.93 |
