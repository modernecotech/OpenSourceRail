...
| Per-capita (city pop) | $912 / person |
...
|---|---|---|
| Construction (years 1–5) | **$45 M / yr** | $69 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$225 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, high scenario) | **$225 M cumulative** | $347 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.18 bn cumulative** | $1,809 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $474 M | 4.5% | 40 y, 5 y grace | $27 M / yr |
| Government equity (no debt service) | 20% | $119 M | — | — | — |
| **Total** | **100%** | **$593 M** | | | **$27 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $336 M | 57% of $593 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,118 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $546 M |
...
| Low/high project IRR | 29.9% / 40.0% |
| Low/high steady-state DSCR | 11.81 / 19.15 |
