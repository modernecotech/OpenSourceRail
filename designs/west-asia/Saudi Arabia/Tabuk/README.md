...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$825 M (86.8%) of external capital** and **$1.01 bn of external interest**. Capital plus saved interest totals **$1.84 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **58.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 52 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 307 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 58.8 MW / 353 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 153 kWh | 220 kWh | 52 kWh | 3.7 km / 30 kWh |
| line-2 | 8 | 172 kWh | 261 kWh | 73 kWh | 3.6 km / 29 kWh |
| line-3 | 8 | 184 kWh | 261 kWh | 59 kWh | 7.0 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (57.3 km @ $2.58 M/km) | $148 M |
| Elevated (5.8 km @ $9.75 M/km) | $56 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$209 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 58,782 kW @ $700/kW | $41 M |
| Grid interconnection / PPA tie-in | 58,782 kW @ $100/kW | $5.9 M |
| Annual generation proxy | 58.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 128.7 GWh/yr |
...
|---|---:|---:|---:|---:|
| Civil works | $209 M | 15% | $31 M | $177 M |
| Stations | $106 M | 20% | $21 M | $85 M |
...
| **Total city CAPEX** | **$528 M** | **23.7%** | **$125 M** | **$402 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tabuk`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$125 M** | **$25 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$402 M** | **$80 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $322 M | $64 M / yr |
| **Total city programme** | **100.0%** | **$528 M** | **$106 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $712 M | $587 M (82.4%) | $722 M | **$1.31 bn** |
| **Default** | 2.00× | $950 M | $825 M (86.8%) | $1.01 bn | **$1.84 bn** |
| High | 3.00× | $1.42 bn | $1.30 bn (91.2%) | $1.60 bn | **$2.90 bn** |

At the default 2.00× case, OSR's $125 M external requirement is 86.8% below the illustrative foreign-company requirement of $950 M; the associated lifetime external-interest saving is $1.01 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $56 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$181 M cumulative** | $279 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $279 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.08 bn cumulative** | $1,658 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $125 M | 4.5% | 40 y, 5 y grace | $7.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $322 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $80 M | — | — | — |
| **Total** | **100%** | **$528 M** | | | **$26 M / yr** |
...
| Traction energy (138.7 GWh / yr) | 29,312 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.7 GWh/yr + dedicated solar plant 58.8 MW / 128.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $705 k |
| Labour (372 FTE) | driverless roster: OCC/remote 81, station/platform 87, passenger service 49, fleet maintenance 79, infrastructure/energy 55, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $11 M |
| **OPEX subtotal** | | **$23 M / yr** |

_Annual service work: 29,312 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.6 M train-km / yr (34.7 M car-km / yr). On-site PV covers 26.7 GWh/yr and the dedicated solar plant adds 128.7 GWh/yr against 138.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 134 trainsets, 26 stations, 63.0 route-km, 3 lines, and 29,312 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 113 | 180 | 4 |
...
| **Total revenue** | **$344 M / yr** | **$544 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 1512% | 2388% | 100% |
...
_Commercial-revenue assumptions: 3,520 m² of station shop/kiosk leases at $90/m²/month and 700 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $125 M / yr | $200 M / yr | 20% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$315 M / yr** | **$504 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 10 major/terminal/interchange nodes | 40,253 trips/trading day; 13.3 M access-events/yr | 64,405 trips/trading day; 21.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $402 M | 76% of $528 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,932 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$528 M** |
| Imported / external-capital requirement | $125 M (23.7%) |
| Local-content / local-funding requirement | $402 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $950 M; OSR saves $825 M (86.8%) |
| Lifetime external interest and combined financing saving | $1.01 bn interest; $1.84 bn capital + interest |
| 15%–25% planning risk envelope | $607 M–$660 M |
| Annual OPEX | $23 M / yr |
| Low/high project NPV at 8% | $2.13 bn / $3.71 bn |
| Low/high project IRR | 32.3% / 42.8% |
| Low/high steady-state DSCR | 12.55 / 20.34 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,362.42 train-km; 19,052.46 kWh consumed; 17,370.23 kWh charged; 25 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 29,934.01 train-km; 241,406.03 kWh consumed; 233,552.99 kWh charged; 498 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 174 SoC warnings; 8 energy-adapted off-peak departures, maximum 16 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 98.9% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
