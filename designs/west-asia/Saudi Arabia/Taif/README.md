...
|---|---|---|---|---|
| line-1 | 25.7 km | 13 | 68 | SE Outer ↔ NW Mid |
| line-2 | 14.5 km | 9 | 38 | S Mid ↔ NW Mid |
| line-3 | 19.2 km | 12 | 48 | NE Outer ↔ W Mid |
| **Total** | **59.5 km** | **34 unique** | **154** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **52.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 84 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 52.6 MW / 316 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 208 kWh | 318 kWh | 90 kWh | 7.0 km / 57 kWh |
| line-2 | 9 | 117 kWh | 192 kWh | 63 kWh | 2.0 km / 16 kWh |
| line-3 | 11 | 155 kWh | 233 kWh | 62 kWh | 5.0 km / 41 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 52,619 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 52,619 kW @ $100/kW | $5.3 M |
| Annual generation proxy | 52.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 115.2 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $68 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$237 M cumulative** | $338 |
| Lifecycle envelope (yr 1–40, high scenario) | **$237 M cumulative** | $338 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.24 bn cumulative** | $1,766 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $498 M | 4.5% | 40 y, 5 y grace | $29 M / yr |
...
| Traction energy (130.9 GWh / yr) | 27,665 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.7 GWh/yr + dedicated solar plant 52.6 MW / 115.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $631 k |
| Labour (417 FTE) | driverless roster: OCC/remote 94, station/platform 115, passenger service 49, fleet maintenance 83, infrastructure/energy 55, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $12 M |
| **OPEX subtotal** | | **$26 M / yr** |

_Annual service work: 27,665 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.9 M train-km / yr (32.7 M car-km / yr). On-site PV covers 30.7 GWh/yr and the dedicated solar plant adds 115.2 GWh/yr against 130.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 154 trainsets, 34 stations, 59.5 route-km, 3 lines, and 27,665 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $332 M / yr | $532 M / yr | $9.8 M / yr |
| Station shop leases | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| Advertising boards | $11 M / yr | $11 M / yr | $11 M / yr |
| **Total revenue** | **$348 M / yr** | **$548 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 1358% | 2136% | 100% |
...
_Commercial-revenue assumptions: 4,792 m² of station shop/kiosk leases at $90/m²/month and 932 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $129 M / yr | $206 M / yr | 21% of paid trips × $8.50 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $352 M | 57% of $623 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,315 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $581 M |
...
| Low/high project IRR | 29.1% / 39.0% |
| Low/high steady-state DSCR | 11.30 / 18.29 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,196.90 train-km; 17,717.32 kWh consumed; 17,729.98 kWh charged; 24 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,489.03 train-km; 229,754.07 kWh consumed; 230,824.76 kWh charged; 495 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 72 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 34 line platforms, 2 interchange complexes, 12 civil segments, and 0 input findings |
