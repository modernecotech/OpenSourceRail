...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 375 | $60 k | $22 M |
| High sensitivity check | 375 | $120 k | $45 M |
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $56 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$198 M cumulative** | $282 |
| Lifecycle envelope (yr 1–40, high scenario) | **$198 M cumulative** | $282 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.03 bn cumulative** | $1,474 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $416 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $104 M | — | — | — |
| **Total** | **100%** | **$520 M** | | | **$24 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $292 M | 56% of $520 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 3,583 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $2.13 bn / $3.72 bn |
| Low/high project IRR | 32.5% / 43.1% |
| Low/high steady-state DSCR | 13.48 / 21.85 |
