...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$776 M (86.9%) of external capital** and **$954 M of external interest**. Capital plus saved interest totals **$1.73 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (56.8 km @ $3.0 M/km) | $170 M |
| Elevated (2.7 km @ $12.0 M/km) | $32 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$207 M** |
...
| Per-capita (city pop) | $709 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $207 M | 15% | $31 M | $176 M |
...
| **Total city CAPEX** | **$496 M** | **23.6%** | **$117 M** | **$379 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$117 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$379 M** | **$76 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $303 M | $61 M / yr |
| **Total city programme** | **100.0%** | **$496 M** | **$99 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $670 M | $553 M (82.5%) | $679 M | **$1.23 bn** |
| **Default** | 2.00× | $893 M | $776 M (86.9%) | $954 M | **$1.73 bn** |
| High | 3.00× | $1.34 bn | $1.22 bn (91.2%) | $1.50 bn | **$2.73 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 86.9% below the illustrative foreign-company requirement of $893 M; the associated lifetime external-interest saving is $954 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$34 M / yr** | $49 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$170 M cumulative** | $243 |
| Lifecycle envelope (yr 1–40, high scenario) | **$170 M cumulative** | $243 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,447 |
...
| Revenue / OPEX recovery | 1600% | 2531% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $379 M | 76% of $496 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $606 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $121 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,643 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $451 M |
| Timetable-sized dedicated solar CAPEX | $45 M |
| **Reconciled project CAPEX** | **$496 M** |
| Imported / external-capital requirement | $117 M (23.6%) |
| Local-content / local-funding requirement | $379 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $893 M; OSR saves $776 M (86.9%) |
| Lifetime external interest and combined financing saving | $954 M interest; $1.73 bn capital + interest |
| 15%–25% planning risk envelope | $571 M–$620 M |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $2.15 bn / $3.73 bn |
| Low/high project IRR | 33.5% / 44.3% |
| Low/high steady-state DSCR | 13.35 / 21.63 |
