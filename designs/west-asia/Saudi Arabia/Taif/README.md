...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 73 | €3.0 M | €219 M |
...
| Steady-state, low-ridership (year 6+) | **€45 M / yr** | €65 |
| Steady-state, high-ridership (year 6+) | **€45 M / yr** | €65 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.14 bn cumulative** | €1,630 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.14 bn cumulative** | €1,630 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€0 k / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €436 M | 3.8% | 25 y, 5 y grace | €31 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €181 M | 4.5% | 25 y, 5 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €109 M | — | — | — |
| **Total** | **100%** | **€726 M** | | | **€45 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €17 M / yr + bonds €8.2 M / yr = **€25 M / yr** total — plus the equity tranche amortised across construction (€22 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (453 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €12 M |
...
| Farebox revenue | €33 M / yr | €67 M / yr |
| Farebox / OPEX recovery | 113% | 225% |
| Country policy-target recovery (diagnostic) | 85% | 85% |
| Operating shortfall (gov subsidy required) | €0 k / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €3.7 M / yr | €37 M / yr |
