...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$723 M (86.5%) of external capital** and **$889 M of external interest**. Capital plus saved interest totals **$1.61 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 69.3%
- Catchment population: **≈ 485,099** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **56.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 483 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 27,665 train-km/day | One-way train journeys × route length |
| Annual service work | 10.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 359 MWh/day | 32.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 294 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 56.4 MW / 338 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 208 kWh | 294 kWh | 66 kWh | 7.0 km / 57 kWh |
| line-2 | 5 | 117 kWh | 163 kWh | 35 kWh | 5.5 km / 44 kWh |
| line-3 | 7 | 155 kWh | 229 kWh | 58 kWh | 7.0 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (56.8 km @ $2.58 M/km) | $147 M |
| Elevated (2.7 km @ $9.75 M/km) | $26 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 56,414 kW @ $700/kW | $39 M |
| Grid interconnection / PPA tie-in | 56,414 kW @ $100/kW | $5.6 M |
| Annual generation proxy | 56.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 123.5 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.5 km × $0.050 M/km | $3.0 M |
...
|---|---:|---:|---:|---:|
| Civil works | $177 M | 15% | $27 M | $151 M |
...
| **Total city CAPEX** | **$464 M** | **24.2%** | **$113 M** | **$352 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh taif`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$113 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$352 M** | **$70 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $282 M | $56 M / yr |
| **Total city programme** | **100.0%** | **$464 M** | **$93 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $627 M | $514 M (82.1%) | $632 M | **$1.15 bn** |
| **Default** | 2.00× | $836 M | $723 M (86.5%) | $889 M | **$1.61 bn** |
| High | 3.00× | $1.25 bn | $1.14 bn (91.0%) | $1.40 bn | **$2.54 bn** |

At the default 2.00× case, OSR's $113 M external requirement is 86.5% below the illustrative foreign-company requirement of $836 M; the associated lifetime external-interest saving is $889 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$32 M / yr** | $45 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$159 M cumulative** | $227 |
| Lifecycle envelope (yr 1–40, high scenario) | **$159 M cumulative** | $227 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$949 M cumulative** | $1,356 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $113 M | 4.5% | 40 y, 5 y grace | $6.4 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $282 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $70 M | — | — | — |
| **Total** | **100%** | **$464 M** | | | **$23 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.1 M / yr + local bonds $13 M / yr = **$18 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (130.9 GWh / yr) | 27,665 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 56.4 MW / 123.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $677 k |
| Labour (351 FTE) | driverless roster: OCC/remote 81, station/platform 75, passenger service 49, fleet maintenance 74, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $10 M |
| **OPEX subtotal** | | **$21 M / yr** |

_Annual service work: 27,665 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.9 M train-km / yr (32.7 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 123.5 GWh/yr against 130.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 125 trainsets, 22 stations, 59.5 route-km, 3 lines, and 27,665 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$343 M / yr** | **$542 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 1646% | 2603% | 100% |
...
_Commercial-revenue assumptions: 3,112 m² of station shop/kiosk leases at $90/m²/month and 616 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $25 M / yr | 196 M - 314 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.8 M / yr | $4.5 M / yr | 35.3–56.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.9 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $132 M / yr | $212 M / yr | 21% of paid trips × $8.50 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $352 M | 76% of $464 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $563 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $113 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,312 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$464 M** |
| Imported / external-capital requirement | $113 M (24.2%) |
| Local-content / local-funding requirement | $352 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $836 M; OSR saves $723 M (86.5%) |
| Lifetime external interest and combined financing saving | $889 M interest; $1.61 bn capital + interest |
| 15%–25% planning risk envelope | $534 M–$581 M |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $2.18 bn / $3.77 bn |
| Low/high project IRR | 34.9% / 45.9% |
| Low/high steady-state DSCR | 14.27 / 23.11 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,217.15 train-km; 17,880.89 kWh consumed; 15,513.99 kWh charged; 27 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,532.35 train-km; 213,973.49 kWh consumed; 202,943.91 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.9% of scheduled train-km delivered; 99 SoC warnings; 8 energy-adapted off-peak departures, maximum 13 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 95.3% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 92.9% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 78.8% / 60% | pass |
...
|---|---|
| ![Taif energy and battery simulation dashboard](engineering/screenshots/taif-simulation-dashboard.png) | ![Taif simulator network visualizer](engineering/screenshots/taif-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Taif QGIS engineering layers](engineering/screenshots/taif-qgis-engineering-map.png) | ![Taif SUMO timetable validation](engineering/screenshots/taif-sumo-validation.png) |
...
scripts/regenerate-city.sh taif
```
