...
| Per-capita (city pop) | $1,116 / person |
...
|---|---|---|
| Construction (years 1–5) | **$127 M / yr** | $85 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$636 M cumulative** | $424 |
| Lifecycle envelope (yr 1–40, high scenario) | **$636 M cumulative** | $424 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.32 bn cumulative** | $2,214 |
...
| Government equity (no debt service) | 20% | $335 M | — | — | — |
| **Total** | **100%** | **$1.67 bn** | | | **$77 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $953 M | 57% of $1.67 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.53 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $305 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 11,682 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.51 bn |
| Timetable-sized dedicated solar CAPEX | $165 M |
| **Reconciled project CAPEX** | **$1.67 bn** |
| 15%–25% planning risk envelope | $1.93 bn–$2.09 bn |
| Annual OPEX | $58 M / yr |
| Low/high project NPV at 8% | $4.93 bn / $8.79 bn |
| Low/high project IRR | 27.4% / 36.9% |
| Low/high steady-state DSCR | 10.29 / 16.65 |
