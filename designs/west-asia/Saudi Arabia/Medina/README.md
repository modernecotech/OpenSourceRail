...
|---|---|---|---|---|
| line-1 | 34.2 km | 19 | 74 | NW Outer ↔ SE Outer |
| line-2 | 21.3 km | 13 | 49 | SW Mid ↔ NE Mid |
| line-3 | 20.7 km | 14 | 48 | NW Mid ↔ S Mid |
| line-4 | 24.2 km | 13 | 53 | NE Mid ↔ W Outer |
| line-5 | 18.7 km | 10 | 41 | NW Mid ↔ E Outer |
| line-6 | 60.8 km | 36 | 32 | E Mid ↔ E Mid |
| **Total** | **179.8 km** | **105 unique** | **297** | |
...
| Standard | 60 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **99** | **34,400 kW** | **187,000 kWh** |

Aggregate station-rail charging power: **148,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **190.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.0× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 640 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 268 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 206 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 994 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 190.5 MW / 1,143 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 187 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 18 | 368 kWh | 956 kWh | 551 kWh | 7.5 km / 80 kWh |
| line-2 | 13 | 229 kWh | 686 kWh | 435 kWh | 2.0 km / 22 kWh |
| line-3 | 13 | 222 kWh | 686 kWh | 442 kWh | 3.9 km / 42 kWh |
| line-4 | 13 | 260 kWh | 686 kWh | 400 kWh | 3.1 km / 34 kWh |
| line-5 | 9 | 201 kWh | 490 kWh | 268 kWh | 4.5 km / 49 kWh |
| line-6 | 33 | 653 kWh | 1,617 kWh | 898 kWh | 5.6 km / 60 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (161.9 km @ $3.0 M/km) | $486 M |
| Elevated (17.9 km @ $12.0 M/km) | $215 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$736 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 190,541 kW @ $700/kW | $133 M |
| Grid interconnection / PPA tie-in | 190,541 kW @ $100/kW | $19 M |
| Annual generation proxy | 190.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 417.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$152 M** |
...
| Dedicated solar power plant | $152 M |
...
|---|---|---|
| Construction (years 1–5) | **$150 M / yr** | $100 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$91 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$752 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$752 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.92 bn cumulative** | $2,616 |
...
| Traction energy (438.2 GWh / yr) | 69,475 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 75.3 GWh/yr + dedicated solar plant 190.5 MW / 417.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.3 M |
| Labour (1,037 FTE) | driverless roster: OCC/remote 171, station/platform 389, passenger service 111, fleet maintenance 181, infrastructure/energy 158, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $30 M |
| **OPEX subtotal** | | **$71 M / yr** |

_Annual service work: 69,475 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.4 M train-km / yr (109.5 M car-km / yr). On-site PV covers 75.3 GWh/yr and the dedicated solar plant adds 417.3 GWh/yr against 438.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 297 trainsets, 105 stations, 179.8 route-km, 6 lines, and 69,475 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 3.8 M |
| Annual paid trips / city resident | 119 | 191 | 3 |
| Farebox revenue | $813 M / yr | $1.30 bn / yr | $17 M / yr |
| Station shop leases | $16 M / yr | $16 M / yr | $16 M / yr |
| Advertising boards | $38 M / yr | $38 M / yr | $38 M / yr |
| **Total revenue** | **$866 M / yr** | **$1.35 bn / yr** | **$71 M / yr** |
| Revenue / OPEX recovery | 1222% | 1910% | 100% |
...
| Operating surplus after OPEX (before debt support) | $795 M / yr | $1.28 bn / yr | $0 / yr |

_Commercial-revenue assumptions: 16,616 m² of station shop/kiosk leases at $90/m²/month and 3,116 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $303 M / yr | $485 M / yr | 20% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $161 M / yr | $258 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$786 M / yr** | **$1.26 bn / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 13 healthcare anchors | 43,212 trips/day; 15.8 M access-events/yr | 69,138 trips/day; 25.2 M access-events/yr |
| Commerce | 39 major/terminal/interchange nodes | 97,717 trips/trading day; 32.2 M access-events/yr | 156,347 trips/trading day; 51.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.12 bn | 57% of $1.98 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.80 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $360 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 13,780 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $152 M |
| **Reconciled project CAPEX** | **$1.98 bn** |
| 15%–25% planning risk envelope | $2.27 bn–$2.47 bn |
| Annual OPEX | $71 M / yr |
| Low/high project NPV at 8% | $4.73 bn / $8.59 bn |
| Low/high project IRR | 24.6% / 33.5% |
| Low/high steady-state DSCR | 8.77 / 14.15 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,997.07 train-km; 53,733.51 kWh consumed; 59,245.40 kWh charged; 39 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 69,914.31 train-km; 751,787.95 kWh consumed; 764,407.75 kWh charged; 993 depot services completed (8 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 85.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 105 line platforms, 8 interchange complexes, 46 civil segments, and 0 input findings |
