...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.36 bn (87.1%) of external capital** and **$2.90 bn of external interest**. Capital plus saved interest totals **$5.25 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 179.8 km |
| Revenue fleet | 190 × 4-car trainsets |
| Revenue fleet passenger capacity | 91,200 AW2 pax (121,600 AW3 crush) |
...
| Revenue fleet capacity | 91,200 AW2 pax (121,600 AW3 crush) |
| Total fleet capacity | 101,760 AW2 pax (135,680 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 190 × 480 = **91,200 AW2 passengers** (121,600 AW3 crush)
...
- Anchor-weighted coverage: 50.8%
- Catchment population: **≈ 762,000** (within ~800 m walk of a station)
...
| **Total installed** | **52** | **20,300 kW** | **116,500 kWh** |

Aggregate station-rail charging power: **78,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **206.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.1× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 579 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 121 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 122 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 69,475 train-km/day | One-way train journeys × route length |
| Annual service work | 27.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,201 MWh/day | 109.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,079 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 206.8 MW / 1,241 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 116 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 368 kWh | 662 kWh | 257 kWh | 9.0 km / 97 kWh |
| line-2 | 9 | 229 kWh | 490 kWh | 239 kWh | 3.3 km / 35 kWh |
| line-3 | 6 | 222 kWh | 392 kWh | 148 kWh | 6.2 km / 67 kWh |
| line-4 | 8 | 260 kWh | 441 kWh | 155 kWh | 6.1 km / 65 kWh |
| line-5 | 6 | 201 kWh | 343 kWh | 121 kWh | 6.4 km / 69 kWh |
| line-6 | 13 | 653 kWh | 956 kWh | 237 kWh | 13.1 km / 141 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (160.5 km @ $2.58 M/km) | $415 M |
| Elevated (19.2 km @ $9.75 M/km) | $188 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 206,756 kW @ $700/kW | $145 M |
| Grid interconnection / PPA tie-in | 206,756 kW @ $100/kW | $21 M |
| Annual generation proxy | 206.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 452.8 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 179.8 km × $0.050 M/km | $9.0 M |
...
| Per-capita (city pop) | $1,001 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $643 M | 15% | $96 M | $547 M |
| Stations | $334 M | 20% | $67 M | $267 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $237 M | 35% | $83 M | $154 M |
| Dedicated solar plant | $165 M | 45% | $74 M | $91 M |
| Residual signalling / train control | $9.0 M | 50% | $4.5 M | $4.5 M |
| Charging microgrids | $17 M | 40% | $7.0 M | $10 M |
| EPC / project services | $87 M | 15% | $13 M | $74 M |
| **Total city CAPEX** | **$1.50 bn** | **23.1%** | **$347 M** | **$1.15 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh medina`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$347 M** | **$69 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$1.15 bn** | **$231 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $923 M | $185 M / yr |
| **Total city programme** | **100.0%** | **$1.50 bn** | **$300 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.03 bn | $1.68 bn (82.9%) | $2.07 bn | **$3.75 bn** |
| **Default** | 2.00× | $2.70 bn | $2.36 bn (87.1%) | $2.90 bn | **$5.25 bn** |
| High | 3.00× | $4.05 bn | $3.71 bn (91.4%) | $4.56 bn | **$8.26 bn** |

At the default 2.00× case, OSR's $347 M external requirement is 87.1% below the illustrative foreign-company requirement of $2.70 bn; the associated lifetime external-interest saving is $2.90 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$103 M / yr** | $69 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$73 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$517 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, high scenario) | **$517 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.06 bn cumulative** | $2,043 |

_Population basis: 1,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $73 M / yr → $73 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $347 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $923 M | 4.5% | 40 y, 5 y grace | $53 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $231 M | — | — | — |
| **Total** | **100%** | **$1.50 bn** | | | **$73 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $16 M / yr + local bonds $42 M / yr = **$57 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($46 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $449 k |
| Traction energy (438.2 GWh / yr) | 69,475 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 44.5 GWh/yr + dedicated solar plant 206.8 MW / 452.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.5 M |
| Labour (813 FTE) | driverless roster: OCC/remote 130, station/platform 249, passenger service 111, fleet maintenance 155, infrastructure/energy 141, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $23 M |
| **OPEX subtotal** | | **$55 M / yr** |

_Annual service work: 69,475 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.4 M train-km / yr (109.5 M car-km / yr). On-site PV covers 44.5 GWh/yr and the dedicated solar plant adds 452.8 GWh/yr against 438.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 212 trainsets, 57 stations, 179.8 route-km, 6 lines, and 69,475 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 4.6 M |
| Annual paid trips / city resident | 119 | 191 | 3 |
| Farebox revenue | $813 M / yr | $1.30 bn / yr | $21 M / yr |
| Station shop leases | $10 M / yr | $10 M / yr | $10 M / yr |
| Advertising boards | $24 M / yr | $24 M / yr | $24 M / yr |
| **Total revenue** | **$847 M / yr** | **$1.33 bn / yr** | **$55 M / yr** |
| Revenue / OPEX recovery | 1530% | 2411% | 100% |
...
| Operating surplus applied to debt support | -$73 M / yr | -$73 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$73 M / yr** |
| Operating surplus after OPEX (before debt support) | $792 M / yr | $1.28 bn / yr | $0 / yr |

_Commercial-revenue assumptions: 10,840 m² of station shop/kiosk leases at $90/m²/month and 1,992 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $325 M / yr | $520 M / yr | 21% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $161 M / yr | $258 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$808 M / yr** | **$1.29 bn / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 23,430 trips/school day; 5.2 M access-events/yr | 37,487 trips/school day; 8.2 M access-events/yr |
| Healthcare | 10 healthcare anchors | 44,194 trips/day; 16.1 M access-events/yr | 70,710 trips/day; 25.8 M access-events/yr |
| Commerce | 29 major/terminal/interchange nodes | 104,798 trips/trading day; 34.6 M access-events/yr | 167,677 trips/trading day; 55.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.15 bn | 77% of $1.50 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.85 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $369 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 14,146 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.34 bn |
| Timetable-sized dedicated solar CAPEX | $165 M |
| **Reconciled project CAPEX** | **$1.50 bn** |
| Imported / external-capital requirement | $347 M (23.1%) |
| Local-content / local-funding requirement | $1.15 bn (76.9%) |
| Default foreign-turnkey external-capital comparison | $2.70 bn; OSR saves $2.36 bn (87.1%) |
| Lifetime external interest and combined financing saving | $2.90 bn interest; $5.25 bn capital + interest |
| 15%–25% planning risk envelope | $1.73 bn–$1.88 bn |
| Annual OPEX | $55 M / yr |
| Low/high project NPV at 8% | $5.08 bn / $8.95 bn |
| Low/high project IRR | 29.5% / 39.4% |
| Low/high steady-state DSCR | 10.88 / 17.58 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,313.55 train-km; 57,137.29 kWh consumed; 58,876.77 kWh charged; 51 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 65,514.87 train-km; 704,489.58 kWh consumed; 712,299.59 kWh charged; 968 depot services completed (10 active at cutoff); minimum SoC 67%; 0 onboard emergencies; 0 invariant violations; 94.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 58.7% | 94.3% / 90% | pass |
| maximum planning climate/HVAC duty | 59.0% | 94.3% / 90% | pass |
| 50% charging-contact availability | 67.0% | 94.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 71.7% / 60% | pass |
| ten-hour single charging-pad outage | 67.0% | 94.3% / 90% | pass |
...
|---|---|
| ![Medina energy and battery simulation dashboard](engineering/screenshots/medina-simulation-dashboard.png) | ![Medina simulator network visualizer](engineering/screenshots/medina-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 57 line platforms, 9 interchange complexes, 48 civil segments, and 0 input findings |
...
|---|---|
| ![Medina QGIS engineering layers](engineering/screenshots/medina-qgis-engineering-map.png) | ![Medina SUMO timetable validation](engineering/screenshots/medina-sumo-validation.png) |
...
scripts/regenerate-city.sh medina
```
