...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 171 | $5.60 M | $958 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 684 | $100 k | $68 M |
| High sensitivity check | 684 | $200 k | $137 M |
...
|---|---|---|
| Construction (years 1–5) | **$164 M / yr** | $109 |
| Steady-state, low-ridership (year 6+) | **$160 M / yr** | $107 |
| Steady-state, high-ridership (year 6+) | **$160 M / yr** | $107 |
| Steady-state, operating-neutral revenue case | **$160 M / yr** | $107 |
| Lifecycle envelope (yr 1–25, low scenario) | **$4.02 bn cumulative** | $2,683 |
| Lifecycle envelope (yr 1–25, high scenario) | **$4.02 bn cumulative** | $2,683 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$4.02 bn cumulative** | $2,683 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.54 bn | 3.8% | 25 y, 5 y grace | $111 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $640 M | 4.5% | 25 y, 5 y grace | $49 M / yr |
| Government equity (no debt service) | 15% | $384 M | — | — | — |
| **Total** | **100%** | **$2.56 bn** | | | **$160 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $58 M / yr + bonds $29 M / yr = **$87 M / yr** total — plus the equity tranche amortised across construction ($77 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 126,900 | 211,500 | 36,376 |
| Daily paid trips / catchment | 18% | 30% | 5% |
| Daily paid trips / city population | 8% | 14% | 2% |
| Annual paid trips | 46.3 M | 77.2 M | 13.3 M |
| Farebox revenue | $157 M / yr | $262 M / yr | $45 M / yr |
| Station shop leases | $17 M / yr | $17 M / yr | $17 M / yr |
| Advertising boards | $40 M / yr | $40 M / yr | $40 M / yr |
| **Total revenue** | **$214 M / yr** | **$319 M / yr** | **$102 M / yr** |
| Revenue / OPEX recovery | 211% | 314% | 100% |
| Country farebox-only policy target (diagnostic) | 85% | 85% | 85% |
| Gov debt service + residual OPEX subsidy | $160 M / yr | $160 M / yr | **$160 M / yr** |
| Operating surplus after OPEX | $112 M / yr | $217 M / yr | $0 / yr |
