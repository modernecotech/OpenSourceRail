...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.55 bn (87.5%) of external capital** and **$3.14 bn of external interest**. Capital plus saved interest totals **$5.69 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $1,080 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $753 M | 15% | $113 M | $640 M |
...
| **Total city CAPEX** | **$1.62 bn** | **22.5%** | **$365 M** | **$1.25 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.5%** | **$365 M** | **$73 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.5%** | **$1.25 bn** | **$251 M / yr** |
| of which planned local bond issuance | 62.0% of total CAPEX | $1.00 bn | $201 M / yr |
| **Total city programme** | **100.0%** | **$1.62 bn** | **$324 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.19 bn | $1.82 bn (83.3%) | $2.24 bn | **$4.06 bn** |
| **Default** | 2.00× | $2.92 bn | $2.55 bn (87.5%) | $3.14 bn | **$5.69 bn** |
| High | 3.00× | $4.37 bn | $4.01 bn (91.7%) | $4.93 bn | **$8.93 bn** |

At the default 2.00× case, OSR's $365 M external requirement is 87.5% below the illustrative foreign-company requirement of $2.92 bn; the associated lifetime external-interest saving is $3.14 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$112 M / yr** | $75 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$559 M cumulative** | $373 |
| Lifecycle envelope (yr 1–40, high scenario) | **$559 M cumulative** | $373 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.30 bn cumulative** | $2,201 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $365 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.00 bn | 4.5% | 40 y, 5 y grace | $57 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $251 M | — | — | — |
| **Total** | **100%** | **$1.62 bn** | | | **$78 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $16 M / yr + local bonds $45 M / yr = **$62 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($50 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 5.1 M |
| Annual paid trips / city resident | 119 | 191 | 3 |
| Farebox revenue | $813 M / yr | $1.30 bn / yr | $23 M / yr |
| Station shop leases | $10 M / yr | $10 M / yr | $10 M / yr |
| Advertising boards | $24 M / yr | $24 M / yr | $24 M / yr |
| **Total revenue** | **$847 M / yr** | **$1.33 bn / yr** | **$58 M / yr** |
| Revenue / OPEX recovery | 1472% | 2319% | 100% |
...
| Operating surplus after OPEX (before debt support) | $789 M / yr | $1.28 bn / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.25 bn | 77% of $1.62 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.01 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $401 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 15,373 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.45 bn |
| Timetable-sized dedicated solar CAPEX | $165 M |
| **Reconciled project CAPEX** | **$1.62 bn** |
| Imported / external-capital requirement | $365 M (22.5%) |
| Local-content / local-funding requirement | $1.25 bn (77.5%) |
| Default foreign-turnkey external-capital comparison | $2.92 bn; OSR saves $2.55 bn (87.5%) |
| Lifetime external interest and combined financing saving | $3.14 bn interest; $5.69 bn capital + interest |
| 15%–25% planning risk envelope | $1.86 bn–$2.02 bn |
| Annual OPEX | $58 M / yr |
| Low/high project NPV at 8% | $4.97 bn / $8.84 bn |
| Low/high project IRR | 28.0% / 37.7% |
| Low/high steady-state DSCR | 10.07 / 16.29 |
