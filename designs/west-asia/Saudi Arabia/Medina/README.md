...
| Revenue fleet passenger capacity | 121,920 AW2 pax (162,560 AW3 crush) |
...
| Revenue fleet capacity | 121,920 AW2 pax (162,560 AW3 crush) |
| Total fleet capacity | 135,360 AW2 pax (180,480 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 254 × 480 = **121,920 AW2 passengers** (162,560 AW3 crush)
- **Total fleet passenger capacity:** 282 × 480 = **135,360 AW2 passengers** (180,480 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **375.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 211 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,846 MWh/day | 106,800 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,635 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 375.9 MW / 1,880 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 375,937 kW @ $700/kW | $263 M |
| Grid interconnection / PPA tie-in | 375,937 kW @ $100/kW | $38 M |
| Annual generation proxy | 375.9 MW × 5.0 peak-sun-h/day × 365 d/yr | 686.1 GWh/yr |
...
| Per-capita (city pop) | $2,382 / person |
...
|---|---|---|
| Construction (years 1–5) | **$200 M / yr** | $133 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$1.00 bn cumulative** | $667 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.00 bn cumulative** | $667 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.00 bn cumulative** | $3,336 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.86 bn | 2.0% | 40 y, 5 y grace | $114 M / yr |
| Government equity (no debt service) | 20% | $715 M | — | — | — |
| **Total** | **100%** | **$3.57 bn** | | | **$114 M / yr** |
...
| Traction energy (673.6 GWh / yr) | 106,800 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 77.0 GWh/yr + dedicated solar plant 375.9 MW / 686.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.5 M |
| Labour (1,116 FTE) | driverless roster: OCC/remote 158, station/platform 392, passenger service 89, fleet maintenance 225, infrastructure/energy 206, admin/training 46; no train drivers × country median × 12 × engineer-premium 1.4 | $32 M |
| **OPEX subtotal** | | **$126 M / yr** |

_Annual service work: 106,800 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 42.1 M train-km / yr (168.4 M car-km / yr). On-site PV covers 77.0 GWh/yr and the dedicated solar plant adds 686.1 GWh/yr against 673.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 140.2 M | 224.3 M | 15.4 M |
| Annual paid trips / city resident | 93 | 150 | 10 |
| Farebox revenue | $635 M / yr | $1.02 bn / yr | $70 M / yr |
| Station shop leases | $17 M / yr | $17 M / yr | $17 M / yr |
| Advertising boards | $40 M / yr | $40 M / yr | $40 M / yr |
| **Total revenue** | **$692 M / yr** | **$1.07 bn / yr** | **$126 M / yr** |
| Revenue / OPEX recovery | 548% | 850% | 100% |
...
| Operating surplus after OPEX (before debt support) | $566 M / yr | $947 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $183 M / yr | $293 M / yr | 16 min/trip × $4.90/h value-of-time proxy |
...
| Station-area commerce turnover supported | $268 M / yr | $429 M / yr | 23% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $126 M / yr | $202 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$646 M / yr** | **$1.03 bn / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 17,487 trips/school day; 3.8 M access-events/yr | 27,979 trips/school day; 6.2 M access-events/yr |
| Healthcare | 12 healthcare anchors | 32,965 trips/day; 12.0 M access-events/yr | 52,744 trips/day; 19.3 M access-events/yr |
| Commerce | 64 major/terminal/interchange nodes | 86,493 trips/trading day; 28.5 M access-events/yr | 138,389 trips/trading day; 45.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.85 bn | 52% of $3.57 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.96 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $593 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 22,705 job-years | retained CAPEX ÷ (4.0 × median annual income) |
