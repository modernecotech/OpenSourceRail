...
| Bucket | Value |
|---|---|
| At-grade (196.9 km @ €3.5 M/km) | €689 M |
| Elevated (13.8 km @ €18 M/km) | €248 M |
...
|---|---|---|---|
| `halt` | 7 | €0.4 M | €2.8 M |
| `standard` | 33 | €1.5 M | €50 M |
| `major` | 42 | €3.0 M | €126 M |
| `terminal` | 7 | €2.5 M | €18 M |
| `depot-terminal` | 1 | €3.0 M | €3.0 M |
| `interchange-elevated` | 14 | €4.5 M | €63 M |
| **Stations subtotal** | | | **€262 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 171 | €4.0 M | €684 M |
...
| Steady-state, low-ridership (year 6+) | **€166 M / yr** | €111 |
| Steady-state, high-ridership (year 6+) | **€147 M / yr** | €98 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.07 bn cumulative** | €2,711 |
| Lifecycle envelope (yr 1–25, high scenario) | **€3.68 bn cumulative** | €2,456 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€19 M / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.41 bn | 3.8% | 25 y, 5 y grace | €102 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €586 M | 4.5% | 25 y, 5 y grace | €45 M / yr |
| Government equity (no debt service) | 15% | €352 M | — | — | — |
| **Total** | **100%** | **€2.34 bn** | | | **€147 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €53 M / yr + bonds €26 M / yr = **€80 M / yr** total — plus the equity tranche amortised across construction (€70 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (1,281 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €34 M |
...
| Farebox / OPEX recovery | 79% | 158% |
| Country policy-target recovery (diagnostic) | 85% | 85% |
| Operating shortfall (gov subsidy required) | €19 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €52 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€166 M / yr** | **€147 M / yr** |
