...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$930 M (86.5%) of external capital** and **$1.14 bn of external interest**. Capital plus saved interest totals **$2.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (77.5 km @ $3.0 M/km) | $233 M |
| Elevated (0.3 km @ $12.0 M/km) | $3.9 M |
| **Civil subtotal** | **$236 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $236 M | 15% | $35 M | $201 M |
...
| EPC / project services | $35 M | 15% | $5.3 M | $30 M |
| **Total city CAPEX** | **$597 M** | **24.3%** | **$145 M** | **$452 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$145 M** | **$29 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$452 M** | **$90 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $362 M | $72 M / yr |
| **Total city programme** | **100.0%** | **$597 M** | **$119 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $806 M | $661 M (82.0%) | $813 M | **$1.47 bn** |
| **Default** | 2.00× | $1.08 bn | $930 M (86.5%) | $1.14 bn | **$2.07 bn** |
| High | 3.00× | $1.61 bn | $1.47 bn (91.0%) | $1.80 bn | **$3.27 bn** |

At the default 2.00× case, OSR's $145 M external requirement is 86.5% below the illustrative foreign-company requirement of $1.08 bn; the associated lifetime external-interest saving is $1.14 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $51 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$205 M cumulative** | $256 |
| Lifecycle envelope (yr 1–40, high scenario) | **$205 M cumulative** | $256 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.22 bn cumulative** | $1,526 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $145 M | 4.5% | 40 y, 5 y grace | $8.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $362 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $90 M | — | — | — |
| **Total** | **100%** | **$597 M** | | | **$29 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.5 M / yr + local bonds $16 M / yr = **$23 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($18 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 2.9 M |
| Annual paid trips / city resident | 92 | 147 | 4 |
| Farebox revenue | $332 M / yr | $532 M / yr | $13 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $9.3 M / yr | $9.3 M / yr | $9.3 M / yr |
| **Total revenue** | **$345 M / yr** | **$545 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 1325% | 2090% | 100% |
...
| Operating surplus after OPEX (before debt support) | $319 M / yr | $519 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $452 M | 76% of $597 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $724 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $145 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,542 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $537 M |
| Timetable-sized dedicated solar CAPEX | $60 M |
| **Reconciled project CAPEX** | **$597 M** |
| Imported / external-capital requirement | $145 M (24.3%) |
| Local-content / local-funding requirement | $452 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $1.08 bn; OSR saves $930 M (86.5%) |
| Lifetime external interest and combined financing saving | $1.14 bn interest; $2.07 bn capital + interest |
| 15%–25% planning risk envelope | $687 M–$747 M |
| Annual OPEX | $26 M / yr |
| Low/high project NPV at 8% | $2.06 bn / $3.64 bn |
| Low/high project IRR | 29.7% / 39.8% |
| Low/high steady-state DSCR | 11.00 / 17.87 |
