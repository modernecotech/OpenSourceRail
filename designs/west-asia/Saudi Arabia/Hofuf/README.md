...
| Revenue fleet | 172 × 3-car trainsets |
| Revenue fleet passenger capacity | 61,920 AW2 pax (82,560 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 25.9 km | 16 | 64 | NW Outer ↔ S Outer |
| line-2 | 26.7 km | 16 | 65 | SW Outer ↔ NE Outer |
| line-3 | 25.3 km | 15 | 61 | N Outer ↔ S Outer |
| **Total** | **77.9 km** | **47 unique** | **190** | |
...
| Revenue fleet capacity | 61,920 AW2 pax (82,560 AW3 crush) |
| Total fleet capacity | 68,400 AW2 pax (91,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 172 × 360 = **61,920 AW2 passengers** (82,560 AW3 crush)
...
| Major | 11 | 300 kW | 500 kWh |
| Standard | 24 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **46** | **18,500 kW** | **62,500 kWh** |

Aggregate station-rail charging power: **23,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **68.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 500 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 68.6 MW / 412 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 209 kWh | 335 kWh | 105 kWh | 2.9 km / 24 kWh |
| line-2 | 16 | 215 kWh | 343 kWh | 106 kWh | 2.0 km / 16 kWh |
| line-3 | 14 | 204 kWh | 294 kWh | 70 kWh | 5.0 km / 40 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 570 | $60 k | $34 M |
| High sensitivity check | 570 | $120 k | $68 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 68,649 kW @ $700/kW | $48 M |
| Grid interconnection / PPA tie-in | 68,649 kW @ $100/kW | $6.9 M |
| Annual generation proxy | 68.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 150.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$55 M** |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hofuf`.
...
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $42 |
| Lifecycle envelope (yr 1–40, low scenario) | **$279 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, high scenario) | **$279 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.46 bn cumulative** | $1,823 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $588 M | 4.5% | 40 y, 5 y grace | $34 M / yr |
| Government equity (no debt service) | 20% | $147 M | — | — | — |
| **Total** | **100%** | **$735 M** | | | **$34 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $26 M / yr = **$26 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($29 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (171.2 GWh / yr) | 36,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 40.5 GWh/yr + dedicated solar plant 68.6 MW / 150.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $824 k |
| Labour (518 FTE) | driverless roster: OCC/remote 110, station/platform 161, passenger service 49, fleet maintenance 105, infrastructure/energy 72, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $15 M |
| **OPEX subtotal** | | **$31 M / yr** |

_Annual service work: 36,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.3 M train-km / yr (42.8 M car-km / yr). On-site PV covers 40.5 GWh/yr and the dedicated solar plant adds 150.3 GWh/yr against 171.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 190 trainsets, 47 stations, 77.9 route-km, 3 lines, and 36,201 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 2.0 M |
| Annual paid trips / city resident | 92 | 147 | 2 |
| Farebox revenue | $332 M / yr | $532 M / yr | $9.0 M / yr |
| Station shop leases | $6.4 M / yr | $6.4 M / yr | $6.4 M / yr |
| Advertising boards | $16 M / yr | $16 M / yr | $16 M / yr |
| **Total revenue** | **$354 M / yr** | **$554 M / yr** | **$31 M / yr** |
| Revenue / OPEX recovery | 1140% | 1781% | 100% |
...
| Operating surplus after OPEX (before debt support) | $323 M / yr | $523 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,696 m² of station shop/kiosk leases at $90/m²/month and 1,292 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $130 M / yr | $209 M / yr | 21% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$327 M / yr** | **$523 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 9,771 trips/school day; 2.1 M access-events/yr | 15,633 trips/school day; 3.4 M access-events/yr |
| Healthcare | 3 healthcare anchors | 14,078 trips/day; 5.1 M access-events/yr | 22,524 trips/day; 8.2 M access-events/yr |
| Commerce | 22 major/terminal/interchange nodes | 42,014 trips/trading day; 13.9 M access-events/yr | 67,222 trips/trading day; 22.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $412 M | 56% of $735 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $658 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $132 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,043 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $680 M |
| Timetable-sized dedicated solar CAPEX | $55 M |
| **Reconciled project CAPEX** | **$735 M** |
| 15%–25% planning risk envelope | $846 M–$919 M |
| Annual OPEX | $31 M / yr |
| Low/high project NPV at 8% | $1.98 bn / $3.56 bn |
| Low/high project IRR | 26.2% / 35.4% |
| Low/high steady-state DSCR | 9.60 / 15.52 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,643.25 train-km; 21,316.96 kWh consumed; 22,269.12 kWh charged; 16 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 37,141.02 train-km; 299,530.14 kWh consumed; 305,065.98 kWh charged; 502 depot services completed (1 active at cutoff); minimum SoC 34%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 22.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 34.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.4% / 60% | pass |
| ten-hour single charging-pad outage | 34.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 47 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
