...
**Country:** SA · **Population:** 800,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$872 M (86.2%) of external capital** and **$1.07 bn of external interest**. Capital plus saved interest totals **$1.94 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`hofuf.corridor.geojson`](hofuf.corridor.geojson).
...
| Anchor-weighted coverage | 49.3% |
| Route length (double track) | 77.9 km |
| Revenue fleet | 147 × 3-car trainsets |
| Revenue fleet passenger capacity | 52,920 AW2 pax (70,560 AW3 crush) |
...
| Revenue fleet capacity | 52,920 AW2 pax (70,560 AW3 crush) |
| Total fleet capacity | 58,680 AW2 pax (78,240 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 147 × 360 = **52,920 AW2 passengers** (70,560 AW3 crush)
- **Total fleet passenger capacity:** 163 × 360 = **58,680 AW2 passengers** (78,240 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 49.3%
- Catchment population: **≈ 394,400** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **75.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 484 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 64 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 75 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 36,201 train-km/day | One-way train journeys × route length |
| Annual service work | 14.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 469 MWh/day | 42.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 394 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 75.5 MW / 453 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 209 kWh | 294 kWh | 64 kWh | 5.6 km / 45 kWh |
| line-2 | 9 | 215 kWh | 331 kWh | 94 kWh | 6.9 km / 56 kWh |
| line-3 | 9 | 204 kWh | 294 kWh | 70 kWh | 5.4 km / 44 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (77.5 km @ $2.58 M/km) | $200 M |
| Elevated (0.3 km @ $9.75 M/km) | $3.2 M |
| **Civil subtotal** | **$203 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 163 | $900 k | $147 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 489 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 489 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 75,549 kW @ $700/kW | $53 M |
| Grid interconnection / PPA tie-in | 75,549 kW @ $100/kW | $7.6 M |
| Annual generation proxy | 75.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 165.5 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $6.6 M |
| EPC overhead (7%) | $33 M |
| **CAPEX total** | **$562 M** |
| Per-route-km | $7.2 M / km |
| Per-capita (city pop) | $703 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $203 M | 15% | $31 M | $173 M |
| Stations | $104 M | 20% | $21 M | $83 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $147 M | 35% | $51 M | $95 M |
| Dedicated solar plant | $60 M | 45% | $27 M | $33 M |
| Residual signalling / train control | $3.9 M | 50% | $1.9 M | $1.9 M |
| Charging microgrids | $2.8 M | 40% | $1.1 M | $1.6 M |
| EPC / project services | $33 M | 15% | $4.9 M | $28 M |
| **Total city CAPEX** | **$562 M** | **24.9%** | **$140 M** | **$422 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hofuf`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.9%** | **$140 M** | **$28 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.1%** | **$422 M** | **$84 M / yr** |
| of which planned local bond issuance | 60.1% of total CAPEX | $338 M | $68 M / yr |
| **Total city programme** | **100.0%** | **$562 M** | **$112 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $759 M | $619 M (81.6%) | $761 M | **$1.38 bn** |
| **Default** | 2.00× | $1.01 bn | $872 M (86.2%) | $1.07 bn | **$1.94 bn** |
| High | 3.00× | $1.52 bn | $1.38 bn (90.8%) | $1.69 bn | **$3.07 bn** |

At the default 2.00× case, OSR's $140 M external requirement is 86.2% below the illustrative foreign-company requirement of $1.01 bn; the associated lifetime external-interest saving is $1.07 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$38 M / yr** | $48 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$192 M cumulative** | $240 |
| Lifecycle envelope (yr 1–40, high scenario) | **$192 M cumulative** | $240 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.15 bn cumulative** | $1,437 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $140 M | 4.5% | 40 y, 5 y grace | $8.0 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $338 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $84 M | — | — | — |
| **Total** | **100%** | **$562 M** | | | **$27 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.3 M / yr + local bonds $15 M / yr = **$21 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($17 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $5.9 M |
...
| Traction energy (171.2 GWh / yr) | 36,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 75.5 MW / 165.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $907 k |
| Labour (425 FTE) | driverless roster: OCC/remote 98, station/platform 96, passenger service 49, fleet maintenance 97, infrastructure/energy 64, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $12 M |
| **OPEX subtotal** | | **$25 M / yr** |

_Annual service work: 36,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.3 M train-km / yr (42.8 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 165.5 GWh/yr against 171.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 163 trainsets, 26 stations, 77.9 route-km, 3 lines, and 36,201 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 2.7 M |
| Annual paid trips / city resident | 92 | 147 | 3 |
| Farebox revenue | $332 M / yr | $532 M / yr | $12 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $9.3 M / yr | $9.3 M / yr | $9.3 M / yr |
| **Total revenue** | **$345 M / yr** | **$545 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 1359% | 2144% | 100% |
...
| Operating surplus after OPEX (before debt support) | $320 M / yr | $519 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,952 m² of station shop/kiosk leases at $90/m²/month and 768 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $21 M / yr | $33 M / yr | 257 M - 411 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.7 M / yr | $5.9 M / yr | 46.3–74.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $10 M / yr | $16 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $135 M / yr | $216 M / yr | 22% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$331 M / yr** | **$530 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 10,588 trips/school day; 2.3 M access-events/yr | 16,940 trips/school day; 3.7 M access-events/yr |
| Healthcare | 2 healthcare anchors | 14,038 trips/day; 5.1 M access-events/yr | 22,461 trips/day; 8.2 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 43,498 trips/trading day; 14.4 M access-events/yr | 69,597 trips/trading day; 23.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $422 M | 75% of $562 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $676 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $135 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,175 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $502 M |
| Timetable-sized dedicated solar CAPEX | $60 M |
| **Reconciled project CAPEX** | **$562 M** |
| Imported / external-capital requirement | $140 M (24.9%) |
| Local-content / local-funding requirement | $422 M (75.1%) |
| Default foreign-turnkey external-capital comparison | $1.01 bn; OSR saves $872 M (86.2%) |
| Lifetime external interest and combined financing saving | $1.07 bn interest; $1.94 bn capital + interest |
| 15%–25% planning risk envelope | $646 M–$703 M |
| Annual OPEX | $25 M / yr |
| Low/high project NPV at 8% | $2.09 bn / $3.67 bn |
| Low/high project IRR | 30.9% / 41.2% |
| Low/high steady-state DSCR | 11.70 / 18.99 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,655.03 train-km; 21,412.28 kWh consumed; 18,451.96 kWh charged; 20 depot services completed; minimum SoC 70%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 33,933.60 train-km; 273,662.62 kWh consumed; 262,105.71 kWh charged; 482 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 93.7% of scheduled train-km delivered; 77 SoC warnings; 9 energy-adapted off-peak departures, maximum 15 min headway |
...
| 50% charging-contact availability | 20.0% | 93.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.9% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 92.7% / 90% | pass |
...
|---|---|
| ![Hofuf energy and battery simulation dashboard](engineering/screenshots/hofuf-simulation-dashboard.png) | ![Hofuf simulator network visualizer](engineering/screenshots/hofuf-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
...
|---|---|
| ![Hofuf QGIS engineering layers](engineering/screenshots/hofuf-qgis-engineering-map.png) | ![Hofuf SUMO timetable validation](engineering/screenshots/hofuf-sumo-validation.png) |
...
| [`hofuf.toml`](hofuf.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`hofuf-network-map.png`](hofuf-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`hofuf.corridor.geojson`](hofuf.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`hofuf.stations.json`](hofuf.stations.json) | Machine-readable station list |
| [`hofuf.design-quality.yaml`](hofuf.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
