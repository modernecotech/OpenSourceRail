...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 489 | $60 k | $29 M |
| High sensitivity check | 489 | $120 k | $59 M |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$239 M cumulative** | $299 |
| Lifecycle envelope (yr 1–40, high scenario) | **$239 M cumulative** | $299 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.25 bn cumulative** | $1,559 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $503 M | 4.5% | 40 y, 5 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $126 M | — | — | — |
| **Total** | **100%** | **$629 M** | | | **$29 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $23 M / yr = **$23 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($25 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $350 M | 56% of $629 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $559 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $112 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,283 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $568 M |
| Timetable-sized dedicated solar CAPEX | $60 M |
| **Reconciled project CAPEX** | **$629 M** |
| 15%–25% planning risk envelope | $723 M–$786 M |
| Annual OPEX | $26 M / yr |
| Low/high project NPV at 8% | $2.03 bn / $3.61 bn |
| Low/high project IRR | 28.8% / 38.7% |
| Low/high steady-state DSCR | 11.09 / 18.01 |
