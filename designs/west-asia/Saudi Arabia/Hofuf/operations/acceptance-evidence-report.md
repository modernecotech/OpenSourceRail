# Hofuf Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 456 |
| Manufacturing schedule rows | 1,714 |
| Manufacturing material/BOM rows | 25,226 |
| Manufacturing QA verification rows | 1,714 |
| Construction QA action rows | 1,579 |
| Maintenance handover schedule rows | 2,053 |
| Manufacturing rows with material refs | 1,714 / 1,714 |
| Manufacturing rows with verification refs | 1,714 / 1,714 |
| Manufacturing rows linked to QA actions | 1,714 / 1,714 |
