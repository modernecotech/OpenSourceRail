...
| Steady-state, low-ridership (year 6+) | **€51 M / yr** | €73 |
| Steady-state, high-ridership (year 6+) | **€51 M / yr** | €73 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.27 bn cumulative** | €1,821 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.27 bn cumulative** | €1,821 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €487 M | 3.8% | 25 y, 5 y grace | €35 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €203 M | 4.5% | 25 y, 5 y grace | €16 M / yr |
| Government equity (no debt service) | 15% | €122 M | — | — | — |
| **Total** | **100%** | **€811 M** | | | **€51 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €18 M / yr + bonds €9.1 M / yr = **€28 M / yr** total — plus the equity tranche amortised across construction (€24 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (490 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €13 M |
...
| Farebox / OPEX recovery | 103% | 206% |
| Country policy-target recovery (diagnostic) | 85% | 85% |
| Operating shortfall (gov subsidy required) | €0 k / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €962 k / yr | €34 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€51 M / yr** | **€51 M / yr** |
