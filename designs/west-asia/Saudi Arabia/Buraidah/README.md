...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$899 M (86.8%) of external capital** and **$1.11 bn of external interest**. Capital plus saved interest totals **$2.00 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 46.1% |
| Route length (double track) | 69.2 km |
| Revenue fleet | 131 × 3-car trainsets |
| Revenue fleet passenger capacity | 47,160 AW2 pax (62,880 AW3 crush) |
...
| Revenue fleet capacity | 47,160 AW2 pax (62,880 AW3 crush) |
| Total fleet capacity | 52,560 AW2 pax (70,080 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 131 × 360 = **47,160 AW2 passengers** (62,880 AW3 crush)
- **Total fleet passenger capacity:** 146 × 360 = **52,560 AW2 passengers** (70,080 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 46.1%
- Catchment population: **≈ 322,700** (within ~800 m walk of a station)
...
| **Total installed** | **27** | **12,800 kW** | **53,000 kWh** |

Aggregate station-rail charging power: **13,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.
...
| Onboard battery adequacy | 9.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 485 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 52 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 77 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 32,199 train-km/day | One-way train journeys × route length |
| Annual service work | 12.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 417 MWh/day | 38.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 341 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 65.3 MW / 392 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 237 kWh | 331 kWh | 70 kWh | 6.9 km / 55 kWh |
| line-2 | 9 | 168 kWh | 257 kWh | 72 kWh | 3.4 km / 28 kWh |
| line-3 | 9 | 153 kWh | 220 kWh | 52 kWh | 3.0 km / 24 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (67.8 km @ $3.0 M/km) | $204 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 146 | $900 k | $131 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 438 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 438 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 65,263 kW @ $700/kW | $46 M |
| Grid interconnection / PPA tie-in | 65,263 kW @ $100/kW | $6.5 M |
| Annual generation proxy | 65.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 142.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 69.2 km × $0.050 M/km | $3.5 M |
...
| Residual train-control wayside + charging microgrids | $6.4 M |
| EPC overhead (7%) | $34 M |
| **CAPEX total** | **$576 M** |
| Per-route-km | $8.3 M / km |
| Per-capita (city pop) | $822 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $225 M | 15% | $34 M | $191 M |
| Stations | $118 M | 20% | $24 M | $95 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $131 M | 35% | $46 M | $85 M |
| Dedicated solar plant | $52 M | 45% | $23 M | $29 M |
| Residual signalling / train control | $3.5 M | 50% | $1.7 M | $1.7 M |
| Charging microgrids | $2.9 M | 40% | $1.2 M | $1.8 M |
| EPC / project services | $34 M | 15% | $5.1 M | $29 M |
| **Total city CAPEX** | **$576 M** | **23.8%** | **$137 M** | **$439 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh buraidah`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.8%** | **$137 M** | **$27 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.2%** | **$439 M** | **$88 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $351 M | $70 M / yr |
| **Total city programme** | **100.0%** | **$576 M** | **$115 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $777 M | $640 M (82.4%) | $787 M | **$1.43 bn** |
| **Default** | 2.00× | $1.04 bn | $899 M (86.8%) | $1.11 bn | **$2.00 bn** |
| High | 3.00× | $1.55 bn | $1.42 bn (91.2%) | $1.74 bn | **$3.16 bn** |

At the default 2.00× case, OSR's $137 M external requirement is 86.8% below the illustrative foreign-company requirement of $1.04 bn; the associated lifetime external-interest saving is $1.11 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$39 M / yr** | $56 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$197 M cumulative** | $282 |
| Lifecycle envelope (yr 1–40, high scenario) | **$197 M cumulative** | $282 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.18 bn cumulative** | $1,679 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $137 M | 4.5% | 40 y, 5 y grace | $7.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $351 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $88 M | — | — | — |
| **Total** | **100%** | **$576 M** | | | **$28 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.2 M / yr + local bonds $16 M / yr = **$22 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($18 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $173 k |
| Traction energy (152.3 GWh / yr) | 32,199 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.0 GWh/yr + dedicated solar plant 65.3 MW / 142.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $783 k |
| Labour (404 FTE) | driverless roster: OCC/remote 90, station/platform 98, passenger service 49, fleet maintenance 87, infrastructure/energy 59, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $12 M |
| **OPEX subtotal** | | **$25 M / yr** |

_Annual service work: 32,199 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.7 M train-km / yr (38.1 M car-km / yr). On-site PV covers 28.0 GWh/yr and the dedicated solar plant adds 142.9 GWh/yr against 152.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 146 trainsets, 27 stations, 69.2 route-km, 3 lines, and 32,199 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 105 | 168 | 3 |
| Farebox revenue | $332 M / yr | $532 M / yr | $11 M / yr |
| Station shop leases | $4.0 M / yr | $4.0 M / yr | $4.0 M / yr |
| Advertising boards | $9.8 M / yr | $9.8 M / yr | $9.8 M / yr |
| **Total revenue** | **$346 M / yr** | **$546 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 1397% | 2202% | 100% |
...
_Commercial-revenue assumptions: 4,168 m² of station shop/kiosk leases at $90/m²/month and 808 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $18 M / yr | $29 M / yr | 228 M - 365 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.3 M / yr | $5.3 M / yr | 41.1–65.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $9.1 M / yr | $15 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $134 M / yr | $214 M / yr | 21% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$326 M / yr** | **$522 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 10,928 trips/school day; 2.4 M access-events/yr | 17,485 trips/school day; 3.8 M access-events/yr |
| Healthcare | 1 healthcare anchors | 13,178 trips/day; 4.8 M access-events/yr | 21,084 trips/day; 7.7 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 43,078 trips/trading day; 14.2 M access-events/yr | 68,924 trips/trading day; 22.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $439 M | 76% of $576 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 5,375 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$576 M** |
| Imported / external-capital requirement | $137 M (23.8%) |
| Local-content / local-funding requirement | $439 M (76.2%) |
| Default foreign-turnkey external-capital comparison | $1.04 bn; OSR saves $899 M (86.8%) |
| Lifetime external interest and combined financing saving | $1.11 bn interest; $2.00 bn capital + interest |
| 15%–25% planning risk envelope | $662 M–$719 M |
| Annual OPEX | $25 M / yr |
| Low/high project NPV at 8% | $2.09 bn / $3.67 bn |
| Low/high project IRR | 30.5% / 40.8% |
| Low/high steady-state DSCR | 11.50 / 18.64 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,454.98 train-km; 19,798.95 kWh consumed; 17,705.49 kWh charged; 23 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 30,962.39 train-km; 249,700.23 kWh consumed; 245,878.23 kWh charged; 481 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 96.2% of scheduled train-km delivered; 263 SoC warnings; 26 energy-adapted off-peak departures, maximum 15 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 96.7% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 94.7% / 90% | pass |
| 50% charging-contact availability | 20.0% | 96.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 82.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 95.4% / 90% | pass |
...
|---|---|
| ![Buraidah energy and battery simulation dashboard](engineering/screenshots/buraidah-simulation-dashboard.png) | ![Buraidah simulator network visualizer](engineering/screenshots/buraidah-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 6 civil segments, and 0 input findings |
...
|---|---|
| ![Buraidah QGIS engineering layers](engineering/screenshots/buraidah-qgis-engineering-map.png) | ![Buraidah SUMO timetable validation](engineering/screenshots/buraidah-sumo-validation.png) |
