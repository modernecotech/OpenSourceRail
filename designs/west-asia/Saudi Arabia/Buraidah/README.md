...
|---|---|---|---|---|
| line-1 | 29.3 km | 17 | 75 | SE Outer ↔ NW Outer |
| line-2 | 20.9 km | 13 | 53 | NW Mid ↔ E Mid |
| line-3 | 19.0 km | 13 | 45 | S Mid ↔ N Mid |
| **Total** | **69.2 km** | **43 unique** | **173** | |
...
| Total fleet capacity | 62,280 AW2 pax (83,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 156 × 360 = **56,160 AW2 passengers** (74,880 AW3 crush)
- **Total fleet passenger capacity:** 173 × 360 = **62,280 AW2 passengers** (83,040 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 21 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **41** | **17,000 kW** | **60,000 kWh** |

Aggregate station-rail charging power: **20,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **60.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 498 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 60 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 102 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 60.4 MW / 363 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 237 kWh | 376 kWh | 115 kWh | 5.2 km / 42 kWh |
| line-2 | 13 | 168 kWh | 274 kWh | 88 kWh | 2.2 km / 18 kWh |
| line-3 | 13 | 153 kWh | 229 kWh | 60 kWh | 2.0 km / 16 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 173 | $900 k | $156 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 519 | $60 k | $31 M |
| High sensitivity check | 519 | $120 k | $62 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 60,433 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 60,433 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 60.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 132.3 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $7.8 M |
| EPC overhead (7%) | $42 M |
| **CAPEX total** | **$684 M** |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $74 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$260 M cumulative** | $371 |
| Lifecycle envelope (yr 1–40, high scenario) | **$260 M cumulative** | $371 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.36 bn cumulative** | $1,939 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $547 M | 4.5% | 40 y, 5 y grace | $31 M / yr |
| Government equity (no debt service) | 20% | $137 M | — | — | — |
| **Total** | **100%** | **$684 M** | | | **$31 M / yr** |
...
| Traction energy (152.3 GWh / yr) | 32,199 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 37.2 GWh/yr + dedicated solar plant 60.4 MW / 132.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $725 k |
| Labour (472 FTE) | driverless roster: OCC/remote 102, station/platform 140, passenger service 49, fleet maintenance 95, infrastructure/energy 65, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $13 M |
| **OPEX subtotal** | | **$29 M / yr** |

_Annual service work: 32,199 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.7 M train-km / yr (38.1 M car-km / yr). On-site PV covers 37.2 GWh/yr and the dedicated solar plant adds 132.3 GWh/yr against 152.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 173 trainsets, 43 stations, 69.2 route-km, 3 lines, and 32,199 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $332 M / yr | $532 M / yr | $8.9 M / yr |
| Station shop leases | $5.7 M / yr | $5.7 M / yr | $5.7 M / yr |
| Advertising boards | $14 M / yr | $14 M / yr | $14 M / yr |
| **Total revenue** | **$352 M / yr** | **$552 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 1231% | 1929% | 100% |
...
_Commercial-revenue assumptions: 5,960 m² of station shop/kiosk leases at $90/m²/month and 1,160 advertising boards at $1190/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 6 education anchors | 13,459 trips/school day; 3.0 M access-events/yr | 21,534 trips/school day; 4.7 M access-events/yr |
| Healthcare | 2 healthcare anchors | 13,459 trips/day; 4.9 M access-events/yr | 21,534 trips/day; 7.9 M access-events/yr |
| Commerce | 20 major/terminal/interchange nodes | 41,951 trips/trading day; 13.8 M access-events/yr | 67,122 trips/trading day; 22.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $384 M | 56% of $684 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $615 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $123 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,711 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$684 M** |
| 15%–25% planning risk envelope | $787 M–$855 M |
| Annual OPEX | $29 M / yr |
| Low/high project NPV at 8% | $2.02 bn / $3.60 bn |
| Low/high project IRR | 27.5% / 37.0% |
| Low/high steady-state DSCR | 10.32 / 16.69 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,420.10 train-km; 19,517.29 kWh consumed; 20,445.95 kWh charged; 21 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 33,084.70 train-km; 266,816.76 kWh consumed; 271,326.34 kWh charged; 503 depot services completed (4 active at cutoff); minimum SoC 44%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 31.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 44.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.9% / 60% | pass |
| ten-hour single charging-pad outage | 32.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 43 line platforms, 1 interchange complexes, 6 civil segments, and 0 input findings |
