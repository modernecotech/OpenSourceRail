...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$844 M (86.5%) of external capital** and **$1.04 bn of external interest**. Capital plus saved interest totals **$1.88 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (67.8 km @ $2.58 M/km) | $175 M |
...
|---|---:|---:|---:|---:|
| Civil works | $193 M | 15% | $29 M | $164 M |
...
| **Total city CAPEX** | **$542 M** | **24.3%** | **$132 M** | **$410 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$132 M** | **$26 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$410 M** | **$82 M / yr** |
| of which planned local bond issuance | 60.5% of total CAPEX | $328 M | $66 M / yr |
| **Total city programme** | **100.0%** | **$542 M** | **$108 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $732 M | $600 M (82.0%) | $737 M | **$1.34 bn** |
| **Default** | 2.00× | $976 M | $844 M (86.5%) | $1.04 bn | **$1.88 bn** |
| High | 3.00× | $1.46 bn | $1.33 bn (91.0%) | $1.64 bn | **$2.97 bn** |

At the default 2.00× case, OSR's $132 M external requirement is 86.5% below the illustrative foreign-company requirement of $976 M; the associated lifetime external-interest saving is $1.04 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$37 M / yr** | $53 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $38 |
| Lifecycle envelope (yr 1–40, low scenario) | **$186 M cumulative** | $265 |
| Lifecycle envelope (yr 1–40, high scenario) | **$186 M cumulative** | $265 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $1,582 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $132 M | 4.5% | 40 y, 5 y grace | $7.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $328 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $82 M | — | — | — |
| **Total** | **100%** | **$542 M** | | | **$26 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.9 M / yr + local bonds $15 M / yr = **$21 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($16 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 2.3 M |
...
| **Total revenue** | **$346 M / yr** | **$546 M / yr** | **$24 M / yr** |
| Revenue / OPEX recovery | 1433% | 2259% | 100% |
...
| Operating surplus after OPEX (before debt support) | $322 M / yr | $521 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $410 M | 76% of $542 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $656 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $131 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,026 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$542 M** |
| Imported / external-capital requirement | $132 M (24.3%) |
| Local-content / local-funding requirement | $410 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $976 M; OSR saves $844 M (86.5%) |
| Lifetime external interest and combined financing saving | $1.04 bn interest; $1.88 bn capital + interest |
| 15%–25% planning risk envelope | $623 M–$677 M |
| Annual OPEX | $24 M / yr |
| Low/high project NPV at 8% | $2.12 bn / $3.70 bn |
| Low/high project IRR | 31.8% / 42.2% |
| Low/high steady-state DSCR | 12.22 / 19.79 |
