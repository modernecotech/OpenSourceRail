...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 438 | $60 k | $26 M |
| High sensitivity check | 438 | $120 k | $53 M |
...
| Per-capita (city pop) | $862 / person |
...
|---|---|---|
| Construction (years 1–5) | **$46 M / yr** | $66 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$229 M cumulative** | $328 |
| Lifecycle envelope (yr 1–40, high scenario) | **$229 M cumulative** | $328 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.20 bn cumulative** | $1,711 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $483 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $338 M | 56% of $604 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,147 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $551 M |
| Timetable-sized dedicated solar CAPEX | $52 M |
| **Reconciled project CAPEX** | **$604 M** |
| 15%–25% planning risk envelope | $694 M–$755 M |
| Annual OPEX | $25 M / yr |
| Low/high project NPV at 8% | $2.07 bn / $3.65 bn |
| Low/high project IRR | 29.6% / 39.7% |
| Low/high steady-state DSCR | 11.62 / 18.83 |
