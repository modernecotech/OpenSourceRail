...
|---|---|---|
| Construction (years 1–5) | **$122 M / yr** | $56 |
| Steady-state, low-ridership (year 6+) | **$120 M / yr** | $54 |
| Steady-state, high-ridership (year 6+) | **$120 M / yr** | $54 |
| Steady-state, operating-neutral revenue case | **$120 M / yr** | $54 |
| Lifecycle envelope (yr 1–25, low scenario) | **$3.01 bn cumulative** | $1,366 |
| Lifecycle envelope (yr 1–25, high scenario) | **$3.01 bn cumulative** | $1,366 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$3.01 bn cumulative** | $1,366 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.15 bn | 3.8% | 25 y, 5 y grace | $83 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $478 M | 4.5% | 25 y, 5 y grace | $37 M / yr |
| Government equity (no debt service) | 15% | $287 M | — | — | — |
| **Total** | **100%** | **$1.91 bn** | | | **$120 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $44 M / yr + bonds $22 M / yr = **$65 M / yr** total — plus the equity tranche amortised across construction ($57 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
