...
| Steady-state, low-ridership (year 6+) | **$48 M / yr** | $120 |
| Steady-state, high-ridership (year 6+) | **$48 M / yr** | $120 |
| Steady-state, operating-neutral revenue case | **$48 M / yr** | $120 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.20 bn cumulative** | $3,004 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.20 bn cumulative** | $3,004 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.20 bn cumulative** | $3,004 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $459 M | 3.8% | 25 y, 5 y grace | $33 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $191 M | 4.5% | 25 y, 5 y grace | $15 M / yr |
| Government equity (no debt service) | 15% | $115 M | — | — | — |
| **Total** | **100%** | **$764 M** | | | **$48 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $8.6 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($23 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
