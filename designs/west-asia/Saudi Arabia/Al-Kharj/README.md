...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.9%** | **$250 M** | **$50 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.1%** | **$307 M** | **$61 M / yr** |
| of which planned local bond issuance | 44.1% of total CAPEX | $246 M | $49 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$35 M / yr** | $87 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$173 M cumulative** | $433 |
| Lifecycle envelope (yr 1–40, high scenario) | **$173 M cumulative** | $433 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.17 bn cumulative** | $2,917 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $250 M | 4.5% | 40 y, 5 y grace | $14 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $246 M | 4.5% | 40 y, 5 y grace | $14 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $61 M | — | — | — |
| **Total** | **100%** | **$557 M** | | | **$28 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $11 M / yr + local bonds $11 M / yr = **$22 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($12 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $307 M | 55% of $557 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 3,766 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $250 M (44.9%) |
| Local-content / local-funding requirement | $307 M (55.1%) |
| 15%–25% planning risk envelope | $641 M–$697 M |
| Annual OPEX | $24 M / yr |
| Low/high project NPV at 8% | $2.10 bn / $3.68 bn |
| Low/high project IRR | 31.1% / 41.5% |
| Low/high steady-state DSCR | 11.30 / 18.32 |
