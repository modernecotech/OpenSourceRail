...
|---|---|---|
| Construction (years 1–5) | **$44 M / yr** | $111 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$222 M cumulative** | $556 |
| Lifecycle envelope (yr 1–40, high scenario) | **$222 M cumulative** | $556 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $2,900 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $468 M | 4.5% | 40 y, 5 y grace | $27 M / yr |
| Government equity (no debt service) | 20% | $117 M | — | — | — |
| **Total** | **100%** | **$585 M** | | | **$27 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $328 M | 56% of $585 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,015 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $534 M |
...
| Low/high project IRR | 30.2% / 40.4% |
| Low/high steady-state DSCR | 11.97 / 19.42 |
