...
| Bucket | Value |
|---|---|
| At-grade (65.7 km @ €3.5 M/km) | €230 M |
| Elevated (1.9 km @ €18 M/km) | €35 M |
| Elevated-interchange premium (2 sites @ €20 M) | €40 M |
| **Civil subtotal** | **€305 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 67 | €3.0 M | €201 M |
...
| Per-capita (city pop) | €1,706 / person |
...
|---|---|---|
| Construction (years 1–5) | **€44 M / yr** | €109 |
| Steady-state, low-ridership (year 6+) | **€51 M / yr** | €128 |
| Steady-state, high-ridership (year 6+) | **€43 M / yr** | €107 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.24 bn cumulative** | €3,108 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.07 bn cumulative** | €2,682 |

_Population basis: 400,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€8.5 M / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €410 M | 3.8% | 25 y, 5 y grace | €30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €171 M | 4.5% | 25 y, 5 y grace | €13 M / yr |
| Government equity (no debt service) | 15% | €102 M | — | — | — |
| **Total** | **100%** | **€683 M** | | | **€43 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €16 M / yr + bonds €7.7 M / yr = **€23 M / yr** total — plus the equity tranche amortised across construction (€20 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (418 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €11 M |
...
| Farebox / OPEX recovery | 69% | 138% |
| Country policy-target recovery (diagnostic) | 85% | 85% |
| Operating shortfall (gov subsidy required) | €8.5 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €11 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€51 M / yr** | **€43 M / yr** |
