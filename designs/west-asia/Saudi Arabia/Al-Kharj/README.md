...
| Revenue fleet | 153 × 3-car trainsets |
| Revenue fleet passenger capacity | 55,080 AW2 pax (73,440 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 23.3 km | 14 | 58 | E Outer ↔ W Outer |
| line-2 | 23.1 km | 13 | 60 | NE Outer ↔ SW Outer |
| line-3 | 21.4 km | 12 | 52 | W Outer ↔ E Outer |
| **Total** | **67.7 km** | **39 unique** | **170** | |
...
| Revenue fleet capacity | 55,080 AW2 pax (73,440 AW3 crush) |
| Total fleet capacity | 61,200 AW2 pax (81,600 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 153 × 360 = **55,080 AW2 passengers** (73,440 AW3 crush)
- **Total fleet passenger capacity:** 170 × 360 = **61,200 AW2 passengers** (81,600 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 13.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 500 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 312 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 59.7 MW / 358 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 188 kWh | 302 kWh | 96 kWh | 2.0 km / 16 kWh |
| line-2 | 12 | 186 kWh | 294 kWh | 89 kWh | 5.0 km / 40 kWh |
| line-3 | 12 | 172 kWh | 253 kWh | 64 kWh | 2.3 km / 19 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 170 | $900 k | $153 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 510 | $60 k | $31 M |
| High sensitivity check | 510 | $120 k | $61 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 59,723 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 59,723 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 59.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 130.8 GWh/yr |
...
| Per-capita (city pop) | $1,672 / person |
...
|---|---|---|
| Construction (years 1–5) | **$51 M / yr** | $127 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $77 |
| Lifecycle envelope (yr 1–40, low scenario) | **$254 M cumulative** | $635 |
| Lifecycle envelope (yr 1–40, high scenario) | **$254 M cumulative** | $635 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.33 bn cumulative** | $3,316 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $535 M | 4.5% | 40 y, 5 y grace | $31 M / yr |
| Government equity (no debt service) | 20% | $134 M | — | — | — |
| **Total** | **100%** | **$669 M** | | | **$31 M / yr** |
...
| Traction energy (149.0 GWh / yr) | 31,497 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 35.3 GWh/yr + dedicated solar plant 59.7 MW / 130.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $717 k |
| Labour (456 FTE) | driverless roster: OCC/remote 102, station/platform 129, passenger service 49, fleet maintenance 93, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $13 M |
| **OPEX subtotal** | | **$28 M / yr** |

_Annual service work: 31,497 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.4 M train-km / yr (37.2 M car-km / yr). On-site PV covers 35.3 GWh/yr and the dedicated solar plant adds 130.8 GWh/yr against 149.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 170 trainsets, 39 stations, 67.7 route-km, 3 lines, and 31,497 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$350 M / yr** | **$550 M / yr** | **$28 M / yr** |
| Revenue / OPEX recovery | 1259% | 1976% | 100% |
...
_Commercial-revenue assumptions: 5,336 m² of station shop/kiosk leases at $90/m²/month and 1,044 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $123 M / yr | $197 M / yr | 20% of paid trips × $8.50 local spend proxy |
...
| Commerce | 14 major/terminal/interchange nodes | 39,712 trips/trading day; 13.1 M access-events/yr | 63,540 trips/trading day; 21.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $375 M | 56% of $669 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $601 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $120 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 4,602 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$669 M** |
| 15%–25% planning risk envelope | $769 M–$836 M |
| Annual OPEX | $28 M / yr |
| Low/high project NPV at 8% | $2.02 bn / $3.60 bn |
| Low/high project IRR | 27.8% / 37.4% |
| Low/high steady-state DSCR | 10.52 / 17.03 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,421.12 train-km; 19,525.61 kWh consumed; 20,363.55 kWh charged; 22 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 32,407.97 train-km; 261,359.89 kWh consumed; 266,271.48 kWh charged; 500 depot services completed (6 active at cutoff); minimum SoC 39%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 24.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 38.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.4% / 60% | pass |
| ten-hour single charging-pad outage | 38.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
