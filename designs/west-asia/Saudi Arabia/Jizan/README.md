...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.6%** | **$184 M** | **$37 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.4%** | **$229 M** | **$46 M / yr** |
| of which planned local bond issuance | 44.3% of total CAPEX | $183 M | $37 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$26 M / yr** | $64 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$128 M cumulative** | $321 |
| Lifecycle envelope (yr 1–40, high scenario) | **$128 M cumulative** | $321 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$863 M cumulative** | $2,158 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $184 M | 4.5% | 40 y, 5 y grace | $11 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $183 M | 4.5% | 40 y, 5 y grace | $10 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $46 M | — | — | — |
| **Total** | **100%** | **$412 M** | | | **$21 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $8.3 M / yr + local bonds $8.2 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $229 M | 55% of $412 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 2,801 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $184 M (44.6%) |
| Local-content / local-funding requirement | $229 M (55.4%) |
| 15%–25% planning risk envelope | $474 M–$515 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $2.24 bn / $3.82 bn |
| Low/high project IRR | 37.6% / 49.0% |
| Low/high steady-state DSCR | 15.43 / 24.93 |
