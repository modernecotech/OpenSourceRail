...
|---|---|---|---|---|
| line-1 | 20.9 km | 13 | 53 | SE Mid ↔ N Outer |
| line-2 |  7.9 km | 6 | 21 | W Inner ↔ NE Inner |
| line-3 | 19.1 km | 11 | 50 | SE Outer ↔ NW Inner |
| **Total** | **47.9 km** | **30 unique** | **124** | |
...
| Onboard battery adequacy | 11.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 492 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 39.9 MW / 239 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 168 kWh | 282 kWh | 96 kWh | 2.0 km / 16 kWh |
| line-2 | 6 | 64 kWh | 114 kWh | 44 kWh | 2.0 km / 16 kWh |
| line-3 | 10 | 154 kWh | 245 kWh | 76 kWh | 6.0 km / 48 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,872 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,872 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 39.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 87.3 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$38 M / yr** | $94 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $57 |
| Lifecycle envelope (yr 1–40, low scenario) | **$188 M cumulative** | $470 |
| Lifecycle envelope (yr 1–40, high scenario) | **$188 M cumulative** | $470 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$981 M cumulative** | $2,453 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $396 M | 4.5% | 40 y, 5 y grace | $23 M / yr |
| Government equity (no debt service) | 20% | $99 M | — | — | — |
| **Total** | **100%** | **$495 M** | | | **$23 M / yr** |
...
| Traction energy (105.3 GWh / yr) | 22,255 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.3 GWh/yr + dedicated solar plant 39.9 MW / 87.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $478 k |
| Labour (365 FTE) | driverless roster: OCC/remote 77, station/platform 105, passenger service 49, fleet maintenance 67, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $10 M |
| **OPEX subtotal** | | **$21 M / yr** |

_Annual service work: 22,255 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.8 M train-km / yr (26.3 M car-km / yr). On-site PV covers 29.3 GWh/yr and the dedicated solar plant adds 87.3 GWh/yr against 105.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 124 trainsets, 30 stations, 47.9 route-km, 3 lines, and 22,255 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 1.5 M |
| Annual paid trips / city resident | 183 | 293 | 4 |
| Farebox revenue | $332 M / yr | $532 M / yr | $7.0 M / yr |
| Station shop leases | $4.1 M / yr | $4.1 M / yr | $4.1 M / yr |
| Advertising boards | $10 M / yr | $10 M / yr | $10 M / yr |
| **Total revenue** | **$347 M / yr** | **$546 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 1624% | 2559% | 100% |
...
| Operating surplus after OPEX (before debt support) | $325 M / yr | $525 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,328 m² of station shop/kiosk leases at $90/m²/month and 844 advertising boards at $1190/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$311 M / yr** | **$498 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 13 major/terminal/interchange nodes | 41,281 trips/trading day; 13.6 M access-events/yr | 66,049 trips/trading day; 21.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $279 M | 56% of $495 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 3,417 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $463 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$495 M** |
| 15%–25% planning risk envelope | $569 M–$618 M |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $2.19 bn / $3.77 bn |
| Low/high project IRR | 33.8% / 44.5% |
| Low/high steady-state DSCR | 14.36 / 23.16 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,832.27 train-km; 14,776.70 kWh consumed; 15,350.93 kWh charged; 29 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,978.32 train-km; 185,312.79 kWh consumed; 187,888.01 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 53%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 43.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 30.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 52.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.0% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 30 line platforms, 2 interchange complexes, 9 civil segments, and 0 input findings |
