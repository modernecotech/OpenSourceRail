...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$645 M (86.9%) of external capital** and **$793 M of external interest**. Capital plus saved interest totals **$1.44 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`jizan.corridor.geojson`](jizan.corridor.geojson).
...
| Anchor-weighted coverage | 68.0% |
| Route length (double track) | 47.9 km |
...
- Anchor-weighted coverage: 68.0%
- Catchment population: **≈ 272,000** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 9.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 485 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 22,255 train-km/day | One-way train journeys × route length |
| Annual service work | 8.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 288 MWh/day | 26.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 230 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 44.0 MW / 264 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 168 kWh | 245 kWh | 60 kWh | 6.4 km / 52 kWh |
| line-2 | 4 | 64 kWh | 98 kWh | 28 kWh | 2.7 km / 22 kWh |
| line-3 | 7 | 154 kWh | 229 kWh | 59 kWh | 6.8 km / 55 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 44,012 kW @ $700/kW | $31 M |
| Grid interconnection / PPA tie-in | 44,012 kW @ $100/kW | $4.4 M |
| Annual generation proxy | 44.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 96.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 47.9 km × $0.050 M/km | $2.4 M |
...
| Residual train-control wayside + charging microgrids | $4.3 M |
| EPC overhead (7%) | $25 M |
| **CAPEX total** | **$412 M** |
| Per-route-km | $8.6 M / km |
| Per-capita (city pop) | $1,031 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $159 M | 15% | $24 M | $135 M |
...
| **Total city CAPEX** | **$412 M** | **23.6%** | **$97 M** | **$315 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh jizan`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$97 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$315 M** | **$63 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $252 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$412 M** | **$82 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $557 M | $459 M (82.5%) | $565 M | **$1.02 bn** |
| **Default** | 2.00× | $742 M | $645 M (86.9%) | $793 M | **$1.44 bn** |
| High | 3.00× | $1.11 bn | $1.02 bn (91.3%) | $1.25 bn | **$2.27 bn** |

At the default 2.00× case, OSR's $97 M external requirement is 86.9% below the illustrative foreign-company requirement of $742 M; the associated lifetime external-interest saving is $793 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$28 M / yr** | $71 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $50 |
| Lifecycle envelope (yr 1–40, low scenario) | **$142 M cumulative** | $354 |
| Lifecycle envelope (yr 1–40, high scenario) | **$142 M cumulative** | $354 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$842 M cumulative** | $2,105 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $97 M | 4.5% | 40 y, 5 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $252 M | 4.5% | 40 y, 5 y grace | $14 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$412 M** | | | **$20 M / yr** |
...
| Traction energy (105.3 GWh / yr) | 22,255 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 44.0 MW / 96.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $528 k |
| Labour (314 FTE) | driverless roster: OCC/remote 69, station/platform 73, passenger service 49, fleet maintenance 60, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $9.0 M |
| **OPEX subtotal** | | **$18 M / yr** |

_Annual service work: 22,255 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.8 M train-km / yr (26.3 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 96.4 GWh/yr against 105.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 102 trainsets, 17 stations, 47.9 route-km, 3 lines, and 22,255 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 1.8 M |
| Annual paid trips / city resident | 183 | 293 | 5 |
| Farebox revenue | $332 M / yr | $532 M / yr | $8.4 M / yr |
| Station shop leases | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| Advertising boards | $7.1 M / yr | $7.1 M / yr | $7.1 M / yr |
| **Total revenue** | **$342 M / yr** | **$542 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 1860% | 2943% | 100% |
...
| Operating surplus after OPEX (before debt support) | $324 M / yr | $523 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,072 m² of station shop/kiosk leases at $90/m²/month and 588 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $20 M / yr | 158 M - 253 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.3 M / yr | $3.6 M / yr | 28.4–45.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.3 M / yr | $10 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $138 M / yr | $221 M / yr | 22% of paid trips × $8.50 local spend proxy |
| Entertainment / community activity supported | $66 M / yr | $106 M / yr | 11% of paid trips × $8.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$321 M / yr** | **$514 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $315 M | 76% of $412 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $504 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $101 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 3,861 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $377 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$412 M** |
| Imported / external-capital requirement | $97 M (23.6%) |
| Local-content / local-funding requirement | $315 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $742 M; OSR saves $645 M (86.9%) |
| Lifetime external interest and combined financing saving | $793 M interest; $1.44 bn capital + interest |
| 15%–25% planning risk envelope | $474 M–$515 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $2.24 bn / $3.82 bn |
| Low/high project IRR | 37.6% / 49.0% |
| Low/high steady-state DSCR | 16.19 / 26.16 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,829.56 train-km; 14,755.08 kWh consumed; 12,997.58 kWh charged; 31 depot services completed; minimum SoC 66%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,639.15 train-km; 166,447.81 kWh consumed; 159,388.65 kWh charged; 468 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 92.7% of scheduled train-km delivered; 35 SoC warnings; 6 energy-adapted off-peak departures, maximum 25 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 92.8% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 92.7% / 90% | pass |
...
|---|---|
| ![Jizan energy and battery simulation dashboard](engineering/screenshots/jizan-simulation-dashboard.png) | ![Jizan simulator network visualizer](engineering/screenshots/jizan-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 2 interchange complexes, 9 civil segments, and 0 input findings |
...
|---|---|
| ![Jizan QGIS engineering layers](engineering/screenshots/jizan-qgis-engineering-map.png) | ![Jizan SUMO timetable validation](engineering/screenshots/jizan-sumo-validation.png) |
...
| [`jizan.toml`](jizan.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`jizan-network-map.png`](jizan-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`jizan.corridor.geojson`](jizan.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`jizan.stations.json`](jizan.stations.json) | Machine-readable station list |
| [`jizan.design-quality.yaml`](jizan.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
