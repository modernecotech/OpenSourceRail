...
| Revenue fleet | 186 × 3-car trainsets |
| Revenue fleet passenger capacity | 66,960 AW2 pax (89,280 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 29.1 km | 15 | 73 | SE Outer ↔ NW Outer |
| line-2 | 25.5 km | 14 | 64 | SE Mid ↔ NW Outer |
| line-3 | 26.5 km | 15 | 69 | N Outer ↔ SE Outer |
| **Total** | **81.2 km** | **44 unique** | **206** | |
...
| Revenue fleet capacity | 66,960 AW2 pax (89,280 AW3 crush) |
| Total fleet capacity | 74,160 AW2 pax (98,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 186 × 360 = **66,960 AW2 passengers** (89,280 AW3 crush)
- **Total fleet passenger capacity:** 206 × 360 = **74,160 AW2 passengers** (98,880 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 22 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **40** | **16,700 kW** | **59,500 kWh** |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **74.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 492 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 389 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 74.5 MW / 447 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 235 kWh | 351 kWh | 93 kWh | 5.0 km / 41 kWh |
| line-2 | 12 | 206 kWh | 294 kWh | 67 kWh | 6.0 km / 48 kWh |
| line-3 | 14 | 214 kWh | 343 kWh | 108 kWh | 5.4 km / 44 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (75.9 km @ $3.0 M/km) | $228 M |
| Elevated (5.3 km @ $12.0 M/km) | $63 M |
| Elevated-interchange premium (2 sites @ $4.50 M) | $9.0 M |
| **Civil subtotal** | **$300 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 206 | $900 k | $185 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 618 | $60 k | $37 M |
| High sensitivity check | 618 | $120 k | $74 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 74,547 kW @ $700/kW | $52 M |
| Grid interconnection / PPA tie-in | 74,547 kW @ $100/kW | $7.5 M |
| Annual generation proxy | 74.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 163.3 GWh/yr |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $4.2 M |
...
| Per-capita (city pop) | $1,374 / person |
...
|---|---|---|
| Construction (years 1–5) | **$63 M / yr** | $104 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$313 M cumulative** | $522 |
| Lifecycle envelope (yr 1–40, high scenario) | **$313 M cumulative** | $522 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.63 bn cumulative** | $2,725 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $659 M | 4.5% | 40 y, 5 y grace | $38 M / yr |
| Government equity (no debt service) | 20% | $165 M | — | — | — |
| **Total** | **100%** | **$824 M** | | | **$38 M / yr** |
...
| Traction energy (178.5 GWh / yr) | 37,742 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 36.6 GWh/yr + dedicated solar plant 74.5 MW / 163.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $895 k |
| Labour (521 FTE) | driverless roster: OCC/remote 118, station/platform 148, passenger service 49, fleet maintenance 112, infrastructure/energy 73, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $15 M |
| **OPEX subtotal** | | **$33 M / yr** |

_Annual service work: 37,742 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.9 M train-km / yr (44.6 M car-km / yr). On-site PV covers 36.6 GWh/yr and the dedicated solar plant adds 163.3 GWh/yr against 178.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 206 trainsets, 44 stations, 81.2 route-km, 3 lines, and 37,742 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 122 | 196 | 5 |
...
| **Total revenue** | **$353 M / yr** | **$552 M / yr** | **$33 M / yr** |
| Revenue / OPEX recovery | 1066% | 1669% | 100% |
...
_Commercial-revenue assumptions: 6,104 m² of station shop/kiosk leases at $90/m²/month and 1,180 advertising boards at $1190/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$324 M / yr** | **$518 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $465 M | 56% of $824 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $743 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $149 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,694 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $765 M |
| Timetable-sized dedicated solar CAPEX | $60 M |
| **Reconciled project CAPEX** | **$824 M** |
| 15%–25% planning risk envelope | $948 M–$1.03 bn |
| Annual OPEX | $33 M / yr |
| Low/high project NPV at 8% | $1.88 bn / $3.46 bn |
| Low/high project IRR | 24.0% / 32.9% |
| Low/high steady-state DSCR | 8.46 / 13.74 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,715.33 train-km; 21,898.37 kWh consumed; 22,064.82 kWh charged; 16 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 38,501.92 train-km; 310,505.12 kWh consumed; 313,342.60 kWh charged; 507 depot services completed (1 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 34 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |
...
| 50% charging-contact availability | 21.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 44 line platforms, 3 interchange complexes, 21 civil segments, and 0 input findings |
