...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **23,250 – 34,875 trips/day**
...
| Elevated (12.4 km @ €18 M/km) | €224 M |
| Elevated-interchange premium (1 sites @ €20 M) | €20 M |
| **Civil subtotal** | **€398 M** |
...
|---|---|---|
| Construction (years 1–5) | **€48 M / yr** | €95 |
| Steady-state, low-ridership (year 6+) | **€49 M / yr** | €99 |
| Steady-state, high-ridership (year 6+) | **€47 M / yr** | €93 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.22 bn cumulative** | €2,448 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.17 bn cumulative** | €2,344 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€2.6 M / yr (low) → €0 k / yr (high)._
...
| Labour (352 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €9.2 M |
...
| Farebox / OPEX recovery | 90% | 180% |
| Country policy-target recovery (diagnostic) | 85% | 85% |
| Operating shortfall (gov subsidy required) | €2.6 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €21 M / yr |
