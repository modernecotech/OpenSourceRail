...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$902 M (87.7%) of external capital** and **$1.11 bn of external interest**. Capital plus saved interest totals **$2.01 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **53.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 487 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Scheduled train journey-km | 26,368 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 278 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 53.2 MW / 319 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 173 kWh | 261 kWh | 72 kWh | 4.6 km / 37 kWh |
| line-2 | 6 | 162 kWh | 245 kWh | 67 kWh | 6.5 km / 53 kWh |
| line-3 | 6 | 123 kWh | 172 kWh | 36 kWh | 3.5 km / 28 kWh |
...
| Elevated (12.6 km @ $12.0 M/km) | $151 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 360 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 360 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 53,194 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 53,194 kW @ $100/kW | $5.3 M |
| Annual generation proxy | 53.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 116.5 GWh/yr |
...
|---|---:|---:|---:|---:|
| Civil works | $288 M | 15% | $43 M | $245 M |
| Stations | $86 M | 20% | $17 M | $68 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $108 M | 35% | $38 M | $70 M |
| Dedicated solar plant | $43 M | 45% | $19 M | $23 M |
...
| **Total city CAPEX** | **$572 M** | **22.2%** | **$127 M** | **$445 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh najran`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.2%** | **$127 M** | **$25 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.8%** | **$445 M** | **$89 M / yr** |
| of which planned local bond issuance | 62.3% of total CAPEX | $356 M | $71 M / yr |
| **Total city programme** | **100.0%** | **$572 M** | **$114 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $772 M | $645 M (83.6%) | $793 M | **$1.44 bn** |
| **Default** | 2.00× | $1.03 bn | $902 M (87.7%) | $1.11 bn | **$2.01 bn** |
| High | 3.00× | $1.54 bn | $1.42 bn (91.8%) | $1.74 bn | **$3.16 bn** |

At the default 2.00× case, OSR's $127 M external requirement is 87.7% below the illustrative foreign-company requirement of $1.03 bn; the associated lifetime external-interest saving is $1.11 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $79 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$198 M cumulative** | $395 |
| Lifecycle envelope (yr 1–40, high scenario) | **$198 M cumulative** | $395 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $2,330 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $127 M | 4.5% | 40 y, 5 y grace | $7.3 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $356 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $89 M | — | — | — |
| **Total** | **100%** | **$572 M** | | | **$28 M / yr** |
...
| Traction energy (124.7 GWh / yr) | 26,368 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 53.2 MW / 116.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $638 k |
| Labour (337 FTE) | driverless roster: OCC/remote 77, station/platform 71, passenger service 49, fleet maintenance 71, infrastructure/energy 48, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $9.6 M |
| **OPEX subtotal** | | **$22 M / yr** |

_Annual service work: 26,368 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.4 M train-km / yr (31.2 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 116.5 GWh/yr against 124.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 120 trainsets, 20 stations, 56.7 route-km, 3 lines, and 26,368 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 147 | 235 | 5 |
...
| **Total revenue** | **$342 M / yr** | **$542 M / yr** | **$22 M / yr** |
| Revenue / OPEX recovery | 1532% | 2424% | 100% |
...
_Commercial-revenue assumptions: 2,968 m² of station shop/kiosk leases at $90/m²/month and 588 advertising boards at $1190/board/month, with occupancy derates applied._
...
| Avoided road congestion | $15 M / yr | $24 M / yr | 187 M - 299 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.7 M / yr | $4.3 M / yr | 33.7–53.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$320 M / yr** | **$511 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $445 M | 78% of $572 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $712 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $142 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 5,451 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $529 M |
| Timetable-sized dedicated solar CAPEX | $43 M |
| **Reconciled project CAPEX** | **$572 M** |
| Imported / external-capital requirement | $127 M (22.2%) |
| Local-content / local-funding requirement | $445 M (77.8%) |
| Default foreign-turnkey external-capital comparison | $1.03 bn; OSR saves $902 M (87.7%) |
| Lifetime external interest and combined financing saving | $1.11 bn interest; $2.01 bn capital + interest |
| 15%–25% planning risk envelope | $657 M–$714 M |
| Annual OPEX | $22 M / yr |
| Low/high project NPV at 8% | $2.08 bn / $3.66 bn |
| Low/high project IRR | 30.6% / 40.9% |
| Low/high steady-state DSCR | 11.58 / 18.79 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,163.11 train-km; 17,445.07 kWh consumed; 14,626.24 kWh charged; 28 depot services completed; minimum SoC 62%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,757.02 train-km; 207,720.06 kWh consumed; 201,890.32 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.7% of scheduled train-km delivered; 215 SoC warnings; 26 energy-adapted off-peak departures, maximum 15 min headway |
...
| 50% charging-contact availability | 20.0% | 97.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 82.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 97.1% / 90% | pass |
...
|---|---|
| ![Najran energy and battery simulation dashboard](engineering/screenshots/najran-simulation-dashboard.png) | ![Najran simulator network visualizer](engineering/screenshots/najran-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
...
|---|---|
| ![Najran QGIS engineering layers](engineering/screenshots/najran-qgis-engineering-map.png) | ![Najran SUMO timetable validation](engineering/screenshots/najran-sumo-validation.png) |
