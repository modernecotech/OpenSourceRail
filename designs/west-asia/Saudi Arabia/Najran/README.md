...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$820 M (87.3%) of external capital** and **$1.01 bn of external interest**. Capital plus saved interest totals **$1.83 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Elevated (12.6 km @ $9.75 M/km) | $123 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$241 M** |
...
| Per-capita (city pop) | $1,043 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $241 M | 15% | $36 M | $205 M |
...
| **Total city CAPEX** | **$522 M** | **22.9%** | **$119 M** | **$402 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.9%** | **$119 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.1%** | **$402 M** | **$80 M / yr** |
| of which planned local bond issuance | 61.7% of total CAPEX | $322 M | $64 M / yr |
| **Total city programme** | **100.0%** | **$522 M** | **$104 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $704 M | $585 M (83.1%) | $719 M | **$1.30 bn** |
| **Default** | 2.00× | $939 M | $820 M (87.3%) | $1.01 bn | **$1.83 bn** |
| High | 3.00× | $1.41 bn | $1.29 bn (91.5%) | $1.58 bn | **$2.87 bn** |

At the default 2.00× case, OSR's $119 M external requirement is 87.3% below the illustrative foreign-company requirement of $939 M; the associated lifetime external-interest saving is $1.01 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $72 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$180 M cumulative** | $359 |
| Lifecycle envelope (yr 1–40, high scenario) | **$180 M cumulative** | $359 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $2,128 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $119 M | 4.5% | 40 y, 5 y grace | $6.8 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $322 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $80 M | — | — | — |
| **Total** | **100%** | **$522 M** | | | **$25 M / yr** |
...
| **Total revenue** | **$342 M / yr** | **$542 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 1598% | 2530% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $402 M | 77% of $522 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 4,931 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$522 M** |
| Imported / external-capital requirement | $119 M (22.9%) |
| Local-content / local-funding requirement | $402 M (77.1%) |
| Default foreign-turnkey external-capital comparison | $939 M; OSR saves $820 M (87.3%) |
| Lifetime external interest and combined financing saving | $1.01 bn interest; $1.83 bn capital + interest |
| 15%–25% planning risk envelope | $600 M–$652 M |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $2.13 bn / $3.71 bn |
| Low/high project IRR | 32.5% / 43.0% |
| Low/high steady-state DSCR | 12.70 / 20.60 |
