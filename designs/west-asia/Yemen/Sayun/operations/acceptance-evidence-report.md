...
| Manufacturing schedule rows | 683 |
| Manufacturing material/BOM rows | 10,164 |
| Manufacturing QA verification rows | 683 |
| Construction QA action rows | 636 |
| Maintenance handover schedule rows | 811 |
| Manufacturing rows with material refs | 683 / 683 |
| Manufacturing rows with verification refs | 683 / 683 |
| Manufacturing rows linked to QA actions | 683 / 683 |
