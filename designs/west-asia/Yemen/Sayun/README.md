...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$350 M (88.3%) of external capital** and **$452 M of external interest**. Capital plus saved interest totals **$801 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Onboard battery adequacy | 11.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 327 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 34 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 9.6 MW / 58 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 76 kWh | 131 kWh | 47 kWh | 6.1 km / 33 kWh |
| line-2 | 3 | 29 kWh | 65 kWh | 34 kWh | 2.9 km / 16 kWh |
| line-3 | 3 | 26 kWh | 65 kWh | 37 kWh | 2.8 km / 15 kWh |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 108 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 108 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 9,590 kW @ $700/kW | $6.7 M |
| Grid interconnection / PPA tie-in | 9,590 kW @ $100/kW | $959 k |
...
| Residual train-control wayside + charging microgrids | $2.5 M |
| EPC overhead (7%) | $14 M |
| **CAPEX total** | **$220 M** |
| Per-route-km | $9.0 M / km |
| Per-capita (city pop) | $1,100 / person |
...
| Rolling stock | $30 M | 35% | $11 M | $20 M |
| Dedicated solar plant | $7.7 M | 45% | $3.5 M | $4.2 M |
| Residual signalling / train control | $1.2 M | 50% | $610 k | $610 k |
| Charging microgrids | $1.3 M | 40% | $530 k | $795 k |
| EPC / project services | $14 M | 15% | $2.1 M | $12 M |
| **Total city CAPEX** | **$220 M** | **21.1%** | **$46 M** | **$174 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sayun`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.1%** | **$46 M** | **$4.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.9%** | **$174 M** | **$17 M / yr** |
| of which planned local bond issuance | 63.2% of total CAPEX | $139 M | $14 M / yr |
| **Total city programme** | **100.0%** | **$220 M** | **$22 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $297 M | $251 M (84.4%) | $324 M | **$574 M** |
| **Default** | 2.00× | $396 M | $350 M (88.3%) | $452 M | **$801 M** |
| High | 3.00× | $594 M | $548 M (92.2%) | $707 M | **$1.25 bn** |

At the default 2.00× case, OSR's $46 M external requirement is 88.3% below the illustrative foreign-company requirement of $396 M; the associated lifetime external-interest saving is $452 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$31 M / yr** | $153 |
| Steady-state, low capacity-use (year 11+) | **$22 M / yr** | $110 |
| Steady-state, high capacity-use (year 11+) | **$16 M / yr** | $79 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $140 |
| Lifecycle envelope (yr 1–40, low scenario) | **$965 M cumulative** | $4,826 |
| Lifecycle envelope (yr 1–40, high scenario) | **$777 M cumulative** | $3,887 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.15 bn cumulative** | $5,732 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.0 M / yr → $12 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $46 M | 4.5% | 40 y, 10 y grace | $2.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $139 M | 18.0% | 40 y, 10 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $35 M | — | — | — |
| **Total** | **100%** | **$220 M** | | | **$28 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.1 M / yr + local bonds $25 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (35.8 GWh / yr) | 11,346 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.5 GWh/yr + dedicated solar plant 9.6 MW / 21.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $115 k |
| Labour (215 FTE) | driverless roster: OCC/remote 45, station/platform 55, passenger service 38, fleet maintenance 32, infrastructure/energy 24, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $289 k |
| **OPEX subtotal** | | **$5.0 M / yr** |

_Annual service work: 11,346 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.5 M train-km / yr (8.9 M car-km / yr). On-site PV covers 17.5 GWh/yr and the dedicated solar plant adds 21.0 GWh/yr against 35.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 54 trainsets, 11 stations, 24.4 route-km, 3 lines, and 11,346 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 20.6 M |
| Annual paid trips / city resident | 244 | 391 | 103 |
| Farebox revenue | $10 M / yr | $17 M / yr | $4.4 M / yr |
| Station shop leases | $251 k / yr | $251 k / yr | $251 k / yr |
| Advertising boards | $346 k / yr | $346 k / yr | $346 k / yr |
| **Total revenue** | **$11 M / yr** | **$17 M / yr** | **$5.0 M / yr** |
...
| Operating surplus applied to debt support | -$6.0 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $22 M / yr | $16 M / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.0 M / yr | $12 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,376 m² of station shop/kiosk leases at $10/m²/month and 452 advertising boards at $75/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $174 M | 79% of $220 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $278 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $28 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 45,218 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $212 M |
| Timetable-sized dedicated solar CAPEX | $7.7 M |
| **Reconciled project CAPEX** | **$220 M** |
| Imported / external-capital requirement | $46 M (21.1%) |
| Local-content / local-funding requirement | $174 M (78.9%) |
| Default foreign-turnkey external-capital comparison | $396 M; OSR saves $350 M (88.3%) |
| Lifetime external interest and combined financing saving | $452 M interest; $801 M capital + interest |
| 15%–25% planning risk envelope | $253 M–$275 M |
| Annual OPEX | $5.0 M / yr |
| Low/high project NPV at 8% | $-116115 k / $-83489 k |
| Low/high project IRR | -1.0% / 2.7% |
| Low/high steady-state DSCR | 0.22 / 0.44 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,059.47 train-km; 5,695.20 kWh consumed; 6,066.38 kWh charged; 40 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 10,933.81 train-km; 58,775.05 kWh consumed; 59,843.65 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 78%; 0 onboard emergencies; 0 invariant violations; 96.4% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 74.3% | 96.4% / 90% | pass |
| maximum planning climate/HVAC duty | 74.4% | 96.4% / 90% | pass |
| 50% charging-contact availability | 78.5% | 96.4% / 90% | pass |
| ten-hour all-site grid outage | 20.1% | 95.8% / 60% | pass |
| ten-hour single charging-pad outage | 72.5% | 96.4% / 90% | pass |
