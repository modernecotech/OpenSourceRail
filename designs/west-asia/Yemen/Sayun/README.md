...
|---|---|---|
| Construction (years 1–10) | **$13 M / yr** | $64 |
| Steady-state, low capacity-use (year 11+) | **$5.1 M / yr** | $26 |
| Steady-state, high capacity-use (year 11+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$11 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$280 M cumulative** | $1,401 |
| Lifecycle envelope (yr 1–40, high scenario) | **$127 M cumulative** | $635 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$461 M cumulative** | $2,307 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.0 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $182 M | 4.5% | 40 y, 10 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $45 M | — | — | — |
| **Total** | **100%** | **$227 M** | | | **$11 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $8.2 M / yr = **$8.2 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($4.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Operating surplus applied to debt support | -$6.0 M / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.1 M / yr | $0 k / yr | **$11 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $133 M | 59% of $227 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 34,720 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$227 M** |
| 15%–25% planning risk envelope | $261 M–$284 M |
| Annual OPEX | $5.0 M / yr |
| Low/high project NPV at 8% | $-120768 k / $-88142 k |
