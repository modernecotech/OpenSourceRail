...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$328 M (88.1%) of external capital** and **$423 M of external interest**. Capital plus saved interest totals **$751 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (23.1 km @ $2.58 M/km) | $60 M |
...
| Per-capita (city pop) | $1,033 / person |
...
| **Total city CAPEX** | **$207 M** | **21.5%** | **$44 M** | **$162 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.5%** | **$44 M** | **$4.4 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.5%** | **$162 M** | **$16 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $130 M | $13 M / yr |
| **Total city programme** | **100.0%** | **$207 M** | **$21 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $279 M | $235 M (84.1%) | $303 M | **$538 M** |
| **Default** | 2.00× | $372 M | $328 M (88.1%) | $423 M | **$751 M** |
| High | 3.00× | $558 M | $514 M (92.1%) | $663 M | **$1.18 bn** |

At the default 2.00× case, OSR's $44 M external requirement is 88.1% below the illustrative foreign-company requirement of $372 M; the associated lifetime external-interest saving is $423 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$29 M / yr** | $143 |
| Steady-state, low capacity-use (year 11+) | **$20 M / yr** | $100 |
| Steady-state, high capacity-use (year 11+) | **$14 M / yr** | $69 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $131 |
| Lifecycle envelope (yr 1–40, low scenario) | **$885 M cumulative** | $4,426 |
| Lifecycle envelope (yr 1–40, high scenario) | **$697 M cumulative** | $3,487 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $5,369 |

_Population basis: 200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.3 M / yr → $13 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $44 M | 4.5% | 40 y, 10 y grace | $2.7 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $130 M | 18.0% | 40 y, 10 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $32 M | — | — | — |
| **Total** | **100%** | **$207 M** | | | **$26 M / yr** |
...
| Annual paid trips / city resident | 244 | 391 | 97 |
| Farebox revenue | $10 M / yr | $17 M / yr | $4.1 M / yr |
| Station shop leases | $251 k / yr | $251 k / yr | $251 k / yr |
| Advertising boards | $346 k / yr | $346 k / yr | $346 k / yr |
| **Total revenue** | **$11 M / yr** | **$17 M / yr** | **$4.7 M / yr** |
| Revenue / OPEX recovery | 233% | 365% | 100% |
...
| Operating surplus applied to debt support | -$6.3 M / yr | -$13 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $20 M / yr | $14 M / yr | **$26 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.3 M / yr | $13 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $162 M | 79% of $207 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $260 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $26 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 42,262 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $199 M |
| Timetable-sized dedicated solar CAPEX | $7.7 M |
| **Reconciled project CAPEX** | **$207 M** |
| Imported / external-capital requirement | $44 M (21.5%) |
| Local-content / local-funding requirement | $162 M (78.5%) |
| Default foreign-turnkey external-capital comparison | $372 M; OSR saves $328 M (88.1%) |
| Lifetime external interest and combined financing saving | $423 M interest; $751 M capital + interest |
| 15%–25% planning risk envelope | $238 M–$258 M |
| Annual OPEX | $4.7 M / yr |
| Low/high project NPV at 8% | $-105854 k / $-73228 k |
