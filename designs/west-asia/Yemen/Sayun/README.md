...
|---|---|---|
| Construction (years 1–10) | **$16 M / yr** | $82 |
| Steady-state, low-ridership (year 11+) | **$18 M / yr** | $92 |
| Steady-state, high-ridership (year 11+) | **$18 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $80 |
| Lifecycle envelope (yr 1–40, low scenario) | **$719 M cumulative** | $3,596 |
| Lifecycle envelope (yr 1–40, high scenario) | **$695 M cumulative** | $3,475 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$646 M cumulative** | $3,228 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.5 M / yr → $1.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $127 M | 3.0% | 40 y, 10 y grace | $6.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $53 M | 18.0% | 40 y, 10 y grace | $9.6 M / yr |
| Government equity (no debt service) | 15% | $32 M | — | — | — |
| **Total** | **100%** | **$211 M** | | | **$16 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.8 M / yr + bonds $9.5 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($3.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,735 | 34,559 | 62,697 |
| Daily paid trips / catchment | 18% | 30% | 54% |
| Daily paid trips / city population | 10% | 17% | 31% |
| Annual paid trips | 7.6 M | 12.6 M | 22.9 M |
| Farebox revenue | $1.2 M / yr | $2.0 M / yr | $3.7 M / yr |
| Station shop leases | $291 k / yr | $291 k / yr | $291 k / yr |
| Advertising boards | $398 k / yr | $398 k / yr | $398 k / yr |
| **Total revenue** | **$1.9 M / yr** | **$2.7 M / yr** | **$4.3 M / yr** |
| Revenue / OPEX recovery | 44% | 62% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov commitment | $18 M / yr | $18 M / yr | **$16 M / yr** |
