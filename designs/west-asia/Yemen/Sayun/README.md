...
| Bucket | Value |
|---|---|
| At-grade (20.4 km @ $0.85 M/km) | $17 M |
| Elevated (1.1 km @ $4.0 M/km) | $4.6 M |
...
| EPC integration + project management (7%) | on subtotal | $4.4 M |
...
|---|---|---|
| Construction (years 1–10) | **$5.3 M / yr** | $26 |
| Steady-state, low-ridership (year 11+) | **$5.3 M / yr** | $26 |
| Steady-state, high-ridership (year 11+) | **$4.4 M / yr** | $22 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$211 M cumulative** | $1,053 |
| Lifecycle envelope (yr 1–40, high scenario) | **$186 M cumulative** | $930 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$53 M cumulative** | $265 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $101 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $41 M | 3.0% | 40 y, 10 y grace | $2.1 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $17 M | 18.0% | 40 y, 10 y grace | $3.1 M / yr |
| Government equity (no debt service) | 15% | $10 M | — | — | — |
| **Total** | **100%** | **$68 M** | | | **$5.2 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $1.2 M / yr + bonds $3.1 M / yr = **$4.3 M / yr** total — plus the equity tranche amortised across construction ($1.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $856 k |
...
|---|---|---|---|
| Daily paid trips | 16,000 | 30,000 | 105,963 |
| Daily paid trips / population | 8% | 15% | 53% |
| Annual paid trips | 5.8 M | 10.9 M | 38.7 M |
| Farebox revenue | $934 k / yr | $1.8 M / yr | $6.2 M / yr |
| Station shop leases | $291 k / yr | $291 k / yr | $291 k / yr |
| Advertising boards | $398 k / yr | $398 k / yr | $398 k / yr |
| **Total revenue** | **$1.6 M / yr** | **$2.4 M / yr** | **$6.9 M / yr** |
| Revenue / OPEX + debt-service recovery | 24% | 35% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $5.3 M / yr | $4.4 M / yr | **$0 / yr** |
