...
| Bucket | Value |
|---|---|
| At-grade (20.4 km @ €3.5 M/km) | €71 M |
| Elevated (1.1 km @ €18 M/km) | €21 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 31 | €2.0 M | €62 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 21.5 km × €0.015 M/km | €0.3 M |
...
|---|---|---|
| Construction (years 1–10) | **€21 M / yr** | €106 |
| Steady-state, low-ridership (year 11+) | **€27 M / yr** | €133 |
| Steady-state, high-ridership (year 11+) | **€26 M / yr** | €131 |
| Lifecycle envelope (yr 1–40, low scenario) | **€1.01 bn cumulative** | €5,060 |
| Lifecycle envelope (yr 1–40, high scenario) | **€999 M cumulative** | €4,993 |

_Population basis: 200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€5.9 M / yr (low) → €5.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €164 M | 3.0% | 40 y, 10 y grace | €8.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €68 M | 18.0% | 40 y, 10 y grace | €12 M / yr |
| Government equity (no debt service) | 15% | €41 M | — | — | — |
| **Total** | **100%** | **€273 M** | | | **€21 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €4.9 M / yr + bonds €12 M / yr = **€17 M / yr** total — plus the equity tranche amortised across construction (€4.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (141 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €174 k |
...
| Farebox revenue | €448 k / yr | €895 k / yr |
| Farebox / OPEX recovery | 7% | 14% |
| Country policy-target recovery (diagnostic) | 25% | 25% |
| Operating shortfall (gov subsidy required) | €5.9 M / yr | €5.5 M / yr |
