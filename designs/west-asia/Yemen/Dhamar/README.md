...
|---|---|---|
| Construction (years 1–10) | **$6.5 M / yr** | $22 |
| Steady-state, low-ridership (year 11+) | **$6.4 M / yr** | $21 |
| Steady-state, high-ridership (year 11+) | **$5.2 M / yr** | $17 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$256 M cumulative** | $854 |
| Lifecycle envelope (yr 1–40, high scenario) | **$219 M cumulative** | $731 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$65 M cumulative** | $216 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $59 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $21 M | 18.0% | 40 y, 10 y grace | $3.8 M / yr |
