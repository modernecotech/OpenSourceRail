...
| Lifecycle envelope (yr 1–40, low scenario) | **$282 M cumulative** | $941 |
| Lifecycle envelope (yr 1–40, high scenario) | **$127 M cumulative** | $423 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$460 M cumulative** | $1,534 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $5.9 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $181 M | 4.5% | 40 y, 10 y grace | $11 M / yr |
| Government equity (no debt service) | 20% | $45 M | — | — | — |
| **Total** | **100%** | **$226 M** | | | **$11 M / yr** |
...
| Operating surplus applied to debt support | -$5.9 M / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $5.2 M / yr | $0 k / yr | **$11 M / yr** |
...
| Construction employment supported | 34,294 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $216 M |
...
| Low/high project NPV at 8% | $-120980 k / $-88354 k |
| Low/high project IRR | -1.2% / 2.5% |
