...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 32.3 km × $0.015 M/km | $485 k |
...
| Steady-state, low-ridership (year 11+) | **$8.0 M / yr** | $27 |
| Steady-state, high-ridership (year 11+) | **$6.8 M / yr** | $23 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$318 M cumulative** | $1,061 |
| Lifecycle envelope (yr 1–40, high scenario) | **$282 M cumulative** | $939 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$78 M cumulative** | $261 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $381 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $60 M | 3.0% | 40 y, 10 y grace | $3.1 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $25 M | 18.0% | 40 y, 10 y grace | $4.5 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$100 M** | | | **$7.6 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $1.8 M / yr + bonds $4.5 M / yr = **$6.3 M / yr** total — plus the equity tranche amortised across construction ($1.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 161,046 |
| Daily paid trips / population | 8% | 15% | 54% |
| Annual paid trips | 8.8 M | 16.4 M | 58.8 M |
| Farebox revenue | $1.4 M / yr | $2.6 M / yr | $9.4 M / yr |
| Station shop leases | $329 k / yr | $329 k / yr | $329 k / yr |
| Advertising boards | $459 k / yr | $459 k / yr | $459 k / yr |
| **Total revenue** | **$2.2 M / yr** | **$3.4 M / yr** | **$10 M / yr** |
| Revenue / OPEX + debt-service recovery | 21% | 34% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $8.0 M / yr | $6.8 M / yr | **$0 / yr** |
