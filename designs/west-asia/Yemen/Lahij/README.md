...
| Revenue fleet | 81 × 2-car trainsets |
| Revenue fleet passenger capacity | 19,440 AW2 pax (25,920 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 10.4 km | 7 | 32 | S Mid ↔ N Outer |
| line-2 |  8.2 km | 6 | 27 | N Mid ↔ S Mid |
| line-3 | 10.3 km | 6 | 31 | SE Outer ↔ NW Mid |
| **Total** | **28.9 km** | **19 unique** | **90** | |
...
| Revenue fleet capacity | 19,440 AW2 pax (25,920 AW3 crush) |
| Total fleet capacity | 21,600 AW2 pax (28,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 81 × 240 = **19,440 AW2 passengers** (25,920 AW3 crush)
- **Total fleet passenger capacity:** 90 × 240 = **21,600 AW2 passengers** (28,800 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 24.5× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 345 kWh usable margin across the worst powered-stop gap (line-3) |
...
| On-site PV shortfall before solar plant | 54 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 10.3 MW / 62 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 56 kWh | 139 kWh | 78 kWh | 2.1 km / 11 kWh |
| line-2 | 6 | 44 kWh | 114 kWh | 66 kWh | 2.3 km / 12 kWh |
| line-3 | 6 | 56 kWh | 114 kWh | 53 kWh | 2.7 km / 15 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (27.5 km @ $3.0 M/km) | $82 M |
| Elevated (1.5 km @ $12.0 M/km) | $17 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 90 | $560 k | $50 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 180 | $60 k | $11 M |
| High sensitivity check | 180 | $120 k | $22 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 10,317 kW @ $700/kW | $7.2 M |
| Grid interconnection / PPA tie-in | 10,317 kW @ $100/kW | $1.0 M |
| Annual generation proxy | 10.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 22.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$8.3 M** |
...
|---|---|---|
| Construction (years 1–10) | **$19 M / yr** | $75 |
| Steady-state, low capacity-use (year 11+) | **$12 M / yr** | $50 |
| Steady-state, high capacity-use (year 11+) | **$6.2 M / yr** | $25 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$560 M cumulative** | $2,240 |
| Lifecycle envelope (yr 1–40, high scenario) | **$372 M cumulative** | $1,489 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$682 M cumulative** | $2,728 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.1 M / yr → $10 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $268 M | 4.5% | 40 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $67 M | — | — | — |
| **Total** | **100%** | **$335 M** | | | **$16 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $12 M / yr = **$12 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (42.4 GWh / yr) | 13,452 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 22.8 GWh/yr + dedicated solar plant 10.3 MW / 22.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $124 k |
| Labour (297 FTE) | driverless roster: OCC/remote 65, station/platform 98, passenger service 38, fleet maintenance 45, infrastructure/energy 30, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $399 k |
| **OPEX subtotal** | | **$7.4 M / yr** |

_Annual service work: 13,452 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.3 M train-km / yr (10.6 M car-km / yr). On-site PV covers 22.8 GWh/yr and the dedicated solar plant adds 22.6 GWh/yr against 42.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 90 trainsets, 19 stations, 28.9 route-km, 3 lines, and 13,452 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 29.8 M |
| Annual paid trips / city resident | 196 | 313 | 119 |
| Farebox revenue | $10 M / yr | $17 M / yr | $6.4 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $606 k / yr | $606 k / yr | $606 k / yr |
| **Total revenue** | **$11 M / yr** | **$18 M / yr** | **$7.4 M / yr** |
| Revenue / OPEX recovery | 155% | 239% | 100% |
...
| Operating surplus applied to debt support | -$4.1 M / yr | -$10 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $6.2 M / yr | **$16 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.1 M / yr | $10 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,328 m² of station shop/kiosk leases at $10/m²/month and 792 advertising boards at $75/board/month, with occupancy derates applied._
...
| Commerce | 14 major/terminal/interchange nodes | 31,788 trips/trading day; 10.5 M access-events/yr | 50,861 trips/trading day; 16.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $196 M | 58% of $335 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 51,052 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $8.3 M |
| **Reconciled project CAPEX** | **$335 M** |
| 15%–25% planning risk envelope | $386 M–$419 M |
| Annual OPEX | $7.4 M / yr |
| Low/high project NPV at 8% | $-203850 k / $-171224 k |
| Low/high project IRR | -4.6% / -0.4% |
| Low/high steady-state DSCR | 0.25 / 0.63 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,291.99 train-km; 6,945.21 kWh consumed; 7,583.47 kWh charged; 37 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 13,992.64 train-km; 75,218.44 kWh consumed; 77,158.97 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 89%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 87.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 81.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 79.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 2 interchange complexes, 27 civil segments, and 0 input findings |
