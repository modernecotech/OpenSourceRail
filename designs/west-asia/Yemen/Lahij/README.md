...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **20,525 – 30,787 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (26.1 km @ $0.85 M/km) | $22 M |
| Elevated (2.3 km @ $4.0 M/km) | $9.3 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 29.0 km × $0.015 M/km | $434 k |
...
|---|---|---|
| Construction (years 1–10) | **$7.4 M / yr** | $30 |
| Steady-state, low-ridership (year 11+) | **$7.6 M / yr** | $30 |
| Steady-state, high-ridership (year 11+) | **$6.5 M / yr** | $26 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$301 M cumulative** | $1,203 |
| Lifecycle envelope (yr 1–40, high scenario) | **$270 M cumulative** | $1,080 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$74 M cumulative** | $297 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $336 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $57 M | 3.0% | 40 y, 10 y grace | $2.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $24 M | 18.0% | 40 y, 10 y grace | $4.3 M / yr |
| Government equity (no debt service) | 15% | $14 M | — | — | — |
| **Total** | **100%** | **$95 M** | | | **$7.2 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $1.7 M / yr + bonds $4.3 M / yr = **$6.0 M / yr** total — plus the equity tranche amortised across construction ($1.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 149,321 |
| Daily paid trips / population | 8% | 15% | 60% |
| Annual paid trips | 7.3 M | 13.7 M | 54.5 M |
| Farebox revenue | $1.2 M / yr | $2.2 M / yr | $8.7 M / yr |
| Station shop leases | $379 k / yr | $379 k / yr | $379 k / yr |
| Advertising boards | $520 k / yr | $520 k / yr | $520 k / yr |
| **Total revenue** | **$2.1 M / yr** | **$3.1 M / yr** | **$9.6 M / yr** |
| Revenue / OPEX + debt-service recovery | 21% | 32% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $7.6 M / yr | $6.5 M / yr | **$0 / yr** |
