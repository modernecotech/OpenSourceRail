...
| Bucket | Value |
|---|---|
| At-grade (26.1 km @ €3.5 M/km) | €91 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 29.0 km × €0.015 M/km | €0.4 M |
...
| Per-capita (city pop) | €1,621 / person |
...
|---|---|---|
| Construction (years 1–10) | **€32 M / yr** | €126 |
| Steady-state, low-ridership (year 11+) | **€40 M / yr** | €158 |
| Steady-state, high-ridership (year 11+) | **€39 M / yr** | €156 |
| Lifecycle envelope (yr 1–40, low scenario) | **€1.50 bn cumulative** | €6,016 |
| Lifecycle envelope (yr 1–40, high scenario) | **€1.49 bn cumulative** | €5,949 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€8.8 M / yr (low) → €8.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €243 M | 3.0% | 40 y, 10 y grace | €12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €101 M | 18.0% | 40 y, 10 y grace | €18 M / yr |
| Government equity (no debt service) | 15% | €61 M | — | — | — |
| **Total** | **100%** | **€405 M** | | | **€31 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €7.3 M / yr + bonds €18 M / yr = **€26 M / yr** total — plus the equity tranche amortised across construction (€6.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (186 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €230 k |
...
| Farebox revenue | €560 k / yr | €1.1 M / yr |
| Farebox / OPEX recovery | 6% | 12% |
| Country policy-target recovery (diagnostic) | 25% | 25% |
| Operating shortfall (gov subsidy required) | €8.8 M / yr | €8.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€40 M / yr** | **€39 M / yr** |
