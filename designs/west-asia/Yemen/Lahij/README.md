...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 118 | $60 k | $7.1 M |
| High sensitivity check | 118 | $120 k | $14 M |
...
| Depots | $8.0 M |
| Rolling stock | $33 M |
| Railway production plant | $7.1 M |
...
| Steady-state, low capacity-use (year 11+) | **$11 M / yr** | $44 |
| Steady-state, high capacity-use (year 11+) | **$4.7 M / yr** | $19 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$505 M cumulative** | $2,021 |
| Lifecycle envelope (yr 1–40, high scenario) | **$318 M cumulative** | $1,270 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$642 M cumulative** | $2,568 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $253 M | 4.5% | 40 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 20% | $63 M | — | — | — |
| **Total** | **100%** | **$316 M** | | | **$16 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $4.7 M / yr | **$16 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $187 M | 59% of $316 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 48,791 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $306 M |
...
| Low/high project NPV at 8% | $-188101 k / $-155475 k |
