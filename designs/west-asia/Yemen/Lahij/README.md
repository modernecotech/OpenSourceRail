...
|---|---|---|
| Construction (years 1–10) | **$32 M / yr** | $127 |
| Steady-state, low-ridership (year 11+) | **$38 M / yr** | $151 |
| Steady-state, high-ridership (year 11+) | **$36 M / yr** | $145 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $124 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.45 bn cumulative** | $5,800 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.41 bn cumulative** | $5,627 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.24 bn cumulative** | $4,974 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.9 M / yr → $5.4 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $244 M | 3.0% | 40 y, 10 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $102 M | 18.0% | 40 y, 10 y grace | $18 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$31 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 36,945 | 61,575 | 154,777 |
| Daily paid trips / catchment | 18% | 30% | 75% |
| Daily paid trips / city population | 15% | 25% | 62% |
| Annual paid trips | 13.5 M | 22.5 M | 56.5 M |
| Farebox revenue | $2.2 M / yr | $3.6 M / yr | $9.0 M / yr |
| Station shop leases | $379 k / yr | $379 k / yr | $379 k / yr |
| Advertising boards | $520 k / yr | $520 k / yr | $520 k / yr |
| **Total revenue** | **$3.1 M / yr** | **$4.5 M / yr** | **$9.9 M / yr** |
| Revenue / OPEX recovery | 31% | 45% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Gov debt service + residual OPEX subsidy | $38 M / yr | $36 M / yr | **$31 M / yr** |
