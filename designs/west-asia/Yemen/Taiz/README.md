...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **60,663 – 101,106 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (46.8 km @ $2.0 M/km) | $94 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.0 km × $0.015 M/km | $2.4 M |
...
|---|---|---|
| Construction (years 1–10) | **$21 M / yr** | $34 |
| Steady-state, low-ridership (year 11+) | **$21 M / yr** | $35 |
| Steady-state, high-ridership (year 11+) | **$20 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $33 |
| Lifecycle envelope (yr 1–40, low scenario) | **$852 M cumulative** | $1,386 |
| Lifecycle envelope (yr 1–40, high scenario) | **$820 M cumulative** | $1,333 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$820 M cumulative** | $1,333 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $161 M | 3.0% | 40 y, 10 y grace | $8.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $67 M | 18.0% | 40 y, 10 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $40 M | — | — | — |
| **Total** | **100%** | **$268 M** | | | **$20 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $4.8 M / yr + bonds $12 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($4.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 60,663 | 101,106 | 78,982 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 10% | 16% | 13% |
| Annual paid trips | 22.1 M | 36.9 M | 28.8 M |
| Farebox revenue | $3.5 M / yr | $5.9 M / yr | $4.6 M / yr |
| Station shop leases | $594 k / yr | $594 k / yr | $594 k / yr |
| Advertising boards | $814 k / yr | $814 k / yr | $814 k / yr |
| **Total revenue** | **$5.0 M / yr** | **$7.3 M / yr** | **$6.0 M / yr** |
| Revenue / OPEX recovery | 82% | 121% | 100% |
