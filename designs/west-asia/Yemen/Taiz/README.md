...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **60,663 – 101,106 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$20 M / yr** | $32 |
| Steady-state, high-ridership (year 11+) | **$16 M / yr** | $26 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$797 M cumulative** | $1,296 |
| Lifecycle envelope (yr 1–40, high scenario) | **$689 M cumulative** | $1,120 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$209 M cumulative** | $340 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 92,250 | 153,750 | 427,630 |
| Daily paid trips / population | 15% | 25% | 70% |
| Annual paid trips | 33.7 M | 56.1 M | 156.1 M |
| Farebox revenue | $5.4 M / yr | $9.0 M / yr | $25 M / yr |
| Station shop leases | $594 k / yr | $594 k / yr | $594 k / yr |
| Advertising boards | $814 k / yr | $814 k / yr | $814 k / yr |
| **Total revenue** | **$6.8 M / yr** | **$10 M / yr** | **$26 M / yr** |
| Revenue / OPEX + debt-service recovery | 26% | 39% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $20 M / yr | $16 M / yr | **$0 / yr** |
