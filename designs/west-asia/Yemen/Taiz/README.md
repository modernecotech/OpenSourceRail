...
|---|---|---|
| Construction (years 1–10) | **$49 M / yr** | $80 |
| Steady-state, low-ridership (year 11+) | **$59 M / yr** | $96 |
| Steady-state, high-ridership (year 11+) | **$57 M / yr** | $92 |
| Steady-state, operating-neutral revenue case | **$48 M / yr** | $78 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.27 bn cumulative** | $3,694 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.20 bn cumulative** | $3,579 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.94 bn cumulative** | $3,154 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $11 M / yr → $8.7 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $381 M | 3.0% | 40 y, 10 y grace | $19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $159 M | 18.0% | 40 y, 10 y grace | $29 M / yr |
| Government equity (no debt service) | 15% | $95 M | — | — | — |
| **Total** | **100%** | **$634 M** | | | **$48 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $29 M / yr = **$40 M / yr** total — plus the equity tranche amortised across construction ($9.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 60,663 | 101,106 | 250,318 |
| Daily paid trips / catchment | 18% | 30% | 74% |
| Daily paid trips / city population | 10% | 16% | 41% |
| Annual paid trips | 22.1 M | 36.9 M | 91.4 M |
| Farebox revenue | $3.5 M / yr | $5.9 M / yr | $15 M / yr |
| Station shop leases | $594 k / yr | $594 k / yr | $594 k / yr |
| Advertising boards | $814 k / yr | $814 k / yr | $814 k / yr |
| **Total revenue** | **$5.0 M / yr** | **$7.3 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 31% | 46% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Gov debt service + residual OPEX subsidy | $59 M / yr | $57 M / yr | **$48 M / yr** |
