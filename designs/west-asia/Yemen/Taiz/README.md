...
|---|---|---|---|---|
| line-1 | 18.2 km | 10 | 48 | E Outer ↔ W Mid |
| line-2 |  8.7 km | 6 | 23 | NW Mid ↔ NE Mid |
| line-3 | 15.9 km | 9 | 42 | SW Outer ↔ N Mid |
| **Total** | **42.8 km** | **25 unique** | **113** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **34.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 497 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 45 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 72 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 186 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 34.5 MW / 214 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 131 kWh | 229 kWh | 85 kWh | 5.5 km / 40 kWh |
| line-2 | 6 | 63 kWh | 114 kWh | 45 kWh | 2.1 km / 15 kWh |
| line-3 | 8 | 114 kWh | 196 kWh | 70 kWh | 6.0 km / 43 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 34,493 kW @ $700/kW | $24 M |
| Grid interconnection / PPA tie-in | 34,493 kW @ $100/kW | $3.4 M |
| Annual generation proxy | 34.5 MW × 6.2 peak-sun-h/day × 365 d/yr | 78.1 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$26 M / yr** | $42 |
| Steady-state, low capacity-use (year 11+) | **$16 M / yr** | $27 |
| Steady-state, high capacity-use (year 11+) | **$7.0 M / yr** | $11 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$749 M cumulative** | $1,217 |
| Lifecycle envelope (yr 1–40, high scenario) | **$467 M cumulative** | $759 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$933 M cumulative** | $1,516 |
...
| Traction energy (94.1 GWh / yr) | 19,898 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.3 GWh/yr + dedicated solar plant 34.5 MW / 78.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $414 k |
| Labour (345 FTE) | driverless roster: OCC/remote 73, station/platform 100, passenger service 49, fleet maintenance 61, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $464 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 19,898 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.5 M car-km / yr). On-site PV covers 26.3 GWh/yr and the dedicated solar plant adds 78.1 GWh/yr against 94.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 113 trainsets, 25 stations, 42.8 route-km, 3 lines, and 19,898 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $7.0 M / yr | **$23 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.1 M / yr | $16 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,264 m² of station shop/kiosk leases at $10/m²/month and 808 advertising boards at $75/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $259 M | 57% of $459 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 67,506 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-275760 k / $-226821 k |
| Low/high project IRR | -4.2% / 0.1% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,728.14 train-km; 12,441.79 kWh consumed; 13,102.94 kWh charged; 32 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,605.17 train-km; 148,347.80 kWh consumed; 151,517.44 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 41%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 27.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 21.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 41.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.9% / 60% | pass |
| ten-hour single charging-pad outage | 33.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
