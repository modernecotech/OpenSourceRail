...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.0 km × €0.015 M/km | €0.7 M |
...
| Depots | €40 M |
| Rolling stock | €153 M |
| Residual train-control wayside + power | €40 M |
| EPC overhead (7%) | €39 M |
| **CAPEX total** | **€598 M** |
...
|---|---|---|
| Construction (years 1–10) | **€47 M / yr** | €76 |
| Steady-state, low-ridership (year 11+) | **€58 M / yr** | €94 |
| Steady-state, high-ridership (year 11+) | **€57 M / yr** | €92 |
| Lifecycle envelope (yr 1–40, low scenario) | **€2.20 bn cumulative** | €3,584 |
| Lifecycle envelope (yr 1–40, high scenario) | **€2.16 bn cumulative** | €3,517 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €11 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €359 M | 3.0% | 40 y, 10 y grace | €18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €150 M | 18.0% | 40 y, 10 y grace | €27 M / yr |
| Government equity (no debt service) | 15% | €90 M | — | — | — |
| **Total** | **100%** | **€598 M** | | | **€45 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €11 M / yr + bonds €27 M / yr = **€38 M / yr** total — plus the equity tranche amortised across construction (€9.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€58 M / yr** | **€57 M / yr** |
