...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$560 M (86.7%) of external capital** and **$724 M of external interest**. Capital plus saved interest totals **$1.28 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 84 × 3-car trainsets |
| Revenue fleet passenger capacity | 30,240 AW2 pax (40,320 AW3 crush) |
...
| Revenue fleet capacity | 30,240 AW2 pax (40,320 AW3 crush) |
| Total fleet capacity | 33,840 AW2 pax (45,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 84 × 360 = **30,240 AW2 passengers** (40,320 AW3 crush)
- **Total fleet passenger capacity:** 94 × 360 = **33,840 AW2 passengers** (45,120 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 65.3%
- Catchment population: **≈ 401,595** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 10.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 489 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 19,898 train-km/day | One-way train journeys × route length |
| Annual service work | 7.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 258 MWh/day | 23.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 197 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 36.6 MW / 227 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 131 kWh | 229 kWh | 85 kWh | 7.0 km / 50 kWh |
| line-2 | 5 | 63 kWh | 110 kWh | 41 kWh | 2.3 km / 17 kWh |
| line-3 | 5 | 114 kWh | 184 kWh | 58 kWh | 7.0 km / 51 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (41.6 km @ $2.58 M/km) | $108 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 94 | $900 k | $85 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 282 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 282 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 36,563 kW @ $700/kW | $26 M |
| Grid interconnection / PPA tie-in | 36,563 kW @ $100/kW | $3.7 M |
| Annual generation proxy | 36.6 MW × 6.2 peak-sun-h/day × 365 d/yr | 82.7 GWh/yr |
...
| Per-capita (city pop) | $584 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $123 M | 15% | $19 M | $105 M |
| Stations | $88 M | 20% | $18 M | $70 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $85 M | 35% | $30 M | $55 M |
...
| EPC / project services | $22 M | 15% | $3.2 M | $18 M |
| **Total city CAPEX** | **$359 M** | **23.9%** | **$86 M** | **$273 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh taiz`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.9%** | **$86 M** | **$8.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.1%** | **$273 M** | **$27 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $218 M | $22 M / yr |
| **Total city programme** | **100.0%** | **$359 M** | **$36 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $485 M | $399 M (82.3%) | $515 M | **$914 M** |
| **Default** | 2.00× | $646 M | $560 M (86.7%) | $724 M | **$1.28 bn** |
| High | 3.00× | $969 M | $883 M (91.1%) | $1.14 bn | **$2.02 bn** |

At the default 2.00× case, OSR's $86 M external requirement is 86.7% below the illustrative foreign-company requirement of $646 M; the associated lifetime external-interest saving is $724 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$49 M / yr** | $79 |
| Steady-state, low capacity-use (year 11+) | **$37 M / yr** | $60 |
| Steady-state, high capacity-use (year 11+) | **$28 M / yr** | $45 |
| Steady-state, operating-neutral revenue case | **$45 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.60 bn cumulative** | $2,605 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.32 bn cumulative** | $2,147 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.83 bn cumulative** | $2,980 |

_Population basis: 615,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.7 M / yr → $17 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $86 M | 4.5% | 40 y, 10 y grace | $5.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $218 M | 18.0% | 40 y, 10 y grace | $40 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $55 M | — | — | — |
| **Total** | **100%** | **$359 M** | | | **$45 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.9 M / yr + local bonds $39 M / yr = **$43 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (94.1 GWh / yr) | 19,898 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.2 GWh/yr + dedicated solar plant 36.6 MW / 82.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $439 k |
| Labour (301 FTE) | driverless roster: OCC/remote 65, station/platform 72, passenger service 49, fleet maintenance 55, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $405 k |
| **OPEX subtotal** | | **$8.7 M / yr** |

_Annual service work: 19,898 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.5 M car-km / yr). On-site PV covers 22.2 GWh/yr and the dedicated solar plant adds 82.7 GWh/yr against 94.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 94 trainsets, 18 stations, 42.8 route-km, 3 lines, and 19,898 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 37.3 M |
| Annual paid trips / city resident | 119 | 191 | 61 |
| Farebox revenue | $16 M / yr | $25 M / yr | $7.9 M / yr |
| Station shop leases | $324 k / yr | $324 k / yr | $324 k / yr |
| Advertising boards | $453 k / yr | $453 k / yr | $453 k / yr |
| **Total revenue** | **$16 M / yr** | **$26 M / yr** | **$8.7 M / yr** |
| Revenue / OPEX recovery | 188% | 296% | 100% |
...
| Operating surplus applied to debt support | -$7.7 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $37 M / yr | $28 M / yr | **$45 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.7 M / yr | $17 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,072 m² of station shop/kiosk leases at $10/m²/month and 592 advertising boards at $75/board/month, with occupancy derates applied._
...
| Avoided road congestion | $11 M / yr | $18 M / yr | 141 M - 226 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.0 M / yr | $3.3 M / yr | 25.4–40.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $273 M | 76% of $359 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 71,108 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $330 M |
| Timetable-sized dedicated solar CAPEX | $29 M |
| **Reconciled project CAPEX** | **$359 M** |
| Imported / external-capital requirement | $86 M (23.9%) |
| Local-content / local-funding requirement | $273 M (76.1%) |
| Default foreign-turnkey external-capital comparison | $646 M; OSR saves $560 M (86.7%) |
| Lifetime external interest and combined financing saving | $724 M interest; $1.28 bn capital + interest |
| 15%–25% planning risk envelope | $413 M–$449 M |
| Annual OPEX | $8.7 M / yr |
| Low/high project NPV at 8% | $-200799 k / $-151860 k |
| Low/high project IRR | -2.1% / 1.9% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,724.63 train-km; 12,416.47 kWh consumed; 11,998.71 kWh charged; 34 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,454.51 train-km; 140,062.51 kWh consumed; 141,090.90 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 26%; 0 onboard emergencies; 0 invariant violations; 97.8% of scheduled train-km delivered; 4 SoC warnings |
...
| maximum planning climate/HVAC duty | 20.0% | 97.1% / 90% | pass |
| 50% charging-contact availability | 26.2% | 97.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 89.0% / 60% | pass |
| ten-hour single charging-pad outage | 26.2% | 97.8% / 90% | pass |
...
|---|---|
| ![Taiz energy and battery simulation dashboard](engineering/screenshots/taiz-simulation-dashboard.png) | ![Taiz simulator network visualizer](engineering/screenshots/taiz-network-visualizer.png) |
...
|---|---|
| ![Taiz QGIS engineering layers](engineering/screenshots/taiz-qgis-engineering-map.png) | ![Taiz SUMO timetable validation](engineering/screenshots/taiz-sumo-validation.png) |
...
scripts/regenerate-city.sh taiz
```
