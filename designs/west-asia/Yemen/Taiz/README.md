...
|---|---|---|
| Construction (years 1–10) | **$34 M / yr** | $55 |
| Steady-state, low-ridership (year 11+) | **$37 M / yr** | $60 |
| Steady-state, high-ridership (year 11+) | **$35 M / yr** | $56 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $53 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.45 bn cumulative** | $2,352 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.38 bn cumulative** | $2,237 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.32 bn cumulative** | $2,150 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.1 M / yr → $1.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $259 M | 3.0% | 40 y, 10 y grace | $13 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $108 M | 18.0% | 40 y, 10 y grace | $20 M / yr |
| Government equity (no debt service) | 15% | $65 M | — | — | — |
| **Total** | **100%** | **$432 M** | | | **$33 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $7.8 M / yr + bonds $19 M / yr = **$27 M / yr** total — plus the equity tranche amortised across construction ($6.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 60,663 | 101,106 | 131,563 |
| Daily paid trips / catchment | 18% | 30% | 39% |
| Daily paid trips / city population | 10% | 16% | 21% |
| Annual paid trips | 22.1 M | 36.9 M | 48.0 M |
| Farebox revenue | $3.5 M / yr | $5.9 M / yr | $7.7 M / yr |
| Station shop leases | $594 k / yr | $594 k / yr | $594 k / yr |
| Advertising boards | $814 k / yr | $814 k / yr | $814 k / yr |
| **Total revenue** | **$5.0 M / yr** | **$7.3 M / yr** | **$9.1 M / yr** |
