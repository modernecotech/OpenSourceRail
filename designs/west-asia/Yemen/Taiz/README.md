...
| Bucket | Value |
|---|---|
| At-grade (46.8 km @ €3.5 M/km) | €164 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 51 | €2.0 M | €102 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 49.0 km × €0.1 M/km | €4.9 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 49.0 km × €0.8 M/km | €39 M |
...
|---|---|---|
| Construction (years 1–10) | **€43 M / yr** | €70 |
| Steady-state, low-ridership (year 11+) | **€52 M / yr** | €85 |
| Steady-state, high-ridership (year 11+) | **€51 M / yr** | €83 |
| Lifecycle envelope (yr 1–40, low scenario) | **€2.00 bn cumulative** | €3,245 |
| Lifecycle envelope (yr 1–40, high scenario) | **€1.95 bn cumulative** | €3,178 |

_Population basis: 615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€11 M / yr (low) → €9.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €329 M | 3.0% | 40 y, 10 y grace | €17 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €137 M | 18.0% | 40 y, 10 y grace | €25 M / yr |
| Government equity (no debt service) | 15% | €82 M | — | — | — |
| **Total** | **100%** | **€548 M** | | | **€42 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €9.9 M / yr + bonds €25 M / yr = **€35 M / yr** total — plus the equity tranche amortised across construction (€8.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €245 k |
| Traction energy (90.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (306 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €378 k |
...
|---|---|---|
| Annual paid trips | 11.2 M | 22.4 M |
| Farebox revenue | €1.4 M / yr | €2.8 M / yr |
| Farebox / OPEX recovery | 11% | 23% |
| Country policy-target recovery (diagnostic) | 25% | 25% |
| Operating shortfall (gov subsidy required) | €11 M / yr | €9.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€52 M / yr** | **€51 M / yr** |
