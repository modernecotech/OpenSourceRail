...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$639 M (86.7%) of external capital** and **$825 M of external interest**. Capital plus saved interest totals **$1.46 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`ibb.corridor.geojson`](ibb.corridor.geojson).
...
| Total fleet capacity | 38,160 AW2 pax (50,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 95 × 360 = **34,200 AW2 passengers** (45,600 AW3 crush)
- **Total fleet passenger capacity:** 106 × 360 = **38,160 AW2 passengers** (50,880 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 74.1%
- Catchment population: **≈ 555,750** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **44.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 474 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 55 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 61 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 23,202 train-km/day | One-way train journeys × route length |
| Annual service work | 9.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 301 MWh/day | 27.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 240 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 44.5 MW / 276 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 105 kWh | 172 kWh | 56 kWh | 5.9 km / 43 kWh |
| line-2 | 6 | 156 kWh | 245 kWh | 74 kWh | 9.1 km / 66 kWh |
| line-3 | 5 | 98 kWh | 163 kWh | 55 kWh | 4.8 km / 35 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (48.1 km @ $2.58 M/km) | $124 M |
| Elevated (1.8 km @ $9.75 M/km) | $18 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$146 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 106 | $900 k | $95 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 318 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 318 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 44,503 kW @ $700/kW | $31 M |
| Grid interconnection / PPA tie-in | 44,503 kW @ $100/kW | $4.5 M |
| Annual generation proxy | 44.5 MW × 6.2 peak-sun-h/day × 365 d/yr | 100.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.9 km × $0.050 M/km | $2.5 M |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ibb`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$98 M** | **$9.8 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$311 M** | **$31 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $249 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$409 M** | **$41 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $553 M | $454 M (82.3%) | $587 M | **$1.04 bn** |
| **Default** | 2.00× | $737 M | $639 M (86.7%) | $825 M | **$1.46 bn** |
| High | 3.00× | $1.11 bn | $1.01 bn (91.1%) | $1.30 bn | **$2.31 bn** |

At the default 2.00× case, OSR's $98 M external requirement is 86.7% below the illustrative foreign-company requirement of $737 M; the associated lifetime external-interest saving is $825 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$55 M / yr** | $74 |
| Steady-state, low capacity-use (year 11+) | **$45 M / yr** | $59 |
| Steady-state, high capacity-use (year 11+) | **$35 M / yr** | $47 |
| Steady-state, operating-neutral revenue case | **$51 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.89 bn cumulative** | $2,521 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.61 bn cumulative** | $2,145 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.09 bn cumulative** | $2,785 |

_Population basis: 750,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.6 M / yr → $16 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $98 M | 4.5% | 40 y, 10 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $249 M | 18.0% | 40 y, 10 y grace | $45 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $62 M | — | — | — |
| **Total** | **100%** | **$409 M** | | | **$51 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.4 M / yr + local bonds $45 M / yr = **$49 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (109.8 GWh / yr) | 23,202 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.2 GWh/yr + dedicated solar plant 44.5 MW / 100.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $534 k |
| Labour (330 FTE) | driverless roster: OCC/remote 69, station/platform 85, passenger service 49, fleet maintenance 63, infrastructure/energy 43, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $444 k |
| **OPEX subtotal** | | **$9.9 M / yr** |

_Annual service work: 23,202 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.1 M train-km / yr (27.4 M car-km / yr). On-site PV covers 22.2 GWh/yr and the dedicated solar plant adds 100.7 GWh/yr against 109.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 106 trainsets, 18 stations, 49.9 route-km, 3 lines, and 23,202 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 42.3 M |
| Annual paid trips / city resident | 98 | 156 | 56 |
| Farebox revenue | $16 M / yr | $25 M / yr | $9.0 M / yr |
| Station shop leases | $375 k / yr | $375 k / yr | $375 k / yr |
| Advertising boards | $508 k / yr | $508 k / yr | $508 k / yr |
| **Total revenue** | **$17 M / yr** | **$26 M / yr** | **$9.9 M / yr** |
...
| Operating surplus applied to debt support | -$6.6 M / yr | -$16 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $45 M / yr | $35 M / yr | **$51 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.6 M / yr | $16 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,552 m² of station shop/kiosk leases at $10/m²/month and 664 advertising boards at $75/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $21 M / yr | 165 M - 263 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.4 M / yr | $3.8 M / yr | 29.6–47.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.6 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $26 M / yr | $41 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $12 M / yr | $19 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$64 M / yr** | **$103 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 3 healthcare anchors | 17,115 trips/day; 6.2 M access-events/yr | 27,384 trips/day; 10.0 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 47,374 trips/trading day; 15.6 M access-events/yr | 75,799 trips/trading day; 25.0 M access-events/yr |
...
| Construction-phase local economic activity | $498 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $50 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 81,046 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $98 M (24.0%) |
| Local-content / local-funding requirement | $311 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $737 M; OSR saves $639 M (86.7%) |
| Lifetime external interest and combined financing saving | $825 M interest; $1.46 bn capital + interest |
| 15%–25% planning risk envelope | $471 M–$512 M |
| Annual OPEX | $9.9 M / yr |
| Low/high project NPV at 8% | $-240114 k / $-191175 k |
| Low/high project IRR | -3.4% / 0.8% |
| Low/high steady-state DSCR | 0.13 / 0.31 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,931.26 train-km; 13,904.06 kWh consumed; 12,943.04 kWh charged; 32 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,918.05 train-km; 157,798.46 kWh consumed; 155,567.18 kWh charged; 497 depot services completed (6 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 94.5% of scheduled train-km delivered; 7 SoC warnings; 2 energy-adapted off-peak departures, maximum 13 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 21.8% | 94.4% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 93.4% / 90% | pass |
| 50% charging-contact availability | 21.2% | 94.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 86.6% / 60% | pass |
| ten-hour single charging-pad outage | 21.2% | 94.5% / 90% | pass |
...
|---|---|
| ![Ibb energy and battery simulation dashboard](engineering/screenshots/ibb-simulation-dashboard.png) | ![Ibb simulator network visualizer](engineering/screenshots/ibb-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 18 line platforms, 2 interchange complexes, 49 civil segments, and 0 input findings |
...
|---|---|
| ![Ibb QGIS engineering layers](engineering/screenshots/ibb-qgis-engineering-map.png) | ![Ibb SUMO timetable validation](engineering/screenshots/ibb-sumo-validation.png) |
...
| [`ibb.toml`](ibb.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`ibb-network-map.png`](ibb-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`ibb.corridor.geojson`](ibb.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`ibb.stations.json`](ibb.stations.json) | Machine-readable station list |
| [`ibb.design-quality.yaml`](ibb.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
