...
|---|---|---|---|---|
| line-1 | 14.6 km | 9 | 38 | NE Inner ↔ SW Mid |
| line-2 | 21.6 km | 10 | 57 | S Inner ↔ NW Outer |
| line-3 | 13.6 km | 8 | 35 | S Mid ↔ NE Mid |
| **Total** | **49.9 km** | **27 unique** | **130** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **41.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 483 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 64 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 78 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 41.4 MW / 257 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 105 kWh | 192 kWh | 76 kWh | 2.5 km / 18 kWh |
| line-2 | 9 | 156 kWh | 261 kWh | 90 kWh | 8.0 km / 57 kWh |
| line-3 | 8 | 98 kWh | 172 kWh | 64 kWh | 2.3 km / 17 kWh |
...
| Elevated (0.7 km @ $12.0 M/km) | $8.3 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 390 | $60 k | $23 M |
| High sensitivity check | 390 | $120 k | $47 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 41,398 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 41,398 kW @ $100/kW | $4.1 M |
| Annual generation proxy | 41.4 MW × 6.2 peak-sun-h/day × 365 d/yr | 93.7 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ibb`.
...
|---|---|---|
| Construction (years 1–10) | **$27 M / yr** | $35 |
| Steady-state, low capacity-use (year 11+) | **$18 M / yr** | $24 |
| Steady-state, high capacity-use (year 11+) | **$8.4 M / yr** | $11 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $31 |
| Lifecycle envelope (yr 1–40, low scenario) | **$799 M cumulative** | $1,065 |
| Lifecycle envelope (yr 1–40, high scenario) | **$517 M cumulative** | $690 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$964 M cumulative** | $1,285 |

_Population basis: 750,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $5.5 M / yr → $15 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $379 M | 4.5% | 40 y, 10 y grace | $23 M / yr |
| Government equity (no debt service) | 20% | $95 M | — | — | — |
| **Total** | **100%** | **$474 M** | | | **$23 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $17 M / yr = **$17 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (109.8 GWh / yr) | 23,202 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.3 GWh/yr + dedicated solar plant 41.4 MW / 93.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $497 k |
| Labour (362 FTE) | driverless roster: OCC/remote 81, station/platform 95, passenger service 49, fleet maintenance 70, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $487 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 23,202 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.1 M train-km / yr (27.4 M car-km / yr). On-site PV covers 28.3 GWh/yr and the dedicated solar plant adds 93.7 GWh/yr against 109.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 130 trainsets, 27 stations, 49.9 route-km, 3 lines, and 23,202 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 47.5 M |
| Annual paid trips / city resident | 98 | 156 | 63 |
| Farebox revenue | $16 M / yr | $25 M / yr | $10 M / yr |
| Station shop leases | $405 k / yr | $405 k / yr | $405 k / yr |
| Advertising boards | $575 k / yr | $575 k / yr | $575 k / yr |
| **Total revenue** | **$17 M / yr** | **$26 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 149% | 234% | 100% |
...
| Operating surplus applied to debt support | -$5.5 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $8.4 M / yr | **$23 M / yr** |
| Operating surplus after OPEX (before debt support) | $5.5 M / yr | $15 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,832 m² of station shop/kiosk leases at $10/m²/month and 752 advertising boards at $75/board/month, with occupancy derates applied._
...
| Healthcare | 3 healthcare anchors | 15,428 trips/day; 5.6 M access-events/yr | 24,684 trips/day; 9.0 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 42,296 trips/trading day; 14.0 M access-events/yr | 67,674 trips/trading day; 22.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $265 M | 56% of $474 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 69,127 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$474 M** |
| 15%–25% planning risk envelope | $545 M–$593 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-289451 k / $-240512 k |
| Low/high project IRR | -4.8% / -0.3% |
| Low/high steady-state DSCR | 0.24 / 0.64 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,933.96 train-km; 13,923.65 kWh consumed; 14,595.04 kWh charged; 29 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,448.03 train-km; 168,814.94 kWh consumed; 171,604.88 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 69%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 62.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 46.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 69.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.6% / 60% | pass |
| ten-hour single charging-pad outage | 53.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 49 civil segments, and 0 input findings |
