...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 318 | $60 k | $19 M |
| High sensitivity check | 318 | $120 k | $38 M |
...
| Per-capita (city pop) | $607 / person |
...
|---|---|---|
| Construction (years 1–10) | **$26 M / yr** | $34 |
| Steady-state, low capacity-use (year 11+) | **$16 M / yr** | $22 |
| Steady-state, high capacity-use (year 11+) | **$6.8 M / yr** | $9 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$742 M cumulative** | $989 |
| Lifecycle envelope (yr 1–40, high scenario) | **$460 M cumulative** | $614 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$926 M cumulative** | $1,235 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $364 M | 4.5% | 40 y, 10 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $91 M | — | — | — |
| **Total** | **100%** | **$455 M** | | | **$22 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $16 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($9.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $6.8 M / yr | **$22 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $257 M | 56% of $455 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 66,925 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $420 M |
| Timetable-sized dedicated solar CAPEX | $36 M |
| **Reconciled project CAPEX** | **$455 M** |
| 15%–25% planning risk envelope | $524 M–$569 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-273598 k / $-224659 k |
| Low/high project IRR | -4.1% / 0.1% |
| Low/high steady-state DSCR | 0.27 / 0.69 |
