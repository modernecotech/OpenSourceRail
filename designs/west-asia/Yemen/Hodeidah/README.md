...
| Per-capita (city pop) | $485 / person |
...
|---|---|---|
| Construction (years 1–10) | **$28 M / yr** | $38 |
| Steady-state, low-ridership (year 11+) | **$29 M / yr** | $39 |
| Steady-state, high-ridership (year 11+) | **$28 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.15 bn cumulative** | $1,539 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.11 bn cumulative** | $1,484 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $1,484 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.4 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $218 M | 3.0% | 40 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $91 M | 18.0% | 40 y, 10 y grace | $16 M / yr |
