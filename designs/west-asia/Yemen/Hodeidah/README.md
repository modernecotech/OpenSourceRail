...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 40 | €3.0 M | €120 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 36.2 km × €0.015 M/km | €0.5 M |
...
|---|---|---|
| Construction (years 1–10) | **€37 M / yr** | €49 |
| Steady-state, low-ridership (year 11+) | **€46 M / yr** | €61 |
| Steady-state, high-ridership (year 11+) | **€44 M / yr** | €59 |
| Lifecycle envelope (yr 1–40, low scenario) | **€1.74 bn cumulative** | €2,317 |
| Lifecycle envelope (yr 1–40, high scenario) | **€1.69 bn cumulative** | €2,250 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€9.7 M / yr (low) → €8.0 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €284 M | 3.0% | 40 y, 10 y grace | €15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €118 M | 18.0% | 40 y, 10 y grace | €21 M / yr |
| Government equity (no debt service) | 15% | €71 M | — | — | — |
| **Total** | **100%** | **€474 M** | | | **€36 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €8.5 M / yr + bonds €21 M / yr = **€30 M / yr** total — plus the equity tranche amortised across construction (€7.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (229 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €283 k |
...
| Operating shortfall (gov subsidy required) | €9.7 M / yr | €8.0 M / yr |
