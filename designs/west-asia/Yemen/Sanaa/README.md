...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **552,825 – 921,375 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$113 M / yr** | $29 |
| Steady-state, high-ridership (year 11+) | **$90 M / yr** | $23 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.59 bn cumulative** | $1,165 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.90 bn cumulative** | $990 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$1.20 bn cumulative** | $304 |

_Population basis: 3,937,500 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
