...
| Residual train-control wayside + power | €212 M |
...
|---|---|---|
| Construction (years 1–10) | **€294 M / yr** | €75 |
| Steady-state, low-ridership (year 11+) | **€372 M / yr** | €94 |
| Steady-state, high-ridership (year 11+) | **€363 M / yr** | €92 |
| Lifecycle envelope (yr 1–40, low scenario) | **€14.09 bn cumulative** | €3,579 |
| Lifecycle envelope (yr 1–40, high scenario) | **€13.83 bn cumulative** | €3,512 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.26 bn | 3.0% | 40 y, 10 y grace | €115 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €942 M | 18.0% | 40 y, 10 y grace | €171 M / yr |
| Government equity (no debt service) | 15% | €565 M | — | — | — |
| **Total** | **100%** | **€3.77 bn** | | | **€286 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €68 M / yr + bonds €170 M / yr = **€237 M / yr** total — plus the equity tranche amortised across construction (€57 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€372 M / yr** | **€363 M / yr** |
