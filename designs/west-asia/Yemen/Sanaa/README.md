...
_Population basis: 3,937,500 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $93 M / yr → $45 M / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $214 M / yr | $166 M / yr | **$121 M / yr** |
