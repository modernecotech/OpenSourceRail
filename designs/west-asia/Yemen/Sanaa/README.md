...
|---|---|---|
| Construction (years 1–10) | **$185 M / yr** | $47 |
| Steady-state, low-ridership (year 11+) | **$195 M / yr** | $49 |
| Steady-state, high-ridership (year 11+) | **$180 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$180 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$7.69 bn cumulative** | $1,954 |
| Lifecycle envelope (yr 1–40, high scenario) | **$7.26 bn cumulative** | $1,845 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.26 bn cumulative** | $1,845 |

_Population basis: 3,937,500 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.43 bn | 3.0% | 40 y, 10 y grace | $73 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $594 M | 18.0% | 40 y, 10 y grace | $108 M / yr |
| Government equity (no debt service) | 15% | $356 M | — | — | — |
| **Total** | **100%** | **$2.38 bn** | | | **$180 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $43 M / yr + bonds $107 M / yr = **$150 M / yr** total — plus the equity tranche amortised across construction ($36 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
