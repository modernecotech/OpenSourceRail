# Sanaa Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,237 |
| Manufacturing schedule rows | 4,487 |
| Manufacturing material/BOM rows | 63,909 |
| Manufacturing QA verification rows | 4,487 |
| Construction QA action rows | 4,100 |
| Maintenance handover schedule rows | 5,424 |
| Manufacturing rows with material refs | 4,487 / 4,487 |
| Manufacturing rows with verification refs | 4,487 / 4,487 |
| Manufacturing rows linked to QA actions | 4,487 / 4,487 |
...
|---|---:|
| `project_kit` | 8,451 |
| `rolling_stock_bom` | 52,140 |
| `rolling_stock_cots_fitout` | 3,318 |
...
| `qa-11-bogie-wheelset` | 474 |
| `qa-12-traction-brake-battery` | 474 |
| `qa-13-passenger-systems` | 474 |
| `qa-15-first-article-trainset` | 474 |
| `qa-20-survey-geotech` | 133 |
| `qa-21-earthworks-drainage` | 133 |
| `qa-22-trackform-rail` | 301 |
| `qa-24-stations-depots-plant` | 282 |
| `qa-25-power-energy` | 247 |
