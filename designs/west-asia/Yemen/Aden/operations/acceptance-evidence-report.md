# Aden Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,070 |
| Manufacturing material/BOM rows | 15,781 |
| Manufacturing QA verification rows | 1,070 |
| Construction QA action rows | 989 |
| Maintenance handover schedule rows | 1,279 |
| Manufacturing rows with material refs | 1,070 / 1,070 |
| Manufacturing rows with verification refs | 1,070 / 1,070 |
| Manufacturing rows linked to QA actions | 1,070 / 1,070 |
