...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$626 M (87.0%) of external capital** and **$809 M of external interest**. Capital plus saved interest totals **$1.44 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 45.8 km |
| Revenue fleet | 87 × 3-car trainsets |
| Revenue fleet passenger capacity | 31,320 AW2 pax (41,760 AW3 crush) |
...
| Revenue fleet capacity | 31,320 AW2 pax (41,760 AW3 crush) |
| Total fleet capacity | 34,920 AW2 pax (46,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 87 × 360 = **31,320 AW2 passengers** (41,760 AW3 crush)
- **Total fleet passenger capacity:** 97 × 360 = **34,920 AW2 passengers** (46,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 72.0%
- Catchment population: **≈ 709,200** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 9.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 484 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 21,316 train-km/day | One-way train journeys × route length |
| Annual service work | 8.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 276 MWh/day | 25.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 217 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 41.7 MW / 250 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 133 kWh | 196 kWh | 49 kWh | 7.0 km / 56 kWh |
| line-2 | 5 | 115 kWh | 163 kWh | 37 kWh | 5.2 km / 42 kWh |
| line-3 | 6 | 122 kWh | 172 kWh | 38 kWh | 6.2 km / 50 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 97 | $900 k | $87 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 291 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 291 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 41,679 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 41,679 kW @ $100/kW | $4.2 M |
| Annual generation proxy | 41.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 91.3 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 45.8 km × $0.050 M/km | $2.3 M |
...
|---|---:|---:|---:|---:|
| Civil works | $156 M | 15% | $23 M | $132 M |
| Stations | $88 M | 20% | $18 M | $70 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $87 M | 35% | $31 M | $57 M |
...
| **Total city CAPEX** | **$400 M** | **23.5%** | **$94 M** | **$306 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh aden`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.5%** | **$94 M** | **$9.4 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.5%** | **$306 M** | **$31 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $245 M | $25 M / yr |
| **Total city programme** | **100.0%** | **$400 M** | **$40 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $540 M | $446 M (82.6%) | $577 M | **$1.02 bn** |
| **Default** | 2.00× | $720 M | $626 M (87.0%) | $809 M | **$1.44 bn** |
| High | 3.00× | $1.08 bn | $987 M (91.3%) | $1.27 bn | **$2.26 bn** |

At the default 2.00× case, OSR's $94 M external requirement is 87.0% below the illustrative foreign-company requirement of $720 M; the associated lifetime external-interest saving is $809 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$54 M / yr** | $55 |
| Steady-state, low capacity-use (year 11+) | **$43 M / yr** | $44 |
| Steady-state, high capacity-use (year 11+) | **$34 M / yr** | $34 |
| Steady-state, operating-neutral revenue case | **$50 M / yr** | $51 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.84 bn cumulative** | $1,872 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.56 bn cumulative** | $1,586 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.05 bn cumulative** | $2,081 |

_Population basis: 985,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.9 M / yr → $16 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $94 M | 4.5% | 40 y, 10 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $245 M | 18.0% | 40 y, 10 y grace | $44 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$400 M** | | | **$50 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.2 M / yr + local bonds $44 M / yr = **$48 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (100.8 GWh / yr) | 21,316 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 41.7 MW / 91.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $500 k |
| Labour (304 FTE) | driverless roster: OCC/remote 65, station/platform 71, passenger service 49, fleet maintenance 58, infrastructure/energy 40, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $409 k |
| **OPEX subtotal** | | **$9.5 M / yr** |

_Annual service work: 21,316 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.2 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 91.3 GWh/yr against 100.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 97 trainsets, 17 stations, 45.8 route-km, 3 lines, and 21,316 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 41.1 M |
| Annual paid trips / city resident | 74 | 119 | 42 |
| Farebox revenue | $16 M / yr | $25 M / yr | $8.8 M / yr |
| Station shop leases | $324 k / yr | $324 k / yr | $324 k / yr |
| Advertising boards | $450 k / yr | $450 k / yr | $450 k / yr |
| **Total revenue** | **$16 M / yr** | **$26 M / yr** | **$9.5 M / yr** |
...
| Operating surplus applied to debt support | -$6.9 M / yr | -$16 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $43 M / yr | $34 M / yr | **$50 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.9 M / yr | $16 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,064 m² of station shop/kiosk leases at $10/m²/month and 588 advertising boards at $75/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$62 M / yr** | **$98 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $306 M | 77% of $400 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $490 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $49 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 79,757 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $367 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$400 M** |
| Imported / external-capital requirement | $94 M (23.5%) |
| Local-content / local-funding requirement | $306 M (76.5%) |
| Default foreign-turnkey external-capital comparison | $720 M; OSR saves $626 M (87.0%) |
| Lifetime external interest and combined financing saving | $809 M interest; $1.44 bn capital + interest |
| 15%–25% planning risk envelope | $460 M–$500 M |
| Annual OPEX | $9.5 M / yr |
| Low/high project NPV at 8% | $-232716 k / $-183777 k |
| Low/high project IRR | -3.1% / 1.0% |
| Low/high steady-state DSCR | 0.14 / 0.32 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,805.15 train-km; 14,558.19 kWh consumed; 13,331.55 kWh charged; 32 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,964.14 train-km; 161,005.26 kWh consumed; 161,559.10 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 93.7% of scheduled train-km delivered; 10 SoC warnings; 2 energy-adapted off-peak departures, maximum 13 min headway |
...
| 50% charging-contact availability | 21.1% | 93.7% / 90% | pass |
...
|---|---|
| ![Aden energy and battery simulation dashboard](engineering/screenshots/aden-simulation-dashboard.png) | ![Aden simulator network visualizer](engineering/screenshots/aden-network-visualizer.png) |
...
|---|---|
| ![Aden QGIS engineering layers](engineering/screenshots/aden-qgis-engineering-map.png) | ![Aden SUMO timetable validation](engineering/screenshots/aden-sumo-validation.png) |
