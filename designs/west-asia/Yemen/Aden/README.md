...
|---|---|---|---|---|
| line-1 | 16.5 km | 11 | 43 | NW Outer ↔ S Mid |
| line-2 | 14.2 km | 9 | 37 | NE Mid ↔ SW Outer |
| line-3 | 15.1 km | 9 | 39 | N Outer ↔ SE Outer |
| **Total** | **45.8 km** | **29 unique** | **119** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **37.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 28.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 521 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 58 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 196 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 37.5 MW / 225 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 133 kWh | 241 kWh | 94 kWh | 2.0 km / 16 kWh |
| line-2 | 9 | 115 kWh | 192 kWh | 66 kWh | 2.0 km / 16 kWh |
| line-3 | 9 | 122 kWh | 192 kWh | 58 kWh | 2.4 km / 19 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 37,539 kW @ $700/kW | $26 M |
| Grid interconnection / PPA tie-in | 37,539 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 37.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 82.2 GWh/yr |
...
| Per-capita (city pop) | $488 / person |
...
| Steady-state, low capacity-use (year 11+) | **$18 M / yr** | $18 |
| Steady-state, high capacity-use (year 11+) | **$8.6 M / yr** | $9 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $24 |
| Lifecycle envelope (yr 1–40, low scenario) | **$808 M cumulative** | $820 |
| Lifecycle envelope (yr 1–40, high scenario) | **$526 M cumulative** | $534 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$978 M cumulative** | $993 |
...
| Traction energy (100.8 GWh / yr) | 21,316 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.3 GWh/yr + dedicated solar plant 37.5 MW / 82.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $450 k |
| Labour (357 FTE) | driverless roster: OCC/remote 77, station/platform 102, passenger service 49, fleet maintenance 64, infrastructure/energy 44, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $480 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 21,316 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.2 M car-km / yr). On-site PV covers 29.3 GWh/yr and the dedicated solar plant adds 82.2 GWh/yr against 100.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 119 trainsets, 29 stations, 45.8 route-km, 3 lines, and 21,316 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 46.8 M |
| Annual paid trips / city resident | 74 | 119 | 47 |
| Farebox revenue | $16 M / yr | $25 M / yr | $10.0 M / yr |
| Station shop leases | $455 k / yr | $455 k / yr | $455 k / yr |
| Advertising boards | $643 k / yr | $643 k / yr | $643 k / yr |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $8.6 M / yr | **$24 M / yr** |
| Operating surplus after OPEX (before debt support) | $5.7 M / yr | $15 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,312 m² of station shop/kiosk leases at $10/m²/month and 840 advertising boards at $75/board/month, with occupancy derates applied._
...
| Commerce | 14 major/terminal/interchange nodes | 42,323 trips/trading day; 14.0 M access-events/yr | 67,717 trips/trading day; 22.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $272 M | 56% of $481 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 70,720 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-293101 k / $-244162 k |
| Low/high project IRR | -4.7% / -0.3% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,818.75 train-km; 14,667.71 kWh consumed; 15,552.52 kWh charged; 29 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,053.65 train-km; 177,856.16 kWh consumed; 181,415.60 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 71%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 64.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 57.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 70.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.0% / 60% | pass |
| ten-hour single charging-pad outage | 52.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 29 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
