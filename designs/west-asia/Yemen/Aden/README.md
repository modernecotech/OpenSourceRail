...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$588 M (86.7%) of external capital** and **$759 M of external interest**. Capital plus saved interest totals **$1.35 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $134 M | 15% | $20 M | $114 M |
...
| **Total city CAPEX** | **$377 M** | **24.0%** | **$90 M** | **$286 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$90 M** | **$9.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$286 M** | **$29 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $229 M | $23 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $509 M | $418 M (82.2%) | $540 M | **$958 M** |
| **Default** | 2.00× | $678 M | $588 M (86.7%) | $759 M | **$1.35 bn** |
| High | 3.00× | $1.02 bn | $927 M (91.1%) | $1.20 bn | **$2.12 bn** |

At the default 2.00× case, OSR's $90 M external requirement is 86.7% below the illustrative foreign-company requirement of $678 M; the associated lifetime external-interest saving is $759 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$51 M / yr** | $52 |
| Steady-state, low capacity-use (year 11+) | **$40 M / yr** | $40 |
| Steady-state, high capacity-use (year 11+) | **$30 M / yr** | $31 |
| Steady-state, operating-neutral revenue case | **$47 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.70 bn cumulative** | $1,729 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.42 bn cumulative** | $1,443 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.92 bn cumulative** | $1,952 |
...
| Annual paid trips / city resident | 74 | 119 | 40 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $40 M / yr | $30 M / yr | **$47 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $286 M | 76% of $377 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 74,572 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $343 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$377 M** |
| Imported / external-capital requirement | $90 M (24.0%) |
| Local-content / local-funding requirement | $286 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $678 M; OSR saves $588 M (86.7%) |
| Lifetime external interest and combined financing saving | $759 M interest; $1.35 bn capital + interest |
| 15%–25% planning risk envelope | $433 M–$471 M |
| Annual OPEX | $9.1 M / yr |
| Low/high project NPV at 8% | $-214713 k / $-165774 k |
| Low/high project IRR | -2.6% / 1.5% |
| Low/high steady-state DSCR | 0.16 / 0.35 |
