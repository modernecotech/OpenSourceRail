...
| Bucket | Value |
|---|---|
| At-grade (41.9 km @ $0.85 M/km) | $36 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 44.4 km × $0.015 M/km | $665 k |
...
| Per-capita (city pop) | $129 / person |
...
|---|---|---|
| Construction (years 1–10) | **$9.9 M / yr** | $10 |
| Steady-state, low-ridership (year 11+) | **$7.3 M / yr** | $7 |
| Steady-state, high-ridership (year 11+) | **$3.3 M / yr** | $3 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$318 M cumulative** | $323 |
| Lifecycle envelope (yr 1–40, high scenario) | **$197 M cumulative** | $200 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$99 M cumulative** | $101 |

_Population basis: 985,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $76 M | 3.0% | 40 y, 10 y grace | $3.9 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $32 M | 18.0% | 40 y, 10 y grace | $5.8 M / yr |
| Government equity (no debt service) | 15% | $19 M | — | — | — |
| **Total** | **100%** | **$127 M** | | | **$9.6 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.3 M / yr + bonds $5.7 M / yr = **$8.0 M / yr** total — plus the equity tranche amortised across construction ($1.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $33 k |
...
|---|---|---|---|
| Daily paid trips | 78,800 | 147,750 | 203,627 |
| Daily paid trips / population | 8% | 15% | 21% |
| Annual paid trips | 28.8 M | 53.9 M | 74.3 M |
| Farebox revenue | $4.6 M / yr | $8.6 M / yr | $12 M / yr |
| Station shop leases | $476 k / yr | $476 k / yr | $476 k / yr |
| Advertising boards | $661 k / yr | $661 k / yr | $661 k / yr |
| **Total revenue** | **$5.7 M / yr** | **$9.8 M / yr** | **$13 M / yr** |
| Revenue / OPEX + debt-service recovery | 44% | 75% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $7.3 M / yr | $3.3 M / yr | **$0 / yr** |
