...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 44.4 km × €0.1 M/km | €4.4 M |
...
|---|---|---|
| Construction (years 1–10) | **€39 M / yr** | €40 |
| Steady-state, low-ridership (year 11+) | **€47 M / yr** | €47 |
| Steady-state, high-ridership (year 11+) | **€45 M / yr** | €45 |
| Lifecycle envelope (yr 1–40, low scenario) | **€1.79 bn cumulative** | €1,818 |
| Lifecycle envelope (yr 1–40, high scenario) | **€1.72 bn cumulative** | €1,751 |

_Population basis: 985,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€8.7 M / yr (low) → €6.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €300 M | 3.0% | 40 y, 10 y grace | €15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €125 M | 18.0% | 40 y, 10 y grace | €23 M / yr |
| Government equity (no debt service) | 15% | €75 M | — | — | — |
| **Total** | **100%** | **€500 M** | | | **€38 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €9.0 M / yr + bonds €22 M / yr = **€31 M / yr** total — plus the equity tranche amortised across construction (€7.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €221 k |
...
| Operating shortfall (gov subsidy required) | €8.7 M / yr | €6.5 M / yr |
