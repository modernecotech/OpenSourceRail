...
| Steady-state, low-ridership (year 11+) | **$31 M / yr** | $32 |
| Steady-state, high-ridership (year 11+) | **$29 M / yr** | $29 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $29 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.23 bn cumulative** | $1,251 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.16 bn cumulative** | $1,177 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.16 bn cumulative** | $1,177 |

_Population basis: 985,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.4 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $227 M | 3.0% | 40 y, 10 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $95 M | 18.0% | 40 y, 10 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$379 M** | | | **$29 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.8 M / yr + bonds $17 M / yr = **$24 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 76,061 | 126,769 | 117,898 |
| Daily paid trips / catchment | 18% | 30% | 28% |
| Daily paid trips / city population | 8% | 13% | 12% |
| Annual paid trips | 27.8 M | 46.3 M | 43.0 M |
| Farebox revenue | $4.4 M / yr | $7.4 M / yr | $6.9 M / yr |
| Station shop leases | $476 k / yr | $476 k / yr | $476 k / yr |
| Advertising boards | $661 k / yr | $661 k / yr | $661 k / yr |
| **Total revenue** | **$5.6 M / yr** | **$8.5 M / yr** | **$8.0 M / yr** |
| Revenue / OPEX recovery | 70% | 106% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov commitment | $31 M / yr | $29 M / yr | **$29 M / yr** |
