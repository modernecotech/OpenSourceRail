...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$762 M (86.3%) of external capital** and **$984 M of external interest**. Capital plus saved interest totals **$1.75 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 62.8% |
| Route length (double track) | 61.6 km |
| Revenue fleet | 137 × 3-car trainsets |
| Revenue fleet passenger capacity | 49,320 AW2 pax (65,760 AW3 crush) |
...
| Revenue fleet capacity | 49,320 AW2 pax (65,760 AW3 crush) |
| Total fleet capacity | 54,720 AW2 pax (72,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 137 × 360 = **49,320 AW2 passengers** (65,760 AW3 crush)
- **Total fleet passenger capacity:** 152 × 360 = **54,720 AW2 passengers** (72,960 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 62.8%
- Catchment population: **≈ 345,400** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **59.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 460 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 50 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 61 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 28,649 train-km/day | One-way train journeys × route length |
| Annual service work | 11.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 371 MWh/day | 33.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 311 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 59.5 MW / 357 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 155 kWh | 229 kWh | 58 kWh | 6.7 km / 54 kWh |
| line-2 | 4 | 133 kWh | 196 kWh | 50 kWh | 9.9 km / 80 kWh |
| line-3 | 7 | 209 kWh | 314 kWh | 84 kWh | 9.7 km / 79 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (61.1 km @ $3.0 M/km) | $183 M |
| Elevated (0.5 km @ $12.0 M/km) | $6.1 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 152 | $900 k | $137 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 456 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 456 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 59,549 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 59,549 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 59.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 130.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 61.6 km × $0.050 M/km | $3.1 M |
...
| Per-capita (city pop) | $892 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $189 M | 15% | $28 M | $161 M |
| Stations | $75 M | 20% | $15 M | $60 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $137 M | 35% | $48 M | $89 M |
| Dedicated solar plant | $48 M | 45% | $21 M | $26 M |
| Residual signalling / train control | $3.1 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $1.9 M | 40% | $780 k | $1.2 M |
| EPC / project services | $29 M | 15% | $4.3 M | $25 M |
| **Total city CAPEX** | **$491 M** | **24.7%** | **$121 M** | **$369 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mukalla`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$121 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$369 M** | **$37 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $296 M | $30 M / yr |
| **Total city programme** | **100.0%** | **$491 M** | **$49 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $663 M | $541 M (81.7%) | $699 M | **$1.24 bn** |
| **Default** | 2.00× | $883 M | $762 M (86.3%) | $984 M | **$1.75 bn** |
| High | 3.00× | $1.33 bn | $1.20 bn (90.8%) | $1.55 bn | **$2.76 bn** |

At the default 2.00× case, OSR's $121 M external requirement is 86.3% below the illustrative foreign-company requirement of $883 M; the associated lifetime external-interest saving is $984 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$66 M / yr** | $120 |
| Steady-state, low capacity-use (year 11+) | **$57 M / yr** | $104 |
| Steady-state, high capacity-use (year 11+) | **$48 M / yr** | $86 |
| Steady-state, operating-neutral revenue case | **$61 M / yr** | $111 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.37 bn cumulative** | $4,307 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.09 bn cumulative** | $3,795 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.49 bn cumulative** | $4,529 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.1 M / yr → $13 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $121 M | 4.5% | 40 y, 10 y grace | $7.5 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $296 M | 18.0% | 40 y, 10 y grace | $54 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$491 M** | | | **$61 M / yr** |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $154 k |
| Traction energy (135.5 GWh / yr) | 28,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.1 GWh/yr + dedicated solar plant 59.5 MW / 130.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $715 k |
| Labour (371 FTE) | driverless roster: OCC/remote 94, station/platform 71, passenger service 49, fleet maintenance 84, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $499 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 28,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.3 M train-km / yr (33.9 M car-km / yr). On-site PV covers 22.1 GWh/yr and the dedicated solar plant adds 130.4 GWh/yr against 135.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 152 trainsets, 22 stations, 61.6 route-km, 3 lines, and 28,649 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 54.2 M |
| Annual paid trips / city resident | 133 | 213 | 99 |
| Farebox revenue | $16 M / yr | $25 M / yr | $12 M / yr |
| Station shop leases | $291 k / yr | $291 k / yr | $291 k / yr |
| Advertising boards | $425 k / yr | $425 k / yr | $425 k / yr |
| **Total revenue** | **$16 M / yr** | **$26 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 133% | 210% | 100% |
...
| Operating surplus applied to debt support | -$4.1 M / yr | -$13 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $57 M / yr | $48 M / yr | **$61 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.1 M / yr | $13 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,760 m² of station shop/kiosk leases at $10/m²/month and 556 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $4.5 M / yr | $7.2 M / yr | 16 min/trip × $0.23/h value-of-time proxy |
| Avoided road congestion | $16 M / yr | $26 M / yr | 203 M - 325 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.7 M / yr | 36.6–58.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Healthcare | 2 healthcare anchors | 15,428 trips/day; 5.6 M access-events/yr | 24,684 trips/day; 9.0 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 41,728 trips/trading day; 13.8 M access-events/yr | 66,765 trips/trading day; 22.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $369 M | 75% of $491 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 96,197 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $443 M |
| Timetable-sized dedicated solar CAPEX | $48 M |
| **Reconciled project CAPEX** | **$491 M** |
| Imported / external-capital requirement | $121 M (24.7%) |
| Local-content / local-funding requirement | $369 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $883 M; OSR saves $762 M (86.3%) |
| Lifetime external interest and combined financing saving | $984 M interest; $1.75 bn capital + interest |
| 15%–25% planning risk envelope | $564 M–$613 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-308073 k / $-259134 k |
| Low/high project IRR | -6.1% / -1.0% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,268.42 train-km; 18,294.22 kWh consumed; 14,005.39 kWh charged; 27 depot services completed; minimum SoC 54%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,894.13 train-km; 216,887.78 kWh consumed; 190,870.38 kWh charged; 478 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 93.9% of scheduled train-km delivered; 187 SoC warnings; 30 energy-adapted off-peak departures, maximum 28 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 93.2% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 89.8% / 90% | pass |
| 50% charging-contact availability | 20.0% | 93.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.5% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 93.0% / 90% | pass |
...
|---|---|
| ![Mukalla energy and battery simulation dashboard](engineering/screenshots/mukalla-simulation-dashboard.png) | ![Mukalla simulator network visualizer](engineering/screenshots/mukalla-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 27 civil segments, and 0 input findings |
...
|---|---|
| ![Mukalla QGIS engineering layers](engineering/screenshots/mukalla-qgis-engineering-map.png) | ![Mukalla SUMO timetable validation](engineering/screenshots/mukalla-sumo-validation.png) |
...
scripts/regenerate-city.sh mukalla
```
