...
|---|---|---|
| Construction (years 1–10) | **$37 M / yr** | $67 |
| Steady-state, low-ridership (year 11+) | **$40 M / yr** | $73 |
| Steady-state, high-ridership (year 11+) | **$38 M / yr** | $68 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $65 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.58 bn cumulative** | $2,865 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.49 bn cumulative** | $2,714 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.44 bn cumulative** | $2,613 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $1.9 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $282 M | 3.0% | 40 y, 10 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $117 M | 18.0% | 40 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $70 M | — | — | — |
| **Total** | **100%** | **$470 M** | | | **$36 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $8.5 M / yr + bonds $21 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($7.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 71,280 | 118,800 | 150,520 |
| Daily paid trips / catchment | 18% | 30% | 38% |
| Daily paid trips / city population | 13% | 22% | 27% |
| Annual paid trips | 26.0 M | 43.4 M | 54.9 M |
| Farebox revenue | $4.2 M / yr | $6.9 M / yr | $8.8 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $750 k / yr | $750 k / yr | $750 k / yr |
| **Total revenue** | **$5.5 M / yr** | **$8.2 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 54% | 82% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov commitment | $40 M / yr | $38 M / yr | **$36 M / yr** |
