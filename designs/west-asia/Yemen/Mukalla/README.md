...
|---|---|---|
| Construction (years 1–10) | **$28 M / yr** | $52 |
| Steady-state, low-ridership (year 11+) | **$30 M / yr** | $55 |
| Steady-state, high-ridership (year 11+) | **$28 M / yr** | $50 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $50 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.19 bn cumulative** | $2,171 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.11 bn cumulative** | $2,026 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $2,026 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $219 M | 3.0% | 40 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $91 M | 18.0% | 40 y, 10 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $55 M | — | — | — |
| **Total** | **100%** | **$364 M** | | | **$28 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.6 M / yr + bonds $16 M / yr = **$23 M / yr** total — plus the equity tranche amortised across construction ($5.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Operating surplus after OPEX | $0 k / yr | $120 k / yr | $0 / yr |
