...
| Revenue fleet | 143 × 3-car trainsets |
| Revenue fleet passenger capacity | 51,480 AW2 pax (68,640 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 19.2 km | 12 | 48 | SW Mid ↔ NE Mid |
| line-2 | 16.5 km | 8 | 45 | E Mid ↔ SW Outer |
| line-3 | 26.0 km | 15 | 67 | NE Outer ↔ SW Mid |
| **Total** | **61.6 km** | **35 unique** | **160** | |
...
| Revenue fleet capacity | 51,480 AW2 pax (68,640 AW3 crush) |
| Total fleet capacity | 57,600 AW2 pax (76,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 143 × 360 = **51,480 AW2 passengers** (68,640 AW3 crush)
- **Total fleet passenger capacity:** 160 × 360 = **57,600 AW2 passengers** (76,800 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **55.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 473 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 289 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 55.4 MW / 332 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 155 kWh | 233 kWh | 63 kWh | 3.7 km / 30 kWh |
| line-2 | 6 | 133 kWh | 196 kWh | 50 kWh | 8.4 km / 67 kWh |
| line-3 | 13 | 209 kWh | 327 kWh | 96 kWh | 5.7 km / 46 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 160 | $900 k | $144 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 480 | $60 k | $29 M |
| High sensitivity check | 480 | $120 k | $58 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 55,409 kW @ $700/kW | $39 M |
| Grid interconnection / PPA tie-in | 55,409 kW @ $100/kW | $5.5 M |
| Annual generation proxy | 55.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 121.3 GWh/yr |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $3.3 M |
...
| Per-capita (city pop) | $1,214 / person |
...
|---|---|---|
| Construction (years 1–10) | **$37 M / yr** | $68 |
| Steady-state, low capacity-use (year 11+) | **$31 M / yr** | $56 |
| Steady-state, high capacity-use (year 11+) | **$22 M / yr** | $39 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.31 bn cumulative** | $2,373 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.02 bn cumulative** | $1,861 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.36 bn cumulative** | $2,468 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $1.7 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $534 M | 4.5% | 40 y, 10 y grace | $33 M / yr |
| Government equity (no debt service) | 20% | $134 M | — | — | — |
| **Total** | **100%** | **$668 M** | | | **$33 M / yr** |
...
| Traction energy (135.5 GWh / yr) | 28,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.0 GWh/yr + dedicated solar plant 55.4 MW / 121.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $665 k |
| Labour (434 FTE) | driverless roster: OCC/remote 94, station/platform 127, passenger service 49, fleet maintenance 86, infrastructure/energy 57, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $583 k |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 28,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.3 M train-km / yr (33.9 M car-km / yr). On-site PV covers 30.0 GWh/yr and the dedicated solar plant adds 121.3 GWh/yr against 135.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 160 trainsets, 35 stations, 61.6 route-km, 3 lines, and 28,649 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 65.1 M |
| Annual paid trips / city resident | 133 | 213 | 118 |
| Farebox revenue | $16 M / yr | $25 M / yr | $14 M / yr |
| Station shop leases | $558 k / yr | $558 k / yr | $558 k / yr |
| Advertising boards | $771 k / yr | $771 k / yr | $771 k / yr |
| **Total revenue** | **$17 M / yr** | **$26 M / yr** | **$15 M / yr** |
...
| Operating surplus applied to debt support | -$1.7 M / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $31 M / yr | $22 M / yr | **$33 M / yr** |
| Operating surplus after OPEX (before debt support) | $1.7 M / yr | $11 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,288 m² of station shop/kiosk leases at $10/m²/month and 1,008 advertising boards at $75/board/month, with occupancy derates applied._
...
| Commerce | 15 major/terminal/interchange nodes | 41,180 trips/trading day; 13.6 M access-events/yr | 65,889 trips/trading day; 21.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $378 M | 57% of $668 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $605 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $60 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 98,406 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $623 M |
| Timetable-sized dedicated solar CAPEX | $44 M |
| **Reconciled project CAPEX** | **$668 M** |
| 15%–25% planning risk envelope | $768 M–$834 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-438819 k / $-389880 k |
| Low/high project IRR | -10.3% / -3.2% |
| Low/high steady-state DSCR | 0.05 / 0.34 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,255.63 train-km; 18,190.99 kWh consumed; 17,797.25 kWh charged; 24 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 29,426.66 train-km; 237,315.34 kWh consumed; 236,282.66 kWh charged; 496 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 60 SoC warnings; 4 energy-adapted off-peak departures, maximum 13 min headway |
...
| 50% charging-contact availability | 20.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.8% / 60% | pass |
| ten-hour single charging-pad outage | 20.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 3 interchange complexes, 31 civil segments, and 0 input findings |
