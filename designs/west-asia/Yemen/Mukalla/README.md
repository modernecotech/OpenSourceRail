...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$715 M (85.9%) of external capital** and **$924 M of external interest**. Capital plus saved interest totals **$1.64 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (61.1 km @ $2.58 M/km) | $158 M |
| Elevated (0.5 km @ $9.75 M/km) | $5.0 M |
...
| Per-capita (city pop) | $841 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $163 M | 15% | $24 M | $138 M |
...
| **Total city CAPEX** | **$462 M** | **25.3%** | **$117 M** | **$345 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.3%** | **$117 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.7%** | **$345 M** | **$35 M / yr** |
| of which planned local bond issuance | 59.7% of total CAPEX | $276 M | $28 M / yr |
| **Total city programme** | **100.0%** | **$462 M** | **$46 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $624 M | $507 M (81.2%) | $655 M | **$1.16 bn** |
| **Default** | 2.00× | $832 M | $715 M (85.9%) | $924 M | **$1.64 bn** |
| High | 3.00× | $1.25 bn | $1.13 bn (90.6%) | $1.46 bn | **$2.59 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 85.9% below the illustrative foreign-company requirement of $832 M; the associated lifetime external-interest saving is $924 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$62 M / yr** | $113 |
| Steady-state, low capacity-use (year 11+) | **$53 M / yr** | $96 |
| Steady-state, high capacity-use (year 11+) | **$43 M / yr** | $79 |
| Steady-state, operating-neutral revenue case | **$57 M / yr** | $104 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.20 bn cumulative** | $3,997 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.92 bn cumulative** | $3,485 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.34 bn cumulative** | $4,248 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.6 M / yr → $14 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $117 M | 4.5% | 40 y, 10 y grace | $7.2 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $276 M | 18.0% | 40 y, 10 y grace | $50 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$462 M** | | | **$57 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.3 M / yr + local bonds $50 M / yr = **$55 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($6.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 51.7 M |
| Annual paid trips / city resident | 133 | 213 | 94 |
| Farebox revenue | $16 M / yr | $25 M / yr | $11 M / yr |
...
| Revenue / OPEX recovery | 139% | 219% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Gross repayable-debt service + residual OPEX subsidy | $57 M / yr | $57 M / yr | **$57 M / yr** |
| Operating surplus applied to debt support | -$4.6 M / yr | -$14 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $53 M / yr | $43 M / yr | **$57 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.6 M / yr | $14 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $345 M | 75% of $462 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $552 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $55 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 89,904 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$462 M** |
| Imported / external-capital requirement | $117 M (25.3%) |
| Local-content / local-funding requirement | $345 M (74.7%) |
| Default foreign-turnkey external-capital comparison | $832 M; OSR saves $715 M (85.9%) |
| Lifetime external interest and combined financing saving | $924 M interest; $1.64 bn capital + interest |
| 15%–25% planning risk envelope | $532 M–$578 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-286229 k / $-237290 k |
| Low/high project IRR | -5.4% / -0.5% |
| Low/high steady-state DSCR | 0.08 / 0.24 |
