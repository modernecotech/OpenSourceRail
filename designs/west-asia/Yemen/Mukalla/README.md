...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **71,280 – 118,800 trips/day**
...
| Per-capita (city pop) | $652 / person |
...
|---|---|---|
| Construction (years 1–10) | **$28 M / yr** | $51 |
| Steady-state, low-ridership (year 11+) | **$30 M / yr** | $54 |
| Steady-state, high-ridership (year 11+) | **$27 M / yr** | $49 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.17 bn cumulative** | $2,131 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.10 bn cumulative** | $1,992 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.10 bn cumulative** | $1,992 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.5 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $215 M | 3.0% | 40 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $90 M | 18.0% | 40 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $54 M | — | — | — |
| **Total** | **100%** | **$358 M** | | | **$27 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.5 M / yr + bonds $16 M / yr = **$23 M / yr** total — plus the equity tranche amortised across construction ($5.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 71,280 | 118,800 | 114,808 |
| Daily paid trips / catchment | 18% | 30% | 29% |
| Daily paid trips / city population | 13% | 22% | 21% |
| Annual paid trips | 26.0 M | 43.4 M | 41.9 M |
| Farebox revenue | $4.2 M / yr | $6.9 M / yr | $6.7 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $750 k / yr | $750 k / yr | $750 k / yr |
| **Total revenue** | **$5.5 M / yr** | **$8.2 M / yr** | **$8.0 M / yr** |
| Revenue / OPEX recovery | 68% | 103% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov commitment | $30 M / yr | $27 M / yr | **$27 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $233 k / yr | $0 / yr |
