...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **71,280 – 118,800 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$23 M / yr** | $42 |
| Steady-state, high-ridership (year 11+) | **$20 M / yr** | $36 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$927 M cumulative** | $1,686 |
| Lifecycle envelope (yr 1–40, high scenario) | **$831 M cumulative** | $1,510 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$231 M cumulative** | $420 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $722 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 82,500 | 137,500 | 479,821 |
| Daily paid trips / population | 15% | 25% | 87% |
| Annual paid trips | 30.1 M | 50.2 M | 175.1 M |
| Farebox revenue | $4.8 M / yr | $8.0 M / yr | $28 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $750 k / yr | $750 k / yr | $750 k / yr |
| **Total revenue** | **$6.1 M / yr** | **$9.3 M / yr** | **$29 M / yr** |
| Revenue / OPEX + debt-service recovery | 21% | 32% | 100% |
| Country farebox-only policy target (diagnostic) | 25% | 25% | 25% |
| Remaining steady-state gov gap | $23 M / yr | $20 M / yr | **$0 / yr** |
