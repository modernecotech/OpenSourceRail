...
| Bucket | Value |
|---|---|
| At-grade (58.2 km @ €3.5 M/km) | €204 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.9 km × €0.015 M/km | €0.9 M |
...
|---|---|---|
| Construction (years 1–10) | **€49 M / yr** | €90 |
| Steady-state, low-ridership (year 11+) | **€63 M / yr** | €114 |
| Steady-state, high-ridership (year 11+) | **€61 M / yr** | €111 |
| Lifecycle envelope (yr 1–40, low scenario) | **€2.37 bn cumulative** | €4,307 |
| Lifecycle envelope (yr 1–40, high scenario) | **€2.33 bn cumulative** | €4,240 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€15 M / yr (low) → €13 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €379 M | 3.0% | 40 y, 10 y grace | €19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €158 M | 18.0% | 40 y, 10 y grace | €29 M / yr |
| Government equity (no debt service) | 15% | €95 M | — | — | — |
| **Total** | **100%** | **€632 M** | | | **€48 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €11 M / yr + bonds €28 M / yr = **€40 M / yr** total — plus the equity tranche amortised across construction (€9.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (377 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €466 k |
...
| Farebox revenue | €1.2 M / yr | €2.5 M / yr |
| Farebox / OPEX recovery | 8% | 16% |
| Country policy-target recovery (diagnostic) | 25% | 25% |
| Operating shortfall (gov subsidy required) | €15 M / yr | €13 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€63 M / yr** | **€61 M / yr** |
