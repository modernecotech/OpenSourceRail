...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **71,280 – 112,320 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (58.2 km @ $2.0 M/km) | $116 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.9 km × $0.015 M/km | $3.0 M |
...
| Steady-state, low-ridership (year 11+) | **$24 M / yr** | $43 |
| Steady-state, high-ridership (year 11+) | **$22 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$947 M cumulative** | $1,721 |
| Lifecycle envelope (yr 1–40, high scenario) | **$905 M cumulative** | $1,646 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$905 M cumulative** | $1,646 |

_Population basis: 550,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.4 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $178 M | 3.0% | 40 y, 10 y grace | $9.1 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $74 M | 18.0% | 40 y, 10 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $44 M | — | — | — |
| **Total** | **100%** | **$296 M** | | | **$22 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $5.3 M / yr + bonds $13 M / yr = **$19 M / yr** total — plus the equity tranche amortised across construction ($4.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 71,280 | 112,320 | 94,871 |
| Daily paid trips / catchment | 18% | 28% | 24% |
| Daily paid trips / city population | 13% | 20% | 17% |
| Annual paid trips | 26.0 M | 41.0 M | 34.6 M |
| Farebox revenue | $4.2 M / yr | $6.6 M / yr | $5.5 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $750 k / yr | $750 k / yr | $750 k / yr |
| **Total revenue** | **$5.5 M / yr** | **$7.8 M / yr** | **$6.8 M / yr** |
| Revenue / OPEX recovery | 80% | 115% | 100% |
