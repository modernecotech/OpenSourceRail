...
|---|---|---|---|---|
| line-1 | 21.6 km | 14 | 53 | NW Mid ↔ SE Outer |
| line-2 | 13.0 km | 9 | 31 | SW Mid ↔ N Mid |
| line-3 | 12.0 km | 9 | 30 | E Inner ↔ W Mid |
| **Total** | **46.6 km** | **32 unique** | **114** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **38.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 492 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 199 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 38.1 MW / 228 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 174 kWh | 261 kWh | 70 kWh | 6.0 km / 48 kWh |
| line-2 | 9 | 105 kWh | 163 kWh | 48 kWh | 2.2 km / 18 kWh |
| line-3 | 9 | 97 kWh | 163 kWh | 57 kWh | 2.0 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,067 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,067 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 38.1 MW × 6.0 peak-sun-h/day × 365 d/yr | 83.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $65 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$213 M cumulative** | $323 |
| Lifecycle envelope (yr 1–40, high scenario) | **$213 M cumulative** | $323 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.11 bn cumulative** | $1,685 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $449 M | 4.5% | 40 y, 5 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $112 M | — | — | — |
| **Total** | **100%** | **$561 M** | | | **$26 M / yr** |
...
| Traction energy (102.5 GWh / yr) | 21,668 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.0 GWh/yr + dedicated solar plant 38.1 MW / 83.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $457 k |
| Labour (376 FTE) | driverless roster: OCC/remote 73, station/platform 124, passenger service 49, fleet maintenance 63, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.4 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 21,668 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.5 M train-km / yr (25.6 M car-km / yr). On-site PV covers 30.0 GWh/yr and the dedicated solar plant adds 83.4 GWh/yr against 102.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 114 trainsets, 32 stations, 46.6 route-km, 3 lines, and 21,668 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$79 M / yr** | **$123 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 545% | 854% | 100% |
...
_Commercial-revenue assumptions: 5,168 m² of station shop/kiosk leases at $30/m²/month and 980 advertising boards at $266/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 11,289 trips/school day; 2.5 M access-events/yr | 18,063 trips/school day; 4.0 M access-events/yr |
| Healthcare | 6 healthcare anchors | 17,115 trips/day; 6.2 M access-events/yr | 27,384 trips/day; 10.0 M access-events/yr |
| Commerce | 19 major/terminal/interchange nodes | 44,664 trips/trading day; 14.7 M access-events/yr | 71,463 trips/trading day; 23.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $323 M | 58% of $561 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $517 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $103 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,721 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $530 M |
| Timetable-sized dedicated solar CAPEX | $30 M |
| **Reconciled project CAPEX** | **$561 M** |
| 15%–25% planning risk envelope | $645 M–$701 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $61 M / $415 M |
| Low/high project IRR | 9.1% / 14.4% |
| Low/high steady-state DSCR | 2.50 / 4.23 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,839.18 train-km; 14,832.37 kWh consumed; 15,072.38 kWh charged; 29 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,401.53 train-km; 180,660.37 kWh consumed; 183,592.44 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 61%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 51.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 60.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 32 line platforms, 1 interchange complexes, 17 civil segments, and 0 input findings |
