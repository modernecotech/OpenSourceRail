...
|---|---|---|---|---|
| line-1 | 25.6 km | 14 | 64 | N Mid ↔ SW Outer |
| line-2 | 12.8 km | 9 | 31 | N Mid ↔ SE Mid |
| line-3 | 12.0 km | 9 | 30 | W Inner ↔ E Mid |
| **Total** | **50.4 km** | **32 unique** | **125** | |
...
| Onboard battery adequacy | 7.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 464 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 23,436 train-km/day | One-way train journeys × route length |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 206 kWh | 302 kWh | 75 kWh | 9.4 km / 76 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,460 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,460 kW @ $100/kW | $4.2 M |
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $109 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$204 M cumulative** | $547 |
| Lifecycle envelope (yr 1–40, high scenario) | **$204 M cumulative** | $547 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $2,854 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $430 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $108 M | — | — | — |
| **Total** | **100%** | **$538 M** | | | **$25 M / yr** |
...
| Traction energy (110.9 GWh / yr) | 23,436 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.0 GWh/yr + dedicated solar plant 42.5 MW / 93.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $510 k |
| Labour (394 FTE) | driverless roster: OCC/remote 81, station/platform 126, passenger service 49, fleet maintenance 69, infrastructure/energy 48, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 23,436 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.2 M train-km / yr (27.7 M car-km / yr). On-site PV covers 30.0 GWh/yr and the dedicated solar plant adds 93.0 GWh/yr against 110.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 125 trainsets, 32 stations, 50.4 route-km, 3 lines, and 23,436 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 196 | 314 | 25 |
| Farebox revenue | $74 M / yr | $119 M / yr | $9.7 M / yr |
...
| Revenue / OPEX recovery | 554% | 866% | 100% |
...
_Commercial-revenue assumptions: 5,536 m² of station shop/kiosk leases at $30/m²/month and 1,040 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $31 M / yr | $50 M / yr | 23% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 10,639 trips/school day; 2.3 M access-events/yr | 17,022 trips/school day; 3.7 M access-events/yr |
| Healthcare | 3 healthcare anchors | 14,078 trips/day; 5.1 M access-events/yr | 22,524 trips/day; 8.2 M access-events/yr |
| Commerce | 20 major/terminal/interchange nodes | 45,324 trips/trading day; 15.0 M access-events/yr | 72,518 trips/trading day; 23.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $304 M | 57% of $538 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 16,681 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$538 M** |
| 15%–25% planning risk envelope | $619 M–$672 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $83 M / $437 M |
| Low/high project IRR | 9.5% / 15.0% |
| Low/high steady-state DSCR | 2.62 / 4.43 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,933.22 train-km; 15,590.87 kWh consumed; 15,494.93 kWh charged; 28 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 24,174.67 train-km; 194,960.45 kWh consumed; 196,957.15 kWh charged; 490 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 19 SoC warnings |
