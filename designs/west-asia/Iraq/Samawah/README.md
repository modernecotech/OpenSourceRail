...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **38,012 – 63,354 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (53.1 km @ $2.0 M/km) | $106 M |
...
|---|---|---|
| Construction (years 1–5) | **$21 M / yr** | $56 |
| Steady-state, low-ridership (year 6+) | **$7.2 M / yr** | $19 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$248 M cumulative** | $663 |
| Lifecycle envelope (yr 1–25, high scenario) | **$104 M cumulative** | $278 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$104 M cumulative** | $278 |

_Population basis: 373,770 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $166 M | 4.0% | 25 y, 5 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $69 M | 8.5% | 25 y, 5 y grace | $7.3 M / yr |
| Government equity (no debt service) | 15% | $41 M | — | — | — |
| **Total** | **100%** | **$276 M** | | | **$19 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $6.6 M / yr + bonds $5.9 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($8.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,066 | 93,442 | 82,002 |
| Daily paid trips / population | 15% | 25% | 22% |
| Annual paid trips | 20.5 M | 34.1 M | 29.9 M |
| Farebox revenue | $16 M / yr | $26 M / yr | $23 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| **Total revenue** | **$20 M / yr** | **$31 M / yr** | **$27 M / yr** |
| Revenue / OPEX + debt-service recovery | 74% | 112% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $7.2 M / yr | $0 k / yr | **$0 / yr** |
