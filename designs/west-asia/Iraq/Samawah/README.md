...
| Bucket | Value |
|---|---|
| At-grade (53.1 km @ €3.5 M/km) | €186 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 54.9 km × €0.015 M/km | €0.8 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 54.9 km × €0.8 M/km | €44 M |
...
| Depots | €40 M |
| Rolling stock | €165 M |
| Residual train-control wayside + power | €45 M |
| EPC overhead (7%) | €40 M |
| **CAPEX total** | **€608 M** |
| Per-route-km | €11 M / km |
| Per-capita (city pop) | €1,628 / person |
...
|---|---|---|
| Construction (years 1–5) | **€46 M / yr** | €123 |
| Steady-state, low-ridership (year 6+) | **€55 M / yr** | €147 |
| Steady-state, high-ridership (year 6+) | **€51 M / yr** | €136 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.32 bn cumulative** | €3,544 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.25 bn cumulative** | €3,332 |

_Population basis: 373,770 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €7.9 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €152 M | 8.5% | 25 y, 5 y grace | €16 M / yr |
| Government equity (no debt service) | 15% | €91 M | — | — | — |
| **Total** | **100%** | **€608 M** | | | **€43 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €13 M / yr = **€28 M / yr** total — plus the equity tranche amortised across construction (€18 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (341 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €2.0 M |
...
| Farebox / OPEX recovery | 25% | 50% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €12 M / yr | €7.9 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€55 M / yr** | **€51 M / yr** |
