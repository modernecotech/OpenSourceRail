...
| Anchor-weighted coverage | 58.9% |
| Route length (double track) | 50.4 km |
...
- Anchor-weighted coverage: 58.9%
- Catchment population: **≈ 220,150** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **45.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 461 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 23,447 train-km/day | One-way train journeys × route length |
| Annual service work | 9.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 304 MWh/day | 27.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 240 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 45.9 MW / 276 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 206 kWh | 294 kWh | 67 kWh | 9.8 km / 79 kWh |
| line-2 | 6 | 103 kWh | 147 kWh | 33 kWh | 3.0 km / 24 kWh |
| line-3 | 6 | 97 kWh | 147 kWh | 40 kWh | 3.0 km / 24 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (49.1 km @ $2.58 M/km) | $127 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 45,937 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 45,937 kW @ $100/kW | $4.6 M |
| Annual generation proxy | 45.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 100.6 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 50.4 km × $0.050 M/km | $2.5 M |
...
| Per-capita (city pop) | $1,111 / person |
...
| **Total city CAPEX** | **$415 M** | **24.1%** | **$100 M** | **$315 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh samawah`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$100 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$315 M** | **$63 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $252 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$415 M** | **$83 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $561 M | $461 M (82.2%) | $566 M | **$1.03 bn** |
| **Default** | 2.00× | $748 M | $648 M (86.6%) | $796 M | **$1.44 bn** |
| High | 3.00× | $1.12 bn | $1.02 bn (91.1%) | $1.26 bn | **$2.28 bn** |

At the default 2.00× case, OSR's $100 M external requirement is 86.6% below the illustrative foreign-company requirement of $748 M; the associated lifetime external-interest saving is $796 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$39 M / yr** | $103 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $76 |
| Lifecycle envelope (yr 1–40, low scenario) | **$193 M cumulative** | $516 |
| Lifecycle envelope (yr 1–40, high scenario) | **$193 M cumulative** | $516 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.19 bn cumulative** | $3,183 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $100 M | 4.5% | 40 y, 5 y grace | $5.7 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $252 M | 8.5% | 40 y, 5 y grace | $23 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$415 M** | | | **$28 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.5 M / yr + local bonds $21 M / yr = **$26 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $126 k |
| Traction energy (110.9 GWh / yr) | 23,447 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 45.9 MW / 100.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $551 k |
| Labour (335 FTE) | driverless roster: OCC/remote 73, station/platform 83, passenger service 49, fleet maintenance 64, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 23,447 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.2 M train-km / yr (27.7 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 100.6 GWh/yr against 110.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 108 trainsets, 21 stations, 50.4 route-km, 3 lines, and 23,447 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 8.6 M |
| Annual paid trips / city resident | 196 | 314 | 23 |
| Farebox revenue | $74 M / yr | $119 M / yr | $8.8 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$77 M / yr** | **$122 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 658% | 1038% | 100% |
...
| Operating surplus after OPEX (before debt support) | $66 M / yr | $110 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,544 m² of station shop/kiosk leases at $30/m²/month and 680 advertising boards at $266/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $21 M / yr | 166 M - 266 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.4 M / yr | $3.8 M / yr | 29.9–47.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.7 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $31 M / yr | $50 M / yr | 22% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $15 M / yr | $24 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$90 M / yr** | **$144 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 9,482 trips/school day; 2.1 M access-events/yr | 15,170 trips/school day; 3.3 M access-events/yr |
| Healthcare | 1 healthcare anchors | 13,178 trips/day; 4.8 M access-events/yr | 21,084 trips/day; 7.7 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 45,198 trips/trading day; 14.9 M access-events/yr | 72,317 trips/trading day; 23.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $315 M | 76% of $415 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $505 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $101 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,289 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $100 M (24.1%) |
| Local-content / local-funding requirement | $315 M (75.9%) |
...
| 15%–25% planning risk envelope | $478 M–$519 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $188 M / $542 M |
| Low/high project IRR | 12.2% / 18.4% |
| Low/high steady-state DSCR | 2.30 / 3.87 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,946.98 train-km; 15,701.99 kWh consumed; 14,433.67 kWh charged; 31 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,839.66 train-km; 184,194.07 kWh consumed; 179,125.50 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.4% of scheduled train-km delivered; 52 SoC warnings; 5 energy-adapted off-peak departures, maximum 14 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 95.5% / 90% | pass |
| 50% charging-contact availability | 20.0% | 97.4% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.3% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 96.3% / 90% | pass |
...
|---|---|
| ![Samawah QGIS engineering layers](engineering/screenshots/samawah-qgis-engineering-map.png) | ![Samawah SUMO timetable validation](engineering/screenshots/samawah-sumo-validation.png) |
