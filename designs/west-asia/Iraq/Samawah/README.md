...
Aggregate station-rail charging power: **15,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 320 kWh battery covers running.
...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 54.9 km × €0.1 M/km | €5.5 M |
...
|---|---|---|
| Construction (years 1–5) | **€42 M / yr** | €112 |
| Steady-state, low-ridership (year 6+) | **€49 M / yr** | €131 |
| Steady-state, high-ridership (year 6+) | **€45 M / yr** | €121 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.19 bn cumulative** | €3,181 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.11 bn cumulative** | €2,969 |

_Population basis: 373,770 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€9.9 M / yr (low) → €5.9 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €333 M | 4.0% | 25 y, 5 y grace | €24 M / yr |
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €273 k |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€49 M / yr** | **€45 M / yr** |
