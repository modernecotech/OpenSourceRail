...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$689 M (86.9%) of external capital** and **$847 M of external interest**. Capital plus saved interest totals **$1.54 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $1,178 / person |
...
| **Total city CAPEX** | **$440 M** | **23.6%** | **$104 M** | **$337 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$104 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$337 M** | **$67 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $269 M | $54 M / yr |
| **Total city programme** | **100.0%** | **$440 M** | **$88 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $595 M | $491 M (82.6%) | $603 M | **$1.09 bn** |
| **Default** | 2.00× | $793 M | $689 M (86.9%) | $847 M | **$1.54 bn** |
| High | 3.00× | $1.19 bn | $1.09 bn (91.3%) | $1.33 bn | **$2.42 bn** |

At the default 2.00× case, OSR's $104 M external requirement is 86.9% below the illustrative foreign-company requirement of $793 M; the associated lifetime external-interest saving is $847 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $110 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $81 |
| Lifecycle envelope (yr 1–40, low scenario) | **$205 M cumulative** | $549 |
| Lifecycle envelope (yr 1–40, high scenario) | **$205 M cumulative** | $549 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.26 bn cumulative** | $3,380 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $104 M | 4.5% | 40 y, 5 y grace | $5.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $269 M | 8.5% | 40 y, 5 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$440 M** | | | **$30 M / yr** |
...
| Annual paid trips / city resident | 196 | 314 | 24 |
| Farebox revenue | $74 M / yr | $119 M / yr | $9.2 M / yr |
...
| Revenue / OPEX recovery | 633% | 998% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $337 M | 76% of $440 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $539 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $108 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 18,456 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $404 M |
| Timetable-sized dedicated solar CAPEX | $37 M |
| **Reconciled project CAPEX** | **$440 M** |
| Imported / external-capital requirement | $104 M (23.6%) |
| Local-content / local-funding requirement | $337 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $793 M; OSR saves $689 M (86.9%) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $164 M / $518 M |
| Low/high project IRR | 11.5% / 17.5% |
| Low/high steady-state DSCR | 2.15 / 3.63 |
