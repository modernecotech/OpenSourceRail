...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **52,795 – 95,031 trips/day**
...
| Per-capita (city pop) | $2,232 / person |
...
| Steady-state, low-ridership (year 6+) | **$17 M / yr** | $46 |
| Steady-state, high-ridership (year 6+) | **$17 M / yr** | $45 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$724 M cumulative** | $1,936 |
| Lifecycle envelope (yr 1–40, high scenario) | **$709 M cumulative** | $1,898 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$709 M cumulative** | $1,898 |

_Population basis: 373,770 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $410 k / yr → $0 k / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $417 M | 2.0% | 40 y, 5 y grace | $17 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 8.5% | 40 y, 5 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $83 M | — | — | — |
| **Total** | **100%** | **$834 M** | | | **$17 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — concessional loan $8.3 M / yr + fallback bonds $0 k / yr = **$8.3 M / yr** total. The $334 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($17 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| **Total revenue** | **$24 M / yr** | **$40 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 98% | 162% | 100% |
