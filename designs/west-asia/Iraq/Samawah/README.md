...
|---|---|---|
| Construction (years 1–5) | **$50 M / yr** | $133 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$248 M cumulative** | $663 |
| Lifecycle envelope (yr 1–40, high scenario) | **$248 M cumulative** | $663 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.24 bn cumulative** | $3,315 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $708 M | 2.0% | 40 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $177 M | — | — | — |
| **Total** | **100%** | **$885 M** | | | **$28 M / yr** |
...
| Labour (408 FTE) | driverless roster: OCC/remote 65, station/platform 127, passenger service 44, fleet maintenance 64, infrastructure/energy 72, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $2.6 M |
...
| Annual paid trips / city resident | 169 | 270 | 56 |
...
| **Annual quantified benefit / activity proxy** | **$80 M / yr** | **$129 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 10 healthcare anchors | 15,951 trips/day; 5.8 M access-events/yr | 25,521 trips/day; 9.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $466 M | 53% of $885 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $745 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $149 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 25,536 job-years | retained CAPEX ÷ (4.0 × median annual income) |
