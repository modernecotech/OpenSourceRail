...
| Per-capita (city pop) | $1,769 / person |
...
| Steady-state, low-ridership (year 6+) | **$50 M / yr** | $134 |
| Steady-state, high-ridership (year 6+) | **$47 M / yr** | $125 |
| Steady-state, operating-neutral revenue case | **$47 M / yr** | $125 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.25 bn cumulative** | $3,341 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.18 bn cumulative** | $3,162 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.18 bn cumulative** | $3,162 |

_Population basis: 373,770 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.3 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $397 M | 4.0% | 25 y, 5 y grace | $29 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $165 M | 8.5% | 25 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $99 M | — | — | — |
| **Total** | **100%** | **$661 M** | | | **$47 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $16 M / yr + bonds $14 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 38,012 | 63,354 | 50,069 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 10% | 17% | 13% |
| Annual paid trips | 13.9 M | 23.1 M | 18.3 M |
| Farebox revenue | $11 M / yr | $18 M / yr | $14 M / yr |
...
| Revenue / OPEX recovery | 82% | 120% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $50 M / yr | $47 M / yr | **$47 M / yr** |
