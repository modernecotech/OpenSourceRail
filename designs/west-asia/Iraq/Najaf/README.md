...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 172.3 km × €0.1 M/km | €17 M |
...
| Depots | €52 M |
| Rolling stock | €432 M |
| Signalling + power | €154 M |
| EPC overhead (7%) | €152 M |
| **CAPEX total** | **€2.32 bn** |
| Per-route-km | €13 M / km |
| Per-capita (city pop) | €1,505 / person |
...
|---|---|---|
| Construction (years 1–5) | **€174 M / yr** | €113 |
| Steady-state, low-ridership (year 6+) | **€203 M / yr** | €132 |
| Steady-state, high-ridership (year 6+) | **€187 M / yr** | €121 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.93 bn cumulative** | €3,204 |
| Lifecycle envelope (yr 1–25, high scenario) | **€4.61 bn cumulative** | €2,991 |

_Population basis: 1,540,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€40 M / yr (low) → €23 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €580 M | 8.5% | 25 y, 5 y grace | €61 M / yr |
| Government equity (no debt service) | 15% | €348 M | — | — | — |
| **Total** | **100%** | **€2.32 bn** | | | **€164 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €56 M / yr + bonds €49 M / yr = **€105 M / yr** total — plus the equity tranche amortised across construction (€70 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €857 k |
...
| Operating shortfall (gov subsidy required) | €40 M / yr | €23 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€203 M / yr** | **€187 M / yr** |
