...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **164,934 – 274,890 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (140.6 km @ $2.0 M/km) | $281 M |
| Elevated (30.9 km @ $9.0 M/km) | $278 M |
| Elevated-interchange premium (11 sites @ $4.50 M) | $50 M |
| **Civil subtotal** | **$609 M** |
...
| `major` | 29 | $1.60 M | $46 M |
| `terminal` | 9 | $1.40 M | $13 M |
| `depot-terminal` | 1 | $2.0 M | $2.0 M |
| `interchange-elevated` | 25 | $3.50 M | $88 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 144 | $1.07 M | $154 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 172.3 km × $0.015 M/km | $8.6 M |
...
|---|---|---|
| Construction (years 1–5) | **$82 M / yr** | $53 |
| Steady-state, low-ridership (year 6+) | **$77 M / yr** | $50 |
| Steady-state, high-ridership (year 6+) | **$77 M / yr** | $50 |
| Steady-state, operating-neutral revenue case | **$77 M / yr** | $50 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.94 bn cumulative** | $1,260 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.94 bn cumulative** | $1,260 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.94 bn cumulative** | $1,260 |

_Population basis: 1,540,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $651 M | 4.0% | 25 y, 5 y grace | $48 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $271 M | 8.5% | 25 y, 5 y grace | $29 M / yr |
| Government equity (no debt service) | 15% | $163 M | — | — | — |
| **Total** | **100%** | **$1.09 bn** | | | **$77 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $26 M / yr + bonds $23 M / yr = **$49 M / yr** total — plus the equity tranche amortised across construction ($33 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (1,046 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $6.7 M |
...
|---|---|---|---|
| Daily paid trips | 164,934 | 274,890 | 50,775 |
| Daily paid trips / catchment | 18% | 30% | 6% |
| Daily paid trips / city population | 11% | 18% | 3% |
| Annual paid trips | 60.2 M | 100.3 M | 18.5 M |
| Farebox revenue | $46 M / yr | $76 M / yr | $14 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.2 M / yr | $9.2 M / yr | $9.2 M / yr |
| **Total revenue** | **$61 M / yr** | **$92 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 208% | 312% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $77 M / yr | $77 M / yr | **$77 M / yr** |
| Operating surplus after OPEX | $32 M / yr | $62 M / yr | $0 / yr |
