...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 144 | $5.60 M | $806 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 576 | $100 k | $58 M |
| High sensitivity check | 576 | $200 k | $115 M |
...
| EPC integration + project management (7%) | on subtotal | $163 M |
...
| EPC overhead (7%) | $163 M |
| **CAPEX total** | **$2.49 bn** |
| Per-route-km | $14 M / km |
| Per-capita (city pop) | $1,615 / person |
...
|---|---|---|
| Construction (years 1–5) | **$187 M / yr** | $122 |
| Steady-state, low-ridership (year 6+) | **$182 M / yr** | $118 |
| Steady-state, high-ridership (year 6+) | **$176 M / yr** | $114 |
| Steady-state, operating-neutral revenue case | **$176 M / yr** | $114 |
| Lifecycle envelope (yr 1–25, low scenario) | **$4.57 bn cumulative** | $2,971 |
| Lifecycle envelope (yr 1–25, high scenario) | **$4.45 bn cumulative** | $2,887 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$4.45 bn cumulative** | $2,887 |

_Population basis: 1,540,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.4 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.49 bn | 4.0% | 25 y, 5 y grace | $110 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $622 M | 8.5% | 25 y, 5 y grace | $66 M / yr |
| Government equity (no debt service) | 15% | $373 M | — | — | — |
| **Total** | **100%** | **$2.49 bn** | | | **$176 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $60 M / yr + bonds $53 M / yr = **$113 M / yr** total — plus the equity tranche amortised across construction ($75 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 164,934 | 274,890 | 188,131 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 11% | 18% | 12% |
| Annual paid trips | 60.2 M | 100.3 M | 68.7 M |
| Farebox revenue | $46 M / yr | $76 M / yr | $52 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.2 M / yr | $9.2 M / yr | $9.2 M / yr |
| **Total revenue** | **$61 M / yr** | **$92 M / yr** | **$67 M / yr** |
| Revenue / OPEX recovery | 90% | 136% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $182 M / yr | $176 M / yr | **$176 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $24 M / yr | $0 / yr |
