...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.38 bn (87.1%) of external capital** and **$2.93 bn of external interest**. Capital plus saved interest totals **$5.31 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 52.0% |
| Route length (double track) | 165.1 km |
| Revenue fleet | 205 × 4-car trainsets |
| Revenue fleet passenger capacity | 98,400 AW2 pax (131,200 AW3 crush) |
...
| Revenue fleet capacity | 98,400 AW2 pax (131,200 AW3 crush) |
| Total fleet capacity | 109,920 AW2 pax (146,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 205 × 480 = **98,400 AW2 passengers** (131,200 AW3 crush)
- **Total fleet passenger capacity:** 229 × 480 = **109,920 AW2 passengers** (146,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 52.0%
- Catchment population: **≈ 800,800** (within ~800 m walk of a station)
...
| **Total installed** | **54** | **20,900 kW** | **119,500 kWh** |

Aggregate station-rail charging power: **81,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **206.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 4.9× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 574 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 103 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 125 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 69,469 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 1,075 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 206.0 MW / 1,236 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 120 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 280 kWh | 539 kWh | 231 kWh | 5.9 km / 64 kWh |
| line-2 | 10 | 395 kWh | 662 kWh | 227 kWh | 13.6 km / 146 kWh |
| line-3 | 8 | 199 kWh | 441 kWh | 222 kWh | 3.6 km / 39 kWh |
| line-4 | 8 | 301 kWh | 514 kWh | 183 kWh | 12.7 km / 137 kWh |
| line-5 | 6 | 263 kWh | 392 kWh | 103 kWh | 7.0 km / 75 kWh |
| line-6 | 12 | 338 kWh | 588 kWh | 216 kWh | 5.3 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (142.1 km @ $2.58 M/km) | $367 M |
| Elevated (23.0 km @ $9.75 M/km) | $224 M |
| Elevated-interchange premium (9 sites @ $4.50 M) | $40 M |
| **Civil subtotal** | **$632 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 229 | $1.12 M | $256 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 916 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 916 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 206,047 kW @ $700/kW | $144 M |
| Grid interconnection / PPA tie-in | 206,047 kW @ $100/kW | $21 M |
| Annual generation proxy | 206.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 451.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$165 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 165.1 km × $0.050 M/km | $8.3 M |
...
| Dedicated solar power plant | $165 M |
...
|---|---:|---:|---:|---:|
| Civil works | $632 M | 15% | $95 M | $537 M |
| Stations | $345 M | 20% | $69 M | $276 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $256 M | 35% | $90 M | $167 M |
| Dedicated solar plant | $165 M | 45% | $74 M | $91 M |
| Residual signalling / train control | $8.3 M | 50% | $4.1 M | $4.1 M |
| Charging microgrids | $18 M | 40% | $7.2 M | $11 M |
| EPC / project services | $89 M | 15% | $13 M | $75 M |
| **Total city CAPEX** | **$1.52 bn** | **23.3%** | **$354 M** | **$1.17 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh najaf`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.3%** | **$354 M** | **$71 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.7%** | **$1.17 bn** | **$233 M / yr** |
| of which planned local bond issuance | 61.4% of total CAPEX | $933 M | $187 M / yr |
| **Total city programme** | **100.0%** | **$1.52 bn** | **$304 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.05 bn | $1.70 bn (82.7%) | $2.09 bn | **$3.79 bn** |
| **Default** | 2.00× | $2.74 bn | $2.38 bn (87.1%) | $2.93 bn | **$5.31 bn** |
| High | 3.00× | $4.11 bn | $3.75 bn (91.4%) | $4.61 bn | **$8.37 bn** |

At the default 2.00× case, OSR's $354 M external requirement is 87.1% below the illustrative foreign-company requirement of $2.74 bn; the associated lifetime external-interest saving is $2.93 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$142 M / yr** | $92 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$104 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$710 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, high scenario) | **$710 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.37 bn cumulative** | $2,836 |

_Population basis: 1,540,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $104 M / yr → $104 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $354 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $933 M | 8.5% | 40 y, 5 y grace | $84 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $233 M | — | — | — |
| **Total** | **100%** | **$1.52 bn** | | | **$104 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $16 M / yr + local bonds $79 M / yr = **$95 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($47 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (438.2 GWh / yr) | 69,469 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 45.8 GWh/yr + dedicated solar plant 206.0 MW / 451.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.5 M |
| Labour (827 FTE) | driverless roster: OCC/remote 138, station/platform 259, passenger service 111, fleet maintenance 160, infrastructure/energy 132, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.3 M |
| **OPEX subtotal** | | **$38 M / yr** |

_Annual service work: 69,469 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.4 M train-km / yr (109.5 M car-km / yr). On-site PV covers 45.8 GWh/yr and the dedicated solar plant adds 451.2 GWh/yr against 438.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 229 trainsets, 59 stations, 165.1 route-km, 6 lines, and 69,469 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 28.4 M |
| Annual paid trips / city resident | 116 | 186 | 18 |
| Farebox revenue | $182 M / yr | $291 M / yr | $29 M / yr |
| Station shop leases | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| Advertising boards | $5.7 M / yr | $5.7 M / yr | $5.7 M / yr |
| **Total revenue** | **$191 M / yr** | **$300 M / yr** | **$38 M / yr** |
| Revenue / OPEX recovery | 501% | 787% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $104 M / yr | $104 M / yr | **$104 M / yr** |
| Operating surplus applied to debt support | -$104 M / yr | -$104 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$104 M / yr** |
| Operating surplus after OPEX (before debt support) | $153 M / yr | $262 M / yr | $0 / yr |

_Commercial-revenue assumptions: 11,368 m² of station shop/kiosk leases at $30/m²/month and 2,084 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $74 M / yr | $118 M / yr | 22% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $36 M / yr | $58 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$249 M / yr** | **$399 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 21,299 trips/school day; 4.7 M access-events/yr | 34,078 trips/school day; 7.5 M access-events/yr |
| Healthcare | 7 healthcare anchors | 38,485 trips/day; 14.0 M access-events/yr | 61,576 trips/day; 22.5 M access-events/yr |
| Commerce | 32 major/terminal/interchange nodes | 106,531 trips/trading day; 35.2 M access-events/yr | 170,449 trips/trading day; 56.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.17 bn | 77% of $1.52 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.87 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $373 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 63,969 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $165 M |
| **Reconciled project CAPEX** | **$1.52 bn** |
| Imported / external-capital requirement | $354 M (23.3%) |
| Local-content / local-funding requirement | $1.17 bn (76.7%) |
| Default foreign-turnkey external-capital comparison | $2.74 bn; OSR saves $2.38 bn (87.1%) |
| Lifetime external interest and combined financing saving | $2.93 bn interest; $5.31 bn capital + interest |
| 15%–25% planning risk envelope | $1.75 bn–$1.90 bn |
| Annual OPEX | $38 M / yr |
| Low/high project NPV at 8% | $-2708 k / $862 M |
| Low/high project IRR | 8.0% / 13.1% |
| Low/high steady-state DSCR | 1.46 / 2.51 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,479.63 train-km; 58,923.04 kWh consumed; 60,198.86 kWh charged; 54 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 66,812.34 train-km; 718,440.30 kWh consumed; 726,313.85 kWh charged; 1,005 depot services completed (12 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 96.2% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 51.1% | 96.2% / 90% | pass |
| maximum planning climate/HVAC duty | 29.5% | 96.2% / 90% | pass |
| 50% charging-contact availability | 59.9% | 96.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 76.2% / 60% | pass |
| ten-hour single charging-pad outage | 59.9% | 96.2% / 90% | pass |
...
|---|---|
| ![Najaf energy and battery simulation dashboard](engineering/screenshots/najaf-simulation-dashboard.png) | ![Najaf simulator network visualizer](engineering/screenshots/najaf-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 59 line platforms, 9 interchange complexes, 42 civil segments, and 0 input findings |
...
|---|---|
| ![Najaf QGIS engineering layers](engineering/screenshots/najaf-qgis-engineering-map.png) | ![Najaf SUMO timetable validation](engineering/screenshots/najaf-sumo-validation.png) |
...
scripts/regenerate-city.sh najaf
```
