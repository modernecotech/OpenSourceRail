...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 144.6 km × €0.1 M/km | €14 M |
...
|---|---|---|
| Construction (years 1–5) | **€134 M / yr** | €69 |
| Steady-state, low-ridership (year 6+) | **€150 M / yr** | €77 |
| Steady-state, high-ridership (year 6+) | **€129 M / yr** | €66 |
| Lifecycle envelope (yr 1–25, low scenario) | **€3.66 bn cumulative** | €1,888 |
| Lifecycle envelope (yr 1–25, high scenario) | **€3.25 bn cumulative** | €1,675 |

_Population basis: 1,940,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€23 M / yr (low) → €2.8 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €447 M | 8.5% | 25 y, 5 y grace | €47 M / yr |
| Government equity (no debt service) | 15% | €268 M | — | — | — |
| **Total** | **100%** | **€1.79 bn** | | | **€126 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €43 M / yr + bonds €38 M / yr = **€81 M / yr** total — plus the equity tranche amortised across construction (€54 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €719 k |
...
| Operating shortfall (gov subsidy required) | €23 M / yr | €2.8 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€150 M / yr** | **€129 M / yr** |
