...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **133,394 – 222,324 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (117.3 km @ $3.0 M/km) | $352 M |
| Elevated (26.5 km @ $12.0 M/km) | $318 M |
| Elevated-interchange premium (5 sites @ $4.50 M) | $22 M |
| **Civil subtotal** | **$693 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 144.6 km × $0.050 M/km | $7.2 M |
...
|---|---|---|
| Construction (years 1–5) | **$90 M / yr** | $47 |
| Steady-state, low-ridership (year 6+) | **$85 M / yr** | $44 |
| Steady-state, high-ridership (year 6+) | **$85 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$85 M / yr** | $44 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.14 bn cumulative** | $1,105 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.14 bn cumulative** | $1,105 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.14 bn cumulative** | $1,105 |

_Population basis: 1,940,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $719 M | 4.0% | 25 y, 5 y grace | $53 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $300 M | 8.5% | 25 y, 5 y grace | $32 M / yr |
| Government equity (no debt service) | 15% | $180 M | — | — | — |
| **Total** | **100%** | **$1.20 bn** | | | **$85 M / yr** |
