...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.04 bn (87.6%) of external capital** and **$3.73 bn of external interest**. Capital plus saved interest totals **$6.77 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (154.1 km @ $2.58 M/km) | $398 M |
| Elevated (53.3 km @ $9.75 M/km) | $519 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$949 M** |
...
| Per-capita (city pop) | $993 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $949 M | 15% | $142 M | $807 M |
...
| **Total city CAPEX** | **$1.93 bn** | **22.4%** | **$432 M** | **$1.50 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.4%** | **$432 M** | **$86 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.6%** | **$1.50 bn** | **$299 M / yr** |
| of which planned local bond issuance | 62.1% of total CAPEX | $1.20 bn | $239 M / yr |
| **Total city programme** | **100.0%** | **$1.93 bn** | **$385 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.60 bn | $2.17 bn (83.4%) | $2.67 bn | **$4.84 bn** |
| **Default** | 2.00× | $3.47 bn | $3.04 bn (87.6%) | $3.73 bn | **$6.77 bn** |
| High | 3.00× | $5.20 bn | $4.77 bn (91.7%) | $5.87 bn | **$10.64 bn** |

At the default 2.00× case, OSR's $432 M external requirement is 87.6% below the illustrative foreign-company requirement of $3.47 bn; the associated lifetime external-interest saving is $3.73 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$181 M / yr** | $93 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$133 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$904 M cumulative** | $466 |
| Lifecycle envelope (yr 1–40, high scenario) | **$904 M cumulative** | $466 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.55 bn cumulative** | $2,858 |

_Population basis: 1,940,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $133 M / yr → $133 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $432 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.20 bn | 8.5% | 40 y, 5 y grace | $108 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $299 M | — | — | — |
| **Total** | **100%** | **$1.93 bn** | | | **$133 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $102 M / yr = **$121 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($60 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 36.5 M |
| Annual paid trips / city resident | 92 | 148 | 19 |
| Farebox revenue | $182 M / yr | $291 M / yr | $37 M / yr |
| Station shop leases | $3.9 M / yr | $3.9 M / yr | $3.9 M / yr |
| Advertising boards | $6.0 M / yr | $6.0 M / yr | $6.0 M / yr |
| **Total revenue** | **$192 M / yr** | **$300 M / yr** | **$47 M / yr** |
| Revenue / OPEX recovery | 409% | 641% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $133 M / yr | $133 M / yr | **$133 M / yr** |
| Operating surplus applied to debt support | -$133 M / yr | -$133 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$133 M / yr** |
| Operating surplus after OPEX (before debt support) | $145 M / yr | $254 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.50 bn | 78% of $1.93 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.39 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $478 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 81,973 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.93 bn** |
| Imported / external-capital requirement | $432 M (22.4%) |
| Local-content / local-funding requirement | $1.50 bn (77.6%) |
| Default foreign-turnkey external-capital comparison | $3.47 bn; OSR saves $3.04 bn (87.6%) |
| Lifetime external interest and combined financing saving | $3.73 bn interest; $6.77 bn capital + interest |
| 15%–25% planning risk envelope | $2.22 bn–$2.41 bn |
| Annual OPEX | $47 M / yr |
| Low/high project NPV at 8% | $-391373 k / $473 M |
| Low/high project IRR | 5.7% / 10.4% |
| Low/high steady-state DSCR | 1.09 / 1.91 |
