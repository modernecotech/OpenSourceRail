...
|---|---|---|
| Construction (years 1–5) | **€282 M / yr** | €71 |
| Steady-state, low-ridership (year 6+) | **€330 M / yr** | €84 |
| Steady-state, high-ridership (year 6+) | **€288 M / yr** | €73 |
| Lifecycle envelope (yr 1–25, low scenario) | **€8.02 bn cumulative** | €2,027 |
| Lifecycle envelope (yr 1–25, high scenario) | **€7.18 bn cumulative** | €1,815 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.25 bn | 4.0% | 25 y, 5 y grace | €165 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €937 M | 8.5% | 25 y, 5 y grace | €99 M / yr |
| Government equity (no debt service) | 15% | €562 M | — | — | — |
| **Total** | **100%** | **€3.75 bn** | | | **€264 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €90 M / yr + bonds €80 M / yr = **€170 M / yr** total — plus the equity tranche amortised across construction (€112 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€330 M / yr** | **€288 M / yr** |
