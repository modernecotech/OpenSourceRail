...
| Steady-state, low-ridership (year 6+) | **$114 M / yr** | $29 |
| Steady-state, high-ridership (year 6+) | **$114 M / yr** | $29 |
| Steady-state, operating-neutral revenue case | **$114 M / yr** | $29 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.84 bn cumulative** | $1,225 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.84 bn cumulative** | $1,225 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.84 bn cumulative** | $1,225 |

_Population basis: 3,955,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $114 M / yr | $114 M / yr | **$114 M / yr** |
| Operating surplus after OPEX | $36 M / yr | $195 M / yr | $0 / yr |
