...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **385,849 – 643,083 trips/day**
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 236 | $8.40 M | $1.98 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1416 | $100 k | $142 M |
| High sensitivity check | 1416 | $200 k | $283 M |
...
| EPC integration + project management (7%) | on subtotal | $278 M |
...
| Railway production plant | $142 M |
| Residual train-control wayside + charging microgrids | $63 M |
| EPC overhead (7%) | $278 M |
| **CAPEX total** | **$4.24 bn** |
| Per-route-km | $15 M / km |
| Per-capita (city pop) | $1,073 / person |
...
|---|---|---|
| Construction (years 1–5) | **$319 M / yr** | $81 |
| Steady-state, low-ridership (year 6+) | **$304 M / yr** | $77 |
| Steady-state, high-ridership (year 6+) | **$299 M / yr** | $76 |
| Steady-state, operating-neutral revenue case | **$299 M / yr** | $76 |
| Lifecycle envelope (yr 1–25, low scenario) | **$7.67 bn cumulative** | $1,939 |
| Lifecycle envelope (yr 1–25, high scenario) | **$7.59 bn cumulative** | $1,918 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$7.59 bn cumulative** | $1,918 |

_Population basis: 3,955,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.2 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $2.55 bn | 4.0% | 25 y, 5 y grace | $187 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $1.06 bn | 8.5% | 25 y, 5 y grace | $112 M / yr |
| Government equity (no debt service) | 15% | $637 M | — | — | — |
| **Total** | **100%** | **$4.24 bn** | | | **$299 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $102 M / yr + bonds $90 M / yr = **$192 M / yr** total — plus the equity tranche amortised across construction ($127 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 385,849 | 643,083 | 400,983 |
| Daily paid trips / catchment | 18% | 30% | 19% |
| Daily paid trips / city population | 10% | 16% | 10% |
| Annual paid trips | 140.8 M | 234.7 M | 146.4 M |
| Farebox revenue | $107 M / yr | $178 M / yr | $111 M / yr |
| Station shop leases | $6.0 M / yr | $6.0 M / yr | $6.0 M / yr |
| Advertising boards | $9.5 M / yr | $9.5 M / yr | $9.5 M / yr |
| **Total revenue** | **$123 M / yr** | **$194 M / yr** | **$127 M / yr** |
| Revenue / OPEX recovery | 97% | 153% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $304 M / yr | $299 M / yr | **$299 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $67 M / yr | $0 / yr |
