...
| Elevated (18.4 km @ $4.0 M/km) | $74 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.4 km × $0.015 M/km | $846 k |
...
| Per-capita (city pop) | $290 / person |
...
|---|---|---|
| Construction (years 1–5) | **$15 M / yr** | $22 |
| Steady-state, low-ridership (year 6+) | **$746 k / yr** | $1 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$92 M cumulative** | $130 |
| Lifecycle envelope (yr 1–25, high scenario) | **$77 M cumulative** | $109 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$77 M cumulative** | $109 |

_Population basis: 705,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $123 M | 4.0% | 25 y, 5 y grace | $9.0 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $51 M | 8.5% | 25 y, 5 y grace | $5.4 M / yr |
| Government equity (no debt service) | 15% | $31 M | — | — | — |
| **Total** | **100%** | **$205 M** | | | **$14 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $4.9 M / yr + bonds $4.3 M / yr = **$9.3 M / yr** total — plus the equity tranche amortised across construction ($6.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (350 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $2.2 M |
...
|---|---|---|---|
| Daily paid trips | 56,400 | 105,750 | 59,088 |
| Daily paid trips / population | 8% | 15% | 8% |
| Annual paid trips | 20.6 M | 38.6 M | 21.6 M |
| Farebox revenue | $16 M / yr | $29 M / yr | $16 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| **Total revenue** | **$21 M / yr** | **$34 M / yr** | **$21 M / yr** |
| Revenue / OPEX + debt-service recovery | 96% | 161% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $746 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $13 M / yr | $0 / yr |
