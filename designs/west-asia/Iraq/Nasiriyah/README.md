...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 56.4 km × €0.4 M/km | €22 M |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €507 M | 4.0% | 25 y, 5 y grace | €37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €211 M | 8.5% | 25 y, 5 y grace | €22 M / yr |
| Government equity (no debt service) | 15% | €127 M | — | — | — |
| **Total** | **100%** | **€845 M** | | | **€60 M / yr** |
...
| Farebox / OPEX recovery | 38% | 75% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €12 M / yr | €4.9 M / yr |
| **Total annual government burden** (debt service + OPEX shortfall) | **€72 M / yr** | **€64 M / yr** |
