...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **51,267 – 85,446 trips/day**
...
| Elevated (18.4 km @ $9.0 M/km) | $165 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.4 km × $0.015 M/km | $2.8 M |
...
|---|---|---|
| Construction (years 1–5) | **$31 M / yr** | $43 |
| Steady-state, low-ridership (year 6+) | **$29 M / yr** | $41 |
| Steady-state, high-ridership (year 6+) | **$29 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $41 |
| Lifecycle envelope (yr 1–25, low scenario) | **$727 M cumulative** | $1,031 |
| Lifecycle envelope (yr 1–25, high scenario) | **$727 M cumulative** | $1,031 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$727 M cumulative** | $1,031 |

_Population basis: 705,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $244 M | 4.0% | 25 y, 5 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $102 M | 8.5% | 25 y, 5 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$29 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $9.8 M / yr + bonds $8.6 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
