...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 127.0 km × €0.1 M/km | €13 M |
...
|---|---|---|
| Construction (years 1–5) | **€105 M / yr** | €49 |
| Steady-state, low-ridership (year 6+) | **€110 M / yr** | €51 |
| Steady-state, high-ridership (year 6+) | **€98 M / yr** | €46 |
| Lifecycle envelope (yr 1–25, low scenario) | **€2.73 bn cumulative** | €1,271 |
| Lifecycle envelope (yr 1–25, high scenario) | **€2.48 bn cumulative** | €1,156 |

_Population basis: 2,150,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €834 M | 4.0% | 25 y, 5 y grace | €61 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €348 M | 8.5% | 25 y, 5 y grace | €37 M / yr |
| Government equity (no debt service) | 15% | €209 M | — | — | — |
| **Total** | **100%** | **€1.39 bn** | | | **€98 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €33 M / yr + bonds €30 M / yr = **€63 M / yr** total — plus the equity tranche amortised across construction (€42 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €633 k |
...
| Operating shortfall (gov subsidy required) | €12 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €10 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€110 M / yr** | **€98 M / yr** |
