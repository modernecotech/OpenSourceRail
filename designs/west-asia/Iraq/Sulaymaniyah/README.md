...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **189,630 – 199,680 trips/day**
...
Aggregate station-rail charging power: **31,750 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 480 kWh battery covers running.
...
| Average one-way line energy | 508 kWh | 31.8 km average line length |
...
| PV daily yield proxy | 129 MWh/day | 5 peak-sun-hour planning proxy before local derates |
...
| Bucket | Value |
|---|---|
| At-grade (115.3 km @ $2.0 M/km) | $231 M |
| Elevated (11.3 km @ $9.0 M/km) | $101 M |
| Elevated-interchange premium (4 sites @ $4.50 M) | $18 M |
| **Civil subtotal** | **$350 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 127.0 km × $0.015 M/km | $6.3 M |
...
|---|---|---|
| Construction (years 1–5) | **$48 M / yr** | $23 |
| Steady-state, low-ridership (year 6+) | **$45 M / yr** | $21 |
| Steady-state, high-ridership (year 6+) | **$45 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$45 M / yr** | $21 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.15 bn cumulative** | $535 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.15 bn cumulative** | $535 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.15 bn cumulative** | $535 |

_Population basis: 2,150,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $386 M | 4.0% | 25 y, 5 y grace | $28 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $161 M | 8.5% | 25 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $96 M | — | — | — |
| **Total** | **100%** | **$643 M** | | | **$45 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $15 M / yr + bonds $14 M / yr = **$29 M / yr** total — plus the equity tranche amortised across construction ($19 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $316 k |
| Traction energy (295.4 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (774 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $4.9 M |
...
|---|---|---|---|
| Daily paid trips | 189,630 | 199,680 | 40,105 |
| Daily paid trips / catchment | 18% | 19% | 4% |
| Daily paid trips / city population | 9% | 9% | 2% |
| Annual paid trips | 69.2 M | 72.9 M | 14.6 M |
| Farebox revenue | $53 M / yr | $55 M / yr | $11 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$60 M / yr** | **$63 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 319% | 334% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $45 M / yr | $45 M / yr | **$45 M / yr** |
| Operating surplus after OPEX | $41 M / yr | $44 M / yr | $0 / yr |

_Commercial-revenue assumptions: 9,376 m² of station shop/kiosk leases at $30/m²/month and 1,764 advertising boards at $266/board/month, with occupancy derates applied._
