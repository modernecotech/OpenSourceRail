...
| Steady-state, low-ridership (year 6+) | **$37 M / yr** | $17 |
| Steady-state, high-ridership (year 6+) | **$37 M / yr** | $17 |
| Steady-state, operating-neutral revenue case | **$37 M / yr** | $17 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.58 bn cumulative** | $734 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.58 bn cumulative** | $734 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.58 bn cumulative** | $734 |

_Population basis: 2,150,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $37 M / yr | $37 M / yr | **$37 M / yr** |
| Operating surplus after OPEX | $84 M / yr | $178 M / yr | $0 / yr |
