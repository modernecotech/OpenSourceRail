...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **147,219 – 245,366 trips/day**
...
| Average one-way line energy | 532 kWh | 33.2 km average line length |
...
| Bucket | Value |
|---|---|
| At-grade (191.4 km @ $2.0 M/km) | $383 M |
| Elevated (7.4 km @ $9.0 M/km) | $67 M |
| Elevated-interchange premium (6 sites @ $4.50 M) | $27 M |
| **Civil subtotal** | **$477 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 166 | $1.07 M | $177 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 199.4 km × $0.015 M/km | $9.9 M |
...
|---|---|---|
| Construction (years 1–5) | **$72 M / yr** | $37 |
| Steady-state, low-ridership (year 6+) | **$302 k / yr** | $0 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$368 M cumulative** | $188 |
| Lifecycle envelope (yr 1–25, high scenario) | **$362 M cumulative** | $185 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$362 M cumulative** | $185 |

_Population basis: 1,952,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $577 M | 4.0% | 25 y, 5 y grace | $42 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $240 M | 8.5% | 25 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 15% | $144 M | — | — | — |
| **Total** | **100%** | **$961 M** | | | **$68 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $23 M / yr + bonds $20 M / yr = **$43 M / yr** total — plus the equity tranche amortised across construction ($29 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $497 k |
| Traction energy (465.1 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,208 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $7.7 M |
...
|---|---|---|---|
| Daily paid trips | 292,800 | 488,000 | 293,889 |
| Daily paid trips / population | 15% | 25% | 15% |
| Annual paid trips | 106.9 M | 178.1 M | 107.3 M |
| Farebox revenue | $81 M / yr | $135 M / yr | $82 M / yr |
| Station shop leases | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| Advertising boards | $9.1 M / yr | $9.1 M / yr | $9.1 M / yr |
| **Total revenue** | **$96 M / yr** | **$150 M / yr** | **$96 M / yr** |
| Revenue / OPEX + debt-service recovery | 100% | 156% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $302 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $54 M / yr | $0 / yr |

_Commercial-revenue assumptions: 18,256 m² of station shop/kiosk leases at $30/m²/month and 3,344 advertising boards at $266/board/month, with occupancy derates applied._
