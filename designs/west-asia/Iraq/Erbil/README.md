...
|---|---|---|
| Construction (years 1–5) | **$87 M / yr** | $44 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$52 M / yr** | $27 |
| Lifecycle envelope (yr 1–40, low scenario) | **$433 M cumulative** | $222 |
| Lifecycle envelope (yr 1–40, high scenario) | **$433 M cumulative** | $222 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.26 bn cumulative** | $1,158 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $911 M | 4.5% | 40 y, 5 y grace | $52 M / yr |
| Government equity (no debt service) | 20% | $228 M | — | — | — |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $623 M | 55% of $1.14 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $996 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $199 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 34,141 job-years | retained CAPEX ÷ (4.0 × median annual income) |
