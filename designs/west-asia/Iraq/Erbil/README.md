...
| Multi-line transfer reachability | 30% (line-pairs sharing ≥ 1 station) |
...
|---|---|---|---|---|
| line-1 | 36.5 km | 22 | 79 | NW Outer ↔ S Mid |
| line-2 | 31.7 km | 17 | 68 | SW Mid ↔ NE Outer |
| line-3 | 23.4 km | 13 | 52 | W Mid ↔ E Outer |
| line-4 | 26.5 km | 15 | 58 | N Outer ↔ S Mid |
| line-5 | 19.9 km | 12 | 46 | SW Mid ↔ SE Mid |
| **Total** | **138.1 km** | **79 unique** | **303** | |
...
| Total fleet capacity | 145,440 AW2 pax (193,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 272 × 480 = **130,560 AW2 passengers** (174,080 AW3 crush)
- **Total fleet passenger capacity:** 303 × 480 = **145,440 AW2 passengers** (193,920 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **182.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 352 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 156 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 953 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 182.7 MW / 1,096 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 393 kWh | 1,004 kWh | 573 kWh | 10.3 km / 111 kWh |
| line-2 | 15 | 341 kWh | 784 kWh | 409 kWh | 9.8 km / 105 kWh |
| line-3 | 13 | 251 kWh | 686 kWh | 409 kWh | 2.8 km / 30 kWh |
| line-4 | 13 | 285 kWh | 686 kWh | 372 kWh | 8.1 km / 88 kWh |
| line-5 | 11 | 214 kWh | 588 kWh | 352 kWh | 3.9 km / 42 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 303 | $1.12 M | $339 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1212 | $60 k | $73 M |
| High sensitivity check | 1212 | $120 k | $145 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 182,732 kW @ $700/kW | $128 M |
| Grid interconnection / PPA tie-in | 182,732 kW @ $100/kW | $18 M |
| Annual generation proxy | 182.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 400.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$146 M** |
...
| Dedicated solar power plant | $146 M |
...
|---|---|---|
| Construction (years 1–5) | **$112 M / yr** | $57 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$67 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$559 M cumulative** | $286 |
| Lifecycle envelope (yr 1–40, high scenario) | **$559 M cumulative** | $286 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.92 bn cumulative** | $1,494 |

_Population basis: 1,952,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $67 M / yr → $67 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.18 bn | 4.5% | 40 y, 5 y grace | $67 M / yr |
| Government equity (no debt service) | 20% | $294 M | — | — | — |
| **Total** | **100%** | **$1.47 bn** | | | **$67 M / yr** |
...
| Traction energy (404.9 GWh / yr) | 64,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 56.9 GWh/yr + dedicated solar plant 182.7 MW / 400.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.2 M |
| Labour (853 FTE) | driverless roster: OCC/remote 167, station/platform 264, passenger service 99, fleet maintenance 176, infrastructure/energy 122, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $5.4 M |
| **OPEX subtotal** | | **$37 M / yr** |

_Annual service work: 64,201 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 25.3 M train-km / yr (101.2 M car-km / yr). On-site PV covers 56.9 GWh/yr and the dedicated solar plant adds 400.2 GWh/yr against 404.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 303 trainsets, 79 stations, 138.1 route-km, 5 lines, and 64,201 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (892,800 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the CAPEX funding stack, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 8% |
| Annual paid trips | 162.9 M | 260.7 M | 27.7 M |
| Annual paid trips / city resident | 83 | 134 | 14 |
| Farebox revenue | $165 M / yr | $264 M / yr | $28 M / yr |
| Station shop leases | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| Advertising boards | $5.8 M / yr | $5.8 M / yr | $5.8 M / yr |
| **Total revenue** | **$175 M / yr** | **$274 M / yr** | **$37 M / yr** |
| Revenue / OPEX recovery | 466% | 730% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $67 M / yr | $67 M / yr | **$67 M / yr** |
| Operating surplus applied to debt support | -$67 M / yr | -$67 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$67 M / yr** |
| Operating surplus after OPEX (before debt support) | $137 M / yr | $236 M / yr | $0 / yr |

_Commercial-revenue assumptions: 11,216 m² of station shop/kiosk leases at $30/m²/month and 2,156 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $64 M / yr | $102 M / yr | 21% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 13 education anchors | 27,804 trips/school day; 6.1 M access-events/yr | 44,487 trips/school day; 9.8 M access-events/yr |
| Healthcare | 22 healthcare anchors | 39,878 trips/day; 14.6 M access-events/yr | 63,805 trips/day; 23.3 M access-events/yr |
| Commerce | 34 major/terminal/interchange nodes | 91,597 trips/trading day; 30.2 M access-events/yr | 146,555 trips/trading day; 48.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $811 M | 55% of $1.47 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.30 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $259 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 44,451 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $146 M |
| **Reconciled project CAPEX** | **$1.47 bn** |
| 15%–25% planning risk envelope | $1.69 bn–$1.84 bn |
| Annual OPEX | $37 M / yr |
| Low/high project NPV at 8% | $-86508 k / $699 M |
| Low/high project IRR | 7.4% / 12.3% |
| Low/high steady-state DSCR | 2.04 / 3.51 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,833.84 train-km; 51,978.24 kWh consumed; 55,567.47 kWh charged; 33 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 65,966.78 train-km; 709,340.27 kWh consumed; 721,751.40 kWh charged; 832 depot services completed (7 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 68.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 71.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 75.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 79 line platforms, 3 interchange complexes, 23 civil segments, and 0 input findings |
