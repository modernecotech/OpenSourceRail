...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 199.4 km × €0.4 M/km | €80 M |
...
| Sovereign bonds (10-y benchmark + project) | 25% | €528 M | 8.5% | 25 y, 5 y grace | €56 M / yr |
| Government equity (no debt service) | 15% | €317 M | — | — | — |
| **Total** | **100%** | **€2.11 bn** | | | **€149 M / yr** |
...
| Operating shortfall (gov subsidy required) | €35 M / yr | €14 M / yr |
| **Total annual government burden** (debt service + OPEX shortfall) | **€184 M / yr** | **€163 M / yr** |
