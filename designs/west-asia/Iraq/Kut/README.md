...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$738 M (87.6%) of external capital** and **$907 M of external interest**. Capital plus saved interest totals **$1.64 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 46.4 km |
...
- Anchor-weighted coverage: 60.1%
- Catchment population: **≈ 246,410** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **42.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 444 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 33 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 21,583 train-km/day | One-way train journeys × route length |
| Annual service work | 8.5 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 280 MWh/day | 25.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 223 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 42.7 MW / 256 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 180 kWh | 270 kWh | 71 kWh | 11.9 km / 96 kWh |
| line-2 | 5 | 76 kWh | 122 kWh | 39 kWh | 3.4 km / 27 kWh |
| line-3 | 5 | 118 kWh | 163 kWh | 33 kWh | 6.9 km / 55 kWh |
...
| Elevated (10.4 km @ $12.0 M/km) | $124 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,687 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,687 kW @ $100/kW | $4.3 M |
| Annual generation proxy | 42.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 93.5 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.4 km × $0.050 M/km | $2.3 M |
...
|---|---:|---:|---:|---:|
| Civil works | $233 M | 15% | $35 M | $198 M |
...
| EPC / project services | $28 M | 15% | $4.3 M | $24 M |
| **Total city CAPEX** | **$468 M** | **22.3%** | **$104 M** | **$364 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kut`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.3%** | **$104 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.7%** | **$364 M** | **$73 M / yr** |
| of which planned local bond issuance | 62.2% of total CAPEX | $291 M | $58 M / yr |
| **Total city programme** | **100.0%** | **$468 M** | **$94 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $631 M | $527 M (83.5%) | $648 M | **$1.18 bn** |
| **Default** | 2.00× | $842 M | $738 M (87.6%) | $907 M | **$1.64 bn** |
| High | 3.00× | $1.26 bn | $1.16 bn (91.8%) | $1.42 bn | **$2.58 bn** |

At the default 2.00× case, OSR's $104 M external requirement is 87.6% below the illustrative foreign-company requirement of $842 M; the associated lifetime external-interest saving is $907 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$44 M / yr** | $107 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$220 M cumulative** | $536 |
| Lifecycle envelope (yr 1–40, high scenario) | **$220 M cumulative** | $536 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $3,284 |

_Population basis: 410,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $32 M / yr → $32 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $104 M | 4.5% | 40 y, 5 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $291 M | 8.5% | 40 y, 5 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $73 M | — | — | — |
| **Total** | **100%** | **$468 M** | | | **$32 M / yr** |
...
| Traction energy (102.1 GWh / yr) | 21,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.8 GWh/yr + dedicated solar plant 42.7 MW / 93.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $512 k |
| Labour (305 FTE) | driverless roster: OCC/remote 69, station/platform 66, passenger service 49, fleet maintenance 59, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.9 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 21,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.5 M train-km / yr (25.5 M car-km / yr). On-site PV covers 20.8 GWh/yr and the dedicated solar plant adds 93.5 GWh/yr against 102.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 101 trainsets, 17 stations, 46.4 route-km, 3 lines, and 21,583 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 179 | 286 | 25 |
...
| **Total revenue** | **$77 M / yr** | **$121 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 616% | 975% | 100% |
...
_Commercial-revenue assumptions: 2,600 m² of station shop/kiosk leases at $30/m²/month and 512 advertising boards at $266/board/month, with occupancy derates applied._
...
| Avoided CO2e | $2.2 M / yr | $3.5 M / yr | 27.6–44.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$87 M / yr** | **$139 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 11,134 trips/school day; 2.4 M access-events/yr | 17,815 trips/school day; 3.9 M access-events/yr |
| Healthcare | 2 healthcare anchors | 16,874 trips/day; 6.2 M access-events/yr | 26,998 trips/day; 9.9 M access-events/yr |
| Commerce | 9 major/terminal/interchange nodes | 43,307 trips/trading day; 14.3 M access-events/yr | 69,292 trips/trading day; 22.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $364 M | 78% of $468 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $582 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $116 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,932 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $434 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$468 M** |
| Imported / external-capital requirement | $104 M (22.3%) |
| Local-content / local-funding requirement | $364 M (77.7%) |
| Default foreign-turnkey external-capital comparison | $842 M; OSR saves $738 M (87.6%) |
| Lifetime external interest and combined financing saving | $907 M interest; $1.64 bn capital + interest |
| 15%–25% planning risk envelope | $538 M–$585 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $135 M / $489 M |
| Low/high project IRR | 10.8% / 16.6% |
| Low/high steady-state DSCR | 1.99 / 3.38 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,802.05 train-km; 14,533.15 kWh consumed; 12,517.25 kWh charged; 32 depot services completed; minimum SoC 66%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,104.09 train-km; 162,131.86 kWh consumed; 151,117.03 kWh charged; 475 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 93.1% of scheduled train-km delivered; 87 SoC warnings; 6 energy-adapted off-peak departures, maximum 28 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 92.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.7% / 90% | pass |
| 50% charging-contact availability | 20.0% | 93.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 78.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 91.6% / 90% | pass |
...
|---|---|
| ![Kut energy and battery simulation dashboard](engineering/screenshots/kut-simulation-dashboard.png) | ![Kut simulator network visualizer](engineering/screenshots/kut-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 18 civil segments, and 0 input findings |
...
|---|---|
| ![Kut QGIS engineering layers](engineering/screenshots/kut-qgis-engineering-map.png) | ![Kut SUMO timetable validation](engineering/screenshots/kut-sumo-validation.png) |
...
scripts/regenerate-city.sh kut
```
