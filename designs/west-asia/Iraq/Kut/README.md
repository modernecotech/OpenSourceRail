...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **64.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 365 MWh/day | 28,145 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 281 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 64.7 MW / 323 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 64,690 kW @ $700/kW | $45 M |
| Grid interconnection / PPA tie-in | 64,690 kW @ $100/kW | $6.5 M |
| Annual generation proxy | 64.7 MW × 5.0 peak-sun-h/day × 365 d/yr | 118.1 GWh/yr |
...
| Per-capita (city pop) | $2,543 / person |
...
|---|---|---|
| Construction (years 1–5) | **$58 M / yr** | $142 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $81 |
| Lifecycle envelope (yr 1–40, low scenario) | **$292 M cumulative** | $712 |
| Lifecycle envelope (yr 1–40, high scenario) | **$292 M cumulative** | $712 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.46 bn cumulative** | $3,561 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $834 M | 2.0% | 40 y, 5 y grace | $33 M / yr |
| Government equity (no debt service) | 20% | $209 M | — | — | — |
| **Total** | **100%** | **$1.04 bn** | | | **$33 M / yr** |
...
| Traction energy (133.1 GWh / yr) | 28,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.5 GWh/yr + dedicated solar plant 64.7 MW / 118.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $776 k |
| Labour (406 FTE) | driverless roster: OCC/remote 65, station/platform 124, passenger service 44, fleet maintenance 65, infrastructure/energy 72, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $2.6 M |
| **OPEX subtotal** | | **$29 M / yr** |

_Annual service work: 28,145 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.1 M train-km / yr (33.3 M car-km / yr). On-site PV covers 30.5 GWh/yr and the dedicated solar plant adds 118.1 GWh/yr against 133.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 23.9 M |
| Annual paid trips / city resident | 154 | 246 | 58 |
...
| Avoided CO2e | $2.3 M / yr | $3.6 M / yr | 28.5–45.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Entertainment / community activity supported | $14 M / yr | $22 M / yr | 11% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 10,911 trips/school day; 2.4 M access-events/yr | 17,458 trips/school day; 3.8 M access-events/yr |
| Healthcare | 2 healthcare anchors | 12,442 trips/day; 4.5 M access-events/yr | 19,907 trips/day; 7.3 M access-events/yr |
...
| Entertainment / community | 20.5 h/day service span | 19,749 trips/activity day; 5.9 M access-events/yr | 31,598 trips/activity day; 9.5 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $567 M | 54% of $1.04 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $907 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $181 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 31,088 job-years | retained CAPEX ÷ (4.0 × median annual income) |
