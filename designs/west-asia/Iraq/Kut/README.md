...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$670 M (87.2%) of external capital** and **$824 M of external interest**. Capital plus saved interest totals **$1.49 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| **Total city CAPEX** | **$427 M** | **23.0%** | **$98 M** | **$329 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.0%** | **$98 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.0%** | **$329 M** | **$66 M / yr** |
| of which planned local bond issuance | 61.6% of total CAPEX | $263 M | $53 M / yr |
| **Total city programme** | **100.0%** | **$427 M** | **$85 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $576 M | $478 M (83.0%) | $588 M | **$1.07 bn** |
| **Default** | 2.00× | $768 M | $670 M (87.2%) | $824 M | **$1.49 bn** |
| High | 3.00× | $1.15 bn | $1.05 bn (91.5%) | $1.30 bn | **$2.35 bn** |

At the default 2.00× case, OSR's $98 M external requirement is 87.2% below the illustrative foreign-company requirement of $768 M; the associated lifetime external-interest saving is $824 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $97 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$200 M cumulative** | $487 |
| Lifecycle envelope (yr 1–40, high scenario) | **$200 M cumulative** | $487 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.23 bn cumulative** | $2,990 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $98 M | 4.5% | 40 y, 5 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $263 M | 8.5% | 40 y, 5 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $66 M | — | — | — |
| **Total** | **100%** | **$427 M** | | | **$29 M / yr** |
...
| Annual paid trips / city resident | 179 | 286 | 23 |
| Farebox revenue | $74 M / yr | $119 M / yr | $9.4 M / yr |
...
| Revenue / OPEX recovery | 657% | 1040% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $329 M | 77% of $427 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 18,019 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $392 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$427 M** |
| Imported / external-capital requirement | $98 M (23.0%) |
| Local-content / local-funding requirement | $329 M (77.0%) |
| Default foreign-turnkey external-capital comparison | $768 M; OSR saves $670 M (87.2%) |
| Lifetime external interest and combined financing saving | $824 M interest; $1.49 bn capital + interest |
| 15%–25% planning risk envelope | $491 M–$533 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $174 M / $528 M |
| Low/high project IRR | 11.8% / 17.9% |
| Low/high steady-state DSCR | 2.21 / 3.73 |
