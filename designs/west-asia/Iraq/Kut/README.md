...
| Per-capita (city pop) | $1,188 / person |
...
|---|---|---|
| Construction (years 1–5) | **$37 M / yr** | $90 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$185 M cumulative** | $451 |
| Lifecycle envelope (yr 1–40, high scenario) | **$185 M cumulative** | $451 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$966 M cumulative** | $2,357 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $390 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $97 M | — | — | — |
| **Total** | **100%** | **$487 M** | | | **$22 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $280 M | 57% of $487 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 15,355 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$487 M** |
| 15%–25% planning risk envelope | $560 M–$609 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $120 M / $473 M |
| Low/high project IRR | 10.4% / 16.1% |
| Low/high steady-state DSCR | 2.87 / 4.87 |
