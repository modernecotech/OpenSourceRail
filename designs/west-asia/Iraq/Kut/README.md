...
|---|---:|---:|---:|---:|
| Civil works | $233 M | 35% | $81 M | $151 M |
...
| Residual signalling / train control | $2.3 M | 80% | $1.9 M | $464 k |
| Charging microgrids | $1.8 M | 55% | $963 k | $787 k |
| EPC / project services | $28 M | 45% | $13 M | $16 M |
| **Total city CAPEX** | **$468 M** | **43.2%** | **$202 M** | **$266 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.2%** | **$202 M** | **$40 M / yr** |
| **Local capital for domestic procurement / payroll** | **56.8%** | **$266 M** | **$53 M / yr** |
| of which planned local bond issuance | 45.5% of total CAPEX | $213 M | $43 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$38 M / yr** | $92 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $75 |
| Lifecycle envelope (yr 1–40, low scenario) | **$189 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, high scenario) | **$189 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.26 bn cumulative** | $3,085 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 43% | $202 M | 4.5% | 40 y, 5 y grace | $12 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $213 M | 8.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $53 M | — | — | — |
| **Total** | **100%** | **$468 M** | | | **$31 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $266 M | 57% of $468 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 14,569 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $202 M (43.2%) |
| Local-content / local-funding requirement | $266 M (56.8%) |
| 15%–25% planning risk envelope | $538 M–$585 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $135 M / $489 M |
| Low/high project IRR | 10.8% / 16.6% |
| Low/high steady-state DSCR | 2.09 / 3.54 |
