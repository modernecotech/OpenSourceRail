...
|---|---|---|---|---|
| line-1 | 22.4 km | 12 | 58 | NW Outer ↔ SE Outer |
| line-2 |  9.4 km | 6 | 26 | NW Mid ↔ SW Inner |
| line-3 | 14.6 km | 9 | 38 | E Mid ↔ NW Mid |
| **Total** | **46.4 km** | **27 unique** | **122** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **39.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 504 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 205 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 39.2 MW / 235 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 180 kWh | 278 kWh | 79 kWh | 4.5 km / 36 kWh |
| line-2 | 6 | 76 kWh | 131 kWh | 47 kWh | 2.2 km / 18 kWh |
| line-3 | 9 | 118 kWh | 192 kWh | 62 kWh | 2.6 km / 21 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,237 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 39,237 kW @ $100/kW | $3.9 M |
| Annual generation proxy | 39.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 85.9 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $100 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$205 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$205 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $2,616 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $433 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $108 M | — | — | — |
| **Total** | **100%** | **$541 M** | | | **$25 M / yr** |
...
| Traction energy (102.1 GWh / yr) | 21,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 39.2 MW / 85.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $471 k |
| Labour (347 FTE) | driverless roster: OCC/remote 77, station/platform 91, passenger service 49, fleet maintenance 65, infrastructure/energy 44, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.2 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 21,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.5 M train-km / yr (25.5 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 85.9 GWh/yr against 102.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 122 trainsets, 27 stations, 46.4 route-km, 3 lines, and 21,583 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 179 | 286 | 26 |
...
| Revenue / OPEX recovery | 554% | 873% | 100% |
...
_Commercial-revenue assumptions: 3,576 m² of station shop/kiosk leases at $30/m²/month and 712 advertising boards at $266/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$85 M / yr** | **$136 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $310 M | 57% of $541 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,021 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $509 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$541 M** |
| 15%–25% planning risk envelope | $622 M–$676 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $71 M / $425 M |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,804.06 train-km; 14,549.26 kWh consumed; 15,121.42 kWh charged; 29 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,925.76 train-km; 176,824.98 kWh consumed; 179,735.01 kWh charged; 499 depot services completed (6 active at cutoff); minimum SoC 67%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 42.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 67.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.6% / 60% | pass |
| ten-hour single charging-pad outage | 41.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 18 civil segments, and 0 input findings |
