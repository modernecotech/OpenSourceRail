...
| Manufacturing schedule rows | 1,047 |
| Manufacturing material/BOM rows | 16,218 |
| Manufacturing QA verification rows | 1,047 |
| Construction QA action rows | 984 |
| Maintenance handover schedule rows | 1,238 |
| Manufacturing rows with material refs | 1,047 / 1,047 |
| Manufacturing rows with verification refs | 1,047 / 1,047 |
| Manufacturing rows linked to QA actions | 1,047 / 1,047 |
