# Hillah Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,340 |
| Manufacturing material/BOM rows | 20,034 |
| Manufacturing QA verification rows | 1,340 |
| Construction QA action rows | 1,243 |
| Maintenance handover schedule rows | 1,599 |
| Manufacturing rows with material refs | 1,340 / 1,340 |
| Manufacturing rows with verification refs | 1,340 / 1,340 |
| Manufacturing rows linked to QA actions | 1,340 / 1,340 |
