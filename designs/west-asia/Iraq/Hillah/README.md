...
|---|---|---|---|---|
| line-1 | 19.5 km | 13 | 51 | NE Mid ↔ S Outer |
| line-2 | 18.9 km | 11 | 50 | N Outer ↔ SW Mid |
| line-3 | 19.5 km | 11 | 51 | W Outer ↔ NE Mid |
| **Total** | **57.9 km** | **35 unique** | **152** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **50.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 493 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 78 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 50.0 MW / 300 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 157 kWh | 274 kWh | 101 kWh | 2.0 km / 16 kWh |
| line-2 | 10 | 152 kWh | 245 kWh | 78 kWh | 5.5 km / 44 kWh |
| line-3 | 10 | 157 kWh | 253 kWh | 80 kWh | 5.8 km / 47 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 50,046 kW @ $700/kW | $35 M |
| Grid interconnection / PPA tie-in | 50,046 kW @ $100/kW | $5.0 M |
| Annual generation proxy | 50.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 109.6 GWh/yr |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$228 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, high scenario) | **$228 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.19 bn cumulative** | $1,703 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $481 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
...
| Traction energy (127.3 GWh / yr) | 26,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 32.0 GWh/yr + dedicated solar plant 50.0 MW / 109.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $601 k |
| Labour (419 FTE) | driverless roster: OCC/remote 94, station/platform 120, passenger service 49, fleet maintenance 81, infrastructure/energy 54, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 26,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.6 M train-km / yr (31.8 M car-km / yr). On-site PV covers 32.0 GWh/yr and the dedicated solar plant adds 109.6 GWh/yr against 127.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 152 trainsets, 35 stations, 57.9 route-km, 3 lines, and 26,907 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 11.5 M |
...
| **Total revenue** | **$79 M / yr** | **$123 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 492% | 771% | 100% |
...
| Operating surplus after OPEX (before debt support) | $63 M / yr | $107 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,056 m² of station shop/kiosk leases at $30/m²/month and 980 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $29 M / yr | $46 M / yr | 21% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 10,747 trips/school day; 2.4 M access-events/yr | 17,195 trips/school day; 3.8 M access-events/yr |
| Healthcare | 12 healthcare anchors | 20,490 trips/day; 7.5 M access-events/yr | 32,784 trips/day; 12.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $339 M | 56% of $601 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $542 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $108 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 18,565 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $17 M / $370 M |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,147.58 train-km; 17,319.59 kWh consumed; 17,819.36 kWh charged; 24 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,743.87 train-km; 223,744.96 kWh consumed; 228,015.50 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 37%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 24.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 37.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.3% / 60% | pass |
| ten-hour single charging-pad outage | 37.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
