...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$718 M (86.5%) of external capital** and **$883 M of external interest**. Capital plus saved interest totals **$1.60 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 57.9 km |
...
- Anchor-weighted coverage: 65.7%
- Catchment population: **≈ 459,900** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **54.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 480 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 26,907 train-km/day | One-way train journeys × route length |
| Annual service work | 10.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 349 MWh/day | 31.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 283 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 54.2 MW / 325 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 157 kWh | 229 kWh | 56 kWh | 7.4 km / 60 kWh |
| line-2 | 7 | 152 kWh | 229 kWh | 61 kWh | 7.0 km / 57 kWh |
| line-3 | 7 | 157 kWh | 229 kWh | 56 kWh | 7.0 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (55.5 km @ $2.58 M/km) | $143 M |
| Elevated (2.4 km @ $9.75 M/km) | $23 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$171 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 54,186 kW @ $700/kW | $38 M |
| Grid interconnection / PPA tie-in | 54,186 kW @ $100/kW | $5.4 M |
| Annual generation proxy | 54.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 118.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 57.9 km × $0.050 M/km | $2.9 M |
...
| **Total city CAPEX** | **$461 M** | **24.2%** | **$112 M** | **$349 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hillah`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$112 M** | **$22 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$349 M** | **$70 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $280 M | $56 M / yr |
| **Total city programme** | **100.0%** | **$461 M** | **$92 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $623 M | $511 M (82.0%) | $628 M | **$1.14 bn** |
| **Default** | 2.00× | $830 M | $718 M (86.5%) | $883 M | **$1.60 bn** |
| High | 3.00× | $1.25 bn | $1.13 bn (91.0%) | $1.39 bn | **$2.53 bn** |

At the default 2.00× case, OSR's $112 M external requirement is 86.5% below the illustrative foreign-company requirement of $830 M; the associated lifetime external-interest saving is $883 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $61 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$214 M cumulative** | $305 |
| Lifecycle envelope (yr 1–40, high scenario) | **$214 M cumulative** | $305 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.32 bn cumulative** | $1,886 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $112 M | 4.5% | 40 y, 5 y grace | $6.4 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $280 M | 8.5% | 40 y, 5 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $70 M | — | — | — |
| **Total** | **100%** | **$461 M** | | | **$32 M / yr** |
...
| Traction energy (127.3 GWh / yr) | 26,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.1 GWh/yr + dedicated solar plant 54.2 MW / 118.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $650 k |
| Labour (355 FTE) | driverless roster: OCC/remote 81, station/platform 80, passenger service 49, fleet maintenance 73, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 26,907 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.6 M train-km / yr (31.8 M car-km / yr). On-site PV covers 24.1 GWh/yr and the dedicated solar plant adds 118.7 GWh/yr against 127.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 125 trainsets, 24 stations, 57.9 route-km, 3 lines, and 26,907 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.0 M |
| Annual paid trips / city resident | 105 | 168 | 14 |
...
| Revenue / OPEX recovery | 593% | 935% | 100% |
...
_Commercial-revenue assumptions: 3,320 m² of station shop/kiosk leases at $30/m²/month and 656 advertising boards at $266/board/month, with occupancy derates applied._
...
| Healthcare | 8 healthcare anchors | 19,552 trips/day; 7.1 M access-events/yr | 31,284 trips/day; 11.4 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 42,687 trips/trading day; 14.1 M access-events/yr | 68,299 trips/trading day; 22.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $349 M | 76% of $461 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,158 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$461 M** |
| Imported / external-capital requirement | $112 M (24.2%) |
| Local-content / local-funding requirement | $349 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $830 M; OSR saves $718 M (86.5%) |
| Lifetime external interest and combined financing saving | $883 M interest; $1.60 bn capital + interest |
| 15%–25% planning risk envelope | $530 M–$577 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $140 M / $494 M |
| Low/high project IRR | 10.9% / 16.8% |
| Low/high steady-state DSCR | 2.03 / 3.44 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,224.23 train-km; 17,937.88 kWh consumed; 14,883.11 kWh charged; 27 depot services completed; minimum SoC 65%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,164.22 train-km; 219,066.24 kWh consumed; 206,674.43 kWh charged; 481 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 279 SoC warnings; 32 energy-adapted off-peak departures, maximum 16 min headway |
...
|---|---|
| ![Hillah energy and battery simulation dashboard](engineering/screenshots/hillah-simulation-dashboard.png) | ![Hillah simulator network visualizer](engineering/screenshots/hillah-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 1 interchange complexes, 12 civil segments, and 0 input findings |
...
|---|---|
| ![Hillah QGIS engineering layers](engineering/screenshots/hillah-qgis-engineering-map.png) | ![Hillah SUMO timetable validation](engineering/screenshots/hillah-sumo-validation.png) |
