...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.7%** | **$220 M** | **$44 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.3%** | **$272 M** | **$54 M / yr** |
| of which planned local bond issuance | 44.3% of total CAPEX | $218 M | $44 M / yr |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$196 M cumulative** | $280 |
| Lifecycle envelope (yr 1–40, high scenario) | **$196 M cumulative** | $280 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.32 bn cumulative** | $1,891 |
...
| Local-currency sovereign / project bonds for local content | 44% | $218 M | 8.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $54 M | — | — | — |
| **Total** | **100%** | **$492 M** | | | **$32 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $272 M | 55% of $492 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $435 M | retained CAPEX × 1.6 local supplier / wage multiplier |
...
| Imported / external-capital requirement | $220 M (44.7%) |
| Local-content / local-funding requirement | $272 M (55.3%) |
