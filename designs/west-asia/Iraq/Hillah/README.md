...
| Depots | €40 M |
| Rolling stock | €204 M |
| Residual train-control wayside + power | €56 M |
| EPC overhead (7%) | €48 M |
| **CAPEX total** | **€741 M** |
...
|---|---|---|
| Construction (years 1–5) | **€56 M / yr** | €80 |
| Steady-state, low-ridership (year 6+) | **€64 M / yr** | €92 |
| Steady-state, high-ridership (year 6+) | **€57 M / yr** | €81 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.56 bn cumulative** | €2,233 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.41 bn cumulative** | €2,021 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €4.5 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €445 M | 4.0% | 25 y, 5 y grace | €33 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €185 M | 8.5% | 25 y, 5 y grace | €20 M / yr |
| Government equity (no debt service) | 15% | €111 M | — | — | — |
| **Total** | **100%** | **€741 M** | | | **€52 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €18 M / yr + bonds €16 M / yr = **€34 M / yr** total — plus the equity tranche amortised across construction (€22 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Operating shortfall (gov subsidy required) | €12 M / yr | €4.5 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€64 M / yr** | **€57 M / yr** |
