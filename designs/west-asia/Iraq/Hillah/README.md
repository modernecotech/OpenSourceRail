...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 69.0 km × €0.1 M/km | €6.9 M |
...
|---|---|---|
| Construction (years 1–5) | **€51 M / yr** | €73 |
| Steady-state, low-ridership (year 6+) | **€57 M / yr** | €82 |
| Steady-state, high-ridership (year 6+) | **€50 M / yr** | €71 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.40 bn cumulative** | €1,994 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.25 bn cumulative** | €1,782 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€9.5 M / yr (low) → €2.1 M / yr (high)._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €344 k |
...
| Operating shortfall (gov subsidy required) | €9.5 M / yr | €2.1 M / yr |
