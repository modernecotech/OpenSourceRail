...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$769 M (86.9%) of external capital** and **$945 M of external interest**. Capital plus saved interest totals **$1.71 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (55.5 km @ $3.0 M/km) | $166 M |
...
| Per-capita (city pop) | $702 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $199 M | 15% | $30 M | $170 M |
...
| **Total city CAPEX** | **$492 M** | **23.7%** | **$116 M** | **$375 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$116 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$375 M** | **$75 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $300 M | $60 M / yr |
| **Total city programme** | **100.0%** | **$492 M** | **$98 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $664 M | $547 M (82.5%) | $673 M | **$1.22 bn** |
| **Default** | 2.00× | $885 M | $769 M (86.9%) | $945 M | **$1.71 bn** |
| High | 3.00× | $1.33 bn | $1.21 bn (91.2%) | $1.49 bn | **$2.70 bn** |

At the default 2.00× case, OSR's $116 M external requirement is 86.9% below the illustrative foreign-company requirement of $885 M; the associated lifetime external-interest saving is $945 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$46 M / yr** | $65 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$229 M cumulative** | $327 |
| Lifecycle envelope (yr 1–40, high scenario) | **$229 M cumulative** | $327 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.41 bn cumulative** | $2,014 |
...
| Local-currency sovereign / project bonds for local content | 61% | $300 M | 8.5% | 40 y, 5 y grace | $27 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $75 M | — | — | — |
| **Total** | **100%** | **$492 M** | | | **$34 M / yr** |
...
| Annual paid trips / city resident | 105 | 168 | 15 |
...
| Revenue / OPEX recovery | 568% | 896% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $375 M | 76% of $492 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 20,576 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$492 M** |
| Imported / external-capital requirement | $116 M (23.7%) |
| Local-content / local-funding requirement | $375 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $885 M; OSR saves $769 M (86.9%) |
| Lifetime external interest and combined financing saving | $945 M interest; $1.71 bn capital + interest |
| 15%–25% planning risk envelope | $565 M–$615 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $112 M / $465 M |
| Low/high project IRR | 10.2% / 15.9% |
| Low/high steady-state DSCR | 1.88 / 3.20 |
