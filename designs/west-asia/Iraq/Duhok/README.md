...
| Bucket | Value |
|---|---|
| At-grade (51.0 km @ $0.85 M/km) | $43 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.2 km × $0.015 M/km | $798 k |
...
|---|---|---|
| Construction (years 1–5) | **$11 M / yr** | $31 |
| Steady-state, low-ridership (year 6+) | **$3.2 M / yr** | $9 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$119 M cumulative** | $330 |
| Lifecycle envelope (yr 1–25, high scenario) | **$56 M cumulative** | $154 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$56 M cumulative** | $154 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $89 M | 4.0% | 25 y, 5 y grace | $6.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $37 M | 8.5% | 25 y, 5 y grace | $3.9 M / yr |
| Government equity (no debt service) | 15% | $22 M | — | — | — |
| **Total** | **100%** | **$148 M** | | | **$10 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $3.5 M / yr + bonds $3.1 M / yr = **$6.7 M / yr** total — plus the equity tranche amortised across construction ($4.4 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,800 | 54,000 | 40,218 |
| Daily paid trips / population | 8% | 15% | 11% |
| Annual paid trips | 10.5 M | 19.7 M | 14.7 M |
| Farebox revenue | $8.0 M / yr | $15 M / yr | $11 M / yr |
...
| Revenue / OPEX + debt-service recovery | 80% | 124% | 100% |
