...
| Revenue fleet | 133 × 3-car trainsets |
| Revenue fleet passenger capacity | 47,880 AW2 pax (63,840 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 18.5 km | 12 | 48 | E Outer ↔ W Outer |
| line-2 | 18.3 km | 11 | 46 | W Outer ↔ E Outer |
| line-3 | 20.4 km | 12 | 54 | W Outer ↔ E Outer |
| **Total** | **57.3 km** | **35 unique** | **148** | |
...
| Revenue fleet capacity | 47,880 AW2 pax (63,840 AW3 crush) |
| Total fleet capacity | 53,280 AW2 pax (71,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 133 × 360 = **47,880 AW2 passengers** (63,840 AW3 crush)
- **Total fleet passenger capacity:** 148 × 360 = **53,280 AW2 passengers** (71,040 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 17.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 509 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 67 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 61 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 77.7 MW / 326 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 133 kWh | 253 kWh | 106 kWh | 2.0 km / 15 kWh |
| line-2 | 10 | 132 kWh | 212 kWh | 67 kWh | 4.2 km / 30 kWh |
| line-3 | 11 | 147 kWh | 278 kWh | 116 kWh | 4.3 km / 31 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (55.7 km @ $3.0 M/km) | $167 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 148 | $900 k | $133 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 444 | $60 k | $27 M |
| High sensitivity check | 444 | $120 k | $53 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 77,733 kW @ $700/kW | $54 M |
| Grid interconnection / PPA tie-in | 77,733 kW @ $100/kW | $7.8 M |
| Annual generation proxy | 77.7 MW × 4.2 peak-sun-h/day × 365 d/yr | 119.2 GWh/yr |
...
| Per-capita (city pop) | $1,722 / person |
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $131 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $79 |
| Lifecycle envelope (yr 1–40, low scenario) | **$236 M cumulative** | $654 |
| Lifecycle envelope (yr 1–40, high scenario) | **$236 M cumulative** | $654 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.23 bn cumulative** | $3,415 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $496 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $124 M | — | — | — |
| **Total** | **100%** | **$620 M** | | | **$28 M / yr** |
...
| Traction energy (126.0 GWh / yr) | 26,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.4 GWh/yr + dedicated solar plant 77.7 MW / 119.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $933 k |
| Labour (416 FTE) | driverless roster: OCC/remote 90, station/platform 122, passenger service 49, fleet maintenance 80, infrastructure/energy 54, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 26,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.5 M train-km / yr (31.5 M car-km / yr). On-site PV covers 22.4 GWh/yr and the dedicated solar plant adds 119.2 GWh/yr against 126.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 148 trainsets, 35 stations, 57.3 route-km, 3 lines, and 26,637 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 11.7 M |
| Annual paid trips / city resident | 204 | 326 | 32 |
...
| Revenue / OPEX recovery | 487% | 763% | 100% |
...
_Commercial-revenue assumptions: 5,112 m² of station shop/kiosk leases at $30/m²/month and 988 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $29 M / yr | $46 M / yr | 20% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 8 education anchors | 15,581 trips/school day; 3.4 M access-events/yr | 24,930 trips/school day; 5.5 M access-events/yr |
| Healthcare | 8 healthcare anchors | 17,922 trips/day; 6.5 M access-events/yr | 28,675 trips/day; 10.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $343 M | 55% of $620 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 18,831 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$620 M** |
| 15%–25% planning risk envelope | $713 M–$775 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $547 k / $354 M |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,141.29 train-km; 15,416.32 kWh consumed; 16,729.67 kWh charged; 25 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,474.98 train-km; 197,807.77 kWh consumed; 202,083.17 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 71%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 45.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 70.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.9% / 60% | pass |
| ten-hour single charging-pad outage | 70.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 2 interchange complexes, 6 civil segments, and 0 input findings |
