...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$806 M (86.3%) of external capital** and **$990 M of external interest**. Capital plus saved interest totals **$1.80 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 57.3 km |
| Revenue fleet | 110 × 3-car trainsets |
| Revenue fleet passenger capacity | 39,600 AW2 pax (52,800 AW3 crush) |
...
| Revenue fleet capacity | 39,600 AW2 pax (52,800 AW3 crush) |
| Total fleet capacity | 43,920 AW2 pax (58,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 110 × 360 = **39,600 AW2 passengers** (52,800 AW3 crush)
- **Total fleet passenger capacity:** 122 × 360 = **43,920 AW2 passengers** (58,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 59.9%
- Catchment population: **≈ 215,640** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **81.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 15.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 505 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 67 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 47 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 26,637 train-km/day | One-way train journeys × route length |
| Annual service work | 10.5 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 345 MWh/day | 31.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 298 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 81.5 MW / 342 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 133 kWh | 229 kWh | 82 kWh | 4.0 km / 29 kWh |
| line-2 | 7 | 132 kWh | 229 kWh | 84 kWh | 4.6 km / 33 kWh |
| line-3 | 7 | 147 kWh | 229 kWh | 67 kWh | 4.9 km / 35 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (54.5 km @ $2.58 M/km) | $141 M |
| Elevated (2.8 km @ $9.75 M/km) | $27 M |
| Elevated-interchange premium (3 sites @ $4.50 M) | $14 M |
| **Civil subtotal** | **$181 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 122 | $900 k | $110 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 366 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 366 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 81,528 kW @ $700/kW | $57 M |
| Grid interconnection / PPA tie-in | 81,528 kW @ $100/kW | $8.2 M |
| Annual generation proxy | 81.5 MW × 4.2 peak-sun-h/day × 365 d/yr | 125.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 57.3 km × $0.050 M/km | $2.9 M |
...
| Per-capita (city pop) | $1,440 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $181 M | 15% | $27 M | $154 M |
| Stations | $119 M | 20% | $24 M | $95 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $110 M | 35% | $38 M | $71 M |
| Dedicated solar plant | $65 M | 45% | $29 M | $36 M |
| Residual signalling / train control | $2.9 M | 50% | $1.4 M | $1.4 M |
| Charging microgrids | $2.5 M | 40% | $990 k | $1.5 M |
| EPC / project services | $30 M | 15% | $4.4 M | $25 M |
| **Total city CAPEX** | **$518 M** | **24.6%** | **$128 M** | **$391 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh duhok`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$128 M** | **$26 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$391 M** | **$78 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $313 M | $63 M / yr |
| **Total city programme** | **100.0%** | **$518 M** | **$104 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $700 M | $572 M (81.8%) | $704 M | **$1.28 bn** |
| **Default** | 2.00× | $933 M | $806 M (86.3%) | $990 M | **$1.80 bn** |
| High | 3.00× | $1.40 bn | $1.27 bn (90.9%) | $1.56 bn | **$2.84 bn** |

At the default 2.00× case, OSR's $128 M external requirement is 86.3% below the illustrative foreign-company requirement of $933 M; the associated lifetime external-interest saving is $990 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$48 M / yr** | $133 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $99 |
| Lifecycle envelope (yr 1–40, low scenario) | **$240 M cumulative** | $666 |
| Lifecycle envelope (yr 1–40, high scenario) | **$240 M cumulative** | $666 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.48 bn cumulative** | $4,118 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $128 M | 4.5% | 40 y, 5 y grace | $7.3 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $313 M | 8.5% | 40 y, 5 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $78 M | — | — | — |
| **Total** | **100%** | **$518 M** | | | **$36 M / yr** |
...
| Traction energy (126.0 GWh / yr) | 26,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 17.3 GWh/yr + dedicated solar plant 81.5 MW / 125.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $978 k |
| Labour (362 FTE) | driverless roster: OCC/remote 77, station/platform 94, passenger service 49, fleet maintenance 72, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 26,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.5 M train-km / yr (31.5 M car-km / yr). On-site PV covers 17.3 GWh/yr and the dedicated solar plant adds 125.0 GWh/yr against 126.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 122 trainsets, 22 stations, 57.3 route-km, 3 lines, and 26,637 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.5 M |
| Annual paid trips / city resident | 204 | 326 | 29 |
...
| **Total revenue** | **$78 M / yr** | **$122 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 555% | 874% | 100% |
...
_Commercial-revenue assumptions: 4,048 m² of station shop/kiosk leases at $30/m²/month and 764 advertising boards at $266/board/month, with occupancy derates applied._
...
| Avoided road congestion | $15 M / yr | $24 M / yr | 189 M - 302 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.7 M / yr | $4.4 M / yr | 34.0–54.4 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.6 M / yr | $12 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $31 M / yr | $49 M / yr | 22% of paid trips × $1.90 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $391 M | 75% of $518 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $625 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $125 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 21,425 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $65 M |
| **Reconciled project CAPEX** | **$518 M** |
| Imported / external-capital requirement | $128 M (24.6%) |
| Local-content / local-funding requirement | $391 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $933 M; OSR saves $806 M (86.3%) |
| Lifetime external interest and combined financing saving | $990 M interest; $1.80 bn capital + interest |
| 15%–25% planning risk envelope | $596 M–$648 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $91 M / $445 M |
| Low/high project IRR | 9.7% / 15.3% |
| Low/high steady-state DSCR | 1.79 / 3.05 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,163.58 train-km; 15,576.64 kWh consumed; 15,189.15 kWh charged; 27 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,115.89 train-km; 188,020.92 kWh consumed; 190,490.26 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 32%; 0 onboard emergencies; 0 invariant violations; 98.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 97.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 96.8% / 90% | pass |
| 50% charging-contact availability | 31.7% | 98.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 84.6% / 60% | pass |
| ten-hour single charging-pad outage | 31.7% | 98.0% / 90% | pass |
...
|---|---|
| ![Duhok energy and battery simulation dashboard](engineering/screenshots/duhok-simulation-dashboard.png) | ![Duhok simulator network visualizer](engineering/screenshots/duhok-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 3 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Duhok QGIS engineering layers](engineering/screenshots/duhok-qgis-engineering-map.png) | ![Duhok SUMO timetable validation](engineering/screenshots/duhok-sumo-validation.png) |
...
scripts/regenerate-city.sh duhok
```
