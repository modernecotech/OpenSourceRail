...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 53.2 km × €0.1 M/km | €5.3 M |
...
| Per-capita (city pop) | €1,598 / person |
...
|---|---|---|
| Construction (years 1–5) | **€43 M / yr** | €120 |
| Steady-state, low-ridership (year 6+) | **€51 M / yr** | €141 |
| Steady-state, high-ridership (year 6+) | **€47 M / yr** | €131 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.23 bn cumulative** | €3,430 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.16 bn cumulative** | €3,218 |

_Population basis: 360,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€10 M / yr (low) → €6.5 M / yr (high)._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €266 k |
...
| Operating shortfall (gov subsidy required) | €10 M / yr | €6.5 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€51 M / yr** | **€47 M / yr** |
