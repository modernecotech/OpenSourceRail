...
| Per-capita (city pop) | $1,873 / person |
...
|---|---|---|
| Construction (years 1–5) | **$51 M / yr** | $141 |
| Steady-state, low-ridership (year 6+) | **$52 M / yr** | $144 |
| Steady-state, high-ridership (year 6+) | **$48 M / yr** | $132 |
| Steady-state, operating-neutral revenue case | **$48 M / yr** | $132 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.29 bn cumulative** | $3,584 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.21 bn cumulative** | $3,349 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.21 bn cumulative** | $3,349 |

_Population basis: 360,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.2 M / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 34,603 | 57,672 | 49,831 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 10% | 16% | 14% |
| Annual paid trips | 12.6 M | 21.1 M | 18.2 M |
| Farebox revenue | $9.6 M / yr | $16 M / yr | $14 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| **Total revenue** | **$14 M / yr** | **$21 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 77% | 112% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $52 M / yr | $48 M / yr | **$48 M / yr** |
