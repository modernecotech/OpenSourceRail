...
| Bucket | Value |
|---|---|
| At-grade (51.0 km @ $1.2 M/km) | $61 M |
...
|---|---|---|
| Construction (years 1–5) | **$14 M / yr** | $38 |
| Steady-state, low-ridership (year 6+) | **$6.2 M / yr** | $17 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$192 M cumulative** | $534 |
| Lifecycle envelope (yr 1–25, high scenario) | **$68 M cumulative** | $190 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$68 M cumulative** | $190 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $109 M | 4.0% | 25 y, 5 y grace | $8.0 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $45 M | 8.5% | 25 y, 5 y grace | $4.8 M / yr |
| Government equity (no debt service) | 15% | $27 M | — | — | — |
| **Total** | **100%** | **$182 M** | | | **$13 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $4.4 M / yr + bonds $3.9 M / yr = **$8.2 M / yr** total — plus the equity tranche amortised across construction ($5.4 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,800 | 54,000 | 51,109 |
| Daily paid trips / population | 8% | 15% | 14% |
| Annual paid trips | 10.5 M | 19.7 M | 18.7 M |
| Farebox revenue | $8.0 M / yr | $15 M / yr | $14 M / yr |
...
| Revenue / OPEX + debt-service recovery | 68% | 104% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $6.2 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $802 k / yr | $0 / yr |
