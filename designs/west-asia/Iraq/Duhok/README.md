...
| Per-capita (city pop) | $1,591 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$218 M cumulative** | $605 |
| Lifecycle envelope (yr 1–40, high scenario) | **$218 M cumulative** | $605 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.14 bn cumulative** | $3,157 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $458 M | 4.5% | 40 y, 5 y grace | $26 M / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $318 M | 56% of $573 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $509 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $102 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,453 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $508 M |
| Timetable-sized dedicated solar CAPEX | $65 M |
| **Reconciled project CAPEX** | **$573 M** |
| 15%–25% planning risk envelope | $659 M–$716 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $43 M / $397 M |
| Low/high project IRR | 8.8% / 14.1% |
| Low/high steady-state DSCR | 2.40 / 4.10 |
