...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 169.9 km × €0.1 M/km | €17 M |
...
|---|---|---|
| Construction (years 1–5) | **€157 M / yr** | €113 |
| Steady-state, low-ridership (year 6+) | **€184 M / yr** | €132 |
| Steady-state, high-ridership (year 6+) | **€169 M / yr** | €122 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.46 bn cumulative** | €3,208 |
| Lifecycle envelope (yr 1–25, high scenario) | **€4.16 bn cumulative** | €2,995 |

_Population basis: 1,390,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€37 M / yr (low) → €22 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €521 M | 8.5% | 25 y, 5 y grace | €55 M / yr |
| Government equity (no debt service) | 15% | €313 M | — | — | — |
| **Total** | **100%** | **€2.08 bn** | | | **€147 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €50 M / yr + bonds €44 M / yr = **€94 M / yr** total — plus the equity tranche amortised across construction (€63 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €847 k |
...
| Operating shortfall (gov subsidy required) | €37 M / yr | €22 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€184 M / yr** | **€169 M / yr** |
