...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.15 bn (87.1%) of external capital** and **$2.65 bn of external interest**. Capital plus saved interest totals **$4.80 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 60.0% |
| Route length (double track) | 168.5 km |
| Revenue fleet | 177 × 4-car trainsets |
| Revenue fleet passenger capacity | 84,960 AW2 pax (113,280 AW3 crush) |
...
| Revenue fleet capacity | 84,960 AW2 pax (113,280 AW3 crush) |
| Total fleet capacity | 95,040 AW2 pax (126,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 177 × 480 = **84,960 AW2 passengers** (113,280 AW3 crush)
- **Total fleet passenger capacity:** 198 × 480 = **95,040 AW2 passengers** (126,720 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 60.0%
- Catchment population: **≈ 834,000** (within ~800 m walk of a station)
...
| **Total installed** | **50** | **19,700 kW** | **113,500 kWh** |

Aggregate station-rail charging power: **75,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **189.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 585 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 93 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 118 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 63,961 train-km/day | One-way train journeys × route length |
| Annual service work | 25.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,105 MWh/day | 100.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 987 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 189.2 MW / 1,135 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 114 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 272 kWh | 612 kWh | 314 kWh | 5.7 km / 62 kWh |
| line-2 | 9 | 216 kWh | 490 kWh | 252 kWh | 4.0 km / 43 kWh |
| line-3 | 6 | 195 kWh | 343 kWh | 128 kWh | 5.4 km / 58 kWh |
| line-4 | 5 | 216 kWh | 331 kWh | 93 kWh | 7.6 km / 82 kWh |
| line-5 | 7 | 247 kWh | 392 kWh | 120 kWh | 7.1 km / 76 kWh |
| line-6 | 12 | 665 kWh | 1,029 kWh | 298 kWh | 12.6 km / 135 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (155.6 km @ $2.58 M/km) | $402 M |
| Elevated (12.8 km @ $9.75 M/km) | $125 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 198 | $1.12 M | $222 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 792 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 792 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 189,183 kW @ $700/kW | $132 M |
| Grid interconnection / PPA tie-in | 189,183 kW @ $100/kW | $19 M |
| Annual generation proxy | 189.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 414.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$151 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 168.5 km × $0.050 M/km | $8.4 M |
...
| Stations | $315 M | 20% | $63 M | $252 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $222 M | 35% | $78 M | $144 M |
| Dedicated solar plant | $151 M | 45% | $68 M | $83 M |
| Residual signalling / train control | $8.4 M | 50% | $4.2 M | $4.2 M |
| Charging microgrids | $17 M | 40% | $6.7 M | $10.0 M |
| EPC / project services | $80 M | 15% | $12 M | $68 M |
| **Total city CAPEX** | **$1.37 bn** | **23.3%** | **$319 M** | **$1.05 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh karbala`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.3%** | **$319 M** | **$64 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.7%** | **$1.05 bn** | **$211 M / yr** |
| of which planned local bond issuance | 61.4% of total CAPEX | $843 M | $169 M / yr |
| **Total city programme** | **100.0%** | **$1.37 bn** | **$275 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.85 bn | $1.53 bn (82.8%) | $1.89 bn | **$3.42 bn** |
| **Default** | 2.00× | $2.47 bn | $2.15 bn (87.1%) | $2.65 bn | **$4.80 bn** |
| High | 3.00× | $3.71 bn | $3.39 bn (91.4%) | $4.17 bn | **$7.56 bn** |

At the default 2.00× case, OSR's $319 M external requirement is 87.1% below the illustrative foreign-company requirement of $2.47 bn; the associated lifetime external-interest saving is $2.65 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$128 M / yr** | $92 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$94 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$641 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, high scenario) | **$641 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.94 bn cumulative** | $2,837 |

_Population basis: 1,390,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $94 M / yr → $94 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $319 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $843 M | 8.5% | 40 y, 5 y grace | $76 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $211 M | — | — | — |
| **Total** | **100%** | **$1.37 bn** | | | **$94 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $14 M / yr + local bonds $72 M / yr = **$86 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($42 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $421 k |
| Traction energy (403.4 GWh / yr) | 63,961 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 43.1 GWh/yr + dedicated solar plant 189.2 MW / 414.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.3 M |
| Labour (783 FTE) | driverless roster: OCC/remote 126, station/platform 241, passenger service 111, fleet maintenance 144, infrastructure/energy 134, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.0 M |
| **OPEX subtotal** | | **$34 M / yr** |

_Annual service work: 63,961 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 25.2 M train-km / yr (100.9 M car-km / yr). On-site PV covers 43.1 GWh/yr and the dedicated solar plant adds 414.3 GWh/yr against 403.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 198 trainsets, 56 stations, 168.5 route-km, 6 lines, and 63,961 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 25.4 M |
| Annual paid trips / city resident | 129 | 206 | 18 |
| Farebox revenue | $182 M / yr | $291 M / yr | $26 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$190 M / yr** | **$299 M / yr** | **$34 M / yr** |
| Revenue / OPEX recovery | 552% | 868% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $94 M / yr | $94 M / yr | **$94 M / yr** |
| Operating surplus applied to debt support | -$94 M / yr | -$94 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$94 M / yr** |
| Operating surplus after OPEX (before debt support) | $156 M / yr | $265 M / yr | $0 / yr |

_Commercial-revenue assumptions: 10,664 m² of station shop/kiosk leases at $30/m²/month and 1,960 advertising boards at $266/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $52 M / yr | $84 M / yr | 16 min/trip × $1.10/h value-of-time proxy |
...
| Station-area commerce turnover supported | $76 M / yr | $121 M / yr | 22% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $36 M / yr | $58 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$251 M / yr** | **$401 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 43,948 trips/school day; 9.7 M access-events/yr | 70,317 trips/school day; 15.5 M access-events/yr |
| Healthcare | 11 healthcare anchors | 48,367 trips/day; 17.7 M access-events/yr | 77,388 trips/day; 28.2 M access-events/yr |
| Commerce | 33 major/terminal/interchange nodes | 108,950 trips/trading day; 36.0 M access-events/yr | 174,319 trips/trading day; 57.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.05 bn | 77% of $1.37 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.69 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $337 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 57,791 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.22 bn |
| Timetable-sized dedicated solar CAPEX | $151 M |
| **Reconciled project CAPEX** | **$1.37 bn** |
| Imported / external-capital requirement | $319 M (23.3%) |
| Local-content / local-funding requirement | $1.05 bn (76.7%) |
| Default foreign-turnkey external-capital comparison | $2.47 bn; OSR saves $2.15 bn (87.1%) |
| Lifetime external interest and combined financing saving | $2.65 bn interest; $4.80 bn capital + interest |
| 15%–25% planning risk envelope | $1.58 bn–$1.72 bn |
| Annual OPEX | $34 M / yr |
| Low/high project NPV at 8% | $140 M / $1.00 bn |
| Low/high project IRR | 9.0% / 14.4% |
| Low/high steady-state DSCR | 1.65 / 2.81 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,019.14 train-km; 53,971.34 kWh consumed; 55,269.81 kWh charged; 53 depot services completed; minimum SoC 71%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 61,692.18 train-km; 663,383.15 kWh consumed; 670,256.06 kWh charged; 979 depot services completed (10 active at cutoff); minimum SoC 67%; 0 onboard emergencies; 0 invariant violations; 96.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 58.5% | 96.5% / 90% | pass |
| maximum planning climate/HVAC duty | 54.1% | 96.5% / 90% | pass |
| 50% charging-contact availability | 66.8% | 96.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 69.2% / 60% | pass |
| ten-hour single charging-pad outage | 66.8% | 96.5% / 90% | pass |
...
|---|---|
| ![Karbala energy and battery simulation dashboard](engineering/screenshots/karbala-simulation-dashboard.png) | ![Karbala simulator network visualizer](engineering/screenshots/karbala-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 56 line platforms, 10 interchange complexes, 30 civil segments, and 0 input findings |
...
|---|---|
| ![Karbala QGIS engineering layers](engineering/screenshots/karbala-qgis-engineering-map.png) | ![Karbala SUMO timetable validation](engineering/screenshots/karbala-sumo-validation.png) |
