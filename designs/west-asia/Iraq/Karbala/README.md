...
| Per-capita (city pop) | $1,097 / person |
...
|---|---|---|
| Construction (years 1–5) | **$116 M / yr** | $83 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$70 M / yr** | $50 |
| Lifecycle envelope (yr 1–40, low scenario) | **$579 M cumulative** | $417 |
| Lifecycle envelope (yr 1–40, high scenario) | **$579 M cumulative** | $417 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.02 bn cumulative** | $2,176 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.22 bn | 4.5% | 40 y, 5 y grace | $70 M / yr |
| Government equity (no debt service) | 20% | $305 M | — | — | — |
| **Total** | **100%** | **$1.52 bn** | | | **$70 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $55 M / yr = **$55 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($61 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $866 M | 57% of $1.52 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 47,488 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $1.75 bn–$1.91 bn |
| Annual OPEX | $36 M / yr |
| Low/high project NPV at 8% | $4.2 M / $869 M |
| Low/high project IRR | 8.0% / 13.1% |
| Low/high steady-state DSCR | 2.20 / 3.76 |
