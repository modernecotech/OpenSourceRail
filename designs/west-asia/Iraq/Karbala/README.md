...
| Revenue fleet | 253 × 4-car trainsets |
| Revenue fleet passenger capacity | 121,440 AW2 pax (161,920 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 25.3 km | 16 | 58 | SE Outer ↔ NW Outer |
| line-2 | 20.1 km | 13 | 48 | S Mid ↔ NE Outer |
| line-3 | 18.1 km | 15 | 46 | SE Mid ↔ W Outer |
| line-4 | 20.1 km | 11 | 45 | E Outer ↔ NW Mid |
| line-5 | 23.0 km | 15 | 53 | SW Mid ↔ NE Outer |
| line-6 | 61.8 km | 37 | 32 | W Outer ↔ W Outer |
| **Total** | **168.5 km** | **107 unique** | **282** | |
...
| Revenue fleet capacity | 121,440 AW2 pax (161,920 AW3 crush) |
| Total fleet capacity | 135,360 AW2 pax (180,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 253 × 480 = **121,440 AW2 passengers** (161,920 AW3 crush)
- **Total fleet passenger capacity:** 282 × 480 = **135,360 AW2 passengers** (180,480 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 37 | 300 kW | 1500 kWh |
| Major | 10 | 300 kW | 1500 kWh |
| Standard | 41 | 300 kW | 1500 kWh |
...
| Lowest traversal charging margin | 301 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 205 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 901 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 172.6 MW / 1,036 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 272 kWh | 858 kWh | 559 kWh | 3.7 km / 40 kWh |
| line-2 | 13 | 216 kWh | 686 kWh | 448 kWh | 2.4 km / 25 kWh |
| line-3 | 15 | 195 kWh | 784 kWh | 569 kWh | 2.0 km / 22 kWh |
| line-4 | 10 | 216 kWh | 539 kWh | 301 kWh | 5.9 km / 64 kWh |
| line-5 | 14 | 247 kWh | 735 kWh | 463 kWh | 5.8 km / 62 kWh |
| line-6 | 30 | 665 kWh | 1,470 kWh | 739 kWh | 11.1 km / 119 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 282 | $1.12 M | $316 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1128 | $60 k | $68 M |
| High sensitivity check | 1128 | $120 k | $135 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 172,623 kW @ $700/kW | $121 M |
| Grid interconnection / PPA tie-in | 172,623 kW @ $100/kW | $17 M |
| Annual generation proxy | 172.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 378.0 GWh/yr |
...
| Per-capita (city pop) | $1,450 / person |
...
|---|---|---|
| Construction (years 1–5) | **$153 M / yr** | $110 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$92 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$766 M cumulative** | $551 |
| Lifecycle envelope (yr 1–40, high scenario) | **$766 M cumulative** | $551 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.00 bn cumulative** | $2,875 |

_Population basis: 1,390,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $92 M / yr → $92 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.61 bn | 4.5% | 40 y, 5 y grace | $92 M / yr |
| Government equity (no debt service) | 20% | $403 M | — | — | — |
| **Total** | **100%** | **$2.02 bn** | | | **$92 M / yr** |
...
| Traction energy (403.4 GWh / yr) | 63,961 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 74.7 GWh/yr + dedicated solar plant 172.6 MW / 378.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.1 M |
| Labour (1,095 FTE) | driverless roster: OCC/remote 162, station/platform 475, passenger service 111, fleet maintenance 169, infrastructure/energy 151, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $7.0 M |
| **OPEX subtotal** | | **$49 M / yr** |

_Annual service work: 63,961 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 25.2 M train-km / yr (100.9 M car-km / yr). On-site PV covers 74.7 GWh/yr and the dedicated solar plant adds 378.0 GWh/yr against 403.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 282 trainsets, 107 stations, 168.5 route-km, 6 lines, and 63,961 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 31.2 M |
| Annual paid trips / city resident | 129 | 206 | 22 |
| Farebox revenue | $182 M / yr | $291 M / yr | $32 M / yr |
| Station shop leases | $6.8 M / yr | $6.8 M / yr | $6.8 M / yr |
| Advertising boards | $10 M / yr | $10 M / yr | $10 M / yr |
| **Total revenue** | **$199 M / yr** | **$308 M / yr** | **$49 M / yr** |
| Revenue / OPEX recovery | 408% | 632% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $92 M / yr | $92 M / yr | **$92 M / yr** |
| Operating surplus applied to debt support | -$92 M / yr | -$92 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$92 M / yr** |
| Operating surplus after OPEX (before debt support) | $150 M / yr | $259 M / yr | $0 / yr |

_Commercial-revenue assumptions: 21,080 m² of station shop/kiosk leases at $30/m²/month and 3,808 advertising boards at $266/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$249 M / yr** | **$398 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 31,080 trips/school day; 6.8 M access-events/yr | 49,728 trips/school day; 10.9 M access-events/yr |
| Healthcare | 21 healthcare anchors | 46,447 trips/day; 17.0 M access-events/yr | 74,315 trips/day; 27.1 M access-events/yr |
| Commerce | 57 major/terminal/interchange nodes | 106,033 trips/trading day; 35.0 M access-events/yr | 169,652 trips/trading day; 56.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.15 bn | 57% of $2.02 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.84 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $368 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 63,043 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,623.52 train-km; 49,716.53 kWh consumed; 54,971.05 kWh charged; 42 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 64,404.87 train-km; 692,543.28 kWh consumed; 704,344.32 kWh charged; 996 depot services completed (10 active at cutoff); minimum SoC 84%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 81.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 84.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.5% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 107 line platforms, 11 interchange complexes, 32 civil segments, and 0 input findings |
