...
|---|---:|---:|---:|---:|
| Civil works | $210 M | 35% | $73 M | $136 M |
...
| Residual signalling / train control | $3.0 M | 80% | $2.4 M | $609 k |
| Charging microgrids | $2.1 M | 55% | $1.2 M | $956 k |
| EPC / project services | $30 M | 45% | $14 M | $17 M |
| **Total city CAPEX** | **$511 M** | **44.7%** | **$229 M** | **$283 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.7%** | **$229 M** | **$46 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.3%** | **$283 M** | **$57 M / yr** |
| of which planned local bond issuance | 44.2% of total CAPEX | $226 M | $45 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $87 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$204 M cumulative** | $434 |
| Lifecycle envelope (yr 1–40, high scenario) | **$204 M cumulative** | $434 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.38 bn cumulative** | $2,928 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $229 M | 4.5% | 40 y, 5 y grace | $13 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $226 M | 8.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $57 M | — | — | — |
| **Total** | **100%** | **$511 M** | | | **$33 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $10 M / yr + local bonds $19 M / yr = **$30 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $283 M | 55% of $511 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $452 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $90 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 15,495 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $229 M (44.7%) |
| Local-content / local-funding requirement | $283 M (55.3%) |
| 15%–25% planning risk envelope | $588 M–$639 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $91 M / $445 M |
| Low/high project IRR | 9.8% / 15.4% |
| Low/high steady-state DSCR | 1.88 / 3.21 |
