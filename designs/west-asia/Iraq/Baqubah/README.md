...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$746 M (86.5%) of external capital** and **$917 M of external interest**. Capital plus saved interest totals **$1.66 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 59.9%
- Catchment population: **≈ 281,530** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **58.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 460 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Scheduled train journey-km | 28,306 train-km/day | One-way train journeys × route length |
| Annual service work | 11.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 367 MWh/day | 33.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 304 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 58.4 MW / 350 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 125 kWh | 184 kWh | 46 kWh | 6.5 km / 53 kWh |
| line-2 | 6 | 177 kWh | 245 kWh | 50 kWh | 9.9 km / 80 kWh |
| line-3 | 8 | 189 kWh | 261 kWh | 54 kWh | 7.0 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (58.4 km @ $2.58 M/km) | $151 M |
| Elevated (2.5 km @ $9.75 M/km) | $24 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$180 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 58,353 kW @ $700/kW | $41 M |
| Grid interconnection / PPA tie-in | 58,353 kW @ $100/kW | $5.8 M |
| Annual generation proxy | 58.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 127.8 GWh/yr |
...
| Per-capita (city pop) | $1,020 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $180 M | 15% | $27 M | $153 M |
| Stations | $94 M | 20% | $19 M | $75 M |
...
| **Total city CAPEX** | **$479 M** | **24.3%** | **$116 M** | **$363 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh baqubah`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$116 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$363 M** | **$73 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $290 M | $58 M / yr |
| **Total city programme** | **100.0%** | **$479 M** | **$96 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $647 M | $531 M (82.0%) | $652 M | **$1.18 bn** |
| **Default** | 2.00× | $863 M | $746 M (86.5%) | $917 M | **$1.66 bn** |
| High | 3.00× | $1.29 bn | $1.18 bn (91.0%) | $1.45 bn | **$2.63 bn** |

At the default 2.00× case, OSR's $116 M external requirement is 86.5% below the illustrative foreign-company requirement of $863 M; the associated lifetime external-interest saving is $917 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$44 M / yr** | $95 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$222 M cumulative** | $473 |
| Lifecycle envelope (yr 1–40, high scenario) | **$222 M cumulative** | $473 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.37 bn cumulative** | $2,918 |

_Population basis: 470,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $33 M / yr → $33 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $116 M | 4.5% | 40 y, 5 y grace | $6.7 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $290 M | 8.5% | 40 y, 5 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $73 M | — | — | — |
| **Total** | **100%** | **$479 M** | | | **$33 M / yr** |
...
| Traction energy (133.9 GWh / yr) | 28,306 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.8 GWh/yr + dedicated solar plant 58.4 MW / 127.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $700 k |
| Labour (358 FTE) | driverless roster: OCC/remote 81, station/platform 78, passenger service 49, fleet maintenance 77, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.3 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 28,306 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.2 M train-km / yr (33.5 M car-km / yr). On-site PV covers 22.8 GWh/yr and the dedicated solar plant adds 127.8 GWh/yr against 133.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 130 trainsets, 22 stations, 60.9 route-km, 3 lines, and 28,306 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.6 M |
| Annual paid trips / city resident | 156 | 250 | 22 |
...
| **Total revenue** | **$77 M / yr** | **$122 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 572% | 904% | 100% |
...
| Operating surplus after OPEX (before debt support) | $64 M / yr | $108 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,232 m² of station shop/kiosk leases at $30/m²/month and 632 advertising boards at $266/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $26 M / yr | 201 M - 321 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.6 M / yr | 36.2–57.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.0 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $30 M / yr | $47 M / yr | 21% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $15 M / yr | $24 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$93 M / yr** | **$148 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 15,924 trips/school day; 3.5 M access-events/yr | 25,479 trips/school day; 5.6 M access-events/yr |
| Healthcare | 4 healthcare anchors | 18,189 trips/day; 6.6 M access-events/yr | 29,102 trips/day; 10.6 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 42,687 trips/trading day; 14.1 M access-events/yr | 68,299 trips/trading day; 22.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $363 M | 76% of $479 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $581 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $116 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,892 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $433 M |
| Timetable-sized dedicated solar CAPEX | $47 M |
| **Reconciled project CAPEX** | **$479 M** |
| Imported / external-capital requirement | $116 M (24.3%) |
| Local-content / local-funding requirement | $363 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $863 M; OSR saves $746 M (86.5%) |
| Lifetime external interest and combined financing saving | $917 M interest; $1.66 bn capital + interest |
| 15%–25% planning risk envelope | $551 M–$599 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $122 M / $475 M |
| Low/high project IRR | 10.4% / 16.2% |
| Low/high steady-state DSCR | 1.94 / 3.29 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,273.18 train-km; 18,332.68 kWh consumed; 14,612.71 kWh charged; 28 depot services completed; minimum SoC 62%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,979.95 train-km; 217,580.03 kWh consumed; 193,996.63 kWh charged; 481 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.3% of scheduled train-km delivered; 311 SoC warnings; 32 energy-adapted off-peak departures, maximum 20 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 94.5% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.5% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 75.1% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.9% / 90% | pass |
...
|---|---|
| ![Baqubah energy and battery simulation dashboard](engineering/screenshots/baqubah-simulation-dashboard.png) | ![Baqubah simulator network visualizer](engineering/screenshots/baqubah-network-visualizer.png) |
...
|---|---|
| ![Baqubah QGIS engineering layers](engineering/screenshots/baqubah-qgis-engineering-map.png) | ![Baqubah SUMO timetable validation](engineering/screenshots/baqubah-sumo-validation.png) |
...
scripts/regenerate-city.sh baqubah
```
