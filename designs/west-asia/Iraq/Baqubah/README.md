...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 59.9 km × €0.4 M/km | €24 M |
...
| Depots | €40 M |
| Rolling stock | €120 M |
| Signalling + power | €71 M |
| EPC overhead (7%) | €42 M |
| **CAPEX total** | **€636 M** |
| Per-route-km | €11 M / km |
| Per-capita (city pop) | €1,353 / person |
...
| **Total annual government burden** (debt service + OPEX shortfall) | **€56 M / yr** | **€51 M / yr** |
