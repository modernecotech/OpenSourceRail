...
|---|---|---|
| Construction (years 1–5) | **$37 M / yr** | $79 |
| Steady-state, low-ridership (year 6+) | **$35 M / yr** | $74 |
| Steady-state, high-ridership (year 6+) | **$35 M / yr** | $74 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $74 |
| Lifecycle envelope (yr 1–25, low scenario) | **$877 M cumulative** | $1,866 |
| Lifecycle envelope (yr 1–25, high scenario) | **$877 M cumulative** | $1,866 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$877 M cumulative** | $1,866 |

_Population basis: 470,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $294 M | 4.0% | 25 y, 5 y grace | $22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $123 M | 8.5% | 25 y, 5 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$491 M** | | | **$35 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $10 M / yr = **$22 M / yr** total — plus the equity tranche amortised across construction ($15 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
