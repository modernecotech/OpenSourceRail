...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$799 M (86.8%) of external capital** and **$982 M of external interest**. Capital plus saved interest totals **$1.78 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $210 M | 15% | $31 M | $178 M |
...
| **Total city CAPEX** | **$511 M** | **23.7%** | **$121 M** | **$390 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$121 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$390 M** | **$78 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $312 M | $62 M / yr |
| **Total city programme** | **100.0%** | **$511 M** | **$102 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $690 M | $569 M (82.4%) | $700 M | **$1.27 bn** |
| **Default** | 2.00× | $920 M | $799 M (86.8%) | $982 M | **$1.78 bn** |
| High | 3.00× | $1.38 bn | $1.26 bn (91.2%) | $1.55 bn | **$2.81 bn** |

At the default 2.00× case, OSR's $121 M external requirement is 86.8% below the illustrative foreign-company requirement of $920 M; the associated lifetime external-interest saving is $982 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$48 M / yr** | $101 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $75 |
| Lifecycle envelope (yr 1–40, low scenario) | **$238 M cumulative** | $506 |
| Lifecycle envelope (yr 1–40, high scenario) | **$238 M cumulative** | $506 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.47 bn cumulative** | $3,119 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $121 M | 4.5% | 40 y, 5 y grace | $6.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $312 M | 8.5% | 40 y, 5 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $78 M | — | — | — |
| **Total** | **100%** | **$511 M** | | | **$35 M / yr** |
...
| Annual paid trips / city resident | 156 | 250 | 24 |
...
| **Total revenue** | **$77 M / yr** | **$122 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 548% | 865% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $390 M | 76% of $511 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $624 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $125 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 21,384 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $465 M |
| Timetable-sized dedicated solar CAPEX | $47 M |
| **Reconciled project CAPEX** | **$511 M** |
| Imported / external-capital requirement | $121 M (23.7%) |
| Local-content / local-funding requirement | $390 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $920 M; OSR saves $799 M (86.8%) |
| Lifetime external interest and combined financing saving | $982 M interest; $1.78 bn capital + interest |
| 15%–25% planning risk envelope | $588 M–$639 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $91 M / $445 M |
| Low/high project IRR | 9.8% / 15.4% |
| Low/high steady-state DSCR | 1.80 / 3.07 |
