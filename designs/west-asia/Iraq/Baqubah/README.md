...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 60 | €2.0 M | €120 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 59.9 km × €0.1 M/km | €6.0 M |
...
|---|---|---|
| Construction (years 1–5) | **€46 M / yr** | €99 |
| Steady-state, low-ridership (year 6+) | **€54 M / yr** | €115 |
| Steady-state, high-ridership (year 6+) | **€49 M / yr** | €104 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.31 bn cumulative** | €2,786 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.21 bn cumulative** | €2,573 |

_Population basis: 470,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€10 M / yr (low) → €5.3 M / yr (high)._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €298 k |
...
| Farebox / OPEX recovery | 33% | 65% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €10 M / yr | €5.3 M / yr |
