# Baqubah Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,379 |
| Manufacturing material/BOM rows | 20,668 |
| Manufacturing QA verification rows | 1,379 |
| Construction QA action rows | 1,283 |
| Maintenance handover schedule rows | 1,646 |
| Manufacturing rows with material refs | 1,379 / 1,379 |
| Manufacturing rows with verification refs | 1,379 / 1,379 |
| Manufacturing rows linked to QA actions | 1,379 / 1,379 |
