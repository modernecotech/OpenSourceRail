...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.97 bn (87.3%) of external capital** and **$2.42 bn of external interest**. Capital plus saved interest totals **$4.38 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 143.9 km |
| Revenue fleet | 160 × 4-car trainsets |
| Revenue fleet passenger capacity | 76,800 AW2 pax (102,400 AW3 crush) |
...
| Revenue fleet capacity | 76,800 AW2 pax (102,400 AW3 crush) |
| Total fleet capacity | 85,920 AW2 pax (114,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 160 × 480 = **76,800 AW2 passengers** (102,400 AW3 crush)
- **Total fleet passenger capacity:** 179 × 480 = **85,920 AW2 passengers** (114,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 61.2%
- Catchment population: **≈ 1,089,360** (within ~800 m walk of a station)
...
| Interchange | 13 | 300 kW | 1500 kWh |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **156.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 136 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 54,113 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 819 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 156.9 MW / 941 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 249 kWh | 490 kWh | 216 kWh | 4.0 km / 43 kWh |
| line-2 | 10 | 231 kWh | 539 kWh | 284 kWh | 3.9 km / 42 kWh |
| line-3 | 9 | 219 kWh | 490 kWh | 249 kWh | 4.1 km / 44 kWh |
| line-4 | 6 | 255 kWh | 416 kWh | 136 kWh | 9.1 km / 98 kWh |
| line-5 | 15 | 593 kWh | 919 kWh | 267 kWh | 11.5 km / 124 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 179 | $1.12 M | $200 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 716 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 716 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 156,912 kW @ $700/kW | $110 M |
| Grid interconnection / PPA tie-in | 156,912 kW @ $100/kW | $16 M |
| Annual generation proxy | 156.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 343.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$126 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 143.9 km × $0.050 M/km | $7.2 M |
...
| Dedicated solar power plant | $126 M |
...
|---|---:|---:|---:|---:|
| Civil works | $554 M | 15% | $83 M | $471 M |
| Stations | $266 M | 20% | $53 M | $213 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $200 M | 35% | $70 M | $130 M |
| Dedicated solar plant | $126 M | 45% | $56 M | $69 M |
| Residual signalling / train control | $7.2 M | 50% | $3.6 M | $3.6 M |
| Charging microgrids | $16 M | 40% | $6.4 M | $9.6 M |
| EPC / project services | $74 M | 15% | $11 M | $63 M |
| **Total city CAPEX** | **$1.25 bn** | **22.9%** | **$286 M** | **$965 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kirkuk`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.9%** | **$286 M** | **$57 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.1%** | **$965 M** | **$193 M / yr** |
| of which planned local bond issuance | 61.7% of total CAPEX | $772 M | $154 M / yr |
| **Total city programme** | **100.0%** | **$1.25 bn** | **$250 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.69 bn | $1.40 bn (83.1%) | $1.72 bn | **$3.13 bn** |
| **Default** | 2.00× | $2.25 bn | $1.97 bn (87.3%) | $2.42 bn | **$4.38 bn** |
| High | 3.00× | $3.38 bn | $3.09 bn (91.5%) | $3.80 bn | **$6.89 bn** |

At the default 2.00× case, OSR's $286 M external requirement is 87.3% below the illustrative foreign-company requirement of $2.25 bn; the associated lifetime external-interest saving is $2.42 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$117 M / yr** | $66 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$585 M cumulative** | $329 |
| Lifecycle envelope (yr 1–40, high scenario) | **$585 M cumulative** | $329 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.60 bn cumulative** | $2,020 |

_Population basis: 1,780,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $86 M / yr → $86 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $286 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $772 M | 8.5% | 40 y, 5 y grace | $70 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $193 M | — | — | — |
| **Total** | **100%** | **$1.25 bn** | | | **$86 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $13 M / yr + local bonds $66 M / yr = **$78 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($39 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $360 k |
| Traction energy (341.3 GWh / yr) | 54,113 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 42.5 GWh/yr + dedicated solar plant 156.9 MW / 343.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.9 M |
| Labour (674 FTE) | driverless roster: OCC/remote 110, station/platform 206, passenger service 92, fleet maintenance 125, infrastructure/energy 116, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $4.3 M |
| **OPEX subtotal** | | **$31 M / yr** |

_Annual service work: 54,113 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 21.3 M train-km / yr (85.3 M car-km / yr). On-site PV covers 42.5 GWh/yr and the dedicated solar plant adds 343.6 GWh/yr against 341.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 179 trainsets, 52 stations, 143.9 route-km, 5 lines, and 54,113 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 23.5 M |
| Annual paid trips / city resident | 82 | 132 | 13 |
| Farebox revenue | $149 M / yr | $238 M / yr | $24 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| **Total revenue** | **$156 M / yr** | **$245 M / yr** | **$31 M / yr** |
| Revenue / OPEX recovery | 501% | 787% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $86 M / yr | $86 M / yr | **$86 M / yr** |
| Operating surplus applied to debt support | -$86 M / yr | -$86 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$86 M / yr** |
| Operating surplus after OPEX (before debt support) | $125 M / yr | $214 M / yr | $0 / yr |

_Commercial-revenue assumptions: 8,832 m² of station shop/kiosk leases at $30/m²/month and 1,652 advertising boards at $266/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $43 M / yr | $69 M / yr | 16 min/trip × $1.10/h value-of-time proxy |
...
| Station-area commerce turnover supported | $58 M / yr | $93 M / yr | 21% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $30 M / yr | $47 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$201 M / yr** | **$322 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 0 education anchors | 16,070 trips/school day; 3.5 M access-events/yr | 25,713 trips/school day; 5.7 M access-events/yr |
| Healthcare | 8 healthcare anchors | 33,415 trips/day; 12.2 M access-events/yr | 53,465 trips/day; 19.5 M access-events/yr |
| Commerce | 24 major/terminal/interchange nodes | 83,752 trips/trading day; 27.6 M access-events/yr | 134,002 trips/trading day; 44.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $965 M | 77% of $1.25 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.54 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $309 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 52,895 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.13 bn |
| Timetable-sized dedicated solar CAPEX | $126 M |
| **Reconciled project CAPEX** | **$1.25 bn** |
| Imported / external-capital requirement | $286 M (22.9%) |
| Local-content / local-funding requirement | $965 M (77.1%) |
| Default foreign-turnkey external-capital comparison | $2.25 bn; OSR saves $1.97 bn (87.3%) |
| Lifetime external interest and combined financing saving | $2.42 bn interest; $4.38 bn capital + interest |
| 15%–25% planning risk envelope | $1.44 bn–$1.56 bn |
| Annual OPEX | $31 M / yr |
| Low/high project NPV at 8% | $-9014 k / $698 M |
| Low/high project IRR | 7.9% / 13.0% |
| Low/high steady-state DSCR | 1.45 / 2.49 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,233.40 train-km; 45,522.14 kWh consumed; 47,704.96 kWh charged; 42 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 53,085.31 train-km; 570,831.48 kWh consumed; 577,422.56 kWh charged; 830 depot services completed (8 active at cutoff); minimum SoC 74%; 0 onboard emergencies; 0 invariant violations; 98.1% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 68.7% | 98.1% / 90% | pass |
| maximum planning climate/HVAC duty | 59.7% | 98.1% / 90% | pass |
| 50% charging-contact availability | 74.0% | 98.1% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.0% / 60% | pass |
| ten-hour single charging-pad outage | 74.0% | 98.1% / 90% | pass |
...
|---|---|
| ![Kirkuk energy and battery simulation dashboard](engineering/screenshots/kirkuk-simulation-dashboard.png) | ![Kirkuk simulator network visualizer](engineering/screenshots/kirkuk-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 52 line platforms, 8 interchange complexes, 30 civil segments, and 0 input findings |
...
|---|---|
| ![Kirkuk QGIS engineering layers](engineering/screenshots/kirkuk-qgis-engineering-map.png) | ![Kirkuk SUMO timetable validation](engineering/screenshots/kirkuk-sumo-validation.png) |
...
scripts/regenerate-city.sh kirkuk
```
