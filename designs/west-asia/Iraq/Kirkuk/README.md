...
| Revenue fleet passenger capacity | 83,520 AW2 pax (111,360 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 23.1 km | 11 | 32 | N Outer ↔ SW Outer |
| line-2 | 20.9 km | 10 | 29 | S Outer ↔ NE Mid |
| line-3 | 19.4 km | 11 | 28 | SW Mid ↔ E Mid |
| line-4 | 22.7 km | 9 | 31 | W Outer ↔ NE Mid |
| line-5 | 55.5 km | 23 | 73 | NW Outer ↔ NW Outer |
| **Total** | **141.5 km** | **63 unique** | **193** | |
...
| Revenue fleet capacity | 83,520 AW2 pax (111,360 AW3 crush) |
| Total fleet capacity | 92,640 AW2 pax (123,520 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 174 × 480 = **83,520 AW2 passengers** (111,360 AW3 crush)
- **Total fleet passenger capacity:** 193 × 480 = **92,640 AW2 passengers** (123,520 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **251.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 142 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,235 MWh/day | 71,452 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,093 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 251.4 MW / 1,257 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 193 | $5.60 M | $1.08 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 772 | $100 k | $77 M |
| High sensitivity check | 772 | $200 k | $154 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 251,432 kW @ $700/kW | $176 M |
| Grid interconnection / PPA tie-in | 251,432 kW @ $100/kW | $25 M |
| Annual generation proxy | 251.4 MW × 5.0 peak-sun-h/day × 365 d/yr | 458.9 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$134 M / yr** | $75 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$77 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$670 M cumulative** | $376 |
| Lifecycle envelope (yr 1–40, high scenario) | **$670 M cumulative** | $376 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.35 bn cumulative** | $1,882 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $1.91 bn | 2.0% | 40 y, 5 y grace | $77 M / yr |
| Government equity (no debt service) | 20% | $479 M | — | — | — |
| **Total** | **100%** | **$2.39 bn** | | | **$77 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $38 M / yr = **$38 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($96 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (450.7 GWh / yr) | 71,452 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 51.6 GWh/yr + dedicated solar plant 251.4 MW / 458.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.0 M |
| Labour (790 FTE) | driverless roster: OCC/remote 118, station/platform 238, passenger service 89, fleet maintenance 152, infrastructure/energy 147, admin/training 46; no train drivers × country median × 12 × engineer-premium 1.4 | $5.0 M |
| **OPEX subtotal** | | **$69 M / yr** |

_Annual service work: 71,452 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 28.2 M train-km / yr (112.7 M car-km / yr). On-site PV covers 51.6 GWh/yr and the dedicated solar plant adds 458.9 GWh/yr against 450.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 140.2 M | 224.3 M | 59.4 M |
| Annual paid trips / city resident | 79 | 126 | 33 |
| Farebox revenue | $142 M / yr | $227 M / yr | $60 M / yr |
| Station shop leases | $3.3 M / yr | $3.3 M / yr | $3.3 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$151 M / yr** | **$236 M / yr** | **$69 M / yr** |
| Revenue / OPEX recovery | 219% | 343% | 100% |
...
| Operating surplus after OPEX (before debt support) | $82 M / yr | $167 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $41 M / yr | $66 M / yr | 16 min/trip × $1.10/h value-of-time proxy |
...
| Station-area commerce turnover supported | $55 M / yr | $89 M / yr | 21% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $28 M / yr | $45 M / yr | 11% of paid trips × $1.90 local spend proxy |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 16,423 trips/school day; 3.6 M access-events/yr | 26,277 trips/school day; 5.8 M access-events/yr |
| Healthcare | 9 healthcare anchors | 30,484 trips/day; 11.1 M access-events/yr | 48,774 trips/day; 17.8 M access-events/yr |
| Commerce | 29 major/terminal/interchange nodes | 80,000 trips/trading day; 26.4 M access-events/yr | 128,000 trips/trading day; 42.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.24 bn | 52% of $2.39 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.98 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $396 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 67,828 job-years | retained CAPEX ÷ (4.0 × median annual income) |
