...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.83 bn (87.0%) of external capital** and **$2.25 bn of external interest**. Capital plus saved interest totals **$4.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $475 M | 15% | $71 M | $404 M |
...
| EPC / project services | $68 M | 15% | $10 M | $58 M |
| **Total city CAPEX** | **$1.17 bn** | **23.4%** | **$273 M** | **$894 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$273 M** | **$55 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$894 M** | **$179 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $715 M | $143 M / yr |
| **Total city programme** | **100.0%** | **$1.17 bn** | **$233 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.58 bn | $1.30 bn (82.6%) | $1.60 bn | **$2.90 bn** |
| **Default** | 2.00× | $2.10 bn | $1.83 bn (87.0%) | $2.25 bn | **$4.07 bn** |
| High | 3.00× | $3.15 bn | $2.88 bn (91.3%) | $3.54 bn | **$6.42 bn** |

At the default 2.00× case, OSR's $273 M external requirement is 87.0% below the illustrative foreign-company requirement of $2.10 bn; the associated lifetime external-interest saving is $2.25 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$109 M / yr** | $61 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$80 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$544 M cumulative** | $306 |
| Lifecycle envelope (yr 1–40, high scenario) | **$544 M cumulative** | $306 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.35 bn cumulative** | $1,881 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $273 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $715 M | 8.5% | 40 y, 5 y grace | $64 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $179 M | — | — | — |
| **Total** | **100%** | **$1.17 bn** | | | **$80 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $12 M / yr + local bonds $61 M / yr = **$73 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($36 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 146.6 M | 234.6 M | 21.9 M |
| Annual paid trips / city resident | 82 | 132 | 12 |
| Farebox revenue | $149 M / yr | $238 M / yr | $22 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| **Total revenue** | **$156 M / yr** | **$245 M / yr** | **$30 M / yr** |
| Revenue / OPEX recovery | 527% | 829% | 100% |
...
| Operating surplus after OPEX (before debt support) | $126 M / yr | $216 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $894 M | 77% of $1.17 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.43 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $286 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 48,991 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.04 bn |
| Timetable-sized dedicated solar CAPEX | $126 M |
| **Reconciled project CAPEX** | **$1.17 bn** |
| Imported / external-capital requirement | $273 M (23.4%) |
| Local-content / local-funding requirement | $894 M (76.6%) |
| Default foreign-turnkey external-capital comparison | $2.10 bn; OSR saves $1.83 bn (87.0%) |
| Lifetime external interest and combined financing saving | $2.25 bn interest; $4.07 bn capital + interest |
| 15%–25% planning risk envelope | $1.34 bn–$1.46 bn |
| Annual OPEX | $30 M / yr |
| Low/high project NPV at 8% | $70 M / $778 M |
| Low/high project IRR | 8.6% / 13.9% |
| Low/high steady-state DSCR | 1.58 / 2.69 |
