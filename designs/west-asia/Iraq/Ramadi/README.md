...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $69 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $42 |
| Lifecycle envelope (yr 1–40, low scenario) | **$181 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$945 M cumulative** | $1,800 |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $270 M | 57% of $477 M CAPEX using bucket local-content shares |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $137 M / $490 M |
| Low/high project IRR | 10.7% / 16.5% |
| Low/high steady-state DSCR | 2.99 / 5.03 |
