...
|---|---|---|---|---|
| line-1 | 16.4 km | 11 | 43 | E Outer ↔ W Mid |
| line-2 | 14.3 km | 10 | 35 | SW Mid ↔ NE Outer |
| line-3 | 17.3 km | 11 | 45 | W Outer ↔ NE Mid |
| **Total** | **48.0 km** | **32 unique** | **123** | |
...
| Onboard battery adequacy | 28.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 521 kWh usable margin across the worst powered-stop gap (line-3) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 132 kWh | 233 kWh | 87 kWh | 2.0 km / 16 kWh |
| line-2 | 10 | 115 kWh | 180 kWh | 53 kWh | 2.2 km / 18 kWh |
| line-3 | 11 | 139 kWh | 241 kWh | 88 kWh | 2.4 km / 19 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,006 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 39,006 kW @ $100/kW | $3.9 M |
...
| Per-capita (city pop) | $1,056 / person |
...
|---|---|---|
| Construction (years 1–5) | **$42 M / yr** | $80 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$211 M cumulative** | $401 |
| Lifecycle envelope (yr 1–40, high scenario) | **$211 M cumulative** | $401 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.10 bn cumulative** | $2,095 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $444 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $111 M | — | — | — |
| **Total** | **100%** | **$555 M** | | | **$25 M / yr** |
...
| Traction energy (105.6 GWh / yr) | 22,323 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 31.3 GWh/yr + dedicated solar plant 39.0 MW / 85.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $468 k |
| Labour (395 FTE) | driverless roster: OCC/remote 77, station/platform 134, passenger service 49, fleet maintenance 67, infrastructure/energy 47, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 22,323 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.8 M train-km / yr (26.4 M car-km / yr). On-site PV covers 31.3 GWh/yr and the dedicated solar plant adds 85.4 GWh/yr against 105.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 123 trainsets, 32 stations, 48.0 route-km, 3 lines, and 22,323 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 140 | 223 | 18 |
...
| **Total revenue** | **$79 M / yr** | **$124 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 545% | 851% | 100% |
...
_Commercial-revenue assumptions: 5,976 m² of station shop/kiosk leases at $30/m²/month and 1,112 advertising boards at $266/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 8 education anchors | 15,267 trips/school day; 3.4 M access-events/yr | 24,427 trips/school day; 5.4 M access-events/yr |
| Healthcare | 1 healthcare anchors | 12,756 trips/day; 4.7 M access-events/yr | 20,409 trips/day; 7.4 M access-events/yr |
| Commerce | 21 major/terminal/interchange nodes | 45,983 trips/trading day; 15.2 M access-events/yr | 73,572 trips/trading day; 24.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $316 M | 57% of $555 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,306 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$555 M** |
| 15%–25% planning risk envelope | $638 M–$693 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $70 M / $424 M |
| Low/high project IRR | 9.3% / 14.6% |
| Low/high steady-state DSCR | 2.55 / 4.30 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,880.62 train-km; 15,166.62 kWh consumed; 16,210.33 kWh charged; 28 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,080.74 train-km; 186,138.69 kWh consumed; 189,759.94 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 61.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.6% / 60% | pass |
| ten-hour single charging-pad outage | 56.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 32 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
