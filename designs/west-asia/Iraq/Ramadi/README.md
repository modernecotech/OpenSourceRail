...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$716 M (87.2%) of external capital** and **$881 M of external interest**. Capital plus saved interest totals **$1.60 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 70.1% |
| Route length (double track) | 48.0 km |
...
| Total fleet capacity | 37,440 AW2 pax (49,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 93 × 360 = **33,480 AW2 passengers** (44,640 AW3 crush)
- **Total fleet passenger capacity:** 104 × 360 = **37,440 AW2 passengers** (49,920 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 70.1%
- Catchment population: **≈ 368,025** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 19.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 513 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 44 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 68 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 22,323 train-km/day | One-way train journeys × route length |
| Annual service work | 8.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 289 MWh/day | 26.4 M car-km/yr × 4.0 kWh/car-km |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 132 kWh | 200 kWh | 55 kWh | 3.1 km / 25 kWh |
| line-2 | 7 | 115 kWh | 172 kWh | 44 kWh | 3.0 km / 24 kWh |
| line-3 | 8 | 139 kWh | 204 kWh | 51 kWh | 3.4 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (45.6 km @ $3.0 M/km) | $137 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 104 | $900 k | $94 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 312 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 312 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,456 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,456 kW @ $100/kW | $4.2 M |
| Annual generation proxy | 42.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 93.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 48.0 km × $0.050 M/km | $2.4 M |
...
| EPC / project services | $28 M | 15% | $4.1 M | $23 M |
| **Total city CAPEX** | **$456 M** | **23.1%** | **$105 M** | **$351 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh ramadi`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$105 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$351 M** | **$70 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $281 M | $56 M / yr |
| **Total city programme** | **100.0%** | **$456 M** | **$91 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $616 M | $511 M (82.9%) | $628 M | **$1.14 bn** |
| **Default** | 2.00× | $822 M | $716 M (87.2%) | $881 M | **$1.60 bn** |
| High | 3.00× | $1.23 bn | $1.13 bn (91.5%) | $1.39 bn | **$2.51 bn** |

At the default 2.00× case, OSR's $105 M external requirement is 87.2% below the illustrative foreign-company requirement of $822 M; the associated lifetime external-interest saving is $881 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $81 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$213 M cumulative** | $406 |
| Lifecycle envelope (yr 1–40, high scenario) | **$213 M cumulative** | $406 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.31 bn cumulative** | $2,498 |

_Population basis: 525,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $31 M / yr → $31 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $105 M | 4.5% | 40 y, 5 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $281 M | 8.5% | 40 y, 5 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $70 M | — | — | — |
| **Total** | **100%** | **$456 M** | | | **$31 M / yr** |
...
| Traction energy (105.6 GWh / yr) | 22,323 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.7 GWh/yr + dedicated solar plant 42.5 MW / 93.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $509 k |
| Labour (335 FTE) | driverless roster: OCC/remote 69, station/platform 92, passenger service 49, fleet maintenance 61, infrastructure/energy 43, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 22,323 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.8 M train-km / yr (26.4 M car-km / yr). On-site PV covers 24.7 GWh/yr and the dedicated solar plant adds 93.0 GWh/yr against 105.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 104 trainsets, 22 stations, 48.0 route-km, 3 lines, and 22,323 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 9.0 M |
| Annual paid trips / city resident | 140 | 223 | 17 |
| Farebox revenue | $74 M / yr | $119 M / yr | $9.1 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$78 M / yr** | **$122 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 624% | 982% | 100% |
...
| Operating surplus after OPEX (before debt support) | $65 M / yr | $110 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,992 m² of station shop/kiosk leases at $30/m²/month and 756 advertising boards at $266/board/month, with occupancy derates applied._
...
| Avoided CO2e | $2.3 M / yr | $3.6 M / yr | 28.5–45.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.3 M / yr | $10 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $32 M / yr | $51 M / yr | 23% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $15 M / yr | $24 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$89 M / yr** | **$143 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 13,459 trips/school day; 3.0 M access-events/yr | 21,534 trips/school day; 4.7 M access-events/yr |
| Healthcare | 2 healthcare anchors | 14,162 trips/day; 5.2 M access-events/yr | 22,659 trips/day; 8.3 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 45,563 trips/trading day; 15.0 M access-events/yr | 72,901 trips/trading day; 24.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $351 M | 77% of $456 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $562 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $112 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,253 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $423 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$456 M** |
| Imported / external-capital requirement | $105 M (23.1%) |
| Local-content / local-funding requirement | $351 M (76.9%) |
| Default foreign-turnkey external-capital comparison | $822 M; OSR saves $716 M (87.2%) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $153 M / $506 M |
| Low/high project IRR | 11.1% / 17.1% |
| Low/high steady-state DSCR | 2.08 / 3.50 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,940.77 train-km; 15,651.85 kWh consumed; 14,633.48 kWh charged; 31 depot services completed; minimum SoC 65%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,814.68 train-km; 183,992.40 kWh consumed; 186,577.63 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 133 SoC warnings; 20 energy-adapted off-peak departures, maximum 16 min headway |
...
| ten-hour all-site grid outage | 20.0% | 87.9% / 60% | pass |
...
|---|---|
| ![Ramadi energy and battery simulation dashboard](engineering/screenshots/ramadi-simulation-dashboard.png) | ![Ramadi simulator network visualizer](engineering/screenshots/ramadi-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![Ramadi QGIS engineering layers](engineering/screenshots/ramadi-qgis-engineering-map.png) | ![Ramadi SUMO timetable validation](engineering/screenshots/ramadi-sumo-validation.png) |
...
scripts/regenerate-city.sh ramadi
```
