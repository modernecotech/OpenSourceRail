...
Aggregate station-rail charging power: **17,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 320 kWh battery covers running.
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 49 | €2.0 M | €98 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 46.8 km × €0.1 M/km | €4.7 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 46.8 km × €0.8 M/km | €37 M |
...
| Steady-state, low-ridership (year 6+) | **€45 M / yr** | €85 |
| Steady-state, high-ridership (year 6+) | **€39 M / yr** | €74 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.09 bn cumulative** | €2,075 |
| Lifecycle envelope (yr 1–25, high scenario) | **€978 M cumulative** | €1,863 |

_Population basis: 525,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€7.3 M / yr (low) → €1.8 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €316 M | 4.0% | 25 y, 5 y grace | €23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €132 M | 8.5% | 25 y, 5 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €79 M | — | — | — |
| **Total** | **100%** | **€527 M** | | | **€37 M / yr** |
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €233 k |
| Traction energy (86.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (293 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.7 M |
...
|---|---|---|
| Annual paid trips | 9.6 M | 19.2 M |
| Farebox revenue | €5.6 M / yr | €11 M / yr |
| Farebox / OPEX recovery | 43% | 86% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €7.3 M / yr | €1.8 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€45 M / yr** | **€39 M / yr** |
