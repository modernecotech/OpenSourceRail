...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.8 km × $0.015 M/km | $2.3 M |
...
|---|---|---|
| Construction (years 1–5) | **$24 M / yr** | $45 |
| Steady-state, low-ridership (year 6+) | **$22 M / yr** | $42 |
| Steady-state, high-ridership (year 6+) | **$22 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $42 |
| Lifecycle envelope (yr 1–25, low scenario) | **$562 M cumulative** | $1,071 |
| Lifecycle envelope (yr 1–25, high scenario) | **$562 M cumulative** | $1,071 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$562 M cumulative** | $1,071 |

_Population basis: 525,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $189 M | 4.0% | 25 y, 5 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $79 M | 8.5% | 25 y, 5 y grace | $8.3 M / yr |
| Government equity (no debt service) | 15% | $47 M | — | — | — |
| **Total** | **100%** | **$315 M** | | | **$22 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $7.5 M / yr + bonds $6.7 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($9.4 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 37,044 | 61,740 | 10,022 |
| Daily paid trips / catchment | 18% | 30% | 5% |
| Daily paid trips / city population | 7% | 12% | 2% |
| Annual paid trips | 13.5 M | 22.5 M | 3.7 M |
| Farebox revenue | $10 M / yr | $17 M / yr | $2.8 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$16 M / yr** | **$23 M / yr** | **$8.3 M / yr** |
| Revenue / OPEX recovery | 191% | 273% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $22 M / yr | $22 M / yr | **$22 M / yr** |
| Operating surplus after OPEX | $7.5 M / yr | $14 M / yr | $0 / yr |
