...
|---|---|---|
| Construction (years 1–5) | **$13 M / yr** | $24 |
| Steady-state, low-ridership (year 6+) | **$592 k / yr** | $1 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$76 M cumulative** | $145 |
| Lifecycle envelope (yr 1–25, high scenario) | **$64 M cumulative** | $122 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$64 M cumulative** | $122 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $102 M | 4.0% | 25 y, 5 y grace | $7.5 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $4.1 M / yr + bonds $3.6 M / yr = **$7.7 M / yr** total — plus the equity tranche amortised across construction ($5.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 42,000 | 78,750 | 44,133 |
| Daily paid trips / population | 8% | 15% | 8% |
| Annual paid trips | 15.3 M | 28.7 M | 16.1 M |
...
| Revenue / OPEX + debt-service recovery | 97% | 154% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $592 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $9.6 M / yr | $0 / yr |
