...
Aggregate station-rail charging power: **13,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 320 kWh battery covers running.
...
| Bucket | Value |
|---|---|
| At-grade (42.5 km @ €3.5 M/km) | €149 M |
| Elevated (3.3 km @ €18 M/km) | €60 M |
| Elevated-interchange premium (2 sites @ €20 M) | €40 M |
| **Civil subtotal** | **€249 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 48 | €2.0 M | €96 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 45.9 km × €0.1 M/km | €4.6 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 45.9 km × €0.8 M/km | €37 M |
...
|---|---|---|
| Construction (years 1–5) | **€40 M / yr** | €112 |
| Steady-state, low-ridership (year 6+) | **€47 M / yr** | €130 |
| Steady-state, high-ridership (year 6+) | **€43 M / yr** | €120 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.14 bn cumulative** | €3,169 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.06 bn cumulative** | €2,956 |

_Population basis: 360,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€9.2 M / yr (low) → €5.4 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €321 M | 4.0% | 25 y, 5 y grace | €24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €134 M | 8.5% | 25 y, 5 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €80 M | — | — | — |
| **Total** | **100%** | **€535 M** | | | **€38 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €13 M / yr + bonds €11 M / yr = **€24 M / yr** total — plus the equity tranche amortised across construction (€16 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €229 k |
| Traction energy (84.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (287 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.7 M |
...
| Operating shortfall (gov subsidy required) | €9.2 M / yr | €5.4 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€47 M / yr** | **€43 M / yr** |
