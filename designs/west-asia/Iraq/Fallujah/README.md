...
|---|---|---|---|---|
| line-1 | 20.5 km | 10 | 20 | SE Mid ↔ NW Outer |
| line-2 | 15.0 km | 10 | 16 | E Mid ↔ W Mid |
| line-3 | 10.4 km | 8 | 12 | W Inner ↔ SE Mid |
| **Total** | **45.9 km** | **28 unique** | **48** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **36,935 – 61,559 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (42.5 km @ $2.0 M/km) | $85 M |
| Elevated (3.3 km @ $9.0 M/km) | $30 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 45.9 km × $0.015 M/km | $2.3 M |
...
| Per-capita (city pop) | $724 / person |
...
|---|---|---|
| Construction (years 1–5) | **$20 M / yr** | $54 |
| Steady-state, low-ridership (year 6+) | **$18 M / yr** | $51 |
| Steady-state, high-ridership (year 6+) | **$18 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $51 |
| Lifecycle envelope (yr 1–25, low scenario) | **$466 M cumulative** | $1,294 |
| Lifecycle envelope (yr 1–25, high scenario) | **$466 M cumulative** | $1,294 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$466 M cumulative** | $1,294 |

_Population basis: 360,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $156 M | 4.0% | 25 y, 5 y grace | $12 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $65 M | 8.5% | 25 y, 5 y grace | $6.9 M / yr |
| Government equity (no debt service) | 15% | $39 M | — | — | — |
| **Total** | **100%** | **$261 M** | | | **$18 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $6.3 M / yr + bonds $5.5 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($7.8 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (287 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.8 M |
