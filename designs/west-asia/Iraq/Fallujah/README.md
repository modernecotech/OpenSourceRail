...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.6%** | **$215 M** | **$43 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.4%** | **$267 M** | **$53 M / yr** |
| of which planned local bond issuance | 44.3% of total CAPEX | $213 M | $43 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$38 M / yr** | $107 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $88 |
| Lifecycle envelope (yr 1–40, low scenario) | **$192 M cumulative** | $534 |
| Lifecycle envelope (yr 1–40, high scenario) | **$192 M cumulative** | $534 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.30 bn cumulative** | $3,600 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $215 M | 4.5% | 40 y, 5 y grace | $12 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $213 M | 8.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $53 M | — | — | — |
| **Total** | **100%** | **$481 M** | | | **$32 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $9.7 M / yr + local bonds $18 M / yr = **$28 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $267 M | 55% of $481 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 14,613 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $215 M (44.6%) |
| Local-content / local-funding requirement | $267 M (55.4%) |
