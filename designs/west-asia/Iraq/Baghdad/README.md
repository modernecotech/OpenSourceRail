...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 4704 | $60 k | $282 M |
| High sensitivity check | 4704 | $120 k | $564 M |
...
| EPC integration + project management (7%) | on subtotal | $295 M |
...
|---|---|---|
| Construction (years 1–5) | **$403 M / yr** | $41 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$243 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.01 bn cumulative** | $206 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.01 bn cumulative** | $206 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.51 bn cumulative** | $1,075 |

_Population basis: 9,780,429 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $243 M / yr → $243 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $4.24 bn | 4.5% | 40 y, 5 y grace | $243 M / yr |
| Government equity (no debt service) | 20% | $1.06 bn | — | — | — |
| **Total** | **100%** | **$5.30 bn** | | | **$243 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $191 M / yr = **$191 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($212 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $243 M / yr | $243 M / yr | **$243 M / yr** |
| Operating surplus applied to debt support | -$243 M / yr | -$243 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$243 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.85 bn | 54% of $5.30 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.55 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $911 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 156,024 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $4.51 bn |
| Timetable-sized dedicated solar CAPEX | $789 M |
| **Reconciled project CAPEX** | **$5.30 bn** |
| 15%–25% planning risk envelope | $6.09 bn–$6.62 bn |
| Annual OPEX | $130 M / yr |
| Low/high project NPV at 8% | $-1775256 k / $228 M |
| Low/high project IRR | 4.0% / 8.4% |
| Low/high steady-state DSCR | 1.28 / 2.32 |
