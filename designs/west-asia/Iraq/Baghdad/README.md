...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$7.69 bn (85.5%) of external capital** and **$9.45 bn of external interest**. Capital plus saved interest totals **$17.14 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 85.5% |
| Route length (double track) | 501.3 km |
| Revenue fleet | 707 × 6-car trainsets |
| Revenue fleet passenger capacity | 509,040 AW2 pax (678,720 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 77 × 6-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 68 planned-maintenance spares and 9 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
| Revenue fleet capacity | 509,040 AW2 pax (678,720 AW3 crush) |
| Total fleet capacity | 564,480 AW2 pax (752,640 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 707 × 720 = **509,040 AW2 passengers** (678,720 AW3 crush)
- **Total fleet passenger capacity:** 784 × 720 = **564,480 AW2 passengers** (752,640 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 85.5%
- Catchment population: **≈ 8,362,266** (within ~800 m walk of a station)
...
| Interchange | 35 | 300 kW | 2000 kWh |
| Standard | 77 | 300 kW | 2000 kWh |
| Terminal | 15 | 300 kW | 2000 kWh |
| **Total installed** | **128** | **43,100 kW** | **294,000 kWh** |

Aggregate station-rail charging power: **256,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **986.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 3.6× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 778 kWh usable margin across the worst powered-stop gap (line-9) |
| Lowest traversal charging margin | 237 kWh | line-8 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 259 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 3,952 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 208,504 train-km/day | One-way train journeys × route length |
| Annual service work | 82.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 5,404 MWh/day | 493.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 5,146 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 986.3 MW / 5,918 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 294 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 937 kWh | 1,372 kWh | 341 kWh | 11.6 km / 187 kWh |
| line-2 | 11 | 739 kWh | 1,078 kWh | 265 kWh | 14.0 km / 226 kWh |
| line-3 | 14 | 888 kWh | 1,372 kWh | 395 kWh | 17.5 km / 283 kWh |
| line-4 | 14 | 853 kWh | 1,372 kWh | 433 kWh | 12.5 km / 202 kWh |
| line-5 | 13 | 695 kWh | 1,094 kWh | 329 kWh | 10.5 km / 170 kWh |
| line-6 | 12 | 762 kWh | 1,176 kWh | 338 kWh | 17.4 km / 281 kWh |
| line-7 | 13 | 918 kWh | 1,274 kWh | 264 kWh | 12.8 km / 206 kWh |
| line-8 | 9 | 586 kWh | 882 kWh | 237 kWh | 10.3 km / 166 kWh |
| line-9 | 26 | 1,705 kWh | 2,548 kWh | 673 kWh | 18.7 km / 302 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (473.4 km @ $3.0 M/km) | $1.42 bn |
| Elevated (27.8 km @ $12.0 M/km) | $334 M |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 784 | $1.68 M | $1.32 bn |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 4704 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 4704 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 986,285 kW @ $700/kW | $690 M |
| Grid interconnection / PPA tie-in | 986,285 kW @ $100/kW | $99 M |
| Annual generation proxy | 986.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 2,160.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$789 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 501.3 km × $0.050 M/km | $25 M |
...
| EPC integration + project management (7%) | on subtotal | $275 M |
...
| Dedicated solar power plant | $789 M |
| Residual train-control wayside + charging microgrids | $80 M |
| EPC overhead (7%) | $275 M |
| **CAPEX total** | **$5.00 bn** |
...
|---|---:|---:|---:|---:|
| Civil works | $1.83 bn | 15% | $274 M | $1.55 bn |
| Stations | $701 M | 20% | $140 M | $561 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $1.32 bn | 35% | $461 M | $856 M |
| Dedicated solar plant | $789 M | 45% | $355 M | $434 M |
| Residual signalling / train control | $25 M | 50% | $13 M | $13 M |
| Charging microgrids | $55 M | 40% | $22 M | $33 M |
| EPC / project services | $275 M | 15% | $41 M | $234 M |
| **Total city CAPEX** | **$5.00 bn** | **26.2%** | **$1.31 bn** | **$3.69 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh baghdad`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.2%** | **$1.31 bn** | **$262 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.8%** | **$3.69 bn** | **$738 M / yr** |
| of which planned local bond issuance | 59.1% of total CAPEX | $2.95 bn | $590 M / yr |
| **Total city programme** | **100.0%** | **$5.00 bn** | **$999 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $6.75 bn | $5.44 bn (80.6%) | $6.69 bn | **$12.12 bn** |
| **Default** | 2.00× | $9.00 bn | $7.69 bn (85.5%) | $9.45 bn | **$17.14 bn** |
| High | 3.00× | $13.49 bn | $12.18 bn (90.3%) | $14.98 bn | **$27.17 bn** |

At the default 2.00× case, OSR's $1.31 bn external requirement is 85.5% below the illustrative foreign-company requirement of $9.00 bn; the associated lifetime external-interest saving is $9.45 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$457 M / yr** | $47 |
| Steady-state, low capacity-use (year 6+) | **$31 M / yr** | $3 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$341 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.39 bn cumulative** | $346 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.29 bn cumulative** | $234 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$14.22 bn cumulative** | $1,454 |

_Population basis: 9,780,429 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $310 M / yr → $341 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $1.31 bn | 4.5% | 40 y, 5 y grace | $75 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.95 bn | 8.5% | 40 y, 5 y grace | $266 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $738 M | — | — | — |
| **Total** | **100%** | **$5.00 bn** | | | **$341 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $59 M / yr + local bonds $251 M / yr = **$310 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($148 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (1972.6 GWh / yr) | 208,504 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 94.4 GWh/yr + dedicated solar plant 986.3 MW / 2160.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $12 M |
| Labour (2,098 FTE) | driverless roster: OCC/remote 405, station/platform 534, passenger service 231, fleet maintenance 510, infrastructure/energy 385, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $13 M |
| **OPEX subtotal** | | **$130 M / yr** |

_Annual service work: 208,504 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 82.2 M train-km / yr (493.2 M car-km / yr). On-site PV covers 94.4 GWh/yr and the dedicated solar plant adds 2160.0 GWh/yr against 1972.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 784 trainsets, 155 stations, 501.3 route-km, 9 lines, and 208,504 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 109.9 M |
| Annual paid trips / city resident | 42 | 68 | 11 |
| Farebox revenue | $421 M / yr | $674 M / yr | $111 M / yr |
| Station shop leases | $7.1 M / yr | $7.1 M / yr | $7.1 M / yr |
| Advertising boards | $11 M / yr | $11 M / yr | $11 M / yr |
| **Total revenue** | **$440 M / yr** | **$692 M / yr** | **$130 M / yr** |
| Revenue / OPEX recovery | 338% | 533% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $341 M / yr | $341 M / yr | **$341 M / yr** |
| Operating surplus applied to debt support | -$310 M / yr | -$341 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $31 M / yr | $0 k / yr | **$341 M / yr** |
| Operating surplus after OPEX (before debt support) | $310 M / yr | $562 M / yr | $0 / yr |

_Commercial-revenue assumptions: 22,200 m² of station shop/kiosk leases at $30/m²/month and 4,208 advertising boards at $266/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $121 M / yr | $194 M / yr | 16 min/trip × $1.10/h value-of-time proxy |
...
| Station-area commerce turnover supported | $154 M / yr | $246 M / yr | 19% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $84 M / yr | $134 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$560 M / yr** | **$896 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 14 education anchors | 69,438 trips/school day; 15.3 M access-events/yr | 111,100 trips/school day; 24.4 M access-events/yr |
| Healthcare | 23 healthcare anchors | 98,844 trips/day; 36.1 M access-events/yr | 158,151 trips/day; 57.7 M access-events/yr |
| Commerce | 51 major/terminal/interchange nodes | 221,458 trips/trading day; 73.1 M access-events/yr | 354,333 trips/trading day; 116.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.69 bn | 74% of $5.00 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.90 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $1.18 bn / yr | spread across 5 construction / grace years |
| Construction employment supported | 202,255 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $4.21 bn |
| Timetable-sized dedicated solar CAPEX | $789 M |
| **Reconciled project CAPEX** | **$5.00 bn** |
| Imported / external-capital requirement | $1.31 bn (26.2%) |
| Local-content / local-funding requirement | $3.69 bn (73.8%) |
| Default foreign-turnkey external-capital comparison | $9.00 bn; OSR saves $7.69 bn (85.5%) |
| Lifetime external interest and combined financing saving | $9.45 bn interest; $17.14 bn capital + interest |
| 15%–25% planning risk envelope | $5.75 bn–$6.25 bn |
| Annual OPEX | $130 M / yr |
| Low/high project NPV at 8% | $-1534099 k / $470 M |
| Low/high project IRR | 4.4% / 8.9% |
| Low/high steady-state DSCR | 0.91 / 1.65 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 12,503.81 train-km; 201,682.35 kWh consumed; 194,966.06 kWh charged; 23 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 201,715.77 train-km; 3,253,595.51 kWh consumed; 3,269,822.20 kWh charged; 1,604 depot services completed (2 active at cutoff); minimum SoC 38%; 0 onboard emergencies; 0 invariant violations; 96.7% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 23.1% | 96.7% / 90% | pass |
| maximum planning climate/HVAC duty | 20.2% | 96.7% / 90% | pass |
| 50% charging-contact availability | 38.4% | 96.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 72.2% / 60% | pass |
| ten-hour single charging-pad outage | 38.4% | 96.7% / 90% | pass |
...
|---|---|
| ![Baghdad energy and battery simulation dashboard](engineering/screenshots/baghdad-simulation-dashboard.png) | ![Baghdad simulator network visualizer](engineering/screenshots/baghdad-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 155 line platforms, 16 interchange complexes, 71 civil segments, and 0 input findings |
...
|---|---|
| ![Baghdad QGIS engineering layers](engineering/screenshots/baghdad-qgis-engineering-map.png) | ![Baghdad SUMO timetable validation](engineering/screenshots/baghdad-sumo-validation.png) |
