...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$7.23 bn (85.1%) of external capital** and **$8.89 bn of external interest**. Capital plus saved interest totals **$16.12 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (473.4 km @ $2.58 M/km) | $1.22 bn |
| Elevated (27.8 km @ $9.75 M/km) | $271 M |
| Elevated-interchange premium (16 sites @ $4.50 M) | $72 M |
| **Civil subtotal** | **$1.57 bn** |
...
|---|---:|---:|---:|---:|
| Civil works | $1.57 bn | 15% | $235 M | $1.33 bn |
...
| EPC / project services | $257 M | 15% | $39 M | $219 M |
| **Total city CAPEX** | **$4.72 bn** | **26.8%** | **$1.27 bn** | **$3.45 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.8%** | **$1.27 bn** | **$253 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.2%** | **$3.45 bn** | **$691 M / yr** |
| of which planned local bond issuance | 58.5% of total CAPEX | $2.76 bn | $552 M / yr |
| **Total city programme** | **100.0%** | **$4.72 bn** | **$944 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $6.37 bn | $5.10 bn (80.1%) | $6.28 bn | **$11.38 bn** |
| **Default** | 2.00× | $8.50 bn | $7.23 bn (85.1%) | $8.89 bn | **$16.12 bn** |
| High | 3.00× | $12.74 bn | $11.48 bn (90.1%) | $14.11 bn | **$25.59 bn** |

At the default 2.00× case, OSR's $1.27 bn external requirement is 85.1% below the illustrative foreign-company requirement of $8.50 bn; the associated lifetime external-interest saving is $8.89 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$430 M / yr** | $44 |
| Steady-state, low capacity-use (year 6+) | **$6.8 M / yr** | $1 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$322 M / yr** | $33 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.39 bn cumulative** | $244 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.15 bn cumulative** | $220 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$13.41 bn cumulative** | $1,371 |

_Population basis: 9,780,429 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $315 M / yr → $322 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 27% | $1.27 bn | 4.5% | 40 y, 5 y grace | $73 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.76 bn | 8.5% | 40 y, 5 y grace | $249 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $691 M | — | — | — |
| **Total** | **100%** | **$4.72 bn** | | | **$322 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $57 M / yr + local bonds $235 M / yr = **$292 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($138 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 104.7 M |
| Annual paid trips / city resident | 42 | 68 | 11 |
| Farebox revenue | $421 M / yr | $674 M / yr | $106 M / yr |
| Station shop leases | $7.1 M / yr | $7.1 M / yr | $7.1 M / yr |
| Advertising boards | $11 M / yr | $11 M / yr | $11 M / yr |
| **Total revenue** | **$440 M / yr** | **$692 M / yr** | **$125 M / yr** |
| Revenue / OPEX recovery | 353% | 555% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $322 M / yr | $322 M / yr | **$322 M / yr** |
| Operating surplus applied to debt support | -$315 M / yr | -$322 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.8 M / yr | $0 k / yr | **$322 M / yr** |
| Operating surplus after OPEX (before debt support) | $315 M / yr | $568 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.45 bn | 73% of $4.72 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.52 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $1.10 bn / yr | spread across 5 construction / grace years |
| Construction employment supported | 189,309 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.93 bn |
| Timetable-sized dedicated solar CAPEX | $789 M |
| **Reconciled project CAPEX** | **$4.72 bn** |
| Imported / external-capital requirement | $1.27 bn (26.8%) |
| Local-content / local-funding requirement | $3.45 bn (73.2%) |
| Default foreign-turnkey external-capital comparison | $8.50 bn; OSR saves $7.23 bn (85.1%) |
| Lifetime external interest and combined financing saving | $8.89 bn interest; $16.12 bn capital + interest |
| 15%–25% planning risk envelope | $5.43 bn–$5.90 bn |
| Annual OPEX | $125 M / yr |
| Low/high project NPV at 8% | $-1271075 k / $733 M |
| Low/high project IRR | 4.9% / 9.5% |
| Low/high steady-state DSCR | 0.98 / 1.76 |
