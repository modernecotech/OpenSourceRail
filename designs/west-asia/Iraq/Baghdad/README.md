...
| Revenue fleet | 903 × 6-car trainsets |
| Revenue fleet passenger capacity | 650,160 AW2 pax (866,880 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 95 × 6-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 86 planned-maintenance spares and 9 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 58.1 km | 30 | 137 | SE Outer ↔ NW Outer |
| line-2 | 45.8 km | 23 | 108 | NW Outer ↔ SE Mid |
| line-3 | 55.1 km | 29 | 130 | SW Outer ↔ NE Mid |
| line-4 | 52.9 km | 28 | 126 | W Outer ↔ E Outer |
| line-5 | 43.1 km | 23 | 105 | N Outer ↔ S Mid |
| line-6 | 47.2 km | 24 | 112 | N Mid ↔ S Outer |
| line-7 | 56.9 km | 29 | 133 | W Mid ↔ E Outer |
| line-8 | 36.4 km | 17 | 85 | E Mid ↔ NW Outer |
| line-9 | 105.7 km | 58 | 62 | W Mid ↔ W Mid |
| **Total** | **501.3 km** | **261 unique** | **998** | |
...
| Revenue fleet capacity | 650,160 AW2 pax (866,880 AW3 crush) |
| Total fleet capacity | 718,560 AW2 pax (958,080 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 903 × 720 = **650,160 AW2 passengers** (866,880 AW3 crush)
- **Total fleet passenger capacity:** 998 × 720 = **718,560 AW2 passengers** (958,080 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 67 | 300 kW | 2000 kWh |
| Major | 1 | 300 kW | 2000 kWh |
| Standard | 136 | 300 kW | 2000 kWh |
| Terminal | 15 | 300 kW | 2000 kWh |
| **Total installed** | **220** | **70,700 kW** | **478,000 kWh** |

Aggregate station-rail charging power: **440,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **954.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 3.9× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 806 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 335 kWh | line-8 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 424 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 4,980 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 954.5 MW / 5,727 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 478 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 25 | 937 kWh | 1,731 kWh | 700 kWh | 12.1 km / 194 kWh |
| line-2 | 19 | 739 kWh | 1,307 kWh | 494 kWh | 13.7 km / 220 kWh |
| line-3 | 24 | 888 kWh | 1,633 kWh | 656 kWh | 17.0 km / 274 kWh |
| line-4 | 24 | 853 kWh | 1,633 kWh | 694 kWh | 11.0 km / 178 kWh |
| line-5 | 21 | 695 kWh | 1,437 kWh | 672 kWh | 8.9 km / 144 kWh |
| line-6 | 20 | 762 kWh | 1,372 kWh | 534 kWh | 16.4 km / 264 kWh |
| line-7 | 23 | 918 kWh | 1,568 kWh | 558 kWh | 12.8 km / 206 kWh |
| line-8 | 14 | 586 kWh | 980 kWh | 335 kWh | 9.2 km / 149 kWh |
| line-9 | 50 | 1,705 kWh | 3,267 kWh | 1,391 kWh | 15.7 km / 253 kWh |
...
|---|---|---|---|
| `halt` | 41 | $600 k | $25 M |
| `standard` | 136 | $2.50 M | $340 M |
| `major` | 1 | $4.50 M | $4.5 M |
| `terminal` | 15 | $4.50 M | $68 M |
| `depot-terminal` | 1 | $5.0 M | $5.0 M |
| `interchange-elevated` | 67 | $12.0 M | $804 M |
| **Stations subtotal** | | | **$1.25 bn** |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 998 | $1.68 M | $1.68 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 5988 | $60 k | $359 M |
| High sensitivity check | 5988 | $120 k | $719 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 954,545 kW @ $700/kW | $668 M |
| Grid interconnection / PPA tie-in | 954,545 kW @ $100/kW | $95 M |
| Annual generation proxy | 954.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 2,090.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$764 M** |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $95 M |
...
| Stations | $1.25 bn |
| Depots | $8.0 M |
| Rolling stock | $1.68 bn |
| Railway production plant | $359 M |
| Dedicated solar power plant | $764 M |
| Residual train-control wayside + charging microgrids | $120 M |
...
| Steady-state, low capacity-use (year 6+) | **$276 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$294 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.45 bn cumulative** | $250 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.44 bn cumulative** | $249 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$12.73 bn cumulative** | $1,302 |

_Population basis: 9,780,429 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $294 M / yr → $294 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $5.13 bn | 4.5% | 40 y, 5 y grace | $294 M / yr |
| Government equity (no debt service) | 20% | $1.28 bn | — | — | — |
| **Total** | **100%** | **$6.42 bn** | | | **$294 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $231 M / yr = **$231 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($257 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (1972.6 GWh / yr) | 208,504 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 154.8 GWh/yr + dedicated solar plant 954.5 MW / 2090.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $11 M |
| Labour (2,694 FTE) | driverless roster: OCC/remote 503, station/platform 931, passenger service 231, fleet maintenance 574, infrastructure/energy 422, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $17 M |
| **OPEX subtotal** | | **$160 M / yr** |

_Annual service work: 208,504 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 82.2 M train-km / yr (493.2 M car-km / yr). On-site PV covers 154.8 GWh/yr and the dedicated solar plant adds 2090.5 GWh/yr against 1972.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 998 trainsets, 261 stations, 501.3 route-km, 9 lines, and 208,504 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 125.6 M |
| Annual paid trips / city resident | 42 | 68 | 13 |
| Farebox revenue | $421 M / yr | $674 M / yr | $127 M / yr |
| Station shop leases | $13 M / yr | $13 M / yr | $13 M / yr |
| Advertising boards | $20 M / yr | $20 M / yr | $20 M / yr |
| **Total revenue** | **$453 M / yr** | **$706 M / yr** | **$160 M / yr** |
| Revenue / OPEX recovery | 284% | 442% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $294 M / yr | $294 M / yr | **$294 M / yr** |
| Operating surplus applied to debt support | -$294 M / yr | -$294 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $276 k / yr | $0 k / yr | **$294 M / yr** |
| Operating surplus after OPEX (before debt support) | $294 M / yr | $546 M / yr | $0 / yr |

_Commercial-revenue assumptions: 39,048 m² of station shop/kiosk leases at $30/m²/month and 7,292 advertising boards at $266/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $153 M / yr | $245 M / yr | 19% of paid trips × $1.90 local spend proxy |
| Entertainment / community activity supported | $84 M / yr | $134 M / yr | 11% of paid trips × $1.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$559 M / yr** | **$895 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 22 education anchors | 68,849 trips/school day; 15.1 M access-events/yr | 110,158 trips/school day; 24.2 M access-events/yr |
| Healthcare | 43 healthcare anchors | 103,744 trips/day; 37.9 M access-events/yr | 165,991 trips/day; 60.6 M access-events/yr |
| Commerce | 84 major/terminal/interchange nodes | 220,599 trips/trading day; 72.8 M access-events/yr | 352,958 trips/trading day; 116.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.48 bn | 54% of $6.42 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.56 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $1.11 bn / yr | spread across 5 construction / grace years |
| Construction employment supported | 190,537 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $5.65 bn |
| Timetable-sized dedicated solar CAPEX | $764 M |
| **Reconciled project CAPEX** | **$6.42 bn** |
| 15%–25% planning risk envelope | $7.38 bn–$8.02 bn |
| Annual OPEX | $160 M / yr |
| Low/high project NPV at 8% | $-2795123 k / $-791397 k |
| Low/high project IRR | 2.5% / 6.7% |
| Low/high steady-state DSCR | 1.00 / 1.86 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 11,709.60 train-km; 188,870.09 kWh consumed; 191,442.34 kWh charged; 11 depot services completed; minimum SoC 75%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 211,892.08 train-km; 3,417,711.00 kWh consumed; 3,473,267.74 kWh charged; 1,597 depot services completed; minimum SoC 61%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 51.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 56.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 60.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 84.3% / 60% | pass |
| ten-hour single charging-pad outage | 60.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 261 line platforms, 19 interchange complexes, 75 civil segments, and 0 input findings |
