...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 53.7 km × €0.4 M/km | €21 M |
...
| Sovereign bonds (10-y benchmark + project) | 25% | €167 M | 8.5% | 25 y, 5 y grace | €18 M / yr |
| Government equity (no debt service) | 15% | €100 M | — | — | — |
| **Total** | **100%** | **€668 M** | | | **€47 M / yr** |
...
| **Total annual government burden** (debt service + OPEX shortfall) | **€59 M / yr** | **€54 M / yr** |
