...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.7%** | **$206 M** | **$41 M / yr** |
| **Local capital for domestic procurement / payroll** | **56.3%** | **$265 M** | **$53 M / yr** |
| of which planned local bond issuance | 45.1% of total CAPEX | $212 M | $42 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$38 M / yr** | $86 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$189 M cumulative** | $431 |
| Lifecycle envelope (yr 1–40, high scenario) | **$189 M cumulative** | $431 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.27 bn cumulative** | $2,889 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 44% | $206 M | 4.5% | 40 y, 5 y grace | $12 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $212 M | 8.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $53 M | — | — | — |
| **Total** | **100%** | **$471 M** | | | **$31 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $265 M | 56% of $471 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 14,542 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $206 M (43.7%) |
| Local-content / local-funding requirement | $265 M (56.3%) |
| 15%–25% planning risk envelope | $541 M–$588 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $132 M / $486 M |
| Low/high project IRR | 10.7% / 16.5% |
| Low/high steady-state DSCR | 2.07 / 3.52 |
