...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$681 M (87.0%) of external capital** and **$837 M of external interest**. Capital plus saved interest totals **$1.52 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Elevated (7.1 km @ $9.75 M/km) | $70 M |
...
|---|---:|---:|---:|---:|
| Civil works | $184 M | 15% | $28 M | $157 M |
...
| **Total city CAPEX** | **$435 M** | **23.4%** | **$101 M** | **$333 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$101 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$333 M** | **$67 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $266 M | $53 M / yr |
| **Total city programme** | **100.0%** | **$435 M** | **$87 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $587 M | $485 M (82.7%) | $596 M | **$1.08 bn** |
| **Default** | 2.00× | $782 M | $681 M (87.0%) | $837 M | **$1.52 bn** |
| High | 3.00× | $1.17 bn | $1.07 bn (91.4%) | $1.32 bn | **$2.39 bn** |

At the default 2.00× case, OSR's $101 M external requirement is 87.0% below the illustrative foreign-company requirement of $782 M; the associated lifetime external-interest saving is $837 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$203 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, high scenario) | **$203 M cumulative** | $461 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.25 bn cumulative** | $2,835 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $101 M | 4.5% | 40 y, 5 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $266 M | 8.5% | 40 y, 5 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$435 M** | | | **$30 M / yr** |
...
| Annual paid trips / city resident | 167 | 267 | 21 |
| Farebox revenue | $74 M / yr | $119 M / yr | $9.6 M / yr |
...
| Revenue / OPEX recovery | 643% | 1017% | 100% |
...
| Construction employment supported | 18,260 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $101 M (23.4%) |
| Local-content / local-funding requirement | $333 M (76.6%) |
| Default foreign-turnkey external-capital comparison | $782 M; OSR saves $681 M (87.0%) |
| Lifetime external interest and combined financing saving | $837 M interest; $1.52 bn capital + interest |
| 15%–25% planning risk envelope | $500 M–$543 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $167 M / $520 M |
| Low/high project IRR | 11.6% / 17.6% |
| Low/high steady-state DSCR | 2.17 / 3.66 |
