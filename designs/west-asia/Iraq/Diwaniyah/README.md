...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **34,135 – 56,892 trips/day**
...
| Steady-state, low-ridership (year 6+) | **$7.6 M / yr** | $17 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$272 M cumulative** | $617 |
| Lifecycle envelope (yr 1–25, high scenario) | **$120 M cumulative** | $273 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$120 M cumulative** | $273 |

_Population basis: 440,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 66,000 | 110,000 | 93,280 |
| Daily paid trips / population | 15% | 25% | 21% |
| Annual paid trips | 24.1 M | 40.1 M | 34.0 M |
| Farebox revenue | $18 M / yr | $31 M / yr | $26 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.3 M / yr | $3.3 M / yr | $3.3 M / yr |
| **Total revenue** | **$24 M / yr** | **$36 M / yr** | **$31 M / yr** |
| Revenue / OPEX + debt-service recovery | 76% | 115% | 100% |
