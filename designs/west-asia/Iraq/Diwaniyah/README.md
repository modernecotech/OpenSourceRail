...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$740 M (87.4%) of external capital** and **$910 M of external interest**. Capital plus saved interest totals **$1.65 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Onboard battery adequacy | 7.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 472 kWh usable margin across the worst powered-stop gap (line-3) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 167 kWh | 233 kWh | 49 kWh | 7.0 km / 57 kWh |
| line-2 | 5 | 103 kWh | 143 kWh | 30 kWh | 3.7 km / 30 kWh |
| line-3 | 4 | 132 kWh | 196 kWh | 50 kWh | 8.5 km / 68 kWh |
...
| Elevated (7.1 km @ $12.0 M/km) | $86 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 46,308 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 46,308 kW @ $100/kW | $4.6 M |
...
|---|---:|---:|---:|---:|
| Civil works | $218 M | 15% | $33 M | $186 M |
...
| **Total city CAPEX** | **$471 M** | **22.7%** | **$107 M** | **$364 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh diwaniyah`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.7%** | **$107 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.3%** | **$364 M** | **$73 M / yr** |
| of which planned local bond issuance | 61.8% of total CAPEX | $291 M | $58 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $636 M | $529 M (83.2%) | $650 M | **$1.18 bn** |
| **Default** | 2.00× | $847 M | $740 M (87.4%) | $910 M | **$1.65 bn** |
| High | 3.00× | $1.27 bn | $1.16 bn (91.6%) | $1.43 bn | **$2.60 bn** |

At the default 2.00× case, OSR's $107 M external requirement is 87.4% below the illustrative foreign-company requirement of $847 M; the associated lifetime external-interest saving is $910 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $74 |
| Lifecycle envelope (yr 1–40, low scenario) | **$221 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$221 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $3,077 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $107 M | 4.5% | 40 y, 5 y grace | $6.1 M / yr |
...
| Traction energy (109.6 GWh / yr) | 23,180 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 46.3 MW / 101.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $556 k |
| Labour (313 FTE) | driverless roster: OCC/remote 69, station/platform 67, passenger service 49, fleet maintenance 63, infrastructure/energy 44, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 23,180 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.1 M train-km / yr (27.4 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 101.4 GWh/yr against 109.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 106 trainsets, 19 stations, 49.8 route-km, 3 lines, and 23,180 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 167 | 267 | 23 |
| Farebox revenue | $74 M / yr | $119 M / yr | $10 M / yr |
| Station shop leases | $889 k / yr | $889 k / yr | $889 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$77 M / yr** | **$121 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 608% | 962% | 100% |
...
_Commercial-revenue assumptions: 2,768 m² of station shop/kiosk leases at $30/m²/month and 548 advertising boards at $266/board/month, with occupancy derates applied._
...
| Entertainment / community | 20.5 h/day service span | 21,549 trips/activity day; 6.5 M access-events/yr | 34,478 trips/activity day; 10.3 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $364 M | 77% of $471 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,948 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $107 M (22.7%) |
| Local-content / local-funding requirement | $364 M (77.3%) |
| Default foreign-turnkey external-capital comparison | $847 M; OSR saves $740 M (87.4%) |
...
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $132 M / $486 M |
| Low/high project IRR | 10.7% / 16.5% |
| Low/high steady-state DSCR | 1.98 / 3.36 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,997.69 train-km; 16,110.92 kWh consumed; 12,847.70 kWh charged; 32 depot services completed; minimum SoC 60%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,964.30 train-km; 185,196.54 kWh consumed; 170,361.42 kWh charged; 476 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.1% of scheduled train-km delivered; 223 SoC warnings; 37 energy-adapted off-peak departures, maximum 20 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 96.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 92.3% / 90% | pass |
