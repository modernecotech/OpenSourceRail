...
|---|---|---|
| Construction (years 1–5) | **$55 M / yr** | $124 |
| Steady-state, low-ridership (year 6+) | **$56 M / yr** | $128 |
| Steady-state, high-ridership (year 6+) | **$51 M / yr** | $116 |
| Steady-state, operating-neutral revenue case | **$51 M / yr** | $116 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.40 bn cumulative** | $3,172 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.30 bn cumulative** | $2,951 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.30 bn cumulative** | $2,951 |

_Population basis: 440,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.9 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $436 M | 4.0% | 25 y, 5 y grace | $32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $182 M | 8.5% | 25 y, 5 y grace | $19 M / yr |
| Government equity (no debt service) | 15% | $109 M | — | — | — |
| **Total** | **100%** | **$726 M** | | | **$51 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $15 M / yr = **$33 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 34,135 | 56,892 | 51,691 |
| Daily paid trips / catchment | 18% | 30% | 27% |
| Daily paid trips / city population | 8% | 13% | 12% |
| Annual paid trips | 12.5 M | 20.8 M | 18.9 M |
| Farebox revenue | $9.5 M / yr | $16 M / yr | $14 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.3 M / yr | $3.3 M / yr | $3.3 M / yr |
| **Total revenue** | **$15 M / yr** | **$21 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 75% | 107% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $56 M / yr | $51 M / yr | **$51 M / yr** |
