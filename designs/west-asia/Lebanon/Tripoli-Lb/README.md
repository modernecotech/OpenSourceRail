...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$604 M (86.6%) of external capital** and **$765 M of external interest**. Capital plus saved interest totals **$1.37 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 57.5% |
| Route length (double track) | 45.6 km |
...
| Total fleet capacity | 35,640 AW2 pax (47,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 89 × 360 = **32,040 AW2 passengers** (42,720 AW3 crush)
- **Total fleet passenger capacity:** 99 × 360 = **35,640 AW2 passengers** (47,520 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 57.5%
- Catchment population: **≈ 419,749** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **45.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 498 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 47 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 59 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 21,210 train-km/day | One-way train journeys × route length |
| Annual service work | 8.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 275 MWh/day | 25.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 216 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 45.2 MW / 248 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 91 kWh | 147 kWh | 47 kWh | 3.0 km / 22 kWh |
| line-2 | 8 | 136 kWh | 233 kWh | 84 kWh | 3.5 km / 25 kWh |
| line-3 | 6 | 102 kWh | 172 kWh | 59 kWh | 5.9 km / 42 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (44.3 km @ $2.58 M/km) | $114 M |
| Elevated (1.4 km @ $9.75 M/km) | $13 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$132 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 99 | $900 k | $89 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 297 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 297 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 45,169 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 45,169 kW @ $100/kW | $4.5 M |
| Annual generation proxy | 45.2 MW × 5.5 peak-sun-h/day × 365 d/yr | 90.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 45.6 km × $0.050 M/km | $2.3 M |
...
| Per-capita (city pop) | $531 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $132 M | 15% | $20 M | $112 M |
| Stations | $95 M | 20% | $19 M | $76 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $89 M | 35% | $31 M | $58 M |
| Dedicated solar plant | $36 M | 45% | $16 M | $20 M |
| Residual signalling / train control | $2.3 M | 50% | $1.1 M | $1.1 M |
| Charging microgrids | $2.2 M | 40% | $890 k | $1.3 M |
| EPC / project services | $23 M | 15% | $3.5 M | $20 M |
| **Total city CAPEX** | **$388 M** | **24.2%** | **$94 M** | **$294 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tripoli-lb`.
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $524 M | $430 M (82.1%) | $544 M | **$974 M** |
| **Default** | 2.00× | $698 M | $604 M (86.6%) | $765 M | **$1.37 bn** |
| High | 3.00× | $1.05 bn | $953 M (91.0%) | $1.21 bn | **$2.16 bn** |

At the default 2.00× case, OSR's $94 M external requirement is 86.6% below the illustrative foreign-company requirement of $698 M; the associated lifetime external-interest saving is $765 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.

### Government commitment summary (budgetable)

Bottom line for next year's budget submission. Construction phase runs **years 1–8** (local public-equity drawdown + interest-only grace on external import finance and local bonds; capital-raising draws are shown above; no climate-development grant assumed); steady-state operation begins **year 9** and runs for **32 years** until the loans amortise.

| Phase | Annual gov / municipal commitment | Per resident / yr |
|---|---|---|
| Construction (years 1–8) | **$70 M / yr** | $96 |
| Steady-state, low capacity-use (year 9+) | **$18 M / yr** | $25 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$64 M / yr** | $88 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.14 bn cumulative** | $1,563 |
| Lifecycle envelope (yr 1–40, high scenario) | **$563 M cumulative** | $771 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.63 bn cumulative** | $3,596 |

_Population basis: 730,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $46 M / yr → $64 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $94 M | 4.5% | 40 y, 8 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $235 M | 25.0% | 40 y, 8 y grace | $59 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $59 M | — | — | — |
| **Total** | **100%** | **$388 M** | | | **$64 M / yr** |

_During the 8-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.2 M / yr + local bonds $59 M / yr = **$63 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.4 M / yr × 8 yr). Principal repayment begins in year 9 on a 32-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $114 k |
| Traction energy (100.3 GWh / yr) | 21,210 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 45.2 MW / 90.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $542 k |
| Labour (315 FTE) | driverless roster: OCC/remote 69, station/platform 77, passenger service 49, fleet maintenance 58, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 21,210 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.1 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 90.7 GWh/yr against 100.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 99 trainsets, 20 stations, 45.6 route-km, 3 lines, and 21,210 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 100 | 161 | 15 |
| Farebox revenue | $55 M / yr | $88 M / yr | $8.4 M / yr |
| Station shop leases | $776 k / yr | $776 k / yr | $776 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$57 M / yr** | **$90 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 546% | 862% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gross repayable-debt service + residual OPEX subsidy | $64 M / yr | $64 M / yr | **$64 M / yr** |
| Operating surplus applied to debt support | -$46 M / yr | -$64 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $0 k / yr | **$64 M / yr** |
| Operating surplus after OPEX (before debt support) | $46 M / yr | $79 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,280 m² of station shop/kiosk leases at $22/m²/month and 636 advertising boards at $196/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $16 M / yr | $25 M / yr | 16 min/trip × $0.81/h value-of-time proxy |
| Avoided road congestion | $12 M / yr | $19 M / yr | 150 M - 241 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.2 M / yr | $3.5 M / yr | 27.1–43.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.0 M / yr | $9.6 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$72 M / yr** | **$115 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 4 healthcare anchors | 18,189 trips/day; 6.6 M access-events/yr | 29,102 trips/day; 10.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $294 M | 76% of $388 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $471 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $59 M / yr | spread across 8 construction / grace years |
| Construction employment supported | 21,880 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $352 M |
| Timetable-sized dedicated solar CAPEX | $36 M |
| **Reconciled project CAPEX** | **$388 M** |
| Imported / external-capital requirement | $94 M (24.2%) |
| Local-content / local-funding requirement | $294 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $698 M; OSR saves $604 M (86.6%) |
| Lifetime external interest and combined financing saving | $765 M interest; $1.37 bn capital + interest |
| 15%–25% planning risk envelope | $446 M–$485 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $8.0 M / $211 M |
| Low/high project IRR | 8.2% / 12.7% |
| Low/high steady-state DSCR | 0.72 / 1.23 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,831.24 train-km; 13,184.00 kWh consumed; 13,411.38 kWh charged; 32 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,259.79 train-km; 153,059.79 kWh consumed; 155,865.64 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 57%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 47.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 25.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 57.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.7% / 60% | pass |
| ten-hour single charging-pad outage | 22.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Tripoli-Lb energy and battery simulation dashboard](engineering/screenshots/tripoli-lb-simulation-dashboard.png) | ![Tripoli-Lb simulator network visualizer](engineering/screenshots/tripoli-lb-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 20 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Tripoli-Lb QGIS engineering layers](engineering/screenshots/tripoli-lb-qgis-engineering-map.png) | ![Tripoli-Lb SUMO timetable validation](engineering/screenshots/tripoli-lb-sumo-validation.png) |
...
scripts/regenerate-city.sh tripoli-lb
```
