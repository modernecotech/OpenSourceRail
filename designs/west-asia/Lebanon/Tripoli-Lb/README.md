...
|---|---|---|
| Construction (years 1–8) | **$26 M / yr** | $36 |
| Steady-state, low capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$210 M cumulative** | $287 |
| Lifecycle envelope (yr 1–40, high scenario) | **$210 M cumulative** | $287 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$865 M cumulative** | $1,185 |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $242 M | 56% of $430 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $386 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $48 M / yr | spread across 8 construction / grace years |
| Construction employment supported | 17,970 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-24813 k / $178 M |
| Low/high project IRR | 7.4% / 11.7% |
| Low/high steady-state DSCR | 2.24 / 3.85 |
