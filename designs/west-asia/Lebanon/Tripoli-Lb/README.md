...
|---|---|---|---|---|
| line-1 | 12.6 km | 9 | 31 | NW Mid ↔ SE Mid |
| line-2 | 18.8 km | 12 | 49 | NE Outer ↔ SW Mid |
| line-3 | 14.2 km | 9 | 36 | W Mid ↔ SE Outer |
| **Total** | **45.6 km** | **30 unique** | **116** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **42.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 16.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 508 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 59 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 74 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 42.1 MW / 231 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 91 kWh | 163 kWh | 64 kWh | 2.0 km / 15 kWh |
| line-2 | 12 | 136 kWh | 261 kWh | 112 kWh | 2.4 km / 18 kWh |
| line-3 | 8 | 102 kWh | 172 kWh | 59 kWh | 4.5 km / 32 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (43.0 km @ $3.0 M/km) | $129 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,064 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 42,064 kW @ $100/kW | $4.2 M |
| Annual generation proxy | 42.1 MW × 5.5 peak-sun-h/day × 365 d/yr | 84.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–8) | **$32 M / yr** | $43 |
| Steady-state, low capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$252 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, high scenario) | **$252 M cumulative** | $345 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.04 bn cumulative** | $1,424 |
...
| Traction energy (100.3 GWh / yr) | 21,210 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.9 GWh/yr + dedicated solar plant 42.1 MW / 84.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $505 k |
| Labour (366 FTE) | driverless roster: OCC/remote 73, station/platform 115, passenger service 49, fleet maintenance 63, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 21,210 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.1 M car-km / yr). On-site PV covers 26.9 GWh/yr and the dedicated solar plant adds 84.4 GWh/yr against 100.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 116 trainsets, 30 stations, 45.6 route-km, 3 lines, and 21,210 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 100 | 161 | 18 |
| Farebox revenue | $55 M / yr | $88 M / yr | $9.9 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$58 M / yr** | **$91 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 447% | 701% | 100% |
...
| Operating surplus after OPEX (before debt support) | $45 M / yr | $78 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,944 m² of station shop/kiosk leases at $22/m²/month and 940 advertising boards at $196/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $293 M | 57% of $517 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,785 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $483 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$517 M** |
| 15%–25% planning risk envelope | $594 M–$646 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-93831 k / $109 M |
| Low/high project IRR | 5.9% / 10.0% |
| Low/high steady-state DSCR | 1.82 / 3.16 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,815.08 train-km; 13,067.77 kWh consumed; 13,993.12 kWh charged; 30 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,940.26 train-km; 157,960.39 kWh consumed; 161,571.53 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 63.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 74.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 99.7% / 60% | pass |
| ten-hour single charging-pad outage | 65.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 30 line platforms, 2 interchange complexes, 12 civil segments, and 0 input findings |
