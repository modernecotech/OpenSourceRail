...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$642 M (86.9%) of external capital** and **$813 M of external interest**. Capital plus saved interest totals **$1.46 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (44.3 km @ $3.0 M/km) | $133 M |
...
|---|---:|---:|---:|---:|
| Civil works | $154 M | 15% | $23 M | $130 M |
...
| **Total city CAPEX** | **$411 M** | **23.7%** | **$97 M** | **$314 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$97 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$314 M** | **$39 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $251 M | $31 M / yr |
| **Total city programme** | **100.0%** | **$411 M** | **$51 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $555 M | $457 M (82.5%) | $579 M | **$1.04 bn** |
| **Default** | 2.00× | $739 M | $642 M (86.9%) | $813 M | **$1.46 bn** |
| High | 3.00× | $1.11 bn | $1.01 bn (91.2%) | $1.28 bn | **$2.29 bn** |

At the default 2.00× case, OSR's $97 M external requirement is 86.9% below the illustrative foreign-company requirement of $739 M; the associated lifetime external-interest saving is $813 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–8) | **$75 M / yr** | $103 |
| Steady-state, low capacity-use (year 9+) | **$23 M / yr** | $31 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$69 M / yr** | $94 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.32 bn cumulative** | $1,812 |
| Lifecycle envelope (yr 1–40, high scenario) | **$599 M cumulative** | $821 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.79 bn cumulative** | $3,826 |

_Population basis: 730,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $46 M / yr → $69 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $97 M | 4.5% | 40 y, 8 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $251 M | 25.0% | 40 y, 8 y grace | $63 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$411 M** | | | **$69 M / yr** |

_During the 8-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.4 M / yr + local bonds $63 M / yr = **$67 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.8 M / yr × 8 yr). Principal repayment begins in year 9 on a 32-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 11.8 M |
| Annual paid trips / city resident | 100 | 161 | 16 |
| Farebox revenue | $55 M / yr | $88 M / yr | $8.8 M / yr |
| Station shop leases | $776 k / yr | $776 k / yr | $776 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$57 M / yr** | **$90 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 524% | 828% | 100% |
...
| Operating surplus applied to debt support | -$46 M / yr | -$69 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $0 k / yr | **$69 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $314 M | 76% of $411 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,332 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $375 M |
| Timetable-sized dedicated solar CAPEX | $36 M |
| **Reconciled project CAPEX** | **$411 M** |
| Imported / external-capital requirement | $97 M (23.7%) |
| Local-content / local-funding requirement | $314 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $739 M; OSR saves $642 M (86.9%) |
| Lifetime external interest and combined financing saving | $813 M interest; $1.46 bn capital + interest |
| 15%–25% planning risk envelope | $472 M–$513 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-11116 k / $192 M |
| Low/high project IRR | 7.7% / 12.1% |
| Low/high steady-state DSCR | 0.67 / 1.15 |
