...
| Bucket | Value |
|---|---|
| At-grade (51.6 km @ €3.5 M/km) | €181 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.1 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–8) | **€58 M / yr** | €80 |
| Steady-state, low-ridership (year 9+) | **€66 M / yr** | €91 |
| Steady-state, high-ridership (year 9+) | **€61 M / yr** | €83 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.93 bn cumulative** | €2,638 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.80 bn cumulative** | €2,465 |

_Population basis: 730,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€8.9 M / yr (low) → €3.2 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €323 M | 4.5% | 30 y, 8 y grace | €23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €135 M | 25.0% | 30 y, 8 y grace | €34 M / yr |
| Government equity (no debt service) | 15% | €81 M | — | — | — |
| **Total** | **100%** | **€539 M** | | | **€57 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €34 M / yr = **€48 M / yr** total — plus the equity tranche amortised across construction (€10 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
...
| Labour (331 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.4 M |
...
|---|---|---|
| Annual paid trips | 13.3 M | 26.6 M |
| Farebox revenue | €5.7 M / yr | €11 M / yr |
| Farebox / OPEX recovery | 39% | 78% |
| Country policy-target recovery (diagnostic) | 40% | 40% |
| Operating shortfall (gov subsidy required) | €8.9 M / yr | €3.2 M / yr |
