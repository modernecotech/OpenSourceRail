...
|---|---|---|
| Construction (years 1–8) | **$67 M / yr** | $91 |
| Steady-state, low-ridership (year 9+) | **$67 M / yr** | $91 |
| Steady-state, high-ridership (year 9+) | **$65 M / yr** | $90 |
| Steady-state, operating-neutral revenue case | **$65 M / yr** | $90 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.00 bn cumulative** | $2,738 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.97 bn cumulative** | $2,702 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.97 bn cumulative** | $2,702 |

_Population basis: 730,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.2 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $369 M | 4.5% | 30 y, 8 y grace | $27 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $154 M | 25.0% | 30 y, 8 y grace | $39 M / yr |
| Government equity (no debt service) | 15% | $92 M | — | — | — |
| **Total** | **100%** | **$615 M** | | | **$65 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $38 M / yr = **$55 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 65,568 | 109,281 | 71,443 |
| Daily paid trips / catchment | 18% | 30% | 20% |
| Daily paid trips / city population | 9% | 15% | 10% |
| Annual paid trips | 23.9 M | 39.9 M | 26.1 M |
| Farebox revenue | $13 M / yr | $22 M / yr | $15 M / yr |
...
| Gov debt service + residual OPEX subsidy | $67 M / yr | $65 M / yr | **$65 M / yr** |
