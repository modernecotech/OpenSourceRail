...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **21,420 – 32,130 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (35.1 km @ $0.85 M/km) | $30 M |
| Elevated (1.9 km @ $4.0 M/km) | $7.4 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 52 | $534 k | $28 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 37.2 km × $0.015 M/km | $558 k |
...
|---|---|---|
| Construction (years 1–8) | **$12 M / yr** | $39 |
| Steady-state, low-ridership (year 9+) | **$7.5 M / yr** | $25 |
| Steady-state, high-ridership (year 9+) | **$3.2 M / yr** | $11 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$258 M cumulative** | $860 |
| Lifecycle envelope (yr 1–30, high scenario) | **$164 M cumulative** | $546 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$93 M cumulative** | $309 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $64 M | 4.5% | 30 y, 8 y grace | $4.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $27 M | 25.0% | 30 y, 8 y grace | $6.7 M / yr |
| Government equity (no debt service) | 15% | $16 M | — | — | — |
| **Total** | **100%** | **$107 M** | | | **$11 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral $2.9 M / yr + bonds $6.7 M / yr = **$9.6 M / yr** total — plus the equity tranche amortised across construction ($2.0 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 60,789 |
| Daily paid trips / population | 8% | 15% | 20% |
| Annual paid trips | 8.8 M | 16.4 M | 22.2 M |
| Farebox revenue | $4.9 M / yr | $9.2 M / yr | $12 M / yr |
| Station shop leases | $978 k / yr | $978 k / yr | $978 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$7.4 M / yr** | **$12 M / yr** | **$15 M / yr** |
| Revenue / OPEX + debt-service recovery | 50% | 78% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov gap | $7.5 M / yr | $3.2 M / yr | **$0 / yr** |
