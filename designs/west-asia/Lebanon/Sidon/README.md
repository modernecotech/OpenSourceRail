...
| Revenue fleet | 100 × 2-car trainsets |
| Revenue fleet passenger capacity | 24,000 AW2 pax (32,000 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 15.0 km | 9 | 43 | S Mid ↔ NE Outer |
| line-2 |  9.8 km | 6 | 30 | SW Mid ↔ S Mid |
| line-3 | 12.9 km | 6 | 38 | SE Inner ↔ NE Outer |
| **Total** | **37.8 km** | **21 unique** | **111** | |
...
| Revenue fleet capacity | 24,000 AW2 pax (32,000 AW3 crush) |
| Total fleet capacity | 26,640 AW2 pax (35,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 100 × 240 = **24,000 AW2 passengers** (32,000 AW3 crush)
- **Total fleet passenger capacity:** 111 × 240 = **26,640 AW2 passengers** (35,520 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **19.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Dedicated solar plant | 19.8 MW / 109 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 72 kWh | 155 kWh | 76 kWh | 4.8 km / 23 kWh |
| line-2 | 6 | 47 kWh | 114 kWh | 63 kWh | 2.4 km / 12 kWh |
| line-3 | 5 | 62 kWh | 110 kWh | 42 kWh | 7.3 km / 35 kWh |
...
| Elevated (2.5 km @ $12.0 M/km) | $29 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 111 | $560 k | $62 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 222 | $60 k | $13 M |
| High sensitivity check | 222 | $120 k | $27 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 19,759 kW @ $700/kW | $14 M |
| Grid interconnection / PPA tie-in | 19,759 kW @ $100/kW | $2.0 M |
| Annual generation proxy | 19.8 MW × 5.5 peak-sun-h/day × 365 d/yr | 39.7 GWh/yr |
...
| Per-capita (city pop) | $1,296 / person |
...
|---|---|---|
| Construction (years 1–8) | **$24 M / yr** | $79 |
| Steady-state, low capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$190 M cumulative** | $632 |
| Lifecycle envelope (yr 1–40, high scenario) | **$190 M cumulative** | $632 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$783 M cumulative** | $2,609 |
...
| Traction energy (55.4 GWh / yr) | 17,558 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.9 GWh/yr + dedicated solar plant 19.8 MW / 39.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $237 k |
| Labour (319 FTE) | driverless roster: OCC/remote 73, station/platform 94, passenger service 38, fleet maintenance 57, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$9.7 M / yr** |

_Annual service work: 17,558 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.9 M train-km / yr (13.8 M car-km / yr). On-site PV covers 20.9 GWh/yr and the dedicated solar plant adds 39.7 GWh/yr against 55.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 111 trainsets, 21 stations, 37.8 route-km, 3 lines, and 17,558 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 9.6 M |
| Annual paid trips / city resident | 163 | 261 | 32 |
| Farebox revenue | $36 M / yr | $58 M / yr | $7.2 M / yr |
| Station shop leases | $971 k / yr | $971 k / yr | $971 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$39 M / yr** | **$61 M / yr** | **$9.7 M / yr** |
| Revenue / OPEX recovery | 402% | 628% | 100% |
...
| Operating surplus after OPEX (before debt support) | $29 M / yr | $51 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,104 m² of station shop/kiosk leases at $22/m²/month and 764 advertising boards at $196/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$47 M / yr** | **$75 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 15 major/terminal/interchange nodes | 31,471 trips/trading day; 10.4 M access-events/yr | 50,354 trips/trading day; 16.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $226 M | 58% of $389 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $362 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $45 M / yr | spread across 8 construction / grace years |
| Construction employment supported | 16,826 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-98311 k / $37 M |
| Low/high project IRR | 5.0% / 9.0% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,603.90 train-km; 7,698.10 kWh consumed; 8,268.80 kWh charged; 35 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,886.29 train-km; 85,846.97 kWh consumed; 88,153.74 kWh charged; 500 depot services completed (6 active at cutoff); minimum SoC 85%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 84.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 79.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 84.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 75.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 2 interchange complexes, 14 civil segments, and 0 input findings |
