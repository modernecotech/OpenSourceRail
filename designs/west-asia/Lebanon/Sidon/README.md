...
|---|---|---|
| Construction (years 1–8) | **$36 M / yr** | $120 |
| Steady-state, low-ridership (year 9+) | **$35 M / yr** | $118 |
| Steady-state, high-ridership (year 9+) | **$35 M / yr** | $118 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $118 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.06 bn cumulative** | $3,543 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.06 bn cumulative** | $3,543 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.06 bn cumulative** | $3,543 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $199 M | 4.5% | 30 y, 8 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $83 M | 25.0% | 30 y, 8 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $50 M | — | — | — |
| **Total** | **100%** | **$331 M** | | | **$35 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral $8.9 M / yr + bonds $21 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($6.2 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 38,556 | 64,260 | 25,208 |
| Daily paid trips / catchment | 18% | 30% | 12% |
| Daily paid trips / city population | 13% | 21% | 8% |
| Annual paid trips | 14.1 M | 23.5 M | 9.2 M |
| Farebox revenue | $7.9 M / yr | $13 M / yr | $5.2 M / yr |
