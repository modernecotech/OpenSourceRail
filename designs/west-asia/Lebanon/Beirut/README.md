...
|---|---|---|---|---|
| line-1 | 30.1 km | 14 | 41 | NE Outer ↔ S Mid |
| line-2 | 20.2 km | 11 | 29 | NE Outer ↔ W Mid |
| line-3 | 19.6 km | 12 | 28 | E Mid ↔ SW Mid |
| line-4 | 19.8 km | 11 | 28 | NW Mid ↔ S Outer |
| line-5 | 17.9 km | 9 | 26 | NW Inner ↔ SE Mid |
| line-6 | 52.0 km | 26 | 69 | W Mid ↔ W Mid |
| **Total** | **159.5 km** | **82 unique** | **221** | |
...
| Total fleet capacity | 106,080 AW2 pax (141,440 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 198 × 480 = **95,040 AW2 passengers** (126,720 AW3 crush)
- **Total fleet passenger capacity:** 221 × 480 = **106,080 AW2 passengers** (141,440 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **276.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 1,392 MWh/day | 80,541 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,204 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 276.9 MW / 1,384 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 221 | $5.60 M | $1.24 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 884 | $100 k | $88 M |
| High sensitivity check | 884 | $200 k | $177 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 276,861 kW @ $700/kW | $194 M |
| Grid interconnection / PPA tie-in | 276,861 kW @ $100/kW | $28 M |
| Annual generation proxy | 276.9 MW × 5.0 peak-sun-h/day × 365 d/yr | 505.3 GWh/yr |
...
| EPC integration + project management (7%) | on subtotal | $173 M |
...
| EPC overhead (7%) | $173 M |
| **CAPEX total** | **$2.87 bn** |
| Per-route-km | $18 M / km |
| Per-capita (city pop) | $1,303 / person |
...
|---|---|---|
| Construction (years 1–8) | **$118 M / yr** | $53 |
| Steady-state, low capacity-use (year 9+) | **$42 M / yr** | $19 |
| Steady-state, high capacity-use (year 9+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$98 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.30 bn cumulative** | $1,043 |
| Lifecycle envelope (yr 1–40, high scenario) | **$940 M cumulative** | $427 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.07 bn cumulative** | $1,849 |

_Population basis: 2,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $55 M / yr → $98 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.29 bn | 2.0% | 40 y, 8 y grace | $98 M / yr |
| Government equity (no debt service) | 20% | $573 M | — | — | — |
| **Total** | **100%** | **$2.87 bn** | | | **$98 M / yr** |

_During the 8-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $46 M / yr = **$46 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($72 M / yr × 8 yr). Principal repayment begins in year 9 on a 32-year amortisation schedule._
...
| Traction energy (508.0 GWh / yr) | 80,541 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 68.6 GWh/yr + dedicated solar plant 276.9 MW / 505.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.3 M |
| Labour (992 FTE) | driverless roster: OCC/remote 134, station/platform 351, passenger service 107, fleet maintenance 173, infrastructure/energy 173, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $4.7 M |
| **OPEX subtotal** | | **$80 M / yr** |

_Annual service work: 80,541 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 31.7 M train-km / yr (127.0 M car-km / yr). On-site PV covers 68.6 GWh/yr and the dedicated solar plant adds 505.3 GWh/yr against 508.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 168.2 M | 269.1 M | 94.0 M |
| Annual paid trips / city resident | 76 | 122 | 43 |
| Farebox revenue | $126 M / yr | $201 M / yr | $70 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| **Total revenue** | **$135 M / yr** | **$211 M / yr** | **$80 M / yr** |
...
| Operating surplus applied to debt support | -$55 M / yr | -$98 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $42 M / yr | $0 k / yr | **$98 M / yr** |
| Operating surplus after OPEX (before debt support) | $55 M / yr | $131 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $36 M / yr | $58 M / yr | 16 min/trip × $0.81/h value-of-time proxy |
| Avoided road congestion | $48 M / yr | $77 M / yr | 604 M - 966 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $8.7 M / yr | $14 M / yr | 108.6–173.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $24 M / yr | $39 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $58 M / yr | $93 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $27 M / yr | $43 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$202 M / yr** | **$324 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 29,381 trips/school day; 6.5 M access-events/yr | 47,009 trips/school day; 10.3 M access-events/yr |
| Healthcare | 11 healthcare anchors | 36,164 trips/day; 13.2 M access-events/yr | 57,862 trips/day; 21.1 M access-events/yr |
| Commerce | 55 major/terminal/interchange nodes | 106,181 trips/trading day; 35.0 M access-events/yr | 169,889 trips/trading day; 56.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.49 bn | 52% of $2.87 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.39 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $299 M / yr | spread across 8 construction / grace years |
| Construction employment supported | 111,203 job-years | retained CAPEX ÷ (4.0 × median annual income) |
