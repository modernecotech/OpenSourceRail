...
|---|---|---|
| Construction (years 1–8) | **$149 M / yr** | $68 |
| Steady-state, low-ridership (year 9+) | **$147 M / yr** | $67 |
| Steady-state, high-ridership (year 9+) | **$147 M / yr** | $67 |
| Steady-state, operating-neutral revenue case | **$147 M / yr** | $67 |
| Lifecycle envelope (yr 1–30, low scenario) | **$4.43 bn cumulative** | $2,012 |
| Lifecycle envelope (yr 1–30, high scenario) | **$4.43 bn cumulative** | $2,012 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.43 bn cumulative** | $2,012 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $828 M | 4.5% | 30 y, 8 y grace | $60 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $345 M | 25.0% | 30 y, 8 y grace | $87 M / yr |
| Government equity (no debt service) | 15% | $207 M | — | — | — |
| **Total** | **100%** | **$1.38 bn** | | | **$147 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral $37 M / yr + bonds $86 M / yr = **$123 M / yr** total — plus the equity tranche amortised across construction ($26 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
