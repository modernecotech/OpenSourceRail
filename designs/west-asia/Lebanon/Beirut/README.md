...
|---|---|---|---|---|
| line-1 | 31.9 km | 19 | 69 | SW Outer ↔ NE Outer |
| line-2 | 18.1 km | 14 | 46 | NW Mid ↔ S Mid |
| line-3 | 20.3 km | 14 | 48 | W Mid ↔ NE Outer |
| line-4 | 17.4 km | 11 | 40 | E Mid ↔ W Mid |
| line-5 | 18.5 km | 12 | 42 | NW Inner ↔ SE Mid |
| line-6 | 36.4 km | 25 | 21 | NE Mid ↔ NE Inner |
| **Total** | **142.6 km** | **95 unique** | **266** | |
...
| **Total installed** | **88** | **31,100 kW** | **170,500 kWh** |

Aggregate station-rail charging power: **132,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **173.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 643 kWh usable margin across the worst powered-stop gap (line-5) |
| Lowest traversal charging margin | 344 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 171 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 828 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 173.2 MW / 953 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 170 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 307 kWh | 858 kWh | 520 kWh | 8.0 km / 77 kWh |
| line-2 | 14 | 174 kWh | 735 kWh | 544 kWh | 2.0 km / 19 kWh |
| line-3 | 13 | 195 kWh | 686 kWh | 472 kWh | 4.3 km / 42 kWh |
| line-4 | 10 | 167 kWh | 539 kWh | 356 kWh | 5.0 km / 48 kWh |
| line-5 | 10 | 178 kWh | 539 kWh | 344 kWh | 8.0 km / 77 kWh |
| line-6 | 25 | 350 kWh | 1,225 kWh | 840 kWh | 2.5 km / 24 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (132.5 km @ $3.0 M/km) | $398 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1064 | $60 k | $64 M |
| High sensitivity check | 1064 | $120 k | $128 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 173,207 kW @ $700/kW | $121 M |
| Grid interconnection / PPA tie-in | 173,207 kW @ $100/kW | $17 M |
| Annual generation proxy | 173.2 MW × 5.5 peak-sun-h/day × 365 d/yr | 347.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$139 M** |
...
|---|---|---|
| Construction (years 1–8) | **$115 M / yr** | $52 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$918 M cumulative** | $417 |
| Lifecycle envelope (yr 1–40, high scenario) | **$918 M cumulative** | $417 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.78 bn cumulative** | $1,720 |

_Population basis: 2,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $90 M / yr → $90 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.50 bn | 4.5% | 40 y, 8 y grace | $90 M / yr |
| Government equity (no debt service) | 20% | $376 M | — | — | — |
| **Total** | **100%** | **$1.88 bn** | | | **$90 M / yr** |

_During the 8-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $68 M / yr = **$68 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($47 M / yr × 8 yr). Principal repayment begins in year 9 on a 32-year amortisation schedule._
...
| Traction energy (364.8 GWh / yr) | 57,837 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 62.4 GWh/yr + dedicated solar plant 173.2 MW / 347.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.1 M |
| Labour (1,074 FTE) | driverless roster: OCC/remote 154, station/platform 496, passenger service 111, fleet maintenance 156, infrastructure/energy 130, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.1 M |
| **OPEX subtotal** | | **$44 M / yr** |

_Annual service work: 57,837 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 22.8 M train-km / yr (91.2 M car-km / yr). On-site PV covers 62.4 GWh/yr and the dedicated solar plant adds 347.7 GWh/yr against 364.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 266 trainsets, 95 stations, 142.6 route-km, 6 lines, and 57,837 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 41.3 M |
| Annual paid trips / city resident | 81 | 130 | 19 |
| Farebox revenue | $134 M / yr | $214 M / yr | $31 M / yr |
| Station shop leases | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| Advertising boards | $7.9 M / yr | $7.9 M / yr | $7.9 M / yr |
| **Total revenue** | **$147 M / yr** | **$227 M / yr** | **$44 M / yr** |
| Revenue / OPEX recovery | 334% | 517% | 100% |
...
| Operating surplus applied to debt support | -$90 M / yr | -$90 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$90 M / yr** |
| Operating surplus after OPEX (before debt support) | $103 M / yr | $183 M / yr | $0 / yr |

_Commercial-revenue assumptions: 22,336 m² of station shop/kiosk leases at $22/m²/month and 3,944 advertising boards at $196/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$206 M / yr** | **$330 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 13 education anchors | 31,737 trips/school day; 7.0 M access-events/yr | 50,779 trips/school day; 11.2 M access-events/yr |
| Healthcare | 11 healthcare anchors | 37,422 trips/day; 13.7 M access-events/yr | 59,876 trips/day; 21.9 M access-events/yr |
| Commerce | 64 major/terminal/interchange nodes | 113,301 trips/trading day; 37.4 M access-events/yr | 181,282 trips/trading day; 59.8 M access-events/yr |
...
| Annualised during construction | $213 M / yr | spread across 8 construction / grace years |
| Construction employment supported | 79,335 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $139 M |
| **Reconciled project CAPEX** | **$1.88 bn** |
| 15%–25% planning risk envelope | $2.16 bn–$2.35 bn |
| Annual OPEX | $44 M / yr |
| Low/high project NPV at 8% | $-714389 k / $-218330 k |
| Low/high project IRR | 3.0% / 6.7% |
| Low/high steady-state DSCR | 1.15 / 2.05 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,461.67 train-km; 42,830.49 kWh consumed; 47,747.14 kWh charged; 43 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 58,867.22 train-km; 565,105.15 kWh consumed; 576,184.29 kWh charged; 983 depot services completed (8 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| 50% charging-contact availability | 86.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.6% / 60% | pass |
| ten-hour single charging-pad outage | 86.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 95 line platforms, 10 interchange complexes, 72 civil segments, and 0 input findings |
