...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 134 | $5.60 M | $750 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 536 | $100 k | $54 M |
| High sensitivity check | 536 | $200 k | $107 M |
...
| Per-capita (city pop) | $948 / person |
...
|---|---|---|
| Construction (years 1–8) | **$226 M / yr** | $103 |
| Steady-state, low-ridership (year 9+) | **$222 M / yr** | $101 |
| Steady-state, high-ridership (year 9+) | **$222 M / yr** | $101 |
| Steady-state, operating-neutral revenue case | **$222 M / yr** | $101 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.70 bn cumulative** | $3,043 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.70 bn cumulative** | $3,043 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$6.70 bn cumulative** | $3,043 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.25 bn | 4.5% | 30 y, 8 y grace | $91 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $522 M | 25.0% | 30 y, 8 y grace | $131 M / yr |
| Government equity (no debt service) | 15% | $313 M | — | — | — |
| **Total** | **100%** | **$2.09 bn** | | | **$222 M / yr** |

_During the 8-year grace period the operator pays interest only — multilateral $56 M / yr + bonds $130 M / yr = **$187 M / yr** total — plus the equity tranche amortised across construction ($39 M / yr × 8 yr). Principal repayment begins in year 9 on a 22-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 275,616 | 449,280 | 231,401 |
| Daily paid trips / catchment | 18% | 29% | 15% |
| Daily paid trips / city population | 13% | 20% | 11% |
| Annual paid trips | 100.6 M | 164.0 M | 84.5 M |
| Farebox revenue | $56 M / yr | $92 M / yr | $47 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| **Total revenue** | **$66 M / yr** | **$101 M / yr** | **$57 M / yr** |
| Revenue / OPEX recovery | 116% | 178% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $222 M / yr | $222 M / yr | **$222 M / yr** |
| Operating surplus after OPEX | $9.0 M / yr | $45 M / yr | $0 / yr |
