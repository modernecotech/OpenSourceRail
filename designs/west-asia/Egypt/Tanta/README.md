...
| Lifecycle envelope (yr 1–40, high scenario) | **$871 M cumulative** | $1,162 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$871 M cumulative** | $1,162 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $905 k / yr → $0 k / yr._
...
| Operating surplus after OPEX | $0 k / yr | $20 M / yr | $0 / yr |
