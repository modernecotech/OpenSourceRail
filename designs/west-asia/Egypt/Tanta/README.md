...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$904 M (86.2%) of external capital** and **$1.11 bn of external interest**. Capital plus saved interest totals **$2.02 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 158 × 3-car trainsets |
| Revenue fleet passenger capacity | 56,880 AW2 pax (75,840 AW3 crush) |
...
| Revenue fleet capacity | 56,880 AW2 pax (75,840 AW3 crush) |
| Total fleet capacity | 63,360 AW2 pax (84,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 158 × 360 = **56,880 AW2 passengers** (75,840 AW3 crush)
- **Total fleet passenger capacity:** 176 × 360 = **63,360 AW2 passengers** (84,480 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 56.5%
- Catchment population: **≈ 423,749** (within ~800 m walk of a station)
...
| Interchange | 3 | 300 kW | 1000 kWh |
| Major | 3 | 300 kW | 1000 kWh |
| Standard | 8 | 300 kW | 1000 kWh |
| Terminal | 5 | 300 kW | 1000 kWh |
| **Total installed** | **20** | **10,700 kW** | **59,000 kWh** |

Aggregate station-rail charging power: **20,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **74.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 444 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 94 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 64 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 34,838 train-km/day | One-way train journeys × route length |
| Annual service work | 13.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 452 MWh/day | 41.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 387 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 74.2 MW / 445 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 59 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 146 kWh | 294 kWh | 133 kWh | 5.3 km / 43 kWh |
| line-2 | 6 | 224 kWh | 343 kWh | 96 kWh | 11.8 km / 95 kWh |
| line-3 | 6 | 233 kWh | 351 kWh | 94 kWh | 11.9 km / 96 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (74.7 km @ $3.0 M/km) | $224 M |
| Elevated (0.2 km @ $12.0 M/km) | $2.5 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 176 | $900 k | $158 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 528 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 528 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 74,233 kW @ $700/kW | $52 M |
| Grid interconnection / PPA tie-in | 74,233 kW @ $100/kW | $7.4 M |
| Annual generation proxy | 74.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 162.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$59 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 74.9 km × $0.050 M/km | $3.7 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $4.3 M |
...
| Dedicated solar power plant | $59 M |
| Residual train-control wayside + charging microgrids | $8.0 M |
| EPC overhead (7%) | $34 M |
| **CAPEX total** | **$583 M** |
| Per-route-km | $7.8 M / km |
| Per-capita (city pop) | $777 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $227 M | 15% | $34 M | $193 M |
| Stations | $88 M | 20% | $18 M | $70 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $158 M | 35% | $55 M | $103 M |
| Dedicated solar plant | $59 M | 45% | $27 M | $33 M |
| Residual signalling / train control | $3.7 M | 50% | $1.9 M | $1.9 M |
| Charging microgrids | $4.3 M | 40% | $1.7 M | $2.6 M |
| EPC / project services | $34 M | 15% | $5.1 M | $29 M |
| **Total city CAPEX** | **$583 M** | **24.8%** | **$144 M** | **$438 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tanta`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.8%** | **$144 M** | **$29 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.2%** | **$438 M** | **$88 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $351 M | $70 M / yr |
| **Total city programme** | **100.0%** | **$583 M** | **$117 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $787 M | $642 M (81.6%) | $790 M | **$1.43 bn** |
| **Default** | 2.00× | $1.05 bn | $904 M (86.2%) | $1.11 bn | **$2.02 bn** |
| High | 3.00× | $1.57 bn | $1.43 bn (90.8%) | $1.76 bn | **$3.19 bn** |

At the default 2.00× case, OSR's $144 M external requirement is 86.2% below the illustrative foreign-company requirement of $1.05 bn; the associated lifetime external-interest saving is $1.11 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$61 M / yr** | $81 |
| Steady-state, low capacity-use (year 6+) | **$9.2 M / yr** | $12 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$625 M cumulative** | $833 |
| Lifecycle envelope (yr 1–40, high scenario) | **$304 M cumulative** | $406 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.92 bn cumulative** | $2,563 |

_Population basis: 750,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $37 M / yr → $46 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $144 M | 4.5% | 40 y, 5 y grace | $8.3 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $351 M | 10.5% | 40 y, 5 y grace | $38 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $88 M | — | — | — |
| **Total** | **100%** | **$583 M** | | | **$46 M / yr** |
...
| Traction energy (164.8 GWh / yr) | 34,838 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 74.2 MW / 162.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $891 k |
| Labour (418 FTE) | driverless roster: OCC/remote 102, station/platform 85, passenger service 49, fleet maintenance 99, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 34,838 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.7 M train-km / yr (41.2 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 162.6 GWh/yr against 164.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 176 trainsets, 25 stations, 74.9 route-km, 3 lines, and 34,838 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 19.8 M |
| Annual paid trips / city resident | 98 | 156 | 26 |
| Farebox revenue | $51 M / yr | $81 M / yr | $14 M / yr |
| Station shop leases | $726 k / yr | $726 k / yr | $726 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 336% | 531% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $46 M / yr | $46 M / yr | **$46 M / yr** |
| Operating surplus applied to debt support | -$37 M / yr | -$46 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.2 M / yr | $0 k / yr | **$46 M / yr** |
| Operating surplus after OPEX (before debt support) | $37 M / yr | $68 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,304 m² of station shop/kiosk leases at $21/m²/month and 652 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $20 M / yr | $32 M / yr | 247 M - 395 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.6 M / yr | $5.7 M / yr | 44.5–71.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$83 M / yr** | **$132 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 1 healthcare anchors | 13,928 trips/day; 5.1 M access-events/yr | 22,284 trips/day; 8.1 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 42,265 trips/trading day; 13.9 M access-events/yr | 67,624 trips/trading day; 22.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $438 M | 75% of $583 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $701 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $140 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 35,114 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $523 M |
| Timetable-sized dedicated solar CAPEX | $59 M |
| **Reconciled project CAPEX** | **$583 M** |
| Imported / external-capital requirement | $144 M (24.8%) |
| Local-content / local-funding requirement | $438 M (75.2%) |
| Default foreign-turnkey external-capital comparison | $1.05 bn; OSR saves $904 M (86.2%) |
| Lifetime external interest and combined financing saving | $1.11 bn interest; $2.02 bn capital + interest |
| 15%–25% planning risk envelope | $670 M–$728 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-171215 k / $71 M |
| Low/high project IRR | 4.6% / 9.2% |
| Low/high steady-state DSCR | 0.80 / 1.46 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,784.92 train-km; 22,459.88 kWh consumed; 22,012.18 kWh charged; 29 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 33,316.76 train-km; 268,693.36 kWh consumed; 272,061.85 kWh charged; 531 depot services completed (6 active at cutoff); minimum SoC 58%; 0 onboard emergencies; 0 invariant violations; 95.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 53.9% | 95.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.4% | 95.5% / 90% | pass |
| 50% charging-contact availability | 58.2% | 95.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 85.4% / 60% | pass |
| ten-hour single charging-pad outage | 58.2% | 95.6% / 90% | pass |
...
|---|---|
| ![Tanta energy and battery simulation dashboard](engineering/screenshots/tanta-simulation-dashboard.png) | ![Tanta simulator network visualizer](engineering/screenshots/tanta-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 1 interchange complexes, 17 civil segments, and 0 input findings |
...
|---|---|
| ![Tanta QGIS engineering layers](engineering/screenshots/tanta-qgis-engineering-map.png) | ![Tanta SUMO timetable validation](engineering/screenshots/tanta-sumo-validation.png) |
...
scripts/regenerate-city.sh tanta
```
