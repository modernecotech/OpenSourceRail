...
| Revenue fleet | 174 × 3-car trainsets |
| Revenue fleet passenger capacity | 62,640 AW2 pax (83,520 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 18.2 km | 10 | 48 | N Mid ↔ SW Outer |
| line-2 | 27.8 km | 14 | 71 | NW Outer ↔ SE Outer |
| line-3 | 28.9 km | 14 | 74 | SW Outer ↔ NE Outer |
| **Total** | **74.9 km** | **38 unique** | **193** | |
...
| Revenue fleet capacity | 62,640 AW2 pax (83,520 AW3 crush) |
| Total fleet capacity | 69,480 AW2 pax (92,640 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 174 × 360 = **62,640 AW2 passengers** (83,520 AW3 crush)
- **Total fleet passenger capacity:** 193 × 360 = **69,480 AW2 passengers** (92,640 AW3 crush, incl. service rotation + spare + reserve)
...
| Lowest traversal charging margin | 59 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 369 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 70.8 MW / 425 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 146 kWh | 220 kWh | 59 kWh | 5.5 km / 45 kWh |
| line-2 | 11 | 224 kWh | 314 kWh | 68 kWh | 7.7 km / 62 kWh |
| line-3 | 10 | 233 kWh | 327 kWh | 70 kWh | 8.4 km / 68 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 193 | $900 k | $174 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 579 | $60 k | $35 M |
| High sensitivity check | 579 | $120 k | $69 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 70,783 kW @ $700/kW | $50 M |
| Grid interconnection / PPA tie-in | 70,783 kW @ $100/kW | $7.1 M |
| Annual generation proxy | 70.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 155.0 GWh/yr |
...
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$256 M cumulative** | $341 |
| Lifecycle envelope (yr 1–40, high scenario) | **$256 M cumulative** | $341 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.33 bn cumulative** | $1,779 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $538 M | 4.5% | 40 y, 5 y grace | $31 M / yr |
| Government equity (no debt service) | 20% | $135 M | — | — | — |
| **Total** | **100%** | **$673 M** | | | **$31 M / yr** |
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $6.9 M |
...
| Traction energy (164.8 GWh / yr) | 34,838 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.0 GWh/yr + dedicated solar plant 70.8 MW / 155.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $849 k |
| Labour (470 FTE) | driverless roster: OCC/remote 110, station/platform 120, passenger service 49, fleet maintenance 104, infrastructure/energy 66, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.1 M |
| **OPEX subtotal** | | **$17 M / yr** |

_Annual service work: 34,838 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.7 M train-km / yr (41.2 M car-km / yr). On-site PV covers 30.0 GWh/yr and the dedicated solar plant adds 155.0 GWh/yr against 164.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 193 trainsets, 38 stations, 74.9 route-km, 3 lines, and 34,838 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 21.0 M |
| Annual paid trips / city resident | 98 | 156 | 28 |
...
| **Total revenue** | **$54 M / yr** | **$84 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 310% | 487% | 100% |
...
| Operating surplus after OPEX (before debt support) | $36 M / yr | $67 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,576 m² of station shop/kiosk leases at $21/m²/month and 904 advertising boards at $182/board/month, with occupancy derates applied._
...
| Commerce | 14 major/terminal/interchange nodes | 39,912 trips/trading day; 13.2 M access-events/yr | 63,859 trips/trading day; 21.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $373 M | 55% of $673 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $597 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $119 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 29,899 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $616 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$673 M** |
| 15%–25% planning risk envelope | $774 M–$841 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-249480 k / $-7544 k |
| Low/high project IRR | 3.5% / 7.9% |
| Low/high steady-state DSCR | 1.18 / 2.17 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,613.26 train-km; 21,075.25 kWh consumed; 19,294.13 kWh charged; 19 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 35,050.87 train-km; 282,669.10 kWh consumed; 266,580.90 kWh charged; 482 depot services completed (2 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 400 SoC warnings; 17 energy-adapted off-peak departures, maximum 16 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 97.5% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 38 line platforms, 1 interchange complexes, 17 civil segments, and 0 input findings |
