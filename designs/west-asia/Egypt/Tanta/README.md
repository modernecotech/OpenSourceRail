...
|---|---|---|
| Construction (years 1–5) | **€58 M / yr** | €77 |
| Steady-state, low-ridership (year 6+) | **€67 M / yr** | €89 |
| Steady-state, high-ridership (year 6+) | **€61 M / yr** | €82 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.62 bn cumulative** | €2,162 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.51 bn cumulative** | €2,016 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€14 M / yr (low) → €8.1 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €416 M | 4.5% | 25 y, 5 y grace | €32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €173 M | 10.5% | 25 y, 5 y grace | €21 M / yr |
| Government equity (no debt service) | 15% | €104 M | — | — | — |
| **Total** | **100%** | **€694 M** | | | **€53 M / yr** |
...
| Labour (461 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.9 M |
...
| Operating shortfall (gov subsidy required) | €14 M / yr | €8.1 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€67 M / yr** | **€61 M / yr** |
