...
| Manufacturing material/BOM rows | 25,054 |
| Manufacturing QA verification rows | 1,619 |
| Construction QA action rows | 1,518 |
| Maintenance handover schedule rows | 1,918 |
