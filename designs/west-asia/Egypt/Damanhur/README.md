...
| Bucket | Value |
|---|---|
| At-grade (40.1 km @ €3.5 M/km) | €140 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 44 | €3.0 M | €132 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 41.5 km × €0.015 M/km | €0.6 M |
...
|---|---|---|
| Construction (years 1–5) | **€37 M / yr** | €74 |
| Steady-state, low-ridership (year 6+) | **€42 M / yr** | €85 |
| Steady-state, high-ridership (year 6+) | **€39 M / yr** | €77 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.03 bn cumulative** | €2,065 |
| Lifecycle envelope (yr 1–25, high scenario) | **€960 M cumulative** | €1,919 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€8.2 M / yr (low) → €4.6 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €267 M | 4.5% | 25 y, 5 y grace | €21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €111 M | 10.5% | 25 y, 5 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €67 M | — | — | — |
| **Total** | **100%** | **€446 M** | | | **€34 M / yr** |
...
| Labour (261 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.0 M |
...
| Operating shortfall (gov subsidy required) | €8.2 M / yr | €4.6 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€42 M / yr** | **€39 M / yr** |
