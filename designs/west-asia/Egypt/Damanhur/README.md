...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$635 M (86.8%) of external capital** and **$780 M of external interest**. Capital plus saved interest totals **$1.42 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 85.7% |
| Route length (double track) | 47.4 km |
...
| Total fleet capacity | 37,080 AW2 pax (49,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 92 × 360 = **33,120 AW2 passengers** (44,160 AW3 crush)
- **Total fleet passenger capacity:** 103 × 360 = **37,080 AW2 passengers** (49,440 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 85.7%
- Catchment population: **≈ 428,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **43.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 39 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 22,049 train-km/day | One-way train journeys × route length |
| Annual service work | 8.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 286 MWh/day | 26.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 227 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 43.5 MW / 261 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 76 kWh | 122 kWh | 39 kWh | 3.0 km / 24 kWh |
| line-2 | 6 | 147 kWh | 220 kWh | 59 kWh | 7.0 km / 56 kWh |
| line-3 | 6 | 159 kWh | 220 kWh | 45 kWh | 6.3 km / 51 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (46.2 km @ $3.0 M/km) | $139 M |
| Elevated (1.2 km @ $12.0 M/km) | $15 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$158 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 103 | $900 k | $93 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 309 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 309 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 43,501 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 43,501 kW @ $100/kW | $4.4 M |
| Annual generation proxy | 43.5 MW × 6.0 peak-sun-h/day × 365 d/yr | 95.3 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 47.4 km × $0.050 M/km | $2.4 M |
...
| Per-capita (city pop) | $812 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $158 M | 15% | $24 M | $134 M |
| Stations | $84 M | 20% | $17 M | $67 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $93 M | 35% | $32 M | $60 M |
...
| EPC / project services | $24 M | 15% | $3.6 M | $21 M |
| **Total city CAPEX** | **$406 M** | **23.7%** | **$96 M** | **$310 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh damanhur`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$96 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$310 M** | **$62 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $248 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$406 M** | **$81 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $548 M | $452 M (82.5%) | $556 M | **$1.01 bn** |
| **Default** | 2.00× | $731 M | $635 M (86.8%) | $780 M | **$1.42 bn** |
| High | 3.00× | $1.10 bn | $1.00 bn (91.2%) | $1.23 bn | **$2.23 bn** |

At the default 2.00× case, OSR's $96 M external requirement is 86.8% below the illustrative foreign-company requirement of $731 M; the associated lifetime external-interest saving is $780 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $86 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $65 |
| Lifecycle envelope (yr 1–40, low scenario) | **$214 M cumulative** | $428 |
| Lifecycle envelope (yr 1–40, high scenario) | **$214 M cumulative** | $428 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $2,692 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $96 M | 4.5% | 40 y, 5 y grace | $5.5 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $248 M | 10.5% | 40 y, 5 y grace | $27 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $62 M | — | — | — |
| **Total** | **100%** | **$406 M** | | | **$32 M / yr** |
...
| Traction energy (104.3 GWh / yr) | 22,049 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 43.5 MW / 95.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $522 k |
| Labour (309 FTE) | driverless roster: OCC/remote 69, station/platform 68, passenger service 49, fleet maintenance 60, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 22,049 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.7 M train-km / yr (26.1 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 95.3 GWh/yr against 104.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 103 trainsets, 18 stations, 47.4 route-km, 3 lines, and 22,049 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
_Commercial-revenue assumptions: 2,816 m² of station shop/kiosk leases at $21/m²/month and 552 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $20 M / yr | 156 M - 250 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.3 M / yr | $3.6 M / yr | 28.2–45.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 10,205 trips/school day; 2.2 M access-events/yr | 16,328 trips/school day; 3.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $310 M | 76% of $406 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $496 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $99 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 24,828 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $371 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$406 M** |
| Imported / external-capital requirement | $96 M (23.7%) |
| Local-content / local-funding requirement | $310 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $731 M; OSR saves $635 M (86.8%) |
| Lifetime external interest and combined financing saving | $780 M interest; $1.42 bn capital + interest |
| 15%–25% planning risk envelope | $467 M–$508 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $7.2 M / $249 M |
| Low/high project IRR | 8.2% / 13.4% |
| Low/high steady-state DSCR | 1.29 / 2.23 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,874.83 train-km; 15,120.10 kWh consumed; 12,991.86 kWh charged; 33 depot services completed; minimum SoC 69%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,340.74 train-km; 172,104.43 kWh consumed; 162,888.18 kWh charged; 473 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 96.8% of scheduled train-km delivered; 145 SoC warnings; 19 energy-adapted off-peak departures, maximum 22 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 96.4% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 93.5% / 90% | pass |
| 50% charging-contact availability | 20.0% | 96.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.7% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 96.7% / 90% | pass |
...
|---|---|
| ![Damanhur energy and battery simulation dashboard](engineering/screenshots/damanhur-simulation-dashboard.png) | ![Damanhur simulator network visualizer](engineering/screenshots/damanhur-network-visualizer.png) |
...
|---|---|
| ![Damanhur QGIS engineering layers](engineering/screenshots/damanhur-qgis-engineering-map.png) | ![Damanhur SUMO timetable validation](engineering/screenshots/damanhur-sumo-validation.png) |
