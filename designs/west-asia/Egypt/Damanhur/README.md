...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$596 M (86.5%) of external capital** and **$733 M of external interest**. Capital plus saved interest totals **$1.33 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (46.2 km @ $2.58 M/km) | $119 M |
...
| Per-capita (city pop) | $765 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $136 M | 15% | $20 M | $115 M |
...
| **Total city CAPEX** | **$383 M** | **24.2%** | **$93 M** | **$290 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$93 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$290 M** | **$58 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $232 M | $46 M / yr |
| **Total city programme** | **100.0%** | **$383 M** | **$77 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $516 M | $424 M (82.1%) | $521 M | **$945 M** |
| **Default** | 2.00× | $689 M | $596 M (86.5%) | $733 M | **$1.33 bn** |
| High | 3.00× | $1.03 bn | $940 M (91.0%) | $1.16 bn | **$2.10 bn** |

At the default 2.00× case, OSR's $93 M external requirement is 86.5% below the illustrative foreign-company requirement of $689 M; the associated lifetime external-interest saving is $733 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $80 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$201 M cumulative** | $401 |
| Lifecycle envelope (yr 1–40, high scenario) | **$201 M cumulative** | $401 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.27 bn cumulative** | $2,530 |
...
| Local-currency sovereign / project bonds for local content | 61% | $232 M | 10.5% | 40 y, 5 y grace | $25 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $58 M | — | — | — |
| **Total** | **100%** | **$383 M** | | | **$30 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 12.4 M |
| Annual paid trips / city resident | 147 | 235 | 25 |
| Farebox revenue | $51 M / yr | $81 M / yr | $8.6 M / yr |
| Station shop leases | $619 k / yr | $619 k / yr | $619 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$52 M / yr** | **$83 M / yr** | **$10 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $290 M | 76% of $383 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,225 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $348 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$383 M** |
| Imported / external-capital requirement | $93 M (24.2%) |
| Local-content / local-funding requirement | $290 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $689 M; OSR saves $596 M (86.5%) |
| Lifetime external interest and combined financing saving | $733 M interest; $1.33 bn capital + interest |
| 15%–25% planning risk envelope | $440 M–$478 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $29 M / $271 M |
| Low/high project IRR | 8.8% / 14.2% |
| Low/high steady-state DSCR | 1.39 / 2.39 |
