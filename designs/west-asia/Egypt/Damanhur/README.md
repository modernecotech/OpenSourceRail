...
|---|---|---|---|---|
| line-1 |  9.4 km | 7 | 25 | N Mid ↔ S Mid |
| line-2 | 18.3 km | 10 | 49 | E Outer ↔ W Mid |
| line-3 | 19.8 km | 12 | 49 | SW Outer ↔ NE Outer |
| **Total** | **47.4 km** | **29 unique** | **123** | |
...
| Total fleet capacity | 44,280 AW2 pax (59,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 110 × 360 = **39,600 AW2 passengers** (52,800 AW3 crush)
- **Total fleet passenger capacity:** 123 × 360 = **44,280 AW2 passengers** (59,040 AW3 crush, incl. service rotation + spare + reserve)
...
| Dedicated solar plant | 40.4 MW / 242 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 76 kWh | 131 kWh | 47 kWh | 2.0 km / 16 kWh |
| line-2 | 8 | 147 kWh | 229 kWh | 67 kWh | 8.0 km / 65 kWh |
| line-3 | 11 | 159 kWh | 241 kWh | 66 kWh | 4.0 km / 32 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 123 | $900 k | $111 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 369 | $60 k | $22 M |
| High sensitivity check | 369 | $120 k | $44 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 40,396 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 40,396 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 40.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 88.5 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$37 M / yr** | $73 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$183 M cumulative** | $366 |
| Lifecycle envelope (yr 1–40, high scenario) | **$183 M cumulative** | $366 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$955 M cumulative** | $1,910 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $385 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $96 M | — | — | — |
| **Total** | **100%** | **$481 M** | | | **$22 M / yr** |
...
| Traction energy (104.3 GWh / yr) | 22,049 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 40.4 MW / 88.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $485 k |
| Labour (355 FTE) | driverless roster: OCC/remote 77, station/platform 97, passenger service 49, fleet maintenance 66, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 22,049 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.7 M train-km / yr (26.1 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 88.5 GWh/yr against 104.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 123 trainsets, 29 stations, 47.4 route-km, 3 lines, and 22,049 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 147 | 235 | 29 |
| Farebox revenue | $51 M / yr | $81 M / yr | $9.9 M / yr |
| Station shop leases | $877 k / yr | $877 k / yr | $877 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 435% | 685% | 100% |
...
_Commercial-revenue assumptions: 3,992 m² of station shop/kiosk leases at $21/m²/month and 784 advertising boards at $182/board/month, with occupancy derates applied._
...
| Commerce | 13 major/terminal/interchange nodes | 41,596 trips/trading day; 13.7 M access-events/yr | 66,554 trips/trading day; 22.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $271 M | 56% of $481 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,708 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $449 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$481 M** |
| 15%–25% planning risk envelope | $554 M–$602 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-59588 k / $182 M |
| Low/high project IRR | 6.7% / 11.5% |
| Low/high steady-state DSCR | 1.86 / 3.24 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,860.96 train-km; 15,008.03 kWh consumed; 14,927.01 kWh charged; 29 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,758.59 train-km; 183,539.89 kWh consumed; 185,227.34 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 33 SoC warnings; 2 energy-adapted off-peak departures, maximum 16 min headway |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 29 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
