...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 309 | $60 k | $19 M |
| High sensitivity check | 309 | $120 k | $37 M |
...
|---|---|---|
| Construction (years 1–5) | **$32 M / yr** | $65 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$162 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, high scenario) | **$162 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$845 M cumulative** | $1,690 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $341 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $85 M | — | — | — |
| **Total** | **100%** | **$426 M** | | | **$20 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $239 M | 56% of $426 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,179 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $391 M |
| Timetable-sized dedicated solar CAPEX | $35 M |
| **Reconciled project CAPEX** | **$426 M** |
| 15%–25% planning risk envelope | $490 M–$532 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-8688 k / $233 M |
| Low/high project IRR | 7.8% / 12.9% |
| Low/high steady-state DSCR | 2.14 / 3.70 |
