...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$650 M (86.6%) of external capital** and **$799 M of external interest**. Capital plus saved interest totals **$1.45 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (45.7 km @ $2.58 M/km) | $118 M |
| Elevated (3.5 km @ $9.75 M/km) | $34 M |
...
| Per-capita (city pop) | $1,191 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $157 M | 15% | $24 M | $133 M |
...
| **Total city CAPEX** | **$417 M** | **24.2%** | **$101 M** | **$316 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$101 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$316 M** | **$63 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $253 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$417 M** | **$83 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $563 M | $462 M (82.1%) | $568 M | **$1.03 bn** |
| **Default** | 2.00× | $750 M | $650 M (86.6%) | $799 M | **$1.45 bn** |
| High | 3.00× | $1.13 bn | $1.02 bn (91.0%) | $1.26 bn | **$2.28 bn** |

At the default 2.00× case, OSR's $101 M external requirement is 86.6% below the illustrative foreign-company requirement of $750 M; the associated lifetime external-interest saving is $799 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$44 M / yr** | $125 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $95 |
| Lifecycle envelope (yr 1–40, low scenario) | **$219 M cumulative** | $625 |
| Lifecycle envelope (yr 1–40, high scenario) | **$219 M cumulative** | $625 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.38 bn cumulative** | $3,940 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $33 M / yr → $33 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $101 M | 4.5% | 40 y, 5 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $253 M | 10.5% | 40 y, 5 y grace | $27 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $63 M | — | — | — |
| **Total** | **100%** | **$417 M** | | | **$33 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.5 M / yr + local bonds $27 M / yr = **$31 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 13.8 M |
| Annual paid trips / city resident | 209 | 335 | 40 |
| Farebox revenue | $51 M / yr | $81 M / yr | $9.6 M / yr |
| Station shop leases | $613 k / yr | $613 k / yr | $613 k / yr |
| Advertising boards | $995 k / yr | $995 k / yr | $995 k / yr |
| **Total revenue** | **$52 M / yr** | **$83 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 468% | 741% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $33 M / yr | $33 M / yr | **$33 M / yr** |
| Operating surplus applied to debt support | -$33 M / yr | -$33 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$33 M / yr** |
| Operating surplus after OPEX (before debt support) | $41 M / yr | $72 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $316 M | 76% of $417 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $506 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $101 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 25,327 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $380 M |
| Timetable-sized dedicated solar CAPEX | $37 M |
| **Reconciled project CAPEX** | **$417 M** |
| Imported / external-capital requirement | $101 M (24.2%) |
| Local-content / local-funding requirement | $316 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $750 M; OSR saves $650 M (86.6%) |
| Lifetime external interest and combined financing saving | $799 M interest; $1.45 bn capital + interest |
| 15%–25% planning risk envelope | $479 M–$521 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-5764 k / $236 M |
| Low/high project IRR | 7.9% / 13.1% |
| Low/high steady-state DSCR | 1.24 / 2.16 |
