...
**Country:** EG · **Population:** 350,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$697 M (86.9%) of external capital** and **$857 M of external interest**. Capital plus saved interest totals **$1.55 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`qena.corridor.geojson`](qena.corridor.geojson).
...
| Route length (double track) | 49.3 km |
...
| Total fleet capacity | 42,120 AW2 pax (56,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 105 × 360 = **37,800 AW2 passengers** (50,400 AW3 crush)
- **Total fleet passenger capacity:** 117 × 360 = **42,120 AW2 passengers** (56,160 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 82.0%
- Catchment population: **≈ 287,000** (within ~800 m walk of a station)
...
Aggregate station-rail charging power: **7,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **46.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 484 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 33 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 55 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 22,905 train-km/day | One-way train journeys × route length |
| Annual service work | 9.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 297 MWh/day | 27.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 242 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 46.3 MW / 278 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 104 kWh | 147 kWh | 33 kWh | 4.1 km / 33 kWh |
| line-2 | 5 | 166 kWh | 245 kWh | 62 kWh | 6.5 km / 52 kWh |
| line-3 | 4 | 128 kWh | 180 kWh | 39 kWh | 7.0 km / 56 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 117 | $900 k | $105 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 351 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 351 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 46,316 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 46,316 kW @ $100/kW | $4.6 M |
| Annual generation proxy | 46.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 101.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$37 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.3 km × $0.050 M/km | $2.5 M |
...
| Stations | $80 M | 20% | $16 M | $64 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $105 M | 35% | $37 M | $68 M |
| Dedicated solar plant | $37 M | 45% | $17 M | $20 M |
| Residual signalling / train control | $2.5 M | 50% | $1.2 M | $1.2 M |
| Charging microgrids | $1.7 M | 40% | $690 k | $1.0 M |
| EPC / project services | $27 M | 15% | $4.0 M | $23 M |
| **Total city CAPEX** | **$446 M** | **23.6%** | **$105 M** | **$341 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh qena`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$105 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$341 M** | **$68 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $272 M | $54 M / yr |
| **Total city programme** | **100.0%** | **$446 M** | **$89 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $602 M | $497 M (82.5%) | $611 M | **$1.11 bn** |
| **Default** | 2.00× | $802 M | $697 M (86.9%) | $857 M | **$1.55 bn** |
| High | 3.00× | $1.20 bn | $1.10 bn (91.3%) | $1.35 bn | **$2.45 bn** |

At the default 2.00× case, OSR's $105 M external requirement is 86.9% below the illustrative foreign-company requirement of $802 M; the associated lifetime external-interest saving is $857 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $134 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $102 |
| Lifecycle envelope (yr 1–40, low scenario) | **$235 M cumulative** | $671 |
| Lifecycle envelope (yr 1–40, high scenario) | **$235 M cumulative** | $671 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.48 bn cumulative** | $4,224 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $36 M / yr → $36 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $105 M | 4.5% | 40 y, 5 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $272 M | 10.5% | 40 y, 5 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $68 M | — | — | — |
| **Total** | **100%** | **$446 M** | | | **$36 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.7 M / yr + local bonds $29 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (108.3 GWh / yr) | 22,905 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.1 GWh/yr + dedicated solar plant 46.3 MW / 101.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $556 k |
| Labour (320 FTE) | driverless roster: OCC/remote 77, station/platform 65, passenger service 49, fleet maintenance 66, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 22,905 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.0 M train-km / yr (27.1 M car-km / yr). On-site PV covers 20.1 GWh/yr and the dedicated solar plant adds 101.4 GWh/yr against 108.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 117 trainsets, 15 stations, 49.3 route-km, 3 lines, and 22,905 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 14.6 M |
| Annual paid trips / city resident | 209 | 335 | 42 |
| Farebox revenue | $51 M / yr | $81 M / yr | $10 M / yr |
| Station shop leases | $613 k / yr | $613 k / yr | $613 k / yr |
| Advertising boards | $995 k / yr | $995 k / yr | $995 k / yr |
| **Total revenue** | **$52 M / yr** | **$83 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 447% | 707% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $36 M / yr | $36 M / yr | **$36 M / yr** |
| Operating surplus applied to debt support | -$36 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$36 M / yr** |
| Operating surplus after OPEX (before debt support) | $41 M / yr | $71 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,792 m² of station shop/kiosk leases at $21/m²/month and 536 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $13 M / yr | $21 M / yr | 163 M - 260 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.3 M / yr | $3.7 M / yr | 29.3–46.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.5 M / yr | $10 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$73 M / yr** | **$118 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 10,747 trips/school day; 2.4 M access-events/yr | 17,195 trips/school day; 3.8 M access-events/yr |
| Healthcare | 3 healthcare anchors | 18,381 trips/day; 6.7 M access-events/yr | 29,409 trips/day; 10.7 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 46,202 trips/trading day; 15.2 M access-events/yr | 73,924 trips/trading day; 24.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $341 M | 76% of $446 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $545 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $109 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 27,291 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $37 M |
| **Reconciled project CAPEX** | **$446 M** |
| Imported / external-capital requirement | $105 M (23.6%) |
| Local-content / local-funding requirement | $341 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $802 M; OSR saves $697 M (86.9%) |
| Lifetime external interest and combined financing saving | $857 M interest; $1.55 bn capital + interest |
| 15%–25% planning risk envelope | $513 M–$557 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-33074 k / $209 M |
| Low/high project IRR | 7.2% / 12.3% |
| Low/high steady-state DSCR | 1.15 / 2.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,892.73 train-km; 15,264.36 kWh consumed; 12,100.18 kWh charged; 33 depot services completed; minimum SoC 57%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,057.65 train-km; 169,821.49 kWh consumed; 152,495.08 kWh charged; 481 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 91.9% of scheduled train-km delivered; 170 SoC warnings; 28 energy-adapted off-peak departures, maximum 17 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 91.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.2% / 90% | pass |
| 50% charging-contact availability | 20.0% | 91.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 81.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 91.8% / 90% | pass |
...
|---|---|
| ![Qena energy and battery simulation dashboard](engineering/screenshots/qena-simulation-dashboard.png) | ![Qena simulator network visualizer](engineering/screenshots/qena-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![Qena QGIS engineering layers](engineering/screenshots/qena-qgis-engineering-map.png) | ![Qena SUMO timetable validation](engineering/screenshots/qena-sumo-validation.png) |
...
| [`qena.toml`](qena.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`qena-network-map.png`](qena-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`qena.corridor.geojson`](qena.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`qena.stations.json`](qena.stations.json) | Machine-readable station list |
| [`qena.design-quality.yaml`](qena.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
