...
|---|---|---|---|---|
| line-1 | 12.9 km | 8 | 34 | NE Mid ↔ SW Mid |
| line-2 | 20.6 km | 12 | 53 | W Mid ↔ SE Outer |
| line-3 | 15.8 km | 9 | 42 | SW Inner ↔ N Outer |
| **Total** | **49.3 km** | **29 unique** | **129** | |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 104 kWh | 172 kWh | 58 kWh | 2.2 km / 18 kWh |
| line-2 | 10 | 166 kWh | 253 kWh | 71 kWh | 6.9 km / 56 kWh |
| line-3 | 8 | 128 kWh | 196 kWh | 56 kWh | 5.4 km / 43 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 387 | $60 k | $23 M |
| High sensitivity check | 387 | $120 k | $46 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,521 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,521 kW @ $100/kW | $4.3 M |
...
| Per-capita (city pop) | $1,518 / person |
...
|---|---|---|
| Construction (years 1–5) | **$40 M / yr** | $115 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$202 M cumulative** | $577 |
| Lifecycle envelope (yr 1–40, high scenario) | **$202 M cumulative** | $577 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.05 bn cumulative** | $3,011 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $425 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $106 M | — | — | — |
| **Total** | **100%** | **$531 M** | | | **$24 M / yr** |
...
| Traction energy (108.3 GWh / yr) | 22,905 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 42.5 MW / 93.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $510 k |
| Labour (368 FTE) | driverless roster: OCC/remote 81, station/platform 101, passenger service 49, fleet maintenance 69, infrastructure/energy 47, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 22,905 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.0 M train-km / yr (27.1 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 93.1 GWh/yr against 108.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 129 trainsets, 29 stations, 49.3 route-km, 3 lines, and 22,905 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 45 |
| Farebox revenue | $51 M / yr | $81 M / yr | $11 M / yr |
| Station shop leases | $901 k / yr | $901 k / yr | $901 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 401% | 630% | 100% |
...
_Commercial-revenue assumptions: 4,104 m² of station shop/kiosk leases at $21/m²/month and 800 advertising boards at $182/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $301 M | 57% of $531 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 24,105 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $497 M |
| Timetable-sized dedicated solar CAPEX | $34 M |
| **Reconciled project CAPEX** | **$531 M** |
| 15%–25% planning risk envelope | $611 M–$664 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-107445 k / $134 M |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,926.27 train-km; 15,534.83 kWh consumed; 15,719.19 kWh charged; 29 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,674.00 train-km; 190,923.04 kWh consumed; 194,231.86 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 39%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 25.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 39.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.4% / 60% | pass |
| ten-hour single charging-pad outage | 39.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 29 line platforms, 1 interchange complexes, 7 civil segments, and 0 input findings |
