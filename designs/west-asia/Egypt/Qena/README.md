...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 351 | $60 k | $21 M |
| High sensitivity check | 351 | $120 k | $42 M |
...
| Per-capita (city pop) | $1,338 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh qena`.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $102 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$178 M cumulative** | $508 |
| Lifecycle envelope (yr 1–40, high scenario) | **$178 M cumulative** | $508 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$929 M cumulative** | $2,654 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $375 M | 4.5% | 40 y, 5 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $94 M | — | — | — |
| **Total** | **100%** | **$468 M** | | | **$21 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $264 M | 56% of $468 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,135 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $539 M–$585 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-51068 k / $191 M |
| Low/high project IRR | 6.8% / 11.8% |
| Low/high steady-state DSCR | 1.90 / 3.32 |
