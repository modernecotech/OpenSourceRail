...
| Manufacturing schedule rows | 1,128 |
| Manufacturing material/BOM rows | 16,957 |
| Manufacturing QA verification rows | 1,128 |
| Construction QA action rows | 1,050 |
| Maintenance handover schedule rows | 1,342 |
| Manufacturing rows with material refs | 1,128 / 1,128 |
| Manufacturing rows with verification refs | 1,128 / 1,128 |
| Manufacturing rows linked to QA actions | 1,128 / 1,128 |
