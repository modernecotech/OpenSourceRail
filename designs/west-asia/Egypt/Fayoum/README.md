...
| Revenue fleet | 157 × 3-car trainsets |
| Revenue fleet passenger capacity | 56,520 AW2 pax (75,360 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 28.5 km | 15 | 71 | NW Outer ↔ SE Outer |
| line-2 | 18.8 km | 12 | 49 | E Mid ↔ NW Mid |
| line-3 | 21.5 km | 12 | 54 | SW Outer ↔ NE Outer |
| **Total** | **68.8 km** | **39 unique** | **174** | |
...
| Revenue fleet capacity | 56,520 AW2 pax (75,360 AW3 crush) |
| Total fleet capacity | 62,640 AW2 pax (83,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 157 × 360 = **56,520 AW2 passengers** (75,360 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **61.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 494 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 323 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 61.9 MW / 372 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 230 kWh | 327 kWh | 74 kWh | 5.7 km / 46 kWh |
| line-2 | 12 | 152 kWh | 253 kWh | 86 kWh | 2.0 km / 16 kWh |
| line-3 | 10 | 173 kWh | 245 kWh | 55 kWh | 5.0 km / 41 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 522 | $60 k | $31 M |
| High sensitivity check | 522 | $120 k | $63 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 61,931 kW @ $700/kW | $43 M |
| Grid interconnection / PPA tie-in | 61,931 kW @ $100/kW | $6.2 M |
| Annual generation proxy | 61.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 135.6 GWh/yr |
...
| Per-capita (city pop) | $1,277 / person |
...
|---|---|---|
| Construction (years 1–5) | **$49 M / yr** | $97 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$243 M cumulative** | $485 |
| Lifecycle envelope (yr 1–40, high scenario) | **$243 M cumulative** | $485 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.27 bn cumulative** | $2,533 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $511 M | 4.5% | 40 y, 5 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $128 M | — | — | — |
| **Total** | **100%** | **$639 M** | | | **$29 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $23 M / yr = **$23 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($26 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (151.2 GWh / yr) | 31,969 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 33.3 GWh/yr + dedicated solar plant 61.9 MW / 135.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $743 k |
| Labour (460 FTE) | driverless roster: OCC/remote 102, station/platform 130, passenger service 49, fleet maintenance 95, infrastructure/energy 63, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 31,969 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.6 M train-km / yr (37.8 M car-km / yr). On-site PV covers 33.3 GWh/yr and the dedicated solar plant adds 135.6 GWh/yr against 151.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 174 trainsets, 39 stations, 68.8 route-km, 3 lines, and 31,969 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$54 M / yr** | **$84 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 330% | 518% | 100% |
...
_Commercial-revenue assumptions: 5,160 m² of station shop/kiosk leases at $21/m²/month and 1,008 advertising boards at $182/board/month, with occupancy derates applied._
...
| Commerce | 16 major/terminal/interchange nodes | 40,794 trips/trading day; 13.5 M access-events/yr | 65,271 trips/trading day; 21.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $356 M | 56% of $639 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 28,525 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$639 M** |
| 15%–25% planning risk envelope | $734 M–$798 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-212110 k / $30 M |
| Low/high project IRR | 4.1% / 8.5% |
| Low/high steady-state DSCR | 1.28 / 2.33 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,443.33 train-km; 19,704.77 kWh consumed; 19,750.14 kWh charged; 21 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 32,870.00 train-km; 265,084.38 kWh consumed; 267,161.18 kWh charged; 498 depot services completed (4 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 60 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
