...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **44,100 – 66,150 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (52.1 km @ $0.85 M/km) | $44 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.4 km × $0.015 M/km | $802 k |
...
| Steady-state, low-ridership (year 6+) | **$2.0 M / yr** | $3 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$99 M cumulative** | $141 |
| Lifecycle envelope (yr 1–25, high scenario) | **$59 M cumulative** | $85 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$59 M cumulative** | $85 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $36 M | 10.5% | 25 y, 5 y grace | $4.3 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$143 M** | | | **$11 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $3.8 M / yr + bonds $3.7 M / yr = **$7.6 M / yr** total — plus the equity tranche amortised across construction ($4.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,000 | 105,000 | 66,364 |
| Daily paid trips / population | 8% | 15% | 9% |
| Annual paid trips | 20.4 M | 38.3 M | 24.2 M |
...
| **Total revenue** | **$14 M / yr** | **$23 M / yr** | **$16 M / yr** |
| Revenue / OPEX + debt-service recovery | 88% | 147% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $2.0 M / yr | $0 k / yr | **$0 / yr** |
