...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$658 M (86.5%) of external capital** and **$808 M of external interest**. Capital plus saved interest totals **$1.47 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Per-capita (city pop) | $603 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $137 M | 15% | $21 M | $116 M |
...
| **Total city CAPEX** | **$422 M** | **24.3%** | **$102 M** | **$320 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$102 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$320 M** | **$64 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $256 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$422 M** | **$84 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $570 M | $468 M (82.0%) | $575 M | **$1.04 bn** |
| **Default** | 2.00× | $760 M | $658 M (86.5%) | $808 M | **$1.47 bn** |
| High | 3.00× | $1.14 bn | $1.04 bn (91.0%) | $1.28 bn | **$2.31 bn** |

At the default 2.00× case, OSR's $102 M external requirement is 86.5% below the illustrative foreign-company requirement of $760 M; the associated lifetime external-interest saving is $808 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Lifecycle envelope (yr 1–40, low scenario) | **$221 M cumulative** | $316 |
| Lifecycle envelope (yr 1–40, high scenario) | **$221 M cumulative** | $316 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.40 bn cumulative** | $1,995 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $102 M | 4.5% | 40 y, 5 y grace | $5.9 M / yr |
...
| Annual paid trips / city resident | 105 | 168 | 19 |
...
| Revenue / OPEX recovery | 464% | 731% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $320 M | 76% of $422 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,621 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $102 M (24.3%) |
| Local-content / local-funding requirement | $320 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $760 M; OSR saves $658 M (86.5%) |
| Lifetime external interest and combined financing saving | $808 M interest; $1.47 bn capital + interest |
| 15%–25% planning risk envelope | $486 M–$528 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-7059 k / $235 M |
