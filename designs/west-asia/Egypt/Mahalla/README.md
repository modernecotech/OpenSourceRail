...
|---|---|---|---|---|
| line-1 | 12.3 km | 8 | 32 | W Inner ↔ E Mid |
| line-2 | 18.6 km | 9 | 50 | SW Outer ↔ E Mid |
| line-3 |  7.4 km | 5 | 19 | W Inner ↔ NE Inner |
| **Total** | **38.3 km** | **22 unique** | **101** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **31.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 468 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 167 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 31.9 MW / 191 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 99 kWh | 172 kWh | 63 kWh | 2.2 km / 18 kWh |
| line-2 | 7 | 150 kWh | 229 kWh | 63 kWh | 9.0 km / 72 kWh |
| line-3 | 5 | 59 kWh | 98 kWh | 33 kWh | 2.0 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 31,914 kW @ $700/kW | $22 M |
| Grid interconnection / PPA tie-in | 31,914 kW @ $100/kW | $3.2 M |
| Annual generation proxy | 31.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 69.9 GWh/yr |
...
| Per-capita (city pop) | $686 / person |
...
|---|---|---|
| Construction (years 1–5) | **$31 M / yr** | $52 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $31 |
| Lifecycle envelope (yr 1–40, low scenario) | **$156 M cumulative** | $261 |
| Lifecycle envelope (yr 1–40, high scenario) | **$156 M cumulative** | $261 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$817 M cumulative** | $1,361 |
...
| Traction energy (84.2 GWh / yr) | 17,802 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 31.9 MW / 69.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $383 k |
| Labour (311 FTE) | driverless roster: OCC/remote 69, station/platform 81, passenger service 49, fleet maintenance 54, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 17,802 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.0 M train-km / yr (21.1 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 69.9 GWh/yr against 84.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 101 trainsets, 22 stations, 38.3 route-km, 3 lines, and 17,802 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 122 | 196 | 20 |
| Farebox revenue | $51 M / yr | $81 M / yr | $8.4 M / yr |
| Station shop leases | $752 k / yr | $752 k / yr | $752 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 507% | 799% | 100% |
...
_Commercial-revenue assumptions: 3,424 m² of station shop/kiosk leases at $21/m²/month and 664 advertising boards at $182/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $233 M | 57% of $412 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $373 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $75 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 18,686 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,565.69 train-km; 12,626.85 kWh consumed; 12,516.21 kWh charged; 33 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,310.28 train-km; 147,665.90 kWh consumed; 144,157.19 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 10 SoC warnings; 1 energy-adapted off-peak departures, maximum 12 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 21.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 20.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.3% / 60% | pass |
| ten-hour single charging-pad outage | 20.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 2 interchange complexes, 14 civil segments, and 0 input findings |
