...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 252 | $60 k | $15 M |
| High sensitivity check | 252 | $120 k | $30 M |
...
| Per-capita (city pop) | $620 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mahalla`.
...
|---|---|---|
| Construction (years 1–5) | **$28 M / yr** | $47 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$17 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$141 M cumulative** | $236 |
| Lifecycle envelope (yr 1–40, high scenario) | **$141 M cumulative** | $236 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$738 M cumulative** | $1,230 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $298 M | 4.5% | 40 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 20% | $74 M | — | — | — |
| **Total** | **100%** | **$372 M** | | | **$17 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $13 M / yr = **$13 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($15 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $211 M | 57% of $372 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 16,903 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$372 M** |
| 15%–25% planning risk envelope | $428 M–$465 M |
| Annual OPEX | $9.3 M / yr |
| Low/high project NPV at 8% | $44 M / $286 M |
| Low/high project IRR | 9.2% / 14.6% |
| Low/high steady-state DSCR | 2.53 / 4.32 |
