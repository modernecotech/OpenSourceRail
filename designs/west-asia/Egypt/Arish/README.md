...
| Bucket | Value |
|---|---|
| At-grade (12.5 km @ €3.5 M/km) | €44 M |
| Elevated (0.3 km @ €18 M/km) | €5.0 M |
| **Civil subtotal** | **€49 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 18 | €2.0 M | €36 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 12.9 km × €0.015 M/km | €0.2 M |
...
| EPC integration + project management (7%) | on subtotal | €9.2 M |
...
|---|---|---|
| Construction (years 1–5) | **€12 M / yr** | €39 |
| Steady-state, low-ridership (year 6+) | **€12 M / yr** | €41 |
| Steady-state, high-ridership (year 6+) | **€11 M / yr** | €36 |
| Lifecycle envelope (yr 1–25, low scenario) | **€304 M cumulative** | €1,014 |
| Lifecycle envelope (yr 1–25, high scenario) | **€274 M cumulative** | €915 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€1.5 M / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €85 M | 4.5% | 25 y, 5 y grace | €6.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €35 M | 10.5% | 25 y, 5 y grace | €4.3 M / yr |
| Government equity (no debt service) | 15% | €21 M | — | — | — |
| **Total** | **100%** | **€141 M** | | | **€11 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €3.8 M / yr + bonds €3.7 M / yr = **€7.5 M / yr** total — plus the equity tranche amortised across construction (€4.2 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (89 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €358 k |
...
| Farebox / OPEX recovery | 60% | 119% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €1.5 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €700 k / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€12 M / yr** | **€11 M / yr** |
