...
| Revenue fleet | 16 × 2-car trainsets |
...
|---|---|---|---|---|
| line-1 | 12.9 km | 7 | 18 | S Outer ↔ N Mid |
| **Total** | **12.9 km** | **7 unique** | **18** | |
...
- **Practical daily service capacity** (65% load factor): ≈ **32,760 passenger-trips/day**
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **23,814 – 32,760 trips/day**
...
| PV daily yield proxy | 36 MWh/day | 5 peak-sun-hour planning proxy before local derates |
...
| Bucket | Value |
|---|---|
| At-grade (12.5 km @ $2.0 M/km) | $25 M |
| Elevated (0.3 km @ $9.0 M/km) | $2.5 M |
| **Civil subtotal** | **$28 M** |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 18 | $534 k | $9.6 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 12.9 km × $0.015 M/km | $641 k |
...
| EPC integration + project management (7%) | on subtotal | $4.5 M |
...
| EPC overhead (7%) | $4.5 M |
| **CAPEX total** | **$68 M** |
| Per-route-km | $5.3 M / km |
| Per-capita (city pop) | $228 / person |
...
|---|---|---|
| Construction (years 1–5) | **$5.7 M / yr** | $19 |
| Steady-state, low-ridership (year 6+) | **$5.2 M / yr** | $17 |
| Steady-state, high-ridership (year 6+) | **$5.2 M / yr** | $17 |
| Steady-state, operating-neutral revenue case | **$5.2 M / yr** | $17 |
| Lifecycle envelope (yr 1–25, low scenario) | **$133 M cumulative** | $444 |
| Lifecycle envelope (yr 1–25, high scenario) | **$133 M cumulative** | $444 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$133 M cumulative** | $444 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $41 M | 4.5% | 25 y, 5 y grace | $3.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $17 M | 10.5% | 25 y, 5 y grace | $2.1 M / yr |
| Government equity (no debt service) | 15% | $10 M | — | — | — |
| **Total** | **100%** | **$68 M** | | | **$5.2 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $1.8 M / yr + bonds $1.8 M / yr = **$3.6 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Traction energy (15.8 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (89 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $389 k |
| **OPEX subtotal** | | **$1.8 M / yr** |

_Annual fleet utilisation: 16 revenue trainsets × 20.5 h/day × 365 d/yr × 22 km/h commercial × 75% revenue factor = 2.0 M train-km / yr (~123 k km / trainset / yr)._
...
Planning ridership bracket = 18-30% of catchment × 365 service-days at the operating-neutral fare, capped by practical service capacity (32,760 trips/day). The operating-neutral column solves annual paid trips so **farebox + station-shop leases + advertising = steady-state OPEX**. Post-grace debt service remains a capital-funding obligation in the government commitment table above.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Daily paid trips | 23,814 | 32,760 | 6,659 |
| Daily paid trips / catchment | 18% | 25% | 5% |
| Daily paid trips / city population | 8% | 11% | 2% |
| Annual paid trips | 8.7 M | 12.0 M | 2.4 M |
| Farebox revenue | $4.5 M / yr | $6.2 M / yr | $1.3 M / yr |
| Station shop leases | $204 k / yr | $204 k / yr | $204 k / yr |
| Advertising boards | $349 k / yr | $349 k / yr | $349 k / yr |
| **Total revenue** | **$5.1 M / yr** | **$6.8 M / yr** | **$1.8 M / yr** |
| Revenue / OPEX recovery | 279% | 373% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $5.2 M / yr | $5.2 M / yr | **$5.2 M / yr** |
| Operating surplus after OPEX | $3.3 M / yr | $5.0 M / yr | $0 / yr |
