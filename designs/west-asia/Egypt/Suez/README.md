...
| Revenue fleet | 138 × 3-car trainsets |
| Revenue fleet passenger capacity | 49,680 AW2 pax (66,240 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 24.6 km | 14 | 62 | SE Outer ↔ W Mid |
| line-2 | 17.7 km | 10 | 45 | SW Mid ↔ NE Mid |
| line-3 | 18.3 km | 11 | 47 | N Mid ↔ W Mid |
| **Total** | **60.6 km** | **35 unique** | **154** | |
...
| Revenue fleet capacity | 49,680 AW2 pax (66,240 AW3 crush) |
| Total fleet capacity | 55,440 AW2 pax (73,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 138 × 360 = **49,680 AW2 passengers** (66,240 AW3 crush)
- **Total fleet passenger capacity:** 154 × 360 = **55,440 AW2 passengers** (73,920 AW3 crush, incl. service rotation + spare + reserve)
...
| PV daily yield proxy | 88 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 198 kWh | 302 kWh | 84 kWh | 9.2 km / 74 kWh |
| line-2 | 10 | 143 kWh | 212 kWh | 55 kWh | 3.6 km / 29 kWh |
| line-3 | 11 | 148 kWh | 233 kWh | 70 kWh | 2.0 km / 16 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 154 | $900 k | $139 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 462 | $60 k | $28 M |
| High sensitivity check | 462 | $120 k | $55 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 53,182 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 53,182 kW @ $100/kW | $5.3 M |
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $59 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$235 M cumulative** | $293 |
| Lifecycle envelope (yr 1–40, high scenario) | **$235 M cumulative** | $293 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.23 bn cumulative** | $1,531 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $494 M | 4.5% | 40 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $124 M | — | — | — |
| **Total** | **100%** | **$618 M** | | | **$28 M / yr** |
...
| Traction energy (133.3 GWh / yr) | 28,169 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 32.0 GWh/yr + dedicated solar plant 53.2 MW / 116.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $638 k |
| Labour (420 FTE) | driverless roster: OCC/remote 94, station/platform 116, passenger service 49, fleet maintenance 84, infrastructure/energy 56, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 28,169 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.1 M train-km / yr (33.3 M car-km / yr). On-site PV covers 32.0 GWh/yr and the dedicated solar plant adds 116.5 GWh/yr against 133.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 154 trainsets, 35 stations, 60.6 route-km, 3 lines, and 28,169 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 18.3 M |
| Annual paid trips / city resident | 92 | 147 | 23 |
...
| **Total revenue** | **$54 M / yr** | **$84 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 347% | 544% | 100% |
...
| Operating surplus after OPEX (before debt support) | $38 M / yr | $69 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,800 m² of station shop/kiosk leases at $21/m²/month and 940 advertising boards at $182/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$75 M / yr** | **$121 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 14 major/terminal/interchange nodes | 40,578 trips/trading day; 13.4 M access-events/yr | 64,924 trips/trading day; 21.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $348 M | 56% of $618 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $557 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $111 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 27,904 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $575 M |
| Timetable-sized dedicated solar CAPEX | $43 M |
| **Reconciled project CAPEX** | **$618 M** |
| 15%–25% planning risk envelope | $710 M–$772 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-190348 k / $52 M |
| Low/high project IRR | 4.4% / 8.8% |
| Low/high steady-state DSCR | 1.35 / 2.43 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,225.06 train-km; 17,944.43 kWh consumed; 18,257.10 kWh charged; 24 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,705.15 train-km; 231,497.88 kWh consumed; 233,228.88 kWh charged; 492 depot services completed (5 active at cutoff); minimum SoC 56%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 47.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 31.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 56.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.2% / 60% | pass |
| ten-hour single charging-pad outage | 48.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
