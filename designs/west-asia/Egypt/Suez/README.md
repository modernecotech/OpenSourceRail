...
| Dedicated solar plant | $46 M | 70% | $32 M | $14 M |
| Residual signalling / train control | $3.0 M | 80% | $2.4 M | $606 k |
| Charging microgrids | $2.2 M | 55% | $1.2 M | $990 k |
| EPC / project services | $29 M | 45% | $13 M | $16 M |
| **Total city CAPEX** | **$490 M** | **45.0%** | **$220 M** | **$269 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **45.0%** | **$220 M** | **$44 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.0%** | **$269 M** | **$54 M / yr** |
| of which planned local bond issuance | 44.0% of total CAPEX | $216 M | $43 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $54 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $45 |
| Lifecycle envelope (yr 1–40, low scenario) | **$217 M cumulative** | $271 |
| Lifecycle envelope (yr 1–40, high scenario) | **$217 M cumulative** | $271 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.48 bn cumulative** | $1,844 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $220 M | 4.5% | 40 y, 5 y grace | $13 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $216 M | 10.5% | 40 y, 5 y grace | $23 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $54 M | — | — | — |
| **Total** | **100%** | **$490 M** | | | **$36 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $9.9 M / yr + local bonds $23 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $269 M | 55% of $490 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,594 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $220 M (45.0%) |
| Local-content / local-funding requirement | $269 M (55.0%) |
| 15%–25% planning risk envelope | $563 M–$612 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-76077 k / $166 M |
| Low/high project IRR | 6.3% / 11.2% |
| Low/high steady-state DSCR | 1.10 / 1.95 |
