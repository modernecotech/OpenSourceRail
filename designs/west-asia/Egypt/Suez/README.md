...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$764 M (86.7%) of external capital** and **$940 M of external interest**. Capital plus saved interest totals **$1.70 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 60.6 km |
| Revenue fleet | 116 × 3-car trainsets |
| Revenue fleet passenger capacity | 41,760 AW2 pax (55,680 AW3 crush) |
...
| Revenue fleet capacity | 41,760 AW2 pax (55,680 AW3 crush) |
| Total fleet capacity | 46,440 AW2 pax (61,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 116 × 360 = **41,760 AW2 passengers** (55,680 AW3 crush)
- **Total fleet passenger capacity:** 129 × 360 = **46,440 AW2 passengers** (61,920 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 57.4%
- Catchment population: **≈ 459,199** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **57.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 447 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 28,169 train-km/day | One-way train journeys × route length |
| Annual service work | 11.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 365 MWh/day | 33.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 301 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 57.7 MW / 346 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 198 kWh | 294 kWh | 76 kWh | 11.5 km / 93 kWh |
| line-2 | 7 | 143 kWh | 200 kWh | 43 kWh | 4.3 km / 35 kWh |
| line-3 | 5 | 148 kWh | 204 kWh | 42 kWh | 7.1 km / 57 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (59.3 km @ $3.0 M/km) | $178 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 129 | $900 k | $116 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 387 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 387 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 57,667 kW @ $700/kW | $40 M |
| Grid interconnection / PPA tie-in | 57,667 kW @ $100/kW | $5.8 M |
| Annual generation proxy | 57.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 126.3 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.6 km × $0.050 M/km | $3.0 M |
...
| Residual train-control wayside + charging microgrids | $5.2 M |
| EPC overhead (7%) | $29 M |
| **CAPEX total** | **$490 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $198 M | 15% | $30 M | $168 M |
| Stations | $87 M | 20% | $17 M | $70 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $116 M | 35% | $41 M | $75 M |
| Dedicated solar plant | $46 M | 45% | $21 M | $25 M |
...
| **Total city CAPEX** | **$490 M** | **24.0%** | **$117 M** | **$372 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh suez`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$117 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$372 M** | **$74 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $298 M | $60 M / yr |
| **Total city programme** | **100.0%** | **$490 M** | **$98 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $661 M | $544 M (82.3%) | $669 M | **$1.21 bn** |
| **Default** | 2.00× | $882 M | $764 M (86.7%) | $940 M | **$1.70 bn** |
| High | 3.00× | $1.32 bn | $1.20 bn (91.1%) | $1.48 bn | **$2.69 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 86.7% below the illustrative foreign-company requirement of $882 M; the associated lifetime external-interest saving is $940 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$39 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$257 M cumulative** | $322 |
| Lifecycle envelope (yr 1–40, high scenario) | **$257 M cumulative** | $322 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.62 bn cumulative** | $2,027 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $117 M | 4.5% | 40 y, 5 y grace | $6.7 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $298 M | 10.5% | 40 y, 5 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$490 M** | | | **$39 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.3 M / yr + local bonds $31 M / yr = **$37 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($15 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $151 k |
| Traction energy (133.3 GWh / yr) | 28,169 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 57.7 MW / 126.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $692 k |
| Labour (353 FTE) | driverless roster: OCC/remote 81, station/platform 74, passenger service 49, fleet maintenance 76, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 28,169 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.1 M train-km / yr (33.3 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 126.3 GWh/yr against 133.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 129 trainsets, 23 stations, 60.6 route-km, 3 lines, and 28,169 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 16.0 M |
| Annual paid trips / city resident | 92 | 147 | 20 |
| Farebox revenue | $51 M / yr | $81 M / yr | $11 M / yr |
| Station shop leases | $657 k / yr | $657 k / yr | $657 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 408% | 645% | 100% |
...
| Operating surplus after OPEX (before debt support) | $40 M / yr | $70 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,992 m² of station shop/kiosk leases at $21/m²/month and 600 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $26 M / yr | 200 M - 320 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.6 M / yr | 36.0–57.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.0 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$76 M / yr** | **$121 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 4 healthcare anchors | 16,271 trips/day; 5.9 M access-events/yr | 26,034 trips/day; 9.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $372 M | 76% of $490 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $596 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $119 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 29,843 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $444 M |
| Timetable-sized dedicated solar CAPEX | $46 M |
| **Reconciled project CAPEX** | **$490 M** |
| Imported / external-capital requirement | $117 M (24.0%) |
| Local-content / local-funding requirement | $372 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $882 M; OSR saves $764 M (86.7%) |
| Lifetime external interest and combined financing saving | $940 M interest; $1.70 bn capital + interest |
| 15%–25% planning risk envelope | $563 M–$612 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-76077 k / $166 M |
| Low/high project IRR | 6.3% / 11.2% |
| Low/high steady-state DSCR | 1.02 / 1.80 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,273.84 train-km; 18,338.02 kWh consumed; 15,073.71 kWh charged; 27 depot services completed; minimum SoC 61%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 27,547.14 train-km; 222,155.29 kWh consumed; 202,265.86 kWh charged; 488 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 97.8% of scheduled train-km delivered; 196 SoC warnings; 20 energy-adapted off-peak departures, maximum 15 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 97.1% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 93.3% / 90% | pass |
| 50% charging-contact availability | 20.0% | 97.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 78.1% / 60% | pass |
...
|---|---|
| ![Suez energy and battery simulation dashboard](engineering/screenshots/suez-simulation-dashboard.png) | ![Suez simulator network visualizer](engineering/screenshots/suez-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Suez QGIS engineering layers](engineering/screenshots/suez-qgis-engineering-map.png) | ![Suez SUMO timetable validation](engineering/screenshots/suez-sumo-validation.png) |
