...
|---|---|---|
| Construction (years 1–5) | **$39 M / yr** | $49 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $29 |
| Lifecycle envelope (yr 1–40, low scenario) | **$196 M cumulative** | $244 |
| Lifecycle envelope (yr 1–40, high scenario) | **$196 M cumulative** | $244 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $1,276 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $412 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $103 M | — | — | — |
| **Total** | **100%** | **$515 M** | | | **$24 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $288 M | 56% of $515 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 23,061 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $468 M |
| Timetable-sized dedicated solar CAPEX | $46 M |
| **Reconciled project CAPEX** | **$515 M** |
| 15%–25% planning risk envelope | $592 M–$643 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-95917 k / $146 M |
| Low/high project IRR | 5.9% / 10.7% |
| Low/high steady-state DSCR | 1.68 / 2.98 |
