...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$716 M (86.4%) of external capital** and **$880 M of external interest**. Capital plus saved interest totals **$1.60 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (59.3 km @ $2.58 M/km) | $153 M |
...
| **Total city CAPEX** | **$460 M** | **24.5%** | **$113 M** | **$347 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.5%** | **$113 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.5%** | **$347 M** | **$69 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $278 M | $56 M / yr |
| **Total city programme** | **100.0%** | **$460 M** | **$92 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $621 M | $508 M (81.8%) | $625 M | **$1.13 bn** |
| **Default** | 2.00× | $828 M | $716 M (86.4%) | $880 M | **$1.60 bn** |
| High | 3.00× | $1.24 bn | $1.13 bn (90.9%) | $1.39 bn | **$2.52 bn** |

At the default 2.00× case, OSR's $113 M external requirement is 86.4% below the illustrative foreign-company requirement of $828 M; the associated lifetime external-interest saving is $880 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$48 M / yr** | $60 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$241 M cumulative** | $301 |
| Lifecycle envelope (yr 1–40, high scenario) | **$241 M cumulative** | $301 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.52 bn cumulative** | $1,900 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $113 M | 4.5% | 40 y, 5 y grace | $6.5 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $278 M | 10.5% | 40 y, 5 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $69 M | — | — | — |
| **Total** | **100%** | **$460 M** | | | **$37 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 15.2 M |
| Annual paid trips / city resident | 92 | 147 | 19 |
...
| Revenue / OPEX recovery | 426% | 673% | 100% |
...
| Operating surplus after OPEX (before debt support) | $40 M / yr | $71 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $347 M | 75% of $460 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $556 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $111 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 27,832 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $414 M |
| Timetable-sized dedicated solar CAPEX | $46 M |
| **Reconciled project CAPEX** | **$460 M** |
| Imported / external-capital requirement | $113 M (24.5%) |
| Local-content / local-funding requirement | $347 M (75.5%) |
| Default foreign-turnkey external-capital comparison | $828 M; OSR saves $716 M (86.4%) |
| Lifetime external interest and combined financing saving | $880 M interest; $1.60 bn capital + interest |
| 15%–25% planning risk envelope | $529 M–$575 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-48125 k / $194 M |
| Low/high project IRR | 6.9% / 11.9% |
| Low/high steady-state DSCR | 1.10 / 1.94 |
