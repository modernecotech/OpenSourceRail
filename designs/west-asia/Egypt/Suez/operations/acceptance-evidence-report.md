# Suez Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,354 |
| Manufacturing material/BOM rows | 20,280 |
| Manufacturing QA verification rows | 1,354 |
| Construction QA action rows | 1,258 |
| Maintenance handover schedule rows | 1,615 |
| Manufacturing rows with material refs | 1,354 / 1,354 |
| Manufacturing rows with verification refs | 1,354 / 1,354 |
| Manufacturing rows linked to QA actions | 1,354 / 1,354 |
