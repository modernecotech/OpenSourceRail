...
| Per-capita (city pop) | $1,273 / person |
...
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$145 M cumulative** | $484 |
| Lifecycle envelope (yr 1–40, high scenario) | **$145 M cumulative** | $484 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$758 M cumulative** | $2,526 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $306 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $76 M | — | — | — |
| **Total** | **100%** | **$382 M** | | | **$18 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $225 M | 59% of $382 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 18,043 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $439 M–$477 M |
| Annual OPEX | $9.1 M / yr |
| Low/high project NPV at 8% | $-90449 k / $71 M |
| Low/high project IRR | 5.3% / 9.8% |
| Low/high steady-state DSCR | 1.55 / 2.71 |
