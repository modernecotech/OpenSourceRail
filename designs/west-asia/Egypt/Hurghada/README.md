...
| Bucket | Value |
|---|---|
| At-grade (38.8 km @ $0.85 M/km) | $33 M |
| Elevated (3.9 km @ $4.0 M/km) | $16 M |
...
| Steady-state, low-ridership (year 6+) | **$6.7 M / yr** | $22 |
| Steady-state, high-ridership (year 6+) | **$2.7 M / yr** | $9 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$188 M cumulative** | $628 |
| Lifecycle envelope (yr 1–25, high scenario) | **$109 M cumulative** | $362 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$55 M cumulative** | $182 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $79 M | 4.5% | 25 y, 5 y grace | $6.1 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $3.5 M / yr + bonds $3.4 M / yr = **$7.0 M / yr** total — plus the equity tranche amortised across construction ($3.9 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 59,223 |
| Daily paid trips / population | 8% | 15% | 20% |
| Annual paid trips | 8.8 M | 16.4 M | 21.6 M |
...
| **Total revenue** | **$7.5 M / yr** | **$11 M / yr** | **$14 M / yr** |
| Revenue / OPEX + debt-service recovery | 53% | 81% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $6.7 M / yr | $2.7 M / yr | **$0 / yr** |
