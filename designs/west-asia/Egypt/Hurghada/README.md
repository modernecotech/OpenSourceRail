...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **41,850 – 75,330 trips/day**
...
| Per-capita (city pop) | $2,279 / person |
...
|---|---|---|
| Construction (years 1–5) | **$21 M / yr** | $68 |
| Steady-state, low-ridership (year 6+) | **$19 M / yr** | $63 |
| Steady-state, high-ridership (year 6+) | **$14 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$14 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$763 M cumulative** | $2,542 |
| Lifecycle envelope (yr 1–40, high scenario) | **$581 M cumulative** | $1,937 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$581 M cumulative** | $1,937 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.2 M / yr → $0 k / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $342 M | 2.0% | 40 y, 5 y grace | $14 M / yr |
...
_During the 5-year grace period the public sponsor pays interest only on repayable debt — concessional loan $6.8 M / yr + fallback bonds $0 k / yr = **$6.8 M / yr** total. The $273 M grant tranche carries no repayment or coupon. Government equity is drawn across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 41,850 | 75,330 | 62,344 |
| Daily paid trips / catchment | 25% | 45% | 37% |
| Daily paid trips / city population | 14% | 25% | 21% |
| Annual paid trips | 15.3 M | 27.5 M | 22.8 M |
| Farebox revenue | $11 M / yr | $19 M / yr | $16 M / yr |
...
| Revenue / OPEX recovery | 72% | 118% | 100% |
