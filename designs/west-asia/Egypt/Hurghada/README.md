...
| Dedicated solar plant | $15 M | 70% | $10 M | $4.5 M |
...
| **Total city CAPEX** | **$372 M** | **41.5%** | **$154 M** | **$218 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **41.5%** | **$154 M** | **$31 M / yr** |
| **Local capital for domestic procurement / payroll** | **58.5%** | **$218 M** | **$44 M / yr** |
| of which planned local bond issuance | 46.8% of total CAPEX | $174 M | $35 M / yr |
...
| Steady-state, low capacity-use (year 6+) | **$623 k / yr** | $2 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $92 |
| Lifecycle envelope (yr 1–40, low scenario) | **$191 M cumulative** | $638 |
| Lifecycle envelope (yr 1–40, high scenario) | **$170 M cumulative** | $565 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.14 bn cumulative** | $3,794 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $27 M / yr → $28 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 41% | $154 M | 4.5% | 40 y, 5 y grace | $8.8 M / yr |
| Local-currency sovereign / project bonds for local content | 47% | $174 M | 10.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 12% | $44 M | — | — | — |
| **Total** | **100%** | **$372 M** | | | **$28 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.9 M / yr + local bonds $18 M / yr = **$25 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.7 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Operating surplus applied to debt support | -$27 M / yr | -$28 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $623 k / yr | $0 k / yr | **$28 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $218 M | 59% of $372 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 17,436 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $154 M (41.5%) |
| Local-content / local-funding requirement | $218 M (58.5%) |
