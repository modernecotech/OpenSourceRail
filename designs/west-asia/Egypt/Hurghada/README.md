...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$553 M (88.3%) of external capital** and **$679 M of external interest**. Capital plus saved interest totals **$1.23 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 57.7%
- Catchment population: **≈ 173,100** (within ~800 m walk of a station)
...
| Dedicated solar plant | 18.7 MW / 112 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 78 kWh | 131 kWh | 45 kWh | 3.1 km / 17 kWh |
| line-2 | 6 | 82 kWh | 139 kWh | 49 kWh | 3.5 km / 19 kWh |
| line-3 | 5 | 50 kWh | 98 kWh | 43 kWh | 3.0 km / 16 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (35.6 km @ $2.58 M/km) | $92 M |
| Elevated (3.4 km @ $9.75 M/km) | $33 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 18,737 kW @ $700/kW | $13 M |
| Grid interconnection / PPA tie-in | 18,737 kW @ $100/kW | $1.9 M |
| Annual generation proxy | 18.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 41.0 GWh/yr |
...
| Per-capita (city pop) | $1,159 / person |
...
| **Total city CAPEX** | **$348 M** | **21.1%** | **$73 M** | **$274 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hurghada`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.1%** | **$73 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.9%** | **$274 M** | **$55 M / yr** |
| of which planned local bond issuance | 63.1% of total CAPEX | $219 M | $44 M / yr |
| **Total city programme** | **100.0%** | **$348 M** | **$70 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $470 M | $396 M (84.4%) | $487 M | **$883 M** |
| **Default** | 2.00× | $626 M | $553 M (88.3%) | $679 M | **$1.23 bn** |
| High | 3.00× | $939 M | $866 M (92.2%) | $1.06 bn | **$1.93 bn** |

At the default 2.00× case, OSR's $73 M external requirement is 88.3% below the illustrative foreign-company requirement of $626 M; the associated lifetime external-interest saving is $679 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$37 M / yr** | $124 |
| Steady-state, low capacity-use (year 6+) | **$471 k / yr** | $2 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $93 |
| Lifecycle envelope (yr 1–40, low scenario) | **$203 M cumulative** | $677 |
| Lifecycle envelope (yr 1–40, high scenario) | **$187 M cumulative** | $622 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.17 bn cumulative** | $3,886 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $73 M | 4.5% | 40 y, 5 y grace | $4.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $219 M | 10.5% | 40 y, 5 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $55 M | — | — | — |
| **Total** | **100%** | **$348 M** | | | **$28 M / yr** |
...
| Traction energy (57.1 GWh / yr) | 18,120 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 18.7 MW / 41.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $225 k |
| Labour (290 FTE) | driverless roster: OCC/remote 57, station/platform 90, passenger service 38, fleet maintenance 48, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$8.6 M / yr** |

_Annual service work: 18,120 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.3 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 41.0 GWh/yr against 57.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 80 trainsets, 17 stations, 39.0 route-km, 3 lines, and 18,120 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 9.2 M |
| Annual paid trips / city resident | 163 | 261 | 31 |
| Farebox revenue | $34 M / yr | $54 M / yr | $6.4 M / yr |
| Station shop leases | $879 k / yr | $879 k / yr | $879 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$36 M / yr** | **$56 M / yr** | **$8.6 M / yr** |
| Revenue / OPEX recovery | 419% | 655% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $471 k / yr | $0 k / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $28 M / yr | $48 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,000 m² of station shop/kiosk leases at $21/m²/month and 732 advertising boards at $182/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$47 M / yr** | **$76 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 14 major/terminal/interchange nodes | 33,007 trips/trading day; 10.9 M access-events/yr | 52,812 trips/trading day; 17.4 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,574 trips/activity day; 4.4 M access-events/yr | 23,318 trips/activity day; 7.0 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $274 M | 79% of $348 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,985 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $73 M (21.1%) |
| Local-content / local-funding requirement | $274 M (78.9%) |
| Default foreign-turnkey external-capital comparison | $626 M; OSR saves $553 M (88.3%) |
| Lifetime external interest and combined financing saving | $679 M interest; $1.23 bn capital + interest |
| 15%–25% planning risk envelope | $400 M–$435 M |
| Annual OPEX | $8.6 M / yr |
| Low/high project NPV at 8% | $-59574 k / $102 M |
| Low/high project IRR | 6.1% / 10.8% |
| Low/high steady-state DSCR | 0.98 / 1.71 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,689.55 train-km; 9,082.21 kWh consumed; 9,213.82 kWh charged; 35 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,720.49 train-km; 100,632.53 kWh consumed; 102,030.86 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 59%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 49.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 49.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 58.5% | 100.0% / 90% | pass |
...
|---|---|
| ![Hurghada energy and battery simulation dashboard](engineering/screenshots/hurghada-simulation-dashboard.png) | ![Hurghada simulator network visualizer](engineering/screenshots/hurghada-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 3 interchange complexes, 15 civil segments, and 0 input findings |
...
|---|---|
| ![Hurghada QGIS engineering layers](engineering/screenshots/hurghada-qgis-engineering-map.png) | ![Hurghada SUMO timetable validation](engineering/screenshots/hurghada-sumo-validation.png) |
