...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 57 | $2.80 M | $160 M |
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $156 |
| Steady-state, low-ridership (year 6+) | **$49 M / yr** | $163 |
| Steady-state, high-ridership (year 6+) | **$45 M / yr** | $150 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $143 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.21 bn cumulative** | $4,031 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.13 bn cumulative** | $3,777 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.09 bn cumulative** | $3,644 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.8 M / yr → $2.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $337 M | 4.5% | 25 y, 5 y grace | $26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $140 M | 10.5% | 25 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $84 M | — | — | — |
| **Total** | **100%** | **$562 M** | | | **$43 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 30,132 | 50,220 | 60,702 |
| Daily paid trips / catchment | 18% | 30% | 36% |
| Daily paid trips / city population | 10% | 17% | 20% |
| Annual paid trips | 11.0 M | 18.3 M | 22.2 M |
| Farebox revenue | $5.7 M / yr | $9.5 M / yr | $12 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$8.6 M / yr** | **$12 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 60% | 86% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $49 M / yr | $45 M / yr | **$43 M / yr** |
