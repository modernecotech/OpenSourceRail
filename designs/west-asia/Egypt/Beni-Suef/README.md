...
|---|---|---|---|---|
| line-1 | 16.8 km | 11 | 43 | S Outer ↔ NE Outer |
| line-2 | 13.6 km | 8 | 36 | N Outer ↔ SW Outer |
| line-3 |  9.5 km | 7 | 25 | NW Mid ↔ E Mid |
| **Total** | **40.0 km** | **26 unique** | **104** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **31.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 28.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 521 kWh usable margin across the worst powered-stop gap (line-2) |
...
| On-site PV shortfall before solar plant | 166 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 31.8 MW / 191 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 136 kWh | 241 kWh | 92 kWh | 2.3 km / 19 kWh |
| line-2 | 8 | 110 kWh | 172 kWh | 51 kWh | 2.4 km / 19 kWh |
| line-3 | 7 | 77 kWh | 131 kWh | 46 kWh | 2.0 km / 16 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 312 | $60 k | $19 M |
| High sensitivity check | 312 | $120 k | $37 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 31,770 kW @ $700/kW | $22 M |
| Grid interconnection / PPA tie-in | 31,770 kW @ $100/kW | $3.2 M |
| Annual generation proxy | 31.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 69.6 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh beni-suef`.
...
|---|---|---|
| Construction (years 1–5) | **$31 M / yr** | $89 |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$814 M cumulative** | $2,326 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $328 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $82 M | — | — | — |
| **Total** | **100%** | **$410 M** | | | **$19 M / yr** |
...
| Traction energy (87.9 GWh / yr) | 18,577 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 27.4 GWh/yr + dedicated solar plant 31.8 MW / 69.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $381 k |
| Labour (333 FTE) | driverless roster: OCC/remote 69, station/platform 98, passenger service 49, fleet maintenance 56, infrastructure/energy 40, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 18,577 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.3 M train-km / yr (22.0 M car-km / yr). On-site PV covers 27.4 GWh/yr and the dedicated solar plant adds 69.6 GWh/yr against 87.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 104 trainsets, 26 stations, 40.0 route-km, 3 lines, and 18,577 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 34 |
| Farebox revenue | $51 M / yr | $81 M / yr | $8.2 M / yr |
| Station shop leases | $896 k / yr | $896 k / yr | $896 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 505% | 795% | 100% |
...
_Commercial-revenue assumptions: 4,080 m² of station shop/kiosk leases at $21/m²/month and 788 advertising boards at $182/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $231 M | 56% of $410 M CAPEX using bucket local-content shares |
...
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $11 M / $253 M |
| Low/high project IRR | 8.3% / 13.5% |
| Low/high steady-state DSCR | 2.27 / 3.89 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,635.19 train-km; 13,187.30 kWh consumed; 13,863.28 kWh charged; 32 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,243.47 train-km; 155,192.30 kWh consumed; 158,243.21 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 63%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 55.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 56.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 63.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.1% / 60% | pass |
| ten-hour single charging-pad outage | 57.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 1 interchange complexes, 29 civil segments, and 0 input findings |
