...
| Per-capita (city pop) | $1,363 / person |
...
| Steady-state, low-ridership (year 6+) | **$40 M / yr** | $115 |
| Steady-state, high-ridership (year 6+) | **$36 M / yr** | $104 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $104 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.00 bn cumulative** | $2,870 |
| Lifecycle envelope (yr 1–25, high scenario) | **$928 M cumulative** | $2,652 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$928 M cumulative** | $2,652 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.8 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $286 M | 4.5% | 25 y, 5 y grace | $22 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $13 M / yr = **$25 M / yr** total — plus the equity tranche amortised across construction ($14 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| **Total revenue** | **$8.9 M / yr** | **$13 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 70% | 104% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $40 M / yr | $36 M / yr | **$36 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $556 k / yr | $0 / yr |
