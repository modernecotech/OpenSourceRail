...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$503 M (86.5%) of external capital** and **$619 M of external interest**. Capital plus saved interest totals **$1.12 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`beni-suef.corridor.geojson`](beni-suef.corridor.geojson).
...
| Route length (double track) | 40.0 km |
...
| Total fleet capacity | 31,320 AW2 pax (41,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 78 × 360 = **28,080 AW2 passengers** (37,440 AW3 crush)
- **Total fleet passenger capacity:** 87 × 360 = **31,320 AW2 passengers** (41,760 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 49.1%
- Catchment population: **≈ 171,850** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **34.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 18.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 510 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 18,577 train-km/day | One-way train journeys × route length |
| Annual service work | 7.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 241 MWh/day | 22.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 182 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 34.9 MW / 209 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 136 kWh | 204 kWh | 55 kWh | 3.4 km / 27 kWh |
| line-2 | 6 | 110 kWh | 172 kWh | 51 kWh | 3.1 km / 25 kWh |
| line-3 | 4 | 77 kWh | 114 kWh | 30 kWh | 3.7 km / 30 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (39.0 km @ $2.58 M/km) | $101 M |
| Elevated (1.0 km @ $9.75 M/km) | $9.6 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 87 | $900 k | $78 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 261 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 261 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 34,875 kW @ $700/kW | $24 M |
| Grid interconnection / PPA tie-in | 34,875 kW @ $100/kW | $3.5 M |
| Annual generation proxy | 34.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 76.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$28 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 40.0 km × $0.050 M/km | $2.0 M |
...
| Rolling stock | $78 M | 35% | $27 M | $51 M |
| Dedicated solar plant | $28 M | 45% | $13 M | $15 M |
| Residual signalling / train control | $2.0 M | 50% | $999 k | $999 k |
| Charging microgrids | $1.9 M | 40% | $740 k | $1.1 M |
| EPC / project services | $19 M | 15% | $2.9 M | $16 M |
| **Total city CAPEX** | **$323 M** | **24.2%** | **$78 M** | **$245 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh beni-suef`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$78 M** | **$16 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$245 M** | **$49 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $196 M | $39 M / yr |
| **Total city programme** | **100.0%** | **$323 M** | **$65 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $436 M | $358 M (82.1%) | $440 M | **$798 M** |
| **Default** | 2.00× | $582 M | $503 M (86.5%) | $619 M | **$1.12 bn** |
| High | 3.00× | $872 M | $794 M (91.0%) | $976 M | **$1.77 bn** |

At the default 2.00× case, OSR's $78 M external requirement is 86.5% below the illustrative foreign-company requirement of $582 M; the associated lifetime external-interest saving is $619 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$34 M / yr** | $97 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$169 M cumulative** | $484 |
| Lifecycle envelope (yr 1–40, high scenario) | **$169 M cumulative** | $484 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $3,054 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $78 M | 4.5% | 40 y, 5 y grace | $4.5 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $196 M | 10.5% | 40 y, 5 y grace | $21 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $49 M | — | — | — |
| **Total** | **100%** | **$323 M** | | | **$26 M / yr** |
...
| Traction energy (87.9 GWh / yr) | 18,577 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.5 GWh/yr + dedicated solar plant 34.9 MW / 76.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $418 k |
| Labour (289 FTE) | driverless roster: OCC/remote 61, station/platform 71, passenger service 49, fleet maintenance 51, infrastructure/energy 36, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$8.8 M / yr** |

_Annual service work: 18,577 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.3 M train-km / yr (22.0 M car-km / yr). On-site PV covers 21.5 GWh/yr and the dedicated solar plant adds 76.4 GWh/yr against 87.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 87 trainsets, 17 stations, 40.0 route-km, 3 lines, and 18,577 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 209 | 335 | 29 |
| Farebox revenue | $51 M / yr | $81 M / yr | $7.1 M / yr |
| Station shop leases | $641 k / yr | $641 k / yr | $641 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 598% | 945% | 100% |
...
| Operating surplus after OPEX (before debt support) | $44 M / yr | $74 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,920 m² of station shop/kiosk leases at $21/m²/month and 564 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $11 M / yr | $17 M / yr | 132 M - 211 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.9 M / yr | $3.0 M / yr | 23.8–38.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.3 M / yr | $8.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| Commerce | 11 major/terminal/interchange nodes | 45,789 trips/trading day; 15.1 M access-events/yr | 73,262 trips/trading day; 24.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $245 M | 76% of $323 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $392 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $78 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,622 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $28 M |
| **Reconciled project CAPEX** | **$323 M** |
| Imported / external-capital requirement | $78 M (24.2%) |
| Local-content / local-funding requirement | $245 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $582 M; OSR saves $503 M (86.5%) |
| Lifetime external interest and combined financing saving | $619 M interest; $1.12 bn capital + interest |
| 15%–25% planning risk envelope | $372 M–$404 M |
| Annual OPEX | $8.8 M / yr |
| Low/high project NPV at 8% | $89 M / $331 M |
| Low/high project IRR | 10.6% / 16.5% |
| Low/high steady-state DSCR | 1.70 / 2.89 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,678.30 train-km; 13,535.15 kWh consumed; 11,830.11 kWh charged; 34 depot services completed; minimum SoC 67%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,735.96 train-km; 151,098.00 kWh consumed; 152,930.18 kWh charged; 478 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 205 SoC warnings; 34 energy-adapted off-peak departures, maximum 25 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 99.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 87.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 99.8% / 90% | pass |
...
|---|---|
| ![Beni-Suef energy and battery simulation dashboard](engineering/screenshots/beni-suef-simulation-dashboard.png) | ![Beni-Suef simulator network visualizer](engineering/screenshots/beni-suef-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 29 civil segments, and 0 input findings |
...
|---|---|
| ![Beni-Suef QGIS engineering layers](engineering/screenshots/beni-suef-qgis-engineering-map.png) | ![Beni-Suef SUMO timetable validation](engineering/screenshots/beni-suef-sumo-validation.png) |
...
| [`beni-suef.toml`](beni-suef.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`beni-suef-network-map.png`](beni-suef-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`beni-suef.corridor.geojson`](beni-suef.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`beni-suef.stations.json`](beni-suef.stations.json) | Machine-readable station list |
| [`beni-suef.design-quality.yaml`](beni-suef.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug beni-suef

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh beni-suef
```
