# Luxor Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 304 |
| Manufacturing schedule rows | 1,140 |
| Manufacturing material/BOM rows | 16,831 |
| Manufacturing QA verification rows | 1,140 |
| Construction QA action rows | 1,055 |
| Maintenance handover schedule rows | 1,361 |
| Manufacturing rows with material refs | 1,140 / 1,140 |
| Manufacturing rows with verification refs | 1,140 / 1,140 |
| Manufacturing rows linked to QA actions | 1,140 / 1,140 |
