...
| Manufacturing schedule rows | 906 |
| Manufacturing material/BOM rows | 14,291 |
| Manufacturing QA verification rows | 906 |
| Construction QA action rows | 857 |
| Maintenance handover schedule rows | 1,066 |
| Manufacturing rows with material refs | 906 / 906 |
| Manufacturing rows with verification refs | 906 / 906 |
| Manufacturing rows linked to QA actions | 906 / 906 |
