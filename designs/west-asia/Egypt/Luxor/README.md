...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 54 | $4.20 M | $227 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 162 | $100 k | $16 M |
| High sensitivity check | 162 | $200 k | $32 M |
...
| Steady-state, low-ridership (year 6+) | **$54 M / yr** | $109 |
| Steady-state, high-ridership (year 6+) | **$52 M / yr** | $104 |
| Steady-state, operating-neutral revenue case | **$52 M / yr** | $104 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.37 bn cumulative** | $2,740 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.32 bn cumulative** | $2,640 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.32 bn cumulative** | $2,640 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.5 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $407 M | 4.5% | 25 y, 5 y grace | $31 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $170 M | 10.5% | 25 y, 5 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $102 M | — | — | — |
| **Total** | **100%** | **$678 M** | | | **$52 M / yr** |
...
|---|---|---|---|
| Daily paid trips | 65,430 | 109,050 | 78,623 |
| Daily paid trips / catchment | 18% | 30% | 22% |
| Daily paid trips / city population | 13% | 22% | 16% |
| Annual paid trips | 23.9 M | 39.8 M | 28.7 M |
| Farebox revenue | $12 M / yr | $21 M / yr | $15 M / yr |
...
| Revenue / OPEX recovery | 86% | 132% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $54 M / yr | $52 M / yr | **$52 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $5.8 M / yr | $0 / yr |
