...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$689 M (86.8%) of external capital** and **$847 M of external interest**. Capital plus saved interest totals **$1.54 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (49.3 km @ $3.0 M/km) | $148 M |
...
| **Total city CAPEX** | **$441 M** | **23.7%** | **$104 M** | **$337 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$104 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$337 M** | **$67 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $269 M | $54 M / yr |
| **Total city programme** | **100.0%** | **$441 M** | **$88 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $595 M | $491 M (82.5%) | $604 M | **$1.09 bn** |
| **Default** | 2.00× | $794 M | $689 M (86.8%) | $847 M | **$1.54 bn** |
| High | 3.00× | $1.19 bn | $1.09 bn (91.2%) | $1.34 bn | **$2.42 bn** |

At the default 2.00× case, OSR's $104 M external requirement is 86.8% below the illustrative foreign-company requirement of $794 M; the associated lifetime external-interest saving is $847 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$46 M / yr** | $93 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$232 M cumulative** | $464 |
| Lifecycle envelope (yr 1–40, high scenario) | **$232 M cumulative** | $464 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.46 bn cumulative** | $2,924 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $104 M | 4.5% | 40 y, 5 y grace | $6.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $269 M | 10.5% | 40 y, 5 y grace | $29 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$441 M** | | | **$35 M / yr** |
...
| Annual paid trips / city resident | 147 | 235 | 28 |
...
| Revenue / OPEX recovery | 455% | 718% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $337 M | 76% of $441 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,967 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $104 M (23.7%) |
| Local-content / local-funding requirement | $337 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $794 M; OSR saves $689 M (86.8%) |
| Lifetime external interest and combined financing saving | $847 M interest; $1.54 bn capital + interest |
| 15%–25% planning risk envelope | $507 M–$551 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-24985 k / $217 M |
| Low/high project IRR | 7.4% / 12.5% |
| Low/high steady-state DSCR | 1.17 / 2.04 |
