...
|---|---|---|
| Construction (years 1–5) | **$49 M / yr** | $122 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$244 M cumulative** | $609 |
| Lifecycle envelope (yr 1–40, high scenario) | **$244 M cumulative** | $609 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.27 bn cumulative** | $3,179 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $513 M | 4.5% | 40 y, 5 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $128 M | — | — | — |
| **Total** | **100%** | **$641 M** | | | **$29 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $360 M | 56% of $641 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $575 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $115 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 28,809 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $584 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$641 M** |
| 15%–25% planning risk envelope | $737 M–$801 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-217537 k / $24 M |
| Low/high project IRR | 4.0% / 8.4% |
| Low/high steady-state DSCR | 1.26 / 2.30 |
