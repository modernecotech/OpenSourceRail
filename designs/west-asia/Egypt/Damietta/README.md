...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$893 M (86.5%) of external capital** and **$1.10 bn of external interest**. Capital plus saved interest totals **$1.99 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (70.9 km @ $2.58 M/km) | $183 M |
| Elevated (2.5 km @ $9.75 M/km) | $25 M |
| Elevated-interchange premium (2 sites @ $4.50 M) | $9.0 M |
| **Civil subtotal** | **$217 M** |
...
| Per-capita (city pop) | $1,433 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $217 M | 15% | $33 M | $185 M |
...
| **Total city CAPEX** | **$573 M** | **24.3%** | **$140 M** | **$434 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$140 M** | **$28 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$434 M** | **$87 M / yr** |
| of which planned local bond issuance | 60.5% of total CAPEX | $347 M | $69 M / yr |
| **Total city programme** | **100.0%** | **$573 M** | **$115 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $774 M | $635 M (82.0%) | $780 M | **$1.41 bn** |
| **Default** | 2.00× | $1.03 bn | $893 M (86.5%) | $1.10 bn | **$1.99 bn** |
| High | 3.00× | $1.55 bn | $1.41 bn (91.0%) | $1.73 bn | **$3.14 bn** |

At the default 2.00× case, OSR's $140 M external requirement is 86.5% below the illustrative foreign-company requirement of $1.03 bn; the associated lifetime external-interest saving is $1.10 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$60 M / yr** | $150 |
| Steady-state, low capacity-use (year 6+) | **$7.7 M / yr** | $19 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $114 |
| Lifecycle envelope (yr 1–40, low scenario) | **$572 M cumulative** | $1,429 |
| Lifecycle envelope (yr 1–40, high scenario) | **$300 M cumulative** | $751 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.90 bn cumulative** | $4,739 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $38 M / yr → $46 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $140 M | 4.5% | 40 y, 5 y grace | $8.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $347 M | 10.5% | 40 y, 5 y grace | $38 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $87 M | — | — | — |
| **Total** | **100%** | **$573 M** | | | **$46 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.3 M / yr + local bonds $36 M / yr = **$43 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($17 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 18.8 M |
| Annual paid trips / city resident | 183 | 293 | 47 |
...
| Revenue / OPEX recovery | 350% | 551% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $46 M / yr | $46 M / yr | **$46 M / yr** |
| Operating surplus applied to debt support | -$38 M / yr | -$46 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $7.7 M / yr | $0 k / yr | **$46 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $434 M | 76% of $573 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $694 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $139 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 34,766 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $516 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$573 M** |
| Imported / external-capital requirement | $140 M (24.3%) |
| Local-content / local-funding requirement | $434 M (75.7%) |
| Default foreign-turnkey external-capital comparison | $1.03 bn; OSR saves $893 M (86.5%) |
| Lifetime external interest and combined financing saving | $1.10 bn interest; $1.99 bn capital + interest |
| 15%–25% planning risk envelope | $659 M–$717 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-157832 k / $84 M |
| Low/high project IRR | 4.8% / 9.4% |
| Low/high steady-state DSCR | 0.83 / 1.50 |
