...
| Per-capita (city pop) | €1,813 / person |
...
|---|---|---|
| Construction (years 1–5) | **€60 M / yr** | €151 |
| Steady-state, low-ridership (year 6+) | **€72 M / yr** | €180 |
| Steady-state, high-ridership (year 6+) | **€69 M / yr** | €173 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.74 bn cumulative** | €4,361 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.69 bn cumulative** | €4,216 |

_Population basis: 400,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€17 M / yr (low) → €14 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €435 M | 4.5% | 25 y, 5 y grace | €33 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €181 M | 10.5% | 25 y, 5 y grace | €22 M / yr |
| Government equity (no debt service) | 15% | €109 M | — | — | — |
| **Total** | **100%** | **€725 M** | | | **€55 M / yr** |
...
| Labour (453 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.8 M |
...
| Farebox revenue | €2.9 M / yr | €5.8 M / yr |
| Farebox / OPEX recovery | 15% | 30% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €17 M / yr | €14 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€72 M / yr** | **€69 M / yr** |
