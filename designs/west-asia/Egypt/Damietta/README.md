...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$955 M (86.8%) of external capital** and **$1.17 bn of external interest**. Capital plus saved interest totals **$2.13 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Revenue fleet | 140 × 3-car trainsets |
| Revenue fleet passenger capacity | 50,400 AW2 pax (67,200 AW3 crush) |
...
| Revenue fleet capacity | 50,400 AW2 pax (67,200 AW3 crush) |
| Total fleet capacity | 56,160 AW2 pax (74,880 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 140 × 360 = **50,400 AW2 passengers** (67,200 AW3 crush)
- **Total fleet passenger capacity:** 156 × 360 = **56,160 AW2 passengers** (74,880 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 71.7%
- Catchment population: **≈ 286,800** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **71.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 483 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 56 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 70 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 34,176 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 71.6 MW / 429 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 194 kWh | 294 kWh | 80 kWh | 7.0 km / 56 kWh |
| line-2 | 7 | 183 kWh | 257 kWh | 56 kWh | 5.3 km / 43 kWh |
| line-3 | 8 | 216 kWh | 327 kWh | 89 kWh | 7.0 km / 57 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 156 | $900 k | $140 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 468 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 468 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 71,552 kW @ $700/kW | $50 M |
| Grid interconnection / PPA tie-in | 71,552 kW @ $100/kW | $7.2 M |
| Annual generation proxy | 71.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 156.7 GWh/yr |
...
| Per-capita (city pop) | $1,528 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $252 M | 15% | $38 M | $215 M |
| Stations | $111 M | 20% | $22 M | $88 M |
...
| Charging microgrids | $2.5 M | 40% | $1.0 M | $1.5 M |
| EPC / project services | $36 M | 15% | $5.4 M | $31 M |
| **Total city CAPEX** | **$611 M** | **23.8%** | **$145 M** | **$466 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh damietta`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.8%** | **$145 M** | **$29 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.2%** | **$466 M** | **$93 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $373 M | $75 M / yr |
| **Total city programme** | **100.0%** | **$611 M** | **$122 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $825 M | $680 M (82.4%) | $836 M | **$1.52 bn** |
| **Default** | 2.00× | $1.10 bn | $955 M (86.8%) | $1.17 bn | **$2.13 bn** |
| High | 3.00× | $1.65 bn | $1.50 bn (91.2%) | $1.85 bn | **$3.35 bn** |

At the default 2.00× case, OSR's $145 M external requirement is 86.8% below the illustrative foreign-company requirement of $1.10 bn; the associated lifetime external-interest saving is $1.17 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$64 M / yr** | $161 |
| Steady-state, low capacity-use (year 6+) | **$12 M / yr** | $29 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $122 |
| Lifecycle envelope (yr 1–40, low scenario) | **$726 M cumulative** | $1,815 |
| Lifecycle envelope (yr 1–40, high scenario) | **$322 M cumulative** | $804 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.03 bn cumulative** | $5,063 |

_Population basis: 400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $37 M / yr → $49 M / yr._
...
| Local-currency sovereign / project bonds for local content | 61% | $373 M | 10.5% | 40 y, 5 y grace | $40 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $93 M | — | — | — |
| **Total** | **100%** | **$611 M** | | | **$49 M / yr** |
...
| Traction energy (161.7 GWh / yr) | 34,176 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 25.4 GWh/yr + dedicated solar plant 71.6 MW / 156.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $859 k |
| Labour (406 FTE) | driverless roster: OCC/remote 94, station/platform 89, passenger service 49, fleet maintenance 92, infrastructure/energy 61, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 34,176 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.5 M train-km / yr (40.4 M car-km / yr). On-site PV covers 25.4 GWh/yr and the dedicated solar plant adds 156.7 GWh/yr against 161.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 156 trainsets, 24 stations, 73.5 route-km, 3 lines, and 34,176 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 183 | 293 | 49 |
| Farebox revenue | $51 M / yr | $81 M / yr | $14 M / yr |
| Station shop leases | $810 k / yr | $810 k / yr | $810 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 334% | 527% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $49 M / yr | $49 M / yr | **$49 M / yr** |
| Operating surplus applied to debt support | -$37 M / yr | -$49 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $0 k / yr | **$49 M / yr** |
| Operating surplus after OPEX (before debt support) | $37 M / yr | $68 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,688 m² of station shop/kiosk leases at $21/m²/month and 716 advertising boards at $182/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$82 M / yr** | **$131 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $466 M | 76% of $611 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $746 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $149 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 37,335 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $554 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$611 M** |
| Imported / external-capital requirement | $145 M (23.8%) |
| Local-content / local-funding requirement | $466 M (76.2%) |
| Default foreign-turnkey external-capital comparison | $1.10 bn; OSR saves $955 M (86.8%) |
| Lifetime external interest and combined financing saving | $1.17 bn interest; $2.13 bn capital + interest |
| 15%–25% planning risk envelope | $703 M–$764 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-193544 k / $48 M |
| Low/high project IRR | 4.3% / 8.8% |
| Low/high steady-state DSCR | 0.76 / 1.39 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,591.23 train-km; 20,897.79 kWh consumed; 17,272.74 kWh charged; 23 depot services completed; minimum SoC 70%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 32,317.15 train-km; 260,622.83 kWh consumed; 235,902.35 kWh charged; 483 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.6% of scheduled train-km delivered; 329 SoC warnings; 26 energy-adapted off-peak departures, maximum 31 min headway |
...
| 50% charging-contact availability | 20.0% | 94.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 78.4% / 60% | pass |
...
|---|---|
| ![Damietta energy and battery simulation dashboard](engineering/screenshots/damietta-simulation-dashboard.png) | ![Damietta simulator network visualizer](engineering/screenshots/damietta-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 2 interchange complexes, 13 civil segments, and 0 input findings |
...
|---|---|
| ![Damietta QGIS engineering layers](engineering/screenshots/damietta-qgis-engineering-map.png) | ![Damietta SUMO timetable validation](engineering/screenshots/damietta-sumo-validation.png) |
...
scripts/regenerate-city.sh damietta
```
