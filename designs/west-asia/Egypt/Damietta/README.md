...
| Revenue fleet | 175 × 3-car trainsets |
| Revenue fleet passenger capacity | 63,000 AW2 pax (84,000 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 24.1 km | 14 | 63 | N Outer ↔ S Outer |
| line-2 | 22.6 km | 13 | 60 | SE Mid ↔ W Outer |
| line-3 | 26.8 km | 14 | 71 | SW Outer ↔ NE Outer |
| **Total** | **73.5 km** | **41 unique** | **194** | |
...
| Revenue fleet capacity | 63,000 AW2 pax (84,000 AW3 crush) |
| Total fleet capacity | 69,840 AW2 pax (93,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 175 × 360 = **63,000 AW2 passengers** (84,000 AW3 crush)
- **Total fleet passenger capacity:** 194 × 360 = **69,840 AW2 passengers** (93,120 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **66.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 471 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 93 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 348 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 66.7 MW / 400 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 194 kWh | 318 kWh | 105 kWh | 3.5 km / 28 kWh |
| line-2 | 12 | 183 kWh | 294 kWh | 93 kWh | 3.5 km / 28 kWh |
| line-3 | 12 | 216 kWh | 347 kWh | 110 kWh | 8.5 km / 69 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 194 | $900 k | $175 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 582 | $60 k | $35 M |
| High sensitivity check | 582 | $120 k | $70 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 66,722 kW @ $700/kW | $47 M |
| Grid interconnection / PPA tie-in | 66,722 kW @ $100/kW | $6.7 M |
| Annual generation proxy | 66.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 146.1 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $7.6 M |
| EPC overhead (7%) | $42 M |
| **CAPEX total** | **$690 M** |
| Per-route-km | $9.4 M / km |
| Per-capita (city pop) | $1,725 / person |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $131 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$262 M cumulative** | $655 |
| Lifecycle envelope (yr 1–40, high scenario) | **$262 M cumulative** | $655 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.37 bn cumulative** | $3,421 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $552 M | 4.5% | 40 y, 5 y grace | $32 M / yr |
| Government equity (no debt service) | 20% | $138 M | — | — | — |
| **Total** | **100%** | **$690 M** | | | **$32 M / yr** |
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $7.0 M |
...
| Traction energy (161.7 GWh / yr) | 34,176 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 34.6 GWh/yr + dedicated solar plant 66.7 MW / 146.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $801 k |
| Labour (463 FTE) | driverless roster: OCC/remote 110, station/platform 112, passenger service 49, fleet maintenance 104, infrastructure/energy 67, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$18 M / yr** |

_Annual service work: 34,176 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.5 M train-km / yr (40.4 M car-km / yr). On-site PV covers 34.6 GWh/yr and the dedicated solar plant adds 146.1 GWh/yr against 161.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 194 trainsets, 41 stations, 73.5 route-km, 3 lines, and 34,176 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 21.5 M |
| Annual paid trips / city resident | 183 | 293 | 54 |
| Farebox revenue | $51 M / yr | $81 M / yr | $15 M / yr |
| Station shop leases | $956 k / yr | $956 k / yr | $956 k / yr |
| Advertising boards | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 305% | 479% | 100% |
...
| Operating surplus after OPEX (before debt support) | $36 M / yr | $66 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,352 m² of station shop/kiosk leases at $21/m²/month and 896 advertising boards at $182/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $21 M / yr | $33 M / yr | 19% of paid trips × $1.50 local spend proxy |
...
| Commerce | 11 major/terminal/interchange nodes | 37,800 trips/trading day; 12.5 M access-events/yr | 60,480 trips/trading day; 20.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $385 M | 56% of $690 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 30,822 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$690 M** |
| 15%–25% planning risk envelope | $793 M–$862 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $-266020 k / $-24085 k |
| Low/high project IRR | 3.3% / 7.6% |
| Low/high steady-state DSCR | 1.14 / 2.10 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,514.71 train-km; 20,280.37 kWh consumed; 20,702.68 kWh charged; 18 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 35,078.78 train-km; 282,898.46 kWh consumed; 283,905.77 kWh charged; 501 depot services completed (3 active at cutoff); minimum SoC 30%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 1 SoC warnings |
...
| 50% charging-contact availability | 29.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.1% / 60% | pass |
| ten-hour single charging-pad outage | 29.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 41 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
