...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$500 M (87.4%) of external capital** and **$614 M of external interest**. Capital plus saved interest totals **$1.11 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Elevated (2.9 km @ $9.75 M/km) | $28 M |
...
| Per-capita (city pop) | $397 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $105 M | 15% | $16 M | $89 M |
...
| **Total city CAPEX** | **$317 M** | **22.6%** | **$72 M** | **$246 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.6%** | **$72 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.4%** | **$246 M** | **$49 M / yr** |
| of which planned local bond issuance | 61.9% of total CAPEX | $197 M | $39 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $429 M | $357 M (83.3%) | $439 M | **$796 M** |
| **Default** | 2.00× | $571 M | $500 M (87.4%) | $614 M | **$1.11 bn** |
| High | 3.00× | $857 M | $785 M (91.6%) | $966 M | **$1.75 bn** |

At the default 2.00× case, OSR's $72 M external requirement is 87.4% below the illustrative foreign-company requirement of $571 M; the associated lifetime external-interest saving is $614 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$34 M / yr** | $42 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $32 |
| Lifecycle envelope (yr 1–40, low scenario) | **$168 M cumulative** | $211 |
| Lifecycle envelope (yr 1–40, high scenario) | **$168 M cumulative** | $211 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $1,322 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $72 M | 4.5% | 40 y, 5 y grace | $4.1 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $197 M | 10.5% | 40 y, 5 y grace | $21 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $49 M | — | — | — |
| **Total** | **100%** | **$317 M** | | | **$25 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.2 M / yr + local bonds $21 M / yr = **$24 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.8 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 8.8 M |
| Annual paid trips / city resident | 92 | 147 | 11 |
| Farebox revenue | $51 M / yr | $81 M / yr | $6.1 M / yr |
| Station shop leases | $835 k / yr | $835 k / yr | $835 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$8.2 M / yr** |
| Revenue / OPEX recovery | 644% | 1015% | 100% |
...
| Operating surplus after OPEX (before debt support) | $45 M / yr | $75 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $246 M | 77% of $317 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $393 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $79 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 19,691 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Local-content / local-funding requirement | $246 M (77.4%) |
| Default foreign-turnkey external-capital comparison | $571 M; OSR saves $500 M (87.4%) |
| Lifetime external interest and combined financing saving | $614 M interest; $1.11 bn capital + interest |
| 15%–25% planning risk envelope | $365 M–$397 M |
| Annual OPEX | $8.2 M / yr |
| Low/high project NPV at 8% | $101 M / $343 M |
| Low/high project IRR | 11.0% / 16.9% |
| Low/high steady-state DSCR | 1.76 / 2.96 |
