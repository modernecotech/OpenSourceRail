# Kafr El Sheikh Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 819 |
| Manufacturing material/BOM rows | 12,432 |
| Manufacturing QA verification rows | 819 |
| Construction QA action rows | 768 |
| Maintenance handover schedule rows | 972 |
| Manufacturing rows with material refs | 819 / 819 |
| Manufacturing rows with verification refs | 819 / 819 |
| Manufacturing rows linked to QA actions | 819 / 819 |
...
|---|---:|
| `project_kit` | 1,317 |
| `rolling_stock_bom` | 10,450 |
| `rolling_stock_cots_fitout` | 665 |
...
| `qa-10-carbody-structure` | 190 |
| `qa-11-bogie-wheelset` | 95 |
| `qa-12-traction-brake-battery` | 95 |
| `qa-13-passenger-systems` | 95 |
| `qa-15-first-article-trainset` | 95 |
