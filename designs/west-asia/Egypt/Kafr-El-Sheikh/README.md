...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **40,608 – 67,680 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (31.0 km @ $2.0 M/km) | $62 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 33.0 km × $0.015 M/km | $1.6 M |
...
| Steady-state, low-ridership (year 6+) | **$9.0 M / yr** | $30 |
| Steady-state, high-ridership (year 6+) | **$3.3 M / yr** | $11 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$262 M cumulative** | $872 |
| Lifecycle envelope (yr 1–25, high scenario) | **$148 M cumulative** | $492 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$81 M cumulative** | $271 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $49 M | 10.5% | 25 y, 5 y grace | $5.9 M / yr |
| Government equity (no debt service) | 15% | $29 M | — | — | — |
| **Total** | **100%** | **$195 M** | | | **$15 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $5.3 M / yr + bonds $5.1 M / yr = **$10 M / yr** total — plus the equity tranche amortised across construction ($5.9 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 45,000 | 75,000 | 92,512 |
| Daily paid trips / population | 15% | 25% | 31% |
| Annual paid trips | 16.4 M | 27.4 M | 33.8 M |
| Farebox revenue | $8.5 M / yr | $14 M / yr | $18 M / yr |
...
| Revenue / OPEX + debt-service recovery | 55% | 83% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $9.0 M / yr | $3.3 M / yr | **$0 / yr** |
