...
| Bucket | Value |
|---|---|
| At-grade (31.0 km @ €3.5 M/km) | €109 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 47 | €2.0 M | €94 M |
...
| Depots | €40 M |
| Rolling stock | €94 M |
| Residual train-control wayside + charging microgrids | €9.2 M |
| EPC overhead (7%) | €27 M |
| **CAPEX total** | **€411 M** |
...
| Steady-state, high-ridership (year 6+) | **€37 M / yr** | €124 |
| Lifecycle envelope (yr 1–25, low scenario) | **€961 M cumulative** | €3,203 |
| Lifecycle envelope (yr 1–25, high scenario) | **€917 M cumulative** | €3,057 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€8.1 M / yr (low) → €5.9 M / yr (high)._
...
| Labour (210 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €844 k |
...
| Operating shortfall (gov subsidy required) | €8.1 M / yr | €5.9 M / yr |
