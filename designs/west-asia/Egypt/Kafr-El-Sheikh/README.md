...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$426 M (88.2%) of external capital** and **$524 M of external interest**. Capital plus saved interest totals **$951 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (29.0 km @ $2.58 M/km) | $75 M |
| Elevated (2.6 km @ $9.75 M/km) | $26 M |
...
| **Total city CAPEX** | **$268 M** | **21.2%** | **$57 M** | **$212 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$57 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$212 M** | **$42 M / yr** |
| of which planned local bond issuance | 63.1% of total CAPEX | $169 M | $34 M / yr |
| **Total city programme** | **100.0%** | **$268 M** | **$54 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $362 M | $306 M (84.3%) | $376 M | **$681 M** |
| **Default** | 2.00× | $483 M | $426 M (88.2%) | $524 M | **$951 M** |
| High | 3.00× | $725 M | $668 M (92.2%) | $821 M | **$1.49 bn** |

At the default 2.00× case, OSR's $57 M external requirement is 88.2% below the illustrative foreign-company requirement of $483 M; the associated lifetime external-interest saving is $524 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$29 M / yr** | $96 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$144 M cumulative** | $480 |
| Lifecycle envelope (yr 1–40, high scenario) | **$144 M cumulative** | $480 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$899 M cumulative** | $2,998 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $57 M | 4.5% | 40 y, 5 y grace | $3.3 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $169 M | 10.5% | 40 y, 5 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $42 M | — | — | — |
| **Total** | **100%** | **$268 M** | | | **$22 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.6 M / yr + local bonds $18 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($8.5 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 7.6 M |
| Annual paid trips / city resident | 163 | 261 | 25 |
| Farebox revenue | $34 M / yr | $54 M / yr | $5.3 M / yr |
| Station shop leases | $590 k / yr | $590 k / yr | $590 k / yr |
| Advertising boards | $928 k / yr | $928 k / yr | $928 k / yr |
| **Total revenue** | **$35 M / yr** | **$56 M / yr** | **$6.8 M / yr** |
| Revenue / OPEX recovery | 523% | 823% | 100% |
...
| Operating surplus after OPEX (before debt support) | $29 M / yr | $49 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $212 M | 79% of $268 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $339 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $68 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 16,957 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$268 M** |
| Imported / external-capital requirement | $57 M (21.2%) |
| Local-content / local-funding requirement | $212 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $483 M; OSR saves $426 M (88.2%) |
| Lifetime external interest and combined financing saving | $524 M interest; $951 M capital + interest |
| 15%–25% planning risk envelope | $309 M–$335 M |
| Annual OPEX | $6.8 M / yr |
| Low/high project NPV at 8% | $13 M / $174 M |
| Low/high project IRR | 8.5% / 13.7% |
| Low/high steady-state DSCR | 1.33 / 2.27 |
