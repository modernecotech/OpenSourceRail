...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **22,560 – 33,840 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (31.0 km @ $0.85 M/km) | $26 M |
...
|---|---|---|---|
| `tram-2car` (revenue + spare + cold reserve) | 47 | $534 k | $25 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 33.0 km × $0.015 M/km | $495 k |
...
|---|---|---|
| Construction (years 1–5) | **$8.3 M / yr** | $28 |
| Steady-state, low-ridership (year 6+) | **$4.0 M / yr** | $13 |
| Steady-state, high-ridership (year 6+) | **$22 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$122 M cumulative** | $406 |
| Lifecycle envelope (yr 1–25, high scenario) | **$42 M cumulative** | $140 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$42 M cumulative** | $139 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $60 M | 4.5% | 25 y, 5 y grace | $4.6 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $25 M | 10.5% | 25 y, 5 y grace | $3.0 M / yr |
| Government equity (no debt service) | 15% | $15 M | — | — | — |
| **Total** | **100%** | **$100 M** | | | **$7.6 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $2.7 M / yr + bonds $2.6 M / yr = **$5.3 M / yr** total — plus the equity tranche amortised across construction ($3.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 45,116 |
| Daily paid trips / population | 8% | 15% | 15% |
| Annual paid trips | 8.8 M | 16.4 M | 16.5 M |
| Farebox revenue | $4.6 M / yr | $8.5 M / yr | $8.6 M / yr |
| Station shop leases | $879 k / yr | $879 k / yr | $879 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$6.8 M / yr** | **$11 M / yr** | **$11 M / yr** |
| Revenue / OPEX + debt-service recovery | 63% | 100% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $4.0 M / yr | $22 k / yr | **$0 / yr** |
