...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$684 M (86.7%) of external capital** and **$841 M of external interest**. Capital plus saved interest totals **$1.53 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (48.8 km @ $2.58 M/km) | $126 M |
...
|---|---:|---:|---:|---:|
| Civil works | $169 M | 15% | $25 M | $144 M |
...
| **Total city CAPEX** | **$438 M** | **23.9%** | **$105 M** | **$334 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.9%** | **$105 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.1%** | **$334 M** | **$67 M / yr** |
| of which planned local bond issuance | 60.9% of total CAPEX | $267 M | $53 M / yr |
| **Total city programme** | **100.0%** | **$438 M** | **$88 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $592 M | $487 M (82.3%) | $599 M | **$1.09 bn** |
| **Default** | 2.00× | $789 M | $684 M (86.7%) | $841 M | **$1.53 bn** |
| High | 3.00× | $1.18 bn | $1.08 bn (91.2%) | $1.33 bn | **$2.40 bn** |

At the default 2.00× case, OSR's $105 M external requirement is 86.7% below the illustrative foreign-company requirement of $789 M; the associated lifetime external-interest saving is $841 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$46 M / yr** | $77 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$230 M cumulative** | $384 |
| Lifecycle envelope (yr 1–40, high scenario) | **$230 M cumulative** | $384 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.45 bn cumulative** | $2,419 |
...
| Local-currency sovereign / project bonds for local content | 61% | $267 M | 10.5% | 40 y, 5 y grace | $29 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$438 M** | | | **$35 M / yr** |
...
| Annual paid trips / city resident | 122 | 196 | 23 |
...
| Revenue / OPEX recovery | 454% | 717% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $334 M | 76% of $438 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,726 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $105 M (23.9%) |
| Local-content / local-funding requirement | $334 M (76.1%) |
| Default foreign-turnkey external-capital comparison | $789 M; OSR saves $684 M (86.7%) |
| Lifetime external interest and combined financing saving | $841 M interest; $1.53 bn capital + interest |
| 15%–25% planning risk envelope | $504 M–$548 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-23419 k / $219 M |
| Low/high project IRR | 7.4% / 12.5% |
| Low/high steady-state DSCR | 1.18 / 2.05 |
