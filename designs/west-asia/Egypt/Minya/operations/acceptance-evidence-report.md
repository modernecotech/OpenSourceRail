...
| Manufacturing schedule rows | 1,237 |
| Manufacturing material/BOM rows | 18,192 |
| Manufacturing QA verification rows | 1,237 |
| Construction QA action rows | 1,141 |
| Maintenance handover schedule rows | 1,479 |
| Manufacturing rows with material refs | 1,237 / 1,237 |
| Manufacturing rows with verification refs | 1,237 / 1,237 |
| Manufacturing rows linked to QA actions | 1,237 / 1,237 |
