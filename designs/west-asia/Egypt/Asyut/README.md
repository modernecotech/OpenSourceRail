...
| Bucket | Value |
|---|---|
| At-grade (60.1 km @ $2.0 M/km) | $120 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 62.8 km × $0.015 M/km | $3.1 M |
...
| Steady-state, high-ridership (year 6+) | **$22 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $37 |
| Lifecycle envelope (yr 1–25, low scenario) | **$562 M cumulative** | $937 |
| Lifecycle envelope (yr 1–25, high scenario) | **$562 M cumulative** | $937 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$562 M cumulative** | $937 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $72 M | 10.5% | 25 y, 5 y grace | $8.8 M / yr |
| Government equity (no debt service) | 15% | $43 M | — | — | — |
| **Total** | **100%** | **$289 M** | | | **$22 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $7.8 M / yr + bonds $7.6 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($8.7 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
