...
| Bucket | Value |
|---|---|
| At-grade (60.1 km @ $1.2 M/km) | $72 M |
...
|---|---|---|
| Construction (years 1–5) | **$16 M / yr** | $26 |
| Steady-state, low-ridership (year 6+) | **$9.2 M / yr** | $15 |
| Steady-state, high-ridership (year 6+) | **$1.3 M / yr** | $2 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$264 M cumulative** | $440 |
| Lifecycle envelope (yr 1–25, high scenario) | **$104 M cumulative** | $174 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$79 M cumulative** | $132 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $114 M | 4.5% | 25 y, 5 y grace | $8.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $47 M | 10.5% | 25 y, 5 y grace | $5.8 M / yr |
| Government equity (no debt service) | 15% | $28 M | — | — | — |
| **Total** | **100%** | **$190 M** | | | **$15 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $5.1 M / yr + bonds $5.0 M / yr = **$10 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 96,685 |
| Daily paid trips / population | 8% | 15% | 16% |
| Annual paid trips | 17.5 M | 32.9 M | 35.3 M |
| Farebox revenue | $9.1 M / yr | $17 M / yr | $18 M / yr |
...
| Revenue / OPEX + debt-service recovery | 55% | 94% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $9.2 M / yr | $1.3 M / yr | **$0 / yr** |
