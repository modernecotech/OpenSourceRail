...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$740 M (86.1%) of external capital** and **$910 M of external interest**. Capital plus saved interest totals **$1.65 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (49.2 km @ $2.58 M/km) | $127 M |
...
| Per-capita (city pop) | $796 / person |
...
| **Total city CAPEX** | **$477 M** | **25.0%** | **$119 M** | **$358 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.0%** | **$119 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.0%** | **$358 M** | **$72 M / yr** |
| of which planned local bond issuance | 60.0% of total CAPEX | $287 M | $57 M / yr |
| **Total city programme** | **100.0%** | **$477 M** | **$95 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $645 M | $525 M (81.5%) | $646 M | **$1.17 bn** |
| **Default** | 2.00× | $859 M | $740 M (86.1%) | $910 M | **$1.65 bn** |
| High | 3.00× | $1.29 bn | $1.17 bn (90.7%) | $1.44 bn | **$2.61 bn** |

At the default 2.00× case, OSR's $119 M external requirement is 86.1% below the illustrative foreign-company requirement of $859 M; the associated lifetime external-interest saving is $910 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Lifecycle envelope (yr 1–40, low scenario) | **$249 M cumulative** | $415 |
| Lifecycle envelope (yr 1–40, high scenario) | **$249 M cumulative** | $415 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.57 bn cumulative** | $2,623 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $119 M | 4.5% | 40 y, 5 y grace | $6.8 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $287 M | 10.5% | 40 y, 5 y grace | $31 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $72 M | — | — | — |
| **Total** | **100%** | **$477 M** | | | **$38 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 16.7 M |
...
| Revenue / OPEX recovery | 394% | 623% | 100% |
...
| Operating surplus after OPEX (before debt support) | $39 M / yr | $70 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $358 M | 75% of $477 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $573 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $115 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 28,700 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $438 M |
| Timetable-sized dedicated solar CAPEX | $39 M |
| **Reconciled project CAPEX** | **$477 M** |
| Imported / external-capital requirement | $119 M (25.0%) |
| Local-content / local-funding requirement | $358 M (75.0%) |
| Default foreign-turnkey external-capital comparison | $859 M; OSR saves $740 M (86.1%) |
| Lifetime external interest and combined financing saving | $910 M interest; $1.65 bn capital + interest |
| 15%–25% planning risk envelope | $549 M–$597 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-70048 k / $172 M |
| Low/high project IRR | 6.4% / 11.4% |
| Low/high steady-state DSCR | 1.04 / 1.84 |
