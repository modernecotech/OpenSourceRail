...
**Country:** EG · **Population:** 550,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$617 M (86.9%) of external capital** and **$758 M of external interest**. Capital plus saved interest totals **$1.38 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`sohag.corridor.geojson`](sohag.corridor.geojson).
...
| Total fleet capacity | 35,280 AW2 pax (47,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 88 × 360 = **31,680 AW2 passengers** (42,240 AW3 crush)
- **Total fleet passenger capacity:** 98 × 360 = **35,280 AW2 passengers** (47,040 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 76.9%
- Catchment population: **≈ 422,950** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **41.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 435 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 20,649 train-km/day | One-way train journeys × route length |
| Annual service work | 8.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 268 MWh/day | 24.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 214 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 41.1 MW / 246 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 73 kWh | 114 kWh | 34 kWh | 3.4 km / 27 kWh |
| line-2 | 5 | 135 kWh | 204 kWh | 56 kWh | 8.1 km / 65 kWh |
| line-3 | 5 | 151 kWh | 225 kWh | 59 kWh | 13.0 km / 105 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (40.0 km @ $2.58 M/km) | $103 M |
| Elevated (4.4 km @ $9.75 M/km) | $43 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$151 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 98 | $900 k | $88 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 294 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 294 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 41,058 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 41,058 kW @ $100/kW | $4.1 M |
| Annual generation proxy | 41.1 MW × 6.0 peak-sun-h/day × 365 d/yr | 89.9 GWh/yr |
...
| Per-capita (city pop) | $717 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $151 M | 15% | $23 M | $128 M |
| Stations | $87 M | 20% | $17 M | $70 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $88 M | 35% | $31 M | $57 M |
| Dedicated solar plant | $33 M | 45% | $15 M | $18 M |
| Residual signalling / train control | $2.2 M | 50% | $1.1 M | $1.1 M |
| Charging microgrids | $1.6 M | 40% | $660 k | $990 k |
| EPC / project services | $24 M | 15% | $3.5 M | $20 M |
| **Total city CAPEX** | **$394 M** | **23.6%** | **$93 M** | **$301 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sohag`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.6%** | **$93 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.4%** | **$301 M** | **$60 M / yr** |
| of which planned local bond issuance | 61.1% of total CAPEX | $241 M | $48 M / yr |
| **Total city programme** | **100.0%** | **$394 M** | **$79 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $532 M | $439 M (82.5%) | $540 M | **$980 M** |
| **Default** | 2.00× | $710 M | $617 M (86.9%) | $758 M | **$1.38 bn** |
| High | 3.00× | $1.06 bn | $972 M (91.3%) | $1.19 bn | **$2.17 bn** |

At the default 2.00× case, OSR's $93 M external requirement is 86.9% below the illustrative foreign-company requirement of $710 M; the associated lifetime external-interest saving is $758 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$42 M / yr** | $76 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $57 |
| Lifecycle envelope (yr 1–40, low scenario) | **$208 M cumulative** | $378 |
| Lifecycle envelope (yr 1–40, high scenario) | **$208 M cumulative** | $378 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.31 bn cumulative** | $2,378 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $31 M / yr → $31 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $93 M | 4.5% | 40 y, 5 y grace | $5.3 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $241 M | 10.5% | 40 y, 5 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $60 M | — | — | — |
| **Total** | **100%** | **$394 M** | | | **$31 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.2 M / yr + local bonds $25 M / yr = **$30 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($12 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (97.7 GWh / yr) | 20,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.5 GWh/yr + dedicated solar plant 41.1 MW / 89.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $493 k |
| Labour (301 FTE) | driverless roster: OCC/remote 65, station/platform 70, passenger service 49, fleet maintenance 57, infrastructure/energy 39, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 20,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.1 M train-km / yr (24.4 M car-km / yr). On-site PV covers 19.5 GWh/yr and the dedicated solar plant adds 89.9 GWh/yr against 97.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 98 trainsets, 17 stations, 44.4 route-km, 3 lines, and 20,649 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 133 | 213 | 23 |
| Farebox revenue | $51 M / yr | $81 M / yr | $8.7 M / yr |
| Station shop leases | $643 k / yr | $643 k / yr | $643 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 507% | 801% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $31 M / yr | $31 M / yr | **$31 M / yr** |
| Operating surplus applied to debt support | -$31 M / yr | -$31 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$31 M / yr** |
| Operating surplus after OPEX (before debt support) | $42 M / yr | $73 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,928 m² of station shop/kiosk leases at $21/m²/month and 560 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $12 M / yr | $19 M / yr | 146 M - 234 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.1 M / yr | $3.4 M / yr | 26.4–42.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.9 M / yr | $9.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$70 M / yr** | **$113 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 12,856 trips/school day; 2.8 M access-events/yr | 20,570 trips/school day; 4.5 M access-events/yr |
| Healthcare | 0 healthcare anchors | 12,053 trips/day; 4.4 M access-events/yr | 19,284 trips/day; 7.0 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 44,548 trips/trading day; 14.7 M access-events/yr | 71,277 trips/trading day; 23.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $301 M | 76% of $394 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $482 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $96 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 24,148 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $362 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$394 M** |
| Imported / external-capital requirement | $93 M (23.6%) |
| Local-content / local-funding requirement | $301 M (76.4%) |
| Default foreign-turnkey external-capital comparison | $710 M; OSR saves $617 M (86.9%) |
| Lifetime external interest and combined financing saving | $758 M interest; $1.38 bn capital + interest |
| 15%–25% planning risk envelope | $454 M–$493 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $19 M / $261 M |
| Low/high project IRR | 8.5% / 13.8% |
| Low/high steady-state DSCR | 1.34 / 2.31 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,768.04 train-km; 14,258.81 kWh consumed; 11,351.98 kWh charged; 33 depot services completed; minimum SoC 66%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,581.99 train-km; 157,919.50 kWh consumed; 143,415.06 kWh charged; 478 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.8% of scheduled train-km delivered; 111 SoC warnings; 20 energy-adapted off-peak departures, maximum 26 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 93.5% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.6% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 77.6% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.5% / 90% | pass |
...
|---|---|
| ![Sohag energy and battery simulation dashboard](engineering/screenshots/sohag-simulation-dashboard.png) | ![Sohag simulator network visualizer](engineering/screenshots/sohag-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![Sohag QGIS engineering layers](engineering/screenshots/sohag-qgis-engineering-map.png) | ![Sohag SUMO timetable validation](engineering/screenshots/sohag-sumo-validation.png) |
...
| [`sohag.toml`](sohag.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`sohag-network-map.png`](sohag-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`sohag.corridor.geojson`](sohag.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`sohag.stations.json`](sohag.stations.json) | Machine-readable station list |
| [`sohag.design-quality.yaml`](sohag.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
