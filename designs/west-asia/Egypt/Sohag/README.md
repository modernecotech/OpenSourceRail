...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 294 | $60 k | $18 M |
| High sensitivity check | 294 | $120 k | $35 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sohag`.
...
|---|---|---|
| Construction (years 1–5) | **$34 M / yr** | $61 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$168 M cumulative** | $305 |
| Lifecycle envelope (yr 1–40, high scenario) | **$168 M cumulative** | $305 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$876 M cumulative** | $1,593 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $353 M | 4.5% | 40 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $88 M | — | — | — |
| **Total** | **100%** | **$442 M** | | | **$20 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $251 M | 57% of $442 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 20,103 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $508 M–$552 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-22446 k / $219 M |
| Low/high project IRR | 7.5% / 12.5% |
| Low/high steady-state DSCR | 2.06 / 3.57 |
