...
|---|---|---|---|---|
| line-1 |  9.0 km | 6 | 26 | NE Mid ↔ NW Mid |
| line-2 | 16.7 km | 10 | 43 | N Inner ↔ SW Outer |
| line-3 | 18.7 km | 8 | 50 | N Inner ↔ SE Outer |
| **Total** | **44.4 km** | **24 unique** | **119** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **39.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 451 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 48 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 203 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 39.0 MW / 234 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 73 kWh | 131 kWh | 51 kWh | 2.4 km / 19 kWh |
| line-2 | 8 | 135 kWh | 196 kWh | 48 kWh | 7.5 km / 61 kWh |
| line-3 | 6 | 151 kWh | 220 kWh | 55 kWh | 11.0 km / 89 kWh |
...
| Elevated (5.6 km @ $12.0 M/km) | $67 M |
| Elevated-interchange premium (2 sites @ $4.50 M) | $9.0 M |
| **Civil subtotal** | **$192 M** |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 357 | $60 k | $21 M |
| High sensitivity check | 357 | $120 k | $43 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,988 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,988 kW @ $100/kW | $3.9 M |
| Annual generation proxy | 39.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 85.4 GWh/yr |
...
| Per-capita (city pop) | $928 / person |
...
|---|---|---|
| Construction (years 1–5) | **$39 M / yr** | $71 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$194 M cumulative** | $353 |
| Lifecycle envelope (yr 1–40, high scenario) | **$194 M cumulative** | $353 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,841 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $408 M | 4.5% | 40 y, 5 y grace | $23 M / yr |
| Government equity (no debt service) | 20% | $102 M | — | — | — |
| **Total** | **100%** | **$510 M** | | | **$23 M / yr** |
...
| Traction energy (97.7 GWh / yr) | 20,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.4 GWh/yr + dedicated solar plant 39.0 MW / 85.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $468 k |
| Labour (344 FTE) | driverless roster: OCC/remote 77, station/platform 92, passenger service 49, fleet maintenance 63, infrastructure/energy 42, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 20,649 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.1 M train-km / yr (24.4 M car-km / yr). On-site PV covers 23.4 GWh/yr and the dedicated solar plant adds 85.4 GWh/yr against 97.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 119 trainsets, 24 stations, 44.4 route-km, 3 lines, and 20,649 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 133 | 213 | 27 |
| Farebox revenue | $51 M / yr | $81 M / yr | $10 M / yr |
| Station shop leases | $836 k / yr | $836 k / yr | $836 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 419% | 660% | 100% |
...
_Commercial-revenue assumptions: 3,808 m² of station shop/kiosk leases at $21/m²/month and 728 advertising boards at $182/board/month, with occupancy derates applied._
...
| Healthcare | 3 healthcare anchors | 16,271 trips/day; 5.9 M access-events/yr | 26,034 trips/day; 9.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $291 M | 57% of $510 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $465 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $93 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 23,302 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-87370 k / $155 M |
| Low/high project IRR | 6.1% / 10.9% |
| Low/high steady-state DSCR | 1.73 / 3.03 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,758.77 train-km; 14,184.04 kWh consumed; 13,082.95 kWh charged; 31 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,782.28 train-km; 167,600.94 kWh consumed; 164,117.71 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 23 SoC warnings; 4 energy-adapted off-peak departures, maximum 13 min headway |
