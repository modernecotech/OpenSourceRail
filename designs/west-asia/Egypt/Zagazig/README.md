...
| Bucket | Value |
|---|---|
| At-grade (54.9 km @ $0.85 M/km) | $47 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.2 km × $0.015 M/km | $844 k |
...
| Per-capita (city pop) | $205 / person |
...
| Steady-state, low-ridership (year 6+) | **$2.7 M / yr** | $4 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$113 M cumulative** | $161 |
| Lifecycle envelope (yr 1–25, high scenario) | **$60 M cumulative** | $85 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$60 M cumulative** | $85 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $86 M | 4.5% | 25 y, 5 y grace | $6.6 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $36 M | 10.5% | 25 y, 5 y grace | $4.4 M / yr |
| Government equity (no debt service) | 15% | $22 M | — | — | — |
| **Total** | **100%** | **$143 M** | | | **$11 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $3.9 M / yr + bonds $3.8 M / yr = **$7.6 M / yr** total — plus the equity tranche amortised across construction ($4.3 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,000 | 105,000 | 69,980 |
| Daily paid trips / population | 8% | 15% | 10% |
| Annual paid trips | 20.4 M | 38.3 M | 25.5 M |
| Farebox revenue | $11 M / yr | $20 M / yr | $13 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| **Total revenue** | **$13 M / yr** | **$23 M / yr** | **$16 M / yr** |
| Revenue / OPEX + debt-service recovery | 83% | 142% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $2.7 M / yr | $0 k / yr | **$0 / yr** |
