...
|---|---|---|---|---|
| line-1 | 17.0 km | 10 | 46 | N Outer ↔ S Mid |
| line-2 | 10.4 km | 7 | 29 | W Inner ↔ SE Outer |
| line-3 | 15.5 km | 9 | 41 | W Outer ↔ E Mid |
| **Total** | **42.9 km** | **26 unique** | **116** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **35.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 496 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 187 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 35.9 MW / 215 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 137 kWh | 229 kWh | 78 kWh | 5.5 km / 44 kWh |
| line-2 | 7 | 84 kWh | 151 kWh | 59 kWh | 2.4 km / 19 kWh |
| line-3 | 8 | 125 kWh | 196 kWh | 59 kWh | 5.0 km / 41 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 348 | $60 k | $21 M |
| High sensitivity check | 348 | $120 k | $42 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 35,855 kW @ $700/kW | $25 M |
| Grid interconnection / PPA tie-in | 35,855 kW @ $100/kW | $3.6 M |
| Annual generation proxy | 35.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 78.5 GWh/yr |
...
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$932 M cumulative** | $1,332 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $376 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $94 M | — | — | — |
| **Total** | **100%** | **$470 M** | | | **$22 M / yr** |
...
| Traction energy (94.3 GWh / yr) | 19,944 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 35.9 MW / 78.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $430 k |
| Labour (350 FTE) | driverless roster: OCC/remote 73, station/platform 104, passenger service 49, fleet maintenance 62, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 19,944 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.9 M train-km / yr (23.6 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 78.5 GWh/yr against 94.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 116 trainsets, 26 stations, 42.9 route-km, 3 lines, and 19,944 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 13.5 M |
| Annual paid trips / city resident | 105 | 168 | 19 |
| Farebox revenue | $51 M / yr | $81 M / yr | $9.3 M / yr |
| Station shop leases | $981 k / yr | $981 k / yr | $981 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$53 M / yr** | **$84 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 449% | 706% | 100% |
...
_Commercial-revenue assumptions: 4,464 m² of station shop/kiosk leases at $21/m²/month and 844 advertising boards at $182/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $265 M | 56% of $470 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 21,263 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $540 M–$587 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-46104 k / $196 M |
| Low/high project IRR | 7.0% / 11.9% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,725.55 train-km; 13,915.98 kWh consumed; 14,240.21 kWh charged; 31 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,646.10 train-km; 166,503.54 kWh consumed; 169,756.52 kWh charged; 493 depot services completed (6 active at cutoff); minimum SoC 23%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 7 SoC warnings |
...
| 50% charging-contact availability | 23.3% | 100.0% / 90% | pass |
