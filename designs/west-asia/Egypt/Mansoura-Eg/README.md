...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$657 M (86.6%) of external capital** and **$807 M of external interest**. Capital plus saved interest totals **$1.46 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (49.6 km @ $2.58 M/km) | $128 M |
| Elevated (2.0 km @ $9.75 M/km) | $20 M |
...
| **Total city CAPEX** | **$421 M** | **24.0%** | **$101 M** | **$320 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$101 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$320 M** | **$64 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $256 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$421 M** | **$84 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $568 M | $467 M (82.2%) | $574 M | **$1.04 bn** |
| **Default** | 2.00× | $758 M | $657 M (86.6%) | $807 M | **$1.46 bn** |
| High | 3.00× | $1.14 bn | $1.04 bn (91.1%) | $1.27 bn | **$2.31 bn** |

At the default 2.00× case, OSR's $101 M external requirement is 86.6% below the illustrative foreign-company requirement of $758 M; the associated lifetime external-interest saving is $807 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$44 M / yr** | $44 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$221 M cumulative** | $221 |
| Lifecycle envelope (yr 1–40, high scenario) | **$221 M cumulative** | $221 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.39 bn cumulative** | $1,394 |
...
| Local-currency sovereign / project bonds for local content | 61% | $256 M | 10.5% | 40 y, 5 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$421 M** | | | **$34 M / yr** |
...
| Annual paid trips / city resident | 73 | 117 | 13 |
...
| Revenue / OPEX recovery | 472% | 745% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $320 M | 76% of $421 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $512 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $102 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 25,629 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $383 M |
| Timetable-sized dedicated solar CAPEX | $38 M |
| **Reconciled project CAPEX** | **$421 M** |
| Imported / external-capital requirement | $101 M (24.0%) |
| Local-content / local-funding requirement | $320 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $758 M; OSR saves $657 M (86.6%) |
| Lifetime external interest and combined financing saving | $807 M interest; $1.46 bn capital + interest |
| 15%–25% planning risk envelope | $484 M–$526 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-6203 k / $236 M |
| Low/high project IRR | 7.8% / 13.0% |
| Low/high steady-state DSCR | 1.24 / 2.15 |
