...
**Country:** EG · **Population:** 1,000,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$701 M (86.9%) of external capital** and **$862 M of external interest**. Capital plus saved interest totals **$1.56 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`mansoura-eg.corridor.geojson`](mansoura-eg.corridor.geojson).
...
| Total fleet capacity | 39,240 AW2 pax (52,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 98 × 360 = **35,280 AW2 passengers** (47,040 AW3 crush)
- **Total fleet passenger capacity:** 109 × 360 = **39,240 AW2 passengers** (52,320 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 70.8%
- Catchment population: **≈ 708,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **48.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled train journey-km | 24,012 train-km/day | One-way train journeys × route length |
| Annual service work | 9.5 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 311 MWh/day | 28.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 251 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 48.0 MW / 288 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 106 kWh | 163 kWh | 47 kWh | 3.7 km / 30 kWh |
| line-2 | 6 | 106 kWh | 147 kWh | 30 kWh | 5.5 km / 45 kWh |
| line-3 | 7 | 204 kWh | 286 kWh | 62 kWh | 12.0 km / 97 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (49.6 km @ $3.0 M/km) | $149 M |
| Elevated (2.0 km @ $12.0 M/km) | $24 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$178 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 109 | $900 k | $98 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 327 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 327 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 48,032 kW @ $700/kW | $34 M |
| Grid interconnection / PPA tie-in | 48,032 kW @ $100/kW | $4.8 M |
| Annual generation proxy | 48.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 105.2 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $4.6 M |
| EPC overhead (7%) | $27 M |
| **CAPEX total** | **$448 M** |
| Per-route-km | $8.7 M / km |
| Per-capita (city pop) | $448 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $178 M | 15% | $27 M | $151 M |
| Stations | $95 M | 20% | $19 M | $76 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $98 M | 35% | $34 M | $64 M |
| Dedicated solar plant | $38 M | 45% | $17 M | $21 M |
...
| **Total city CAPEX** | **$448 M** | **23.5%** | **$105 M** | **$343 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mansoura-eg`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.5%** | **$105 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.5%** | **$343 M** | **$69 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $274 M | $55 M / yr |
| **Total city programme** | **100.0%** | **$448 M** | **$90 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $605 M | $500 M (82.6%) | $614 M | **$1.11 bn** |
| **Default** | 2.00× | $806 M | $701 M (86.9%) | $862 M | **$1.56 bn** |
| High | 3.00× | $1.21 bn | $1.10 bn (91.3%) | $1.36 bn | **$2.46 bn** |

At the default 2.00× case, OSR's $105 M external requirement is 86.9% below the illustrative foreign-company requirement of $806 M; the associated lifetime external-interest saving is $862 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$47 M / yr** | $47 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$236 M cumulative** | $236 |
| Lifecycle envelope (yr 1–40, high scenario) | **$236 M cumulative** | $236 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.49 bn cumulative** | $1,486 |
...
| Traction energy (113.6 GWh / yr) | 24,012 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.1 GWh/yr + dedicated solar plant 48.0 MW / 105.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $576 k |
| Labour (331 FTE) | driverless roster: OCC/remote 73, station/platform 78, passenger service 49, fleet maintenance 65, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 24,012 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.5 M train-km / yr (28.4 M car-km / yr). On-site PV covers 22.1 GWh/yr and the dedicated solar plant adds 105.2 GWh/yr against 113.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 109 trainsets, 19 stations, 51.6 route-km, 3 lines, and 24,012 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 14.0 M |
| Annual paid trips / city resident | 73 | 117 | 14 |
| Farebox revenue | $51 M / yr | $81 M / yr | $9.7 M / yr |
| Station shop leases | $747 k / yr | $747 k / yr | $747 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$53 M / yr** | **$83 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 452% | 713% | 100% |
...
_Commercial-revenue assumptions: 3,400 m² of station shop/kiosk leases at $21/m²/month and 648 advertising boards at $182/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $22 M / yr | 170 M - 272 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.5 M / yr | $3.9 M / yr | 30.6–49.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| **Annual quantified benefit / activity proxy** | **$75 M / yr** | **$120 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 13 major/terminal/interchange nodes | 46,572 trips/trading day; 15.4 M access-events/yr | 74,516 trips/trading day; 24.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $343 M | 76% of $448 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $548 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $110 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 27,463 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $410 M |
| Timetable-sized dedicated solar CAPEX | $38 M |
| **Reconciled project CAPEX** | **$448 M** |
| Imported / external-capital requirement | $105 M (23.5%) |
| Local-content / local-funding requirement | $343 M (76.5%) |
| Default foreign-turnkey external-capital comparison | $806 M; OSR saves $701 M (86.9%) |
| Lifetime external interest and combined financing saving | $862 M interest; $1.56 bn capital + interest |
| 15%–25% planning risk envelope | $515 M–$560 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-31702 k / $210 M |
| Low/high project IRR | 7.3% / 12.3% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,964.71 train-km; 15,845.03 kWh consumed; 13,713.77 kWh charged; 32 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,757.95 train-km; 183,534.76 kWh consumed; 174,302.20 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.8% of scheduled train-km delivered; 108 SoC warnings; 13 energy-adapted off-peak departures, maximum 12 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 91.5% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 77.0% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 93.7% / 90% | pass |
...
|---|---|
| ![Mansoura-Eg energy and battery simulation dashboard](engineering/screenshots/mansoura-eg-simulation-dashboard.png) | ![Mansoura-Eg simulator network visualizer](engineering/screenshots/mansoura-eg-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 19 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
...
|---|---|
| ![Mansoura-Eg QGIS engineering layers](engineering/screenshots/mansoura-eg-qgis-engineering-map.png) | ![Mansoura-Eg SUMO timetable validation](engineering/screenshots/mansoura-eg-sumo-validation.png) |
...
| [`mansoura-eg.toml`](mansoura-eg.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`mansoura-eg-network-map.png`](mansoura-eg-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`mansoura-eg.corridor.geojson`](mansoura-eg.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`mansoura-eg.stations.json`](mansoura-eg.stations.json) | Machine-readable station list |
| [`mansoura-eg.design-quality.yaml`](mansoura-eg.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug mansoura-eg

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh mansoura-eg
```
