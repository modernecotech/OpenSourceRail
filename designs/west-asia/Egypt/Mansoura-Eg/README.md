...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 327 | $60 k | $20 M |
| High sensitivity check | 327 | $120 k | $39 M |
...
| Per-capita (city pop) | $469 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mansoura-eg`.
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $36 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$178 M cumulative** | $178 |
| Lifecycle envelope (yr 1–40, high scenario) | **$178 M cumulative** | $178 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$930 M cumulative** | $930 |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $264 M | 56% of $469 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $423 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $85 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 21,173 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$469 M** |
| 15%–25% planning risk envelope | $539 M–$586 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-48466 k / $193 M |
| Low/high project IRR | 6.9% / 11.8% |
| Low/high steady-state DSCR | 1.91 / 3.33 |
