...
|---|---|---|---|---|
| line-1 | 13.2 km | 9 | 32 | SE Mid ↔ N Mid |
| line-2 | 13.2 km | 9 | 32 | NE Mid ↔ W Mid |
| line-3 | 25.3 km | 13 | 67 | NE Mid ↔ SW Outer |
| **Total** | **51.6 km** | **31 unique** | **131** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **44.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 459 kWh usable margin across the worst powered-stop gap (line-3) |
...
| On-site PV shortfall before solar plant | 234 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 44.9 MW / 270 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 106 kWh | 163 kWh | 47 kWh | 2.0 km / 16 kWh |
| line-2 | 9 | 106 kWh | 163 kWh | 46 kWh | 2.2 km / 18 kWh |
| line-3 | 9 | 204 kWh | 294 kWh | 70 kWh | 10.0 km / 81 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 44,927 kW @ $700/kW | $31 M |
| Grid interconnection / PPA tie-in | 44,927 kW @ $100/kW | $4.5 M |
| Annual generation proxy | 44.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 98.4 GWh/yr |
...
| Per-capita (city pop) | $539 / person |
...
|---|---|---|
| Construction (years 1–5) | **$41 M / yr** | $41 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$205 M cumulative** | $205 |
| Lifecycle envelope (yr 1–40, high scenario) | **$205 M cumulative** | $205 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.07 bn cumulative** | $1,070 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $431 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $108 M | — | — | — |
| **Total** | **100%** | **$539 M** | | | **$25 M / yr** |
...
| Traction energy (113.6 GWh / yr) | 24,012 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.0 GWh/yr + dedicated solar plant 44.9 MW / 98.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $539 k |
| Labour (383 FTE) | driverless roster: OCC/remote 81, station/platform 112, passenger service 49, fleet maintenance 71, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 24,012 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.5 M train-km / yr (28.4 M car-km / yr). On-site PV covers 28.0 GWh/yr and the dedicated solar plant adds 98.4 GWh/yr against 113.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 131 trainsets, 31 stations, 51.6 route-km, 3 lines, and 24,012 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 73 | 117 | 16 |
...
| **Total revenue** | **$54 M / yr** | **$84 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 396% | 621% | 100% |
...
_Commercial-revenue assumptions: 4,696 m² of station shop/kiosk leases at $21/m²/month and 900 advertising boards at $182/board/month, with occupancy derates applied._
...
| Commerce | 15 major/terminal/interchange nodes | 42,347 trips/trading day; 14.0 M access-events/yr | 67,755 trips/trading day; 22.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $304 M | 56% of $539 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 24,391 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $503 M |
| Timetable-sized dedicated solar CAPEX | $36 M |
| **Reconciled project CAPEX** | **$539 M** |
| 15%–25% planning risk envelope | $620 M–$674 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-113282 k / $129 M |
| Low/high project IRR | 5.7% / 10.3% |
| Low/high steady-state DSCR | 1.62 / 2.85 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,989.46 train-km; 16,044.37 kWh consumed; 15,354.54 kWh charged; 28 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 24,433.39 train-km; 197,045.07 kWh consumed; 191,838.97 kWh charged; 484 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 133 SoC warnings; 6 energy-adapted off-peak departures, maximum 15 min headway |
...
| ten-hour all-site grid outage | 20.0% | 91.7% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
