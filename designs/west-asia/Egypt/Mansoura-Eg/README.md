...
|---|---|---|---|---|
| line-1 | 17.6 km | 11 | 29 | N Mid ↔ S Mid |
| line-2 | 16.9 km | 11 | 28 | E Mid ↔ W Mid |
| line-3 | 21.5 km | 12 | 35 | SW Outer ↔ NE Inner |
| **Total** | **56.1 km** | **34 unique** | **92** | |
...
- Anchor-weighted coverage: 54.3%
- Catchment population: **≈ 543,000** (within ~800 m walk of a station)
...
| Scheduled traction demand | 367 MWh/day | 28,319 scheduled train-km/day × 108% depot/deadhead factor |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 64,402 kW @ $700/kW | $45 M |
| Grid interconnection / PPA tie-in | 64,402 kW @ $100/kW | $6.4 M |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $52 |
| Steady-state, low capacity-use (year 6+) | **$8.6 M / yr** | $9 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $30 |
| Lifecycle envelope (yr 1–40, low scenario) | **$559 M cumulative** | $559 |
| Lifecycle envelope (yr 1–40, high scenario) | **$260 M cumulative** | $260 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.30 bn cumulative** | $1,300 |

_Population basis: 1,000,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $30 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $743 M | 2.0% | 40 y, 5 y grace | $30 M / yr |
| Government equity (no debt service) | 20% | $186 M | — | — | — |
| **Total** | **100%** | **$928 M** | | | **$30 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $15 M / yr = **$15 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($37 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (134.0 GWh / yr) | 28,319 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 31.8 GWh/yr + dedicated solar plant 64.4 MW / 117.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $773 k |
| Labour (417 FTE) | driverless roster: OCC/remote 65, station/platform 134, passenger service 44, fleet maintenance 65, infrastructure/energy 73, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $1.8 M |
| **OPEX subtotal** | | **$26 M / yr** |

_Annual service work: 28,319 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.2 M train-km / yr (33.5 M car-km / yr). On-site PV covers 31.8 GWh/yr and the dedicated solar plant adds 117.5 GWh/yr against 134.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 32.6 M |
| Annual paid trips / city resident | 63 | 101 | 33 |
...
| **Total revenue** | **$47 M / yr** | **$73 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 182% | 283% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $30 M / yr | $30 M / yr | **$30 M / yr** |
| Operating surplus applied to debt support | -$21 M / yr | -$30 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $8.6 M / yr | $0 k / yr | **$30 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $47 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,936 m² of station shop/kiosk leases at $21/m²/month and 1,112 advertising boards at $182/board/month, with occupancy derates applied._
...
| Healthcare | 3 healthcare anchors | 12,930 trips/day; 4.7 M access-events/yr | 20,687 trips/day; 7.6 M access-events/yr |
| Commerce | 22 major/terminal/interchange nodes | 39,388 trips/trading day; 13.0 M access-events/yr | 63,021 trips/trading day; 20.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $492 M | 53% of $928 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 39,393 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
cargo run --release --bin osr-design -- --slug mansoura-eg \
    --sidecar .cache/osr-pipeline/rasters/mansoura-eg.grid.json \
    --out-dir designs/.../Mansoura-Eg
...
python -m osr_scenario.network_readme \
    ...
    --scenario designs/.../mansoura-eg.toml \
    --out designs/.../README.md
```

`scripts/regenerate-mansoura-eg.sh` chains steps 3 + drift tests into a single command.
