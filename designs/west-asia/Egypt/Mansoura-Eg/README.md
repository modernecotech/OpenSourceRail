...
| Bucket | Value |
|---|---|
| At-grade (53.0 km @ €3.5 M/km) | €185 M |
| Elevated (2.9 km @ €18 M/km) | €51 M |
| Elevated-interchange premium (2 sites @ €20 M) | €40 M |
| **Civil subtotal** | **€277 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.1 km × €0.015 M/km | €0.8 M |
...
| Steady-state, low-ridership (year 6+) | **€57 M / yr** | €57 |
| Steady-state, high-ridership (year 6+) | **€50 M / yr** | €50 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.40 bn cumulative** | €1,398 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.25 bn cumulative** | €1,253 |

_Population basis: 1,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€9.0 M / yr (low) → €1.7 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €376 M | 4.5% | 25 y, 5 y grace | €29 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €157 M | 10.5% | 25 y, 5 y grace | €19 M / yr |
| Government equity (no debt service) | 15% | €94 M | — | — | — |
| **Total** | **100%** | **€626 M** | | | **€48 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €17 M / yr + bonds €16 M / yr = **€33 M / yr** total — plus the equity tranche amortised across construction (€19 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Operating shortfall (gov subsidy required) | €9.0 M / yr | €1.7 M / yr |
