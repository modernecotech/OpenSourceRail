...
| Steady-state, low-ridership (year 6+) | **$58 M / yr** | $82 |
| Steady-state, high-ridership (year 6+) | **$58 M / yr** | $82 |
| Steady-state, operating-neutral revenue case | **$58 M / yr** | $82 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.45 bn cumulative** | $2,078 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.45 bn cumulative** | $2,078 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.45 bn cumulative** | $2,078 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $503 M | 4.0% | 25 y, 5 y grace | $37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $209 M | 7.5% | 25 y, 5 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $126 M | — | — | — |
| **Total** | **100%** | **$838 M** | | | **$58 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $20 M / yr + bonds $16 M / yr = **$36 M / yr** total — plus the equity tranche amortised across construction ($25 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
