...
| Bucket | Value |
|---|---|
| At-grade (62.9 km @ €3.5 M/km) | €220 M |
| Elevated (20.0 km @ €18 M/km) | €360 M |
| Elevated-interchange premium (1 sites @ €20 M) | €20 M |
| **Civil subtotal** | **€600 M** |
...
|---|---|---|
| Construction (years 1–5) | **€82 M / yr** | €117 |
| Steady-state, low-ridership (year 6+) | **€96 M / yr** | €137 |
| Steady-state, high-ridership (year 6+) | **€85 M / yr** | €121 |
| Lifecycle envelope (yr 1–25, low scenario) | **€2.33 bn cumulative** | €3,325 |
| Lifecycle envelope (yr 1–25, high scenario) | **€2.10 bn cumulative** | €3,001 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€19 M / yr (low) → €7.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €675 M | 4.0% | 25 y, 5 y grace | €50 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €281 M | 7.5% | 25 y, 5 y grace | €28 M / yr |
| Government equity (no debt service) | 15% | €169 M | — | — | — |
| **Total** | **100%** | **€1.13 bn** | | | **€77 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €27 M / yr + bonds €21 M / yr = **€48 M / yr** total — plus the equity tranche amortised across construction (€34 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (511 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €4.6 M |
...
| Farebox revenue | €11 M / yr | €23 M / yr |
| Farebox / OPEX recovery | 38% | 76% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €19 M / yr | €7.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€96 M / yr** | **€85 M / yr** |
