...
| Revenue fleet | 167 × 3-car trainsets |
| Revenue fleet passenger capacity | 60,120 AW2 pax (80,160 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 29.7 km | 17 | 74 | NE Outer ↔ SW Outer |
| line-2 | 27.9 km | 16 | 71 | SW Outer ↔ NE Outer |
| line-3 | 15.0 km | 10 | 40 | NW Mid ↔ E Mid |
| **Total** | **72.5 km** | **43 unique** | **185** | |
...
| Revenue fleet capacity | 60,120 AW2 pax (80,160 AW3 crush) |
| Total fleet capacity | 66,600 AW2 pax (88,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 167 × 360 = **60,120 AW2 passengers** (80,160 AW3 crush)
- **Total fleet passenger capacity:** 185 × 360 = **66,600 AW2 passengers** (88,800 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **38** | **16,100 kW** | **58,500 kWh** |

Aggregate station-rail charging power: **19,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.
...
| Onboard battery adequacy | 8.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 475 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 79 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 97 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 239 kWh | 351 kWh | 88 kWh | 8.0 km / 65 kWh |
| line-2 | 14 | 225 kWh | 343 kWh | 96 kWh | 7.4 km / 60 kWh |
| line-3 | 10 | 121 kWh | 212 kWh | 79 kWh | 2.0 km / 16 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 185 | $900 k | $166 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 555 | $60 k | $33 M |
| High sensitivity check | 555 | $120 k | $67 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 65,268 kW @ $700/kW | $46 M |
| Grid interconnection / PPA tie-in | 65,268 kW @ $100/kW | $6.5 M |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $4.1 M |
...
| Per-capita (city pop) | $1,223 / person |
...
|---|---|---|
| Construction (years 1–5) | **$65 M / yr** | $93 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$39 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$325 M cumulative** | $465 |
| Lifecycle envelope (yr 1–40, high scenario) | **$325 M cumulative** | $465 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.70 bn cumulative** | $2,425 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $685 M | 4.5% | 40 y, 5 y grace | $39 M / yr |
| Government equity (no debt service) | 20% | $171 M | — | — | — |
| **Total** | **100%** | **$856 M** | | | **$39 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $31 M / yr = **$31 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($34 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (159.6 GWh / yr) | 33,729 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 35.3 GWh/yr + dedicated solar plant 65.3 MW / 142.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $783 k |
| Labour (482 FTE) | driverless roster: OCC/remote 106, station/platform 139, passenger service 49, fleet maintenance 100, infrastructure/energy 67, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $4.7 M |
| **OPEX subtotal** | | **$23 M / yr** |

_Annual service work: 33,729 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.3 M train-km / yr (39.9 M car-km / yr). On-site PV covers 35.3 GWh/yr and the dedicated solar plant adds 142.9 GWh/yr against 159.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 185 trainsets, 43 stations, 72.5 route-km, 3 lines, and 33,729 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $113 M / yr | $181 M / yr | $16 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| **Total revenue** | **$121 M / yr** | **$189 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 521% | 815% | 100% |
...
| Operating surplus after OPEX (before debt support) | $98 M / yr | $166 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,752 m² of station shop/kiosk leases at $46/m²/month and 1,120 advertising boards at $406/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$130 M / yr** | **$208 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 3 healthcare anchors | 14,584 trips/day; 5.3 M access-events/yr | 23,334 trips/day; 8.5 M access-events/yr |
| Commerce | 17 major/terminal/interchange nodes | 40,480 trips/trading day; 13.4 M access-events/yr | 64,767 trips/trading day; 21.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $491 M | 57% of $856 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $786 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $157 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,652 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $804 M |
| Timetable-sized dedicated solar CAPEX | $52 M |
| **Reconciled project CAPEX** | **$856 M** |
| 15%–25% planning risk envelope | $984 M–$1.07 bn |
| Annual OPEX | $23 M / yr |
| Low/high project NPV at 8% | $91 M / $631 M |
| Low/high project IRR | 9.1% / 14.4% |
| Low/high steady-state DSCR | 2.49 / 4.23 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,461.04 train-km; 19,847.50 kWh consumed; 20,027.04 kWh charged; 19 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 34,598.97 train-km; 279,027.94 kWh consumed; 282,465.01 kWh charged; 504 depot services completed (2 active at cutoff); minimum SoC 35%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 21.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 34.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 43 line platforms, 2 interchange complexes, 12 civil segments, and 0 input findings |
