...
| Steady-state, low-ridership (year 6+) | **$46 M / yr** | $66 |
| Steady-state, high-ridership (year 6+) | **$46 M / yr** | $66 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $66 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.17 bn cumulative** | $1,667 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.17 bn cumulative** | $1,667 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.17 bn cumulative** | $1,667 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $403 M | 4.0% | 25 y, 5 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $168 M | 7.5% | 25 y, 5 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $101 M | — | — | — |
| **Total** | **100%** | **$672 M** | | | **$46 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $16 M / yr + bonds $13 M / yr = **$29 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
