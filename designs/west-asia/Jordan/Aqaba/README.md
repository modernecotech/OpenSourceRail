...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$512 M (88.4%) of external capital** and **$629 M of external interest**. Capital plus saved interest totals **$1.14 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 34.6 km |
| Revenue fleet | 64 × 2-car trainsets |
| Revenue fleet passenger capacity | 15,360 AW2 pax (20,480 AW3 crush) |
...
| Revenue fleet capacity | 15,360 AW2 pax (20,480 AW3 crush) |
...
- **Revenue fleet simultaneous capacity:** 64 × 240 = **15,360 AW2 passengers** (20,480 AW3 crush)
...
- Anchor-weighted coverage: 62.8%
- Catchment population: **≈ 157,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **15.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 18.5× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 341 kWh usable margin across the worst powered-stop gap (line-2) |
...
| Scheduled train journey-km | 16,098 train-km/day | One-way train journeys × route length |
| Annual service work | 6.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 139 MWh/day | 12.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 82 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 15.7 MW / 94 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 80 kWh | 139 kWh | 50 kWh | 3.4 km / 18 kWh |
| line-2 | 5 | 52 kWh | 98 kWh | 41 kWh | 3.6 km / 19 kWh |
| line-3 | 5 | 54 kWh | 98 kWh | 39 kWh | 3.0 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 15,734 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 15,734 kW @ $100/kW | $1.6 M |
| Annual generation proxy | 15.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 34.5 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 34.6 km × $0.050 M/km | $1.7 M |
...
| Per-capita (city pop) | $1,286 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $135 M | 15% | $20 M | $115 M |
| Stations | $102 M | 20% | $20 M | $82 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $40 M | 35% | $14 M | $26 M |
| Dedicated solar plant | $13 M | 45% | $5.7 M | $6.9 M |
| Residual signalling / train control | $1.7 M | 50% | $866 k | $866 k |
| Charging microgrids | $1.9 M | 40% | $750 k | $1.1 M |
| EPC / project services | $20 M | 15% | $3.0 M | $17 M |
| **Total city CAPEX** | **$321 M** | **20.8%** | **$67 M** | **$255 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh aqaba`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **20.8%** | **$67 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.2%** | **$255 M** | **$51 M / yr** |
| of which planned local bond issuance | 63.3% of total CAPEX | $204 M | $41 M / yr |
| **Total city programme** | **100.0%** | **$321 M** | **$64 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $434 M | $367 M (84.6%) | $451 M | **$818 M** |
| **Default** | 2.00× | $579 M | $512 M (88.4%) | $629 M | **$1.14 bn** |
| High | 3.00× | $868 M | $801 M (92.3%) | $985 M | **$1.79 bn** |

At the default 2.00× case, OSR's $67 M external requirement is 88.4% below the illustrative foreign-company requirement of $579 M; the associated lifetime external-interest saving is $629 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$28 M / yr** | $114 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $82 |
| Lifecycle envelope (yr 1–40, low scenario) | **$142 M cumulative** | $569 |
| Lifecycle envelope (yr 1–40, high scenario) | **$142 M cumulative** | $569 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$857 M cumulative** | $3,429 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $67 M | 4.5% | 40 y, 5 y grace | $3.8 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $204 M | 7.5% | 40 y, 5 y grace | $17 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $51 M | — | — | — |
| **Total** | **100%** | **$321 M** | | | **$20 M / yr** |
...
| Traction energy (50.8 GWh / yr) | 16,098 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.8 GWh/yr + dedicated solar plant 15.7 MW / 34.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $189 k |
| Labour (267 FTE) | driverless roster: OCC/remote 53, station/platform 79, passenger service 38, fleet maintenance 43, infrastructure/energy 33, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.6 M |
| **OPEX subtotal** | | **$9.4 M / yr** |

_Annual service work: 16,098 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (12.7 M car-km / yr). On-site PV covers 20.8 GWh/yr and the dedicated solar plant adds 34.5 GWh/yr against 50.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 71 trainsets, 16 stations, 34.6 route-km, 3 lines, and 16,098 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 3.2 M |
| Annual paid trips / city resident | 196 | 313 | 13 |
| Farebox revenue | $76 M / yr | $121 M / yr | $5.0 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$80 M / yr** | **$125 M / yr** | **$9.4 M / yr** |
| Revenue / OPEX recovery | 853% | 1337% | 100% |
...
| Operating surplus after OPEX (before debt support) | $71 M / yr | $116 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,488 m² of station shop/kiosk leases at $46/m²/month and 648 advertising boards at $406/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $22 M / yr | $35 M / yr | 16 min/trip × $1.67/h value-of-time proxy |
| Avoided road congestion | $6.1 M / yr | $9.7 M / yr | 76 M - 122 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.1 M / yr | $1.8 M / yr | 13.7–21.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.0 M / yr | $4.9 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $34 M / yr | $54 M / yr | 24% of paid trips × $2.90 local spend proxy |
| Entertainment / community activity supported | $15 M / yr | $24 M / yr | 11% of paid trips × $2.90 local spend proxy |
...
| Commerce | 12 major/terminal/interchange nodes | 31,973 trips/trading day; 10.6 M access-events/yr | 51,157 trips/trading day; 16.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $255 M | 79% of $321 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $407 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $81 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 9,142 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $309 M |
| Timetable-sized dedicated solar CAPEX | $13 M |
| **Reconciled project CAPEX** | **$321 M** |
| Imported / external-capital requirement | $67 M (20.8%) |
| Local-content / local-funding requirement | $255 M (79.2%) |
| Default foreign-turnkey external-capital comparison | $579 M; OSR saves $512 M (88.4%) |
| Lifetime external interest and combined financing saving | $629 M interest; $1.14 bn capital + interest |
| 15%–25% planning risk envelope | $370 M–$402 M |
| Annual OPEX | $9.4 M / yr |
| Low/high project NPV at 8% | $303 M / $663 M |
| Low/high project IRR | 15.9% / 22.9% |
| Low/high steady-state DSCR | 3.46 / 5.68 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,521.57 train-km; 8,179.22 kWh consumed; 8,428.37 kWh charged; 37 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,597.71 train-km; 89,221.48 kWh consumed; 90,576.18 kWh charged; 499 depot services completed (6 active at cutoff); minimum SoC 62%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 53.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 51.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 61.6% | 100.0% / 90% | pass |
...
|---|---|
| ![Aqaba energy and battery simulation dashboard](engineering/screenshots/aqaba-simulation-dashboard.png) | ![Aqaba simulator network visualizer](engineering/screenshots/aqaba-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 16 line platforms, 2 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Aqaba QGIS engineering layers](engineering/screenshots/aqaba-qgis-engineering-map.png) | ![Aqaba SUMO timetable validation](engineering/screenshots/aqaba-sumo-validation.png) |
...
scripts/regenerate-city.sh aqaba
```
