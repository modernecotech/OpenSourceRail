...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$478 M (88.2%) of external capital** and **$588 M of external interest**. Capital plus saved interest totals **$1.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (32.1 km @ $2.58 M/km) | $83 M |
...
|---|---:|---:|---:|---:|
| Civil works | $116 M | 15% | $17 M | $99 M |
...
| **Total city CAPEX** | **$301 M** | **21.2%** | **$64 M** | **$237 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$64 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$237 M** | **$47 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $190 M | $38 M / yr |
| **Total city programme** | **100.0%** | **$301 M** | **$60 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $407 M | $343 M (84.3%) | $421 M | **$764 M** |
| **Default** | 2.00× | $542 M | $478 M (88.2%) | $588 M | **$1.07 bn** |
| High | 3.00× | $813 M | $749 M (92.1%) | $921 M | **$1.67 bn** |

At the default 2.00× case, OSR's $64 M external requirement is 88.2% below the illustrative foreign-company requirement of $542 M; the associated lifetime external-interest saving is $588 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$27 M / yr** | $106 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$19 M / yr** | $76 |
| Lifecycle envelope (yr 1–40, low scenario) | **$133 M cumulative** | $532 |
| Lifecycle envelope (yr 1–40, high scenario) | **$133 M cumulative** | $532 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$802 M cumulative** | $3,209 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $64 M | 4.5% | 40 y, 5 y grace | $3.7 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $190 M | 7.5% | 40 y, 5 y grace | $15 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $47 M | — | — | — |
| **Total** | **100%** | **$301 M** | | | **$19 M / yr** |
...
| Annual paid trips | 48.9 M | 78.2 M | 3.0 M |
| Annual paid trips / city resident | 196 | 313 | 12 |
| Farebox revenue | $76 M / yr | $121 M / yr | $4.6 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$80 M / yr** | **$125 M / yr** | **$9.0 M / yr** |
| Revenue / OPEX recovery | 889% | 1394% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $237 M | 79% of $301 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $380 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $76 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 8,522 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $64 M (21.2%) |
| Local-content / local-funding requirement | $237 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $542 M; OSR saves $478 M (88.2%) |
| Lifetime external interest and combined financing saving | $588 M interest; $1.07 bn capital + interest |
| 15%–25% planning risk envelope | $346 M–$376 M |
| Annual OPEX | $9.0 M / yr |
| Low/high project NPV at 8% | $323 M / $683 M |
| Low/high project IRR | 16.8% / 24.0% |
| Low/high steady-state DSCR | 3.71 / 6.08 |
