...
| Revenue fleet | 94 × 2-car trainsets |
| Revenue fleet passenger capacity | 22,560 AW2 pax (30,080 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 15.0 km | 10 | 45 | W Outer ↔ E Outer |
| line-2 |  9.6 km | 7 | 30 | S Mid ↔ NE Outer |
| line-3 | 10.0 km | 6 | 30 | SE Mid ↔ W Outer |
| **Total** | **34.6 km** | **23 unique** | **105** | |
...
| Revenue fleet capacity | 22,560 AW2 pax (30,080 AW3 crush) |
...
- **Revenue fleet simultaneous capacity:** 94 × 240 = **22,560 AW2 passengers** (30,080 AW3 crush)
- **Total fleet passenger capacity:** 105 × 240 = **25,200 AW2 passengers** (33,600 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **13.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 29.6× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 348 kWh usable margin across the worst powered-stop gap (line-1) |
...
| On-site PV shortfall before solar plant | 69 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 13.3 MW / 80 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 80 kWh | 188 kWh | 99 kWh | 2.3 km / 12 kWh |
| line-2 | 7 | 52 kWh | 131 kWh | 74 kWh | 2.0 km / 11 kWh |
| line-3 | 6 | 54 kWh | 114 kWh | 55 kWh | 2.2 km / 12 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 105 | $560 k | $59 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 210 | $60 k | $13 M |
| High sensitivity check | 210 | $120 k | $25 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 13,319 kW @ $700/kW | $9.3 M |
| Grid interconnection / PPA tie-in | 13,319 kW @ $100/kW | $1.3 M |
| Annual generation proxy | 13.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 29.2 GWh/yr |
...
|---|---|---|
| Construction (years 1–5) | **$29 M / yr** | $117 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$146 M cumulative** | $586 |
| Lifecycle envelope (yr 1–40, high scenario) | **$146 M cumulative** | $586 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$764 M cumulative** | $3,057 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $308 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $77 M | — | — | — |
| **Total** | **100%** | **$385 M** | | | **$18 M / yr** |
...
| Traction energy (50.8 GWh / yr) | 16,098 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 25.4 GWh/yr + dedicated solar plant 13.3 MW / 29.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $160 k |
| Labour (322 FTE) | driverless roster: OCC/remote 69, station/platform 106, passenger service 38, fleet maintenance 53, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.1 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 16,098 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 6.3 M train-km / yr (12.7 M car-km / yr). On-site PV covers 25.4 GWh/yr and the dedicated solar plant adds 29.2 GWh/yr against 50.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 105 trainsets, 23 stations, 34.6 route-km, 3 lines, and 16,098 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $76 M / yr | $121 M / yr | $5.2 M / yr |
| Station shop leases | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$82 M / yr** | **$127 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 727% | 1131% | 100% |
...
| Operating surplus after OPEX (before debt support) | $70 M / yr | $116 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,760 m² of station shop/kiosk leases at $46/m²/month and 880 advertising boards at $406/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $34 M / yr | $55 M / yr | 24% of paid trips × $2.90 local spend proxy |
...
| Healthcare | 1 healthcare anchors | 8,973 trips/day; 3.3 M access-events/yr | 14,356 trips/day; 5.2 M access-events/yr |
| Commerce | 18 major/terminal/interchange nodes | 32,432 trips/trading day; 10.7 M access-events/yr | 51,891 trips/trading day; 17.1 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,382 trips/activity day; 4.3 M access-events/yr | 23,011 trips/activity day; 6.9 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $225 M | 59% of $385 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $361 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $72 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 8,099 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $443 M–$482 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $250 M / $610 M |
| Low/high project IRR | 13.7% / 20.1% |
| Low/high steady-state DSCR | 3.99 / 6.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,479.80 train-km; 7,954.76 kWh consumed; 8,712.25 kWh charged; 34 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 16,710.75 train-km; 89,829.91 kWh consumed; 92,085.28 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 80.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 87.1% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 87.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 2 interchange complexes, 8 civil segments, and 0 input findings |
