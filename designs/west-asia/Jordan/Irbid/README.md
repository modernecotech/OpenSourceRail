...
| Lifecycle envelope (yr 1–25, low scenario) | **$588 M cumulative** | $980 |
| Lifecycle envelope (yr 1–25, high scenario) | **$588 M cumulative** | $980 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$588 M cumulative** | $980 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $85 M | 7.5% | 25 y, 5 y grace | $8.3 M / yr |
| Government equity (no debt service) | 15% | $51 M | — | — | — |
| **Total** | **100%** | **$339 M** | | | **$23 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $8.1 M / yr + bonds $6.3 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($10 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 45,036 | 75,060 | 7,179 |
...
| Revenue / OPEX recovery | 254% | 376% | 100% |
