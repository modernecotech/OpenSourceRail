...
|---|---|---|---|---|
| line-1 | 15.8 km | 10 | 41 | S Mid ↔ N Outer |
| line-2 | 14.0 km | 9 | 37 | E Outer ↔ W Mid |
| line-3 | 18.9 km | 10 | 49 | NE Outer ↔ SW Outer |
| **Total** | **48.7 km** | **29 unique** | **127** | |
...
| Dedicated solar plant | 46.3 MW / 255 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 114 kWh | 212 kWh | 87 kWh | 2.1 km / 15 kWh |
| line-2 | 9 | 101 kWh | 192 kWh | 81 kWh | 2.0 km / 15 kWh |
| line-3 | 9 | 136 kWh | 229 kWh | 79 kWh | 5.1 km / 37 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 46,276 kW @ $700/kW | $32 M |
| Grid interconnection / PPA tie-in | 46,276 kW @ $100/kW | $4.6 M |
| Annual generation proxy | 46.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 92.9 GWh/yr |
...
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$181 M cumulative** | $301 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $301 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$943 M cumulative** | $1,571 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $380 M | 4.5% | 40 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $95 M | — | — | — |
| **Total** | **100%** | **$475 M** | | | **$22 M / yr** |
...
| Traction energy (107.1 GWh / yr) | 22,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.3 GWh/yr + dedicated solar plant 46.3 MW / 92.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $555 k |
| Labour (368 FTE) | driverless roster: OCC/remote 81, station/platform 103, passenger service 49, fleet maintenance 68, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.6 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 22,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.9 M train-km / yr (26.8 M car-km / yr). On-site PV covers 26.3 GWh/yr and the dedicated solar plant adds 92.9 GWh/yr against 107.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 127 trainsets, 29 stations, 48.7 route-km, 3 lines, and 22,637 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 5.6 M |
| Annual paid trips / city resident | 122 | 196 | 9 |
| Farebox revenue | $113 M / yr | $181 M / yr | $8.7 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$119 M / yr** | **$187 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 839% | 1319% | 100% |
...
_Commercial-revenue assumptions: 4,232 m² of station shop/kiosk leases at $46/m²/month and 824 advertising boards at $406/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $46 M / yr | $73 M / yr | 21% of paid trips × $2.90 local spend proxy |
| Entertainment / community activity supported | $23 M / yr | $36 M / yr | 11% of paid trips × $2.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$122 M / yr** | **$196 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $265 M | 56% of $475 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,512 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $451 M / $991 M |
| Low/high project IRR | 15.9% / 23.0% |
| Low/high steady-state DSCR | 4.81 / 7.94 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,914.39 train-km; 13,782.74 kWh consumed; 14,805.06 kWh charged; 29 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,411.18 train-km; 168,549.89 kWh consumed; 172,202.10 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 56.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 50.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 63.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.1% / 60% | pass |
| ten-hour single charging-pad outage | 63.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 29 line platforms, 1 interchange complexes, 14 civil segments, and 0 input findings |
