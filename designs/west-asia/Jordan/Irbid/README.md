...
| Steady-state, low-ridership (year 6+) | **$31 M / yr** | $51 |
| Steady-state, high-ridership (year 6+) | **$31 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $51 |
| Lifecycle envelope (yr 1–25, low scenario) | **$777 M cumulative** | $1,295 |
| Lifecycle envelope (yr 1–25, high scenario) | **$777 M cumulative** | $1,295 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$777 M cumulative** | $1,295 |
...
| Sovereign bonds (10-y benchmark + project) | 25% | $112 M | 7.5% | 25 y, 5 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $67 M | — | — | — |
| **Total** | **100%** | **$447 M** | | | **$31 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $8.4 M / yr = **$19 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
