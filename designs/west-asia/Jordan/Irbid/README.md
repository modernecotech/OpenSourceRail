...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$591 M (86.2%) of external capital** and **$726 M of external interest**. Capital plus saved interest totals **$1.32 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 65.1% |
| Route length (double track) | 48.7 km |
| Revenue fleet | 96 × 3-car trainsets |
| Revenue fleet passenger capacity | 34,560 AW2 pax (46,080 AW3 crush) |
...
| Revenue fleet capacity | 34,560 AW2 pax (46,080 AW3 crush) |
| Total fleet capacity | 38,520 AW2 pax (51,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 96 × 360 = **34,560 AW2 passengers** (46,080 AW3 crush)
- **Total fleet passenger capacity:** 107 × 360 = **38,520 AW2 passengers** (51,360 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 15.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 505 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 22,637 train-km/day | One-way train journeys × route length |
| Annual service work | 8.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 293 MWh/day | 26.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 233 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 48.7 MW / 268 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 114 kWh | 200 kWh | 75 kWh | 3.6 km / 26 kWh |
| line-2 | 7 | 101 kWh | 172 kWh | 61 kWh | 3.0 km / 22 kWh |
| line-3 | 7 | 136 kWh | 229 kWh | 79 kWh | 4.9 km / 35 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (48.5 km @ $2.58 M/km) | $125 M |
| Elevated (0.1 km @ $9.75 M/km) | $1.4 M |
| **Civil subtotal** | **$127 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 107 | $900 k | $96 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 321 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 321 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 48,691 kW @ $700/kW | $34 M |
| Grid interconnection / PPA tie-in | 48,691 kW @ $100/kW | $4.9 M |
| Annual generation proxy | 48.7 MW × 5.5 peak-sun-h/day × 365 d/yr | 97.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 48.7 km × $0.050 M/km | $2.4 M |
...
|---|---:|---:|---:|---:|
| Civil works | $127 M | 15% | $19 M | $108 M |
| Stations | $84 M | 20% | $17 M | $67 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $96 M | 35% | $34 M | $63 M |
...
| EPC / project services | $22 M | 15% | $3.4 M | $19 M |
| **Total city CAPEX** | **$381 M** | **24.8%** | **$94 M** | **$286 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh irbid`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.8%** | **$94 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.2%** | **$286 M** | **$57 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $229 M | $46 M / yr |
| **Total city programme** | **100.0%** | **$381 M** | **$76 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $514 M | $419 M (81.6%) | $516 M | **$935 M** |
| **Default** | 2.00× | $685 M | $591 M (86.2%) | $726 M | **$1.32 bn** |
| High | 3.00× | $1.03 bn | $933 M (90.8%) | $1.15 bn | **$2.08 bn** |

At the default 2.00× case, OSR's $94 M external requirement is 86.2% below the illustrative foreign-company requirement of $685 M; the associated lifetime external-interest saving is $726 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$33 M / yr** | $55 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$164 M cumulative** | $274 |
| Lifecycle envelope (yr 1–40, high scenario) | **$164 M cumulative** | $274 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,678 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $94 M | 4.5% | 40 y, 5 y grace | $5.4 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $229 M | 7.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$381 M** | | | **$24 M / yr** |
...
| Traction energy (107.1 GWh / yr) | 22,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.1 GWh/yr + dedicated solar plant 48.7 MW / 97.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $584 k |
| Labour (322 FTE) | driverless roster: OCC/remote 69, station/platform 77, passenger service 49, fleet maintenance 62, infrastructure/energy 44, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 22,637 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.9 M train-km / yr (26.8 M car-km / yr). On-site PV covers 22.1 GWh/yr and the dedicated solar plant adds 97.7 GWh/yr against 107.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 107 trainsets, 21 stations, 48.7 route-km, 3 lines, and 22,637 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 5.2 M |
| Annual paid trips / city resident | 122 | 196 | 9 |
| Farebox revenue | $113 M / yr | $181 M / yr | $8.0 M / yr |
| Station shop leases | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$117 M / yr** | **$185 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 974% | 1538% | 100% |
...
| Operating surplus after OPEX (before debt support) | $105 M / yr | $173 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,080 m² of station shop/kiosk leases at $46/m²/month and 608 advertising boards at $406/board/month, with occupancy derates applied._
...
| Avoided CO2e | $2.3 M / yr | $3.7 M / yr | 28.9–46.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.4 M / yr | $10 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $45 M / yr | $71 M / yr | 21% of paid trips × $2.90 local spend proxy |
...
| Healthcare | 8 healthcare anchors | 22,437 trips/day; 8.2 M access-events/yr | 35,899 trips/day; 13.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $286 M | 75% of $381 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $458 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $92 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 10,280 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $342 M |
| Timetable-sized dedicated solar CAPEX | $39 M |
| **Reconciled project CAPEX** | **$381 M** |
| Imported / external-capital requirement | $94 M (24.8%) |
| Local-content / local-funding requirement | $286 M (75.2%) |
| Default foreign-turnkey external-capital comparison | $685 M; OSR saves $591 M (86.2%) |
| Lifetime external interest and combined financing saving | $726 M interest; $1.32 bn capital + interest |
| 15%–25% planning risk envelope | $438 M–$476 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $532 M / $1.07 bn |
| Low/high project IRR | 18.9% / 26.8% |
| Low/high steady-state DSCR | 4.38 / 7.21 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,936.74 train-km; 13,943.53 kWh consumed; 13,672.67 kWh charged; 30 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,813.43 train-km; 164,245.29 kWh consumed; 166,608.88 kWh charged; 498 depot services completed (6 active at cutoff); minimum SoC 51%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 39.6% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 34.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 50.7% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.0% / 60% | pass |
| ten-hour single charging-pad outage | 48.1% | 100.0% / 90% | pass |
...
|---|---|
| ![Irbid energy and battery simulation dashboard](engineering/screenshots/irbid-simulation-dashboard.png) | ![Irbid simulator network visualizer](engineering/screenshots/irbid-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 21 line platforms, 1 interchange complexes, 14 civil segments, and 0 input findings |
...
|---|---|
| ![Irbid QGIS engineering layers](engineering/screenshots/irbid-qgis-engineering-map.png) | ![Irbid SUMO timetable validation](engineering/screenshots/irbid-sumo-validation.png) |
...
scripts/regenerate-city.sh irbid
```
