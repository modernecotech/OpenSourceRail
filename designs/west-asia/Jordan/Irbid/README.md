...
| Bucket | Value |
|---|---|
| At-grade (54.7 km @ €3.5 M/km) | €192 M |
...
| Steady-state, low-ridership (year 6+) | **€47 M / yr** | €78 |
| Steady-state, high-ridership (year 6+) | **€40 M / yr** | €66 |
| Lifecycle envelope (yr 1–25, low scenario) | **€1.15 bn cumulative** | €1,913 |
| Lifecycle envelope (yr 1–25, high scenario) | **€1.00 bn cumulative** | €1,670 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€7.3 M / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €346 M | 4.0% | 25 y, 5 y grace | €25 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €144 M | 7.5% | 25 y, 5 y grace | €14 M / yr |
| Government equity (no debt service) | 15% | €87 M | — | — | — |
| **Total** | **100%** | **€577 M** | | | **€40 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €14 M / yr + bonds €11 M / yr = **€25 M / yr** total — plus the equity tranche amortised across construction (€17 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (349 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.1 M |
...
| Operating shortfall (gov subsidy required) | €7.3 M / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €0 k / yr | €2.4 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€47 M / yr** | **€40 M / yr** |
