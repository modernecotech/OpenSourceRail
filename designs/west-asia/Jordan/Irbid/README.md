...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 321 | $60 k | $19 M |
| High sensitivity check | 321 | $120 k | $39 M |
...
|---|---|---|
| Construction (years 1–5) | **$32 M / yr** | $54 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$161 M cumulative** | $268 |
| Lifecycle envelope (yr 1–40, high scenario) | **$161 M cumulative** | $268 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$839 M cumulative** | $1,399 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $339 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Government equity (no debt service) | 20% | $85 M | — | — | — |
| **Total** | **100%** | **$423 M** | | | **$19 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $235 M | 56% of $423 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 8,458 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $495 M / $1.03 bn |
| Low/high project IRR | 17.5% / 24.9% |
| Low/high steady-state DSCR | 5.41 / 8.92 |
