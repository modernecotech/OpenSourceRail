...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 3330 | $60 k | $200 M |
| High sensitivity check | 3330 | $120 k | $400 M |
...
| Depots | $8.0 M |
| Rolling stock | $932 M |
| Railway production plant | $200 M |
...
|---|---|---|
| Construction (years 1–5) | **$321 M / yr** | $80 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$193 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.60 bn cumulative** | $400 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.60 bn cumulative** | $400 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$8.38 bn cumulative** | $2,090 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $3.38 bn | 4.5% | 40 y, 5 y grace | $193 M / yr |
| Government equity (no debt service) | 20% | $844 M | — | — | — |
| **Total** | **100%** | **$4.22 bn** | | | **$193 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.31 bn | 55% of $4.22 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.69 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $738 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 82,876 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.67 bn |
| Timetable-sized dedicated solar CAPEX | $551 M |
| **Reconciled project CAPEX** | **$4.22 bn** |
| 15%–25% planning risk envelope | $4.86 bn–$5.28 bn |
| Annual OPEX | $108 M / yr |
| Low/high project NPV at 8% | $1.10 bn / $4.16 bn |
| Low/high project IRR | 10.5% / 16.2% |
| Low/high steady-state DSCR | 2.91 / 4.91 |
