...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.82 bn (85.7%) of external capital** and **$7.16 bn of external interest**. Capital plus saved interest totals **$12.98 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Lines | 9 |
| Unique stations | 120 |
| Interchange-class stations | 21 |
| Multi-line transfer reachability | 47% (line-pairs sharing ≥ 1 station) |
| Anchor-weighted coverage | 66.9% |
| Route length (double track) | 358.4 km |
| Revenue fleet | 500 × 6-car trainsets |
| Revenue fleet passenger capacity | 360,000 AW2 pax (480,000 AW3 crush) |
...
| Revenue fleet capacity | 360,000 AW2 pax (480,000 AW3 crush) |
| Total fleet capacity | 399,600 AW2 pax (532,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 500 × 720 = **360,000 AW2 passengers** (480,000 AW3 crush)
- **Total fleet passenger capacity:** 555 × 720 = **399,600 AW2 passengers** (532,800 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 66.9%
- Catchment population: **≈ 2,680,683** (within ~800 m walk of a station)
...
| Major | 6 | 300 kW | 2000 kWh |
| Standard | 50 | 300 kW | 2000 kWh |
| Terminal | 15 | 300 kW | 2000 kWh |
| **Total installed** | **112** | **38,300 kW** | **262,000 kWh** |

Aggregate station-rail charging power: **224,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **689.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.5× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 884 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 210 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 230 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 3,952 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 147,553 train-km/day | One-way train journeys × route length |
| Annual service work | 58.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 3,825 MWh/day | 349.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 3,595 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 689.0 MW / 4,134 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 262 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 709 kWh | 1,176 kWh | 396 kWh | 12.1 km / 196 kWh |
| line-2 | 15 | 775 kWh | 1,290 kWh | 438 kWh | 9.7 km / 156 kWh |
| line-3 | 10 | 489 kWh | 849 kWh | 312 kWh | 5.5 km / 89 kWh |
| line-4 | 9 | 387 kWh | 653 kWh | 227 kWh | 4.1 km / 66 kWh |
| line-5 | 11 | 522 kWh | 784 kWh | 210 kWh | 7.0 km / 113 kWh |
| line-6 | 12 | 562 kWh | 849 kWh | 231 kWh | 6.9 km / 112 kWh |
| line-7 | 9 | 458 kWh | 768 kWh | 264 kWh | 5.1 km / 82 kWh |
| line-8 | 10 | 554 kWh | 849 kWh | 240 kWh | 12.1 km / 195 kWh |
| line-9 | 22 | 1,324 kWh | 2,156 kWh | 700 kWh | 10.9 km / 176 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (320.1 km @ $2.58 M/km) | $827 M |
| Elevated (38.3 km @ $9.75 M/km) | $373 M |
| Elevated-interchange premium (21 sites @ $4.50 M) | $94 M |
| **Civil subtotal** | **$1.29 bn** |
...
| `interchange-elevated` | 40 | $12.0 M | $480 M |
| **Stations subtotal** | | | **$709 M** |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 555 | $1.68 M | $932 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 3330 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 3330 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 688,996 kW @ $700/kW | $482 M |
| Grid interconnection / PPA tie-in | 688,996 kW @ $100/kW | $69 M |
| Annual generation proxy | 689.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 1,508.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$551 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 358.4 km × $0.050 M/km | $18 M |
...
| EPC integration + project management (7%) | on subtotal | $211 M |
...
| Dedicated solar power plant | $551 M |
| Residual train-control wayside + charging microgrids | $67 M |
| EPC overhead (7%) | $211 M |
| **CAPEX total** | **$3.77 bn** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $942 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.29 bn | 15% | $194 M | $1.10 bn |
| Stations | $709 M | 20% | $142 M | $567 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $932 M | 35% | $326 M | $606 M |
| Dedicated solar plant | $551 M | 45% | $248 M | $303 M |
| Residual signalling / train control | $18 M | 50% | $9.0 M | $9.0 M |
| Charging microgrids | $49 M | 40% | $20 M | $30 M |
| EPC / project services | $211 M | 15% | $32 M | $179 M |
| **Total city CAPEX** | **$3.77 bn** | **25.8%** | **$973 M** | **$2.80 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh amman`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.8%** | **$973 M** | **$195 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.2%** | **$2.80 bn** | **$560 M / yr** |
| of which planned local bond issuance | 59.4% of total CAPEX | $2.24 bn | $448 M / yr |
| **Total city programme** | **100.0%** | **$3.77 bn** | **$755 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $5.09 bn | $4.12 bn (80.9%) | $5.07 bn | **$9.19 bn** |
| **Default** | 2.00× | $6.79 bn | $5.82 bn (85.7%) | $7.16 bn | **$12.98 bn** |
| High | 3.00× | $10.19 bn | $9.22 bn (90.5%) | $11.33 bn | **$20.55 bn** |

At the default 2.00× case, OSR's $973 M external requirement is 85.7% below the illustrative foreign-company requirement of $6.79 bn; the associated lifetime external-interest saving is $7.16 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$324 M / yr** | $81 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$238 M / yr** | $59 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.62 bn cumulative** | $404 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.62 bn cumulative** | $404 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.96 bn cumulative** | $2,486 |

_Population basis: 4,007,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $238 M / yr → $238 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $973 M | 4.5% | 40 y, 5 y grace | $56 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.24 bn | 7.5% | 40 y, 5 y grace | $183 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $560 M | — | — | — |
| **Total** | **100%** | **$3.77 bn** | | | **$238 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $44 M / yr + local bonds $168 M / yr = **$212 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($112 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $896 k |
| Traction energy (1396.0 GWh / yr) | 147,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 83.9 GWh/yr + dedicated solar plant 689.0 MW / 1508.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $8.3 M |
| Labour (1,729 FTE) | driverless roster: OCC/remote 300, station/platform 525, passenger service 231, fleet maintenance 361, infrastructure/energy 279, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $17 M |
| **OPEX subtotal** | | **$104 M / yr** |

_Annual service work: 147,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 58.2 M train-km / yr (349.0 M car-km / yr). On-site PV covers 83.9 GWh/yr and the dedicated solar plant adds 1508.9 GWh/yr against 1396.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 555 trainsets, 120 stations, 358.4 route-km, 9 lines, and 147,553 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 48.3 M |
| Annual paid trips / city resident | 104 | 166 | 12 |
| Farebox revenue | $643 M / yr | $1.03 bn / yr | $75 M / yr |
| Station shop leases | $11 M / yr | $11 M / yr | $11 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$672 M / yr** | **$1.06 bn / yr** | **$104 M / yr** |
| Revenue / OPEX recovery | 649% | 1021% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $238 M / yr | $238 M / yr | **$238 M / yr** |
| Operating surplus applied to debt support | -$238 M / yr | -$238 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$238 M / yr** |
| Operating surplus after OPEX (before debt support) | $568 M / yr | $954 M / yr | $0 / yr |

_Commercial-revenue assumptions: 23,224 m² of station shop/kiosk leases at $46/m²/month and 4,236 advertising boards at $406/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $185 M / yr | $297 M / yr | 16 min/trip × $1.67/h value-of-time proxy |
...
| Station-area commerce turnover supported | $258 M / yr | $413 M / yr | 21% of paid trips × $2.90 local spend proxy |
| Entertainment / community activity supported | $128 M / yr | $204 M / yr | 11% of paid trips × $2.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$772 M / yr** | **$1.24 bn / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 9 education anchors | 67,228 trips/school day; 14.8 M access-events/yr | 107,565 trips/school day; 23.7 M access-events/yr |
| Healthcare | 11 healthcare anchors | 88,923 trips/day; 32.5 M access-events/yr | 142,277 trips/day; 51.9 M access-events/yr |
| Commerce | 62 major/terminal/interchange nodes | 243,885 trips/trading day; 80.5 M access-events/yr | 390,216 trips/trading day; 128.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.80 bn | 74% of $3.77 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.48 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $896 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 100,611 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.22 bn |
| Timetable-sized dedicated solar CAPEX | $551 M |
| **Reconciled project CAPEX** | **$3.77 bn** |
| Imported / external-capital requirement | $973 M (25.8%) |
| Local-content / local-funding requirement | $2.80 bn (74.2%) |
| Default foreign-turnkey external-capital comparison | $6.79 bn; OSR saves $5.82 bn (85.7%) |
| Lifetime external interest and combined financing saving | $7.16 bn interest; $12.98 bn capital + interest |
| 15%–25% planning risk envelope | $4.34 bn–$4.72 bn |
| Annual OPEX | $104 M / yr |
| Low/high project NPV at 8% | $1.49 bn / $4.55 bn |
| Low/high project IRR | 11.7% / 17.7% |
| Low/high steady-state DSCR | 2.38 / 4.00 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 10,173.58 train-km; 164,096.35 kWh consumed; 169,011.17 kWh charged; 56 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 143,564.17 train-km; 2,315,640.80 kWh consumed; 2,346,311.89 kWh charged; 1,524 depot services completed (12 active at cutoff); minimum SoC 70%; 0 onboard emergencies; 0 invariant violations; 97.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 62.1% | 97.3% / 90% | pass |
| maximum planning climate/HVAC duty | 33.6% | 97.3% / 90% | pass |
| 50% charging-contact availability | 69.7% | 97.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 74.1% / 60% | pass |
| ten-hour single charging-pad outage | 69.7% | 97.3% / 90% | pass |
...
|---|---|
| ![Amman energy and battery simulation dashboard](engineering/screenshots/amman-simulation-dashboard.png) | ![Amman simulator network visualizer](engineering/screenshots/amman-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 120 line platforms, 21 interchange complexes, 75 civil segments, and 0 input findings |
...
|---|---|
| ![Amman QGIS engineering layers](engineering/screenshots/amman-qgis-engineering-map.png) | ![Amman SUMO timetable validation](engineering/screenshots/amman-sumo-validation.png) |
...
scripts/regenerate-city.sh amman
```
