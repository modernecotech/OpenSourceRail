...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$6.21 bn (86.0%) of external capital** and **$7.63 bn of external interest**. Capital plus saved interest totals **$13.84 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (320.1 km @ $3.0 M/km) | $960 M |
| Elevated (38.3 km @ $12.0 M/km) | $459 M |
...
| EPC integration + project management (7%) | on subtotal | $226 M |
...
| EPC overhead (7%) | $226 M |
| **CAPEX total** | **$4.01 bn** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $1,000 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.51 bn | 15% | $227 M | $1.29 bn |
...
| EPC / project services | $226 M | 15% | $34 M | $192 M |
| **Total city CAPEX** | **$4.01 bn** | **25.1%** | **$1.01 bn** | **$3.00 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.1%** | **$1.01 bn** | **$202 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.9%** | **$3.00 bn** | **$600 M / yr** |
| of which planned local bond issuance | 59.9% of total CAPEX | $2.40 bn | $480 M / yr |
| **Total city programme** | **100.0%** | **$4.01 bn** | **$802 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $5.41 bn | $4.40 bn (81.4%) | $5.41 bn | **$9.82 bn** |
| **Default** | 2.00× | $7.22 bn | $6.21 bn (86.0%) | $7.63 bn | **$13.84 bn** |
| High | 3.00× | $10.82 bn | $9.82 bn (90.7%) | $12.07 bn | **$21.88 bn** |

At the default 2.00× case, OSR's $1.01 bn external requirement is 86.0% below the illustrative foreign-company requirement of $7.22 bn; the associated lifetime external-interest saving is $7.63 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$345 M / yr** | $86 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$253 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.73 bn cumulative** | $431 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.73 bn cumulative** | $431 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.59 bn cumulative** | $2,644 |

_Population basis: 4,007,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $253 M / yr → $253 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $1.01 bn | 4.5% | 40 y, 5 y grace | $58 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $2.40 bn | 7.5% | 40 y, 5 y grace | $196 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $600 M | — | — | — |
| **Total** | **100%** | **$4.01 bn** | | | **$253 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $45 M / yr + local bonds $180 M / yr = **$225 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($120 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 51.1 M |
| Annual paid trips / city resident | 104 | 166 | 13 |
| Farebox revenue | $643 M / yr | $1.03 bn / yr | $79 M / yr |
| Station shop leases | $11 M / yr | $11 M / yr | $11 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$672 M / yr** | **$1.06 bn / yr** | **$108 M / yr** |
| Revenue / OPEX recovery | 622% | 979% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $253 M / yr | $253 M / yr | **$253 M / yr** |
| Operating surplus applied to debt support | -$253 M / yr | -$253 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$253 M / yr** |
| Operating surplus after OPEX (before debt support) | $564 M / yr | $949 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.00 bn | 75% of $4.01 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.80 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $960 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 107,778 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.46 bn |
| Timetable-sized dedicated solar CAPEX | $551 M |
| **Reconciled project CAPEX** | **$4.01 bn** |
| Imported / external-capital requirement | $1.01 bn (25.1%) |
| Local-content / local-funding requirement | $3.00 bn (74.9%) |
| Default foreign-turnkey external-capital comparison | $7.22 bn; OSR saves $6.21 bn (86.0%) |
| Lifetime external interest and combined financing saving | $7.63 bn interest; $13.84 bn capital + interest |
| 15%–25% planning risk envelope | $4.61 bn–$5.01 bn |
| Annual OPEX | $108 M / yr |
| Low/high project NPV at 8% | $1.27 bn / $4.33 bn |
| Low/high project IRR | 11.0% / 16.9% |
| Low/high steady-state DSCR | 2.22 / 3.75 |
