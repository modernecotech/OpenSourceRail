...
| Revenue fleet | 674 × 6-car trainsets |
| Revenue fleet passenger capacity | 485,280 AW2 pax (647,040 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 72 × 6-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 63 planned-maintenance spares and 9 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 44.0 km | 25 | 108 | SW Mid ↔ NE Outer |
| line-2 | 48.0 km | 26 | 116 | N Outer ↔ S Outer |
| line-3 | 30.3 km | 19 | 80 | S Outer ↔ N Mid |
| line-4 | 24.0 km | 15 | 64 | N Mid ↔ S Mid |
| line-5 | 32.4 km | 17 | 81 | W Outer ↔ SE Mid |
| line-6 | 34.9 km | 20 | 89 | E Mid ↔ W Outer |
| line-7 | 28.4 km | 16 | 72 | E Mid ↔ NW Outer |
| line-8 | 34.3 km | 19 | 84 | NE Outer ↔ SW Mid |
| line-9 | 82.1 km | 55 | 52 | W Mid ↔ W Mid |
| **Total** | **358.4 km** | **212 unique** | **746** | |
...
| Revenue fleet capacity | 485,280 AW2 pax (647,040 AW3 crush) |
| Total fleet capacity | 537,120 AW2 pax (716,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 674 × 720 = **485,280 AW2 passengers** (647,040 AW3 crush)
- **Total fleet passenger capacity:** 746 × 720 = **537,120 AW2 passengers** (716,160 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 57 | 300 kW | 2000 kWh |
| Major | 19 | 300 kW | 2000 kWh |
| Standard | 105 | 300 kW | 2000 kWh |
| Terminal | 15 | 300 kW | 2000 kWh |
| **Total installed** | **197** | **63,800 kW** | **432,000 kWh** |

Aggregate station-rail charging power: **394,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **659.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.5× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 885 kWh usable margin across the worst powered-stop gap (line-8) |
| Lowest traversal charging margin | 502 kWh | line-8 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 383 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 3,442 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 659.7 MW / 3,958 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 432 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 22 | 709 kWh | 1,503 kWh | 722 kWh | 9.0 km / 146 kWh |
| line-2 | 23 | 775 kWh | 1,601 kWh | 748 kWh | 8.2 km / 132 kWh |
| line-3 | 19 | 489 kWh | 1,307 kWh | 769 kWh | 2.3 km / 37 kWh |
| line-4 | 15 | 387 kWh | 1,045 kWh | 619 kWh | 2.0 km / 33 kWh |
| line-5 | 16 | 522 kWh | 1,111 kWh | 536 kWh | 5.0 km / 81 kWh |
| line-6 | 19 | 562 kWh | 1,307 kWh | 688 kWh | 4.6 km / 74 kWh |
| line-7 | 15 | 458 kWh | 1,045 kWh | 542 kWh | 3.8 km / 61 kWh |
| line-8 | 16 | 554 kWh | 1,111 kWh | 502 kWh | 12.1 km / 195 kWh |
| line-9 | 52 | 1,324 kWh | 3,397 kWh | 1,941 kWh | 5.1 km / 83 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (321.4 km @ $3.0 M/km) | $964 M |
...
| `interchange-elevated` | 57 | $12.0 M | $684 M |
| **Stations subtotal** | | | **$1.11 bn** |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 746 | $1.68 M | $1.25 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 4476 | $60 k | $269 M |
| High sensitivity check | 4476 | $120 k | $537 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 659,671 kW @ $700/kW | $462 M |
| Grid interconnection / PPA tie-in | 659,671 kW @ $100/kW | $66 M |
| Annual generation proxy | 659.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 1,444.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$528 M** |
...
| Stations | $1.11 bn |
| Depots | $8.0 M |
| Rolling stock | $1.25 bn |
| Railway production plant | $269 M |
| Dedicated solar power plant | $528 M |
| Residual train-control wayside + charging microgrids | $103 M |
| EPC overhead (7%) | $297 M |
| **CAPEX total** | **$5.06 bn** |
| Per-route-km | $14 M / km |
| Per-capita (city pop) | $1,264 / person |
...
|---|---|---|
| Construction (years 1–5) | **$385 M / yr** | $96 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$232 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.92 bn cumulative** | $480 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.92 bn cumulative** | $480 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.04 bn cumulative** | $2,507 |

_Population basis: 4,007,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $232 M / yr → $232 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $4.05 bn | 4.5% | 40 y, 5 y grace | $232 M / yr |
| Government equity (no debt service) | 20% | $1.01 bn | — | — | — |
| **Total** | **100%** | **$5.06 bn** | | | **$232 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $182 M / yr = **$182 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($203 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $50 M |
...
| Traction energy (1396.0 GWh / yr) | 147,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 139.7 GWh/yr + dedicated solar plant 659.7 MW / 1444.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $7.9 M |
| Labour (2,217 FTE) | driverless roster: OCC/remote 389, station/platform 834, passenger service 231, fleet maintenance 418, infrastructure/energy 312, admin/training 33; no train drivers × country median × 12 × engineer-premium 1.4 | $22 M |
| **OPEX subtotal** | | **$133 M / yr** |

_Annual service work: 147,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 58.2 M train-km / yr (349.0 M car-km / yr). On-site PV covers 139.7 GWh/yr and the dedicated solar plant adds 1444.7 GWh/yr against 1396.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 746 trainsets, 212 stations, 358.4 route-km, 9 lines, and 147,553 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 415.5 M | 664.8 M | 56.4 M |
| Annual paid trips / city resident | 104 | 166 | 14 |
| Farebox revenue | $643 M / yr | $1.03 bn / yr | $87 M / yr |
| Station shop leases | $18 M / yr | $18 M / yr | $18 M / yr |
| Advertising boards | $28 M / yr | $28 M / yr | $28 M / yr |
| **Total revenue** | **$688 M / yr** | **$1.07 bn / yr** | **$133 M / yr** |
| Revenue / OPEX recovery | 518% | 808% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $232 M / yr | $232 M / yr | **$232 M / yr** |
| Operating surplus applied to debt support | -$232 M / yr | -$232 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$232 M / yr** |
| Operating surplus after OPEX (before debt support) | $555 M / yr | $941 M / yr | $0 / yr |

_Commercial-revenue assumptions: 36,368 m² of station shop/kiosk leases at $46/m²/month and 6,700 advertising boards at $406/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $248 M / yr | $396 M / yr | 21% of paid trips × $2.90 local spend proxy |
| Entertainment / community activity supported | $128 M / yr | $204 M / yr | 11% of paid trips × $2.90 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$762 M / yr** | **$1.22 bn / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 14 education anchors | 64,241 trips/school day; 14.1 M access-events/yr | 102,785 trips/school day; 22.6 M access-events/yr |
| Healthcare | 21 healthcare anchors | 90,125 trips/day; 32.9 M access-events/yr | 144,200 trips/day; 52.6 M access-events/yr |
| Commerce | 92 major/terminal/interchange nodes | 234,000 trips/trading day; 77.2 M access-events/yr | 374,400 trips/trading day; 123.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.77 bn | 55% of $5.06 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 99,571 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $4.54 bn |
| Timetable-sized dedicated solar CAPEX | $528 M |
| **Reconciled project CAPEX** | **$5.06 bn** |
| 15%–25% planning risk envelope | $5.82 bn–$6.33 bn |
| Annual OPEX | $133 M / yr |
| Low/high project NPV at 8% | $361 M / $3.42 bn |
| Low/high project IRR | 8.7% / 13.9% |
| Low/high steady-state DSCR | 2.39 / 4.06 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 9,374.31 train-km; 151,202.49 kWh consumed; 164,730.21 kWh charged; 35 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 149,829.51 train-km; 2,416,668.49 kWh consumed; 2,462,999.00 kWh charged; 1,536 depot services completed (5 active at cutoff); minimum SoC 81%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 76.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 74.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 80.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 88.9% / 60% | pass |
| ten-hour single charging-pad outage | 80.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 9 corridors, 212 line platforms, 19 interchange complexes, 72 civil segments, and 0 input findings |
