...
| Bucket | Value |
|---|---|
| At-grade (47.7 km @ €3.5 M/km) | €167 M |
| Elevated (8.6 km @ €18 M/km) | €156 M |
| Elevated-interchange premium (1 sites @ €20 M) | €20 M |
| **Civil subtotal** | **€343 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.7 km × €0.015 M/km | €0.8 M |
...
| Per-capita (city pop) | €1,377 / person |
...
|---|---|---|
| Construction (years 1–10) | **€63 M / yr** | €127 |
| Steady-state, low-ridership (year 11+) | **€78 M / yr** | €156 |
| Steady-state, high-ridership (year 11+) | **€77 M / yr** | €154 |
| Lifecycle envelope (yr 1–35, low scenario) | **€2.59 bn cumulative** | €5,173 |
| Lifecycle envelope (yr 1–35, high scenario) | **€2.56 bn cumulative** | €5,124 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€15 M / yr (low) → €15 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €413 M | 4.5% | 35 y, 10 y grace | €28 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €172 M | 20.0% | 35 y, 10 y grace | €35 M / yr |
| Government equity (no debt service) | 15% | €103 M | — | — | — |
| **Total** | **100%** | **€688 M** | | | **€63 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €19 M / yr + bonds €34 M / yr = **€53 M / yr** total — plus the equity tranche amortised across construction (€10 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (352 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €381 k |
...
| Farebox revenue | €979 k / yr | €2.0 M / yr |
| Farebox / OPEX recovery | 6% | 12% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €15 M / yr | €15 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€78 M / yr** | **€77 M / yr** |
