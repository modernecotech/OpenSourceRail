...
|---|---|---|
| Construction (years 1–10) | **$67 M / yr** | $135 |
| Steady-state, low-ridership (year 11+) | **$81 M / yr** | $162 |
| Steady-state, high-ridership (year 11+) | **$79 M / yr** | $158 |
| Steady-state, operating-neutral revenue case | **$67 M / yr** | $133 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.70 bn cumulative** | $5,397 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.65 bn cumulative** | $5,301 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.34 bn cumulative** | $4,686 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $14 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $440 M | 4.5% | 35 y, 10 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $183 M | 20.0% | 35 y, 10 y grace | $37 M / yr |
| Government equity (no debt service) | 15% | $110 M | — | — | — |
| **Total** | **100%** | **$733 M** | | | **$67 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $20 M / yr + bonds $37 M / yr = **$56 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,250 | 93,750 | 334,513 |
| Daily paid trips / catchment | 18% | 30% | 107% |
| Daily paid trips / city population | 11% | 19% | 67% |
| Annual paid trips | 20.5 M | 34.2 M | 122.1 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $17 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 23% | 33% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $81 M / yr | $79 M / yr | **$67 M / yr** |
