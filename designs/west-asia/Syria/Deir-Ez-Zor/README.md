...
|---|---|---|
| Construction (years 1–10) | **$47 M / yr** | $93 |
| Steady-state, low-ridership (year 11+) | **$53 M / yr** | $105 |
| Steady-state, high-ridership (year 11+) | **$51 M / yr** | $102 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $92 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.78 bn cumulative** | $3,568 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.74 bn cumulative** | $3,472 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.62 bn cumulative** | $3,244 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.5 M / yr → $4.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $305 M | 4.5% | 35 y, 10 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $127 M | 20.0% | 35 y, 10 y grace | $26 M / yr |
| Government equity (no debt service) | 15% | $76 M | — | — | — |
| **Total** | **100%** | **$508 M** | | | **$46 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $14 M / yr + bonds $25 M / yr = **$39 M / yr** total — plus the equity tranche amortised across construction ($7.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,250 | 93,750 | 182,825 |
| Daily paid trips / catchment | 18% | 30% | 59% |
| Daily paid trips / city population | 11% | 19% | 37% |
| Annual paid trips | 20.5 M | 34.2 M | 66.7 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $9.3 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 39% | 57% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $53 M / yr | $51 M / yr | **$46 M / yr** |
