...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$759 M (86.7%) of external capital** and **$980 M of external interest**. Capital plus saved interest totals **$1.74 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (43.3 km @ $2.58 M/km) | $112 M |
...
|---|---:|---:|---:|---:|
| Civil works | $195 M | 15% | $29 M | $165 M |
...
| **Total city CAPEX** | **$486 M** | **24.0%** | **$117 M** | **$370 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$117 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$370 M** | **$37 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $296 M | $30 M / yr |
| **Total city programme** | **100.0%** | **$486 M** | **$49 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $656 M | $540 M (82.2%) | $697 M | **$1.24 bn** |
| **Default** | 2.00× | $875 M | $759 M (86.7%) | $980 M | **$1.74 bn** |
| High | 3.00× | $1.31 bn | $1.20 bn (91.1%) | $1.55 bn | **$2.74 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 86.7% below the illustrative foreign-company requirement of $875 M; the associated lifetime external-interest saving is $980 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$72 M / yr** | $144 |
| Steady-state, low capacity-use (year 11+) | **$64 M / yr** | $128 |
| Steady-state, high capacity-use (year 11+) | **$56 M / yr** | $112 |
| Steady-state, operating-neutral revenue case | **$67 M / yr** | $133 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.64 bn cumulative** | $5,282 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.39 bn cumulative** | $4,789 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.71 bn cumulative** | $5,428 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $2.4 M / yr → $11 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $117 M | 4.5% | 40 y, 10 y grace | $7.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $296 M | 20.0% | 40 y, 10 y grace | $59 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$486 M** | | | **$67 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.2 M / yr + local bonds $59 M / yr = **$64 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 60.3 M |
| Annual paid trips / city resident | 147 | 235 | 121 |
| Farebox revenue | $14 M / yr | $22 M / yr | $11 M / yr |
| Station shop leases | $297 k / yr | $297 k / yr | $297 k / yr |
| Advertising boards | $419 k / yr | $419 k / yr | $419 k / yr |
| **Total revenue** | **$14 M / yr** | **$23 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 120% | 189% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $67 M / yr | $67 M / yr | **$67 M / yr** |
| Operating surplus applied to debt support | -$2.4 M / yr | -$11 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $64 M / yr | $56 M / yr | **$67 M / yr** |
| Operating surplus after OPEX (before debt support) | $2.4 M / yr | $11 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $370 M | 76% of $486 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 109,995 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $447 M |
| Timetable-sized dedicated solar CAPEX | $39 M |
| **Reconciled project CAPEX** | **$486 M** |
| Imported / external-capital requirement | $117 M (24.0%) |
| Local-content / local-funding requirement | $370 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $875 M; OSR saves $759 M (86.7%) |
| Lifetime external interest and combined financing saving | $980 M interest; $1.74 bn capital + interest |
| 15%–25% planning risk envelope | $559 M–$608 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-313523 k / $-270701 k |
| Low/high project IRR | -8.0% / -2.0% |
| Low/high steady-state DSCR | 0.04 / 0.16 |
