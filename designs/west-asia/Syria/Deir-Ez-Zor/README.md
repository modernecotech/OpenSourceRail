...
|---|---|---|
| Construction (years 1–10) | **$37 M / yr** | $75 |
| Steady-state, low-ridership (year 11+) | **$42 M / yr** | $83 |
| Steady-state, high-ridership (year 11+) | **$40 M / yr** | $80 |
| Steady-state, operating-neutral revenue case | **$37 M / yr** | $74 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.42 bn cumulative** | $2,833 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.37 bn cumulative** | $2,738 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.30 bn cumulative** | $2,604 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $2.7 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $244 M | 4.5% | 35 y, 10 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $102 M | 20.0% | 35 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$37 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $20 M / yr = **$31 M / yr** total — plus the equity tranche amortised across construction ($6.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,250 | 93,750 | 146,152 |
| Daily paid trips / catchment | 18% | 30% | 47% |
| Daily paid trips / city population | 11% | 19% | 29% |
| Annual paid trips | 20.5 M | 34.2 M | 53.3 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $7.5 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 48% | 69% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $42 M / yr | $40 M / yr | **$37 M / yr** |
