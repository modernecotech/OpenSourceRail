...
| Bucket | Value |
|---|---|
| At-grade (47.7 km @ $2.0 M/km) | $95 M |
...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $60 |
| Steady-state, low-ridership (year 11+) | **$33 M / yr** | $66 |
| Steady-state, high-ridership (year 11+) | **$31 M / yr** | $62 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $60 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.13 bn cumulative** | $2,256 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.08 bn cumulative** | $2,161 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.05 bn cumulative** | $2,100 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.1 M / yr → $1.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $197 M | 4.5% | 35 y, 10 y grace | $13 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $82 M | 20.0% | 35 y, 10 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $49 M | — | — | — |
| **Total** | **100%** | **$329 M** | | | **$30 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $8.9 M / yr + bonds $16 M / yr = **$25 M / yr** total — plus the equity tranche amortised across construction ($4.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,250 | 93,750 | 117,334 |
| Daily paid trips / catchment | 18% | 30% | 38% |
| Daily paid trips / city population | 11% | 19% | 23% |
| Annual paid trips | 20.5 M | 34.2 M | 42.8 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $6.0 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$7.3 M / yr** |
| Revenue / OPEX recovery | 57% | 83% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $33 M / yr | $31 M / yr | **$30 M / yr** |
