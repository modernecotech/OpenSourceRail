...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **56,250 – 93,750 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$32 M / yr** | $64 |
| Steady-state, high-ridership (year 11+) | **$30 M / yr** | $59 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.10 bn cumulative** | $2,208 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.04 bn cumulative** | $2,081 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$302 M cumulative** | $605 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.2 M / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 75,000 | 125,000 | 702,647 |
| Daily paid trips / population | 15% | 25% | 141% |
| Annual paid trips | 27.4 M | 45.6 M | 256.5 M |
| Farebox revenue | $3.8 M / yr | $6.4 M / yr | $36 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$5.1 M / yr** | **$7.7 M / yr** | **$37 M / yr** |
| Revenue / OPEX + debt-service recovery | 14% | 21% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $32 M / yr | $30 M / yr | **$0 / yr** |
