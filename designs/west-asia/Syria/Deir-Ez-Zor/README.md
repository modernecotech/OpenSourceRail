...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **56,250 – 93,750 trips/day**
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 56.7 km × $0.015 M/km | $2.8 M |
...
|---|---|---|
| Construction (years 1–10) | **$35 M / yr** | $70 |
| Steady-state, low-ridership (year 11+) | **$39 M / yr** | $77 |
| Steady-state, high-ridership (year 11+) | **$37 M / yr** | $73 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $69 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.32 bn cumulative** | $2,630 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.27 bn cumulative** | $2,534 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.21 bn cumulative** | $2,426 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.1 M / yr → $2.2 M / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $95 M | 20.0% | 35 y, 10 y grace | $19 M / yr |
| Government equity (no debt service) | 15% | $57 M | — | — | — |
| **Total** | **100%** | **$380 M** | | | **$35 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $19 M / yr = **$29 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,250 | 93,750 | 136,003 |
| Daily paid trips / catchment | 18% | 30% | 44% |
| Daily paid trips / city population | 11% | 19% | 27% |
| Annual paid trips | 20.5 M | 34.2 M | 49.6 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $6.9 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$8.2 M / yr** |
| Revenue / OPEX recovery | 51% | 74% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $39 M / yr | $37 M / yr | **$35 M / yr** |
