...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **78,125 – 140,625 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$38 M / yr** | $76 |
| Steady-state, high-ridership (year 11+) | **$34 M / yr** | $68 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $40 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.32 bn cumulative** | $2,646 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.20 bn cumulative** | $2,391 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$789 M cumulative** | $1,577 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $18 M / yr → $14 M / yr._
...
|---|---|---|---|
| Daily paid trips | 78,125 | 140,625 | 339,652 |
| Daily paid trips / catchment | 25% | 45% | 109% |
| Daily paid trips / city population | 16% | 28% | 68% |
| Annual paid trips | 28.5 M | 51.3 M | 124.0 M |
| Farebox revenue | $5.3 M / yr | $9.6 M / yr | $23 M / yr |
| Station shop leases | $539 k / yr | $539 k / yr | $539 k / yr |
| Advertising boards | $747 k / yr | $747 k / yr | $747 k / yr |
| **Total revenue** | **$6.6 M / yr** | **$11 M / yr** | **$24 M / yr** |
| Revenue / OPEX recovery | 27% | 44% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov repayable-debt service + residual OPEX subsidy | $38 M / yr | $34 M / yr | **$20 M / yr** |
