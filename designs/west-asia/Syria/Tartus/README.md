...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$368 M (88.0%) of external capital** and **$476 M of external interest**. Capital plus saved interest totals **$844 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 27.8 km |
...
| Total fleet capacity | 14,400 AW2 pax (19,200 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 60 × 240 = **14,400 AW2 passengers** (19,200 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 17.0× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 339 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 39 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 47 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 12,939 train-km/day | One-way train journeys × route length |
| Annual service work | 5.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 112 MWh/day | 10.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 64 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 13.5 MW / 74 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 58 kWh | 118 kWh | 54 kWh | 4.4 km / 21 kWh |
| line-2 | 5 | 51 kWh | 98 kWh | 42 kWh | 3.0 km / 14 kWh |
| line-3 | 3 | 24 kWh | 65 kWh | 39 kWh | 3.4 km / 16 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (26.3 km @ $2.58 M/km) | $68 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 60 | $560 k | $34 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 120 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 120 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 13,485 kW @ $700/kW | $9.4 M |
| Grid interconnection / PPA tie-in | 13,485 kW @ $100/kW | $1.3 M |
| Annual generation proxy | 13.5 MW × 5.5 peak-sun-h/day × 365 d/yr | 27.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 27.8 km × $0.050 M/km | $1.4 M |
...
|---|---:|---:|---:|---:|
| Civil works | $87 M | 15% | $13 M | $74 M |
| Stations | $76 M | 20% | $15 M | $60 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $34 M | 35% | $12 M | $22 M |
| Dedicated solar plant | $11 M | 45% | $4.9 M | $5.9 M |
| Residual signalling / train control | $1.4 M | 50% | $696 k | $696 k |
| Charging microgrids | $1.5 M | 40% | $610 k | $915 k |
| EPC / project services | $15 M | 15% | $2.2 M | $12 M |
| **Total city CAPEX** | **$233 M** | **21.6%** | **$50 M** | **$182 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh tartus`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.6%** | **$50 M** | **$5.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.4%** | **$182 M** | **$18 M / yr** |
| of which planned local bond issuance | 62.7% of total CAPEX | $146 M | $15 M / yr |
| **Total city programme** | **100.0%** | **$233 M** | **$23 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $314 M | $264 M (84.0%) | $341 M | **$604 M** |
| **Default** | 2.00× | $419 M | $368 M (88.0%) | $476 M | **$844 M** |
| High | 3.00× | $628 M | $578 M (92.0%) | $746 M | **$1.32 bn** |

At the default 2.00× case, OSR's $50 M external requirement is 88.0% below the illustrative foreign-company requirement of $419 M; the associated lifetime external-interest saving is $476 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$35 M / yr** | $140 |
| Steady-state, low capacity-use (year 11+) | **$28 M / yr** | $111 |
| Steady-state, high capacity-use (year 11+) | **$22 M / yr** | $89 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $129 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.19 bn cumulative** | $4,744 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.02 bn cumulative** | $4,087 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.32 bn cumulative** | $5,287 |

_Population basis: 250,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.5 M / yr → $10 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $50 M | 4.5% | 40 y, 10 y grace | $3.1 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $146 M | 20.0% | 40 y, 10 y grace | $29 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $36 M | — | — | — |
| **Total** | **100%** | **$233 M** | | | **$32 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.3 M / yr + local bonds $29 M / yr = **$31 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $70 k |
| Traction energy (40.8 GWh / yr) | 12,939 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 17.3 GWh/yr + dedicated solar plant 13.5 MW / 27.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $162 k |
| Labour (232 FTE) | driverless roster: OCC/remote 49, station/platform 61, passenger service 38, fleet maintenance 36, infrastructure/energy 27, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $273 k |
| **OPEX subtotal** | | **$5.3 M / yr** |

_Annual service work: 12,939 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.1 M train-km / yr (10.2 M car-km / yr). On-site PV covers 17.3 GWh/yr and the dedicated solar plant adds 27.1 GWh/yr against 40.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 60 trainsets, 13 stations, 27.8 route-km, 3 lines, and 12,939 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 24.6 M |
| Annual paid trips / city resident | 196 | 313 | 99 |
| Farebox revenue | $9.1 M / yr | $15 M / yr | $4.6 M / yr |
| Station shop leases | $280 k / yr | $280 k / yr | $280 k / yr |
| Advertising boards | $386 k / yr | $386 k / yr | $386 k / yr |
| **Total revenue** | **$9.8 M / yr** | **$15 M / yr** | **$5.3 M / yr** |
| Revenue / OPEX recovery | 186% | 290% | 100% |
...
| Operating surplus applied to debt support | -$4.5 M / yr | -$10 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $28 M / yr | $22 M / yr | **$32 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.5 M / yr | $10 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,648 m² of station shop/kiosk leases at $10/m²/month and 504 advertising boards at $75/board/month, with occupancy derates applied._
...
| Avoided CO2e | $881 k / yr | $1.4 M / yr | 11.0–17.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Entertainment / community activity supported | $7.8 M / yr | $13 M / yr | 11% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 8,571 trips/school day; 1.9 M access-events/yr | 13,713 trips/school day; 3.0 M access-events/yr |
| Healthcare | 3 healthcare anchors | 11,785 trips/day; 4.3 M access-events/yr | 18,856 trips/day; 6.9 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 32,244 trips/trading day; 10.6 M access-events/yr | 51,590 trips/trading day; 17.0 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,319 trips/activity day; 4.3 M access-events/yr | 22,911 trips/activity day; 6.9 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $182 M | 78% of $233 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $292 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $29 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 54,245 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $222 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$233 M** |
| Imported / external-capital requirement | $50 M (21.6%) |
| Local-content / local-funding requirement | $182 M (78.4%) |
| Default foreign-turnkey external-capital comparison | $419 M; OSR saves $368 M (88.0%) |
| Lifetime external interest and combined financing saving | $476 M interest; $844 M capital + interest |
| 15%–25% planning risk envelope | $267 M–$291 M |
| Annual OPEX | $5.3 M / yr |
| Low/high project NPV at 8% | $-132434 k / $-103886 k |
| Low/high project IRR | -2.5% / 1.3% |
| Low/high steady-state DSCR | 0.14 / 0.31 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,228.96 train-km; 5,898.44 kWh consumed; 6,428.19 kWh charged; 39 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 12,984.03 train-km; 62,317.56 kWh consumed; 63,574.11 kWh charged; 485 depot services completed (6 active at cutoff); minimum SoC 82%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 78.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 81.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.9% / 60% | pass |
| ten-hour single charging-pad outage | 80.0% | 100.0% / 90% | pass |
...
|---|---|
| ![Tartus energy and battery simulation dashboard](engineering/screenshots/tartus-simulation-dashboard.png) | ![Tartus simulator network visualizer](engineering/screenshots/tartus-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 13 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
...
|---|---|
| ![Tartus QGIS engineering layers](engineering/screenshots/tartus-qgis-engineering-map.png) | ![Tartus SUMO timetable validation](engineering/screenshots/tartus-sumo-validation.png) |
