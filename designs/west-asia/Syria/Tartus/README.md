...
|---|---|---|
| Construction (years 1–10) | **$24 M / yr** | $97 |
| Steady-state, low-ridership (year 11+) | **$27 M / yr** | $107 |
| Steady-state, high-ridership (year 11+) | **$26 M / yr** | $102 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $96 |
| Lifecycle envelope (yr 1–35, low scenario) | **$910 M cumulative** | $3,640 |
| Lifecycle envelope (yr 1–35, high scenario) | **$882 M cumulative** | $3,527 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$841 M cumulative** | $3,365 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.7 M / yr → $1.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $158 M | 4.5% | 35 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $66 M | 20.0% | 35 y, 10 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $39 M | — | — | — |
| **Total** | **100%** | **$263 M** | | | **$24 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $7.1 M / yr + bonds $13 M / yr = **$20 M / yr** total — plus the equity tranche amortised across construction ($3.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 33,030 | 55,050 | 86,821 |
| Daily paid trips / catchment | 18% | 30% | 47% |
| Daily paid trips / city population | 13% | 22% | 35% |
| Annual paid trips | 12.1 M | 20.1 M | 31.7 M |
| Farebox revenue | $1.7 M / yr | $2.8 M / yr | $4.4 M / yr |
| Station shop leases | $464 k / yr | $464 k / yr | $464 k / yr |
| Advertising boards | $630 k / yr | $630 k / yr | $630 k / yr |
| **Total revenue** | **$2.8 M / yr** | **$3.9 M / yr** | **$5.5 M / yr** |
| Revenue / OPEX recovery | 50% | 71% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $27 M / yr | $26 M / yr | **$24 M / yr** |
