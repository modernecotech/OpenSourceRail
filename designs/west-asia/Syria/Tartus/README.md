...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **18,350 – 27,525 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (31.6 km @ $1.2 M/km) | $38 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 35.0 km × $0.015 M/km | $525 k |
...
|---|---|---|
| Construction (years 1–10) | **$13 M / yr** | $51 |
| Steady-state, low-ridership (year 11+) | **$14 M / yr** | $55 |
| Steady-state, high-ridership (year 11+) | **$13 M / yr** | $51 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$467 M cumulative** | $1,868 |
| Lifecycle envelope (yr 1–35, high scenario) | **$445 M cumulative** | $1,778 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$126 M cumulative** | $505 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.1 M / yr → $240 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $82 M | 4.5% | 35 y, 10 y grace | $5.6 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $34 M | 20.0% | 35 y, 10 y grace | $6.9 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$137 M** | | | **$12 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.7 M / yr + bonds $6.9 M / yr = **$11 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 286,650 |
| Daily paid trips / population | 8% | 15% | 115% |
| Annual paid trips | 7.3 M | 13.7 M | 104.6 M |
| Farebox revenue | $1.0 M / yr | $1.9 M / yr | $15 M / yr |
| Station shop leases | $464 k / yr | $464 k / yr | $464 k / yr |
| Advertising boards | $630 k / yr | $630 k / yr | $630 k / yr |
| **Total revenue** | **$2.1 M / yr** | **$3.0 M / yr** | **$16 M / yr** |
| Revenue / OPEX + debt-service recovery | 13% | 19% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $14 M / yr | $13 M / yr | **$0 / yr** |
