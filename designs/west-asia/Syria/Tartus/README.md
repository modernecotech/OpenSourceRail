...
|---|---|---|
| Construction (years 1–10) | **€43 M / yr** | €173 |
| Steady-state, low-ridership (year 11+) | **€53 M / yr** | €213 |
| Steady-state, high-ridership (year 11+) | **€53 M / yr** | €211 |
| Lifecycle envelope (yr 1–35, low scenario) | **€1.76 bn cumulative** | €7,050 |
| Lifecycle envelope (yr 1–35, high scenario) | **€1.75 bn cumulative** | €7,001 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€10 M / yr (low) → €9.8 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €282 M | 4.5% | 35 y, 10 y grace | €19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €118 M | 20.0% | 35 y, 10 y grace | €24 M / yr |
| Government equity (no debt service) | 15% | €71 M | — | — | — |
| **Total** | **100%** | **€471 M** | | | **€43 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €13 M / yr + bonds €24 M / yr = **€36 M / yr** total — plus the equity tranche amortised across construction (€7.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Farebox revenue | €490 k / yr | €979 k / yr |
| Farebox / OPEX recovery | 5% | 9% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €10 M / yr | €9.8 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€53 M / yr** | **€53 M / yr** |
