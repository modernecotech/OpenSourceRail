...
| Bucket | Value |
|---|---|
| At-grade (31.6 km @ $0.85 M/km) | $27 M |
...
| Per-capita (city pop) | $444 / person |
...
| Steady-state, low-ridership (year 11+) | **$11 M / yr** | $43 |
| Steady-state, high-ridership (year 11+) | **$9.9 M / yr** | $39 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$371 M cumulative** | $1,484 |
| Lifecycle envelope (yr 1–35, high scenario) | **$349 M cumulative** | $1,394 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$102 M cumulative** | $409 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $645 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $67 M | 4.5% | 35 y, 10 y grace | $4.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $28 M | 20.0% | 35 y, 10 y grace | $5.6 M / yr |
| Government equity (no debt service) | 15% | $17 M | — | — | — |
| **Total** | **100%** | **$111 M** | | | **$10 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.0 M / yr + bonds $5.6 M / yr = **$8.6 M / yr** total — plus the equity tranche amortised across construction ($1.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 20,000 | 37,500 | 230,404 |
| Daily paid trips / population | 8% | 15% | 92% |
| Annual paid trips | 7.3 M | 13.7 M | 84.1 M |
| Farebox revenue | $1.0 M / yr | $1.9 M / yr | $12 M / yr |
| Station shop leases | $464 k / yr | $464 k / yr | $464 k / yr |
| Advertising boards | $630 k / yr | $630 k / yr | $630 k / yr |
| **Total revenue** | **$2.1 M / yr** | **$3.0 M / yr** | **$13 M / yr** |
| Revenue / OPEX + debt-service recovery | 16% | 23% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $11 M / yr | $9.9 M / yr | **$0 / yr** |
