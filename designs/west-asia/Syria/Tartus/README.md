...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$394 M (88.2%) of external capital** and **$508 M of external interest**. Capital plus saved interest totals **$902 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (26.3 km @ $3.0 M/km) | $79 M |
| Elevated (1.5 km @ $12.0 M/km) | $18 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$102 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $102 M | 15% | $15 M | $86 M |
...
| EPC / project services | $16 M | 15% | $2.3 M | $13 M |
| **Total city CAPEX** | **$248 M** | **21.2%** | **$53 M** | **$195 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.2%** | **$53 M** | **$5.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.8%** | **$195 M** | **$20 M / yr** |
| of which planned local bond issuance | 63.0% of total CAPEX | $156 M | $16 M / yr |
| **Total city programme** | **100.0%** | **$248 M** | **$25 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $335 M | $282 M (84.3%) | $364 M | **$646 M** |
| **Default** | 2.00× | $446 M | $394 M (88.2%) | $508 M | **$902 M** |
| High | 3.00× | $669 M | $617 M (92.1%) | $797 M | **$1.41 bn** |

At the default 2.00× case, OSR's $53 M external requirement is 88.2% below the illustrative foreign-company requirement of $446 M; the associated lifetime external-interest saving is $508 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$38 M / yr** | $150 |
| Steady-state, low capacity-use (year 11+) | **$30 M / yr** | $121 |
| Steady-state, high capacity-use (year 11+) | **$25 M / yr** | $100 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $138 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.29 bn cumulative** | $5,145 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.12 bn cumulative** | $4,488 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.41 bn cumulative** | $5,654 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $53 M | 4.5% | 40 y, 10 y grace | $3.2 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $156 M | 20.0% | 40 y, 10 y grace | $31 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $39 M | — | — | — |
| **Total** | **100%** | **$248 M** | | | **$35 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.4 M / yr + local bonds $31 M / yr = **$34 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 26.2 M |
| Annual paid trips / city resident | 196 | 313 | 105 |
...
| **Total revenue** | **$9.8 M / yr** | **$15 M / yr** | **$5.5 M / yr** |
| Revenue / OPEX recovery | 176% | 275% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $30 M / yr | $25 M / yr | **$35 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $195 M | 79% of $248 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $313 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $31 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 58,129 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $237 M |
| Timetable-sized dedicated solar CAPEX | $11 M |
| **Reconciled project CAPEX** | **$248 M** |
| Imported / external-capital requirement | $53 M (21.2%) |
| Local-content / local-funding requirement | $195 M (78.8%) |
| Default foreign-turnkey external-capital comparison | $446 M; OSR saves $394 M (88.2%) |
| Lifetime external interest and combined financing saving | $508 M interest; $902 M capital + interest |
| 15%–25% planning risk envelope | $285 M–$310 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $-144234 k / $-115686 k |
| Low/high project IRR | -3.1% / 0.8% |
| Low/high steady-state DSCR | 0.12 / 0.28 |
