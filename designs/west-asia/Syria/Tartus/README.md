...
| Per-capita (city pop) | $1,390 / person |
...
| Steady-state, low-ridership (year 11+) | **$36 M / yr** | $144 |
| Steady-state, high-ridership (year 11+) | **$35 M / yr** | $139 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $126 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.22 bn cumulative** | $4,872 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.19 bn cumulative** | $4,759 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.11 bn cumulative** | $4,440 |

_Population basis: 250,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.3 M / yr → $3.2 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $208 M | 4.5% | 35 y, 10 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $87 M | 20.0% | 35 y, 10 y grace | $18 M / yr |
| Government equity (no debt service) | 15% | $52 M | — | — | — |
| **Total** | **100%** | **$347 M** | | | **$32 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $9.4 M / yr + bonds $17 M / yr = **$27 M / yr** total — plus the equity tranche amortised across construction ($5.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 33,030 | 55,050 | 117,584 |
| Daily paid trips / catchment | 18% | 30% | 64% |
| Daily paid trips / city population | 13% | 22% | 47% |
| Annual paid trips | 12.1 M | 20.1 M | 42.9 M |
| Farebox revenue | $1.7 M / yr | $2.8 M / yr | $6.0 M / yr |
| Station shop leases | $464 k / yr | $464 k / yr | $464 k / yr |
| Advertising boards | $630 k / yr | $630 k / yr | $630 k / yr |
| **Total revenue** | **$2.8 M / yr** | **$3.9 M / yr** | **$7.1 M / yr** |
| Revenue / OPEX recovery | 39% | 55% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $36 M / yr | $35 M / yr | **$32 M / yr** |
