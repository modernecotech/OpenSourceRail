...
|---|---|---|
| Construction (years 1–10) | **$45 M / yr** | $65 |
| Steady-state, low-ridership (year 11+) | **$53 M / yr** | $76 |
| Steady-state, high-ridership (year 11+) | **$51 M / yr** | $72 |
| Steady-state, operating-neutral revenue case | **$45 M / yr** | $64 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.78 bn cumulative** | $2,536 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.72 bn cumulative** | $2,453 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.57 bn cumulative** | $2,246 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.1 M / yr → $5.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $295 M | 4.5% | 35 y, 10 y grace | $20 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $123 M | 20.0% | 35 y, 10 y grace | $25 M / yr |
| Government equity (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$492 M** | | | **$45 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $25 M / yr = **$38 M / yr** total — plus the equity tranche amortised across construction ($7.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 68,166 | 113,610 | 226,990 |
| Daily paid trips / catchment | 18% | 30% | 60% |
| Daily paid trips / city population | 10% | 16% | 32% |
| Annual paid trips | 24.9 M | 41.5 M | 82.9 M |
| Farebox revenue | $3.5 M / yr | $5.8 M / yr | $12 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $633 k / yr | $633 k / yr | $633 k / yr |
| **Total revenue** | **$4.6 M / yr** | **$6.9 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 36% | 54% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $53 M / yr | $51 M / yr | **$45 M / yr** |
