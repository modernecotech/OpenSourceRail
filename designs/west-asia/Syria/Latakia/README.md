...
|---|---|---|---|---|
| line-1 | 18.2 km | 10 | 48 | SW Mid ↔ E Outer |
| line-2 | 11.5 km | 7 | 30 | W Mid ↔ NE Mid |
| line-3 | 13.1 km | 8 | 35 | SW Mid ↔ NW Outer |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **40.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 15.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 505 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 60 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 65 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 193 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 40.3 MW / 222 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 131 kWh | 229 kWh | 84 kWh | 4.9 km / 35 kWh |
| line-2 | 7 | 83 kWh | 151 kWh | 60 kWh | 2.3 km / 17 kWh |
| line-3 | 8 | 95 kWh | 172 kWh | 67 kWh | 2.1 km / 15 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (41.5 km @ $3.0 M/km) | $125 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 40,300 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 40,300 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 40.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 80.9 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$26 M / yr** | $36 |
| Steady-state, low capacity-use (year 11+) | **$18 M / yr** | $26 |
| Steady-state, high capacity-use (year 11+) | **$9.9 M / yr** | $14 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $32 |
| Lifecycle envelope (yr 1–40, low scenario) | **$798 M cumulative** | $1,140 |
| Lifecycle envelope (yr 1–40, high scenario) | **$552 M cumulative** | $788 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$927 M cumulative** | $1,324 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $365 M | 4.5% | 40 y, 10 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $91 M | — | — | — |
| **Total** | **100%** | **$456 M** | | | **$22 M / yr** |
...
| Traction energy (94.2 GWh / yr) | 19,922 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.9 GWh/yr + dedicated solar plant 40.3 MW / 80.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $484 k |
| Labour (348 FTE) | driverless roster: OCC/remote 73, station/platform 103, passenger service 49, fleet maintenance 61, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $409 k |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 19,922 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.9 M train-km / yr (23.6 M car-km / yr). On-site PV covers 23.9 GWh/yr and the dedicated solar plant adds 80.9 GWh/yr against 94.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 113 trainsets, 25 stations, 42.8 route-km, 3 lines, and 19,922 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 50.3 M |
...
| **Total revenue** | **$15 M / yr** | **$23 M / yr** | **$10 M / yr** |
| Revenue / OPEX recovery | 141% | 220% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $9.9 M / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.3 M / yr | $13 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,192 m² of station shop/kiosk leases at $10/m²/month and 796 advertising boards at $75/board/month, with occupancy derates applied._
...
| Healthcare | 7 healthcare anchors | 21,139 trips/day; 7.7 M access-events/yr | 33,822 trips/day; 12.3 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 43,109 trips/trading day; 14.2 M access-events/yr | 68,974 trips/trading day; 22.8 M access-events/yr |
...
| Construction-phase local economic activity | $410 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $41 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 76,245 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $524 M–$570 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-283438 k / $-240616 k |
| Low/high project IRR | -5.6% / -1.0% |
| Low/high steady-state DSCR | 0.19 / 0.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,744.24 train-km; 12,557.76 kWh consumed; 13,323.79 kWh charged; 32 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,633.57 train-km; 148,552.26 kWh consumed; 151,811.03 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 68%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 60.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 55.9% | 100.0% / 90% | pass |
| 50% charging-contact availability | 67.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.5% / 60% | pass |
| ten-hour single charging-pad outage | 35.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 3 interchange complexes, 18 civil segments, and 0 input findings |
