...
| EPC / project services | $22 M | 45% | $9.7 M | $12 M |
| **Total city CAPEX** | **$364 M** | **45.1%** | **$164 M** | **$200 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **45.1%** | **$164 M** | **$16 M / yr** |
| **Local capital for domestic procurement / payroll** | **54.9%** | **$200 M** | **$20 M / yr** |
| of which planned local bond issuance | 43.9% of total CAPEX | $160 M | $16 M / yr |
...
|---|---|---|
| Construction (years 1–10) | **$43 M / yr** | $62 |
| Steady-state, low capacity-use (year 11+) | **$36 M / yr** | $52 |
| Steady-state, high capacity-use (year 11+) | **$28 M / yr** | $40 |
| Steady-state, operating-neutral revenue case | **$42 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.53 bn cumulative** | $2,183 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.28 bn cumulative** | $1,831 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.70 bn cumulative** | $2,429 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $164 M | 4.5% | 40 y, 10 y grace | $10 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $160 M | 20.0% | 40 y, 10 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $40 M | — | — | — |
| **Total** | **100%** | **$364 M** | | | **$42 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $7.4 M / yr + local bonds $32 M / yr = **$39 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $36 M / yr | $28 M / yr | **$42 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $200 M | 55% of $364 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $320 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $32 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 59,516 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $164 M (45.1%) |
| Local-content / local-funding requirement | $200 M (54.9%) |
