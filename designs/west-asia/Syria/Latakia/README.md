...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$536 M (86.3%) of external capital** and **$692 M of external interest**. Capital plus saved interest totals **$1.23 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 57.2%
- Catchment population: **≈ 400,399** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 13.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 501 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 43 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 19,922 train-km/day | One-way train journeys × route length |
...
| On-site PV shortfall before solar plant | 204 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 42.7 MW / 235 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 131 kWh | 220 kWh | 76 kWh | 4.6 km / 33 kWh |
| line-2 | 5 | 83 kWh | 143 kWh | 52 kWh | 5.4 km / 39 kWh |
| line-3 | 6 | 95 kWh | 147 kWh | 43 kWh | 3.6 km / 26 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (42.7 km @ $2.58 M/km) | $110 M |
| Elevated (0.2 km @ $9.75 M/km) | $1.8 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 42,715 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 42,715 kW @ $100/kW | $4.3 M |
| Annual generation proxy | 42.7 MW × 5.5 peak-sun-h/day × 365 d/yr | 85.7 GWh/yr |
...
| Per-capita (city pop) | $492 / person |
...
| Rolling stock | $84 M | 35% | $29 M | $54 M |
...
| **Total city CAPEX** | **$345 M** | **24.6%** | **$85 M** | **$260 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh latakia`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$85 M** | **$8.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$260 M** | **$26 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $208 M | $21 M / yr |
| **Total city programme** | **100.0%** | **$345 M** | **$34 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $465 M | $381 M (81.8%) | $492 M | **$872 M** |
| **Default** | 2.00× | $620 M | $536 M (86.3%) | $692 M | **$1.23 bn** |
| High | 3.00× | $931 M | $846 M (90.9%) | $1.09 bn | **$1.94 bn** |

At the default 2.00× case, OSR's $85 M external requirement is 86.3% below the illustrative foreign-company requirement of $620 M; the associated lifetime external-interest saving is $692 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$51 M / yr** | $72 |
| Steady-state, low capacity-use (year 11+) | **$41 M / yr** | $58 |
| Steady-state, high capacity-use (year 11+) | **$33 M / yr** | $47 |
| Steady-state, operating-neutral revenue case | **$47 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.73 bn cumulative** | $2,474 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.49 bn cumulative** | $2,122 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.91 bn cumulative** | $2,736 |

_Population basis: 700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.1 M / yr → $14 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $85 M | 4.5% | 40 y, 10 y grace | $5.2 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $208 M | 20.0% | 40 y, 10 y grace | $42 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $52 M | — | — | — |
| **Total** | **100%** | **$345 M** | | | **$47 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.8 M / yr + local bonds $42 M / yr = **$45 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (94.2 GWh / yr) | 19,922 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.7 GWh/yr + dedicated solar plant 42.7 MW / 85.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $513 k |
| Labour (307 FTE) | driverless roster: OCC/remote 65, station/platform 79, passenger service 49, fleet maintenance 55, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $361 k |
| **OPEX subtotal** | | **$8.4 M / yr** |

_Annual service work: 19,922 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.9 M train-km / yr (23.6 M car-km / yr). On-site PV covers 19.7 GWh/yr and the dedicated solar plant adds 85.7 GWh/yr against 94.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 93 trainsets, 17 stations, 42.8 route-km, 3 lines, and 19,922 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 40.6 M |
| Annual paid trips / city resident | 105 | 168 | 58 |
| Farebox revenue | $14 M / yr | $22 M / yr | $7.6 M / yr |
| Station shop leases | $337 k / yr | $337 k / yr | $337 k / yr |
| Advertising boards | $462 k / yr | $462 k / yr | $462 k / yr |
| **Total revenue** | **$14 M / yr** | **$23 M / yr** | **$8.4 M / yr** |
| Revenue / OPEX recovery | 173% | 271% | 100% |
...
| Operating surplus applied to debt support | -$6.1 M / yr | -$14 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $41 M / yr | $33 M / yr | **$47 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.1 M / yr | $14 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,192 m² of station shop/kiosk leases at $10/m²/month and 604 advertising boards at $75/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$60 M / yr** | **$95 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $260 M | 75% of $345 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $416 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $42 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 77,344 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$345 M** |
| Imported / external-capital requirement | $85 M (24.6%) |
| Local-content / local-funding requirement | $260 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $620 M; OSR saves $536 M (86.3%) |
| Lifetime external interest and combined financing saving | $692 M interest; $1.23 bn capital + interest |
| 15%–25% planning risk envelope | $396 M–$431 M |
| Annual OPEX | $8.4 M / yr |
| Low/high project NPV at 8% | $-199461 k / $-156639 k |
| Low/high project IRR | -3.0% / 1.1% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,740.18 train-km; 12,528.37 kWh consumed; 12,269.42 kWh charged; 34 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,694.15 train-km; 141,787.62 kWh consumed; 143,123.95 kWh charged; 502 depot services completed (6 active at cutoff); minimum SoC 39%; 0 onboard emergencies; 0 invariant violations; 98.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 25.0% | 98.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 98.1% / 90% | pass |
| 50% charging-contact availability | 39.0% | 98.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.1% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 98.2% / 90% | pass |
...
|---|---|
| ![Latakia energy and battery simulation dashboard](engineering/screenshots/latakia-simulation-dashboard.png) | ![Latakia simulator network visualizer](engineering/screenshots/latakia-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 17 line platforms, 2 interchange complexes, 16 civil segments, and 0 input findings |
...
|---|---|
| ![Latakia QGIS engineering layers](engineering/screenshots/latakia-qgis-engineering-map.png) | ![Latakia SUMO timetable validation](engineering/screenshots/latakia-sumo-validation.png) |
