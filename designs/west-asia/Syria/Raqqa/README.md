...
| Bucket | Value |
|---|---|
| At-grade (41.6 km @ $0.85 M/km) | $35 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 44.9 km × $0.015 M/km | $673 k |
...
|---|---|---|
| Construction (years 1–10) | **$12 M / yr** | $34 |
| Steady-state, low-ridership (year 11+) | **$13 M / yr** | $36 |
| Steady-state, high-ridership (year 11+) | **$11 M / yr** | $33 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$435 M cumulative** | $1,244 |
| Lifecycle envelope (yr 1–35, high scenario) | **$404 M cumulative** | $1,154 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$119 M cumulative** | $339 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $908 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $77 M | 4.5% | 35 y, 10 y grace | $5.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $32 M | 20.0% | 35 y, 10 y grace | $6.5 M / yr |
| Government equity (no debt service) | 15% | $19 M | — | — | — |
| **Total** | **100%** | **$129 M** | | | **$12 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.5 M / yr + bonds $6.5 M / yr = **$9.9 M / yr** total — plus the equity tranche amortised across construction ($1.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,000 | 52,500 | 275,752 |
| Daily paid trips / population | 8% | 15% | 79% |
| Annual paid trips | 10.2 M | 19.2 M | 100.6 M |
| Farebox revenue | $1.4 M / yr | $2.7 M / yr | $14 M / yr |
| Station shop leases | $438 k / yr | $438 k / yr | $438 k / yr |
| Advertising boards | $609 k / yr | $609 k / yr | $609 k / yr |
| **Total revenue** | **$2.5 M / yr** | **$3.7 M / yr** | **$15 M / yr** |
| Revenue / OPEX + debt-service recovery | 16% | 25% | 100% |
