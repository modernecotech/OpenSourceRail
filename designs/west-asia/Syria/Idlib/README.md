...
|---|---|---|---|---|
| line-1 | 12.4 km | 7 | 36 | NE Outer ↔ SW Mid |
| line-2 |  8.9 km | 5 | 26 | W Mid ↔ S Outer |
| line-3 | 10.7 km | 6 | 31 | NE Outer ↔ W Inner |
| **Total** | **32.0 km** | **18 unique** | **93** | |
...
| Total fleet capacity | 22,320 AW2 pax (29,760 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 93 × 240 = **22,320 AW2 passengers** (29,760 AW3 crush, incl. service rotation + spare + reserve)
...
| Onboard battery adequacy | 14.1× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 334 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 16.3 MW / 89 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 59 kWh | 123 kWh | 57 kWh | 5.3 km / 26 kWh |
| line-2 | 4 | 43 kWh | 82 kWh | 35 kWh | 4.4 km / 21 kWh |
| line-3 | 5 | 52 kWh | 98 kWh | 41 kWh | 5.0 km / 24 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 93 | $560 k | $52 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 186 | $60 k | $11 M |
| High sensitivity check | 186 | $120 k | $22 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 16,262 kW @ $700/kW | $11 M |
| Grid interconnection / PPA tie-in | 16,262 kW @ $100/kW | $1.6 M |
| Annual generation proxy | 16.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 32.6 GWh/yr |
...
| Steady-state, low capacity-use (year 11+) | **$11 M / yr** | $38 |
| Steady-state, high capacity-use (year 11+) | **$6.0 M / yr** | $20 |
| Steady-state, operating-neutral revenue case | **$15 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$511 M cumulative** | $1,705 |
| Lifecycle envelope (yr 1–40, high scenario) | **$347 M cumulative** | $1,157 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$606 M cumulative** | $2,019 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.1 M / yr → $8.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $238 M | 4.5% | 40 y, 10 y grace | $15 M / yr |
| Government equity (no debt service) | 20% | $60 M | — | — | — |
| **Total** | **100%** | **$298 M** | | | **$15 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $11 M / yr = **$11 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (46.9 GWh / yr) | 14,858 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 18.5 GWh/yr + dedicated solar plant 16.3 MW / 32.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $195 k |
| Labour (270 FTE) | driverless roster: OCC/remote 65, station/platform 66, passenger service 38, fleet maintenance 48, infrastructure/energy 32, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $318 k |
| **OPEX subtotal** | | **$6.7 M / yr** |

_Annual service work: 14,858 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.7 M car-km / yr). On-site PV covers 18.5 GWh/yr and the dedicated solar plant adds 32.6 GWh/yr against 46.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 93 trainsets, 18 stations, 32.0 route-km, 3 lines, and 14,858 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 32.0 M |
| Annual paid trips / city resident | 163 | 261 | 107 |
| Farebox revenue | $9.1 M / yr | $15 M / yr | $6.0 M / yr |
| Station shop leases | $284 k / yr | $284 k / yr | $284 k / yr |
| Advertising boards | $404 k / yr | $404 k / yr | $404 k / yr |
| **Total revenue** | **$9.8 M / yr** | **$15 M / yr** | **$6.7 M / yr** |
| Revenue / OPEX recovery | 147% | 229% | 100% |
...
| Operating surplus applied to debt support | -$3.1 M / yr | -$8.6 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $11 M / yr | $6.0 M / yr | **$15 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.1 M / yr | $8.6 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,688 m² of station shop/kiosk leases at $10/m²/month and 528 advertising boards at $75/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$35 M / yr** | **$57 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 9 major/terminal/interchange nodes | 28,458 trips/trading day; 9.4 M access-events/yr | 45,533 trips/trading day; 15.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $172 M | 58% of $298 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 51,321 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-183505 k / $-154957 k |
| Low/high project IRR | -5.2% / -0.7% |
| Low/high steady-state DSCR | 0.21 / 0.59 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,434.34 train-km; 6,884.21 kWh consumed; 7,233.09 kWh charged; 38 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 15,458.33 train-km; 74,193.09 kWh consumed; 76,111.51 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 85.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 78.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 87.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 76.3% | 100.0% / 90% | pass |
