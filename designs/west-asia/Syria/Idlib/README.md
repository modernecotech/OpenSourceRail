...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$384 M (87.8%) of external capital** and **$496 M of external interest**. Capital plus saved interest totals **$880 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (30.7 km @ $2.58 M/km) | $79 M |
...
| Per-capita (city pop) | $810 / person |
...
| EPC / project services | $15 M | 15% | $2.2 M | $13 M |
| **Total city CAPEX** | **$243 M** | **22.0%** | **$53 M** | **$190 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.0%** | **$53 M** | **$5.3 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.0%** | **$190 M** | **$19 M / yr** |
| of which planned local bond issuance | 62.4% of total CAPEX | $152 M | $15 M / yr |
| **Total city programme** | **100.0%** | **$243 M** | **$24 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $328 M | $275 M (83.7%) | $355 M | **$630 M** |
| **Default** | 2.00× | $438 M | $384 M (87.8%) | $496 M | **$880 M** |
| High | 3.00× | $656 M | $603 M (91.9%) | $779 M | **$1.38 bn** |

At the default 2.00× case, OSR's $53 M external requirement is 87.8% below the illustrative foreign-company requirement of $438 M; the associated lifetime external-interest saving is $496 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$37 M / yr** | $122 |
| Steady-state, low capacity-use (year 11+) | **$30 M / yr** | $99 |
| Steady-state, high capacity-use (year 11+) | **$24 M / yr** | $80 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $113 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.25 bn cumulative** | $4,176 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.09 bn cumulative** | $3,628 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.38 bn cumulative** | $4,594 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $4.2 M / yr → $9.7 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $53 M | 4.5% | 40 y, 10 y grace | $3.3 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $152 M | 20.0% | 40 y, 10 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $38 M | — | — | — |
| **Total** | **100%** | **$243 M** | | | **$34 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.4 M / yr + local bonds $30 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($3.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 26.5 M |
| Annual paid trips / city resident | 163 | 261 | 88 |
| Farebox revenue | $9.1 M / yr | $15 M / yr | $4.9 M / yr |
| Station shop leases | $253 k / yr | $253 k / yr | $253 k / yr |
| Advertising boards | $352 k / yr | $352 k / yr | $352 k / yr |
| **Total revenue** | **$9.7 M / yr** | **$15 M / yr** | **$5.5 M / yr** |
| Revenue / OPEX recovery | 175% | 274% | 100% |
...
| Operating surplus applied to debt support | -$4.2 M / yr | -$9.7 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $30 M / yr | $24 M / yr | **$34 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.2 M / yr | $9.7 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $190 M | 78% of $243 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $304 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $30 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 56,460 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $229 M |
| Timetable-sized dedicated solar CAPEX | $14 M |
| **Reconciled project CAPEX** | **$243 M** |
| Imported / external-capital requirement | $53 M (22.0%) |
| Local-content / local-funding requirement | $190 M (78.0%) |
| Default foreign-turnkey external-capital comparison | $438 M; OSR saves $384 M (87.8%) |
| Lifetime external interest and combined financing saving | $496 M interest; $880 M capital + interest |
| 15%–25% planning risk envelope | $280 M–$304 M |
| Annual OPEX | $5.5 M / yr |
| Low/high project NPV at 8% | $-141289 k / $-112741 k |
| Low/high project IRR | -3.1% / 0.9% |
| Low/high steady-state DSCR | 0.12 / 0.29 |
