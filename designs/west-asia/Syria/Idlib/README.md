...
| Bucket | Value |
|---|---|
| At-grade (33.7 km @ €3.5 M/km) | €118 M |
...
| Per-capita (city pop) | €1,241 / person |
...
|---|---|---|
| Construction (years 1–10) | **€34 M / yr** | €114 |
| Steady-state, low-ridership (year 11+) | **€42 M / yr** | €141 |
| Steady-state, high-ridership (year 11+) | **€42 M / yr** | €139 |
| Lifecycle envelope (yr 1–35, low scenario) | **€1.40 bn cumulative** | €4,668 |
| Lifecycle envelope (yr 1–35, high scenario) | **€1.39 bn cumulative** | €4,619 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€8.4 M / yr (low) → €7.9 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €223 M | 4.5% | 35 y, 10 y grace | €15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €93 M | 20.0% | 35 y, 10 y grace | €19 M / yr |
| Government equity (no debt service) | 15% | €56 M | — | — | — |
| **Total** | **100%** | **€372 M** | | | **€34 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €10 M / yr + bonds €19 M / yr = **€29 M / yr** total — plus the equity tranche amortised across construction (€5.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (222 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €240 k |
...
| Farebox revenue | €588 k / yr | €1.2 M / yr |
| Farebox / OPEX recovery | 7% | 13% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €8.4 M / yr | €7.9 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€42 M / yr** | **€42 M / yr** |
