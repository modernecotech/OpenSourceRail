...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 134 | $60 k | $8.0 M |
| High sensitivity check | 134 | $120 k | $16 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh idlib`.
...
|---|---|---|
| Construction (years 1–10) | **$15 M / yr** | $50 |
| Steady-state, low capacity-use (year 11+) | **$9.3 M / yr** | $31 |
| Steady-state, high capacity-use (year 11+) | **$3.8 M / yr** | $13 |
| Steady-state, operating-neutral revenue case | **$13 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$429 M cumulative** | $1,431 |
| Lifecycle envelope (yr 1–40, high scenario) | **$265 M cumulative** | $884 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$546 M cumulative** | $1,819 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $215 M | 4.5% | 40 y, 10 y grace | $13 M / yr |
| Government equity (no debt service) | 20% | $54 M | — | — | — |
| **Total** | **100%** | **$268 M** | | | **$13 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $9.7 M / yr = **$9.7 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($5.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.3 M / yr | $3.8 M / yr | **$13 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $156 M | 58% of $268 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $250 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $25 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 46,498 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-159842 k / $-131294 k |
| Low/high project IRR | -3.9% / 0.2% |
| Low/high steady-state DSCR | 0.29 / 0.71 |
