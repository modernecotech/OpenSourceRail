...
**Country:** SY · **Population:** 300,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$412 M (88.0%) of external capital** and **$532 M of external interest**. Capital plus saved interest totals **$943 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`idlib.corridor.geojson`](idlib.corridor.geojson).
...
| Anchor-weighted coverage | 74.7% |
| Route length (double track) | 32.0 km |
| Revenue fleet | 59 × 2-car trainsets |
| Revenue fleet passenger capacity | 14,160 AW2 pax (18,880 AW3 crush) |
...
| Revenue fleet capacity | 14,160 AW2 pax (18,880 AW3 crush) |
| Total fleet capacity | 16,080 AW2 pax (21,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 59 × 240 = **14,160 AW2 passengers** (18,880 AW3 crush)
- **Total fleet passenger capacity:** 67 × 240 = **16,080 AW2 passengers** (21,440 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 74.7%
- Catchment population: **≈ 224,100** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **17.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.7× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 326 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 27 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 44 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 14,858 train-km/day | One-way train journeys × route length |
| Annual service work | 5.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 128 MWh/day | 11.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 84 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 17.6 MW / 97 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 4 | 59 kWh | 106 kWh | 41 kWh | 7.0 km / 34 kWh |
| line-2 | 3 | 43 kWh | 74 kWh | 27 kWh | 6.7 km / 32 kWh |
| line-3 | 4 | 52 kWh | 90 kWh | 33 kWh | 7.0 km / 34 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (30.7 km @ $3.0 M/km) | $92 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 67 | $560 k | $38 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 134 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 134 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 17,642 kW @ $700/kW | $12 M |
| Grid interconnection / PPA tie-in | 17,642 kW @ $100/kW | $1.8 M |
| Annual generation proxy | 17.6 MW × 5.5 peak-sun-h/day × 365 d/yr | 35.4 GWh/yr |
...
|---|---:|---:|---:|---:|
| Civil works | $111 M | 15% | $17 M | $95 M |
| Stations | $70 M | 20% | $14 M | $56 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $38 M | 35% | $13 M | $24 M |
| Dedicated solar plant | $14 M | 45% | $6.4 M | $7.8 M |
| Residual signalling / train control | $1.6 M | 50% | $799 k | $799 k |
| Charging microgrids | $1.3 M | 40% | $530 k | $795 k |
| EPC / project services | $16 M | 15% | $2.4 M | $14 M |
| **Total city CAPEX** | **$260 M** | **21.5%** | **$56 M** | **$204 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh idlib`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.5%** | **$56 M** | **$5.6 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.5%** | **$204 M** | **$20 M / yr** |
| of which planned local bond issuance | 62.8% of total CAPEX | $163 M | $16 M / yr |
| **Total city programme** | **100.0%** | **$260 M** | **$26 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $351 M | $295 M (84.1%) | $381 M | **$675 M** |
| **Default** | 2.00× | $467 M | $412 M (88.0%) | $532 M | **$943 M** |
| High | 3.00× | $701 M | $645 M (92.0%) | $834 M | **$1.48 bn** |

At the default 2.00× case, OSR's $56 M external requirement is 88.0% below the illustrative foreign-company requirement of $467 M; the associated lifetime external-interest saving is $532 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$39 M / yr** | $131 |
| Steady-state, low capacity-use (year 11+) | **$32 M / yr** | $108 |
| Steady-state, high capacity-use (year 11+) | **$27 M / yr** | $89 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $121 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.36 bn cumulative** | $4,538 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.20 bn cumulative** | $3,990 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.48 bn cumulative** | $4,925 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.9 M / yr → $9.3 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $56 M | 4.5% | 40 y, 10 y grace | $3.4 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $163 M | 20.0% | 40 y, 10 y grace | $33 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $41 M | — | — | — |
| **Total** | **100%** | **$260 M** | | | **$36 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $2.5 M / yr + local bonds $33 M / yr = **$35 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $3.8 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $80 k |
| Traction energy (46.9 GWh / yr) | 14,858 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.1 GWh/yr + dedicated solar plant 17.6 MW / 35.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $212 k |
| Labour (239 FTE) | driverless roster: OCC/remote 53, station/platform 57, passenger service 38, fleet maintenance 40, infrastructure/energy 30, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $281 k |
| **OPEX subtotal** | | **$5.9 M / yr** |

_Annual service work: 14,858 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 5.9 M train-km / yr (11.7 M car-km / yr). On-site PV covers 16.1 GWh/yr and the dedicated solar plant adds 35.4 GWh/yr against 46.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 67 trainsets, 13 stations, 32.0 route-km, 3 lines, and 14,858 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 28.1 M |
| Annual paid trips / city resident | 163 | 261 | 94 |
| Farebox revenue | $9.1 M / yr | $15 M / yr | $5.3 M / yr |
| Station shop leases | $253 k / yr | $253 k / yr | $253 k / yr |
| Advertising boards | $352 k / yr | $352 k / yr | $352 k / yr |
| **Total revenue** | **$9.7 M / yr** | **$15 M / yr** | **$5.9 M / yr** |
| Revenue / OPEX recovery | 166% | 260% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $36 M / yr | $36 M / yr | **$36 M / yr** |
| Operating surplus applied to debt support | -$3.9 M / yr | -$9.3 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $32 M / yr | $27 M / yr | **$36 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.9 M / yr | $9.3 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,392 m² of station shop/kiosk leases at $10/m²/month and 460 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $2.6 M / yr | $4.2 M / yr | 16 min/trip × $0.20/h value-of-time proxy |
...
| **Annual quantified benefit / activity proxy** | **$37 M / yr** | **$59 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 9 major/terminal/interchange nodes | 31,162 trips/trading day; 10.3 M access-events/yr | 49,859 trips/trading day; 16.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $204 M | 78% of $260 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $326 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $33 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 60,667 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $246 M |
| Timetable-sized dedicated solar CAPEX | $14 M |
| **Reconciled project CAPEX** | **$260 M** |
| Imported / external-capital requirement | $56 M (21.5%) |
| Local-content / local-funding requirement | $204 M (78.5%) |
| Default foreign-turnkey external-capital comparison | $467 M; OSR saves $412 M (88.0%) |
| Lifetime external interest and combined financing saving | $532 M interest; $943 M capital + interest |
| 15%–25% planning risk envelope | $299 M–$325 M |
| Annual OPEX | $5.9 M / yr |
| Low/high project NPV at 8% | $-154070 k / $-125522 k |
| Low/high project IRR | -3.7% / 0.4% |
| Low/high steady-state DSCR | 0.11 / 0.26 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,367.21 train-km; 6,562.02 kWh consumed; 6,903.66 kWh charged; 38 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 14,548.58 train-km; 69,826.66 kWh consumed; 71,015.73 kWh charged; 485 depot services completed (5 active at cutoff); minimum SoC 69%; 0 onboard emergencies; 0 invariant violations; 97.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 63.2% | 97.9% / 90% | pass |
| maximum planning climate/HVAC duty | 33.5% | 97.9% / 90% | pass |
| 50% charging-contact availability | 69.3% | 97.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.0% / 60% | pass |
| ten-hour single charging-pad outage | 38.5% | 97.9% / 90% | pass |
...
|---|---|
| ![Idlib energy and battery simulation dashboard](engineering/screenshots/idlib-simulation-dashboard.png) | ![Idlib simulator network visualizer](engineering/screenshots/idlib-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 13 line platforms, 1 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Idlib QGIS engineering layers](engineering/screenshots/idlib-qgis-engineering-map.png) | ![Idlib SUMO timetable validation](engineering/screenshots/idlib-sumo-validation.png) |
...
| [`idlib.toml`](idlib.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`idlib-network-map.png`](idlib-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`idlib.corridor.geojson`](idlib.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`idlib.stations.json`](idlib.stations.json) | Machine-readable station list |
| [`idlib.design-quality.yaml`](idlib.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
