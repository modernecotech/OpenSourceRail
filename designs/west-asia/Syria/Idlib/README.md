...
|---|---|---|
| Construction (years 1–10) | **$26 M / yr** | $87 |
| Steady-state, low-ridership (year 11+) | **$29 M / yr** | $96 |
| Steady-state, high-ridership (year 11+) | **$27 M / yr** | $91 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $86 |
| Lifecycle envelope (yr 1–35, low scenario) | **$979 M cumulative** | $3,262 |
| Lifecycle envelope (yr 1–35, high scenario) | **$942 M cumulative** | $3,141 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$903 M cumulative** | $3,011 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.0 M / yr → $1.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $170 M | 4.5% | 35 y, 10 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $71 M | 20.0% | 35 y, 10 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $42 M | — | — | — |
| **Total** | **100%** | **$283 M** | | | **$26 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $7.6 M / yr + bonds $14 M / yr = **$22 M / yr** total — plus the equity tranche amortised across construction ($4.2 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 42,660 | 71,100 | 101,600 |
| Daily paid trips / catchment | 18% | 30% | 43% |
| Daily paid trips / city population | 14% | 24% | 34% |
| Annual paid trips | 15.6 M | 26.0 M | 37.1 M |
| Farebox revenue | $2.2 M / yr | $3.6 M / yr | $5.2 M / yr |
| Station shop leases | $318 k / yr | $318 k / yr | $318 k / yr |
| Advertising boards | $444 k / yr | $444 k / yr | $444 k / yr |
| **Total revenue** | **$2.9 M / yr** | **$4.4 M / yr** | **$6.0 M / yr** |
| Revenue / OPEX recovery | 49% | 74% | 100% |
