...
|---|---|---|
| Construction (years 1–10) | **$196 M / yr** | $120 |
| Steady-state, low-ridership (year 11+) | **$239 M / yr** | $146 |
| Steady-state, high-ridership (year 11+) | **$235 M / yr** | $143 |
| Steady-state, operating-neutral revenue case | **$194 M / yr** | $119 |
| Lifecycle envelope (yr 1–35, low scenario) | **$7.94 bn cumulative** | $4,847 |
| Lifecycle envelope (yr 1–35, high scenario) | **$7.83 bn cumulative** | $4,776 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$6.82 bn cumulative** | $4,163 |

_Population basis: 1,639,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $45 M / yr → $40 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.28 bn | 4.5% | 35 y, 10 y grace | $86 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $534 M | 20.0% | 35 y, 10 y grace | $108 M / yr |
| Government equity (no debt service) | 15% | $320 M | — | — | — |
| **Total** | **100%** | **$2.14 bn** | | | **$194 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $58 M / yr + bonds $107 M / yr = **$164 M / yr** total — plus the equity tranche amortised across construction ($32 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 136,299 | 227,165 | 1,014,004 |
| Daily paid trips / catchment | 18% | 30% | 134% |
| Daily paid trips / city population | 8% | 14% | 62% |
| Annual paid trips | 49.7 M | 82.9 M | 370.1 M |
| Farebox revenue | $7.0 M / yr | $12 M / yr | $52 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| **Total revenue** | **$11 M / yr** | **$16 M / yr** | **$56 M / yr** |
| Revenue / OPEX recovery | 20% | 28% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $239 M / yr | $235 M / yr | **$194 M / yr** |
