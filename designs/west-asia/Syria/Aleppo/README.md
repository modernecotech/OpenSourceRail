...
| Steady-state, low-ridership (year 11+) | **$86 M / yr** | $53 |
| Steady-state, high-ridership (year 11+) | **$82 M / yr** | $50 |
| Steady-state, operating-neutral revenue case | **$77 M / yr** | $47 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.94 bn cumulative** | $1,793 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.82 bn cumulative** | $1,722 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.72 bn cumulative** | $1,658 |

_Population basis: 1,639,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.8 M / yr → $4.2 M / yr._
...
|---|---|---|---|
| Daily paid trips | 136,299 | 227,165 | 309,358 |
| Daily paid trips / catchment | 18% | 30% | 41% |
| Daily paid trips / city population | 8% | 14% | 19% |
| Annual paid trips | 49.7 M | 82.9 M | 112.9 M |
| Farebox revenue | $7.0 M / yr | $12 M / yr | $16 M / yr |
...
| Revenue / OPEX recovery | 55% | 79% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $86 M / yr | $82 M / yr | **$77 M / yr** |
