...
|---|---:|---:|---:|---:|
| Civil works | $715 M | 35% | $250 M | $465 M |
| Stations | $397 M | 40% | $159 M | $238 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $245 M | 55% | $135 M | $110 M |
| Dedicated solar plant | $186 M | 70% | $130 M | $56 M |
| Residual signalling / train control | $9.2 M | 80% | $7.4 M | $1.8 M |
| Charging microgrids | $20 M | 55% | $11 M | $9.0 M |
| EPC / project services | $98 M | 45% | $44 M | $54 M |
| **Total city CAPEX** | **$1.68 bn** | **44.1%** | **$740 M** | **$938 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.1%** | **$740 M** | **$74 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.9%** | **$938 M** | **$94 M / yr** |
| of which planned local bond issuance | 44.7% of total CAPEX | $751 M | $75 M / yr |
...
|---|---|---|
| Construction (years 1–10) | **$202 M / yr** | $123 |
| Steady-state, low capacity-use (year 11+) | **$196 M / yr** | $120 |
| Steady-state, high capacity-use (year 11+) | **$176 M / yr** | $107 |
| Steady-state, operating-neutral revenue case | **$196 M / yr** | $120 |
| Lifecycle envelope (yr 1–40, low scenario) | **$7.90 bn cumulative** | $4,821 |
| Lifecycle envelope (yr 1–40, high scenario) | **$7.30 bn cumulative** | $4,453 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.91 bn cumulative** | $4,825 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 44% | $740 M | 4.5% | 40 y, 10 y grace | $45 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $751 M | 20.0% | 40 y, 10 y grace | $151 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $188 M | — | — | — |
| **Total** | **100%** | **$1.68 bn** | | | **$196 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $33 M / yr + local bonds $150 M / yr = **$183 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($19 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $196 M / yr | $176 M / yr | **$196 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $938 M | 56% of $1.68 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.50 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $150 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 279,293 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $740 M (44.1%) |
| Local-content / local-funding requirement | $938 M (55.9%) |
| 15%–25% planning risk envelope | $1.93 bn–$2.10 bn |
| Annual OPEX | $36 M / yr |
| Low/high project NPV at 8% | $-1124850 k / $-1020175 k |
| Low/high project IRR | -19.5% / -4.6% |
| Low/high steady-state DSCR | 0.00 / 0.10 |
