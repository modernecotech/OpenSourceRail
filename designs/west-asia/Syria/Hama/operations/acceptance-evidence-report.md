...
| Item | Count / Status |
|---|---:|
| Assets in register | 305 |
| Manufacturing schedule rows | 1,171 |
| Manufacturing material/BOM rows | 17,611 |
| Manufacturing QA verification rows | 1,171 |
| Construction QA action rows | 1,089 |
| Maintenance handover schedule rows | 1,392 |
| Manufacturing rows with material refs | 1,171 / 1,171 |
| Manufacturing rows with verification refs | 1,171 / 1,171 |
| Manufacturing rows linked to QA actions | 1,171 / 1,171 |
