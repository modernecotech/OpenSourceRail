...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $49 |
| Steady-state, low-ridership (year 11+) | **$32 M / yr** | $54 |
| Steady-state, high-ridership (year 11+) | **$30 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $49 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.10 bn cumulative** | $1,837 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.05 bn cumulative** | $1,756 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.03 bn cumulative** | $1,711 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.0 M / yr → $1.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $193 M | 4.5% | 35 y, 10 y grace | $13 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $80 M | 20.0% | 35 y, 10 y grace | $16 M / yr |
| Government equity (no debt service) | 15% | $48 M | — | — | — |
| **Total** | **100%** | **$321 M** | | | **$29 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $8.7 M / yr + bonds $16 M / yr = **$25 M / yr** total — plus the equity tranche amortised across construction ($4.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,916 | 94,860 | 116,085 |
| Daily paid trips / catchment | 18% | 30% | 37% |
| Daily paid trips / city population | 9% | 16% | 19% |
| Annual paid trips | 20.8 M | 34.6 M | 42.4 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $5.9 M / yr |
| Station shop leases | $496 k / yr | $496 k / yr | $496 k / yr |
| Advertising boards | $692 k / yr | $692 k / yr | $692 k / yr |
| **Total revenue** | **$4.1 M / yr** | **$6.0 M / yr** | **$7.1 M / yr** |
| Revenue / OPEX recovery | 58% | 85% | 100% |
