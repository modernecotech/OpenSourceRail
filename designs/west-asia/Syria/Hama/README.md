...
| Steady-state, low-ridership (year 11+) | **$25 M / yr** | $42 |
| Steady-state, high-ridership (year 11+) | **$24 M / yr** | $39 |
| Steady-state, operating-neutral revenue case | **$24 M / yr** | $39 |
| Lifecycle envelope (yr 1–35, low scenario) | **$875 M cumulative** | $1,458 |
| Lifecycle envelope (yr 1–35, high scenario) | **$828 M cumulative** | $1,380 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$828 M cumulative** | $1,380 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.9 M / yr → $0 k / yr._
