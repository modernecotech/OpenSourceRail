...
| Bucket | Value |
|---|---|
| At-grade (53.6 km @ $0.85 M/km) | $46 M |
| Elevated (1.5 km @ $4.0 M/km) | $5.9 M |
| **Civil subtotal** | **$51 M** |
...
| Per-capita (city pop) | $232 / person |
...
| Steady-state, high-ridership (year 11+) | **$11 M / yr** | $18 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$447 M cumulative** | $746 |
| Lifecycle envelope (yr 1–35, high scenario) | **$394 M cumulative** | $656 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$128 M cumulative** | $213 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $132 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $83 M | 4.5% | 35 y, 10 y grace | $5.6 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $35 M | 20.0% | 35 y, 10 y grace | $7.0 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$139 M** | | | **$13 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.8 M / yr + bonds $7.0 M / yr = **$11 M / yr** total — plus the equity tranche amortised across construction ($2.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 298,106 |
| Daily paid trips / population | 8% | 15% | 50% |
| Annual paid trips | 17.5 M | 32.9 M | 108.8 M |
| Farebox revenue | $2.5 M / yr | $4.6 M / yr | $15 M / yr |
| Station shop leases | $496 k / yr | $496 k / yr | $496 k / yr |
| Advertising boards | $692 k / yr | $692 k / yr | $692 k / yr |
| **Total revenue** | **$3.6 M / yr** | **$5.8 M / yr** | **$16 M / yr** |
