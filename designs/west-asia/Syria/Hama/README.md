...
| Steady-state, low-ridership (year 11+) | **$69 M / yr** | $115 |
| Steady-state, high-ridership (year 11+) | **$67 M / yr** | $112 |
| Steady-state, operating-neutral revenue case | **$57 M / yr** | $95 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.30 bn cumulative** | $3,833 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.25 bn cumulative** | $3,752 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.00 bn cumulative** | $3,328 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $10 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $375 M | 4.5% | 35 y, 10 y grace | $25 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $156 M | 20.0% | 35 y, 10 y grace | $32 M / yr |
| Government equity (no debt service) | 15% | $94 M | — | — | — |
| **Total** | **100%** | **$625 M** | | | **$57 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $31 M / yr = **$48 M / yr** total — plus the equity tranche amortised across construction ($9.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,916 | 94,860 | 293,918 |
| Daily paid trips / catchment | 18% | 30% | 93% |
| Daily paid trips / city population | 9% | 16% | 49% |
| Annual paid trips | 20.8 M | 34.6 M | 107.3 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $15 M / yr |
| Station shop leases | $496 k / yr | $496 k / yr | $496 k / yr |
| Advertising boards | $692 k / yr | $692 k / yr | $692 k / yr |
| **Total revenue** | **$4.1 M / yr** | **$6.0 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 25% | 37% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $69 M / yr | $67 M / yr | **$57 M / yr** |
