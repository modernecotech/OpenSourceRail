...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **31,620 – 47,430 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (53.6 km @ $1.2 M/km) | $64 M |
| Elevated (1.5 km @ $5.5 M/km) | $8.2 M |
| **Civil subtotal** | **$72 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 55.3 km × $0.015 M/km | $830 k |
...
|---|---|---|
| Construction (years 1–10) | **$16 M / yr** | $26 |
| Steady-state, low-ridership (year 11+) | **$16 M / yr** | $27 |
| Steady-state, high-ridership (year 11+) | **$14 M / yr** | $23 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$560 M cumulative** | $933 |
| Lifecycle envelope (yr 1–35, high scenario) | **$506 M cumulative** | $843 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$156 M cumulative** | $260 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $705 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $42 M | 20.0% | 35 y, 10 y grace | $8.6 M / yr |
| Government equity (no debt service) | 15% | $25 M | — | — | — |
| **Total** | **100%** | **$170 M** | | | **$15 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $4.6 M / yr + bonds $8.5 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($2.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 363,899 |
| Daily paid trips / population | 8% | 15% | 61% |
| Annual paid trips | 17.5 M | 32.9 M | 132.8 M |
| Farebox revenue | $2.5 M / yr | $4.6 M / yr | $19 M / yr |
| Station shop leases | $496 k / yr | $496 k / yr | $496 k / yr |
| Advertising boards | $692 k / yr | $692 k / yr | $692 k / yr |
| **Total revenue** | **$3.6 M / yr** | **$5.8 M / yr** | **$20 M / yr** |
| Revenue / OPEX + debt-service recovery | 18% | 29% | 100% |
