...
| Steady-state, low-ridership (year 11+) | **$42 M / yr** | $69 |
| Steady-state, high-ridership (year 11+) | **$40 M / yr** | $66 |
| Steady-state, operating-neutral revenue case | **$37 M / yr** | $62 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.42 bn cumulative** | $2,362 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.37 bn cumulative** | $2,281 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.30 bn cumulative** | $2,169 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $2.7 M / yr._
...
|---|---|---|---|
| Daily paid trips | 56,916 | 94,860 | 147,553 |
| Daily paid trips / catchment | 18% | 30% | 47% |
| Daily paid trips / city population | 9% | 16% | 25% |
| Annual paid trips | 20.8 M | 34.6 M | 53.9 M |
...
| **Total revenue** | **$4.1 M / yr** | **$6.0 M / yr** | **$8.7 M / yr** |
