...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **56,916 – 94,860 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (53.6 km @ $2.0 M/km) | $107 M |
...
|---|---|---|
| Construction (years 1–10) | **$24 M / yr** | $40 |
| Steady-state, low-ridership (year 11+) | **$24 M / yr** | $40 |
| Steady-state, high-ridership (year 11+) | **$21 M / yr** | $34 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$832 M cumulative** | $1,387 |
| Lifecycle envelope (yr 1–35, high scenario) | **$756 M cumulative** | $1,259 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$238 M cumulative** | $397 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $173 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $156 M | 4.5% | 35 y, 10 y grace | $10 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $65 M | 20.0% | 35 y, 10 y grace | $13 M / yr |
| Government equity (no debt service) | 15% | $39 M | — | — | — |
| **Total** | **100%** | **$259 M** | | | **$24 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $7.0 M / yr + bonds $13 M / yr = **$20 M / yr** total — plus the equity tranche amortised across construction ($3.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 90,000 | 150,000 | 554,877 |
| Daily paid trips / population | 15% | 25% | 92% |
| Annual paid trips | 32.9 M | 54.8 M | 202.5 M |
| Farebox revenue | $4.6 M / yr | $7.7 M / yr | $28 M / yr |
| Station shop leases | $496 k / yr | $496 k / yr | $496 k / yr |
| Advertising boards | $692 k / yr | $692 k / yr | $692 k / yr |
| **Total revenue** | **$5.8 M / yr** | **$8.9 M / yr** | **$30 M / yr** |
| Revenue / OPEX + debt-service recovery | 20% | 30% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $24 M / yr | $21 M / yr | **$0 / yr** |
