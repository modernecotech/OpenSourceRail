...
| Bucket | Value |
|---|---|
| At-grade (53.6 km @ €3.5 M/km) | €187 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 55.3 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–10) | **€50 M / yr** | €83 |
| Steady-state, low-ridership (year 11+) | **€62 M / yr** | €103 |
| Steady-state, high-ridership (year 11+) | **€60 M / yr** | €101 |
| Lifecycle envelope (yr 1–35, low scenario) | **€2.03 bn cumulative** | €3,391 |
| Lifecycle envelope (yr 1–35, high scenario) | **€2.00 bn cumulative** | €3,342 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€12 M / yr (low) → €11 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €324 M | 4.5% | 35 y, 10 y grace | €22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €135 M | 20.0% | 35 y, 10 y grace | €27 M / yr |
| Government equity (no debt service) | 15% | €81 M | — | — | — |
| **Total** | **100%** | **€540 M** | | | **€49 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €27 M / yr = **€42 M / yr** total — plus the equity tranche amortised across construction (€8.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (344 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €372 k |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€62 M / yr** | **€60 M / yr** |
