...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$559 M (86.8%) of external capital** and **$722 M of external interest**. Capital plus saved interest totals **$1.28 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
- Anchor-weighted coverage: 48.1%
- Catchment population: **≈ 372,775** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 13.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 499 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 18,583 train-km/day | One-way train journeys × route length |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 96 kWh | 172 kWh | 65 kWh | 2.7 km / 19 kWh |
| line-2 | 6 | 85 kWh | 147 kWh | 54 kWh | 3.0 km / 22 kWh |
| line-3 | 5 | 107 kWh | 163 kWh | 46 kWh | 5.7 km / 41 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (37.6 km @ $2.58 M/km) | $97 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,743 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,743 kW @ $100/kW | $3.9 M |
| Annual generation proxy | 38.7 MW × 5.5 peak-sun-h/day × 365 d/yr | 77.8 GWh/yr |
...
| Per-capita (city pop) | $461 / person |
...
| **Total city CAPEX** | **$358 M** | **23.8%** | **$85 M** | **$272 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh homs`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.8%** | **$85 M** | **$8.5 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.2%** | **$272 M** | **$27 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $218 M | $22 M / yr |
| **Total city programme** | **100.0%** | **$358 M** | **$36 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $483 M | $398 M (82.4%) | $514 M | **$911 M** |
| **Default** | 2.00× | $644 M | $559 M (86.8%) | $722 M | **$1.28 bn** |
| High | 3.00× | $966 M | $880 M (91.2%) | $1.14 bn | **$2.02 bn** |

At the default 2.00× case, OSR's $85 M external requirement is 86.8% below the illustrative foreign-company requirement of $644 M; the associated lifetime external-interest saving is $722 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$53 M / yr** | $68 |
| Steady-state, low capacity-use (year 11+) | **$43 M / yr** | $56 |
| Steady-state, high capacity-use (year 11+) | **$35 M / yr** | $45 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.82 bn cumulative** | $2,348 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.57 bn cumulative** | $2,030 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.00 bn cumulative** | $2,579 |

_Population basis: 775,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.0 M / yr → $14 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $85 M | 4.5% | 40 y, 10 y grace | $5.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $218 M | 20.0% | 40 y, 10 y grace | $44 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $54 M | — | — | — |
| **Total** | **100%** | **$358 M** | | | **$49 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.8 M / yr + local bonds $44 M / yr = **$47 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (87.9 GWh / yr) | 18,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 38.7 MW / 77.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $465 k |
| Labour (292 FTE) | driverless roster: OCC/remote 61, station/platform 73, passenger service 49, fleet maintenance 51, infrastructure/energy 37, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $343 k |
| **OPEX subtotal** | | **$8.5 M / yr** |

_Annual service work: 18,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.3 M train-km / yr (22.0 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 77.8 GWh/yr against 87.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 87 trainsets, 18 stations, 40.0 route-km, 3 lines, and 18,583 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 41.3 M |
| Annual paid trips / city resident | 95 | 151 | 53 |
| Farebox revenue | $14 M / yr | $22 M / yr | $7.7 M / yr |
| Station shop leases | $331 k / yr | $331 k / yr | $331 k / yr |
| Advertising boards | $462 k / yr | $462 k / yr | $462 k / yr |
| **Total revenue** | **$14 M / yr** | **$23 M / yr** | **$8.5 M / yr** |
| Revenue / OPEX recovery | 170% | 267% | 100% |
...
| Operating surplus applied to debt support | -$6.0 M / yr | -$14 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $43 M / yr | $35 M / yr | **$49 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.0 M / yr | $14 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,136 m² of station shop/kiosk leases at $10/m²/month and 604 advertising boards at $75/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $25 M / yr | $39 M / yr | 22% of paid trips × $1.50 local spend proxy |
...
| Commerce | 11 major/terminal/interchange nodes | 45,031 trips/trading day; 14.9 M access-events/yr | 72,049 trips/trading day; 23.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $272 M | 76% of $358 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 81,098 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $327 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$358 M** |
| Imported / external-capital requirement | $85 M (23.8%) |
| Local-content / local-funding requirement | $272 M (76.2%) |
| Default foreign-turnkey external-capital comparison | $644 M; OSR saves $559 M (86.8%) |
| Lifetime external interest and combined financing saving | $722 M interest; $1.28 bn capital + interest |
| 15%–25% planning risk envelope | $411 M–$447 M |
| Annual OPEX | $8.5 M / yr |
| Low/high project NPV at 8% | $-208758 k / $-165936 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,645.68 train-km; 11,848.10 kWh consumed; 11,664.99 kWh charged; 34 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,538.78 train-km; 133,469.95 kWh consumed; 135,774.52 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 42%; 0 onboard emergencies; 0 invariant violations; 99.8% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 28.8% | 99.8% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 98.1% / 90% | pass |
| 50% charging-contact availability | 42.4% | 99.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.4% / 60% | pass |
| ten-hour single charging-pad outage | 32.7% | 99.8% / 90% | pass |
...
|---|---|
| ![Homs energy and battery simulation dashboard](engineering/screenshots/homs-simulation-dashboard.png) | ![Homs simulator network visualizer](engineering/screenshots/homs-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 18 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
...
|---|---|
| ![Homs QGIS engineering layers](engineering/screenshots/homs-qgis-engineering-map.png) | ![Homs SUMO timetable validation](engineering/screenshots/homs-sumo-validation.png) |
