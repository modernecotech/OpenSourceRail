...
| Depots | €40 M |
| Rolling stock | €159 M |
| Residual train-control wayside + power | €42 M |
| EPC overhead (7%) | €39 M |
| **CAPEX total** | **€591 M** |
...
|---|---|---|
| Construction (years 1–10) | **€54 M / yr** | €70 |
| Steady-state, low-ridership (year 11+) | **€66 M / yr** | €85 |
| Steady-state, high-ridership (year 11+) | **€64 M / yr** | €83 |
| Lifecycle envelope (yr 1–35, low scenario) | **€2.19 bn cumulative** | €2,829 |
| Lifecycle envelope (yr 1–35, high scenario) | **€2.15 bn cumulative** | €2,780 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €354 M | 4.5% | 35 y, 10 y grace | €24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €148 M | 20.0% | 35 y, 10 y grace | €30 M / yr |
| Government equity (no debt service) | 15% | €89 M | — | — | — |
| **Total** | **100%** | **€591 M** | | | **€54 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €16 M / yr + bonds €30 M / yr = **€45 M / yr** total — plus the equity tranche amortised across construction (€8.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€66 M / yr** | **€64 M / yr** |
