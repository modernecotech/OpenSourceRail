...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **58,032 – 96,720 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$23 M / yr** | $30 |
| Steady-state, high-ridership (year 11+) | **$19 M / yr** | $25 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$820 M cumulative** | $1,058 |
| Lifecycle envelope (yr 1–35, high scenario) | **$721 M cumulative** | $930 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$246 M cumulative** | $317 |

_Population basis: 775,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 116,250 | 193,750 | 565,844 |
| Daily paid trips / population | 15% | 25% | 73% |
| Annual paid trips | 42.4 M | 70.7 M | 206.5 M |
| Farebox revenue | $5.9 M / yr | $9.9 M / yr | $29 M / yr |
| Station shop leases | $581 k / yr | $581 k / yr | $581 k / yr |
| Advertising boards | $799 k / yr | $799 k / yr | $799 k / yr |
| **Total revenue** | **$7.3 M / yr** | **$11 M / yr** | **$30 M / yr** |
| Revenue / OPEX + debt-service recovery | 24% | 37% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $23 M / yr | $19 M / yr | **$0 / yr** |
