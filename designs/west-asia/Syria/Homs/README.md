...
|---|---|---|
| Construction (years 1–10) | **$59 M / yr** | $76 |
| Steady-state, low-ridership (year 11+) | **$70 M / yr** | $90 |
| Steady-state, high-ridership (year 11+) | **$68 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$58 M / yr** | $75 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.33 bn cumulative** | $3,008 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.28 bn cumulative** | $2,945 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$2.04 bn cumulative** | $2,626 |

_Population basis: 775,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $9.9 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $382 M | 4.5% | 35 y, 10 y grace | $26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $159 M | 20.0% | 35 y, 10 y grace | $32 M / yr |
| Government equity (no debt service) | 15% | $96 M | — | — | — |
| **Total** | **100%** | **$637 M** | | | **$58 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $32 M / yr = **$49 M / yr** total — plus the equity tranche amortised across construction ($9.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 58,032 | 96,720 | 290,153 |
| Daily paid trips / catchment | 18% | 30% | 90% |
| Daily paid trips / city population | 7% | 12% | 37% |
| Annual paid trips | 21.2 M | 35.3 M | 105.9 M |
| Farebox revenue | $3.0 M / yr | $4.9 M / yr | $15 M / yr |
| Station shop leases | $581 k / yr | $581 k / yr | $581 k / yr |
| Advertising boards | $799 k / yr | $799 k / yr | $799 k / yr |
| **Total revenue** | **$4.3 M / yr** | **$6.3 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 27% | 39% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $70 M / yr | $68 M / yr | **$58 M / yr** |
