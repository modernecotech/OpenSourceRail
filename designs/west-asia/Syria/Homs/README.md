...
|---|---|---|---|---|
| line-1 | 13.4 km | 9 | 36 | W Mid ↔ SE Mid |
| line-2 | 11.8 km | 9 | 30 | SW Outer ↔ NE Mid |
| line-3 | 14.8 km | 10 | 36 | NW Outer ↔ E Outer |
| **Total** | **40.0 km** | **28 unique** | **102** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **35.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 70 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 72 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 35.3 MW / 194 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 96 kWh | 192 kWh | 86 kWh | 2.4 km / 17 kWh |
| line-2 | 9 | 85 kWh | 163 kWh | 70 kWh | 2.0 km / 14 kWh |
| line-3 | 10 | 107 kWh | 188 kWh | 71 kWh | 2.2 km / 16 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 35,293 kW @ $700/kW | $25 M |
| Grid interconnection / PPA tie-in | 35,293 kW @ $100/kW | $3.5 M |
| Annual generation proxy | 35.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 70.8 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$25 M / yr** | $32 |
| Steady-state, low capacity-use (year 11+) | **$17 M / yr** | $22 |
| Steady-state, high capacity-use (year 11+) | **$9.0 M / yr** | $12 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$766 M cumulative** | $988 |
| Lifecycle envelope (yr 1–40, high scenario) | **$520 M cumulative** | $670 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$906 M cumulative** | $1,169 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $357 M | 4.5% | 40 y, 10 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $89 M | — | — | — |
| **Total** | **100%** | **$446 M** | | | **$22 M / yr** |
...
| Traction energy (87.9 GWh / yr) | 18,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.3 GWh/yr + dedicated solar plant 35.3 MW / 70.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $424 k |
| Labour (335 FTE) | driverless roster: OCC/remote 69, station/platform 100, passenger service 49, fleet maintenance 56, infrastructure/energy 40, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $394 k |
| **OPEX subtotal** | | **$10 M / yr** |

_Annual service work: 18,583 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.3 M train-km / yr (22.0 M car-km / yr). On-site PV covers 26.3 GWh/yr and the dedicated solar plant adds 70.8 GWh/yr against 87.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 102 trainsets, 28 stations, 40.0 route-km, 3 lines, and 18,583 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 48.3 M |
| Annual paid trips / city resident | 95 | 151 | 62 |
| Farebox revenue | $14 M / yr | $22 M / yr | $9.0 M / yr |
| Station shop leases | $448 k / yr | $448 k / yr | $448 k / yr |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $17 M / yr | $9.0 M / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $4.7 M / yr | $13 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,240 m² of station shop/kiosk leases at $10/m²/month and 824 advertising boards at $75/board/month, with occupancy derates applied._
...
| Commerce | 14 major/terminal/interchange nodes | 42,687 trips/trading day; 14.1 M access-events/yr | 68,299 trips/trading day; 22.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $253 M | 57% of $446 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 75,174 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-274649 k / $-231828 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,648.99 train-km; 11,872.01 kWh consumed; 12,980.35 kWh charged; 31 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 19,260.97 train-km; 138,671.04 kWh consumed; 141,807.01 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 74.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 83.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 28 line platforms, 1 interchange complexes, 11 civil segments, and 0 input findings |
