...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **203,193 – 338,655 trips/day**
...
| Steady-state, low-ridership (year 11+) | **$110 M / yr** | $44 |
| Steady-state, high-ridership (year 11+) | **$97 M / yr** | $39 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$3.82 bn cumulative** | $1,528 |
| Lifecycle envelope (yr 1–35, high scenario) | **$3.51 bn cumulative** | $1,400 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$1.08 bn cumulative** | $432 |

_Population basis: 2,503,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.8 M / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 375,450 | 625,750 | 2,523,359 |
| Daily paid trips / population | 15% | 25% | 101% |
| Annual paid trips | 137.0 M | 228.4 M | 921.0 M |
| Farebox revenue | $19 M / yr | $32 M / yr | $129 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| **Total revenue** | **$24 M / yr** | **$37 M / yr** | **$134 M / yr** |
| Revenue / OPEX + debt-service recovery | 18% | 28% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $110 M / yr | $97 M / yr | **$0 / yr** |
