...
| Bucket | Value |
|---|---|
| At-grade (217.4 km @ $0.85 M/km) | $185 M |
| Elevated (14.3 km @ $4.0 M/km) | $57 M |
...
|---|---|---|
| Construction (years 1–10) | **$57 M / yr** | $23 |
| Steady-state, low-ridership (year 11+) | **$58 M / yr** | $23 |
| Steady-state, high-ridership (year 11+) | **$49 M / yr** | $20 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.03 bn cumulative** | $811 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.81 bn cumulative** | $722 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$572 M cumulative** | $229 |

_Population basis: 2,503,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $373 M | 4.5% | 35 y, 10 y grace | $25 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $156 M | 20.0% | 35 y, 10 y grace | $31 M / yr |
| Government equity (no debt service) | 15% | $93 M | — | — | — |
| **Total** | **100%** | **$622 M** | | | **$57 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $17 M / yr + bonds $31 M / yr = **$48 M / yr** total — plus the equity tranche amortised across construction ($9.3 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
