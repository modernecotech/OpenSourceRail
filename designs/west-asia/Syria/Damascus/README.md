...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 944 | $60 k | $57 M |
| High sensitivity check | 944 | $120 k | $113 M |
...
| Steady-state, operating-neutral revenue case | **$89 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.75 bn cumulative** | $1,499 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.15 bn cumulative** | $1,259 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.70 bn cumulative** | $1,478 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.46 bn | 4.5% | 40 y, 10 y grace | $89 M / yr |
| Government equity (no debt service) | 20% | $364 M | — | — | — |
| **Total** | **100%** | **$1.82 bn** | | | **$89 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $66 M / yr = **$66 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($36 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $91 M / yr | $89 M / yr | **$89 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$18 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $91 M / yr | $71 M / yr | **$89 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.03 bn | 57% of $1.82 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 307,198 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $38 M / yr |
| Low/high project NPV at 8% | $-1230179 k / $-1125504 k |
| Low/high project IRR | not resolved |
| Low/high steady-state DSCR | -0.02 / 0.20 |
