...
|---|---:|---:|---:|---:|
| Civil works | $779 M | 35% | $273 M | $507 M |
| Stations | $391 M | 40% | $156 M | $235 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $264 M | 55% | $145 M | $119 M |
| Dedicated solar plant | $183 M | 70% | $128 M | $55 M |
...
| **Total city CAPEX** | **$1.76 bn** | **43.9%** | **$771 M** | **$988 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.9%** | **$771 M** | **$77 M / yr** |
| **Local capital for domestic procurement / payroll** | **56.1%** | **$988 M** | **$99 M / yr** |
| of which planned local bond issuance | 44.9% of total CAPEX | $790 M | $79 M / yr |
...
|---|---|---|
| Construction (years 1–10) | **$212 M / yr** | $85 |
| Steady-state, low capacity-use (year 11+) | **$208 M / yr** | $83 |
| Steady-state, high capacity-use (year 11+) | **$188 M / yr** | $75 |
| Steady-state, operating-neutral revenue case | **$206 M / yr** | $82 |
| Lifecycle envelope (yr 1–40, low scenario) | **$8.36 bn cumulative** | $3,340 |
| Lifecycle envelope (yr 1–40, high scenario) | **$7.76 bn cumulative** | $3,099 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$8.31 bn cumulative** | $3,318 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 44% | $771 M | 4.5% | 40 y, 10 y grace | $47 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $790 M | 20.0% | 40 y, 10 y grace | $159 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $198 M | — | — | — |
| **Total** | **100%** | **$1.76 bn** | | | **$206 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $35 M / yr + local bonds $158 M / yr = **$193 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($20 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $208 M / yr | $206 M / yr | **$206 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$18 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $208 M / yr | $188 M / yr | **$206 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $988 M | 56% of $1.76 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.58 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $158 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 293,906 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $771 M (43.9%) |
| Local-content / local-funding requirement | $988 M (56.1%) |
...
| Low/high steady-state DSCR | -0.01 / 0.09 |
