...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.77 bn (87.3%) of external capital** and **$3.57 bn of external interest**. Capital plus saved interest totals **$6.34 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (183.3 km @ $3.0 M/km) | $550 M |
...
|---|---:|---:|---:|---:|
| Civil works | $779 M | 15% | $117 M | $662 M |
...
| **Total city CAPEX** | **$1.76 bn** | **22.8%** | **$401 M** | **$1.36 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.8%** | **$401 M** | **$40 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.2%** | **$1.36 bn** | **$136 M / yr** |
| of which planned local bond issuance | 61.8% of total CAPEX | $1.09 bn | $109 M / yr |
| **Total city programme** | **100.0%** | **$1.76 bn** | **$176 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.37 bn | $1.97 bn (83.1%) | $2.55 bn | **$4.52 bn** |
| **Default** | 2.00× | $3.17 bn | $2.77 bn (87.3%) | $3.57 bn | **$6.34 bn** |
| High | 3.00× | $4.75 bn | $4.35 bn (91.6%) | $5.62 bn | **$9.97 bn** |

At the default 2.00× case, OSR's $401 M external requirement is 87.3% below the illustrative foreign-company requirement of $3.17 bn; the associated lifetime external-interest saving is $3.57 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$263 M / yr** | $105 |
| Steady-state, low capacity-use (year 11+) | **$245 M / yr** | $98 |
| Steady-state, high capacity-use (year 11+) | **$225 M / yr** | $90 |
| Steady-state, operating-neutral revenue case | **$243 M / yr** | $97 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.96 bn cumulative** | $3,981 |
| Lifecycle envelope (yr 1–40, high scenario) | **$9.36 bn cumulative** | $3,740 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.91 bn cumulative** | $3,960 |

_Population basis: 2,503,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.8 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $18 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $401 M | 4.5% | 40 y, 10 y grace | $25 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.09 bn | 20.0% | 40 y, 10 y grace | $218 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $272 M | — | — | — |
| **Total** | **100%** | **$1.76 bn** | | | **$243 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $18 M / yr + local bonds $217 M / yr = **$235 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($27 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 188.8 M |
| Annual paid trips / city resident | 72 | 115 | 75 |
| Farebox revenue | $33 M / yr | $54 M / yr | $35 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$37 M / yr** | **$57 M / yr** | **$38 M / yr** |
| Revenue / OPEX recovery | 95% | 148% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $245 M / yr | $243 M / yr | **$243 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$18 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $245 M / yr | $225 M / yr | **$243 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.36 bn | 77% of $1.76 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.17 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $217 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 404,276 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $401 M (22.8%) |
| Local-content / local-funding requirement | $1.36 bn (77.2%) |
| Default foreign-turnkey external-capital comparison | $3.17 bn; OSR saves $2.77 bn (87.3%) |
| Lifetime external interest and combined financing saving | $3.57 bn interest; $6.34 bn capital + interest |
| 15%–25% planning risk envelope | $2.02 bn–$2.20 bn |
| Annual OPEX | $38 M / yr |
| Low/high project NPV at 8% | $-1189513 k / $-1084838 k |
| Low/high project IRR | not resolved |
| Low/high steady-state DSCR | -0.01 / 0.08 |
