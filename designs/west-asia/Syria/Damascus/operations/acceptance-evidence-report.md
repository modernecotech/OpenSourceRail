...
| Item | Count / Status |
|---|---:|
| Assets in register | 999 |
| Manufacturing schedule rows | 3,428 |
| Manufacturing material/BOM rows | 46,358 |
| Manufacturing QA verification rows | 3,428 |
| Construction QA action rows | 3,092 |
| Maintenance handover schedule rows | 4,189 |
...
|---|---:|
| `project_kit` | 7,163 |
| `rolling_stock_bom` | 36,850 |
| `rolling_stock_cots_fitout` | 2,345 |
...
| `qa-10-carbody-structure` | 670 |
| `qa-11-bogie-wheelset` | 335 |
| `qa-12-traction-brake-battery` | 335 |
| `qa-13-passenger-systems` | 335 |
| `qa-15-first-article-trainset` | 335 |
| `qa-20-survey-geotech` | 116 |
| `qa-21-earthworks-drainage` | 116 |
| `qa-22-trackform-rail` | 238 |
| `qa-24-stations-depots-plant` | 246 |
