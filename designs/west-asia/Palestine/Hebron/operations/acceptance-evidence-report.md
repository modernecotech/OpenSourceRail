# Hebron Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 358 |
| Manufacturing schedule rows | 1,357 |
| Manufacturing material/BOM rows | 20,204 |
| Manufacturing QA verification rows | 1,357 |
| Construction QA action rows | 1,257 |
| Maintenance handover schedule rows | 1,621 |
| Manufacturing rows with material refs | 1,357 / 1,357 |
| Manufacturing rows with verification refs | 1,357 / 1,357 |
| Manufacturing rows linked to QA actions | 1,357 / 1,357 |
...
| `qa-26-wayside-comms-safety` | 138 |
