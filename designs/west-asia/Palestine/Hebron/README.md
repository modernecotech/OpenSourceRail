...
|---|---|---|---|---|
| line-1 | 19.5 km | 12 | 49 | S Outer ↔ N Mid |
| line-2 | 17.5 km | 11 | 45 | SW Mid ↔ NE Mid |
| line-3 | 23.3 km | 13 | 59 | E Outer ↔ NW Outer |
| **Total** | **60.3 km** | **36 unique** | **153** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **58.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 491 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 93 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 82 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 58.9 MW / 324 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 140 kWh | 253 kWh | 99 kWh | 2.7 km / 20 kWh |
| line-2 | 11 | 126 kWh | 233 kWh | 94 kWh | 2.0 km / 15 kWh |
| line-3 | 11 | 168 kWh | 278 kWh | 93 kWh | 6.8 km / 49 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 459 | $60 k | $28 M |
| High sensitivity check | 459 | $120 k | $55 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 58,862 kW @ $700/kW | $41 M |
| Grid interconnection / PPA tie-in | 58,862 kW @ $100/kW | $5.9 M |
| Annual generation proxy | 58.9 MW × 5.5 peak-sun-h/day × 365 d/yr | 118.2 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hebron`.
...
|---|---|---|
| Construction (years 1–7) | **$39 M / yr** | $49 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$272 M cumulative** | $340 |
| Lifecycle envelope (yr 1–40, high scenario) | **$272 M cumulative** | $340 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.20 bn cumulative** | $1,506 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $481 M | 4.5% | 40 y, 7 y grace | $28 M / yr |
| Government equity (no debt service) | 20% | $120 M | — | — | — |
| **Total** | **100%** | **$602 M** | | | **$28 M / yr** |
...
| Traction energy (132.7 GWh / yr) | 28,045 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.9 GWh/yr + dedicated solar plant 58.9 MW / 118.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $706 k |
| Labour (421 FTE) | driverless roster: OCC/remote 94, station/platform 118, passenger service 49, fleet maintenance 83, infrastructure/energy 56, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 28,045 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.1 M train-km / yr (33.2 M car-km / yr). On-site PV covers 29.9 GWh/yr and the dedicated solar plant adds 118.2 GWh/yr against 132.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 153 trainsets, 36 stations, 60.3 route-km, 3 lines, and 28,045 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 12.3 M |
| Annual paid trips / city resident | 92 | 147 | 15 |
| Farebox revenue | $70 M / yr | $113 M / yr | $12 M / yr |
| Station shop leases | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| Advertising boards | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| **Total revenue** | **$74 M / yr** | **$117 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 470% | 736% | 100% |
...
| Operating surplus after OPEX (before debt support) | $59 M / yr | $101 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,944 m² of station shop/kiosk leases at $29/m²/month and 968 advertising boards at $252/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $27 M / yr | $44 M / yr | 21% of paid trips × $1.80 local spend proxy |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 12,856 trips/school day; 2.8 M access-events/yr | 20,570 trips/school day; 4.5 M access-events/yr |
| Healthcare | 6 healthcare anchors | 17,677 trips/day; 6.5 M access-events/yr | 28,284 trips/day; 10.3 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 41,515 trips/trading day; 13.7 M access-events/yr | 66,424 trips/trading day; 21.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $337 M | 56% of $602 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,476 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$602 M** |
| 15%–25% planning risk envelope | $692 M–$752 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-54082 k / $230 M |
| Low/high project IRR | 7.0% / 11.5% |
| Low/high steady-state DSCR | 2.07 / 3.56 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,226.31 train-km; 16,028.45 kWh consumed; 17,179.46 kWh charged; 24 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,907.13 train-km; 208,118.40 kWh consumed; 212,450.06 kWh charged; 497 depot services completed (6 active at cutoff); minimum SoC 61%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 52.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 61.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 96.7% / 60% | pass |
| ten-hour single charging-pad outage | 61.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 36 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
