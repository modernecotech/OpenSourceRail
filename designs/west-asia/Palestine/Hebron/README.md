...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$792 M (86.7%) of external capital** and **$992 M of external interest**. Capital plus saved interest totals **$1.78 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (59.0 km @ $3.0 M/km) | $177 M |
...
|---|---:|---:|---:|---:|
| Civil works | $197 M | 15% | $30 M | $168 M |
...
| EPC / project services | $30 M | 15% | $4.5 M | $25 M |
| **Total city CAPEX** | **$507 M** | **24.0%** | **$122 M** | **$386 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$122 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$386 M** | **$55 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $309 M | $44 M / yr |
| **Total city programme** | **100.0%** | **$507 M** | **$72 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $685 M | $563 M (82.2%) | $706 M | **$1.27 bn** |
| **Default** | 2.00× | $913 M | $792 M (86.7%) | $992 M | **$1.78 bn** |
| High | 3.00× | $1.37 bn | $1.25 bn (91.1%) | $1.56 bn | **$2.81 bn** |

At the default 2.00× case, OSR's $122 M external requirement is 86.7% below the illustrative foreign-company requirement of $913 M; the associated lifetime external-interest saving is $992 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $53 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$299 M cumulative** | $374 |
| Lifecycle envelope (yr 1–40, high scenario) | **$299 M cumulative** | $374 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.46 bn cumulative** | $1,829 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $122 M | 4.5% | 40 y, 7 y grace | $7.1 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $309 M | 8.5% | 40 y, 7 y grace | $28 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $77 M | — | — | — |
| **Total** | **100%** | **$507 M** | | | **$35 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.5 M / yr + local bonds $26 M / yr = **$32 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Farebox revenue | $70 M / yr | $113 M / yr | $11 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$73 M / yr** | **$116 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 530% | 836% | 100% |
...
| Operating surplus after OPEX (before debt support) | $59 M / yr | $102 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $386 M | 76% of $507 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 22,318 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $457 M |
| Timetable-sized dedicated solar CAPEX | $51 M |
| **Reconciled project CAPEX** | **$507 M** |
| Imported / external-capital requirement | $122 M (24.0%) |
| Local-content / local-funding requirement | $386 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $913 M; OSR saves $792 M (86.7%) |
| Lifetime external interest and combined financing saving | $992 M interest; $1.78 bn capital + interest |
| 15%–25% planning risk envelope | $583 M–$634 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $22 M / $306 M |
| Low/high project IRR | 8.4% / 13.2% |
| Low/high steady-state DSCR | 1.69 / 2.88 |
