...
**Country:** PS · **Population:** 800,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$743 M (86.4%) of external capital** and **$931 M of external interest**. Capital plus saved interest totals **$1.67 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`hebron.corridor.geojson`](hebron.corridor.geojson).
...
| Anchor-weighted coverage | 73.3% |
| Route length (double track) | 60.3 km |
...
- Anchor-weighted coverage: 73.3%
- Catchment population: **≈ 586,400** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 7.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 465 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 58 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 60 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 28,045 train-km/day | One-way train journeys × route length |
| Annual service work | 11.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 363 MWh/day | 33.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 303 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 63.3 MW / 348 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 140 kWh | 229 kWh | 74 kWh | 6.4 km / 46 kWh |
| line-2 | 8 | 126 kWh | 196 kWh | 58 kWh | 3.0 km / 22 kWh |
| line-3 | 6 | 168 kWh | 270 kWh | 85 kWh | 10.4 km / 75 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (59.0 km @ $2.58 M/km) | $153 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 381 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 381 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 63,347 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 63,347 kW @ $100/kW | $6.3 M |
| Annual generation proxy | 63.3 MW × 5.5 peak-sun-h/day × 365 d/yr | 127.2 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 60.3 km × $0.050 M/km | $3.0 M |
...
| Per-capita (city pop) | $597 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $170 M | 15% | $25 M | $144 M |
| Stations | $102 M | 20% | $20 M | $82 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $114 M | 35% | $40 M | $74 M |
| Dedicated solar plant | $51 M | 45% | $23 M | $28 M |
| Residual signalling / train control | $3.0 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $2.3 M | 40% | $930 k | $1.4 M |
| EPC / project services | $28 M | 15% | $4.2 M | $24 M |
| **Total city CAPEX** | **$478 M** | **24.5%** | **$117 M** | **$361 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh hebron`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.5%** | **$117 M** | **$17 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.5%** | **$361 M** | **$52 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $289 M | $41 M / yr |
| **Total city programme** | **100.0%** | **$478 M** | **$68 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $645 M | $528 M (81.8%) | $662 M | **$1.19 bn** |
| **Default** | 2.00× | $860 M | $743 M (86.4%) | $931 M | **$1.67 bn** |
| High | 3.00× | $1.29 bn | $1.17 bn (90.9%) | $1.47 bn | **$2.64 bn** |

At the default 2.00× case, OSR's $117 M external requirement is 86.4% below the illustrative foreign-company requirement of $860 M; the associated lifetime external-interest saving is $931 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$40 M / yr** | $50 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$281 M cumulative** | $351 |
| Lifecycle envelope (yr 1–40, high scenario) | **$281 M cumulative** | $351 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.38 bn cumulative** | $1,720 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $117 M | 4.5% | 40 y, 7 y grace | $6.9 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $289 M | 8.5% | 40 y, 7 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $72 M | — | — | — |
| **Total** | **100%** | **$478 M** | | | **$33 M / yr** |
...
| Traction energy (132.7 GWh / yr) | 28,045 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 22.1 GWh/yr + dedicated solar plant 63.3 MW / 127.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $760 k |
| Labour (362 FTE) | driverless roster: OCC/remote 81, station/platform 85, passenger service 49, fleet maintenance 75, infrastructure/energy 51, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.2 M |
| **OPEX subtotal** | | **$13 M / yr** |

_Annual service work: 28,045 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.1 M train-km / yr (33.2 M car-km / yr). On-site PV covers 22.1 GWh/yr and the dedicated solar plant adds 127.2 GWh/yr against 132.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 127 trainsets, 22 stations, 60.3 route-km, 3 lines, and 28,045 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 10.8 M |
| Annual paid trips / city resident | 92 | 147 | 14 |
| Farebox revenue | $70 M / yr | $113 M / yr | $10 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| **Total revenue** | **$73 M / yr** | **$116 M / yr** | **$13 M / yr** |
| Revenue / OPEX recovery | 552% | 871% | 100% |
...
| Operating surplus after OPEX (before debt support) | $60 M / yr | $102 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,616 m² of station shop/kiosk leases at $29/m²/month and 696 advertising boards at $252/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $25 M / yr | 199 M - 318 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.6 M / yr | 35.8–57.3 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.0 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $29 M / yr | $47 M / yr | 22% of paid trips × $1.80 local spend proxy |
| Entertainment / community activity supported | $14 M / yr | $22 M / yr | 11% of paid trips × $1.80 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$90 M / yr** | **$145 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 5 healthcare anchors | 18,543 trips/day; 6.8 M access-events/yr | 29,668 trips/day; 10.8 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 44,604 trips/trading day; 14.7 M access-events/yr | 71,367 trips/trading day; 23.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $361 M | 75% of $478 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $577 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $82 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 20,873 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $427 M |
| Timetable-sized dedicated solar CAPEX | $51 M |
| **Reconciled project CAPEX** | **$478 M** |
| Imported / external-capital requirement | $117 M (24.5%) |
| Local-content / local-funding requirement | $361 M (75.5%) |
| Default foreign-turnkey external-capital comparison | $860 M; OSR saves $743 M (86.4%) |
| Lifetime external interest and combined financing saving | $931 M interest; $1.67 bn capital + interest |
| 15%–25% planning risk envelope | $550 M–$597 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $48 M / $331 M |
| Low/high project IRR | 9.0% / 13.8% |
| Low/high steady-state DSCR | 1.81 / 3.08 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,235.35 train-km; 16,093.36 kWh consumed; 14,896.63 kWh charged; 27 depot services completed; minimum SoC 69%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,968.47 train-km; 194,159.16 kWh consumed; 187,244.31 kWh charged; 485 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 96.2% of scheduled train-km delivered; 33 SoC warnings; 4 energy-adapted off-peak departures, maximum 12 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 94.5% / 90% | pass |
| 50% charging-contact availability | 20.1% | 96.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 84.2% / 60% | pass |
| ten-hour single charging-pad outage | 20.1% | 96.2% / 90% | pass |
...
|---|---|
| ![Hebron energy and battery simulation dashboard](engineering/screenshots/hebron-simulation-dashboard.png) | ![Hebron simulator network visualizer](engineering/screenshots/hebron-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Hebron QGIS engineering layers](engineering/screenshots/hebron-qgis-engineering-map.png) | ![Hebron SUMO timetable validation](engineering/screenshots/hebron-sumo-validation.png) |
...
| [`hebron.toml`](hebron.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`hebron-network-map.png`](hebron-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`hebron.corridor.geojson`](hebron.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`hebron.stations.json`](hebron.stations.json) | Machine-readable station list |
| [`hebron.design-quality.yaml`](hebron.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug hebron
