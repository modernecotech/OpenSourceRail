...
| Bucket | Value |
|---|---|
| At-grade (23.4 km @ $0.85 M/km) | $20 M |
| Elevated (0.0 km @ $4.0 M/km) | $80 k |
| **Civil subtotal** | **$20 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 24 | $800 k | $19 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 23.9 km × $0.015 M/km | $359 k |
...
| EPC integration + project management (7%) | on subtotal | $4.1 M |
...
| EPC overhead (7%) | $4.1 M |
| **CAPEX total** | **$62 M** |
| Per-route-km | $2.6 M / km |
| Per-capita (city pop) | $104 / person |
...
|---|---|---|
| Construction (years 1–7) | **$3.8 M / yr** | $6 |
...
| Lifecycle envelope (yr 1–30, low scenario) | **$27 M cumulative** | $44 |
| Lifecycle envelope (yr 1–30, high scenario) | **$27 M cumulative** | $44 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$27 M cumulative** | $44 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $37 M | 3.0% | 30 y, 7 y grace | $2.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $16 M | 8.5% | 30 y, 7 y grace | $1.6 M / yr |
| Government equity (no debt service) | 15% | $9.4 M | — | — | — |
| **Total** | **100%** | **$62 M** | | | **$3.8 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $1.1 M / yr + bonds $1.3 M / yr = **$2.5 M / yr** total — plus the equity tranche amortised across construction ($1.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $768 k |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $710 k |
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 17,350 |
| Daily paid trips / population | 8% | 15% | 3% |
| Annual paid trips | 17.5 M | 32.9 M | 6.3 M |
| Farebox revenue | $13 M / yr | $24 M / yr | $4.6 M / yr |
| Station shop leases | $652 k / yr | $652 k / yr | $652 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$14 M / yr** | **$25 M / yr** | **$6.3 M / yr** |
| Revenue / OPEX + debt-service recovery | 228% | 404% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $0 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $8.1 M / yr | $19 M / yr | $0 / yr |
