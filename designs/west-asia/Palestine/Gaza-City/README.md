...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$517 M (86.7%) of external capital** and **$648 M of external interest**. Capital plus saved interest totals **$1.17 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 38.8 km |
...
- Anchor-weighted coverage: 61.7%
- Catchment population: **≈ 370,200** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **38.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 461 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 37 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 18,058 train-km/day | One-way train journeys × route length |
| Annual service work | 7.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 234 MWh/day | 21.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 185 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 38.7 MW / 213 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 87 kWh | 147 kWh | 51 kWh | 3.0 km / 22 kWh |
| line-2 | 4 | 122 kWh | 196 kWh | 62 kWh | 10.9 km / 79 kWh |
| line-3 | 4 | 70 kWh | 114 kWh | 37 kWh | 3.7 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (36.3 km @ $2.58 M/km) | $94 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 38,700 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 38,700 kW @ $100/kW | $3.9 M |
| Annual generation proxy | 38.7 MW × 5.5 peak-sun-h/day × 365 d/yr | 77.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 38.8 km × $0.050 M/km | $1.9 M |
...
| Residual signalling / train control | $1.9 M | 50% | $971 k | $971 k |
| Charging microgrids | $1.6 M | 40% | $640 k | $960 k |
| EPC / project services | $20 M | 15% | $2.9 M | $17 M |
| **Total city CAPEX** | **$332 M** | **24.0%** | **$80 M** | **$252 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh gaza-city`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$80 M** | **$11 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$252 M** | **$36 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $202 M | $29 M / yr |
| **Total city programme** | **100.0%** | **$332 M** | **$47 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $448 M | $368 M (82.2%) | $461 M | **$829 M** |
| **Default** | 2.00× | $597 M | $517 M (86.7%) | $648 M | **$1.17 bn** |
| High | 3.00× | $895 M | $816 M (91.1%) | $1.02 bn | **$1.84 bn** |

At the default 2.00× case, OSR's $80 M external requirement is 86.7% below the illustrative foreign-company requirement of $597 M; the associated lifetime external-interest saving is $648 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$28 M / yr** | $47 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$195 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, high scenario) | **$195 M cumulative** | $326 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$956 M cumulative** | $1,593 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $80 M | 4.5% | 40 y, 7 y grace | $4.7 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $202 M | 8.5% | 40 y, 7 y grace | $18 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $50 M | — | — | — |
| **Total** | **100%** | **$332 M** | | | **$23 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.6 M / yr + local bonds $17 M / yr = **$21 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (85.4 GWh / yr) | 18,058 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 17.9 GWh/yr + dedicated solar plant 38.7 MW / 77.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $464 k |
| Labour (275 FTE) | driverless roster: OCC/remote 61, station/platform 60, passenger service 49, fleet maintenance 49, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$9.3 M / yr** |

_Annual service work: 18,058 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (21.4 M car-km / yr). On-site PV covers 17.9 GWh/yr and the dedicated solar plant adds 77.7 GWh/yr against 85.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 84 trainsets, 15 stations, 38.8 route-km, 3 lines, and 18,058 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 7.5 M |
| Annual paid trips / city resident | 122 | 196 | 13 |
| Farebox revenue | $70 M / yr | $113 M / yr | $7.2 M / yr |
| Station shop leases | $774 k / yr | $774 k / yr | $774 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$72 M / yr** | **$115 M / yr** | **$9.3 M / yr** |
| Revenue / OPEX recovery | 780% | 1235% | 100% |
...
| Operating surplus after OPEX (before debt support) | $63 M / yr | $105 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,544 m² of station shop/kiosk leases at $29/m²/month and 496 advertising boards at $252/board/month, with occupancy derates applied._
...
| Avoided road congestion | $10 M / yr | $16 M / yr | 128 M - 205 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.8 M / yr | $2.9 M / yr | 23.0–36.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.1 M / yr | $8.2 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $30 M / yr | $49 M / yr | 23% of paid trips × $1.80 local spend proxy |
...
| Healthcare | 5 healthcare anchors | 19,084 trips/day; 7.0 M access-events/yr | 30,534 trips/day; 11.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $252 M | 76% of $332 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $403 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $58 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 14,580 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$332 M** |
| Imported / external-capital requirement | $80 M (24.0%) |
| Local-content / local-funding requirement | $252 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $597 M; OSR saves $517 M (86.7%) |
| Lifetime external interest and combined financing saving | $648 M interest; $1.17 bn capital + interest |
| 15%–25% planning risk envelope | $381 M–$414 M |
| Annual OPEX | $9.3 M / yr |
| Low/high project NPV at 8% | $178 M / $461 M |
| Low/high project IRR | 12.7% / 18.2% |
| Low/high steady-state DSCR | 2.74 / 4.57 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,629.10 train-km; 11,728.70 kWh consumed; 10,378.83 kWh charged; 36 depot services completed; minimum SoC 66%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,901.05 train-km; 128,878.35 kWh consumed; 124,096.75 kWh charged; 496 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 99.1% of scheduled train-km delivered; 55 SoC warnings; 8 energy-adapted off-peak departures, maximum 20 min headway |
...
| ten-hour all-site grid outage | 20.0% | 86.8% / 60% | pass |
...
|---|---|
| ![Gaza-City energy and battery simulation dashboard](engineering/screenshots/gaza-city-simulation-dashboard.png) | ![Gaza-City simulator network visualizer](engineering/screenshots/gaza-city-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 1 interchange complexes, 71 civil segments, and 0 input findings |
...
|---|---|
| ![Gaza-City QGIS engineering layers](engineering/screenshots/gaza-city-qgis-engineering-map.png) | ![Gaza-City SUMO timetable validation](engineering/screenshots/gaza-city-sumo-validation.png) |
