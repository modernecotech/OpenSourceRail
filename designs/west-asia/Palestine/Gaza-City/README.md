...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$554 M (87.0%) of external capital** and **$694 M of external interest**. Capital plus saved interest totals **$1.25 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (36.3 km @ $3.0 M/km) | $109 M |
...
| Per-capita (city pop) | $589 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $143 M | 15% | $22 M | $122 M |
...
| **Total city CAPEX** | **$354 M** | **23.4%** | **$83 M** | **$271 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$83 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$271 M** | **$39 M / yr** |
| of which planned local bond issuance | 61.2% of total CAPEX | $217 M | $31 M / yr |
| **Total city programme** | **100.0%** | **$354 M** | **$51 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $477 M | $395 M (82.6%) | $495 M | **$889 M** |
| **Default** | 2.00× | $637 M | $554 M (87.0%) | $694 M | **$1.25 bn** |
| High | 3.00× | $955 M | $872 M (91.3%) | $1.09 bn | **$1.97 bn** |

At the default 2.00× case, OSR's $83 M external requirement is 87.0% below the illustrative foreign-company requirement of $637 M; the associated lifetime external-interest saving is $694 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$209 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, high scenario) | **$209 M cumulative** | $349 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $1,703 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $83 M | 4.5% | 40 y, 7 y grace | $4.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $217 M | 8.5% | 40 y, 7 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $54 M | — | — | — |
| **Total** | **100%** | **$354 M** | | | **$25 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.7 M / yr + local bonds $18 M / yr = **$22 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 8.0 M |
| Annual paid trips / city resident | 122 | 196 | 13 |
| Farebox revenue | $70 M / yr | $113 M / yr | $7.6 M / yr |
| Station shop leases | $774 k / yr | $774 k / yr | $774 k / yr |
| Advertising boards | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| **Total revenue** | **$72 M / yr** | **$115 M / yr** | **$9.7 M / yr** |
| Revenue / OPEX recovery | 747% | 1182% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $271 M | 77% of $354 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $433 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $62 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 15,671 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $323 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$354 M** |
| Imported / external-capital requirement | $83 M (23.4%) |
| Local-content / local-funding requirement | $271 M (76.6%) |
| Default foreign-turnkey external-capital comparison | $637 M; OSR saves $554 M (87.0%) |
| Lifetime external interest and combined financing saving | $694 M interest; $1.25 bn capital + interest |
| 15%–25% planning risk envelope | $407 M–$442 M |
| Annual OPEX | $9.7 M / yr |
| Low/high project NPV at 8% | $158 M / $442 M |
| Low/high project IRR | 12.0% / 17.4% |
| Low/high steady-state DSCR | 2.55 / 4.26 |
