...
Aggregate station-rail charging power: **5,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 320 kWh battery covers running.
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 24 | €2.0 M | €48 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 23.9 km × €0.1 M/km | €2.3 M |
...
| Lifecycle envelope (yr 1–30, low scenario) | **€423 M cumulative** | €705 |
| Lifecycle envelope (yr 1–30, high scenario) | **€423 M cumulative** | €705 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€0 k / yr (low) → €0 k / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €138 M | 3.0% | 30 y, 7 y grace | €8.4 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €57 M | 8.5% | 30 y, 7 y grace | €5.8 M / yr |
| Government equity (no debt service) | 15% | €34 M | — | — | — |
| **Total** | **100%** | **€230 M** | | | **€14 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €4.1 M / yr + bonds €4.9 M / yr = **€9.0 M / yr** total — plus the equity tranche amortised across construction (€4.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €117 k |
...
| Farebox / OPEX recovery | 104% | 208% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €0 k / yr | €0 k / yr |
| Operating surplus (operator retained → capex sinking fund) | €233 k / yr | €6.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€14 M / yr** | **€14 M / yr** |
