...
|---|---|---|
| Construction (years 1–7) | **$40 M / yr** | $90 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $65 |
| Lifecycle envelope (yr 1–40, low scenario) | **$282 M cumulative** | $627 |
| Lifecycle envelope (yr 1–40, high scenario) | **$282 M cumulative** | $627 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.25 bn cumulative** | $2,779 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $500 M | 4.5% | 40 y, 7 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $125 M | — | — | — |
| **Total** | **100%** | **$624 M** | | | **$29 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $345 M | 55% of $624 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 19,963 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $561 M |
| Timetable-sized dedicated solar CAPEX | $63 M |
| **Reconciled project CAPEX** | **$624 M** |
| 15%–25% planning risk envelope | $718 M–$781 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-85422 k / $198 M |
| Low/high project IRR | 6.5% / 11.0% |
| Low/high steady-state DSCR | 1.92 / 3.36 |
