...
|---|---|---|---|---|
| line-1 | 19.1 km | 12 | 31 | NW Mid ↔ SE Mid |
| line-2 | 22.9 km | 12 | 37 | W Mid ↔ E Mid |
| line-3 | 22.7 km | 10 | 37 | NE Outer ↔ SW Inner |
| **Total** | **64.6 km** | **34 unique** | **105** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **78.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 423 MWh/day | 32,645 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 343 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 78.9 MW / 395 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Bucket | Value |
|---|---|
| At-grade (63.3 km @ $3.0 M/km) | $190 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 78,908 kW @ $700/kW | $55 M |
| Grid interconnection / PPA tie-in | 78,908 kW @ $100/kW | $7.9 M |
| Annual generation proxy | 78.9 MW × 5.0 peak-sun-h/day × 365 d/yr | 144.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.6 km × $0.050 M/km | $3.2 M |
...
| Per-capita (city pop) | $2,168 / person |
...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $97 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$33 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$304 M cumulative** | $676 |
| Lifecycle envelope (yr 1–40, high scenario) | **$304 M cumulative** | $676 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.38 bn cumulative** | $3,062 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $780 M | 2.0% | 40 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 20% | $195 M | — | — | — |
| **Total** | **100%** | **$975 M** | | | **$33 M / yr** |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $161 k |
| Traction energy (154.4 GWh / yr) | 32,645 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 29.2 GWh/yr + dedicated solar plant 78.9 MW / 144.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $947 k |
| Labour (414 FTE) | driverless roster: OCC/remote 69, station/platform 112, passenger service 44, fleet maintenance 75, infrastructure/energy 78, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$29 M / yr** |

_Annual service work: 32,645 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.9 M train-km / yr (38.6 M car-km / yr). On-site PV covers 29.2 GWh/yr and the dedicated solar plant adds 144.0 GWh/yr against 154.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 63.1 M | 100.9 M | 25.8 M |
| Annual paid trips / city resident | 140 | 224 | 57 |
| Farebox revenue | $61 M / yr | $97 M / yr | $25 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| **Total revenue** | **$64 M / yr** | **$101 M / yr** | **$29 M / yr** |
...
| Operating surplus after OPEX (before debt support) | $36 M / yr | $72 M / yr | $0 / yr |
...
| Avoided CO2e | $2.6 M / yr | $4.2 M / yr | 33.0–52.8 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $7.3 M / yr | $12 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $24 M / yr | $38 M / yr | 21% of paid trips × $1.80 local spend proxy |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 7,845 trips/school day; 1.7 M access-events/yr | 12,552 trips/school day; 2.8 M access-events/yr |
| Healthcare | 4 healthcare anchors | 13,271 trips/day; 4.8 M access-events/yr | 21,234 trips/day; 7.8 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 36,186 trips/trading day; 11.9 M access-events/yr | 57,898 trips/trading day; 19.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $509 M | 52% of $975 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $815 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $116 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 29,461 job-years | retained CAPEX ÷ (4.0 × median annual income) |
