...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$918 M (86.3%) of external capital** and **$1.15 bn of external interest**. Capital plus saved interest totals **$2.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (70.4 km @ $3.0 M/km) | $211 M |
...
| Per-capita (city pop) | $1,313 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $232 M | 15% | $35 M | $197 M |
...
| EPC / project services | $35 M | 15% | $5.2 M | $29 M |
| **Total city CAPEX** | **$591 M** | **24.7%** | **$146 M** | **$445 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$146 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$445 M** | **$64 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $356 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$591 M** | **$84 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $798 M | $652 M (81.7%) | $817 M | **$1.47 bn** |
| **Default** | 2.00× | $1.06 bn | $918 M (86.3%) | $1.15 bn | **$2.07 bn** |
| High | 3.00× | $1.60 bn | $1.45 bn (90.8%) | $1.82 bn | **$3.27 bn** |

At the default 2.00× case, OSR's $146 M external requirement is 86.3% below the illustrative foreign-company requirement of $1.06 bn; the associated lifetime external-interest saving is $1.15 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$50 M / yr** | $110 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$41 M / yr** | $91 |
| Lifecycle envelope (yr 1–40, low scenario) | **$347 M cumulative** | $771 |
| Lifecycle envelope (yr 1–40, high scenario) | **$347 M cumulative** | $771 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.70 bn cumulative** | $3,779 |
...
| Farebox revenue | $70 M / yr | $113 M / yr | $14 M / yr |
...
| Revenue / OPEX recovery | 443% | 699% | 100% |
...
| Operating surplus after OPEX (before debt support) | $56 M / yr | $99 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $445 M | 75% of $591 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $712 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $102 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 25,747 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $528 M |
| Timetable-sized dedicated solar CAPEX | $63 M |
| **Reconciled project CAPEX** | **$591 M** |
| Imported / external-capital requirement | $146 M (24.7%) |
| Local-content / local-funding requirement | $445 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $1.06 bn; OSR saves $918 M (86.3%) |
| Lifetime external interest and combined financing saving | $1.15 bn interest; $2.07 bn capital + interest |
| 15%–25% planning risk envelope | $680 M–$739 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-60497 k / $223 M |
| Low/high project IRR | 6.9% / 11.5% |
| Low/high steady-state DSCR | 1.37 / 2.40 |
