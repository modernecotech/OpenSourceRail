...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$861 M (85.9%) of external capital** and **$1.08 bn of external interest**. Capital plus saved interest totals **$1.94 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 71.7 km |
| Revenue fleet | 156 × 3-car trainsets |
| Revenue fleet passenger capacity | 56,160 AW2 pax (74,880 AW3 crush) |
...
| Revenue fleet capacity | 56,160 AW2 pax (74,880 AW3 crush) |
| Total fleet capacity | 62,640 AW2 pax (83,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 156 × 360 = **56,160 AW2 passengers** (74,880 AW3 crush)
- **Total fleet passenger capacity:** 174 × 360 = **62,640 AW2 passengers** (83,520 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 71.4%
- Catchment population: **≈ 321,300** (within ~800 m walk of a station)
...
| **Total installed** | **18** | **10,100 kW** | **48,500 kWh** |

Aggregate station-rail charging power: **9,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **78.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 439 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 83 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 56 MWh/day | 5.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 33,353 train-km/day | One-way train journeys × route length |
| Annual service work | 13.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 432 MWh/day | 39.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 377 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 78.8 MW / 433 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 147 kWh | 245 kWh | 83 kWh | 9.8 km / 71 kWh |
| line-2 | 7 | 204 kWh | 314 kWh | 90 kWh | 11.5 km / 83 kWh |
| line-3 | 5 | 165 kWh | 265 kWh | 84 kWh | 14.0 km / 101 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (70.4 km @ $2.58 M/km) | $182 M |
| Elevated (1.3 km @ $9.75 M/km) | $13 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$199 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 174 | $900 k | $157 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 522 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 522 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 78,767 kW @ $700/kW | $55 M |
| Grid interconnection / PPA tie-in | 78,767 kW @ $100/kW | $7.9 M |
| Annual generation proxy | 78.8 MW × 5.5 peak-sun-h/day × 365 d/yr | 158.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 71.7 km × $0.050 M/km | $3.6 M |
...
| Per-capita (city pop) | $1,236 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $199 M | 15% | $30 M | $169 M |
| Stations | $92 M | 20% | $18 M | $73 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $157 M | 35% | $55 M | $102 M |
| Dedicated solar plant | $63 M | 45% | $28 M | $35 M |
| Residual signalling / train control | $3.6 M | 50% | $1.8 M | $1.8 M |
| Charging microgrids | $2.0 M | 40% | $810 k | $1.2 M |
| EPC / project services | $32 M | 15% | $4.8 M | $27 M |
| **Total city CAPEX** | **$556 M** | **25.3%** | **$141 M** | **$416 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh nablus`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.3%** | **$141 M** | **$20 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.7%** | **$416 M** | **$59 M / yr** |
| of which planned local bond issuance | 59.8% of total CAPEX | $332 M | $47 M / yr |
| **Total city programme** | **100.0%** | **$556 M** | **$79 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $751 M | $610 M (81.3%) | $765 M | **$1.38 bn** |
| **Default** | 2.00× | $1.00 bn | $861 M (85.9%) | $1.08 bn | **$1.94 bn** |
| High | 3.00× | $1.50 bn | $1.36 bn (90.6%) | $1.71 bn | **$3.07 bn** |

At the default 2.00× case, OSR's $141 M external requirement is 85.9% below the illustrative foreign-company requirement of $1.00 bn; the associated lifetime external-interest saving is $1.08 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$46 M / yr** | $103 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$39 M / yr** | $86 |
| Lifecycle envelope (yr 1–40, low scenario) | **$325 M cumulative** | $723 |
| Lifecycle envelope (yr 1–40, high scenario) | **$325 M cumulative** | $723 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.60 bn cumulative** | $3,552 |

_Population basis: 450,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $39 M / yr → $39 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $141 M | 4.5% | 40 y, 7 y grace | $8.3 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $332 M | 8.5% | 40 y, 7 y grace | $30 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $83 M | — | — | — |
| **Total** | **100%** | **$556 M** | | | **$39 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.3 M / yr + local bonds $28 M / yr = **$35 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $179 k |
| Traction energy (157.8 GWh / yr) | 33,353 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 78.8 MW / 158.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $945 k |
| Labour (406 FTE) | driverless roster: OCC/remote 102, station/platform 77, passenger service 49, fleet maintenance 97, infrastructure/energy 60, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 33,353 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.1 M train-km / yr (39.4 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 158.1 GWh/yr against 157.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 174 trainsets, 24 stations, 71.7 route-km, 3 lines, and 33,353 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 13.9 M |
| Annual paid trips / city resident | 163 | 261 | 31 |
| Farebox revenue | $70 M / yr | $113 M / yr | $13 M / yr |
| Station shop leases | $929 k / yr | $929 k / yr | $929 k / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$73 M / yr** | **$115 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 461% | 728% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $39 M / yr | $39 M / yr | **$39 M / yr** |
| Operating surplus applied to debt support | -$39 M / yr | -$39 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$39 M / yr** |
| Operating surplus after OPEX (before debt support) | $57 M / yr | $99 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,056 m² of station shop/kiosk leases at $29/m²/month and 608 advertising boards at $252/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $20 M / yr | $32 M / yr | 16 min/trip × $1.04/h value-of-time proxy |
| Avoided road congestion | $19 M / yr | $30 M / yr | 237 M - 379 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.4 M / yr | $5.5 M / yr | 42.6–68.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $9.5 M / yr | $15 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $27 M / yr | $43 M / yr | 20% of paid trips × $1.80 local spend proxy |
| Entertainment / community activity supported | $14 M / yr | $22 M / yr | 11% of paid trips × $1.80 local spend proxy |
...
| Healthcare | 3 healthcare anchors | 15,217 trips/day; 5.6 M access-events/yr | 24,347 trips/day; 8.9 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 40,929 trips/trading day; 13.5 M access-events/yr | 65,487 trips/trading day; 21.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $416 M | 75% of $556 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $665 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $95 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 24,049 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $493 M |
| Timetable-sized dedicated solar CAPEX | $63 M |
| **Reconciled project CAPEX** | **$556 M** |
| Imported / external-capital requirement | $141 M (25.3%) |
| Local-content / local-funding requirement | $416 M (74.7%) |
| Default foreign-turnkey external-capital comparison | $1.00 bn; OSR saves $861 M (85.9%) |
| Lifetime external interest and combined financing saving | $1.08 bn interest; $1.94 bn capital + interest |
| 15%–25% planning risk envelope | $640 M–$695 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-30490 k / $253 M |
| Low/high project IRR | 7.4% / 12.1% |
| Low/high steady-state DSCR | 1.48 / 2.57 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,590.26 train-km; 18,648.45 kWh consumed; 14,114.85 kWh charged; 24 depot services completed; minimum SoC 63%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 31,885.52 train-km; 229,559.68 kWh consumed; 194,184.00 kWh charged; 464 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.6% of scheduled train-km delivered; 258 SoC warnings; 40 energy-adapted off-peak departures, maximum 29 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 94.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.3% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 79.4% / 60% | pass |
...
|---|---|
| ![Nablus energy and battery simulation dashboard](engineering/screenshots/nablus-simulation-dashboard.png) | ![Nablus simulator network visualizer](engineering/screenshots/nablus-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 24 line platforms, 1 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Nablus QGIS engineering layers](engineering/screenshots/nablus-qgis-engineering-map.png) | ![Nablus SUMO timetable validation](engineering/screenshots/nablus-sumo-validation.png) |
...
scripts/regenerate-city.sh nablus
```
