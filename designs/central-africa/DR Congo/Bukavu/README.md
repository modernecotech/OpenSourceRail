...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **45.7%** | **$231 M** | **$23 M / yr** |
| **Local capital for domestic procurement / payroll** | **54.3%** | **$274 M** | **$27 M / yr** |
| of which planned local bond issuance | 43.4% of total CAPEX | $219 M | $22 M / yr |
...
| Steady-state, low capacity-use (year 11+) | **$33 M / yr** | $33 |
| Steady-state, high capacity-use (year 11+) | **$20 M / yr** | $20 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.44 bn cumulative** | $1,445 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.06 bn cumulative** | $1,058 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.75 bn cumulative** | $1,748 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $33 M / yr | $20 M / yr | **$43 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $274 M | 54% of $505 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 51,942 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $231 M (45.7%) |
| Local-content / local-funding requirement | $274 M (54.3%) |
| 15%–25% planning risk envelope | $581 M–$632 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-286434 k / $-219143 k |
| Low/high project IRR | -2.4% / 1.6% |
| Low/high steady-state DSCR | 0.23 / 0.53 |
