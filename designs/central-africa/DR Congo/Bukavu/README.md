...
|---|---|---|---|---|
| line-1 | 18.3 km | 12 | 48 | NE Mid ↔ SW Mid |
| line-2 | 23.6 km | 14 | 61 | NW Outer ↔ SE Outer |
| line-3 | 19.4 km | 11 | 48 | SW Mid ↔ NE Outer |
| **Total** | **61.4 km** | **37 unique** | **157** | |
...
| **Total installed** | **35** | **15,200 kW** | **57,000 kWh** |

Aggregate station-rail charging power: **17,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **71.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 495 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 73 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 73 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 297 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 71.1 MW / 341 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 57 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 12 | 137 kWh | 253 kWh | 103 kWh | 2.2 km / 16 kWh |
| line-2 | 12 | 177 kWh | 302 kWh | 107 kWh | 6.1 km / 45 kWh |
| line-3 | 11 | 146 kWh | 233 kWh | 73 kWh | 2.3 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (57.4 km @ $3.0 M/km) | $172 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 471 | $60 k | $28 M |
| High sensitivity check | 471 | $120 k | $57 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 71,135 kW @ $700/kW | $50 M |
| Grid interconnection / PPA tie-in | 71,135 kW @ $100/kW | $7.1 M |
| Annual generation proxy | 71.1 MW × 4.8 peak-sun-h/day × 365 d/yr | 124.6 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $6.9 M |
| EPC overhead (7%) | $42 M |
| **CAPEX total** | **$706 M** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $706 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bukavu`.
...
|---|---|---|
| Construction (years 1–10) | **$40 M / yr** | $40 |
| Steady-state, low capacity-use (year 11+) | **$28 M / yr** | $28 |
| Steady-state, high capacity-use (year 11+) | **$15 M / yr** | $15 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.22 bn cumulative** | $1,222 |
| Lifecycle envelope (yr 1–40, high scenario) | **$835 M cumulative** | $835 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.43 bn cumulative** | $1,435 |

_Population basis: 1,000,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.1 M / yr → $20 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $565 M | 4.5% | 40 y, 10 y grace | $35 M / yr |
| Government equity (no debt service) | 20% | $141 M | — | — | — |
| **Total** | **100%** | **$706 M** | | | **$35 M / yr** |
...
| Traction energy (135.0 GWh / yr) | 28,540 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.6 GWh/yr + dedicated solar plant 71.1 MW / 124.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $854 k |
| Labour (458 FTE) | driverless roster: OCC/remote 94, station/platform 152, passenger service 49, fleet maintenance 85, infrastructure/energy 57, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $846 k |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 28,540 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.3 M train-km / yr (33.8 M car-km / yr). On-site PV covers 26.6 GWh/yr and the dedicated solar plant adds 124.6 GWh/yr against 135.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 157 trainsets, 37 stations, 61.4 route-km, 3 lines, and 28,540 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 49.1 M |
| Annual paid trips / city resident | 73 | 117 | 49 |
| Farebox revenue | $22 M / yr | $34 M / yr | $14 M / yr |
| Station shop leases | $708 k / yr | $708 k / yr | $708 k / yr |
| Advertising boards | $977 k / yr | $977 k / yr | $977 k / yr |
| **Total revenue** | **$23 M / yr** | **$36 M / yr** | **$16 M / yr** |
...
| Operating surplus applied to debt support | -$7.1 M / yr | -$20 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $28 M / yr | $15 M / yr | **$35 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.1 M / yr | $20 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,704 m² of station shop/kiosk leases at $10/m²/month and 1,244 advertising boards at $77/board/month, with occupancy derates applied._
...
| Healthcare | 7 healthcare anchors | 18,270 trips/day; 6.7 M access-events/yr | 29,231 trips/day; 10.7 M access-events/yr |
| Commerce | 22 major/terminal/interchange nodes | 44,682 trips/trading day; 14.7 M access-events/yr | 71,492 trips/trading day; 23.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $397 M | 56% of $706 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 75,165 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $649 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$706 M** |
| 15%–25% planning risk envelope | $812 M–$882 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-436530 k / $-369239 k |
| Low/high project IRR | -5.4% / -0.8% |
| Low/high steady-state DSCR | 0.20 / 0.58 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,243.64 train-km; 16,800.19 kWh consumed; 17,975.43 kWh charged; 23 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 29,403.18 train-km; 220,168.44 kWh consumed; 224,557.18 kWh charged; 496 depot services completed (5 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 56.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 64.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.0% / 60% | pass |
| ten-hour single charging-pad outage | 64.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 37 line platforms, 2 interchange complexes, 76 civil segments, and 0 input findings |
