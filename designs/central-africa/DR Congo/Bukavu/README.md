...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $30 |
| Steady-state, low capacity-use (year 11+) | **$16 M / yr** | $16 |
| Steady-state, high capacity-use (year 11+) | **$3.1 M / yr** | $3 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$776 M cumulative** | $776 |
| Lifecycle envelope (yr 1–40, high scenario) | **$389 M cumulative** | $389 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.08 bn cumulative** | $1,078 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $424 M | 4.5% | 40 y, 10 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $106 M | — | — | — |
| **Total** | **100%** | **$530 M** | | | **$26 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $19 M / yr = **$19 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($11 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $3.1 M / yr | **$26 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $293 M | 55% of $530 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 55,437 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $610 M–$663 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-303235 k / $-235944 k |
| Low/high project IRR | -2.6% / 1.4% |
| Low/high steady-state DSCR | 0.39 / 0.88 |
