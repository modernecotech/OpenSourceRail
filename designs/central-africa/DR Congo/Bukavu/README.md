...
|---|---|---|
| Construction (years 1–10) | **$45 M / yr** | $45 |
| Steady-state, low-ridership (year 11+) | **$51 M / yr** | $51 |
| Steady-state, high-ridership (year 11+) | **$46 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $43 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.98 bn cumulative** | $1,982 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.84 bn cumulative** | $1,837 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.75 bn cumulative** | $1,750 |

_Population basis: 1,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.7 M / yr → $2.9 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $408 M | 3.0% | 40 y, 10 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $170 M | 13.0% | 40 y, 10 y grace | $23 M / yr |
| Government equity (no debt service) | 15% | $102 M | — | — | — |
| **Total** | **100%** | **$680 M** | | | **$43 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $22 M / yr = **$34 M / yr** total — plus the equity tranche amortised across construction ($10 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 108,180 | 168,480 | 204,654 |
| Daily paid trips / catchment | 18% | 28% | 34% |
| Daily paid trips / city population | 11% | 17% | 20% |
| Annual paid trips | 39.5 M | 61.5 M | 74.7 M |
| Farebox revenue | $8.7 M / yr | $14 M / yr | $16 M / yr |
| Station shop leases | $589 k / yr | $589 k / yr | $589 k / yr |
| Advertising boards | $842 k / yr | $842 k / yr | $842 k / yr |
| **Total revenue** | **$10 M / yr** | **$15 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 57% | 84% | 100% |
