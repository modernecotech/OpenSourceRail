...
| Revenue fleet | 158 × 4-car trainsets |
| Revenue fleet passenger capacity | 75,840 AW2 pax (101,120 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 32.8 km | 17 | 45 | N Outer ↔ S Outer |
| line-2 | 23.2 km | 15 | 32 | SW Mid ↔ NE Mid |
| line-3 | 23.4 km | 14 | 32 | E Mid ↔ W Mid |
| line-4 | 50.2 km | 29 | 67 | W Mid ↔ W Mid |
| **Total** | **129.5 km** | **74 unique** | **176** | |
...
| Revenue fleet capacity | 75,840 AW2 pax (101,120 AW3 crush) |
| Total fleet capacity | 84,480 AW2 pax (112,640 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 158 × 480 = **75,840 AW2 passengers** (101,120 AW3 crush)
- **Total fleet passenger capacity:** 176 × 480 = **84,480 AW2 passengers** (112,640 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **219.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 177 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,130 MWh/day | 65,410 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 953 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 219.3 MW / 1,096 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 176 | $5.60 M | $986 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 704 | $100 k | $70 M |
| High sensitivity check | 704 | $200 k | $141 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 219,255 kW @ $700/kW | $153 M |
| Grid interconnection / PPA tie-in | 219,255 kW @ $100/kW | $22 M |
| Annual generation proxy | 219.3 MW × 5.0 peak-sun-h/day × 365 d/yr | 400.1 GWh/yr |
| **Dedicated solar plant subtotal** | | **$175 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 129.5 km × $0.050 M/km | $6.4 M |
...
| Dedicated solar power plant | $175 M |
...
|---|---|---|
| Construction (years 1–10) | **$88 M / yr** | $31 |
| Steady-state, low capacity-use (year 11+) | **$114 M / yr** | $40 |
| Steady-state, high capacity-use (year 11+) | **$95 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$87 M / yr** | $31 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.31 bn cumulative** | $1,525 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.72 bn cumulative** | $1,315 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.49 bn cumulative** | $1,235 |

_Population basis: 2,829,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $27 M / yr → $7.6 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $1.95 bn | 2.0% | 40 y, 10 y grace | $87 M / yr |
| Government equity (no debt service) | 20% | $488 M | — | — | — |
| **Total** | **100%** | **$2.44 bn** | | | **$87 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $39 M / yr = **$39 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($49 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (412.6 GWh / yr) | 65,410 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 64.6 GWh/yr + dedicated solar plant 219.3 MW / 400.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.6 M |
| Labour (842 FTE) | driverless roster: OCC/remote 106, station/platform 353, passenger service 71, fleet maintenance 139, infrastructure/energy 135, admin/training 38; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$64 M / yr** |

_Annual service work: 65,410 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 25.8 M train-km / yr (103.1 M car-km / yr). On-site PV covers 64.6 GWh/yr and the dedicated solar plant adds 400.1 GWh/yr against 412.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 112.1 M | 179.4 M | 205.3 M |
| Annual paid trips / city resident | 40 | 63 | 73 |
| Farebox revenue | $33 M / yr | $53 M / yr | $60 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| **Total revenue** | **$37 M / yr** | **$57 M / yr** | **$64 M / yr** |
| Revenue / OPEX recovery | 57% | 88% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $114 M / yr | $95 M / yr | **$87 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $114 M / yr | $95 M / yr | **$87 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $9.5 M / yr | $15 M / yr | 16 min/trip × $0.32/h value-of-time proxy |
...
| Station-area commerce turnover supported | $41 M / yr | $65 M / yr | 24% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $18 M / yr | $29 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$123 M / yr** | **$196 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 5 education anchors | 19,501 trips/school day; 4.3 M access-events/yr | 31,201 trips/school day; 6.9 M access-events/yr |
| Healthcare | 7 healthcare anchors | 26,286 trips/day; 9.6 M access-events/yr | 42,057 trips/day; 15.4 M access-events/yr |
| Commerce | 58 major/terminal/interchange nodes | 74,434 trips/trading day; 24.6 M access-events/yr | 119,094 trips/trading day; 39.3 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 33,003 trips/activity day; 9.9 M access-events/yr | 52,805 trips/activity day; 15.8 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.29 bn | 53% of $2.44 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 243,471 job-years | retained CAPEX ÷ (4.0 × median annual income) |
