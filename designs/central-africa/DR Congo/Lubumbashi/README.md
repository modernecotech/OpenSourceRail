...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.58 bn (86.3%) of external capital** and **$2.04 bn of external interest**. Capital plus saved interest totals **$3.61 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 50.8% |
| Route length (double track) | 130.0 km |
...
| Total fleet capacity | 77,280 AW2 pax (103,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 144 × 480 = **69,120 AW2 passengers** (92,160 AW3 crush)
- **Total fleet passenger capacity:** 161 × 480 = **77,280 AW2 passengers** (103,040 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 50.8%
- Catchment population: **≈ 1,437,132** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **188.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.8× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 614 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 109 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 76 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,092 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 49,945 train-km/day | One-way train journeys × route length |
| Annual service work | 19.7 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 863 MWh/day | 78.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 787 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 188.6 MW / 905 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 222 kWh | 392 kWh | 147 kWh | 5.2 km / 52 kWh |
| line-2 | 10 | 217 kWh | 539 kWh | 300 kWh | 3.6 km / 36 kWh |
| line-3 | 4 | 146 kWh | 270 kWh | 109 kWh | 6.6 km / 66 kWh |
| line-4 | 7 | 261 kWh | 478 kWh | 190 kWh | 10.6 km / 106 kWh |
| line-5 | 9 | 451 kWh | 772 kWh | 276 kWh | 10.4 km / 104 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (123.5 km @ $2.58 M/km) | $319 M |
| Elevated (6.5 km @ $9.75 M/km) | $63 M |
| Elevated-interchange premium (5 sites @ $4.50 M) | $22 M |
| **Civil subtotal** | **$405 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 161 | $1.12 M | $180 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 644 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 644 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 188,604 kW @ $700/kW | $132 M |
| Grid interconnection / PPA tie-in | 188,604 kW @ $100/kW | $19 M |
| Annual generation proxy | 188.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 330.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 130.0 km × $0.050 M/km | $6.5 M |
...
| Per-capita (city pop) | $359 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $405 M | 15% | $61 M | $344 M |
| Stations | $195 M | 20% | $39 M | $156 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $180 M | 35% | $63 M | $117 M |
| Dedicated solar plant | $151 M | 45% | $68 M | $83 M |
| Residual signalling / train control | $6.5 M | 50% | $3.2 M | $3.2 M |
| Charging microgrids | $12 M | 40% | $4.9 M | $7.3 M |
| EPC / project services | $56 M | 15% | $8.5 M | $48 M |
| **Total city CAPEX** | **$1.01 bn** | **24.6%** | **$249 M** | **$765 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh lubumbashi`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$249 M** | **$25 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$765 M** | **$77 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $612 M | $61 M / yr |
| **Total city programme** | **100.0%** | **$1.01 bn** | **$101 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.37 bn | $1.12 bn (81.8%) | $1.45 bn | **$2.57 bn** |
| **Default** | 2.00× | $1.83 bn | $1.58 bn (86.3%) | $2.04 bn | **$3.61 bn** |
| High | 3.00× | $2.74 bn | $2.49 bn (90.9%) | $3.22 bn | **$5.71 bn** |

At the default 2.00× case, OSR's $249 M external requirement is 86.3% below the illustrative foreign-company requirement of $1.83 bn; the associated lifetime external-interest saving is $2.04 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$106 M / yr** | $37 |
| Steady-state, low capacity-use (year 11+) | **$75 M / yr** | $27 |
| Steady-state, high capacity-use (year 11+) | **$50 M / yr** | $17 |
| Steady-state, operating-neutral revenue case | **$97 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.32 bn cumulative** | $1,174 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.55 bn cumulative** | $900 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.97 bn cumulative** | $1,403 |

_Population basis: 2,829,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $47 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $249 M | 4.5% | 40 y, 10 y grace | $15 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $612 M | 13.0% | 40 y, 10 y grace | $82 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $153 M | — | — | — |
| **Total** | **100%** | **$1.01 bn** | | | **$97 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $11 M / yr + local bonds $80 M / yr = **$91 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($15 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $325 k |
| Traction energy (315.0 GWh / yr) | 49,945 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 27.7 GWh/yr + dedicated solar plant 188.6 MW / 330.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.3 M |
| Labour (590 FTE) | driverless roster: OCC/remote 102, station/platform 154, passenger service 92, fleet maintenance 114, infrastructure/energy 103, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$23 M / yr** |

_Annual service work: 49,945 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 19.7 M train-km / yr (78.8 M car-km / yr). On-site PV covers 27.7 GWh/yr and the dedicated solar plant adds 330.4 GWh/yr against 315.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 161 trainsets, 41 stations, 130.0 route-km, 5 lines, and 49,945 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 72.9 M |
| Annual paid trips / city resident | 52 | 83 | 26 |
| Farebox revenue | $43 M / yr | $69 M / yr | $21 M / yr |
| Station shop leases | $696 k / yr | $696 k / yr | $696 k / yr |
| Advertising boards | $983 k / yr | $983 k / yr | $983 k / yr |
| **Total revenue** | **$45 M / yr** | **$71 M / yr** | **$23 M / yr** |
| Revenue / OPEX recovery | 194% | 306% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $97 M / yr | $97 M / yr | **$97 M / yr** |
| Operating surplus applied to debt support | -$22 M / yr | -$47 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $75 M / yr | $50 M / yr | **$97 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $47 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,592 m² of station shop/kiosk leases at $10/m²/month and 1,252 advertising boards at $77/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $12 M / yr | $20 M / yr | 16 min/trip × $0.32/h value-of-time proxy |
| Avoided road congestion | $41 M / yr | $66 M / yr | 515 M - 824 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $7.4 M / yr | $12 M / yr | 92.6–148.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $21 M / yr | $33 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $46 M / yr | $74 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $23 M / yr | $37 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$151 M / yr** | **$242 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 26,918 trips/school day; 5.9 M access-events/yr | 43,069 trips/school day; 9.5 M access-events/yr |
| Healthcare | 2 healthcare anchors | 29,730 trips/day; 10.9 M access-events/yr | 47,568 trips/day; 17.4 M access-events/yr |
| Commerce | 20 major/terminal/interchange nodes | 84,860 trips/trading day; 28.0 M access-events/yr | 135,775 trips/trading day; 44.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $765 M | 75% of $1.01 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.22 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $122 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 144,887 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $863 M |
| Timetable-sized dedicated solar CAPEX | $151 M |
| **Reconciled project CAPEX** | **$1.01 bn** |
| Imported / external-capital requirement | $249 M (24.6%) |
| Local-content / local-funding requirement | $765 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $1.83 bn; OSR saves $1.58 bn (86.3%) |
| Lifetime external interest and combined financing saving | $2.04 bn interest; $3.61 bn capital + interest |
| 15%–25% planning risk envelope | $1.17 bn–$1.27 bn |
| Annual OPEX | $23 M / yr |
| Low/high project NPV at 8% | $-567795 k / $-433213 k |
| Low/high project IRR | -2.1% / 1.8% |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,045.69 train-km; 40,395.01 kWh consumed; 41,627.08 kWh charged; 48 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 49,380.48 train-km; 493,049.60 kWh consumed; 498,109.61 kWh charged; 821 depot services completed (8 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 98.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.8% | 98.9% / 90% | pass |
| maximum planning climate/HVAC duty | 48.4% | 98.9% / 90% | pass |
| 50% charging-contact availability | 72.5% | 98.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 72.5% / 60% | pass |
| ten-hour single charging-pad outage | 72.5% | 98.9% / 90% | pass |
...
|---|---|
| ![Lubumbashi energy and battery simulation dashboard](engineering/screenshots/lubumbashi-simulation-dashboard.png) | ![Lubumbashi simulator network visualizer](engineering/screenshots/lubumbashi-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 41 line platforms, 5 interchange complexes, 26 civil segments, and 0 input findings |
...
|---|---|
| ![Lubumbashi QGIS engineering layers](engineering/screenshots/lubumbashi-qgis-engineering-map.png) | ![Lubumbashi SUMO timetable validation](engineering/screenshots/lubumbashi-sumo-validation.png) |
