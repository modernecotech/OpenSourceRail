...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$825 M (86.6%) of external capital** and **$1.07 bn of external interest**. Capital plus saved interest totals **$1.89 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $198 M | 15% | $30 M | $169 M |
...
| **Total city CAPEX** | **$529 M** | **24.1%** | **$128 M** | **$402 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.1%** | **$128 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.9%** | **$402 M** | **$40 M / yr** |
| of which planned local bond issuance | 60.7% of total CAPEX | $321 M | $32 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $715 M | $587 M (82.1%) | $758 M | **$1.35 bn** |
| **Default** | 2.00× | $953 M | $825 M (86.6%) | $1.07 bn | **$1.89 bn** |
| High | 3.00× | $1.43 bn | $1.30 bn (91.1%) | $1.68 bn | **$2.98 bn** |

At the default 2.00× case, OSR's $128 M external requirement is 86.6% below the illustrative foreign-company requirement of $953 M; the associated lifetime external-interest saving is $1.07 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$56 M / yr** | $56 |
| Steady-state, low capacity-use (year 11+) | **$41 M / yr** | $41 |
| Steady-state, high capacity-use (year 11+) | **$28 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$51 M / yr** | $51 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.78 bn cumulative** | $1,779 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.39 bn cumulative** | $1,392 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.08 bn cumulative** | $2,077 |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $41 M / yr | $28 M / yr | **$51 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $402 M | 76% of $529 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $643 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $64 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 76,090 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $128 M (24.1%) |
| Local-content / local-funding requirement | $402 M (75.9%) |
| Default foreign-turnkey external-capital comparison | $953 M; OSR saves $825 M (86.6%) |
| Lifetime external interest and combined financing saving | $1.07 bn interest; $1.89 bn capital + interest |
| 15%–25% planning risk envelope | $609 M–$662 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-303454 k / $-236163 k |
| Low/high project IRR | -2.7% / 1.3% |
| Low/high steady-state DSCR | 0.20 / 0.45 |
