...
|---|---|---|---|---|
| line-1 | 23.1 km | 15 | 58 | NW Outer ↔ SE Mid |
| line-2 | 20.0 km | 13 | 51 | SE Outer ↔ N Mid |
| line-3 | 16.8 km | 11 | 43 | NE Mid ↔ NW Mid |
| **Total** | **59.9 km** | **39 unique** | **152** | |
...
| Onboard battery adequacy | 13.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 500 kWh usable margin across the worst powered-stop gap (line-1) |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 173 kWh | 302 kWh | 112 kWh | 5.4 km / 40 kWh |
| line-2 | 13 | 150 kWh | 274 kWh | 109 kWh | 2.3 km / 18 kWh |
| line-3 | 11 | 126 kWh | 233 kWh | 94 kWh | 2.3 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (58.3 km @ $3.0 M/km) | $175 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 68,008 kW @ $700/kW | $48 M |
| Grid interconnection / PPA tie-in | 68,008 kW @ $100/kW | $6.8 M |
...
| Per-capita (city pop) | $693 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh goma`.
...
|---|---|---|
| Construction (years 1–10) | **$39 M / yr** | $39 |
| Steady-state, low capacity-use (year 11+) | **$26 M / yr** | $26 |
| Steady-state, high capacity-use (year 11+) | **$14 M / yr** | $14 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $34 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.18 bn cumulative** | $1,181 |
| Lifecycle envelope (yr 1–40, high scenario) | **$793 M cumulative** | $793 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.41 bn cumulative** | $1,410 |

_Population basis: 1,000,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.6 M / yr → $21 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $555 M | 4.5% | 40 y, 10 y grace | $34 M / yr |
| Government equity (no debt service) | 20% | $139 M | — | — | — |
| **Total** | **100%** | **$693 M** | | | **$34 M / yr** |
...
| Traction energy (131.8 GWh / yr) | 27,866 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 28.2 GWh/yr + dedicated solar plant 68.0 MW / 119.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $816 k |
| Labour (482 FTE) | driverless roster: OCC/remote 94, station/platform 178, passenger service 49, fleet maintenance 83, infrastructure/energy 57, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $891 k |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 27,866 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.0 M train-km / yr (33.0 M car-km / yr). On-site PV covers 28.2 GWh/yr and the dedicated solar plant adds 119.1 GWh/yr against 131.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 152 trainsets, 39 stations, 59.9 route-km, 3 lines, and 27,866 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Operating surplus applied to debt support | -$7.6 M / yr | -$21 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $26 M / yr | $14 M / yr | **$34 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.6 M / yr | $21 M / yr | $0 / yr |

_Commercial-revenue assumptions: 7,952 m² of station shop/kiosk leases at $10/m²/month and 1,448 advertising boards at $77/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 6 education anchors | 13,242 trips/school day; 2.9 M access-events/yr | 21,187 trips/school day; 4.7 M access-events/yr |
| Healthcare | 13 healthcare anchors | 20,827 trips/day; 7.6 M access-events/yr | 33,324 trips/day; 12.2 M access-events/yr |
| Commerce | 28 major/terminal/interchange nodes | 47,284 trips/trading day; 15.6 M access-events/yr | 75,654 trips/trading day; 25.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $389 M | 56% of $693 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $623 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $62 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 73,727 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $639 M |
| Timetable-sized dedicated solar CAPEX | $54 M |
| **Reconciled project CAPEX** | **$693 M** |
| 15%–25% planning risk envelope | $797 M–$867 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-425383 k / $-358092 k |
| Low/high project IRR | -5.0% / -0.6% |
| Low/high steady-state DSCR | 0.22 / 0.60 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,190.12 train-km; 16,399.40 kWh consumed; 17,758.86 kWh charged; 24 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,702.58 train-km; 214,922.53 kWh consumed; 219,442.68 kWh charged; 497 depot services completed (6 active at cutoff); minimum SoC 73%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 67.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 39.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 73.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.0% / 60% | pass |
| ten-hour single charging-pad outage | 61.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 2 interchange complexes, 30 civil segments, and 0 input findings |
