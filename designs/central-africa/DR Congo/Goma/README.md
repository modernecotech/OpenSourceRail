...
| Bucket | Value |
|---|---|
| At-grade (53.3 km @ €3.5 M/km) | €187 M |
| Elevated (3.1 km @ €18 M/km) | €56 M |
| Elevated-interchange premium (3 sites @ €20 M) | €60 M |
| **Civil subtotal** | **€303 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 58 | €3.0 M | €174 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 58.2 km × €0.015 M/km | €0.8 M |
...
| Per-capita (city pop) | €676 / person |
...
| Steady-state, low-ridership (year 11+) | **€57 M / yr** | €57 |
| Steady-state, high-ridership (year 11+) | **€54 M / yr** | €54 |
| Lifecycle envelope (yr 1–40, low scenario) | **€2.14 bn cumulative** | €2,143 |
| Lifecycle envelope (yr 1–40, high scenario) | **€2.05 bn cumulative** | €2,050 |

_Population basis: 1,000,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€13 M / yr (low) → €10 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €406 M | 3.0% | 40 y, 10 y grace | €21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €169 M | 13.0% | 40 y, 10 y grace | €23 M / yr |
| Government equity (no debt service) | 15% | €101 M | — | — | — |
| **Total** | **100%** | **€676 M** | | | **€43 M / yr** |
...
| Labour (361 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €614 k |
...
| Farebox / OPEX recovery | 19% | 37% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €13 M / yr | €10 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€57 M / yr** | **€54 M / yr** |
