...
|---|---|---|
| Construction (years 1–10) | **$31 M / yr** | $31 |
| Steady-state, low capacity-use (year 11+) | **$17 M / yr** | $17 |
| Steady-state, high capacity-use (year 11+) | **$4.3 M / yr** | $4 |
| Steady-state, operating-neutral revenue case | **$27 M / yr** | $27 |
| Lifecycle envelope (yr 1–40, low scenario) | **$827 M cumulative** | $827 |
| Lifecycle envelope (yr 1–40, high scenario) | **$440 M cumulative** | $440 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.13 bn cumulative** | $1,126 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $443 M | 4.5% | 40 y, 10 y grace | $27 M / yr |
| Government equity (no debt service) | 20% | $111 M | — | — | — |
| **Total** | **100%** | **$554 M** | | | **$27 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $17 M / yr | $4.3 M / yr | **$27 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $308 M | 56% of $554 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 58,303 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$554 M** |
| 15%–25% planning risk envelope | $637 M–$692 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-319609 k / $-252318 k |
