...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **599,040 – 599,040 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (355.8 km @ $2.0 M/km) | $712 M |
| Elevated (22.9 km @ $9.0 M/km) | $207 M |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 310 | $1.60 M | $496 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 384.8 km × $0.015 M/km | $19 M |
...
| Per-capita (city pop) | $119 / person |
...
|---|---|---|
| Construction (years 1–10) | **$134 M / yr** | $8 |
| Steady-state, low-ridership (year 11+) | **$131 M / yr** | $8 |
| Steady-state, high-ridership (year 11+) | **$131 M / yr** | $8 |
| Steady-state, operating-neutral revenue case | **$131 M / yr** | $8 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.28 bn cumulative** | $307 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.28 bn cumulative** | $307 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.28 bn cumulative** | $307 |

_Population basis: 17,178,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.23 bn | 3.0% | 40 y, 10 y grace | $63 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $513 M | 13.0% | 40 y, 10 y grace | $68 M / yr |
| Government equity (no debt service) | 15% | $308 M | — | — | — |
| **Total** | **100%** | **$2.05 bn** | | | **$131 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $37 M / yr + bonds $67 M / yr = **$104 M / yr** total — plus the equity tranche amortised across construction ($31 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 599,040 | 599,040 | 538,643 |
| Daily paid trips / catchment | 7% | 7% | 6% |
| Daily paid trips / city population | 3% | 3% | 3% |
| Annual paid trips | 218.6 M | 218.6 M | 196.6 M |
| Farebox revenue | $48 M / yr | $48 M / yr | $43 M / yr |
| Station shop leases | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$56 M / yr** | **$56 M / yr** | **$51 M / yr** |
| Revenue / OPEX recovery | 109% | 109% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $131 M / yr | $131 M / yr | **$131 M / yr** |
| Operating surplus after OPEX | $4.8 M / yr | $4.8 M / yr | $0 / yr |
