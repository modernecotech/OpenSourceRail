...
| Bucket | Value |
|---|---|
| At-grade (44.2 km @ $2.0 M/km) | $88 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 47.3 km × $0.015 M/km | $2.3 M |
...
| Per-capita (city pop) | $197 / person |
...
| Steady-state, low-ridership (year 11+) | **$16 M / yr** | $13 |
| Steady-state, high-ridership (year 11+) | **$16 M / yr** | $13 |
| Steady-state, operating-neutral revenue case | **$16 M / yr** | $13 |
| Lifecycle envelope (yr 1–40, low scenario) | **$659 M cumulative** | $507 |
| Lifecycle envelope (yr 1–40, high scenario) | **$659 M cumulative** | $507 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$659 M cumulative** | $507 |

_Population basis: 1,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $154 M | 3.0% | 40 y, 10 y grace | $7.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $64 M | 13.0% | 40 y, 10 y grace | $8.5 M / yr |
| Government equity (no debt service) | 15% | $38 M | — | — | — |
| **Total** | **100%** | **$256 M** | | | **$16 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $4.6 M / yr + bonds $8.3 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($3.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 99,840 | 99,840 | 58,937 |
| Daily paid trips / catchment | 12% | 12% | 7% |
| Daily paid trips / city population | 8% | 8% | 5% |
| Annual paid trips | 36.4 M | 36.4 M | 21.5 M |
| Farebox revenue | $8.0 M / yr | $8.0 M / yr | $4.7 M / yr |
| Station shop leases | $537 k / yr | $537 k / yr | $537 k / yr |
| Advertising boards | $729 k / yr | $729 k / yr | $729 k / yr |
| **Total revenue** | **$9.3 M / yr** | **$9.3 M / yr** | **$6.0 M / yr** |
| Revenue / OPEX recovery | 155% | 155% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $16 M / yr | $16 M / yr | **$16 M / yr** |
| Operating surplus after OPEX | $3.3 M / yr | $3.3 M / yr | $0 / yr |
