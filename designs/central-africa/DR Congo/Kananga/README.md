...
| Bucket | Value |
|---|---|
| At-grade (36.0 km @ €3.5 M/km) | €126 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 34 | €4.0 M | €136 M |
...
|---|---|---|
| Construction (years 1–10) | **€30 M / yr** | €25 |
| Steady-state, low-ridership (year 11+) | **€37 M / yr** | €30 |
| Steady-state, high-ridership (year 11+) | **€33 M / yr** | €27 |
| Lifecycle envelope (yr 1–40, low scenario) | **€1.39 bn cumulative** | €1,159 |
| Lifecycle envelope (yr 1–40, high scenario) | **€1.28 bn cumulative** | €1,067 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero and only the OPEX shortfall remains — ~€7.7 M / yr (low) → €4.0 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €270 M | 3.0% | 40 y, 10 y grace | €14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €113 M | 13.0% | 40 y, 10 y grace | €15 M / yr |
| Government equity (no debt service) | 15% | €68 M | — | — | — |
| **Total** | **100%** | **€450 M** | | | **€29 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €8.1 M / yr + bonds €15 M / yr = **€23 M / yr** total — plus the equity tranche amortised across construction (€6.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Labour (241 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €410 k |
...
| Farebox / OPEX recovery | 32% | 65% |
| Country policy-target recovery (diagnostic) | 30% | 30% |
| Operating shortfall (gov subsidy required) | €7.7 M / yr | €4.0 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€37 M / yr** | **€33 M / yr** |
