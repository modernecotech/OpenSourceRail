...
| Revenue fleet | 46 × 4-car trainsets |
...
|---|---|---|---|---|
| line-1 | 15.9 km | 11 | 39 | SE Outer ↔ NW Mid |
| line-2 | 22.2 km | 14 | 13 | NE Inner ↔ NW Inner |
| **Total** | **38.1 km** | **25 unique** | **52** | |
...
| Total fleet capacity | 24,960 AW2 pax (33,280 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 46 × 480 = **22,080 AW2 passengers** (29,440 AW3 crush)
- **Total fleet passenger capacity:** 52 × 480 = **24,960 AW2 passengers** (33,280 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **25** | **12,200 kW** | **76,000 kWh** |

Aggregate station-rail charging power: **37,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **37.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 24.4× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 691 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 438 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 158 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 37.9 MW / 182 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 76 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 159 kWh | 612 kWh | 438 kWh | 2.0 km / 20 kWh |
| line-2 | 14 | 222 kWh | 686 kWh | 442 kWh | 3.0 km / 29 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 52 | $1.12 M | $58 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 208 | $60 k | $12 M |
| High sensitivity check | 208 | $120 k | $25 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 37,938 kW @ $700/kW | $27 M |
| Grid interconnection / PPA tie-in | 37,938 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 37.9 MW × 4.8 peak-sun-h/day × 365 d/yr | 66.5 GWh/yr |
...
| Steady-state, low capacity-use (year 11+) | **$15 M / yr** | $13 |
| Steady-state, high capacity-use (year 11+) | **$6.6 M / yr** | $6 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $18 |
| Lifecycle envelope (yr 1–40, low scenario) | **$701 M cumulative** | $584 |
| Lifecycle envelope (yr 1–40, high scenario) | **$442 M cumulative** | $369 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$886 M cumulative** | $738 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $349 M | 4.5% | 40 y, 10 y grace | $21 M / yr |
| Government equity (no debt service) | 20% | $87 M | — | — | — |
| **Total** | **100%** | **$436 M** | | | **$21 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $16 M / yr = **$16 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($8.7 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (79.2 GWh / yr) | 12,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 21.4 GWh/yr + dedicated solar plant 37.9 MW / 66.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $455 k |
| Labour (274 FTE) | driverless roster: OCC/remote 41, station/platform 110, passenger service 33, fleet maintenance 33, infrastructure/energy 38, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $506 k |
| **OPEX subtotal** | | **$9.3 M / yr** |

_Annual service work: 12,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.9 M train-km / yr (19.8 M car-km / yr). On-site PV covers 21.4 GWh/yr and the dedicated solar plant adds 66.5 GWh/yr against 79.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 52 trainsets, 25 stations, 38.1 route-km, 2 lines, and 12,553 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 27.8 M |
| Annual paid trips / city resident | 41 | 65 | 23 |
| Farebox revenue | $14 M / yr | $23 M / yr | $8.2 M / yr |
| Station shop leases | $498 k / yr | $498 k / yr | $498 k / yr |
| Advertising boards | $675 k / yr | $675 k / yr | $675 k / yr |
| **Total revenue** | **$16 M / yr** | **$24 M / yr** | **$9.3 M / yr** |
| Revenue / OPEX recovery | 166% | 258% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $15 M / yr | $6.6 M / yr | **$21 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.2 M / yr | $15 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,720 m² of station shop/kiosk leases at $10/m²/month and 860 advertising boards at $77/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 13,622 trips/school day; 3.0 M access-events/yr | 21,795 trips/school day; 4.8 M access-events/yr |
| Healthcare | 1 healthcare anchors | 9,642 trips/day; 3.5 M access-events/yr | 15,428 trips/day; 5.6 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 28,177 trips/trading day; 9.3 M access-events/yr | 45,083 trips/trading day; 14.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $249 M | 57% of $436 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 47,190 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Low/high project NPV at 8% | $-260114 k / $-215253 k |
| Low/high project IRR | -3.9% / 0.1% |
| Low/high steady-state DSCR | 0.29 / 0.69 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,003.08 train-km; 10,015.39 kWh consumed; 11,378.47 kWh charged; 18 depot services completed; minimum SoC 93%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 12,213.33 train-km; 121,945.29 kWh consumed; 124,198.60 kWh charged; 324 depot services completed (4 active at cutoff); minimum SoC 93%; 0 onboard emergencies; 0 invariant violations; 97.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 92.2% | 97.3% / 90% | pass |
| maximum planning climate/HVAC duty | 92.4% | 97.3% / 90% | pass |
| 50% charging-contact availability | 92.8% | 97.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 97.3% / 60% | pass |
| ten-hour single charging-pad outage | 92.8% | 97.3% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 25 line platforms, 2 interchange complexes, 6 civil segments, and 0 input findings |
