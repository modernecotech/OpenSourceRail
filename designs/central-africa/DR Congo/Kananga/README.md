...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$503 M (87.4%) of external capital** and **$650 M of external interest**. Capital plus saved interest totals **$1.15 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 38.1 km |
| Revenue fleet | 31 × 4-car trainsets |
...
| Spare + cold-reserve | 5 × 4-car trainsets |
| Peak headway | 3 min |
...
- **Revenue fleet simultaneous capacity:** 31 × 480 = **14,880 AW2 passengers** (19,840 AW3 crush)
- **Total fleet passenger capacity:** 36 × 480 = **17,280 AW2 passengers** (23,040 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 3 | 300 kW | 1500 kWh |
| Major | 1 | 300 kW | 1500 kWh |
| Standard | 8 | 300 kW | 1500 kWh |
| Terminal | 1 | 300 kW | 1500 kWh |
| **Total installed** | **14** | **8,900 kW** | **59,500 kWh** |

Aggregate station-rail charging power: **21,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **41.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 19.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 683 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 148 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 12,553 train-km/day | One-way train journeys × route length |
| Annual service work | 4.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 217 MWh/day | 19.8 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 174 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 41.7 MW / 200 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 60 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 159 kWh | 368 kWh | 193 kWh | 3.7 km / 37 kWh |
| line-2 | 8 | 222 kWh | 392 kWh | 148 kWh | 3.7 km / 37 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 36 | $1.12 M | $40 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 41,733 kW @ $700/kW | $29 M |
| Grid interconnection / PPA tie-in | 41,733 kW @ $100/kW | $4.2 M |
| Annual generation proxy | 41.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 73.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 38.1 km × $0.050 M/km | $1.9 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $4.9 M |
...
| Per-capita (city pop) | $266 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $142 M | 15% | $21 M | $121 M |
| Stations | $70 M | 20% | $14 M | $56 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $40 M | 35% | $14 M | $26 M |
| Dedicated solar plant | $33 M | 45% | $15 M | $18 M |
| Residual signalling / train control | $1.9 M | 50% | $953 k | $953 k |
| Charging microgrids | $4.9 M | 40% | $1.9 M | $2.9 M |
| EPC / project services | $19 M | 15% | $2.8 M | $16 M |
| **Total city CAPEX** | **$320 M** | **22.6%** | **$72 M** | **$247 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kananga`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.6%** | **$72 M** | **$7.2 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.4%** | **$247 M** | **$25 M / yr** |
| of which planned local bond issuance | 61.9% of total CAPEX | $198 M | $20 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $432 M | $359 M (83.3%) | $464 M | **$823 M** |
| **Default** | 2.00× | $575 M | $503 M (87.4%) | $650 M | **$1.15 bn** |
| High | 3.00× | $863 M | $791 M (91.6%) | $1.02 bn | **$1.81 bn** |

At the default 2.00× case, OSR's $72 M external requirement is 87.4% below the illustrative foreign-company requirement of $575 M; the associated lifetime external-interest saving is $650 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$34 M / yr** | $28 |
| Steady-state, low capacity-use (year 11+) | **$23 M / yr** | $19 |
| Steady-state, high capacity-use (year 11+) | **$14 M / yr** | $12 |
| Steady-state, operating-neutral revenue case | **$31 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.03 bn cumulative** | $856 |
| Lifecycle envelope (yr 1–40, high scenario) | **$769 M cumulative** | $641 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.26 bn cumulative** | $1,054 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.9 M / yr → $17 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $72 M | 4.5% | 40 y, 10 y grace | $4.4 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $198 M | 13.0% | 40 y, 10 y grace | $26 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $49 M | — | — | — |
| **Total** | **100%** | **$320 M** | | | **$31 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.2 M / yr + local bonds $26 M / yr = **$29 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (79.2 GWh / yr) | 12,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 15.6 GWh/yr + dedicated solar plant 41.7 MW / 73.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $501 k |
| Labour (202 FTE) | driverless roster: OCC/remote 33, station/platform 55, passenger service 33, fleet maintenance 28, infrastructure/energy 34, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $373 k |
| **OPEX subtotal** | | **$7.0 M / yr** |

_Annual service work: 12,553 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 4.9 M train-km / yr (19.8 M car-km / yr). On-site PV covers 15.6 GWh/yr and the dedicated solar plant adds 73.1 GWh/yr against 79.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 36 trainsets, 14 stations, 38.1 route-km, 2 lines, and 12,553 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 21.9 M |
| Annual paid trips / city resident | 41 | 65 | 18 |
| Farebox revenue | $14 M / yr | $23 M / yr | $6.4 M / yr |
| Station shop leases | $237 k / yr | $237 k / yr | $237 k / yr |
| Advertising boards | $333 k / yr | $333 k / yr | $333 k / yr |
| **Total revenue** | **$15 M / yr** | **$24 M / yr** | **$7.0 M / yr** |
| Revenue / OPEX recovery | 213% | 336% | 100% |
...
| Operating surplus applied to debt support | -$7.9 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $14 M / yr | **$31 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.9 M / yr | $17 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,240 m² of station shop/kiosk leases at $10/m²/month and 424 advertising boards at $77/board/month, with occupancy derates applied._
...
| Avoided road congestion | $10 M / yr | $16 M / yr | 126 M - 201 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.8 M / yr | $2.9 M / yr | 22.6–36.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.0 M / yr | $8.0 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $15 M / yr | $24 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $7.8 M / yr | $12 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$44 M / yr** | **$70 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Commerce | 6 major/terminal/interchange nodes | 27,454 trips/trading day; 9.1 M access-events/yr | 43,926 trips/trading day; 14.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $247 M | 77% of $320 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $396 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $40 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 46,863 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $286 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$320 M** |
| Imported / external-capital requirement | $72 M (22.6%) |
| Local-content / local-funding requirement | $247 M (77.4%) |
| Default foreign-turnkey external-capital comparison | $575 M; OSR saves $503 M (87.4%) |
| Lifetime external interest and combined financing saving | $650 M interest; $1.15 bn capital + interest |
| 15%–25% planning risk envelope | $368 M–$400 M |
| Annual OPEX | $7.0 M / yr |
| Low/high project NPV at 8% | $-173206 k / $-128345 k |
| Low/high project IRR | -1.4% / 2.3% |
| Low/high steady-state DSCR | 0.26 / 0.54 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,125.65 train-km; 11,239.25 kWh consumed; 12,074.15 kWh charged; 23 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 12,696.87 train-km; 126,774.42 kWh consumed; 128,221.66 kWh charged; 327 depot services completed (4 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 87.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 73.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 88.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.0% / 60% | pass |
| ten-hour single charging-pad outage | 72.3% | 100.0% / 90% | pass |
...
|---|---|
| ![Kananga energy and battery simulation dashboard](engineering/screenshots/kananga-simulation-dashboard.png) | ![Kananga simulator network visualizer](engineering/screenshots/kananga-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 14 line platforms, 2 interchange complexes, 6 civil segments, and 0 input findings |
...
|---|---|
| ![Kananga QGIS engineering layers](engineering/screenshots/kananga-qgis-engineering-map.png) | ![Kananga SUMO timetable validation](engineering/screenshots/kananga-sumo-validation.png) |
