...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$468 M (87.2%) of external capital** and **$605 M of external interest**. Capital plus saved interest totals **$1.07 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (36.0 km @ $2.58 M/km) | $93 M |
| Elevated (2.1 km @ $9.75 M/km) | $21 M |
...
|---|---:|---:|---:|---:|
| Civil works | $123 M | 15% | $18 M | $104 M |
...
| EPC / project services | $17 M | 15% | $2.6 M | $15 M |
| **Total city CAPEX** | **$299 M** | **23.1%** | **$69 M** | **$229 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.1%** | **$69 M** | **$6.9 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.9%** | **$229 M** | **$23 M / yr** |
| of which planned local bond issuance | 61.5% of total CAPEX | $184 M | $18 M / yr |
| **Total city programme** | **100.0%** | **$299 M** | **$30 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $403 M | $334 M (82.9%) | $431 M | **$765 M** |
| **Default** | 2.00× | $537 M | $468 M (87.2%) | $605 M | **$1.07 bn** |
| High | 3.00× | $806 M | $737 M (91.4%) | $952 M | **$1.69 bn** |

At the default 2.00× case, OSR's $69 M external requirement is 87.2% below the illustrative foreign-company requirement of $537 M; the associated lifetime external-interest saving is $605 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$32 M / yr** | $26 |
| Steady-state, low capacity-use (year 11+) | **$20 M / yr** | $17 |
| Steady-state, high capacity-use (year 11+) | **$12 M / yr** | $10 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $24 |
| Lifecycle envelope (yr 1–40, low scenario) | **$928 M cumulative** | $773 |
| Lifecycle envelope (yr 1–40, high scenario) | **$670 M cumulative** | $558 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.18 bn cumulative** | $981 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $8.3 M / yr → $17 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $69 M | 4.5% | 40 y, 10 y grace | $4.2 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $184 M | 13.0% | 40 y, 10 y grace | $24 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $46 M | — | — | — |
| **Total** | **100%** | **$299 M** | | | **$29 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $3.1 M / yr + local bonds $24 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 20.5 M |
| Annual paid trips / city resident | 41 | 65 | 17 |
| Farebox revenue | $14 M / yr | $23 M / yr | $6.0 M / yr |
| Station shop leases | $237 k / yr | $237 k / yr | $237 k / yr |
| Advertising boards | $333 k / yr | $333 k / yr | $333 k / yr |
| **Total revenue** | **$15 M / yr** | **$24 M / yr** | **$6.6 M / yr** |
| Revenue / OPEX recovery | 226% | 356% | 100% |
...
| Operating surplus applied to debt support | -$8.3 M / yr | -$17 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $20 M / yr | $12 M / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $8.3 M / yr | $17 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $229 M | 77% of $299 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $367 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $37 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 43,461 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $265 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$299 M** |
| Imported / external-capital requirement | $69 M (23.1%) |
| Local-content / local-funding requirement | $229 M (76.9%) |
| Default foreign-turnkey external-capital comparison | $537 M; OSR saves $468 M (87.2%) |
| Lifetime external interest and combined financing saving | $605 M interest; $1.07 bn capital + interest |
| 15%–25% planning risk envelope | $343 M–$373 M |
| Annual OPEX | $6.6 M / yr |
| Low/high project NPV at 8% | $-156965 k / $-112104 k |
| Low/high project IRR | -0.9% / 2.8% |
| Low/high steady-state DSCR | 0.29 / 0.59 |
