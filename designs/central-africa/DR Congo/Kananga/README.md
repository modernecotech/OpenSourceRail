...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **87,840 – 131,760 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (36.0 km @ $0.85 M/km) | $31 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 38.2 km × $0.015 M/km | $573 k |
...
|---|---|---|
| Construction (years 1–10) | **$7.2 M / yr** | $6 |
| Steady-state, low-ridership (year 11+) | **$1.7 M / yr** | $1 |
| Steady-state, high-ridership (year 11+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–40, low scenario) | **$123 M cumulative** | $102 |
| Lifecycle envelope (yr 1–40, high scenario) | **$72 M cumulative** | $60 |
| Lifecycle envelope (yr 1–40, cost-neutral after opening) | **$72 M cumulative** | $60 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $27 M | 13.0% | 40 y, 10 y grace | $3.7 M / yr |
| Government equity (no debt service) | 15% | $16 M | — | — | — |
| **Total** | **100%** | **$110 M** | | | **$7.0 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $2.0 M / yr + bonds $3.6 M / yr = **$5.5 M / yr** total — plus the equity tranche amortised across construction ($1.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 96,000 | 180,000 | 117,116 |
| Daily paid trips / population | 8% | 15% | 10% |
| Annual paid trips | 35.0 M | 65.7 M | 42.7 M |
| Farebox revenue | $7.7 M / yr | $14 M / yr | $9.4 M / yr |
| Station shop leases | $321 k / yr | $321 k / yr | $321 k / yr |
| Advertising boards | $446 k / yr | $446 k / yr | $446 k / yr |
| **Total revenue** | **$8.5 M / yr** | **$15 M / yr** | **$10 M / yr** |
| Revenue / OPEX + debt-service recovery | 83% | 150% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $1.7 M / yr | $0 k / yr | **$0 / yr** |
