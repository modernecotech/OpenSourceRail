...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 101 | $5.60 M | $566 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 404 | $100 k | $40 M |
| High sensitivity check | 404 | $200 k | $81 M |
...
|---|---|---|
| Construction (years 1–10) | **$95 M / yr** | $38 |
| Steady-state, low-ridership (year 11+) | **$104 M / yr** | $42 |
| Steady-state, high-ridership (year 11+) | **$104 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$92 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.08 bn cumulative** | $1,631 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.08 bn cumulative** | $1,631 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.72 bn cumulative** | $1,487 |

_Population basis: 2,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $12 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $866 M | 3.0% | 40 y, 10 y grace | $44 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $361 M | 13.0% | 40 y, 10 y grace | $48 M / yr |
| Government equity (no debt service) | 15% | $217 M | — | — | — |
| **Total** | **100%** | **$1.44 bn** | | | **$92 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $26 M / yr + bonds $47 M / yr = **$73 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 299,520 | 299,520 | 449,380 |
| Daily paid trips / catchment | 17% | 17% | 26% |
| Daily paid trips / city population | 12% | 12% | 18% |
| Annual paid trips | 109.3 M | 109.3 M | 164.0 M |
| Farebox revenue | $24 M / yr | $24 M / yr | $36 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$26 M / yr** | **$26 M / yr** | **$39 M / yr** |
| Revenue / OPEX recovery | 69% | 69% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gov debt service + residual OPEX subsidy | $104 M / yr | $104 M / yr | **$92 M / yr** |
