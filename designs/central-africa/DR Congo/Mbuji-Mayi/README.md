...
|---|---|---|---|---|
| line-1 | 29.3 km | 17 | 63 | W Outer ↔ E Outer |
| line-2 | 16.8 km | 11 | 40 | SW Mid ↔ SE Mid |
| line-3 | 28.9 km | 15 | 59 | NE Outer ↔ SW Mid |
| line-4 | 43.8 km | 29 | 25 | W Mid ↔ W Mid |
| **Total** | **118.8 km** | **72 unique** | **187** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **158.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.5× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 590 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 271 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 663 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 158.7 MW / 762 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 293 kWh | 808 kWh | 487 kWh | 7.7 km / 77 kWh |
| line-2 | 11 | 168 kWh | 588 kWh | 403 kWh | 2.0 km / 20 kWh |
| line-3 | 11 | 288 kWh | 588 kWh | 271 kWh | 13.0 km / 130 kWh |
| line-4 | 28 | 437 kWh | 1,372 kWh | 891 kWh | 3.5 km / 35 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 748 | $60 k | $45 M |
| High sensitivity check | 748 | $120 k | $90 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 158,724 kW @ $700/kW | $111 M |
| Grid interconnection / PPA tie-in | 158,724 kW @ $100/kW | $16 M |
| Annual generation proxy | 158.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 278.1 GWh/yr |
| **Dedicated solar plant subtotal** | | **$127 M** |
...
| Dedicated solar power plant | $127 M |
...
|---|---|---|
| Construction (years 1–10) | **$78 M / yr** | $31 |
| Steady-state, low capacity-use (year 11+) | **$61 M / yr** | $24 |
| Steady-state, high capacity-use (year 11+) | **$41 M / yr** | $16 |
| Steady-state, operating-neutral revenue case | **$68 M / yr** | $27 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.60 bn cumulative** | $1,042 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.00 bn cumulative** | $801 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.81 bn cumulative** | $1,126 |

_Population basis: 2,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $7.0 M / yr → $27 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.11 bn | 4.5% | 40 y, 10 y grace | $68 M / yr |
| Government equity (no debt service) | 20% | $277 M | — | — | — |
| **Total** | **100%** | **$1.38 bn** | | | **$68 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $50 M / yr = **$50 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($28 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (284.2 GWh / yr) | 45,061 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 42.4 GWh/yr + dedicated solar plant 158.7 MW / 278.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.9 M |
| Labour (739 FTE) | driverless roster: OCC/remote 110, station/platform 311, passenger service 72, fleet maintenance 116, infrastructure/energy 107, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$30 M / yr** |

_Annual service work: 45,061 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 17.8 M train-km / yr (71.1 M car-km / yr). On-site PV covers 42.4 GWh/yr and the dedicated solar plant adds 278.1 GWh/yr against 284.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 187 trainsets, 72 stations, 118.8 route-km, 4 lines, and 45,061 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 114.1 M | 182.5 M | 90.1 M |
| Annual paid trips / city resident | 46 | 73 | 36 |
| Farebox revenue | $33 M / yr | $54 M / yr | $26 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$37 M / yr** | **$57 M / yr** | **$30 M / yr** |
| Revenue / OPEX recovery | 124% | 191% | 100% |
...
| Operating surplus applied to debt support | -$7.0 M / yr | -$27 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $61 M / yr | $41 M / yr | **$68 M / yr** |
| Operating surplus after OPEX (before debt support) | $7.0 M / yr | $27 M / yr | $0 / yr |

_Commercial-revenue assumptions: 13,640 m² of station shop/kiosk leases at $10/m²/month and 2,472 advertising boards at $77/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$119 M / yr** | **$191 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 6 healthcare anchors | 25,907 trips/day; 9.5 M access-events/yr | 41,452 trips/day; 15.1 M access-events/yr |
| Commerce | 36 major/terminal/interchange nodes | 66,402 trips/trading day; 21.9 M access-events/yr | 106,243 trips/trading day; 35.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $781 M | 56% of $1.38 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.25 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $125 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 147,990 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $127 M |
| **Reconciled project CAPEX** | **$1.38 bn** |
| 15%–25% planning risk envelope | $1.59 bn–$1.73 bn |
| Annual OPEX | $30 M / yr |
| Low/high project NPV at 8% | $-892261 k / $-787586 k |
| Low/high project IRR | -8.0% / -2.5% |
| Low/high steady-state DSCR | 0.10 / 0.40 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,298.47 train-km; 32,933.98 kWh consumed; 35,466.76 kWh charged; 23 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 45,169.52 train-km; 451,001.22 kWh consumed; 458,348.96 kWh charged; 656 depot services completed (5 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 64.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.1% / 60% | pass |
| ten-hour single charging-pad outage | 72.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 4 corridors, 72 line platforms, 7 interchange complexes, 23 civil segments, and 0 input findings |
