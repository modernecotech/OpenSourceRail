...
| Revenue fleet passenger capacity | 106,560 AW2 pax (142,080 AW3 crush) |
...
| Revenue fleet capacity | 106,560 AW2 pax (142,080 AW3 crush) |
| Total fleet capacity | 118,560 AW2 pax (158,080 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 222 × 480 = **106,560 AW2 passengers** (142,080 AW3 crush)
- **Total fleet passenger capacity:** 247 × 480 = **118,560 AW2 passengers** (158,080 AW3 crush, incl. spare + reserve)
...
| PV daily yield proxy | 175 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,586 MWh/day | 91,774 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,411 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 324.5 MW / 1,622 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 324,498 kW @ $700/kW | $227 M |
| Grid interconnection / PPA tie-in | 324,498 kW @ $100/kW | $32 M |
| Annual generation proxy | 324.5 MW × 5.0 peak-sun-h/day × 365 d/yr | 592.2 GWh/yr |
...
| Per-capita (city pop) | $1,668 / person |
...
|---|---|---|
| Construction (years 1–7) | **$141 M / yr** | $74 |
| Steady-state, low capacity-use (year 8+) | **$113 M / yr** | $59 |
| Steady-state, high capacity-use (year 8+) | **$68 M / yr** | $36 |
| Steady-state, operating-neutral revenue case | **$106 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.71 bn cumulative** | $2,478 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.24 bn cumulative** | $1,707 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.48 bn cumulative** | $2,356 |

_Population basis: 1,900,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.0 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $37 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.54 bn | 2.0% | 40 y, 7 y grace | $106 M / yr |
| Government equity (no debt service) | 20% | $634 M | — | — | — |
| **Total** | **100%** | **$3.17 bn** | | | **$106 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $51 M / yr = **$51 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($91 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (578.8 GWh / yr) | 91,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 63.9 GWh/yr + dedicated solar plant 324.5 MW / 592.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.9 M |
| Labour (1,025 FTE) | driverless roster: OCC/remote 146, station/platform 335, passenger service 107, fleet maintenance 195, infrastructure/energy 188, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $2.8 M |
| **OPEX subtotal** | | **$86 M / yr** |

_Annual service work: 91,774 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 36.2 M train-km / yr (144.7 M car-km / yr). On-site PV covers 63.9 GWh/yr and the dedicated solar plant adds 592.2 GWh/yr against 578.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 168.2 M | 269.1 M | 184.1 M |
| Annual paid trips / city resident | 89 | 142 | 97 |
| Farebox revenue | $74 M / yr | $118 M / yr | $81 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.2 M / yr | $3.2 M / yr | $3.2 M / yr |
| **Total revenue** | **$79 M / yr** | **$124 M / yr** | **$86 M / yr** |
| Revenue / OPEX recovery | 92% | 143% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $113 M / yr | $106 M / yr | **$106 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$37 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $113 M / yr | $68 M / yr | **$106 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $21 M / yr | $34 M / yr | 16 min/trip × $0.48/h value-of-time proxy |
...
| Station-area commerce turnover supported | $56 M / yr | $90 M / yr | 22% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 8 education anchors | 27,480 trips/school day; 6.0 M access-events/yr | 43,969 trips/school day; 9.7 M access-events/yr |
| Healthcare | 7 healthcare anchors | 33,806 trips/day; 12.3 M access-events/yr | 54,090 trips/day; 19.7 M access-events/yr |
| Commerce | 50 major/terminal/interchange nodes | 102,528 trips/trading day; 33.8 M access-events/yr | 164,045 trips/trading day; 54.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.65 bn | 52% of $3.17 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.64 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $377 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 208,242 job-years | retained CAPEX ÷ (4.0 × median annual income) |
