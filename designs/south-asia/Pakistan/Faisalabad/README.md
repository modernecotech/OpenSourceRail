...
| Multi-line transfer reachability | 93% (line-pairs sharing ≥ 1 station) |
| Anchor-weighted coverage | 79.8% |
| Route length (double track) | 169.7 km |
| Revenue fleet | 326 × 6-car trainsets |
| Revenue fleet passenger capacity | 234,720 AW2 pax (312,960 AW3 crush) |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 29 planned-maintenance spares and 6 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 32.3 km | 21 | 83 | SW Mid ↔ NE Outer |
| line-2 | 22.9 km | 14 | 60 | NE Mid ↔ W Mid |
| line-3 | 23.1 km | 17 | 64 | SE Mid ↔ W Mid |
| line-4 | 22.8 km | 15 | 62 | NW Mid ↔ S Mid |
| line-5 | 24.7 km | 14 | 62 | N Mid ↔ SW Outer |
| line-6 | 43.9 km | 36 | 30 | W Inner ↔ W Inner |
| **Total** | **169.7 km** | **117 unique** | **361** | |
...
| Revenue fleet capacity | 234,720 AW2 pax (312,960 AW3 crush) |
| Total fleet capacity | 259,920 AW2 pax (346,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 326 × 720 = **234,720 AW2 passengers** (312,960 AW3 crush)
- **Total fleet passenger capacity:** 361 × 720 = **259,920 AW2 passengers** (346,560 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **111** | **38,000 kW** | **260,000 kWh** |

Aggregate station-rail charging power: **222,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **271.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.3× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 932 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 395 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 247 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 271.4 MW / 1,764 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 260 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 539 kWh | 1,339 kWh | 747 kWh | 8.8 km / 148 kWh |
| line-2 | 13 | 383 kWh | 915 kWh | 494 kWh | 4.0 km / 66 kWh |
| line-3 | 17 | 385 kWh | 1,176 kWh | 752 kWh | 2.0 km / 34 kWh |
| line-4 | 15 | 381 kWh | 1,045 kWh | 626 kWh | 2.2 km / 36 kWh |
| line-5 | 12 | 413 kWh | 849 kWh | 395 kWh | 7.8 km / 131 kWh |
| line-6 | 35 | 734 kWh | 2,287 kWh | 1,479 kWh | 4.1 km / 69 kWh |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 361 | $1.68 M | $606 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 2166 | $60 k | $130 M |
| High sensitivity check | 2166 | $120 k | $260 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 271,359 kW @ $700/kW | $190 M |
| Grid interconnection / PPA tie-in | 271,359 kW @ $100/kW | $27 M |
| Annual generation proxy | 271.4 MW × 6.5 peak-sun-h/day × 365 d/yr | 643.8 GWh/yr |
| **Dedicated solar plant subtotal** | | **$217 M** |
...
| EPC integration + project management (7%) | on subtotal | $165 M |
...
| Depots | $8.0 M |
| Rolling stock | $606 M |
| Railway production plant | $130 M |
| Dedicated solar power plant | $217 M |
| Residual train-control wayside + charging microgrids | $59 M |
| EPC overhead (7%) | $165 M |
| **CAPEX total** | **$2.74 bn** |
| Per-route-km | $16 M / km |
| Per-capita (city pop) | $771 / person |
...
|---|---|---|
| Construction (years 1–7) | **$177 M / yr** | $50 |
| Steady-state, low capacity-use (year 8+) | **$64 M / yr** | $18 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$129 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.35 bn cumulative** | $942 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.24 bn cumulative** | $348 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.49 bn cumulative** | $1,544 |

_Population basis: 3,556,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $65 M / yr → $129 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.19 bn | 4.5% | 40 y, 7 y grace | $129 M / yr |
| Government equity (no debt service) | 20% | $548 M | — | — | — |
| **Total** | **100%** | **$2.74 bn** | | | **$129 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $99 M / yr = **$99 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($78 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (650.0 GWh / yr) | 68,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 90.2 GWh/yr + dedicated solar plant 271.4 MW / 643.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.3 M |
| Labour (1,336 FTE) | driverless roster: OCC/remote 199, station/platform 604, passenger service 151, fleet maintenance 199, infrastructure/energy 156, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.7 M |
| **OPEX subtotal** | | **$63 M / yr** |

_Annual service work: 68,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.1 M train-km / yr (162.5 M car-km / yr). On-site PV covers 90.2 GWh/yr and the dedicated solar plant adds 643.8 GWh/yr against 650.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 361 trainsets, 117 stations, 169.7 route-km, 6 lines, and 68,703 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (1,473,120 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the CAPEX funding stack, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 23% |
| Annual paid trips | 268.8 M | 430.2 M | 121.4 M |
| Annual paid trips / city resident | 76 | 121 | 34 |
| Farebox revenue | $118 M / yr | $189 M / yr | $53 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $5.7 M / yr | $5.7 M / yr | $5.7 M / yr |
| **Total revenue** | **$128 M / yr** | **$199 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 203% | 316% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $129 M / yr | $129 M / yr | **$129 M / yr** |
| Operating surplus applied to debt support | -$65 M / yr | -$129 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $64 M / yr | $0 k / yr | **$129 M / yr** |
| Operating surplus after OPEX (before debt support) | $65 M / yr | $136 M / yr | $0 / yr |

_Commercial-revenue assumptions: 27,352 m² of station shop/kiosk leases at $13/m²/month and 4,828 advertising boards at $115/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $91 M / yr | $146 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $43 M / yr | $68 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$298 M / yr** | **$477 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 19 education anchors | 51,367 trips/school day; 11.3 M access-events/yr | 82,187 trips/school day; 18.1 M access-events/yr |
| Healthcare | 26 healthcare anchors | 67,507 trips/day; 24.6 M access-events/yr | 108,012 trips/day; 39.4 M access-events/yr |
| Commerce | 73 major/terminal/interchange nodes | 166,104 trips/trading day; 54.8 M access-events/yr | 265,766 trips/trading day; 87.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.52 bn | 56% of $2.74 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.44 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $349 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 192,511 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.52 bn |
| Timetable-sized dedicated solar CAPEX | $217 M |
| **Reconciled project CAPEX** | **$2.74 bn** |
| 15%–25% planning risk envelope | $3.15 bn–$3.43 bn |
| Annual OPEX | $63 M / yr |
| Low/high project NPV at 8% | $-1602986 k / $-1126160 k |
| Low/high project IRR | -1.2% / 2.6% |
| Low/high steady-state DSCR | 0.50 / 1.05 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,956.66 train-km; 82,786.59 kWh consumed; 91,213.76 kWh charged; 34 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 69,628.22 train-km; 1,162,937.20 kWh consumed; 1,185,199.46 kWh charged; 998 depot services completed (8 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 79.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 80.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 83.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.7% / 60% | pass |
| ten-hour single charging-pad outage | 83.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 117 line platforms, 9 interchange complexes, 44 civil segments, and 0 input findings |
