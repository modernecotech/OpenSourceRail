...
| Per-capita (city pop) | $557 / person |
...
|---|---|---|
| Construction (years 1–7) | **$128 M / yr** | $36 |
| Steady-state, low capacity-use (year 8+) | **$16 M / yr** | $4 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$93 M / yr** | $26 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.41 bn cumulative** | $397 |
| Lifecycle envelope (yr 1–40, high scenario) | **$895 M cumulative** | $252 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.97 bn cumulative** | $1,115 |

_Population basis: 3,556,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $77 M / yr → $93 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.58 bn | 4.5% | 40 y, 7 y grace | $93 M / yr |
| Government equity (no debt service) | 20% | $396 M | — | — | — |
| **Total** | **100%** | **$1.98 bn** | | | **$93 M / yr** |
...
| Operating surplus applied to debt support | -$77 M / yr | -$93 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $16 M / yr | $0 k / yr | **$93 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.09 bn | 55% of $1.98 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.75 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $250 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 137,841 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $2.28 bn–$2.48 bn |
| Annual OPEX | $45 M / yr |
| Low/high project NPV at 8% | $-952621 k / $-475795 k |
| Low/high project IRR | 1.3% / 5.2% |
| Low/high steady-state DSCR | 0.83 / 1.59 |
