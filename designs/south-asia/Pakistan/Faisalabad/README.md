...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **331,561 – 514,800 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (148.0 km @ $2.0 M/km) | $296 M |
| Elevated (17.2 km @ $9.0 M/km) | $155 M |
| Elevated-interchange premium (9 sites @ $4.50 M) | $40 M |
| **Civil subtotal** | **$491 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 166.0 km × $0.015 M/km | $8.3 M |
...
| Per-capita (city pop) | $286 / person |
...
|---|---|---|
| Construction (years 1–7) | **$88 M / yr** | $25 |
| Steady-state, low-ridership (year 8+) | **$84 M / yr** | $24 |
| Steady-state, high-ridership (year 8+) | **$84 M / yr** | $24 |
| Steady-state, operating-neutral revenue case | **$84 M / yr** | $24 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.56 bn cumulative** | $719 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.56 bn cumulative** | $719 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.56 bn cumulative** | $719 |

_Population basis: 3,556,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $610 M | 4.0% | 30 y, 7 y grace | $41 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $254 M | 16.5% | 30 y, 7 y grace | $43 M / yr |
| Government equity (no debt service) | 15% | $153 M | — | — | — |
| **Total** | **100%** | **$1.02 bn** | | | **$84 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $24 M / yr + bonds $42 M / yr = **$66 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 331,561 | 514,800 | 158,326 |
| Daily paid trips / catchment | 18% | 28% | 9% |
| Daily paid trips / city population | 9% | 14% | 4% |
| Annual paid trips | 121.0 M | 187.9 M | 57.8 M |
| Farebox revenue | $40 M / yr | $62 M / yr | $19 M / yr |
| Station shop leases | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| Advertising boards | $3.9 M / yr | $3.9 M / yr | $3.9 M / yr |
| **Total revenue** | **$46 M / yr** | **$68 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 182% | 268% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $84 M / yr | $84 M / yr | **$84 M / yr** |
| Operating surplus after OPEX | $21 M / yr | $43 M / yr | $0 / yr |
