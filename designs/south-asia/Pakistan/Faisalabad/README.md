...
|---|---|---|
| Construction (years 1–7) | **$107 M / yr** | $30 |
| Steady-state, low-ridership (year 8+) | **$102 M / yr** | $29 |
| Steady-state, high-ridership (year 8+) | **$102 M / yr** | $29 |
| Steady-state, operating-neutral revenue case | **$102 M / yr** | $29 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.09 bn cumulative** | $870 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.09 bn cumulative** | $870 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.09 bn cumulative** | $870 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $738 M | 4.0% | 30 y, 7 y grace | $50 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $308 M | 16.5% | 30 y, 7 y grace | $52 M / yr |
| Government equity (no debt service) | 15% | $185 M | — | — | — |
| **Total** | **100%** | **$1.23 bn** | | | **$102 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $30 M / yr + bonds $51 M / yr = **$80 M / yr** total — plus the equity tranche amortised across construction ($26 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
