...
| Steady-state, high-ridership (year 8+) | **$73 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$73 M / yr** | $21 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.76 bn cumulative** | $1,057 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.02 bn cumulative** | $849 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.02 bn cumulative** | $849 |

_Population basis: 3,556,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $22 M / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $96 M / yr | $73 M / yr | **$73 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $37 M / yr | $0 / yr |
