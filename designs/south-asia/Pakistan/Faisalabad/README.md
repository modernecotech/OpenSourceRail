...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.93 bn (86.3%) of external capital** and **$3.67 bn of external interest**. Capital plus saved interest totals **$6.59 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 79.8% |
| Route length (double track) | 169.7 km |
| Revenue fleet | 227 × 6-car trainsets |
| Revenue fleet passenger capacity | 163,440 AW2 pax (217,920 AW3 crush) |
...
| Revenue fleet capacity | 163,440 AW2 pax (217,920 AW3 crush) |
| Total fleet capacity | 181,440 AW2 pax (241,920 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 227 × 720 = **163,440 AW2 passengers** (217,920 AW3 crush)
- **Total fleet passenger capacity:** 252 × 720 = **181,440 AW2 passengers** (241,920 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 79.8%
- Catchment population: **≈ 2,837,688** (within ~800 m walk of a station)
...
| Interchange | 20 | 300 kW | 2000 kWh |
| Major | 3 | 300 kW | 2000 kWh |
| Standard | 24 | 300 kW | 2000 kWh |
| Terminal | 9 | 300 kW | 2000 kWh |
| **Total installed** | **57** | **21,800 kW** | **152,000 kWh** |

Aggregate station-rail charging power: **114,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **290.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.1× worst inter-charge run | OK: 1,350 kWh nameplate, 270 kWh protected reserve, and 902 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 164 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 142 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 68,703 train-km/day | One-way train journeys × route length |
| Annual service work | 27.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,781 MWh/day | 162.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,639 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 290.0 MW / 1,885 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 152 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 11 | 539 kWh | 817 kWh | 224 kWh | 9.4 km / 156 kWh |
| line-2 | 8 | 383 kWh | 588 kWh | 167 kWh | 6.2 km / 104 kWh |
| line-3 | 8 | 385 kWh | 588 kWh | 164 kWh | 4.6 km / 76 kWh |
| line-4 | 8 | 381 kWh | 588 kWh | 169 kWh | 6.8 km / 114 kWh |
| line-5 | 8 | 413 kWh | 686 kWh | 231 kWh | 9.6 km / 161 kWh |
| line-6 | 14 | 734 kWh | 1,143 kWh | 336 kWh | 10.6 km / 178 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (151.1 km @ $3.0 M/km) | $453 M |
| Elevated (18.6 km @ $12.0 M/km) | $224 M |
| Elevated-interchange premium (9 sites @ $4.50 M) | $40 M |
| **Civil subtotal** | **$717 M** |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 252 | $1.68 M | $423 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 1512 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 1512 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 289,989 kW @ $700/kW | $203 M |
| Grid interconnection / PPA tie-in | 289,989 kW @ $100/kW | $29 M |
| Annual generation proxy | 290.0 MW × 6.5 peak-sun-h/day × 365 d/yr | 688.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 169.7 km × $0.050 M/km | $8.5 M |
...
| Per-capita (city pop) | $530 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $717 M | 15% | $108 M | $610 M |
| Stations | $361 M | 20% | $72 M | $289 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $423 M | 35% | $148 M | $275 M |
| Dedicated solar plant | $232 M | 45% | $104 M | $128 M |
| Residual signalling / train control | $8.5 M | 50% | $4.2 M | $4.2 M |
| Charging microgrids | $25 M | 40% | $10 M | $15 M |
| EPC / project services | $108 M | 15% | $16 M | $92 M |
| **Total city CAPEX** | **$1.88 bn** | **24.7%** | **$465 M** | **$1.42 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh faisalabad`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$465 M** | **$66 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$1.42 bn** | **$203 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $1.13 bn | $162 M / yr |
| **Total city programme** | **100.0%** | **$1.88 bn** | **$269 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.54 bn | $2.08 bn (81.7%) | $2.60 bn | **$4.68 bn** |
| **Default** | 2.00× | $3.39 bn | $2.93 bn (86.3%) | $3.67 bn | **$6.59 bn** |
| High | 3.00× | $5.09 bn | $4.62 bn (90.9%) | $5.79 bn | **$10.41 bn** |

At the default 2.00× case, OSR's $465 M external requirement is 86.3% below the illustrative foreign-company requirement of $3.39 bn; the associated lifetime external-interest saving is $3.67 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$249 M / yr** | $70 |
| Steady-state, low capacity-use (year 8+) | **$138 M / yr** | $39 |
| Steady-state, high capacity-use (year 8+) | **$67 M / yr** | $19 |
| Steady-state, operating-neutral revenue case | **$216 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.31 bn cumulative** | $1,773 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.96 bn cumulative** | $1,114 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$8.86 bn cumulative** | $2,492 |

_Population basis: 3,556,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $77 M / yr → $148 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $465 M | 4.5% | 40 y, 7 y grace | $27 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $1.13 bn | 16.5% | 40 y, 7 y grace | $188 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $284 M | — | — | — |
| **Total** | **100%** | **$1.88 bn** | | | **$216 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $21 M / yr + local bonds $187 M / yr = **$208 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $424 k |
| Traction energy (650.0 GWh / yr) | 68,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 51.7 GWh/yr + dedicated solar plant 290.0 MW / 688.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.5 M |
| Labour (899 FTE) | driverless roster: OCC/remote 150, station/platform 269, passenger service 151, fleet maintenance 166, infrastructure/energy 136, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $2.5 M |
| **OPEX subtotal** | | **$45 M / yr** |

_Annual service work: 68,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 27.1 M train-km / yr (162.5 M car-km / yr). On-site PV covers 51.7 GWh/yr and the dedicated solar plant adds 688.0 GWh/yr against 650.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 252 trainsets, 60 stations, 169.7 route-km, 6 lines, and 68,703 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 268.8 M | 430.2 M | 92.8 M |
| Annual paid trips / city resident | 76 | 121 | 26 |
| Farebox revenue | $118 M / yr | $189 M / yr | $41 M / yr |
| Station shop leases | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| Advertising boards | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| **Total revenue** | **$123 M / yr** | **$193 M / yr** | **$45 M / yr** |
| Revenue / OPEX recovery | 272% | 429% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $216 M / yr | $216 M / yr | **$216 M / yr** |
| Operating surplus applied to debt support | -$77 M / yr | -$148 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $138 M / yr | $67 M / yr | **$216 M / yr** |
| Operating surplus after OPEX (before debt support) | $77 M / yr | $148 M / yr | $0 / yr |

_Commercial-revenue assumptions: 11,880 m² of station shop/kiosk leases at $13/m²/month and 2,172 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $34 M / yr | $55 M / yr | 16 min/trip × $0.48/h value-of-time proxy |
...
| Station-area commerce turnover supported | $88 M / yr | $140 M / yr | 22% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $43 M / yr | $68 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$295 M / yr** | **$472 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 10 education anchors | 51,559 trips/school day; 11.3 M access-events/yr | 82,495 trips/school day; 18.1 M access-events/yr |
| Healthcare | 11 healthcare anchors | 63,099 trips/day; 23.0 M access-events/yr | 100,958 trips/day; 36.8 M access-events/yr |
| Commerce | 33 major/terminal/interchange nodes | 160,386 trips/trading day; 52.9 M access-events/yr | 256,618 trips/trading day; 84.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.42 bn | 75% of $1.88 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.27 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $324 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 179,094 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.65 bn |
| Timetable-sized dedicated solar CAPEX | $232 M |
| **Reconciled project CAPEX** | **$1.88 bn** |
| Imported / external-capital requirement | $465 M (24.7%) |
| Local-content / local-funding requirement | $1.42 bn (75.3%) |
| Default foreign-turnkey external-capital comparison | $3.39 bn; OSR saves $2.93 bn (86.3%) |
| Lifetime external interest and combined financing saving | $3.67 bn interest; $6.59 bn capital + interest |
| 15%–25% planning risk envelope | $2.17 bn–$2.35 bn |
| Annual OPEX | $45 M / yr |
| Low/high project NPV at 8% | $-880424 k / $-403597 k |
| Low/high project IRR | 1.6% / 5.5% |
| Low/high steady-state DSCR | 0.36 / 0.69 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,417.04 train-km; 90,474.31 kWh consumed; 92,637.24 kWh charged; 51 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 66,327.08 train-km; 1,107,780.77 kWh consumed; 1,120,054.41 kWh charged; 1,021 depot services completed (10 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 96.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.4% | 96.5% / 90% | pass |
| maximum planning climate/HVAC duty | 64.2% | 96.5% / 90% | pass |
| 50% charging-contact availability | 71.9% | 96.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 75.8% / 60% | pass |
| ten-hour single charging-pad outage | 63.6% | 96.5% / 90% | pass |
...
|---|---|
| ![Faisalabad energy and battery simulation dashboard](engineering/screenshots/faisalabad-simulation-dashboard.png) | ![Faisalabad simulator network visualizer](engineering/screenshots/faisalabad-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 60 line platforms, 9 interchange complexes, 44 civil segments, and 0 input findings |
...
|---|---|
| ![Faisalabad QGIS engineering layers](engineering/screenshots/faisalabad-qgis-engineering-map.png) | ![Faisalabad SUMO timetable validation](engineering/screenshots/faisalabad-sumo-validation.png) |
...
scripts/regenerate-city.sh faisalabad
```
