...
| Steady-state, low-ridership (year 8+) | **$51 M / yr** | $103 |
| Steady-state, high-ridership (year 8+) | **$49 M / yr** | $97 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $85 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.49 bn cumulative** | $2,981 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.43 bn cumulative** | $2,859 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.29 bn cumulative** | $2,581 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.7 M / yr → $6.0 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $308 M | 4.0% | 30 y, 7 y grace | $21 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $128 M | 16.5% | 30 y, 7 y grace | $22 M / yr |
| Government equity (no debt service) | 15% | $77 M | — | — | — |
| **Total** | **100%** | **$514 M** | | | **$43 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $21 M / yr = **$34 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 33,030 | 55,050 | 105,197 |
| Daily paid trips / catchment | 18% | 30% | 57% |
| Daily paid trips / city population | 7% | 11% | 21% |
| Annual paid trips | 12.1 M | 20.1 M | 38.4 M |
| Farebox revenue | $4.0 M / yr | $6.6 M / yr | $13 M / yr |
| Station shop leases | $476 k / yr | $476 k / yr | $476 k / yr |
| Advertising boards | $792 k / yr | $792 k / yr | $792 k / yr |
| **Total revenue** | **$5.2 M / yr** | **$7.9 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 38% | 57% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $51 M / yr | $49 M / yr | **$43 M / yr** |
