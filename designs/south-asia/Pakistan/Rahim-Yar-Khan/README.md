...
| Revenue fleet | 126 × 3-car trainsets |
| Revenue fleet passenger capacity | 45,360 AW2 pax (60,480 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 10.2 km | 7 | 26 | NW Inner ↔ SE Mid |
| line-2 | 18.4 km | 10 | 49 | SW Mid ↔ NE Outer |
| line-3 | 25.1 km | 12 | 65 | NE Outer ↔ SW Outer |
| **Total** | **53.6 km** | **29 unique** | **140** | |
...
| Revenue fleet capacity | 45,360 AW2 pax (60,480 AW3 crush) |
| Total fleet capacity | 50,400 AW2 pax (67,200 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 126 × 360 = **45,360 AW2 passengers** (60,480 AW3 crush)
- **Total fleet passenger capacity:** 140 × 360 = **50,400 AW2 passengers** (67,200 AW3 crush, incl. service rotation + spare + reserve)
...
| Lowest traversal charging margin | 40 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 71 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 82 kWh | 131 kWh | 40 kWh | 2.3 km / 19 kWh |
| line-2 | 8 | 148 kWh | 229 kWh | 66 kWh | 7.9 km / 64 kWh |
| line-3 | 9 | 202 kWh | 294 kWh | 72 kWh | 8.1 km / 65 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (51.3 km @ $3.0 M/km) | $154 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 140 | $900 k | $126 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 420 | $60 k | $25 M |
| High sensitivity check | 420 | $120 k | $50 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 48,198 kW @ $700/kW | $34 M |
| Grid interconnection / PPA tie-in | 48,198 kW @ $100/kW | $4.8 M |
...
|---|---|---|
| Construction (years 1–7) | **$37 M / yr** | $74 |
| Steady-state, low capacity-use (year 8+) | **$6.7 M / yr** | $13 |
...
| Lifecycle envelope (yr 1–40, high scenario) | **$260 M cumulative** | $520 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.15 bn cumulative** | $2,303 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $460 M | 4.5% | 40 y, 7 y grace | $27 M / yr |
| Government equity (no debt service) | 20% | $115 M | — | — | — |
| **Total** | **100%** | **$575 M** | | | **$27 M / yr** |
...
| Traction energy (117.8 GWh / yr) | 24,913 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 48.2 MW / 105.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $578 k |
| Labour (395 FTE) | driverless roster: OCC/remote 86, station/platform 115, passenger service 49, fleet maintenance 75, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 24,913 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.8 M train-km / yr (29.5 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 105.6 GWh/yr against 117.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 140 trainsets, 29 stations, 53.6 route-km, 3 lines, and 24,913 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 27.2 M |
...
| Revenue / OPEX recovery | 248% | 388% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.7 M / yr | $0 k / yr | **$27 M / yr** |
| Operating surplus after OPEX (before debt support) | $20 M / yr | $40 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,856 m² of station shop/kiosk leases at $13/m²/month and 912 advertising boards at $115/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $325 M | 56% of $575 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 40,976 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $536 M |
| Timetable-sized dedicated solar CAPEX | $39 M |
| **Reconciled project CAPEX** | **$575 M** |
| 15%–25% planning risk envelope | $661 M–$719 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-291371 k / $-161327 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,037.32 train-km; 16,430.47 kWh consumed; 15,182.78 kWh charged; 28 depot services completed; minimum SoC 77%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,525.93 train-km; 205,855.73 kWh consumed; 197,952.43 kWh charged; 487 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 138 SoC warnings; 8 energy-adapted off-peak departures, maximum 17 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 99.8% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 29 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
