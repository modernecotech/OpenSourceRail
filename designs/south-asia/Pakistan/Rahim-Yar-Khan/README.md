...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$731 M (86.7%) of external capital** and **$916 M of external interest**. Capital plus saved interest totals **$1.65 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (51.7 km @ $3.0 M/km) | $155 M |
...
| Per-capita (city pop) | $937 / person |
...
| **Total city CAPEX** | **$468 M** | **24.0%** | **$113 M** | **$356 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$113 M** | **$16 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$356 M** | **$51 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $285 M | $41 M / yr |
| **Total city programme** | **100.0%** | **$468 M** | **$67 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $632 M | $520 M (82.2%) | $652 M | **$1.17 bn** |
| **Default** | 2.00× | $843 M | $731 M (86.7%) | $916 M | **$1.65 bn** |
| High | 3.00× | $1.26 bn | $1.15 bn (91.1%) | $1.44 bn | **$2.60 bn** |

At the default 2.00× case, OSR's $113 M external requirement is 86.7% below the illustrative foreign-company requirement of $843 M; the associated lifetime external-interest saving is $916 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$62 M / yr** | $124 |
| Steady-state, low capacity-use (year 8+) | **$32 M / yr** | $65 |
| Steady-state, high capacity-use (year 8+) | **$13 M / yr** | $26 |
| Steady-state, operating-neutral revenue case | **$54 M / yr** | $108 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.51 bn cumulative** | $3,014 |
| Lifecycle envelope (yr 1–40, high scenario) | **$868 M cumulative** | $1,737 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.21 bn cumulative** | $4,429 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $41 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $113 M | 4.5% | 40 y, 7 y grace | $6.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $285 M | 16.5% | 40 y, 7 y grace | $47 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $71 M | — | — | — |
| **Total** | **100%** | **$468 M** | | | **$54 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.1 M / yr + local bonds $47 M / yr = **$52 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($10 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 24.6 M |
| Annual paid trips / city resident | 147 | 235 | 49 |
| Farebox revenue | $32 M / yr | $52 M / yr | $11 M / yr |
| Station shop leases | $393 k / yr | $393 k / yr | $393 k / yr |
| Advertising boards | $646 k / yr | $646 k / yr | $646 k / yr |
| **Total revenue** | **$33 M / yr** | **$53 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 280% | 444% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $54 M / yr | $54 M / yr | **$54 M / yr** |
| Operating surplus applied to debt support | -$21 M / yr | -$41 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $32 M / yr | $13 M / yr | **$54 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $41 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $356 M | 76% of $468 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $570 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $81 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 44,944 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$468 M** |
| Imported / external-capital requirement | $113 M (24.0%) |
| Local-content / local-funding requirement | $356 M (76.0%) |
| Default foreign-turnkey external-capital comparison | $843 M; OSR saves $731 M (86.7%) |
| Lifetime external interest and combined financing saving | $916 M interest; $1.65 bn capital + interest |
| 15%–25% planning risk envelope | $539 M–$586 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-204486 k / $-74443 k |
| Low/high project IRR | 2.2% / 6.2% |
| Low/high steady-state DSCR | 0.40 / 0.76 |
