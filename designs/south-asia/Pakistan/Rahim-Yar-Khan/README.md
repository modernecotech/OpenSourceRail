...
|---|---|---|---|---|
| line-1 | 19.6 km | 9 | 19 | NE Outer ↔ SW Outer |
| line-2 |  9.7 km | 7 | 11 | W Mid ↔ S Mid |
| line-3 | 16.7 km | 8 | 17 | NE Outer ↔ S Mid |
| **Total** | **46.0 km** | **24 unique** | **47** | |
...
| Bucket | Value |
|---|---|
| At-grade (45.1 km @ $2.0 M/km) | $90 M |
| Elevated (0.8 km @ $9.0 M/km) | $7.2 M |
| **Civil subtotal** | **$97 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.0 km × $0.015 M/km | $2.3 M |
...
|---|---|---|
| Construction (years 1–7) | **$18 M / yr** | $37 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $36 |
| Steady-state, high-ridership (year 8+) | **$18 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $35 |
| Lifecycle envelope (yr 1–30, low scenario) | **$538 M cumulative** | $1,076 |
| Lifecycle envelope (yr 1–30, high scenario) | **$534 M cumulative** | $1,069 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$534 M cumulative** | $1,069 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $154 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $128 M | 4.0% | 30 y, 7 y grace | $8.6 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $53 M | 16.5% | 30 y, 7 y grace | $9.0 M / yr |
| Government equity (no debt service) | 15% | $32 M | — | — | — |
| **Total** | **100%** | **$213 M** | | | **$18 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $5.1 M / yr + bonds $8.8 M / yr = **$14 M / yr** total — plus the equity tranche amortised across construction ($4.6 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
