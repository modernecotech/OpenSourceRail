...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$685 M (86.3%) of external capital** and **$859 M of external interest**. Capital plus saved interest totals **$1.54 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 53.6 km |
...
- Anchor-weighted coverage: 75.8%
- Catchment population: **≈ 379,000** (within ~800 m walk of a station)
...
| Major | 1 | 300 kW | 1000 kWh |
| Standard | 5 | 300 kW | 1000 kWh |
| Terminal | 5 | 300 kW | 1000 kWh |
| **Total installed** | **15** | **9,200 kW** | **54,000 kWh** |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **51.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 435 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 66 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 24,913 train-km/day | One-way train journeys × route length |
| Annual service work | 9.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 323 MWh/day | 29.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 268 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 51.3 MW / 308 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 82 kWh | 229 kWh | 138 kWh | 2.5 km / 20 kWh |
| line-2 | 4 | 148 kWh | 229 kWh | 66 kWh | 13.0 km / 105 kWh |
| line-3 | 5 | 202 kWh | 294 kWh | 72 kWh | 10.3 km / 83 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (51.7 km @ $2.58 M/km) | $133 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 51,303 kW @ $700/kW | $36 M |
| Grid interconnection / PPA tie-in | 51,303 kW @ $100/kW | $5.1 M |
| Annual generation proxy | 51.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 112.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 53.6 km × $0.050 M/km | $2.7 M |
...
| Per-capita (city pop) | $882 / person |
...
| Dedicated solar plant | $41 M | 45% | $18 M | $23 M |
| Residual signalling / train control | $2.7 M | 50% | $1.3 M | $1.3 M |
| Charging microgrids | $3.5 M | 40% | $1.4 M | $2.1 M |
| EPC / project services | $26 M | 15% | $3.9 M | $22 M |
| **Total city CAPEX** | **$441 M** | **24.6%** | **$108 M** | **$332 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh rahim-yar-khan`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$108 M** | **$15 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$332 M** | **$47 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $266 M | $38 M / yr |
| **Total city programme** | **100.0%** | **$441 M** | **$63 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $595 M | $487 M (81.8%) | $610 M | **$1.10 bn** |
| **Default** | 2.00× | $794 M | $685 M (86.3%) | $859 M | **$1.54 bn** |
| High | 3.00× | $1.19 bn | $1.08 bn (90.9%) | $1.36 bn | **$2.44 bn** |

At the default 2.00× case, OSR's $108 M external requirement is 86.3% below the illustrative foreign-company requirement of $794 M; the associated lifetime external-interest saving is $859 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$58 M / yr** | $117 |
| Steady-state, low capacity-use (year 8+) | **$29 M / yr** | $57 |
| Steady-state, high capacity-use (year 8+) | **$9.2 M / yr** | $18 |
| Steady-state, operating-neutral revenue case | **$51 M / yr** | $101 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.35 bn cumulative** | $2,703 |
| Lifecycle envelope (yr 1–40, high scenario) | **$713 M cumulative** | $1,426 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.08 bn cumulative** | $4,151 |

_Population basis: 500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $41 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $108 M | 4.5% | 40 y, 7 y grace | $6.4 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $266 M | 16.5% | 40 y, 7 y grace | $44 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $66 M | — | — | — |
| **Total** | **100%** | **$441 M** | | | **$51 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.9 M / yr + local bonds $44 M / yr = **$49 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (117.8 GWh / yr) | 24,913 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.1 GWh/yr + dedicated solar plant 51.3 MW / 112.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $616 k |
| Labour (337 FTE) | driverless roster: OCC/remote 81, station/platform 68, passenger service 49, fleet maintenance 72, infrastructure/energy 46, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $934 k |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 24,913 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.8 M train-km / yr (29.5 M car-km / yr). On-site PV covers 20.1 GWh/yr and the dedicated solar plant adds 112.4 GWh/yr against 117.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 129 trainsets, 18 stations, 53.6 route-km, 3 lines, and 24,913 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 23.5 M |
| Annual paid trips / city resident | 147 | 235 | 47 |
| Farebox revenue | $32 M / yr | $52 M / yr | $10 M / yr |
| Station shop leases | $393 k / yr | $393 k / yr | $393 k / yr |
| Advertising boards | $646 k / yr | $646 k / yr | $646 k / yr |
| **Total revenue** | **$33 M / yr** | **$53 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 293% | 464% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $51 M / yr | $51 M / yr | **$51 M / yr** |
| Operating surplus applied to debt support | -$22 M / yr | -$41 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $29 M / yr | $9.2 M / yr | **$51 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $41 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,816 m² of station shop/kiosk leases at $13/m²/month and 548 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $23 M / yr | 177 M - 283 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.5 M / yr | $4.1 M / yr | 31.8–50.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $332 M | 75% of $441 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $532 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $76 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 41,981 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $400 M |
| Timetable-sized dedicated solar CAPEX | $41 M |
| **Reconciled project CAPEX** | **$441 M** |
| Imported / external-capital requirement | $108 M (24.6%) |
| Local-content / local-funding requirement | $332 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $794 M; OSR saves $685 M (86.3%) |
| Lifetime external interest and combined financing saving | $859 M interest; $1.54 bn capital + interest |
| 15%–25% planning risk envelope | $507 M–$551 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $-180487 k / $-50444 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,120.36 train-km; 17,100.31 kWh consumed; 17,019.72 kWh charged; 35 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,886.09 train-km; 192,636.57 kWh consumed; 195,279.21 kWh charged; 515 depot services completed (6 active at cutoff); minimum SoC 59%; 0 onboard emergencies; 0 invariant violations; 95.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 48.8% | 95.9% / 90% | pass |
| maximum planning climate/HVAC duty | 24.0% | 95.9% / 90% | pass |
| 50% charging-contact availability | 59.0% | 95.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 86.1% / 60% | pass |
| ten-hour single charging-pad outage | 59.0% | 95.9% / 90% | pass |
...
|---|---|
| ![Rahim-Yar-Khan energy and battery simulation dashboard](engineering/screenshots/rahim-yar-khan-simulation-dashboard.png) | ![Rahim-Yar-Khan simulator network visualizer](engineering/screenshots/rahim-yar-khan-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 18 line platforms, 2 interchange complexes, 6 civil segments, and 0 input findings |
...
|---|---|
| ![Rahim-Yar-Khan QGIS engineering layers](engineering/screenshots/rahim-yar-khan-qgis-engineering-map.png) | ![Rahim-Yar-Khan SUMO timetable validation](engineering/screenshots/rahim-yar-khan-sumo-validation.png) |
