# Larkana Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 210 |
| Manufacturing schedule rows | 820 |
| Manufacturing material/BOM rows | 12,527 |
| Manufacturing QA verification rows | 820 |
| Construction QA action rows | 768 |
| Maintenance handover schedule rows | 970 |
| Manufacturing rows with material refs | 820 / 820 |
| Manufacturing rows with verification refs | 820 / 820 |
| Manufacturing rows linked to QA actions | 820 / 820 |
