...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **25,200 – 42,000 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$30 M / yr** | $59 |
| Steady-state, low-ridership (year 8+) | **$32 M / yr** | $64 |
| Steady-state, high-ridership (year 8+) | **$30 M / yr** | $59 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $57 |
| Lifecycle envelope (yr 1–30, low scenario) | **$938 M cumulative** | $1,877 |
| Lifecycle envelope (yr 1–30, high scenario) | **$892 M cumulative** | $1,784 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$861 M cumulative** | $1,722 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.4 M / yr → $1.3 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $206 M | 4.0% | 30 y, 7 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $86 M | 16.5% | 30 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 15% | $51 M | — | — | — |
| **Total** | **100%** | **$343 M** | | | **$28 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.2 M / yr + bonds $14 M / yr = **$22 M / yr** total — plus the equity tranche amortised across construction ($7.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 25,200 | 42,000 | 53,120 |
| Daily paid trips / catchment | 18% | 30% | 38% |
| Daily paid trips / city population | 5% | 8% | 11% |
| Annual paid trips | 9.2 M | 15.3 M | 19.4 M |
| Farebox revenue | $3.0 M / yr | $5.1 M / yr | $6.4 M / yr |
| Station shop leases | $453 k / yr | $453 k / yr | $453 k / yr |
| Advertising boards | $716 k / yr | $716 k / yr | $716 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.2 M / yr** | **$7.6 M / yr** |
| Revenue / OPEX recovery | 56% | 82% | 100% |
