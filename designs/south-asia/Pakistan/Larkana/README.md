...
| Steady-state, low-ridership (year 8+) | **$38 M / yr** | $76 |
| Steady-state, high-ridership (year 8+) | **$36 M / yr** | $72 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $67 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.13 bn cumulative** | $2,252 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.08 bn cumulative** | $2,159 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.02 bn cumulative** | $2,042 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $2.5 M / yr._
...
_During the 7-year grace period the operator pays interest only — multilateral $9.8 M / yr + bonds $17 M / yr = **$27 M / yr** total — plus the equity tranche amortised across construction ($8.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 25,200 | 42,000 | 63,017 |
| Daily paid trips / catchment | 18% | 30% | 45% |
| Daily paid trips / city population | 5% | 8% | 13% |
| Annual paid trips | 9.2 M | 15.3 M | 23.0 M |
| Farebox revenue | $3.0 M / yr | $5.1 M / yr | $7.6 M / yr |
| Station shop leases | $453 k / yr | $453 k / yr | $453 k / yr |
| Advertising boards | $716 k / yr | $716 k / yr | $716 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.2 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 48% | 71% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $38 M / yr | $36 M / yr | **$34 M / yr** |
