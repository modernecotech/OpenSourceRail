...
| Steady-state, low-ridership (year 8+) | **$56 M / yr** | $113 |
| Steady-state, high-ridership (year 8+) | **$54 M / yr** | $109 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $93 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.64 bn cumulative** | $3,272 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.59 bn cumulative** | $3,179 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.41 bn cumulative** | $2,819 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $9.9 M / yr → $7.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $336 M | 4.0% | 30 y, 7 y grace | $23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $140 M | 16.5% | 30 y, 7 y grace | $24 M / yr |
| Government equity (no debt service) | 15% | $84 M | — | — | — |
| **Total** | **100%** | **$561 M** | | | **$46 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $23 M / yr = **$37 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 25,200 | 42,000 | 107,047 |
| Daily paid trips / catchment | 18% | 30% | 76% |
| Daily paid trips / city population | 5% | 8% | 21% |
| Annual paid trips | 9.2 M | 15.3 M | 39.1 M |
| Farebox revenue | $3.0 M / yr | $5.1 M / yr | $13 M / yr |
| Station shop leases | $453 k / yr | $453 k / yr | $453 k / yr |
| Advertising boards | $716 k / yr | $716 k / yr | $716 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.2 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 30% | 44% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $56 M / yr | $54 M / yr | **$46 M / yr** |
