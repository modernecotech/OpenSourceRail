...
| Elevated (12.7 km @ €18 M/km) | €229 M |
| Elevated-interchange premium (1 sites @ €20 M) | €20 M |
| **Civil subtotal** | **€336 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 37.7 km × €0.015 M/km | €0.6 M |
...
| Steady-state, low-ridership (year 8+) | **€59 M / yr** | €119 |
| Steady-state, high-ridership (year 8+) | **€57 M / yr** | €114 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.72 bn cumulative** | €3,440 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.67 bn cumulative** | €3,334 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€11 M / yr (low) → €9.0 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €348 M | 4.0% | 30 y, 7 y grace | €23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €145 M | 16.5% | 30 y, 7 y grace | €25 M / yr |
| Government equity (no debt service) | 15% | €87 M | — | — | — |
| **Total** | **100%** | **€580 M** | | | **€48 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €14 M / yr + bonds €24 M / yr = **€38 M / yr** total — plus the equity tranche amortised across construction (€12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (238 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €607 k |
...
| Operating shortfall (gov subsidy required) | €11 M / yr | €9.0 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€59 M / yr** | **€57 M / yr** |
