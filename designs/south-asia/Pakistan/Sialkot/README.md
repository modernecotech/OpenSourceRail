...
|---|---|---|
| Construction (years 1–7) | **$67 M / yr** | $89 |
| Steady-state, low-ridership (year 8+) | **$70 M / yr** | $94 |
| Steady-state, high-ridership (year 8+) | **$66 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$64 M / yr** | $85 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.09 bn cumulative** | $2,781 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.98 bn cumulative** | $2,638 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.93 bn cumulative** | $2,572 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.8 M / yr → $2.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $460 M | 4.0% | 30 y, 7 y grace | $31 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $192 M | 16.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $115 M | — | — | — |
| **Total** | **100%** | **$767 M** | | | **$64 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $18 M / yr + bonds $32 M / yr = **$50 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 58,050 | 96,750 | 114,497 |
| Daily paid trips / catchment | 18% | 30% | 36% |
| Daily paid trips / city population | 8% | 13% | 15% |
| Annual paid trips | 21.2 M | 35.3 M | 41.8 M |
| Farebox revenue | $7.0 M / yr | $12 M / yr | $14 M / yr |
...
| Remaining steady-state gov commitment | $70 M / yr | $66 M / yr | **$64 M / yr** |
