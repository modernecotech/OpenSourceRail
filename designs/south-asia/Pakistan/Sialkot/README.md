...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **32,250 – 48,375 trips/day**
...
| Elevated (31.3 km @ $4.0 M/km) | $125 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.4 km × $0.015 M/km | $890 k |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $30 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $24 |
| Steady-state, high-ridership (year 8+) | **$12 M / yr** | $16 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$577 M cumulative** | $770 |
| Lifecycle envelope (yr 1–30, high scenario) | **$432 M cumulative** | $576 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$155 M cumulative** | $207 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $154 M | 4.0% | 30 y, 7 y grace | $10 M / yr |
...
_During the 7-year grace period the operator pays interest only — multilateral $6.2 M / yr + bonds $11 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($5.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 60,000 | 112,500 | 212,306 |
| Daily paid trips / population | 8% | 15% | 28% |
| Annual paid trips | 21.9 M | 41.1 M | 77.5 M |
| Farebox revenue | $7.2 M / yr | $14 M / yr | $26 M / yr |
| Station shop leases | $882 k / yr | $882 k / yr | $882 k / yr |
| Advertising boards | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| **Total revenue** | **$9.5 M / yr** | **$16 M / yr** | **$28 M / yr** |
| Revenue / OPEX + debt-service recovery | 34% | 57% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $18 M / yr | $12 M / yr | **$0 / yr** |
