...
| Elevated (31.3 km @ €18 M/km) | €564 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.4 km × €0.015 M/km | €0.9 M |
...
|---|---|---|
| Construction (years 1–7) | **€94 M / yr** | €125 |
| Steady-state, low-ridership (year 8+) | **€110 M / yr** | €147 |
| Steady-state, high-ridership (year 8+) | **€107 M / yr** | €143 |
| Lifecycle envelope (yr 1–30, low scenario) | **€3.20 bn cumulative** | €4,260 |
| Lifecycle envelope (yr 1–30, high scenario) | **€3.12 bn cumulative** | €4,154 |

_Population basis: 750,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€21 M / yr (low) → €17 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €648 M | 4.0% | 30 y, 7 y grace | €44 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €270 M | 16.5% | 30 y, 7 y grace | €46 M / yr |
| Government equity (no debt service) | 15% | €162 M | — | — | — |
| **Total** | **100%** | **€1.08 bn** | | | **€89 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €26 M / yr + bonds €45 M / yr = **€70 M / yr** total — plus the equity tranche amortised across construction (€23 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (368 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €938 k |
...
| Farebox revenue | €3.5 M / yr | €6.9 M / yr |
| Farebox / OPEX recovery | 14% | 28% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €21 M / yr | €17 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€110 M / yr** | **€107 M / yr** |
