...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **159,804 – 199,680 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (149.8 km @ $2.0 M/km) | $300 M |
| Elevated (9.9 km @ $9.0 M/km) | $89 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 130 | $1.07 M | $139 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 160.2 km × $0.015 M/km | $8.0 M |
...
| Per-capita (city pop) | $335 / person |
...
|---|---|---|
| Construction (years 1–7) | **$67 M / yr** | $29 |
| Steady-state, low-ridership (year 8+) | **$64 M / yr** | $28 |
| Steady-state, high-ridership (year 8+) | **$64 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$64 M / yr** | $28 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.94 bn cumulative** | $842 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.94 bn cumulative** | $842 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.94 bn cumulative** | $842 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $463 M | 4.0% | 30 y, 7 y grace | $31 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $193 M | 16.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $116 M | — | — | — |
| **Total** | **100%** | **$771 M** | | | **$64 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $19 M / yr + bonds $32 M / yr = **$50 M / yr** total — plus the equity tranche amortised across construction ($17 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 159,804 | 199,680 | 127,169 |
| Daily paid trips / catchment | 18% | 22% | 14% |
| Daily paid trips / city population | 7% | 9% | 6% |
| Annual paid trips | 58.3 M | 72.9 M | 46.4 M |
| Farebox revenue | $19 M / yr | $24 M / yr | $15 M / yr |
| Station shop leases | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| Advertising boards | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| **Total revenue** | **$23 M / yr** | **$28 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 120% | 145% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $64 M / yr | $64 M / yr | **$64 M / yr** |
| Operating surplus after OPEX | $3.9 M / yr | $8.7 M / yr | $0 / yr |
