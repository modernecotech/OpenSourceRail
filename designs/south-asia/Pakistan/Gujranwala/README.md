...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 872 | $60 k | $52 M |
| High sensitivity check | 872 | $120 k | $105 M |
...
| Per-capita (city pop) | $690 / person |
...
|---|---|---|
| Construction (years 1–7) | **$102 M / yr** | $45 |
| Steady-state, low capacity-use (year 8+) | **$41 M / yr** | $18 |
| Steady-state, high capacity-use (year 8+) | **$2.8 M / yr** | $1 |
| Steady-state, operating-neutral revenue case | **$75 M / yr** | $32 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.09 bn cumulative** | $907 |
| Lifecycle envelope (yr 1–40, high scenario) | **$809 M cumulative** | $352 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.18 bn cumulative** | $1,382 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.27 bn | 4.5% | 40 y, 7 y grace | $75 M / yr |
| Government equity (no debt service) | 20% | $317 M | — | — | — |
| **Total** | **100%** | **$1.59 bn** | | | **$75 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $57 M / yr = **$57 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($45 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $41 M / yr | $2.8 M / yr | **$75 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $895 M | 56% of $1.59 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.43 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $204 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 112,946 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$1.59 bn** |
| 15%–25% planning risk envelope | $1.82 bn–$1.98 bn |
| Annual OPEX | $35 M / yr |
| Low/high project NPV at 8% | $-957918 k / $-697831 k |
| Low/high project IRR | -1.8% / 2.1% |
| Low/high steady-state DSCR | 0.44 / 0.96 |
