...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.23 bn (86.8%) of external capital** and **$2.80 bn of external interest**. Capital plus saved interest totals **$5.03 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 65.3% |
| Route length (double track) | 187.2 km |
| Revenue fleet | 196 × 4-car trainsets |
| Revenue fleet passenger capacity | 94,080 AW2 pax (125,440 AW3 crush) |
...
| Revenue fleet capacity | 94,080 AW2 pax (125,440 AW3 crush) |
| Total fleet capacity | 104,640 AW2 pax (139,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 196 × 480 = **94,080 AW2 passengers** (125,440 AW3 crush)
- **Total fleet passenger capacity:** 218 × 480 = **104,640 AW2 passengers** (139,520 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 65.3%
- Catchment population: **≈ 1,501,900** (within ~800 m walk of a station)
...
| Interchange | 16 | 300 kW | 1500 kWh |
| Major | 3 | 300 kW | 1500 kWh |
| Standard | 22 | 300 kW | 1500 kWh |
| Terminal | 7 | 300 kW | 1500 kWh |
| **Total installed** | **49** | **19,400 kW** | **112,000 kWh** |

Aggregate station-rail charging power: **73,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **217.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.1× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 578 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 155 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 116 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,092 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 72,535 train-km/day | One-way train journeys × route length |
| Annual service work | 28.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,253 MWh/day | 114.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,137 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 217.9 MW / 1,308 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 112 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 422 kWh | 662 kWh | 197 kWh | 12.6 km / 135 kWh |
| line-2 | 9 | 354 kWh | 576 kWh | 187 kWh | 13.2 km / 142 kWh |
| line-3 | 6 | 215 kWh | 392 kWh | 155 kWh | 5.9 km / 63 kWh |
| line-4 | 9 | 351 kWh | 576 kWh | 190 kWh | 11.4 km / 123 kWh |
| line-5 | 15 | 671 kWh | 919 kWh | 181 kWh | 6.0 km / 65 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (177.0 km @ $2.58 M/km) | $457 M |
| Elevated (10.2 km @ $9.75 M/km) | $99 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$593 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 218 | $1.12 M | $244 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 872 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 872 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 217,925 kW @ $700/kW | $153 M |
| Grid interconnection / PPA tie-in | 217,925 kW @ $100/kW | $22 M |
| Annual generation proxy | 217.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 477.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$174 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 187.2 km × $0.050 M/km | $9.4 M |
...
|---|---:|---:|---:|---:|
| Civil works | $593 M | 15% | $89 M | $504 M |
| Stations | $301 M | 20% | $60 M | $240 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $244 M | 35% | $85 M | $159 M |
| Dedicated solar plant | $174 M | 45% | $78 M | $96 M |
| Residual signalling / train control | $9.4 M | 50% | $4.7 M | $4.7 M |
| Charging microgrids | $16 M | 40% | $6.5 M | $9.8 M |
| EPC / project services | $82 M | 15% | $12 M | $70 M |
| **Total city CAPEX** | **$1.43 bn** | **23.7%** | **$338 M** | **$1.09 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh gujranwala`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$338 M** | **$48 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$1.09 bn** | **$156 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $871 M | $124 M / yr |
| **Total city programme** | **100.0%** | **$1.43 bn** | **$204 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.93 bn | $1.59 bn (82.4%) | $1.99 bn | **$3.58 bn** |
| **Default** | 2.00× | $2.57 bn | $2.23 bn (86.8%) | $2.80 bn | **$5.03 bn** |
| High | 3.00× | $3.85 bn | $3.52 bn (91.2%) | $4.41 bn | **$7.92 bn** |

At the default 2.00× case, OSR's $338 M external requirement is 86.8% below the illustrative foreign-company requirement of $2.57 bn; the associated lifetime external-interest saving is $2.80 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$190 M / yr** | $83 |
| Steady-state, low capacity-use (year 8+) | **$130 M / yr** | $56 |
| Steady-state, high capacity-use (year 8+) | **$91 M / yr** | $39 |
| Steady-state, operating-neutral revenue case | **$165 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.61 bn cumulative** | $2,437 |
| Lifecycle envelope (yr 1–40, high scenario) | **$4.33 bn cumulative** | $1,882 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.76 bn cumulative** | $2,939 |

_Population basis: 2,300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $35 M / yr → $74 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $338 M | 4.5% | 40 y, 7 y grace | $20 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $871 M | 16.5% | 40 y, 7 y grace | $145 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $218 M | — | — | — |
| **Total** | **100%** | **$1.43 bn** | | | **$165 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $15 M / yr + local bonds $144 M / yr = **$159 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($31 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $468 k |
| Traction energy (457.5 GWh / yr) | 72,535 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 42.5 GWh/yr + dedicated solar plant 217.9 MW / 477.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.6 M |
| Labour (780 FTE) | driverless roster: OCC/remote 130, station/platform 227, passenger service 92, fleet maintenance 161, infrastructure/energy 145, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $2.2 M |
| **OPEX subtotal** | | **$33 M / yr** |

_Annual service work: 72,535 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 28.6 M train-km / yr (114.4 M car-km / yr). On-site PV covers 42.5 GWh/yr and the dedicated solar plant adds 477.3 GWh/yr against 457.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 218 trainsets, 55 stations, 187.2 route-km, 5 lines, and 72,535 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 67.1 M |
| Annual paid trips / city resident | 64 | 102 | 29 |
| Farebox revenue | $65 M / yr | $103 M / yr | $30 M / yr |
| Station shop leases | $1.4 M / yr | $1.4 M / yr | $1.4 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$68 M / yr** | **$107 M / yr** | **$33 M / yr** |
| Revenue / OPEX recovery | 206% | 323% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $165 M / yr | $165 M / yr | **$165 M / yr** |
| Operating surplus applied to debt support | -$35 M / yr | -$74 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $130 M / yr | $91 M / yr | **$165 M / yr** |
| Operating surplus after OPEX (before debt support) | $35 M / yr | $74 M / yr | $0 / yr |

_Commercial-revenue assumptions: 9,840 m² of station shop/kiosk leases at $13/m²/month and 1,816 advertising boards at $115/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $47 M / yr | $74 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $23 M / yr | $37 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$159 M / yr** | **$255 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 21,175 trips/school day; 4.7 M access-events/yr | 33,880 trips/school day; 7.5 M access-events/yr |
| Healthcare | 5 healthcare anchors | 34,031 trips/day; 12.4 M access-events/yr | 54,450 trips/day; 19.9 M access-events/yr |
| Commerce | 27 major/terminal/interchange nodes | 84,991 trips/trading day; 28.0 M access-events/yr | 135,985 trips/trading day; 44.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.09 bn | 76% of $1.43 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.74 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $249 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 137,489 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.25 bn |
| Timetable-sized dedicated solar CAPEX | $174 M |
| **Reconciled project CAPEX** | **$1.43 bn** |
| Imported / external-capital requirement | $338 M (23.7%) |
| Local-content / local-funding requirement | $1.09 bn (76.3%) |
| Default foreign-turnkey external-capital comparison | $2.57 bn; OSR saves $2.23 bn (86.8%) |
| Lifetime external interest and combined financing saving | $2.80 bn interest; $5.03 bn capital + interest |
| 15%–25% planning risk envelope | $1.64 bn–$1.78 bn |
| Annual OPEX | $33 M / yr |
| Low/high project NPV at 8% | $-826477 k / $-566390 k |
| Low/high project IRR | -1.0% / 2.9% |
| Low/high steady-state DSCR | 0.21 / 0.45 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,189.65 train-km; 55,804.94 kWh consumed; 55,688.03 kWh charged; 42 depot services completed; minimum SoC 71%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 67,878.05 train-km; 729,901.59 kWh consumed; 736,142.64 kWh charged; 816 depot services completed (8 active at cutoff); minimum SoC 58%; 0 onboard emergencies; 0 invariant violations; 93.6% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 47.8% | 93.6% / 90% | pass |
| maximum planning climate/HVAC duty | 52.3% | 93.6% / 90% | pass |
| 50% charging-contact availability | 58.2% | 93.6% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 70.8% / 60% | pass |
| ten-hour single charging-pad outage | 58.2% | 93.6% / 90% | pass |
...
|---|---|
| ![Gujranwala energy and battery simulation dashboard](engineering/screenshots/gujranwala-simulation-dashboard.png) | ![Gujranwala simulator network visualizer](engineering/screenshots/gujranwala-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 55 line platforms, 8 interchange complexes, 23 civil segments, and 0 input findings |
...
|---|---|
| ![Gujranwala QGIS engineering layers](engineering/screenshots/gujranwala-qgis-engineering-map.png) | ![Gujranwala SUMO timetable validation](engineering/screenshots/gujranwala-sumo-validation.png) |
...
scripts/regenerate-city.sh gujranwala
```
