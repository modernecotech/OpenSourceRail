...
| Revenue fleet | 267 × 4-car trainsets |
| Revenue fleet passenger capacity | 128,160 AW2 pax (170,880 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 39.2 km | 22 | 81 | NW Mid ↔ S Outer |
| line-2 | 32.9 km | 17 | 68 | NE Outer ↔ SW Inner |
| line-3 | 20.0 km | 12 | 47 | NW Mid ↔ S Mid |
| line-4 | 32.6 km | 17 | 68 | W Mid ↔ SE Outer |
| line-5 | 62.4 km | 36 | 34 | NW Mid ↔ NW Mid |
| **Total** | **187.2 km** | **104 unique** | **298** | |
...
| Revenue fleet capacity | 128,160 AW2 pax (170,880 AW3 crush) |
| Total fleet capacity | 143,040 AW2 pax (190,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 267 × 480 = **128,160 AW2 passengers** (170,880 AW3 crush)
- **Total fleet passenger capacity:** 298 × 480 = **143,040 AW2 passengers** (190,720 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **203.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 297 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 1,061 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 203.4 MW / 1,221 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 17 | 422 kWh | 906 kWh | 442 kWh | 12.6 km / 135 kWh |
| line-2 | 13 | 354 kWh | 686 kWh | 297 kWh | 13.2 km / 142 kWh |
| line-3 | 12 | 215 kWh | 637 kWh | 400 kWh | 2.0 km / 22 kWh |
| line-4 | 14 | 351 kWh | 735 kWh | 349 kWh | 11.3 km / 122 kWh |
| line-5 | 35 | 671 kWh | 1,715 kWh | 977 kWh | 6.1 km / 65 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 298 | $1.12 M | $334 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1192 | $60 k | $72 M |
| High sensitivity check | 1192 | $120 k | $143 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 203,435 kW @ $700/kW | $142 M |
| Grid interconnection / PPA tie-in | 203,435 kW @ $100/kW | $20 M |
| Annual generation proxy | 203.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 445.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$163 M** |
...
| Dedicated solar power plant | $163 M |
...
|---|---|---|
| Construction (years 1–7) | **$125 M / yr** | $54 |
| Steady-state, low capacity-use (year 8+) | **$64 M / yr** | $28 |
| Steady-state, high capacity-use (year 8+) | **$25 M / yr** | $11 |
| Steady-state, operating-neutral revenue case | **$91 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.97 bn cumulative** | $1,293 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.70 bn cumulative** | $738 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.87 bn cumulative** | $1,682 |

_Population basis: 2,300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $27 M / yr → $66 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.55 bn | 4.5% | 40 y, 7 y grace | $91 M / yr |
| Government equity (no debt service) | 20% | $386 M | — | — | — |
| **Total** | **100%** | **$1.93 bn** | | | **$91 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $70 M / yr = **$70 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($55 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (457.5 GWh / yr) | 72,535 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 70.1 GWh/yr + dedicated solar plant 203.4 MW / 445.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.4 M |
| Labour (1,014 FTE) | driverless roster: OCC/remote 167, station/platform 382, passenger service 92, fleet maintenance 185, infrastructure/energy 163, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $2.8 M |
| **OPEX subtotal** | | **$43 M / yr** |

_Annual service work: 72,535 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 28.6 M train-km / yr (114.4 M car-km / yr). On-site PV covers 70.1 GWh/yr and the dedicated solar plant adds 445.5 GWh/yr against 457.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 298 trainsets, 104 stations, 187.2 route-km, 5 lines, and 72,535 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 85.1 M |
| Annual paid trips / city resident | 64 | 102 | 37 |
| Farebox revenue | $65 M / yr | $103 M / yr | $37 M / yr |
| Station shop leases | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$70 M / yr** | **$109 M / yr** | **$43 M / yr** |
| Revenue / OPEX recovery | 163% | 252% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $91 M / yr | $91 M / yr | **$91 M / yr** |
| Operating surplus applied to debt support | -$27 M / yr | -$66 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $64 M / yr | $25 M / yr | **$91 M / yr** |
| Operating surplus after OPEX (before debt support) | $27 M / yr | $66 M / yr | $0 / yr |

_Commercial-revenue assumptions: 16,168 m² of station shop/kiosk leases at $13/m²/month and 3,016 advertising boards at $115/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $44 M / yr | $70 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $23 M / yr | $37 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$157 M / yr** | **$250 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 6 education anchors | 24,468 trips/school day; 5.4 M access-events/yr | 39,150 trips/school day; 8.6 M access-events/yr |
| Healthcare | 7 healthcare anchors | 31,726 trips/day; 11.6 M access-events/yr | 50,762 trips/day; 18.5 M access-events/yr |
| Commerce | 38 major/terminal/interchange nodes | 79,695 trips/trading day; 26.3 M access-events/yr | 127,512 trips/trading day; 42.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.09 bn | 57% of $1.93 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 137,815 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $163 M |
| **Reconciled project CAPEX** | **$1.93 bn** |
| 15%–25% planning risk envelope | $2.22 bn–$2.41 bn |
| Annual OPEX | $43 M / yr |
| Low/high project NPV at 8% | $-1254686 k / $-994598 k |
| Low/high project IRR | -3.5% / 0.6% |
| Low/high steady-state DSCR | 0.30 / 0.72 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,868.65 train-km; 52,352.61 kWh consumed; 54,433.82 kWh charged; 32 depot services completed; minimum SoC 78%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 73,173.43 train-km; 786,834.13 kWh consumed; 797,155.20 kWh charged; 836 depot services completed (5 active at cutoff); minimum SoC 73%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 65.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 104 line platforms, 8 interchange complexes, 25 civil segments, and 0 input findings |
