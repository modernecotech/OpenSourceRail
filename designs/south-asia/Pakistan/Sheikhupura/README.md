...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$285 M (87.6%) of external capital** and **$357 M of external interest**. Capital plus saved interest totals **$643 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (14.9 km @ $2.58 M/km) | $38 M |
| Elevated (1.7 km @ $9.75 M/km) | $16 M |
...
| Per-capita (city pop) | $301 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $64 M | 15% | $9.6 M | $54 M |
...
| **Total city CAPEX** | **$181 M** | **22.3%** | **$40 M** | **$140 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.3%** | **$40 M** | **$5.8 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.7%** | **$140 M** | **$20 M / yr** |
| of which planned local bond issuance | 62.1% of total CAPEX | $112 M | $16 M / yr |
| **Total city programme** | **100.0%** | **$181 M** | **$26 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $244 M | $204 M (83.5%) | $255 M | **$459 M** |
| **Default** | 2.00× | $326 M | $285 M (87.6%) | $357 M | **$643 M** |
| High | 3.00× | $488 M | $448 M (91.7%) | $561 M | **$1.01 bn** |

At the default 2.00× case, OSR's $40 M external requirement is 87.6% below the illustrative foreign-company requirement of $326 M; the associated lifetime external-interest saving is $357 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$24 M / yr** | $41 |
| Steady-state, low capacity-use (year 8+) | **$3.3 M / yr** | $6 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$280 M cumulative** | $467 |
| Lifecycle envelope (yr 1–40, high scenario) | **$171 M cumulative** | $284 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$865 M cumulative** | $1,441 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $18 M / yr → $21 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $40 M | 4.5% | 40 y, 7 y grace | $2.4 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $112 M | 16.5% | 40 y, 7 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $28 M | — | — | — |
| **Total** | **100%** | **$181 M** | | | **$21 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.8 M / yr + local bonds $19 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.0 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 48.9 M | 78.2 M | 8.6 M |
| Annual paid trips / city resident | 81 | 130 | 14 |
| Farebox revenue | $22 M / yr | $34 M / yr | $3.8 M / yr |
| Station shop leases | $270 k / yr | $270 k / yr | $270 k / yr |
| Advertising boards | $429 k / yr | $429 k / yr | $429 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$4.5 M / yr** |
| Revenue / OPEX recovery | 493% | 780% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $21 M / yr | $21 M / yr | **$21 M / yr** |
| Operating surplus applied to debt support | -$18 M / yr | -$21 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.3 M / yr | $0 k / yr | **$21 M / yr** |
| Operating surplus after OPEX (before debt support) | $18 M / yr | $31 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $140 M | 78% of $181 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $225 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $32 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 17,733 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $172 M |
| Timetable-sized dedicated solar CAPEX | $8.5 M |
| **Reconciled project CAPEX** | **$181 M** |
| Imported / external-capital requirement | $40 M (22.3%) |
| Local-content / local-funding requirement | $140 M (77.7%) |
| Default foreign-turnkey external-capital comparison | $326 M; OSR saves $285 M (87.6%) |
| Lifetime external interest and combined financing saving | $357 M interest; $643 M capital + interest |
| 15%–25% planning risk envelope | $208 M–$226 M |
| Annual OPEX | $4.5 M / yr |
| Low/high project NPV at 8% | $-15550 k / $71 M |
| Low/high project IRR | 7.1% / 11.6% |
| Low/high steady-state DSCR | 0.84 / 1.46 |
