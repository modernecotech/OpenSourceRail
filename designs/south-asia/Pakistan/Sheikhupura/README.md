...
| Revenue fleet passenger capacity | 14,040 AW2 pax (18,720 AW3 crush) |
...
|---|---|---|---|---|
| line-1 |  8.7 km | 6 | 23 | W Outer ↔ E Outer |
| line-2 |  7.9 km | 6 | 21 | W Outer ↔ E Outer |
| **Total** | **16.6 km** | **12 unique** | **44** | |
...
| Revenue fleet capacity | 14,040 AW2 pax (18,720 AW3 crush) |
| Total fleet capacity | 15,840 AW2 pax (21,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 39 × 360 = **14,040 AW2 passengers** (18,720 AW3 crush)
- **Total fleet passenger capacity:** 44 × 360 = **15,840 AW2 passengers** (21,120 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **9.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 29.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 522 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 45 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 50 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 9.6 MW / 57 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 70 kWh | 123 kWh | 45 kWh | 2.2 km / 18 kWh |
| line-2 | 6 | 63 kWh | 114 kWh | 45 kWh | 2.2 km / 18 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 44 | $900 k | $40 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 132 | $60 k | $7.9 M |
| High sensitivity check | 132 | $120 k | $16 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 9,575 kW @ $700/kW | $6.7 M |
| Grid interconnection / PPA tie-in | 9,575 kW @ $100/kW | $958 k |
| Annual generation proxy | 9.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 21.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$7.7 M** |
...
| Depots | $8.0 M |
| Rolling stock | $40 M |
| Railway production plant | $7.9 M |
| Dedicated solar power plant | $7.7 M |
| Residual train-control wayside + charging microgrids | $2.2 M |
| EPC overhead (7%) | $14 M |
| **CAPEX total** | **$216 M** |
| Per-route-km | $13 M / km |
| Per-capita (city pop) | $361 / person |
...
|---|---|---|
| Construction (years 1–7) | **$14 M / yr** | $23 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$10 M / yr** | $17 |
| Lifecycle envelope (yr 1–40, low scenario) | **$98 M cumulative** | $163 |
| Lifecycle envelope (yr 1–40, high scenario) | **$98 M cumulative** | $163 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$433 M cumulative** | $722 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $173 M | 4.5% | 40 y, 7 y grace | $10 M / yr |
| Government equity (no debt service) | 20% | $43 M | — | — | — |
| **Total** | **100%** | **$216 M** | | | **$10 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $7.8 M / yr = **$7.8 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($6.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (36.4 GWh / yr) | 7,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 18.2 GWh/yr + dedicated solar plant 9.6 MW / 21.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $115 k |
| Labour (185 FTE) | driverless roster: OCC/remote 37, station/platform 53, passenger service 33, fleet maintenance 24, infrastructure/energy 19, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $513 k |
| **OPEX subtotal** | | **$5.2 M / yr** |

_Annual service work: 7,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 3.0 M train-km / yr (9.1 M car-km / yr). On-site PV covers 18.2 GWh/yr and the dedicated solar plant adds 21.0 GWh/yr against 36.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 44 trainsets, 12 stations, 16.6 route-km, 2 lines, and 7,697 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
_Commercial-revenue assumptions: 2,280 m² of station shop/kiosk leases at $13/m²/month and 432 advertising boards at $115/board/month, with occupancy derates applied._
...
| Healthcare | 6 healthcare anchors | 16,472 trips/day; 6.0 M access-events/yr | 26,355 trips/day; 9.6 M access-events/yr |
| Commerce | 9 major/terminal/interchange nodes | 31,973 trips/trading day; 10.6 M access-events/yr | 51,157 trips/trading day; 16.9 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,229 trips/activity day; 4.3 M access-events/yr | 22,766 trips/activity day; 6.8 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $125 M | 58% of $216 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $200 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $29 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 15,815 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $209 M |
| Timetable-sized dedicated solar CAPEX | $7.7 M |
| **Reconciled project CAPEX** | **$216 M** |
| 15%–25% planning risk envelope | $249 M–$270 M |
| Annual OPEX | $5.2 M / yr |
| Low/high project NPV at 8% | $-45564 k / $41 M |
| Low/high project IRR | 5.6% / 9.8% |
| Low/high steady-state DSCR | 1.69 / 2.96 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 755.46 train-km; 6,092.50 kWh consumed; 6,497.53 kWh charged; 26 depot services completed; minimum SoC 90%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 8,015.15 train-km; 64,639.39 kWh consumed; 66,047.78 kWh charged; 328 depot services completed (4 active at cutoff); minimum SoC 85%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 82.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 72.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 84.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 54.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 12 line platforms, 2 interchange complexes, 5 civil segments, and 0 input findings |
