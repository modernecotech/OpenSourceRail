...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$303 M (87.8%) of external capital** and **$380 M of external interest**. Capital plus saved interest totals **$682 M over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`sheikhupura.corridor.geojson`](sheikhupura.corridor.geojson).
...
| Anchor-weighted coverage | 77.3% |
| Route length (double track) | 16.6 km |
| Revenue fleet | 33 × 3-car trainsets |
| Revenue fleet passenger capacity | 11,880 AW2 pax (15,840 AW3 crush) |
...
| Revenue fleet capacity | 11,880 AW2 pax (15,840 AW3 crush) |
| Total fleet capacity | 13,320 AW2 pax (17,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 33 × 360 = **11,880 AW2 passengers** (15,840 AW3 crush)
- **Total fleet passenger capacity:** 37 × 360 = **13,320 AW2 passengers** (17,760 AW3 crush, incl. service rotation + spare + reserve)
...
- **Daily theoretical capacity from timetable:** 930 scheduled one-way train journeys/day × 360 AW2 pax = **334,800 passenger-trips/day**
...
- Anchor-weighted coverage: 77.3%
- Catchment population: **≈ 463,800** (within ~800 m walk of a station)
...
| **Total installed** | **9** | **7,400 kW** | **44,000 kWh** |

Aggregate station-rail charging power: **4,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **10.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 22.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 516 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 28 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 44 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 930 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 7,697 train-km/day | One-way train journeys × route length |
| Annual service work | 3.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 100 MWh/day | 9.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 55 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 10.6 MW / 64 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 5 | 70 kWh | 118 kWh | 41 kWh | 3.0 km / 24 kWh |
| line-2 | 4 | 63 kWh | 98 kWh | 28 kWh | 2.9 km / 23 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (14.9 km @ $3.0 M/km) | $45 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 37 | $900 k | $33 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 111 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 111 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 10,610 kW @ $700/kW | $7.4 M |
| Grid interconnection / PPA tie-in | 10,610 kW @ $100/kW | $1.1 M |
| Annual generation proxy | 10.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 23.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$8.5 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 16.6 km × $0.050 M/km | $828 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $1.1 M |
...
| Stations | $54 M | 20% | $11 M | $43 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $33 M | 35% | $12 M | $22 M |
| Dedicated solar plant | $8.5 M | 45% | $3.8 M | $4.7 M |
| Residual signalling / train control | $828 k | 50% | $414 k | $414 k |
| Charging microgrids | $1.1 M | 40% | $440 k | $660 k |
| EPC / project services | $12 M | 15% | $1.8 M | $10 M |
| **Total city CAPEX** | **$192 M** | **21.9%** | **$42 M** | **$150 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sheikhupura`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.9%** | **$42 M** | **$6.0 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.1%** | **$150 M** | **$21 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $120 M | $17 M / yr |
| **Total city programme** | **100.0%** | **$192 M** | **$27 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $259 M | $217 M (83.8%) | $271 M | **$488 M** |
| **Default** | 2.00× | $345 M | $303 M (87.8%) | $380 M | **$682 M** |
| High | 3.00× | $517 M | $475 M (91.9%) | $596 M | **$1.07 bn** |

At the default 2.00× case, OSR's $42 M external requirement is 87.8% below the illustrative foreign-company requirement of $345 M; the associated lifetime external-interest saving is $380 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$26 M / yr** | $43 |
| Steady-state, low capacity-use (year 8+) | **$4.8 M / yr** | $8 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $37 |
| Lifecycle envelope (yr 1–40, low scenario) | **$341 M cumulative** | $568 |
| Lifecycle envelope (yr 1–40, high scenario) | **$181 M cumulative** | $302 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$918 M cumulative** | $1,530 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $18 M / yr → $22 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $42 M | 4.5% | 40 y, 7 y grace | $2.5 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $120 M | 16.5% | 40 y, 7 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $30 M | — | — | — |
| **Total** | **100%** | **$192 M** | | | **$22 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $1.9 M / yr + local bonds $20 M / yr = **$22 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($4.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $2.7 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $41 k |
| Traction energy (36.4 GWh / yr) | 7,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 16.2 GWh/yr + dedicated solar plant 10.6 MW / 23.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $127 k |
| Labour (174 FTE) | driverless roster: OCC/remote 37, station/platform 45, passenger service 33, fleet maintenance 22, infrastructure/energy 18, admin/training 19; no train drivers × country median × 12 × engineer-premium 1.4 | $482 k |
| **OPEX subtotal** | | **$4.7 M / yr** |

_Annual service work: 7,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 3.0 M train-km / yr (9.1 M car-km / yr). On-site PV covers 16.2 GWh/yr and the dedicated solar plant adds 23.2 GWh/yr against 36.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 37 trainsets, 9 stations, 16.6 route-km, 2 lines, and 7,697 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 9.1 M |
| Annual paid trips / city resident | 81 | 130 | 15 |
| Farebox revenue | $22 M / yr | $34 M / yr | $4.0 M / yr |
| Station shop leases | $270 k / yr | $270 k / yr | $270 k / yr |
| Advertising boards | $429 k / yr | $429 k / yr | $429 k / yr |
| **Total revenue** | **$22 M / yr** | **$35 M / yr** | **$4.7 M / yr** |
| Revenue / OPEX recovery | 473% | 747% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $22 M / yr | $22 M / yr | **$22 M / yr** |
| Operating surplus applied to debt support | -$18 M / yr | -$22 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $4.8 M / yr | $0 k / yr | **$22 M / yr** |
| Operating surplus after OPEX (before debt support) | $18 M / yr | $30 M / yr | $0 / yr |

_Commercial-revenue assumptions: 1,936 m² of station shop/kiosk leases at $13/m²/month and 364 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $6.2 M / yr | $9.9 M / yr | 16 min/trip × $0.48/h value-of-time proxy |
...
| Station-area commerce turnover supported | $19 M / yr | $30 M / yr | 25% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $8.1 M / yr | $13 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$41 M / yr** | **$65 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 7 healthcare anchors | 17,878 trips/day; 6.5 M access-events/yr | 28,605 trips/day; 10.4 M access-events/yr |
| Commerce | 8 major/terminal/interchange nodes | 33,926 trips/trading day; 11.2 M access-events/yr | 54,282 trips/trading day; 17.9 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 14,880 trips/activity day; 4.5 M access-events/yr | 23,808 trips/activity day; 7.1 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $150 M | 78% of $192 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $239 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $34 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 18,879 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $183 M |
| Timetable-sized dedicated solar CAPEX | $8.5 M |
| **Reconciled project CAPEX** | **$192 M** |
| Imported / external-capital requirement | $42 M (21.9%) |
| Local-content / local-funding requirement | $150 M (78.1%) |
| Default foreign-turnkey external-capital comparison | $345 M; OSR saves $303 M (87.8%) |
| Lifetime external interest and combined financing saving | $380 M interest; $682 M capital + interest |
| 15%–25% planning risk envelope | $220 M–$239 M |
| Annual OPEX | $4.7 M / yr |
| Low/high project NPV at 8% | $-24834 k / $62 M |
| Low/high project IRR | 6.6% / 11.0% |
| Low/high steady-state DSCR | 0.78 / 1.36 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 763.50 train-km; 6,157.49 kWh consumed; 6,170.02 kWh charged; 26 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 8,016.27 train-km; 64,649.21 kWh consumed; 65,704.38 kWh charged; 326 depot services completed (4 active at cutoff); minimum SoC 41%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 28.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 41.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.1% / 60% | pass |
| ten-hour single charging-pad outage | 21.6% | 100.0% / 90% | pass |
...
|---|---|
| ![Sheikhupura energy and battery simulation dashboard](engineering/screenshots/sheikhupura-simulation-dashboard.png) | ![Sheikhupura simulator network visualizer](engineering/screenshots/sheikhupura-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 2 corridors, 9 line platforms, 2 interchange complexes, 5 civil segments, and 0 input findings |
...
|---|---|
| ![Sheikhupura QGIS engineering layers](engineering/screenshots/sheikhupura-qgis-engineering-map.png) | ![Sheikhupura SUMO timetable validation](engineering/screenshots/sheikhupura-sumo-validation.png) |
...
| [`sheikhupura.toml`](sheikhupura.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`sheikhupura-network-map.png`](sheikhupura-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`sheikhupura.corridor.geojson`](sheikhupura.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`sheikhupura.stations.json`](sheikhupura.stations.json) | Machine-readable station list |
| [`sheikhupura.design-quality.yaml`](sheikhupura.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug sheikhupura

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh sheikhupura
```
