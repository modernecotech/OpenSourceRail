# Sheikhupura Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 5,907 |
| Manufacturing QA verification rows | 412 |
| Construction QA action rows | 382 |
| Maintenance handover schedule rows | 492 |
