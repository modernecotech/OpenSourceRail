...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.2 km × $0.015 M/km | $2.3 M |
...
| Per-capita (city pop) | $284 / person |
...
|---|---|---|
| Construction (years 1–7) | **$22 M / yr** | $25 |
| Steady-state, low-ridership (year 8+) | **$21 M / yr** | $24 |
| Steady-state, high-ridership (year 8+) | **$21 M / yr** | $24 |
| Steady-state, operating-neutral revenue case | **$21 M / yr** | $24 |
| Lifecycle envelope (yr 1–30, low scenario) | **$642 M cumulative** | $714 |
| Lifecycle envelope (yr 1–30, high scenario) | **$642 M cumulative** | $714 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$642 M cumulative** | $714 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $153 M | 4.0% | 30 y, 7 y grace | $10 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $64 M | 16.5% | 30 y, 7 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $38 M | — | — | — |
| **Total** | **100%** | **$256 M** | | | **$21 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.1 M / yr + bonds $11 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($5.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 67,230 | 112,050 | 35,424 |
| Daily paid trips / catchment | 18% | 30% | 9% |
| Daily paid trips / city population | 7% | 12% | 4% |
| Annual paid trips | 24.5 M | 40.9 M | 12.9 M |
| Farebox revenue | $8.1 M / yr | $13 M / yr | $4.3 M / yr |
| Station shop leases | $734 k / yr | $734 k / yr | $734 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$10.0 M / yr** | **$15 M / yr** | **$6.2 M / yr** |
| Revenue / OPEX recovery | 162% | 250% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $21 M / yr | $21 M / yr | **$21 M / yr** |
| Operating surplus after OPEX | $3.8 M / yr | $9.2 M / yr | $0 / yr |
