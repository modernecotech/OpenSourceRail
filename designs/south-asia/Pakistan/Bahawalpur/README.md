...
|---|---|---|---|---|
| line-1 | 13.9 km | 10 | 15 | E Outer ↔ SW Inner |
| line-2 | 17.5 km | 9 | 18 | NE Mid ↔ SW Outer |
| line-3 | 14.8 km | 10 | 16 | NW Outer ↔ E Inner |
| **Total** | **46.2 km** | **29 unique** | **49** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **67,230 – 112,050 trips/day**
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 49 | $4.20 M | $206 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 147 | $100 k | $15 M |
| High sensitivity check | 147 | $200 k | $29 M |
...
|---|---|---|
| Construction (years 1–7) | **$52 M / yr** | $58 |
| Steady-state, low-ridership (year 8+) | **$56 M / yr** | $62 |
| Steady-state, high-ridership (year 8+) | **$51 M / yr** | $56 |
| Steady-state, operating-neutral revenue case | **$50 M / yr** | $56 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.65 bn cumulative** | $1,837 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.53 bn cumulative** | $1,699 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.52 bn cumulative** | $1,690 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.7 M / yr → $343 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $363 M | 4.0% | 30 y, 7 y grace | $24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $151 M | 16.5% | 30 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 15% | $91 M | — | — | — |
| **Total** | **100%** | **$605 M** | | | **$50 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $15 M / yr + bonds $25 M / yr = **$39 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (289 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $801 k |
...
|---|---|---|---|
| Daily paid trips | 67,230 | 112,050 | 114,896 |
| Daily paid trips / catchment | 18% | 30% | 31% |
| Daily paid trips / city population | 7% | 12% | 13% |
| Annual paid trips | 24.5 M | 40.9 M | 41.9 M |
| Farebox revenue | $8.1 M / yr | $13 M / yr | $14 M / yr |
| Station shop leases | $734 k / yr | $734 k / yr | $734 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$10.0 M / yr** | **$15 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 64% | 98% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $56 M / yr | $51 M / yr | **$50 M / yr** |
