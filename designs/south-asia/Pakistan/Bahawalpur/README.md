...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 49 | €3.0 M | €147 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 46.2 km × €0.015 M/km | €0.7 M |
...
| Steady-state, low-ridership (year 8+) | **€54 M / yr** | €60 |
| Steady-state, high-ridership (year 8+) | **€50 M / yr** | €56 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.58 bn cumulative** | €1,756 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.48 bn cumulative** | €1,650 |

_Population basis: 900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€9.5 M / yr (low) → €5.3 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €325 M | 4.0% | 30 y, 7 y grace | €22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €136 M | 16.5% | 30 y, 7 y grace | €23 M / yr |
| Government equity (no debt service) | 15% | €81 M | — | — | — |
| **Total** | **100%** | **€542 M** | | | **€45 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €13 M / yr + bonds €22 M / yr = **€35 M / yr** total — plus the equity tranche amortised across construction (€12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (289 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €737 k |
...
| Farebox revenue | €4.2 M / yr | €8.3 M / yr |
| Farebox / OPEX recovery | 31% | 61% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €9.5 M / yr | €5.3 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€54 M / yr** | **€50 M / yr** |
