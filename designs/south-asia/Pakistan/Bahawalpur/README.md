...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$630 M (86.8%) of external capital** and **$789 M of external interest**. Capital plus saved interest totals **$1.42 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $141 M | 15% | $21 M | $119 M |
| Stations | $103 M | 20% | $21 M | $83 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $90 M | 35% | $31 M | $58 M |
...
| **Total city CAPEX** | **$403 M** | **23.7%** | **$95 M** | **$307 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$95 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$307 M** | **$44 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $246 M | $35 M / yr |
| **Total city programme** | **100.0%** | **$403 M** | **$58 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $544 M | $448 M (82.4%) | $562 M | **$1.01 bn** |
| **Default** | 2.00× | $725 M | $630 M (86.8%) | $789 M | **$1.42 bn** |
| High | 3.00× | $1.09 bn | $992 M (91.2%) | $1.24 bn | **$2.24 bn** |

At the default 2.00× case, OSR's $95 M external requirement is 86.8% below the illustrative foreign-company requirement of $725 M; the associated lifetime external-interest saving is $789 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$54 M / yr** | $60 |
| Steady-state, low capacity-use (year 8+) | **$23 M / yr** | $26 |
| Steady-state, high capacity-use (year 8+) | **$3.7 M / yr** | $4 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.14 bn cumulative** | $1,262 |
| Lifecycle envelope (yr 1–40, high scenario) | **$497 M cumulative** | $552 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.91 bn cumulative** | $2,120 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $95 M | 4.5% | 40 y, 7 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $246 M | 16.5% | 40 y, 7 y grace | $41 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$403 M** | | | **$46 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $3.7 M / yr | **$46 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $307 M | 76% of $403 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 38,802 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $370 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$403 M** |
| Imported / external-capital requirement | $95 M (23.7%) |
| Local-content / local-funding requirement | $307 M (76.3%) |
| Default foreign-turnkey external-capital comparison | $725 M; OSR saves $630 M (86.8%) |
| Lifetime external interest and combined financing saving | $789 M interest; $1.42 bn capital + interest |
| 15%–25% planning risk envelope | $463 M–$503 M |
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-142319 k / $-12275 k |
| Low/high project IRR | 3.6% / 7.7% |
| Low/high steady-state DSCR | 0.50 / 0.92 |
