...
|---|---|---|---|---|
| line-1 | 16.7 km | 10 | 45 | SW Outer ↔ NE Mid |
| line-2 | 14.9 km | 9 | 40 | NW Outer ↔ E Inner |
| line-3 | 13.3 km | 8 | 35 | E Outer ↔ W Inner |
| **Total** | **44.8 km** | **27 unique** | **120** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **37.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Dedicated solar plant | 37.8 MW / 227 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 135 kWh | 229 kWh | 81 kWh | 5.5 km / 44 kWh |
| line-2 | 8 | 120 kWh | 196 kWh | 64 kWh | 5.0 km / 40 kWh |
| line-3 | 8 | 107 kWh | 172 kWh | 54 kWh | 2.1 km / 17 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (42.5 km @ $3.0 M/km) | $128 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 37,768 kW @ $700/kW | $26 M |
| Grid interconnection / PPA tie-in | 37,768 kW @ $100/kW | $3.8 M |
| Annual generation proxy | 37.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 82.7 GWh/yr |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bahawalpur`.
...
| Lifecycle envelope (yr 1–40, low scenario) | **$281 M cumulative** | $312 |
| Lifecycle envelope (yr 1–40, high scenario) | **$227 M cumulative** | $252 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.01 bn cumulative** | $1,117 |

_Population basis: 900,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $24 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $401 M | 4.5% | 40 y, 7 y grace | $24 M / yr |
...
| Traction energy (98.6 GWh / yr) | 20,853 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.7 GWh/yr + dedicated solar plant 37.8 MW / 82.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $453 k |
| Labour (362 FTE) | driverless roster: OCC/remote 77, station/platform 108, passenger service 49, fleet maintenance 64, infrastructure/energy 43, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 20,853 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.2 M train-km / yr (24.7 M car-km / yr). On-site PV covers 26.7 GWh/yr and the dedicated solar plant adds 82.7 GWh/yr against 98.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 120 trainsets, 27 stations, 44.8 route-km, 3 lines, and 20,853 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 81 | 130 | 26 |
| Farebox revenue | $32 M / yr | $52 M / yr | $10 M / yr |
| Station shop leases | $650 k / yr | $650 k / yr | $650 k / yr |
...
| Operating surplus applied to debt support | -$22 M / yr | -$24 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $1.6 M / yr | $0 k / yr | **$24 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $41 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,664 m² of station shop/kiosk leases at $13/m²/month and 880 advertising boards at $115/board/month, with occupancy derates applied._
...
| Healthcare | 4 healthcare anchors | 17,245 trips/day; 6.3 M access-events/yr | 27,592 trips/day; 10.1 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 44,640 trips/trading day; 14.7 M access-events/yr | 71,424 trips/trading day; 23.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $284 M | 57% of $502 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 35,915 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $577 M–$627 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-225883 k / $-95839 k |
| Low/high project IRR | 1.9% / 5.8% |
| Low/high steady-state DSCR | 0.93 / 1.75 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,794.95 train-km; 14,475.78 kWh consumed; 14,818.07 kWh charged; 30 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 21,582.67 train-km; 174,057.59 kWh consumed; 177,403.03 kWh charged; 494 depot services completed (6 active at cutoff); minimum SoC 36%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 24.2% | 100.0% / 90% | pass |
...
| ten-hour single charging-pad outage | 20.6% | 100.0% / 90% | pass |
