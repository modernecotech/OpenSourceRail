...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$670 M (87.1%) of external capital** and **$839 M of external interest**. Capital plus saved interest totals **$1.51 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
|---|---:|---:|---:|---:|
| Civil works | $163 M | 15% | $24 M | $139 M |
...
| **Total city CAPEX** | **$427 M** | **23.2%** | **$99 M** | **$328 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.2%** | **$99 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.8%** | **$328 M** | **$47 M / yr** |
| of which planned local bond issuance | 61.4% of total CAPEX | $262 M | $37 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $576 M | $477 M (82.8%) | $598 M | **$1.08 bn** |
| **Default** | 2.00× | $769 M | $670 M (87.1%) | $839 M | **$1.51 bn** |
| High | 3.00× | $1.15 bn | $1.05 bn (91.4%) | $1.32 bn | **$2.37 bn** |

At the default 2.00× case, OSR's $99 M external requirement is 87.1% below the illustrative foreign-company requirement of $769 M; the associated lifetime external-interest saving is $839 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$57 M / yr** | $63 |
| Steady-state, low capacity-use (year 8+) | **$26 M / yr** | $29 |
| Steady-state, high capacity-use (year 8+) | **$7.1 M / yr** | $8 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $55 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.27 bn cumulative** | $1,414 |
| Lifecycle envelope (yr 1–40, high scenario) | **$633 M cumulative** | $704 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.03 bn cumulative** | $2,255 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $99 M | 4.5% | 40 y, 7 y grace | $5.8 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $262 M | 16.5% | 40 y, 7 y grace | $44 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $66 M | — | — | — |
| **Total** | **100%** | **$427 M** | | | **$49 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $26 M / yr | $7.1 M / yr | **$49 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $328 M | 77% of $427 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 41,405 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $99 M (23.2%) |
| Local-content / local-funding requirement | $328 M (76.8%) |
| Default foreign-turnkey external-capital comparison | $769 M; OSR saves $670 M (87.1%) |
| Lifetime external interest and combined financing saving | $839 M interest; $1.51 bn capital + interest |
