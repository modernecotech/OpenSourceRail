...
|---|---|---|
| Construction (years 1–7) | **$210 M / yr** | $91 |
| Steady-state, low-ridership (year 8+) | **$244 M / yr** | $106 |
| Steady-state, high-ridership (year 8+) | **$233 M / yr** | $101 |
| Steady-state, operating-neutral revenue case | **$201 M / yr** | $87 |
| Lifecycle envelope (yr 1–30, low scenario) | **$7.08 bn cumulative** | $3,077 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.83 bn cumulative** | $2,968 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$6.08 bn cumulative** | $2,643 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $43 M / yr → $32 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.45 bn | 4.0% | 30 y, 7 y grace | $98 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $605 M | 16.5% | 30 y, 7 y grace | $103 M / yr |
| Government equity (no debt service) | 15% | $363 M | — | — | — |
| **Total** | **100%** | **$2.42 bn** | | | **$201 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $58 M / yr + bonds $100 M / yr = **$158 M / yr** total — plus the equity tranche amortised across construction ($52 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 135,792 | 226,320 | 495,926 |
| Daily paid trips / catchment | 18% | 30% | 66% |
| Daily paid trips / city population | 6% | 10% | 22% |
| Annual paid trips | 49.6 M | 82.6 M | 181.0 M |
| Farebox revenue | $16 M / yr | $27 M / yr | $60 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| **Total revenue** | **$21 M / yr** | **$32 M / yr** | **$65 M / yr** |
| Revenue / OPEX recovery | 33% | 50% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $244 M / yr | $233 M / yr | **$201 M / yr** |
