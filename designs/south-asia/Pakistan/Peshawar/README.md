...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **135,792 – 199,680 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (167.1 km @ $2.0 M/km) | $334 M |
| Elevated (28.7 km @ $9.0 M/km) | $258 M |
| Elevated-interchange premium (6 sites @ $4.50 M) | $27 M |
| **Civil subtotal** | **$619 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 158 | $1.07 M | $169 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 196.7 km × $0.015 M/km | $9.8 M |
...
|---|---|---|
| Construction (years 1–7) | **$90 M / yr** | $39 |
| Steady-state, low-ridership (year 8+) | **$91 M / yr** | $40 |
| Steady-state, high-ridership (year 8+) | **$87 M / yr** | $38 |
| Steady-state, operating-neutral revenue case | **$87 M / yr** | $38 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.73 bn cumulative** | $1,187 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.62 bn cumulative** | $1,141 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.62 bn cumulative** | $1,141 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.6 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $626 M | 4.0% | 30 y, 7 y grace | $42 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $261 M | 16.5% | 30 y, 7 y grace | $44 M / yr |
| Government equity (no debt service) | 15% | $157 M | — | — | — |
| **Total** | **100%** | **$1.04 bn** | | | **$87 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $25 M / yr + bonds $43 M / yr = **$68 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 135,792 | 199,680 | 174,143 |
| Daily paid trips / catchment | 18% | 26% | 23% |
| Daily paid trips / city population | 6% | 9% | 8% |
| Annual paid trips | 49.6 M | 72.9 M | 63.6 M |
| Farebox revenue | $16 M / yr | $24 M / yr | $21 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| **Total revenue** | **$21 M / yr** | **$29 M / yr** | **$26 M / yr** |
| Revenue / OPEX recovery | 82% | 112% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $91 M / yr | $87 M / yr | **$87 M / yr** |
