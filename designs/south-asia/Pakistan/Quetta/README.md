...
|---|---|---|
| Construction (years 1–7) | **$67 M / yr** | $56 |
| Steady-state, low-ridership (year 8+) | **$64 M / yr** | $54 |
| Steady-state, high-ridership (year 8+) | **$64 M / yr** | $54 |
| Steady-state, operating-neutral revenue case | **$64 M / yr** | $54 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.95 bn cumulative** | $1,625 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.95 bn cumulative** | $1,625 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.95 bn cumulative** | $1,625 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $466 M | 4.0% | 30 y, 7 y grace | $31 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $194 M | 16.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $116 M | — | — | — |
| **Total** | **100%** | **$776 M** | | | **$64 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $19 M / yr + bonds $32 M / yr = **$51 M / yr** total — plus the equity tranche amortised across construction ($17 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 115,560 | 192,600 | 110,049 |
| Daily paid trips / catchment | 18% | 30% | 17% |
| Daily paid trips / city population | 10% | 16% | 9% |
| Annual paid trips | 42.2 M | 70.3 M | 40.2 M |
| Farebox revenue | $14 M / yr | $23 M / yr | $13 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$20 M / yr** | **$29 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 104% | 153% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $64 M / yr | $64 M / yr | **$64 M / yr** |
| Operating surplus after OPEX | $664 k / yr | $9.9 M / yr | $0 / yr |
