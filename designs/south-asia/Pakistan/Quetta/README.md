...
|---|---|---|
| Construction (years 1–7) | **$165 M / yr** | $137 |
| Steady-state, low-ridership (year 8+) | **$188 M / yr** | $157 |
| Steady-state, high-ridership (year 8+) | **$179 M / yr** | $149 |
| Steady-state, operating-neutral revenue case | **$158 M / yr** | $131 |
| Lifecycle envelope (yr 1–30, low scenario) | **$5.48 bn cumulative** | $4,565 |
| Lifecycle envelope (yr 1–30, high scenario) | **$5.26 bn cumulative** | $4,387 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.78 bn cumulative** | $3,984 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $30 M / yr → $21 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.14 bn | 4.0% | 30 y, 7 y grace | $77 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $475 M | 16.5% | 30 y, 7 y grace | $81 M / yr |
| Government equity (no debt service) | 15% | $285 M | — | — | — |
| **Total** | **100%** | **$1.90 bn** | | | **$158 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $46 M / yr + bonds $78 M / yr = **$124 M / yr** total — plus the equity tranche amortised across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 115,560 | 192,600 | 367,136 |
| Daily paid trips / catchment | 18% | 30% | 57% |
| Daily paid trips / city population | 10% | 16% | 31% |
| Annual paid trips | 42.2 M | 70.3 M | 134.0 M |
| Farebox revenue | $14 M / yr | $23 M / yr | $44 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$20 M / yr** | **$29 M / yr** | **$50 M / yr** |
| Revenue / OPEX recovery | 39% | 58% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $188 M / yr | $179 M / yr | **$158 M / yr** |
