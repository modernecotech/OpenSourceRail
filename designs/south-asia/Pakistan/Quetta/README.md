...
| Revenue fleet passenger capacity | 79,680 AW2 pax (106,240 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 25.4 km | 15 | 58 | SW Outer ↔ N Mid |
| line-2 | 26.7 km | 17 | 60 | S Mid ↔ NE Outer |
| line-3 | 15.4 km | 10 | 37 | SW Mid ↔ N Mid |
| line-4 | 53.1 km | 38 | 30 | NW Mid ↔ NW Mid |
| **Total** | **120.7 km** | **80 unique** | **185** | |
...
| Revenue fleet capacity | 79,680 AW2 pax (106,240 AW3 crush) |
| Total fleet capacity | 88,800 AW2 pax (118,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 166 × 480 = **79,680 AW2 passengers** (106,240 AW3 crush)
- **Total fleet passenger capacity:** 185 × 480 = **88,800 AW2 passengers** (118,400 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **108.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 377 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 582 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 108.0 MW / 669 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 244 kWh | 784 kWh | 515 kWh | 2.2 km / 21 kWh |
| line-2 | 15 | 257 kWh | 808 kWh | 526 kWh | 8.0 km / 77 kWh |
| line-3 | 10 | 148 kWh | 539 kWh | 377 kWh | 2.4 km / 23 kWh |
| line-4 | 38 | 510 kWh | 1,862 kWh | 1,301 kWh | 2.8 km / 27 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (111.0 km @ $3.0 M/km) | $333 M |
| Elevated (9.7 km @ $12.0 M/km) | $116 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$485 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 185 | $1.12 M | $207 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 740 | $60 k | $44 M |
| High sensitivity check | 740 | $120 k | $89 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 107,955 kW @ $700/kW | $76 M |
| Grid interconnection / PPA tie-in | 107,955 kW @ $100/kW | $11 M |
| Annual generation proxy | 108.0 MW × 6.2 peak-sun-h/day × 365 d/yr | 244.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$86 M** |
...
| Depots | $8.0 M |
| Rolling stock | $207 M |
| Railway production plant | $44 M |
| Dedicated solar power plant | $86 M |
| Residual train-control wayside + charging microgrids | $32 M |
| EPC overhead (7%) | $91 M |
| **CAPEX total** | **$1.48 bn** |
| Per-route-km | $12 M / km |
| Per-capita (city pop) | $1,231 / person |
...
|---|---|---|
| Construction (years 1–7) | **$95 M / yr** | $79 |
| Steady-state, low capacity-use (year 8+) | **$46 M / yr** | $38 |
| Steady-state, high capacity-use (year 8+) | **$16 M / yr** | $13 |
| Steady-state, operating-neutral revenue case | **$69 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.18 bn cumulative** | $1,817 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.19 bn cumulative** | $989 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.96 bn cumulative** | $2,465 |

_Population basis: 1,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $24 M / yr → $54 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.18 bn | 4.5% | 40 y, 7 y grace | $69 M / yr |
| Government equity (no debt service) | 20% | $295 M | — | — | — |
| **Total** | **100%** | **$1.48 bn** | | | **$69 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $53 M / yr = **$53 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($42 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (276.0 GWh / yr) | 43,764 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 63.6 GWh/yr + dedicated solar plant 108.0 MW / 244.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.3 M |
| Labour (805 FTE) | driverless roster: OCC/remote 110, station/platform 375, passenger service 72, fleet maintenance 114, infrastructure/energy 111, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $2.2 M |
| **OPEX subtotal** | | **$32 M / yr** |

_Annual service work: 43,764 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 17.3 M train-km / yr (69.0 M car-km / yr). On-site PV covers 63.6 GWh/yr and the dedicated solar plant adds 244.3 GWh/yr against 276.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 185 trainsets, 80 stations, 120.7 route-km, 4 lines, and 43,764 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 114.1 M | 182.5 M | 60.5 M |
| Annual paid trips / city resident | 95 | 152 | 50 |
| Farebox revenue | $50 M / yr | $80 M / yr | $27 M / yr |
| Station shop leases | $2.3 M / yr | $2.3 M / yr | $2.3 M / yr |
| Advertising boards | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| **Total revenue** | **$56 M / yr** | **$86 M / yr** | **$32 M / yr** |
| Revenue / OPEX recovery | 173% | 266% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $69 M / yr | $69 M / yr | **$69 M / yr** |
| Operating surplus applied to debt support | -$24 M / yr | -$54 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $46 M / yr | $16 M / yr | **$69 M / yr** |
| Operating surplus after OPEX (before debt support) | $24 M / yr | $54 M / yr | $0 / yr |

_Commercial-revenue assumptions: 16,576 m² of station shop/kiosk leases at $13/m²/month and 2,972 advertising boards at $115/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 2 education anchors | 15,567 trips/school day; 3.4 M access-events/yr | 24,907 trips/school day; 5.5 M access-events/yr |
| Healthcare | 6 healthcare anchors | 25,907 trips/day; 9.5 M access-events/yr | 41,452 trips/day; 15.1 M access-events/yr |
| Commerce | 39 major/terminal/interchange nodes | 65,992 trips/trading day; 21.8 M access-events/yr | 105,587 trips/trading day; 34.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $849 M | 57% of $1.48 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.36 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $194 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 107,210 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $86 M |
| **Reconciled project CAPEX** | **$1.48 bn** |
| 15%–25% planning risk envelope | $1.70 bn–$1.85 bn |
| Annual OPEX | $32 M / yr |
| Low/high project NPV at 8% | $-940051 k / $-737761 k |
| Low/high project IRR | -3.0% / 0.9% |
| Low/high steady-state DSCR | 0.34 / 0.77 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,025.58 train-km; 29,044.54 kWh consumed; 32,867.10 kWh charged; 24 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 43,554.44 train-km; 418,108.45 kWh consumed; 425,963.51 kWh charged; 657 depot services completed (6 active at cutoff); minimum SoC 86%; 0 onboard emergencies; 0 invariant violations; 99.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 84.4% | 99.5% / 90% | pass |
| maximum planning climate/HVAC duty | 85.4% | 99.5% / 90% | pass |
| 50% charging-contact availability | 86.5% | 99.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 98.3% / 60% | pass |
| ten-hour single charging-pad outage | 86.5% | 99.5% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 4 corridors, 80 line platforms, 8 interchange complexes, 22 civil segments, and 0 input findings |
