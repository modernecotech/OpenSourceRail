...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **115,560 – 192,600 trips/day**
...
| Elevated (10.0 km @ $9.0 M/km) | $90 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$515 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 140.1 km × $0.015 M/km | $7.0 M |
...
| Per-capita (city pop) | $762 / person |
...
|---|---|---|
| Construction (years 1–7) | **$79 M / yr** | $66 |
| Steady-state, low-ridership (year 8+) | **$78 M / yr** | $65 |
| Steady-state, high-ridership (year 8+) | **$76 M / yr** | $63 |
| Steady-state, operating-neutral revenue case | **$76 M / yr** | $63 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.34 bn cumulative** | $1,953 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.30 bn cumulative** | $1,916 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.30 bn cumulative** | $1,916 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.9 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $549 M | 4.0% | 30 y, 7 y grace | $37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $229 M | 16.5% | 30 y, 7 y grace | $39 M / yr |
| Government equity (no debt service) | 15% | $137 M | — | — | — |
| **Total** | **100%** | **$915 M** | | | **$76 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $22 M / yr + bonds $38 M / yr = **$60 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 115,560 | 192,600 | 131,571 |
| Daily paid trips / catchment | 18% | 30% | 20% |
| Daily paid trips / city population | 10% | 16% | 11% |
| Annual paid trips | 42.2 M | 70.3 M | 48.0 M |
| Farebox revenue | $14 M / yr | $23 M / yr | $16 M / yr |
| Station shop leases | $2.2 M / yr | $2.2 M / yr | $2.2 M / yr |
| Advertising boards | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| **Total revenue** | **$20 M / yr** | **$29 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 91% | 134% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $78 M / yr | $76 M / yr | **$76 M / yr** |
