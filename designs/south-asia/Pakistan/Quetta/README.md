...
| Bucket | Value |
|---|---|
| At-grade (129.6 km @ €3.5 M/km) | €454 M |
| Elevated (10.0 km @ €18 M/km) | €181 M |
| Elevated-interchange premium (8 sites @ €20 M) | €160 M |
| **Civil subtotal** | **€794 M** |
...
| Per-capita (city pop) | €1,407 / person |
...
|---|---|---|
| Construction (years 1–7) | **€146 M / yr** | €122 |
| Steady-state, low-ridership (year 8+) | **€177 M / yr** | €148 |
| Steady-state, high-ridership (year 8+) | **€172 M / yr** | €143 |
| Lifecycle envelope (yr 1–30, low scenario) | **€5.10 bn cumulative** | €4,249 |
| Lifecycle envelope (yr 1–30, high scenario) | **€4.97 bn cumulative** | €4,142 |

_Population basis: 1,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€37 M / yr (low) → €32 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.01 bn | 4.0% | 30 y, 7 y grace | €68 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €422 M | 16.5% | 30 y, 7 y grace | €72 M / yr |
| Government equity (no debt service) | 15% | €253 M | — | — | — |
| **Total** | **100%** | **€1.69 bn** | | | **€140 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €41 M / yr + bonds €70 M / yr = **€110 M / yr** total — plus the equity tranche amortised across construction (€36 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (853 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €2.2 M |
...
| Farebox revenue | €5.5 M / yr | €11 M / yr |
| Farebox / OPEX recovery | 13% | 26% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €37 M / yr | €32 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€177 M / yr** | **€172 M / yr** |
