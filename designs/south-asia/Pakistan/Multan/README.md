...
| Bucket | Value |
|---|---|
| At-grade (109.4 km @ $1.2 M/km) | $131 M |
| Elevated (5.5 km @ $5.5 M/km) | $30 M |
...
| Per-capita (city pop) | $179 / person |
...
|---|---|---|
| Construction (years 1–7) | **$34 M / yr** | $16 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $8 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$657 M cumulative** | $299 |
| Lifecycle envelope (yr 1–30, high scenario) | **$239 M cumulative** | $109 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$239 M cumulative** | $109 |

_Population basis: 2,197,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $237 M | 4.0% | 30 y, 7 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $99 M | 16.5% | 30 y, 7 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $59 M | — | — | — |
| **Total** | **100%** | **$394 M** | | | **$33 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $9.5 M / yr + bonds $16 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($8.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
