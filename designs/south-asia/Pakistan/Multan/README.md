...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **196.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 152 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,007 MWh/day | 58,265 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 855 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 196.7 MW / 984 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 196,723 kW @ $700/kW | $138 M |
| Grid interconnection / PPA tie-in | 196,723 kW @ $100/kW | $20 M |
| Annual generation proxy | 196.7 MW × 5.0 peak-sun-h/day × 365 d/yr | 359.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$157 M** |
...
| Dedicated solar power plant | $157 M |
...
|---|---|---|
| Construction (years 1–7) | **$91 M / yr** | $41 |
| Steady-state, low capacity-use (year 8+) | **$70 M / yr** | $32 |
| Steady-state, high capacity-use (year 8+) | **$40 M / yr** | $18 |
| Steady-state, operating-neutral revenue case | **$68 M / yr** | $31 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.95 bn cumulative** | $1,342 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.97 bn cumulative** | $897 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.89 bn cumulative** | $1,315 |

_Population basis: 2,197,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.8 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $28 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $1.64 bn | 2.0% | 40 y, 7 y grace | $68 M / yr |
| Government equity (no debt service) | 20% | $409 M | — | — | — |
| **Total** | **100%** | **$2.05 bn** | | | **$68 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $33 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($58 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (367.5 GWh / yr) | 58,265 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 55.3 GWh/yr + dedicated solar plant 196.7 MW / 359.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.4 M |
| Labour (729 FTE) | driverless roster: OCC/remote 98, station/platform 276, passenger service 71, fleet maintenance 124, infrastructure/energy 122, admin/training 38; no train drivers × country median × 12 × engineer-premium 1.4 | $2.0 M |
| **OPEX subtotal** | | **$56 M / yr** |

_Annual service work: 58,265 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 23.0 M train-km / yr (91.9 M car-km / yr). On-site PV covers 55.3 GWh/yr and the dedicated solar plant adds 359.0 GWh/yr against 367.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 112.1 M | 179.4 M | 116.2 M |
| Annual paid trips / city resident | 51 | 82 | 53 |
| Farebox revenue | $49 M / yr | $79 M / yr | $51 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$54 M / yr** | **$83 M / yr** | **$56 M / yr** |
| Revenue / OPEX recovery | 97% | 150% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $70 M / yr | $68 M / yr | **$68 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$28 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $70 M / yr | $40 M / yr | **$68 M / yr** |
...
| **Annual quantified benefit / activity proxy** | **$127 M / yr** | **$203 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 18 education anchors | 27,218 trips/school day; 6.0 M access-events/yr | 43,549 trips/school day; 9.6 M access-events/yr |
| Healthcare | 6 healthcare anchors | 22,303 trips/day; 8.1 M access-events/yr | 35,684 trips/day; 13.0 M access-events/yr |
| Commerce | 49 major/terminal/interchange nodes | 74,240 trips/trading day; 24.5 M access-events/yr | 118,784 trips/trading day; 39.2 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 32,939 trips/activity day; 9.9 M access-events/yr | 52,702 trips/activity day; 15.8 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.06 bn | 52% of $2.05 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.70 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $243 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 134,410 job-years | retained CAPEX ÷ (4.0 × median annual income) |
