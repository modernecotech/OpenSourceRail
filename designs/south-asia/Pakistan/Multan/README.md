...
|---|---|---|
| Construction (years 1–7) | **$83 M / yr** | $38 |
| Steady-state, low capacity-use (year 8+) | **$20 M / yr** | $9 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$61 M / yr** | $28 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.25 bn cumulative** | $569 |
| Lifecycle envelope (yr 1–40, high scenario) | **$584 M cumulative** | $266 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.59 bn cumulative** | $1,178 |

_Population basis: 2,197,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $41 M / yr → $61 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.03 bn | 4.5% | 40 y, 7 y grace | $61 M / yr |
| Government equity (no debt service) | 20% | $258 M | — | — | — |
| **Total** | **100%** | **$1.29 bn** | | | **$61 M / yr** |
...
| Operating surplus applied to debt support | -$41 M / yr | -$61 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $20 M / yr | $0 k / yr | **$61 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $745 M | 58% of $1.29 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.19 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $170 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 94,095 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| 15%–25% planning risk envelope | $1.49 bn–$1.62 bn |
| Annual OPEX | $28 M / yr |
| Low/high project NPV at 8% | $-688630 k / $-428542 k |
| Low/high project IRR | 0.2% / 3.9% |
| Low/high steady-state DSCR | 0.67 / 1.31 |
