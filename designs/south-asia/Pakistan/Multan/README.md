...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **91,834 – 137,751 trips/day**
...
Aggregate station-rail charging power: **27,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 460 kWh battery covers running.
...
| Bucket | Value |
|---|---|
| At-grade (109.4 km @ €3.5 M/km) | €383 M |
| Elevated (5.5 km @ €18 M/km) | €99 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 98 | €3.0 M | €294 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 115.4 km × €0.1 M/km | €11 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 115.4 km × €0.8 M/km | €92 M |
...
| Depots | €40 M |
| Rolling stock | €294 M |
| Signalling + power | €103 M |
| EPC overhead (7%) | €84 M |
| **CAPEX total** | **€1.29 bn** |
| Per-route-km | €11 M / km |
| Per-capita (city pop) | €586 / person |
...
|---|---|---|
| Construction (years 1–7) | **€112 M / yr** | €51 |
| Steady-state, low-ridership (year 8+) | **€127 M / yr** | €58 |
| Steady-state, high-ridership (year 8+) | **€117 M / yr** | €53 |
| Lifecycle envelope (yr 1–30, low scenario) | **€3.70 bn cumulative** | €1,683 |
| Lifecycle envelope (yr 1–30, high scenario) | **€3.46 bn cumulative** | €1,577 |

_Population basis: 2,197,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€20 M / yr (low) → €10.0 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €772 M | 4.0% | 30 y, 7 y grace | €52 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €322 M | 16.5% | 30 y, 7 y grace | €55 M / yr |
| Government equity (no debt service) | 15% | €193 M | — | — | — |
| **Total** | **100%** | **€1.29 bn** | | | **€107 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €31 M / yr + bonds €53 M / yr = **€84 M / yr** total — plus the equity tranche amortised across construction (€28 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €575 k |
| Traction energy (273.4 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (704 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.8 M |
...
|---|---|---|
| Annual paid trips | 40.1 M | 80.2 M |
| Farebox revenue | €10 M / yr | €20 M / yr |
| Farebox / OPEX recovery | 34% | 67% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €20 M / yr | €10.0 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€127 M / yr** | **€117 M / yr** |
