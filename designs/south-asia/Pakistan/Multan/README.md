...
|---|---|---|---|---|
| line-1 | 18.2 km | 13 | 45 | NE Outer ↔ SW Outer |
| line-2 | 20.0 km | 13 | 47 | NE Outer ↔ SW Outer |
| line-3 | 18.8 km | 13 | 46 | S Mid ↔ N Outer |
| line-4 | 19.7 km | 13 | 46 | W Mid ↔ E Outer |
| line-5 | 41.9 km | 31 | 25 | N Outer ↔ N Outer |
| **Total** | **118.6 km** | **83 unique** | **209** | |
...
| Total fleet capacity | 100,320 AW2 pax (133,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 186 × 480 = **89,280 AW2 passengers** (119,040 AW3 crush)
- **Total fleet passenger capacity:** 209 × 480 = **100,320 AW2 passengers** (133,760 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 45 | 300 kW | 1500 kWh |
| Major | 9 | 300 kW | 1500 kWh |
| Standard | 19 | 300 kW | 1500 kWh |
| Terminal | 7 | 300 kW | 1500 kWh |
| **Total installed** | **81** | **29,000 kW** | **160,000 kWh** |

Aggregate station-rail charging power: **121,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **105.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.9× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 648 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 396 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 188 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 596 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 105.4 MW / 685 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 160 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 202 kWh | 686 kWh | 464 kWh | 2.1 km / 23 kWh |
| line-2 | 13 | 222 kWh | 710 kWh | 466 kWh | 3.4 km / 38 kWh |
| line-3 | 13 | 210 kWh | 686 kWh | 455 kWh | 2.1 km / 23 kWh |
| line-4 | 12 | 219 kWh | 637 kWh | 396 kWh | 6.5 km / 72 kWh |
| line-5 | 30 | 467 kWh | 1,470 kWh | 956 kWh | 3.6 km / 40 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (106.8 km @ $3.0 M/km) | $320 M |
| Elevated (11.7 km @ $12.0 M/km) | $141 M |
| Elevated-interchange premium (11 sites @ $4.50 M) | $50 M |
| **Civil subtotal** | **$511 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 209 | $1.12 M | $234 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 836 | $60 k | $50 M |
| High sensitivity check | 836 | $120 k | $100 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 105,382 kW @ $700/kW | $74 M |
| Grid interconnection / PPA tie-in | 105,382 kW @ $100/kW | $11 M |
| Annual generation proxy | 105.4 MW × 6.5 peak-sun-h/day × 365 d/yr | 250.0 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$109 M / yr** | $50 |
| Steady-state, low capacity-use (year 8+) | **$45 M / yr** | $20 |
| Steady-state, high capacity-use (year 8+) | **$6.0 M / yr** | $3 |
| Steady-state, operating-neutral revenue case | **$80 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.24 bn cumulative** | $1,020 |
| Lifecycle envelope (yr 1–40, high scenario) | **$963 M cumulative** | $438 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.39 bn cumulative** | $1,543 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.35 bn | 4.5% | 40 y, 7 y grace | $80 M / yr |
| Government equity (no debt service) | 20% | $338 M | — | — | — |
| **Total** | **100%** | **$1.69 bn** | | | **$80 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $61 M / yr = **$61 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($48 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (286.2 GWh / yr) | 45,378 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 68.8 GWh/yr + dedicated solar plant 105.4 MW / 250.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.3 M |
| Labour (953 FTE) | driverless roster: OCC/remote 126, station/platform 476, passenger service 92, fleet maintenance 123, infrastructure/energy 111, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $2.6 M |
| **OPEX subtotal** | | **$37 M / yr** |

_Annual service work: 45,378 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 17.9 M train-km / yr (71.6 M car-km / yr). On-site PV covers 68.8 GWh/yr and the dedicated solar plant adds 250.0 GWh/yr against 286.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 209 trainsets, 83 stations, 118.6 route-km, 5 lines, and 45,378 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
Planning revenue is capacity-led: annual paid trips are calculated from practical daily service capacity (803,520 trips/day) × 365 service-days × capacity utilisation. The low/high bracket uses 50%–80% of that practical capacity. The operating-neutral column solves the capacity utilisation needed so **farebox + station-shop leases + advertising = steady-state OPEX**. Gross post-grace repayable-debt service remains visible in the CAPEX funding stack, while any operating surplus is netted from the budgetable government support line.

| | Low scenario | High scenario | Operating-neutral target |
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 23% |
| Annual paid trips | 146.6 M | 234.6 M | 67.5 M |
| Annual paid trips / city resident | 67 | 107 | 31 |
...
| **Total revenue** | **$72 M / yr** | **$111 M / yr** | **$37 M / yr** |
| Revenue / OPEX recovery | 193% | 297% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $45 M / yr | $6.0 M / yr | **$80 M / yr** |
| Operating surplus after OPEX (before debt support) | $35 M / yr | $74 M / yr | $0 / yr |

_Commercial-revenue assumptions: 21,928 m² of station shop/kiosk leases at $13/m²/month and 3,824 advertising boards at $115/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $52 M / yr | $84 M / yr | 24% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 24 education anchors | 40,288 trips/school day; 8.9 M access-events/yr | 64,461 trips/school day; 14.2 M access-events/yr |
| Healthcare | 7 healthcare anchors | 29,599 trips/day; 10.8 M access-events/yr | 47,359 trips/day; 17.3 M access-events/yr |
| Commerce | 62 major/terminal/interchange nodes | 95,793 trips/trading day; 31.6 M access-events/yr | 153,269 trips/trading day; 50.6 M access-events/yr |
| Entertainment / community | 20.5 h/day service span | 42,645 trips/activity day; 12.8 M access-events/yr | 68,231 trips/activity day; 20.5 M access-events/yr |

### Local recirculation of initial CAPEX

| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $976 M | 58% of $1.69 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.56 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $223 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 123,258 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $37 M / yr |
| Low/high project NPV at 8% | $-1024711 k / $-764623 k |
| Low/high project IRR | -1.8% / 1.9% |
| Low/high steady-state DSCR | 0.44 / 0.92 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,443.88 train-km; 38,351.48 kWh consumed; 42,979.41 kWh charged; 36 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 45,357.66 train-km; 505,108.02 kWh consumed; 513,971.34 kWh charged; 826 depot services completed (8 active at cutoff); minimum SoC 87%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 84.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 86.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 87.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 83 line platforms, 11 interchange complexes, 24 civil segments, and 0 input findings |
