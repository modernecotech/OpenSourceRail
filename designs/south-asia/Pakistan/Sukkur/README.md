...
|---|---|---|
| Construction (years 1–7) | **$43 M / yr** | $71 |
| Steady-state, low-ridership (year 8+) | **$43 M / yr** | $71 |
| Steady-state, high-ridership (year 8+) | **$41 M / yr** | $68 |
| Steady-state, operating-neutral revenue case | **$41 M / yr** | $68 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.28 bn cumulative** | $2,132 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.24 bn cumulative** | $2,063 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.24 bn cumulative** | $2,063 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $295 M | 4.0% | 30 y, 7 y grace | $20 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $123 M | 16.5% | 30 y, 7 y grace | $21 M / yr |
| Government equity (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$492 M** | | | **$41 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $20 M / yr = **$32 M / yr** total — plus the equity tranche amortised across construction ($11 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 59,508 | 99,180 | 74,470 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 10% | 17% | 12% |
| Annual paid trips | 21.7 M | 36.2 M | 27.2 M |
| Farebox revenue | $7.2 M / yr | $12 M / yr | $9.0 M / yr |
...
| Revenue / OPEX recovery | 83% | 128% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $43 M / yr | $41 M / yr | **$41 M / yr** |
