...
| Steady-state, low capacity-use (year 8+) | **$9.5 M / yr** | $16 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$592 M cumulative** | $987 |
| Lifecycle envelope (yr 1–40, high scenario) | **$280 M cumulative** | $466 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.24 bn cumulative** | $2,065 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $495 M | 4.5% | 40 y, 7 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $124 M | — | — | — |
| **Total** | **100%** | **$619 M** | | | **$29 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $9.5 M / yr | $0 k / yr | **$29 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $367 M | 59% of $619 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 46,354 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $587 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$619 M** |
| 15%–25% planning risk envelope | $712 M–$773 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-328416 k / $-198373 k |
| Low/high project IRR | 0.2% / 4.1% |
| Low/high steady-state DSCR | 0.67 / 1.34 |
