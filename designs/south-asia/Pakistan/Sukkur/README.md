...
| Bucket | Value |
|---|---|
| At-grade (19.9 km @ €3.5 M/km) | €70 M |
| Elevated (31.0 km @ €18 M/km) | €558 M |
| **Civil subtotal** | **€628 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.1 km × €0.015 M/km | €0.8 M |
...
|---|---|---|
| Construction (years 1–7) | **€85 M / yr** | €141 |
| Steady-state, low-ridership (year 8+) | **€100 M / yr** | €167 |
| Steady-state, high-ridership (year 8+) | **€98 M / yr** | €163 |
| Lifecycle envelope (yr 1–30, low scenario) | **€2.90 bn cumulative** | €4,841 |
| Lifecycle envelope (yr 1–30, high scenario) | **€2.84 bn cumulative** | €4,735 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €587 M | 4.0% | 30 y, 7 y grace | €40 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €245 M | 16.5% | 30 y, 7 y grace | €42 M / yr |
| Government equity (no debt service) | 15% | €147 M | — | — | — |
| **Total** | **100%** | **€979 M** | | | **€81 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €23 M / yr + bonds €40 M / yr = **€64 M / yr** total — plus the equity tranche amortised across construction (€21 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (319 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €814 k |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€100 M / yr** | **€98 M / yr** |
