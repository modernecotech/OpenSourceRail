...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$842 M (88.4%) of external capital** and **$1.06 bn of external interest**. Capital plus saved interest totals **$1.90 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 43.7 km |
...
- Anchor-weighted coverage: 71.5%
- Catchment population: **≈ 429,000** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **39.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 9.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 484 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Scheduled train journey-km | 20,331 train-km/day | One-way train journeys × route length |
| Annual service work | 8.0 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 263 MWh/day | 24.0 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 208 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 39.9 MW / 240 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 165 kWh | 229 kWh | 47 kWh | 6.9 km / 56 kWh |
| line-2 | 4 | 97 kWh | 147 kWh | 40 kWh | 6.9 km / 55 kWh |
| line-3 | 4 | 91 kWh | 131 kWh | 31 kWh | 4.7 km / 38 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (17.3 km @ $2.58 M/km) | $45 M |
| Elevated (26.4 km @ $9.75 M/km) | $257 M |
| **Civil subtotal** | **$302 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,923 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,923 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 39.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 87.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 43.7 km × $0.050 M/km | $2.2 M |
...
| Per-capita (city pop) | $883 / person |
...
| **Total city CAPEX** | **$530 M** | **21.0%** | **$111 M** | **$419 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh sukkur`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.0%** | **$111 M** | **$16 M / yr** |
| **Local capital for domestic procurement / payroll** | **79.0%** | **$419 M** | **$60 M / yr** |
| of which planned local bond issuance | 63.2% of total CAPEX | $335 M | $48 M / yr |
| **Total city programme** | **100.0%** | **$530 M** | **$76 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $715 M | $604 M (84.5%) | $757 M | **$1.36 bn** |
| **Default** | 2.00× | $953 M | $842 M (88.4%) | $1.06 bn | **$1.90 bn** |
| High | 3.00× | $1.43 bn | $1.32 bn (92.2%) | $1.65 bn | **$2.97 bn** |

At the default 2.00× case, OSR's $111 M external requirement is 88.4% below the illustrative foreign-company requirement of $953 M; the associated lifetime external-interest saving is $1.06 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$72 M / yr** | $120 |
| Steady-state, low capacity-use (year 8+) | **$41 M / yr** | $69 |
| Steady-state, high capacity-use (year 8+) | **$22 M / yr** | $36 |
| Steady-state, operating-neutral revenue case | **$62 M / yr** | $104 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.87 bn cumulative** | $3,109 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.23 bn cumulative** | $2,044 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.56 bn cumulative** | $4,261 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $21 M / yr → $40 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 21% | $111 M | 4.5% | 40 y, 7 y grace | $6.5 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $335 M | 16.5% | 40 y, 7 y grace | $56 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $84 M | — | — | — |
| **Total** | **100%** | **$530 M** | | | **$62 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.0 M / yr + local bonds $55 M / yr = **$60 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (96.2 GWh / yr) | 20,331 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.1 GWh/yr + dedicated solar plant 39.9 MW / 87.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $479 k |
| Labour (293 FTE) | driverless roster: OCC/remote 65, station/platform 65, passenger service 49, fleet maintenance 55, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $812 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 20,331 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.0 M train-km / yr (24.0 M car-km / yr). On-site PV covers 20.1 GWh/yr and the dedicated solar plant adds 87.4 GWh/yr against 96.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 92 trainsets, 15 stations, 43.7 route-km, 3 lines, and 20,331 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 25.7 M |
| Annual paid trips / city resident | 122 | 196 | 43 |
| Farebox revenue | $32 M / yr | $52 M / yr | $11 M / yr |
| Station shop leases | $369 k / yr | $369 k / yr | $369 k / yr |
| Advertising boards | $603 k / yr | $603 k / yr | $603 k / yr |
| **Total revenue** | **$33 M / yr** | **$53 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 271% | 428% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $62 M / yr | $62 M / yr | **$62 M / yr** |
| Operating surplus applied to debt support | -$21 M / yr | -$40 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $41 M / yr | $22 M / yr | **$62 M / yr** |
| Operating surplus after OPEX (before debt support) | $21 M / yr | $40 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,648 m² of station shop/kiosk leases at $13/m²/month and 512 advertising boards at $115/board/month, with occupancy derates applied._
...
| Avoided road congestion | $12 M / yr | $18 M / yr | 144 M - 231 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.1 M / yr | $3.3 M / yr | 26.0–41.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $5.8 M / yr | $9.2 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $419 M | 79% of $530 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $670 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $96 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 52,868 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $498 M |
| Timetable-sized dedicated solar CAPEX | $32 M |
| **Reconciled project CAPEX** | **$530 M** |
| Imported / external-capital requirement | $111 M (21.0%) |
| Local-content / local-funding requirement | $419 M (79.0%) |
| Default foreign-turnkey external-capital comparison | $953 M; OSR saves $842 M (88.4%) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-253240 k / $-123196 k |
| Low/high project IRR | 1.4% / 5.3% |
| Low/high steady-state DSCR | 0.34 / 0.65 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,714.56 train-km; 13,827.64 kWh consumed; 12,129.56 kWh charged; 34 depot services completed; minimum SoC 68%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,655.94 train-km; 150,454.27 kWh consumed; 146,041.50 kWh charged; 477 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 91.8% of scheduled train-km delivered; 33 SoC warnings; 4 energy-adapted off-peak departures, maximum 15 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 91.9% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.4% / 90% | pass |
| 50% charging-contact availability | 20.0% | 91.8% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 81.1% / 60% | pass |
...
|---|---|
| ![Sukkur energy and battery simulation dashboard](engineering/screenshots/sukkur-simulation-dashboard.png) | ![Sukkur simulator network visualizer](engineering/screenshots/sukkur-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 15 line platforms, 1 interchange complexes, 15 civil segments, and 0 input findings |
...
|---|---|
| ![Sukkur QGIS engineering layers](engineering/screenshots/sukkur-qgis-engineering-map.png) | ![Sukkur SUMO timetable validation](engineering/screenshots/sukkur-sumo-validation.png) |
...
scripts/regenerate-city.sh sukkur
```
