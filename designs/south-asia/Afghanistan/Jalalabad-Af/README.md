...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **24,219 – 36,329 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (48.4 km @ $1.2 M/km) | $58 M |
| Elevated (1.4 km @ $5.5 M/km) | $7.9 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 50.8 km × $0.015 M/km | $761 k |
...
| Steady-state, high-ridership (year 11+) | **$14 M / yr** | $41 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$538 M cumulative** | $1,537 |
| Lifecycle envelope (yr 1–35, high scenario) | **$505 M cumulative** | $1,442 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$145 M cumulative** | $414 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.4 M / yr → $50 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $100 M | 4.5% | 35 y, 10 y grace | $6.7 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $42 M | 18.0% | 35 y, 10 y grace | $7.6 M / yr |
| Government equity (no debt service) | 15% | $25 M | — | — | — |
| **Total** | **100%** | **$166 M** | | | **$14 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $4.5 M / yr + bonds $7.5 M / yr = **$12 M / yr** total — plus the equity tranche amortised across construction ($2.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,000 | 52,500 | 315,380 |
| Daily paid trips / population | 8% | 15% | 90% |
| Annual paid trips | 10.2 M | 19.2 M | 115.1 M |
| Farebox revenue | $1.5 M / yr | $2.9 M / yr | $17 M / yr |
| Station shop leases | $551 k / yr | $551 k / yr | $551 k / yr |
| Advertising boards | $759 k / yr | $759 k / yr | $759 k / yr |
| **Total revenue** | **$2.8 M / yr** | **$4.2 M / yr** | **$19 M / yr** |
| Revenue / OPEX + debt-service recovery | 15% | 23% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $16 M / yr | $14 M / yr | **$0 / yr** |
