...
| Bucket | Value |
|---|---|
| At-grade (48.4 km @ €3.5 M/km) | €169 M |
| Elevated (1.4 km @ €18 M/km) | €26 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 50.8 km × €0.015 M/km | €0.7 M |
...
| Per-capita (city pop) | €1,551 / person |
...
|---|---|---|
| Construction (years 1–10) | **€47 M / yr** | €135 |
| Steady-state, low-ridership (year 11+) | **€60 M / yr** | €170 |
| Steady-state, high-ridership (year 11+) | **€59 M / yr** | €168 |
| Lifecycle envelope (yr 1–35, low scenario) | **€1.96 bn cumulative** | €5,602 |
| Lifecycle envelope (yr 1–35, high scenario) | **€1.94 bn cumulative** | €5,550 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €326 M | 4.5% | 35 y, 10 y grace | €22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €136 M | 18.0% | 35 y, 10 y grace | €25 M / yr |
| Government equity (no debt service) | 15% | €81 M | — | — | — |
| **Total** | **100%** | **€543 M** | | | **€47 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €24 M / yr = **€39 M / yr** total — plus the equity tranche amortised across construction (€8.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (317 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €367 k |
...
| Farebox revenue | €735 k / yr | €1.5 M / yr |
