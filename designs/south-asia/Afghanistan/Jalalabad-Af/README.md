...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **43,595 – 72,659 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (48.4 km @ $2.0 M/km) | $97 M |
| Elevated (1.4 km @ $9.0 M/km) | $13 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 50.8 km × $0.015 M/km | $2.5 M |
...
|---|---|---|
| Construction (years 1–10) | **$22 M / yr** | $64 |
| Steady-state, low-ridership (year 11+) | **$24 M / yr** | $68 |
| Steady-state, high-ridership (year 11+) | **$22 M / yr** | $62 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$814 M cumulative** | $2,325 |
| Lifecycle envelope (yr 1–35, high scenario) | **$766 M cumulative** | $2,188 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$222 M cumulative** | $635 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.6 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $153 M | 4.5% | 35 y, 10 y grace | $10 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $64 M | 18.0% | 35 y, 10 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $38 M | — | — | — |
| **Total** | **100%** | **$255 M** | | | **$22 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.9 M / yr + bonds $11 M / yr = **$18 M / yr** total — plus the equity tranche amortised across construction ($3.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 52,500 | 87,500 | 484,651 |
| Daily paid trips / population | 15% | 25% | 138% |
| Annual paid trips | 19.2 M | 31.9 M | 176.9 M |
| Farebox revenue | $2.9 M / yr | $4.8 M / yr | $27 M / yr |
| Station shop leases | $551 k / yr | $551 k / yr | $551 k / yr |
| Advertising boards | $759 k / yr | $759 k / yr | $759 k / yr |
| **Total revenue** | **$4.2 M / yr** | **$6.1 M / yr** | **$28 M / yr** |
| Revenue / OPEX + debt-service recovery | 15% | 22% | 100% |
