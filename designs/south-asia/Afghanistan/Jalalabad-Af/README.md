...
| Bucket | Value |
|---|---|
| At-grade (48.4 km @ $0.85 M/km) | $41 M |
| Elevated (1.4 km @ $4.0 M/km) | $5.8 M |
...
| Steady-state, high-ridership (year 11+) | **$11 M / yr** | $32 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$434 M cumulative** | $1,239 |
| Lifecycle envelope (yr 1–35, high scenario) | **$400 M cumulative** | $1,143 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$119 M cumulative** | $339 |

_Population basis: 350,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $833 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $82 M | 4.5% | 35 y, 10 y grace | $5.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $34 M | 18.0% | 35 y, 10 y grace | $6.2 M / yr |
| Government equity (no debt service) | 15% | $20 M | — | — | — |
| **Total** | **100%** | **$136 M** | | | **$12 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $3.7 M / yr + bonds $6.1 M / yr = **$9.8 M / yr** total — plus the equity tranche amortised across construction ($2.0 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 28,000 | 52,500 | 258,082 |
| Daily paid trips / population | 8% | 15% | 74% |
| Annual paid trips | 10.2 M | 19.2 M | 94.2 M |
| Farebox revenue | $1.5 M / yr | $2.9 M / yr | $14 M / yr |
| Station shop leases | $551 k / yr | $551 k / yr | $551 k / yr |
| Advertising boards | $759 k / yr | $759 k / yr | $759 k / yr |
| **Total revenue** | **$2.8 M / yr** | **$4.2 M / yr** | **$15 M / yr** |
| Revenue / OPEX + debt-service recovery | 18% | 27% | 100% |
