...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$573 M (86.3%) of external capital** and **$740 M of external interest**. Capital plus saved interest totals **$1.31 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (46.1 km @ $2.58 M/km) | $119 M |
| Elevated (0.9 km @ $9.75 M/km) | $8.4 M |
...
| Per-capita (city pop) | $1,054 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $128 M | 15% | $19 M | $108 M |
...
| **Total city CAPEX** | **$369 M** | **24.7%** | **$91 M** | **$278 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$91 M** | **$9.1 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$278 M** | **$28 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $222 M | $22 M / yr |
| **Total city programme** | **100.0%** | **$369 M** | **$37 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $498 M | $407 M (81.7%) | $525 M | **$932 M** |
| **Default** | 2.00× | $664 M | $573 M (86.3%) | $740 M | **$1.31 bn** |
| High | 3.00× | $996 M | $904 M (90.8%) | $1.17 bn | **$2.07 bn** |

At the default 2.00× case, OSR's $91 M external requirement is 86.3% below the illustrative foreign-company requirement of $664 M; the associated lifetime external-interest saving is $740 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$50 M / yr** | $142 |
| Steady-state, low capacity-use (year 11+) | **$40 M / yr** | $113 |
| Steady-state, high capacity-use (year 11+) | **$31 M / yr** | $88 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $131 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.69 bn cumulative** | $4,819 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.42 bn cumulative** | $4,065 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.87 bn cumulative** | $5,348 |

_Population basis: 350,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $6.2 M / yr → $15 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $91 M | 4.5% | 40 y, 10 y grace | $5.6 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $222 M | 18.0% | 40 y, 10 y grace | $40 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $56 M | — | — | — |
| **Total** | **100%** | **$369 M** | | | **$46 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $4.1 M / yr + local bonds $40 M / yr = **$44 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($5.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Annual paid trips | 73.3 M | 117.3 M | 42.5 M |
| Annual paid trips / city resident | 209 | 335 | 121 |
| Farebox revenue | $15 M / yr | $23 M / yr | $8.5 M / yr |
| Station shop leases | $301 k / yr | $301 k / yr | $301 k / yr |
| Advertising boards | $419 k / yr | $419 k / yr | $419 k / yr |
| **Total revenue** | **$15 M / yr** | **$24 M / yr** | **$9.2 M / yr** |
...
| Operating surplus applied to debt support | -$6.2 M / yr | -$15 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $40 M / yr | $31 M / yr | **$46 M / yr** |
| Operating surplus after OPEX (before debt support) | $6.2 M / yr | $15 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $278 M | 75% of $369 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $444 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $44 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 77,103 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $335 M |
| Timetable-sized dedicated solar CAPEX | $33 M |
| **Reconciled project CAPEX** | **$369 M** |
| Imported / external-capital requirement | $91 M (24.7%) |
| Local-content / local-funding requirement | $278 M (75.3%) |
| Default foreign-turnkey external-capital comparison | $664 M; OSR saves $573 M (86.3%) |
| Lifetime external interest and combined financing saving | $740 M interest; $1.31 bn capital + interest |
| 15%–25% planning risk envelope | $424 M–$461 M |
| Annual OPEX | $9.2 M / yr |
| Low/high project NPV at 8% | $-215276 k / $-169395 k |
| Low/high project IRR | -3.2% / 1.0% |
| Low/high steady-state DSCR | 0.13 / 0.33 |
