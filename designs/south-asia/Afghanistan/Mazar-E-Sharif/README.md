...
**Country:** AF · **Population:** 600,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$760 M (86.4%) of external capital** and **$982 M of external interest**. Capital plus saved interest totals **$1.74 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`mazar-e-sharif.corridor.geojson`](mazar-e-sharif.corridor.geojson).
...
| Anchor-weighted coverage | 82.5% |
| Route length (double track) | 64.1 km |
| Revenue fleet | 124 × 3-car trainsets |
| Revenue fleet passenger capacity | 44,640 AW2 pax (59,520 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 15 × 3-car trainsets |
| Peak headway | 3 min |
...
| Revenue fleet capacity | 44,640 AW2 pax (59,520 AW3 crush) |
| Total fleet capacity | 50,040 AW2 pax (66,720 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 124 × 360 = **44,640 AW2 passengers** (59,520 AW3 crush)
...
- Anchor-weighted coverage: 82.5%
- Catchment population: **≈ 495,000** (within ~800 m walk of a station)
...
| **Total installed** | **19** | **10,400 kW** | **49,000 kWh** |

Aggregate station-rail charging power: **9,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **59.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 454 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 72 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 64 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 29,823 train-km/day | One-way train journeys × route length |
| Annual service work | 11.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 387 MWh/day | 35.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 322 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 59.7 MW / 370 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 49 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 115 kWh | 200 kWh | 74 kWh | 3.5 km / 25 kWh |
| line-2 | 7 | 189 kWh | 314 kWh | 106 kWh | 12.0 km / 86 kWh |
| line-3 | 5 | 157 kWh | 245 kWh | 72 kWh | 11.6 km / 83 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (62.3 km @ $2.58 M/km) | $161 M |
| Elevated (1.9 km @ $9.75 M/km) | $18 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 59,732 kW @ $700/kW | $42 M |
| Grid interconnection / PPA tie-in | 59,732 kW @ $100/kW | $6.0 M |
| Annual generation proxy | 59.7 MW × 6.2 peak-sun-h/day × 365 d/yr | 135.2 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.1 km × $0.050 M/km | $3.2 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $2.1 M |
...
| Residual train-control wayside + charging microgrids | $5.3 M |
| EPC overhead (7%) | $29 M |
| **CAPEX total** | **$489 M** |
| Per-route-km | $7.6 M / km |
| Per-capita (city pop) | $815 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $184 M | 15% | $28 M | $156 M |
| Stations | $90 M | 20% | $18 M | $72 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $125 M | 35% | $44 M | $81 M |
| Dedicated solar plant | $48 M | 45% | $22 M | $26 M |
| Residual signalling / train control | $3.2 M | 50% | $1.6 M | $1.6 M |
| Charging microgrids | $2.1 M | 40% | $850 k | $1.3 M |
| EPC / project services | $29 M | 15% | $4.3 M | $25 M |
| **Total city CAPEX** | **$489 M** | **24.5%** | **$120 M** | **$369 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh mazar-e-sharif`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.5%** | **$120 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.5%** | **$369 M** | **$37 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $295 M | $30 M / yr |
| **Total city programme** | **100.0%** | **$489 M** | **$49 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $660 M | $540 M (81.9%) | $698 M | **$1.24 bn** |
| **Default** | 2.00× | $880 M | $760 M (86.4%) | $982 M | **$1.74 bn** |
| High | 3.00× | $1.32 bn | $1.20 bn (90.9%) | $1.55 bn | **$2.75 bn** |

At the default 2.00× case, OSR's $120 M external requirement is 86.4% below the illustrative foreign-company requirement of $880 M; the associated lifetime external-interest saving is $982 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–10) | **$66 M / yr** | $110 |
| Steady-state, low capacity-use (year 11+) | **$57 M / yr** | $96 |
| Steady-state, high capacity-use (year 11+) | **$49 M / yr** | $81 |
| Steady-state, operating-neutral revenue case | **$61 M / yr** | $101 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.38 bn cumulative** | $3,971 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.12 bn cumulative** | $3,531 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.49 bn cumulative** | $4,144 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.5 M / yr → $12 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $120 M | 4.5% | 40 y, 10 y grace | $7.3 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $295 M | 18.0% | 40 y, 10 y grace | $54 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $74 M | — | — | — |
| **Total** | **100%** | **$489 M** | | | **$61 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $5.4 M / yr + local bonds $53 M / yr = **$59 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($7.4 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $5.6 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $160 k |
| Traction energy (141.1 GWh / yr) | 29,823 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 23.5 GWh/yr + dedicated solar plant 59.7 MW / 135.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $717 k |
| Labour (365 FTE) | driverless roster: OCC/remote 86, station/platform 74, passenger service 49, fleet maintenance 81, infrastructure/energy 54, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $460 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 29,823 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.8 M train-km / yr (35.3 M car-km / yr). On-site PV covers 23.5 GWh/yr and the dedicated solar plant adds 135.2 GWh/yr against 141.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 139 trainsets, 22 stations, 64.1 route-km, 3 lines, and 29,823 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 56.1 M |
| Annual paid trips / city resident | 122 | 196 | 93 |
| Farebox revenue | $15 M / yr | $23 M / yr | $11 M / yr |
| Station shop leases | $314 k / yr | $314 k / yr | $314 k / yr |
| Advertising boards | $453 k / yr | $453 k / yr | $453 k / yr |
| **Total revenue** | **$15 M / yr** | **$24 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 129% | 202% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $61 M / yr | $61 M / yr | **$61 M / yr** |
| Operating surplus applied to debt support | -$3.5 M / yr | -$12 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $57 M / yr | $49 M / yr | **$61 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.5 M / yr | $12 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,976 m² of station shop/kiosk leases at $10/m²/month and 592 advertising boards at $75/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $4.2 M / yr | $6.8 M / yr | 16 min/trip × $0.22/h value-of-time proxy |
| Avoided road congestion | $17 M / yr | $27 M / yr | 211 M - 338 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.0 M / yr | $4.9 M / yr | 38.1–60.9 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.5 M / yr | $14 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $22 M / yr | $36 M / yr | 20% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 14,544 trips/school day; 3.2 M access-events/yr | 23,270 trips/school day; 5.1 M access-events/yr |
| Healthcare | 0 healthcare anchors | 12,053 trips/day; 4.4 M access-events/yr | 19,284 trips/day; 7.0 M access-events/yr |
| Commerce | 9 major/terminal/interchange nodes | 40,770 trips/trading day; 13.5 M access-events/yr | 65,231 trips/trading day; 21.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $369 M | 76% of $489 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $591 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $59 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 102,580 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $441 M |
| Timetable-sized dedicated solar CAPEX | $48 M |
| **Reconciled project CAPEX** | **$489 M** |
| Imported / external-capital requirement | $120 M (24.5%) |
| Local-content / local-funding requirement | $369 M (75.5%) |
| Default foreign-turnkey external-capital comparison | $880 M; OSR saves $760 M (86.4%) |
| Lifetime external interest and combined financing saving | $982 M interest; $1.74 bn capital + interest |
| 15%–25% planning risk envelope | $562 M–$611 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-310087 k / $-264207 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,343.93 train-km; 16,875.04 kWh consumed; 14,102.63 kWh charged; 26 depot services completed; minimum SoC 60%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 28,319.76 train-km; 203,887.74 kWh consumed; 186,831.80 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 95.0% of scheduled train-km delivered; 123 SoC warnings; 19 energy-adapted off-peak departures, maximum 20 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 93.6% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.8% / 90% | pass |
| 50% charging-contact availability | 20.0% | 95.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.4% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 95.0% / 90% | pass |
...
|---|---|
| ![Mazar-E-Sharif energy and battery simulation dashboard](engineering/screenshots/mazar-e-sharif-simulation-dashboard.png) | ![Mazar-E-Sharif simulator network visualizer](engineering/screenshots/mazar-e-sharif-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 22 line platforms, 1 interchange complexes, 19 civil segments, and 0 input findings |
...
|---|---|
| ![Mazar-E-Sharif QGIS engineering layers](engineering/screenshots/mazar-e-sharif-qgis-engineering-map.png) | ![Mazar-E-Sharif SUMO timetable validation](engineering/screenshots/mazar-e-sharif-sumo-validation.png) |
...
| [`mazar-e-sharif.toml`](mazar-e-sharif.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`mazar-e-sharif-network-map.png`](mazar-e-sharif-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`mazar-e-sharif.corridor.geojson`](mazar-e-sharif.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`mazar-e-sharif.stations.json`](mazar-e-sharif.stations.json) | Machine-readable station list |
| [`mazar-e-sharif.design-quality.yaml`](mazar-e-sharif.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug mazar-e-sharif

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh mazar-e-sharif
```
