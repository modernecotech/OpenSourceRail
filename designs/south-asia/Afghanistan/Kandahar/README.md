...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.0 km × €0.015 M/km | €1.0 M |
...
|---|---|---|
| Construction (years 1–10) | **€57 M / yr** | €82 |
| Steady-state, low-ridership (year 11+) | **€72 M / yr** | €102 |
| Steady-state, high-ridership (year 11+) | **€70 M / yr** | €100 |
| Lifecycle envelope (yr 1–35, low scenario) | **€2.37 bn cumulative** | €3,383 |
| Lifecycle envelope (yr 1–35, high scenario) | **€2.33 bn cumulative** | €3,330 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€15 M / yr (low) → €13 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €396 M | 4.5% | 35 y, 10 y grace | €27 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €165 M | 18.0% | 35 y, 10 y grace | €30 M / yr |
| Government equity (no debt service) | 15% | €99 M | — | — | — |
| **Total** | **100%** | **€661 M** | | | **€57 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €18 M / yr + bonds €30 M / yr = **€48 M / yr** total — plus the equity tranche amortised across construction (€9.9 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Labour (396 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €459 k |
