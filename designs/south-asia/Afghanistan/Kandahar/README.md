...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **37,100 – 55,650 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (62.9 km @ $1.2 M/km) | $75 M |
| Elevated (1.1 km @ $5.5 M/km) | $6.0 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.0 km × $0.015 M/km | $960 k |
...
| Steady-state, high-ridership (year 11+) | **$15 M / yr** | $22 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$629 M cumulative** | $899 |
| Lifecycle envelope (yr 1–35, high scenario) | **$562 M cumulative** | $803 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$179 M cumulative** | $256 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $211 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $124 M | 4.5% | 35 y, 10 y grace | $8.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $52 M | 18.0% | 35 y, 10 y grace | $9.4 M / yr |
| Government equity (no debt service) | 15% | $31 M | — | — | — |
| **Total** | **100%** | **$206 M** | | | **$18 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $5.6 M / yr + bonds $9.3 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($3.1 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 56,000 | 105,000 | 384,465 |
| Daily paid trips / population | 8% | 15% | 55% |
| Annual paid trips | 20.4 M | 38.3 M | 140.3 M |
| Farebox revenue | $3.1 M / yr | $5.7 M / yr | $21 M / yr |
| Station shop leases | $805 k / yr | $805 k / yr | $805 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$5.0 M / yr** | **$7.6 M / yr** | **$23 M / yr** |
