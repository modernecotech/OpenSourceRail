# Kandahar Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,222 |
| Manufacturing material/BOM rows | 18,032 |
| Manufacturing QA verification rows | 1,222 |
| Construction QA action rows | 1,130 |
| Maintenance handover schedule rows | 1,462 |
| Manufacturing rows with material refs | 1,222 / 1,222 |
| Manufacturing rows with verification refs | 1,222 / 1,222 |
| Manufacturing rows linked to QA actions | 1,222 / 1,222 |
