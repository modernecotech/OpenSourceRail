...
| Manufacturing schedule rows | 3,075 |
| Manufacturing material/BOM rows | 46,091 |
| Manufacturing QA verification rows | 3,075 |
| Construction QA action rows | 2,857 |
| Maintenance handover schedule rows | 3,686 |
| Manufacturing rows with material refs | 3,075 / 3,075 |
| Manufacturing rows with verification refs | 3,075 / 3,075 |
| Manufacturing rows linked to QA actions | 3,075 / 3,075 |
...
|---|---:|
| `project_kit` | 5,141 |
| `rolling_stock_bom` | 38,500 |
| `rolling_stock_cots_fitout` | 2,450 |
