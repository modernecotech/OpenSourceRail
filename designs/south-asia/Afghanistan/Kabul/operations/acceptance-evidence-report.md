# Kabul Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,274 |
| Manufacturing schedule rows | 4,553 |
| Manufacturing material/BOM rows | 64,223 |
| Manufacturing QA verification rows | 4,553 |
| Construction QA action rows | 4,149 |
| Maintenance handover schedule rows | 5,523 |
| Manufacturing rows with material refs | 4,553 / 4,553 |
| Manufacturing rows with verification refs | 4,553 / 4,553 |
| Manufacturing rows linked to QA actions | 4,553 / 4,553 |
...
| `qa-24-stations-depots-plant` | 290 |
