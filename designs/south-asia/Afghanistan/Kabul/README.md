...
| Bucket | Value |
|---|---|
| At-grade (233.0 km @ $0.85 M/km) | $198 M |
| Elevated (23.3 km @ $4.0 M/km) | $93 M |
| Elevated-interchange premium (15 sites @ $2.0 M) | $30 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 260.9 km × $0.015 M/km | $3.9 M |
...
| Per-capita (city pop) | $186 / person |
...
|---|---|---|
| Construction (years 1–10) | **$75 M / yr** | $16 |
| Steady-state, low-ridership (year 11+) | **$72 M / yr** | $16 |
| Steady-state, high-ridership (year 11+) | **$54 M / yr** | $12 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$2.54 bn cumulative** | $552 |
| Lifecycle envelope (yr 1–35, high scenario) | **$2.10 bn cumulative** | $456 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$746 M cumulative** | $162 |

_Population basis: 4,601,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $515 M | 4.5% | 35 y, 10 y grace | $35 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $214 M | 18.0% | 35 y, 10 y grace | $39 M / yr |
| Government equity (no debt service) | 15% | $129 M | — | — | — |
| **Total** | **100%** | **$858 M** | | | **$74 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $23 M / yr + bonds $39 M / yr = **$62 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 368,080 | 690,150 | 1,678,305 |
| Daily paid trips / population | 8% | 15% | 36% |
| Annual paid trips | 134.3 M | 251.9 M | 612.6 M |
| Farebox revenue | $20 M / yr | $38 M / yr | $92 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$27 M / yr** | **$44 M / yr** | **$98 M / yr** |
| Revenue / OPEX + debt-service recovery | 27% | 45% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $72 M / yr | $54 M / yr | **$0 / yr** |
