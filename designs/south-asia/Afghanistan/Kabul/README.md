...
|---|---|---|
| Construction (years 1–10) | **$205 M / yr** | $45 |
| Steady-state, low-ridership (year 11+) | **$225 M / yr** | $49 |
| Steady-state, high-ridership (year 11+) | **$209 M / yr** | $45 |
| Steady-state, operating-neutral revenue case | **$203 M / yr** | $44 |
| Lifecycle envelope (yr 1–35, low scenario) | **$7.67 bn cumulative** | $1,667 |
| Lifecycle envelope (yr 1–35, high scenario) | **$7.27 bn cumulative** | $1,581 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$7.13 bn cumulative** | $1,549 |

_Population basis: 4,601,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $22 M / yr → $5.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.41 bn | 4.5% | 35 y, 10 y grace | $95 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $589 M | 18.0% | 35 y, 10 y grace | $108 M / yr |
| Government equity (no debt service) | 15% | $353 M | — | — | — |
| **Total** | **100%** | **$2.36 bn** | | | **$203 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $64 M / yr + bonds $106 M / yr = **$170 M / yr** total — plus the equity tranche amortised across construction ($35 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 436,450 | 727,418 | 833,415 |
| Daily paid trips / catchment | 18% | 30% | 34% |
| Daily paid trips / city population | 9% | 16% | 18% |
| Annual paid trips | 159.3 M | 265.5 M | 304.2 M |
| Farebox revenue | $24 M / yr | $40 M / yr | $46 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$30 M / yr** | **$46 M / yr** | **$52 M / yr** |
| Revenue / OPEX recovery | 58% | 89% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $225 M / yr | $209 M / yr | **$203 M / yr** |
