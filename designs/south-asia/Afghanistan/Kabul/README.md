...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **436,450 – 727,418 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$154 M / yr** | $34 |
| Steady-state, low-ridership (year 11+) | **$164 M / yr** | $36 |
| Steady-state, high-ridership (year 11+) | **$153 M / yr** | $33 |
| Steady-state, operating-neutral revenue case | **$153 M / yr** | $33 |
| Lifecycle envelope (yr 1–35, low scenario) | **$5.64 bn cumulative** | $1,225 |
| Lifecycle envelope (yr 1–35, high scenario) | **$5.37 bn cumulative** | $1,166 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$5.37 bn cumulative** | $1,166 |

_Population basis: 4,601,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $11 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.06 bn | 4.5% | 35 y, 10 y grace | $72 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $443 M | 18.0% | 35 y, 10 y grace | $81 M / yr |
| Government equity (no debt service) | 15% | $266 M | — | — | — |
| **Total** | **100%** | **$1.77 bn** | | | **$153 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $48 M / yr + bonds $80 M / yr = **$128 M / yr** total — plus the equity tranche amortised across construction ($27 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 436,450 | 727,418 | 634,460 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 9% | 16% | 14% |
| Annual paid trips | 159.3 M | 265.5 M | 231.6 M |
| Farebox revenue | $24 M / yr | $40 M / yr | $35 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$30 M / yr** | **$46 M / yr** | **$41 M / yr** |
| Revenue / OPEX recovery | 74% | 112% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $164 M / yr | $153 M / yr | **$153 M / yr** |
