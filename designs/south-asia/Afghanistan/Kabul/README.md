...
| Revenue fleet passenger capacity | 228,240 AW2 pax (304,320 AW3 crush) |
...
| Revenue fleet capacity | 228,240 AW2 pax (304,320 AW3 crush) |
| Total fleet capacity | 254,160 AW2 pax (338,880 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 317 × 720 = **228,240 AW2 passengers** (304,320 AW3 crush)
- **Total fleet passenger capacity:** 353 × 720 = **254,160 AW2 passengers** (338,880 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **719.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Scheduled traction demand | 3,416 MWh/day | 131,778 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 3,126 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 719.0 MW / 3,595 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 719,022 kW @ $700/kW | $503 M |
| Grid interconnection / PPA tie-in | 719,022 kW @ $100/kW | $72 M |
| Annual generation proxy | 719.0 MW × 5.0 peak-sun-h/day × 365 d/yr | 1,312.2 GWh/yr |
| **Dedicated solar plant subtotal** | | **$575 M** |
...
| Dedicated solar power plant | $575 M |
...
|---|---|---|
| Construction (years 1–10) | **$215 M / yr** | $47 |
| Steady-state, low capacity-use (year 11+) | **$313 M / yr** | $68 |
| Steady-state, high capacity-use (year 11+) | **$278 M / yr** | $60 |
| Steady-state, operating-neutral revenue case | **$213 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$11.54 bn cumulative** | $2,509 |
| Lifecycle envelope (yr 1–40, high scenario) | **$10.48 bn cumulative** | $2,278 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$8.54 bn cumulative** | $1,855 |

_Population basis: 4,601,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $100 M / yr → $65 M / yr; surplus applied to debt support is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $4.77 bn | 2.0% | 40 y, 10 y grace | $213 M / yr |
| Government equity (no debt service) | 20% | $1.19 bn | — | — | — |
| **Total** | **100%** | **$5.96 bn** | | | **$213 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $95 M / yr = **$95 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($119 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (1246.7 GWh / yr) | 131,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 105.7 GWh/yr + dedicated solar plant 719.0 MW / 1312.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $8.6 M |
| Labour (1,543 FTE) | driverless roster: OCC/remote 199, station/platform 569, passenger service 167, fleet maintenance 280, infrastructure/energy 266, admin/training 62; no train drivers × country median × 12 × engineer-premium 1.4 | $1.9 M |
| **OPEX subtotal** | | **$165 M / yr** |

_Annual service work: 131,778 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 51.9 M train-km / yr (311.7 M car-km / yr). On-site PV covers 105.7 GWh/yr and the dedicated solar plant adds 1312.2 GWh/yr against 1246.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 135% |
| Annual paid trips | 294.3 M | 470.9 M | 795.3 M |
| Annual paid trips / city resident | 64 | 102 | 173 |
| Farebox revenue | $59 M / yr | $94 M / yr | $159 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $3.6 M / yr | $3.6 M / yr | $3.6 M / yr |
| **Total revenue** | **$65 M / yr** | **$101 M / yr** | **$165 M / yr** |
| Revenue / OPEX recovery | 39% | 61% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Gross repayable-debt service + residual OPEX subsidy | $313 M / yr | $278 M / yr | **$213 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | $0 k / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $313 M / yr | $278 M / yr | **$213 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $17 M / yr | $27 M / yr | 16 min/trip × $0.22/h value-of-time proxy |
...
| Station-area commerce turnover supported | $103 M / yr | $165 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $47 M / yr | $75 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$310 M / yr** | **$495 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 49,363 trips/school day; 10.9 M access-events/yr | 78,981 trips/school day; 17.4 M access-events/yr |
| Healthcare | 26 healthcare anchors | 79,834 trips/day; 29.1 M access-events/yr | 127,734 trips/day; 46.6 M access-events/yr |
| Commerce | 96 major/terminal/interchange nodes | 188,792 trips/trading day; 62.3 M access-events/yr | 302,068 trips/trading day; 99.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.01 bn | 51% of $5.96 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.82 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $482 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 836,748 job-years | retained CAPEX ÷ (4.0 × median annual income) |
