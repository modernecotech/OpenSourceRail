...
|---|---|---|
| Construction (years 1–10) | **$161 M / yr** | $35 |
| Steady-state, low-ridership (year 11+) | **$172 M / yr** | $37 |
| Steady-state, high-ridership (year 11+) | **$159 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$159 M / yr** | $35 |
| Lifecycle envelope (yr 1–35, low scenario) | **$5.90 bn cumulative** | $1,282 |
| Lifecycle envelope (yr 1–35, high scenario) | **$5.59 bn cumulative** | $1,215 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$5.59 bn cumulative** | $1,215 |

_Population basis: 4,601,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.11 bn | 4.5% | 35 y, 10 y grace | $75 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $462 M | 18.0% | 35 y, 10 y grace | $85 M / yr |
| Government equity (no debt service) | 15% | $277 M | — | — | — |
| **Total** | **100%** | **$1.85 bn** | | | **$159 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $50 M / yr + bonds $83 M / yr = **$133 M / yr** total — plus the equity tranche amortised across construction ($28 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
