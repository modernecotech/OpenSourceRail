...
| Per-capita (city pop) | $731 / person |
...
| Steady-state, low-ridership (year 11+) | **$58 M / yr** | $72 |
| Steady-state, high-ridership (year 11+) | **$56 M / yr** | $70 |
| Steady-state, operating-neutral revenue case | **$50 M / yr** | $63 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.95 bn cumulative** | $2,443 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.91 bn cumulative** | $2,384 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.77 bn cumulative** | $2,210 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.4 M / yr → $5.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $351 M | 4.5% | 35 y, 10 y grace | $24 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $146 M | 18.0% | 35 y, 10 y grace | $27 M / yr |
| Government equity (no debt service) | 15% | $88 M | — | — | — |
| **Total** | **100%** | **$585 M** | | | **$50 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $16 M / yr + bonds $26 M / yr = **$42 M / yr** total — plus the equity tranche amortised across construction ($8.8 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 51,264 | 85,440 | 187,267 |
| Daily paid trips / catchment | 18% | 30% | 66% |
| Daily paid trips / city population | 6% | 11% | 23% |
| Annual paid trips | 18.7 M | 31.2 M | 68.4 M |
| Farebox revenue | $2.8 M / yr | $4.7 M / yr | $10 M / yr |
| Station shop leases | $813 k / yr | $813 k / yr | $813 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$4.7 M / yr** | **$6.6 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 39% | 54% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $58 M / yr | $56 M / yr | **$50 M / yr** |
