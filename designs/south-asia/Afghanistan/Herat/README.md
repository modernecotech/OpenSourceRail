...
| Bucket | Value |
|---|---|
| At-grade (58.7 km @ €3.5 M/km) | €205 M |
| Elevated (4.5 km @ €18 M/km) | €80 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.8 km × €0.015 M/km | €0.9 M |
...
|---|---|---|
| Construction (years 1–10) | **€68 M / yr** | €85 |
| Steady-state, low-ridership (year 11+) | **€84 M / yr** | €105 |
| Steady-state, high-ridership (year 11+) | **€83 M / yr** | €103 |
| Lifecycle envelope (yr 1–35, low scenario) | **€2.78 bn cumulative** | €3,480 |
| Lifecycle envelope (yr 1–35, high scenario) | **€2.74 bn cumulative** | €3,428 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero and only the OPEX shortfall remains — ~€17 M / yr (low) → €15 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €468 M | 4.5% | 35 y, 10 y grace | €32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €195 M | 18.0% | 35 y, 10 y grace | €36 M / yr |
| Government equity (no debt service) | 15% | €117 M | — | — | — |
| **Total** | **100%** | **€781 M** | | | **€67 M / yr** |
...
| Labour (401 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €465 k |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€84 M / yr** | **€83 M / yr** |
