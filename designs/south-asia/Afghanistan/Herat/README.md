...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **28,480 – 42,720 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (58.7 km @ $1.2 M/km) | $70 M |
| Elevated (4.5 km @ $5.5 M/km) | $24 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 64 | $800 k | $51 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.8 km × $0.015 M/km | $971 k |
...
|---|---|---|
| Construction (years 1–10) | **$20 M / yr** | $25 |
| Steady-state, low-ridership (year 11+) | **$20 M / yr** | $25 |
| Steady-state, high-ridership (year 11+) | **$17 M / yr** | $21 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–35, low scenario) | **$705 M cumulative** | $881 |
| Lifecycle envelope (yr 1–35, high scenario) | **$628 M cumulative** | $785 |
| Lifecycle envelope (yr 1–35, cost-neutral after opening) | **$201 M cumulative** | $251 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $258 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $139 M | 4.5% | 35 y, 10 y grace | $9.3 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $58 M | 18.0% | 35 y, 10 y grace | $11 M / yr |
| Government equity (no debt service) | 15% | $35 M | — | — | — |
| **Total** | **100%** | **$231 M** | | | **$20 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $6.2 M / yr + bonds $10 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($3.5 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $49 k |
...
|---|---|---|---|
| Daily paid trips | 64,000 | 120,000 | 432,140 |
| Daily paid trips / population | 8% | 15% | 54% |
| Annual paid trips | 23.4 M | 43.8 M | 157.7 M |
| Farebox revenue | $3.5 M / yr | $6.6 M / yr | $24 M / yr |
| Station shop leases | $813 k / yr | $813 k / yr | $813 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$5.4 M / yr** | **$8.5 M / yr** | **$26 M / yr** |
| Revenue / OPEX + debt-service recovery | 21% | 33% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov gap | $20 M / yr | $17 M / yr | **$0 / yr** |
