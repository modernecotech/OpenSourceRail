...
| Per-capita (city pop) | $548 / person |
...
|---|---|---|
| Construction (years 1–10) | **$38 M / yr** | $48 |
| Steady-state, low-ridership (year 11+) | **$42 M / yr** | $53 |
| Steady-state, high-ridership (year 11+) | **$41 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$38 M / yr** | $47 |
| Lifecycle envelope (yr 1–35, low scenario) | **$1.44 bn cumulative** | $1,805 |
| Lifecycle envelope (yr 1–35, high scenario) | **$1.40 bn cumulative** | $1,746 |
| Lifecycle envelope (yr 1–35, operating-neutral after opening) | **$1.33 bn cumulative** | $1,657 |

_Population basis: 800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 35, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.7 M / yr → $2.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $263 M | 4.5% | 35 y, 10 y grace | $18 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $110 M | 18.0% | 35 y, 10 y grace | $20 M / yr |
| Government equity (no debt service) | 15% | $66 M | — | — | — |
| **Total** | **100%** | **$438 M** | | | **$38 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $12 M / yr + bonds $20 M / yr = **$32 M / yr** total — plus the equity tranche amortised across construction ($6.6 M / yr × 10 yr). Principal repayment begins in year 11 on a 25-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 51,264 | 85,440 | 137,367 |
| Daily paid trips / catchment | 18% | 30% | 48% |
| Daily paid trips / city population | 6% | 11% | 17% |
| Annual paid trips | 18.7 M | 31.2 M | 50.1 M |
| Farebox revenue | $2.8 M / yr | $4.7 M / yr | $7.5 M / yr |
| Station shop leases | $813 k / yr | $813 k / yr | $813 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$4.7 M / yr** | **$6.6 M / yr** | **$9.4 M / yr** |
| Revenue / OPEX recovery | 50% | 70% | 100% |
| Country farebox-only policy target (diagnostic) | 30% | 30% | 30% |
| Remaining steady-state gov commitment | $42 M / yr | $41 M / yr | **$38 M / yr** |
