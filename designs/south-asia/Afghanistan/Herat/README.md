...
|---|---|---|---|---|
| line-1 | 14.0 km | 9 | 37 | NE Mid ↔ SW Mid |
| line-2 | 14.3 km | 10 | 35 | S Mid ↔ W Mid |
| line-3 | 21.3 km | 11 | 54 | NW Outer ↔ E Outer |
| **Total** | **49.5 km** | **30 unique** | **126** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **40.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 17.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 509 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 67 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 83 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 215 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 40.0 MW / 248 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 100 kWh | 192 kWh | 81 kWh | 2.3 km / 16 kWh |
| line-2 | 10 | 103 kWh | 180 kWh | 67 kWh | 2.2 km / 16 kWh |
| line-3 | 10 | 153 kWh | 253 kWh | 85 kWh | 4.3 km / 31 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (47.5 km @ $3.0 M/km) | $143 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,958 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,958 kW @ $100/kW | $4.0 M |
| Annual generation proxy | 40.0 MW × 6.2 peak-sun-h/day × 365 d/yr | 90.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–10) | **$30 M / yr** | $37 |
| Steady-state, low capacity-use (year 11+) | **$22 M / yr** | $28 |
| Steady-state, high capacity-use (year 11+) | **$14 M / yr** | $17 |
| Steady-state, operating-neutral revenue case | **$26 M / yr** | $33 |
| Lifecycle envelope (yr 1–40, low scenario) | **$969 M cumulative** | $1,211 |
| Lifecycle envelope (yr 1–40, high scenario) | **$705 M cumulative** | $881 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.08 bn cumulative** | $1,353 |

_Population basis: 800,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.8 M / yr → $13 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $426 M | 4.5% | 40 y, 10 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $106 M | — | — | — |
| **Total** | **100%** | **$532 M** | | | **$26 M / yr** |
...
| Traction energy (109.0 GWh / yr) | 23,033 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.3 GWh/yr + dedicated solar plant 40.0 MW / 90.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $479 k |
| Labour (386 FTE) | driverless roster: OCC/remote 81, station/platform 119, passenger service 49, fleet maintenance 69, infrastructure/energy 47, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $486 k |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 23,033 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.1 M train-km / yr (27.2 M car-km / yr). On-site PV covers 30.3 GWh/yr and the dedicated solar plant adds 90.4 GWh/yr against 109.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 126 trainsets, 30 stations, 49.5 route-km, 3 lines, and 23,033 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 54.4 M |
| Annual paid trips / city resident | 92 | 147 | 68 |
...
| Revenue / OPEX recovery | 131% | 204% | 100% |
...
| Operating surplus applied to debt support | -$3.8 M / yr | -$13 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $22 M / yr | $14 M / yr | **$26 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.8 M / yr | $13 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,080 m² of station shop/kiosk leases at $10/m²/month and 960 advertising boards at $75/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $302 M | 57% of $532 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 83,796 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-337434 k / $-291553 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,939.41 train-km; 13,962.91 kWh consumed; 14,970.22 kWh charged; 28 depot services completed; minimum SoC 89%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,809.55 train-km; 171,418.26 kWh consumed; 175,153.68 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 65%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 57.3% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 32.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 64.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 99.4% / 60% | pass |
| ten-hour single charging-pad outage | 64.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 30 line platforms, 2 interchange complexes, 54 civil segments, and 0 input findings |
