...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.87 bn (85.7%) of external capital** and **$7.36 bn of external interest**. Capital plus saved interest totals **$13.24 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (285.3 km @ $3.0 M/km) | $856 M |
| Elevated (35.6 km @ $12.0 M/km) | $427 M |
...
| Per-capita (city pop) | $674 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.37 bn | 15% | $206 M | $1.17 bn |
...
| **Total city CAPEX** | **$3.81 bn** | **25.7%** | **$978 M** | **$2.83 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.7%** | **$978 M** | **$140 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.3%** | **$2.83 bn** | **$404 M / yr** |
| of which planned local bond issuance | 59.4% of total CAPEX | $2.26 bn | $323 M / yr |
| **Total city programme** | **100.0%** | **$3.81 bn** | **$544 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $5.14 bn | $4.16 bn (81.0%) | $5.22 bn | **$9.38 bn** |
| **Default** | 2.00× | $6.85 bn | $5.87 bn (85.7%) | $7.36 bn | **$13.24 bn** |
| High | 3.00× | $10.28 bn | $9.30 bn (90.5%) | $11.66 bn | **$20.96 bn** |

At the default 2.00× case, OSR's $978 M external requirement is 85.7% below the illustrative foreign-company requirement of $6.85 bn; the associated lifetime external-interest saving is $7.36 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$430 M / yr** | $76 |
| Steady-state, low capacity-use (year 8+) | **$182 M / yr** | $32 |
| Steady-state, high capacity-use (year 8+) | **$22 M / yr** | $4 |
| Steady-state, operating-neutral revenue case | **$368 M / yr** | $65 |
| Lifecycle envelope (yr 1–40, low scenario) | **$9.01 bn cumulative** | $1,595 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.75 bn cumulative** | $663 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$15.15 bn cumulative** | $2,682 |

_Population basis: 5,648,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $186 M / yr → $345 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $978 M | 4.5% | 40 y, 7 y grace | $57 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.26 bn | 13.5% | 40 y, 7 y grace | $310 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $566 M | — | — | — |
| **Total** | **100%** | **$3.81 bn** | | | **$368 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $44 M / yr + local bonds $306 M / yr = **$350 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($81 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 124.9 M |
| Annual paid trips / city resident | 74 | 118 | 22 |
| Farebox revenue | $266 M / yr | $425 M / yr | $80 M / yr |
| Station shop leases | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| Advertising boards | $7.1 M / yr | $7.1 M / yr | $7.1 M / yr |
| **Total revenue** | **$278 M / yr** | **$437 M / yr** | **$92 M / yr** |
| Revenue / OPEX recovery | 303% | 477% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $368 M / yr | $368 M / yr | **$368 M / yr** |
| Operating surplus applied to debt support | -$186 M / yr | -$345 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $182 M / yr | $22 M / yr | **$368 M / yr** |
| Operating surplus after OPEX (before debt support) | $186 M / yr | $345 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.83 bn | 74% of $3.81 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.53 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $647 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 245,566 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$3.81 bn** |
| Imported / external-capital requirement | $978 M (25.7%) |
| Local-content / local-funding requirement | $2.83 bn (74.3%) |
| Default foreign-turnkey external-capital comparison | $6.85 bn; OSR saves $5.87 bn (85.7%) |
| Lifetime external interest and combined financing saving | $7.36 bn interest; $13.24 bn capital + interest |
| 15%–25% planning risk envelope | $4.38 bn–$4.76 bn |
| Annual OPEX | $92 M / yr |
| Low/high project NPV at 8% | $-1582162 k / $-510287 k |
| Low/high project IRR | 2.6% / 6.5% |
| Low/high steady-state DSCR | 0.51 / 0.94 |
