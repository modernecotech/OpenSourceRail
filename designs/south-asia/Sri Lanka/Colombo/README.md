...
| Revenue fleet | 333 × 6-car trainsets |
| Revenue fleet passenger capacity | 239,760 AW2 pax (319,680 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 41.2 km | 20 | 56 | SW Outer ↔ NE Outer |
| line-2 | 39.6 km | 19 | 53 | S Outer ↔ N Outer |
| line-3 | 36.1 km | 13 | 49 | S Mid ↔ NE Outer |
| line-4 | 31.1 km | 16 | 42 | SW Outer ↔ N Mid |
| line-5 | 35.5 km | 17 | 48 | W Mid ↔ SE Outer |
| line-6 | 94.4 km | 41 | 122 | NW Mid ↔ NW Mid |
| **Total** | **278.0 km** | **125 unique** | **370** | |
...
| Revenue fleet capacity | 239,760 AW2 pax (319,680 AW3 crush) |
| Total fleet capacity | 266,400 AW2 pax (355,200 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 333 × 720 = **239,760 AW2 passengers** (319,680 AW3 crush)
- **Total fleet passenger capacity:** 370 × 720 = **266,400 AW2 passengers** (355,200 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **778.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 255 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 3,639 MWh/day | 140,380 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 3,384 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 778.2 MW / 3,891 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 370 | $8.40 M | $3.11 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 2220 | $100 k | $222 M |
| High sensitivity check | 2220 | $200 k | $444 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 778,242 kW @ $700/kW | $545 M |
| Grid interconnection / PPA tie-in | 778,242 kW @ $100/kW | $78 M |
| Annual generation proxy | 778.2 MW × 5.0 peak-sun-h/day × 365 d/yr | 1,420.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$623 M** |
...
| EPC integration + project management (7%) | on subtotal | $351 M |
...
|---|---|---|
| Construction (years 1–7) | **$267 M / yr** | $47 |
| Steady-state, low capacity-use (year 8+) | **$200 M / yr** | $35 |
| Steady-state, high capacity-use (year 8+) | **$103 M / yr** | $18 |
| Steady-state, operating-neutral revenue case | **$200 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$8.48 bn cumulative** | $1,502 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.28 bn cumulative** | $936 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$8.46 bn cumulative** | $1,498 |

_Population basis: 5,648,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $641 k / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $96 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $4.79 bn | 2.0% | 40 y, 7 y grace | $200 M / yr |
| Government equity (no debt service) | 20% | $1.20 bn | — | — | — |
| **Total** | **100%** | **$5.99 bn** | | | **$200 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $96 M / yr = **$96 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($171 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $124 M |
...
| Traction energy (1328.1 GWh / yr) | 140,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 93.1 GWh/yr + dedicated solar plant 778.2 MW / 1420.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $9.3 M |
| Labour (1,405 FTE) | driverless roster: OCC/remote 203, station/platform 444, passenger service 143, fleet maintenance 296, infrastructure/energy 265, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $5.7 M |
| **OPEX subtotal** | | **$172 M / yr** |

_Annual service work: 140,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 55.3 M train-km / yr (332.0 M car-km / yr). On-site PV covers 93.1 GWh/yr and the dedicated solar plant adds 1420.3 GWh/yr against 1328.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 252.3 M | 403.7 M | 253.3 M |
| Annual paid trips / city resident | 45 | 71 | 45 |
...
| **Total revenue** | **$172 M / yr** | **$269 M / yr** | **$172 M / yr** |
| Revenue / OPEX recovery | 100% | 156% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $200 M / yr | $200 M / yr | **$200 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$96 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $200 M / yr | $103 M / yr | **$200 M / yr** |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $47 M / yr | $75 M / yr | 16 min/trip × $0.69/h value-of-time proxy |
...
| Station-area commerce turnover supported | $80 M / yr | $128 M / yr | 21% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $40 M / yr | $64 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$289 M / yr** | **$462 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 13 education anchors | 43,052 trips/school day; 9.5 M access-events/yr | 68,883 trips/school day; 15.2 M access-events/yr |
| Healthcare | 17 healthcare anchors | 57,139 trips/day; 20.9 M access-events/yr | 91,423 trips/day; 33.4 M access-events/yr |
| Commerce | 62 major/terminal/interchange nodes | 146,590 trips/trading day; 48.4 M access-events/yr | 234,544 trips/trading day; 77.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.00 bn | 50% of $5.99 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.79 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $685 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 259,989 job-years | retained CAPEX ÷ (4.0 × median annual income) |
