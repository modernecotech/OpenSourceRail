...
|---|---|---|---|---|
| line-1 | 28.0 km | 16 | 27 | E Outer ↔ W Outer |
| line-2 | 22.9 km | 13 | 23 | NW Outer ↔ SE Mid |
| line-3 | 27.1 km | 14 | 26 | SW Mid ↔ NE Outer |
| **Total** | **77.9 km** | **43 unique** | **76** | |
...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **36,270 – 54,405 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (67.4 km @ $1.2 M/km) | $81 M |
| Elevated (9.8 km @ $5.5 M/km) | $54 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 76 | $800 k | $61 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 77.9 km × $0.015 M/km | $1.2 M |
...
|---|---|---|
| Construction (years 1–7) | **$21 M / yr** | $32 |
| Steady-state, low-ridership (year 8+) | **$16 M / yr** | $25 |
| Steady-state, high-ridership (year 8+) | **$8.0 M / yr** | $12 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$515 M cumulative** | $792 |
| Lifecycle envelope (yr 1–30, high scenario) | **$332 M cumulative** | $510 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$147 M cumulative** | $227 |

_Population basis: 650,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $159 M | 4.0% | 30 y, 7 y grace | $11 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $66 M | 13.5% | 30 y, 7 y grace | $9.5 M / yr |
| Government equity (no debt service) | 15% | $40 M | — | — | — |
| **Total** | **100%** | **$266 M** | | | **$20 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.4 M / yr + bonds $9.0 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (479 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.9 M |
...
|---|---|---|---|
| Daily paid trips | 52,000 | 97,500 | 143,252 |
| Daily paid trips / population | 8% | 15% | 22% |
| Annual paid trips | 19.0 M | 35.6 M | 52.3 M |
| Farebox revenue | $9.1 M / yr | $17 M / yr | $25 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$12 M / yr** | **$20 M / yr** | **$28 M / yr** |
| Revenue / OPEX + debt-service recovery | 43% | 72% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $16 M / yr | $8.0 M / yr | **$0 / yr** |
