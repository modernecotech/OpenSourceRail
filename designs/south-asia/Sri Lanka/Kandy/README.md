...
| Bucket | Value |
|---|---|
| At-grade (67.4 km @ €3.5 M/km) | €236 M |
| Elevated (9.8 km @ €18 M/km) | €176 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + spare + cold reserve) | 76 | €3.0 M | €228 M |
...
| Per-capita (city pop) | €1,332 / person |
...
|---|---|---|
| Construction (years 1–7) | **€69 M / yr** | €105 |
| Steady-state, low-ridership (year 8+) | **€84 M / yr** | €129 |
| Steady-state, high-ridership (year 8+) | **€79 M / yr** | €122 |
| Lifecycle envelope (yr 1–30, low scenario) | **€2.41 bn cumulative** | €3,702 |
| Lifecycle envelope (yr 1–30, high scenario) | **€2.31 bn cumulative** | €3,548 |

_Population basis: 650,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€18 M / yr (low) → €14 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €519 M | 4.0% | 30 y, 7 y grace | €35 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €216 M | 13.5% | 30 y, 7 y grace | €31 M / yr |
| Government equity (no debt service) | 15% | €130 M | — | — | — |
| **Total** | **100%** | **€866 M** | | | **€66 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €21 M / yr + bonds €29 M / yr = **€50 M / yr** total — plus the equity tranche amortised across construction (€19 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (479 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.8 M |
...
|---|---|---|
| Annual paid trips | 11.9 M | 23.7 M |
| Farebox revenue | €4.4 M / yr | €8.7 M / yr |
| Farebox / OPEX recovery | 20% | 39% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €18 M / yr | €14 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€84 M / yr** | **€79 M / yr** |
