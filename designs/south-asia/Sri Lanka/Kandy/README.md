...
| Per-capita (city pop) | $1,419 / person |
...
|---|---|---|
| Construction (years 1–7) | **$73 M / yr** | $112 |
| Steady-state, low-ridership (year 8+) | **$81 M / yr** | $124 |
| Steady-state, high-ridership (year 8+) | **$73 M / yr** | $112 |
| Steady-state, operating-neutral revenue case | **$70 M / yr** | $108 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.36 bn cumulative** | $3,637 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.19 bn cumulative** | $3,367 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.13 bn cumulative** | $3,270 |

_Population basis: 650,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $10 M / yr → $2.7 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $554 M | 4.0% | 30 y, 7 y grace | $37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $231 M | 13.5% | 30 y, 7 y grace | $33 M / yr |
| Government equity (no debt service) | 15% | $138 M | — | — | — |
| **Total** | **100%** | **$923 M** | | | **$70 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $22 M / yr + bonds $31 M / yr = **$53 M / yr** total — plus the equity tranche amortised across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 65,286 | 108,810 | 124,438 |
| Daily paid trips / catchment | 18% | 30% | 34% |
| Daily paid trips / city population | 10% | 17% | 19% |
| Annual paid trips | 23.8 M | 39.7 M | 45.4 M |
...
| **Total revenue** | **$15 M / yr** | **$22 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 58% | 89% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $81 M / yr | $73 M / yr | **$70 M / yr** |
