...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$1.10 bn (86.7%) of external capital** and **$1.38 bn of external interest**. Capital plus saved interest totals **$2.48 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 75.4 km |
| Revenue fleet | 161 × 3-car trainsets |
| Revenue fleet passenger capacity | 57,960 AW2 pax (77,280 AW3 crush) |
...
| Revenue fleet capacity | 57,960 AW2 pax (77,280 AW3 crush) |
| Total fleet capacity | 64,080 AW2 pax (85,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 161 × 360 = **57,960 AW2 passengers** (77,280 AW3 crush)
- **Total fleet passenger capacity:** 178 × 360 = **64,080 AW2 passengers** (85,440 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 57.4%
- Catchment population: **≈ 373,099** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **95.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 472 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 76 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 35,050 train-km/day | One-way train journeys × route length |
| Annual service work | 13.8 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 454 MWh/day | 41.5 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 400 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 95.8 MW / 460 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 203 kWh | 331 kWh | 107 kWh | 5.3 km / 40 kWh |
| line-2 | 7 | 191 kWh | 286 kWh | 76 kWh | 6.3 km / 47 kWh |
| line-3 | 6 | 170 kWh | 270 kWh | 83 kWh | 9.0 km / 68 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (66.2 km @ $3.0 M/km) | $199 M |
| Elevated (9.2 km @ $12.0 M/km) | $110 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$313 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 178 | $900 k | $160 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 534 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 534 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 95,837 kW @ $700/kW | $67 M |
| Grid interconnection / PPA tie-in | 95,837 kW @ $100/kW | $9.6 M |
| Annual generation proxy | 95.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 167.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$77 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 75.4 km × $0.050 M/km | $3.8 M |
...
| Dedicated solar power plant | $77 M |
| Residual train-control wayside + charging microgrids | $6.2 M |
| EPC overhead (7%) | $41 M |
| **CAPEX total** | **$704 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $313 M | 15% | $47 M | $266 M |
| Stations | $99 M | 20% | $20 M | $79 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $160 M | 35% | $56 M | $104 M |
| Dedicated solar plant | $77 M | 45% | $35 M | $42 M |
| Residual signalling / train control | $3.8 M | 50% | $1.9 M | $1.9 M |
| Charging microgrids | $2.4 M | 40% | $970 k | $1.5 M |
| EPC / project services | $41 M | 15% | $6.2 M | $35 M |
| **Total city CAPEX** | **$704 M** | **23.9%** | **$168 M** | **$536 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh kandy`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.9%** | **$168 M** | **$24 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.1%** | **$536 M** | **$77 M / yr** |
| of which planned local bond issuance | 60.9% of total CAPEX | $429 M | $61 M / yr |
| **Total city programme** | **100.0%** | **$704 M** | **$101 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $950 M | $782 M (82.3%) | $980 M | **$1.76 bn** |
| **Default** | 2.00× | $1.27 bn | $1.10 bn (86.7%) | $1.38 bn | **$2.48 bn** |
| High | 3.00× | $1.90 bn | $1.73 bn (91.1%) | $2.17 bn | **$3.90 bn** |

At the default 2.00× case, OSR's $168 M external requirement is 86.7% below the illustrative foreign-company requirement of $1.27 bn; the associated lifetime external-interest saving is $1.38 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$81 M / yr** | $124 |
| Steady-state, low capacity-use (year 8+) | **$38 M / yr** | $58 |
| Steady-state, high capacity-use (year 8+) | **$9.6 M / yr** | $15 |
| Steady-state, operating-neutral revenue case | **$69 M / yr** | $106 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.81 bn cumulative** | $2,786 |
| Lifecycle envelope (yr 1–40, high scenario) | **$882 M cumulative** | $1,357 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.83 bn cumulative** | $4,354 |

_Population basis: 650,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $31 M / yr → $59 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $168 M | 4.5% | 40 y, 7 y grace | $9.9 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $429 M | 13.5% | 40 y, 7 y grace | $59 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $107 M | — | — | — |
| **Total** | **100%** | **$704 M** | | | **$69 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $7.6 M / yr + local bonds $58 M / yr = **$65 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($15 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (165.8 GWh / yr) | 35,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.8 GWh/yr + dedicated solar plant 95.8 MW / 167.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.2 M |
| Labour (418 FTE) | driverless roster: OCC/remote 106, station/platform 80, passenger service 49, fleet maintenance 100, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.7 M |
| **OPEX subtotal** | | **$18 M / yr** |

_Annual service work: 35,050 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.8 M train-km / yr (41.5 M car-km / yr). On-site PV covers 19.8 GWh/yr and the dedicated solar plant adds 167.9 GWh/yr against 165.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 178 trainsets, 23 stations, 75.4 route-km, 3 lines, and 35,050 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 25.1 M |
| Annual paid trips / city resident | 113 | 180 | 39 |
| Farebox revenue | $47 M / yr | $75 M / yr | $16 M / yr |
| Station shop leases | $670 k / yr | $670 k / yr | $670 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$49 M / yr** | **$77 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 273% | 431% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $69 M / yr | $69 M / yr | **$69 M / yr** |
| Operating surplus applied to debt support | -$31 M / yr | -$59 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $38 M / yr | $9.6 M / yr | **$69 M / yr** |
| Operating surplus after OPEX (before debt support) | $31 M / yr | $59 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,304 m² of station shop/kiosk leases at $19/m²/month and 652 advertising boards at $168/board/month, with occupancy derates applied._
...
| Avoided road congestion | $20 M / yr | $32 M / yr | 249 M - 398 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.6 M / yr | $5.7 M / yr | 44.8–71.6 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $10.0 M / yr | $16 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
|---|---:|---:|---:|
| Education | 3 education anchors | 11,864 trips/school day; 2.6 M access-events/yr | 18,982 trips/school day; 4.2 M access-events/yr |
| Healthcare | 2 healthcare anchors | 14,038 trips/day; 5.1 M access-events/yr | 22,461 trips/day; 8.2 M access-events/yr |
| Commerce | 10 major/terminal/interchange nodes | 41,311 trips/trading day; 13.6 M access-events/yr | 66,098 trips/trading day; 21.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $536 M | 76% of $704 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $857 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $122 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 46,497 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $627 M |
| Timetable-sized dedicated solar CAPEX | $77 M |
| **Reconciled project CAPEX** | **$704 M** |
| Imported / external-capital requirement | $168 M (23.9%) |
| Local-content / local-funding requirement | $536 M (76.1%) |
| Default foreign-turnkey external-capital comparison | $1.27 bn; OSR saves $1.10 bn (86.7%) |
| Lifetime external interest and combined financing saving | $1.38 bn interest; $2.48 bn capital + interest |
| 15%–25% planning risk envelope | $810 M–$880 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $-316075 k / $-126921 k |
| Low/high project IRR | 1.9% / 6.0% |
| Low/high steady-state DSCR | 0.45 / 0.86 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,602.03 train-km; 19,483.79 kWh consumed; 16,782.94 kWh charged; 22 depot services completed; minimum SoC 65%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 32,788.18 train-km; 245,514.95 kWh consumed; 228,304.92 kWh charged; 466 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 93.5% of scheduled train-km delivered; 99 SoC warnings; 16 energy-adapted off-peak departures, maximum 14 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 93.8% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.6% / 90% | pass |
| 50% charging-contact availability | 20.0% | 93.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.5% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 93.5% / 90% | pass |
...
|---|---|
| ![Kandy energy and battery simulation dashboard](engineering/screenshots/kandy-simulation-dashboard.png) | ![Kandy simulator network visualizer](engineering/screenshots/kandy-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 1 interchange complexes, 20 civil segments, and 0 input findings |
...
|---|---|
| ![Kandy QGIS engineering layers](engineering/screenshots/kandy-qgis-engineering-map.png) | ![Kandy SUMO timetable validation](engineering/screenshots/kandy-sumo-validation.png) |
...
scripts/regenerate-city.sh kandy
```
