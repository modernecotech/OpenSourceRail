...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **50,220 – 83,700 trips/day**
...
| Per-capita (city pop) | $1,477 / person |
...
| Steady-state, low-ridership (year 8+) | **$65 M / yr** | $129 |
| Steady-state, high-ridership (year 8+) | **$59 M / yr** | $117 |
| Steady-state, operating-neutral revenue case | **$56 M / yr** | $112 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.89 bn cumulative** | $3,788 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.76 bn cumulative** | $3,519 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.70 bn cumulative** | $3,403 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $8.4 M / yr → $2.5 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $443 M | 4.0% | 30 y, 7 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $185 M | 13.5% | 30 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 15% | $111 M | — | — | — |
| **Total** | **100%** | **$738 M** | | | **$56 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $18 M / yr + bonds $25 M / yr = **$43 M / yr** total — plus the equity tranche amortised across construction ($16 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 50,220 | 83,700 | 98,097 |
| Daily paid trips / catchment | 18% | 30% | 35% |
| Daily paid trips / city population | 10% | 17% | 20% |
| Annual paid trips | 18.3 M | 30.6 M | 35.8 M |
| Farebox revenue | $8.8 M / yr | $15 M / yr | $17 M / yr |
| Station shop leases | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$12 M / yr** | **$18 M / yr** | **$20 M / yr** |
| Revenue / OPEX recovery | 58% | 88% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gov debt service + residual OPEX subsidy | $65 M / yr | $59 M / yr | **$56 M / yr** |
