...
| Bucket | Value |
|---|---|
| At-grade (62.5 km @ €3.5 M/km) | €219 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 64.4 km × €0.015 M/km | €1.0 M |
...
| Per-capita (city pop) | €1,275 / person |
...
|---|---|---|
| Construction (years 1–7) | **€50 M / yr** | €101 |
| Steady-state, low-ridership (year 8+) | **€62 M / yr** | €124 |
| Steady-state, high-ridership (year 8+) | **€59 M / yr** | €118 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.78 bn cumulative** | €3,564 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.70 bn cumulative** | €3,410 |

_Population basis: 500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€14 M / yr (low) → €10 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €382 M | 4.0% | 30 y, 7 y grace | €26 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €159 M | 13.5% | 30 y, 7 y grace | €23 M / yr |
| Government equity (no debt service) | 15% | €96 M | — | — | — |
| **Total** | **100%** | **€637 M** | | | **€48 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €15 M / yr + bonds €22 M / yr = **€37 M / yr** total — plus the equity tranche amortised across construction (€14 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (398 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.5 M |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€62 M / yr** | **€59 M / yr** |
