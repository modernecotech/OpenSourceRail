...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **25,440 – 38,160 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (50.4 km @ $0.85 M/km) | $43 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.8 km × $0.015 M/km | $778 k |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $7.4 M |
...
| Per-capita (city pop) | $229 / person |
...
|---|---|---|
| Construction (years 1–7) | **$11 M / yr** | $18 |
| Steady-state, low-ridership (year 8+) | **$3.9 M / yr** | $6 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$165 M cumulative** | $276 |
| Lifecycle envelope (yr 1–30, high scenario) | **$76 M cumulative** | $127 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$76 M cumulative** | $127 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $82 M | 4.0% | 30 y, 7 y grace | $5.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $34 M | 13.5% | 30 y, 7 y grace | $4.9 M / yr |
| Government equity (no debt service) | 15% | $21 M | — | — | — |
| **Total** | **100%** | **$137 M** | | | **$10 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.3 M / yr + bonds $4.6 M / yr = **$7.9 M / yr** total — plus the equity tranche amortised across construction ($2.9 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 48,000 | 90,000 | 70,159 |
| Daily paid trips / population | 8% | 15% | 12% |
| Annual paid trips | 17.5 M | 32.9 M | 25.6 M |
| Farebox revenue | $8.4 M / yr | $16 M / yr | $12 M / yr |
...
| Revenue / OPEX + debt-service recovery | 74% | 123% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $3.9 M / yr | $0 k / yr | **$0 / yr** |
