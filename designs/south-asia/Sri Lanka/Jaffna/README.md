...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 393 | $60 k | $24 M |
| High sensitivity check | 393 | $120 k | $47 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh jaffna`.
...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $55 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$230 M cumulative** | $383 |
| Lifecycle envelope (yr 1–40, high scenario) | **$230 M cumulative** | $383 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.02 bn cumulative** | $1,697 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $407 M | 4.5% | 40 y, 7 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $102 M | — | — | — |
| **Total** | **100%** | **$508 M** | | | **$24 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $18 M / yr = **$18 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($15 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $281 M | 55% of $508 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $450 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $64 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 24,404 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $456 M |
| Timetable-sized dedicated solar CAPEX | $52 M |
| **Reconciled project CAPEX** | **$508 M** |
| 15%–25% planning risk envelope | $585 M–$635 M |
| Annual OPEX | $13 M / yr |
| Low/high project NPV at 8% | $-135687 k / $53 M |
| Low/high project IRR | 4.8% / 9.0% |
| Low/high steady-state DSCR | 1.51 / 2.69 |
