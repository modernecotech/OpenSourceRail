...
|---|---|---|---|---|
| line-1 | 13.9 km | 9 | 37 | S Mid ↔ N Mid |
| line-2 | 22.5 km | 12 | 60 | SE Mid ↔ NW Outer |
| line-3 | 17.1 km | 9 | 46 | NE Outer ↔ S Mid |
| **Total** | **53.4 km** | **30 unique** | **143** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **62.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.7× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 478 kWh usable margin across the worst powered-stop gap (line-3) |
...
| On-site PV shortfall before solar plant | 262 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 62.7 MW / 301 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 104 kWh | 192 kWh | 77 kWh | 2.3 km / 17 kWh |
| line-2 | 10 | 168 kWh | 290 kWh | 105 kWh | 7.3 km / 54 kWh |
| line-3 | 7 | 128 kWh | 200 kWh | 60 kWh | 8.3 km / 62 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 429 | $60 k | $26 M |
| High sensitivity check | 429 | $120 k | $51 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 62,743 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 62,743 kW @ $100/kW | $6.3 M |
| Annual generation proxy | 62.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 109.9 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$35 M / yr** | $59 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$246 M cumulative** | $411 |
| Lifecycle envelope (yr 1–40, high scenario) | **$246 M cumulative** | $411 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.09 bn cumulative** | $1,820 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $436 M | 4.5% | 40 y, 7 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $109 M | — | — | — |
| **Total** | **100%** | **$545 M** | | | **$26 M / yr** |
...
| Traction energy (117.5 GWh / yr) | 24,837 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.9 GWh/yr + dedicated solar plant 62.7 MW / 109.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $753 k |
| Labour (382 FTE) | driverless roster: OCC/remote 86, station/platform 100, passenger service 49, fleet maintenance 76, infrastructure/energy 50, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.5 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 24,837 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.8 M train-km / yr (29.4 M car-km / yr). On-site PV covers 21.9 GWh/yr and the dedicated solar plant adds 109.9 GWh/yr against 117.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 143 trainsets, 30 stations, 53.4 route-km, 3 lines, and 24,837 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 17.8 M |
| Annual paid trips / city resident | 122 | 196 | 30 |
...
| **Total revenue** | **$49 M / yr** | **$77 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 361% | 567% | 100% |
...
_Commercial-revenue assumptions: 4,128 m² of station shop/kiosk leases at $19/m²/month and 808 advertising boards at $168/board/month, with occupancy derates applied._
...
| Commerce | 14 major/terminal/interchange nodes | 41,984 trips/trading day; 13.9 M access-events/yr | 67,174 trips/trading day; 22.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $302 M | 55% of $545 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 26,247 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $495 M |
| Timetable-sized dedicated solar CAPEX | $50 M |
| **Reconciled project CAPEX** | **$545 M** |
| 15%–25% planning risk envelope | $627 M–$682 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-166939 k / $22 M |
| Low/high project IRR | 4.3% / 8.4% |
| Low/high steady-state DSCR | 1.39 / 2.48 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,039.52 train-km; 15,271.77 kWh consumed; 15,227.36 kWh charged; 27 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 25,643.02 train-km; 192,012.71 kWh consumed; 195,650.63 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered; 29 SoC warnings |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 30 line platforms, 1 interchange complexes, 9 civil segments, and 0 input findings |
