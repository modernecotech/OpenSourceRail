...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 260 | $8.40 M | $2.18 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1560 | $100 k | $156 M |
| High sensitivity check | 1560 | $200 k | $312 M |
...
| Stations | $679 M |
| Depots | $34 M |
| Rolling stock | $2.18 bn |
| Railway production plant | $156 M |
...
|---|---|---|
| Construction (years 1–5) | **$337 M / yr** | $105 |
| Steady-state, low-ridership (year 6+) | **$395 M / yr** | $124 |
| Steady-state, high-ridership (year 6+) | **$365 M / yr** | $114 |
| Steady-state, operating-neutral revenue case | **$319 M / yr** | $100 |
| Lifecycle envelope (yr 1–25, low scenario) | **$9.59 bn cumulative** | $2,998 |
| Lifecycle envelope (yr 1–25, high scenario) | **$8.98 bn cumulative** | $2,807 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$8.06 bn cumulative** | $2,519 |

_Population basis: 3,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $77 M / yr → $46 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $2.81 bn | 4.0% | 25 y, 5 y grace | $207 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $1.17 bn | 7.2% | 25 y, 5 y grace | $112 M / yr |
| Government equity (no debt service) | 15% | $702 M | — | — | — |
| **Total** | **100%** | **$4.68 bn** | | | **$319 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $112 M / yr + bonds $84 M / yr = **$197 M / yr** total — plus the equity tranche amortised across construction ($140 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $87 M |
...
|---|---|---|---|
| Daily paid trips | 273,600 | 456,000 | 730,278 |
| Daily paid trips / catchment | 18% | 30% | 48% |
| Daily paid trips / city population | 9% | 14% | 23% |
| Annual paid trips | 99.9 M | 166.4 M | 266.6 M |
| Farebox revenue | $46 M / yr | $77 M / yr | $123 M / yr |
| Station shop leases | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| Advertising boards | $7.5 M / yr | $7.5 M / yr | $7.5 M / yr |
| **Total revenue** | **$58 M / yr** | **$89 M / yr** | **$135 M / yr** |
| Revenue / OPEX recovery | 43% | 66% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $395 M / yr | $365 M / yr | **$319 M / yr** |
