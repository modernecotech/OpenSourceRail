...
| Bucket | Value |
|---|---|
| At-grade (297.9 km @ €3.5 M/km) | €1.04 bn |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 260 | €6.0 M | €1.56 bn |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 323.6 km × €0.015 M/km | €4.8 M |
...
| Per-capita (city pop) | €1,276 / person |
...
|---|---|---|
| Construction (years 1–5) | **€294 M / yr** | €92 |
| Steady-state, low-ridership (year 6+) | **€371 M / yr** | €116 |
| Steady-state, high-ridership (year 6+) | **€351 M / yr** | €110 |
| Lifecycle envelope (yr 1–25, low scenario) | **€8.89 bn cumulative** | €2,779 |
| Lifecycle envelope (yr 1–25, high scenario) | **€8.48 bn cumulative** | €2,650 |

_Population basis: 3,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€93 M / yr (low) → €72 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €1.02 bn | 7.2% | 25 y, 5 y grace | €98 M / yr |
| Government equity (no debt service) | 15% | €613 M | — | — | — |
| **Total** | **100%** | **€4.08 bn** | | | **€278 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €98 M / yr + bonds €74 M / yr = **€172 M / yr** total — plus the equity tranche amortised across construction (€123 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | €241 k |
| Traction energy (1103.1 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (1,954 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €6.9 M |
...
| Operating shortfall (gov subsidy required) | €93 M / yr | €72 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€371 M / yr** | **€351 M / yr** |
