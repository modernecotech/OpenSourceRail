...
| Manufacturing material/BOM rows | 34,767 |
| Manufacturing QA verification rows | 2,595 |
| Construction QA action rows | 2,331 |
| Maintenance handover schedule rows | 3,173 |
...
|---|---:|
| `project_kit` | 5,517 |
| `rolling_stock_bom` | 27,500 |
| `rolling_stock_cots_fitout` | 1,750 |
...
| `qa-25-power-energy` | 179 |
| `qa-26-wayside-comms-safety` | 366 |
