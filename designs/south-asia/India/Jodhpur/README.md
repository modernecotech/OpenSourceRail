...
|---|---|---|
| Construction (years 1–5) | **$124 M / yr** | $95 |
| Steady-state, low-ridership (year 6+) | **$131 M / yr** | $100 |
| Steady-state, high-ridership (year 6+) | **$119 M / yr** | $92 |
| Steady-state, operating-neutral revenue case | **$117 M / yr** | $90 |
| Lifecycle envelope (yr 1–25, low scenario) | **$3.23 bn cumulative** | $2,486 |
| Lifecycle envelope (yr 1–25, high scenario) | **$3.00 bn cumulative** | $2,310 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.97 bn cumulative** | $2,284 |

_Population basis: 1,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $13 M / yr → $1.7 M / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $431 M | 7.2% | 25 y, 5 y grace | $41 M / yr |
| Government equity (no debt service) | 15% | $259 M | — | — | — |
| **Total** | **100%** | **$1.72 bn** | | | **$117 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $41 M / yr + bonds $31 M / yr = **$72 M / yr** total — plus the equity tranche amortised across construction ($52 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 102,024 | 170,040 | 180,079 |
| Daily paid trips / catchment | 18% | 30% | 32% |
| Daily paid trips / city population | 8% | 13% | 14% |
| Annual paid trips | 37.2 M | 62.1 M | 65.7 M |
| Farebox revenue | $17 M / yr | $29 M / yr | $30 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| **Total revenue** | **$25 M / yr** | **$36 M / yr** | **$38 M / yr** |
| Revenue / OPEX recovery | 65% | 96% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $131 M / yr | $119 M / yr | **$117 M / yr** |
