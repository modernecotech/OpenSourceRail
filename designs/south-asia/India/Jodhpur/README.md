...
| Bucket | Value |
|---|---|
| At-grade (86.5 km @ €3.5 M/km) | €303 M |
| Elevated (62.2 km @ €18 M/km) | €1.12 bn |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 124 | €4.0 M | €496 M |
...
| Per-capita (city pop) | €1,865 / person |
...
|---|---|---|
| Construction (years 1–5) | **€175 M / yr** | €134 |
| Steady-state, low-ridership (year 6+) | **€215 M / yr** | €165 |
| Steady-state, high-ridership (year 6+) | **€206 M / yr** | €159 |
| Lifecycle envelope (yr 1–25, low scenario) | **€5.17 bn cumulative** | €3,975 |
| Lifecycle envelope (yr 1–25, high scenario) | **€5.00 bn cumulative** | €3,846 |

_Population basis: 1,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€50 M / yr (low) → €41 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €606 M | 7.2% | 25 y, 5 y grace | €58 M / yr |
| Government equity (no debt service) | 15% | €364 M | — | — | — |
| **Total** | **100%** | **€2.42 bn** | | | **€165 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €58 M / yr + bonds €44 M / yr = **€102 M / yr** total — plus the equity tranche amortised across construction (€73 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (910 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.2 M |
...
| Farebox revenue | €8.4 M / yr | €17 M / yr |
| Farebox / OPEX recovery | 14% | 29% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €50 M / yr | €41 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€215 M / yr** | **€206 M / yr** |
