...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 124 | $5.60 M | $694 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 496 | $100 k | $50 M |
| High sensitivity check | 496 | $200 k | $99 M |
...
| Per-capita (city pop) | $1,830 / person |
...
|---|---|---|
| Construction (years 1–5) | **$171 M / yr** | $132 |
| Steady-state, low-ridership (year 6+) | **$198 M / yr** | $152 |
| Steady-state, high-ridership (year 6+) | **$186 M / yr** | $143 |
| Steady-state, operating-neutral revenue case | **$162 M / yr** | $125 |
| Lifecycle envelope (yr 1–25, low scenario) | **$4.81 bn cumulative** | $3,699 |
| Lifecycle envelope (yr 1–25, high scenario) | **$4.58 bn cumulative** | $3,523 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$4.10 bn cumulative** | $3,151 |

_Population basis: 1,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $36 M / yr → $24 M / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $595 M | 7.2% | 25 y, 5 y grace | $57 M / yr |
| Government equity (no debt service) | 15% | $357 M | — | — | — |
| **Total** | **100%** | **$2.38 bn** | | | **$162 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $57 M / yr + bonds $43 M / yr = **$100 M / yr** total — plus the equity tranche amortised across construction ($71 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 102,024 | 170,040 | 313,987 |
| Daily paid trips / catchment | 18% | 30% | 55% |
| Daily paid trips / city population | 8% | 13% | 24% |
| Annual paid trips | 37.2 M | 62.1 M | 114.6 M |
| Farebox revenue | $17 M / yr | $29 M / yr | $53 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| **Total revenue** | **$25 M / yr** | **$36 M / yr** | **$60 M / yr** |
| Revenue / OPEX recovery | 41% | 60% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $198 M / yr | $186 M / yr | **$162 M / yr** |
