...
| Bucket | Value |
|---|---|
| At-grade (126.2 km @ €3.5 M/km) | €442 M |
| Elevated (15.7 km @ €18 M/km) | €283 M |
| Elevated-interchange premium (6 sites @ €20 M) | €120 M |
| **Civil subtotal** | **€845 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 121 | €4.0 M | €484 M |
...
|---|---|---|
| Construction (years 1–5) | **€124 M / yr** | €69 |
| Steady-state, low-ridership (year 6+) | **€151 M / yr** | €84 |
| Steady-state, high-ridership (year 6+) | **€139 M / yr** | €77 |
| Lifecycle envelope (yr 1–25, low scenario) | **€3.64 bn cumulative** | €2,021 |
| Lifecycle envelope (yr 1–25, high scenario) | **€3.41 bn cumulative** | €1,892 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€33 M / yr (low) → €21 M / yr (high)._
...
| Labour (869 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.1 M |
...
| Farebox revenue | €12 M / yr | €23 M / yr |
| Farebox / OPEX recovery | 26% | 52% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €33 M / yr | €21 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€151 M / yr** | **€139 M / yr** |
