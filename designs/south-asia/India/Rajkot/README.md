...
| Steady-state, high-ridership (year 6+) | **$48 M / yr** | $27 |
| Steady-state, operating-neutral revenue case | **$48 M / yr** | $27 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.11 bn cumulative** | $1,170 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.03 bn cumulative** | $1,127 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.03 bn cumulative** | $1,127 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.2 M / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $50 M / yr | $48 M / yr | **$48 M / yr** |
