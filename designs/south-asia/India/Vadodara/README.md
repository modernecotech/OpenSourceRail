...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 137 | $5.60 M | $767 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 548 | $100 k | $55 M |
| High sensitivity check | 548 | $200 k | $110 M |
...
|---|---|---|
| Construction (years 1–5) | **$155 M / yr** | $70 |
| Steady-state, low-ridership (year 6+) | **$164 M / yr** | $74 |
| Steady-state, high-ridership (year 6+) | **$146 M / yr** | $67 |
| Steady-state, operating-neutral revenue case | **$146 M / yr** | $67 |
| Lifecycle envelope (yr 1–25, low scenario) | **$4.05 bn cumulative** | $1,840 |
| Lifecycle envelope (yr 1–25, high scenario) | **$3.70 bn cumulative** | $1,683 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$3.70 bn cumulative** | $1,683 |

_Population basis: 2,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $17 M / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $538 M | 7.2% | 25 y, 5 y grace | $52 M / yr |
| Government equity (no debt service) | 15% | $323 M | — | — | — |
| **Total** | **100%** | **$2.15 bn** | | | **$146 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $52 M / yr + bonds $39 M / yr = **$90 M / yr** total — plus the equity tranche amortised across construction ($65 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 189,288 | 315,480 | 291,855 |
| Daily paid trips / catchment | 18% | 30% | 28% |
| Daily paid trips / city population | 9% | 14% | 13% |
| Annual paid trips | 69.1 M | 115.2 M | 106.5 M |
| Farebox revenue | $32 M / yr | $53 M / yr | $49 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| **Total revenue** | **$40 M / yr** | **$62 M / yr** | **$58 M / yr** |
| Revenue / OPEX recovery | 70% | 107% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $164 M / yr | $146 M / yr | **$146 M / yr** |
