...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.19 bn (87.0%) of external capital** and **$2.70 bn of external interest**. Capital plus saved interest totals **$4.89 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 65.7% |
| Route length (double track) | 150.2 km |
| Revenue fleet | 186 × 4-car trainsets |
| Revenue fleet passenger capacity | 89,280 AW2 pax (119,040 AW3 crush) |
...
| Revenue fleet capacity | 89,280 AW2 pax (119,040 AW3 crush) |
| Total fleet capacity | 99,360 AW2 pax (132,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 186 × 480 = **89,280 AW2 passengers** (119,040 AW3 crush)
- **Total fleet passenger capacity:** 207 × 480 = **99,360 AW2 passengers** (132,480 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 65.7%
- Catchment population: **≈ 1,445,400** (within ~800 m walk of a station)
...
| Onboard battery adequacy | 8.8× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 638 kWh usable margin across the worst powered-stop gap (line-5) |
| Lowest traversal charging margin | 161 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 134 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 59,883 train-km/day | One-way train journeys × route length |
| Annual service work | 23.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,035 MWh/day | 94.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 900 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 172.6 MW / 1,035 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 277 kWh | 466 kWh | 161 kWh | 7.0 km / 75 kWh |
| line-2 | 9 | 202 kWh | 490 kWh | 268 kWh | 3.4 km / 36 kWh |
| line-3 | 8 | 179 kWh | 441 kWh | 244 kWh | 3.0 km / 32 kWh |
| line-4 | 10 | 247 kWh | 539 kWh | 268 kWh | 5.5 km / 59 kWh |
| line-5 | 8 | 249 kWh | 441 kWh | 167 kWh | 7.6 km / 82 kWh |
| line-6 | 16 | 461 kWh | 784 kWh | 277 kWh | 5.5 km / 59 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (141.9 km @ $2.58 M/km) | $367 M |
| Elevated (8.3 km @ $9.75 M/km) | $81 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$479 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 207 | $1.12 M | $232 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 828 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 828 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 172,574 kW @ $700/kW | $121 M |
| Grid interconnection / PPA tie-in | 172,574 kW @ $100/kW | $17 M |
| Annual generation proxy | 172.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 377.9 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 150.2 km × $0.050 M/km | $7.5 M |
...
| Per-capita (city pop) | $637 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $479 M | 15% | $72 M | $407 M |
| Stations | $434 M | 20% | $87 M | $347 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $232 M | 35% | $81 M | $151 M |
| Dedicated solar plant | $138 M | 45% | $62 M | $76 M |
| Residual signalling / train control | $7.5 M | 50% | $3.8 M | $3.8 M |
| Charging microgrids | $20 M | 40% | $8.1 M | $12 M |
| EPC / project services | $83 M | 15% | $12 M | $70 M |
| **Total city CAPEX** | **$1.40 bn** | **23.4%** | **$328 M** | **$1.07 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh vadodara`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$328 M** | **$66 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$1.07 bn** | **$215 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $858 M | $172 M / yr |
| **Total city programme** | **100.0%** | **$1.40 bn** | **$280 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.89 bn | $1.56 bn (82.7%) | $1.92 bn | **$3.49 bn** |
| **Default** | 2.00× | $2.52 bn | $2.19 bn (87.0%) | $2.70 bn | **$4.89 bn** |
| High | 3.00× | $3.78 bn | $3.45 bn (91.3%) | $4.25 bn | **$7.70 bn** |

At the default 2.00× case, OSR's $328 M external requirement is 87.0% below the illustrative foreign-company requirement of $2.52 bn; the associated lifetime external-interest saving is $2.70 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$119 M / yr** | $54 |
| Steady-state, low capacity-use (year 6+) | **$3.0 M / yr** | $1 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$87 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$704 M cumulative** | $320 |
| Lifecycle envelope (yr 1–40, high scenario) | **$597 M cumulative** | $272 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.63 bn cumulative** | $1,648 |

_Population basis: 2,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $83 M / yr → $87 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $328 M | 4.5% | 40 y, 5 y grace | $19 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $858 M | 7.2% | 40 y, 5 y grace | $68 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $215 M | — | — | — |
| **Total** | **100%** | **$1.40 bn** | | | **$87 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $15 M / yr + local bonds $62 M / yr = **$77 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($43 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $376 k |
| Traction energy (377.7 GWh / yr) | 59,883 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 49.1 GWh/yr + dedicated solar plant 172.6 MW / 377.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.1 M |
| Labour (848 FTE) | driverless roster: OCC/remote 130, station/platform 316, passenger service 111, fleet maintenance 141, infrastructure/energy 123, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.3 M |
| **OPEX subtotal** | | **$33 M / yr** |

_Annual service work: 59,883 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 23.6 M train-km / yr (94.4 M car-km / yr). On-site PV covers 49.1 GWh/yr and the dedicated solar plant adds 377.9 GWh/yr against 377.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 207 trainsets, 61 stations, 150.2 route-km, 6 lines, and 59,883 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 43.1 M |
| Annual paid trips / city resident | 81 | 130 | 20 |
| Farebox revenue | $110 M / yr | $176 M / yr | $26 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.2 M / yr | $4.2 M / yr | $4.2 M / yr |
| **Total revenue** | **$117 M / yr** | **$183 M / yr** | **$33 M / yr** |
| Revenue / OPEX recovery | 350% | 547% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $87 M / yr | $87 M / yr | **$87 M / yr** |
| Operating surplus applied to debt support | -$83 M / yr | -$87 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.0 M / yr | $0 k / yr | **$87 M / yr** |
| Operating surplus after OPEX (before debt support) | $83 M / yr | $149 M / yr | $0 / yr |

_Commercial-revenue assumptions: 14,328 m² of station shop/kiosk leases at $18/m²/month and 2,556 advertising boards at $161/board/month, with occupancy derates applied._
...
| Avoided road congestion | $48 M / yr | $78 M / yr | 606 M - 969 M vehicle-km/yr avoided × $0.08/vehicle-km |
...
|---|---:|---:|---:|
| Education | 2 education anchors | 22,588 trips/school day; 5.0 M access-events/yr | 36,141 trips/school day; 8.0 M access-events/yr |
| Healthcare | 31 healthcare anchors | 64,981 trips/day; 23.7 M access-events/yr | 103,970 trips/day; 37.9 M access-events/yr |
| Commerce | 41 major/terminal/interchange nodes | 113,221 trips/trading day; 37.4 M access-events/yr | 181,154 trips/trading day; 59.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.07 bn | 77% of $1.40 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.72 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $343 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 97,182 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.26 bn |
| Timetable-sized dedicated solar CAPEX | $138 M |
| **Reconciled project CAPEX** | **$1.40 bn** |
| Imported / external-capital requirement | $328 M (23.4%) |
| Local-content / local-funding requirement | $1.07 bn (76.6%) |
| Default foreign-turnkey external-capital comparison | $2.52 bn; OSR saves $2.19 bn (87.0%) |
| Lifetime external interest and combined financing saving | $2.70 bn interest; $4.89 bn capital + interest |
| 15%–25% planning risk envelope | $1.61 bn–$1.75 bn |
| Annual OPEX | $33 M / yr |
| Low/high project NPV at 8% | $-456455 k / $67 M |
| Low/high project IRR | 4.2% / 8.5% |
| Low/high steady-state DSCR | 0.96 / 1.73 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,924.93 train-km; 52,958.24 kWh consumed; 55,477.92 kWh charged; 55 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 59,861.41 train-km; 643,694.97 kWh consumed; 651,505.88 kWh charged; 981 depot services completed (10 active at cutoff); minimum SoC 62%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 48.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 61.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.5% / 60% | pass |
| ten-hour single charging-pad outage | 56.7% | 100.0% / 90% | pass |
...
|---|---|
| ![Vadodara energy and battery simulation dashboard](engineering/screenshots/vadodara-simulation-dashboard.png) | ![Vadodara simulator network visualizer](engineering/screenshots/vadodara-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 61 line platforms, 7 interchange complexes, 41 civil segments, and 0 input findings |
...
|---|---|
| ![Vadodara QGIS engineering layers](engineering/screenshots/vadodara-qgis-engineering-map.png) | ![Vadodara SUMO timetable validation](engineering/screenshots/vadodara-sumo-validation.png) |
...
scripts/regenerate-city.sh vadodara
```
