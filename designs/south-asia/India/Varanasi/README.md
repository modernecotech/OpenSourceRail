...
|---|---|---|---|---|
| line-1 | 32.7 km | 16 | 68 | SW Mid ↔ NE Outer |
| line-2 | 40.6 km | 20 | 82 | NW Outer ↔ SE Outer |
| line-3 | 17.0 km | 11 | 40 | N Mid ↔ W Mid |
| line-4 | 24.7 km | 13 | 53 | NW Mid ↔ S Outer |
| line-5 | 21.8 km | 12 | 48 | NW Mid ↔ E Outer |
| line-6 | 64.5 km | 38 | 35 | NW Mid ↔ NW Mid |
| **Total** | **201.4 km** | **110 unique** | **326** | |
...
| Total fleet capacity | 156,480 AW2 pax (208,640 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 293 × 480 = **140,640 AW2 passengers** (187,520 AW3 crush)
- **Total fleet passenger capacity:** 326 × 480 = **156,480 AW2 passengers** (208,640 AW3 crush, incl. service rotation + spare + reserve)
...
| **Total installed** | **97** | **33,800 kW** | **184,000 kWh** |

Aggregate station-rail charging power: **145,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **221.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 606 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 328 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 203 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,156 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 221.6 MW / 1,330 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 184 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 352 kWh | 735 kWh | 348 kWh | 10.6 km / 114 kWh |
| line-2 | 15 | 437 kWh | 808 kWh | 328 kWh | 10.3 km / 111 kWh |
| line-3 | 11 | 183 kWh | 588 kWh | 387 kWh | 2.0 km / 22 kWh |
| line-4 | 12 | 266 kWh | 637 kWh | 345 kWh | 6.5 km / 70 kWh |
| line-5 | 11 | 235 kWh | 588 kWh | 330 kWh | 4.7 km / 51 kWh |
| line-6 | 34 | 694 kWh | 1,666 kWh | 903 kWh | 7.3 km / 79 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (160.0 km @ $3.0 M/km) | $480 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 326 | $1.12 M | $365 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1304 | $60 k | $78 M |
| High sensitivity check | 1304 | $120 k | $156 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 221,591 kW @ $700/kW | $155 M |
| Grid interconnection / PPA tie-in | 221,591 kW @ $100/kW | $22 M |
| Annual generation proxy | 221.6 MW × 6.0 peak-sun-h/day × 365 d/yr | 485.3 GWh/yr |
...
| EPC integration + project management (7%) | on subtotal | $146 M |
...
| EPC overhead (7%) | $146 M |
| **CAPEX total** | **$2.41 bn** |
| Per-route-km | $12 M / km |
| Per-capita (city pop) | $1,603 / person |
...
|---|---|---|
| Construction (years 1–5) | **$183 M / yr** | $122 |
| Steady-state, low capacity-use (year 6+) | **$45 M / yr** | $30 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$110 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.50 bn cumulative** | $1,665 |
| Lifecycle envelope (yr 1–40, high scenario) | **$914 M cumulative** | $609 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.77 bn cumulative** | $3,181 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.92 bn | 4.5% | 40 y, 5 y grace | $110 M / yr |
| Government equity (no debt service) | 20% | $481 M | — | — | — |
...
| Traction energy (496.0 GWh / yr) | 78,642 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 74.0 GWh/yr + dedicated solar plant 221.6 MW / 485.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.7 M |
| Labour (1,128 FTE) | driverless roster: OCC/remote 183, station/platform 431, passenger service 111, fleet maintenance 202, infrastructure/energy 174, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $4.4 M |
| **OPEX subtotal** | | **$54 M / yr** |

_Annual service work: 78,642 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 31.0 M train-km / yr (124.0 M car-km / yr). On-site PV covers 74.0 GWh/yr and the dedicated solar plant adds 485.3 GWh/yr against 496.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 326 trainsets, 110 stations, 201.4 route-km, 6 lines, and 78,642 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 73.3 M |
...
| **Total revenue** | **$119 M / yr** | **$185 M / yr** | **$54 M / yr** |
| Revenue / OPEX recovery | 220% | 342% | 100% |
...
_Commercial-revenue assumptions: 18,264 m² of station shop/kiosk leases at $18/m²/month and 3,376 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 3 education anchors | 23,257 trips/school day; 5.1 M access-events/yr | 37,212 trips/school day; 8.2 M access-events/yr |
| Healthcare | 31 healthcare anchors | 58,523 trips/day; 21.4 M access-events/yr | 93,637 trips/day; 34.2 M access-events/yr |
| Commerce | 44 major/terminal/interchange nodes | 99,190 trips/trading day; 32.7 M access-events/yr | 158,704 trips/trading day; 52.4 M access-events/yr |
...
| Annualised during construction | $442 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 125,193 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,513.34 train-km; 59,285.06 kWh consumed; 63,335.32 kWh charged; 37 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 78,737.94 train-km; 846,670.04 kWh consumed; 859,244.92 kWh charged; 1,012 depot services completed (7 active at cutoff); minimum SoC 79%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| maximum planning climate/HVAC duty | 76.1% | 100.0% / 90% | pass |
| 50% charging-contact availability | 79.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 89.0% / 60% | pass |
| ten-hour single charging-pad outage | 79.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 110 line platforms, 13 interchange complexes, 60 civil segments, and 0 input findings |
