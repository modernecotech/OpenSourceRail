...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.70 bn (87.3%) of external capital** and **$3.33 bn of external interest**. Capital plus saved interest totals **$6.03 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 49.1% |
| Route length (double track) | 201.4 km |
...
| Total fleet capacity | 116,640 AW2 pax (155,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 218 × 480 = **104,640 AW2 passengers** (139,520 AW3 crush)
- **Total fleet passenger capacity:** 243 × 480 = **116,640 AW2 passengers** (155,520 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 49.1%
- Catchment population: **≈ 736,500** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **235.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.7× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 593 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 127 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 131 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 78,642 train-km/day | One-way train journeys × route length |
...
| Dedicated solar plant | 235.4 MW / 1,412 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 352 kWh | 514 kWh | 127 kWh | 11.8 km / 127 kWh |
| line-2 | 11 | 437 kWh | 723 kWh | 243 kWh | 10.3 km / 111 kWh |
| line-3 | 8 | 183 kWh | 441 kWh | 240 kWh | 3.0 km / 32 kWh |
| line-4 | 7 | 266 kWh | 453 kWh | 161 kWh | 9.6 km / 103 kWh |
| line-5 | 8 | 235 kWh | 441 kWh | 183 kWh | 4.7 km / 51 kWh |
| line-6 | 15 | 694 kWh | 1,102 kWh | 339 kWh | 9.5 km / 102 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (163.9 km @ $2.58 M/km) | $423 M |
| Elevated (37.5 km @ $9.75 M/km) | $366 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$821 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 243 | $1.12 M | $272 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 972 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 972 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 235,391 kW @ $700/kW | $165 M |
| Grid interconnection / PPA tie-in | 235,391 kW @ $100/kW | $24 M |
| Annual generation proxy | 235.4 MW × 6.0 peak-sun-h/day × 365 d/yr | 515.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$188 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 201.4 km × $0.050 M/km | $10 M |
...
|---|---:|---:|---:|---:|
| Civil works | $821 M | 15% | $123 M | $698 M |
| Stations | $303 M | 20% | $61 M | $243 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $272 M | 35% | $95 M | $177 M |
| Dedicated solar plant | $188 M | 45% | $85 M | $104 M |
| Residual signalling / train control | $10 M | 50% | $5.0 M | $5.0 M |
| Charging microgrids | $18 M | 40% | $7.4 M | $11 M |
| EPC / project services | $100 M | 15% | $15 M | $85 M |
| **Total city CAPEX** | **$1.72 bn** | **22.8%** | **$393 M** | **$1.33 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh varanasi`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.8%** | **$393 M** | **$79 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.2%** | **$1.33 bn** | **$266 M / yr** |
| of which planned local bond issuance | 61.7% of total CAPEX | $1.06 bn | $212 M / yr |
| **Total city programme** | **100.0%** | **$1.72 bn** | **$344 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.32 bn | $1.93 bn (83.1%) | $2.37 bn | **$4.30 bn** |
| **Default** | 2.00× | $3.10 bn | $2.70 bn (87.3%) | $3.33 bn | **$6.03 bn** |
| High | 3.00× | $4.65 bn | $4.25 bn (91.5%) | $5.23 bn | **$9.48 bn** |

At the default 2.00× case, OSR's $393 M external requirement is 87.3% below the illustrative foreign-company requirement of $3.10 bn; the associated lifetime external-interest saving is $3.33 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$147 M / yr** | $98 |
| Steady-state, low capacity-use (year 6+) | **$32 M / yr** | $21 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$106 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.84 bn cumulative** | $1,227 |
| Lifecycle envelope (yr 1–40, high scenario) | **$736 M cumulative** | $491 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.46 bn cumulative** | $2,973 |

_Population basis: 1,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $75 M / yr → $106 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $393 M | 4.5% | 40 y, 5 y grace | $23 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.06 bn | 7.2% | 40 y, 5 y grace | $84 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $266 M | — | — | — |
| **Total** | **100%** | **$1.72 bn** | | | **$106 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $18 M / yr + local bonds $76 M / yr = **$94 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($53 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (496.0 GWh / yr) | 78,642 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 47.7 GWh/yr + dedicated solar plant 235.4 MW / 515.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.8 M |
| Labour (861 FTE) | driverless roster: OCC/remote 146, station/platform 242, passenger service 111, fleet maintenance 177, infrastructure/energy 158, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.3 M |
| **OPEX subtotal** | | **$40 M / yr** |

_Annual service work: 78,642 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 31.0 M train-km / yr (124.0 M car-km / yr). On-site PV covers 47.7 GWh/yr and the dedicated solar plant adds 515.5 GWh/yr against 496.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 243 trainsets, 64 stations, 201.4 route-km, 6 lines, and 78,642 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 57.2 M |
| Annual paid trips / city resident | 119 | 191 | 38 |
| Farebox revenue | $110 M / yr | $176 M / yr | $35 M / yr |
| Station shop leases | $2.0 M / yr | $2.0 M / yr | $2.0 M / yr |
| Advertising boards | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| **Total revenue** | **$115 M / yr** | **$181 M / yr** | **$40 M / yr** |
| Revenue / OPEX recovery | 286% | 450% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $106 M / yr | $106 M / yr | **$106 M / yr** |
| Operating surplus applied to debt support | -$75 M / yr | -$106 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $32 M / yr | $0 k / yr | **$106 M / yr** |
| Operating surplus after OPEX (before debt support) | $75 M / yr | $141 M / yr | $0 / yr |

_Commercial-revenue assumptions: 10,088 m² of station shop/kiosk leases at $18/m²/month and 1,904 advertising boards at $161/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $54 M / yr | $87 M / yr | 20% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 1 education anchors | 21,409 trips/school day; 4.7 M access-events/yr | 34,255 trips/school day; 7.5 M access-events/yr |
| Healthcare | 24 healthcare anchors | 62,460 trips/day; 22.8 M access-events/yr | 99,936 trips/day; 36.5 M access-events/yr |
| Commerce | 26 major/terminal/interchange nodes | 99,512 trips/trading day; 32.8 M access-events/yr | 159,220 trips/trading day; 52.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.33 bn | 77% of $1.72 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.12 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $425 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 120,283 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $188 M |
| **Reconciled project CAPEX** | **$1.72 bn** |
| Imported / external-capital requirement | $393 M (22.8%) |
| Local-content / local-funding requirement | $1.33 bn (77.2%) |
| Default foreign-turnkey external-capital comparison | $3.10 bn; OSR saves $2.70 bn (87.3%) |
| Lifetime external interest and combined financing saving | $3.33 bn interest; $6.03 bn capital + interest |
| 15%–25% planning risk envelope | $1.98 bn–$2.15 bn |
| Annual OPEX | $40 M / yr |
| Low/high project NPV at 8% | $-780796 k / $-257635 k |
| Low/high project IRR | 2.2% / 6.4% |
| Low/high steady-state DSCR | 0.70 / 1.32 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,853.91 train-km; 62,947.80 kWh consumed; 63,759.32 kWh charged; 44 depot services completed; minimum SoC 77%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 75,905.46 train-km; 816,220.69 kWh consumed; 823,249.74 kWh charged; 1,000 depot services completed (8 active at cutoff); minimum SoC 60%; 0 onboard emergencies; 0 invariant violations; 96.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 50.5% | 96.5% / 90% | pass |
| maximum planning climate/HVAC duty | 30.2% | 96.5% / 90% | pass |
| 50% charging-contact availability | 60.4% | 96.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 67.7% / 60% | pass |
| ten-hour single charging-pad outage | 59.3% | 96.5% / 90% | pass |
...
|---|---|
| ![Varanasi energy and battery simulation dashboard](engineering/screenshots/varanasi-simulation-dashboard.png) | ![Varanasi simulator network visualizer](engineering/screenshots/varanasi-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 64 line platforms, 9 interchange complexes, 54 civil segments, and 0 input findings |
...
|---|---|
| ![Varanasi QGIS engineering layers](engineering/screenshots/varanasi-qgis-engineering-map.png) | ![Varanasi SUMO timetable validation](engineering/screenshots/varanasi-sumo-validation.png) |
