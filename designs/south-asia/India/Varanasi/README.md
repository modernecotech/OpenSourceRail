...
|---|---|---|---|---|
| line-1 | 41.5 km | 20 | 56 | NW Outer ↔ SE Mid |
| line-2 | 35.2 km | 17 | 48 | E Outer ↔ W Outer |
| line-3 | 31.6 km | 17 | 43 | NE Outer ↔ SW Mid |
| line-4 | 26.6 km | 13 | 37 | NW Inner ↔ S Outer |
| line-5 | 67.1 km | 33 | 87 | NW Mid ↔ NW Mid |
| **Total** | **202.0 km** | **99 unique** | **271** | |
...
| Total fleet capacity | 130,080 AW2 pax (173,440 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 244 × 480 = **117,120 AW2 passengers** (156,160 AW3 crush)
- **Total fleet passenger capacity:** 271 × 480 = **130,080 AW2 passengers** (173,440 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **357.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 210 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,763 MWh/day | 102,002 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,553 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 357.1 MW / 1,785 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 271 | $5.60 M | $1.52 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1084 | $100 k | $108 M |
| High sensitivity check | 1084 | $200 k | $217 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 357,095 kW @ $700/kW | $250 M |
| Grid interconnection / PPA tie-in | 357,095 kW @ $100/kW | $36 M |
| Annual generation proxy | 357.1 MW × 5.0 peak-sun-h/day × 365 d/yr | 651.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$286 M** |
...
| Stations | $466 M |
| Depots | $26 M |
| Rolling stock | $1.52 bn |
| Railway production plant | $108 M |
| Dedicated solar power plant | $286 M |
...
|---|---|---|
| Construction (years 1–5) | **$201 M / yr** | $134 |
| Steady-state, low capacity-use (year 6+) | **$118 M / yr** | $79 |
| Steady-state, high capacity-use (year 6+) | **$66 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$115 M / yr** | $76 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.13 bn cumulative** | $3,417 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.32 bn cumulative** | $2,213 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.02 bn cumulative** | $3,344 |

_Population basis: 1,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.1 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $48 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.87 bn | 2.0% | 40 y, 5 y grace | $115 M / yr |
| Government equity (no debt service) | 20% | $716 M | — | — | — |
| **Total** | **100%** | **$3.58 bn** | | | **$115 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $57 M / yr = **$57 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($143 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (643.3 GWh / yr) | 102,002 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 76.7 GWh/yr + dedicated solar plant 357.1 MW / 651.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.3 M |
| Labour (1,087 FTE) | driverless roster: OCC/remote 154, station/platform 384, passenger service 89, fleet maintenance 216, infrastructure/energy 198, admin/training 46; no train drivers × country median × 12 × engineer-premium 1.4 | $4.2 M |
| **OPEX subtotal** | | **$98 M / yr** |

_Annual service work: 102,002 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 40.2 M train-km / yr (160.8 M car-km / yr). On-site PV covers 76.7 GWh/yr and the dedicated solar plant adds 651.7 GWh/yr against 643.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 140.2 M | 224.3 M | 145.3 M |
| Annual paid trips / city resident | 93 | 150 | 97 |
| Farebox revenue | $86 M / yr | $138 M / yr | $89 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$95 M / yr** | **$146 M / yr** | **$98 M / yr** |
| Revenue / OPEX recovery | 97% | 150% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $118 M / yr | $115 M / yr | **$115 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$48 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $118 M / yr | $66 M / yr | **$115 M / yr** |
| Operating surplus after OPEX (before debt support) | $0 k / yr | $48 M / yr | $0 / yr |
...
| Station-area commerce turnover supported | $47 M / yr | $76 M / yr | 23% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $22 M / yr | $36 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$162 M / yr** | **$260 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 17,088 trips/school day; 3.8 M access-events/yr | 27,341 trips/school day; 6.0 M access-events/yr |
| Healthcare | 36 healthcare anchors | 47,232 trips/day; 17.2 M access-events/yr | 75,571 trips/day; 27.6 M access-events/yr |
| Commerce | 62 major/terminal/interchange nodes | 86,691 trips/trading day; 28.6 M access-events/yr | 138,705 trips/trading day; 45.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.88 bn | 52% of $3.58 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.00 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $600 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 169,966 job-years | retained CAPEX ÷ (4.0 × median annual income) |
