...
| Bucket | Value |
|---|---|
| At-grade (170.1 km @ €3.5 M/km) | €595 M |
| Elevated (31.0 km @ €18 M/km) | €559 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 165 | €4.0 M | €660 M |
...
|---|---|---|
| Construction (years 1–5) | **€175 M / yr** | €117 |
| Steady-state, low-ridership (year 6+) | **€219 M / yr** | €146 |
| Steady-state, high-ridership (year 6+) | **€209 M / yr** | €139 |
| Lifecycle envelope (yr 1–25, low scenario) | **€5.25 bn cumulative** | €3,502 |
| Lifecycle envelope (yr 1–25, high scenario) | **€5.06 bn cumulative** | €3,373 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€53 M / yr (low) → €43 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €609 M | 7.2% | 25 y, 5 y grace | €58 M / yr |
| Government equity (no debt service) | 15% | €366 M | — | — | — |
| **Total** | **100%** | **€2.44 bn** | | | **€166 M / yr** |
...
| Labour (1,224 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €4.4 M |
...
| Operating shortfall (gov subsidy required) | €53 M / yr | €43 M / yr |
