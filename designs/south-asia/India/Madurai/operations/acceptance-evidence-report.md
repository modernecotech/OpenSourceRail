# Madurai Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,006 |
| Manufacturing schedule rows | 3,537 |
| Manufacturing material/BOM rows | 49,037 |
| Manufacturing QA verification rows | 3,537 |
| Construction QA action rows | 3,219 |
| Maintenance handover schedule rows | 4,300 |
| Manufacturing rows with material refs | 3,537 / 3,537 |
| Manufacturing rows with verification refs | 3,537 / 3,537 |
| Manufacturing rows linked to QA actions | 3,537 / 3,537 |
...
|---|---:|
| `project_kit` | 7,034 |
| `rolling_stock_bom` | 39,490 |
| `rolling_stock_cots_fitout` | 2,513 |
...
| `qa-10-carbody-structure` | 718 |
| `qa-11-bogie-wheelset` | 359 |
| `qa-12-traction-brake-battery` | 359 |
| `qa-13-passenger-systems` | 359 |
| `qa-15-first-article-trainset` | 359 |
| `qa-20-survey-geotech` | 115 |
| `qa-21-earthworks-drainage` | 115 |
| `qa-22-trackform-rail` | 243 |
| `qa-24-stations-depots-plant` | 244 |
| `qa-25-power-energy` | 193 |
| `qa-26-wayside-comms-safety` | 472 |
