...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.65 bn (86.3%) of external capital** and **$3.26 bn of external interest**. Capital plus saved interest totals **$5.92 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (213.9 km @ $2.58 M/km) | $553 M |
| Elevated (10.4 km @ $9.75 M/km) | $101 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$690 M** |
...
|---|---:|---:|---:|---:|
| Civil works | $690 M | 15% | $103 M | $586 M |
...
| EPC / project services | $94 M | 15% | $14 M | $80 M |
| **Total city CAPEX** | **$1.71 bn** | **24.7%** | **$423 M** | **$1.29 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.7%** | **$423 M** | **$85 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.3%** | **$1.29 bn** | **$257 M / yr** |
| of which planned local bond issuance | 60.2% of total CAPEX | $1.03 bn | $206 M / yr |
| **Total city programme** | **100.0%** | **$1.71 bn** | **$342 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.31 bn | $1.88 bn (81.7%) | $2.32 bn | **$4.20 bn** |
| **Default** | 2.00× | $3.08 bn | $2.65 bn (86.3%) | $3.26 bn | **$5.92 bn** |
| High | 3.00× | $4.62 bn | $4.19 bn (90.8%) | $5.15 bn | **$9.35 bn** |

At the default 2.00× case, OSR's $423 M external requirement is 86.3% below the illustrative foreign-company requirement of $3.08 bn; the associated lifetime external-interest saving is $3.26 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$145 M / yr** | $90 |
| Steady-state, low capacity-use (year 6+) | **$31 M / yr** | $19 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$105 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.80 bn cumulative** | $1,123 |
| Lifecycle envelope (yr 1–40, high scenario) | **$723 M cumulative** | $452 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.41 bn cumulative** | $2,759 |

_Population basis: 1,600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $75 M / yr → $105 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $423 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $1.03 bn | 7.2% | 40 y, 5 y grace | $81 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $257 M | — | — | — |
| **Total** | **100%** | **$1.71 bn** | | | **$105 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $74 M / yr = **$93 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($51 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 57.3 M |
| Annual paid trips / city resident | 112 | 179 | 36 |
...
| Revenue / OPEX recovery | 285% | 448% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $105 M / yr | $105 M / yr | **$105 M / yr** |
| Operating surplus applied to debt support | -$75 M / yr | -$105 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $31 M / yr | $0 k / yr | **$105 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.29 bn | 75% of $1.71 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 116,536 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.44 bn |
| Timetable-sized dedicated solar CAPEX | $271 M |
| **Reconciled project CAPEX** | **$1.71 bn** |
| Imported / external-capital requirement | $423 M (24.7%) |
| Local-content / local-funding requirement | $1.29 bn (75.3%) |
| Default foreign-turnkey external-capital comparison | $3.08 bn; OSR saves $2.65 bn (86.3%) |
| Lifetime external interest and combined financing saving | $3.26 bn interest; $5.92 bn capital + interest |
| 15%–25% planning risk envelope | $1.97 bn–$2.14 bn |
| Annual OPEX | $40 M / yr |
| Low/high project NPV at 8% | $-772022 k / $-248861 k |
| Low/high project IRR | 2.3% / 6.4% |
| Low/high steady-state DSCR | 0.71 / 1.33 |
