...
| Bucket | Value |
|---|---|
| At-grade (207.1 km @ €3.5 M/km) | €725 M |
| Elevated (14.0 km @ €18 M/km) | €252 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 183 | €4.0 M | €732 M |
...
|---|---|---|
| Construction (years 1–5) | **€175 M / yr** | €109 |
| Steady-state, low-ridership (year 6+) | **€219 M / yr** | €137 |
| Steady-state, high-ridership (year 6+) | **€209 M / yr** | €131 |
| Lifecycle envelope (yr 1–25, low scenario) | **€5.26 bn cumulative** | €3,286 |
| Lifecycle envelope (yr 1–25, high scenario) | **€5.05 bn cumulative** | €3,157 |

_Population basis: 1,600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€54 M / yr (low) → €44 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.46 bn | 4.0% | 25 y, 5 y grace | €107 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €607 M | 7.2% | 25 y, 5 y grace | €58 M / yr |
| Government equity (no debt service) | 15% | €364 M | — | — | — |
| **Total** | **100%** | **€2.43 bn** | | | **€165 M / yr** |
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | €166 k |
| Traction energy (512.3 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (1,346 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €4.8 M |
...
|---|---|---|
| Annual paid trips | 29.2 M | 58.4 M |
| Farebox revenue | €10 M / yr | €21 M / yr |
| Farebox / OPEX recovery | 16% | 32% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €54 M / yr | €44 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€219 M / yr** | **€209 M / yr** |
