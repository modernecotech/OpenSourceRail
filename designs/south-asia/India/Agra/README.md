...
|---|---|---|
| Construction (years 1–5) | **$120 M / yr** | $70 |
| Steady-state, low capacity-use (year 6+) | **$12 M / yr** | $7 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$72 M / yr** | $42 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.00 bn cumulative** | $590 |
| Lifecycle envelope (yr 1–40, high scenario) | **$599 M cumulative** | $352 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.12 bn cumulative** | $1,838 |

_Population basis: 1,700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $61 M / yr → $72 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.26 bn | 4.5% | 40 y, 5 y grace | $72 M / yr |
| Government equity (no debt service) | 20% | $315 M | — | — | — |
| **Total** | **100%** | **$1.58 bn** | | | **$72 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $57 M / yr = **$57 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($63 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Operating surplus applied to debt support | -$61 M / yr | -$72 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $12 M / yr | $0 k / yr | **$72 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $902 M | 57% of $1.58 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.44 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $289 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 81,747 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.43 bn |
| Timetable-sized dedicated solar CAPEX | $142 M |
| **Reconciled project CAPEX** | **$1.58 bn** |
| 15%–25% planning risk envelope | $1.81 bn–$1.97 bn |
| Annual OPEX | $35 M / yr |
| Low/high project NPV at 8% | $-777141 k / $-349101 k |
| Low/high project IRR | 1.6% / 5.5% |
| Low/high steady-state DSCR | 0.84 / 1.59 |
