...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **164,475 – 296,055 trips/day**
...
| Per-capita (city pop) | $1,802 / person |
...
|---|---|---|
| Construction (years 1–5) | **$92 M / yr** | $54 |
| Steady-state, low-ridership (year 6+) | **$103 M / yr** | $61 |
| Steady-state, high-ridership (year 6+) | **$74 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$61 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.08 bn cumulative** | $2,401 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.05 bn cumulative** | $1,794 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.60 bn cumulative** | $1,532 |

_Population basis: 1,700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $42 M / yr → $13 M / yr._
...
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $1.53 bn | 2.0% | 40 y, 5 y grace | $61 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 7.2% | 40 y, 5 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $306 M | — | — | — |
| **Total** | **100%** | **$3.06 bn** | | | **$61 M / yr** |
...
| Traction energy (726.0 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,158 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $4.5 M |
| **OPEX subtotal** | | **$88 M / yr** |

_Annual fleet utilisation: 231 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 45.4 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 164,475 | 296,055 | 352,941 |
| Daily paid trips / catchment | 25% | 45% | 54% |
| Daily paid trips / city population | 10% | 17% | 21% |
| Annual paid trips | 60.0 M | 108.1 M | 128.8 M |
| Farebox revenue | $37 M / yr | $66 M / yr | $79 M / yr |
| Station shop leases | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| Advertising boards | $5.4 M / yr | $5.4 M / yr | $5.4 M / yr |
| **Total revenue** | **$46 M / yr** | **$75 M / yr** | **$88 M / yr** |
| Revenue / OPEX recovery | 52% | 86% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov repayable-debt service + residual OPEX subsidy | $103 M / yr | $74 M / yr | **$61 M / yr** |
