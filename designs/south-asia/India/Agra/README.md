...
| Elevated (14.5 km @ $9.0 M/km) | $131 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 191.0 km × $0.015 M/km | $9.5 M |
...
|---|---|---|
| Construction (years 1–5) | **$85 M / yr** | $50 |
| Steady-state, low-ridership (year 6+) | **$81 M / yr** | $47 |
| Steady-state, high-ridership (year 6+) | **$80 M / yr** | $47 |
| Steady-state, operating-neutral revenue case | **$80 M / yr** | $47 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.04 bn cumulative** | $1,198 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.03 bn cumulative** | $1,193 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.03 bn cumulative** | $1,193 |

_Population basis: 1,700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $467 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $706 M | 4.0% | 25 y, 5 y grace | $52 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $294 M | 7.2% | 25 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 15% | $177 M | — | — | — |
| **Total** | **100%** | **$1.18 bn** | | | **$80 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $28 M / yr + bonds $21 M / yr = **$49 M / yr** total — plus the equity tranche amortised across construction ($35 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 118,422 | 197,370 | 121,202 |
| Daily paid trips / catchment | 18% | 30% | 18% |
| Daily paid trips / city population | 7% | 12% | 7% |
| Annual paid trips | 43.2 M | 72.0 M | 44.2 M |
| Farebox revenue | $20 M / yr | $33 M / yr | $20 M / yr |
| Station shop leases | $3.5 M / yr | $3.5 M / yr | $3.5 M / yr |
| Advertising boards | $5.4 M / yr | $5.4 M / yr | $5.4 M / yr |
| **Total revenue** | **$29 M / yr** | **$42 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 98% | 144% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $81 M / yr | $80 M / yr | **$80 M / yr** |
