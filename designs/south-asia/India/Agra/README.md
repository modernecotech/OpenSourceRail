...
|---|---|---|
| Construction (years 1–5) | **$187 M / yr** | $110 |
| Steady-state, low capacity-use (year 6+) | **$103 M / yr** | $61 |
| Steady-state, high capacity-use (year 6+) | **$52 M / yr** | $30 |
| Steady-state, operating-neutral revenue case | **$107 M / yr** | $63 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.55 bn cumulative** | $2,676 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.74 bn cumulative** | $1,614 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.66 bn cumulative** | $2,744 |

_Population basis: 1,700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $3.3 M / yr → $55 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.67 bn | 2.0% | 40 y, 5 y grace | $107 M / yr |
| Government equity (no debt service) | 20% | $666 M | — | — | — |
| **Total** | **100%** | **$3.33 bn** | | | **$107 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $53 M / yr = **$53 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($133 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Labour (1,071 FTE) | driverless roster: OCC/remote 146, station/platform 395, passenger service 89, fleet maintenance 204, infrastructure/energy 191, admin/training 46; no train drivers × country median × 12 × engineer-premium 1.4 | $4.1 M |
...
| Annual paid trips | 140.2 M | 224.3 M | 134.8 M |
| Annual paid trips / city resident | 82 | 132 | 79 |
...
| **Total revenue** | **$95 M / yr** | **$146 M / yr** | **$92 M / yr** |
| Revenue / OPEX recovery | 104% | 160% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $107 M / yr | $107 M / yr | **$107 M / yr** |
| Operating surplus applied to debt support | -$3.3 M / yr | -$55 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $103 M / yr | $52 M / yr | **$107 M / yr** |
| Operating surplus after OPEX (before debt support) | $3.3 M / yr | $55 M / yr | $0 / yr |
...
| Healthcare | 20 healthcare anchors | 38,043 trips/day; 13.9 M access-events/yr | 60,868 trips/day; 22.2 M access-events/yr |
| Commerce | 58 major/terminal/interchange nodes | 85,549 trips/trading day; 28.2 M access-events/yr | 136,878 trips/trading day; 45.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.73 bn | 52% of $3.33 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.78 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $555 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 157,113 job-years | retained CAPEX ÷ (4.0 × median annual income) |
