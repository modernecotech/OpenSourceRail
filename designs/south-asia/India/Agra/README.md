...
|---|---|---|---|---|
| line-1 | 23.3 km | 15 | 54 | NW Mid ↔ SE Outer |
| line-2 | 24.0 km | 13 | 52 | S Mid ↔ NE Outer |
| line-3 | 22.6 km | 15 | 53 | NE Mid ↔ W Outer |
| line-4 | 30.7 km | 19 | 68 | SE Outer ↔ NW Outer |
| line-5 | 59.7 km | 36 | 32 | W Outer ↔ W Mid |
| **Total** | **160.2 km** | **98 unique** | **259** | |
...
| Total fleet capacity | 124,320 AW2 pax (165,760 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 234 × 480 = **112,320 AW2 passengers** (149,760 AW3 crush)
- **Total fleet passenger capacity:** 259 × 480 = **124,320 AW2 passengers** (165,760 AW3 crush, incl. service rotation + spare + reserve)
...
| Interchange | 34 | 300 kW | 1500 kWh |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **163.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.4× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 657 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 353 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 852 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 163.3 MW / 980 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 250 kWh | 784 kWh | 509 kWh | 2.5 km / 26 kWh |
| line-2 | 12 | 258 kWh | 637 kWh | 353 kWh | 5.9 km / 63 kWh |
| line-3 | 15 | 243 kWh | 784 kWh | 517 kWh | 2.3 km / 25 kWh |
| line-4 | 17 | 330 kWh | 906 kWh | 543 kWh | 5.7 km / 62 kWh |
| line-5 | 34 | 642 kWh | 1,666 kWh | 960 kWh | 5.1 km / 55 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 259 | $1.12 M | $290 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1036 | $60 k | $62 M |
| High sensitivity check | 1036 | $120 k | $124 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 163,315 kW @ $700/kW | $114 M |
| Grid interconnection / PPA tie-in | 163,315 kW @ $100/kW | $16 M |
| Annual generation proxy | 163.3 MW × 6.0 peak-sun-h/day × 365 d/yr | 357.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$131 M** |
...
| Dedicated solar power plant | $131 M |
...
|---|---|---|
| Construction (years 1–5) | **$148 M / yr** | $87 |
| Steady-state, low capacity-use (year 6+) | **$34 M / yr** | $20 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$89 M / yr** | $52 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.92 bn cumulative** | $1,131 |
| Lifecycle envelope (yr 1–40, high scenario) | **$739 M cumulative** | $435 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.86 bn cumulative** | $2,270 |

_Population basis: 1,700,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $55 M / yr → $89 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.56 bn | 4.5% | 40 y, 5 y grace | $89 M / yr |
| Government equity (no debt service) | 20% | $389 M | — | — | — |
| **Total** | **100%** | **$1.95 bn** | | | **$89 M / yr** |
...
| Traction energy (382.4 GWh / yr) | 60,629 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 71.4 GWh/yr + dedicated solar plant 163.3 MW / 357.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.0 M |
| Labour (999 FTE) | driverless roster: OCC/remote 150, station/platform 431, passenger service 92, fleet maintenance 158, infrastructure/energy 143, admin/training 25; no train drivers × country median × 12 × engineer-premium 1.4 | $3.9 M |
| **OPEX subtotal** | | **$44 M / yr** |

_Annual service work: 60,629 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 23.9 M train-km / yr (95.6 M car-km / yr). On-site PV covers 71.4 GWh/yr and the dedicated solar plant adds 357.7 GWh/yr against 382.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 259 trainsets, 98 stations, 160.2 route-km, 5 lines, and 60,629 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 146.6 M | 234.6 M | 56.4 M |
| Annual paid trips / city resident | 86 | 138 | 33 |
| Farebox revenue | $90 M / yr | $144 M / yr | $35 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.6 M / yr | $5.6 M / yr | $5.6 M / yr |
| **Total revenue** | **$99 M / yr** | **$153 M / yr** | **$44 M / yr** |
| Revenue / OPEX recovery | 226% | 349% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $89 M / yr | $89 M / yr | **$89 M / yr** |
| Operating surplus applied to debt support | -$55 M / yr | -$89 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $34 M / yr | $0 k / yr | **$89 M / yr** |
| Operating surplus after OPEX (before debt support) | $55 M / yr | $109 M / yr | $0 / yr |

_Commercial-revenue assumptions: 19,000 m² of station shop/kiosk leases at $18/m²/month and 3,440 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 11 education anchors | 24,748 trips/school day; 5.4 M access-events/yr | 39,597 trips/school day; 8.7 M access-events/yr |
| Healthcare | 23 healthcare anchors | 38,218 trips/day; 13.9 M access-events/yr | 61,149 trips/day; 22.3 M access-events/yr |
| Commerce | 48 major/terminal/interchange nodes | 84,944 trips/trading day; 28.0 M access-events/yr | 135,910 trips/trading day; 44.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.12 bn | 57% of $1.95 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.79 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $357 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 101,067 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.82 bn |
| Timetable-sized dedicated solar CAPEX | $131 M |
| **Reconciled project CAPEX** | **$1.95 bn** |
| 15%–25% planning risk envelope | $2.24 bn–$2.43 bn |
| Annual OPEX | $44 M / yr |
| Low/high project NPV at 8% | $-1114670 k / $-686630 k |
| Low/high project IRR | -0.0% / 3.8% |
| Low/high steady-state DSCR | 0.62 / 1.23 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 4,206.61 train-km; 45,233.61 kWh consumed; 49,978.82 kWh charged; 28 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 60,912.76 train-km; 654,993.30 kWh consumed; 665,439.64 kWh charged; 829 depot services completed (6 active at cutoff); minimum SoC 88%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |
...
| QGIS/GDAL | GeoPackage generated with 5 corridors, 98 line platforms, 11 interchange complexes, 38 civil segments, and 0 input findings |
