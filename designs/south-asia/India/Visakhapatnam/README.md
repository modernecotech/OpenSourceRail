...
|---|---|---|---|---|
| line-1 | 57.3 km | 25 | 46 | NE Outer ↔ SW Outer |
| line-2 | 32.3 km | 13 | 27 | SW Outer ↔ NE Mid |
| line-3 | 33.0 km | 15 | 27 | S Outer ↔ N Mid |
| line-4 | 31.0 km | 16 | 26 | E Mid ↔ W Outer |
| line-5 | 23.7 km | 9 | 20 | S Inner ↔ NW Outer |
| line-6 | 62.5 km | 32 | 50 | W Mid ↔ W Mid |
| **Total** | **240.0 km** | **109 unique** | **196** | |
...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **213,624 – 299,520 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (221.8 km @ $2.0 M/km) | $444 M |
| Elevated (17.4 km @ $9.0 M/km) | $157 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$636 M** |
...
|---|---|---|---|
| `halt` | 2 | $300 k | $600 k |
| `standard` | 50 | $800 k | $40 M |
| `major` | 25 | $1.60 M | $40 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 196 | $1.07 M | $209 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 240.0 km × $0.015 M/km | $12 M |
...
| Per-capita (city pop) | $516 / person |
...
|---|---|---|
| Construction (years 1–5) | **$86 M / yr** | $37 |
| Steady-state, low-ridership (year 6+) | **$81 M / yr** | $35 |
| Steady-state, high-ridership (year 6+) | **$81 M / yr** | $35 |
| Steady-state, operating-neutral revenue case | **$81 M / yr** | $35 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.05 bn cumulative** | $889 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.05 bn cumulative** | $889 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.05 bn cumulative** | $889 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $713 M | 4.0% | 25 y, 5 y grace | $52 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $297 M | 7.2% | 25 y, 5 y grace | $28 M / yr |
| Government equity (no debt service) | 15% | $178 M | — | — | — |
| **Total** | **100%** | **$1.19 bn** | | | **$81 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $29 M / yr + bonds $21 M / yr = **$50 M / yr** total — plus the equity tranche amortised across construction ($36 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Traction energy (550.0 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,452 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $5.6 M |
| **OPEX subtotal** | | **$31 M / yr** |

_Annual fleet utilisation: 175 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 34.4 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 213,624 | 299,520 | 129,909 |
| Daily paid trips / catchment | 18% | 25% | 11% |
| Daily paid trips / city population | 9% | 13% | 6% |
| Annual paid trips | 78.0 M | 109.3 M | 47.4 M |
| Farebox revenue | $36 M / yr | $50 M / yr | $22 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.8 M / yr | $5.8 M / yr | $5.8 M / yr |
| **Total revenue** | **$45 M / yr** | **$60 M / yr** | **$31 M / yr** |
| Revenue / OPEX recovery | 145% | 191% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $81 M / yr | $81 M / yr | **$81 M / yr** |
| Operating surplus after OPEX | $14 M / yr | $28 M / yr | $0 / yr |
