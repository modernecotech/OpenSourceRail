...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 196 | $5.60 M | $1.10 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 784 | $100 k | $78 M |
| High sensitivity check | 784 | $200 k | $157 M |
...
|---|---|---|
| Construction (years 1–5) | **$210 M / yr** | $91 |
| Steady-state, low-ridership (year 6+) | **$233 M / yr** | $102 |
| Steady-state, high-ridership (year 6+) | **$210 M / yr** | $91 |
| Steady-state, operating-neutral revenue case | **$199 M / yr** | $86 |
| Lifecycle envelope (yr 1–25, low scenario) | **$5.72 bn cumulative** | $2,487 |
| Lifecycle envelope (yr 1–25, high scenario) | **$5.24 bn cumulative** | $2,279 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$5.03 bn cumulative** | $2,187 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $35 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.75 bn | 4.0% | 25 y, 5 y grace | $129 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $730 M | 7.2% | 25 y, 5 y grace | $70 M / yr |
| Government equity (no debt service) | 15% | $438 M | — | — | — |
| **Total** | **100%** | **$2.92 bn** | | | **$199 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $70 M / yr + bonds $53 M / yr = **$123 M / yr** total — plus the equity tranche amortised across construction ($88 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 213,624 | 356,040 | 419,300 |
| Daily paid trips / catchment | 18% | 30% | 35% |
| Daily paid trips / city population | 9% | 15% | 18% |
| Annual paid trips | 78.0 M | 130.0 M | 153.0 M |
| Farebox revenue | $36 M / yr | $60 M / yr | $70 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.8 M / yr | $5.8 M / yr | $5.8 M / yr |
| **Total revenue** | **$45 M / yr** | **$69 M / yr** | **$80 M / yr** |
| Revenue / OPEX recovery | 57% | 87% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $233 M / yr | $210 M / yr | **$199 M / yr** |
