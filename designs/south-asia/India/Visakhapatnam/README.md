...
| Rolling stock | $320 M | 55% | $176 M | $144 M |
| Dedicated solar plant | $288 M | 70% | $201 M | $86 M |
...
| **Total city CAPEX** | **$2.21 bn** | **44.5%** | **$980 M** | **$1.22 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.5%** | **$980 M** | **$196 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.5%** | **$1.22 bn** | **$245 M / yr** |
| of which planned local bond issuance | 44.4% of total CAPEX | $980 M | $196 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$164 M / yr** | $71 |
| Steady-state, low capacity-use (year 6+) | **$67 M / yr** | $29 |
| Steady-state, high capacity-use (year 6+) | **$1.2 M / yr** | $1 |
| Steady-state, operating-neutral revenue case | **$133 M / yr** | $58 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.17 bn cumulative** | $1,378 |
| Lifecycle envelope (yr 1–40, high scenario) | **$861 M cumulative** | $374 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.49 bn cumulative** | $2,387 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 44% | $980 M | 4.5% | 40 y, 5 y grace | $56 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $980 M | 7.2% | 40 y, 5 y grace | $77 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $245 M | — | — | — |
| **Total** | **100%** | **$2.21 bn** | | | **$133 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $44 M / yr + local bonds $71 M / yr = **$115 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($49 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $67 M / yr | $1.2 M / yr | **$133 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.22 bn | 56% of $2.21 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.96 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $392 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 110,939 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $980 M (44.5%) |
| Local-content / local-funding requirement | $1.22 bn (55.5%) |
| 15%–25% planning risk envelope | $2.54 bn–$2.76 bn |
| Annual OPEX | $50 M / yr |
| Low/high project NPV at 8% | $-1235042 k / $-711882 k |
| Low/high project IRR | 0.3% / 4.2% |
| Low/high steady-state DSCR | 0.50 / 0.99 |
