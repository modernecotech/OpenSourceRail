...
| Bucket | Value |
|---|---|
| At-grade (221.8 km @ €3.5 M/km) | €776 M |
| Elevated (17.4 km @ €18 M/km) | €314 M |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 196 | €4.0 M | €784 M |
...
|---|---|---|
| Construction (years 1–5) | **€186 M / yr** | €81 |
| Steady-state, low-ridership (year 6+) | **€229 M / yr** | €100 |
| Steady-state, high-ridership (year 6+) | **€214 M / yr** | €93 |
| Lifecycle envelope (yr 1–25, low scenario) | **€5.51 bn cumulative** | €2,397 |
| Lifecycle envelope (yr 1–25, high scenario) | **€5.22 bn cumulative** | €2,268 |

_Population basis: 2,300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€54 M / yr (low) → €39 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.55 bn | 4.0% | 25 y, 5 y grace | €114 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €645 M | 7.2% | 25 y, 5 y grace | €62 M / yr |
| Government equity (no debt service) | 15% | €387 M | — | — | — |
| **Total** | **100%** | **€2.58 bn** | | | **€176 M / yr** |
...
| Labour (1,452 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €5.2 M |
...
| Operating shortfall (gov subsidy required) | €54 M / yr | €39 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€229 M / yr** | **€214 M / yr** |
