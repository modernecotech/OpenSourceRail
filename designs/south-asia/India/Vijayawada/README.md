...
|---|---|---|---|---|
| line-1 | 33.1 km | 19 | 71 | NW Outer ↔ SE Mid |
| line-2 | 28.8 km | 16 | 63 | NE Mid ↔ SW Outer |
| line-3 | 43.4 km | 22 | 89 | E Outer ↔ W Outer |
| line-4 | 25.0 km | 12 | 51 | E Mid ↔ NW Outer |
| line-5 | 23.3 km | 12 | 50 | NE Inner ↔ S Outer |
| line-6 | 74.7 km | 38 | 37 | NW Mid ↔ W Mid |
| **Total** | **228.3 km** | **119 unique** | **361** | |
...
| Total fleet capacity | 173,280 AW2 pax (231,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 325 × 480 = **156,000 AW2 passengers** (208,000 AW3 crush)
- **Total fleet passenger capacity:** 361 × 480 = **173,280 AW2 passengers** (231,040 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **328.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 215 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 162 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,372 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 328.7 MW / 1,578 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 17 | 330 kWh | 882 kWh | 519 kWh | 9.1 km / 91 kWh |
| line-2 | 16 | 287 kWh | 833 kWh | 517 kWh | 2.9 km / 28 kWh |
| line-3 | 18 | 433 kWh | 956 kWh | 479 kWh | 11.5 km / 115 kWh |
| line-4 | 9 | 250 kWh | 490 kWh | 215 kWh | 11.8 km / 118 kWh |
| line-5 | 11 | 233 kWh | 588 kWh | 332 kWh | 6.2 km / 62 kWh |
| line-6 | 26 | 746 kWh | 1,274 kWh | 454 kWh | 10.2 km / 102 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (207.2 km @ $3.0 M/km) | $622 M |
| Elevated (21.1 km @ $12.0 M/km) | $253 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 361 | $1.12 M | $404 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1444 | $60 k | $87 M |
| High sensitivity check | 1444 | $120 k | $173 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 328,685 kW @ $700/kW | $230 M |
| Grid interconnection / PPA tie-in | 328,685 kW @ $100/kW | $33 M |
| Annual generation proxy | 328.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 575.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$263 M** |
...
| EPC integration + project management (7%) | on subtotal | $143 M |
...
| Depots | $8.0 M |
| Rolling stock | $404 M |
| Railway production plant | $87 M |
| Dedicated solar power plant | $263 M |
| Residual train-control wayside + charging microgrids | $43 M |
| EPC overhead (7%) | $143 M |
| **CAPEX total** | **$2.45 bn** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $1,633 / person |
...
|---|---|---|
| Construction (years 1–5) | **$186 M / yr** | $124 |
| Steady-state, low capacity-use (year 6+) | **$48 M / yr** | $32 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$112 M / yr** | $75 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.63 bn cumulative** | $1,752 |
| Lifecycle envelope (yr 1–40, high scenario) | **$931 M cumulative** | $620 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.86 bn cumulative** | $3,239 |

_Population basis: 1,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $64 M / yr → $112 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.96 bn | 4.5% | 40 y, 5 y grace | $112 M / yr |
| Government equity (no debt service) | 20% | $490 M | — | — | — |
| **Total** | **100%** | **$2.45 bn** | | | **$112 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $88 M / yr = **$88 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($98 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (560.0 GWh / yr) | 88,781 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 59.2 GWh/yr + dedicated solar plant 328.7 MW / 575.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.9 M |
| Labour (1,207 FTE) | driverless roster: OCC/remote 199, station/platform 450, passenger service 111, fleet maintenance 225, infrastructure/energy 195, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $4.7 M |
| **OPEX subtotal** | | **$56 M / yr** |

_Annual service work: 88,781 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 35.0 M train-km / yr (140.0 M car-km / yr). On-site PV covers 59.2 GWh/yr and the dedicated solar plant adds 575.9 GWh/yr against 560.0 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 361 trainsets, 119 stations, 228.3 route-km, 6 lines, and 88,781 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 75.3 M |
| Annual paid trips / city resident | 119 | 191 | 50 |
...
| **Total revenue** | **$119 M / yr** | **$185 M / yr** | **$56 M / yr** |
| Revenue / OPEX recovery | 215% | 334% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $112 M / yr | $112 M / yr | **$112 M / yr** |
| Operating surplus applied to debt support | -$64 M / yr | -$112 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $48 M / yr | $0 k / yr | **$112 M / yr** |
| Operating surplus after OPEX (before debt support) | $64 M / yr | $130 M / yr | $0 / yr |

_Commercial-revenue assumptions: 18,736 m² of station shop/kiosk leases at $18/m²/month and 3,472 advertising boards at $161/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$201 M / yr** | **$321 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 10 education anchors | 28,195 trips/school day; 6.2 M access-events/yr | 45,112 trips/school day; 9.9 M access-events/yr |
| Healthcare | 32 healthcare anchors | 50,751 trips/day; 18.5 M access-events/yr | 81,202 trips/day; 29.6 M access-events/yr |
| Commerce | 45 major/terminal/interchange nodes | 98,064 trips/trading day; 32.4 M access-events/yr | 156,902 trips/trading day; 51.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.37 bn | 56% of $2.45 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 124,341 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.19 bn |
| Timetable-sized dedicated solar CAPEX | $263 M |
| **Reconciled project CAPEX** | **$2.45 bn** |
| 15%–25% planning risk envelope | $2.82 bn–$3.06 bn |
| Annual OPEX | $56 M / yr |
| Low/high project NPV at 8% | $-1450262 k / $-927101 k |
| Low/high project IRR | -0.5% / 3.4% |
| Low/high steady-state DSCR | 0.57 / 1.16 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,005.93 train-km; 59,967.13 kWh consumed; 63,996.10 kWh charged; 32 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 89,308.78 train-km; 891,716.57 kWh consumed; 905,454.19 kWh charged; 1,026 depot services completed (5 active at cutoff); minimum SoC 79%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 73.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 78.5% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.3% / 60% | pass |
| ten-hour single charging-pad outage | 78.5% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 119 line platforms, 13 interchange complexes, 111 civil segments, and 0 input findings |
