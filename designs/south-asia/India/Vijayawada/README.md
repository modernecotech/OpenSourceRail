...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 184 | $5.60 M | $1.03 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 736 | $100 k | $74 M |
| High sensitivity check | 736 | $200 k | $147 M |
...
| Per-capita (city pop) | $1,812 / person |
...
|---|---|---|
| Construction (years 1–5) | **$196 M / yr** | $130 |
| Steady-state, low-ridership (year 6+) | **$226 M / yr** | $150 |
| Steady-state, high-ridership (year 6+) | **$208 M / yr** | $139 |
| Steady-state, operating-neutral revenue case | **$185 M / yr** | $123 |
| Lifecycle envelope (yr 1–25, low scenario) | **$5.49 bn cumulative** | $3,660 |
| Lifecycle envelope (yr 1–25, high scenario) | **$5.14 bn cumulative** | $3,426 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$4.68 bn cumulative** | $3,120 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $40 M / yr → $23 M / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $679 M | 7.2% | 25 y, 5 y grace | $65 M / yr |
...
|---|---|---|---|
| Daily paid trips | 156,599 | 260,999 | 397,548 |
| Daily paid trips / catchment | 18% | 30% | 46% |
| Daily paid trips / city population | 10% | 17% | 27% |
| Annual paid trips | 57.2 M | 95.3 M | 145.1 M |
| Farebox revenue | $26 M / yr | $44 M / yr | $67 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$34 M / yr** | **$52 M / yr** | **$75 M / yr** |
| Revenue / OPEX recovery | 46% | 69% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $226 M / yr | $208 M / yr | **$185 M / yr** |
