...
|---|---|---|---|---|
| line-1 | 33.7 km | 14 | 46 | NE Outer ↔ S Outer |
| line-2 | 29.9 km | 15 | 41 | W Mid ↔ E Outer |
| line-3 | 26.7 km | 14 | 37 | SW Outer ↔ N Mid |
| line-4 | 25.0 km | 10 | 35 | NE Mid ↔ W Outer |
| line-5 | 27.6 km | 14 | 38 | E Mid ↔ W Outer |
| line-6 | 72.8 km | 29 | 95 | NW Mid ↔ NW Mid |
| **Total** | **215.8 km** | **95 unique** | **292** | |
...
| Total fleet capacity | 140,160 AW2 pax (186,880 AW3 crush, incl. spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 262 × 480 = **125,760 AW2 passengers** (167,680 AW3 crush)
- **Total fleet passenger capacity:** 292 × 480 = **140,160 AW2 passengers** (186,880 AW3 crush, incl. spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **388.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 195 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,883 MWh/day | 108,963 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,688 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 388.2 MW / 1,941 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 292 | $5.60 M | $1.64 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1168 | $100 k | $117 M |
| High sensitivity check | 1168 | $200 k | $234 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 388,214 kW @ $700/kW | $272 M |
| Grid interconnection / PPA tie-in | 388,214 kW @ $100/kW | $39 M |
| Annual generation proxy | 388.2 MW × 5.0 peak-sun-h/day × 365 d/yr | 708.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$311 M** |
...
| Stations | $447 M |
| Depots | $30 M |
| Rolling stock | $1.64 bn |
| Railway production plant | $117 M |
| Dedicated solar power plant | $311 M |
| Residual train-control wayside + charging microgrids | $51 M |
| EPC overhead (7%) | $216 M |
| **CAPEX total** | **$3.61 bn** |
| Per-route-km | $17 M / km |
| Per-capita (city pop) | $2,576 / person |
...
|---|---|---|
| Construction (years 1–5) | **$202 M / yr** | $144 |
| Steady-state, low capacity-use (year 6+) | **$105 M / yr** | $75 |
| Steady-state, high capacity-use (year 6+) | **$43 M / yr** | $31 |
| Steady-state, operating-neutral revenue case | **$115 M / yr** | $82 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.68 bn cumulative** | $3,344 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.51 bn cumulative** | $1,796 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.05 bn cumulative** | $3,606 |

_Population basis: 1,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $10 M / yr → $72 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $2.88 bn | 2.0% | 40 y, 5 y grace | $115 M / yr |
| Government equity (no debt service) | 20% | $721 M | — | — | — |
| **Total** | **100%** | **$3.61 bn** | | | **$115 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $58 M / yr = **$58 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($144 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (687.3 GWh / yr) | 108,963 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 71.2 GWh/yr + dedicated solar plant 388.2 MW / 708.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.7 M |
| Labour (1,128 FTE) | driverless roster: OCC/remote 167, station/platform 355, passenger service 107, fleet maintenance 231, infrastructure/energy 214, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $4.4 M |
| **OPEX subtotal** | | **$100 M / yr** |

_Annual service work: 108,963 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 43.0 M train-km / yr (171.8 M car-km / yr). On-site PV covers 71.2 GWh/yr and the dedicated solar plant adds 708.5 GWh/yr against 687.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 168.2 M | 269.1 M | 151.1 M |
| Annual paid trips / city resident | 120 | 192 | 108 |
| Farebox revenue | $103 M / yr | $165 M / yr | $93 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$111 M / yr** | **$173 M / yr** | **$100 M / yr** |
| Revenue / OPEX recovery | 110% | 172% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $115 M / yr | $115 M / yr | **$115 M / yr** |
| Operating surplus applied to debt support | -$10 M / yr | -$72 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $105 M / yr | $43 M / yr | **$115 M / yr** |
| Operating surplus after OPEX (before debt support) | $10 M / yr | $72 M / yr | $0 / yr |
...
| Station-area commerce turnover supported | $54 M / yr | $86 M / yr | 21% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 4 education anchors | 22,051 trips/school day; 4.9 M access-events/yr | 35,282 trips/school day; 7.8 M access-events/yr |
| Healthcare | 27 healthcare anchors | 46,650 trips/day; 17.0 M access-events/yr | 74,640 trips/day; 27.2 M access-events/yr |
| Commerce | 49 major/terminal/interchange nodes | 98,684 trips/trading day; 32.6 M access-events/yr | 157,894 trips/trading day; 52.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.86 bn | 52% of $3.61 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 168,604 job-years | retained CAPEX ÷ (4.0 × median annual income) |
