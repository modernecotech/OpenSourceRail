...
| Bucket | Value |
|---|---|
| At-grade (201.9 km @ $2.0 M/km) | $404 M |
| Elevated (12.8 km @ $9.0 M/km) | $115 M |
| Elevated-interchange premium (9 sites @ $4.50 M) | $40 M |
| **Civil subtotal** | **$559 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 179 | $1.07 M | $191 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 215.8 km × $0.015 M/km | $11 M |
...
|---|---|---|
| Construction (years 1–5) | **$75 M / yr** | $54 |
| Steady-state, low-ridership (year 6+) | **$71 M / yr** | $51 |
| Steady-state, high-ridership (year 6+) | **$71 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$71 M / yr** | $51 |
| Lifecycle envelope (yr 1–25, low scenario) | **$1.79 bn cumulative** | $1,281 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.79 bn cumulative** | $1,281 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$1.79 bn cumulative** | $1,281 |

_Population basis: 1,400,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 124,740 | 207,900 | 119,277 |
| Daily paid trips / catchment | 18% | 30% | 17% |
| Daily paid trips / city population | 9% | 15% | 9% |
| Annual paid trips | 45.5 M | 75.9 M | 43.5 M |
| Farebox revenue | $21 M / yr | $35 M / yr | $20 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$29 M / yr** | **$43 M / yr** | **$28 M / yr** |
| Revenue / OPEX recovery | 103% | 153% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $71 M / yr | $71 M / yr | **$71 M / yr** |
| Operating surplus after OPEX | $917 k / yr | $15 M / yr | $0 / yr |
