...
| Revenue fleet | 325 × 4-car trainsets |
| Revenue fleet passenger capacity | 156,000 AW2 pax (208,000 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 35.6 km | 20 | 78 | NE Outer ↔ SW Mid |
| line-2 | 26.6 km | 18 | 62 | N Mid ↔ S Mid |
| line-3 | 22.9 km | 13 | 52 | E Mid ↔ W Mid |
| line-4 | 30.2 km | 17 | 65 | E Outer ↔ SW Mid |
| line-5 | 27.1 km | 18 | 63 | NW Outer ↔ SE Mid |
| line-6 | 79.2 km | 42 | 40 | NW Mid ↔ NW Mid |
| **Total** | **221.5 km** | **128 unique** | **360** | |
...
| Revenue fleet capacity | 156,000 AW2 pax (208,000 AW3 crush) |
| Total fleet capacity | 172,800 AW2 pax (230,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 325 × 480 = **156,000 AW2 passengers** (208,000 AW3 crush)
- **Total fleet passenger capacity:** 360 × 480 = **172,800 AW2 passengers** (230,400 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 61 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **120** | **40,700 kW** | **218,500 kWh** |

Aggregate station-rail charging power: **180,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **303.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.3× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 633 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 435 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 195 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,266 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 303.4 MW / 1,456 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 218 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 19 | 355 kWh | 1,004 kWh | 614 kWh | 5.0 km / 50 kWh |
| line-2 | 18 | 265 kWh | 931 kWh | 639 kWh | 2.1 km / 21 kWh |
| line-3 | 13 | 228 kWh | 686 kWh | 435 kWh | 2.3 km / 23 kWh |
| line-4 | 15 | 302 kWh | 784 kWh | 452 kWh | 7.3 km / 73 kWh |
| line-5 | 18 | 270 kWh | 931 kWh | 634 kWh | 2.1 km / 21 kWh |
| line-6 | 37 | 791 kWh | 1,813 kWh | 943 kWh | 8.7 km / 87 kWh |
...
| Elevated (17.8 km @ $12.0 M/km) | $214 M |
| Elevated-interchange premium (13 sites @ $4.50 M) | $58 M |
| **Civil subtotal** | **$883 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 360 | $1.12 M | $403 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1440 | $60 k | $86 M |
| High sensitivity check | 1440 | $120 k | $173 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 303,373 kW @ $700/kW | $212 M |
| Grid interconnection / PPA tie-in | 303,373 kW @ $100/kW | $30 M |
| Annual generation proxy | 303.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 531.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$243 M** |
...
|---|---|---|
| Construction (years 1–5) | **$194 M / yr** | $138 |
| Steady-state, low capacity-use (year 6+) | **$53 M / yr** | $38 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$117 M / yr** | $83 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.81 bn cumulative** | $2,011 |
| Lifecycle envelope (yr 1–40, high scenario) | **$968 M cumulative** | $692 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.05 bn cumulative** | $3,610 |

_Population basis: 1,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $64 M / yr → $117 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.04 bn | 4.5% | 40 y, 5 y grace | $117 M / yr |
| Government equity (no debt service) | 20% | $510 M | — | — | — |
| **Total** | **100%** | **$2.55 bn** | | | **$117 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $92 M / yr = **$92 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($102 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (533.5 GWh / yr) | 84,584 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 71.3 GWh/yr + dedicated solar plant 303.4 MW / 531.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.6 M |
| Labour (1,289 FTE) | driverless roster: OCC/remote 199, station/platform 539, passenger service 111, fleet maintenance 220, infrastructure/energy 193, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.0 M |
| **OPEX subtotal** | | **$58 M / yr** |

_Annual service work: 84,584 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 33.3 M train-km / yr (133.4 M car-km / yr). On-site PV covers 71.3 GWh/yr and the dedicated solar plant adds 531.5 GWh/yr against 533.5 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 360 trainsets, 128 stations, 221.5 route-km, 6 lines, and 84,584 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 74.9 M |
| Annual paid trips / city resident | 128 | 205 | 54 |
| Farebox revenue | $110 M / yr | $176 M / yr | $46 M / yr |
| Station shop leases | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| Advertising boards | $7.0 M / yr | $7.0 M / yr | $7.0 M / yr |
| **Total revenue** | **$122 M / yr** | **$188 M / yr** | **$58 M / yr** |
| Revenue / OPEX recovery | 211% | 326% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $117 M / yr | $117 M / yr | **$117 M / yr** |
| Operating surplus applied to debt support | -$64 M / yr | -$117 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $53 M / yr | $0 k / yr | **$117 M / yr** |
| Operating surplus after OPEX (before debt support) | $64 M / yr | $130 M / yr | $0 / yr |

_Commercial-revenue assumptions: 23,552 m² of station shop/kiosk leases at $18/m²/month and 4,292 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 4 education anchors | 22,361 trips/school day; 4.9 M access-events/yr | 35,778 trips/school day; 7.9 M access-events/yr |
| Healthcare | 30 healthcare anchors | 45,327 trips/day; 16.5 M access-events/yr | 72,523 trips/day; 26.5 M access-events/yr |
| Commerce | 59 major/terminal/interchange nodes | 102,332 trips/trading day; 33.8 M access-events/yr | 163,731 trips/trading day; 54.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.43 bn | 56% of $2.55 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.30 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $459 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 129,947 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $243 M |
| **Reconciled project CAPEX** | **$2.55 bn** |
| 15%–25% planning risk envelope | $2.93 bn–$3.18 bn |
| Annual OPEX | $58 M / yr |
| Low/high project NPV at 8% | $-1527127 k / $-1003967 k |
| Low/high project IRR | -0.6% / 3.2% |
| Low/high steady-state DSCR | 0.55 / 1.11 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,567.36 train-km; 55,588.05 kWh consumed; 61,766.86 kWh charged; 30 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 85,012.46 train-km; 848,818.14 kWh consumed; 864,221.74 kWh charged; 1,011 depot services completed (5 active at cutoff); minimum SoC 85%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 82.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 128 line platforms, 14 interchange complexes, 58 civil segments, and 0 input findings |
