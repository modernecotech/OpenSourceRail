...
|---|---|---|
| Construction (years 1–5) | **$91 M / yr** | $65 |
| Steady-state, low-ridership (year 6+) | **$89 M / yr** | $63 |
| Steady-state, high-ridership (year 6+) | **$86 M / yr** | $61 |
| Steady-state, operating-neutral revenue case | **$86 M / yr** | $61 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.23 bn cumulative** | $1,592 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.17 bn cumulative** | $1,547 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.17 bn cumulative** | $1,547 |

_Population basis: 1,400,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $755 M | 4.0% | 25 y, 5 y grace | $56 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $314 M | 7.2% | 25 y, 5 y grace | $30 M / yr |
| Government equity (no debt service) | 15% | $189 M | — | — | — |
| **Total** | **100%** | **$1.26 bn** | | | **$86 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $30 M / yr + bonds $23 M / yr = **$53 M / yr** total — plus the equity tranche amortised across construction ($38 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 124,740 | 207,900 | 143,326 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 9% | 15% | 10% |
| Annual paid trips | 45.5 M | 75.9 M | 52.3 M |
| Farebox revenue | $21 M / yr | $35 M / yr | $24 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.8 M / yr | $4.8 M / yr | $4.8 M / yr |
| **Total revenue** | **$29 M / yr** | **$43 M / yr** | **$32 M / yr** |
| Revenue / OPEX recovery | 90% | 134% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $89 M / yr | $86 M / yr | **$86 M / yr** |
