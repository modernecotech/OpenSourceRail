...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.89 bn (85.8%) of external capital** and **$7.24 bn of external interest**. Capital plus saved interest totals **$13.13 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (334.8 km @ $3.0 M/km) | $1.00 bn |
| Elevated (33.0 km @ $12.0 M/km) | $396 M |
...
|---|---:|---:|---:|---:|
| Civil works | $1.46 bn | 15% | $220 M | $1.24 bn |
...
| EPC / project services | $213 M | 15% | $32 M | $181 M |
| **Total city CAPEX** | **$3.81 bn** | **25.5%** | **$974 M** | **$2.84 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.5%** | **$974 M** | **$195 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.5%** | **$2.84 bn** | **$568 M / yr** |
| of which planned local bond issuance | 59.6% of total CAPEX | $2.27 bn | $454 M / yr |
| **Total city programme** | **100.0%** | **$3.81 bn** | **$763 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $5.15 bn | $4.17 bn (81.1%) | $5.13 bn | **$9.31 bn** |
| **Default** | 2.00× | $6.86 bn | $5.89 bn (85.8%) | $7.24 bn | **$13.13 bn** |
| High | 3.00× | $10.30 bn | $9.32 bn (90.5%) | $11.46 bn | **$20.78 bn** |

At the default 2.00× case, OSR's $974 M external requirement is 85.8% below the illustrative foreign-company requirement of $6.86 bn; the associated lifetime external-interest saving is $7.24 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$321 M / yr** | $92 |
| Steady-state, low capacity-use (year 6+) | **$94 M / yr** | $27 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$235 M / yr** | $67 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.91 bn cumulative** | $1,403 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.60 bn cumulative** | $459 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.83 bn cumulative** | $2,809 |

_Population basis: 3,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $141 M / yr → $235 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $974 M | 4.5% | 40 y, 5 y grace | $56 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $2.27 bn | 7.2% | 40 y, 5 y grace | $179 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $568 M | — | — | — |
| **Total** | **100%** | **$3.81 bn** | | | **$235 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $44 M / yr + local bonds $164 M / yr = **$207 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($114 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 366.6 M | 586.6 M | 137.4 M |
| Annual paid trips / city resident | 105 | 168 | 39 |
| Farebox revenue | $225 M / yr | $360 M / yr | $84 M / yr |
| Station shop leases | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| Advertising boards | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| **Total revenue** | **$234 M / yr** | **$369 M / yr** | **$94 M / yr** |
| Revenue / OPEX recovery | 250% | 394% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $235 M / yr | $235 M / yr | **$235 M / yr** |
| Operating surplus applied to debt support | -$141 M / yr | -$235 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $94 M / yr | $0 k / yr | **$235 M / yr** |
| Operating surplus after OPEX (before debt support) | $141 M / yr | $276 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.84 bn | 74% of $3.81 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.54 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $909 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 257,225 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.25 bn |
| Timetable-sized dedicated solar CAPEX | $560 M |
| **Reconciled project CAPEX** | **$3.81 bn** |
| Imported / external-capital requirement | $974 M (25.5%) |
| Local-content / local-funding requirement | $2.84 bn (74.5%) |
| Default foreign-turnkey external-capital comparison | $6.86 bn; OSR saves $5.89 bn (85.8%) |
| Lifetime external interest and combined financing saving | $7.24 bn interest; $13.13 bn capital + interest |
| 15%–25% planning risk envelope | $4.39 bn–$4.77 bn |
| Annual OPEX | $94 M / yr |
| Low/high project NPV at 8% | $-1930093 k / $-859992 k |
| Low/high project IRR | 1.3% / 5.5% |
| Low/high steady-state DSCR | 0.60 / 1.17 |
