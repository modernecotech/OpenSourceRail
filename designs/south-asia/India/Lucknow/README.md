...
|---|---:|---:|---:|---:|
| Civil works | $1.46 bn | 35% | $512 M | $951 M |
| Stations | $573 M | 40% | $229 M | $344 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $934 M | 55% | $514 M | $420 M |
| Dedicated solar plant | $560 M | 70% | $392 M | $168 M |
| Residual signalling / train control | $18 M | 80% | $15 M | $3.7 M |
| Charging microgrids | $44 M | 55% | $24 M | $20 M |
| EPC / project services | $213 M | 45% | $96 M | $117 M |
| **Total city CAPEX** | **$3.81 bn** | **46.8%** | **$1.79 bn** | **$2.03 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **46.8%** | **$1.79 bn** | **$357 M / yr** |
| **Local capital for domestic procurement / payroll** | **53.2%** | **$2.03 bn** | **$406 M / yr** |
| of which planned local bond issuance | 42.6% of total CAPEX | $1.62 bn | $325 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$278 M / yr** | $80 |
| Steady-state, low capacity-use (year 6+) | **$90 M / yr** | $26 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$230 M / yr** | $66 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.53 bn cumulative** | $1,295 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.39 bn cumulative** | $398 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.45 bn cumulative** | $2,701 |

_Population basis: 3,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $141 M / yr → $230 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 47% | $1.79 bn | 4.5% | 40 y, 5 y grace | $102 M / yr |
| Local-currency sovereign / project bonds for local content | 43% | $1.62 bn | 7.2% | 40 y, 5 y grace | $128 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $406 M | — | — | — |
| **Total** | **100%** | **$3.81 bn** | | | **$230 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $80 M / yr + local bonds $117 M / yr = **$197 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($81 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Operating surplus applied to debt support | -$141 M / yr | -$230 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $90 M / yr | $0 k / yr | **$230 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.03 bn | 53% of $3.81 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.25 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $649 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 183,741 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $1.79 bn (46.8%) |
| Local-content / local-funding requirement | $2.03 bn (53.2%) |
