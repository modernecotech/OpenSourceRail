...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **197,190 – 328,650 trips/day**
...
| Steady-state, low-ridership (year 6+) | **$80 M / yr** | $23 |
| Steady-state, high-ridership (year 6+) | **$22 M / yr** | $6 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.29 bn cumulative** | $653 |
| Lifecycle envelope (yr 1–25, high scenario) | **$1.11 bn cumulative** | $317 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$677 M cumulative** | $193 |

_Population basis: 3,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 525,000 | 875,000 | 1,003,852 |
| Daily paid trips / population | 15% | 25% | 29% |
| Annual paid trips | 191.6 M | 319.4 M | 366.4 M |
| Farebox revenue | $88 M / yr | $147 M / yr | $169 M / yr |
| Station shop leases | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| Advertising boards | $7.6 M / yr | $7.6 M / yr | $7.6 M / yr |
| **Total revenue** | **$100 M / yr** | **$159 M / yr** | **$181 M / yr** |
| Revenue / OPEX + debt-service recovery | 56% | 88% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $80 M / yr | $22 M / yr | **$0 / yr** |
