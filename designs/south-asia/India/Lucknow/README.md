...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **197,190 – 328,650 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (352.1 km @ $2.0 M/km) | $704 M |
| Elevated (22.1 km @ $9.0 M/km) | $199 M |
| Elevated-interchange premium (10 sites @ $4.50 M) | $45 M |
| **Civil subtotal** | **$948 M** |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 297 | $1.60 M | $475 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 375.5 km × $0.015 M/km | $19 M |
...
|---|---|---|
| Construction (years 1–5) | **$135 M / yr** | $39 |
| Steady-state, low-ridership (year 6+) | **$135 M / yr** | $39 |
| Steady-state, high-ridership (year 6+) | **$128 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$128 M / yr** | $37 |
| Lifecycle envelope (yr 1–25, low scenario) | **$3.39 bn cumulative** | $967 |
| Lifecycle envelope (yr 1–25, high scenario) | **$3.24 bn cumulative** | $926 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$3.24 bn cumulative** | $926 |

_Population basis: 3,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.3 M / yr → $0 k / yr._
...
| Sovereign bonds (10-y benchmark + project) | 25% | $470 M | 7.2% | 25 y, 5 y grace | $45 M / yr |
| Government equity (no debt service) | 15% | $282 M | — | — | — |
| **Total** | **100%** | **$1.88 bn** | | | **$128 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $45 M / yr + bonds $34 M / yr = **$79 M / yr** total — plus the equity tranche amortised across construction ($56 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 197,190 | 328,650 | 240,682 |
| Daily paid trips / catchment | 18% | 30% | 22% |
| Daily paid trips / city population | 6% | 9% | 7% |
| Annual paid trips | 72.0 M | 120.0 M | 87.8 M |
| Farebox revenue | $33 M / yr | $55 M / yr | $40 M / yr |
| Station shop leases | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| Advertising boards | $7.6 M / yr | $7.6 M / yr | $7.6 M / yr |
| **Total revenue** | **$45 M / yr** | **$67 M / yr** | **$53 M / yr** |
| Revenue / OPEX recovery | 86% | 128% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $135 M / yr | $128 M / yr | **$128 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $15 M / yr | $0 / yr |
