...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 3336 | $60 k | $200 M |
| High sensitivity check | 3336 | $120 k | $400 M |
...
|---|---|---|
| Construction (years 1–5) | **$306 M / yr** | $87 |
| Steady-state, low capacity-use (year 6+) | **$44 M / yr** | $13 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$185 M / yr** | $53 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.07 bn cumulative** | $877 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.53 bn cumulative** | $437 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.99 bn cumulative** | $2,283 |

_Population basis: 3,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $141 M / yr → $185 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $3.22 bn | 4.5% | 40 y, 5 y grace | $185 M / yr |
| Government equity (no debt service) | 20% | $806 M | — | — | — |
| **Total** | **100%** | **$4.03 bn** | | | **$185 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $145 M / yr = **$145 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($161 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Gross repayable-debt service + residual OPEX subsidy | $185 M / yr | $185 M / yr | **$185 M / yr** |
| Operating surplus applied to debt support | -$141 M / yr | -$185 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $44 M / yr | $0 k / yr | **$185 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.19 bn | 54% of $4.03 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.50 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $700 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 198,037 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$4.03 bn** |
| 15%–25% planning risk envelope | $4.63 bn–$5.03 bn |
| Annual OPEX | $94 M / yr |
| Low/high project NPV at 8% | $-2101118 k / $-1031017 k |
| Low/high project IRR | 1.0% / 5.1% |
| Low/high steady-state DSCR | 0.76 / 1.49 |
