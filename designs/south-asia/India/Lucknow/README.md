...
| Revenue fleet | 653 × 6-car trainsets |
| Revenue fleet passenger capacity | 470,160 AW2 pax (626,880 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 71 × 6-car trainsets |
| Peak headway | 3 min |
...
|---|---|---|---|---|
| line-1 | 48.7 km | 28 | 117 | W Mid ↔ E Outer |
| line-2 | 35.4 km | 22 | 91 | S Mid ↔ N Mid |
| line-3 | 27.1 km | 16 | 71 | SW Mid ↔ E Inner |
| line-4 | 21.9 km | 14 | 59 | S Inner ↔ N Inner |
| line-5 | 54.4 km | 29 | 126 | SW Mid ↔ NE Outer |
| line-6 | 48.4 km | 25 | 114 | SE Outer ↔ W Mid |
| line-7 | 37.6 km | 21 | 90 | SE Inner ↔ W Outer |
| line-8 | 94.2 km | 50 | 56 | W Mid ↔ W Mid |
| **Total** | **367.8 km** | **205 unique** | **724** | |
...
| Revenue fleet capacity | 470,160 AW2 pax (626,880 AW3 crush) |
| Total fleet capacity | 521,280 AW2 pax (695,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 720 AW2 passengers (`metro-6car`)
- **Revenue fleet simultaneous capacity:** 653 × 720 = **470,160 AW2 passengers** (626,880 AW3 crush)
- **Total fleet passenger capacity:** 724 × 720 = **521,280 AW2 passengers** (695,040 AW3 crush, incl. service rotation + spare + reserve)
...
| Major | 28 | 300 kW | 2000 kWh |
| Standard | 88 | 300 kW | 2000 kWh |
| Terminal | 13 | 300 kW | 2000 kWh |
| **Total installed** | **176** | **57,500 kW** | **390,000 kWh** |

Aggregate station-rail charging power: **352,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 1,080 kWh usable (1,350 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **674.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 443 kWh | line-7 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 345 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 3,520 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 674.7 MW / 4,048 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 390 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 23 | 786 kWh | 1,568 kWh | 704 kWh | 15.3 km / 246 kWh |
| line-2 | 21 | 570 kWh | 1,437 kWh | 810 kWh | 5.0 km / 81 kWh |
| line-3 | 16 | 437 kWh | 1,111 kWh | 630 kWh | 2.0 km / 33 kWh |
| line-4 | 14 | 354 kWh | 980 kWh | 591 kWh | 2.0 km / 33 kWh |
| line-5 | 21 | 878 kWh | 1,470 kWh | 505 kWh | 23.9 km / 385 kWh |
| line-6 | 20 | 781 kWh | 1,372 kWh | 513 kWh | 13.7 km / 222 kWh |
| line-7 | 16 | 607 kWh | 1,111 kWh | 443 kWh | 12.2 km / 197 kWh |
| line-8 | 45 | 1,520 kWh | 2,940 kWh | 1,269 kWh | 8.1 km / 131 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (332.3 km @ $3.0 M/km) | $997 M |
| Elevated (35.5 km @ $12.0 M/km) | $426 M |
...
|---|---|---|---|
| `metro-6car` (revenue + service rotation + spare + cold reserve) | 724 | $1.68 M | $1.22 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 4344 | $60 k | $261 M |
| High sensitivity check | 4344 | $120 k | $521 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 674,746 kW @ $700/kW | $472 M |
| Grid interconnection / PPA tie-in | 674,746 kW @ $100/kW | $67 M |
| Annual generation proxy | 674.7 MW × 6.0 peak-sun-h/day × 365 d/yr | 1,477.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$540 M** |
...
| EPC integration + project management (7%) | on subtotal | $283 M |
...
| Railway production plant | $261 M |
| Dedicated solar power plant | $540 M |
| Residual train-control wayside + charging microgrids | $94 M |
| EPC overhead (7%) | $283 M |
| **CAPEX total** | **$4.87 bn** |
| Per-route-km | $13 M / km |
| Per-capita (city pop) | $1,391 / person |
...
|---|---|---|
| Construction (years 1–5) | **$370 M / yr** | $106 |
| Steady-state, low capacity-use (year 6+) | **$97 M / yr** | $28 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$223 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.25 bn cumulative** | $1,501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.85 bn cumulative** | $528 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.65 bn cumulative** | $2,758 |

_Population basis: 3,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $126 M / yr → $223 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $3.89 bn | 4.5% | 40 y, 5 y grace | $223 M / yr |
| Government equity (no debt service) | 20% | $973 M | — | — | — |
| **Total** | **100%** | **$4.87 bn** | | | **$223 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $175 M / yr = **$175 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($195 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (1410.9 GWh / yr) | 149,129 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 6 cars × 4.0 kWh/car-km; on-site PV 125.9 GWh/yr + dedicated solar plant 674.7 MW / 1477.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $8.1 M |
| Labour (2,090 FTE) | driverless roster: OCC/remote 373, station/platform 753, passenger service 204, fleet maintenance 414, infrastructure/energy 315, admin/training 31; no train drivers × country median × 12 × engineer-premium 1.4 | $8.1 M |
| **OPEX subtotal** | | **$115 M / yr** |

_Annual service work: 149,129 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 58.8 M train-km / yr (352.7 M car-km / yr). On-site PV covers 125.9 GWh/yr and the dedicated solar plant adds 1477.7 GWh/yr against 1410.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 724 trainsets, 205 stations, 367.8 route-km, 8 lines, and 149,129 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 366.6 M | 586.6 M | 161.5 M |
| Annual paid trips / city resident | 105 | 168 | 46 |
| Farebox revenue | $225 M / yr | $360 M / yr | $99 M / yr |
| Station shop leases | $6.3 M / yr | $6.3 M / yr | $6.3 M / yr |
| Advertising boards | $9.9 M / yr | $9.9 M / yr | $9.9 M / yr |
| **Total revenue** | **$241 M / yr** | **$376 M / yr** | **$115 M / yr** |
| Revenue / OPEX recovery | 209% | 326% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $223 M / yr | $223 M / yr | **$223 M / yr** |
| Operating surplus applied to debt support | -$126 M / yr | -$223 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $97 M / yr | $0 k / yr | **$223 M / yr** |
| Operating surplus after OPEX (before debt support) | $126 M / yr | $261 M / yr | $0 / yr |

_Commercial-revenue assumptions: 32,352 m² of station shop/kiosk leases at $18/m²/month and 6,008 advertising boards at $161/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $113 M / yr | $180 M / yr | 21% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 9 education anchors | 51,398 trips/school day; 11.3 M access-events/yr | 82,236 trips/school day; 18.1 M access-events/yr |
| Healthcare | 48 healthcare anchors | 106,813 trips/day; 39.0 M access-events/yr | 170,900 trips/day; 62.4 M access-events/yr |
| Commerce | 88 major/terminal/interchange nodes | 205,975 trips/trading day; 68.0 M access-events/yr | 329,561 trips/trading day; 108.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.66 bn | 55% of $4.87 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.25 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $850 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 240,668 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $4.33 bn |
| Timetable-sized dedicated solar CAPEX | $540 M |
| **Reconciled project CAPEX** | **$4.87 bn** |
| 15%–25% planning risk envelope | $5.60 bn–$6.08 bn |
| Annual OPEX | $115 M / yr |
| Low/high project NPV at 8% | $-2888983 k / $-1818882 k |
| Low/high project IRR | -0.5% / 3.5% |
| Low/high steady-state DSCR | 0.56 / 1.17 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 8,943.32 train-km; 144,250.63 kWh consumed; 146,362.95 kWh charged; 23 depot services completed; minimum SoC 64%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 151,255.74 train-km; 2,439,658.70 kWh consumed; 2,480,322.29 kWh charged; 1,392 depot services completed (4 active at cutoff); minimum SoC 48%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 34.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 40.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 47.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.8% / 60% | pass |
| ten-hour single charging-pad outage | 47.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 8 corridors, 205 line platforms, 17 interchange complexes, 74 civil segments, and 0 input findings |
