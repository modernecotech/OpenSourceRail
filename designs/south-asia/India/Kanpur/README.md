...
| Bucket | Value |
|---|---|
| At-grade (321.2 km @ €3.5 M/km) | €1.12 bn |
| Elevated (16.6 km @ €18 M/km) | €300 M |
...
|---|---|---|---|
| `halt` | 11 | €0.4 M | €4.4 M |
| `standard` | 54 | €1.5 M | €81 M |
| `major` | 55 | €3.0 M | €165 M |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 273 | €6.0 M | €1.64 bn |
...
| Per-capita (city pop) | €1,250 / person |
...
|---|---|---|
| Construction (years 1–5) | **€288 M / yr** | €90 |
| Steady-state, low-ridership (year 6+) | **€366 M / yr** | €114 |
| Steady-state, high-ridership (year 6+) | **€345 M / yr** | €108 |
| Lifecycle envelope (yr 1–25, low scenario) | **€8.76 bn cumulative** | €2,737 |
| Lifecycle envelope (yr 1–25, high scenario) | **€8.35 bn cumulative** | €2,608 |

_Population basis: 3,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€93 M / yr (low) → €73 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.40 bn | 4.0% | 25 y, 5 y grace | €177 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €1.00 bn | 7.2% | 25 y, 5 y grace | €96 M / yr |
| Government equity (no debt service) | 15% | €600 M | — | — | — |
| **Total** | **100%** | **€4.00 bn** | | | **€273 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €96 M / yr + bonds €72 M / yr = **€168 M / yr** total — plus the equity tranche amortised across construction (€120 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | €66 M |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | €41 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | €253 k |
| Traction energy (1154.9 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (2,046 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €7.3 M |
...
|---|---|---|
| Annual paid trips | 58.4 M | 116.8 M |
| Farebox revenue | €21 M / yr | €41 M / yr |
| Farebox / OPEX recovery | 18% | 36% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €93 M / yr | €73 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€366 M / yr** | **€345 M / yr** |
