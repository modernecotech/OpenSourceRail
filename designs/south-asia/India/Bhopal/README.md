...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.80 bn (87.2%) of external capital** and **$3.45 bn of external interest**. Capital plus saved interest totals **$6.25 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (176.3 km @ $2.58 M/km) | $456 M |
| Elevated (18.4 km @ $9.75 M/km) | $179 M |
...
| Per-capita (city pop) | $744 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $697 M | 15% | $105 M | $593 M |
...
| **Total city CAPEX** | **$1.79 bn** | **23.0%** | **$411 M** | **$1.37 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.0%** | **$411 M** | **$82 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.0%** | **$1.37 bn** | **$275 M / yr** |
| of which planned local bond issuance | 61.6% of total CAPEX | $1.10 bn | $220 M / yr |
| **Total city programme** | **100.0%** | **$1.79 bn** | **$357 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.41 bn | $2.00 bn (82.9%) | $2.46 bn | **$4.46 bn** |
| **Default** | 2.00× | $3.21 bn | $2.80 bn (87.2%) | $3.45 bn | **$6.25 bn** |
| High | 3.00× | $4.82 bn | $4.41 bn (91.5%) | $5.42 bn | **$9.83 bn** |

At the default 2.00× case, OSR's $411 M external requirement is 87.2% below the illustrative foreign-company requirement of $3.21 bn; the associated lifetime external-interest saving is $3.45 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$153 M / yr** | $64 |
| Steady-state, low capacity-use (year 6+) | **$34 M / yr** | $14 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$110 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.97 bn cumulative** | $819 |
| Lifecycle envelope (yr 1–40, high scenario) | **$763 M cumulative** | $318 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.62 bn cumulative** | $1,927 |

_Population basis: 2,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $76 M / yr → $110 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $411 M | 4.5% | 40 y, 5 y grace | $24 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.10 bn | 7.2% | 40 y, 5 y grace | $87 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $275 M | — | — | — |
| **Total** | **100%** | **$1.79 bn** | | | **$110 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $79 M / yr = **$98 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($55 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 55.4 M |
| Annual paid trips / city resident | 75 | 119 | 23 |
| Farebox revenue | $110 M / yr | $176 M / yr | $34 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| **Total revenue** | **$118 M / yr** | **$184 M / yr** | **$42 M / yr** |
| Revenue / OPEX recovery | 282% | 440% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $110 M / yr | $110 M / yr | **$110 M / yr** |
| Operating surplus applied to debt support | -$76 M / yr | -$110 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $34 M / yr | $0 k / yr | **$110 M / yr** |
| Operating surplus after OPEX (before debt support) | $76 M / yr | $142 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.37 bn | 77% of $1.79 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.20 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $440 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 124,504 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.61 bn |
| Timetable-sized dedicated solar CAPEX | $180 M |
| **Reconciled project CAPEX** | **$1.79 bn** |
| Imported / external-capital requirement | $411 M (23.0%) |
| Local-content / local-funding requirement | $1.37 bn (77.0%) |
| Default foreign-turnkey external-capital comparison | $3.21 bn; OSR saves $2.80 bn (87.2%) |
| Lifetime external interest and combined financing saving | $3.45 bn interest; $6.25 bn capital + interest |
| 15%–25% planning risk envelope | $2.05 bn–$2.23 bn |
| Annual OPEX | $42 M / yr |
| Low/high project NPV at 8% | $-823406 k / $-300245 k |
| Low/high project IRR | 2.1% / 6.2% |
| Low/high steady-state DSCR | 0.69 / 1.29 |
