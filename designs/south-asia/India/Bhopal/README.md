...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.01 bn (87.5%) of external capital** and **$3.70 bn of external interest**. Capital plus saved interest totals **$6.70 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 194.6 km |
| Revenue fleet | 219 × 4-car trainsets |
| Revenue fleet passenger capacity | 105,120 AW2 pax (140,160 AW3 crush) |
...
| Revenue fleet capacity | 105,120 AW2 pax (140,160 AW3 crush) |
| Total fleet capacity | 117,600 AW2 pax (156,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 219 × 480 = **105,120 AW2 passengers** (140,160 AW3 crush)
- **Total fleet passenger capacity:** 245 × 480 = **117,600 AW2 passengers** (156,800 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 59.3%
- Catchment population: **≈ 1,423,200** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **224.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 4.6× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 565 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 144 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 152 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 76,703 train-km/day | One-way train journeys × route length |
| Annual service work | 30.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,325 MWh/day | 120.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,173 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 224.8 MW / 1,349 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 13 | 279 kWh | 686 kWh | 379 kWh | 3.0 km / 33 kWh |
| line-2 | 11 | 272 kWh | 588 kWh | 288 kWh | 3.6 km / 39 kWh |
| line-3 | 8 | 237 kWh | 441 kWh | 181 kWh | 4.9 km / 52 kWh |
| line-4 | 11 | 385 kWh | 612 kWh | 189 kWh | 14.5 km / 155 kWh |
| line-5 | 7 | 281 kWh | 453 kWh | 144 kWh | 6.9 km / 74 kWh |
| line-6 | 19 | 638 kWh | 931 kWh | 229 kWh | 6.5 km / 70 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (176.3 km @ $3.0 M/km) | $529 M |
| Elevated (18.4 km @ $12.0 M/km) | $220 M |
| Elevated-interchange premium (14 sites @ $4.50 M) | $63 M |
| **Civil subtotal** | **$812 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 245 | $1.12 M | $274 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 980 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 980 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 224,831 kW @ $700/kW | $157 M |
| Grid interconnection / PPA tie-in | 224,831 kW @ $100/kW | $22 M |
| Annual generation proxy | 224.8 MW × 6.0 peak-sun-h/day × 365 d/yr | 492.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$180 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 194.6 km × $0.050 M/km | $9.7 M |
...
|---|---:|---:|---:|---:|
| Civil works | $812 M | 15% | $122 M | $690 M |
| Stations | $488 M | 20% | $98 M | $390 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $274 M | 35% | $96 M | $178 M |
| Dedicated solar plant | $180 M | 45% | $81 M | $99 M |
| Residual signalling / train control | $9.7 M | 50% | $4.9 M | $4.9 M |
| Charging microgrids | $23 M | 40% | $9.4 M | $14 M |
| EPC / project services | $113 M | 15% | $17 M | $96 M |
| **Total city CAPEX** | **$1.91 bn** | **22.5%** | **$430 M** | **$1.48 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bhopal`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.5%** | **$430 M** | **$86 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.5%** | **$1.48 bn** | **$296 M / yr** |
| of which planned local bond issuance | 62.0% of total CAPEX | $1.18 bn | $237 M / yr |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.58 bn | $2.15 bn (83.3%) | $2.64 bn | **$4.79 bn** |
| **Default** | 2.00× | $3.44 bn | $3.01 bn (87.5%) | $3.70 bn | **$6.70 bn** |
| High | 3.00× | $5.15 bn | $4.72 bn (91.7%) | $5.81 bn | **$10.53 bn** |

At the default 2.00× case, OSR's $430 M external requirement is 87.5% below the illustrative foreign-company requirement of $3.44 bn; the associated lifetime external-interest saving is $3.70 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$164 M / yr** | $68 |
| Steady-state, low capacity-use (year 6+) | **$44 M / yr** | $18 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$118 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.37 bn cumulative** | $987 |
| Lifecycle envelope (yr 1–40, high scenario) | **$818 M cumulative** | $341 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.95 bn cumulative** | $2,061 |

_Population basis: 2,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $74 M / yr → $118 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $430 M | 4.5% | 40 y, 5 y grace | $25 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $1.18 bn | 7.2% | 40 y, 5 y grace | $93 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $296 M | — | — | — |
| **Total** | **100%** | **$1.91 bn** | | | **$118 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $19 M / yr + local bonds $85 M / yr = **$105 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($59 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $487 k |
| Traction energy (483.8 GWh / yr) | 76,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 55.6 GWh/yr + dedicated solar plant 224.8 MW / 492.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.7 M |
| Labour (971 FTE) | driverless roster: OCC/remote 146, station/platform 356, passenger service 111, fleet maintenance 175, infrastructure/energy 156, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.8 M |
| **OPEX subtotal** | | **$44 M / yr** |

_Annual service work: 76,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 30.2 M train-km / yr (120.9 M car-km / yr). On-site PV covers 55.6 GWh/yr and the dedicated solar plant adds 492.4 GWh/yr against 483.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 245 trainsets, 72 stations, 194.6 route-km, 6 lines, and 76,703 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 59.1 M |
| Annual paid trips / city resident | 75 | 119 | 25 |
| Farebox revenue | $110 M / yr | $176 M / yr | $36 M / yr |
| Station shop leases | $3.1 M / yr | $3.1 M / yr | $3.1 M / yr |
| Advertising boards | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| **Total revenue** | **$118 M / yr** | **$184 M / yr** | **$44 M / yr** |
| Revenue / OPEX recovery | 267% | 417% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $118 M / yr | $118 M / yr | **$118 M / yr** |
| Operating surplus applied to debt support | -$74 M / yr | -$118 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $44 M / yr | $0 k / yr | **$118 M / yr** |
| Operating surplus after OPEX (before debt support) | $74 M / yr | $140 M / yr | $0 / yr |

_Commercial-revenue assumptions: 15,992 m² of station shop/kiosk leases at $18/m²/month and 2,864 advertising boards at $161/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$207 M / yr** | **$332 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 24,613 trips/school day; 5.4 M access-events/yr | 39,381 trips/school day; 8.7 M access-events/yr |
| Healthcare | 21 healthcare anchors | 56,531 trips/day; 20.6 M access-events/yr | 90,450 trips/day; 33.0 M access-events/yr |
| Commerce | 44 major/terminal/interchange nodes | 110,075 trips/trading day; 36.3 M access-events/yr | 176,120 trips/trading day; 58.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.48 bn | 77% of $1.91 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.37 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $473 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 133,950 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.73 bn |
| Timetable-sized dedicated solar CAPEX | $180 M |
| **Reconciled project CAPEX** | **$1.91 bn** |
| Imported / external-capital requirement | $430 M (22.5%) |
| Local-content / local-funding requirement | $1.48 bn (77.5%) |
| Default foreign-turnkey external-capital comparison | $3.44 bn; OSR saves $3.01 bn (87.5%) |
| Lifetime external interest and combined financing saving | $3.70 bn interest; $6.70 bn capital + interest |
| 15%–25% planning risk envelope | $2.19 bn–$2.39 bn |
| Annual OPEX | $44 M / yr |
| Low/high project NPV at 8% | $-939569 k / $-416409 k |
| Low/high project IRR | 1.6% / 5.6% |
| Low/high steady-state DSCR | 0.62 / 1.18 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,798.44 train-km; 62,351.20 kWh consumed; 64,868.71 kWh charged; 46 depot services completed; minimum SoC 73%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 74,523.94 train-km; 801,363.23 kWh consumed; 808,749.15 kWh charged; 991 depot services completed (10 active at cutoff); minimum SoC 71%; 0 onboard emergencies; 0 invariant violations; 97.2% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 64.2% | 97.2% / 90% | pass |
| maximum planning climate/HVAC duty | 59.0% | 97.2% / 90% | pass |
| 50% charging-contact availability | 71.3% | 97.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.7% / 60% | pass |
| ten-hour single charging-pad outage | 71.3% | 97.2% / 90% | pass |
...
|---|---|
| ![Bhopal energy and battery simulation dashboard](engineering/screenshots/bhopal-simulation-dashboard.png) | ![Bhopal simulator network visualizer](engineering/screenshots/bhopal-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 72 line platforms, 14 interchange complexes, 54 civil segments, and 0 input findings |
...
|---|---|
| ![Bhopal QGIS engineering layers](engineering/screenshots/bhopal-qgis-engineering-map.png) | ![Bhopal SUMO timetable validation](engineering/screenshots/bhopal-sumo-validation.png) |
