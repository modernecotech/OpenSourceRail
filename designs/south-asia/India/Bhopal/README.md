...
| Revenue fleet | 302 × 4-car trainsets |
| Revenue fleet passenger capacity | 144,960 AW2 pax (193,280 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 25.9 km | 18 | 61 | E Mid ↔ W Mid |
| line-2 | 25.3 km | 17 | 59 | S Mid ↔ N Mid |
| line-3 | 22.0 km | 14 | 51 | SE Mid ↔ N Mid |
| line-4 | 35.8 km | 19 | 75 | SW Mid ↔ NE Outer |
| line-5 | 26.1 km | 14 | 56 | NW Mid ↔ SE Outer |
| line-6 | 59.4 km | 41 | 34 | NW Mid ↔ NW Mid |
| **Total** | **194.6 km** | **123 unique** | **336** | |
...
| Revenue fleet capacity | 144,960 AW2 pax (193,280 AW3 crush) |
| Total fleet capacity | 161,280 AW2 pax (215,040 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 302 × 480 = **144,960 AW2 passengers** (193,280 AW3 crush)
- **Total fleet passenger capacity:** 336 × 480 = **161,280 AW2 passengers** (215,040 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **207.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 328 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 241 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,085 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 207.9 MW / 1,248 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 18 | 279 kWh | 931 kWh | 624 kWh | 2.0 km / 22 kWh |
| line-2 | 17 | 272 kWh | 882 kWh | 582 kWh | 2.0 km / 22 kWh |
| line-3 | 14 | 237 kWh | 735 kWh | 475 kWh | 2.0 km / 22 kWh |
| line-4 | 16 | 385 kWh | 858 kWh | 434 kWh | 12.1 km / 130 kWh |
| line-5 | 12 | 281 kWh | 637 kWh | 328 kWh | 6.9 km / 74 kWh |
| line-6 | 41 | 638 kWh | 2,009 kWh | 1,307 kWh | 2.2 km / 24 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (172.8 km @ $3.0 M/km) | $518 M |
| Elevated (21.8 km @ $12.0 M/km) | $262 M |
| Elevated-interchange premium (17 sites @ $4.50 M) | $76 M |
| **Civil subtotal** | **$857 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 336 | $1.12 M | $376 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1344 | $60 k | $81 M |
| High sensitivity check | 1344 | $120 k | $161 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 207,926 kW @ $700/kW | $146 M |
| Grid interconnection / PPA tie-in | 207,926 kW @ $100/kW | $21 M |
| Annual generation proxy | 207.9 MW × 6.0 peak-sun-h/day × 365 d/yr | 455.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$166 M** |
...
| Depots | $8.0 M |
| Rolling stock | $376 M |
| Railway production plant | $81 M |
| Dedicated solar power plant | $166 M |
...
|---|---|---|
| Construction (years 1–5) | **$191 M / yr** | $80 |
| Steady-state, low capacity-use (year 6+) | **$49 M / yr** | $21 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$115 M / yr** | $48 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.68 bn cumulative** | $1,117 |
| Lifecycle envelope (yr 1–40, high scenario) | **$957 M cumulative** | $399 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.99 bn cumulative** | $2,081 |

_Population basis: 2,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $66 M / yr → $115 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.01 bn | 4.5% | 40 y, 5 y grace | $115 M / yr |
| Government equity (no debt service) | 20% | $504 M | — | — | — |
| **Total** | **100%** | **$2.52 bn** | | | **$115 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $91 M / yr = **$91 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($101 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (483.8 GWh / yr) | 76,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 87.8 GWh/yr + dedicated solar plant 207.9 MW / 455.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.5 M |
| Labour (1,298 FTE) | driverless roster: OCC/remote 187, station/platform 597, passenger service 111, fleet maintenance 202, infrastructure/energy 174, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.0 M |
| **OPEX subtotal** | | **$57 M / yr** |

_Annual service work: 76,703 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 30.2 M train-km / yr (120.9 M car-km / yr). On-site PV covers 87.8 GWh/yr and the dedicated solar plant adds 455.4 GWh/yr against 483.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 336 trainsets, 123 stations, 194.6 route-km, 6 lines, and 76,703 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 71.5 M |
| Annual paid trips / city resident | 75 | 119 | 30 |
| Farebox revenue | $110 M / yr | $176 M / yr | $44 M / yr |
| Station shop leases | $5.2 M / yr | $5.2 M / yr | $5.2 M / yr |
| Advertising boards | $7.8 M / yr | $7.8 M / yr | $7.8 M / yr |
| **Total revenue** | **$123 M / yr** | **$189 M / yr** | **$57 M / yr** |
| Revenue / OPEX recovery | 216% | 332% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $115 M / yr | $115 M / yr | **$115 M / yr** |
| Operating surplus applied to debt support | -$66 M / yr | -$115 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $49 M / yr | $0 k / yr | **$115 M / yr** |
| Operating surplus after OPEX (before debt support) | $66 M / yr | $132 M / yr | $0 / yr |

_Commercial-revenue assumptions: 26,784 m² of station shop/kiosk leases at $18/m²/month and 4,772 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 7 education anchors | 26,154 trips/school day; 5.8 M access-events/yr | 41,847 trips/school day; 9.2 M access-events/yr |
| Healthcare | 41 healthcare anchors | 59,132 trips/day; 21.6 M access-events/yr | 94,610 trips/day; 34.5 M access-events/yr |
| Commerce | 69 major/terminal/interchange nodes | 107,490 trips/trading day; 35.5 M access-events/yr | 171,984 trips/trading day; 56.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.44 bn | 57% of $2.52 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.31 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $461 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 130,593 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.35 bn |
| Timetable-sized dedicated solar CAPEX | $166 M |
| **Reconciled project CAPEX** | **$2.52 bn** |
| 15%–25% planning risk envelope | $2.90 bn–$3.15 bn |
| Annual OPEX | $57 M / yr |
| Low/high project NPV at 8% | $-1486367 k / $-963206 k |
| Low/high project IRR | -0.4% / 3.4% |
| Low/high steady-state DSCR | 0.57 / 1.14 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,281.12 train-km; 56,787.74 kWh consumed; 62,226.06 kWh charged; 33 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 77,359.29 train-km; 831,841.89 kWh consumed; 845,084.18 kWh charged; 1,003 depot services completed (6 active at cutoff); minimum SoC 74%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 67.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 65.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 73.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.5% / 60% | pass |
| ten-hour single charging-pad outage | 73.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 123 line platforms, 17 interchange complexes, 58 civil segments, and 0 input findings |
