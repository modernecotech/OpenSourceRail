...
|---|---:|
| Cities in catalogue | 17 |
| Served population represented | 36,304,000 |
| Trainsets across city plans | 5,084 |
| Vehicle/car modules to manufacture | 24,736 |
| City infrastructure + fleet CAPEX | $37.35 B |
| One shared national trainset factory | $205.6 M |
| National factory sizing basis | 3,426 modules: largest single-city programme (Indore) |
| **Total national programme CAPEX** | **$37.57 B** |
...
|---|---:|---:|---:|
| **External capital for imports** | **24.0%** | **$9.01 B** | **$1.80 B / yr** |
| **Local capital for domestic value** | **76.0%** | **$28.56 B** | **$5.71 B / yr** |
| planned local-currency bond issuance | 60.8% of total | $22.85 B | $4.57 B / yr |
| local public equity / other domestic funding | 15.2% of total | $5.71 B | $1.14 B / yr |
| **Total capital programme** | **100.0%** | **$37.57 B** | **$7.51 B / yr** |

The annual construction draw is spread evenly over 5 planning years. Post-grace annual debt service is $516.0 M for external import finance plus $1.80 B for local bonds, or **$2.32 B per year** before railway operating cash flow. During construction, interest plus the local public-equity draw is **$3.19 B per year**.
...
|---|---:|---:|---:|---:|
| Civil works | $15.90 B | 15% | $2.38 B | $13.51 B |
| Stations | $6.82 B | 20% | $1.36 B | $5.46 B |
| Depots | $136.0 M | 25% | $34.0 M | $102.0 M |
| Rolling stock | $6.93 B | 35% | $2.42 B | $4.50 B |
| Dedicated solar plants | $4.85 B | 45% | $2.18 B | $2.67 B |
| Residual signalling / train control | $190.3 M | 50% | $95.1 M | $95.1 M |
| Charging microgrids | $407.2 M | 40% | $162.9 M | $244.3 M |
| EPC / project services | $2.14 B | 15% | $321.1 M | $1.82 B |
| Shared national trainset factory | $205.6 M | 20% | $41.1 M | $164.4 M |
| **Total** | **$37.57 B** | **24.0%** | **$9.01 B** | **$28.56 B** |
...
Generated by `scripts/generate-national-briefs.py` for `IN`. Controlled imported-share keys: charging_microgrid, civil, depots, epc_overhead, production_plant, rolling_stock, signalling, solar_plant, stations.
