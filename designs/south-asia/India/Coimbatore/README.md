...
|---|---|---|
| Construction (years 1–5) | **$124 M / yr** | $40 |
| Steady-state, low-ridership (year 6+) | **$124 M / yr** | $40 |
| Steady-state, high-ridership (year 6+) | **$118 M / yr** | $38 |
| Steady-state, operating-neutral revenue case | **$118 M / yr** | $38 |
| Lifecycle envelope (yr 1–25, low scenario) | **$3.09 bn cumulative** | $1,003 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.98 bn cumulative** | $965 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.98 bn cumulative** | $965 |

_Population basis: 3,084,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.9 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.04 bn | 4.0% | 25 y, 5 y grace | $76 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $432 M | 7.2% | 25 y, 5 y grace | $41 M / yr |
| Government equity (no debt service) | 15% | $259 M | — | — | — |
| **Total** | **100%** | **$1.73 bn** | | | **$118 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $41 M / yr + bonds $31 M / yr = **$73 M / yr** total — plus the equity tranche amortised across construction ($52 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 173,197 | 288,662 | 208,407 |
| Daily paid trips / catchment | 18% | 30% | 22% |
| Daily paid trips / city population | 6% | 9% | 7% |
| Annual paid trips | 63.2 M | 105.4 M | 76.1 M |
| Farebox revenue | $29 M / yr | $48 M / yr | $35 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $6.0 M / yr | $6.0 M / yr | $6.0 M / yr |
| **Total revenue** | **$39 M / yr** | **$58 M / yr** | **$45 M / yr** |
| Revenue / OPEX recovery | 87% | 130% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $124 M / yr | $118 M / yr | **$118 M / yr** |
