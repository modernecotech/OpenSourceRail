...
| Bucket | Value |
|---|---|
| At-grade (241.8 km @ $0.85 M/km) | $205 M |
| Elevated (25.2 km @ $4.0 M/km) | $101 M |
| Elevated-interchange premium (11 sites @ $2.0 M) | $22 M |
...
|---|---|---|---|
| `standard` | 67 | $300 k | $20 M |
| `major` | 24 | $600 k | $14 M |
| `terminal` | 7 | $500 k | $3.5 M |
| `depot-terminal` | 1 | $650 k | $650 k |
| `interchange-elevated` | 22 | $1.20 M | $26 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 267.8 km × $0.015 M/km | $4.0 M |
...
|---|---|---|
| Construction (years 1–5) | **$60 M / yr** | $19 |
| Steady-state, low-ridership (year 6+) | **$34 M / yr** | $11 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$978 M cumulative** | $317 |
| Lifecycle envelope (yr 1–25, high scenario) | **$300 M cumulative** | $97 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$300 M cumulative** | $97 |

_Population basis: 3,084,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $500 M | 4.0% | 25 y, 5 y grace | $37 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $209 M | 7.2% | 25 y, 5 y grace | $20 M / yr |
| Government equity (no debt service) | 15% | $125 M | — | — | — |
| **Total** | **100%** | **$834 M** | | | **$57 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $20 M / yr + bonds $15 M / yr = **$35 M / yr** total — plus the equity tranche amortised across construction ($25 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $201 k |
...
|---|---|---|---|
| Daily paid trips | 246,720 | 462,600 | 448,577 |
| Daily paid trips / population | 8% | 15% | 15% |
| Annual paid trips | 90.1 M | 168.8 M | 163.7 M |
| Farebox revenue | $41 M / yr | $78 M / yr | $75 M / yr |
| Station shop leases | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| Advertising boards | $6.0 M / yr | $6.0 M / yr | $6.0 M / yr |
| **Total revenue** | **$51 M / yr** | **$87 M / yr** | **$85 M / yr** |
| Revenue / OPEX + debt-service recovery | 60% | 103% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $34 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $2.4 M / yr | $0 / yr |
