...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.76 bn (85.3%) of external capital** and **$7.08 bn of external interest**. Capital plus saved interest totals **$12.83 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (298.5 km @ $2.58 M/km) | $771 M |
| Elevated (43.5 km @ $9.75 M/km) | $424 M |
...
| Per-capita (city pop) | $1,216 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.27 bn | 15% | $191 M | $1.08 bn |
...
| EPC / project services | $201 M | 15% | $30 M | $171 M |
| **Total city CAPEX** | **$3.75 bn** | **26.5%** | **$994 M** | **$2.76 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.5%** | **$994 M** | **$199 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.5%** | **$2.76 bn** | **$551 M / yr** |
| of which planned local bond issuance | 58.8% of total CAPEX | $2.20 bn | $441 M / yr |
| **Total city programme** | **100.0%** | **$3.75 bn** | **$750 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $5.06 bn | $4.07 bn (80.4%) | $5.00 bn | **$9.07 bn** |
| **Default** | 2.00× | $6.75 bn | $5.76 bn (85.3%) | $7.08 bn | **$12.83 bn** |
| High | 3.00× | $10.13 bn | $9.13 bn (90.2%) | $11.23 bn | **$20.36 bn** |

At the default 2.00× case, OSR's $994 M external requirement is 85.3% below the illustrative foreign-company requirement of $6.75 bn; the associated lifetime external-interest saving is $7.08 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$314 M / yr** | $102 |
| Steady-state, low capacity-use (year 6+) | **$58 M / yr** | $19 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$231 M / yr** | $75 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.59 bn cumulative** | $1,163 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.57 bn cumulative** | $509 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$9.65 bn cumulative** | $3,130 |

_Population basis: 3,084,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $173 M / yr → $231 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 27% | $994 M | 4.5% | 40 y, 5 y grace | $57 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.20 bn | 7.2% | 40 y, 5 y grace | $174 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $551 M | — | — | — |
| **Total** | **100%** | **$3.75 bn** | | | **$231 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $45 M / yr + local bonds $159 M / yr = **$203 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($110 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 132.9 M |
| Annual paid trips / city resident | 135 | 216 | 43 |
| Farebox revenue | $255 M / yr | $408 M / yr | $82 M / yr |
| Station shop leases | $4.0 M / yr | $4.0 M / yr | $4.0 M / yr |
| Advertising boards | $6.2 M / yr | $6.2 M / yr | $6.2 M / yr |
| **Total revenue** | **$265 M / yr** | **$418 M / yr** | **$92 M / yr** |
| Revenue / OPEX recovery | 289% | 455% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $231 M / yr | $231 M / yr | **$231 M / yr** |
| Operating surplus applied to debt support | -$173 M / yr | -$231 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $58 M / yr | $0 k / yr | **$231 M / yr** |
| Operating surplus after OPEX (before debt support) | $173 M / yr | $326 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.76 bn | 73% of $3.75 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.41 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $882 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 249,637 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $3.08 bn |
| Timetable-sized dedicated solar CAPEX | $671 M |
| **Reconciled project CAPEX** | **$3.75 bn** |
| Imported / external-capital requirement | $994 M (26.5%) |
| Local-content / local-funding requirement | $2.76 bn (73.5%) |
| Default foreign-turnkey external-capital comparison | $6.75 bn; OSR saves $5.76 bn (85.3%) |
| Lifetime external interest and combined financing saving | $7.08 bn interest; $12.83 bn capital + interest |
| 15%–25% planning risk envelope | $4.31 bn–$4.69 bn |
| Annual OPEX | $92 M / yr |
| Low/high project NPV at 8% | $-1620245 k / $-407464 k |
| Low/high project IRR | 2.6% / 6.8% |
| Low/high steady-state DSCR | 0.75 / 1.41 |
