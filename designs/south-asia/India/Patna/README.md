...
|---|---|---|
| Construction (years 1–5) | **$115 M / yr** | $46 |
| Steady-state, low-ridership (year 6+) | **$109 M / yr** | $43 |
| Steady-state, high-ridership (year 6+) | **$109 M / yr** | $43 |
| Steady-state, operating-neutral revenue case | **$109 M / yr** | $43 |
| Lifecycle envelope (yr 1–25, low scenario) | **$2.76 bn cumulative** | $1,094 |
| Lifecycle envelope (yr 1–25, high scenario) | **$2.76 bn cumulative** | $1,094 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$2.76 bn cumulative** | $1,094 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $960 M | 4.0% | 25 y, 5 y grace | $71 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $400 M | 7.2% | 25 y, 5 y grace | $38 M / yr |
| Government equity (no debt service) | 15% | $240 M | — | — | — |
| **Total** | **100%** | **$1.60 bn** | | | **$109 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $38 M / yr + bonds $29 M / yr = **$67 M / yr** total — plus the equity tranche amortised across construction ($48 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
