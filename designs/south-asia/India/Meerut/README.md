...
| Revenue fleet | 201 × 4-car trainsets |
| Revenue fleet passenger capacity | 96,480 AW2 pax (128,640 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 24.7 km | 17 | 58 | NW Outer ↔ E Mid |
| line-2 | 31.4 km | 18 | 68 | N Outer ↔ S Outer |
| line-3 | 31.2 km | 18 | 68 | SW Outer ↔ NE Mid |
| line-4 | 58.2 km | 33 | 30 | N Mid ↔ N Mid |
| **Total** | **145.4 km** | **86 unique** | **224** | |
...
| Revenue fleet capacity | 96,480 AW2 pax (128,640 AW3 crush) |
| Total fleet capacity | 107,520 AW2 pax (143,360 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 201 × 480 = **96,480 AW2 passengers** (128,640 AW3 crush)
- **Total fleet passenger capacity:** 224 × 480 = **107,520 AW2 passengers** (143,360 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 37 | 300 kW | 1500 kWh |
| Terminal | 5 | 300 kW | 1500 kWh |
| **Total installed** | **77** | **27,800 kW** | **154,000 kWh** |

Aggregate station-rail charging power: **115,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **147.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 464 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 167 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 768 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 147.2 MW / 883 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 154 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 265 kWh | 833 kWh | 541 kWh | 5.4 km / 58 kWh |
| line-2 | 16 | 337 kWh | 858 kWh | 486 kWh | 9.8 km / 106 kWh |
| line-3 | 16 | 335 kWh | 833 kWh | 464 kWh | 8.0 km / 86 kWh |
| line-4 | 29 | 626 kWh | 1,421 kWh | 733 kWh | 11.5 km / 123 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 224 | $1.12 M | $251 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 896 | $60 k | $54 M |
| High sensitivity check | 896 | $120 k | $108 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 147,205 kW @ $700/kW | $103 M |
| Grid interconnection / PPA tie-in | 147,205 kW @ $100/kW | $15 M |
| Annual generation proxy | 147.2 MW × 6.0 peak-sun-h/day × 365 d/yr | 322.4 GWh/yr |
| **Dedicated solar plant subtotal** | | **$118 M** |
...
| Depots | $8.0 M |
| Rolling stock | $251 M |
| Railway production plant | $54 M |
| Dedicated solar power plant | $118 M |
...
|---|---|---|
| Construction (years 1–5) | **$124 M / yr** | $78 |
| Steady-state, low capacity-use (year 6+) | **$34 M / yr** | $21 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$75 M / yr** | $47 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.82 bn cumulative** | $1,137 |
| Lifecycle envelope (yr 1–40, high scenario) | **$621 M cumulative** | $388 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.24 bn cumulative** | $2,025 |

_Population basis: 1,600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $41 M / yr → $75 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.31 bn | 4.5% | 40 y, 5 y grace | $75 M / yr |
| Government equity (no debt service) | 20% | $327 M | — | — | — |
| **Total** | **100%** | **$1.63 bn** | | | **$75 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $59 M / yr = **$59 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($65 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (341.2 GWh / yr) | 54,099 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 60.9 GWh/yr + dedicated solar plant 147.2 MW / 322.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.8 M |
| Labour (851 FTE) | driverless roster: OCC/remote 130, station/platform 358, passenger service 72, fleet maintenance 139, infrastructure/energy 129, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $3.3 M |
| **OPEX subtotal** | | **$37 M / yr** |

_Annual service work: 54,099 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 21.3 M train-km / yr (85.3 M car-km / yr). On-site PV covers 60.9 GWh/yr and the dedicated solar plant adds 322.4 GWh/yr against 341.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 224 trainsets, 86 stations, 145.4 route-km, 4 lines, and 54,099 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 114.1 M | 182.5 M | 47.9 M |
| Annual paid trips / city resident | 71 | 114 | 30 |
| Farebox revenue | $70 M / yr | $112 M / yr | $29 M / yr |
| Station shop leases | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| Advertising boards | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| **Total revenue** | **$78 M / yr** | **$120 M / yr** | **$37 M / yr** |
| Revenue / OPEX recovery | 210% | 323% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $75 M / yr | $75 M / yr | **$75 M / yr** |
| Operating surplus applied to debt support | -$41 M / yr | -$75 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $34 M / yr | $0 k / yr | **$75 M / yr** |
| Operating surplus after OPEX (before debt support) | $41 M / yr | $83 M / yr | $0 / yr |

_Commercial-revenue assumptions: 15,584 m² of station shop/kiosk leases at $18/m²/month and 2,836 advertising boards at $161/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$129 M / yr** | **$207 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 3 education anchors | 15,312 trips/school day; 3.4 M access-events/yr | 24,498 trips/school day; 5.4 M access-events/yr |
| Healthcare | 24 healthcare anchors | 36,248 trips/day; 13.2 M access-events/yr | 57,996 trips/day; 21.2 M access-events/yr |
| Commerce | 40 major/terminal/interchange nodes | 65,257 trips/trading day; 21.5 M access-events/yr | 104,412 trips/trading day; 34.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $933 M | 57% of $1.63 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.49 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $299 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 84,530 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $118 M |
| **Reconciled project CAPEX** | **$1.63 bn** |
| 15%–25% planning risk envelope | $1.88 bn–$2.04 bn |
| Annual OPEX | $37 M / yr |
| Low/high project NPV at 8% | $-982648 k / $-649728 k |
| Low/high project IRR | -0.7% / 3.1% |
| Low/high steady-state DSCR | 0.54 / 1.10 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,650.55 train-km; 39,254.29 kWh consumed; 42,595.10 kWh charged; 19 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 54,017.72 train-km; 580,851.77 kWh consumed; 589,098.11 kWh charged; 674 depot services completed (4 active at cutoff); minimum SoC 83%; 0 onboard emergencies; 0 invariant violations; 99.9% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 80.3% | 99.9% / 90% | pass |
| maximum planning climate/HVAC duty | 81.8% | 99.9% / 90% | pass |
| 50% charging-contact availability | 83.2% | 99.9% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.2% / 60% | pass |
| ten-hour single charging-pad outage | 83.2% | 99.9% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 4 corridors, 86 line platforms, 8 interchange complexes, 26 civil segments, and 0 input findings |
