...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$2.00 bn (87.5%) of external capital** and **$2.45 bn of external interest**. Capital plus saved interest totals **$4.45 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Anchor-weighted coverage | 68.6% |
| Route length (double track) | 145.4 km |
| Revenue fleet | 141 × 4-car trainsets |
| Revenue fleet passenger capacity | 67,680 AW2 pax (90,240 AW3 crush) |
...
| Revenue fleet capacity | 67,680 AW2 pax (90,240 AW3 crush) |
| Total fleet capacity | 75,840 AW2 pax (101,120 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 141 × 480 = **67,680 AW2 passengers** (90,240 AW3 crush)
- **Total fleet passenger capacity:** 158 × 480 = **75,840 AW2 passengers** (101,120 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 68.6%
- Catchment population: **≈ 1,097,600** (within ~800 m walk of a station)
...
| Interchange | 15 | 300 kW | 1500 kWh |
| Major | 6 | 300 kW | 1500 kWh |
| Standard | 13 | 300 kW | 1500 kWh |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **160.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.8× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 597 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 146 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 100 MWh/day | 6.0 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,628 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 54,099 train-km/day | One-way train journeys × route length |
| Annual service work | 21.3 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 935 MWh/day | 85.3 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 835 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 160.0 MW / 960 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 265 kWh | 490 kWh | 198 kWh | 7.0 km / 75 kWh |
| line-2 | 8 | 337 kWh | 539 kWh | 168 kWh | 10.2 km / 110 kWh |
| line-3 | 8 | 335 kWh | 514 kWh | 146 kWh | 8.2 km / 88 kWh |
| line-4 | 15 | 626 kWh | 919 kWh | 231 kWh | 11.5 km / 123 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 158 | $1.12 M | $177 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 632 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 632 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 159,970 kW @ $700/kW | $112 M |
| Grid interconnection / PPA tie-in | 159,970 kW @ $100/kW | $16 M |
| Annual generation proxy | 160.0 MW × 6.0 peak-sun-h/day × 365 d/yr | 350.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$128 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 145.4 km × $0.050 M/km | $7.3 M |
...
| EPC integration + project management (7%) | on subtotal | $74 M |
...
|---|---:|---:|---:|---:|
| Civil works | $587 M | 15% | $88 M | $499 M |
| Stations | $271 M | 20% | $54 M | $217 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $177 M | 35% | $62 M | $115 M |
| Dedicated solar plant | $128 M | 45% | $58 M | $70 M |
| Residual signalling / train control | $7.3 M | 50% | $3.6 M | $3.6 M |
| Charging microgrids | $14 M | 40% | $5.4 M | $8.1 M |
| EPC / project services | $74 M | 15% | $11 M | $63 M |
| **Total city CAPEX** | **$1.27 bn** | **22.4%** | **$284 M** | **$982 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh meerut`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.4%** | **$284 M** | **$57 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.6%** | **$982 M** | **$196 M / yr** |
| of which planned local bond issuance | 62.1% of total CAPEX | $786 M | $157 M / yr |
| **Total city programme** | **100.0%** | **$1.27 bn** | **$253 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $1.71 bn | $1.43 bn (83.4%) | $1.75 bn | **$3.18 bn** |
| **Default** | 2.00× | $2.28 bn | $2.00 bn (87.5%) | $2.45 bn | **$4.45 bn** |
| High | 3.00× | $3.42 bn | $3.14 bn (91.7%) | $3.85 bn | **$6.99 bn** |

At the default 2.00× case, OSR's $284 M external requirement is 87.5% below the illustrative foreign-company requirement of $2.28 bn; the associated lifetime external-interest saving is $2.45 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$109 M / yr** | $68 |
| Steady-state, low capacity-use (year 6+) | **$33 M / yr** | $21 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$78 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.70 bn cumulative** | $1,062 |
| Lifecycle envelope (yr 1–40, high scenario) | **$543 M cumulative** | $340 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.28 bn cumulative** | $2,052 |

_Population basis: 1,600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $45 M / yr → $78 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $284 M | 4.5% | 40 y, 5 y grace | $16 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $786 M | 7.2% | 40 y, 5 y grace | $62 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $196 M | — | — | — |
| **Total** | **100%** | **$1.27 bn** | | | **$78 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $13 M / yr + local bonds $57 M / yr = **$69 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($39 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $364 k |
| Traction energy (341.2 GWh / yr) | 54,099 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 36.6 GWh/yr + dedicated solar plant 160.0 MW / 350.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.9 M |
| Labour (633 FTE) | driverless roster: OCC/remote 98, station/platform 206, passenger service 72, fleet maintenance 119, infrastructure/energy 115, admin/training 23; no train drivers × country median × 12 × engineer-premium 1.4 | $2.4 M |
| **OPEX subtotal** | | **$29 M / yr** |

_Annual service work: 54,099 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 21.3 M train-km / yr (85.3 M car-km / yr). On-site PV covers 36.6 GWh/yr and the dedicated solar plant adds 350.3 GWh/yr against 341.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 158 trainsets, 47 stations, 145.4 route-km, 4 lines, and 54,099 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 114.1 M | 182.5 M | 40.2 M |
| Annual paid trips / city resident | 71 | 114 | 25 |
| Farebox revenue | $70 M / yr | $112 M / yr | $25 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.7 M / yr | $2.7 M / yr | $2.7 M / yr |
| **Total revenue** | **$74 M / yr** | **$116 M / yr** | **$29 M / yr** |
| Revenue / OPEX recovery | 255% | 399% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $78 M / yr | $78 M / yr | **$78 M / yr** |
| Operating surplus applied to debt support | -$45 M / yr | -$78 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $33 M / yr | $0 k / yr | **$78 M / yr** |
| Operating surplus after OPEX (before debt support) | $45 M / yr | $87 M / yr | $0 / yr |

_Commercial-revenue assumptions: 9,032 m² of station shop/kiosk leases at $18/m²/month and 1,640 advertising boards at $161/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $20 M / yr | $32 M / yr | 16 min/trip × $0.66/h value-of-time proxy |
...
| Station-area commerce turnover supported | $38 M / yr | $60 M / yr | 22% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $18 M / yr | $29 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$131 M / yr** | **$210 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 1 education anchors | 14,187 trips/school day; 3.1 M access-events/yr | 22,699 trips/school day; 5.0 M access-events/yr |
| Healthcare | 14 healthcare anchors | 37,123 trips/day; 13.5 M access-events/yr | 59,396 trips/day; 21.7 M access-events/yr |
| Commerce | 27 major/terminal/interchange nodes | 68,845 trips/trading day; 22.7 M access-events/yr | 110,153 trips/trading day; 36.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $982 M | 78% of $1.27 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.57 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $314 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 88,981 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.14 bn |
| Timetable-sized dedicated solar CAPEX | $128 M |
| **Reconciled project CAPEX** | **$1.27 bn** |
| Imported / external-capital requirement | $284 M (22.4%) |
| Local-content / local-funding requirement | $982 M (77.6%) |
| Default foreign-turnkey external-capital comparison | $2.28 bn; OSR saves $2.00 bn (87.5%) |
| Lifetime external interest and combined financing saving | $2.45 bn interest; $4.45 bn capital + interest |
| 15%–25% planning risk envelope | $1.46 bn–$1.58 bn |
| Annual OPEX | $29 M / yr |
| Low/high project NPV at 8% | $-652178 k / $-319257 k |
| Low/high project IRR | 1.2% / 5.1% |
| Low/high steady-state DSCR | 0.58 / 1.11 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 3,980.50 train-km; 42,802.81 kWh consumed; 42,968.81 kWh charged; 27 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 52,217.32 train-km; 561,499.13 kWh consumed; 565,424.59 kWh charged; 681 depot services completed (6 active at cutoff); minimum SoC 68%; 0 onboard emergencies; 0 invariant violations; 96.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 61.6% | 96.5% / 90% | pass |
| maximum planning climate/HVAC duty | 63.1% | 96.5% / 90% | pass |
| 50% charging-contact availability | 68.3% | 96.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 71.1% / 60% | pass |
| ten-hour single charging-pad outage | 68.3% | 96.5% / 90% | pass |
...
|---|---|
| ![Meerut energy and battery simulation dashboard](engineering/screenshots/meerut-simulation-dashboard.png) | ![Meerut simulator network visualizer](engineering/screenshots/meerut-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 4 corridors, 47 line platforms, 8 interchange complexes, 26 civil segments, and 0 input findings |
...
|---|---|
| ![Meerut QGIS engineering layers](engineering/screenshots/meerut-qgis-engineering-map.png) | ![Meerut SUMO timetable validation](engineering/screenshots/meerut-sumo-validation.png) |
