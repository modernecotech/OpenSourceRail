...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 146 | €4.0 M | €584 M |
...
| Per-capita (city pop) | €1,207 / person |
...
|---|---|---|
| Construction (years 1–5) | **€139 M / yr** | €87 |
| Steady-state, low-ridership (year 6+) | **€172 M / yr** | €108 |
| Steady-state, high-ridership (year 6+) | **€162 M / yr** | €101 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.14 bn cumulative** | €2,590 |
| Lifecycle envelope (yr 1–25, high scenario) | **€3.94 bn cumulative** | €2,461 |

_Population basis: 1,600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€41 M / yr (low) → €31 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.16 bn | 4.0% | 25 y, 5 y grace | €85 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €483 M | 7.2% | 25 y, 5 y grace | €46 M / yr |
| Government equity (no debt service) | 15% | €290 M | — | — | — |
| **Total** | **100%** | **€1.93 bn** | | | **€132 M / yr** |
...
| Labour (1,090 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €3.9 M |
...
| Farebox / OPEX recovery | 20% | 40% |
| Country policy-target recovery (diagnostic) | 55% | 55% |
| Operating shortfall (gov subsidy required) | €41 M / yr | €31 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€172 M / yr** | **€162 M / yr** |
