...
| Bucket | Value |
|---|---|
| At-grade (272.2 km @ €3.5 M/km) | €953 M |
| Elevated (32.4 km @ €18 M/km) | €583 M |
| Elevated-interchange premium (10 sites @ €20 M) | €200 M |
| **Civil subtotal** | **€1.74 bn** |
...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 245 | €4.0 M | €980 M |
...
| Per-capita (city pop) | €2,380 / person |
...
|---|---|---|
| Construction (years 1–7) | **€218 M / yr** | €156 |
| Steady-state, low-ridership (year 8+) | **€295 M / yr** | €210 |
| Steady-state, high-ridership (year 8+) | **€287 M / yr** | €205 |
| Lifecycle envelope (yr 1–30, low scenario) | **€8.30 bn cumulative** | €5,930 |
| Lifecycle envelope (yr 1–30, high scenario) | **€8.13 bn cumulative** | €5,805 |

_Population basis: 1,400,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€79 M / yr (low) → €71 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €2.00 bn | 3.8% | 30 y, 7 y grace | €132 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €833 M | 8.5% | 30 y, 7 y grace | €84 M / yr |
| Government equity (no debt service) | 15% | €500 M | — | — | — |
| **Total** | **100%** | **€3.33 bn** | | | **€215 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €76 M / yr + bonds €71 M / yr = **€147 M / yr** total — plus the equity tranche amortised across construction (€71 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | €228 k |
| Traction energy (694.5 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, €0 / yr** | €0 k |
| Labour (1,862 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €5.6 M |
...
|---|---|---|
| Annual paid trips | 25.6 M | 51.1 M |
| Farebox revenue | €7.6 M / yr | €15 M / yr |
| Farebox / OPEX recovery | 9% | 18% |
| Country policy-target recovery (diagnostic) | 50% | 50% |
| Operating shortfall (gov subsidy required) | €79 M / yr | €71 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€295 M / yr** | **€287 M / yr** |
