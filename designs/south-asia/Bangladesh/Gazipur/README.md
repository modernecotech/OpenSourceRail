...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1352 | $60 k | $81 M |
| High sensitivity check | 1352 | $120 k | $162 M |
...
|---|---|---|
| Construction (years 1–7) | **$166 M / yr** | $119 |
| Steady-state, low capacity-use (year 8+) | **$77 M / yr** | $55 |
| Steady-state, high capacity-use (year 8+) | **$21 M / yr** | $15 |
| Steady-state, operating-neutral revenue case | **$121 M / yr** | $86 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.70 bn cumulative** | $2,646 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.86 bn cumulative** | $1,328 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.15 bn cumulative** | $3,678 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.06 bn | 4.5% | 40 y, 7 y grace | $121 M / yr |
| Government equity (no debt service) | 20% | $514 M | — | — | — |
| **Total** | **100%** | **$2.57 bn** | | | **$121 M / yr** |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $77 M / yr | $21 M / yr | **$121 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.44 bn | 56% of $2.57 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.30 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $328 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 153,427 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.57 bn** |
| 15%–25% planning risk envelope | $2.96 bn–$3.21 bn |
| Annual OPEX | $56 M / yr |
| Low/high project NPV at 8% | $-1618157 k / $-1242476 k |
| Low/high project IRR | -2.7% / 1.3% |
| Low/high steady-state DSCR | 0.36 / 0.83 |
