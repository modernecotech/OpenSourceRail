...
| Revenue fleet | 416 × 4-car trainsets |
| Revenue fleet passenger capacity | 199,680 AW2 pax (266,240 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 37.5 km | 24 | 85 | S Mid ↔ N Mid |
| line-2 | 35.2 km | 22 | 78 | NW Mid ↔ E Outer |
| line-3 | 48.5 km | 26 | 101 | NE Outer ↔ SW Outer |
| line-4 | 47.0 km | 24 | 96 | SE Outer ↔ NW Outer |
| line-5 | 30.3 km | 17 | 67 | N Outer ↔ SW Mid |
| line-6 | 66.1 km | 36 | 35 | NW Mid ↔ W Mid |
| **Total** | **264.5 km** | **149 unique** | **462** | |
...
| Revenue fleet capacity | 199,680 AW2 pax (266,240 AW3 crush) |
| Total fleet capacity | 221,760 AW2 pax (295,680 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 416 × 480 = **199,680 AW2 passengers** (266,240 AW3 crush)
- **Total fleet passenger capacity:** 462 × 480 = **221,760 AW2 passengers** (295,680 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 70 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **135** | **45,200 kW** | **241,000 kWh** |

Aggregate station-rail charging power: **202,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **393.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.0× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 617 kWh usable margin across the worst powered-stop gap (line-4) |
| Lowest traversal charging margin | 501 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 1,643 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 393.6 MW / 1,889 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 241 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 24 | 375 kWh | 1,225 kWh | 813 kWh | 2.0 km / 20 kWh |
| line-2 | 20 | 351 kWh | 1,029 kWh | 642 kWh | 5.9 km / 59 kWh |
| line-3 | 22 | 484 kWh | 1,152 kWh | 619 kWh | 10.0 km / 100 kWh |
| line-4 | 20 | 469 kWh | 1,029 kWh | 513 kWh | 10.3 km / 103 kWh |
| line-5 | 16 | 302 kWh | 833 kWh | 501 kWh | 6.0 km / 60 kWh |
| line-6 | 33 | 660 kWh | 1,617 kWh | 891 kWh | 5.8 km / 58 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (239.7 km @ $3.0 M/km) | $719 M |
| Elevated (24.8 km @ $12.0 M/km) | $298 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 462 | $1.12 M | $517 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1848 | $60 k | $111 M |
| High sensitivity check | 1848 | $120 k | $222 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 393,645 kW @ $700/kW | $276 M |
| Grid interconnection / PPA tie-in | 393,645 kW @ $100/kW | $39 M |
| Annual generation proxy | 393.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 689.7 GWh/yr |
| **Dedicated solar plant subtotal** | | **$315 M** |
...
| EPC integration + project management (7%) | on subtotal | $181 M |
...
| Dedicated solar power plant | $315 M |
| Residual train-control wayside + charging microgrids | $58 M |
| EPC overhead (7%) | $181 M |
| **CAPEX total** | **$3.09 bn** |
| Per-route-km | $12 M / km |
| Per-capita (city pop) | $2,206 / person |
...
|---|---|---|
| Construction (years 1–7) | **$199 M / yr** | $142 |
| Steady-state, low capacity-use (year 8+) | **$110 M / yr** | $79 |
| Steady-state, high capacity-use (year 8+) | **$54 M / yr** | $39 |
| Steady-state, operating-neutral revenue case | **$145 M / yr** | $104 |
| Lifecycle envelope (yr 1–40, low scenario) | **$5.03 bn cumulative** | $3,591 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.18 bn cumulative** | $2,273 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.19 bn cumulative** | $4,419 |

_Population basis: 1,400,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $35 M / yr → $91 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.47 bn | 4.5% | 40 y, 7 y grace | $145 M / yr |
| Government equity (no debt service) | 20% | $618 M | — | — | — |
| **Total** | **100%** | **$3.09 bn** | | | **$145 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $111 M / yr = **$111 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($88 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (678.9 GWh / yr) | 107,639 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 79.2 GWh/yr + dedicated solar plant 393.6 MW / 689.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.7 M |
| Labour (1,496 FTE) | driverless roster: OCC/remote 244, station/platform 604, passenger service 111, fleet maintenance 281, infrastructure/energy 229, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $4.9 M |
| **OPEX subtotal** | | **$69 M / yr** |

_Annual service work: 107,639 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 42.4 M train-km / yr (169.7 M car-km / yr). On-site PV covers 79.2 GWh/yr and the dedicated solar plant adds 689.7 GWh/yr against 678.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 462 trainsets, 149 stations, 264.5 route-km, 6 lines, and 107,639 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 111.7 M |
| Annual paid trips / city resident | 128 | 205 | 80 |
| Farebox revenue | $93 M / yr | $149 M / yr | $58 M / yr |
| Station shop leases | $4.3 M / yr | $4.3 M / yr | $4.3 M / yr |
| Advertising boards | $6.7 M / yr | $6.7 M / yr | $6.7 M / yr |
| **Total revenue** | **$104 M / yr** | **$160 M / yr** | **$69 M / yr** |
| Revenue / OPEX recovery | 151% | 232% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gross repayable-debt service + residual OPEX subsidy | $145 M / yr | $145 M / yr | **$145 M / yr** |
| Operating surplus applied to debt support | -$35 M / yr | -$91 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $110 M / yr | $54 M / yr | **$145 M / yr** |
| Operating surplus after OPEX (before debt support) | $35 M / yr | $91 M / yr | $0 / yr |

_Commercial-revenue assumptions: 26,280 m² of station shop/kiosk leases at $16/m²/month and 4,804 advertising boards at $136/board/month, with occupancy derates applied._
...
| **Annual quantified benefit / activity proxy** | **$197 M / yr** | **$316 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 33,208 trips/school day; 7.3 M access-events/yr | 53,133 trips/school day; 11.7 M access-events/yr |
| Healthcare | 15 healthcare anchors | 43,851 trips/day; 16.0 M access-events/yr | 70,162 trips/day; 25.6 M access-events/yr |
| Commerce | 65 major/terminal/interchange nodes | 101,059 trips/trading day; 33.3 M access-events/yr | 161,694 trips/trading day; 53.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.73 bn | 56% of $3.09 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.77 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $396 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 184,927 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.77 bn |
| Timetable-sized dedicated solar CAPEX | $315 M |
| **Reconciled project CAPEX** | **$3.09 bn** |
| 15%–25% planning risk envelope | $3.55 bn–$3.86 bn |
| Annual OPEX | $69 M / yr |
| Low/high project NPV at 8% | $-2061353 k / $-1685671 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,661.49 train-km; 66,512.51 kWh consumed; 72,473.98 kWh charged; 15 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 108,161.16 train-km; 1,079,949.44 kWh consumed; 1,099,526.03 kWh charged; 1,028 depot services completed (1 active at cutoff); minimum SoC 84%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 80.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 81.7% | 100.0% / 90% | pass |
| 50% charging-contact availability | 83.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.8% / 60% | pass |
| ten-hour single charging-pad outage | 83.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 149 line platforms, 15 interchange complexes, 117 civil segments, and 0 input findings |
