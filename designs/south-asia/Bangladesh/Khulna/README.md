...
|---|---|---|---|
| `metro-4car` (revenue + spare + cold reserve) | 152 | $5.60 M | $851 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 608 | $100 k | $61 M |
| High sensitivity check | 608 | $200 k | $122 M |
...
|---|---|---|
| Construction (years 1–7) | **$155 M / yr** | $104 |
| Steady-state, low-ridership (year 8+) | **$189 M / yr** | $126 |
| Steady-state, high-ridership (year 8+) | **$174 M / yr** | $116 |
| Steady-state, operating-neutral revenue case | **$153 M / yr** | $102 |
| Lifecycle envelope (yr 1–30, low scenario) | **$5.43 bn cumulative** | $3,619 |
| Lifecycle envelope (yr 1–30, high scenario) | **$5.09 bn cumulative** | $3,396 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$4.62 bn cumulative** | $3,078 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $35 M / yr → $21 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.42 bn | 3.8% | 30 y, 7 y grace | $94 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $593 M | 8.5% | 30 y, 7 y grace | $60 M / yr |
| Government equity (no debt service) | 15% | $356 M | — | — | — |
| **Total** | **100%** | **$2.37 bn** | | | **$153 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $54 M / yr + bonds $50 M / yr = **$104 M / yr** total — plus the equity tranche amortised across construction ($51 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 153,629 | 256,049 | 401,736 |
| Daily paid trips / catchment | 18% | 30% | 47% |
| Daily paid trips / city population | 10% | 17% | 27% |
| Annual paid trips | 56.1 M | 93.5 M | 146.6 M |
| Farebox revenue | $22 M / yr | $36 M / yr | $57 M / yr |
| Station shop leases | $2.4 M / yr | $2.4 M / yr | $2.4 M / yr |
| Advertising boards | $3.7 M / yr | $3.7 M / yr | $3.7 M / yr |
| **Total revenue** | **$28 M / yr** | **$43 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 44% | 67% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $189 M / yr | $174 M / yr | **$153 M / yr** |
