...
|---|---|---|
| Construction (years 1–7) | **$77 M / yr** | $52 |
| Steady-state, low-ridership (year 8+) | **$77 M / yr** | $51 |
| Steady-state, high-ridership (year 8+) | **$76 M / yr** | $51 |
| Steady-state, operating-neutral revenue case | **$76 M / yr** | $51 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.31 bn cumulative** | $1,540 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.30 bn cumulative** | $1,533 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.30 bn cumulative** | $1,533 |

_Population basis: 1,500,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $494 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $709 M | 3.8% | 30 y, 7 y grace | $47 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $295 M | 8.5% | 30 y, 7 y grace | $30 M / yr |
| Government equity (no debt service) | 15% | $177 M | — | — | — |
| **Total** | **100%** | **$1.18 bn** | | | **$76 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $27 M / yr + bonds $25 M / yr = **$52 M / yr** total — plus the equity tranche amortised across construction ($25 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
