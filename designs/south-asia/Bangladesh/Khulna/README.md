...
| Revenue fleet | 304 × 4-car trainsets |
| Revenue fleet passenger capacity | 145,920 AW2 pax (194,560 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 34.5 km | 22 | 79 | NW Outer ↔ S Mid |
| line-2 | 32.1 km | 19 | 69 | SW Mid ↔ NE Outer |
| line-3 | 26.3 km | 16 | 57 | SE Outer ↔ N Mid |
| line-4 | 19.4 km | 11 | 43 | NW Mid ↔ S Mid |
| line-5 | 27.0 km | 16 | 59 | SE Outer ↔ NW Mid |
| line-6 | 57.1 km | 36 | 31 | NW Mid ↔ W Mid |
| **Total** | **196.4 km** | **120 unique** | **338** | |
...
| Revenue fleet capacity | 145,920 AW2 pax (194,560 AW3 crush) |
| Total fleet capacity | 162,240 AW2 pax (216,320 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 304 × 480 = **145,920 AW2 passengers** (194,560 AW3 crush)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **279.4 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Lowest traversal charging margin | 326 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 182 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,166 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 279.4 MW / 1,341 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 22 | 344 kWh | 1,152 kWh | 773 kWh | 2.9 km / 29 kWh |
| line-2 | 16 | 321 kWh | 833 kWh | 480 kWh | 9.7 km / 97 kWh |
| line-3 | 13 | 263 kWh | 686 kWh | 397 kWh | 10.7 km / 106 kWh |
| line-4 | 10 | 193 kWh | 539 kWh | 326 kWh | 4.9 km / 49 kWh |
| line-5 | 14 | 270 kWh | 735 kWh | 438 kWh | 4.5 km / 45 kWh |
| line-6 | 36 | 570 kWh | 1,764 kWh | 1,137 kWh | 3.7 km / 37 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (168.7 km @ $3.0 M/km) | $506 M |
| Elevated (27.7 km @ $12.0 M/km) | $332 M |
| Elevated-interchange premium (7 sites @ $4.50 M) | $32 M |
| **Civil subtotal** | **$870 M** |
...
| `interchange` | 15 | $8.0 M | $120 M |
| `interchange-elevated` | 20 | $12.0 M | $240 M |
| **Stations subtotal** | | | **$600 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 279,437 kW @ $700/kW | $196 M |
| Grid interconnection / PPA tie-in | 279,437 kW @ $100/kW | $28 M |
| Annual generation proxy | 279.4 MW × 4.8 peak-sun-h/day × 365 d/yr | 489.6 GWh/yr |
| **Dedicated solar plant subtotal** | | **$224 M** |
...
|---|---|---|
| Construction (years 1–7) | **$151 M / yr** | $101 |
| Steady-state, low capacity-use (year 8+) | **$61 M / yr** | $40 |
| Steady-state, high capacity-use (year 8+) | **$4.8 M / yr** | $3 |
| Steady-state, operating-neutral revenue case | **$110 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.06 bn cumulative** | $2,041 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.22 bn cumulative** | $811 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.70 bn cumulative** | $3,131 |

_Population basis: 1,500,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $50 M / yr → $105 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.88 bn | 4.5% | 40 y, 7 y grace | $110 M / yr |
| Government equity (no debt service) | 20% | $469 M | — | — | — |
| **Total** | **100%** | **$2.34 bn** | | | **$110 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $84 M / yr = **$84 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($67 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (492.3 GWh / yr) | 78,053 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 66.6 GWh/yr + dedicated solar plant 279.4 MW / 489.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.4 M |
| Labour (1,197 FTE) | driverless roster: OCC/remote 187, station/platform 494, passenger service 111, fleet maintenance 204, infrastructure/energy 174, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $3.9 M |
| **OPEX subtotal** | | **$52 M / yr** |

_Annual service work: 78,053 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 30.8 M train-km / yr (123.1 M car-km / yr). On-site PV covers 66.6 GWh/yr and the dedicated solar plant adds 489.6 GWh/yr against 492.3 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 338 trainsets, 120 stations, 196.4 route-km, 6 lines, and 78,053 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 84.0 M |
| Annual paid trips / city resident | 119 | 191 | 56 |
| Farebox revenue | $93 M / yr | $149 M / yr | $44 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$102 M / yr** | **$158 M / yr** | **$52 M / yr** |
| Revenue / OPEX recovery | 194% | 301% | 100% |
...
| Operating surplus applied to debt support | -$50 M / yr | -$105 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $61 M / yr | $4.8 M / yr | **$110 M / yr** |
| Operating surplus after OPEX (before debt support) | $50 M / yr | $105 M / yr | $0 / yr |

_Commercial-revenue assumptions: 20,928 m² of station shop/kiosk leases at $16/m²/month and 3,840 advertising boards at $136/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 5 education anchors | 25,406 trips/school day; 5.6 M access-events/yr | 40,650 trips/school day; 8.9 M access-events/yr |
| Healthcare | 9 healthcare anchors | 37,533 trips/day; 13.7 M access-events/yr | 60,052 trips/day; 21.9 M access-events/yr |
| Commerce | 57 major/terminal/interchange nodes | 103,057 trips/trading day; 34.0 M access-events/yr | 164,891 trips/trading day; 54.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.32 bn | 56% of $2.34 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 141,307 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.12 bn |
| Timetable-sized dedicated solar CAPEX | $224 M |
| **Reconciled project CAPEX** | **$2.34 bn** |
| 15%–25% planning risk envelope | $2.70 bn–$2.93 bn |
| Annual OPEX | $52 M / yr |
| Low/high project NPV at 8% | $-1411352 k / $-1035670 k |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 5,419.09 train-km; 54,107.55 kWh consumed; 59,271.07 kWh charged; 32 depot services completed; minimum SoC 83%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 78,666.75 train-km; 785,457.80 kWh consumed; 799,496.01 kWh charged; 1,000 depot services completed (6 active at cutoff); minimum SoC 81%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 76.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 74.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 81.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.3% / 60% | pass |
| ten-hour single charging-pad outage | 81.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 120 line platforms, 9 interchange complexes, 118 civil segments, and 0 input findings |
