...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$5.36 bn (85.2%) of external capital** and **$6.72 bn of external interest**. Capital plus saved interest totals **$12.08 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (283.6 km @ $2.58 M/km) | $733 M |
| Elevated (40.1 km @ $9.75 M/km) | $391 M |
| Elevated-interchange premium (15 sites @ $4.50 M) | $68 M |
| **Civil subtotal** | **$1.19 bn** |
...
| Per-capita (city pop) | $672 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.19 bn | 15% | $179 M | $1.01 bn |
...
| EPC / project services | $187 M | 15% | $28 M | $159 M |
| **Total city CAPEX** | **$3.50 bn** | **26.7%** | **$933 M** | **$2.56 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.7%** | **$933 M** | **$133 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.3%** | **$2.56 bn** | **$366 M / yr** |
| of which planned local bond issuance | 58.6% of total CAPEX | $2.05 bn | $293 M / yr |
| **Total city programme** | **100.0%** | **$3.50 bn** | **$499 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $4.72 bn | $3.79 bn (80.2%) | $4.75 bn | **$8.53 bn** |
| **Default** | 2.00× | $6.29 bn | $5.36 bn (85.2%) | $6.72 bn | **$12.08 bn** |
| High | 3.00× | $9.44 bn | $8.51 bn (90.1%) | $10.66 bn | **$19.17 bn** |

At the default 2.00× case, OSR's $933 M external requirement is 85.2% below the illustrative foreign-company requirement of $6.29 bn; the associated lifetime external-interest saving is $6.72 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$289 M / yr** | $56 |
| Steady-state, low capacity-use (year 8+) | **$129 M / yr** | $25 |
| Steady-state, high capacity-use (year 8+) | **$14 M / yr** | $3 |
| Steady-state, operating-neutral revenue case | **$242 M / yr** | $46 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.27 bn cumulative** | $1,206 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.50 bn cumulative** | $480 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$10.00 bn cumulative** | $1,924 |

_Population basis: 5,200,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $113 M / yr → $227 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 27% | $933 M | 4.5% | 40 y, 7 y grace | $55 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.05 bn | 8.5% | 40 y, 7 y grace | $187 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $513 M | — | — | — |
| **Total** | **100%** | **$3.50 bn** | | | **$242 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $42 M / yr + local bonds $174 M / yr = **$216 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($73 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Annual paid trips | 366.6 M | 586.6 M | 149.1 M |
| Annual paid trips / city resident | 71 | 113 | 29 |
| Farebox revenue | $191 M / yr | $305 M / yr | $78 M / yr |
| Station shop leases | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| Advertising boards | $4.6 M / yr | $4.6 M / yr | $4.6 M / yr |
| **Total revenue** | **$198 M / yr** | **$312 M / yr** | **$85 M / yr** |
| Revenue / OPEX recovery | 233% | 368% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gross repayable-debt service + residual OPEX subsidy | $242 M / yr | $242 M / yr | **$242 M / yr** |
| Operating surplus applied to debt support | -$113 M / yr | -$227 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $129 M / yr | $14 M / yr | **$242 M / yr** |
| Operating surplus after OPEX (before debt support) | $113 M / yr | $227 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.56 bn | 73% of $3.50 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $4.10 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $586 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 273,776 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.86 bn |
| Timetable-sized dedicated solar CAPEX | $639 M |
| **Reconciled project CAPEX** | **$3.50 bn** |
| Imported / external-capital requirement | $933 M (26.7%) |
| Local-content / local-funding requirement | $2.56 bn (73.3%) |
| Default foreign-turnkey external-capital comparison | $6.29 bn; OSR saves $5.36 bn (85.2%) |
| Lifetime external interest and combined financing saving | $6.72 bn interest; $12.08 bn capital + interest |
| 15%–25% planning risk envelope | $4.02 bn–$4.37 bn |
| Annual OPEX | $85 M / yr |
| Low/high project NPV at 8% | $-1840402 k / $-1071962 k |
| Low/high project IRR | 0.3% / 4.3% |
