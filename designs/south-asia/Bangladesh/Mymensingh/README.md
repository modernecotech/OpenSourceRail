...
| Bucket | Value |
|---|---|
| At-grade (35.3 km @ €3.5 M/km) | €123 M |
| Elevated (31.9 km @ €18 M/km) | €574 M |
| **Civil subtotal** | **€698 M** |
...
| Per-capita (city pop) | €1,566 / person |
...
|---|---|---|
| Construction (years 1–7) | **€72 M / yr** | €103 |
| Steady-state, low-ridership (year 8+) | **€93 M / yr** | €132 |
| Steady-state, high-ridership (year 8+) | **€89 M / yr** | €127 |
| Lifecycle envelope (yr 1–30, low scenario) | **€2.63 bn cumulative** | €3,763 |
| Lifecycle envelope (yr 1–30, high scenario) | **€2.55 bn cumulative** | €3,637 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€22 M / yr (low) → €18 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €658 M | 3.8% | 30 y, 7 y grace | €43 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €274 M | 8.5% | 30 y, 7 y grace | €28 M / yr |
| Government equity (no debt service) | 15% | €164 M | — | — | — |
| **Total** | **100%** | **€1.10 bn** | | | **€71 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €25 M / yr + bonds €23 M / yr = **€48 M / yr** total — plus the equity tranche amortised across construction (€23 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (416 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €1.3 M |
...
| Farebox revenue | €3.8 M / yr | €7.6 M / yr |
| Farebox / OPEX recovery | 15% | 30% |
| Country policy-target recovery (diagnostic) | 50% | 50% |
| Operating shortfall (gov subsidy required) | €22 M / yr | €18 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€93 M / yr** | **€89 M / yr** |
