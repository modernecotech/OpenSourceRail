...
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $35 |
| Lifecycle envelope (yr 1–40, low scenario) | **$239 M cumulative** | $341 |
| Lifecycle envelope (yr 1–40, high scenario) | **$239 M cumulative** | $341 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.06 bn cumulative** | $1,510 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $422 M | 4.5% | 40 y, 7 y grace | $25 M / yr |
| Government equity (no debt service) | 20% | $106 M | — | — | — |
| **Total** | **100%** | **$528 M** | | | **$25 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $306 M | 58% of $528 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $489 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $70 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 32,659 job-years | retained CAPEX ÷ (4.0 × median annual income) |
