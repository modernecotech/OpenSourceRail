...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **71,925 – 129,465 trips/day**
...
| Per-capita (city pop) | $1,735 / person |
...
|---|---|---|
| Construction (years 1–7) | **$29 M / yr** | $42 |
| Steady-state, low-ridership (year 8+) | **$42 M / yr** | $60 |
| Steady-state, high-ridership (year 8+) | **$31 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $36 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.59 bn cumulative** | $2,278 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.23 bn cumulative** | $1,763 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.04 bn cumulative** | $1,488 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $17 M / yr → $5.8 M / yr._
...
| Traction energy (196.0 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (416 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$32 M / yr** |

_Annual fleet utilisation: 97 revenue trainsets × 20.5 h/day × 365 d/yr × 30 km/h commercial × 75% revenue factor = 16.3 M train-km / yr (~168 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 71,925 | 129,465 | 160,118 |
| Daily paid trips / catchment | 25% | 45% | 56% |
| Daily paid trips / city population | 10% | 18% | 23% |
| Annual paid trips | 26.3 M | 47.3 M | 58.4 M |
| Farebox revenue | $14 M / yr | $25 M / yr | $30 M / yr |
| Station shop leases | $717 k / yr | $717 k / yr | $717 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$16 M / yr** | **$27 M / yr** | **$32 M / yr** |
| Revenue / OPEX recovery | 48% | 82% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov repayable-debt service + residual OPEX subsidy | $42 M / yr | $31 M / yr | **$25 M / yr** |
