...
| Steady-state, low-ridership (year 8+) | **$56 M / yr** | $80 |
| Steady-state, high-ridership (year 8+) | **$51 M / yr** | $72 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $69 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.62 bn cumulative** | $2,321 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.51 bn cumulative** | $2,160 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.46 bn cumulative** | $2,090 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.0 M / yr → $2.1 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $451 M | 3.8% | 30 y, 7 y grace | $30 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $188 M | 8.5% | 30 y, 7 y grace | $19 M / yr |
| Government equity (no debt service) | 15% | $113 M | — | — | — |
| **Total** | **100%** | **$752 M** | | | **$49 M / yr** |
