...
|---|---|---|---|---|
| line-1 | 11.6 km | 7 | 30 | NW Mid ↔ S Mid |
| line-2 | 11.0 km | 8 | 28 | W Mid ↔ NE Inner |
| line-3 | 19.7 km | 10 | 51 | NE Outer ↔ S Mid |
| **Total** | **42.3 km** | **25 unique** | **109** | |
...
| Onboard battery adequacy | 7.8× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 471 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Dedicated solar plant | 47.8 MW / 229 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 87 kWh | 151 kWh | 56 kWh | 2.1 km / 16 kWh |
| line-2 | 8 | 82 kWh | 147 kWh | 56 kWh | 2.0 km / 15 kWh |
| line-3 | 8 | 148 kWh | 233 kWh | 70 kWh | 9.2 km / 69 kWh |
...
| Elevated (17.7 km @ $12.0 M/km) | $213 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$291 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 47,752 kW @ $700/kW | $33 M |
| Grid interconnection / PPA tie-in | 47,752 kW @ $100/kW | $4.8 M |
| Annual generation proxy | 47.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 83.7 GWh/yr |
...
| Per-capita (city pop) | $868 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$361 M cumulative** | $516 |
| Lifecycle envelope (yr 1–40, high scenario) | **$275 M cumulative** | $392 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.22 bn cumulative** | $1,738 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $486 M | 4.5% | 40 y, 7 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $122 M | — | — | — |
| **Total** | **100%** | **$608 M** | | | **$29 M / yr** |
...
| Traction energy (93.1 GWh / yr) | 19,675 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 20.3 GWh/yr + dedicated solar plant 47.8 MW / 83.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $573 k |
| Labour (341 FTE) | driverless roster: OCC/remote 73, station/platform 98, passenger service 49, fleet maintenance 59, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 19,675 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.3 M car-km / yr). On-site PV covers 20.3 GWh/yr and the dedicated solar plant adds 83.7 GWh/yr against 93.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 109 trainsets, 25 stations, 42.3 route-km, 3 lines, and 19,675 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 105 | 168 | 34 |
| Farebox revenue | $38 M / yr | $61 M / yr | $12 M / yr |
| Station shop leases | $658 k / yr | $658 k / yr | $658 k / yr |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $2.6 M / yr | $0 k / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $26 M / yr | $49 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,992 m² of station shop/kiosk leases at $16/m²/month and 764 advertising boards at $136/board/month, with occupancy derates applied._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $353 M | 58% of $608 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $564 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $81 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 37,690 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$608 M** |
| 15%–25% planning risk envelope | $699 M–$759 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-277664 k / $-123976 k |
| Low/high project IRR | 1.8% / 5.7% |
| Low/high steady-state DSCR | 0.91 / 1.71 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,710.43 train-km; 12,807.54 kWh consumed; 12,850.46 kWh charged; 33 depot services completed; minimum SoC 79%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,160.95 train-km; 150,963.49 kWh consumed; 150,399.67 kWh charged; 490 depot services completed (6 active at cutoff); minimum SoC 45%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 32.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 23.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 44.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 94.2% / 60% | pass |
| ten-hour single charging-pad outage | 42.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 2 interchange complexes, 19 civil segments, and 0 input findings |
