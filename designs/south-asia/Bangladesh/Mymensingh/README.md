...
|---|---|---|
| Construction (years 1–7) | **$67 M / yr** | $95 |
| Steady-state, low-ridership (year 8+) | **$82 M / yr** | $117 |
| Steady-state, high-ridership (year 8+) | **$77 M / yr** | $110 |
| Steady-state, operating-neutral revenue case | **$66 M / yr** | $94 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.35 bn cumulative** | $3,358 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.24 bn cumulative** | $3,196 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.98 bn cumulative** | $2,828 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $16 M / yr → $11 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $610 M | 3.8% | 30 y, 7 y grace | $40 M / yr |
...
|---|---|---|---|
| Daily paid trips | 51,786 | 86,310 | 165,102 |
| Daily paid trips / catchment | 18% | 30% | 57% |
| Daily paid trips / city population | 7% | 12% | 24% |
| Annual paid trips | 18.9 M | 31.5 M | 60.3 M |
| Farebox revenue | $7.4 M / yr | $12 M / yr | $24 M / yr |
| Station shop leases | $717 k / yr | $717 k / yr | $717 k / yr |
| Advertising boards | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| **Total revenue** | **$9.3 M / yr** | **$14 M / yr** | **$25 M / yr** |
| Revenue / OPEX recovery | 37% | 56% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $82 M / yr | $77 M / yr | **$66 M / yr** |
