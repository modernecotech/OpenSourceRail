...
| Steady-state, low-ridership (year 8+) | **$40 M / yr** | $57 |
| Steady-state, high-ridership (year 8+) | **$36 M / yr** | $52 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $52 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.17 bn cumulative** | $1,676 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.09 bn cumulative** | $1,562 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.09 bn cumulative** | $1,562 |

_Population basis: 700,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.5 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $337 M | 3.8% | 30 y, 7 y grace | $22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $140 M | 8.5% | 30 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $84 M | — | — | — |
| **Total** | **100%** | **$562 M** | | | **$36 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $12 M / yr = **$25 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 51,786 | 86,310 | 76,127 |
| Daily paid trips / catchment | 18% | 30% | 26% |
| Daily paid trips / city population | 7% | 12% | 11% |
| Annual paid trips | 18.9 M | 31.5 M | 27.8 M |
| Farebox revenue | $7.4 M / yr | $12 M / yr | $11 M / yr |
