# Mymensingh Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 960 |
| Manufacturing material/BOM rows | 14,359 |
| Manufacturing QA verification rows | 960 |
| Construction QA action rows | 893 |
| Maintenance handover schedule rows | 1,142 |
| Manufacturing rows with material refs | 960 / 960 |
| Manufacturing rows with verification refs | 960 / 960 |
| Manufacturing rows linked to QA actions | 960 / 960 |
