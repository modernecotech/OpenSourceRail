...
|---|---|---|---|---|
| line-1 | 18.0 km | 10 | 47 | E Mid ↔ W Outer |
| line-2 | 10.3 km | 7 | 26 | SE Mid ↔ NE Inner |
| line-3 | 14.1 km | 9 | 37 | N Mid ↔ SW Inner |
| **Total** | **42.4 km** | **26 unique** | **110** | |
...
| Onboard battery adequacy | 13.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 498 kWh usable margin across the worst powered-stop gap (line-1) |
...
| Dedicated solar plant | 47.2 MW / 226 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 134 kWh | 229 kWh | 81 kWh | 5.6 km / 42 kWh |
| line-2 | 7 | 77 kWh | 131 kWh | 46 kWh | 2.2 km / 17 kWh |
| line-3 | 9 | 106 kWh | 192 kWh | 76 kWh | 2.0 km / 15 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (38.7 km @ $3.0 M/km) | $116 M |
| Elevated (3.7 km @ $12.0 M/km) | $45 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 47,157 kW @ $700/kW | $33 M |
| Grid interconnection / PPA tie-in | 47,157 kW @ $100/kW | $4.7 M |
| Annual generation proxy | 47.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 82.6 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$33 M / yr** | $35 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$234 M cumulative** | $247 |
| Lifecycle envelope (yr 1–40, high scenario) | **$234 M cumulative** | $247 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.04 bn cumulative** | $1,093 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $415 M | 4.5% | 40 y, 7 y grace | $24 M / yr |
| Government equity (no debt service) | 20% | $104 M | — | — | — |
| **Total** | **100%** | **$519 M** | | | **$24 M / yr** |
...
| Traction energy (93.2 GWh / yr) | 19,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.4 GWh/yr + dedicated solar plant 47.2 MW / 82.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $566 k |
| Labour (358 FTE) | driverless roster: OCC/remote 73, station/platform 115, passenger service 49, fleet maintenance 59, infrastructure/energy 41, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 19,706 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.8 M train-km / yr (23.3 M car-km / yr). On-site PV covers 21.4 GWh/yr and the dedicated solar plant adds 82.6 GWh/yr against 93.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 110 trainsets, 26 stations, 42.4 route-km, 3 lines, and 19,706 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 19.6 M |
| Annual paid trips / city resident | 77 | 123 | 21 |
| Farebox revenue | $38 M / yr | $61 M / yr | $10 M / yr |
| Station shop leases | $828 k / yr | $828 k / yr | $828 k / yr |
...
_Commercial-revenue assumptions: 5,024 m² of station shop/kiosk leases at $16/m²/month and 932 advertising boards at $136/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 5 education anchors | 14,062 trips/school day; 3.1 M access-events/yr | 22,499 trips/school day; 4.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $294 M | 57% of $519 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 31,369 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $-198078 k / $-44390 k |
| Low/high project IRR | 3.1% / 7.1% |
| Low/high steady-state DSCR | 1.15 / 2.08 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,719.95 train-km; 12,878.84 kWh consumed; 13,499.88 kWh charged; 31 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 20,406.68 train-km; 152,803.52 kWh consumed; 155,896.47 kWh charged; 489 depot services completed (6 active at cutoff); minimum SoC 61%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 52.3% | 100.0% / 90% | pass |
...
| ten-hour single charging-pad outage | 24.3% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 2 interchange complexes, 54 civil segments, and 0 input findings |
