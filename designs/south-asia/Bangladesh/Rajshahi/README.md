...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.8 km × €0.015 M/km | €0.7 M |
...
| Steady-state, low-ridership (year 8+) | **€40 M / yr** | €42 |
| Steady-state, high-ridership (year 8+) | **€35 M / yr** | €37 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.15 bn cumulative** | €1,208 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.03 bn cumulative** | €1,082 |

_Population basis: 950,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€7.9 M / yr (low) → €2.8 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €297 M | 3.8% | 30 y, 7 y grace | €20 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €124 M | 8.5% | 30 y, 7 y grace | €12 M / yr |
| Government equity (no debt service) | 15% | €74 M | — | — | — |
| **Total** | **100%** | **€496 M** | | | **€32 M / yr** |
...
| Labour (311 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €937 k |
...
| Operating shortfall (gov subsidy required) | €7.9 M / yr | €2.8 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€40 M / yr** | **€35 M / yr** |
