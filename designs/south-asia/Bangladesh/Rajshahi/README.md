...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **28,880 – 43,320 trips/day**
...
| Elevated (1.0 km @ $5.5 M/km) | $5.5 M |
| **Civil subtotal** | **$63 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 49.8 km × $0.015 M/km | $747 k |
...
|---|---|---|
| Construction (years 1–7) | **$10 M / yr** | $11 |
| Steady-state, low-ridership (year 8+) | **$2.0 M / yr** | $2 |
| Steady-state, high-ridership (year 8+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$117 M cumulative** | $123 |
| Lifecycle envelope (yr 1–30, high scenario) | **$71 M cumulative** | $75 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$71 M cumulative** | $75 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $93 M | 3.8% | 30 y, 7 y grace | $6.2 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $39 M | 8.5% | 30 y, 7 y grace | $3.9 M / yr |
| Government equity (no debt service) | 15% | $23 M | — | — | — |
| **Total** | **100%** | **$155 M** | | | **$10 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.5 M / yr + bonds $3.3 M / yr = **$6.8 M / yr** total — plus the equity tranche amortised across construction ($3.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 76,000 | 142,500 | 89,905 |
| Daily paid trips / population | 8% | 15% | 9% |
| Annual paid trips | 27.7 M | 52.0 M | 32.8 M |
