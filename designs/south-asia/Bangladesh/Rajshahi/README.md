...
| Steady-state, low-ridership (year 8+) | **$44 M / yr** | $46 |
| Steady-state, high-ridership (year 8+) | **$39 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$38 M / yr** | $40 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.28 bn cumulative** | $1,346 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.17 bn cumulative** | $1,227 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.13 bn cumulative** | $1,190 |

_Population basis: 950,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.5 M / yr → $1.5 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $348 M | 3.8% | 30 y, 7 y grace | $23 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $145 M | 8.5% | 30 y, 7 y grace | $15 M / yr |
| Government equity (no debt service) | 15% | $87 M | — | — | — |
| **Total** | **100%** | **$581 M** | | | **$38 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $12 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 51,984 | 86,640 | 97,345 |
| Daily paid trips / catchment | 18% | 30% | 34% |
| Daily paid trips / city population | 5% | 9% | 10% |
| Annual paid trips | 19.0 M | 31.6 M | 35.5 M |
...
| Revenue / OPEX recovery | 59% | 90% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gov debt service + residual OPEX subsidy | $44 M / yr | $39 M / yr | **$38 M / yr** |
