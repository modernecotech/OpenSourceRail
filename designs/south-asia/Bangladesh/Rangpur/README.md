...
|---|---|---|---|---|
| line-1 | 13.4 km | 8 | 35 | E Mid ↔ W Mid |
| line-2 | 17.7 km | 10 | 47 | NE Outer ↔ S Mid |
| line-3 | 14.9 km | 8 | 40 | SW Mid ↔ NW Outer |
| **Total** | **46.0 km** | **26 unique** | **122** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **52.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.4× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 503 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 61 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 52.3 MW / 251 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 100 kWh | 172 kWh | 61 kWh | 2.3 km / 17 kWh |
| line-2 | 9 | 133 kWh | 229 kWh | 83 kWh | 5.0 km / 37 kWh |
| line-3 | 8 | 112 kWh | 196 kWh | 73 kWh | 2.8 km / 21 kWh |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 366 | $60 k | $22 M |
| High sensitivity check | 366 | $120 k | $44 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 52,338 kW @ $700/kW | $37 M |
| Grid interconnection / PPA tie-in | 52,338 kW @ $100/kW | $5.2 M |
| Annual generation proxy | 52.3 MW × 4.8 peak-sun-h/day × 365 d/yr | 91.7 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$31 M / yr** | $39 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$216 M cumulative** | $270 |
| Lifecycle envelope (yr 1–40, high scenario) | **$216 M cumulative** | $270 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$957 M cumulative** | $1,196 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $382 M | 4.5% | 40 y, 7 y grace | $22 M / yr |
| Government equity (no debt service) | 20% | $96 M | — | — | — |
| **Total** | **100%** | **$478 M** | | | **$22 M / yr** |
...
| Traction energy (101.1 GWh / yr) | 21,374 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.4 GWh/yr + dedicated solar plant 52.3 MW / 91.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $628 k |
| Labour (344 FTE) | driverless roster: OCC/remote 77, station/platform 89, passenger service 49, fleet maintenance 65, infrastructure/energy 43, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.1 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 21,374 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 8.4 M train-km / yr (25.3 M car-km / yr). On-site PV covers 21.4 GWh/yr and the dedicated solar plant adds 91.7 GWh/yr against 101.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 122 trainsets, 26 stations, 46.0 route-km, 3 lines, and 21,374 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 19.4 M |
| Annual paid trips / city resident | 92 | 147 | 24 |
| Farebox revenue | $38 M / yr | $61 M / yr | $10 M / yr |
| Station shop leases | $601 k / yr | $601 k / yr | $601 k / yr |
| Advertising boards | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| **Total revenue** | **$40 M / yr** | **$63 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 340% | 536% | 100% |
...
_Commercial-revenue assumptions: 3,648 m² of station shop/kiosk leases at $16/m²/month and 720 advertising boards at $136/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 6 education anchors | 18,883 trips/school day; 4.2 M access-events/yr | 30,212 trips/school day; 6.6 M access-events/yr |
| Healthcare | 3 healthcare anchors | 16,271 trips/day; 5.9 M access-events/yr | 26,034 trips/day; 9.5 M access-events/yr |
| Commerce | 11 major/terminal/interchange nodes | 41,065 trips/trading day; 13.6 M access-events/yr | 65,703 trips/trading day; 21.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $266 M | 56% of $478 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 28,411 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,839.78 train-km; 13,776.11 kWh consumed; 14,416.20 kWh charged; 30 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 22,122.72 train-km; 165,652.96 kWh consumed; 169,235.32 kWh charged; 492 depot services completed (6 active at cutoff); minimum SoC 63%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 54.5% | 100.0% / 90% | pass |
...
| ten-hour single charging-pad outage | 43.7% | 100.0% / 90% | pass |
