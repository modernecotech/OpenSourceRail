...
| Steady-state, low-ridership (year 8+) | **$29 M / yr** | $37 |
| Steady-state, high-ridership (year 8+) | **$29 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $37 |
| Lifecycle envelope (yr 1–30, low scenario) | **$884 M cumulative** | $1,105 |
| Lifecycle envelope (yr 1–30, high scenario) | **$884 M cumulative** | $1,105 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$884 M cumulative** | $1,105 |
...
| **Total** | **100%** | **$454 M** | | | **$29 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $10 M / yr + bonds $9.7 M / yr = **$20 M / yr** total — plus the equity tranche amortised across construction ($9.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
