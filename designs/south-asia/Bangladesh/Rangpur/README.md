...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 59.5 km × $0.015 M/km | $3.0 M |
...
| Per-capita (city pop) | $434 / person |
...
| Steady-state, low-ridership (year 8+) | **$22 M / yr** | $28 |
| Steady-state, high-ridership (year 8+) | **$22 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$22 M / yr** | $28 |
| Lifecycle envelope (yr 1–30, low scenario) | **$675 M cumulative** | $844 |
| Lifecycle envelope (yr 1–30, high scenario) | **$675 M cumulative** | $844 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$675 M cumulative** | $844 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $208 M | 3.8% | 30 y, 7 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $87 M | 8.5% | 30 y, 7 y grace | $8.7 M / yr |
| Government equity (no debt service) | 15% | $52 M | — | — | — |
| **Total** | **100%** | **$347 M** | | | **$22 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $7.9 M / yr + bonds $7.4 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($7.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
