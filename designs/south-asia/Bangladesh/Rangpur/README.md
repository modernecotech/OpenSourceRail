...
|---|---|---|
| Construction (years 1–7) | **$28 M / yr** | $35 |
| Steady-state, low capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$20 M / yr** | $25 |
| Lifecycle envelope (yr 1–40, low scenario) | **$195 M cumulative** | $243 |
| Lifecycle envelope (yr 1–40, high scenario) | **$195 M cumulative** | $243 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$863 M cumulative** | $1,079 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $345 M | 4.5% | 40 y, 7 y grace | $20 M / yr |
| Government equity (no debt service) | 20% | $86 M | — | — | — |
| **Total** | **100%** | **$431 M** | | | **$20 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $240 M | 56% of $431 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 25,636 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Annual OPEX | $10 M / yr |
| Low/high project NPV at 8% | $-125161 k / $29 M |
| Low/high project IRR | 4.5% / 8.7% |
| Low/high steady-state DSCR | 1.44 / 2.57 |
