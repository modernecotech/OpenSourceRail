...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **68,112 – 112,320 trips/day**
...
|---|---|---|
| Construction (years 1–7) | **$19 M / yr** | $23 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $23 |
| Steady-state, high-ridership (year 8+) | **$18 M / yr** | $23 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $23 |
| Lifecycle envelope (yr 1–30, low scenario) | **$554 M cumulative** | $693 |
| Lifecycle envelope (yr 1–30, high scenario) | **$554 M cumulative** | $693 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$554 M cumulative** | $693 |
...
| **Total** | **100%** | **$285 M** | | | **$18 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $6.5 M / yr + bonds $6.1 M / yr = **$13 M / yr** total — plus the equity tranche amortised across construction ($6.1 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
