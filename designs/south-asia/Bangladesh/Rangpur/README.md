...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **68,112 – 113,520 trips/day**
...
| Steady-state, low-ridership (year 8+) | **$23 M / yr** | $28 |
| Steady-state, high-ridership (year 8+) | **$23 M / yr** | $28 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $28 |
| Lifecycle envelope (yr 1–30, low scenario) | **$683 M cumulative** | $854 |
| Lifecycle envelope (yr 1–30, high scenario) | **$683 M cumulative** | $854 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$683 M cumulative** | $854 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $211 M | 3.8% | 30 y, 7 y grace | $14 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $88 M | 8.5% | 30 y, 7 y grace | $8.8 M / yr |
| Government equity (no debt service) | 15% | $53 M | — | — | — |
| **Total** | **100%** | **$351 M** | | | **$23 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.0 M / yr + bonds $7.5 M / yr = **$15 M / yr** total — plus the equity tranche amortised across construction ($7.5 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
