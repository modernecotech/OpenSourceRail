...
**Country:** BD · **Population:** 550,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$907 M (87.0%) of external capital** and **$1.14 bn of external interest**. Capital plus saved interest totals **$2.04 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`barisal.corridor.geojson`](barisal.corridor.geojson).
...
| Route length (double track) | 61.2 km |
| Revenue fleet | 117 × 3-car trainsets |
| Revenue fleet passenger capacity | 42,120 AW2 pax (56,160 AW3 crush) |
...
| Revenue fleet capacity | 42,120 AW2 pax (56,160 AW3 crush) |
| Total fleet capacity | 46,800 AW2 pax (62,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 117 × 360 = **42,120 AW2 passengers** (56,160 AW3 crush)
- **Total fleet passenger capacity:** 130 × 360 = **46,800 AW2 passengers** (62,400 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 56.5%
- Catchment population: **≈ 310,749** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **75.8 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 461 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 61 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 53 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 28,473 train-km/day | One-way train journeys × route length |
| Annual service work | 11.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 369 MWh/day | 33.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 316 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 75.8 MW / 364 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 115 kWh | 196 kWh | 70 kWh | 3.8 km / 28 kWh |
| line-2 | 7 | 152 kWh | 229 kWh | 61 kWh | 4.9 km / 37 kWh |
| line-3 | 6 | 192 kWh | 294 kWh | 83 kWh | 10.5 km / 79 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (52.3 km @ $3.0 M/km) | $157 M |
| Elevated (8.9 km @ $12.0 M/km) | $107 M |
| **Civil subtotal** | **$264 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 130 | $900 k | $117 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 390 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 390 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 75,759 kW @ $700/kW | $53 M |
| Grid interconnection / PPA tie-in | 75,759 kW @ $100/kW | $7.6 M |
| Annual generation proxy | 75.8 MW × 4.8 peak-sun-h/day × 365 d/yr | 132.7 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 61.2 km × $0.050 M/km | $3.1 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $2.2 M |
...
|---|---:|---:|---:|---:|
| Civil works | $264 M | 15% | $40 M | $224 M |
| Stations | $91 M | 20% | $18 M | $73 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $117 M | 35% | $41 M | $76 M |
| Dedicated solar plant | $61 M | 45% | $27 M | $33 M |
| Residual signalling / train control | $3.1 M | 50% | $1.5 M | $1.5 M |
| Charging microgrids | $2.2 M | 40% | $900 k | $1.4 M |
| EPC / project services | $34 M | 15% | $5.1 M | $29 M |
| **Total city CAPEX** | **$579 M** | **23.4%** | **$135 M** | **$444 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh barisal`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.4%** | **$135 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.6%** | **$444 M** | **$63 M / yr** |
| of which planned local bond issuance | 61.3% of total CAPEX | $355 M | $51 M / yr |
| **Total city programme** | **100.0%** | **$579 M** | **$83 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $782 M | $647 M (82.7%) | $811 M | **$1.46 bn** |
| **Default** | 2.00× | $1.04 bn | $907 M (87.0%) | $1.14 bn | **$2.04 bn** |
| High | 3.00× | $1.56 bn | $1.43 bn (91.3%) | $1.79 bn | **$3.22 bn** |

At the default 2.00× case, OSR's $135 M external requirement is 87.0% below the illustrative foreign-company requirement of $1.04 bn; the associated lifetime external-interest saving is $1.14 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$49 M / yr** | $89 |
| Steady-state, low capacity-use (year 8+) | **$15 M / yr** | $27 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$834 M cumulative** | $1,516 |
| Lifecycle envelope (yr 1–40, high scenario) | **$343 M cumulative** | $623 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.67 bn cumulative** | $3,043 |

_Population basis: 550,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $25 M / yr → $40 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 23% | $135 M | 4.5% | 40 y, 7 y grace | $8.0 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $355 M | 8.5% | 40 y, 7 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $89 M | — | — | — |
| **Total** | **100%** | **$579 M** | | | **$40 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.1 M / yr + local bonds $30 M / yr = **$36 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (134.7 GWh / yr) | 28,473 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.3 GWh/yr + dedicated solar plant 75.8 MW / 132.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $909 k |
| Labour (366 FTE) | driverless roster: OCC/remote 81, station/platform 86, passenger service 49, fleet maintenance 77, infrastructure/energy 52, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.2 M |
| **OPEX subtotal** | | **$14 M / yr** |

_Annual service work: 28,473 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 11.2 M train-km / yr (33.7 M car-km / yr). On-site PV covers 19.3 GWh/yr and the dedicated solar plant adds 132.7 GWh/yr against 134.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 130 trainsets, 23 stations, 61.2 route-km, 3 lines, and 28,473 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 24.4 M |
| Annual paid trips / city resident | 133 | 213 | 44 |
| Farebox revenue | $38 M / yr | $61 M / yr | $13 M / yr |
| Station shop leases | $573 k / yr | $573 k / yr | $573 k / yr |
| Advertising boards | $941 k / yr | $941 k / yr | $941 k / yr |
| **Total revenue** | **$40 M / yr** | **$63 M / yr** | **$14 M / yr** |
| Revenue / OPEX recovery | 279% | 441% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Gross repayable-debt service + residual OPEX subsidy | $40 M / yr | $40 M / yr | **$40 M / yr** |
| Operating surplus applied to debt support | -$25 M / yr | -$40 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $15 M / yr | $0 k / yr | **$40 M / yr** |
| Operating surplus after OPEX (before debt support) | $25 M / yr | $48 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,480 m² of station shop/kiosk leases at $16/m²/month and 676 advertising boards at $136/board/month, with occupancy derates applied._
...
| Avoided road congestion | $16 M / yr | $26 M / yr | 202 M - 323 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.9 M / yr | $4.7 M / yr | 36.3–58.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.1 M / yr | $13 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$74 M / yr** | **$118 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 8 education anchors | 18,883 trips/school day; 4.2 M access-events/yr | 30,212 trips/school day; 6.6 M access-events/yr |
| Healthcare | 2 healthcare anchors | 14,162 trips/day; 5.2 M access-events/yr | 22,659 trips/day; 8.3 M access-events/yr |
| Commerce | 13 major/terminal/interchange nodes | 44,063 trips/trading day; 14.5 M access-events/yr | 70,500 trips/trading day; 23.3 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $444 M | 77% of $579 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $710 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $101 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 47,421 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $519 M |
| Timetable-sized dedicated solar CAPEX | $61 M |
| **Reconciled project CAPEX** | **$579 M** |
| Imported / external-capital requirement | $135 M (23.4%) |
| Local-content / local-funding requirement | $444 M (76.6%) |
| Default foreign-turnkey external-capital comparison | $1.04 bn; OSR saves $907 M (87.0%) |
| Lifetime external interest and combined financing saving | $1.14 bn interest; $2.04 bn capital + interest |
| 15%–25% planning risk envelope | $666 M–$724 M |
| Annual OPEX | $14 M / yr |
| Low/high project NPV at 8% | $-259882 k / $-106194 k |
| Low/high project IRR | 2.0% / 5.9% |
| Low/high steady-state DSCR | 0.63 / 1.20 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,279.49 train-km; 17,068.61 kWh consumed; 15,058.36 kWh charged; 27 depot services completed; minimum SoC 64%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,810.48 train-km; 200,754.46 kWh consumed; 186,965.32 kWh charged; 482 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.2% of scheduled train-km delivered; 132 SoC warnings; 13 energy-adapted off-peak departures, maximum 25 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 93.1% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 90.7% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.5% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.2% / 90% | pass |
...
|---|---|
| ![Barisal energy and battery simulation dashboard](engineering/screenshots/barisal-simulation-dashboard.png) | ![Barisal simulator network visualizer](engineering/screenshots/barisal-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 1 interchange complexes, 61 civil segments, and 0 input findings |
...
|---|---|
| ![Barisal QGIS engineering layers](engineering/screenshots/barisal-qgis-engineering-map.png) | ![Barisal SUMO timetable validation](engineering/screenshots/barisal-sumo-validation.png) |
...
| [`barisal.toml`](barisal.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`barisal-network-map.png`](barisal-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`barisal.corridor.geojson`](barisal.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`barisal.stations.json`](barisal.stations.json) | Machine-readable station list |
| [`barisal.design-quality.yaml`](barisal.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug barisal

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh barisal
```
