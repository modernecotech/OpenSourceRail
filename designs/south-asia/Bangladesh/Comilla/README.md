...
|---|---|---|---|---|
| line-1 | 26.5 km | 15 | 26 | SE Outer ↔ W Outer |
| line-2 | 18.7 km | 12 | 19 | SE Mid ↔ NW Mid |
| line-3 | 20.5 km | 11 | 20 | SW Mid ↔ E Outer |
| **Total** | **65.7 km** | **38 unique** | **65** | |
...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **44,171 – 73,619 trips/day**
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 65.7 km × $0.015 M/km | $3.2 M |
...
| Steady-state, high-ridership (year 8+) | **$25 M / yr** | $42 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $42 |
| Lifecycle envelope (yr 1–30, low scenario) | **$769 M cumulative** | $1,282 |
| Lifecycle envelope (yr 1–30, high scenario) | **$752 M cumulative** | $1,254 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$752 M cumulative** | $1,254 |

_Population basis: 600,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $722 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $232 M | 3.8% | 30 y, 7 y grace | $15 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $97 M | 8.5% | 30 y, 7 y grace | $9.7 M / yr |
| Government equity (no debt service) | 15% | $58 M | — | — | — |
| **Total** | **100%** | **$387 M** | | | **$25 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $8.8 M / yr + bonds $8.2 M / yr = **$17 M / yr** total — plus the equity tranche amortised across construction ($8.3 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (406 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $1.3 M |
...
|---|---|---|---|
| Daily paid trips | 44,171 | 73,619 | 49,246 |
| Daily paid trips / catchment | 18% | 30% | 20% |
| Daily paid trips / city population | 7% | 12% | 8% |
| Annual paid trips | 16.1 M | 26.9 M | 18.0 M |
| Farebox revenue | $6.3 M / yr | $10 M / yr | $7.0 M / yr |
| Station shop leases | $903 k / yr | $903 k / yr | $903 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$8.7 M / yr** | **$13 M / yr** | **$9.4 M / yr** |
| Revenue / OPEX recovery | 92% | 137% | 100% |
| Country farebox-only policy target (diagnostic) | 50% | 50% | 50% |
| Remaining steady-state gov commitment | $26 M / yr | $25 M / yr | **$25 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $3.5 M / yr | $0 / yr |
