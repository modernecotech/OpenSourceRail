...
|---|---|---|---|---|
| line-1 | 20.1 km | 13 | 52 | NW Outer ↔ E Outer |
| line-2 | 20.3 km | 12 | 50 | SW Outer ↔ E Mid |
| line-3 | 15.1 km | 10 | 40 | NE Mid ↔ SW Mid |
| **Total** | **55.5 km** | **35 unique** | **142** | |
...
| Total fleet capacity | 51,120 AW2 pax (68,160 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 128 × 360 = **46,080 AW2 passengers** (61,440 AW3 crush)
- **Total fleet passenger capacity:** 142 × 360 = **51,120 AW2 passengers** (68,160 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **63.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 500 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 73 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 263 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 63.0 MW / 303 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| line-2 | 11 | 152 kWh | 241 kWh | 73 kWh | 5.3 km / 40 kWh |
| line-3 | 10 | 113 kWh | 212 kWh | 88 kWh | 2.0 km / 15 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (52.6 km @ $3.0 M/km) | $158 M |
| Elevated (2.9 km @ $12.0 M/km) | $34 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 142 | $900 k | $128 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 426 | $60 k | $26 M |
| High sensitivity check | 426 | $120 k | $51 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 63,024 kW @ $700/kW | $44 M |
| Grid interconnection / PPA tie-in | 63,024 kW @ $100/kW | $6.3 M |
| Annual generation proxy | 63.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 110.4 GWh/yr |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $3.7 M |
...
| Per-capita (city pop) | $1,039 / person |
...
|---|---|---|
| Construction (years 1–7) | **$40 M / yr** | $67 |
| Steady-state, low capacity-use (year 8+) | **$3.6 M / yr** | $6 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$29 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$401 M cumulative** | $669 |
| Lifecycle envelope (yr 1–40, high scenario) | **$282 M cumulative** | $470 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.25 bn cumulative** | $2,080 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $26 M / yr → $29 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $499 M | 4.5% | 40 y, 7 y grace | $29 M / yr |
| Government equity (no debt service) | 20% | $125 M | — | — | — |
| **Total** | **100%** | **$623 M** | | | **$29 M / yr** |
...
| Traction energy (122.1 GWh / yr) | 25,816 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.1 GWh/yr + dedicated solar plant 63.0 MW / 110.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $756 k |
| Labour (419 FTE) | driverless roster: OCC/remote 86, station/platform 133, passenger service 49, fleet maintenance 77, infrastructure/energy 53, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.4 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 25,816 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 10.2 M train-km / yr (30.5 M car-km / yr). On-site PV covers 26.1 GWh/yr and the dedicated solar plant adds 110.4 GWh/yr against 122.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 142 trainsets, 35 stations, 55.5 route-km, 3 lines, and 25,816 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 24.0 M |
| Annual paid trips / city resident | 122 | 196 | 40 |
| Farebox revenue | $38 M / yr | $61 M / yr | $12 M / yr |
| Station shop leases | $934 k / yr | $934 k / yr | $934 k / yr |
| Advertising boards | $1.5 M / yr | $1.5 M / yr | $1.5 M / yr |
| **Total revenue** | **$41 M / yr** | **$63 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 272% | 426% | 100% |
...
| Operating surplus applied to debt support | -$26 M / yr | -$29 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $3.6 M / yr | $0 k / yr | **$29 M / yr** |
| Operating surplus after OPEX (before debt support) | $26 M / yr | $49 M / yr | $0 / yr |

_Commercial-revenue assumptions: 5,672 m² of station shop/kiosk leases at $16/m²/month and 1,076 advertising boards at $136/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 2 education anchors | 9,642 trips/school day; 2.1 M access-events/yr | 15,428 trips/school day; 3.4 M access-events/yr |
| Healthcare | 7 healthcare anchors | 16,428 trips/day; 6.0 M access-events/yr | 26,284 trips/day; 9.6 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 41,783 trips/trading day; 13.8 M access-events/yr | 66,853 trips/trading day; 22.1 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $350 M | 56% of $623 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 37,371 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $573 M |
| Timetable-sized dedicated solar CAPEX | $50 M |
| **Reconciled project CAPEX** | **$623 M** |
| 15%–25% planning risk envelope | $717 M–$779 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-291093 k / $-137406 k |
| Low/high project IRR | 1.6% / 5.5% |
| Low/high steady-state DSCR | 0.88 / 1.66 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,093.93 train-km; 15,679.15 kWh consumed; 16,739.54 kWh charged; 26 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 26,639.01 train-km; 199,470.81 kWh consumed; 203,620.88 kWh charged; 495 depot services completed (6 active at cutoff); minimum SoC 47%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 36.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 47.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.8% / 60% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 35 line platforms, 1 interchange complexes, 80 civil segments, and 0 input findings |
