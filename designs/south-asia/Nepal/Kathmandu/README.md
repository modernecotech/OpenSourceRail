...
|---|---|---|
| Construction (years 1–7) | **$111 M / yr** | $77 |
| Steady-state, low-ridership (year 8+) | **$136 M / yr** | $95 |
| Steady-state, high-ridership (year 8+) | **$128 M / yr** | $89 |
| Steady-state, operating-neutral revenue case | **$114 M / yr** | $79 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.91 bn cumulative** | $2,715 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.73 bn cumulative** | $2,587 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.39 bn cumulative** | $2,349 |

_Population basis: 1,442,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $23 M / yr → $15 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.14 bn | 3.0% | 30 y, 7 y grace | $70 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $476 M | 7.5% | 30 y, 7 y grace | $44 M / yr |
| Government equity (no debt service) | 15% | $286 M | — | — | — |
| **Total** | **100%** | **$1.90 bn** | | | **$114 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $34 M / yr + bonds $36 M / yr = **$70 M / yr** total — plus the equity tranche amortised across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 118,099 | 196,833 | 342,356 |
| Daily paid trips / catchment | 18% | 30% | 52% |
| Daily paid trips / city population | 8% | 14% | 24% |
| Annual paid trips | 43.1 M | 71.8 M | 125.0 M |
| Farebox revenue | $12 M / yr | $20 M / yr | $35 M / yr |
| Station shop leases | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$18 M / yr** | **$26 M / yr** | **$41 M / yr** |
| Revenue / OPEX recovery | 45% | 64% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $136 M / yr | $128 M / yr | **$114 M / yr** |
