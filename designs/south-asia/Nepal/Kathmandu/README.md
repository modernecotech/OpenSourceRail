...
| Steady-state, low-ridership (year 8+) | **$102 M / yr** | $71 |
| Steady-state, high-ridership (year 8+) | **$94 M / yr** | $65 |
| Steady-state, operating-neutral revenue case | **$87 M / yr** | $61 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.94 bn cumulative** | $2,042 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.76 bn cumulative** | $1,914 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.61 bn cumulative** | $1,807 |

_Population basis: 1,442,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $15 M / yr → $6.7 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $879 M | 3.0% | 30 y, 7 y grace | $53 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $366 M | 7.5% | 30 y, 7 y grace | $34 M / yr |
| Government equity (no debt service) | 15% | $220 M | — | — | — |
| **Total** | **100%** | **$1.47 bn** | | | **$87 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $26 M / yr + bonds $27 M / yr = **$54 M / yr** total — plus the equity tranche amortised across construction ($31 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 118,099 | 196,833 | 262,003 |
| Daily paid trips / catchment | 18% | 30% | 40% |
| Daily paid trips / city population | 8% | 14% | 18% |
| Annual paid trips | 43.1 M | 71.8 M | 95.6 M |
...
| **Total revenue** | **$18 M / yr** | **$26 M / yr** | **$33 M / yr** |
| Revenue / OPEX recovery | 56% | 80% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $102 M / yr | $94 M / yr | **$87 M / yr** |
