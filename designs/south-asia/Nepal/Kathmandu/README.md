...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **354.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| PV daily yield proxy | 228 MWh/day | 5.0 peak-sun-hour planning proxy before local derates |
| Scheduled traction demand | 1,768 MWh/day | 102,293 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,540 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 354.1 MW / 1,771 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 354,115 kW @ $700/kW | $248 M |
| Grid interconnection / PPA tie-in | 354,115 kW @ $100/kW | $35 M |
| Annual generation proxy | 354.1 MW × 5.0 peak-sun-h/day × 365 d/yr | 646.3 GWh/yr |
...
| Per-capita (city pop) | $2,609 / person |
...
|---|---|---|
| Construction (years 1–7) | **$168 M / yr** | $116 |
| Steady-state, low capacity-use (year 8+) | **$156 M / yr** | $108 |
| Steady-state, high capacity-use (year 8+) | **$119 M / yr** | $82 |
| Steady-state, operating-neutral revenue case | **$125 M / yr** | $87 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.33 bn cumulative** | $4,392 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.09 bn cumulative** | $3,530 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.32 bn cumulative** | $3,686 |

_Population basis: 1,442,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $31 M / yr → $0 k / yr; surplus applied to debt support is $0 k / yr → $6.8 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $3.01 bn | 2.0% | 40 y, 7 y grace | $125 M / yr |
| Government equity (no debt service) | 20% | $753 M | — | — | — |
| **Total** | **100%** | **$3.76 bn** | | | **$125 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $60 M / yr = **$60 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($108 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (645.2 GWh / yr) | 102,293 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 83.2 GWh/yr + dedicated solar plant 354.1 MW / 646.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.2 M |
| Labour (1,206 FTE) | driverless roster: OCC/remote 158, station/platform 462, passenger service 107, fleet maintenance 217, infrastructure/energy 208, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $2.8 M |
| **OPEX subtotal** | | **$100 M / yr** |

_Annual service work: 102,293 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 40.3 M train-km / yr (161.3 M car-km / yr). On-site PV covers 83.2 GWh/yr and the dedicated solar plant adds 646.3 GWh/yr against 645.2 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
|---|---|---|---|
| Practical service capacity used | 50% | 80% | 75% |
| Annual paid trips | 168.2 M | 269.1 M | 250.9 M |
| Annual paid trips / city resident | 117 | 187 | 174 |
| Farebox revenue | $63 M / yr | $100 M / yr | $94 M / yr |
| Station shop leases | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$69 M / yr** | **$107 M / yr** | **$100 M / yr** |
| Revenue / OPEX recovery | 69% | 107% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $156 M / yr | $125 M / yr | **$125 M / yr** |
| Operating surplus applied to debt support | $0 k / yr | -$6.8 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $156 M / yr | $119 M / yr | **$125 M / yr** |
| Operating surplus after OPEX (before debt support) | $0 k / yr | $6.8 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $18 M / yr | $29 M / yr | 16 min/trip × $0.40/h value-of-time proxy |
...
| Station-area commerce turnover supported | $59 M / yr | $94 M / yr | 23% of paid trips × $1.50 local spend proxy |
...
|---|---:|---:|---:|
| Education | 18 education anchors | 30,874 trips/school day; 6.8 M access-events/yr | 49,398 trips/school day; 10.9 M access-events/yr |
| Healthcare | 27 healthcare anchors | 42,163 trips/day; 15.4 M access-events/yr | 67,461 trips/day; 24.6 M access-events/yr |
| Commerce | 71 major/terminal/interchange nodes | 107,407 trips/trading day; 35.4 M access-events/yr | 171,851 trips/trading day; 56.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.98 bn | 53% of $3.76 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.17 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $453 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 294,756 job-years | retained CAPEX ÷ (4.0 × median annual income) |
