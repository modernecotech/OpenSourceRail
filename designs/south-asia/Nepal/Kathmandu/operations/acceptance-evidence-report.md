# Kathmandu Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,052 |
| Manufacturing schedule rows | 3,592 |
| Manufacturing material/BOM rows | 48,210 |
| Manufacturing QA verification rows | 3,592 |
| Construction QA action rows | 3,231 |
| Maintenance handover schedule rows | 4,394 |
| Manufacturing rows with material refs | 3,592 / 3,592 |
| Manufacturing rows with verification refs | 3,592 / 3,592 |
| Manufacturing rows linked to QA actions | 3,592 / 3,592 |
...
| `qa-20-survey-geotech` | 124 |
| `qa-21-earthworks-drainage` | 124 |
| `qa-22-trackform-rail` | 250 |
| `qa-24-stations-depots-plant` | 262 |
| `qa-25-power-energy` | 241 |
| `qa-26-wayside-comms-safety` | 508 |
...
- Operations bundle: [`kathmandu-operations.json.gz`](kathmandu-operations.json.gz)
- Evidence matrix CSV: [`kathmandu-acceptance-evidence-matrix.csv`](kathmandu-acceptance-evidence-matrix.csv)
- Manufacturing schedule CSV: [`kathmandu-manufacturing-schedule.csv`](kathmandu-manufacturing-schedule.csv)
- Manufacturing materials CSV: [`kathmandu-manufacturing-materials.csv`](kathmandu-manufacturing-materials.csv)
- Manufacturing verification CSV: [`kathmandu-manufacturing-verification.csv`](kathmandu-manufacturing-verification.csv)
- QA register CSV: [`kathmandu-qa-register.csv`](kathmandu-qa-register.csv)
- Maintenance schedule CSV: [`kathmandu-maintenance-schedule.csv`](kathmandu-maintenance-schedule.csv)
