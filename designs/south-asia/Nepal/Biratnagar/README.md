...
| Bucket | Value |
|---|---|
| Elevated (34.3 km @ $4.0 M/km) | $137 M |
...
| Steady-state, high-ridership (year 8+) | **$11 M / yr** | $38 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$392 M cumulative** | $1,307 |
| Lifecycle envelope (yr 1–30, high scenario) | **$343 M cumulative** | $1,143 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$84 M cumulative** | $280 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $1.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $124 M | 3.0% | 30 y, 7 y grace | $7.5 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $51 M | 7.5% | 30 y, 7 y grace | $4.8 M / yr |
| Government equity (no debt service) | 15% | $31 M | — | — | — |
| **Total** | **100%** | **$206 M** | | | **$12 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $3.7 M / yr + bonds $3.9 M / yr = **$7.6 M / yr** total — plus the equity tranche amortised across construction ($4.4 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 155,186 |
| Daily paid trips / population | 8% | 15% | 52% |
| Annual paid trips | 8.8 M | 16.4 M | 56.6 M |
| Farebox revenue | $2.5 M / yr | $4.6 M / yr | $16 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $740 k / yr | $740 k / yr | $740 k / yr |
| **Total revenue** | **$3.6 M / yr** | **$5.8 M / yr** | **$17 M / yr** |
