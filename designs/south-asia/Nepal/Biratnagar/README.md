...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$697 M (89.4%) of external capital** and **$874 M of external interest**. Capital plus saved interest totals **$1.57 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (4.9 km @ $2.58 M/km) | $13 M |
| Elevated (26.9 km @ $9.75 M/km) | $262 M |
| **Civil subtotal** | **$275 M** |
...
| Per-capita (city pop) | $1,444 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $275 M | 15% | $41 M | $234 M |
...
| **Total city CAPEX** | **$433 M** | **19.0%** | **$82 M** | **$351 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **19.0%** | **$82 M** | **$12 M / yr** |
| **Local capital for domestic procurement / payroll** | **81.0%** | **$351 M** | **$50 M / yr** |
| of which planned local bond issuance | 64.8% of total CAPEX | $281 M | $40 M / yr |
| **Total city programme** | **100.0%** | **$433 M** | **$62 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $585 M | $502 M (85.9%) | $630 M | **$1.13 bn** |
| **Default** | 2.00× | $780 M | $697 M (89.4%) | $874 M | **$1.57 bn** |
| High | 3.00× | $1.17 bn | $1.09 bn (93.0%) | $1.36 bn | **$2.45 bn** |

At the default 2.00× case, OSR's $82 M external requirement is 89.4% below the illustrative foreign-company requirement of $780 M; the associated lifetime external-interest saving is $874 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$35 M / yr** | $116 |
| Steady-state, low capacity-use (year 8+) | **$18 M / yr** | $61 |
| Steady-state, high capacity-use (year 8+) | **$7.4 M / yr** | $25 |
| Steady-state, operating-neutral revenue case | **$28 M / yr** | $93 |
| Lifecycle envelope (yr 1–40, low scenario) | **$849 M cumulative** | $2,829 |
| Lifecycle envelope (yr 1–40, high scenario) | **$487 M cumulative** | $1,624 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.17 bn cumulative** | $3,893 |

_Population basis: 300,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.7 M / yr → $21 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 19% | $82 M | 4.5% | 40 y, 7 y grace | $4.8 M / yr |
| Local-currency sovereign / project bonds for local content | 65% | $281 M | 7.5% | 40 y, 7 y grace | $23 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $70 M | — | — | — |
| **Total** | **100%** | **$433 M** | | | **$28 M / yr** |
...
| Annual paid trips | 48.9 M | 78.2 M | 23.0 M |
| Annual paid trips / city resident | 163 | 261 | 77 |
| Farebox revenue | $18 M / yr | $29 M / yr | $8.6 M / yr |
| Station shop leases | $305 k / yr | $305 k / yr | $305 k / yr |
| Advertising boards | $496 k / yr | $496 k / yr | $496 k / yr |
| **Total revenue** | **$19 M / yr** | **$30 M / yr** | **$9.4 M / yr** |
| Revenue / OPEX recovery | 203% | 320% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $28 M / yr | $28 M / yr | **$28 M / yr** |
| Operating surplus applied to debt support | -$9.7 M / yr | -$21 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $18 M / yr | $7.4 M / yr | **$28 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.7 M / yr | $21 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $351 M | 81% of $433 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 52,183 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $417 M |
| Timetable-sized dedicated solar CAPEX | $16 M |
| **Reconciled project CAPEX** | **$433 M** |
| Imported / external-capital requirement | $82 M (19.0%) |
| Local-content / local-funding requirement | $351 M (81.0%) |
| Default foreign-turnkey external-capital comparison | $780 M; OSR saves $697 M (89.4%) |
| Lifetime external interest and combined financing saving | $874 M interest; $1.57 bn capital + interest |
| 15%–25% planning risk envelope | $498 M–$541 M |
| Annual OPEX | $9.4 M / yr |
| Low/high project NPV at 8% | $-257137 k / $-183577 k |
| Low/high project IRR | -1.5% / 2.4% |
| Low/high steady-state DSCR | 0.35 / 0.74 |
