...
| Bucket | Value |
|---|---|
| Elevated (34.3 km @ €18 M/km) | €617 M |
| **Civil subtotal** | **€617 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 34.3 km × €0.015 M/km | €0.5 M |
...
| EPC overhead (7%) | €57 M |
| **CAPEX total** | **€878 M** |
| Per-route-km | €26 M / km |
| Per-capita (city pop) | €2,928 / person |
...
|---|---|---|
| Construction (years 1–7) | **€51 M / yr** | €170 |
| Steady-state, low-ridership (year 8+) | **€70 M / yr** | €233 |
| Steady-state, high-ridership (year 8+) | **€69 M / yr** | €229 |
| Lifecycle envelope (yr 1–30, low scenario) | **€1.96 bn cumulative** | €6,548 |
| Lifecycle envelope (yr 1–30, high scenario) | **€1.94 bn cumulative** | €6,458 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€17 M / yr (low) → €16 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €527 M | 3.0% | 30 y, 7 y grace | €32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €220 M | 7.5% | 30 y, 7 y grace | €20 M / yr |
| Government equity (no debt service) | 15% | €132 M | — | — | — |
| **Total** | **100%** | **€878 M** | | | **€52 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €16 M / yr + bonds €16 M / yr = **€32 M / yr** total — plus the equity tranche amortised across construction (€19 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Labour (218 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | €472 k |
...
| Farebox / OPEX recovery | 6% | 13% |
| Country policy-target recovery (diagnostic) | 45% | 45% |
| Operating shortfall (gov subsidy required) | €17 M / yr | €16 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€70 M / yr** | **€69 M / yr** |
