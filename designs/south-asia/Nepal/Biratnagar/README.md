...
| Per-capita (city pop) | $2,030 / person |
...
|---|---|---|
| Construction (years 1–7) | **$35 M / yr** | $118 |
| Steady-state, low-ridership (year 8+) | **$44 M / yr** | $147 |
| Steady-state, high-ridership (year 8+) | **$42 M / yr** | $140 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $121 |
| Lifecycle envelope (yr 1–30, low scenario) | **$1.26 bn cumulative** | $4,206 |
| Lifecycle envelope (yr 1–30, high scenario) | **$1.21 bn cumulative** | $4,037 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$1.08 bn cumulative** | $3,610 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.8 M / yr → $5.6 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $365 M | 3.0% | 30 y, 7 y grace | $22 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $152 M | 7.5% | 30 y, 7 y grace | $14 M / yr |
| Government equity (no debt service) | 15% | $91 M | — | — | — |
| **Total** | **100%** | **$609 M** | | | **$36 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $11 M / yr = **$22 M / yr** total — plus the equity tranche amortised across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 32,238 | 53,730 | 108,188 |
| Daily paid trips / catchment | 18% | 30% | 60% |
| Daily paid trips / city population | 11% | 18% | 36% |
| Annual paid trips | 11.8 M | 19.6 M | 39.5 M |
| Farebox revenue | $3.3 M / yr | $5.5 M / yr | $11 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $740 k / yr | $740 k / yr | $740 k / yr |
| **Total revenue** | **$4.5 M / yr** | **$6.7 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 37% | 55% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $44 M / yr | $42 M / yr | **$36 M / yr** |
