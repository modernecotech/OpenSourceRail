...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **17,910 – 26,865 trips/day**
...
| Bucket | Value |
|---|---|
| Elevated (34.3 km @ $5.5 M/km) | $188 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 34.3 km × $0.015 M/km | $514 k |
...
|---|---|---|
| Construction (years 1–7) | **$16 M / yr** | $52 |
| Steady-state, low-ridership (year 8+) | **$18 M / yr** | $61 |
| Steady-state, high-ridership (year 8+) | **$16 M / yr** | $54 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$528 M cumulative** | $1,761 |
| Lifecycle envelope (yr 1–30, high scenario) | **$479 M cumulative** | $1,596 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$109 M cumulative** | $363 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $2.3 M / yr → $136 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $161 M | 3.0% | 30 y, 7 y grace | $9.8 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $67 M | 7.5% | 30 y, 7 y grace | $6.2 M / yr |
| Government equity (no debt service) | 15% | $40 M | — | — | — |
| **Total** | **100%** | **$268 M** | | | **$16 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $4.8 M / yr + bonds $5.0 M / yr = **$9.8 M / yr** total — plus the equity tranche amortised across construction ($5.7 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 24,000 | 45,000 | 202,397 |
| Daily paid trips / population | 8% | 15% | 67% |
| Annual paid trips | 8.8 M | 16.4 M | 73.9 M |
| Farebox revenue | $2.5 M / yr | $4.6 M / yr | $21 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $740 k / yr | $740 k / yr | $740 k / yr |
| **Total revenue** | **$3.6 M / yr** | **$5.8 M / yr** | **$22 M / yr** |
| Revenue / OPEX + debt-service recovery | 17% | 26% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $18 M / yr | $16 M / yr | **$0 / yr** |
