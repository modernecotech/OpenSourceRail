...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **32,238 – 53,730 trips/day**
...
| Bucket | Value |
|---|---|
| Elevated (34.3 km @ $9.0 M/km) | $308 M |
...
| Steady-state, low-ridership (year 8+) | **$29 M / yr** | $95 |
| Steady-state, high-ridership (year 8+) | **$26 M / yr** | $85 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–30, low scenario) | **$833 M cumulative** | $2,776 |
| Lifecycle envelope (yr 1–30, high scenario) | **$762 M cumulative** | $2,541 |
| Lifecycle envelope (yr 1–30, cost-neutral after opening) | **$174 M cumulative** | $582 |

_Population basis: 300,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $3.1 M / yr → $17 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $257 M | 3.0% | 30 y, 7 y grace | $16 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $107 M | 7.5% | 30 y, 7 y grace | $9.9 M / yr |
| Government equity (no debt service) | 15% | $64 M | — | — | — |
| **Total** | **100%** | **$428 M** | | | **$26 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $7.7 M / yr + bonds $8.0 M / yr = **$16 M / yr** total — plus the equity tranche amortised across construction ($9.2 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 45,000 | 75,000 | 325,102 |
| Daily paid trips / population | 15% | 25% | 108% |
| Annual paid trips | 16.4 M | 27.4 M | 118.7 M |
| Farebox revenue | $4.6 M / yr | $7.7 M / yr | $33 M / yr |
| Station shop leases | $457 k / yr | $457 k / yr | $457 k / yr |
| Advertising boards | $740 k / yr | $740 k / yr | $740 k / yr |
| **Total revenue** | **$5.8 M / yr** | **$8.9 M / yr** | **$34 M / yr** |
| Revenue / OPEX + debt-service recovery | 17% | 26% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov gap | $29 M / yr | $26 M / yr | **$0 / yr** |
