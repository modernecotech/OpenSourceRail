# Pokhara Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,779 |
| Manufacturing material/BOM rows | 26,708 |
| Manufacturing QA verification rows | 1,779 |
| Construction QA action rows | 1,653 |
| Maintenance handover schedule rows | 2,125 |
| Manufacturing rows with material refs | 1,779 / 1,779 |
| Manufacturing rows with verification refs | 1,779 / 1,779 |
| Manufacturing rows linked to QA actions | 1,779 / 1,779 |
...
|---|---:|
| `project_kit` | 2,957 |
| `rolling_stock_bom` | 22,330 |
| `rolling_stock_cots_fitout` | 1,421 |
...
| `qa-10-carbody-structure` | 406 |
| `qa-11-bogie-wheelset` | 203 |
| `qa-12-traction-brake-battery` | 203 |
| `qa-13-passenger-systems` | 203 |
| `qa-15-first-article-trainset` | 203 |
