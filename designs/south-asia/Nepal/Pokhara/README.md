...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh pokhara`.
...
|---|---|---|
| Construction (years 1–7) | **$46 M / yr** | $77 |
| Steady-state, low capacity-use (year 8+) | **$22 M / yr** | $36 |
| Steady-state, high capacity-use (year 8+) | **$5.1 M / yr** | $9 |
| Steady-state, operating-neutral revenue case | **$34 M / yr** | $56 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.03 bn cumulative** | $1,723 |
| Lifecycle envelope (yr 1–40, high scenario) | **$492 M cumulative** | $819 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.43 bn cumulative** | $2,383 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $571 M | 4.5% | 40 y, 7 y grace | $34 M / yr |
| Government equity (no debt service) | 20% | $143 M | — | — | — |
| **Total** | **100%** | **$714 M** | | | **$34 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $26 M / yr = **$26 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($20 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $22 M / yr | $5.1 M / yr | **$34 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $401 M | 56% of $714 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $642 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $92 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 59,702 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $652 M |
| Timetable-sized dedicated solar CAPEX | $62 M |
| **Reconciled project CAPEX** | **$714 M** |
| 15%–25% planning risk envelope | $821 M–$892 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $-450272 k / $-339932 k |
| Low/high project IRR | -2.7% / 1.4% |
| Low/high steady-state DSCR | 0.36 / 0.85 |
