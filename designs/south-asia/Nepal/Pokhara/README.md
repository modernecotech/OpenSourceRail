...
| Revenue fleet | 183 × 3-car trainsets |
| Revenue fleet passenger capacity | 65,880 AW2 pax (87,840 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 20 × 3-car trainsets |
| Peak headway | 3 min |
...
|---|---|---|---|---|
| line-1 | 29.9 km | 16 | 74 | SE Outer ↔ NW Outer |
| line-2 | 23.8 km | 15 | 60 | NW Mid ↔ SE Outer |
| line-3 | 27.4 km | 15 | 69 | NW Outer ↔ SE Outer |
| **Total** | **81.2 km** | **46 unique** | **203** | |
...
| Revenue fleet capacity | 65,880 AW2 pax (87,840 AW3 crush) |
| Total fleet capacity | 73,080 AW2 pax (97,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 183 × 360 = **65,880 AW2 passengers** (87,840 AW3 crush)
- **Total fleet passenger capacity:** 203 × 360 = **73,080 AW2 passengers** (97,440 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **70.9 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 488 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 101 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 107 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
...
| Dedicated solar plant | 70.9 MW / 439 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 216 kWh | 351 kWh | 114 kWh | 6.9 km / 50 kWh |
| line-2 | 15 | 172 kWh | 314 kWh | 126 kWh | 2.0 km / 15 kWh |
| line-3 | 13 | 198 kWh | 318 kWh | 101 kWh | 7.2 km / 52 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (76.2 km @ $3.0 M/km) | $229 M |
| Elevated (5.0 km @ $12.0 M/km) | $60 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 203 | $900 k | $183 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 609 | $60 k | $37 M |
| High sensitivity check | 609 | $120 k | $73 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 70,871 kW @ $700/kW | $50 M |
| Grid interconnection / PPA tie-in | 70,871 kW @ $100/kW | $7.1 M |
| Annual generation proxy | 70.9 MW × 6.2 peak-sun-h/day × 365 d/yr | 160.4 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$58 M / yr** | $97 |
| Steady-state, low capacity-use (year 8+) | **$34 M / yr** | $56 |
| Steady-state, high capacity-use (year 8+) | **$17 M / yr** | $29 |
| Steady-state, operating-neutral revenue case | **$43 M / yr** | $71 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.52 bn cumulative** | $2,531 |
| Lifecycle envelope (yr 1–40, high scenario) | **$976 M cumulative** | $1,627 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.81 bn cumulative** | $3,023 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $9.0 M / yr → $25 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $724 M | 4.5% | 40 y, 7 y grace | $43 M / yr |
| Government equity (no debt service) | 20% | $181 M | — | — | — |
| **Total** | **100%** | **$906 M** | | | **$43 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $33 M / yr = **$33 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($26 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (178.6 GWh / yr) | 37,758 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 39.1 GWh/yr + dedicated solar plant 70.9 MW / 160.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $850 k |
| Labour (563 FTE) | driverless roster: OCC/remote 114, station/platform 195, passenger service 49, fleet maintenance 111, infrastructure/energy 73, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$21 M / yr** |

_Annual service work: 37,758 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.9 M train-km / yr (44.7 M car-km / yr). On-site PV covers 39.1 GWh/yr and the dedicated solar plant adds 160.4 GWh/yr against 178.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 203 trainsets, 46 stations, 81.2 route-km, 3 lines, and 37,758 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 49.3 M |
| Annual paid trips / city resident | 122 | 196 | 82 |
| Farebox revenue | $27 M / yr | $44 M / yr | $18 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.6 M / yr | $1.6 M / yr | $1.6 M / yr |
| **Total revenue** | **$30 M / yr** | **$46 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 143% | 221% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $43 M / yr | $43 M / yr | **$43 M / yr** |
| Operating surplus applied to debt support | -$9.0 M / yr | -$25 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $34 M / yr | $17 M / yr | **$43 M / yr** |
| Operating surplus after OPEX (before debt support) | $9.0 M / yr | $25 M / yr | $0 / yr |

_Commercial-revenue assumptions: 8,528 m² of station shop/kiosk leases at $11/m²/month and 1,564 advertising boards at $98/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 2 education anchors | 9,120 trips/school day; 2.0 M access-events/yr | 14,592 trips/school day; 3.2 M access-events/yr |
| Healthcare | 5 healthcare anchors | 14,162 trips/day; 5.2 M access-events/yr | 22,659 trips/day; 8.3 M access-events/yr |
| Commerce | 25 major/terminal/interchange nodes | 43,604 trips/trading day; 14.4 M access-events/yr | 69,766 trips/trading day; 23.0 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $514 M | 57% of $906 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $823 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $118 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 76,549 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $849 M |
| Timetable-sized dedicated solar CAPEX | $57 M |
| **Reconciled project CAPEX** | **$906 M** |
| 15%–25% planning risk envelope | $1.04 bn–$1.13 bn |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $-613394 k / $-503054 k |
| Low/high project IRR | -4.9% / -0.4% |
| Low/high steady-state DSCR | 0.21 / 0.60 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,714.34 train-km; 19,541.98 kWh consumed; 20,584.67 kWh charged; 15 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 38,701.61 train-km; 278,633.86 kWh consumed; 284,305.70 kWh charged; 503 depot services completed (1 active at cutoff); minimum SoC 56%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 47.9% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 21.6% | 100.0% / 90% | pass |
| 50% charging-contact availability | 56.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 95.5% / 60% | pass |
| ten-hour single charging-pad outage | 45.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 46 line platforms, 3 interchange complexes, 49 civil segments, and 0 input findings |
