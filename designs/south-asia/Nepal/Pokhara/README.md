...
**Country:** NP · **Population:** 600,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$994 M (86.6%) of external capital** and **$1.25 bn of external interest**. Capital plus saved interest totals **$2.24 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`pokhara.corridor.geojson`](pokhara.corridor.geojson).
...
| Route length (double track) | 81.2 km |
| Revenue fleet | 155 × 3-car trainsets |
| Revenue fleet passenger capacity | 55,800 AW2 pax (74,400 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 17 × 3-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 14 planned-maintenance spares and 3 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
| Revenue fleet capacity | 55,800 AW2 pax (74,400 AW3 crush) |
| Total fleet capacity | 61,920 AW2 pax (82,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 155 × 360 = **55,800 AW2 passengers** (74,400 AW3 crush)
- **Total fleet passenger capacity:** 172 × 360 = **61,920 AW2 passengers** (82,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 40.8%
- Catchment population: **≈ 244,799** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **77.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.5× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 456 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 105 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 74 MWh/day | 6.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 37,758 train-km/day | One-way train journeys × route length |
| Annual service work | 14.9 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 489 MWh/day | 44.7 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 416 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 77.1 MW / 478 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 8 | 216 kWh | 359 kWh | 122 kWh | 11.6 km / 84 kWh |
| line-2 | 8 | 172 kWh | 294 kWh | 105 kWh | 4.9 km / 36 kWh |
| line-3 | 8 | 198 kWh | 327 kWh | 109 kWh | 6.6 km / 48 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (77.9 km @ $2.58 M/km) | $201 M |
| Elevated (3.3 km @ $9.75 M/km) | $32 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 172 | $900 k | $155 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 77,081 kW @ $700/kW | $54 M |
| Grid interconnection / PPA tie-in | 77,081 kW @ $100/kW | $7.7 M |
| Annual generation proxy | 77.1 MW × 6.2 peak-sun-h/day × 365 d/yr | 174.4 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 81.2 km × $0.050 M/km | $4.1 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $2.7 M |
...
| Per-capita (city pop) | $1,063 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $243 M | 15% | $36 M | $206 M |
| Stations | $127 M | 20% | $25 M | $101 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $155 M | 35% | $54 M | $101 M |
| Dedicated solar plant | $62 M | 45% | $28 M | $34 M |
| Residual signalling / train control | $4.1 M | 50% | $2.0 M | $2.0 M |
| Charging microgrids | $2.7 M | 40% | $1.1 M | $1.6 M |
| EPC / project services | $38 M | 15% | $5.7 M | $32 M |
| **Total city CAPEX** | **$638 M** | **24.2%** | **$154 M** | **$484 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh pokhara`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.2%** | **$154 M** | **$22 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.8%** | **$484 M** | **$69 M / yr** |
| of which planned local bond issuance | 60.6% of total CAPEX | $387 M | $55 M / yr |
| **Total city programme** | **100.0%** | **$638 M** | **$91 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $861 M | $707 M (82.1%) | $886 M | **$1.59 bn** |
| **Default** | 2.00× | $1.15 bn | $994 M (86.6%) | $1.25 bn | **$2.24 bn** |
| High | 3.00× | $1.72 bn | $1.57 bn (91.0%) | $1.97 bn | **$3.53 bn** |

At the default 2.00× case, OSR's $154 M external requirement is 86.6% below the illustrative foreign-company requirement of $1.15 bn; the associated lifetime external-interest saving is $1.25 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$50 M / yr** | $83 |
| Steady-state, low capacity-use (year 8+) | **$28 M / yr** | $47 |
| Steady-state, high capacity-use (year 8+) | **$12 M / yr** | $20 |
| Steady-state, operating-neutral revenue case | **$41 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.28 bn cumulative** | $2,133 |
| Lifecycle envelope (yr 1–40, high scenario) | **$738 M cumulative** | $1,230 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.70 bn cumulative** | $2,837 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $13 M / yr → $29 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $154 M | 4.5% | 40 y, 7 y grace | $9.1 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $387 M | 7.5% | 40 y, 7 y grace | $32 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $97 M | — | — | — |
| **Total** | **100%** | **$638 M** | | | **$41 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.9 M / yr + local bonds $29 M / yr = **$36 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($14 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $203 k |
| Traction energy (178.6 GWh / yr) | 37,758 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.9 GWh/yr + dedicated solar plant 77.1 MW / 174.4 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $925 k |
| Labour (441 FTE) | driverless roster: OCC/remote 102, station/platform 101, passenger service 49, fleet maintenance 102, infrastructure/energy 66, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.0 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 37,758 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 14.9 M train-km / yr (44.7 M car-km / yr). On-site PV covers 26.9 GWh/yr and the dedicated solar plant adds 174.4 GWh/yr against 178.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 172 trainsets, 25 stations, 81.2 route-km, 3 lines, and 37,758 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 39.0 M |
| Annual paid trips / city resident | 122 | 196 | 65 |
| Farebox revenue | $27 M / yr | $44 M / yr | $15 M / yr |
| Station shop leases | $512 k / yr | $512 k / yr | $512 k / yr |
| Advertising boards | $820 k / yr | $820 k / yr | $820 k / yr |
| **Total revenue** | **$29 M / yr** | **$45 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 181% | 284% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $41 M / yr | $41 M / yr | **$41 M / yr** |
| Operating surplus applied to debt support | -$13 M / yr | -$29 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $28 M / yr | $12 M / yr | **$41 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $29 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,328 m² of station shop/kiosk leases at $11/m²/month and 820 advertising boards at $98/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $7.9 M / yr | $13 M / yr | 16 min/trip × $0.40/h value-of-time proxy |
| Avoided road congestion | $21 M / yr | $34 M / yr | 264 M - 422 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.8 M / yr | $6.1 M / yr | 47.5–76.0 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $11 M / yr | $17 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $24 M / yr | $39 M / yr | 22% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $12 M / yr | $19 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$79 M / yr** | **$127 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 2 education anchors | 10,007 trips/school day; 2.2 M access-events/yr | 16,012 trips/school day; 3.5 M access-events/yr |
| Healthcare | 2 healthcare anchors | 13,587 trips/day; 5.0 M access-events/yr | 21,739 trips/day; 7.9 M access-events/yr |
| Commerce | 14 major/terminal/interchange nodes | 43,953 trips/trading day; 14.5 M access-events/yr | 70,324 trips/trading day; 23.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $484 M | 76% of $638 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $774 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $111 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 71,976 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $576 M |
| Timetable-sized dedicated solar CAPEX | $62 M |
| **Reconciled project CAPEX** | **$638 M** |
| Imported / external-capital requirement | $154 M (24.2%) |
| Local-content / local-funding requirement | $484 M (75.8%) |
| Default foreign-turnkey external-capital comparison | $1.15 bn; OSR saves $994 M (86.6%) |
| Lifetime external interest and combined financing saving | $1.25 bn interest; $2.24 bn capital + interest |
| 15%–25% planning risk envelope | $734 M–$798 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $-388554 k / $-278214 k |
| Low/high project IRR | -2.0% / 2.2% |
| Low/high steady-state DSCR | 0.31 / 0.71 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,739.88 train-km; 19,725.65 kWh consumed; 17,909.09 kWh charged; 21 depot services completed; minimum SoC 76%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 35,952.16 train-km; 258,836.32 kWh consumed; 247,363.65 kWh charged; 516 depot services completed (5 active at cutoff); minimum SoC 21%; 0 onboard emergencies; 0 invariant violations; 95.2% of scheduled train-km delivered; 15 SoC warnings; 2 energy-adapted off-peak departures, maximum 12 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 95.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 93.2% / 90% | pass |
| 50% charging-contact availability | 20.8% | 95.2% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 83.7% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 94.4% / 90% | pass |
...
|---|---|
| ![Pokhara energy and battery simulation dashboard](engineering/screenshots/pokhara-simulation-dashboard.png) | ![Pokhara simulator network visualizer](engineering/screenshots/pokhara-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 2 interchange complexes, 45 civil segments, and 0 input findings |
...
|---|---|
| ![Pokhara QGIS engineering layers](engineering/screenshots/pokhara-qgis-engineering-map.png) | ![Pokhara SUMO timetable validation](engineering/screenshots/pokhara-sumo-validation.png) |
...
| [`pokhara.toml`](pokhara.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`pokhara-network-map.png`](pokhara-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`pokhara.corridor.geojson`](pokhara.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`pokhara.stations.json`](pokhara.stations.json) | Machine-readable station list |
| [`pokhara.design-quality.yaml`](pokhara.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug pokhara
