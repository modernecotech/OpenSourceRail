...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (open-source CBTC on commodity SBCs, RFC 0019) | 227.7 km × €0.4 M/km | €91 M |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.73 bn | 4.0% | 30 y, 7 y grace | €116 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €720 M | 8.0% | 30 y, 7 y grace | €69 M / yr |
| Government equity (no debt service) | 15% | €432 M | — | — | — |
| **Total** | **100%** | **€2.88 bn** | | | **€186 M / yr** |
...
| Operating shortfall (gov subsidy required) | €55 M / yr | €41 M / yr |
| **Total annual government burden** (debt service + OPEX shortfall) | **€241 M / yr** | **€227 M / yr** |
