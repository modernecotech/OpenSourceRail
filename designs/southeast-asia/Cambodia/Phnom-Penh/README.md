...
| Per-capita (city pop) | $879 / person |
...
|---|---|---|
| Construction (years 1–7) | **$131 M / yr** | $58 |
| Steady-state, low-ridership (year 8+) | **$135 M / yr** | $59 |
| Steady-state, high-ridership (year 8+) | **$129 M / yr** | $57 |
| Steady-state, operating-neutral revenue case | **$129 M / yr** | $57 |
| Lifecycle envelope (yr 1–30, low scenario) | **$4.03 bn cumulative** | $1,768 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.89 bn cumulative** | $1,707 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.89 bn cumulative** | $1,707 |

_Population basis: 2,281,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $6.1 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.20 bn | 4.0% | 30 y, 7 y grace | $81 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $501 M | 8.0% | 30 y, 7 y grace | $48 M / yr |
| Government equity (no debt service) | 15% | $301 M | — | — | — |
| **Total** | **100%** | **$2.01 bn** | | | **$129 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $48 M / yr + bonds $40 M / yr = **$88 M / yr** total — plus the equity tranche amortised across construction ($43 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 198,310 | 330,516 | 237,111 |
| Daily paid trips / catchment | 18% | 30% | 22% |
| Daily paid trips / city population | 9% | 14% | 10% |
| Annual paid trips | 72.4 M | 120.6 M | 86.5 M |
| Farebox revenue | $31 M / yr | $52 M / yr | $37 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$40 M / yr** | **$61 M / yr** | **$46 M / yr** |
| Revenue / OPEX recovery | 87% | 132% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $135 M / yr | $129 M / yr | **$129 M / yr** |
