...
|---|---:|---:|---:|---:|
| Civil works | $1.27 bn | 35% | $443 M | $822 M |
| Stations | $459 M | 40% | $184 M | $276 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $328 M | 55% | $180 M | $148 M |
| Dedicated solar plant | $290 M | 70% | $203 M | $87 M |
| Residual signalling / train control | $12 M | 80% | $9.5 M | $2.4 M |
| Charging microgrids | $22 M | 55% | $12 M | $10 M |
| EPC / project services | $147 M | 45% | $66 M | $81 M |
| **Total city CAPEX** | **$2.53 bn** | **43.5%** | **$1.10 bn** | **$1.43 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.5%** | **$1.10 bn** | **$157 M / yr** |
| **Local capital for domestic procurement / payroll** | **56.5%** | **$1.43 bn** | **$204 M / yr** |
| of which planned local bond issuance | 45.2% of total CAPEX | $1.14 bn | $163 M / yr |
...
| Steady-state, low capacity-use (year 8+) | **$111 M / yr** | $49 |
| Steady-state, high capacity-use (year 8+) | **$49 M / yr** | $21 |
| Steady-state, operating-neutral revenue case | **$164 M / yr** | $72 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.93 bn cumulative** | $2,160 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.89 bn cumulative** | $1,268 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.69 bn cumulative** | $2,932 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 43% | $1.10 bn | 4.5% | 40 y, 7 y grace | $65 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $1.14 bn | 8.0% | 40 y, 7 y grace | $99 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $286 M | — | — | — |
| **Total** | **100%** | **$2.53 bn** | | | **$164 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $50 M / yr + local bonds $92 M / yr = **$141 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($41 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $111 M / yr | $49 M / yr | **$164 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.43 bn | 57% of $2.53 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.29 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $327 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 138,597 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $1.10 bn (43.5%) |
| Local-content / local-funding requirement | $1.43 bn (56.5%) |
| 15%–25% planning risk envelope | $2.91 bn–$3.16 bn |
| Annual OPEX | $57 M / yr |
| Low/high project NPV at 8% | $-1524148 k / $-1109935 k |
| Low/high project IRR | -1.7% / 2.1% |
| Low/high steady-state DSCR | 0.33 / 0.70 |
