...
Aggregate station-rail charging power: **34,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 460 kWh battery covers running.
...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 227.7 km × €0.1 M/km | €23 M |
...
|---|---|---|
| Construction (years 1–7) | **€184 M / yr** | €81 |
| Steady-state, low-ridership (year 8+) | **€233 M / yr** | €102 |
| Steady-state, high-ridership (year 8+) | **€219 M / yr** | €96 |
| Lifecycle envelope (yr 1–30, low scenario) | **€6.64 bn cumulative** | €2,909 |
| Lifecycle envelope (yr 1–30, high scenario) | **€6.32 bn cumulative** | €2,771 |

_Population basis: 2,281,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€52 M / yr (low) → €38 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.68 bn | 4.0% | 30 y, 7 y grace | €113 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €702 M | 8.0% | 30 y, 7 y grace | €68 M / yr |
| Government equity (no debt service) | 15% | €421 M | — | — | — |
| **Total** | **100%** | **€2.81 bn** | | | **€181 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral €67 M / yr + bonds €56 M / yr = **€124 M / yr** total — plus the equity tranche amortised across construction (€60 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
| Operating shortfall (gov subsidy required) | €52 M / yr | €38 M / yr |
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€233 M / yr** | **€219 M / yr** |
