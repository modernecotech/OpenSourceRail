...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **198,310 – 299,520 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (186.2 km @ $2.0 M/km) | $372 M |
| Elevated (40.2 km @ $9.0 M/km) | $362 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$770 M** |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 227.7 km × $0.015 M/km | $11 M |
...
|---|---|---|
| Construction (years 1–7) | **$85 M / yr** | $37 |
| Steady-state, low-ridership (year 8+) | **$84 M / yr** | $37 |
| Steady-state, high-ridership (year 8+) | **$84 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$84 M / yr** | $37 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.53 bn cumulative** | $1,111 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.53 bn cumulative** | $1,111 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.53 bn cumulative** | $1,111 |

_Population basis: 2,281,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $783 M | 4.0% | 30 y, 7 y grace | $53 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $326 M | 8.0% | 30 y, 7 y grace | $31 M / yr |
| Government equity (no debt service) | 15% | $196 M | — | — | — |
| **Total** | **100%** | **$1.31 bn** | | | **$84 M / yr** |

_During the 7-year grace period the operator pays interest only — multilateral $31 M / yr + bonds $26 M / yr = **$57 M / yr** total — plus the equity tranche amortised across construction ($28 M / yr × 7 yr). Principal repayment begins in year 8 on a 23-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 198,310 | 299,520 | 153,664 |
| Daily paid trips / catchment | 18% | 27% | 14% |
| Daily paid trips / city population | 9% | 13% | 7% |
| Annual paid trips | 72.4 M | 109.3 M | 56.1 M |
| Farebox revenue | $31 M / yr | $47 M / yr | $24 M / yr |
| Station shop leases | $3.4 M / yr | $3.4 M / yr | $3.4 M / yr |
| Advertising boards | $5.3 M / yr | $5.3 M / yr | $5.3 M / yr |
| **Total revenue** | **$40 M / yr** | **$56 M / yr** | **$33 M / yr** |
| Revenue / OPEX recovery | 121% | 170% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Remaining steady-state gov commitment | $84 M / yr | $84 M / yr | **$84 M / yr** |
| Operating surplus after OPEX | $7.0 M / yr | $23 M / yr | $0 / yr |
