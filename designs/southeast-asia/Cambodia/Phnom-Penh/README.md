...
| Revenue fleet | 357 × 4-car trainsets |
| Revenue fleet passenger capacity | 171,360 AW2 pax (228,480 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 39 × 4-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 33 planned-maintenance spares and 6 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 30.3 km | 17 | 67 | S Mid ↔ N Outer |
| line-2 | 29.1 km | 18 | 64 | W Mid ↔ SE Outer |
| line-3 | 41.5 km | 22 | 85 | SW Mid ↔ NE Outer |
| line-4 | 33.2 km | 20 | 72 | N Outer ↔ S Mid |
| line-5 | 33.5 km | 20 | 71 | NW Outer ↔ SE Mid |
| line-6 | 70.8 km | 40 | 37 | NW Mid ↔ W Mid |
| **Total** | **238.4 km** | **137 unique** | **396** | |
...
| Revenue fleet capacity | 171,360 AW2 pax (228,480 AW3 crush) |
| Total fleet capacity | 190,080 AW2 pax (253,440 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 357 × 480 = **171,360 AW2 passengers** (228,480 AW3 crush)
- **Total fleet passenger capacity:** 396 × 480 = **190,080 AW2 passengers** (253,440 AW3 crush, incl. service rotation + spare + reserve)
...
| Major | 12 | 300 kW | 1500 kWh |
| Standard | 52 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **118** | **40,100 kW** | **215,500 kWh** |

Aggregate station-rail charging power: **177,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **344.7 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.5× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 589 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 450 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 192 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,439 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 344.7 MW / 1,655 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 216 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 302 kWh | 833 kWh | 500 kWh | 6.1 km / 61 kWh |
| line-2 | 16 | 290 kWh | 833 kWh | 514 kWh | 8.0 km / 80 kWh |
| line-3 | 17 | 415 kWh | 906 kWh | 450 kWh | 13.1 km / 131 kWh |
| line-4 | 18 | 332 kWh | 931 kWh | 566 kWh | 7.0 km / 70 kWh |
| line-5 | 16 | 335 kWh | 833 kWh | 465 kWh | 10.2 km / 102 kWh |
| line-6 | 35 | 707 kWh | 1,715 kWh | 938 kWh | 8.0 km / 80 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (184.5 km @ $3.0 M/km) | $553 M |
| Elevated (54.0 km @ $12.0 M/km) | $647 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 396 | $1.12 M | $444 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1584 | $60 k | $95 M |
| High sensitivity check | 1584 | $120 k | $190 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 344,705 kW @ $700/kW | $241 M |
| Grid interconnection / PPA tie-in | 344,705 kW @ $100/kW | $34 M |
| Annual generation proxy | 344.7 MW × 4.8 peak-sun-h/day × 365 d/yr | 603.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$276 M** |
...
| Steady-state, low capacity-use (year 8+) | **$95 M / yr** | $42 |
| Steady-state, high capacity-use (year 8+) | **$33 M / yr** | $15 |
| Steady-state, operating-neutral revenue case | **$142 M / yr** | $62 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.50 bn cumulative** | $1,972 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.46 bn cumulative** | $1,080 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.05 bn cumulative** | $2,654 |

_Population basis: 2,281,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $47 M / yr → $109 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.42 bn | 4.5% | 40 y, 7 y grace | $142 M / yr |
| Government equity (no debt service) | 20% | $604 M | — | — | — |
| **Total** | **100%** | **$3.02 bn** | | | **$142 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $109 M / yr = **$109 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($86 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (595.4 GWh / yr) | 94,401 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 70.3 GWh/yr + dedicated solar plant 344.7 MW / 603.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.1 M |
| Labour (1,376 FTE) | driverless roster: OCC/remote 215, station/platform 573, passenger service 111, fleet maintenance 243, infrastructure/energy 207, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.0 M |
| **OPEX subtotal** | | **$67 M / yr** |

_Annual service work: 94,401 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 37.2 M train-km / yr (148.9 M car-km / yr). On-site PV covers 70.3 GWh/yr and the dedicated solar plant adds 603.9 GWh/yr against 595.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 396 trainsets, 137 stations, 238.4 route-km, 6 lines, and 94,401 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 79 | 126 | 43 |
| Farebox revenue | $103 M / yr | $164 M / yr | $56 M / yr |
| Station shop leases | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| Advertising boards | $6.9 M / yr | $6.9 M / yr | $6.9 M / yr |
| **Total revenue** | **$114 M / yr** | **$176 M / yr** | **$67 M / yr** |
| Revenue / OPEX recovery | 170% | 262% | 100% |
| Country farebox-only policy target (diagnostic) | 45% | 45% | 45% |
| Gross repayable-debt service + residual OPEX subsidy | $142 M / yr | $142 M / yr | **$142 M / yr** |
| Operating surplus applied to debt support | -$47 M / yr | -$109 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $95 M / yr | $33 M / yr | **$142 M / yr** |
| Operating surplus after OPEX (before debt support) | $47 M / yr | $109 M / yr | $0 / yr |

_Commercial-revenue assumptions: 24,608 m² of station shop/kiosk leases at $17/m²/month and 4,472 advertising boards at $150/board/month, with occupancy derates applied._
...
|---|---:|---:|---:|
| Education | 7 education anchors | 24,945 trips/school day; 5.5 M access-events/yr | 39,912 trips/school day; 8.8 M access-events/yr |
| Healthcare | 18 healthcare anchors | 40,069 trips/day; 14.6 M access-events/yr | 64,110 trips/day; 23.4 M access-events/yr |
| Commerce | 66 major/terminal/interchange nodes | 103,405 trips/trading day; 34.1 M access-events/yr | 165,448 trips/trading day; 54.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.72 bn | 57% of $3.02 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.75 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $393 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 166,719 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.75 bn |
| Timetable-sized dedicated solar CAPEX | $276 M |
| **Reconciled project CAPEX** | **$3.02 bn** |
| 15%–25% planning risk envelope | $3.48 bn–$3.78 bn |
| Annual OPEX | $67 M / yr |
| Low/high project NPV at 8% | $-1931289 k / $-1517076 k |
| Low/high project IRR | -3.1% / 0.9% |
| Low/high steady-state DSCR | 0.33 / 0.77 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,199.84 train-km; 61,903.14 kWh consumed; 66,415.93 kWh charged; 25 depot services completed; minimum SoC 80%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 95,433.07 train-km; 952,863.79 kWh consumed; 967,560.08 kWh charged; 1,020 depot services completed (2 active at cutoff); minimum SoC 76%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 70.0% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 69.5% | 100.0% / 90% | pass |
| 50% charging-contact availability | 76.0% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 91.1% / 60% | pass |
| ten-hour single charging-pad outage | 76.0% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 137 line platforms, 12 interchange complexes, 63 civil segments, and 0 input findings |
