...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.43 bn (86.4%) of external capital** and **$4.21 bn of external interest**. Capital plus saved interest totals **$7.64 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (267.7 km @ $2.58 M/km) | $692 M |
...
| EPC integration + project management (7%) | on subtotal | $122 M |
...
|---|---:|---:|---:|---:|
| Civil works | $859 M | 15% | $129 M | $730 M |
...
| EPC / project services | $122 M | 15% | $18 M | $104 M |
| **Total city CAPEX** | **$2.20 bn** | **24.6%** | **$541 M** | **$1.66 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$541 M** | **$108 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$1.66 bn** | **$332 M / yr** |
| of which planned local bond issuance | 60.4% of total CAPEX | $1.33 bn | $266 M / yr |
| **Total city programme** | **100.0%** | **$2.20 bn** | **$441 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.97 bn | $2.43 bn (81.8%) | $2.99 bn | **$5.43 bn** |
| **Default** | 2.00× | $3.97 bn | $3.43 bn (86.4%) | $4.21 bn | **$7.64 bn** |
| High | 3.00× | $5.95 bn | $5.41 bn (90.9%) | $6.65 bn | **$12.06 bn** |

At the default 2.00× case, OSR's $541 M external requirement is 86.4% below the illustrative foreign-company requirement of $3.97 bn; the associated lifetime external-interest saving is $4.21 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$173 M / yr** | $95 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$125 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$866 M cumulative** | $474 |
| Lifecycle envelope (yr 1–40, high scenario) | **$866 M cumulative** | $474 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.24 bn cumulative** | $2,866 |

_Population basis: 1,827,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $125 M / yr → $125 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $541 M | 4.5% | 40 y, 5 y grace | $31 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $1.33 bn | 6.2% | 40 y, 5 y grace | $94 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $332 M | — | — | — |
| **Total** | **100%** | **$2.20 bn** | | | **$125 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $24 M / yr + local bonds $82 M / yr = **$107 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($66 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 44.0 M |
| Annual paid trips / city resident | 98 | 157 | 24 |
| Farebox revenue | $172 M / yr | $275 M / yr | $42 M / yr |
| Station shop leases | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| Advertising boards | $7.3 M / yr | $7.3 M / yr | $7.3 M / yr |
| **Total revenue** | **$184 M / yr** | **$287 M / yr** | **$54 M / yr** |
| Revenue / OPEX recovery | 340% | 531% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $125 M / yr | $125 M / yr | **$125 M / yr** |
| Operating surplus applied to debt support | -$125 M / yr | -$125 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$125 M / yr** |
| Operating surplus after OPEX (before debt support) | $130 M / yr | $233 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.66 bn | 75% of $2.20 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.66 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $532 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 96,198 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.87 bn |
| Timetable-sized dedicated solar CAPEX | $335 M |
| **Reconciled project CAPEX** | **$2.20 bn** |
| Imported / external-capital requirement | $541 M (24.6%) |
| Local-content / local-funding requirement | $1.66 bn (75.4%) |
| Default foreign-turnkey external-capital comparison | $3.97 bn; OSR saves $3.43 bn (86.4%) |
| Lifetime external interest and combined financing saving | $4.21 bn interest; $7.64 bn capital + interest |
| 15%–25% planning risk envelope | $2.53 bn–$2.75 bn |
| Annual OPEX | $54 M / yr |
| Low/high project NPV at 8% | $-729801 k / $89 M |
| Low/high project IRR | 4.1% / 8.4% |
| Low/high steady-state DSCR | 1.04 / 1.87 |
