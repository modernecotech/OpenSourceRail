...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **326,576 – 587,837 trips/day**
...
|---|---|---|
| Construction (years 1–5) | **$106 M / yr** | $58 |
| Steady-state, low-ridership (year 6+) | **$71 M / yr** | $39 |
| Steady-state, high-ridership (year 6+) | **$71 M / yr** | $39 |
| Steady-state, operating-neutral revenue case | **$71 M / yr** | $39 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.02 bn cumulative** | $1,651 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.02 bn cumulative** | $1,651 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.02 bn cumulative** | $1,651 |

_Population basis: 1,827,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $1.42 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $1.77 bn | 2.0% | 40 y, 5 y grace | $71 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 6.2% | 40 y, 5 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $355 M | — | — | — |
| **Total** | **100%** | **$3.55 bn** | | | **$71 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — concessional loan $35 M / yr + fallback bonds $0 k / yr = **$35 M / yr** total. The $1.42 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($71 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Labour (1,385 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $8.4 M |
...
|---|---|---|---|
| Daily paid trips | 326,576 | 587,837 | 258,478 |
| Daily paid trips / catchment | 25% | 45% | 20% |
| Daily paid trips / city population | 18% | 32% | 14% |
| Annual paid trips | 119.2 M | 214.6 M | 94.3 M |
| Farebox revenue | $114 M / yr | $206 M / yr | $91 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.4 M / yr | $9.4 M / yr | $9.4 M / yr |
| **Total revenue** | **$130 M / yr** | **$221 M / yr** | **$106 M / yr** |
| Revenue / OPEX recovery | 123% | 209% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov repayable-debt service + residual OPEX subsidy | $71 M / yr | $71 M / yr | **$71 M / yr** |
| Operating surplus after OPEX | $24 M / yr | $115 M / yr | $0 / yr |
