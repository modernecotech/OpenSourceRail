...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **235,134 – 391,891 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (216.4 km @ $2.0 M/km) | $433 M |
...
|---|---|---|
| Construction (years 1–5) | **$77 M / yr** | $42 |
| Steady-state, low-ridership (year 6+) | **$18 M / yr** | $10 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$755 M cumulative** | $413 |
| Lifecycle envelope (yr 1–25, high scenario) | **$385 M cumulative** | $211 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$385 M cumulative** | $211 |

_Population basis: 1,827,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $665 M | 4.0% | 25 y, 5 y grace | $49 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $277 M | 6.2% | 25 y, 5 y grace | $25 M / yr |
| Government equity (no debt service) | 15% | $166 M | — | — | — |
| **Total** | **100%** | **$1.11 bn** | | | **$74 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $27 M / yr + bonds $17 M / yr = **$44 M / yr** total — plus the equity tranche amortised across construction ($33 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 274,050 | 456,750 | 344,364 |
| Daily paid trips / population | 15% | 25% | 19% |
| Annual paid trips | 100.0 M | 166.7 M | 125.7 M |
| Farebox revenue | $72 M / yr | $120 M / yr | $90 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.4 M / yr | $9.4 M / yr | $9.4 M / yr |
| **Total revenue** | **$87 M / yr** | **$135 M / yr** | **$106 M / yr** |
| Revenue / OPEX + debt-service recovery | 83% | 128% | 100% |
