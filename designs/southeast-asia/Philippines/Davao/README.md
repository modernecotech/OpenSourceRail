...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1316 | $60 k | $79 M |
| High sensitivity check | 1316 | $120 k | $158 M |
...
| EPC integration + project management (7%) | on subtotal | $138 M |
...
|---|---|---|
| Construction (years 1–5) | **$185 M / yr** | $101 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$112 M / yr** | $61 |
| Lifecycle envelope (yr 1–40, low scenario) | **$926 M cumulative** | $507 |
| Lifecycle envelope (yr 1–40, high scenario) | **$926 M cumulative** | $507 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$4.83 bn cumulative** | $2,646 |

_Population basis: 1,827,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $112 M / yr → $112 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.95 bn | 4.5% | 40 y, 5 y grace | $112 M / yr |
| Government equity (no debt service) | 20% | $487 M | — | — | — |
| **Total** | **100%** | **$2.44 bn** | | | **$112 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $88 M / yr = **$88 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($97 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Operating surplus applied to debt support | -$112 M / yr | -$112 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$112 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.35 bn | 55% of $2.44 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 78,211 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.44 bn** |
| 15%–25% planning risk envelope | $2.80 bn–$3.05 bn |
| Annual OPEX | $57 M / yr |
| Low/high project NPV at 8% | $-938622 k / $-119762 k |
| Low/high project IRR | 3.3% / 7.5% |
| Low/high steady-state DSCR | 1.14 / 2.06 |
