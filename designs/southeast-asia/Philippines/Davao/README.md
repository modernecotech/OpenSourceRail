...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 228.9 km × €0.1 M/km | €23 M |
...
|---|---|---|
| Construction (years 1–5) | **€165 M / yr** | €90 |
| Steady-state, low-ridership (year 6+) | **€199 M / yr** | €109 |
| Steady-state, high-ridership (year 6+) | **€180 M / yr** | €99 |
| Lifecycle envelope (yr 1–25, low scenario) | **€4.80 bn cumulative** | €2,626 |
| Lifecycle envelope (yr 1–25, high scenario) | **€4.43 bn cumulative** | €2,424 |

_Population basis: 1,827,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€42 M / yr (low) → €23 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €592 M | 6.2% | 25 y, 5 y grace | €52 M / yr |
| Government equity (no debt service) | 15% | €355 M | — | — | — |
| **Total** | **100%** | **€2.37 bn** | | | **€157 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €57 M / yr + bonds €37 M / yr = **€94 M / yr** total — plus the equity tranche amortised across construction (€71 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€199 M / yr** | **€180 M / yr** |
