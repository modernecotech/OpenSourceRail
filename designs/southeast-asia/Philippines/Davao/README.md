...
| Revenue fleet | 418 × 4-car trainsets |
| Revenue fleet passenger capacity | 200,640 AW2 pax (267,520 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 46 × 4-car trainsets |
| Peak headway | 3 min |
...
The fleet is sized for the 3-minute peaks; when service relaxes to 6 or 12 minutes, the same peak fleet provides enough idle cover for service-point work. Therefore **0 additional trainsets** are required for depot service; only the existing 40 planned-maintenance spares and 6 cold-reserve sets are included in the rolling-stock, production-plant, maintenance, labour, and total CAPEX/OPEX figures below.
...
|---|---|---|---|---|
| line-1 | 47.2 km | 26 | 100 | NE Outer ↔ SW Outer |
| line-2 | 40.4 km | 22 | 85 | NW Outer ↔ SE Mid |
| line-3 | 36.4 km | 21 | 80 | E Outer ↔ W Mid |
| line-4 | 36.9 km | 20 | 80 | W Mid ↔ E Outer |
| line-5 | 32.1 km | 20 | 72 | NW Outer ↔ SE Mid |
| line-6 | 87.3 km | 52 | 47 | NW Mid ↔ NW Mid |
| **Total** | **280.2 km** | **161 unique** | **464** | |
...
| Revenue fleet capacity | 200,640 AW2 pax (267,520 AW3 crush) |
| Total fleet capacity | 222,720 AW2 pax (296,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 418 × 480 = **200,640 AW2 passengers** (267,520 AW3 crush)
- **Total fleet passenger capacity:** 464 × 480 = **222,720 AW2 passengers** (296,960 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 92 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **152** | **50,300 kW** | **266,500 kWh** |

Aggregate station-rail charging power: **228,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **397.5 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 7.6× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 625 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 537 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| On-site PV shortfall before solar plant | 1,659 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 397.5 MW / 1,908 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 266 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 24 | 471 kWh | 1,250 kWh | 731 kWh | 5.0 km / 50 kWh |
| line-2 | 19 | 403 kWh | 980 kWh | 537 kWh | 9.5 km / 95 kWh |
| line-3 | 20 | 363 kWh | 1,029 kWh | 630 kWh | 5.0 km / 50 kWh |
| line-4 | 19 | 368 kWh | 980 kWh | 575 kWh | 6.7 km / 67 kWh |
| line-5 | 19 | 320 kWh | 980 kWh | 628 kWh | 4.5 km / 45 kWh |
| line-6 | 51 | 872 kWh | 2,499 kWh | 1,540 kWh | 5.0 km / 50 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (262.7 km @ $3.0 M/km) | $788 M |
| Elevated (17.5 km @ $12.0 M/km) | $211 M |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 464 | $1.12 M | $520 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1856 | $60 k | $111 M |
| High sensitivity check | 1856 | $120 k | $223 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 397,545 kW @ $700/kW | $278 M |
| Grid interconnection / PPA tie-in | 397,545 kW @ $100/kW | $40 M |
| Annual generation proxy | 397.5 MW × 4.8 peak-sun-h/day × 365 d/yr | 696.5 GWh/yr |
| **Dedicated solar plant subtotal** | | **$318 M** |
...
| EPC integration + project management (7%) | on subtotal | $182 M |
...
| Depots | $8.0 M |
| Rolling stock | $520 M |
| Railway production plant | $111 M |
| Dedicated solar power plant | $318 M |
| Residual train-control wayside + charging microgrids | $63 M |
| EPC overhead (7%) | $182 M |
| **CAPEX total** | **$3.10 bn** |
| Per-route-km | $11 M / km |
| Per-capita (city pop) | $1,697 / person |
...
|---|---|---|
| Construction (years 1–5) | **$236 M / yr** | $129 |
| Steady-state, low capacity-use (year 6+) | **$23 M / yr** | $12 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$142 M / yr** | $78 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.98 bn cumulative** | $1,082 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.18 bn cumulative** | $645 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.15 bn cumulative** | $3,365 |

_Population basis: 1,827,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $119 M / yr → $142 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $2.48 bn | 4.5% | 40 y, 5 y grace | $142 M / yr |
| Government equity (no debt service) | 20% | $620 M | — | — | — |
| **Total** | **100%** | **$3.10 bn** | | | **$142 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $112 M / yr = **$112 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($124 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (693.8 GWh / yr) | 109,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 88.1 GWh/yr + dedicated solar plant 397.5 MW / 696.5 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.8 M |
| Labour (1,532 FTE) | driverless roster: OCC/remote 248, station/platform 619, passenger service 111, fleet maintenance 284, infrastructure/energy 243, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $9.3 M |
| **OPEX subtotal** | | **$74 M / yr** |

_Annual service work: 109,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 43.4 M train-km / yr (173.4 M car-km / yr). On-site PV covers 88.1 GWh/yr and the dedicated solar plant adds 696.5 GWh/yr against 693.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 464 trainsets, 161 stations, 280.2 route-km, 6 lines, and 109,997 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 55.1 M |
| Annual paid trips / city resident | 98 | 157 | 30 |
| Farebox revenue | $172 M / yr | $275 M / yr | $53 M / yr |
| Station shop leases | $8.1 M / yr | $8.1 M / yr | $8.1 M / yr |
| Advertising boards | $13 M / yr | $13 M / yr | $13 M / yr |
| **Total revenue** | **$193 M / yr** | **$296 M / yr** | **$74 M / yr** |
| Revenue / OPEX recovery | 262% | 402% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $142 M / yr | $142 M / yr | **$142 M / yr** |
| Operating surplus applied to debt support | -$119 M / yr | -$142 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $23 M / yr | $0 k / yr | **$142 M / yr** |
| Operating surplus after OPEX (before debt support) | $119 M / yr | $222 M / yr | $0 / yr |

_Commercial-revenue assumptions: 26,640 m² of station shop/kiosk leases at $29/m²/month and 4,928 advertising boards at $252/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $64 M / yr | $103 M / yr | 20% of paid trips × $1.80 local spend proxy |
| Entertainment / community activity supported | $34 M / yr | $55 M / yr | 11% of paid trips × $1.80 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$235 M / yr** | **$376 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 15 education anchors | 26,216 trips/school day; 5.8 M access-events/yr | 41,945 trips/school day; 9.2 M access-events/yr |
| Healthcare | 1 healthcare anchors | 29,803 trips/day; 10.9 M access-events/yr | 47,685 trips/day; 17.4 M access-events/yr |
| Commerce | 60 major/terminal/interchange nodes | 97,781 trips/trading day; 32.3 M access-events/yr | 156,450 trips/trading day; 51.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.73 bn | 56% of $3.10 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.77 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $555 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 100,358 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.78 bn |
| Timetable-sized dedicated solar CAPEX | $318 M |
| **Reconciled project CAPEX** | **$3.10 bn** |
| 15%–25% planning risk envelope | $3.56 bn–$3.87 bn |
| Annual OPEX | $74 M / yr |
| Low/high project NPV at 8% | $-1529858 k / $-710998 k |
| Low/high project IRR | 1.6% / 5.4% |
| Low/high steady-state DSCR | 0.84 / 1.57 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,535.79 train-km; 65,257.45 kWh consumed; 72,031.71 kWh charged; 16 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 110,587.01 train-km; 1,104,170.61 kWh consumed; 1,124,040.09 kWh charged; 1,036 depot services completed; minimum SoC 84%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 81.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 82.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 84.4% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 90.8% / 60% | pass |
| ten-hour single charging-pad outage | 80.9% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 161 line platforms, 14 interchange complexes, 70 civil segments, and 0 input findings |
