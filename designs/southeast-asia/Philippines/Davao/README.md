...
|---|---|---|---|---|
| line-1 | 39.7 km | 16 | 53 | SW Outer ↔ NE Mid |
| line-2 | 24.5 km | 14 | 34 | E Mid ↔ SW Mid |
| line-3 | 35.2 km | 16 | 48 | NE Outer ↔ SE Inner |
| line-4 | 32.1 km | 14 | 43 | S Inner ↔ NW Outer |
| line-5 | 27.7 km | 13 | 38 | W Mid ↔ E Inner |
| line-6 | 69.7 km | 35 | 91 | NW Mid ↔ NW Mid |
| **Total** | **228.9 km** | **107 unique** | **307** | |
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **408.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Average one-way line energy | 610 kWh | 38.1 km average line length |
...
| Scheduled traction demand | 1,997 MWh/day | 115,591 scheduled train-km/day × 108% depot/deadhead factor |
| On-site PV shortfall before solar plant | 1,774 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 408.0 MW / 2,040 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 288 MWh | Distributed Na-ion buffer for charging peaks and grid outages |
...
| Bucket | Value |
|---|---|
| At-grade (216.4 km @ $3.0 M/km) | $649 M |
| Elevated (11.0 km @ $12.0 M/km) | $131 M |
| Elevated-interchange premium (8 sites @ $4.50 M) | $36 M |
| **Civil subtotal** | **$817 M** |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 407,998 kW @ $700/kW | $286 M |
| Grid interconnection / PPA tie-in | 407,998 kW @ $100/kW | $41 M |
| Annual generation proxy | 408.0 MW × 5.0 peak-sun-h/day × 365 d/yr | 744.6 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 228.9 km × $0.050 M/km | $11 M |
...
| Per-capita (city pop) | $2,121 / person |
...
|---|---|---|
| Construction (years 1–5) | **$217 M / yr** | $119 |
| Steady-state, low capacity-use (year 6+) | **$57 M / yr** | $31 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$124 M / yr** | $68 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.09 bn cumulative** | $1,690 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.09 bn cumulative** | $594 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.43 bn cumulative** | $2,970 |

_Population basis: 1,827,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $67 M / yr → $124 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Green concessional loan | 80% | $3.10 bn | 2.0% | 40 y, 5 y grace | $124 M / yr |
| Government equity (no debt service) | 20% | $775 M | — | — | — |
| **Total** | **100%** | **$3.88 bn** | | | **$124 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $62 M / yr = **$62 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($155 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $568 k |
| Traction energy (729.1 GWh / yr) | 115,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 81.6 GWh/yr + dedicated solar plant 408.0 MW / 744.6 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $4.9 M |
| Labour (1,250 FTE) | driverless roster: OCC/remote 175, station/platform 443, passenger service 107, fleet maintenance 244, infrastructure/energy 227, admin/training 54; no train drivers × country median × 12 × engineer-premium 1.4 | $7.6 M |
| **OPEX subtotal** | | **$110 M / yr** |

_Annual service work: 115,591 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 45.6 M train-km / yr (182.3 M car-km / yr). On-site PV covers 81.6 GWh/yr and the dedicated solar plant adds 744.6 GWh/yr against 729.1 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._
...
| Annual paid trips | 168.2 M | 269.1 M | 98.6 M |
| Annual paid trips / city resident | 92 | 147 | 54 |
| Farebox revenue | $161 M / yr | $258 M / yr | $95 M / yr |
| Station shop leases | $6.1 M / yr | $6.1 M / yr | $6.1 M / yr |
| Advertising boards | $9.4 M / yr | $9.4 M / yr | $9.4 M / yr |
| **Total revenue** | **$177 M / yr** | **$274 M / yr** | **$110 M / yr** |
| Revenue / OPEX recovery | 161% | 249% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $124 M / yr | $124 M / yr | **$124 M / yr** |
| Operating surplus applied to debt support | -$67 M / yr | -$124 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $57 M / yr | $0 k / yr | **$124 M / yr** |
| Operating surplus after OPEX (before debt support) | $67 M / yr | $164 M / yr | $0 / yr |
...
|---|---:|---:|---|
| Travel time + reliability dividend | $47 M / yr | $75 M / yr | 16 min/trip × $1.04/h value-of-time proxy |
...
| Station-area commerce turnover supported | $68 M / yr | $108 M / yr | 22% of paid trips × $1.80 local spend proxy |
| Entertainment / community activity supported | $32 M / yr | $51 M / yr | 11% of paid trips × $1.80 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$228 M / yr** | **$364 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 11 education anchors | 24,583 trips/school day; 5.4 M access-events/yr | 39,333 trips/school day; 8.7 M access-events/yr |
| Healthcare | 7 healthcare anchors | 30,692 trips/day; 11.2 M access-events/yr | 49,108 trips/day; 17.9 M access-events/yr |
| Commerce | 65 major/terminal/interchange nodes | 103,120 trips/trading day; 34.0 M access-events/yr | 164,992 trips/trading day; 54.4 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $2.01 bn | 52% of $3.88 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $3.21 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $642 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 116,044 job-years | retained CAPEX ÷ (4.0 × median annual income) |
