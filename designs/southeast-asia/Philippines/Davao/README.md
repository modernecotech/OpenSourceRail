...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.67 bn (86.7%) of external capital** and **$4.51 bn of external interest**. Capital plus saved interest totals **$8.19 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 280.2 km |
| Revenue fleet | 296 × 4-car trainsets |
| Revenue fleet passenger capacity | 142,080 AW2 pax (189,440 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 33 × 4-car trainsets |
| Peak headway | 3 min |
...
| Revenue fleet capacity | 142,080 AW2 pax (189,440 AW3 crush) |
| Total fleet capacity | 157,920 AW2 pax (210,560 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 296 × 480 = **142,080 AW2 passengers** (189,440 AW3 crush)
- **Total fleet passenger capacity:** 329 × 480 = **157,920 AW2 passengers** (210,560 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 39.2%
- Catchment population: **≈ 716,184** (within ~800 m walk of a station)
...
| Standard | 58 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **92** | **32,300 kW** | **176,500 kWh** |

Aggregate station-rail charging power: **138,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **418.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 6.5× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 610 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 236 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 155 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 2,558 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 109,997 train-km/day | One-way train journeys × route length |
| Annual service work | 43.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,901 MWh/day | 173.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,746 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 418.2 MW / 2,008 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 176 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 471 kWh | 808 kWh | 290 kWh | 10.7 km / 107 kWh |
| line-2 | 13 | 403 kWh | 686 kWh | 243 kWh | 11.0 km / 110 kWh |
| line-3 | 12 | 363 kWh | 637 kWh | 238 kWh | 5.6 km / 56 kWh |
| line-4 | 13 | 368 kWh | 686 kWh | 281 kWh | 7.9 km / 79 kWh |
| line-5 | 11 | 320 kWh | 588 kWh | 236 kWh | 5.5 km / 54 kWh |
| line-6 | 28 | 872 kWh | 1,372 kWh | 413 kWh | 7.0 km / 70 kWh |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 329 | $1.12 M | $368 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 1316 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 1316 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 418,245 kW @ $700/kW | $293 M |
| Grid interconnection / PPA tie-in | 418,245 kW @ $100/kW | $42 M |
| Annual generation proxy | 418.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 732.8 GWh/yr |
| **Dedicated solar plant subtotal** | | **$335 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 280.2 km × $0.050 M/km | $14 M |
...
| EPC integration + project management (7%) | on subtotal | $132 M |
...
| Dedicated solar power plant | $335 M |
| Residual train-control wayside + charging microgrids | $44 M |
| EPC overhead (7%) | $132 M |
| **CAPEX total** | **$2.35 bn** |
| Per-route-km | $8.4 M / km |
| Per-capita (city pop) | $1,288 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $998 M | 15% | $150 M | $848 M |
| Stations | $468 M | 20% | $94 M | $374 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $368 M | 35% | $129 M | $240 M |
| Dedicated solar plant | $335 M | 45% | $151 M | $184 M |
| Residual signalling / train control | $14 M | 50% | $7.0 M | $7.0 M |
| Charging microgrids | $30 M | 40% | $12 M | $18 M |
| EPC / project services | $132 M | 15% | $20 M | $112 M |
| **Total city CAPEX** | **$2.35 bn** | **24.0%** | **$563 M** | **$1.79 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh davao`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.0%** | **$563 M** | **$113 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.0%** | **$1.79 bn** | **$358 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $1.43 bn | $286 M / yr |
| **Total city programme** | **100.0%** | **$2.35 bn** | **$471 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $3.18 bn | $2.61 bn (82.3%) | $3.21 bn | **$5.82 bn** |
| **Default** | 2.00× | $4.23 bn | $3.67 bn (86.7%) | $4.51 bn | **$8.19 bn** |
| High | 3.00× | $6.35 bn | $5.79 bn (91.1%) | $7.12 bn | **$12.91 bn** |

At the default 2.00× case, OSR's $563 M external requirement is 86.7% below the illustrative foreign-company requirement of $4.23 bn; the associated lifetime external-interest saving is $4.51 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$186 M / yr** | $102 |
| Steady-state, low capacity-use (year 6+) | **$6.3 M / yr** | $3 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$133 M / yr** | $73 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.15 bn cumulative** | $629 |
| Lifecycle envelope (yr 1–40, high scenario) | **$928 M cumulative** | $508 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.59 bn cumulative** | $3,062 |

_Population basis: 1,827,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $127 M / yr → $133 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $563 M | 4.5% | 40 y, 5 y grace | $32 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.43 bn | 6.2% | 40 y, 5 y grace | $101 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $358 M | — | — | — |
| **Total** | **100%** | **$2.35 bn** | | | **$133 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $25 M / yr + local bonds $89 M / yr = **$114 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($72 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $701 k |
| Traction energy (693.8 GWh / yr) | 109,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 56.6 GWh/yr + dedicated solar plant 418.2 MW / 732.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $5.0 M |
| Labour (1,140 FTE) | driverless roster: OCC/remote 183, station/platform 354, passenger service 111, fleet maintenance 244, infrastructure/energy 221, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $6.9 M |
| **OPEX subtotal** | | **$57 M / yr** |

_Annual service work: 109,997 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 43.4 M train-km / yr (173.4 M car-km / yr). On-site PV covers 56.6 GWh/yr and the dedicated solar plant adds 732.8 GWh/yr against 693.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 329 trainsets, 99 stations, 280.2 route-km, 6 lines, and 109,997 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 46.9 M |
| Annual paid trips / city resident | 98 | 157 | 26 |
| Farebox revenue | $172 M / yr | $275 M / yr | $45 M / yr |
| Station shop leases | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| Advertising boards | $7.3 M / yr | $7.3 M / yr | $7.3 M / yr |
| **Total revenue** | **$184 M / yr** | **$287 M / yr** | **$57 M / yr** |
| Revenue / OPEX recovery | 324% | 505% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $133 M / yr | $133 M / yr | **$133 M / yr** |
| Operating surplus applied to debt support | -$127 M / yr | -$133 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $6.3 M / yr | $0 k / yr | **$133 M / yr** |
| Operating surplus after OPEX (before debt support) | $127 M / yr | $230 M / yr | $0 / yr |

_Commercial-revenue assumptions: 14,928 m² of station shop/kiosk leases at $29/m²/month and 2,824 advertising boards at $252/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $50 M / yr | $79 M / yr | 16 min/trip × $1.04/h value-of-time proxy |
...
| Station-area commerce turnover supported | $63 M / yr | $101 M / yr | 20% of paid trips × $1.80 local spend proxy |
| Entertainment / community activity supported | $34 M / yr | $55 M / yr | 11% of paid trips × $1.80 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$234 M / yr** | **$374 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 12 education anchors | 29,000 trips/school day; 6.4 M access-events/yr | 46,400 trips/school day; 10.2 M access-events/yr |
| Healthcare | 0 healthcare anchors | 29,462 trips/day; 10.8 M access-events/yr | 47,140 trips/day; 17.2 M access-events/yr |
| Commerce | 34 major/terminal/interchange nodes | 96,274 trips/trading day; 31.8 M access-events/yr | 154,038 trips/trading day; 50.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.79 bn | 76% of $2.35 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.86 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $573 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 103,542 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $2.02 bn |
| Timetable-sized dedicated solar CAPEX | $335 M |
| **Reconciled project CAPEX** | **$2.35 bn** |
| Imported / external-capital requirement | $563 M (24.0%) |
| Local-content / local-funding requirement | $1.79 bn (76.0%) |
| Default foreign-turnkey external-capital comparison | $4.23 bn; OSR saves $3.67 bn (86.7%) |
| Lifetime external interest and combined financing saving | $4.51 bn interest; $8.19 bn capital + interest |
| 15%–25% planning risk envelope | $2.71 bn–$2.94 bn |
| Annual OPEX | $57 M / yr |
| Low/high project NPV at 8% | $-871156 k / $-52296 k |
| Low/high project IRR | 3.5% / 7.8% |
| Low/high steady-state DSCR | 0.95 / 1.73 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 7,377.87 train-km; 73,665.79 kWh consumed; 76,888.78 kWh charged; 31 depot services completed; minimum SoC 82%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 107,045.30 train-km; 1,068,814.62 kWh consumed; 1,081,602.22 kWh charged; 1,007 depot services completed (6 active at cutoff); minimum SoC 70%; 0 onboard emergencies; 0 invariant violations; 97.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 62.0% | 97.3% / 90% | pass |
| maximum planning climate/HVAC duty | 57.5% | 97.3% / 90% | pass |
| 50% charging-contact availability | 69.6% | 97.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 74.5% / 60% | pass |
| ten-hour single charging-pad outage | 65.9% | 97.3% / 90% | pass |
...
|---|---|
| ![Davao energy and battery simulation dashboard](engineering/screenshots/davao-simulation-dashboard.png) | ![Davao simulator network visualizer](engineering/screenshots/davao-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 99 line platforms, 10 interchange complexes, 62 civil segments, and 0 input findings |
...
|---|---|
| ![Davao QGIS engineering layers](engineering/screenshots/davao-qgis-engineering-map.png) | ![Davao SUMO timetable validation](engineering/screenshots/davao-sumo-validation.png) |
