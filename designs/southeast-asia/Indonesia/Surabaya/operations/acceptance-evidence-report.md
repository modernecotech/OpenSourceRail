# Surabaya Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,614 |
| Manufacturing schedule rows | 5,879 |
| Manufacturing material/BOM rows | 84,464 |
| Manufacturing QA verification rows | 5,879 |
| Construction QA action rows | 5,389 |
| Maintenance handover schedule rows | 7,105 |
| Manufacturing rows with material refs | 5,879 / 5,879 |
| Manufacturing rows with verification refs | 5,879 / 5,879 |
| Manufacturing rows linked to QA actions | 5,879 / 5,879 |
...
|---|---:|
| `project_kit` | 10,871 |
| `rolling_stock_bom` | 69,190 |
| `rolling_stock_cots_fitout` | 4,403 |
...
| `qa-10-carbody-structure` | 1,258 |
| `qa-11-bogie-wheelset` | 629 |
| `qa-12-traction-brake-battery` | 629 |
| `qa-13-passenger-systems` | 629 |
| `qa-15-first-article-trainset` | 629 |
| `qa-20-survey-geotech` | 169 |
| `qa-21-earthworks-drainage` | 169 |
| `qa-22-trackform-rail` | 391 |
| `qa-24-stations-depots-plant` | 358 |
| `qa-25-power-energy` | 323 |
| `qa-26-wayside-comms-safety` | 694 |
