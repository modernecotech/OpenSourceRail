...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 240 | $8.40 M | $2.02 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1440 | $100 k | $144 M |
| High sensitivity check | 1440 | $200 k | $288 M |
...
| Stations | $675 M |
| Depots | $34 M |
| Rolling stock | $2.02 bn |
| Railway production plant | $144 M |
...
|---|---|---|
| Construction (years 1–5) | **$315 M / yr** | $105 |
| Steady-state, low-ridership (year 6+) | **$361 M / yr** | $120 |
| Steady-state, high-ridership (year 6+) | **$328 M / yr** | $109 |
| Steady-state, operating-neutral revenue case | **$299 M / yr** | $99 |
| Lifecycle envelope (yr 1–25, low scenario) | **$8.79 bn cumulative** | $2,922 |
| Lifecycle envelope (yr 1–25, high scenario) | **$8.12 bn cumulative** | $2,700 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$7.55 bn cumulative** | $2,508 |

_Population basis: 3,009,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $62 M / yr → $29 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $2.67 bn | 4.0% | 25 y, 5 y grace | $196 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $1.11 bn | 6.7% | 25 y, 5 y grace | $102 M / yr |
| Government equity (no debt service) | 15% | $667 M | — | — | — |
| **Total** | **100%** | **$4.45 bn** | | | **$299 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $107 M / yr + bonds $74 M / yr = **$181 M / yr** total — plus the equity tranche amortised across construction ($133 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $81 M |
