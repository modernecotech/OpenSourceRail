...
- **Practical daily ridership estimate** (10–15 % of catchment): ≈ **119,156 – 178,734 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (250.3 km @ $0.85 M/km) | $213 M |
| Elevated (33.8 km @ $4.0 M/km) | $135 M |
| Elevated-interchange premium (12 sites @ $2.0 M) | $24 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 294.0 km × $0.015 M/km | $4.4 M |
...
|---|---|---|
| Construction (years 1–5) | **$67 M / yr** | $22 |
| Steady-state, low-ridership (year 6+) | **$25 M / yr** | $8 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$840 M cumulative** | $279 |
| Lifecycle envelope (yr 1–25, high scenario) | **$336 M cumulative** | $112 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$336 M cumulative** | $112 |

_Population basis: 3,009,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $570 M | 4.0% | 25 y, 5 y grace | $42 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $238 M | 6.7% | 25 y, 5 y grace | $22 M / yr |
| Government equity (no debt service) | 15% | $143 M | — | — | — |
| **Total** | **100%** | **$950 M** | | | **$64 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $23 M / yr + bonds $16 M / yr = **$39 M / yr** total — plus the equity tranche amortised across construction ($29 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $221 k |
...
| Cost-neutral single-trip fare (6 % pass) | $0.64 |
...
|---|---|---|---|
| Daily paid trips | 240,720 | 451,350 | 348,518 |
| Daily paid trips / population | 8% | 15% | 12% |
| Annual paid trips | 87.9 M | 164.7 M | 127.2 M |
| Farebox revenue | $56 M / yr | $105 M / yr | $81 M / yr |
| Station shop leases | $6.6 M / yr | $6.6 M / yr | $6.6 M / yr |
| Advertising boards | $10 M / yr | $10 M / yr | $10 M / yr |
| **Total revenue** | **$73 M / yr** | **$122 M / yr** | **$98 M / yr** |
| Revenue / OPEX + debt-service recovery | 74% | 124% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Remaining steady-state gov gap | $25 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $24 M / yr | $0 / yr |
