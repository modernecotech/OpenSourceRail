...
| Bucket | Value |
|---|---|
| At-grade (219.7 km @ $0.85 M/km) | $187 M |
| Elevated (31.8 km @ $4.0 M/km) | $127 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 257.5 km × $0.015 M/km | $3.9 M |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $20 |
| Steady-state, low-ridership (year 6+) | **$10 M / yr** | $4 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$462 M cumulative** | $177 |
| Lifecycle envelope (yr 1–25, high scenario) | **$258 M cumulative** | $99 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$258 M cumulative** | $99 |

_Population basis: 2,615,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $438 M | 4.0% | 25 y, 5 y grace | $32 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $182 M | 6.7% | 25 y, 5 y grace | $17 M / yr |
| Government equity (no debt service) | 15% | $109 M | — | — | — |
| **Total** | **100%** | **$729 M** | | | **$49 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $18 M / yr + bonds $12 M / yr = **$30 M / yr** total — plus the equity tranche amortised across construction ($22 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 209,200 | 392,250 | 252,836 |
| Daily paid trips / population | 8% | 15% | 10% |
| Annual paid trips | 76.4 M | 143.2 M | 92.3 M |
| Farebox revenue | $49 M / yr | $92 M / yr | $59 M / yr |
| Station shop leases | $6.2 M / yr | $6.2 M / yr | $6.2 M / yr |
| Advertising boards | $9.7 M / yr | $9.7 M / yr | $9.7 M / yr |
| **Total revenue** | **$65 M / yr** | **$108 M / yr** | **$75 M / yr** |
| Revenue / OPEX + debt-service recovery | 86% | 143% | 100% |
| Country farebox-only policy target (diagnostic) | 60% | 60% | 60% |
| Remaining steady-state gov gap | $10 M / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $33 M / yr | $0 / yr |
