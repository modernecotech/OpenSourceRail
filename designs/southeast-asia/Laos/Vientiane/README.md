...
**Country:** LA · **Population:** 948,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$907 M (86.1%) of external capital** and **$1.14 bn of external interest**. Capital plus saved interest totals **$2.04 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`vientiane.corridor.geojson`](vientiane.corridor.geojson).
...
| Anchor-weighted coverage | 49.6% |
| Route length (double track) | 74.4 km |
| Revenue fleet | 139 × 3-car trainsets |
| Revenue fleet passenger capacity | 50,040 AW2 pax (66,720 AW3 crush) |
...
| Revenue fleet capacity | 50,040 AW2 pax (66,720 AW3 crush) |
| Total fleet capacity | 55,800 AW2 pax (74,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 139 × 360 = **50,040 AW2 passengers** (66,720 AW3 crush)
- **Total fleet passenger capacity:** 155 × 360 = **55,800 AW2 passengers** (74,400 AW3 crush, incl. service rotation + spare + reserve)
...
- City population: **948,000**
- Anchor-weighted coverage: 49.6%
- Catchment population: **≈ 470,208** (within ~800 m walk of a station)
...
| Standard | 14 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **26** | **12,500 kW** | **52,500 kWh** |

Aggregate station-rail charging power: **13,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **93.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.3× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 487 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 65 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 34,596 train-km/day | One-way train journeys × route length |
| Annual service work | 13.6 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 448 MWh/day | 40.9 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 388 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 93.0 MW / 447 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 175 kWh | 257 kWh | 65 kWh | 3.7 km / 28 kWh |
| line-2 | 9 | 174 kWh | 257 kWh | 66 kWh | 3.3 km / 25 kWh |
| line-3 | 8 | 208 kWh | 327 kWh | 97 kWh | 7.0 km / 53 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (72.5 km @ $2.58 M/km) | $187 M |
| Elevated (1.9 km @ $9.75 M/km) | $19 M |
| Elevated-interchange premium (1 sites @ $4.50 M) | $4.5 M |
| **Civil subtotal** | **$211 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 155 | $900 k | $140 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 465 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 465 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 93,045 kW @ $700/kW | $65 M |
| Grid interconnection / PPA tie-in | 93,045 kW @ $100/kW | $9.3 M |
| Annual generation proxy | 93.0 MW × 4.8 peak-sun-h/day × 365 d/yr | 163.0 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 74.4 km × $0.050 M/km | $3.7 M |
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $2.8 M |
...
| Per-capita (city pop) | $617 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $211 M | 15% | $32 M | $179 M |
| Stations | $113 M | 20% | $23 M | $90 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $140 M | 35% | $49 M | $91 M |
| Dedicated solar plant | $74 M | 45% | $33 M | $41 M |
...
| **Total city CAPEX** | **$585 M** | **25.0%** | **$146 M** | **$439 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh vientiane`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.0%** | **$146 M** | **$21 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.0%** | **$439 M** | **$63 M / yr** |
| of which planned local bond issuance | 60.0% of total CAPEX | $351 M | $50 M / yr |
| **Total city programme** | **100.0%** | **$585 M** | **$84 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $790 M | $643 M (81.5%) | $806 M | **$1.45 bn** |
| **Default** | 2.00× | $1.05 bn | $907 M (86.1%) | $1.14 bn | **$2.04 bn** |
| High | 3.00× | $1.58 bn | $1.43 bn (90.7%) | $1.80 bn | **$3.23 bn** |

At the default 2.00× case, OSR's $146 M external requirement is 86.1% below the illustrative foreign-company requirement of $1.05 bn; the associated lifetime external-interest saving is $1.14 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–7) | **$56 M / yr** | $59 |
| Steady-state, low capacity-use (year 8+) | **$22 M / yr** | $23 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$47 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$1.11 bn cumulative** | $1,175 |
| Lifecycle envelope (yr 1–40, high scenario) | **$392 M cumulative** | $413 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.94 bn cumulative** | $2,044 |

_Population basis: 948,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $25 M / yr → $47 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $146 M | 4.5% | 40 y, 7 y grace | $8.6 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $351 M | 10.5% | 40 y, 7 y grace | $38 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $88 M | — | — | — |
| **Total** | **100%** | **$585 M** | | | **$47 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.6 M / yr + local bonds $37 M / yr = **$43 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($13 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $5.6 M |
| Civil + station + depot maintenance | 2 % of fixed-asset CAPEX | $6.6 M |
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $186 k |
| Traction energy (163.7 GWh / yr) | 34,596 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 21.9 GWh/yr + dedicated solar plant 93.0 MW / 163.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (411 FTE) | driverless roster: OCC/remote 94, station/platform 93, passenger service 49, fleet maintenance 92, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.3 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 34,596 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.6 M train-km / yr (40.9 M car-km / yr). On-site PV covers 21.9 GWh/yr and the dedicated solar plant adds 163.0 GWh/yr against 163.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 155 trainsets, 27 stations, 74.4 route-km, 3 lines, and 34,596 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 25.3 M |
| Annual paid trips / city resident | 77 | 124 | 27 |
| Farebox revenue | $38 M / yr | $61 M / yr | $13 M / yr |
| Station shop leases | $634 k / yr | $634 k / yr | $634 k / yr |
| Advertising boards | $1.1 M / yr | $1.1 M / yr | $1.1 M / yr |
| **Total revenue** | **$40 M / yr** | **$63 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 268% | 422% | 100% |
...
| Operating surplus applied to debt support | -$25 M / yr | -$47 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $22 M / yr | $0 k / yr | **$47 M / yr** |
| Operating surplus after OPEX (before debt support) | $25 M / yr | $48 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,848 m² of station shop/kiosk leases at $16/m²/month and 756 advertising boards at $136/board/month, with occupancy derates applied._
...
| Avoided road congestion | $20 M / yr | $31 M / yr | 245 M - 393 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.5 M / yr | $5.7 M / yr | 44.2–70.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $9.8 M / yr | $16 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
...
| **Annual quantified benefit / activity proxy** | **$78 M / yr** | **$125 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 4 education anchors | 13,140 trips/school day; 2.9 M access-events/yr | 21,024 trips/school day; 4.6 M access-events/yr |
| Healthcare | 6 healthcare anchors | 18,008 trips/day; 6.6 M access-events/yr | 28,813 trips/day; 10.5 M access-events/yr |
| Commerce | 12 major/terminal/interchange nodes | 41,515 trips/trading day; 13.7 M access-events/yr | 66,424 trips/trading day; 21.9 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $439 M | 75% of $585 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $702 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $100 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 46,857 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $511 M |
| Timetable-sized dedicated solar CAPEX | $74 M |
| **Reconciled project CAPEX** | **$585 M** |
| Imported / external-capital requirement | $146 M (25.0%) |
| Local-content / local-funding requirement | $439 M (75.0%) |
| Default foreign-turnkey external-capital comparison | $1.05 bn; OSR saves $907 M (86.1%) |
| Lifetime external interest and combined financing saving | $1.14 bn interest; $2.04 bn capital + interest |
| 15%–25% planning risk envelope | $673 M–$731 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $-267399 k / $-113711 k |
| Low/high project IRR | 1.8% / 5.8% |
| Low/high steady-state DSCR | 0.53 / 1.02 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,650.58 train-km; 19,847.34 kWh consumed; 17,378.01 kWh charged; 22 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 34,153.32 train-km; 255,737.03 kWh consumed; 247,134.76 kWh charged; 500 depot services completed (5 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 98.7% of scheduled train-km delivered; 161 SoC warnings; 12 energy-adapted off-peak departures, maximum 16 min headway |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 20.0% | 98.5% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 93.7% / 90% | pass |
| 50% charging-contact availability | 20.0% | 98.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.0% / 60% | pass |
| ten-hour single charging-pad outage | 20.0% | 98.1% / 90% | pass |
...
|---|---|
| ![Vientiane energy and battery simulation dashboard](engineering/screenshots/vientiane-simulation-dashboard.png) | ![Vientiane simulator network visualizer](engineering/screenshots/vientiane-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 27 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
...
|---|---|
| ![Vientiane QGIS engineering layers](engineering/screenshots/vientiane-qgis-engineering-map.png) | ![Vientiane SUMO timetable validation](engineering/screenshots/vientiane-sumo-validation.png) |
...
| [`vientiane.toml`](vientiane.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`vientiane-network-map.png`](vientiane-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`vientiane.corridor.geojson`](vientiane.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`vientiane.stations.json`](vientiane.stations.json) | Machine-readable station list |
| [`vientiane.design-quality.yaml`](vientiane.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug vientiane
