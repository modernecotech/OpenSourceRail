...
| Revenue fleet | 169 × 3-car trainsets |
| Revenue fleet passenger capacity | 60,840 AW2 pax (81,120 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 23.3 km | 14 | 58 | NE Outer ↔ S Mid |
| line-2 | 23.2 km | 15 | 59 | NE Outer ↔ SW Mid |
| line-3 | 27.8 km | 15 | 71 | NW Outer ↔ SE Outer |
| **Total** | **74.4 km** | **44 unique** | **188** | |
...
| Revenue fleet capacity | 60,840 AW2 pax (81,120 AW3 crush) |
| Total fleet capacity | 67,680 AW2 pax (90,240 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 169 × 360 = **60,840 AW2 passengers** (81,120 AW3 crush)
- **Total fleet passenger capacity:** 188 × 360 = **67,680 AW2 passengers** (90,240 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 25 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **43** | **17,600 kW** | **61,000 kWh** |

Aggregate station-rail charging power: **21,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **87.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.1× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 499 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 102 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 84 MWh/day | 4.8 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 364 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 87.2 MW / 418 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 61 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 14 | 175 kWh | 294 kWh | 102 kWh | 2.0 km / 15 kWh |
| line-2 | 15 | 174 kWh | 314 kWh | 123 kWh | 2.1 km / 16 kWh |
| line-3 | 14 | 208 kWh | 351 kWh | 122 kWh | 5.5 km / 41 kWh |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 188 | $900 k | $169 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 564 | $60 k | $34 M |
| High sensitivity check | 564 | $120 k | $68 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 87,180 kW @ $700/kW | $61 M |
| Grid interconnection / PPA tie-in | 87,180 kW @ $100/kW | $8.7 M |
| Annual generation proxy | 87.2 MW × 4.8 peak-sun-h/day × 365 d/yr | 152.7 GWh/yr |
...
|---|---|---|
| Construction (years 1–7) | **$49 M / yr** | $52 |
| Steady-state, low capacity-use (year 8+) | **$13 M / yr** | $14 |
| Steady-state, high capacity-use (year 8+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$36 M / yr** | $38 |
| Lifecycle envelope (yr 1–40, low scenario) | **$783 M cumulative** | $826 |
| Lifecycle envelope (yr 1–40, high scenario) | **$344 M cumulative** | $363 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.53 bn cumulative** | $1,609 |

_Population basis: 948,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $22 M / yr → $36 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $609 M | 4.5% | 40 y, 7 y grace | $36 M / yr |
| Government equity (no debt service) | 20% | $152 M | — | — | — |
| **Total** | **100%** | **$761 M** | | | **$36 M / yr** |

_During the 7-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $27 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($22 M / yr × 7 yr). Principal repayment begins in year 8 on a 33-year amortisation schedule._
...
| Traction energy (163.7 GWh / yr) | 34,596 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 30.8 GWh/yr + dedicated solar plant 87.2 MW / 152.7 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.0 M |
| Labour (497 FTE) | driverless roster: OCC/remote 110, station/platform 147, passenger service 49, fleet maintenance 102, infrastructure/energy 68, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $1.6 M |
| **OPEX subtotal** | | **$18 M / yr** |

_Annual service work: 34,596 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.6 M train-km / yr (40.9 M car-km / yr). On-site PV covers 30.8 GWh/yr and the dedicated solar plant adds 152.7 GWh/yr against 163.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 188 trainsets, 44 stations, 74.4 route-km, 3 lines, and 34,596 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 30.1 M |
| Annual paid trips / city resident | 77 | 124 | 32 |
| Farebox revenue | $38 M / yr | $61 M / yr | $16 M / yr |
| Station shop leases | $1.0 M / yr | $1.0 M / yr | $1.0 M / yr |
| Advertising boards | $1.7 M / yr | $1.7 M / yr | $1.7 M / yr |
| **Total revenue** | **$41 M / yr** | **$64 M / yr** | **$18 M / yr** |
| Revenue / OPEX recovery | 223% | 348% | 100% |
...
| Operating surplus applied to debt support | -$22 M / yr | -$36 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $13 M / yr | $0 k / yr | **$36 M / yr** |
| Operating surplus after OPEX (before debt support) | $22 M / yr | $45 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,208 m² of station shop/kiosk leases at $16/m²/month and 1,204 advertising boards at $136/board/month, with occupancy derates applied._
...
| Healthcare | 9 healthcare anchors | 18,956 trips/day; 6.9 M access-events/yr | 30,329 trips/day; 11.1 M access-events/yr |
| Commerce | 18 major/terminal/interchange nodes | 40,770 trips/trading day; 13.5 M access-events/yr | 65,231 trips/trading day; 21.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $423 M | 56% of $761 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $678 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $97 M / yr | spread across 7 construction / grace years |
| Construction employment supported | 45,239 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $692 M |
| Timetable-sized dedicated solar CAPEX | $70 M |
| **Reconciled project CAPEX** | **$761 M** |
| 15%–25% planning risk envelope | $876 M–$952 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $-415188 k / $-261500 k |
| Low/high project IRR | -0.1% / 3.7% |
| Low/high steady-state DSCR | 0.63 / 1.27 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,550.61 train-km; 19,098.78 kWh consumed; 20,681.35 kWh charged; 18 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 35,512.21 train-km; 265,912.44 kWh consumed; 271,500.37 kWh charged; 503 depot services completed (3 active at cutoff); minimum SoC 41%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 27.2% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 100.0% / 90% | pass |
| 50% charging-contact availability | 40.8% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.9% / 60% | pass |
| ten-hour single charging-pad outage | 40.8% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 44 line platforms, 1 interchange complexes, 13 civil segments, and 0 input findings |
