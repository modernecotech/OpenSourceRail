...
| Manufacturing schedule rows | 1,274 |
| Manufacturing material/BOM rows | 20,001 |
| Manufacturing QA verification rows | 1,274 |
| Construction QA action rows | 1,200 |
| Maintenance handover schedule rows | 1,504 |
| Manufacturing rows with material refs | 1,274 / 1,274 |
| Manufacturing rows with verification refs | 1,274 / 1,274 |
| Manufacturing rows linked to QA actions | 1,274 / 1,274 |
