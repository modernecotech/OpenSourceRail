...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this national OSR programme avoids **$10.19 B (85.8%) of external capital** and **$13.16 B of external interest**. Capital plus saved interest totals **$23.34 B over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the comparator external requirement is assumed debt-financed, and the comparator is an editable sensitivity, not a vendor quote.
...
| **Total national programme CAPEX** | **$6.59 B** |
...
|---|---:|---:|---:|
| **External capital for imports** | **25.5%** | **$1.68 B** | **$168.2 M / yr** |
| **Local capital for domestic value** | **74.5%** | **$4.91 B** | **$491.1 M / yr** |
| planned local-currency bond issuance | 59.6% of total | $3.93 B | $392.9 M / yr |
| local public equity / other domestic funding | 14.9% of total | $982.3 M | $98.2 M / yr |
| **Total capital programme** | **100.0%** | **$6.59 B** | **$659.3 M / yr** |

The annual construction draw is spread evenly over 10 planning years. Post-grace annual debt service is $103.3 M for external import finance plus $524.2 M for local bonds, or **$627.4 M per year** before railway operating cash flow. During construction, interest plus the local public-equity draw is **$684.7 M per year**.
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $8.90 B | $7.22 B (81.1%) | $9.33 B | **$16.54 B** |
| **Default** | 2.00× | $11.87 B | $10.19 B (85.8%) | $13.16 B | **$23.34 B** |
| High | 3.00× | $17.80 B | $16.12 B (90.6%) | $20.82 B | **$36.94 B** |

At the default 2.00× case, the OSR programme reduces external capital from $11.87 B to $1.68 B, a saving of **$10.19 B (85.8%)**, plus **$13.16 B** of external interest over the financing life. Total programme CAPEX is 50.0% below the comparator. Replace both variables with scope-normalized bids before investment approval.

## Procurement-origin composition

| CAPEX bucket | Total | Imported share | External capital | Local value |
|---|---:|---:|---:|---:|
| Civil works | $2.27 B | 15% | $341.2 M | $1.93 B |
...
| EPC / project services | $364.1 M | 15% | $54.6 M | $309.5 M |
| Shared national trainset factory | $238.0 M | 20% | $47.6 M | $190.4 M |
| **Total** | **$6.59 B** | **25.5%** | **$1.68 B** | **$4.91 B** |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Yangon](Yangon/README.md) | 5,200,000 | 661 | $4.40 B | 27.0% | $1.19 B | $7.92 B | $6.73 B | $15.42 B | $3.21 B |
| [Mandalay](Mandalay/README.md) | 1,726,000 | 276 | $1.94 B | 22.8% | $443.5 M | $3.49 B | $3.05 B | $6.99 B | $1.50 B |
