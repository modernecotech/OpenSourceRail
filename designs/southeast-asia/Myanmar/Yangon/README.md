...
| Per-capita (city pop) | $565 / person |
...
|---|---|---|
| Construction (years 1–10) | **$219 M / yr** | $42 |
| Steady-state, low-ridership (year 11+) | **$248 M / yr** | $48 |
| Steady-state, high-ridership (year 11+) | **$240 M / yr** | $46 |
| Steady-state, operating-neutral revenue case | **$240 M / yr** | $46 |
| Lifecycle envelope (yr 1–30, low scenario) | **$7.15 bn cumulative** | $1,375 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.99 bn cumulative** | $1,345 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$6.99 bn cumulative** | $1,345 |

_Population basis: 5,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $7.8 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.76 bn | 4.5% | 30 y, 10 y grace | $136 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $735 M | 13.0% | 30 y, 10 y grace | $105 M / yr |
| Government equity (no debt service) | 15% | $441 M | — | — | — |
| **Total** | **100%** | **$2.94 bn** | | | **$240 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $79 M / yr + bonds $96 M / yr = **$175 M / yr** total — plus the equity tranche amortised across construction ($44 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 527,903 | 879,839 | 610,619 |
| Daily paid trips / catchment | 18% | 30% | 21% |
| Daily paid trips / city population | 10% | 17% | 12% |
| Annual paid trips | 192.7 M | 321.1 M | 222.9 M |
| Farebox revenue | $50 M / yr | $83 M / yr | $58 M / yr |
| Station shop leases | $4.7 M / yr | $4.7 M / yr | $4.7 M / yr |
| Advertising boards | $7.1 M / yr | $7.1 M / yr | $7.1 M / yr |
| **Total revenue** | **$62 M / yr** | **$95 M / yr** | **$70 M / yr** |
| Revenue / OPEX recovery | 89% | 137% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $248 M / yr | $240 M / yr | **$240 M / yr** |
| Operating surplus after OPEX | $0 k / yr | $26 M / yr | $0 / yr |
