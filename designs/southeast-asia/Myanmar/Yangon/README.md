...
|---|---|---|
| Construction (years 1–10) | **$281 M / yr** | $54 |
| Steady-state, low-ridership (year 11+) | **$331 M / yr** | $64 |
| Steady-state, high-ridership (year 11+) | **$308 M / yr** | $59 |
| Steady-state, operating-neutral revenue case | **$308 M / yr** | $59 |
| Lifecycle envelope (yr 1–30, low scenario) | **$9.43 bn cumulative** | $1,813 |
| Lifecycle envelope (yr 1–30, high scenario) | **$8.96 bn cumulative** | $1,723 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$8.96 bn cumulative** | $1,723 |

_Population basis: 5,200,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $23 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $2.26 bn | 4.5% | 30 y, 10 y grace | $174 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $942 M | 13.0% | 30 y, 10 y grace | $134 M / yr |
| Government equity (no debt service) | 15% | $565 M | — | — | — |
| **Total** | **100%** | **$3.77 bn** | | | **$308 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $102 M / yr + bonds $122 M / yr = **$224 M / yr** total — plus the equity tranche amortised across construction ($56 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
