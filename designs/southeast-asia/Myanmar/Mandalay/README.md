...
|---|---|---|
| Construction (years 1–10) | **$117 M / yr** | $68 |
| Steady-state, low-ridership (year 11+) | **$140 M / yr** | $81 |
| Steady-state, high-ridership (year 11+) | **$128 M / yr** | $74 |
| Steady-state, operating-neutral revenue case | **$128 M / yr** | $74 |
| Lifecycle envelope (yr 1–30, low scenario) | **$3.97 bn cumulative** | $2,301 |
| Lifecycle envelope (yr 1–30, high scenario) | **$3.74 bn cumulative** | $2,165 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$3.73 bn cumulative** | $2,160 |

_Population basis: 1,726,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $12 M / yr → $380 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $940 M | 4.5% | 30 y, 10 y grace | $72 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $392 M | 13.0% | 30 y, 10 y grace | $56 M / yr |
| Government equity (no debt service) | 15% | $235 M | — | — | — |
| **Total** | **100%** | **$1.57 bn** | | | **$128 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $42 M / yr + bonds $51 M / yr = **$93 M / yr** total — plus the equity tranche amortised across construction ($24 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,718 | 311,197 | 315,206 |
| Daily paid trips / catchment | 18% | 30% | 30% |
| Daily paid trips / city population | 11% | 18% | 18% |
| Annual paid trips | 68.2 M | 113.6 M | 115.1 M |
| Farebox revenue | $18 M / yr | $30 M / yr | $30 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| **Total revenue** | **$22 M / yr** | **$34 M / yr** | **$35 M / yr** |
| Revenue / OPEX recovery | 65% | 99% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $140 M / yr | $128 M / yr | **$128 M / yr** |
