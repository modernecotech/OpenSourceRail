...
Aggregate station-rail charging power: **30,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 460 kWh battery covers running.
...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 187.0 km × €0.1 M/km | €19 M |
| Traction power (**trackside** stationary PV + Na-ion + grid-tie at every station, no OCS, RFC 0002 §6) | 187.0 km × €0.8 M/km | €148 M |
...
| Depots | €52 M |
| Rolling stock | €468 M |
| Signalling + power | €167 M |
| EPC overhead (7%) | €139 M |
| **CAPEX total** | **€2.12 bn** |
| Per-route-km | €11 M / km |
| Per-capita (city pop) | €1,228 / person |
...
|---|---|---|
| Construction (years 1–10) | **€158 M / yr** | €91 |
| Steady-state, low-ridership (year 11+) | **€216 M / yr** | €125 |
| Steady-state, high-ridership (year 11+) | **€209 M / yr** | €121 |
| Lifecycle envelope (yr 1–30, low scenario) | **€5.89 bn cumulative** | €3,415 |
| Lifecycle envelope (yr 1–30, high scenario) | **€5.77 bn cumulative** | €3,342 |

_Population basis: 1,726,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero and only the OPEX shortfall remains — ~€43 M / yr (low) → €36 M / yr (high)._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | €1.27 bn | 4.5% | 30 y, 10 y grace | €98 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | €530 M | 13.0% | 30 y, 10 y grace | €75 M / yr |
| Government equity (no debt service) | 15% | €318 M | — | — | — |
| **Total** | **100%** | **€2.12 bn** | | | **€173 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral €57 M / yr + bonds €69 M / yr = **€126 M / yr** total — plus the equity tranche amortised across construction (€32 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
| Signalling + comms maintenance | 5 % of signalling CAPEX | €927 k |
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€216 M / yr** | **€209 M / yr** |
