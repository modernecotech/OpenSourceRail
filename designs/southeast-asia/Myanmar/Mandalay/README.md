...
|---|---|---|
| Construction (years 1–10) | **$178 M / yr** | $103 |
| Steady-state, low-ridership (year 11+) | **$236 M / yr** | $137 |
| Steady-state, high-ridership (year 11+) | **$224 M / yr** | $130 |
| Steady-state, operating-neutral revenue case | **$195 M / yr** | $113 |
| Lifecycle envelope (yr 1–30, low scenario) | **$6.50 bn cumulative** | $3,764 |
| Lifecycle envelope (yr 1–30, high scenario) | **$6.26 bn cumulative** | $3,627 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$5.69 bn cumulative** | $3,295 |

_Population basis: 1,726,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $40 M / yr → $29 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.43 bn | 4.5% | 30 y, 10 y grace | $110 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $598 M | 13.0% | 30 y, 10 y grace | $85 M / yr |
| Government equity (no debt service) | 15% | $359 M | — | — | — |
| **Total** | **100%** | **$2.39 bn** | | | **$195 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $65 M / yr + bonds $78 M / yr = **$142 M / yr** total — plus the equity tranche amortised across construction ($36 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,718 | 311,197 | 613,259 |
| Daily paid trips / catchment | 18% | 30% | 59% |
| Daily paid trips / city population | 11% | 18% | 36% |
| Annual paid trips | 68.2 M | 113.6 M | 223.8 M |
| Farebox revenue | $18 M / yr | $30 M / yr | $58 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| **Total revenue** | **$22 M / yr** | **$34 M / yr** | **$63 M / yr** |
| Revenue / OPEX recovery | 36% | 54% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Gov debt service + residual OPEX subsidy | $236 M / yr | $224 M / yr | **$195 M / yr** |
