...
- **Planning daily ridership scenario** (18-30% of catchment): ≈ **186,718 – 311,197 trips/day**
...
|---|---|---|
| Construction (years 1–10) | **$90 M / yr** | $52 |
| Steady-state, low-ridership (year 11+) | **$104 M / yr** | $61 |
| Steady-state, high-ridership (year 11+) | **$99 M / yr** | $57 |
| Steady-state, operating-neutral revenue case | **$99 M / yr** | $57 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.99 bn cumulative** | $1,733 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.88 bn cumulative** | $1,669 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.88 bn cumulative** | $1,669 |

_Population basis: 1,726,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $5.5 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $726 M | 4.5% | 30 y, 10 y grace | $56 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $303 M | 13.0% | 30 y, 10 y grace | $43 M / yr |
| Government equity (no debt service) | 15% | $182 M | — | — | — |
| **Total** | **100%** | **$1.21 bn** | | | **$99 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $33 M / yr + bonds $39 M / yr = **$72 M / yr** total — plus the equity tranche amortised across construction ($18 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,718 | 311,197 | 245,006 |
| Daily paid trips / catchment | 18% | 30% | 24% |
| Daily paid trips / city population | 11% | 18% | 14% |
| Annual paid trips | 68.2 M | 113.6 M | 89.4 M |
| Farebox revenue | $18 M / yr | $30 M / yr | $23 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| **Total revenue** | **$22 M / yr** | **$34 M / yr** | **$28 M / yr** |
| Revenue / OPEX recovery | 80% | 123% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $104 M / yr | $99 M / yr | **$99 M / yr** |
