...
|---|---|---|
| Construction (years 1–10) | **$87 M / yr** | $50 |
| Steady-state, low-ridership (year 11+) | **$100 M / yr** | $58 |
| Steady-state, high-ridership (year 11+) | **$95 M / yr** | $55 |
| Steady-state, operating-neutral revenue case | **$95 M / yr** | $55 |
| Lifecycle envelope (yr 1–30, low scenario) | **$2.86 bn cumulative** | $1,658 |
| Lifecycle envelope (yr 1–30, high scenario) | **$2.77 bn cumulative** | $1,604 |
| Lifecycle envelope (yr 1–30, operating-neutral after opening) | **$2.77 bn cumulative** | $1,604 |

_Population basis: 1,726,000 (catchment per `lib/city-batches/world-sample.toml`). After year 30, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $4.7 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $698 M | 4.5% | 30 y, 10 y grace | $54 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $291 M | 13.0% | 30 y, 10 y grace | $41 M / yr |
| Government equity (no debt service) | 15% | $175 M | — | — | — |
| **Total** | **100%** | **$1.16 bn** | | | **$95 M / yr** |

_During the 10-year grace period the operator pays interest only — multilateral $31 M / yr + bonds $38 M / yr = **$69 M / yr** total — plus the equity tranche amortised across construction ($17 M / yr × 10 yr). Principal repayment begins in year 11 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 186,718 | 311,197 | 235,722 |
| Daily paid trips / catchment | 18% | 30% | 23% |
| Daily paid trips / city population | 11% | 18% | 14% |
| Annual paid trips | 68.2 M | 113.6 M | 86.0 M |
| Farebox revenue | $18 M / yr | $30 M / yr | $22 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| **Total revenue** | **$22 M / yr** | **$34 M / yr** | **$27 M / yr** |
| Revenue / OPEX recovery | 83% | 127% | 100% |
| Country farebox-only policy target (diagnostic) | 40% | 40% | 40% |
| Remaining steady-state gov commitment | $100 M / yr | $95 M / yr | **$95 M / yr** |
