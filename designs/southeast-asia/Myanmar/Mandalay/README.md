...
|---|---:|---:|---:|---:|
| Civil works | $997 M | 35% | $349 M | $648 M |
| Stations | $434 M | 40% | $174 M | $260 M |
| Depots | $8.0 M | 40% | $3.2 M | $4.8 M |
| Rolling stock | $309 M | 55% | $170 M | $139 M |
| Dedicated solar plant | $197 M | 70% | $138 M | $59 M |
| Residual signalling / train control | $11 M | 80% | $8.9 M | $2.2 M |
| Charging microgrids | $21 M | 55% | $11 M | $9.2 M |
| EPC / project services | $125 M | 45% | $56 M | $69 M |
| **Total city CAPEX** | **$2.10 bn** | **43.3%** | **$910 M** | **$1.19 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **43.3%** | **$910 M** | **$91 M / yr** |
| **Local capital for domestic procurement / payroll** | **56.7%** | **$1.19 bn** | **$119 M / yr** |
| of which planned local bond issuance | 45.4% of total CAPEX | $953 M | $95 M / yr |
...
|---|---|---|
| Construction (years 1–10) | **$189 M / yr** | $109 |
| Steady-state, low capacity-use (year 11+) | **$164 M / yr** | $95 |
| Steady-state, high capacity-use (year 11+) | **$126 M / yr** | $73 |
| Steady-state, operating-neutral revenue case | **$183 M / yr** | $106 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.80 bn cumulative** | $3,937 |
| Lifecycle envelope (yr 1–40, high scenario) | **$5.68 bn cumulative** | $3,289 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.37 bn cumulative** | $4,273 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 43% | $910 M | 4.5% | 40 y, 10 y grace | $56 M / yr |
| Local-currency sovereign / project bonds for local content | 45% | $953 M | 13.0% | 40 y, 10 y grace | $127 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $238 M | — | — | — |
| **Total** | **100%** | **$2.10 bn** | | | **$183 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $41 M / yr + local bonds $124 M / yr = **$165 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($24 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $164 M / yr | $126 M / yr | **$183 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.19 bn | 57% of $2.10 bn CAPEX using bucket local-content shares |
...
| Construction employment supported | 190,873 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $910 M (43.3%) |
| Local-content / local-funding requirement | $1.19 bn (56.7%) |
