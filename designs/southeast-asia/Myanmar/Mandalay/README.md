...
| Revenue fleet | 331 × 4-car trainsets |
| Revenue fleet passenger capacity | 158,880 AW2 pax (211,840 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 43.9 km | 23 | 89 | N Outer ↔ S Outer |
| line-2 | 32.3 km | 16 | 67 | NW Mid ↔ SE Outer |
| line-3 | 32.0 km | 18 | 67 | SW Outer ↔ NE Mid |
| line-4 | 25.8 km | 13 | 53 | W Inner ↔ NE Outer |
| line-5 | 27.3 km | 17 | 61 | E Mid ↔ SW Outer |
| line-6 | 60.7 km | 34 | 31 | NW Mid ↔ NW Mid |
| **Total** | **221.9 km** | **121 unique** | **368** | |
...
| Revenue fleet capacity | 158,880 AW2 pax (211,840 AW3 crush) |
| Total fleet capacity | 176,640 AW2 pax (235,520 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 331 × 480 = **158,880 AW2 passengers** (211,840 AW3 crush)
- **Total fleet passenger capacity:** 368 × 480 = **176,640 AW2 passengers** (235,520 AW3 crush, incl. service rotation + spare + reserve)
...
| Standard | 48 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **98** | **34,100 kW** | **185,500 kWh** |

Aggregate station-rail charging power: **147,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **233.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 3.5× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 515 kWh usable margin across the worst powered-stop gap (line-6) |
| Lowest traversal charging margin | 223 kWh | line-4 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 222 MWh/day | 6.5 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 1,317 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 233.1 MW / 1,515 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 186 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 17 | 489 kWh | 906 kWh | 369 kWh | 11.6 km / 129 kWh |
| line-2 | 13 | 359 kWh | 686 kWh | 291 kWh | 11.2 km / 125 kWh |
| line-3 | 14 | 356 kWh | 735 kWh | 343 kWh | 12.0 km / 133 kWh |
| line-4 | 10 | 287 kWh | 539 kWh | 223 kWh | 11.4 km / 127 kWh |
| line-5 | 16 | 304 kWh | 833 kWh | 499 kWh | 6.2 km / 69 kWh |
| line-6 | 28 | 676 kWh | 1,372 kWh | 628 kWh | 18.4 km / 205 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (191.3 km @ $3.0 M/km) | $574 M |
| Elevated (30.7 km @ $12.0 M/km) | $368 M |
| Elevated-interchange premium (12 sites @ $4.50 M) | $54 M |
| **Civil subtotal** | **$996 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 368 | $1.12 M | $412 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1472 | $60 k | $88 M |
| High sensitivity check | 1472 | $120 k | $177 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 233,092 kW @ $700/kW | $163 M |
| Grid interconnection / PPA tie-in | 233,092 kW @ $100/kW | $23 M |
| Annual generation proxy | 233.1 MW × 6.5 peak-sun-h/day × 365 d/yr | 553.0 GWh/yr |
| **Dedicated solar plant subtotal** | | **$186 M** |
...
|---|---|---|
| Construction (years 1–10) | **$139 M / yr** | $80 |
| Steady-state, low capacity-use (year 11+) | **$108 M / yr** | $63 |
| Steady-state, high capacity-use (year 11+) | **$71 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$122 M / yr** | $70 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.64 bn cumulative** | $2,686 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.52 bn cumulative** | $2,038 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$5.03 bn cumulative** | $2,915 |

_Population basis: 1,726,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $13 M / yr → $50 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $1.98 bn | 4.5% | 40 y, 10 y grace | $122 M / yr |
| Government equity (no debt service) | 20% | $495 M | — | — | — |
| **Total** | **100%** | **$2.47 bn** | | | **$122 M / yr** |

_During the 10-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $89 M / yr = **$89 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($49 M / yr × 10 yr). Principal repayment begins in year 11 on a 30-year amortisation schedule._
...
| Traction energy (561.8 GWh / yr) | 89,070 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 80.9 GWh/yr + dedicated solar plant 233.1 MW / 553.0 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $2.8 M |
| Labour (1,219 FTE) | driverless roster: OCC/remote 203, station/platform 459, passenger service 111, fleet maintenance 228, infrastructure/energy 191, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$54 M / yr** |

_Annual service work: 89,070 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 35.1 M train-km / yr (140.4 M car-km / yr). On-site PV covers 80.9 GWh/yr and the dedicated solar plant adds 553.0 GWh/yr against 561.8 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 368 trainsets, 121 stations, 221.9 route-km, 6 lines, and 89,070 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 141.2 M |
| Annual paid trips / city resident | 104 | 166 | 82 |
| Farebox revenue | $62 M / yr | $99 M / yr | $49 M / yr |
| Station shop leases | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| Advertising boards | $3.3 M / yr | $3.3 M / yr | $3.3 M / yr |
| **Total revenue** | **$68 M / yr** | **$105 M / yr** | **$54 M / yr** |
| Revenue / OPEX recovery | 124% | 193% | 100% |
...
| Operating surplus applied to debt support | -$13 M / yr | -$50 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $108 M / yr | $71 M / yr | **$122 M / yr** |
| Operating surplus after OPEX (before debt support) | $13 M / yr | $50 M / yr | $0 / yr |

_Commercial-revenue assumptions: 19,368 m² of station shop/kiosk leases at $10/m²/month and 3,580 advertising boards at $91/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $55 M / yr | $87 M / yr | 20% of paid trips × $1.50 local spend proxy |
| Entertainment / community activity supported | $28 M / yr | $46 M / yr | 11% of paid trips × $1.50 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$188 M / yr** | **$301 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 7 education anchors | 27,712 trips/school day; 6.1 M access-events/yr | 44,339 trips/school day; 9.8 M access-events/yr |
| Healthcare | 12 healthcare anchors | 40,223 trips/day; 14.7 M access-events/yr | 64,356 trips/day; 23.5 M access-events/yr |
| Commerce | 50 major/terminal/interchange nodes | 99,872 trips/trading day; 33.0 M access-events/yr | 159,795 trips/trading day; 52.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.41 bn | 57% of $2.47 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.26 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $226 M / yr | spread across 10 construction / grace years |
| Construction employment supported | 226,454 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Timetable-sized dedicated solar CAPEX | $186 M |
| **Reconciled project CAPEX** | **$2.47 bn** |
| 15%–25% planning risk envelope | $2.85 bn–$3.09 bn |
| Annual OPEX | $54 M / yr |
| Low/high project NPV at 8% | $-1591431 k / $-1397035 k |
| Low/high project IRR | -7.8% / -2.3% |
| Low/high steady-state DSCR | 0.11 / 0.42 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,170.18 train-km; 68,711.90 kWh consumed; 70,496.90 kWh charged; 29 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 89,999.05 train-km; 1,002,240.12 kWh consumed; 1,015,565.06 kWh charged; 1,003 depot services completed (5 active at cutoff); minimum SoC 72%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 65.5% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 68.4% | 100.0% / 90% | pass |
| 50% charging-contact availability | 72.3% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 88.3% / 60% | pass |
| ten-hour single charging-pad outage | 71.4% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 121 line platforms, 14 interchange complexes, 131 civil segments, and 0 input findings |
