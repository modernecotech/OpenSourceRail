...
|---|---|---|---|---|
| line-1 | 19.6 km | 11 | 51 | E Mid ↔ NW Outer |
| line-2 | 14.6 km | 10 | 35 | N Mid ↔ S Mid |
| line-3 | 17.1 km | 10 | 46 | SW Mid ↔ NE Outer |
| **Total** | **51.3 km** | **31 unique** | **132** | |
...
| Dedicated solar plant | 39.3 MW / 255 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 164 kWh | 253 kWh | 73 kWh | 5.5 km / 46 kWh |
| line-2 | 10 | 122 kWh | 180 kWh | 46 kWh | 2.1 km / 18 kWh |
| line-3 | 9 | 143 kWh | 220 kWh | 63 kWh | 5.9 km / 49 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 39,293 kW @ $700/kW | $28 M |
| Grid interconnection / PPA tie-in | 39,293 kW @ $100/kW | $3.9 M |
| Annual generation proxy | 39.3 MW × 6.5 peak-sun-h/day × 365 d/yr | 93.2 GWh/yr |
...
| Per-capita (city pop) | $955 / person |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$218 M cumulative** | $363 |
| Lifecycle envelope (yr 1–40, high scenario) | **$218 M cumulative** | $363 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.14 bn cumulative** | $1,895 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $459 M | 4.5% | 40 y, 5 y grace | $26 M / yr |
| Government equity (no debt service) | 20% | $115 M | — | — | — |
| **Total** | **100%** | **$573 M** | | | **$26 M / yr** |
...
| Traction energy (112.9 GWh / yr) | 23,857 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 31.8 GWh/yr + dedicated solar plant 39.3 MW / 93.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $472 k |
| Labour (413 FTE) | driverless roster: OCC/remote 81, station/platform 142, passenger service 49, fleet maintenance 71, infrastructure/energy 49, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.3 M |
| **OPEX subtotal** | | **$16 M / yr** |

_Annual service work: 23,857 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.4 M train-km / yr (28.2 M car-km / yr). On-site PV covers 31.8 GWh/yr and the dedicated solar plant adds 93.2 GWh/yr against 112.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 132 trainsets, 31 stations, 51.3 route-km, 3 lines, and 23,857 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 122 | 196 | 12 |
| Farebox revenue | $94 M / yr | $150 M / yr | $9.6 M / yr |
| Station shop leases | $2.5 M / yr | $2.5 M / yr | $2.5 M / yr |
| Advertising boards | $3.8 M / yr | $3.8 M / yr | $3.8 M / yr |
| **Total revenue** | **$100 M / yr** | **$156 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 632% | 987% | 100% |
...
| Operating surplus after OPEX (before debt support) | $84 M / yr | $141 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,088 m² of station shop/kiosk leases at $38/m²/month and 1,116 advertising boards at $336/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $41 M / yr | $65 M / yr | 23% of paid trips × $2.40 local spend proxy |
...
| Commerce | 21 major/terminal/interchange nodes | 46,429 trips/trading day; 15.3 M access-events/yr | 74,287 trips/trading day; 24.5 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $326 M | 57% of $573 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 14,164 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $542 M |
| Timetable-sized dedicated solar CAPEX | $31 M |
| **Reconciled project CAPEX** | **$573 M** |
| 15%–25% planning risk envelope | $659 M–$717 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $211 M / $658 M |
| Low/high project IRR | 11.4% / 17.3% |
| Low/high steady-state DSCR | 3.21 / 5.35 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,988.30 train-km; 16,604.34 kWh consumed; 16,769.35 kWh charged; 27 depot services completed; minimum SoC 85%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 24,652.37 train-km; 205,873.26 kWh consumed; 209,310.74 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 39%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 25.1% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 20.3% | 100.0% / 90% | pass |
| 50% charging-contact availability | 39.1% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 31 line platforms, 3 interchange complexes, 15 civil segments, and 0 input findings |
