...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$635 M (86.7%) of external capital** and **$780 M of external interest**. Capital plus saved interest totals **$1.41 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Total fleet capacity | 39,600 AW2 pax (52,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 99 × 360 = **35,640 AW2 passengers** (47,520 AW3 crush)
- **Total fleet passenger capacity:** 110 × 360 = **39,600 AW2 passengers** (52,800 AW3 crush, incl. service rotation + spare + reserve)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **43.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 8.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 473 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 38 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 23,857 train-km/day | One-way train journeys × route length |
| Annual service work | 9.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 309 MWh/day | 28.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 244 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 43.1 MW / 280 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 7 | 164 kWh | 229 kWh | 48 kWh | 5.7 km / 47 kWh |
| line-2 | 6 | 122 kWh | 172 kWh | 38 kWh | 3.4 km / 28 kWh |
| line-3 | 5 | 143 kWh | 204 kWh | 47 kWh | 8.1 km / 67 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (51.2 km @ $3.0 M/km) | $154 M |
| Elevated (0.1 km @ $12.0 M/km) | $1.6 M |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 110 | $900 k | $99 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 330 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 330 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 43,088 kW @ $700/kW | $30 M |
| Grid interconnection / PPA tie-in | 43,088 kW @ $100/kW | $4.3 M |
| Annual generation proxy | 43.1 MW × 6.5 peak-sun-h/day × 365 d/yr | 102.2 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 51.3 km × $0.050 M/km | $2.6 M |
...
| Per-capita (city pop) | $678 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $155 M | 15% | $23 M | $132 M |
| Stations | $81 M | 20% | $16 M | $65 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $99 M | 35% | $35 M | $64 M |
| Dedicated solar plant | $34 M | 45% | $16 M | $19 M |
...
| **Total city CAPEX** | **$407 M** | **23.9%** | **$97 M** | **$309 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh polokwane`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.9%** | **$97 M** | **$19 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.1%** | **$309 M** | **$62 M / yr** |
| of which planned local bond issuance | 60.8% of total CAPEX | $247 M | $49 M / yr |
| **Total city programme** | **100.0%** | **$407 M** | **$81 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $549 M | $452 M (82.3%) | $555 M | **$1.01 bn** |
| **Default** | 2.00× | $732 M | $635 M (86.7%) | $780 M | **$1.41 bn** |
| High | 3.00× | $1.10 bn | $1.00 bn (91.1%) | $1.23 bn | **$2.23 bn** |

At the default 2.00× case, OSR's $97 M external requirement is 86.7% below the illustrative foreign-company requirement of $732 M; the associated lifetime external-interest saving is $780 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$43 M / yr** | $71 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$32 M / yr** | $54 |
| Lifecycle envelope (yr 1–40, low scenario) | **$214 M cumulative** | $356 |
| Lifecycle envelope (yr 1–40, high scenario) | **$214 M cumulative** | $356 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $2,244 |
...
| Traction energy (112.9 GWh / yr) | 23,857 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.0 GWh/yr + dedicated solar plant 43.1 MW / 102.2 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $517 k |
| Labour (330 FTE) | driverless roster: OCC/remote 73, station/platform 77, passenger service 49, fleet maintenance 65, infrastructure/energy 45, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$12 M / yr** |

_Annual service work: 23,857 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 9.4 M train-km / yr (28.2 M car-km / yr). On-site PV covers 24.0 GWh/yr and the dedicated solar plant adds 102.2 GWh/yr against 112.9 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 110 trainsets, 20 stations, 51.3 route-km, 3 lines, and 23,857 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 6.9 M |
| Annual paid trips / city resident | 122 | 196 | 11 |
| Farebox revenue | $94 M / yr | $150 M / yr | $8.8 M / yr |
| Station shop leases | $1.3 M / yr | $1.3 M / yr | $1.3 M / yr |
| Advertising boards | $2.1 M / yr | $2.1 M / yr | $2.1 M / yr |
| **Total revenue** | **$97 M / yr** | **$154 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 800% | 1263% | 100% |
...
| Operating surplus after OPEX (before debt support) | $85 M / yr | $141 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,136 m² of station shop/kiosk leases at $38/m²/month and 608 advertising boards at $336/board/month, with occupancy derates applied._
...
| Avoided road congestion | $14 M / yr | $22 M / yr | 169 M - 271 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $2.4 M / yr | $3.9 M / yr | 30.5–48.7 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $6.8 M / yr | $11 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $39 M / yr | $63 M / yr | 22% of paid trips × $2.40 local spend proxy |
...
| Commerce | 12 major/terminal/interchange nodes | 44,796 trips/trading day; 14.8 M access-events/yr | 71,674 trips/trading day; 23.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $309 M | 76% of $407 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $495 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $99 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 13,423 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$407 M** |
| Imported / external-capital requirement | $97 M (23.9%) |
| Local-content / local-funding requirement | $309 M (76.1%) |
| Default foreign-turnkey external-capital comparison | $732 M; OSR saves $635 M (86.7%) |
| Lifetime external interest and combined financing saving | $780 M interest; $1.41 bn capital + interest |
| 15%–25% planning risk envelope | $468 M–$508 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $350 M / $797 M |
| Low/high project IRR | 15.3% / 22.3% |
| Low/high steady-state DSCR | 2.63 / 4.37 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,045.97 train-km; 17,085.75 kWh consumed; 13,817.58 kWh charged; 30 depot services completed; minimum SoC 60%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 23,450.80 train-km; 195,843.51 kWh consumed; 183,392.05 kWh charged; 465 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 98.3% of scheduled train-km delivered; 341 SoC warnings; 54 energy-adapted off-peak departures, maximum 19 min headway |
...
| 50% charging-contact availability | 20.0% | 98.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 79.3% / 60% | pass |
...
|---|---|
| ![Polokwane energy and battery simulation dashboard](engineering/screenshots/polokwane-simulation-dashboard.png) | ![Polokwane simulator network visualizer](engineering/screenshots/polokwane-network-visualizer.png) |
...
|---|---|
| ![Polokwane QGIS engineering layers](engineering/screenshots/polokwane-qgis-engineering-map.png) | ![Polokwane SUMO timetable validation](engineering/screenshots/polokwane-sumo-validation.png) |
