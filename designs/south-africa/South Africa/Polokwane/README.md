...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **44.9%** | **$183 M** | **$37 M / yr** |
| **Local capital for domestic procurement / payroll** | **55.1%** | **$224 M** | **$45 M / yr** |
| of which planned local bond issuance | 44.1% of total CAPEX | $179 M | $36 M / yr |
...
|---|---|---|
| Construction (years 1–5) | **$36 M / yr** | $60 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$180 M cumulative** | $300 |
| Lifecycle envelope (yr 1–40, high scenario) | **$180 M cumulative** | $300 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.23 bn cumulative** | $2,042 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 45% | $183 M | 4.5% | 40 y, 5 y grace | $10 M / yr |
| Local-currency sovereign / project bonds for local content | 44% | $179 M | 10.5% | 40 y, 5 y grace | $19 M / yr |
| Local government equity / other domestic funding (no debt service) | 11% | $45 M | — | — | — |
| **Total** | **100%** | **$407 M** | | | **$30 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $8.2 M / yr + local bonds $19 M / yr = **$27 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($9.0 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $224 M | 55% of $407 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,723 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $183 M (44.9%) |
| Local-content / local-funding requirement | $224 M (55.1%) |
| 15%–25% planning risk envelope | $468 M–$508 M |
| Annual OPEX | $12 M / yr |
| Low/high project NPV at 8% | $350 M / $797 M |
| Low/high project IRR | 15.3% / 22.3% |
| Low/high steady-state DSCR | 2.85 / 4.73 |
