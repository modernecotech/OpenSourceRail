...
- **Practical daily ridership estimate** (18-30% of catchment): ≈ **557,388 – 928,980 trips/day**
...
| Steady-state, low-ridership (year 6+) | **$681 k / yr** | $0 |
| Steady-state, high-ridership (year 6+) | **$0 k / yr** | $0 |
| Steady-state, cost-neutral revenue case | **$0 / yr** | $0 |
| Lifecycle envelope (yr 1–25, low scenario) | **$917 M cumulative** | $235 |
| Lifecycle envelope (yr 1–25, high scenario) | **$903 M cumulative** | $232 |
| Lifecycle envelope (yr 1–25, cost-neutral after opening) | **$903 M cumulative** | $232 |

_Population basis: 3,900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the cost-neutral case already covers steady-state OPEX + debt service from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
|---|---|---|---|
| Daily paid trips | 585,000 | 975,000 | 586,943 |
| Daily paid trips / population | 15% | 25% | 15% |
| Annual paid trips | 213.5 M | 355.9 M | 214.2 M |
| Farebox revenue | $205 M / yr | $342 M / yr | $206 M / yr |
| Station shop leases | $12 M / yr | $12 M / yr | $12 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$235 M / yr** | **$372 M / yr** | **$236 M / yr** |
| Revenue / OPEX + debt-service recovery | 100% | 158% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov gap | $681 k / yr | $0 k / yr | **$0 / yr** |
| Operating surplus after OPEX + debt | $0 k / yr | $136 M / yr | $0 / yr |
