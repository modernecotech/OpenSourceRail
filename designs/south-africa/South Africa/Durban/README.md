...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$6.94 bn (85.4%) of external capital** and **$8.53 bn of external interest**. Capital plus saved interest totals **$15.46 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (359.1 km @ $2.58 M/km) | $928 M |
| Elevated (41.9 km @ $9.75 M/km) | $408 M |
...
| Per-capita (city pop) | $1,157 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $1.45 bn | 15% | $218 M | $1.24 bn |
...
| **Total city CAPEX** | **$4.51 bn** | **26.3%** | **$1.19 bn** | **$3.33 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **26.3%** | **$1.19 bn** | **$237 M / yr** |
| **Local capital for domestic procurement / payroll** | **73.7%** | **$3.33 bn** | **$665 M / yr** |
| of which planned local bond issuance | 59.0% of total CAPEX | $2.66 bn | $532 M / yr |
| **Total city programme** | **100.0%** | **$4.51 bn** | **$902 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $6.09 bn | $4.91 bn (80.5%) | $6.03 bn | **$10.94 bn** |
| **Default** | 2.00× | $8.12 bn | $6.94 bn (85.4%) | $8.53 bn | **$15.46 bn** |
| High | 3.00× | $12.18 bn | $11.00 bn (90.3%) | $13.52 bn | **$24.51 bn** |

At the default 2.00× case, OSR's $1.19 bn external requirement is 85.4% below the illustrative foreign-company requirement of $8.12 bn; the associated lifetime external-interest saving is $8.53 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$466 M / yr** | $119 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$356 M / yr** | $91 |
| Lifecycle envelope (yr 1–40, low scenario) | **$2.33 bn cumulative** | $597 |
| Lifecycle envelope (yr 1–40, high scenario) | **$2.33 bn cumulative** | $597 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$14.79 bn cumulative** | $3,792 |

_Population basis: 3,900,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $356 M / yr → $356 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 26% | $1.19 bn | 4.5% | 40 y, 5 y grace | $68 M / yr |
| Local-currency sovereign / project bonds for local content | 59% | $2.66 bn | 10.5% | 40 y, 5 y grace | $288 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $665 M | — | — | — |
| **Total** | **100%** | **$4.51 bn** | | | **$356 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $53 M / yr + local bonds $279 M / yr = **$333 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($133 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 415.5 M | 664.8 M | 68.4 M |
| Annual paid trips / city resident | 107 | 170 | 18 |
| Farebox revenue | $532 M / yr | $851 M / yr | $87 M / yr |
| Station shop leases | $12 M / yr | $12 M / yr | $12 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$562 M / yr** | **$881 M / yr** | **$118 M / yr** |
| Revenue / OPEX recovery | 478% | 750% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $356 M / yr | $356 M / yr | **$356 M / yr** |
| Operating surplus applied to debt support | -$356 M / yr | -$356 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$356 M / yr** |
| Operating surplus after OPEX (before debt support) | $444 M / yr | $763 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $3.33 bn | 74% of $4.51 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $5.32 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $1.06 bn / yr | spread across 5 construction / grace years |
| Construction employment supported | 144,356 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$4.51 bn** |
| Imported / external-capital requirement | $1.19 bn (26.3%) |
| Local-content / local-funding requirement | $3.33 bn (73.7%) |
| Default foreign-turnkey external-capital comparison | $8.12 bn; OSR saves $6.94 bn (85.4%) |
| Lifetime external interest and combined financing saving | $8.53 bn interest; $15.46 bn capital + interest |
| 15%–25% planning risk envelope | $5.19 bn–$5.64 bn |
| Annual OPEX | $118 M / yr |
| Low/high project NPV at 8% | $-78267 k / $2.45 bn |
| Low/high project IRR | 7.8% / 12.9% |
| Low/high steady-state DSCR | 1.25 / 2.14 |
