...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 325 | $8.40 M | $2.73 bn |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 1950 | $100 k | $195 M |
| High sensitivity check | 1950 | $200 k | $390 M |
...
| Stations | $876 M |
| Depots | $42 M |
| Rolling stock | $2.73 bn |
| Railway production plant | $195 M |
...
|---|---|---|
| Construction (years 1–5) | **$490 M / yr** | $126 |
| Steady-state, low-ridership (year 6+) | **$450 M / yr** | $115 |
| Steady-state, high-ridership (year 6+) | **$450 M / yr** | $115 |
| Steady-state, operating-neutral revenue case | **$450 M / yr** | $115 |
| Lifecycle envelope (yr 1–25, low scenario) | **$11.46 bn cumulative** | $2,937 |
| Lifecycle envelope (yr 1–25, high scenario) | **$11.46 bn cumulative** | $2,937 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$11.46 bn cumulative** | $2,937 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $3.53 bn | 4.5% | 25 y, 5 y grace | $271 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $1.47 bn | 10.5% | 25 y, 5 y grace | $179 M / yr |
| Government equity (no debt service) | 15% | $883 M | — | — | — |
| **Total** | **100%** | **$5.89 bn** | | | **$450 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $159 M / yr + bonds $155 M / yr = **$313 M / yr** total — plus the equity tranche amortised across construction ($177 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._

### Annual OPEX (steady state)

| Component | Basis | Annual cost |
|---|---|---|
| Rolling-stock maintenance | 4 % of rolling-stock CAPEX | $109 M |
...
|---|---|---|---|
| Daily paid trips | 557,388 | 928,980 | 426,589 |
| Daily paid trips / catchment | 18% | 30% | 14% |
| Daily paid trips / city population | 14% | 24% | 11% |
| Annual paid trips | 203.4 M | 339.1 M | 155.7 M |
| Farebox revenue | $195 M / yr | $326 M / yr | $149 M / yr |
| Station shop leases | $12 M / yr | $12 M / yr | $12 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$225 M / yr** | **$355 M / yr** | **$179 M / yr** |
| Revenue / OPEX recovery | 126% | 198% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $450 M / yr | $450 M / yr | **$450 M / yr** |
| Operating surplus after OPEX | $46 M / yr | $176 M / yr | $0 / yr |
