...
- **Network peak throughput (all lines, both directions):** 9 lines × 2 directions × 5,760 = **103,680 passengers/hour**
...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **557,388 – 673,920 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (367.0 km @ $2.0 M/km) | $734 M |
| Elevated (31.4 km @ $9.0 M/km) | $283 M |
| Elevated-interchange premium (19 sites @ $4.50 M) | $86 M |
| **Civil subtotal** | **$1.10 bn** |
...
|---|---|---|---|
| `metro-6car` (revenue + spare + cold reserve) | 325 | $1.60 M | $520 M |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 401.3 km × $0.015 M/km | $20 M |
...
|---|---|---|
| Construction (years 1–5) | **$181 M / yr** | $46 |
| Steady-state, low-ridership (year 6+) | **$166 M / yr** | $43 |
| Steady-state, high-ridership (year 6+) | **$166 M / yr** | $43 |
| Steady-state, operating-neutral revenue case | **$166 M / yr** | $43 |
| Lifecycle envelope (yr 1–25, low scenario) | **$4.22 bn cumulative** | $1,083 |
| Lifecycle envelope (yr 1–25, high scenario) | **$4.22 bn cumulative** | $1,083 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$4.22 bn cumulative** | $1,083 |

_Population basis: 3,900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.30 bn | 4.5% | 25 y, 5 y grace | $100 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $542 M | 10.5% | 25 y, 5 y grace | $66 M / yr |
| Government equity (no debt service) | 15% | $325 M | — | — | — |
| **Total** | **100%** | **$2.17 bn** | | | **$166 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $59 M / yr + bonds $57 M / yr = **$116 M / yr** total — plus the equity tranche amortised across construction ($65 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (2,420 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $20 M |
...
|---|---|---|---|
| Daily paid trips | 557,388 | 673,920 | 113,331 |
| Daily paid trips / catchment | 18% | 22% | 4% |
| Daily paid trips / city population | 14% | 17% | 3% |
| Annual paid trips | 203.4 M | 246.0 M | 41.4 M |
| Farebox revenue | $195 M / yr | $236 M / yr | $40 M / yr |
| Station shop leases | $12 M / yr | $12 M / yr | $12 M / yr |
| Advertising boards | $18 M / yr | $18 M / yr | $18 M / yr |
| **Total revenue** | **$225 M / yr** | **$266 M / yr** | **$70 M / yr** |
| Revenue / OPEX recovery | 324% | 382% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $166 M / yr | $166 M / yr | **$166 M / yr** |
| Operating surplus after OPEX | $156 M / yr | $196 M / yr | $0 / yr |
