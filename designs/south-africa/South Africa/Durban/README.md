...
| Steady-state, low-ridership (year 6+) | **$158 M / yr** | $41 |
| Steady-state, high-ridership (year 6+) | **$158 M / yr** | $41 |
| Steady-state, operating-neutral revenue case | **$158 M / yr** | $41 |
| Lifecycle envelope (yr 1–40, low scenario) | **$6.71 bn cumulative** | $1,722 |
| Lifecycle envelope (yr 1–40, high scenario) | **$6.71 bn cumulative** | $1,722 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.71 bn cumulative** | $1,722 |

_Population basis: 3,900,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._
...
| Gov repayable-debt service + residual OPEX subsidy | $158 M / yr | $158 M / yr | **$158 M / yr** |
| Operating surplus after OPEX | $142 M / yr | $431 M / yr | $0 / yr |
