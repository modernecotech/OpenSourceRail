...
|---|---|---|---|---|
| line-1 | 23.1 km | 15 | 59 | E Outer ↔ S Outer |
| line-2 | 23.2 km | 13 | 60 | SE Mid ↔ NW Outer |
| line-3 | 21.2 km | 11 | 53 | NW Outer ↔ E Outer |
| **Total** | **67.5 km** | **39 unique** | **172** | |
...
| **Total installed** | **37** | **15,800 kW** | **58,000 kWh** |

Aggregate station-rail charging power: **18,500 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **93.2 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 14.6× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 503 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 77 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 66 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 340 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 93.2 MW / 391 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 15 | 166 kWh | 314 kWh | 132 kWh | 2.0 km / 15 kWh |
| line-2 | 12 | 167 kWh | 302 kWh | 118 kWh | 5.0 km / 36 kWh |
| line-3 | 10 | 152 kWh | 245 kWh | 77 kWh | 5.1 km / 37 kWh |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 93,183 kW @ $700/kW | $65 M |
| Grid interconnection / PPA tie-in | 93,183 kW @ $100/kW | $9.3 M |
| Annual generation proxy | 93.2 MW × 4.2 peak-sun-h/day × 365 d/yr | 142.8 GWh/yr |
...
| Residual train-control wayside + charging microgrids | $7.2 M |
| EPC overhead (7%) | $40 M |
| **CAPEX total** | **$683 M** |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $65 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$260 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, high scenario) | **$260 M cumulative** | $324 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $1,694 |
...
| Traction energy (148.4 GWh / yr) | 31,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 24.2 GWh/yr + dedicated solar plant 93.2 MW / 142.8 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.1 M |
| Labour (439 FTE) | driverless roster: OCC/remote 102, station/platform 112, passenger service 49, fleet maintenance 93, infrastructure/energy 62, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.5 M |
| **OPEX subtotal** | | **$19 M / yr** |

_Annual service work: 31,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.4 M train-km / yr (37.1 M car-km / yr). On-site PV covers 24.2 GWh/yr and the dedicated solar plant adds 142.8 GWh/yr against 148.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 172 trainsets, 39 stations, 67.5 route-km, 3 lines, and 31,380 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 92 | 147 | 13 |
...
| **Total revenue** | **$99 M / yr** | **$155 M / yr** | **$19 M / yr** |
| Revenue / OPEX recovery | 532% | 836% | 100% |
...
_Commercial-revenue assumptions: 4,368 m² of station shop/kiosk leases at $38/m²/month and 892 advertising boards at $336/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $34 M / yr | $54 M / yr | 19% of paid trips × $2.40 local spend proxy |
| Entertainment / community activity supported | $19 M / yr | $30 M / yr | 11% of paid trips × $2.40 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$109 M / yr** | **$175 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $377 M | 55% of $683 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 16,368 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $609 M |
| Timetable-sized dedicated solar CAPEX | $75 M |
| **Reconciled project CAPEX** | **$683 M** |
| 15%–25% planning risk envelope | $786 M–$854 M |
| Annual OPEX | $19 M / yr |
| Low/high project NPV at 8% | $90 M / $537 M |
| Low/high project IRR | 9.3% / 14.8% |
| Low/high steady-state DSCR | 2.56 / 4.36 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,403.33 train-km; 17,302.90 kWh consumed; 18,425.80 kWh charged; 21 depot services completed; minimum SoC 87%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 32,280.45 train-km; 232,404.73 kWh consumed; 237,259.43 kWh charged; 497 depot services completed (5 active at cutoff); minimum SoC 63%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 54.4% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 21.8% | 100.0% / 90% | pass |
| 50% charging-contact availability | 62.6% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 92.6% / 60% | pass |
| ten-hour single charging-pad outage | 62.6% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 39 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
