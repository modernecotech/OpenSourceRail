...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$834 M (86.0%) of external capital** and **$1.02 bn of external interest**. Capital plus saved interest totals **$1.86 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 67.5 km |
...
- Anchor-weighted coverage: 41.7%
- Catchment population: **≈ 333,600** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **98.0 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 10.9× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 491 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 75 kWh | line-1 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 49 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 31,380 train-km/day | One-way train journeys × route length |
| Annual service work | 12.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 407 MWh/day | 37.1 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 358 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 98.0 MW / 412 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 166 kWh | 257 kWh | 75 kWh | 3.6 km / 26 kWh |
| line-2 | 8 | 167 kWh | 261 kWh | 77 kWh | 6.4 km / 46 kWh |
| line-3 | 6 | 152 kWh | 245 kWh | 77 kWh | 6.9 km / 49 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (63.0 km @ $2.58 M/km) | $163 M |
| Elevated (4.5 km @ $9.75 M/km) | $43 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 98,013 kW @ $700/kW | $69 M |
| Grid interconnection / PPA tie-in | 98,013 kW @ $100/kW | $9.8 M |
| Annual generation proxy | 98.0 MW × 4.2 peak-sun-h/day × 365 d/yr | 150.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$78 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 67.5 km × $0.050 M/km | $3.4 M |
...
| Dedicated solar power plant | $78 M |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh east-london-za`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.3%** | **$136 M** | **$27 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.7%** | **$403 M** | **$81 M / yr** |
| of which planned local bond issuance | 59.8% of total CAPEX | $322 M | $64 M / yr |
| **Total city programme** | **100.0%** | **$539 M** | **$108 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $727 M | $591 M (81.3%) | $727 M | **$1.32 bn** |
| **Default** | 2.00× | $970 M | $834 M (86.0%) | $1.02 bn | **$1.86 bn** |
| High | 3.00× | $1.45 bn | $1.32 bn (90.6%) | $1.62 bn | **$2.94 bn** |

At the default 2.00× case, OSR's $136 M external requirement is 86.0% below the illustrative foreign-company requirement of $970 M; the associated lifetime external-interest saving is $1.02 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$56 M / yr** | $70 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$280 M cumulative** | $350 |
| Lifecycle envelope (yr 1–40, high scenario) | **$280 M cumulative** | $350 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.77 bn cumulative** | $2,217 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $136 M | 4.5% | 40 y, 5 y grace | $7.8 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $322 M | 10.5% | 40 y, 5 y grace | $35 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $81 M | — | — | — |
| **Total** | **100%** | **$539 M** | | | **$43 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.1 M / yr + local bonds $34 M / yr = **$40 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($16 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (148.4 GWh / yr) | 31,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 17.8 GWh/yr + dedicated solar plant 98.0 MW / 150.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.2 M |
| Labour (372 FTE) | driverless roster: OCC/remote 86, station/platform 77, passenger service 49, fleet maintenance 83, infrastructure/energy 56, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.0 M |
| **OPEX subtotal** | | **$15 M / yr** |

_Annual service work: 31,380 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 12.4 M train-km / yr (37.1 M car-km / yr). On-site PV covers 17.8 GWh/yr and the dedicated solar plant adds 150.3 GWh/yr against 148.4 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 139 trainsets, 23 stations, 67.5 route-km, 3 lines, and 31,380 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| **Total revenue** | **$97 M / yr** | **$154 M / yr** | **$15 M / yr** |
| Revenue / OPEX recovery | 634% | 1001% | 100% |
...
| Operating surplus after OPEX (before debt support) | $82 M / yr | $138 M / yr | $0 / yr |

_Commercial-revenue assumptions: 3,088 m² of station shop/kiosk leases at $38/m²/month and 620 advertising boards at $336/board/month, with occupancy derates applied._
...
| Avoided road congestion | $18 M / yr | $29 M / yr | 223 M - 356 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.2 M / yr | $5.1 M / yr | 40.1–64.1 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.9 M / yr | $14 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $36 M / yr | $58 M / yr | 21% of paid trips × $2.40 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $403 M | 75% of $539 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $644 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $129 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 17,472 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $460 M |
| Timetable-sized dedicated solar CAPEX | $78 M |
| **Reconciled project CAPEX** | **$539 M** |
| Imported / external-capital requirement | $136 M (25.3%) |
| Local-content / local-funding requirement | $403 M (74.7%) |
| Default foreign-turnkey external-capital comparison | $970 M; OSR saves $834 M (86.0%) |
| Lifetime external interest and combined financing saving | $1.02 bn interest; $1.86 bn capital + interest |
| 15%–25% planning risk envelope | $620 M–$673 M |
| Annual OPEX | $15 M / yr |
| Low/high project NPV at 8% | $219 M / $666 M |
| Low/high project IRR | 11.8% / 17.9% |
| Low/high steady-state DSCR | 1.92 / 3.24 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,421.74 train-km; 17,435.24 kWh consumed; 15,641.57 kWh charged; 25 depot services completed; minimum SoC 72%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 29,773.66 train-km; 214,354.77 kWh consumed; 213,557.10 kWh charged; 486 depot services completed (6 active at cutoff); minimum SoC 20%; 0 onboard emergencies; 0 invariant violations; 94.9% of scheduled train-km delivered; 89 SoC warnings; 6 energy-adapted off-peak departures, maximum 16 min headway |
...
| maximum planning climate/HVAC duty | 20.0% | 93.1% / 90% | pass |
| 50% charging-contact availability | 20.0% | 94.9% / 90% | pass |
...
|---|---|
| ![East-London-Za energy and battery simulation dashboard](engineering/screenshots/east-london-za-simulation-dashboard.png) | ![East-London-Za simulator network visualizer](engineering/screenshots/east-london-za-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 23 line platforms, 1 interchange complexes, 10 civil segments, and 0 input findings |
...
|---|---|
| ![East-London-Za QGIS engineering layers](engineering/screenshots/east-london-za-qgis-engineering-map.png) | ![East-London-Za SUMO timetable validation](engineering/screenshots/east-london-za-sumo-validation.png) |
...
scripts/regenerate-city.sh east-london-za
```
