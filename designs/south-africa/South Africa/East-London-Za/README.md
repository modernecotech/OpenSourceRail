...
| Lifecycle envelope (yr 1–25, low scenario) | **$944 M cumulative** | $1,180 |
| Lifecycle envelope (yr 1–25, high scenario) | **$944 M cumulative** | $1,180 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$944 M cumulative** | $1,180 |
...
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $291 M | 4.5% | 25 y, 5 y grace | $22 M / yr |
...
_During the 5-year grace period the operator pays interest only — multilateral $13 M / yr + bonds $13 M / yr = **$26 M / yr** total — plus the equity tranche amortised across construction ($15 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
