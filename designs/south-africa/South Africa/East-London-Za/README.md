...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$898 M (86.3%) of external capital** and **$1.10 bn of external interest**. Capital plus saved interest totals **$2.00 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (63.0 km @ $3.0 M/km) | $189 M |
...
| **Total city CAPEX** | **$578 M** | **24.6%** | **$142 M** | **$436 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.6%** | **$142 M** | **$28 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.4%** | **$436 M** | **$87 M / yr** |
| of which planned local bond issuance | 60.3% of total CAPEX | $348 M | $70 M / yr |
| **Total city programme** | **100.0%** | **$578 M** | **$116 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $780 M | $638 M (81.8%) | $784 M | **$1.42 bn** |
| **Default** | 2.00× | $1.04 bn | $898 M (86.3%) | $1.10 bn | **$2.00 bn** |
| High | 3.00× | $1.56 bn | $1.42 bn (90.9%) | $1.74 bn | **$3.16 bn** |

At the default 2.00× case, OSR's $142 M external requirement is 86.3% below the illustrative foreign-company requirement of $1.04 bn; the associated lifetime external-interest saving is $1.10 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$60 M / yr** | $75 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$46 M / yr** | $57 |
| Lifecycle envelope (yr 1–40, low scenario) | **$302 M cumulative** | $377 |
| Lifecycle envelope (yr 1–40, high scenario) | **$302 M cumulative** | $377 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.91 bn cumulative** | $2,384 |
...
| Local-currency sovereign / project bonds for local content | 60% | $348 M | 10.5% | 40 y, 5 y grace | $38 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $87 M | — | — | — |
| **Total** | **100%** | **$578 M** | | | **$46 M / yr** |
...
| Annual paid trips | 73.3 M | 117.3 M | 9.9 M |
...
| **Total revenue** | **$97 M / yr** | **$154 M / yr** | **$16 M / yr** |
| Revenue / OPEX recovery | 605% | 956% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $436 M | 75% of $578 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 18,903 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Imported / external-capital requirement | $142 M (24.6%) |
| Local-content / local-funding requirement | $436 M (75.4%) |
| Default foreign-turnkey external-capital comparison | $1.04 bn; OSR saves $898 M (86.3%) |
| Lifetime external interest and combined financing saving | $1.10 bn interest; $2.00 bn capital + interest |
| 15%–25% planning risk envelope | $664 M–$722 M |
| Annual OPEX | $16 M / yr |
| Low/high project NPV at 8% | $183 M / $629 M |
| Low/high project IRR | 11.0% / 16.9% |
| Low/high steady-state DSCR | 1.77 / 3.00 |
