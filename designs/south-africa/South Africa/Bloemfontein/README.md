...
| Revenue fleet | 159 × 3-car trainsets |
| Revenue fleet passenger capacity | 57,240 AW2 pax (76,320 AW3 crush) |
...
|---|---|---|---|---|
| line-1 | 27.3 km | 16 | 67 | SE Outer ↔ N Mid |
| line-2 | 25.9 km | 15 | 63 | NW Outer ↔ S Mid |
| line-3 | 18.9 km | 11 | 47 | NE Mid ↔ SW Mid |
| **Total** | **72.1 km** | **42 unique** | **177** | |
...
| Revenue fleet capacity | 57,240 AW2 pax (76,320 AW3 crush) |
| Total fleet capacity | 63,720 AW2 pax (84,960 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 159 × 360 = **57,240 AW2 passengers** (76,320 AW3 crush)
...
| Interchange | 7 | 300 kW | 500 kWh |
| Major | 5 | 300 kW | 500 kWh |
| Standard | 24 | 300 kW | 500 kWh |
| Terminal | 5 | 300 kW | 500 kWh |
| **Total installed** | **42** | **17,300 kW** | **60,500 kWh** |

Aggregate station-rail charging power: **21,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 540 kWh usable (675 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **99.1 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 26.2× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 519 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 83 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 73 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
...
| On-site PV shortfall before solar plant | 362 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 99.1 MW / 416 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 16 | 197 kWh | 343 kWh | 126 kWh | 2.4 km / 17 kWh |
| line-2 | 15 | 186 kWh | 314 kWh | 109 kWh | 2.9 km / 21 kWh |
| line-3 | 11 | 136 kWh | 233 kWh | 83 kWh | 2.0 km / 15 kWh |
...
| `interchange-elevated` | 7 | $12.0 M | $84 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 531 | $60 k | $32 M |
| High sensitivity check | 531 | $120 k | $64 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 99,075 kW @ $700/kW | $69 M |
| Grid interconnection / PPA tie-in | 99,075 kW @ $100/kW | $9.9 M |
| Annual generation proxy | 99.1 MW × 4.2 peak-sun-h/day × 365 d/yr | 151.9 GWh/yr |
| **Dedicated solar plant subtotal** | | **$79 M** |
...
| Station/depot charging microgrids (conductive charger, switchgear, inverter interface, local PV/battery tie-in; no continuous wayside supply) | per-stop allowance by station archetype | $4.5 M |
...
| Dedicated solar power plant | $79 M |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bloemfontein`.
...
|---|---|---|
| Construction (years 1–5) | **$59 M / yr** | $98 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$35 M / yr** | $59 |
| Lifecycle envelope (yr 1–40, low scenario) | **$294 M cumulative** | $490 |
| Lifecycle envelope (yr 1–40, high scenario) | **$294 M cumulative** | $490 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.53 bn cumulative** | $2,556 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $618 M | 4.5% | 40 y, 5 y grace | $35 M / yr |
| Government equity (no debt service) | 20% | $155 M | — | — | — |
| **Total** | **100%** | **$773 M** | | | **$35 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — candidate climate/MDB debt $28 M / yr = **$28 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($31 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (158.6 GWh / yr) | 33,526 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 26.5 GWh/yr + dedicated solar plant 99.1 MW / 151.9 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.2 M |
| Labour (488 FTE) | driverless roster: OCC/remote 102, station/platform 152, passenger service 49, fleet maintenance 98, infrastructure/energy 66, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.9 M |
| **OPEX subtotal** | | **$21 M / yr** |

_Annual service work: 33,526 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.2 M train-km / yr (39.6 M car-km / yr). On-site PV covers 26.5 GWh/yr and the dedicated solar plant adds 151.9 GWh/yr against 158.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 177 trainsets, 42 stations, 72.1 route-km, 3 lines, and 33,526 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Farebox revenue | $94 M / yr | $150 M / yr | $14 M / yr |
| Station shop leases | $2.6 M / yr | $2.6 M / yr | $2.6 M / yr |
| Advertising boards | $4.2 M / yr | $4.2 M / yr | $4.2 M / yr |
| **Total revenue** | **$101 M / yr** | **$157 M / yr** | **$21 M / yr** |
| Revenue / OPEX recovery | 488% | 760% | 100% |
...
| Operating surplus after OPEX (before debt support) | $80 M / yr | $136 M / yr | $0 / yr |

_Commercial-revenue assumptions: 6,496 m² of station shop/kiosk leases at $38/m²/month and 1,240 advertising boards at $336/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $36 M / yr | $58 M / yr | 20% of paid trips × $2.40 local spend proxy |
| Entertainment / community activity supported | $19 M / yr | $30 M / yr | 11% of paid trips × $2.40 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$114 M / yr** | **$182 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |
...
| Healthcare | 4 healthcare anchors | 16,874 trips/day; 6.2 M access-events/yr | 26,998 trips/day; 9.9 M access-events/yr |
| Commerce | 18 major/terminal/interchange nodes | 41,180 trips/trading day; 13.6 M access-events/yr | 65,889 trips/trading day; 21.7 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $429 M | 55% of $773 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $686 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $137 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 18,617 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $694 M |
| Timetable-sized dedicated solar CAPEX | $79 M |
| **Reconciled project CAPEX** | **$773 M** |
| 15%–25% planning risk envelope | $889 M–$966 M |
| Annual OPEX | $21 M / yr |
| Low/high project NPV at 8% | $18 M / $464 M |
| Low/high project IRR | 8.2% / 13.3% |
| Low/high steady-state DSCR | 2.26 / 3.85 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,519.73 train-km; 18,140.92 kWh consumed; 19,719.72 kWh charged; 20 depot services completed; minimum SoC 91%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 34,446.87 train-km; 248,002.08 kWh consumed; 253,447.98 kWh charged; 502 depot services completed (3 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 69.8% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 42.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 74.9% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.5% / 60% | pass |
| ten-hour single charging-pad outage | 66.7% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 42 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
