...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 453 | $60 k | $27 M |
| High sensitivity check | 453 | $120 k | $54 M |
...
|---|---|---|
| Construction (years 1–5) | **$52 M / yr** | $86 |
...
| Lifecycle envelope (yr 1–40, low scenario) | **$259 M cumulative** | $432 |
| Lifecycle envelope (yr 1–40, high scenario) | **$259 M cumulative** | $432 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.35 bn cumulative** | $2,255 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $546 M | 4.5% | 40 y, 5 y grace | $31 M / yr |
| Government equity (no debt service) | 20% | $136 M | — | — | — |
| **Total** | **100%** | **$682 M** | | | **$31 M / yr** |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $376 M | 55% of $682 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 16,335 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $598 M |
| Timetable-sized dedicated solar CAPEX | $84 M |
| **Reconciled project CAPEX** | **$682 M** |
| 15%–25% planning risk envelope | $784 M–$853 M |
| Annual OPEX | $18 M / yr |
| Low/high project NPV at 8% | $96 M / $543 M |
| Low/high project IRR | 9.4% / 14.8% |
| Low/high steady-state DSCR | 2.58 / 4.39 |
