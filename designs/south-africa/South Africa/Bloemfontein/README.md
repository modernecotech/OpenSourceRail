...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$955 M (86.1%) of external capital** and **$1.17 bn of external interest**. Capital plus saved interest totals **$2.13 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`bloemfontein.corridor.geojson`](bloemfontein.corridor.geojson).
...
| Anchor-weighted coverage | 34.7% |
| Route length (double track) | 72.1 km |
| Revenue fleet | 136 × 3-car trainsets |
| Revenue fleet passenger capacity | 48,960 AW2 pax (65,280 AW3 crush) |
...
| Revenue fleet capacity | 48,960 AW2 pax (65,280 AW3 crush) |
| Total fleet capacity | 54,360 AW2 pax (72,480 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 360 AW2 passengers (`light-metro-3car`)
- **Revenue fleet simultaneous capacity:** 136 × 360 = **48,960 AW2 passengers** (65,280 AW3 crush)
- **Total fleet passenger capacity:** 151 × 360 = **54,360 AW2 passengers** (72,480 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 34.7%
- Catchment population: **≈ 208,199** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **104.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 11.0× worst inter-charge run | OK: 675 kWh nameplate, 135 kWh protected reserve, and 491 kWh usable margin across the worst powered-stop gap (line-3) |
| Lowest traversal charging margin | 79 kWh | line-3 after climate load, 98% conversion, and the required 10% operating margin |
| PV daily yield proxy | 52 MWh/day | 4.2 peak-sun-hour planning proxy before local derates |
| Scheduled one-way train journeys | 1,395 / day | Train departures across both directions and all lines |
| Scheduled train journey-km | 33,526 train-km/day | One-way train journeys × route length |
| Annual service work | 13.2 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 434 MWh/day | 39.6 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 382 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 104.6 MW / 439 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 197 kWh | 327 kWh | 110 kWh | 6.1 km / 44 kWh |
| line-2 | 9 | 186 kWh | 294 kWh | 89 kWh | 6.7 km / 48 kWh |
| line-3 | 7 | 136 kWh | 229 kWh | 79 kWh | 6.8 km / 49 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (69.7 km @ $2.58 M/km) | $180 M |
| Elevated (2.4 km @ $9.75 M/km) | $23 M |
| Elevated-interchange premium (2 sites @ $4.50 M) | $9.0 M |
| **Civil subtotal** | **$212 M** |
...
|---|---|---|---|
| `light-metro-3car` (revenue + service rotation + spare + cold reserve) | 151 | $900 k | $136 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 453 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 453 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 104,595 kW @ $700/kW | $73 M |
| Grid interconnection / PPA tie-in | 104,595 kW @ $100/kW | $10 M |
| Annual generation proxy | 104.6 MW × 4.2 peak-sun-h/day × 365 d/yr | 160.3 GWh/yr |
| **Dedicated solar plant subtotal** | | **$84 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 72.1 km × $0.050 M/km | $3.6 M |
...
|---|---:|---:|---:|---:|
| Civil works | $212 M | 15% | $32 M | $180 M |
| Stations | $135 M | 20% | $27 M | $108 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $136 M | 35% | $48 M | $88 M |
| Dedicated solar plant | $84 M | 45% | $38 M | $46 M |
| Residual signalling / train control | $3.6 M | 50% | $1.8 M | $1.8 M |
| Charging microgrids | $2.9 M | 40% | $1.1 M | $1.7 M |
| EPC / project services | $35 M | 15% | $5.2 M | $30 M |
| **Total city CAPEX** | **$616 M** | **25.0%** | **$154 M** | **$462 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh bloemfontein`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.0%** | **$154 M** | **$31 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.0%** | **$462 M** | **$92 M / yr** |
| of which planned local bond issuance | 60.0% of total CAPEX | $370 M | $74 M / yr |
| **Total city programme** | **100.0%** | **$616 M** | **$123 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $832 M | $678 M (81.5%) | $833 M | **$1.51 bn** |
| **Default** | 2.00× | $1.11 bn | $955 M (86.1%) | $1.17 bn | **$2.13 bn** |
| High | 3.00× | $1.66 bn | $1.51 bn (90.7%) | $1.86 bn | **$3.37 bn** |

At the default 2.00× case, OSR's $154 M external requirement is 86.1% below the illustrative foreign-company requirement of $1.11 bn; the associated lifetime external-interest saving is $1.17 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$64 M / yr** | $107 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$49 M / yr** | $81 |
| Lifecycle envelope (yr 1–40, low scenario) | **$321 M cumulative** | $535 |
| Lifecycle envelope (yr 1–40, high scenario) | **$321 M cumulative** | $535 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$2.03 bn cumulative** | $3,385 |

_Population basis: 600,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $49 M / yr → $49 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $154 M | 4.5% | 40 y, 5 y grace | $8.8 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $370 M | 10.5% | 40 y, 5 y grace | $40 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $92 M | — | — | — |
| **Total** | **100%** | **$616 M** | | | **$49 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $6.9 M / yr + local bonds $39 M / yr = **$46 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($18 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (158.6 GWh / yr) | 33,526 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 3 cars × 4.0 kWh/car-km; on-site PV 19.2 GWh/yr + dedicated solar plant 104.6 MW / 160.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $1.3 M |
| Labour (418 FTE) | driverless roster: OCC/remote 90, station/platform 108, passenger service 49, fleet maintenance 90, infrastructure/energy 60, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $3.4 M |
| **OPEX subtotal** | | **$17 M / yr** |

_Annual service work: 33,526 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 13.2 M train-km / yr (39.6 M car-km / yr). On-site PV covers 19.2 GWh/yr and the dedicated solar plant adds 160.3 GWh/yr against 158.6 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 151 trainsets, 26 stations, 72.1 route-km, 3 lines, and 33,526 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 73.3 M | 117.3 M | 9.7 M |
| Annual paid trips / city resident | 122 | 196 | 16 |
| Farebox revenue | $94 M / yr | $150 M / yr | $12 M / yr |
| Station shop leases | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| Advertising boards | $3.0 M / yr | $3.0 M / yr | $3.0 M / yr |
| **Total revenue** | **$99 M / yr** | **$155 M / yr** | **$17 M / yr** |
| Revenue / OPEX recovery | 570% | 894% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $49 M / yr | $49 M / yr | **$49 M / yr** |
| Operating surplus applied to debt support | -$49 M / yr | -$49 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $0 k / yr | $0 k / yr | **$49 M / yr** |
| Operating surplus after OPEX (before debt support) | $81 M / yr | $138 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,720 m² of station shop/kiosk leases at $38/m²/month and 888 advertising boards at $336/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $27 M / yr | $43 M / yr | 16 min/trip × $1.38/h value-of-time proxy |
| Avoided road congestion | $19 M / yr | $30 M / yr | 238 M - 381 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $3.4 M / yr | $5.5 M / yr | 42.8–68.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $9.5 M / yr | $15 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $40 M / yr | $63 M / yr | 22% of paid trips × $2.40 local spend proxy |
| Entertainment / community activity supported | $19 M / yr | $30 M / yr | 11% of paid trips × $2.40 local spend proxy |
| **Annual quantified benefit / activity proxy** | **$117 M / yr** | **$188 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 0 education anchors | 8,035 trips/school day; 1.8 M access-events/yr | 12,856 trips/school day; 2.8 M access-events/yr |
| Healthcare | 2 healthcare anchors | 15,121 trips/day; 5.5 M access-events/yr | 24,193 trips/day; 8.8 M access-events/yr |
| Commerce | 16 major/terminal/interchange nodes | 45,121 trips/trading day; 14.9 M access-events/yr | 72,193 trips/trading day; 23.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $462 M | 75% of $616 M CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $739 M | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $148 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 20,052 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $533 M |
| Timetable-sized dedicated solar CAPEX | $84 M |
| **Reconciled project CAPEX** | **$616 M** |
| Imported / external-capital requirement | $154 M (25.0%) |
| Local-content / local-funding requirement | $462 M (75.0%) |
| Default foreign-turnkey external-capital comparison | $1.11 bn; OSR saves $955 M (86.1%) |
| Lifetime external interest and combined financing saving | $1.17 bn interest; $2.13 bn capital + interest |
| 15%–25% planning risk envelope | $709 M–$770 M |
| Annual OPEX | $17 M / yr |
| Low/high project NPV at 8% | $154 M / $601 M |
| Low/high project IRR | 10.4% / 16.1% |
| Low/high steady-state DSCR | 1.67 / 2.82 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 2,485.13 train-km; 17,891.64 kWh consumed; 17,489.64 kWh charged; 22 depot services completed; minimum SoC 74%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 30,733.38 train-km; 221,264.46 kWh consumed; 223,936.33 kWh charged; 484 depot services completed (5 active at cutoff); minimum SoC 64%; 0 onboard emergencies; 0 invariant violations; 91.7% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 56.2% | 91.7% / 90% | pass |
| maximum planning climate/HVAC duty | 20.0% | 91.4% / 90% | pass |
| 50% charging-contact availability | 64.0% | 91.7% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 81.4% / 60% | pass |
| ten-hour single charging-pad outage | 47.2% | 91.7% / 90% | pass |
...
|---|---|
| ![Bloemfontein energy and battery simulation dashboard](engineering/screenshots/bloemfontein-simulation-dashboard.png) | ![Bloemfontein simulator network visualizer](engineering/screenshots/bloemfontein-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 26 line platforms, 2 interchange complexes, 7 civil segments, and 0 input findings |
...
|---|---|
| ![Bloemfontein QGIS engineering layers](engineering/screenshots/bloemfontein-qgis-engineering-map.png) | ![Bloemfontein SUMO timetable validation](engineering/screenshots/bloemfontein-sumo-validation.png) |
...
| [`bloemfontein.toml`](bloemfontein.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`bloemfontein-network-map.png`](bloemfontein-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`bloemfontein.corridor.geojson`](bloemfontein.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`bloemfontein.stations.json`](bloemfontein.stations.json) | Machine-readable station list |
| [`bloemfontein.design-quality.yaml`](bloemfontein.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug bloemfontein
