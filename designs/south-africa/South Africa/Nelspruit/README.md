...
**Country:** ZA · **Population:** 300,000

> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$461 M (87.6%) of external capital** and **$567 M of external interest**. Capital plus saved interest totals **$1.03 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
Corridor polylines + stations as GeoJSON for GIS / alignment tooling: [`nelspruit.corridor.geojson`](nelspruit.corridor.geojson).
...
| Route length (double track) | 38.7 km |
...
| Total fleet capacity | 19,200 AW2 pax (25,600 AW3 crush, incl. service rotation + spare + reserve) |
...
- **Total fleet passenger capacity:** 80 × 240 = **19,200 AW2 passengers** (25,600 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 71.6%
- Catchment population: **≈ 214,800** (within ~800 m walk of a station)
...
Dedicated utility-scale solar plant / contracted offsite PPA asset: **26.3 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 12.4× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 331 kWh usable margin across the worst powered-stop gap (line-3) |
...
| Scheduled train journey-km | 17,995 train-km/day | One-way train journeys × route length |
| Annual service work | 7.1 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 155 MWh/day | 14.2 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 110 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 26.3 MW / 126 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 6 | 64 kWh | 114 kWh | 44 kWh | 3.1 km / 15 kWh |
| line-2 | 6 | 72 kWh | 139 kWh | 60 kWh | 4.5 km / 22 kWh |
| line-3 | 4 | 57 kWh | 98 kWh | 35 kWh | 5.8 km / 29 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (37.4 km @ $2.58 M/km) | $97 M |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 80 | $560 k | $45 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 160 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 160 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 26,325 kW @ $700/kW | $18 M |
| Grid interconnection / PPA tie-in | 26,325 kW @ $100/kW | $2.6 M |
| Annual generation proxy | 26.3 MW × 4.8 peak-sun-h/day × 365 d/yr | 46.1 GWh/yr |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 38.7 km × $0.050 M/km | $1.9 M |
...
| Per-capita (city pop) | $975 / person |
...
| Dedicated solar plant | $21 M | 45% | $9.5 M | $12 M |
| Residual signalling / train control | $1.9 M | 50% | $967 k | $967 k |
| Charging microgrids | $1.8 M | 40% | $730 k | $1.1 M |
| EPC / project services | $18 M | 15% | $2.7 M | $15 M |
| **Total city CAPEX** | **$293 M** | **22.3%** | **$65 M** | **$227 M** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh nelspruit`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **22.3%** | **$65 M** | **$13 M / yr** |
| **Local capital for domestic procurement / payroll** | **77.7%** | **$227 M** | **$45 M / yr** |
| of which planned local bond issuance | 62.2% of total CAPEX | $182 M | $36 M / yr |
| **Total city programme** | **100.0%** | **$293 M** | **$59 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $395 M | $330 M (83.5%) | $405 M | **$735 M** |
| **Default** | 2.00× | $527 M | $461 M (87.6%) | $567 M | **$1.03 bn** |
| High | 3.00× | $790 M | $725 M (91.7%) | $891 M | **$1.62 bn** |

At the default 2.00× case, OSR's $65 M external requirement is 87.6% below the illustrative foreign-company requirement of $527 M; the associated lifetime external-interest saving is $567 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$31 M / yr** | $104 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$23 M / yr** | $78 |
| Lifecycle envelope (yr 1–40, low scenario) | **$156 M cumulative** | $519 |
| Lifecycle envelope (yr 1–40, high scenario) | **$156 M cumulative** | $519 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$976 M cumulative** | $3,252 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $65 M | 4.5% | 40 y, 5 y grace | $3.7 M / yr |
| Local-currency sovereign / project bonds for local content | 62% | $182 M | 10.5% | 40 y, 5 y grace | $20 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $45 M | — | — | — |
| **Total** | **100%** | **$293 M** | | | **$23 M / yr** |
...
| Traction energy (56.7 GWh / yr) | 17,995 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 16.6 GWh/yr + dedicated solar plant 26.3 MW / 46.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $316 k |
| Labour (266 FTE) | driverless roster: OCC/remote 57, station/platform 67, passenger service 38, fleet maintenance 48, infrastructure/energy 35, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.1 M |
| **OPEX subtotal** | | **$8.5 M / yr** |

_Annual service work: 17,995 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.2 M car-km / yr). On-site PV covers 16.6 GWh/yr and the dedicated solar plant adds 46.1 GWh/yr against 56.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 80 trainsets, 16 stations, 38.7 route-km, 3 lines, and 17,995 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 48.9 M | 78.2 M | 4.2 M |
| Annual paid trips / city resident | 163 | 261 | 14 |
| Farebox revenue | $63 M / yr | $100 M / yr | $5.4 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$66 M / yr** | **$103 M / yr** | **$8.5 M / yr** |
| Revenue / OPEX recovery | 776% | 1220% | 100% |
...
| Operating surplus after OPEX (before debt support) | $57 M / yr | $95 M / yr | $0 / yr |

_Commercial-revenue assumptions: 2,864 m² of station shop/kiosk leases at $38/m²/month and 552 advertising boards at $336/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $18 M / yr | $29 M / yr | 16 min/trip × $1.38/h value-of-time proxy |
| Avoided road congestion | $6.8 M / yr | $11 M / yr | 85 M - 136 M vehicle-km/yr avoided × $0.08/vehicle-km |
| Avoided CO2e | $1.2 M / yr | $2.0 M / yr | 15.3–24.5 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $3.4 M / yr | $5.4 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $26 M / yr | $42 M / yr | 23% of paid trips × $2.40 local spend proxy |
| Entertainment / community activity supported | $12 M / yr | $20 M / yr | 11% of paid trips × $2.40 local spend proxy |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $227 M | 78% of $293 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,865 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$293 M** |
| Imported / external-capital requirement | $65 M (22.3%) |
| Local-content / local-funding requirement | $227 M (77.7%) |
| Default foreign-turnkey external-capital comparison | $527 M; OSR saves $461 M (87.6%) |
| Lifetime external interest and combined financing saving | $567 M interest; $1.03 bn capital + interest |
| 15%–25% planning risk envelope | $336 M–$366 M |
| Annual OPEX | $8.5 M / yr |
| Low/high project NPV at 8% | $220 M / $518 M |
| Low/high project IRR | 14.5% / 21.2% |
| Low/high steady-state DSCR | 2.44 / 4.04 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,624.58 train-km; 8,110.59 kWh consumed; 8,431.69 kWh charged; 37 depot services completed; minimum SoC 86%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 17,501.61 train-km; 87,375.75 kWh consumed; 88,988.57 kWh charged; 498 depot services completed (6 active at cutoff); minimum SoC 73%; 0 onboard emergencies; 0 invariant violations; 97.3% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 66.9% | 97.3% / 90% | pass |
| maximum planning climate/HVAC duty | 58.2% | 97.3% / 90% | pass |
| 50% charging-contact availability | 72.6% | 97.3% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 93.9% / 60% | pass |
| ten-hour single charging-pad outage | 35.6% | 97.3% / 90% | pass |
...
|---|---|
| ![Nelspruit energy and battery simulation dashboard](engineering/screenshots/nelspruit-simulation-dashboard.png) | ![Nelspruit simulator network visualizer](engineering/screenshots/nelspruit-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 16 line platforms, 1 interchange complexes, 8 civil segments, and 0 input findings |
...
|---|---|
| ![Nelspruit QGIS engineering layers](engineering/screenshots/nelspruit-qgis-engineering-map.png) | ![Nelspruit SUMO timetable validation](engineering/screenshots/nelspruit-sumo-validation.png) |
...
| [`nelspruit.toml`](nelspruit.toml) | Expanded simulation scenario (input to `osr-sim`) |
| [`nelspruit-network-map.png`](nelspruit-network-map.png) | Auto-fit network map (rendered by `osr_scenario.render_map`) |
| [`nelspruit.corridor.geojson`](nelspruit.corridor.geojson) | Line polylines + stations (GeoJSON) |
| [`nelspruit.stations.json`](nelspruit.stations.json) | Machine-readable station list |
| [`nelspruit.design-quality.yaml`](nelspruit.design-quality.yaml) | Coverage / anchor-hit / civil-mix metrics + auto-gate result |
...
python -m osr_geo.cli --slug nelspruit

# 2. full generated design, scenario, engineering, and operations bundle
scripts/regenerate-city.sh nelspruit
```
