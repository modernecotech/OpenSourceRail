...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$494 M (87.9%) of external capital** and **$607 M of external interest**. Capital plus saved interest totals **$1.10 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| **Total city CAPEX** | **$312 M** | **21.8%** | **$68 M** | **$244 M** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **21.8%** | **$68 M** | **$14 M / yr** |
| **Local capital for domestic procurement / payroll** | **78.2%** | **$244 M** | **$49 M / yr** |
| of which planned local bond issuance | 62.5% of total CAPEX | $195 M | $39 M / yr |
| **Total city programme** | **100.0%** | **$312 M** | **$62 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $422 M | $354 M (83.8%) | $435 M | **$788 M** |
| **Default** | 2.00× | $562 M | $494 M (87.9%) | $607 M | **$1.10 bn** |
| High | 3.00× | $843 M | $775 M (91.9%) | $953 M | **$1.73 bn** |

At the default 2.00× case, OSR's $68 M external requirement is 87.9% below the illustrative foreign-company requirement of $562 M; the associated lifetime external-interest saving is $607 M, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$33 M / yr** | $111 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$25 M / yr** | $84 |
| Lifecycle envelope (yr 1–40, low scenario) | **$167 M cumulative** | $556 |
| Lifecycle envelope (yr 1–40, high scenario) | **$167 M cumulative** | $556 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.04 bn cumulative** | $3,480 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 22% | $68 M | 4.5% | 40 y, 5 y grace | $3.9 M / yr |
| Local-currency sovereign / project bonds for local content | 63% | $195 M | 10.5% | 40 y, 5 y grace | $21 M / yr |
| Local government equity / other domestic funding (no debt service) | 16% | $49 M | — | — | — |
| **Total** | **100%** | **$312 M** | | | **$25 M / yr** |
...
| Annual paid trips | 48.9 M | 78.2 M | 4.5 M |
| Annual paid trips / city resident | 163 | 261 | 15 |
| Farebox revenue | $63 M / yr | $100 M / yr | $5.8 M / yr |
| Station shop leases | $1.2 M / yr | $1.2 M / yr | $1.2 M / yr |
| Advertising boards | $1.9 M / yr | $1.9 M / yr | $1.9 M / yr |
| **Total revenue** | **$66 M / yr** | **$103 M / yr** | **$8.8 M / yr** |
| Revenue / OPEX recovery | 744% | 1169% | 100% |
...
| Operating surplus after OPEX (before debt support) | $57 M / yr | $94 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $244 M | 78% of $312 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 10,598 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$312 M** |
| Imported / external-capital requirement | $68 M (21.8%) |
| Local-content / local-funding requirement | $244 M (78.2%) |
| Default foreign-turnkey external-capital comparison | $562 M; OSR saves $494 M (87.9%) |
| Lifetime external interest and combined financing saving | $607 M interest; $1.10 bn capital + interest |
| 15%–25% planning risk envelope | $359 M–$391 M |
| Annual OPEX | $8.8 M / yr |
| Low/high project NPV at 8% | $201 M / $499 M |
| Low/high project IRR | 13.7% / 20.2% |
| Low/high steady-state DSCR | 2.27 / 3.76 |
