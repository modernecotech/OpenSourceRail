...
| Revenue fleet | 103 × 2-car trainsets |
| Revenue fleet passenger capacity | 24,720 AW2 pax (32,960 AW3 crush) |
| Dedicated depot-service rotation fleet | 0 (off-peak service uses peak-fleet surplus) |
| Spare + cold-reserve | 12 × 2-car trainsets |
| Peak headway | 3 min |
...
|---|---|---|---|---|
| line-1 | 12.8 km | 9 | 39 | W Mid ↔ NE Mid |
| line-2 | 14.4 km | 8 | 41 | N Mid ↔ S Outer |
| line-3 | 11.4 km | 8 | 35 | W Outer ↔ SE Mid |
| **Total** | **38.7 km** | **25 unique** | **115** | |
...
| Revenue fleet capacity | 24,720 AW2 pax (32,960 AW3 crush) |
| Total fleet capacity | 27,600 AW2 pax (36,800 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 240 AW2 passengers (`tram-2car`)
- **Revenue fleet simultaneous capacity:** 103 × 240 = **24,720 AW2 passengers** (32,960 AW3 crush)
- **Total fleet passenger capacity:** 115 × 240 = **27,600 AW2 passengers** (36,800 AW3 crush, incl. service rotation + spare + reserve)
...
Aggregate station-rail charging power: **12,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 360 kWh usable (450 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **23.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 13.9× worst inter-charge run | OK: 450 kWh nameplate, 90 kWh protected reserve, and 334 kWh usable margin across the worst powered-stop gap (line-2) |
| Lowest traversal charging margin | 60 kWh | line-2 after climate load, 98% conversion, and the required 10% operating margin |
...
| Dedicated solar plant | 23.6 MW / 113 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 9 | 64 kWh | 163 kWh | 93 kWh | 2.0 km / 10 kWh |
| line-2 | 7 | 72 kWh | 139 kWh | 60 kWh | 5.2 km / 26 kWh |
| line-3 | 8 | 57 kWh | 147 kWh | 84 kWh | 2.0 km / 10 kWh |
...
|---|---|---|---|
| `tram-2car` (revenue + service rotation + spare + cold reserve) | 115 | $560 k | $64 M |
...
| Item | Count | Unit | Subtotal |
|---|---:|---:|---:|
| Vehicle/car modules supported by city fleet | 230 | $60 k | $14 M |
| High sensitivity check | 230 | $120 k | $28 M |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 23,565 kW @ $700/kW | $16 M |
| Grid interconnection / PPA tie-in | 23,565 kW @ $100/kW | $2.4 M |
| Annual generation proxy | 23.6 MW × 4.8 peak-sun-h/day × 365 d/yr | 41.3 GWh/yr |
...
| Per-capita (city pop) | $1,318 / person |
...
Planning-grade financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh nelspruit`.
...
|---|---|---|
| Construction (years 1–5) | **$30 M / yr** | $100 |
| Steady-state, low capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$18 M / yr** | $60 |
| Lifecycle envelope (yr 1–40, low scenario) | **$150 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, high scenario) | **$150 M cumulative** | $501 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$784 M cumulative** | $2,615 |
...
|---|---|---|---|---|---|
| Candidate climate/MDB concessional debt (unconfirmed) | 80% | $316 M | 4.5% | 40 y, 5 y grace | $18 M / yr |
| Government equity (no debt service) | 20% | $79 M | — | — | — |
| **Total** | **100%** | **$395 M** | | | **$18 M / yr** |
...
| Traction energy (56.7 GWh / yr) | 17,995 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 2 cars × 4.0 kWh/car-km; on-site PV 20.8 GWh/yr + dedicated solar plant 23.6 MW / 41.3 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $283 k |
| Labour (332 FTE) | driverless roster: OCC/remote 73, station/platform 103, passenger service 38, fleet maintenance 59, infrastructure/energy 38, admin/training 21; no train drivers × country median × 12 × engineer-premium 1.4 | $2.7 M |
| **OPEX subtotal** | | **$11 M / yr** |

_Annual service work: 17,995 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 7.1 M train-km / yr (14.2 M car-km / yr). On-site PV covers 20.8 GWh/yr and the dedicated solar plant adds 41.3 GWh/yr against 56.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 115 trainsets, 25 stations, 38.7 route-km, 3 lines, and 17,995 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips / city resident | 163 | 261 | 16 |
| Farebox revenue | $63 M / yr | $100 M / yr | $6.3 M / yr |
| Station shop leases | $1.8 M / yr | $1.8 M / yr | $1.8 M / yr |
| Advertising boards | $2.9 M / yr | $2.9 M / yr | $2.9 M / yr |
| **Total revenue** | **$67 M / yr** | **$105 M / yr** | **$11 M / yr** |
| Revenue / OPEX recovery | 610% | 951% | 100% |
...
| Operating surplus after OPEX (before debt support) | $56 M / yr | $94 M / yr | $0 / yr |

_Commercial-revenue assumptions: 4,456 m² of station shop/kiosk leases at $38/m²/month and 840 advertising boards at $336/board/month, with occupancy derates applied._
...
| Station-area commerce turnover supported | $26 M / yr | $42 M / yr | 22% of paid trips × $2.40 local spend proxy |
...
| Commerce | 15 major/terminal/interchange nodes | 29,864 trips/trading day; 9.9 M access-events/yr | 47,783 trips/trading day; 15.8 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $228 M | 58% of $395 M CAPEX using bucket local-content shares |
...
| Construction employment supported | 9,907 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$395 M** |
| 15%–25% planning risk envelope | $455 M–$494 M |
| Annual OPEX | $11 M / yr |
| Low/high project NPV at 8% | $130 M / $428 M |
| Low/high project IRR | 11.1% / 16.9% |
| Low/high steady-state DSCR | 3.10 / 5.18 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 1,638.66 train-km; 8,180.85 kWh consumed; 8,957.36 kWh charged; 33 depot services completed; minimum SoC 88%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 18,674.12 train-km; 93,228.77 kWh consumed; 95,636.19 kWh charged; 491 depot services completed (6 active at cutoff); minimum SoC 81%; 0 onboard emergencies; 0 invariant violations; 100.0% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 77.7% | 100.0% / 90% | pass |
| maximum planning climate/HVAC duty | 66.2% | 100.0% / 90% | pass |
| 50% charging-contact availability | 81.2% | 100.0% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 100.0% / 60% | pass |
| ten-hour single charging-pad outage | 81.2% | 100.0% / 90% | pass |
...
| QGIS/GDAL | GeoPackage generated with 3 corridors, 25 line platforms, 1 interchange complexes, 8 civil segments, and 0 input findings |
