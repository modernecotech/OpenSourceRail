...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.29 bn (86.5%) of external capital** and **$4.05 bn of external interest**. Capital plus saved interest totals **$7.34 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (241.2 km @ $2.58 M/km) | $623 M |
| Elevated (15.4 km @ $9.75 M/km) | $150 M |
| Elevated-interchange premium (13 sites @ $4.50 M) | $58 M |
| **Civil subtotal** | **$832 M** |
...
| Per-capita (city pop) | $1,175 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $832 M | 15% | $125 M | $707 M |
...
| EPC / project services | $118 M | 15% | $18 M | $100 M |
| **Total city CAPEX** | **$2.12 bn** | **24.3%** | **$514 M** | **$1.60 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **24.3%** | **$514 M** | **$103 M / yr** |
| **Local capital for domestic procurement / payroll** | **75.7%** | **$1.60 bn** | **$320 M / yr** |
| of which planned local bond issuance | 60.5% of total CAPEX | $1.28 bn | $256 M / yr |
| **Total city programme** | **100.0%** | **$2.12 bn** | **$423 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.86 bn | $2.34 bn (82.0%) | $2.88 bn | **$5.22 bn** |
| **Default** | 2.00× | $3.81 bn | $3.29 bn (86.5%) | $4.05 bn | **$7.34 bn** |
| High | 3.00× | $5.71 bn | $5.20 bn (91.0%) | $6.39 bn | **$11.59 bn** |

At the default 2.00× case, OSR's $514 M external requirement is 86.5% below the illustrative foreign-company requirement of $3.81 bn; the associated lifetime external-interest saving is $4.05 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$234 M / yr** | $130 |
| Steady-state, low capacity-use (year 6+) | **$75 M / yr** | $42 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$180 M / yr** | $100 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.79 bn cumulative** | $2,105 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.17 bn cumulative** | $651 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$7.48 bn cumulative** | $4,153 |

_Population basis: 1,800,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $105 M / yr → $180 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $514 M | 4.5% | 40 y, 5 y grace | $29 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.28 bn | 11.5% | 40 y, 5 y grace | $151 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $320 M | — | — | — |
| **Total** | **100%** | **$2.12 bn** | | | **$180 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $23 M / yr + local bonds $147 M / yr = **$170 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($64 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 49.7 M |
| Annual paid trips / city resident | 100 | 159 | 28 |
| Farebox revenue | $146 M / yr | $233 M / yr | $40 M / yr |
| Station shop leases | $4.1 M / yr | $4.1 M / yr | $4.1 M / yr |
| Advertising boards | $6.3 M / yr | $6.3 M / yr | $6.3 M / yr |
| **Total revenue** | **$156 M / yr** | **$244 M / yr** | **$51 M / yr** |
| Revenue / OPEX recovery | 307% | 479% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gross repayable-debt service + residual OPEX subsidy | $180 M / yr | $180 M / yr | **$180 M / yr** |
| Operating surplus applied to debt support | -$105 M / yr | -$180 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $75 M / yr | $0 k / yr | **$180 M / yr** |
| Operating surplus after OPEX (before debt support) | $105 M / yr | $193 M / yr | $0 / yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.60 bn | 76% of $2.12 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.56 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $512 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 109,363 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.80 bn |
| Timetable-sized dedicated solar CAPEX | $312 M |
| **Reconciled project CAPEX** | **$2.12 bn** |
| Imported / external-capital requirement | $514 M (24.3%) |
| Local-content / local-funding requirement | $1.60 bn (75.7%) |
| Default foreign-turnkey external-capital comparison | $3.81 bn; OSR saves $3.29 bn (86.5%) |
| Lifetime external interest and combined financing saving | $4.05 bn interest; $7.34 bn capital + interest |
| 15%–25% planning risk envelope | $2.43 bn–$2.64 bn |
| Annual OPEX | $51 M / yr |
| Low/high project NPV at 8% | $-853962 k / $-160205 k |
| Low/high project IRR | 3.0% / 7.2% |
| Low/high steady-state DSCR | 0.58 / 1.07 |
