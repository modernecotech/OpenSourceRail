...
|---|---|---|
| Construction (years 1–5) | **$263 M / yr** | $146 |
| Steady-state, low-ridership (year 6+) | **$276 M / yr** | $153 |
| Steady-state, high-ridership (year 6+) | **$252 M / yr** | $140 |
| Steady-state, operating-neutral revenue case | **$241 M / yr** | $134 |
| Lifecycle envelope (yr 1–25, low scenario) | **$6.83 bn cumulative** | $3,796 |
| Lifecycle envelope (yr 1–25, high scenario) | **$6.35 bn cumulative** | $3,527 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$6.14 bn cumulative** | $3,411 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $35 M / yr → $10 M / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $1.84 bn | 4.5% | 25 y, 5 y grace | $142 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $768 M | 11.5% | 25 y, 5 y grace | $100 M / yr |
| Government equity (no debt service) | 15% | $461 M | — | — | — |
| **Total** | **100%** | **$3.07 bn** | | | **$241 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $83 M / yr + bonds $88 M / yr = **$171 M / yr** total — plus the equity tranche amortised across construction ($92 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
|---|---|---|---|
| Daily paid trips | 163,620 | 272,700 | 319,413 |
| Daily paid trips / catchment | 18% | 30% | 35% |
| Daily paid trips / city population | 9% | 15% | 18% |
| Annual paid trips | 59.7 M | 99.5 M | 116.6 M |
| Farebox revenue | $36 M / yr | $61 M / yr | $71 M / yr |
| Station shop leases | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| Advertising boards | $9.1 M / yr | $9.1 M / yr | $9.1 M / yr |
| **Total revenue** | **$51 M / yr** | **$76 M / yr** | **$86 M / yr** |
| Revenue / OPEX recovery | 60% | 88% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov debt service + residual OPEX subsidy | $276 M / yr | $252 M / yr | **$241 M / yr** |
