...
| Item | Basis | Subtotal |
|---|---|---|
| Signalling (onboard ATC + LoRa-linked wayside W-Nodes, RFC 0019/0001) | 254.7 km × €0.1 M/km | €25 M |
...
|---|---|---|
| Construction (years 1–5) | **€229 M / yr** | €127 |
| Steady-state, low-ridership (year 6+) | **€261 M / yr** | €145 |
| Steady-state, high-ridership (year 6+) | **€246 M / yr** | €137 |
| Lifecycle envelope (yr 1–25, low scenario) | **€6.37 bn cumulative** | €3,538 |
| Lifecycle envelope (yr 1–25, high scenario) | **€6.06 bn cumulative** | €3,368 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero and only the OPEX shortfall remains — ~€51 M / yr (low) → €36 M / yr (high)._
...
| Sovereign bonds (10-y benchmark + project) | 25% | €669 M | 11.5% | 25 y, 5 y grace | €87 M / yr |
| Government equity (no debt service) | 15% | €401 M | — | — | — |
| **Total** | **100%** | **€2.67 bn** | | | **€210 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral €72 M / yr + bonds €77 M / yr = **€149 M / yr** total — plus the equity tranche amortised across construction (€80 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| **Steady-state government commitment** (debt service + OPEX shortfall) | **€261 M / yr** | **€246 M / yr** |
