...
- **Planning daily ridership scenario** (25-45% of catchment): ≈ **227,250 – 409,050 trips/day**
...
| Per-capita (city pop) | $2,177 / person |
...
| Steady-state, low-ridership (year 6+) | **$112 M / yr** | $62 |
| Steady-state, high-ridership (year 6+) | **$78 M / yr** | $44 |
| Steady-state, operating-neutral revenue case | **$78 M / yr** | $44 |
| Lifecycle envelope (yr 1–40, low scenario) | **$4.49 bn cumulative** | $2,496 |
| Lifecycle envelope (yr 1–40, high scenario) | **$3.33 bn cumulative** | $1,850 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.33 bn cumulative** | $1,850 |

_Population basis: 1,800,000 (catchment per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $33 M / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Climate / development grant (non-repayable) | 40% | $1.57 bn | — | — | — |
| Green concessional loan (World Bank / AfDB / ADB / GCF class) | 50% | $1.96 bn | 2.0% | 40 y, 5 y grace | $78 M / yr |
| Sovereign / project bonds (fallback only) | 0% | $0 k | 11.5% | 40 y, 5 y grace | $0 k / yr |
| Government equity (no debt service) | 10% | $392 M | — | — | — |
| **Total** | **100%** | **$3.92 bn** | | | **$78 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — concessional loan $39 M / yr + fallback bonds $0 k / yr = **$39 M / yr** total. The $1.57 bn grant tranche carries no repayment or coupon. Government equity is drawn across construction ($78 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Traction energy (958.5 GWh / yr) | trackside PV + Na-ion (RFC 0002) — **self-generated, $0 / yr** | $0 k |
| Labour (1,540 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $7.9 M |
| **OPEX subtotal** | | **$116 M / yr** |

_Annual fleet utilisation: 305 revenue trainsets × 20.5 h/day × 365 d/yr × 35 km/h commercial × 75% revenue factor = 59.9 M train-km / yr (~196 k km / trainset / yr)._
...
|---|---|---|---|
| Daily paid trips | 227,250 | 409,050 | 339,160 |
| Daily paid trips / catchment | 25% | 45% | 37% |
| Daily paid trips / city population | 13% | 23% | 19% |
| Annual paid trips | 82.9 M | 149.3 M | 123.8 M |
| Farebox revenue | $67 M / yr | $121 M / yr | $101 M / yr |
| Station shop leases | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| Advertising boards | $9.1 M / yr | $9.1 M / yr | $9.1 M / yr |
| **Total revenue** | **$82 M / yr** | **$136 M / yr** | **$116 M / yr** |
| Revenue / OPEX recovery | 71% | 118% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Gov repayable-debt service + residual OPEX subsidy | $112 M / yr | $78 M / yr | **$78 M / yr** |
