...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.16 bn (86.8%) of external capital** and **$3.89 bn of external interest**. Capital plus saved interest totals **$7.05 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Route length (double track) | 223.9 km |
| Revenue fleet | 256 × 4-car trainsets |
| Revenue fleet passenger capacity | 122,880 AW2 pax (163,840 AW3 crush) |
...
| Revenue fleet capacity | 122,880 AW2 pax (163,840 AW3 crush) |
| Total fleet capacity | 136,800 AW2 pax (182,400 AW3 crush, incl. service rotation + spare + reserve) |

## Ridership capacity

- **Per-train planning capacity:** 480 AW2 passengers (`metro-4car`)
- **Revenue fleet simultaneous capacity:** 256 × 480 = **122,880 AW2 passengers** (163,840 AW3 crush)
- **Total fleet passenger capacity:** 285 × 480 = **136,800 AW2 passengers** (182,400 AW3 crush, incl. service rotation + spare + reserve)
...
- Anchor-weighted coverage: 60.7%
- Catchment population: **≈ 1,101,705** (within ~800 m walk of a station)
...
| Standard | 30 | 300 kW | 1500 kWh |
| Terminal | 9 | 300 kW | 1500 kWh |
| **Total installed** | **74** | **26,900 kW** | **149,500 kWh** |

Aggregate station-rail charging power: **111,000 kW**. Trains opportunity-charge during station dwell per RFC 0002; onboard 720 kWh usable (900 kWh nameplate) battery covers running.

Dedicated utility-scale solar plant / contracted offsite PPA asset: **325.6 MW** sized to cover the generated timetable traction-energy gap after station/depot PV, including a 115% planning coverage margin. This is carried as infrastructure CAPEX below.
...
| Onboard battery adequacy | 5.8× worst inter-charge run | OK: 900 kWh nameplate, 180 kWh protected reserve, and 597 kWh usable margin across the worst powered-stop gap (line-1) |
| Lowest traversal charging margin | 248 kWh | line-5 after climate load, 98% conversion, and the required 10% operating margin |
...
| Scheduled train journey-km | 89,697 train-km/day | One-way train journeys × route length |
| Annual service work | 35.4 M train-km/yr | Includes 108% depot/deadhead factor |
| Scheduled traction demand | 1,550 MWh/day | 141.4 M car-km/yr × 4.0 kWh/car-km |
| On-site PV shortfall before solar plant | 1,415 MWh/day | Gap used to size the dedicated plant / offsite solar PPA asset |
| Dedicated solar plant | 325.6 MW / 1,628 MWh/day | Utility PV + interconnection with 115% planning coverage margin |
| Residual grid/PPA top-up need | 0 MWh/day | Backup import after on-site PV plus the dedicated solar plant |
| Station/depot stationary storage | 150 MWh | Distributed LFP buffer for charging peaks and grid outages |
...
|---|---:|---:|---:|---:|---:|
| line-1 | 10 | 324 kWh | 637 kWh | 281 kWh | 12.8 km / 123 kWh |
| line-2 | 13 | 357 kWh | 710 kWh | 318 kWh | 6.5 km / 62 kWh |
| line-3 | 9 | 288 kWh | 576 kWh | 259 kWh | 9.2 km / 88 kWh |
| line-4 | 10 | 320 kWh | 637 kWh | 285 kWh | 10.0 km / 96 kWh |
| line-5 | 10 | 265 kWh | 539 kWh | 248 kWh | 4.1 km / 39 kWh |
| line-6 | 22 | 595 kWh | 1,078 kWh | 423 kWh | 6.2 km / 59 kWh |
...
| Bucket | Value |
|---|---|
| At-grade (198.0 km @ $2.58 M/km) | $512 M |
| Elevated (25.9 km @ $9.75 M/km) | $253 M |
| Elevated-interchange premium (11 sites @ $4.50 M) | $50 M |
| **Civil subtotal** | **$814 M** |
...
|---|---|---|---|
| `metro-4car` (revenue + service rotation + spare + cold reserve) | 285 | $1.12 M | $319 M |
...
|---|---:|---:|---:|
| Fleet demand passed to national production plan | 1140 | $60 k | **$0 k** |
| National high sensitivity (shown for scale, not added here) | 1140 | $120 k | $0 |
...
| Item | Basis | Value |
|---|---|---:|
| Utility-scale PV field | 325,556 kW @ $700/kW | $228 M |
| Grid interconnection / PPA tie-in | 325,556 kW @ $100/kW | $33 M |
| Annual generation proxy | 325.6 MW × 5.0 peak-sun-h/day × 365 d/yr | 594.1 GWh/yr |
| **Dedicated solar plant subtotal** | | **$260 M** |

### Systems

| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 223.9 km × $0.050 M/km | $11 M |
...
| EPC integration + project management (7%) | on subtotal | $115 M |
...
|---|---:|---:|---:|---:|
| Civil works | $814 M | 15% | $122 M | $692 M |
| Stations | $471 M | 20% | $94 M | $377 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $319 M | 35% | $112 M | $207 M |
| Dedicated solar plant | $260 M | 45% | $117 M | $143 M |
| Residual signalling / train control | $11 M | 50% | $5.6 M | $5.6 M |
| Charging microgrids | $25 M | 40% | $9.8 M | $15 M |
| EPC / project services | $115 M | 15% | $17 M | $98 M |
| **Total city CAPEX** | **$2.02 bn** | **23.7%** | **$480 M** | **$1.54 bn** |
...
Planning-grade procurement-origin and financing model anchored to country financial parameters from [`lib/templates/country-finance.toml`](../../../../lib/templates/country-finance.toml). Imported content defines the minimum foreign-currency / international capital requirement; locally supplied content can be financed with domestic-currency bonds, public equity, or other local sources. It is a pure function of the [costs] block above + the country code — regenerate by re-running `scripts/regenerate-city.sh la-paz`.
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **23.7%** | **$480 M** | **$96 M / yr** |
| **Local capital for domestic procurement / payroll** | **76.3%** | **$1.54 bn** | **$309 M / yr** |
| of which planned local bond issuance | 61.0% of total CAPEX | $1.23 bn | $247 M / yr |
| **Total city programme** | **100.0%** | **$2.02 bn** | **$405 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $2.73 bn | $2.25 bn (82.4%) | $2.77 bn | **$5.02 bn** |
| **Default** | 2.00× | $3.64 bn | $3.16 bn (86.8%) | $3.89 bn | **$7.05 bn** |
| High | 3.00× | $5.46 bn | $4.98 bn (91.2%) | $6.13 bn | **$11.11 bn** |

At the default 2.00× case, OSR's $480 M external requirement is 86.8% below the illustrative foreign-company requirement of $3.64 bn; the associated lifetime external-interest saving is $3.89 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–5) | **$213 M / yr** | $117 |
| Steady-state, low capacity-use (year 6+) | **$61 M / yr** | $34 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$161 M / yr** | $89 |
| Lifecycle envelope (yr 1–40, low scenario) | **$3.20 bn cumulative** | $1,763 |
| Lifecycle envelope (yr 1–40, high scenario) | **$1.07 bn cumulative** | $587 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$6.71 bn cumulative** | $3,696 |

_Population basis: 1,815,000 (city population per `lib/city-batches/world-sample.toml`). After year 40, debt service drops to zero; steady-state commitments below are net of any operating surplus applied to repayable-debt support. The operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr; surplus applied to debt support is $100 M / yr → $161 M / yr._

### CAPEX funding sources

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 24% | $480 M | 4.5% | 40 y, 5 y grace | $27 M / yr |
| Local-currency sovereign / project bonds for local content | 61% | $1.23 bn | 10.5% | 40 y, 5 y grace | $134 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $309 M | — | — | — |
| **Total** | **100%** | **$2.02 bn** | | | **$161 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $22 M / yr + local bonds $130 M / yr = **$151 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($62 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Residual train-control wayside maintenance | 5 % of residual signalling CAPEX | $560 k |
| Traction energy (565.7 GWh / yr) | 89,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor; 4 cars × 4.0 kWh/car-km; on-site PV 49.1 GWh/yr + dedicated solar plant 325.6 MW / 594.1 GWh/yr (100% coverage); residual grid/PPA top-up 0.0 GWh/yr @ $0.10/kWh; solar plant O&M 1.5%/yr | $3.9 M |
| Labour (1,038 FTE) | driverless roster: OCC/remote 162, station/platform 356, passenger service 111, fleet maintenance 204, infrastructure/energy 178, admin/training 27; no train drivers × country median × 12 × engineer-premium 1.4 | $5.1 M |
| **OPEX subtotal** | | **$48 M / yr** |

_Annual service work: 89,697 scheduled train-km/day × 365 d/yr × 108% depot/deadhead factor = 35.4 M train-km / yr (141.4 M car-km / yr). On-site PV covers 49.1 GWh/yr and the dedicated solar plant adds 594.1 GWh/yr against 565.7 GWh/yr traction demand before residual grid/PPA top-up (0.0 GWh/yr). Driverless labour follows RFC 0015: train drivers are not counted, but OCC remote-assist, platform presence, passenger service, and fleet/energy maintenance scale with the larger service._

## Maintenance schedule system

Baseline scheduled work covers 285 trainsets, 79 stations, 223.9 route-km, 6 lines, and 89,697 scheduled train-km/day. Intervals are defined in [`lib/templates/maintenance-schedule.toml`](../../../../lib/templates/maintenance-schedule.toml) and governed by [RFC 0029](../../../../docs/rfcs/0029-maintenance-schedule-system.md).
...
| Annual paid trips | 179.2 M | 286.8 M | 49.6 M |
| Annual paid trips / city resident | 99 | 158 | 27 |
| Farebox revenue | $139 M / yr | $222 M / yr | $38 M / yr |
| Station shop leases | $3.9 M / yr | $3.9 M / yr | $3.9 M / yr |
| Advertising boards | $5.9 M / yr | $5.9 M / yr | $5.9 M / yr |
| **Total revenue** | **$148 M / yr** | **$232 M / yr** | **$48 M / yr** |
| Revenue / OPEX recovery | 308% | 481% | 100% |
...
| Operating surplus applied to debt support | -$100 M / yr | -$161 M / yr | **$0 k / yr** |
| **Net gov repayable-debt support + residual OPEX subsidy** | $61 M / yr | $0 k / yr | **$161 M / yr** |
| Operating surplus after OPEX (before debt support) | $100 M / yr | $183 M / yr | $0 / yr |

_Commercial-revenue assumptions: 15,720 m² of station shop/kiosk leases at $23/m²/month and 2,852 advertising boards at $203/board/month, with occupancy derates applied._
...
|---|---:|---:|---|
| Travel time + reliability dividend | $40 M / yr | $64 M / yr | 16 min/trip × $0.84/h value-of-time proxy |
...
| **Annual quantified benefit / activity proxy** | **$214 M / yr** | **$342 M / yr** | sum of rows above; use as a screening envelope, not audited revenue |

### Access to education, healthcare, commerce, and entertainment

| Access channel | Anchored stations / signal | Low scenario | High scenario |
|---|---:|---:|---:|
| Education | 8 education anchors | 27,085 trips/school day; 6.0 M access-events/yr | 43,336 trips/school day; 9.5 M access-events/yr |
| Healthcare | 4 healthcare anchors | 32,357 trips/day; 11.8 M access-events/yr | 51,771 trips/day; 18.9 M access-events/yr |
| Commerce | 44 major/terminal/interchange nodes | 107,283 trips/trading day; 35.4 M access-events/yr | 171,653 trips/trading day; 56.6 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.54 bn | 76% of $2.02 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.47 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $494 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 110,898 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| Check | Result |
|---|---:|
| Authoritative design-base CAPEX | $1.76 bn |
| Timetable-sized dedicated solar CAPEX | $260 M |
| **Reconciled project CAPEX** | **$2.02 bn** |
| Imported / external-capital requirement | $480 M (23.7%) |
| Local-content / local-funding requirement | $1.54 bn (76.3%) |
| Default foreign-turnkey external-capital comparison | $3.64 bn; OSR saves $3.16 bn (86.8%) |
| Lifetime external interest and combined financing saving | $3.89 bn interest; $7.05 bn capital + interest |
| 15%–25% planning risk envelope | $2.33 bn–$2.53 bn |
| Annual OPEX | $48 M / yr |
| Low/high project NPV at 8% | $-821071 k / $-161434 k |
| Low/high project IRR | 3.0% / 7.2% |
| Low/high steady-state DSCR | 0.62 / 1.14 |
...
| Verified run | Result |
|---|---|
| 2-hour screenshot trace | 6,498.14 train-km; 62,378.44 kWh consumed; 65,539.54 kWh charged; 37 depot services completed; minimum SoC 81%; 0 onboard emergencies; 0 invariant violations |
| Full 05:30–02:00 service plus run-out | 87,493.29 train-km; 839,885.65 kWh consumed; 850,582.09 kWh charged; 1,018 depot services completed (9 active at cutoff); minimum SoC 75%; 0 onboard emergencies; 0 invariant violations; 97.5% of scheduled train-km delivered |

### Mandatory degraded-energy cases

| Case | Minimum SoC | Service delivered / required | Result |
|---|---:|---:|---:|
| 80% end-of-life battery capacity | 69.1% | 97.5% / 90% | pass |
| maximum planning climate/HVAC duty | 67.0% | 97.5% / 90% | pass |
| 50% charging-contact availability | 75.3% | 97.5% / 90% | pass |
| ten-hour all-site grid outage | 20.0% | 80.5% / 60% | pass |
| ten-hour single charging-pad outage | 72.8% | 97.5% / 90% | pass |
...
|---|---|
| ![La-Paz energy and battery simulation dashboard](engineering/screenshots/la-paz-simulation-dashboard.png) | ![La-Paz simulator network visualizer](engineering/screenshots/la-paz-network-visualizer.png) |
...
| QGIS/GDAL | GeoPackage generated with 6 corridors, 79 line platforms, 12 interchange complexes, 53 civil segments, and 0 input findings |
...
|---|---|
| ![La-Paz QGIS engineering layers](engineering/screenshots/la-paz-qgis-engineering-map.png) | ![La-Paz SUMO timetable validation](engineering/screenshots/la-paz-sumo-validation.png) |
