...
|---|---|---|
| Construction (years 1–5) | **$70 M / yr** | $86 |
| Steady-state, low capacity-use (year 6+) | **$217 k / yr** | $0 |
| Steady-state, high capacity-use (year 6+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$40 M / yr** | $49 |
| Lifecycle envelope (yr 1–40, low scenario) | **$359 M cumulative** | $440 |
| Lifecycle envelope (yr 1–40, high scenario) | **$352 M cumulative** | $431 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$1.76 bn cumulative** | $2,153 |
...
|---|---|---|---|---|---|
| Green concessional loan | 80% | $1.01 bn | 2.0% | 40 y, 5 y grace | $40 M / yr |
| Government equity (no debt service) | 20% | $251 M | — | — | — |
| **Total** | **100%** | **$1.26 bn** | | | **$40 M / yr** |

_During the 5-year grace period the public sponsor pays interest only on repayable debt — green concessional loan $20 M / yr = **$20 M / yr** total. The base case assumes no climate-development grant. Government equity is drawn across construction ($50 M / yr × 5 yr). Principal repayment begins in year 6 on a 35-year amortisation schedule._
...
| Labour (528 FTE) | driverless roster: OCC/remote 81, station/platform 185, passenger service 44, fleet maintenance 90, infrastructure/energy 92, admin/training 36; no train drivers × country median × 12 × engineer-premium 1.4 | $3.6 M |
...
| Annual paid trips | 63.1 M | 100.9 M | 26.5 M |
| Annual paid trips / city resident | 77 | 124 | 32 |
| Farebox revenue | $69 M / yr | $110 M / yr | $29 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| **Total revenue** | **$76 M / yr** | **$118 M / yr** | **$36 M / yr** |
| Revenue / OPEX recovery | 210% | 324% | 100% |
...
| **Net gov repayable-debt support + residual OPEX subsidy** | $217 k / yr | $0 k / yr | **$40 M / yr** |
| Operating surplus after OPEX (before debt support) | $40 M / yr | $81 M / yr | $0 / yr |
...
| Avoided CO2e | $3.2 M / yr | $5.1 M / yr | 40.1–64.2 ktCO2e/yr after rail residual-grid emissions × $80/t |
| Local air / noise / safety externalities | $8.9 M / yr | $14 M / yr | avoided road vehicle-km × $0.04/vehicle-km |
| Station-area commerce turnover supported | $30 M / yr | $48 M / yr | 23% of paid trips × $2.05 local spend proxy |
...
|---|---:|---:|---:|
| Education | 9 education anchors | 11,452 trips/school day; 2.5 M access-events/yr | 18,322 trips/school day; 4.0 M access-events/yr |
| Healthcare | 10 healthcare anchors | 14,291 trips/day; 5.2 M access-events/yr | 22,866 trips/day; 8.3 M access-events/yr |
| Commerce | 33 major/terminal/interchange nodes | 40,122 trips/trading day; 13.2 M access-events/yr | 64,195 trips/trading day; 21.2 M access-events/yr |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $664 M | 53% of $1.26 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $1.06 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $213 M / yr | spread across 5 construction / grace years |
| Construction employment supported | 33,763 job-years | retained CAPEX ÷ (4.0 × median annual income) |
