...
- **Planning daily ridership scenario** (18-30% of catchment (capped by practical service capacity)): ≈ **84,422 – 112,320 trips/day**
...
| Bucket | Value |
|---|---|
| At-grade (72.1 km @ $2.0 M/km) | $144 M |
| Elevated (4.9 km @ $9.0 M/km) | $44 M |
...
| Item | Basis | Subtotal |
|---|---|---|
| Residual signalling / train-control wayside (onboard ATP/ATO + T-OBS carries the function; W-Nodes, balises, LoRa gateways, OCC interfaces remain) | 78.5 km × $0.015 M/km | $3.8 M |
...
|---|---|---|
| Construction (years 1–5) | **$33 M / yr** | $40 |
| Steady-state, low-ridership (year 6+) | **$30 M / yr** | $37 |
| Steady-state, high-ridership (year 6+) | **$30 M / yr** | $37 |
| Steady-state, operating-neutral revenue case | **$30 M / yr** | $37 |
| Lifecycle envelope (yr 1–25, low scenario) | **$768 M cumulative** | $940 |
| Lifecycle envelope (yr 1–25, high scenario) | **$768 M cumulative** | $940 |
| Lifecycle envelope (yr 1–25, operating-neutral after opening) | **$768 M cumulative** | $940 |

_Population basis: 817,100 (catchment per `lib/city-batches/world-sample.toml`). After year 25, debt service drops to zero; the operating-neutral case already covers steady-state OPEX from fares, station shops, and advertising. Low/high residual OPEX shortfall before debt is $0 k / yr → $0 k / yr._

### CAPEX funding stack

| Tranche | Share | Principal | Rate | Tenor | Annual debt service (post-grace) |
|---|---|---|---|---|---|
| Multilateral concessional loan (IBRD / AfDB / ADB class) | 60% | $243 M | 4.5% | 25 y, 5 y grace | $19 M / yr |
| Sovereign bonds (10-y benchmark + project) | 25% | $101 M | 9.5% | 25 y, 5 y grace | $12 M / yr |
| Government equity (no debt service) | 15% | $61 M | — | — | — |
| **Total** | **100%** | **$406 M** | | | **$30 M / yr** |

_During the 5-year grace period the operator pays interest only — multilateral $11 M / yr + bonds $9.6 M / yr = **$21 M / yr** total — plus the equity tranche amortised across construction ($12 M / yr × 5 yr). Principal repayment begins in year 6 on a 20-year amortisation schedule._
...
| Labour (483 FTE) | ~6 FTE/route-km + 12 admin core × country median × 12 × engineer-premium 1.4 | $3.3 M |
...
|---|---|---|---|
| Daily paid trips | 84,422 | 112,320 | 15,095 |
| Daily paid trips / catchment | 18% | 24% | 3% |
| Daily paid trips / city population | 10% | 14% | 2% |
| Annual paid trips | 30.8 M | 41.0 M | 5.5 M |
| Farebox revenue | $25 M / yr | $34 M / yr | $4.5 M / yr |
| Station shop leases | $2.8 M / yr | $2.8 M / yr | $2.8 M / yr |
| Advertising boards | $4.5 M / yr | $4.5 M / yr | $4.5 M / yr |
| **Total revenue** | **$33 M / yr** | **$41 M / yr** | **$12 M / yr** |
| Revenue / OPEX recovery | 275% | 346% | 100% |
| Country farebox-only policy target (diagnostic) | 55% | 55% | 55% |
| Remaining steady-state gov commitment | $30 M / yr | $30 M / yr | **$30 M / yr** |
| Operating surplus after OPEX | $21 M / yr | $29 M / yr | $0 / yr |
