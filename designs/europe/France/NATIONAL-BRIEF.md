...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this national OSR programme avoids **$3.60 B (86.2%) of external capital** and **$4.35 B of external interest**. Capital plus saved interest totals **$7.95 B over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the comparator external requirement is assumed debt-financed, and the comparator is an editable sensitivity, not a vendor quote.
...
| City infrastructure + fleet CAPEX | $2.23 B |
...
| **Total national programme CAPEX** | **$2.32 B** |
...
|---|---:|---:|---:|
| **External capital for imports** | **24.9%** | **$578.7 M** | **$192.9 M / yr** |
| **Local capital for domestic value** | **75.1%** | **$1.74 B** | **$581.5 M / yr** |
| planned local-currency bond issuance | 60.1% of total | $1.40 B | $465.2 M / yr |
| local public equity / other domestic funding | 15.0% of total | $348.9 M | $116.3 M / yr |
| **Total capital programme** | **100.0%** | **$2.32 B** | **$774.4 M / yr** |

The annual construction draw is spread evenly over 3 planning years. Post-grace annual debt service is $32.4 M for external import finance plus $63.0 M for local bonds, or **$95.4 M per year** before railway operating cash flow. During construction, interest plus the local public-equity draw is **$184.2 M per year**.
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $3.14 B | $2.56 B (81.5%) | $3.09 B | **$5.64 B** |
| **Default** | 2.00× | $4.18 B | $3.60 B (86.2%) | $4.35 B | **$7.95 B** |
| High | 3.00× | $6.27 B | $5.69 B (90.8%) | $6.87 B | **$12.56 B** |

At the default 2.00× case, the OSR programme reduces external capital from $4.18 B to $578.7 M, a saving of **$3.60 B (86.2%)**, plus **$4.35 B** of external interest over the financing life. Total programme CAPEX is 50.0% below the comparator. Replace both variables with scope-normalized bids before investment approval.

## Procurement-origin composition

| CAPEX bucket | Total | Imported share | External capital | Local value |
|---|---:|---:|---:|---:|
| Civil works | $878.3 M | 15% | $131.7 M | $746.6 M |
| Stations | $413.7 M | 20% | $82.7 M | $331.0 M |
| Depots | $8.0 M | 25% | $2.0 M | $6.0 M |
| Rolling stock | $388.6 M | 35% | $136.0 M | $252.6 M |
| Dedicated solar plants | $387.3 M | 45% | $174.3 M | $213.0 M |
| Residual signalling / train control | $13.5 M | 50% | $6.7 M | $6.7 M |
| Charging microgrids | $23.8 M | 40% | $9.5 M | $14.3 M |
| EPC / project services | $126.6 M | 15% | $19.0 M | $107.6 M |
| Shared national trainset factory | $83.3 M | 20% | $16.7 M | $66.6 M |
| **Total** | **$2.32 B** | **24.9%** | **$578.7 M** | **$1.74 B** |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Lyon](Lyon/README.md) | 1,436,354 | 347 | $2.23 B | 25.1% | $561.2 M | $4.02 B | $3.46 B | $7.63 B | $1.67 B |
