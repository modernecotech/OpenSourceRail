...
> [!IMPORTANT]
> **Foreign-capital advantage:** against the default equivalent foreign-turnkey case, this OSR plan avoids **$3.46 bn (86.0%) of external capital** and **$4.17 bn of external interest**. Capital plus saved interest totals **$7.63 bn over the 40-year financing life**. Both cases use the same 4.5% external rate and financing schedule; the turnkey external requirement is assumed debt-financed, and the benchmark remains an editable sensitivity, not a vendor quote.
...
| Bucket | Value |
|---|---|
| At-grade (250.8 km @ $2.58 M/km) | $648 M |
| Elevated (19.0 km @ $9.75 M/km) | $185 M |
...
| Per-capita (city pop) | $1,555 / person |
...
|---|---:|---:|---:|---:|
| Civil works | $878 M | 15% | $132 M | $747 M |
...
| EPC / project services | $121 M | 15% | $18 M | $103 M |
| **Total city CAPEX** | **$2.23 bn** | **25.1%** | **$561 M** | **$1.67 bn** |
...
|---|---:|---:|---:|
| **External capital for imported components / machinery** | **25.1%** | **$561 M** | **$187 M / yr** |
| **Local capital for domestic procurement / payroll** | **74.9%** | **$1.67 bn** | **$558 M / yr** |
| of which planned local bond issuance | 59.9% of total CAPEX | $1.34 bn | $446 M / yr |
| **Total city programme** | **100.0%** | **$2.23 bn** | **$745 M / yr** |
...
|---|---:|---:|---:|---:|---:|
| Low | 1.50× | $3.02 bn | $2.45 bn (81.4%) | $2.96 bn | **$5.42 bn** |
| **Default** | 2.00× | $4.02 bn | $3.46 bn (86.0%) | $4.17 bn | **$7.63 bn** |
| High | 3.00× | $6.03 bn | $5.47 bn (90.7%) | $6.60 bn | **$12.07 bn** |

At the default 2.00× case, OSR's $561 M external requirement is 86.0% below the illustrative foreign-company requirement of $4.02 bn; the associated lifetime external-interest saving is $4.17 bn, and total project CAPEX is 50.0% lower. Replace both variables with normalized bids before an investment decision.
...
|---|---|---|
| Construction (years 1–3) | **$177 M / yr** | $123 |
| Steady-state, low capacity-use (year 4+) | **$0 k / yr** | $0 |
| Steady-state, high capacity-use (year 4+) | **$0 k / yr** | $0 |
| Steady-state, operating-neutral revenue case | **$92 M / yr** | $64 |
| Lifecycle envelope (yr 1–40, low scenario) | **$531 M cumulative** | $370 |
| Lifecycle envelope (yr 1–40, high scenario) | **$531 M cumulative** | $370 |
| Lifecycle envelope (yr 1–40, operating-neutral after opening) | **$3.93 bn cumulative** | $2,734 |
...
|---|---|---|---|---|---|
| External climate/MDB debt for imported content (unconfirmed) | 25% | $561 M | 4.5% | 40 y, 3 y grace | $31 M / yr |
| Local-currency sovereign / project bonds for local content | 60% | $1.34 bn | 3.0% | 40 y, 3 y grace | $60 M / yr |
| Local government equity / other domestic funding (no debt service) | 15% | $335 M | — | — | — |
| **Total** | **100%** | **$2.23 bn** | | | **$92 M / yr** |

_During the 3-year grace period the public sponsor pays interest only on repayable debt — external import-finance debt $25 M / yr + local bonds $40 M / yr = **$65 M / yr** total. The base case assumes no climate-development grant. Local public equity is drawn across construction ($112 M / yr × 3 yr). Principal repayment begins in year 4 on a 37-year amortisation schedule._
...
| Annual paid trips | 179.2 M | 286.8 M | 7.5 M |
| Annual paid trips / city resident | 125 | 200 | 5 |
| Farebox revenue | $1.31 bn / yr | $2.10 bn / yr | $55 M / yr |
| Station shop leases | $13 M / yr | $13 M / yr | $13 M / yr |
| Advertising boards | $31 M / yr | $31 M / yr | $31 M / yr |
| **Total revenue** | **$1.36 bn / yr** | **$2.15 bn / yr** | **$99 M / yr** |
| Revenue / OPEX recovery | 1366% | 2159% | 100% |
...
| Channel | Value | Basis |
|---|---:|---|
| CAPEX retained in local procurement / payroll | $1.67 bn | 75% of $2.23 bn CAPEX using bucket local-content shares |
| Construction-phase local economic activity | $2.68 bn | retained CAPEX × 1.6 local supplier / wage multiplier |
| Annualised during construction | $892 M / yr | spread across 3 construction / grace years |
| Construction employment supported | 12,673 job-years | retained CAPEX ÷ (4.0 × median annual income) |
...
| **Reconciled project CAPEX** | **$2.23 bn** |
| Imported / external-capital requirement | $561 M (25.1%) |
| Local-content / local-funding requirement | $1.67 bn (74.9%) |
| Default foreign-turnkey external-capital comparison | $4.02 bn; OSR saves $3.46 bn (86.0%) |
| Lifetime external interest and combined financing saving | $4.17 bn interest; $7.63 bn capital + interest |
| 15%–25% planning risk envelope | $2.57 bn–$2.79 bn |
| Annual OPEX | $99 M / yr |
| Low/high project NPV at 8% | $9.85 bn / $17.22 bn |
| Low/high project IRR | 39.1% / 55.4% |
| Low/high steady-state DSCR | 13.72 / 22.31 |
