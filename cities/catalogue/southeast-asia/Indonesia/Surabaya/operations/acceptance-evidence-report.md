...
| Manufacturing schedule rows | 4,059 |
| Manufacturing material/BOM rows | 61,565 |
| Manufacturing QA verification rows | 4,059 |
| Construction QA action rows | 3,790 |
| Maintenance handover schedule rows | 4,857 |
| Manufacturing rows with material refs | 4,059 / 4,059 |
| Manufacturing rows with verification refs | 4,059 / 4,059 |
| Manufacturing rows linked to QA actions | 4,059 / 4,059 |
...
|---|---:|
| `project_kit` | 6,575 |
| `rolling_stock_bom` | 51,700 |
| `rolling_stock_cots_fitout` | 3,290 |
