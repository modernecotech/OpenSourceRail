...
The strict README generator rejected the evidence: engineering/simulation/validation-summary.json describes scenario SHA-256 f0be11d78c5415c98a06d4a8bf607ee155d22967b3eeec5e2bf8edfd5ce2f45a, but vientiane.toml is 28d500887158c5bdc42835d7b358794756d7d9bd3172df8c8c1a5bb6b9c4121f; rerun and update the validation evidence. This audit view does not accept or replace the retained solver results.
...
| Solar/storage snapshot (operating duty unverified) | unverified; 0 findings; 14 grid-only diagnostics | [`summary.json`](engineering/energy/summary.json) |
| Operations, QA and maintenance | 317 assets / 1,892 tasks | [`vientiane-operations-manifest.json`](operations/vientiane-operations-manifest.json) |
