...
| Manufacturing schedule rows | 911 |
| Manufacturing material/BOM rows | 14,223 |
| Manufacturing QA verification rows | 911 |
| Construction QA action rows | 858 |
| Maintenance handover schedule rows | 1,073 |
| Manufacturing rows with material refs | 911 / 911 |
| Manufacturing rows with verification refs | 911 / 911 |
| Manufacturing rows linked to QA actions | 911 / 911 |
