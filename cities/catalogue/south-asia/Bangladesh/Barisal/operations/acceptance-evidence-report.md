# Barisal Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 16,780 |
| Manufacturing QA verification rows | 1,070 |
| Construction QA action rows | 1,008 |
| Maintenance handover schedule rows | 1,261 |
