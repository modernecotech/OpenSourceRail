...
- Tracked compact asset register: [`kathmandu-assets.csv`](kathmandu-assets.csv)
- Tracked operations manifest: [`kathmandu-operations-manifest.json`](kathmandu-operations-manifest.json)

The following high-volume files are regenerated in the local city
package and intentionally excluded from Git. Their names are recorded
for handover without presenting unavailable GitHub links:

- `kathmandu-operations.json.gz`
- `kathmandu-acceptance-evidence-matrix.csv`
- `kathmandu-manufacturing-schedule.csv`
- `kathmandu-manufacturing-materials.csv`
- `kathmandu-manufacturing-verification.csv`
- `kathmandu-qa-register.csv`
- `kathmandu-maintenance-schedule.csv`
