...
| Manufacturing schedule rows | 1,358 |
| Manufacturing material/BOM rows | 21,938 |
| Manufacturing QA verification rows | 1,358 |
| Construction QA action rows | 1,291 |
| Maintenance handover schedule rows | 1,596 |
| Manufacturing rows with material refs | 1,358 / 1,358 |
| Manufacturing rows with verification refs | 1,358 / 1,358 |
| Manufacturing rows linked to QA actions | 1,358 / 1,358 |
