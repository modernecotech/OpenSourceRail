# Biratnagar Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 1,268 |
| Manufacturing QA verification rows | 646 |
| Construction QA action rows | 542 |
| Maintenance handover schedule rows | 682 |
