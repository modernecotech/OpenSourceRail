...
| Solar/storage snapshot (operating duty unverified) | unverified; 0 findings; 29 grid-only diagnostics | [`summary.json`](engineering/energy/summary.json) |
| Operations, QA and maintenance | 687 assets / 3,726 tasks | [`ranchi-operations-manifest.json`](operations/ranchi-operations-manifest.json) |
