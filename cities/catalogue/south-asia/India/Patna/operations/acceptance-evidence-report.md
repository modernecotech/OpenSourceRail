# Patna Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 565 |
| Manufacturing schedule rows | 2,024 |
| Manufacturing material/BOM rows | 28,934 |
| Manufacturing QA verification rows | 2,024 |
| Construction QA action rows | 1,860 |
| Maintenance handover schedule rows | 2,447 |
| Manufacturing rows with material refs | 2,024 / 2,024 |
| Manufacturing rows with verification refs | 2,024 / 2,024 |
| Manufacturing rows linked to QA actions | 2,024 / 2,024 |
