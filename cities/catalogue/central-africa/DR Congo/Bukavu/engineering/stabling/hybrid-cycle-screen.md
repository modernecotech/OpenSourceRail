...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 44 / 86 | True | True | 38 / 38 | 0 | 174 | 9 |
| 2 | 44 / 86 | True | True | 38 / 38 | 0 | 170 | 9 |

Minimum train SoC across the run: 20.002%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/central-africa/DR Congo/Bukavu/design.toml' --days 2
```
