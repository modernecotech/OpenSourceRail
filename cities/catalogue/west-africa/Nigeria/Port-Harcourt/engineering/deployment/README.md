# Port-Harcourt deployment gaps

2 closed checks; 14 open gates. Status follows the linked evidence; generating a receipt template does not count as receiving field data.
