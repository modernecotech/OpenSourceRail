...
| Manufacturing material/BOM rows | 9,486 |
| Manufacturing QA verification rows | 615 |
| Construction QA action rows | 578 |
| Maintenance handover schedule rows | 724 |
...
|---|---:|
| `project_kit` | 945 |
| `rolling_stock_bom` | 8,030 |
| `rolling_stock_cots_fitout` | 511 |
