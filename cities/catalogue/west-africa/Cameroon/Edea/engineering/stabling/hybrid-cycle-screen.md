...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 10 / 10 | True | True | 8 / 8 | 0 | 6 | 3 |
| 2 | 10 / 10 | True | True | 8 / 8 | 0 | 6 | 3 |

Minimum train SoC across the run: 88.863%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/west-africa/Cameroon/Edea/design.toml' --days 2
```
