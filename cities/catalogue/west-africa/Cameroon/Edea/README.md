...
The strict README generator rejected the evidence: engineering/simulation/validation-summary.json describes scenario SHA-256 728c9a82b0c923a6c8c5009e3f150948a0aff765bb67ad6b000a6764c8d1437a, but edea.toml is 809510b4e8a76da1c8dff27168f27ac543424f39cb48a490dcb0dd8990ad0108; rerun and update the validation evidence. This audit view does not accept or replace the retained solver results.
...
| Operations, QA and maintenance | 52 assets / 271 tasks | [`edea-operations-manifest.json`](operations/edea-operations-manifest.json) |
...
```bash
tools/automation/regenerate-city.sh edea
```
