# Khouribga operations cross-check
...
|---|---:|---:|---:|---:|---|
| line-1 | 812.9 s | 817.0 s | 4.1 s | 121.9 s | pass |
| line-2 | 588.9 s | 592.0 s | 3.1 s | 120.0 s | pass |
| line-3 | 371.8 s | 369.5 s | -2.3 s | 120.0 s | pass |
