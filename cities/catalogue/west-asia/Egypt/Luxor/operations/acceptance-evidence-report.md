...
| Manufacturing schedule rows | 1,017 |
| Manufacturing material/BOM rows | 15,179 |
| Manufacturing QA verification rows | 1,017 |
| Construction QA action rows | 857 |
| Maintenance handover schedule rows | 1,066 |
| Manufacturing rows with material refs | 1,017 / 1,017 |
| Manufacturing rows with verification refs | 1,017 / 1,017 |
| Manufacturing rows linked to QA actions | 1,017 / 1,017 |
