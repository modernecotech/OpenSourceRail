...
The strict README generator rejected the evidence: engineering/simulation/validation-summary.json describes scenario SHA-256 bbd3d2aeb29938034236c288a869deb11bce20cd849d1fcbd587d18b2d9678e0, but mahalla.toml is d75f351e696c14f2f2c08b93267278eb89e90e4235212fa888ad348f80fbb32e; rerun and update the validation evidence. This audit view does not accept or replace the retained solver results.
...
| Operations, QA and maintenance | 180 assets / 1,042 tasks | [`mahalla-operations-manifest.json`](operations/mahalla-operations-manifest.json) |
...
```bash
tools/automation/regenerate-city.sh mahalla
```
