# Deir Ez Zor Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 1,095 |
| Manufacturing material/BOM rows | 18,078 |
| Manufacturing QA verification rows | 1,095 |
| Construction QA action rows | 1,050 |
| Maintenance handover schedule rows | 1,277 |
| Manufacturing rows with material refs | 1,095 / 1,095 |
| Manufacturing rows with verification refs | 1,095 / 1,095 |
| Manufacturing rows linked to QA actions | 1,095 / 1,095 |
