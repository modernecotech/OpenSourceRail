...
| Manufacturing schedule rows | 749 |
| Manufacturing material/BOM rows | 11,380 |
| Manufacturing QA verification rows | 749 |
| Construction QA action rows | 701 |
| Maintenance handover schedule rows | 886 |
| Manufacturing rows with material refs | 749 / 749 |
| Manufacturing rows with verification refs | 749 / 749 |
| Manufacturing rows linked to QA actions | 749 / 749 |
