# Damascus Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 2,178 |
| Manufacturing material/BOM rows | 31,559 |
| Manufacturing QA verification rows | 2,178 |
| Construction QA action rows | 2,010 |
| Maintenance handover schedule rows | 2,629 |
| Manufacturing rows with material refs | 2,178 / 2,178 |
| Manufacturing rows with verification refs | 2,178 / 2,178 |
| Manufacturing rows linked to QA actions | 2,178 / 2,178 |
...
|---|---:|
| `project_kit` | 3,947 |
| `rolling_stock_bom` | 25,960 |
| `rolling_stock_cots_fitout` | 1,652 |
