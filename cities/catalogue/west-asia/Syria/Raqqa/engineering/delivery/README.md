# Raqqa organisation and design work

311 indicative operating FTE, including management; annual labour allowance $365,736. Group totals reconcile to the existing finance model. Individual role shares are editable planning allocations, not measured workload or an accepted duty roster.
...
|---|---:|---:|---:|---:|---|
| corridor civil crew | 2 | 2 | 5 | 311 | civil supervisor; drainage technician; permit coordinator; plant operator; quality technician; safety officer; survey lead / trk-10-survey-utility, trk-20-subgrade-drainage |
...
| test track / depot | unknown | 2 | 666 | unknown | commissioning lead; quality manager; software technician; test operator / rs-50-dynamic-commissioning |
| track crew | 2 | 2 | 62 | 253 | quality technician; rail welder; survey technician; track supervisor / trk-30-trackform-rail |
...
| wayside systems crew | unknown | 3 | 91 | unknown | quality technician; radio technician; software technician; systems supervisor / wpt-20-install-commission |
...
|---|---:|---:|---:|---|
| line-2 13709.1–14449.1 m | 100.0 | 152 | 22 | 17.6 / 22.0 / 26.4 |
| line-3 4669.4–5097.6 m | 100.0 | 92 | 13 | 17.6 / 22.0 / 26.4 |
| line-3 12627.5–13821.5 m | 100.0 | 240 | 36 | 17.6 / 22.0 / 26.4 |
...
[Location-specific soil investigation plan](../soil/README.md). Flag counts: {"coverage-gap": 1, "fine-soil-plasticity-and-shrink-swell-tests": 84, "granular-density-and-groundwater-tests": 64}.
...
|---|---:|
| rs-finish-seal-joint | 105 |
| rs-controlled-wash | 105 |
