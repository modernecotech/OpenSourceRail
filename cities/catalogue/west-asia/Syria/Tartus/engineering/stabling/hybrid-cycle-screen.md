...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 26 / 34 | True | True | 20 / 20 | 0 | 42 | 9 |
| 2 | 26 / 34 | True | True | 20 / 20 | 0 | 42 | 9 |

Minimum train SoC across the run: 83.757%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/west-asia/Syria/Tartus/design.toml' --days 2
```
