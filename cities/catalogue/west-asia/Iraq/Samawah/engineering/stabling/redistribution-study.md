...
A uniform **two-trainsets-per-station** provision gives **40 positions at 20 stations**, leaving **68 fleet positions** elsewhere or unresolved. The larger platform reference includes four-berth interchange variants. Neither comparison verifies physical stabling capacity.
...
Reproduce after generating the continuous native replay:
