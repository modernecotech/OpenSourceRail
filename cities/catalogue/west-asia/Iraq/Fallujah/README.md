...
|---|---:|
| Imported / external capital | $109 M (24.2%) |
| Domestic / local capital | $343 M (75.8%) |
| Annual public construction commitment | $42 M / yr for 5 years |
| Annual post-grace debt service | $31 M / yr |
| External capital saved vs default turnkey sensitivity | $705 M |
...
| Operations, QA and maintenance | 250 assets / 1,181 tasks | [`fallujah-operations-manifest.json`](operations/fallujah-operations-manifest.json) |
