# Hail organisation and design work

361 indicative operating FTE, including management; annual labour allowance $10,310,160. Group totals reconcile to the existing finance model. Individual role shares are editable planning allocations, not measured workload or an accepted duty roster.
...
| test track / depot | unknown | 2 | 841 | unknown | commissioning lead; quality manager; software technician; test operator / rs-50-dynamic-commissioning |
| track crew | 2 | 2 | 63 | 326 | quality technician; rail welder; survey technician; track supervisor / trk-30-trackform-rail |
...
|---|---:|---:|---:|---|
| line-2 13700.7–15035.5 m | 100.0 | 272 | 40 | 17.6 / 22.0 / 26.4 |
...
[Location-specific soil investigation plan](../soil/README.md). Flag counts: {"coverage-gap": 33, "fine-soil-plasticity-and-shrink-swell-tests": 29, "granular-density-and-groundwater-tests": 64}.
