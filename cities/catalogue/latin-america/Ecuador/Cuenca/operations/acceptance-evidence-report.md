# Cuenca Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 314 |
| Manufacturing schedule rows | 1,492 |
| Manufacturing material/BOM rows | 22,852 |
| Manufacturing QA verification rows | 1,492 |
| Construction QA action rows | 1,260 |
| Maintenance handover schedule rows | 1,549 |
| Manufacturing rows with material refs | 1,492 / 1,492 |
| Manufacturing rows with verification refs | 1,492 / 1,492 |
| Manufacturing rows linked to QA actions | 1,492 / 1,492 |
...
|---|---:|
| `project_kit` | 1,727 |
| `rolling_stock_bom` | 19,942 |
| `rolling_stock_cots_fitout` | 1,183 |
...
| `qa-10-carbody-structure` | 507 |
| `qa-11-bogie-wheelset` | 169 |
| `qa-12-traction-brake-battery` | 169 |
| `qa-13-passenger-systems` | 169 |
| `qa-15-first-article-trainset` | 169 |
