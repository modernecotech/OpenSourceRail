...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 10 / 13 | True | True | 8 / 8 | 0 | 2 | 3 |
| 2 | 10 / 13 | True | True | 8 / 8 | 0 | 2 | 3 |

Minimum train SoC across the run: 60.670%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/east-africa/Mozambique/Quelimane/design.toml' --days 2
```
