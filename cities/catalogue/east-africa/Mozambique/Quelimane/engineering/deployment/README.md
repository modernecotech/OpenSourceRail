# Quelimane deployment gaps

5 closed checks; 11 open gates. Status follows the linked evidence; generating a receipt template does not count as receiving field data.
