# Xai-Xai operations cross-check
...
|---|---:|---:|---:|---:|---|
| line-1 | 919.7 s | 930.5 s | 10.8 s | 138.0 s | pass |
| line-2 | 728.3 s | 737.5 s | 9.2 s | 120.0 s | pass |
| line-3 | 243.3 s | 240.0 s | -3.3 s | 120.0 s | pass |
