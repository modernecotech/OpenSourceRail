# Nairobi Acceptance And Accreditation Evidence Basis
...
| Item | Count / Status |
|---|---:|
| Assets in register | 1,657 |
| Manufacturing schedule rows | 6,576 |
| Manufacturing material/BOM rows | 102,338 |
| Manufacturing QA verification rows | 6,576 |
| Construction QA action rows | 6,180 |
| Maintenance handover schedule rows | 7,824 |
| Manufacturing rows with material refs | 6,576 / 6,576 |
| Manufacturing rows with verification refs | 6,576 / 6,576 |
| Manufacturing rows linked to QA actions | 6,576 / 6,576 |
...
|---|---:|
| `project_kit` | 9,908 |
| `rolling_stock_bom` | 86,900 |
| `rolling_stock_cots_fitout` | 5,530 |
...
| `qa-10-carbody-structure` | 1,580 |
| `qa-11-bogie-wheelset` | 790 |
| `qa-12-traction-brake-battery` | 790 |
| `qa-13-passenger-systems` | 790 |
| `qa-15-first-article-trainset` | 790 |
| `qa-20-survey-geotech` | 142 |
| `qa-21-earthworks-drainage` | 142 |
| `qa-22-trackform-rail` | 412 |
| `qa-24-stations-depots-plant` | 304 |
| `qa-25-power-energy` | 249 |
| `qa-26-wayside-comms-safety` | 586 |
