# Nyeri Acceptance And Accreditation Evidence Basis
...
| Manufacturing schedule rows | 657 |
| Manufacturing material/BOM rows | 9,953 |
| Manufacturing QA verification rows | 657 |
| Construction QA action rows | 614 |
| Maintenance handover schedule rows | 776 |
| Manufacturing rows with material refs | 657 / 657 |
| Manufacturing rows with verification refs | 657 / 657 |
| Manufacturing rows linked to QA actions | 657 / 657 |
