# Kisumu Acceptance And Accreditation Evidence Basis
...
| Manufacturing material/BOM rows | 15,797 |
| Manufacturing QA verification rows | 1,069 |
| Construction QA action rows | 898 |
| Maintenance handover schedule rows | 1,412 |
