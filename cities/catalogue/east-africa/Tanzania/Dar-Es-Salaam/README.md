...
The strict README generator rejected the evidence: engineering/simulation/validation-summary.json describes scenario SHA-256 06403a371421be6c617a271dc22450ac31ec910d6d7b60f43cef0e66478b9e5b, but dar-es-salaam.toml is 87056eb4c1521a15cd1cf664539a9fb25777c4925e9b72901e564a32786472c5; rerun and update the validation evidence. This audit view does not accept or replace the retained solver results.
...
| Solar/storage snapshot (operating duty unverified) | unverified; 0 findings; 50 grid-only diagnostics | [`summary.json`](engineering/energy/summary.json) |
| Operations, QA and maintenance | 1,470 assets / 8,769 tasks | [`dar-es-salaam-operations-manifest.json`](operations/dar-es-salaam-operations-manifest.json) |
