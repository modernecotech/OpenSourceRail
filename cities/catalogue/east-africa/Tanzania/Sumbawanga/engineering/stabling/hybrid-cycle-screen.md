...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 20 / 20 | True | True | 14 / 14 | 0 | 0 | 9 |
| 2 | 20 / 20 | True | True | 14 / 14 | 0 | 0 | 9 |

Minimum train SoC across the run: 86.781%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/east-africa/Tanzania/Sumbawanga/design.toml' --days 2
```
