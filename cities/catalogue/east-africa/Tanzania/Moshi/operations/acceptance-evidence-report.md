...
| Maintenance handover schedule rows | 911 |
...
- Tracked compact asset register: [`moshi-assets.csv`](moshi-assets.csv)
- Tracked operations manifest: [`moshi-operations-manifest.json`](moshi-operations-manifest.json)

The following high-volume files are regenerated in the local city
package and intentionally excluded from Git. Their names are recorded
for handover without presenting unavailable GitHub links:

- `moshi-operations.json.gz`
- `moshi-acceptance-evidence-matrix.csv`
- `moshi-manufacturing-schedule.csv`
- `moshi-manufacturing-materials.csv`
- `moshi-manufacturing-verification.csv`
- `moshi-qa-register.csv`
- `moshi-maintenance-schedule.csv`
