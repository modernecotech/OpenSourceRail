...
| Manufacturing schedule rows | 2,395 |
| Manufacturing material/BOM rows | 5,270 |
| Manufacturing QA verification rows | 2,395 |
| Construction QA action rows | 1,987 |
| Maintenance handover schedule rows | 2,628 |
| Manufacturing rows with material refs | 2,395 / 2,395 |
| Manufacturing rows with verification refs | 2,395 / 2,395 |
| Manufacturing rows linked to QA actions | 2,395 / 2,395 |
