...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 12 / 15 | True | True | 10 / 10 | 0 | 7 | 3 |
| 2 | 12 / 15 | True | True | 10 / 10 | 0 | 7 | 3 |

Minimum train SoC across the run: 67.975%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/east-africa/Angola/Uige/design.toml' --days 2
```
