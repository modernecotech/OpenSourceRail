...
|---|---:|---|---|---:|---:|---:|---:|
| 1 | 12 / 11 | True | True | 8 / 8 | 0 | 0 | 5 |
| 2 | 12 / 11 | True | True | 8 / 8 | 0 | 0 | 5 |

Minimum train SoC across the run: 90.011%. Reserve departures: 0.
...
```bash
.venv/bin/python tools/automation/screen-hybrid-stabling.py --design 'cities/catalogue/east-africa/Uganda/Soroti/design.toml' --days 2
```
