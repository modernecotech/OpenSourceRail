...
documentation in `control-electronics/`, while the consist-level quantities and
...
- [`design/component-catalogue/src/osr_mech/rolling_stock/systems.py`](../design/component-catalogue/src/osr_mech/rolling_stock/systems.py)
...
- `control-electronics/` owns board architecture, DIY/COTS integration packs,
  schematics, custom-board gerbers, board-level BOMs, wiring maps,
  enclosure notes, and bring-up evidence.
- `design/component-catalogue/` owns physical CAD envelopes, FreeCAD review
