...
`design/component-catalogue/catalog/fixtures/` and the rolling-stock system
assemblies under `design/component-catalogue/catalog/rolling_stock/`.
...
Generated from `design/component-catalogue/src/osr_mech/rolling_stock/cots_equipment.py`
