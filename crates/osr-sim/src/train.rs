...
pub enum TrainPhase {
    ...
    Dwelling {
        station: StationId,
        remaining_s: f32,
        /// Remaining concurrent depot cleaning + safety inspection time.
        /// Zero at ordinary stations.
        depot_service_remaining_s: f32,
...
impl Train {
    ...
    pub fn kwh_per_km(&self, hvac_uplift_frac: f32) -> f32 {
        let per_car_km = self.energy_kwh_per_car_km * (1.0 + hvac_uplift_frac);
