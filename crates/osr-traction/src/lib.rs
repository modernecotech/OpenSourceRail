...
//!
//! RFC 0021's reference consist has six independently isolated
//! motor/controller sets (two per car) on a 650–700 V nominal DC link. This
//! crate supervises their aggregate torque/current envelope; per-axle FOC,
//! current sensing, and isolation remain drive-controller responsibilities.
//!
//! # API shape
//!
