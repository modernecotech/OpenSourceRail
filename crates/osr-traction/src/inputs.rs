...
impl TractionParams {
    /// Aggregate defaults for the RFC 0021 light-metro three-car set:
    /// six 350 kW-peak motor/controller channels, subject to the train-level
    /// 1.8 MW operational power cap outside this torque supervisor.
    #[must_use]
    pub fn light_metro_default() -> Self {
        Self {
            max_torque_mnm: 12_000_000,    // six channels, 12 kN·m aggregate
