...
//!   HVAC / lighting / PIS / event records.
//!
...
//!   `recv(B)` for A ≠ B.
//! - **T6 class immutability:** once a topic is bound to a traffic
//!   class, a publisher cannot downgrade or replace that class.
//! - **T7 registry determinism:** equal ordered topic sets produce
//!   equal IDs across independent nodes.
