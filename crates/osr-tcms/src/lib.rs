...
pub struct TcmsInputs {
    ...
    pub remote_assist_emergency: bool,
...
/// Emergency-source bitmask, mirrors the five O4-topic sources
/// (ATP + fire + derailment + remote assistance + obstacle).
#[derive(Copy, Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
...
impl EmergencySources {
    ...
    pub fn any(&self) -> bool {
        self.atp || self.fire || self.derailment || self.remote_assist || self.obstacle
    }
    #[must_use]
...
pub fn tcms_evaluate(inputs: &TcmsInputs) -> ConsistStatus {
    ...
    ConsistStatus {
        ...
        direct_hv_enabled: inputs.direct_hv_enabled,
