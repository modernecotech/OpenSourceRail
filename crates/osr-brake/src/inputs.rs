...
pub struct BrakeInputs {
    ...
    /// Authenticated OCC escalation of a passenger-intercom call
    /// (RFC 0015 §5.3). The initial intercom press requests a controlled
    /// service stop, not emergency brake.
