...
fn arb_inputs() -> impl Strategy<Value = AuxInputs> {
    (
        ...
        .prop_map(
            |(now, soc, cc, ot24, ot110, ot400, df24, df110, df400, e24, e110, e400)| AuxInputs {
                now_ns: now,
                pack_soc_ppt: soc,
                pack_contactor_closed: cc,
                v24_over_temp: ot24,
                v110_over_temp: ot110,
                v400_over_temp: ot400,
                v24_drive_fault: df24,
                v110_drive_fault: df110,
                v400_drive_fault: df400,
                v24_enable_request: e24,
                v110_enable_request: e110,
                v400_enable_request: e400,
            },
        )
}
...
proptest! {
    ...
    fn ap2_shedding_monotone_in_soc(
        ...
        let base = AuxInputs {
            ...
            v24_over_temp: false, v110_over_temp: false, v400_over_temp: false,
            v24_drive_fault: false, v110_drive_fault: false, v400_drive_fault: false,
            v24_enable_request: true, v110_enable_request: true, v400_enable_request: true,
        };
        ...
        prop_assert!(!(out_lo.v400_enabled && !out_hi.v400_enabled));
    ...
    fn rails_sheddable_do_not_exceed_enabled_parent(i in arb_inputs()) {
        // Sanity: at any tick, 400 V enabled ⇒ 110 V also enabled
        ...
        clean.v400_over_temp = false;
        clean.v400_drive_fault = false;
        clean.v400_enable_request = true;
        let out = aux_evaluate(&AuxState::default(), &clean, &p);
        if out.v400_enabled {
            prop_assert!(out.v110_enabled, "400V enabled but 110V not: soc={}", clean.pack_soc_ppt);
        }
