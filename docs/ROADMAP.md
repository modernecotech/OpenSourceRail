...
| Software integration | Same-origin revision/simulation/OCC/Ops Core Workbench context is implemented; RFC 0017 signed live consensus actions, TSN transport maturation, CBM service integration, and authenticated GUI live-data paths remain |
