...
| City Studio | Git-backed city projects, source locks, complete manual line/station/alignment authoring, semantic revision comparison, weekly service planning, deterministic manifests, source-locked demand-aware alternatives, controlled GIS/simulation/alignment/IFC4.3 civil jobs, and hash-verified GIS/alignment/IFC object evidence viewers (implemented); demand/OD and approval records next |
