...
| Software integration | Workbench context and onboard TCMS/event-recorder/hot-axle/CBM/T2G software-in-loop are implemented; signed live consensus actions, production TSN/radio transports, depot CBM ingestion, station/wayside harnesses, and authenticated live GUI paths remain |
