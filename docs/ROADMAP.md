...
| Rolling stock | The 101-part/26-assembly IFC and FreeCAD design-reference library is present and completeness-tested; supplier freeze, installed-coordinate/tolerance closure, production drawings, weld/NDT packs, crash/structure/thermal/HV/fire qualification and first articles remain | [LM3 gap register](../design/component-catalogue/catalog/buildable-trainset/open-release-gaps.md) and [drawing register](rolling-stock/light-metro-3car/drawing-register.md) |
