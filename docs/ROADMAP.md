...
| City Studio | Git-backed city projects, source locks, complete manual line/station/alignment authoring, semantic revision comparison, weekly service planning, deterministic manifests, source-locked demand-aware alternatives (implemented), and controlled CAD/GIS/simulation tool adapters (next) |
