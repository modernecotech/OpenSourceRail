...
| City Studio | Git-backed city projects, source locks, complete manual line/station/alignment authoring, semantic revision comparison including BCF decisions, weekly service planning, deterministic manifests, source-locked demand-aware alternatives, controlled GIS/simulation/alignment/IFC4.3 civil jobs, hash-verified GIS/alignment/IFC object/IDS/BCF evidence viewers, and evidence-gated coordination status management (implemented); native 3D BIM streaming, new topic authoring, demand/OD and approval records next |
