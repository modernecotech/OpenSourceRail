...
| Rolling stock | The 101-part/26-assembly IFC and FreeCAD design-reference library and nine solver-backed structural screens are present; the 67 product gaps now have controlled status and routes through 12 evidence packages. Supplier freeze, production FEA/drawings, weld/NDT, thermal/HV/fire tests and first articles remain. | [LM3 public work packages](../design/component-catalogue/catalog/buildable-trainset/first-article-work-packages.md), [evidence status](../design/component-catalogue/catalog/buildable-trainset/first-article-evidence-status.md) and [drawing register](rolling-stock/light-metro-3car/drawing-register.md) |
