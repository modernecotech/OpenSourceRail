...
| Rolling stock | The 120-part/26-assembly IFC and FreeCAD design-reference library, nine solver-backed structural screens, 41 manufacturer/research candidates covering all 56 bought-in rows, 10 factory drawing/interface packages, and one executable 12-gate first-article route are present. Supplier configuration freeze, production FEA/drawings, weld/NDT, thermal/HV/fire tests and first articles remain. | [COTS/RFQ candidates](../design/component-catalogue/catalog/buildable-trainset/cots-candidates.md), [factory release packages](../design/component-catalogue/catalog/buildable-trainset/factory-release-work-packages.md), [LM3 public work packages](../design/component-catalogue/catalog/buildable-trainset/first-article-work-packages.md), [execution pack](../design/component-catalogue/catalog/buildable-trainset/first-article-execution-pack.md) and [evidence status](../design/component-catalogue/catalog/buildable-trainset/first-article-evidence-status.md) |
