...
each repeated 16.5 m car module. All bogies use the RFC 0022 suspension,
...
- **Power electrical:** 650–700 V nominal traction DC plus isolated 110 V and
  24 V DC services through
  a cableguide at the centre pin; not through the pivot itself.
- **Air:** local secondary-suspension levelling only, fed by one compact
  compressor/dryer/reservoir/isolation manifold per car module. No
  trainwide pneumatic brake or door supply per RFC 0008 §3.2.
