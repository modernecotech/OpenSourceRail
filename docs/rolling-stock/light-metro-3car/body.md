...
clipped one-metre fiberglass cladding and COTS passenger-facing modules.
The design avoids large aluminium extrusion dies, stainless body
pressings, and bespoke door/window/HVAC development.

## Architecture

Each 16.5 m car is split into four production zones:
...
| Composite exterior | 1 m-wide fire-rated fiberglass sandwich modules | Clipped, replaceable weather skin, insulation, aerodynamics, livery surface |
...
| `car_body_exterior()` | Sixteen 1 m fiberglass side/roof bays with clips and dry seals, plus glazing, door leaves, livery, skirts, roof PV, and HVAC |
...
Exterior body modules hang from keyed rails and are mechanically retained to
the steel frame. The common design is controlled in
[`modular-fiberglass-body.md`](modular-fiberglass-body.md):

| Panel | Construction | Attachment |
|---|---|---|
| Side skin | 28 mm nominal fire-rated GFRP sandwich; 1,000 mm pitch / 994 mm finished width | Keyed hook, captive over-centre clips, independent anti-lift retainer, dry EPDM joint |
| Roof fairing | 28 mm nominal GFRP sandwich; 1,000 mm pitch / 994 mm finished width | Same clip grid; removable above HVAC/equipment |
...
Cabin fiberglass/phenolic parts are controlled separately because they
are passenger-facing and have different fire, edge-radius, rattle, and
service-removal rules from the exterior cowls. See
[`cabin-fiberglass.md`](cabin-fiberglass.md) for the ceiling liner,
sidewall/window reveal, battery strake cover, vestibule kick-panel,
PRM transition, tooling, lay-up/trim, inspection, and repair
instructions.
...
- Roof HVAC: one 24 kW nominal packaged unit per car, hot-climate
...
## Keyed composite cassette interface

The steel underframe and spaceframe are the permanent datum skeleton. Side and
roof weather modules use the dry LM3-BDY-160 interface; door, window, skirt,
nose, and interior cassettes retain their component-specific interfaces:

- a 3-2-1 locating scheme, with two primary locating pins and an asymmetric
  third locator that prevents reversed installation;
- captive clips and a standard 1,000 mm longitudinal pitch;
- a replaceable EPDM compression seal, drained secondary rail, and visible
  latch witness mark for side/roof modules;
- independent mechanical anti-lift retention;
- dedicated bonding/grounding studs; and
- keyed quick connectors located outside wet drainage paths.

Fastener holes clamp the cassette; they do not establish body geometry.
Location is owned by the datum features. Production adhesive is not used at
the removable side/roof body-to-frame joint. Glazing and released non-service
end-cowl seams retain their qualified adhesive processes. The fiberglass nose
remains a sacrificial shell over the steel crash structure.

## Molded service infrastructure

Composite parts may incorporate empty HVAC supply/return geometry,
condensate drains, cable raceways, conduit paths, clip lands, lighting
recesses, and equipment bosses. Consumable services remain removable:

- no cable, coolant pipe, sensor, lamp, fan, filter, evaporator, damper, or
  connector is encapsulated in laminate;
- passenger-side service covers provide removal access without cutting the
  panel;
- wiring is installed as keyed, labelled, pre-terminated looms; and
- main roof air-duct geometry may be molded into the sandwich, but every
  active HVAC component remains a separate service module.

The cassette release test includes datum repeatability, insert pull-out,
bond durability, water ingress, bond continuity, fire/smoke/toxicity, and a
timed service-removal demonstration.
...
- 3-2-1 locator, asymmetric key, fastener-grid, sealant-groove, bonding, and
  quick-connector interface drawings.
