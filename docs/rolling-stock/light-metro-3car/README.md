...
| [`factory-drawings/index.md`](../../../design/component-catalogue/catalog/buildable-trainset/factory-drawings/index.md) | Twenty-nine individual drafting/checking briefs binding the sixteen packages to products, reference envelopes, sources, tooling, views, controls and verification without claiming manufacturing issue |
| [`factory-release-readiness.md`](../../../design/component-catalogue/catalog/buildable-trainset/factory-release-readiness.md) | Open issue/approval state across all 16 drawing, product-configuration, tooling and verification packages |
...
| [`manufacturing-and-assembly-controls.md`](../../../design/component-catalogue/catalog/buildable-trainset/manufacturing-and-assembly-controls.md) | Ten default work instructions covering datum control, steel, bolting, bonding/glazing, GFRP/fascia moulding, roof, interiors, lifting/recovery, finish and NCR handback |
| [`first-article-inspection-plan.md`](../../../design/component-catalogue/catalog/buildable-trainset/first-article-inspection-plan.md) | 416 package-specific hold, witness and record-review characteristics with every execution result left unperformed |
...
| [`trainset-factory-layout.png`](../../../docs/screenshots/trainset-factory-layout.png) | Pilot factory layout with one 55 m final bay, chassis/body-frame fixtures, GFRP moulding/trim, bogie assembly, interior/HVAC kits, corrosion/base-finish cells, stores, QA, yard staging, and short test access |
