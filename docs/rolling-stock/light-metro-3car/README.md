...
| [`factory-drawings/index.md`](../../../design/component-catalogue/catalog/buildable-trainset/factory-drawings/index.md) | Eighteen individual drafting/checking briefs binding the ten packages to products, reference envelopes, sources, tooling, views, controls and verification without claiming manufacturing issue |
| [`factory-release-readiness.md`](../../../design/component-catalogue/catalog/buildable-trainset/factory-release-readiness.md) | Open issue/approval state across all ten drawing, product-configuration, tooling and verification packages |
