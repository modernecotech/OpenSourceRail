...
The train is built from three repeated 16.5 m car modules:

| Zone | Fabricated parts | COTS / BID modules | Parametric source |
|---|---|---|---|
| End cowls | Steel crash frame, multi-part fiberglass A/B-end cowl casts, cowl backing ring, single panoramic glass carrier, LED lamp brackets | Dark RF-transparent laminated end glass pane, T-OBS LIDAR/radar/camera/ultrasonic pack, LED headlamps, marker/DRL bars, washer/heater | [`end-cowl.md`](end-cowl.md), [`sensor_cowl.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/sensor_cowl.py), [`systems.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/systems.py) |
| Body side | S355 side frame, two door portals per side, window rail, waist rail, composite skin | Window cassettes, door cassettes, green livery band, yellow thresholds | [`car_body.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/car_body.py) |
| Stepped floor | Dropped ~10 m low-floor centre pan, ~3 m raised bogie-end deck supports, side plinth rails, transition steps | Phenolic/aluminium floor boards, rubber covering, step nosings, PRM floor finish | [`car_body.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/car_body.py), [`cad_templates/rolling_stock.py`](../../../design/component-catalogue/src/osr_mech/cad_templates/rolling_stock.py) |
| Roof | Roof bows, PV/HVAC rails, bonded-pad lands, cable tray brackets, composite fairings | Bonded flexible PV laminates, raised rigid panels on clamped rails, MPPT combiner, compact HVAC units, antennas | [`car_body.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/car_body.py), [`systems.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/systems.py) |
| Under-seat bay | Battery tray rails, service covers, outward vent path, mist-pipe/nozzle datums, seat support rail | 225 kWh-per-car LFP modules, BMS, fuses, contactors, mist pump/sensors, longitudinal seat modules | [`car_body.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/car_body.py), [`systems.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/systems.py) |
| Underframe | Side sills, centre spine, cross bearers, bolsters, jacking pads | Six motor controllers, isolated LV DC/DC, protected station/PV DC interfaces, HV cabling, cooling loops, brake/WSP harnesses | [`cad_templates/rolling_stock.py`](../../../design/component-catalogue/src/osr_mech/cad_templates/rolling_stock.py), [`systems.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/systems.py) |
| Running gear | Bogie adapter, motor cradle, torque-link brackets | Three powered bogies, three trailer bogies, wheelsets, brakes, bearings, air springs | [`bogie/`](../../../design/component-catalogue/src/osr_mech/rolling_stock/bogie/) |
| Train ends and inter-car | Coupler pocket, shear plate, articulation adapter frames, underframe anchor castings, upper clevis brackets, trainline brackets | Scharfenberg Type 10 couplers, crash absorbers, lower spherical articulation joint, upper links, bellows, turntable floor, energy-guidance chains | [`systems.py`](../../../design/component-catalogue/src/osr_mech/rolling_stock/systems.py), [`articulation.md`](articulation.md) |
...
| Rooftop PV, mounts, and air cleaner | Bonded-pad lands, roof PV rails, edge-clamp datums, cable gland, blower/nozzle hardpoints | Six bonded flexible laminates and six raised rigid modules per car, isolated combiner, MPPT feed, fire disconnect, filtered low-pressure air-knife cleaner | IEC PV module data, adhesive/bond coupon test, rail vibration mount evidence, blower IP/noise data, filter access proof, soiling-recovery test |
| Station/PV DC interfaces | Underframe charge-rack rails and cooling ports | Per-car roof MPPT, protected station DC input, contactors, precharge, CAN/Ethernet | Rail power-electronics datasheet, insulation/earthing analysis, EMC/vibration evidence, charge-state validation |
| HVAC unit | Roof equipment rails and condensate drain | Bolted rail pattern, molded/removable duct adapter, direct 650–700 V DC, CAN/Ethernet diagnostics | 50 °C hot-climate curve, vibration, EMC, refrigerant record |
...
| Solar panels, air cleaner, and MPPT | Mixed bonded/raised roof PV modules, filtered air pump/manifold, roof combiner, MPPT in every car systems rack | T21, T22, T23 | `car_body.py`, `systems.py` |
...
| [`trainset-car-body-exterior.png`](../../../docs/screenshots/trainset-car-body-exterior.png) | Exterior glazing, door leaves, livery band, skirts, mixed bonded/rail-mounted solar array, and compact HVAC roof units |
| [`trainset-roof-solar-system.png`](../../../docs/screenshots/trainset-roof-solar-system.png) | Rooftop PV package: bonded flexible laminates, raised rigid panels, mounting rails, edge clamps, junction boxes, isolators, MPPT combiner, and downlink gland |
...
| [`trainset-car-systems.png`](../../../docs/screenshots/trainset-car-systems.png) | Batteries, four door cassettes, platform safety interfaces, roof PV/MPPT package, DC charge/protection rack, charging connector, wheelchair bays, systems layout |
