...
| Flat-pattern and NC output | DXF/STEP flat patterns, bend tables, nesting sheets, drilling/cutting programs | Shop can cut and bend one carbody kit without interpreting 3D envelopes |
...
Build123d and STEP models may stay supplier-neutral until procurement
