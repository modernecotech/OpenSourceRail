...
| Factory drawing/interface packages | Ten generated work packages for chassis, exterior modules, panoramic glass, lamps, roof equipment, interiors, fixture rails, livery film, trial roof coating and recovery | Every package has frozen inputs, approved controlled outputs, characteristic list, verification owner and evidence route; the generated package itself is not an approval |
