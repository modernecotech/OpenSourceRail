...
|---|---|---|
| Design baseline freeze | Signed LM3 configuration sheet covering 3 repeated cars, 3 powered bogies, 3 trailer bogies, 360 kWh usable onboard battery, 102 t tare target, two door pairs per side per car, and no city-specific train variant | Drawing register, BOM, RFC 0008, RFC 0021, RFC 0022, and `trainset.py` all agree |
...
| First-car build hold point | One 17 m carbody shell, one powered bogie, one trailer bogie, one battery enclosure set, one door bay, and one roof/HVAC/PV bay built and inspected before committing all three cars | Dimensional/NDT findings are closed or fed back into rev B tooling before repeat production |
