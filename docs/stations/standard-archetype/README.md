...
**Generic platform length:** 49.5 + 10 = **59.5 m**.
...
The whole point of RFC 0010's six-base-archetype catalogue and its
controlled elevated-interchange variant is to avoid
