...
| OSR-STD-A-014 | Entrance, validator, and fare-plinth elevations | 1:20 | A1 | Envelope §Sub-areas |
| OSR-STD-A-015 | Canopy, cabinet, plinth, and platform finish schedule | n/a (table) | A1 | Canopy §Per-deployment customisation |
