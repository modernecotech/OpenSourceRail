...
| [osr-vigilance](../../crates/osr-vigilance/) | V1–V6 (determinism, suppression, warning precedes trip, tripped iff emergency, in-window ack clears, trip latches) | proptest + Kani for V1–V6 in [`src/kani_proofs.rs`](../../crates/osr-vigilance/src/kani_proofs.rs) |
