...
**Status:** Draft — v1 architecture, certification evidence open
**Date:** 2026-04-26
...
commits each 17 m car to one large centre double-leaf plug-door
cassette per side: six exterior cassettes, twelve leaves, and a
...
`light-metro-3car` consist (6 exterior cassettes): **~$12 k DIY
operator BOM** vs **$120 k–$240 k vendor** before certification and
...
| 2026-05-20 | v1 | Aligned count with `light-metro-3car` door layout, added interface contract and release checklist. |
