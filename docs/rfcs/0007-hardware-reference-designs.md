...
| **v1** ✅ | Bring-up board for each class on vendor dev kits (RPi CM5 dev kit, Radxa CM5 dev kit, Raspberry Pi Pico 2 — which carries the RP2350) — validate software boots and all peripherals enumerate. Runbooks are colocated with each host under [`hardware/`](../../hardware/) (done 2026-04-22) | — |
