...
`osr-door-control`, `osr-fire-safety`,
...
`osr-tcms`, `osr-pis-onboard`, `osr-hvac`,
...
| USB 2.0 | 2 | Diagnostics and PIS service |
...
| **v1** ✅ | Bring-up board for each class on vendor dev kits (RPi CM5 dev kit, Radxa CM5 dev kit, Raspberry Pi Pico 2 — which carries the RP2350) — validate software boots and all peripherals enumerate. Runbooks are colocated with each host under [`control-electronics/`](../../control-electronics/) (done 2026-04-22) | — |
| **v2** ✅ (spec) | Board-level specifications for every host class: T-ECU/S at [`control-electronics/t-ecu-s/schematics/v2-spec/`](../../control-electronics/t-ecu-s/schematics/v2-spec/) (done 2026-04-22), T-OBS at [`control-electronics/t-obs/schematics/v2-spec/`](../../control-electronics/t-obs/schematics/v2-spec/) (done 2026-04-22), T-ECU/A at [`control-electronics/t-ecu-a/schematics/v2-spec/`](../../control-electronics/t-ecu-a/schematics/v2-spec/), W-SBC at [`control-electronics/w-sbc/schematics/v2-spec/`](../../control-electronics/w-sbc/schematics/v2-spec/), S-SBC at [`control-electronics/s-sbc/schematics/v2-spec/`](../../control-electronics/s-sbc/schematics/v2-spec/) (all done 2026-04-23). Each covers block diagram, power budget, connector tables, and (for SIL-4 boards) safety-nets. KiCad capture + gerbers + BOM are custom-board deliverables under CERN-OHL-S v2, not prerequisites for an RFC 0019 pilot build. | v1 |
...
- **`control-electronics/` directory.** The top-level directory now carries one
  subdirectory per class, board-level v2 specifications where
  available, RFC 0019 DIY assembly docs, and an explicit
  [`control-electronics/release-checklist.md`](../../control-electronics/release-checklist.md)
...
this RFC's §§4–7, (d) file v1 deliverable as a `control-electronics/` folder
update.
