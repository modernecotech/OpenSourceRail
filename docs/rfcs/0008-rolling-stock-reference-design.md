...
| Nose geometry | **Single panoramic glass end + sensor cowl + coupler, no cab door.** Cars are symmetric end-to-end; passenger floor extends to the full car length. | ~14 extra seats per `light-metro-3car` consist; ~$150 k + ~2.3 t saved vs. a cabbed reference |
