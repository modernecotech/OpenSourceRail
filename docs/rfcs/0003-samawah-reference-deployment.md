...
- **Line 1** — 21.0 km / 13-station south-north radial.
- **Line 2** — 22.2 km / 12-station southwest-north radial with the
  generated main depot-terminal.
- **Line 3** — 11.7 km / 8-station east-northwest radial.
...
|---|---:|---:|---:|---|---|
| line-1 | 21.0 km | 13 | 35 | S Outer ↔ N Outer | Long south-north radial through the strongest health, education, and central-city anchors |
| line-2 | 22.2 km | 12 | 36 | SW Outer ↔ N Mid | Southwest-north radial, including the generated depot-terminal / main maintenance anchor |
| line-3 | 11.7 km | 8 | 20 | E Mid ↔ NW Mid | Shorter radial filling the remaining east/northwest catchment |
...
**63.1–100.9 M annual paid trips**, based on 50–80% use of practical
...
- **55 km / 33 stations / 91 trainsets** is a full multi-phase build-out
...
- Station/depot stationary storage: **113.5 MWh Na-ion**
...
Onboard: **91 trainsets × 360 kWh = 32.8 MWh** fleet battery capacity,
of which 81 trainsets are revenue fleet and 10 are spare/cold reserve.
...
Applying RFC 0002's cost basis to the current generated 54.9 km city
instance:
...
25 kV AC OCS plus traction substations; scaling that to 54.9 km would be
on the order of **$330 M** before local feeder works. The OSR energy
...
91-trainset timetable, applies station charging and roof PV, and can
...
4. **Fleet and charging validation.** Stress the 81+10 trainset fleet,
...
5. **Construction phasing.** Full network in one go is unlikely.
   ...
   expanding to the full 54.9 km network.
