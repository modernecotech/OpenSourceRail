...
4 role families); `osr-safety-case` GSN tree links every claim
...
documents the automated ATO and OCC-visible behaviour.
...
(ATP + fire + derailment + authenticated remote assistance + obstacle);
SR-15 — EB dominates.
...
**Evidence:** RFC 0013 §5; dispatcher rules S7 + S5.
