...
| Station charging and site energy | Deterministic release screens cover end-of-life capacity, maximum climate/HVAC duty, reduced charging contacts, a ten-hour cabinet/pad outage and all-site grid outage; unit tests cover full-storage refusal and simultaneous contact sharing | Add the deployment timetable's combined aged-battery/high-ambient case, consecutive missed-stop pattern and late-running conflict case; then complete site solar yield, grid interconnect, charger thermal study and utility approval |
