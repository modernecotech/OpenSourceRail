# OpenSourceRail × Transportation Research Board
<!-- Generated by scripts/generate-marketing-campaigns.py. -->

Tailored partnership approach for **Transportation Research Board**.
...
| Intended recipient | Relevant standing technical committee or international activities team |
| Named public contact | None; use the official organisational route |
| Public route | Official form/contact route only |
| Official contact | [https://www.nationalacademies.org/trb/transportation-research-board](https://www.nationalacademies.org/trb/transportation-research-board) |
| Contact source | [https://www.nationalacademies.org/trb/transportation-research-board](https://www.nationalacademies.org/trb/transportation-research-board) |
| Last checked | 2026-08-29 |
| Programme fit | Peer-reviewed transport research, technical committees, methods and international knowledge exchange |

**Routing constraint:** Use the appropriate committee, conference or publication process; TRB does not validate unsolicited system designs.
