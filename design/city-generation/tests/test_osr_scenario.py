...
SAMAWAH_SCENARIO = REPO_ROOT / "cities/catalogue/west-asia/Iraq/Samawah/samawah.toml"
MOSUL_DESIGN = REPO_ROOT / "cities/catalogue/west-asia/Iraq/Mosul/design.toml"
BASRA_DESIGN = REPO_ROOT / "cities/catalogue/west-asia/Iraq/Basra/design.toml"
...
def test_catalog_ring_with_repeated_closing_station_becomes_wrap_segment() -> None:
    lyon_design = REPO_ROOT / "cities/catalogue/europe/France/Lyon/design.toml"
...
def test_generated_file_in_repo_matches_regenerated() -> None:
    """The committed cities/catalogue/west-asia/Iraq/Samawah/samawah.toml must match what the generator
    would produce today — catches the "someone hand-edited the generated
    file" regression."""
    committed = (REPO_ROOT / "cities/catalogue/west-asia/Iraq/Samawah/samawah.toml").read_text()
    regenerated = generate_from_path(SAMAWAH_DESIGN)
    assert committed == regenerated, (
        "cities/catalogue/west-asia/Iraq/Samawah/samawah.toml is out of sync with design.toml; run "
