...
6. **Place stations along the line.** Walk the polyline; for each
   ...
   consecutive stations on the same line. The default minimum is 1.2 km for
   OSR light-metro plans; deployments can lower it only when they
   intentionally select a tram-like stop pattern.
...
def plan_arterial_network(
    ...
    *,
    ...
    min_station_spacing_m: float = 1_200.0,
