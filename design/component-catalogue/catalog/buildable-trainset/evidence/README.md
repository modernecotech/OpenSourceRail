...
reconciliation, `factory-release-record-template.json` for the ten drawing,
product-revision, tooling and verification packages, and
`submission-template.json` for the independent gate
...
The factory-release template likewise keeps every drawing, prerequisite,
product configuration, tool, verification and approval explicitly open until
accountable evidence is entered.
