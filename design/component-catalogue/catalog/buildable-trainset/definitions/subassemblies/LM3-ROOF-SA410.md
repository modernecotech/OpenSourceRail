...
### 4. `LM3-EXT-P040` — hvac-24kw-direct-hv-dc roof HVAC
...
### 5. `LM3-EXT-P050` — roof PV module and edge-clamp kit
...
### 6. `LM3-EXT-P070` — roof antennas, service walkway pads, lifting covers, and maintenance labels
...
### 7. `LM3-TRC-P050` — roof-mounted regen dump resistor and thermal shield kit
