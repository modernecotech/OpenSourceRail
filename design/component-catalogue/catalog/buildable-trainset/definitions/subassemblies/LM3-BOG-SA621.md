# LM3-BOG-SA621 — trailer-bogie running unit: wheelsets, axleboxes, primary suspension and brakes
...
### 1. `LM3-BOG-P041` — trailer-bogie wheelset with axle-mounted brake discs
...
### 2. `LM3-BOG-P043` — trailer-wheelset axlebox, sealed bearing unit, speed and temperature sensor set
...
### 3. `LM3-BOG-P045` — trailer-bogie primary suspension spring, guide and bump-stop set
...
### 4. `LM3-BOG-P049` — trailer-bogie brake calipers, parking actuators, pads and wheel-slide hardware
