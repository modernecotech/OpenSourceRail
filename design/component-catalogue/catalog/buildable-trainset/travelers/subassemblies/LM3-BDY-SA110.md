...
|---:|---|---|---:|---|---|---|
| 10 | release traveler, fixture, child kit, and latest definition package | weld and fixture cell | 0.77 | `TRV-LM3-BDY-SA110`<br>`FIX-LM3-BDY-SA110`<br>`KIT-LM3-BDY-SA110` | all child definitions/revisions match the traveler index | cell lead |
...
| 90 | hold point: post-weld datum survey | quality inspection | 0.35 | `GAUGE-LM3-BDY-SA110` | post-weld datum survey | quality inspector |
| 100 | close traveler, attach nonconformance/deviation log, and release to next parent | production control | 0.3 | `REL-LM3-BDY-SA110`<br>`NCR-LM3-BDY-SA110` | all operation and QA signoffs are complete | manufacturing engineer |
