...
| 120 | install and integrate LM3-INT-P040: FRP battery strake covers, seat-base fairings, and service-hatch shells | final assembly and commissioning cell | 1.47 | `FIX-LM3-INT-SA330`<br>`GAUGE-LM3-INT-P040`<br>`TORQUE-LM3-INT-P040` | placement zone and joint controls accepted: under-seat HV bay, side-pin dock zone, and segregated cable route | operator |
