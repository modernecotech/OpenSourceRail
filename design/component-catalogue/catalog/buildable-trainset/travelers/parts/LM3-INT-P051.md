# Shop traveler — LM3-INT-P051 — PRM transition-ramp, bogie-deck step-cover, contrast-nosing, and anti-slip set
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-INT-P051-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-INT-P051-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-INT-P051-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-INT-P051`<br>`DOC-LM3-INT-SA330` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-INT-FAB`<br>`GAUGE-LM3-INT-P051-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-INT-SA330`<br>`TORQUE-LM3-INT-P051` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: fire-material certificate | quality inspection | 0.25 | `QA-LM3-INT-P051` | fire-material certificate | quality inspector |
| 50 | verify acceptance gate: PRM transition gauge | quality inspection | 0.25 | `GAUGE-LM3-INT-P051` | PRM transition gauge | quality inspector |
| 60 | verify acceptance gate: anti-slip/contrast evidence | quality inspection | 0.25 | `QA-LM3-INT-P051` | anti-slip/contrast evidence | quality inspector |
| 70 | verify acceptance gate: trip-edge inspection | quality inspection | 0.25 | `QA-LM3-INT-P051` | trip-edge inspection | quality inspector |
| 80 | final item release to parent assembly | production control | 0.25 | `REL-LM3-INT-P051`<br>`KIT-LM3-INT-SA330` | item is released, tagged, and staged for parent assembly | cell lead |
