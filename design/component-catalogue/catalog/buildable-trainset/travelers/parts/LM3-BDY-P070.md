# Shop traveler — LM3-BDY-P070 — side-wall post, door portal, waist rail, and cant rail kit
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BDY-P070-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BDY-P070-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BDY-P070-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BDY-P070`<br>`DOC-LM3-BDY-SA120` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-BDY-FAB`<br>`GAUGE-LM3-BDY-P070-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-BDY-SA120`<br>`TORQUE-LM3-BDY-P070` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: door cassette gauge | quality inspection | 0.25 | `GAUGE-LM3-BDY-P070` | door cassette gauge | quality inspector |
| 50 | verify acceptance gate: window cassette gauge | quality inspection | 0.25 | `GAUGE-LM3-BDY-P070` | window cassette gauge | quality inspector |
| 60 | verify acceptance gate: side-frame survey | quality inspection | 0.25 | `GAUGE-LM3-BDY-P070` | side-frame survey | quality inspector |
| 70 | final item release to parent assembly | production control | 0.25 | `REL-LM3-BDY-P070`<br>`KIT-LM3-BDY-SA120` | item is released, tagged, and staged for parent assembly | cell lead |
