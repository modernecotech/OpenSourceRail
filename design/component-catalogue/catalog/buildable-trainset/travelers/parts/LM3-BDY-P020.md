...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BDY-P020-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BDY-P020-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BDY-P020-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BDY-P020`<br>`DOC-LM3-BDY-SA110` | traveler rev and parent assembly match released manifest | cell lead |
