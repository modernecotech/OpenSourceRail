# Shop traveler — LM3-BDY-P120 — jacking pad, lifting eye, towing lug, and recovery-label kit
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BDY-P120-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BDY-P120-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BDY-P120-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BDY-P120`<br>`DOC-LM3-BDY-SA110` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-BDY-FAB`<br>`GAUGE-LM3-BDY-P120-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-BDY-SA110`<br>`TORQUE-LM3-BDY-P120` | fit-up evidence recorded before release to assembly | operator |
