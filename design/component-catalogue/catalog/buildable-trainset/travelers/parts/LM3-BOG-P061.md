# Shop traveler — LM3-BOG-P061 — trailer-bogie brake/WSP/speed-sensor harness and junction-bracket kit
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BOG-P061-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BOG-P061-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BOG-P061-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BOG-P061`<br>`DOC-LM3-BOG-SA620` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-BOG-FAB`<br>`GAUGE-LM3-BOG-P061-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-BOG-SA620`<br>`TORQUE-LM3-BOG-P061` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: continuity test | quality inspection | 0.25 | `ELEC-TEST-LM3-BOG-P061` | continuity test | quality inspector |
| 50 | verify acceptance gate: connector IP rating | quality inspection | 0.25 | `QA-LM3-BOG-P061` | connector IP rating | quality inspector |
| 60 | verify acceptance gate: wheelset clearance | quality inspection | 0.25 | `QA-LM3-BOG-P061` | wheelset clearance | quality inspector |
| 70 | verify acceptance gate: dynamic cable sweep | quality inspection | 0.25 | `QA-LM3-BOG-P061` | dynamic cable sweep | quality inspector |
| 80 | final item release to parent assembly | production control | 0.25 | `REL-LM3-BOG-P061`<br>`KIT-LM3-BOG-SA620` | item is released, tagged, and staged for parent assembly | cell lead |
