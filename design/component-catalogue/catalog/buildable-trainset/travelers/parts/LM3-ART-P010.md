# Shop traveler — LM3-ART-P010 — articulation adapter frame, anti-lift keeper, and shim kit
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-ART-P010-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-ART-P010-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-ART-P010-DA` |  |  |  | `pending` |
