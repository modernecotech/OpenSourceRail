# Shop traveler — LM3-CWL-P015 — CWL-FRP-05 lamp, washer, and service-hatch fiberglass cast set
...
- Inspection methods: laminate coupon, void/delamination visual tap check, trim-line gauge, insert pull-out where classed, fit-up survey, mould release record, insert pull-out, gasket compression check, hatch removal trial, split-line gap check, water-ingress test, repair coupon demonstration
- Tooling basis: MOULD/FIX-LM3-CWL-P015 plus TRIM-GAUGE-LM3-CWL-P015
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-CWL-P015-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-CWL-P015-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-CWL-P015-DA` |  |  |  | `pending` |
