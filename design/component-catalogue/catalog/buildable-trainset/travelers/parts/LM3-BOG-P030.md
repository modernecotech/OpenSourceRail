# Shop traveler — LM3-BOG-P030 — powered-bogie guards, cable guides, WSP brackets, and inspection covers
...
- Tooling basis: FIX-LM3-BOG-FAB plus GAUGE-LM3-BOG-P030-DATUM
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BOG-P030-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BOG-P030-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BOG-P030-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BOG-P030`<br>`DOC-LM3-BOG-SA610` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-BOG-FAB`<br>`GAUGE-LM3-BOG-P030-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-BOG-SA610`<br>`TORQUE-LM3-BOG-P030` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: service access check | quality inspection | 0.25 | `QA-LM3-BOG-P030` | service access check | quality inspector |
| 50 | verify acceptance gate: harness clearance | quality inspection | 0.25 | `QA-LM3-BOG-P030` | harness clearance | quality inspector |
| 60 | verify acceptance gate: fastener torque record | quality inspection | 0.25 | `TORQUE-LM3-BOG-P030` | fastener torque record | quality inspector |
| 70 | final item release to parent assembly | production control | 0.25 | `REL-LM3-BOG-P030`<br>`KIT-LM3-BOG-SA610` | item is released, tagged, and staged for parent assembly | cell lead |
