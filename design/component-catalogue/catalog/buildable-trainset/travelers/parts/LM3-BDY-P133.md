# Shop traveler — LM3-BDY-P133 — one-metre clip-on fiberglass roof skin and equipment-fairing module
...
|---|---|---|---|---|---|
| manufacturing engineering | `APP-LM3-BDY-P133-MFG` |  |  |  | `pending` |
| quality | `APP-LM3-BDY-P133-QA` |  |  |  | `pending` |
| design authority | `APP-LM3-BDY-P133-DA` |  |  |  | `pending` |

## Operation router

| Seq | Operation | Work center | Labor h | Tooling IDs | QA gate | Signoff role |
|---:|---|---|---:|---|---|---|
| 10 | release traveler, revision, material/certificate pack, and parent interface | production control | 0.35 | `TRV-LM3-BDY-P133`<br>`DOC-LM3-SHELL-A200` | traveler rev and parent assembly match released manifest | cell lead |
| 20 | cut, form, machine, or fabricate local hardware | fabrication cell | 1.8 | `FIX-LM3-BDY-FAB`<br>`GAUGE-LM3-BDY-P133-DATUM` | fabricated geometry matches datum/gauge requirements | operator |
| 30 | trial-fit to parent interface and record shim/adjustment pack | fit-up cell | 0.8 | `FIX-LM3-SHELL-A200`<br>`TORQUE-LM3-BDY-P133` | fit-up evidence recorded before release to assembly | operator |
| 40 | verify acceptance gate: roof mould/trim record | quality inspection | 0.25 | `QA-LM3-BDY-P133` | roof mould/trim record | quality inspector |
| 50 | verify acceptance gate: anti-lift proof | quality inspection | 0.25 | `QA-LM3-BDY-P133` | anti-lift proof | quality inspector |
| 60 | verify acceptance gate: equipment keep-out gauge | quality inspection | 0.25 | `GAUGE-LM3-BDY-P133` | equipment keep-out gauge | quality inspector |
| 70 | verify acceptance gate: water/debris-ingress test | quality inspection | 0.25 | `LEAK-TEST-LM3-BDY-P133` | water/debris-ingress test | quality inspector |
| 80 | final item release to parent assembly | production control | 0.25 | `REL-LM3-BDY-P133`<br>`KIT-LM3-SHELL-A200` | item is released, tagged, and staged for parent assembly | cell lead |
