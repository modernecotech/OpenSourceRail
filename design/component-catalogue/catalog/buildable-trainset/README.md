...
| Build-record controller | [`evidence/manufacturing-control-record-template.json`](evidence/manufacturing-control-record-template.json) | Copy the blank ten-control execution record per work order; bind actual revisions, people, plant, lots, observations, NCRs and handback |
| Inspection lead | [`first-article-inspection-plan.md`](first-article-inspection-plan.md) | Import the 416 package-specific hold, witness and record-review characteristics into the QMS without pre-claiming a result |
| Production-data controller | [`production-data-release-register.md`](production-data-release-register.md) | Issue and hash-bind the 472 drawing, material, cut/form/NC, mould, harness, finish and inspection artifacts required across all 62 locally made products |
