# LM3-BDY-110 — underframe ladder, floor and equipment-support assembly

- Revision: `A-DRAFT`
- Issue status: `definition-seed-not-issued`
- Owner: vehicle structures + fabricator
- Factory package: `LM3-FRP-010`
- Source: `docs/rolling-stock/light-metro-3car/body.md`, `docs/rolling-stock/light-metro-3car/dedicated-parts-and-moulds.md`
