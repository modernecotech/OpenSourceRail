# LM3-BDY-165 — exterior module trim and bay configuration

- Revision: `A-DRAFT`
- Issue status: `definition-seed-not-issued`
- Owner: configuration engineering + composites fabricator
- Factory package: `LM3-FRP-020`
- Source: `docs/rolling-stock/light-metro-3car/dedicated-parts-and-moulds.md`
