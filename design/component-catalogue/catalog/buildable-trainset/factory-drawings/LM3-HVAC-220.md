# LM3-HVAC-220 — roof HVAC installation and duct interface

- Revision: `A-DRAFT`
- Issue status: `definition-seed-not-issued`
- Owner: HVAC supplier + vehicle integration
- Factory package: `LM3-FRP-050`
- Source: `docs/rolling-stock/light-metro-3car/roof-fitout.md`, `docs/rolling-stock/light-metro-3car/traction.md`
