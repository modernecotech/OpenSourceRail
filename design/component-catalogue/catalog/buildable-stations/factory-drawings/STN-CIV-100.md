...
- Scope type: `reusable-fabrication-definition`
- Owner: civil structures + precast fabricator
- Release package: `STN-FRP-010`
- Source: `docs/stations/standard-archetype/envelope.md`, `design/component-catalogue/catalog/buildable-stations/default-product-specifications.md`
...
- module plan, elevations and typical sections
- mould, reinforcement, inserts and lifting details
- platform edge, tactile, service-trough and joint interfaces
