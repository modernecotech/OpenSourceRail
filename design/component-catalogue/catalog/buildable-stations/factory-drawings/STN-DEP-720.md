...
- Owner: depot energy integrator + fire engineer
...
|---|---|---|---:|---|
| `STN-DEP-P040` — outdoor/open-sided per-stall plug-in charger, isolation, suspended cable, and data-dock kit | `BID` / `buildable-after-supplier-and-energy-freeze` | `deployment-specific` | 1 | [`specified`](../default-product-specifications.md#stn-dep-p040) |
| `STN-DEP-P050` — depot PV canopy, inverter, microgrid switchgear, and separated outdoor stationary-battery package | `BID` / `buildable-after-energy-site-and-supplier-freeze` | `deployment-specific` | 1 | [`specified`](../default-product-specifications.md#stn-dep-p050) |

## Required views

- energy compound and stall-equipment layout
- PV/storage/PCS/charger single-line and protection diagram
- separation, containment, cooling, detection, remote isolation and replacement paths
