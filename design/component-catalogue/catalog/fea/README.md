...
```bash
tools/automation/freecad-generate.sh --fem --screenshots
```

Or regenerate from `design/component-catalogue/` with the lower-level launchers:
...
[`../../models/cad/fea-screening-models.FCStd`](../../models/cad/fea-screening-models.FCStd),
