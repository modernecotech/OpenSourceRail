...
from osr_mech.rolling_stock.baseline import PROMOTED_HVAC_THERMAL_KW_PER_CAR
...
CATALOGUE: dict[Category, CotsItem] = {
    Category.WINDOW: CotsItem(
        ...
        cost_basis="Derived from BOM B10: 18 cassettes / 6,000 USD base after Alibaba laminated transport-glass listed-price pass; rail quotes vary with heating, curvature, and certification pack.",
    ...
    Category.HVAC_ROOF: CotsItem(
        ...
        fit_note="Roof curb accepts hot-climate compact or split unit, drop ducts, condensate drains, and diagnostics harness.",
        ...
        height_mm=450.0,
        mass_kg=460.0,
        power_w=PROMOTED_HVAC_THERMAL_KW_PER_CAR * 1_000.0,
        mount_pattern="10× M12 curb bolts, EPDM gasket, twin 450 × 260 drop ducts",
        unit_cost_low_usd=3_000.0,
        unit_cost_base_usd=5_750.0,
        unit_cost_high_usd=9_500.0,
        cost_basis="Promoted v2A hot-climate 24 kW/car HVAC allowance; high end covers rail-qualified package, pressure-protection options, and diagnostics integration.",
    ...
    Category.PIS_SCREEN: CotsItem(
        ...
        unit_cost_low_usd=150.0,
        unit_cost_base_usd=250.0,
        unit_cost_high_usd=650.0,
        cost_basis="Derived from BOM E14: 12 onboard displays / 3,000 USD base after Alibaba bus/metro display listed-price pass; high end covers rail LCD/LED display controller and EMC evidence.",
    ...
    Category.SEAT: CotsItem(
        ...
        unit_cost_base_usd=333.333,
        unit_cost_high_usd=800.0,
        cost_basis="Derived from BOM B14: 60 seats / 6,000 USD after Alibaba bus/metro seat listed-price pass, represented as 18 multi-seat bench runs per consist.",
    ...
    Category.GRAB_POLE: CotsItem(
        ...
        unit_cost_low_usd=50.0,
        unit_cost_base_usd=104.167,
        unit_cost_high_usd=250.0,
        cost_basis="Derived from BOM B15: 24 primary stanchions / 2,500 USD base after Alibaba bus handrail fittings listed-price pass.",
    ...
    Category.INTERCOM: CotsItem(
        ...
        unit_cost_low_usd=100.0,
        unit_cost_base_usd=250.0,
        unit_cost_high_usd=700.0,
        cost_basis="BOM B19 includes CCTV + intercom kit; this row assigns a 250 USD planning unit after Alibaba bus CCTV/intercom listed-price pass.",
