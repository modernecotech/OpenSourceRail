...
def factory_release_record_template(payload: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "first_article_inspection_plan": "design/component-catalogue/catalog/buildable-trainset/first-article-inspection-plan.json",
        ...
        "instructions": [
            ...
            "retain first-article inspection characteristic IDs and link performed results before package acceptance",
