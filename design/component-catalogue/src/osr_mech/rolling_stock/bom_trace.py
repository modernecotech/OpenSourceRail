...
PROCUREMENT_BOM_ENGINEERING_IDS: dict[str, tuple[str, ...]] = {
    ...
    "B1": ("LM3-BDY-P010", "LM3-BDY-P020", "LM3-BDY-P021", "LM3-BDY-P060", "LM3-BDY-P061", "LM3-BDY-P070", "LM3-BDY-P080", "LM3-BDY-P090"),
    "B2": (
        "LM3-BDY-P030",
        "LM3-BDY-P040",
        "LM3-BDY-P050",
    ...
    "B5": ("LM3-SHELL-A200",),
    "B6": ("LM3-SHELL-A200", "LM3-BDY-P130", "LM3-BDY-P131", "LM3-BDY-P132", "LM3-EXT-P080"),
    "B7": ("LM3-SHELL-A200", "LM3-BDY-P133", "LM3-BDY-P140", "LM3-EXT-P090", "LM3-ROOF-P030", "LM3-ROOF-P040", "LM3-ROOF-SA410", "LM3-INT-P040"),
    "B8": ("LM3-CWL-SA710", "LM3-CWL-P010", "LM3-CWL-P011", "LM3-CWL-P012", "LM3-CWL-P013", "LM3-CWL-P014", "LM3-CWL-P015", "LM3-CWL-P016", "LM3-FAS-P010", "LM3-FAS-P020", "LM3-FAS-P030"),
    "B9": ("LM3-ART-P020", "LM3-ART-P021", "LM3-ART-P022", "LM3-ART-P023", "LM3-ART-P040"),
    "B10": ("LM3-EXT-P020", "LM3-WIN-P010"),
    "B11": ("LM3-EXT-P010", "LM3-DOOR-P010"),
    "B12": ("LM3-BDY-P060", "LM3-EXT-P060"),
    "B13": ("LM3-EXT-P061",),
    "B14": ("LM3-EXT-P062", "LM3-FIX-P030"),
    "B15": ("LM3-EXT-P063", "LM3-FIX-P010", "LM3-FIX-P030"),
    "B16": ("LM3-LGT-P010", "LM3-LGT-P020"),
    "B17": ("LM3-END-SA700", "LM3-END-P050", "LM3-FAS-P020"),
    "B18": ("LM3-EXT-P064",),
    "B19": ("LM3-EXT-P065",),
    "B20": ("LM3-SHELL-A200", "LM3-FIN-P010", "LM3-FIN-P020"),
    "B21": ("LM3-INT-P020", "LM3-INT-P021", "LM3-INT-P022", "LM3-INT-P030", "LM3-INT-P031", "LM3-INT-P032", "LM3-INT-P040", "LM3-INT-P041", "LM3-INT-P050", "LM3-INT-P051", "LM3-INT-P052", "LM3-FIX-P010", "LM3-FIX-P020"),
    "B22": ("LM3-END-P010", "LM3-END-P040"),
    "B23": ("LM3-END-P010",),
    "B24": ("LM3-ART-P024", "LM3-ART-P030", "LM3-ART-P041"),
    "B25": ("LM3-EXT-P010", "LM3-BDY-P100", "LM3-DOOR-P010"),
    "B26": ("LM3-BDY-SA110", "LM3-BDY-P120", "LM3-END-SA700"),
    "B27": ("LM3-EXT-P030", "LM3-FAS-P010", "LM3-FAS-P030"),
    "B28": ("LM3-SHELL-A200", "LM3-FIN-P010", "LM3-FIN-P020"),
    "B29": ("LM3-ART-P010", "LM3-ART-P040"),
    # Bogies.
    "G1": ("LM3-BOG-P010",),
    "G2": ("LM3-BOG-P020",),
    "G3": ("LM3-BOG-P040", "LM3-BOG-P041"),
    "G4": ("LM3-BOG-P042", "LM3-BOG-P043"),
    "G5": ("LM3-BOG-P044", "LM3-BOG-P045"),
    "G6": ("LM3-BOG-P046", "LM3-BOG-P047"),
    "G7": ("LM3-BOG-P046", "LM3-BOG-P047"),
    "G8": ("LM3-BOG-P040", "LM3-BOG-P041", "LM3-BOG-P048", "LM3-BOG-P049"),
    "G9": ("LM3-BOG-P048", "LM3-BOG-P049"),
    "G10": ("LM3-BOG-P046", "LM3-BOG-P047"),
    "G11": ("LM3-BOG-P046", "LM3-BOG-P047"),
    "G12": ("LM3-BOG-P044", "LM3-BOG-P045", "LM3-BOG-P046", "LM3-BOG-P047"),
    "G13": ("LM3-BOG-P030", "LM3-BOG-P031"),
    "G14": ("LM3-BOG-P042", "LM3-BOG-P043", "LM3-BOG-P060", "LM3-BOG-P061"),
    "G15": ("LM3-BOG-P042", "LM3-BOG-P043", "LM3-BOG-P060", "LM3-BOG-P061"),
    "G16": ("LM3-BOG-P048", "LM3-BOG-P049"),
    ...
    "T12": ("LM3-TRC-P060",),
    "T13": ("LM3-TRC-P030",),
    "T14": ("LM3-EXT-P040", "LM3-ROOF-P010", "LM3-ROOF-P030", "LM3-INT-P010"),
    "T15": ("LM3-TRC-P050",),
    "T16": ("LM3-TRC-P070",),
    ...
    "T21": ("LM3-EXT-P050",),
    "T22": ("LM3-ROOF-P020", "LM3-ROOF-P040"),
    "T23": ("LM3-TRC-P030",),
    ...
    "E12": ("LM3-CTRL-P030",),
    "E13": ("LM3-CTRL-P030",),
    "E14": ("LM3-CTRL-P010", "LM3-EXT-P064", "LM3-FIX-P030"),
    "E15": ("LM3-CTRL-P010", "LM3-EXT-P065", "LM3-END-P020"),
    "E16": ("LM3-CTRL-P030",),
