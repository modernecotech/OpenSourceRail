...
def _require_freecad() -> None:
    if App is None or Part is None:
        raise SystemExit(
            ...
            "or design/component-catalogue/scripts/freecad_fea.sh.\n"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--freecad-out", type=Path, default=Path(__file__).resolve().parents[2] / "models" / "cad" / "fea-screening-models.FCStd")
    parser.add_argument(
        "--png-out-dir",
        type=Path,
