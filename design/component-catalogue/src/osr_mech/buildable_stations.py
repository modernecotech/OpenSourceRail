    ...
    if bool(config.get("is_depot", False)):
        ...
        items.extend(
            [
                ...
                _item(
                    "STN-DEP-P040",
                    "outdoor/open-sided per-stall plug-in charger, isolation, suspended cable, and data-dock kit",
                    "BID",
                    depot_stalls,
                    "stall kit",
                    "STN-DEP-SA850",
                    "one controlled charging/data dock per reference stall",
                    ("supplier loss/duty and maximum-ambient declaration", "supplier FAT", "protection/isolation test", "vehicle reach/alignment test", "charge/abort/data-sync SAT", "fire separation and emergency-isolation walkdown"),
                    ("depot/layout.py", "RFC 0014 §5.3", "RFC 0021 §6.1", "engineering/analysis/stations/screening-summary.md"),
                    "buildable-after-supplier-and-energy-freeze",
                ),
                _item(
                    "STN-DEP-P050",
                    "depot PV canopy, inverter, microgrid switchgear, and separated outdoor stationary-battery package",
                    "BID",
                    1,
                    "energy-site kit",
                    "STN-DEP-SA850",
                ...
                _item(
                    "STN-DEP-P060",
                    "main workshop, synchronized LM3 lift/bogie-change bay, overhaul/inspection bays, 40 t crane, wash plant, stores, and wheel-lathe package",
                    "BID",
                    float(depot["workshop_m2"]),
                    "m2 workshop",
                    "STN-DEP-SA850",
                    "main-heavy workshop envelope and enabled equipment from the depot template",
                    ("building/egress release", "foundation reaction calculation", "four-point LM3 interface gauge", "synchronized lift proof and mechanical-lock test", "bogie extraction sweep", "crane certification", "pit/fall-protection inspection", "lathe acceptance", "wash/recycling SAT"),
                    ("lib/templates/depots.toml", "depot/layout.py", "RFC 0014 §5.1/§5.2"),
                    "buildable-after-building-and-equipment-freeze",
                ),
                _item(
                    "STN-DEP-P070",
                    "depot cooled controls room, LV, compressed-air, fire, lighting, CCTV, LAN, access-control, and maintenance-data kit",
                    "BID",
                    1,
                    "depot services kit",
                    "STN-DEP-SA850",
                    "one coordinated services and security package per main-heavy depot",
                    ("utility capacity", "2 x 30 kW packaged-DX schedule and 30 kW single-unit thermal duty proof", "cooling duty/standby changeover and high-temperature alarm", "fire cause/effect and remote energy-isolation test", "air-system pressure test", "coverage/access test", "maintenance-data sync"),
                    ("RFC 0014 §5", "standard-archetype/services.md", "control-electronics/s-sbc/diy-assembly/README.md", "engineering/analysis/stations/screening-summary.md"),
            ...
            (
                StationAssemblyNode(
                    ...
                    (
                        ...
                        "construct the physically separated outdoor/open-sided energy compound with containment, guarded outward access, remote isolation, detection and the project fire-strategy provisions",
                        "install charger power stages and stationary storage in the energy compound; keep controls/switchgear losses in the separate controls room with 2 × 30 kW packaged DX cooling",
                        "install PV canopy, microgrid, per-stall charging/data docks, LV, compressed air, fire, CCTV, LAN, and access control without a shared return-air path to occupied buildings",
                        "commission track geometry/routes, workshop equipment, energy site, charging/data docks, duty/standby cooling and alarm changeover, emergency isolation, fire/security, and maintenance-data interfaces",
