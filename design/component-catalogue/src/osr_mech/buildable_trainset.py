...
def _product_items(candidate: DesignCandidate) -> tuple[ProductItem, ...]:
    ...
    return (
        ...
        ProductItem(
            "LM3-BDY-P020",
            "underframe centre spine and longitudinal load-path kit",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "kit",
            ...
            ("tube/plate certs", "spine straightness survey", "bogie-centre datum report"),
        ),
        ProductItem(
            "LM3-BDY-P021",
            "underframe cross-bearer, door-bay outrigger, and equipment-bracket pack",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car pack",
            ...
            ("cut-list identity", "cross-bearer profile gauge", "station map", "fixture tack survey"),
        ),
        ProductItem(
            "LM3-BDY-P030",
        ...
        ProductItem(
            "LM3-BDY-P060",
            "low-floor centre pan and removable service-floor support set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "set",
            ...
            ("PRM floor height", "egress aisle gauge", "pan weld inspection"),
        ),
        ProductItem(
            "LM3-BDY-P061",
            "raised bogie-end deck, transition ramp, and removable hatch-frame set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-BDY-SA120",
            ("car_body.py", "body.md", "LM3-BDY-100"),
            "Dedicated end-deck fabrications close over each bogie while retaining a gauged PRM transition, inspection hatches, and drainage path.",
            ("deck-height survey", "PRM transition gauge", "hatch fit/removal", "deck weld inspection"),
        ),
        ProductItem(
            "LM3-BDY-P070",
        ...
        ProductItem(
            "LM3-BDY-P130",
            "one-metre clip-on solid-side fiberglass body module",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 16,
            "module",
        ...
        ProductItem(
            "LM3-BDY-P131",
            "one-metre clip-on window-edge fiberglass side module",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 8,
            "module",
            ...
            ("window trim nest", "sealed-edge inspection", "cassette removal sweep", "master-frame dry fit"),
        ),
        ProductItem(
            "LM3-BDY-P132",
            "one-metre clip-on door-edge fiberglass side module",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 8,
            "module",
            "LM3-SHELL-A200",
            ("modular_fiberglass_body.py", "body.md", "LM3-BDY-160"),
            "CNC-trimmed door-bay variant with replaceable pocket closeout, threshold drain clearance, and door-cassette service gap.",
            ("door trim nest", "sealed-edge inspection", "door motion/service sweep", "master-frame dry fit"),
        ),
        ProductItem(
            "LM3-BDY-P133",
            "one-metre clip-on fiberglass roof skin and equipment-fairing module",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 16,
            "module",
            "LM3-SHELL-A200",
            ("modular_fiberglass_body.py", "roof-fitout.md", "LM3-BDY-160"),
            "Dedicated roof-bay moulding uses the common pitch with controlled HVAC, PV, antenna, access, and drainage trim variants.",
            ("roof mould/trim record", "anti-lift proof", "equipment keep-out gauge", "water/debris-ingress test"),
        ),
        ProductItem(
            "LM3-BDY-P140",
        ...
        ProductItem(
            "LM3-ROOF-P030",
            "removable HVAC curb fairing, intake/exhaust skirt, and access-hatch moulding set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-ROOF-SA410",
            ("roof-fitout.md", "systems.py", "LM3-HVAC-220"),
            ...
            ("fairing trim gauge", "HVAC airflow keep-out", "hatch removal trial", "roof leak test"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-ROOF-P040",
            "PV junction plinth, cable-gland cover, antenna closeout, and walkway edge set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-ROOF-SA410",
            ("roof-fitout.md", "systems.py", "LM3-HV-325"),
            ...
            ("gland/closeout trim gauge", "drain-path test", "bonding access check", "service-removal trial"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-CWL-P010",
        ...
        ProductItem(
            "LM3-FAS-P010",
            "panoramic front-glass carrier ring, setting-block pockets, and secondary-retention frame",
            Layer.FABRICATED_PART,
            Route.MAKE,
            2,
            "end set",
            ...
            "A machined/formed carrier transfers the heated laminated glass and its replaceable seal into the steel-backed end ring without making the cowl skin structural.",
            ("carrier datum survey", "glass-edge clearance gauge", "secondary-retention proof", "pane removal trial"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-FAS-P020",
            "reversible front-lamp cassette tray, aiming adjusters, and retained service bracket",
            Layer.FABRICATED_PART,
            Route.MAKE,
            2,
            "end set",
            "LM3-CWL-SA710",
            ("end-cowl.md", "systems.py", "LM3-SYS-160"),
            ...
            ("lamp datum gauge", "aiming range/retention test", "harness clearance", "cassette removal trial"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-FAS-P030",
            "front glazing/lamp EPDM seal, drain rail, washer sleeve, and edge-closeout kit",
            Layer.FABRICATED_PART,
            Route.SOURCE,
            2,
            "end kit",
            "LM3-CWL-SA710",
            ("end-cowl.md", "sensor_cowl.py", "LM3-BDY-155"),
            "Kitted replaceable elastomers and drains isolate glass, lamp, washer, and cowl split lines while leaving earth straps and service connectors visible.",
            ("seal batch/certificate", "compression map", "drain flow test", "water-ingress test"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-ART-P010",
        ...
        ProductItem(
            "LM3-FIN-P010",
            "pre-cut exterior livery graphic film, edge-seal, datum-mark, and repair-patch kit",
            Layer.EXTERNAL_COMPONENT,
            Route.BID,
            cars,
            "car kit",
            "LM3-SHELL-A200",
            ("exterior-finish-process.md", "modular_fiberglass_body.py", "LM3-BDY-160"),
            ...
            ("supplier rail-use statement", "substrate/cure acceptance", "adhesion coupon", "edge/overlap inspection", "cleaning/removal trial"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-FIN-P020",
            "calcium-carbonate radiative roof-coating qualification and exposed-roof application kit",
            Layer.EXTERNAL_COMPONENT,
            Route.BID,
            cars,
            "car kit",
            "LM3-ROOF-SA410",
            ("exterior-finish-process.md", "roof-fitout.md", "LM3-BDY-160"),
            ...
            ("rail fire/chemical evidence", "GFRP adhesion and flexibility", "UV/abrasion/wash ageing", "initial and aged solar reflectance/emittance", "one-car thermal/maintenance trial"),
            Maturity.CONCEPT,
        ),
        ProductItem(
            "LM3-INT-P010",
        ...
        ProductItem(
            "LM3-INT-P020",
            "FRP/phenolic ceiling liner panel set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car kit",
        ...
        ProductItem(
            "LM3-INT-P021",
            "ceiling light-trough bezel, diffuser carrier, and emergency-luminaire closeout set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "small_components.py", "LM3-INT-240"),
            ...
            ("fire-material certificate", "light cassette gauge", "emergency-feed identification", "module removal trial"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P022",
            "HVAC plenum cover, diffuser transition, detector bezel, and ceiling service-hatch set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "car_body.py", "LM3-HVAC-220"),
            ...
            ("fire-material certificate", "airflow opening gauge", "detector access", "hatch retention/rattle check"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P030",
            "FRP/phenolic sidewall liner panel set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 2,
            "side kit",
            ...
            ("fire-material certificate", "visible-gap gauge", "liner removal", "edge-radius inspection"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P031",
            "window reveal, setting-block inspection cover, and blind/label land set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 2,
            "side set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "cots_equipment.py", "LM3-WIN-210"),
            ...
            ("fire-material certificate", "glass-edge clearance", "cassette removal sweep", "sharp-edge inspection"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P032",
            "waist cable-cover, low-voltage access lid, and retained quarter-turn fastener set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 2,
            "side set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "small_components.py", "LM3-INT-245"),
            ...
            ("fire-material certificate", "segregation inspection", "captive-fastener audit", "cover removal/rattle check"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P040",
            "FRP battery strake cover panel set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car kit",
        ...
        ProductItem(
            "LM3-INT-P041",
            "seat-base fairing, retained equipment hatch, and rail-saddle closeout set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars,
            "car set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "small_components.py", "LM3-INT-250"),
            "Non-load-bearing fairings close around structural seat saddles while individual hatches preserve equipment, isolation, and cleaning access.",
            ("fire-material certificate", "seat-load-path clearance", "hatch removal trial", "cleaning/sharp-edge inspection"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P050",
            "FRP vestibule kick-panel and threshold-closeout set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 4,
            "door-zone kit",
            ...
            ("fire-material certificate", "threshold/drain gauge", "anti-slip witness", "kick-panel retention test"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P051",
            "PRM transition-ramp, bogie-deck step-cover, contrast-nosing, and anti-slip set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 2,
            "end-zone set",
            ...
            ("fire-material certificate", "PRM transition gauge", "anti-slip/contrast evidence", "trip-edge inspection"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
        ProductItem(
            "LM3-INT-P052",
            "door-pocket liner, sensitive-edge clearance trim, and removable jamb-cover set",
            Layer.FABRICATED_PART,
            Route.MAKE,
            cars * 4,
            "door-zone set",
            "LM3-INT-SA330",
            ("cabin-fiberglass.md", "systems.py", "LM3-DOOR-200"),
            "Handed only by installation, the common trim set keeps fingers and debris out of the door pocket without intruding into the certified door sweep.",
            ("fire-material certificate", "door sweep/pinch gauge", "jamb-cover removal", "obstruction-test witness"),
            Maturity.BUILDABLE_AFTER_SUPPLIER_FREEZE,
        ),
...
def _assemblies(family: ConsistFamily) -> tuple[AssemblyNode, ...]:
    ...
    return (
        ...
        AssemblyNode(
            ...
            Layer.SUBASSEMBLY,
            cars,
            ("LM3-BDY-SA110", "LM3-BDY-P060", "LM3-BDY-P061", "LM3-BDY-P070"),
            "weld and fixture cell",
...
def render_exterior_finish_system() -> str:
    ...
    lines = [
        ...
        f"- Principle: {payload['principle']}",
        f"- Film procurement boundary: {payload['film_product_boundary']}",
        f"- CaCO3 research screen: initial solar reflectance `{targets['initial_solar_reflectance']}`; sky-window emissivity `{targets['initial_sky_window_emissivity']}`. {targets['use']}",
        "",
        "## Finish zones",
        "",
    ...
    for raw in payload["zones"]:
        row = dict(raw)
        lines.append(
            f"| `{row['id']}` | {row['substrate']} | {row['mandatory_base_system']} | "
            f"{row['simplified_finish']} | {'yes' if row['replaceable'] else 'no'} | "
            f"{'<br>'.join(row['prohibited_coverage'])} | {'<br>'.join(row['release_evidence'])} |"
        )
    lines.extend(
        [
            "",
    ...
    for raw in payload["process"]:
        row = dict(raw)
        lines.append(f"| {row['sequence']} | {row['operation']} | {row['hold_point']} |")
    lines.extend(
        [
            "",
...
def factory_release_work_package_payload(
    design: BuildableTrainsetDesign,
) -> dict[str, object]:
    """Bind v2A drawing packages to the controlled EBOM and CAD registry."""
    ...
    for raw in payload["packages"]:  # type: ignore[union-attr]
        ...
        if package_id in package_ids:
            raise ValueError(f"duplicate factory release package {package_id}")
        package_ids.add(package_id)
        product_rows = []
        for product_id in package["product_ids"]:
            if product_id not in items:
                raise ValueError(f"{package_id} references unknown product {product_id}")
            if product_id not in geometry:
                raise ValueError(f"{package_id} references product without geometry {product_id}")
            item = items[product_id]
            spec = geometry[product_id]
            controlled_products.add(product_id)
            product_rows.append(
                {
                    "id": product_id,
                    "title": item.title,
    ...
    payload["controlled_product_ids"] = sorted(controlled_products)
    payload["tooling_ids"] = sorted(
        {tool_id for package in enriched_packages for tool_id in package["tooling_ids"]}
    )
    payload["validation"] = {
...
def render_factory_release_work_packages(design: BuildableTrainsetDesign) -> str:
    ...
    for package in payload["packages"]:  # type: ignore[union-attr]
        row = dict(package)
        drawings = "<br>".join(f"`{drawing}`" for drawing in row["drawing_ids"])
        lines.append(
            f"| [`{row['id']}`](#{str(row['id']).lower()}) | {row['title']} | "
            f"{drawings} | {len(row['product_ids'])} | {len(row['tooling_ids'])} |"
        )
    for package in payload["packages"]:  # type: ignore[union-attr]
        row = dict(package)
        lines.extend(
            [
                ...
                f"## {row['id']} — {row['title']}",
                "",
                f"Release boundary: {row['release_boundary']}",
                "",
        ...
        for heading, key in (
            ...
            ("Verification and hold points", "verification"),
        ):
...
def write_outputs(
    ...
    finish_json.write_text(
        json.dumps(finish_process_payload(), indent=2, sort_keys=True) + "\n",
        encoding="utf-8",
    )
