...
SCRIPT="$ROOT/src/osr_mech/freecad_assembly_review.py"
...
WRAPPER="$(mktemp "$ROOT/.freecad_assembly_review.XXXXXX.py")"
...
Install FreeCAD or expose its command-line runtime, then retry:
  FreeCADCmd src/osr_mech/freecad_assembly_review.py
