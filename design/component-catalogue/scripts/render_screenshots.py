...
or directly::
    ...
    python3 design/component-catalogue/scripts/render_screenshots.py
"""
...
def _factory_plan_path(out_root: Path) -> Path:
    return out_root.parents[1] / "design/component-catalogue" / "catalog" / "buildable-trainset" / "factory-plan.json"


def _critical_path_path(out_root: Path) -> Path:
    return out_root.parents[1] / "design/component-catalogue" / "catalog" / "buildable-trainset" / "critical-path.json"
