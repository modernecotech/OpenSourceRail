...
def test_fea_summary_result_links_are_local_to_catalog() -> None:
    link = _markdown_link_path(
        "design/component-catalogue/catalog/fea/chassis-bogie-screen/chassis-bogie-screen-result.png",
        Path("design/component-catalogue/catalog/fea").resolve(),
    )
...
def test_generated_fea_screening_artifacts_are_solver_backed() -> None:
    ...
    summary_path = repo_root / "design/component-catalogue/catalog/fea/screening-summary.json"
    assert summary_path.exists(), "run tools/automation/freecad-generate.sh --fem to create FEA evidence"
