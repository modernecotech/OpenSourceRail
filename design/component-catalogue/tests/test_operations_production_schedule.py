...
SPEC = importlib.util.spec_from_file_location(
    "generate_qa_maintenance_data", ROOT / "tools/automation/generate-qa-maintenance-data.py"
)
...
def test_configured_habd_sites_enter_operations_qa_and_maintenance() -> None:
    ...
    bundle = GENERATOR.build_bundle(
        design=_load_toml("cities/catalogue/west-asia/Iraq/Samawah/design.toml"),
        scenario=_load_toml("cities/catalogue/west-asia/Iraq/Samawah/samawah.toml"),
