...
| [`manufacturing-control-record-template.json`](catalog/buildable-trainset/evidence/manufacturing-control-record-template.json) | Blank per-work-order execution, inspection, stop/NCR and configuration-handback record |
| [`first-article-inspection-plan.md`](catalog/buildable-trainset/first-article-inspection-plan.md) | All 16 factory packages expanded into 416 uniquely identified hold, witness and record-review characteristics |
| [`production-data-release-register.md`](catalog/buildable-trainset/production-data-release-register.md) | Per-product route and 472 fail-closed production-artifact slots across all 62 locally made rows, linked to drawings, tooling, controls and inspection IDs |
